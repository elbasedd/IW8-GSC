...
init()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "plague_box", ::_id_12EF5, undefined, ::_id_12EDB );
}
...
_id_12EF5( var_0, var_1 )
{
    ...
    var_4 = wait_for_players_init_puzzle( var_0 );
...
wait_for_players_init_puzzle( var_0 )
{
    var_1 = self;
    var_2 = spawnstruct();
