...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "circle_peek", ::_id_12EF0, undefined, ::_id_12ED9 );
    var_0 = "circle_peak";
...
_id_12EF0( var_0, var_1 )
{
    ...
    var_4 = extract_removemissionweapon( var_0 );
...
extract_removemissionweapon( var_0 )
{
    ...
    var_1 = level._id_12BF1[self.team] + level.br_circle.circleindex + 1;

    for ( var_2 = var_1; var_2 < level.extractcountdown.size; var_2++ )
        scripts\mp\gametypes\br_quest_util.gsc::_id_11C69( self.team );
