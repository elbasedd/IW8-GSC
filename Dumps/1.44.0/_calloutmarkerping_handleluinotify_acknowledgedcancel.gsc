...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "monitorDamage", ::_id_1226B );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "createHintObject", ::_id_12266 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "getTargetMarker", ::_id_12267 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "initSentrySettings", ::_id_12269 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "allowPickupOfTurret", ::_id_12265 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "handleMovingPlatform", scripts\mp\killstreaks\manual_turret_mp::spawnvector );
}

_id_12267( var_0, var_1 )
{
    return scripts\mp\killstreaks\target_marker::gettargetmarker( var_0, var_1 );
}

_id_12266( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
...
_id_1226B( var_0 )
{
    var_0 thread scripts\mp\damage::monitordamage( var_0.maxhealth, "hitequip", ::_id_12268, ::_id_1226A, 1 );
}
...
_id_12265()
{
    ...
    if ( scripts\cp_mp\utility\killstreak_utility::roundnumber( self getcurrentweapon() ) )
        return 0;
