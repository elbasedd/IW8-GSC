...
teamspawnfunc()
{
    ...
    var_0.destroycallback = ::teamrevivefiresalediscount;
...
technical_initcollision()
{
    ...
    var_0.isvalidcustomweapon = getdvarint( "scr_motorcycleUseExitFallback", 1 );
    var_1 = "left";
...
teamvehicles()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "motorcycle", "single", [ "driver", "rear" ] );
}

technical_initdamage()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "motorcycle", 1 );
    var_0.id = 18;
...
teamswithcirclepeek()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "motorcycle", 500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "motorcycle" );
    var_0.class = "super_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "motorcycle" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "motorcycle", 4 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_131EC( "motorcycle", 6, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "motorcycle", ::teamplunderexfilshowviponly );
}

teamstarttime()
{
    var_0 = _applydvarstosettings::_id_13185( "motorcycle", 1 );
    ...
    var_0.getcrossbowammotype = 12.5;
    var_0.getcrossbowimpactfunc = 50;
    var_0.getcrateusetime = 100;
    var_0.getdomplateradius = 0;
    var_0.getdropbagdelay = 0;
    var_0.getdomneutralizeomnvarvalue = 1;
    var_1 = _applydvarstosettings::_id_13184();
    var_1.givebmodevloadouts["motorcycle"] = [];
    var_1.givebmodevloadouts["motorcycle"]["cargo_truck"] = 2;
}
...
teamplunderexfil( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "motorcycle", var_0 );
    ...
    var_2 thread teleport_to_silo_airlock();
...
teamrevivefiresalediscount( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
    {
        var_0 = spawnstruct();
...
teamplunderexfilshowviponly( var_0 )
{
    thread teamrevivefiresalediscount( var_0 );
    return 1;
}

teamfriendlyto( var_0 )
{
    self endon( "death" );
    level endon( "game_ended" );
...
teamplunderexfilvipuav( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
        teamplunderscoremechanic( var_0, var_1, var_2, var_3, var_4 );
}
        ...
        if ( getdvarint( "LTTOPOMRKP", 0 ) == 1 )
        {
            if ( !isdefined( var_2 ) )
            {
                ...
                if ( isdefined( var_5 ) )
                {
                    ...
                    var_0 thread teamfriendlyto( getanimlength( var_5 ) );
                }
            }
        }
    }
...
teamrefundplunder( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
        teamrevivecost( var_0, var_1, var_2, var_3, var_4 );
}
...
technical_initomnvars()
{
    ...
    var_0.priority = 75;
    var_0.getspawnstructscallback = ::teamreviveperkdiscount;
