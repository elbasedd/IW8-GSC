...
{
    level._id_11D1C = [];
    level._id_11D1C["rcxd_rad"] = spawnstruct();
    level._id_11D1C["rcxd_rad"].timeout = getdvarfloat( "scr_br_rcxd_rad_timeout", 45.0 );
    level._id_11D1C["rcxd_rad"].maxhealth = 75;
    level._id_11D1C["rcxd_rad"].hitstokill = 3;
    level._id_11D1C["rcxd_rad"].speed = 140;
    level._id_11D1C["rcxd_rad"].accel = 20;
    level._id_11D1C["rcxd_rad"].halfsize = 27;
    level._id_11D1C["rcxd_rad"].spawndist = 30;
    level._id_11D1C["rcxd_rad"].streakname = "rcxd_rad";
    level._id_11D1C["rcxd_rad"].vehicleinfo = "veh_rcxd_rad_mp";
    level._id_11D1C["rcxd_rad"].modelbase = "lm_veh_t9_drone_rcxd";
    level._id_11D1C["rcxd_rad"].teamsplash = "used_rcxd_rad";
    level._id_11D1C["rcxd_rad"].destroyedsplash = "callout_destroyed_rcxd_rad";
    level._id_11D1C["rcxd_rad"].get_player_info_proc = 0.5;
    level._id_11D1C["rcxd_rad"].sound_explode = "recon_drone_explode";
    level._id_11D1C["rcxd_rad"].vodestroyed = "ball_drone_backup_destroy";
    level._id_11D1C["rcxd_rad"].votimedout = "ball_drone_backup_timeout";
    level._id_11D1C["rcxd_rad"].scorepopup = "destroyed_rcxd_rad";
    level._id_11D1C["rcxd_rad"].playfxcallback = scripts\cp_mp\killstreaks\helper_drone::helperdronefx;
    level._id_11D1C["rcxd_rad"].primarymode = "MANUAL";
    level._id_11D1C["rcxd_rad"].primarymodestring = &"KILLSTREAKS_HINTS/RCD_MANUAL";
    level._id_11D1C["rcxd_rad"].primarymodefunc = scripts\cp_mp\killstreaks\helper_drone::setreconmodesettings;
    level._id_11D1C["rcxd_rad"].premoddamagefunc = undefined;
    level._id_11D1C["rcxd_rad"].postmoddamagefunc = scripts\cp_mp\killstreaks\helper_drone::helperdrone_modifydamageresponse;
    level._id_11D1C["rcxd_rad"].deployweaponname = "ks_remote_rcxd_mp";
    level._id_11D1C["rcxd_rad"].sq_movequestlocale = 1;
    level._id_11D1C["rcxd_rad"].sq_ontimerexpired = 1;
    level._id_11D1C["rcxd_rad"].ss_ontimerexpired = 73984;
    level._id_11D1C["rcxd_rad"].ss_playerdisconnect = 73984;
    level._id_11D1C["rcxd_rad"].deathfunc = ::_id_11D0A;
    level._id_11D1C["rcxd_rad"].hasdropped = 1;
    level._id_11D1C["rcxd_rad"].diewithowner = 1;
    level._id_11D1C["rcxd_rad"].stringcannotplace = &"KILLSTREAKS_HINT_CANNOT_CALL_IN";
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "rcxd_rad", ::_id_12EF6, undefined, ::_id_12EDC );
    initmines();
    var_0 = getarraykeys( level._id_11D1C );

    foreach ( var_2 in var_0 )
    {
        var_3 = level._id_11D1C[var_2].hitstokill;
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "rcxd_rad", ::_id_11D0A );
...
_id_12EF7( var_0 )
{
    ...
    if ( !self isonground() && !self isonladder() || scripts\mp\vehicles\vehicle_compass_mp::rungwperif_largeexplosions() )
        return 0;

    if ( isdefined( level.enable_leaderboard ) )
    {
        if ( ![[ level.enable_leaderboard ]]( var_1 ) )
            return 0;
    }
    ...
    var_3 = level._id_11D1C[var_2].deployweaponname;
    var_4 = var_1 scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweapontabletdeploy( var_0, ::_id_135A4, undefined, undefined, ::deployweapontaken, var_3, 0, ::_id_1344C );
    var_1 scripts\common\utility::allow_usability( 0 );
    var_1 thread scripts\cp_mp\utility\killstreak_utility::tabletdofset( 0, 1, 1 );

    if ( !istrue( var_4 ) )
    {
        var_1 _id_11D12( var_0 );
    ...
    var_5 = 0.4;
    var_6 = var_1 scripts\engine\utility::_id_13404( var_5, "death", "weapon_switch_started" );

    if ( !isdefined( var_6 ) || var_6 != "timeout" )
    {
        var_1 _id_11D08( var_0 );
    ...
    var_8 = level._id_11D1C[var_2].teamsplash;
    var_6 = _id_129DB( var_0 );
...
_id_129DB( var_0 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::time_reduction_bonus( var_1 );
    var_5.owner = var_1;
    var_5.team = var_1.team;
    var_5.vehiclename = var_0.streakname;
    var_6 = level._id_11D1C[var_0.streakname];
    ...
    var_5 thread _id_11D1B();
    var_5 thread _id_11D18();
    var_5 thread _id_11D17();
    var_5 thread _id_11D1A();
    var_5 thread _id_11D0B();
    var_5 thread _id_11D14( var_6 );
    var_5 thread _id_11D16();
    var_5 thread _id_11D13();
    var_5 thread _id_11D10( var_6 );
    ...
    var_5 _id_11D11( "rcxd_enemy", 0, 1 );
    var_5 _id_11D11( "rcxd_friendly_use", 1, 0 );
...
_id_11D10( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( istrue( var_10.seq3_sequences_correct ) )
            var_12 = var_10;
        ...
        var_17 = var_1.maxhealth * var_0.get_player_info_proc;
...
_id_11D1B()
{
    ...
    var_1 = level._id_11D1C[var_0.vehiclename];
...
_id_11D09( var_0 )
{
    ...
    if ( !istrue( var_2.hasactivepunchcard ) )
    {
        var_2 thread _id_11D06();
        var_2.hasactivepunchcard = 1;
    }
    ...
    scripts\cp_mp\utility\killstreak_utility::time_watcher( var_2.owner );
    var_2 setscriptablepartstate( "flash_light", "default", 0 );
    var_2.owner scripts\cp_mp\utility\killstreak_utility::_id_11D86( var_0 );
    var_2.owner unlink();
    ...
    var_2 setscriptablepartstate( "flash_light", "default", 0 );
    var_3 = level._id_11D1C[var_0.streakname].deployweaponname;
...
_id_11D12( var_0 )
{
    ...
    wait 1.5;
    var_2 = level._id_11D1C[var_0.streakname].deployweaponname;
...
_id_11D18()
{
    ...
    var_0 endon( "death" );
    var_0 endon( "explode" );
    var_0 childthread _id_11D19( "disconnect" );
    var_0 childthread _id_11D19( "joined_team" );
    var_0 childthread _id_11D19( "joined_spectators" );
    var_0 childthread _id_11D19( "last_stand_start" );
}
...
_id_11D17()
{
    ...
    for (;;)
    {
        ...
        var_2 = level._id_11D1C[var_0.vehiclename];
...
_id_11D1A()
{
    ...
    var_0 endon( "owner_gone" );
    var_1 = var_0.streakinfo;
    level scripts\engine\utility::_id_133F1( "round_end_finished", "game_ended", "prematch_cleanup", "ending_sequence" );
    var_0 thread _id_11D09( var_1 );
}
...
_id_11D0B()
{
    ...
    var_0 endon( "explode" );
    var_1 = var_0.streakinfo;
    level scripts\engine\utility::_id_133EF( "bro_shot_start", "game_ended" );
    var_0 thread _id_11D09( var_1 );
}
...
{
    var_1 = self;
    var_1 thread _id_11D06();
    var_1.hasactivepunchcard = 1;
    var_1 thread _id_11D09( var_0 );
}
...
applygasdamageovertime( var_0, var_1 )
{
    ...
    while ( var_1 istouching( self ) )
    {
        ...
        var_2 = scripts\engine\utility::_id_13403( 1, "death" );
...
_id_11D11( var_0, var_1, var_2 )
{
    ...
    var_4 = var_3 _id_11D0E( var_1, var_2, 7500 );
    scripts\mp\gametypes\br_public.gsc::brleaderdialog( var_0, 1, var_4 );
}

_id_11D0E( var_0, var_1, var_2 )
{
    var_3 = self;
    var_4 = [];
