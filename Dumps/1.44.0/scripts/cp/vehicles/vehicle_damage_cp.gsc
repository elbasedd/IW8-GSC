...
callbacksoldieragentdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( istrue( self.calloutmarkerping_removeallcalloutsforallplayers ) )
    {
        if ( _id_124E0( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 ) )
            return;
    ...
    if ( var_32 )
    {
        if ( istrue( self.remove_reduce_recoil ) )
        {
            var_2 = 0;
    ...
    if ( var_22 )
    {
        ...
        {
            if ( var_24 )
                var_2 = applycirclesetdvars( var_2, var_5, var_17, var_4, var_1 );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            ...
            if ( scripts\mp\damage::armorvest_washit( var_1 ) || scripts\mp\damage::helmet_washit( var_1 ) )
                var_3 = var_3 | level.prematchmusic;

            if ( scripts\mp\damage::armorvest_wasbroke( var_1 ) || scripts\mp\damage::helmet_wasbroke( var_1 ) )
                var_3 = var_3 | level.prematchloadouts;

            if ( isdefined( level.tv_station_fastrope_two_infil_start_targetname_array_index ) )
                var_3 = var_3 | [[ level.tv_station_fastrope_two_infil_start_targetname_array_index ]]( var_13 );
        }
    }
    ...
    if ( var_22 || var_23 || var_30 )
    {
        if ( isdefined( var_12 ) )
        {
            ...
            arena_turret_op( self, var_1, var_0, var_12, var_2, var_6, var_7, var_8, var_9, var_4 );
        }
...
callbacksoldieragentgametypekilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( self.getminigundamagescale ) )
    {
        var_9 = spawnstruct();
        ...
        thread [[ self.getminigundamagescale ]]( var_9 );
    }
...
applycirclesetdvars( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_0;
...
arena_turret_op( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
...
process_damage_feedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_14 ) && var_14 != var_10 && var_2 + var_11 + var_12 > 0 && ( !isdefined( var_8 ) || var_8 != "shield" ) )
    {
        ...
        if ( isdefined( var_10.light_tank_stopwatchingmissileinputchange ) && var_10.light_tank_stopwatchingmissileinputchange.size > 1 )
...
_id_124E0( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_0 ) && ( issubstr( var_13, "thermite" ) || isdefined( var_12.magazine ) && issubstr( var_12.magazine, "boltfire" ) || isdefined( var_0.weapon_name ) && issubstr( var_0.weapon_name, "incendiary" ) ) )
    {
        ...
        if ( var_15 )
        {
            ...
            {
                self.calloutmarkerping_removeallcalloutsforplayer = 1;
                self._id_12C45 = 0;
            }
        }
        else if ( var_8 != "none" )
        {
            self.calloutmarkerping_removeallcalloutsforplayer = undefined;
            self._id_12C45 = undefined;
        }
    }
    ...
    else if ( var_8 == "none" && isdefined( var_0 ) )
    {
        ...
        if ( istrue( self.calloutmarkerping_removeallcalloutsforplayer ) && var_14 && isdefined( var_23 ) && var_23 == self )
        {
            if ( !isdefined( self._id_12C47 ) )
                self._id_12C47 = [ var_0 ];
            else if ( !scripts\engine\utility::array_contains( self._id_12C47, var_0 ) )
                self._id_12C47[self._id_12C47.size] = var_0;
