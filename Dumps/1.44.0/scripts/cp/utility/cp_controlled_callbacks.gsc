...
init_battlechatter()
{
    ...
    anim._id_12C55 = 120000;
    bcs_setup_countryids();
    level.col_circletick = 1;
}
...
{
    return istrue( level.col_circletick );
}
...
allsupportboxes( var_0 )
{
    ...
    var_0 setnpcid();
    thread _id_11EAA( var_0 );
    var_0 thread trackriotshield_updateoffhandstowignorec4();
}
...
{
    level._battlechatter.setup_comms_obj_b_goals_and_cover = var_0;
    level._battlechatter.setup_comms_obj_crate = gettime();
}

callouttypewillrepeat( var_0 )
{
    if ( !isdefined( level._battlechatter.setup_comms_obj_b_goals_and_cover ) )
        return 0;

    if ( !isdefined( level._battlechatter.setup_comms_obj_crate ) )
        return 0;

    var_1 = level._battlechatter.setup_comms_obj_b_goals_and_cover;
    var_2 = level._battlechatter.setup_comms_obj_crate;
    var_3 = anim._id_12C55;
...
playorderevent( var_0, var_1, var_2 )
{
    ...
    switch ( var_0 )
    {
        case "action":
            ...
            updateindangercirclestate( var_1, var_2 );
            break;
        case "move":
            updateindangercirclestate( var_1, var_2 );
            break;
        case "displace":
            updateindangercirclestate( var_1 );
            break;
    }
...
updateindangercirclestate( var_0, var_1 )
{
    var_2 = self;
    var_2 endon( "death" );
    var_2 endon( "removed from battleChatter" );
...
playphrase( var_0, var_1, var_2 )
{
    ...
    var_1 thread _id_1238B( var_1.curevent.eventaction, var_1.curevent.eventtype );
...
_id_1238B( var_0, var_1 )
{
    self.battlechatter.isspeaking = 1;
    scripts\engine\utility::_id_133EF( "playPhrase_done", "death" );
