...
init()
{
    scripts\engine\scriptable::_id_1219E( "military_ammo_restock", ::bonuskillscharge );
...
bonuskillscharge( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        if ( choppersupport_watchleashrange( var_3 ) )
        {
            if ( scripts\mp\flags::gameflag( "prematch_done" ) && ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "rumble" ) )
                ...
                thread bonusdeathplunderot( var_0, var_3, 5 );
        }
        else
            thread bonusdeathplunderot( var_0, var_3, 0.1 );
    }
...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons.gsc::clean_up_eliminate_drone( var_9, 2 );
            continue;
        }

        var_21 = scripts\mp\weapons::getammooverride( var_9 );

        if ( scripts\mp\utility\weapon::respawnplayers( var_9 ) )
        {
...
choppersupport_watchleashrange( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::run_cleanup_funcs_for_unused_objectives( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons.gsc::clean_up_eliminate_drone( var_8, 2 );
            var_1 = 1;
        }
    }
