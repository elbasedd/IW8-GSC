...
animscriptmp_internal( var_0, var_1, var_2, var_3 )
{
    ...
    scripts\asm\asm_mp::br_toggle_armor_allows();
...
bot_ctf_enemy_team_flag_is_picked_up( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::br_toggle_armor_allows();
...
bot_ctf_can_switch_to_defender( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::br_toggle_armor_allows();
...
bot_ctf_get_node_chance( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "animscripted";
...
bot_ctf_flag_is_home_of_team( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::br_toggle_armor_allows();
