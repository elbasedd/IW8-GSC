...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !istrue( level.helis_assault3_check_size ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0._id_124F3 = 1;
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level._id_121CD[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level._id_121CD ) && isdefined( level._id_121CD[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level._id_121CD[var_0] );
...
finalizespawnpointchoice( var_0 )
{
    ...
    else
    {
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0._id_13137, var_0.threatsight, var_0.damagemod );
    }
...
get_next_available_wire_for_bomb( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
anyplayersinlaststandhold( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level._id_121CD[var_3] ) )
            level._id_121CD[var_3] = [];
        ...
        level._id_121CD[var_3][level._id_121CD[var_3].size] = var_8;
    }

    level thread _id_121CE();
}
...
_id_121CE()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level._id_121CD )
        {
            foreach ( var_3 in var_1 )
            {
