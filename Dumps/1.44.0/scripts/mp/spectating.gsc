...
autoattachtoplayer()
{
    ...
    level.setplayervargulagjail = game["lastSpectatedPlayer"];
    ...
    for (;;)
    {
        ...
        {
            if ( level.currentround > 1 && isdefined( level.setplayervargulagjail ) && self.team != "follower" )
                var_0 = level.setplayervargulagjail;
...
updatemlgspectator()
{
    ...
    for (;;)
    {
        if ( self ismlgspectator() && self isspectatingplayer() )
        {
            ...
            if ( isdefined( var_0 ) )
                level.setplayervargulagjail = var_0.clientid;
        }
...
_id_1211D()
{
    ...
    game["lastSpectatedPlayer"] = level.setplayervargulagjail;
}
