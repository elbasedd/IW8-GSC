...
player_update_unresolved_collision( var_0, var_1 )
{
    ...
    if ( self.unresolved_collision_count >= var_2 )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_4 = isdefined( self.setdragonsbreathcorpseflare ) && gettime() - self.setdragonsbreathcorpseflare <= 250;

                if ( var_4 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::_id_131FD( var_0, self ) )
                {
...
player_unresolved_collision_watch()
{
    ...
    for (;;)
    {
        ...
        if ( watchfordeleteleaderidleanchor( var_0 ) )
            continue;
...
watchfordeleteleaderidleanchor( var_0 )
{
    ...
    if ( istrue( var_0.filter_damage_to_player ) )
        var_1 = 1;

    if ( isdefined( var_0.dropangles ) )
        var_1 = 1;
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level.friendlyicon ) )
    {
        var_3 = self [[ level.friendlyicon ]]( var_0, var_1, var_2 );
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            else if ( isdefined( level.supportbox_updateheadiconallplayers ) && [[ level.supportbox_updateheadiconallplayers ]]( var_0, var_2 ) )
                return;
        }
        else
        {
...
handle_moving_platform_touch( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0.wait_to_reset_wave_loadout ) && var_0.wait_to_reset_wave_loadout )
        {
            if ( scripts\mp\equipment\claymore::respawn_after_death( var_1 ) )
            {
                waitframe();
                continue;
            }
        ...
        if ( !istrue( var_0._id_125A7 ) )
            thread process_moving_platform_death( var_0, var_1 );

        self._id_12CFA = 1;
        self.setplacementstats = var_1;
...
{
    self endon( "death" );
    self.setplacementstats waittill( "death" );
    self.setplacementstats = undefined;
}
...
handle_moving_platforms( var_0 )
{
    ...
    if ( isdefined( var_0.linkparent ) )
    {
        ...
        {
            if ( isdefined( var_0.sidekillcount ) )
                self linkto( var_0.linkparent, "", var_0.sidekillcount, var_0.angleoffset );
            else
