...
onjuggernaut()
{
    ...
    {
        self.carryobject thread setdropped();
        self switchtoweapon( scripts\mp\juggernaut::search() );
    }
}
...
_id_11DDE( var_0 )
{
    self.vo_enemy_armor[self.vo_enemy_armor.size] = var_0;
}

enable_oob_immunity_on_riders( var_0 )
{
    var_1 = 1;

    foreach ( var_3 in self.vo_enemy_armor )
...
carryobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( !roof_rpg_covers() && var_0 scripts\mp\utility\weapon::grenadeinpullback() )
        {
...
setpickedup( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.carryobject ) || isdefined( self.carryweapon ) && !var_0 scripts\common\utility::is_weapon_allowed() || !enable_oob_immunity_on_riders( var_0 ) )
    {
...
updatecarryobjectorigin()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.carrier ) )
        {
            ...
            scripts\engine\utility::_id_1340A( self.objpingdelay, "dropped", "reset" );
            continue;
        }
...
{
    if ( istrue( var_1.score_event_civilian_hit ) )
        var_7 = var_1;
    else
        var_7 = spawnstruct();
...
useobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.supportbox_watch_flight ) )
        {
            if ( ![[ level.supportbox_watch_flight ]]( var_0 ) )
                continue;
        }
...
getearliestclaimplayer()
{
    ...
    if ( isdefined( self.logtrophysuccesful ) && istrue( self.end_health ) )
    {
        if ( self.logtrophysuccesful[var_0].size > 0 )
        {
            var_2 = undefined;
            var_3 = getarraykeys( self.logtrophysuccesful[var_0] );

            for ( var_4 = 0; var_4 < var_3.size; var_4++ )
            {
                var_5 = self.logtrophysuccesful[var_0][var_3[var_4]];
...
{
    if ( isdefined( self._id_12A14 ) )
        self [[ self._id_12A14 ]]( var_0 );
...
proxtriggerthink()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( self.rewardscriptable ) && ( var_1 scripts\mp\utility\player::isusingremote() || isdefined( var_1.spawningafterremotedeath ) ) )
            continue;

        if ( istrue( var_1.inlaststand ) && !istrue( self.trigger.blueprintextract_onpickupcreated ) )
            continue;
...
triggertouchthink( var_0 )
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( self ) && isdefined( var_0.trigger ) && self istouching( var_0.trigger ) && !level.gameended )
    {
        ...
        if ( istrue( self.inlaststand ) && !istrue( var_0.trigger.blueprintextract_onpickupcreated ) )
            break;
        ...
        if ( istrue( var_0.enemy_think ) && isdefined( var_0.usecondition ) && !var_0 [[ var_0.usecondition ]]( self ) )
            break;
            ...
            if ( hasdomflags() && isdefined( var_0.id ) && ( var_0.id == "domFlag" || var_0.id == "hardpoint" || var_0.id == "bomb_site" || var_0.id == "rugby_jugg" ) )
            {
                ...
                else if ( var_1 && isdefined( self.ui_dom_securing ) && ( isdefined( var_0.stalemate ) && !var_0.stalemate && !istrue( var_0.majoritycapprogress ) ) && var_0.ownerteam != self.team )
                {
                    ...
                    if ( scripts\mp\utility\game::getgametype() == "hq" )
                    {
                        ...
                        self setclientomnvar( "ui_objective_state", var_0 scripts\mp\gametypes\obj_dom.gsc::nakeddrophandleloadout() );
                    else
                        self setclientomnvar( "ui_objective_state", 1 );
                }
                else
...
updateuisecuring( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && var_3.id == "laststand_reviver" )
        {
            ...
            scripts\mp\gametypes\br.gsc::_id_130BA( var_6, self, var_0 );
        }
    }
    else
    {
    ...
    else if ( !var_1 )
    {
        if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
        {
            if ( !var_0 scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) )
            {
                ...
                {
                    var_0 thread little_bird_mg_initdamage( 1 );
        ...
        if ( !isdefined( var_2 ) && !var_1 )
        {
            if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
            {
                if ( istrue( var_0.weaponsdisabledwhilereviving ) )
                {
                    ...
                    if ( !level.allowreviveweapons )
                    {
                        var_0 thread little_bird_mg_initdamage( 0 );
...
usetest( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.trigger ) && isdefined( self.trigger._id_1311D ) && distance2dsquared( self.trigger.origin, var_0.origin ) >= self.trigger._id_1311D )
        return 0;
    ...
    if ( istrue( self.enemy_think ) && isdefined( self.usecondition ) && !self [[ self.usecondition ]]( var_0 ) )
        return 0;
...
_id_123A1( var_0, var_1, var_2, var_3, var_4 )
{
        ...
        if ( var_1 != -1 )
        {
            if ( level.codcasterenabled )
            {
                if ( isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_1304D( var_1, var_12 );
                }
                else
                    scripts\mp\objidpoolmanager::_id_1304E( var_1 );
            }
            ...
            if ( !var_7 )
            {
                ...
                if ( level.codcasterenabled && isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_13050( var_1, var_20 );
                }
