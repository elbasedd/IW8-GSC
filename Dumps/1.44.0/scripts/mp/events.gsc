...
init()
{
    ...
    for (;;)
    {
        ...
        var_3 = tablelookupbyrow( "mp/score_event_table.csv", var_1, level.dropping_minigun.game_type_col[var_0] );
...
onplayerconnect()
{
    for (;;)
    {
        ...
        var_0.try_to_punish_with_jugg = 0;
...
brgetloadoutoptionstandardloadoutindex( var_0, var_1, var_2, var_3 )
{
    var_4 = 1;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        else if ( brgetoperatorteam( var_2, var_1, var_3 ) )
        {
...
brgetoperatorteam( var_0, var_1, var_2 )
{
    var_3 = 0;
...
branalytics_respawn( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isplayer( self ) )
        return;
    ...
    {
        var_10 = brgetloadoutoptionstandardloadoutindex( self, var_4, var_2, var_3 );
        ...
        if ( isdefined( var_1._id_12A8D ) && var_1._id_12A8D == self )
        {
            self.modifiers["grenadestuck"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 8;
        }

        if ( scripts\mp\utility\game::restartwrapper( var_1 ) )
        {
        ...
        if ( var_3 == "MOD_HEAD_SHOT" || script_gameobjetname( var_2, var_5 ) || respawncircleinterppct( var_2, var_5 ) )
        {
        ...
        if ( var_10 )
        {
            ...
            switch ( var_24 )
            {
                ...
                case "longshot":
                    ...
                    self setclientomnvar( "ui_longshot_special", rpg_think( var_11, var_1, var_2 ) );
                    break;
                case "very_longshot":
                    self.modifiers["longshot"] = 1;
                    self.modifiers["mask"] = self.modifiers["mask"] | 262144;
            ...
            if ( scripts\mp\class::scramblebink( var_2 ) )
            {
            ...
            if ( risk_flagspawndebugobjicons( self, var_1 ) )
            {
                self.modifiers["detectedimpairedkill"] = 1;
            ...
            if ( isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::nuke_triggermercywin() > gettime() )
            ...
            if ( isdefined( var_5.damageflags ) && var_5.damageflags & level.idflags_penetration && !( var_5.damageflags & level.prepare_mission_failed_text ) )
            {
                self.modifiers["coverkill"] = 1;
                self.modifiers["mask2"] = self.modifiers["mask2"] | 262144;
            }

            if ( scripts\mp\equipment\gas_grenade::lootleadermarkweakvalue( self, var_1 ) )
            {
        ...
        if ( scripts\mp\utility\player::round_spawn_enemies( self ) )
        {
            self.modifiers["last_stand"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 1024;
        }

        if ( scripts\mp\utility\player::round_spawn_enemies( var_1 ) || istrue( var_5.currentpoint ) )
        {
    ...
    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) || scripts\mp\utility\weapon::router_placed( var_4 ) )
    ...
    var_58 = num_nodes_random_search();
...
move_platform( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
    return var_5;
}

move_player_from_under_heli_and_kill( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
...
killedplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_2.vandalize_attack_max_cooldown ) )
        var_2 = var_2.vandalize_attack_max_cooldown;
    ...
    thread _id_13089( var_3, var_4, var_1 );
    ...
    if ( !scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) && !scripts\mp\utility\perk::_hasperk( "specialty_explosivebullets" ) )
    {
        ...
        var_12 = brgetloadoutoptionstandardloadoutindex( self, var_4, var_2, var_3 );
        ...
        if ( var_12 )
        {
            ...
            if ( self ismantling() )
                spawntimestamp( var_0 );

            if ( istrue( self.modifiers["backfire"] ) )
                bshouldreturnvalue( var_0 );
        }
        ...
        if ( scripts\mp\utility\game::getgametypenumlives() >= 1 )
        {
            ...
            var_27 = scripts\mp\utility\game::_id_12EDE();
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() && !level.multiteambased )
    {
        ...
        if ( var_28 > 3 && self.killedplayers.size == var_28 )
        {
            ...
            if ( var_30 )
                set_chopper_strafe_speed( var_0 );
        }
    }
...
{
    var_3 = scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) || scripts\mp\utility\weapon::router_placed( var_2 );
    var_4 = scripts\mp\utility\points::rooftop_crate_usefunc( var_0 );
    ...
    if ( var_3 && !var_4 )
    {
        if ( isdefined( var_2 ) && isdefined( var_2.streakinfo ) )
        {
            ...
            if ( isdefined( var_2.streakinfo.mpstreaksysteminfo ) )
            {
                ...
                if ( var_2.streakinfo.mpstreaksysteminfo.useweaponpickups != self getxuid() )
                    var_5 = 0;
            }
            ...
            if ( isdefined( var_2.streakinfo.streakname ) )
            {
                ...
                if ( isdefined( var_2.streakinfo.kills ) )
                {
                    ...
                    if ( !istrue( var_2.streakinfo.tomastrike_isflyingvehicle ) && var_2.streakinfo.kills > 1 )
                    {
                        scripts\cp\helicopter\chopper_boss::_id_11EFA( "t9_ch_global_scorestreak_kill_two_or_more_s1", 1 );
                        var_2.streakinfo.tomastrike_isflyingvehicle = 1;
                    }
                }
...
_id_11BB5( var_0 )
{
    var_1 = scripts\mp\killstreaks\killstreaks::omnvar_bit( var_0 );
...
risk_flagspawndebugobjicons( var_0, var_1 )
{
    var_2 = isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::nuke_triggermercywin() > gettime();
    var_3 = isdefined( var_0.radarstrength ) && var_0.radarstrength > 3 && !var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ghost" );
    var_4 = istrue( var_1.rpg_guys );
...
longshot( var_0 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "longshot" );
    ...
    if ( self.currentweapon hasattachment( "gunperk_acquisition_ch2" ) )
        thread scripts\mp\perks\perkfunctions::setacquisitionbonus();
}
...
pointblank( var_0 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "pointblank" );
...
headshot( var_0 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "headshot" );
...
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "avenger" );
...
assistedsuicide( var_0, var_1 )
{
    ...
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "assistedsuicide" );
...
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "defender" );
...
postdeathkill( var_0 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "posthumous" );
...
revenge( var_0, var_1 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "revenge" );
...
{
    if ( !isdefined( self.get_teaminquiry_alias ) )
        self.get_teaminquiry_alias = var_1;

    if ( var_1 < self.get_teaminquiry_alias )
        return;
    ...
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_node, var_0, var_1 );
...
firstblood( var_0 )
{
    ...
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "firstblood" );
...
buzzkill( var_0, var_1 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "buzzkill" );
...
comeback( var_0 )
{
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_0, "comeback" );
...
updaterecentkills( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.radarstrength ) && self.radarstrength > 3 && !var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ghost" ) )
    {
        if ( !isdefined( self.recentuavkills ) )
            self.recentuavkills = 1;
        else
            self.recentuavkills++;
    }
    ...
    if ( scripts\mp\utility\game::restartwrapper( var_1 ) )
    {
        ...
        if ( scripts\mp\utility\script::isnumbermultipleof( self._id_11D65, 3 ) )
            _id_12EA1( var_0 );
    }
    ...
    if ( !isdefined( self._id_11D68[var_2.basename] ) )
        self._id_11D68[var_2.basename] = 1;
    else
        self._id_11D68[var_2.basename]++;
    ...
    self._id_11D68 = undefined;
    self.tomastrike_isflyingvehicle = 0;
}

_id_13089( var_0, var_1, var_2 )
{
    if ( scripts\mp\utility\game::getgametype() != "br" )
        return;
    ...
    var_3.victim = var_2;
    var_3.spawnangle = 1;
    scripts\mp\gametypes\br_challenges.gsc::droppoint( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::droppoint( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::droppoint( "br_mastery_ghostRideWhip", var_3 );
}
...
bombdefused( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
        var_0 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "defuse", var_0.origin );

    if ( var_1 )
        scripts\mp\utility\game::spawn_chopper_carepackage( var_0, undefined, "Bomb Defused", var_0.origin, "last_alive" );
    else
        scripts\mp\utility\game::spawn_chopper_carepackage( var_0, undefined, "Bomb Defused", var_0.origin );
...
revivedplayer( var_0, var_1 )
{
    ...
    var_0 scripts\cp\helicopter\chopper_boss::_id_11EFA( "t9_ch_global_revived_teammate_for_operator_mission", 1 );
...
killeventtextpopup( var_0, var_1, var_2 )
{
    ...
    var_6._id_11BAF = 0;
    var_6._id_11BAE = 0;
    var_6.incomingremovedcallback = istrue( var_2 );
...
_id_11BB6()
{
    ...
    self.watch_everyone_entered_caves = 1;

    if ( !isdefined( self.splashpriorityqueue ) )
        self.watch_everyone_entered_caves = 0;
    ...
    foreach ( var_1 in self.splashpriorityqueue )
    {
        ...
        if ( !istrue( level.removekilleventsplash ) && istrue( var_1.showassplash ) && ( !self.watch_everyone_entered_caves || var_1.alwaysshowsplash ) )
        {
            var_2 = 1;
    ...
    foreach ( var_1 in self.splashpriorityqueue )
    {
        if ( var_1._id_11BAE || var_1.incomingremovedcallback )
            continue;
...
script_gameobjetname( var_0, var_1 )
{
...
respawncircleinterppct( var_0, var_1 )
{
...
end_nuke( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.shouldbekilledoff[var_1] ) )
        return;

    if ( self.pers["lethalEquipmentKillMask"] & level.shouldbekilledoff[var_1] )
        return;
    else
        self.pers["lethalEquipmentKillMask"] = self.pers["lethalEquipmentKillMask"] | level.shouldbekilledoff[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.shouldbekilledoff )
    {
...
end_leave_cave( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.playercleanupinfilondisconnect[var_1] ) )
        return;

    if ( self.pers["headshotLongshotMask"] & level.playercleanupinfilondisconnect[var_1] )
        return;
    else
        self.pers["headshotLongshotMask"] = self.pers["headshotLongshotMask"] | level.playercleanupinfilondisconnect[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.playercleanupinfilondisconnect )
    {
...
projectileimpactthermite()
{
    ...
    if ( self.try_to_punish_with_jugg == -1 )
        return;

    self.try_to_punish_with_jugg++;
    var_0 = undefined;
    ...
    if ( self.try_to_punish_with_jugg >= var_0 )
    {
...
enabledfeatures( var_0 )
{
    ...
    {
        self._id_11D7A = undefined;
        return;
    }

    if ( isplayer( var_0 ) && isdefined( self._id_11D7A ) )
    {
        if ( self.modifiers["mask2"] & 32768 )
            var_1 = 1;
    }

    level scripts\engine\utility::_id_13403( 1, "game_ended" );
    ...
    if ( level.gameended )
    {
        if ( var_1 )
        {
            ...
            if ( isdefined( self._id_11D7A ) )
                self._id_11D7A reportchallengeuserevent( "collect_item", "recon_drone_achievement" );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges.gsc::droppoint( "br_mastery_roundKillExecute", var_2 );
        }
    }
