...
forceexplosivedeath( var_0, var_1 )
{
...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::_id_12ED6( level.matchdata_logscoreevent, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( level.roundscorelimit > 1 && !istrue( level.dontendonscore ) )
    {
        ...
        {
            if ( level scripts\mp\utility\game::script_model_spawn_and_use( var_7 ) )
                continue;
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = destroy_vehicle_on_pilot_death( var_2 );

    if ( !istrue( var_4 ) )
        _id_11A83( var_9, var_2, level.waswinning );
...
playleadtakendialog( var_0 )
{
    ...
    level.lastscorestatustime = gettime();
    var_1 = destroy_vehicle_on_pilot_death( var_0 );
...
updateteamscore( var_0 )
{
    if ( scripts\mp\utility\game::script_model_spawn_and_use( var_0 ) )
        return;
