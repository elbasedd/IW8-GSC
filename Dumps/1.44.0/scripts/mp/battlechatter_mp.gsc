...
onplayerspawned()
{
    ...
    self.calculateobjectivesheld = 0;
    ...
    if ( !level.teambased || level.sceneangles || istrue( level.disablebattlechatter ) || scripts\mp\utility\game::isanymlgmatch() )
        self.bcdisabled = 1;
    else
    {
        if ( !scripts\mp\utility\game::runleanthreadmode() || istrue( level.clear_my_munition_slot ) )
        {
...
threatcallouttracking()
{
    ...
    for (;;)
    {
        ...
        var_4 = mine_caves_runner( self.team );
...
dosound( var_0, var_1 )
{
    ...
    {
        if ( isdefined( self.operatorcustomization.isplayerbrsquadleader ) && self.operatorcustomization.isplayerbrsquadleader != "" )
            var_2 = self.operatorcustomization.isplayerbrsquadleader;
        else
        {
            if ( self.operatorcustomization.isplatepouch == "none" )
                return;

            var_2 = var_2 + self.operatorcustomization.isplatepouch;
        }
    }
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        wam_sequence( var_6, var_7, var_0, var_5, var_4 );
    else if ( self issplitscreenplayer() )
        wam_timer_between_each_node( var_6, var_7, var_0, var_5, var_4 );
    else
        wam_pointer( var_6, var_7, var_0, var_5, var_4 );
    ...
    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        ...
        if ( soundexists( var_10 ) )
        {
            ...
            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                wam_sequence( 1, 1, var_11, undefined, var_10, var_12 );
            else if ( self issplitscreenplayer() )
                wam_timer_between_each_node( 1, 1, var_11, undefined, var_10, var_12 );
            else
                wam_pointer( 1, 1, var_11, undefined, var_10, var_12 );
        }
    }
    ...
    scripts\engine\utility::_id_133EF( var_4, "death_or_disconnect" );
    level removespeaker( self, var_14 );
    return 1;
}

wam_pointer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
wam_sequence( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
wam_timer_between_each_node( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
{
    var_2 = scripts\engine\utility::_id_133F7( var_0, "death_or_disconnect" );
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    if ( !isdefined( level.setnexthistorydestination ) )
        level.setnexthistorydestination = [];

    level.setnexthistorydestination[var_1] = var_2;
}
...
{
    if ( isdefined( level.setnexthistorydestination ) && isdefined( level.setnexthistorydestination[var_0] ) )
        return level.setnexthistorydestination[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.clear_my_munition_slot ) )
        return;
    ...
    if ( gettime() > var_0.calculateobjectivesheld + level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        var_0.bcinfoqueued = "none";
        var_0.calculateobjectivesheld = 0;
    }

    if ( comparesoundpriorities( var_1, var_0.bcinfoqueued ) )
    {
        var_0.bcinfoqueued = var_1;
        var_0.calculateobjectivesheld = gettime();
    }
    else
        return;
...
saylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    while ( var_0 <= level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        ...
        {
            var_5 = gettime();
            var_4["higher"]["player"] scripts\engine\utility::_id_133F0( var_4["higher"]["sound_alias"], "death", "disconnect" );
            waitframe();
