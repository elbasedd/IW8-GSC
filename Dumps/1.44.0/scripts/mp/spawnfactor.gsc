...
init_spawn_factors()
{
    ...
    registerfactor( "avoidCloseToDefenderFlag", ::brrebirth_brmayconsiderplayerdead, 1, [ "activeCarrierPosition", "defenderFlagPosition", "avoidDefenderFlagDeadZoneDistSq" ] );
    registerfactor( "avoidCloseToDefenderFlagSpawn", ::brrebirth_cleanupents, 1, [ "avoidDefenderFlagDeadZoneDistSq" ] );
    initfrontline();
}
...
{
    var_2 = var_0.scriptdata.hitbytrain;
