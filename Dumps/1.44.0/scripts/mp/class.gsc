...
init()
{
    ...
    else if ( scripts\mp\utility\game::ring() )
    {
...
deletesolospawnstruct( var_0, var_1, var_2 )
{
...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::mortars_fire_logic( var_0 );
}
...
_id_12B21( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    return _id_12B22( var_3, var_4 );
}

_id_12B22( var_0, var_1 )
{
    if ( var_0 == "none" )
        return 0;

    if ( !isdefined( level.carepackage_set_visible_model ) )
    {
        level.carepackage_set_visible_model = [];
        level.carepackage_set_visible_model["iw8_ar_tango21"] = [ 1 ];
        level.carepackage_set_visible_model["iw8_ar_mike4"] = [ 5 ];
        level.carepackage_set_visible_model["iw8_ar_kilo433"] = [ 3 ];
        level.carepackage_set_visible_model["iw8_ar_scharlie"] = [ 3 ];
        level.carepackage_set_visible_model["iw8_sm_uzulu"] = [ 4 ];
        level.carepackage_set_visible_model["iw8_sh_romeo870"] = [ 5 ];
        level.carepackage_set_visible_model["iw8_sh_dpapa12"] = [ 3 ];
        level.carepackage_set_visible_model["iw8_lm_mgolf34"] = [ 4 ];
        level.carepackage_set_visible_model["iw8_sn_kilo98"] = [ 16 ];
        level.carepackage_set_visible_model["iw8_sn_alpha50"] = [ 2 ];
        level.carepackage_set_visible_model["iw8_sn_hdromeo"] = [ 4 ];
        level.carepackage_set_visible_model["iw8_pi_golf21"] = [ 3 ];
        level.carepackage_set_visible_model["iw8_pi_cpapa"] = [ 15 ];
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.carepackage_set_visible_model[var_7] ) )
                        level.carepackage_set_visible_model[var_7] = [];

                    level.carepackage_set_visible_model[var_7][level.carepackage_set_visible_model[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.carepackage_set_visible_model[var_0] ) )
        var_10 = level.carepackage_set_visible_model[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::onteamproximitybecameinvalidplayer( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::_id_135A8( var_0, var_11 );
...
loadout_clearplayer( var_0 )
{
    ...
    scripts\mp\perks\perkpackage::vehicleoccupantdeathcustomcallback();
...
smokinggunclassindex( var_0 )
{
    ...
    if ( isdefined( var_0.soldier_agent_lwfn0 ) )
        var_1.soldier_agent_lwfn0 = var_0.soldier_agent_lwfn0;
    ...
    if ( isdefined( var_0.soldier_agent_lwfn1 ) )
        var_1.soldier_agent_lwfn1 = var_0.soldier_agent_lwfn1;
    ...
    var_1.riotshield_init_sp = var_0.riotshield_init_sp;
...
loadout_updateclasscustom( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < 10; var_3++ )
    {
        ...
        var_0.loadoutprimaryattachmentids[var_3] = deletesolospawnstruct( var_2, 0, var_3 );
    }
    ...
    for ( var_3 = 0; var_3 < 10; var_3++ )
    {
        ...
        var_0.loadoutsecondaryattachmentids[var_3] = deletesolospawnstruct( var_2, 1, var_3 );
    }
    ...
    var_0.loadoutaccessorylogic = deletesmokinggunhud();
    var_0.loadoutstreaksfilled = 1;
    ...
    foreach ( var_7 in var_0.loadoutprimaryattachments )
    {
        if ( var_7 != "none" )
            var_5++;
    }
    ...
    foreach ( var_7 in var_0.loadoutsecondaryattachments )
    {
        if ( var_7 != "none" )
            var_9++;
    }

    var_12 = int( tablelookup( "mp/statstable.csv", 4, var_0.loadoutprimary, 18 ) );

    if ( var_12 < var_5 )
    {
        for ( var_3 = 0; var_3 < 10; var_3++ )
        {
            var_0.loadoutprimaryattachments[var_3] = "none";
            var_0.loadoutprimaryattachmentids[var_3] = 0;
        }
    }

    var_12 = int( tablelookup( "mp/statstable.csv", 4, var_0.loadoutsecondary, 18 ) );

    if ( var_12 < var_9 )
    {
        for ( var_3 = 0; var_3 < 10; var_3++ )
        {
            var_0.loadoutsecondaryattachments[var_3] = "none";
            var_0.loadoutsecondaryattachmentids[var_3] = 0;
        }
    }
}
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.soldier_agent_lwfn0 = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.soldier_agent_lwfn1 = var_3["loadoutSecondaryAddBlueprintAttachments"];
    ...
    var_0.sol_3_4_pool = isdefined( var_3["loadoutExtraPerks"] );
    ...
    if ( !var_4 )
    {
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 10; var_5++ )
            {
                ...
                var_0.loadoutprimaryattachmentids[var_5] = deletesolospawnstruct( var_2, 0, var_5 );
            }
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 10; var_5++ )
            {
                ...
                var_0.loadoutsecondaryattachmentids[var_5] = deletesolospawnstruct( var_2, 1, var_5 );
            }
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.soldier_agent_lwfn0 = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.soldier_agent_lwfn1 = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        ...
        scripts\mp\utility\script::handle_train_veh_collision( "loadout_updateClassDefault() called on " + var_3 + " with invalid class = " + var_4 );
    }

    if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        sniper_laser_is_on( var_0 );
    else
        sniper_init( var_0, var_2 );
...
sniper_laser_is_on( var_0 )
{
    if ( !isdefined( self.player_xp ) )
    {
        if ( !isdefined( level.player_xp ) )
        {
            var_1 = randomint( 200 );
            level.player_xp = var_1;
            level.playerapplyjumpvelocity = var_1;
        }
        else
        {
            level.player_xp++;
            level.playerapplyjumpvelocity++;
        }

        self.player_xp = level.player_xp;
        self.playerapplyjumpvelocity = level.playerapplyjumpvelocity;
    }

    var_2 = sniper_death_watcher( self.player_xp, 1 );
    var_3 = sniper_death_watcher( self.playerapplyjumpvelocity, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
sniper_death_watcher( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_6.variantid == 0 || var_6.rpg_shoot_at_trigs || !isdefined( var_6.attachcustomtoidmap ) )
                continue;

            if ( var_4 && isdefined( var_6.retreat_vehicle_collision_clear ) && !var_6.retreat_vehicle_collision_clear )
                continue;
...
loadout_updateclass( var_0, var_1 )
{
    ...
    if ( !isbot( self ) && isdefined( level.pitcher_lights ) && level.pitcher_lights )
        sniper_laser_should_turn_on( var_0 );
    else
        loadout_updateclassfinalweapons( var_0 );

    if ( isdefined( level.supportbox_updateheadicononjointeam ) )
        self [[ level.supportbox_updateheadicononjointeam ]]( var_0 );
...
loadout_updateclassfistweapons( var_0 )
{
    if ( isdefined( level.pitcher_lights ) && level.pitcher_lights && issameweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimary = var_0.loadoutprimary;
    else if ( var_0.loadoutprimary == "none" )
        var_0.loadoutprimary = "iw8_fists";

    if ( scripts\mp\utility\game::extractlocale_islocaleavailable() )
    {
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.soldier_agent_lwfn0 ) )
        var_0.loadoutprimaryobject = delay_show_marker_to_tv_station( var_0.loadoutprimary, var_0.loadoutprimaryattachments, var_0.loadoutprimarycamo, var_0.loadoutprimaryreticle, var_0.loadoutprimaryvariantid, var_0.loadoutprimaryattachmentids, var_0.loadoutprimarycosmeticattachment, var_0.loadoutprimarystickers, istrue( var_0.loadouthasnvg ) );
    else
    ...
    {
        if ( istrue( var_0.soldier_agent_lwfn1 ) )
            var_0.loadoutsecondaryobject = delay_show_marker_to_tv_station( var_0.loadoutsecondary, var_0.loadoutsecondaryattachments, var_0.loadoutsecondarycamo, var_0.loadoutsecondaryreticle, var_0.loadoutsecondaryvariantid, var_0.loadoutsecondaryattachmentids, var_0.loadoutsecondarycosmeticattachment, var_0.loadoutsecondarystickers, istrue( var_0.loadouthasnvg ) );
        else
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    snapshot_crate_use( var_0, var_7, var_8, var_4, var_5, var_6 );
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = snapshot_crate_player_at_max_ammo( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = snapshot_crate_player_at_max_ammo( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
snapshot_crate_player_at_max_ammo( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.propminigamesetting ) )
        {
...
snapshot_crate_use( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.player_infil_already_played = var_8 hasattachment( "maxammo" );

    if ( isdefined( level.supersbyextraweapon ) )
        self [[ level.supersbyextraweapon ]]( var_6 );
    ...
    else
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.player_infil_already_played ) )
            {
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.player_infil_already_played ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.player_infil_already_played ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::respawnplayers( var_8 ) )
...
loadout_updateplayernvgs()
{
    ...
    if ( istrue( self.inspawncamera ) )
        scripts\engine\utility::_id_133EF( "spawned_player", "fadeUp_start" );
...
snapshot_crate_spawn( var_0 )
{
    var_1 = getdvarint( "scr_t9_watch_suppression", 0 );

    if ( var_1 && isdefined( var_0.loadoutaccessorydata ) )
    {
        var_2 = scripts\mp\accessories::mortars_fire_projectile( var_0.loadoutaccessorydata );
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::saw_2_origin() )
    {
        var_2 = 0;
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            self.loadoutfieldupgrade1 = lb_impulse_dmg_threshold_low( self.loadoutfieldupgrade1 );
            self.loadoutfieldupgrade2 = lb_impulse_dmg_threshold_low( self.loadoutfieldupgrade2 );
        ...
        {
            var_3 = lb_dmg_factor_fuselage( self.loadoutfieldupgrade1 );
    ...
    {
        self.so_endgame = lb_dmg_factor_fuselage( self.loadoutfieldupgrade1 );
...
swaploadout()
{
    ...
    var_0 = scripts\mp\utility\game::rotate_silo_gyro_lights() && !scripts\mp\flags::gameflag( "prematch_done" );

    if ( var_0 && isdefined( level.bot_killstreak_setup_func ) )
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = snapplayertotoppos();
    var_5 = sniper_laser_vfx( var_5, var_1 );
    self.pathdist = var_5;
    var_6 = undefined;
...
loadout_lognewlygivenloadout( var_0, var_1, var_2 )
{
    ...
    if ( var_8 == -1 || var_1.riotshield_init_sp )
    {
...
scn_infil_tango_npc_5_sfx( var_0 )
{
...
_id_12D4E()
{
    if ( !istrue( self.unset_relic_oneclip ) )
    {
        ...
        if ( !nullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && scn_infil_tango_npc_5_sfx( var_0 ) )
            self.unset_relic_oneclip = 1;
    }
}
...
_id_12D50()
{
    self._id_11FF6 = undefined;
    self._id_11FF5 = undefined;
...
_id_12D49( var_0 )
{
    ...
    childthread _id_12D48();

    if ( isdefined( var_0 ) )
        self._id_13481 = var_0;
    else if ( !isdefined( self._id_13481 ) )
        self._id_13481 = 0;
    ...
    while ( scripts\mp\riotshield::riotshield_hasweapon() )
    {
        ...
        if ( !istrue( self.inlaststand ) )
        {
            if ( self._id_13481 )
            {
                self.setspecialistbonus = 1;
                self.setsuperexpended = gettime() + 1000;
            }
            else if ( isdefined( self.setsuperexpended ) && gettime() >= self.setsuperexpended )
            {
                self.setspecialistbonus = undefined;
                self.setsuperexpended = undefined;
            }
        ...
        if ( self isonladder() )
            ...
            _id_12D4B();
        else if ( istrue( self.setspecialistbonus ) )
            _id_12D4B();
        else if ( istrue( self.unset_relic_oneclip ) )
        {
...
delay_show_marker_to_tv_station( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::brevent1playerthink( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::brevent1playervalid( var_14 );
...
delay_show_balloon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    {
        var_6 = lb_dmg_factor_main_rotor( var_6 );
        var_12[var_6] = 0;
    }
    ...
    if ( !isdefined( var_9 ) || var_9 == "" )
        scripts\mp\utility\script::handle_train_veh_collision( "buildWeapon - bad weaponAssetName - rootName: " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant: " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );

    var_13 = getcompleteweaponname( var_9, [], undefined, var_2, var_4 );

    if ( isdefined( var_9 ) && !isdefined( var_13 ) )
        scripts\mp\utility\script::handle_train_veh_collision( "buildWeapon - null weapon: weaponAssetName = " + var_9 + ", rootName = " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant = " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );
...
lb_dmg_factor_main_rotor( var_0 )
{
    switch ( var_0 )
    {
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && rewardmodifier( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( savedangles( var_19 ) || sat_wait_for_transmission_start( var_20 ) ) )
            var_12 = 1;
    }
...
sat_wait_for_transmission_start( var_0 )
{
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        else if ( istrue( level.play_hud_reminder_vo ) && scripts\mp\utility\game::getgametype() == "infect" && var_0.team == "axis" )
            var_0 _meth_87A8( "zombie" );
        else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 _meth_87A8( "female" );
        else
        ...
        if ( isdefined( var_0.updateexpiredlootleader ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0.updateexpiredlootleader stoploopsound( self.updatefobindanger );
            var_0.updateexpiredlootleader delete();
            var_0.updateexpiredlootleader = undefined;
            var_0.updatefobindanger = undefined;
        }
...
resetfunctionality()
{
    ...
    scripts\cp_mp\vehicles\vehicle_occupancy::_id_13239( self, 1 );
    ...
    scripts\mp\equipment\molotov::tablettype();
    scripts\mp\equipment\throwing_knife_mp::_id_12C5B();
    scripts\mp\equipment\flash_grenade::clearflash( 1 );
    scripts\mp\equipment\gas_grenade::gas_clear( 1 );

    if ( !isagent( self ) )
    {
        scripts\mp\utility\player::playerstreamhintlocation();
    ...
    scripts\cp_mp\utility\player_utility::x1spyplane();
}
...
updateinstantclassswapallowed()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_0 = scripts\mp\gamelogic::disablewinonscore( scripts\mp\utility\game::onfieldupgradeendbuffer() );
...
_id_13088()
{
    ...
    if ( scripts\mp\gamelogic::disablewinonscore( scripts\mp\utility\game::onfieldupgradeendbuffer() ) )
    {
        while ( scripts\mp\utility\game::runextractreroll( self ) )
            waitframe();
...
copyclassfornextlife( var_0 )
{
    ...
    thread addglobalbattlepassxpmultiplier();
    var_1 = undefined;
    ...
    self.pers["copiedClass"] = smokinggunclassindex( var_1 );
...
smuggler_post_tele_kill( var_0, var_1 )
{
    var_0.loadoutsuper = var_1.loadoutsuper;
...
spawnammocountoverride_giveweaponammo( var_0, var_1, var_2 )
{
    ...
    if ( var_4 && !run_blima_exfil_sequence( var_0 ) )
    {
        var_5 = 0;
        var_6 = 0;
...
{
    var_1 = scripts\mp\utility\weapon::isknifeonly( var_0.basename ) || scripts\mp\utility\weapon::respawns_on_failed_unload( var_0.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_0.basename ) || scripts\mp\utility\weapon::run_and_stop_group_after( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename );
    return var_1;
}
