...
init()
{
    ...
    level.display_mission_failed_text = scripts\mp\utility\game::getgametype() == "br" && getdvarint( "scr_log_br_weapon_stats", 0 ) == 1;
    level.stadiumpuzzleactive = ::onmatchstart;
    level.stage = ::onroundend;
    level.stack_patch_waittill_leaf = ::logkillstreakevent;
    level.stack_patch_waittill_context_patch = ::loggameevent;
    level.stack_patch_waittill_context = ::logattackerkillevent;
    level.stadium_puzzle = ::logvictimkillevent;
    level.stack_patch_waittill_node = ::logmultikill;
    level.stadium_one_death_func = ::logplayerlife;
    level.stack_patch_waittill_stack = ::logplayerdeath;
    level.stack_patch_waittill_root = ::logplayerdata;
    level.matchdata_logscoreevent = ::logscoreevent;
    level.stage1accradius = ::_id_11D88;
    level.stadium_three_death_func = ::logweaponstat;
    level.stack_patch_thread_root = ::logattachmentstat;
    level.stack_patch_thread_leaf = ::buildweaponrootlist;
    level.stack_patch_waittill_context_far_patch = ::logchallenge;
    level.stack_patch_waittill_context_far = ::logaward;
...
onmatchstart()
{
    ...
    if ( var_0 == "br" )
        var_1 = level.completesmokinggunquest.name;
    ...
    if ( var_0 == "br" )
        scripts\common\utility::_id_12ED6( level.stack_patch_thread );
...
logplayerdeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isvalidclient( var_1 ) )
    {
        ...
        var_16 = scripts\mp\utility\weapon::onteamproximitysteppedfar( var_7 );
        var_17 = var_1;
        ...
        var_24 = var_1 temp_debug_wait_and_stop_music_loop();
        var_25 = var_1.origin;
        var_26 = var_1.angles;
    ...
    if ( isdefined( self.lastweaponused ) )
    {
        ...
        var_35 = scripts\mp\utility\weapon::onteamproximitysteppedfar( var_32 );
    ...
    var_39 = temp_debug_wait_and_stop_music_loop();
    var_40 = -1;
...
spawn_exfil_juggs( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "arm" && isdefined( self.platform_array ) )
    {
        var_36["press_rclick"] = istrue( self.platform_array["rightmouseup"] );
        var_36["press_lclick"] = istrue( self.platform_array["leftmouseup"] );
        var_36["press_activate"] = istrue( self.platform_array["activate"] );
        var_36["press_gostand"] = istrue( self.platform_array["gostand"] );
    }
...
logplayerdata( var_0 )
{
    ...
    {
        var_2 = scripts\mp\rank::get_players_not_targeted_by_other_battle_station( self );
        scripts\mp\rank::get_positions_around_vector( self.get_power_name_in_slot, var_2 );
    }
    ...
    foreach ( var_23, var_6 in self.pers["matchdataWeaponStats"] )
    {
        ...
        self dlog_recordplayerevent( "dlog_event_player_weapon_stats_br", [ "weapon", var_6.weapon, "variant_id", var_6.variantid, "from_loadout", var_19, "died", var_20, "time_used_s", var_22, "longest_hit_distance", var_21, "deaths", var_9, "headshots", var_10, "hits", var_11, "kills", var_12, "shots", var_13, "damage", var_14, "attachment_0", var_6.attachments[0], "attachment_1", var_6.attachments[1], "attachment_2", var_6.attachments[2], "attachment_3", var_6.attachments[3], "attachment_4", var_6.attachments[4], "sticker_0", var_6._id_12A0C[0], "sticker_1", var_6._id_12A0C[1], "sticker_2", var_6._id_12A0C[2], "sticker_3", var_6._id_12A0C[3], "reticle", var_6.reticle, "cosmetic_attachment", var_6.garbage_bin_clip, "camo", var_6.camo, "match_time_created_s", var_6.pickuptime ] );
    }
}
...
logweaponstat( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && !istrue( level.display_mission_failed_text ) )
        return;
    ...
    {
        if ( !end_loop_emp_spark_vfx( var_4, var_5 ) )
        {
            var_6 = 1;
            var_7 = var_5 + "_" + var_6;
            ...
            for (;;)
            {
                if ( !isdefined( self.pers["matchdataWeaponStats"][var_7] ) || end_loop_emp_spark_vfx( var_4, var_7 ) )
                    break;
    ...
    if ( !isdefined( self.pers["matchdataWeaponStats"][var_5] ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && isdefined( var_4 ) )
        {
            ...
            self.pers["matchdataWeaponStats"][var_5].garbage_bin_clip = var_9;
            ...
            self.pers["matchdataWeaponStats"][var_5]._id_12A0C = var_18;
        }
    }
...
end_loop_emp_spark_vfx( var_0, var_1 )
{
    ...
    if ( var_3 != self.pers["matchdataWeaponStats"][var_1].garbage_bin_clip )
        return 0;
    ...
    if ( var_7.size != self.pers["matchdataWeaponStats"][var_1]._id_12A0C.size )
        return 0;

    for ( var_6 = 0; var_6 < var_7.size; var_6++ )
    {
        if ( var_7[var_6] != self.pers["matchdataWeaponStats"][var_1]._id_12A0C[var_6] )
            return 0;
    }
