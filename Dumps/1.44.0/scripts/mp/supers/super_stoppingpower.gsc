...
_id_12A48()
{
    level.update_health_on_spawn scripts\mp\trials\trial_target_utility::determinetrackingcircleoffset( ::_id_12A4E, level );
    level.update_health_think scripts\mp\trials\trial_target_utility::determinetrackingcircleoffset( ::_id_12A4F, level );
}
...
stoppingpower_beginuse()
{
    ...
    if ( !scripts\mp\weapons::isnormallastweapon( var_0 ) || scripts\mp\utility\weapon::ismeleeonly( var_0 ) || scripts\mp\utility\weapon::isgamemodeweapon( var_0 ) || scripts\mp\utility\weapon::issinglehitweapon( var_0.basename ) || !_id_12A4B( var_0 ) || _id_12A49( var_0 ) )
    {
    ...
    {
        var_8 = scripts\mp\utility\weapon::respawnplayers( var_7 );
        ...
        if ( isnullweapon( var_7, var_0, 0 ) )
        {
            ...
            if ( 1 )
            {
                if ( var_8 )
                {
                    ...
                    var_11 = var_9 + var_4;
                    var_12 = int( min( _id_12A45( var_7, var_11 ), var_11 + var_10 ) );
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var_16 = var_15 - var_4;
                            scripts\mp\gametypes\br_weapons.gsc::clean_up_combat_action( var_7, var_16 );
                        }
                        else
    ...
    thread _id_12A51( var_0, var_4, var_5 );
    return 1;
}

_id_12A45( var_0, var_1 )
{
    var_2 = var_0.maxammo;
...
_id_12A4B( var_0 )
{
    ...
    return scripts\mp\weapons::restorekillstreakplayerangles( var_1 );
}
...
{
    var_3 = get_id_based_on_task( var_0, var_1, var_2 );
    _id_12A47( var_0, var_3 );
}

get_id_based_on_task( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
    var_3.player = var_0;
...
_id_12A47( var_0, var_1 )
{
    ...
    var_1 thread _id_12A43();
    var_1 thread _id_12A44();
...
_id_12A4E( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) )
        return;

    var_3 = var_1 _id_12A46( var_2 );

    if ( isdefined( var_3 ) )
    {
        var_4 = get_id_based_on_task( var_3.player, var_3.objweapon, var_3.rounds );
        var_0.hcrdata = var_4;
        var_3 thread stoppingpower_removehcr();
    }
}

_id_12A4F( var_0, var_1, var_2 )
{
    var_3 = var_0.hcrdata;
...
stoppingpower_watchhcrweaponchange()
{
    ...
    {
        if ( _id_12A4A( self.player getcurrentweapon() ) )
        {
            if ( !self.gavehcr )
            {
...
stoppingpower_watchhcrweaponfire()
{
    ...
    self.player thread _id_12A50( self.objweapon );
    thread stoppingpower_removehcr();
}
...
_id_12A50( var_0 )
{
    ...
    self.setheadicon_addclienttomask = 1;
    scripts\engine\utility::_id_1340A( 2, "weapon_fired", "weapon_change" );
    self.setheadicon_addclienttomask = undefined;
}
...
_id_12A42()
{
    if ( isdefined( self.player.hcrdata ) )
    {
        ...
        self.player scripts\cp\helicopter\chopper_boss::unlink_on_ai_death( "super_support_box", self.kills );
...
_id_12A4D( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            scripts\cp\helicopter\chopper_boss::unsetspecialistbonus();
            var_2.kills++;
        }
    }
}
...
stoppingpower_givefastreload()
{
    ...
    self.player scripts\engine\utility::_id_133F0( "weapon_fired", "weapon_change", "stoppingPower_removeHCR" );
