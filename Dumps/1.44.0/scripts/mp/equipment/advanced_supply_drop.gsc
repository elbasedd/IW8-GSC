...
advanced_supply_drop_marker_used( var_0 )
{
    ...
    var_1 thread seq3_warning_room_b( var_0 );
    var_1 thread area1_targets_mount( var_0 );
    var_0 waittill( "explode", var_2 );
    var_1 notify( "advanced_supply_drop_finished" );
    thread area1_targets( var_2 );
    ...
    var_3 = scripts\mp\gametypes\br_rewards.gsc::nearby_ai_investigate_grenade( 0, 1, 0, 0, 0 );
    var_1 scripts\mp\gametypes\br_rewards.gsc::_id_127C5( var_2, var_3 );
...
area_structs( var_0 )
{
    ...
    if ( isdefined( level._id_12BF4 ) )
        level thread _id_12BCB( var_1, var_0 );
    ...
    if ( isdefined( level._id_12BF5 ) && isdefined( level._id_12BF5[var_1.team] ) )
    {
        if ( isdefined( var_0 ) )
            var_0 delete();
    ...
    var_8 = scripts\mp\gametypes\br_gametype_truckwar.gsc::_id_132C9( var_3 );

    if ( isdefined( var_8 ) )
    {
        if ( getdvar( "scr_br_gametype", "" ) == "truckwar" )
            scripts\mp\gametypes\br_gametype_truckwar.gsc::registerhandlecommand( var_8, var_1.team, 1 );

        level thread scripts\mp\gametypes\br_gametype_truckwar.gsc::_id_12EB3( var_8, var_7, var_8.angles, 1 );
    }
...
are_relics_active( var_0 )
{
    ...
    if ( istrue( self.risk_flagspawncountchange ) || isdefined( var_4 ) && distance2d( var_2, var_4.origin ) < 5000 )
        var_3 = 10000;
    ...
    if ( isdefined( var_7 ) )
        var_7 thread playerexitcombatareamessage( self );
