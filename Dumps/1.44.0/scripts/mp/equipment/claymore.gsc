...
claymore_use( var_0 )
{
    ...
    if ( wave_ai_debug() )
    {
        ...
        var_1.contents = get_current_bush_zone();
    }
        ...
        foreach ( var_3 in var_1 )
        {
            if ( isdefined( var_3.classname ) )
            {
                ...
                if ( var_3.classname == "agent" || var_3.classname == "player" )
                {
                    ...
                    if ( var_3 scripts\mp\gametypes\br_public.gsc::zombie() )
                        continue;
...
claymore_modifieddamage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( isdefined( self.extractplunderheliinvulnerable ) )
        {
            foreach ( var_6 in self.extractplunderheliinvulnerable )
            {
    ...
    else if ( var_1 == getcompleteweaponname( "claymore_radial_mp" ) )
    {
        ...
        thread extractlocale_onentergulag( var_2 );
    }
    else
        return var_4;
    ...
    if ( isdefined( var_2.hasmaxammo ) )
    {
        var_14 = isdefined( var_2.owner ) && var_2.hasmaxammo == var_2.owner;
        var_15 = var_2.hasmaxammo == var_0;
...
extractlocale_onentergulag( var_0 )
{
    ...
    if ( !isdefined( self.extractplunderheliinvulnerable ) )
        self.extractplunderheliinvulnerable = [];

    self.extractplunderheliinvulnerable[self.extractplunderheliinvulnerable.size] = var_0;
    waittillframeend;
    self.extractplunderheliinvulnerable = undefined;
}
