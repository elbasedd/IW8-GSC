...
snapshot_grenade_watch_flight( var_0 )
{
    ...
    if ( istrue( var_1._id_12CFA ) )
        var_1 thread isbecomingzombie();
    ...
    if ( var_8 > 0 )
    {
        ...
        if ( isdefined( var_1.setplacementstats ) )
        {
            var_5 = scripts\mp\vehicles\vehicle_compass_mp::reset_attack_next_available_time( var_1.setplacementstats );

            if ( var_5 )
                var_4 linkto( var_1.setplacementstats );
        }
        ...
        var_1 childthread scripts\mp\utility\equipment::_id_13489();
        var_1 scripts\engine\utility::_id_13403( var_11, "collision_with_platform" );
    }
    else
    {
        var_4.angles = var_9;
...
_id_125F8( var_0, var_1, var_2 )
{
    ...
    if ( 1 )
    {
        var_3 = scripts\mp\utility\game::rotate_silo_gyro_lights();
...
armorbox_used( var_0, var_1 )
{
    var_2 = armorbox_usedcallback( var_0, var_1 );
    var_3 = [];
    var_4 = var_1 * var_1;
