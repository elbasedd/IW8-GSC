...
trophy_deploy()
{
    ...
    thread trophy_watchprotection( 45, 105625, ::_id_12EA9, ::trophy_protectionsuccessful );
    thread _id_12EAC();
...
trophy_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::unlink_on_ai_death( "super_trophy", self.usedcount, var_0, var_2 );
    ...
    while ( [[ var_2 ]]() )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_11 )
            {
                ...
                if ( var_12 scripts\cp_mp\vehicles\vehicle::isvehicle() && isdefined( var_12._id_12EC4 ) && isdefined( var_10.team ) && var_12._id_12EC4 == var_10.team )
                    continue;
            }
            else if ( var_9 == self )
                continue;
...
trophy_protectionsuccessful( var_0 )
{
    ...
    self.owner scripts\mp\supers::force_kill_off_other_ai( "super_trophy" );
    self.usedcount++;
    var_1 = var_0.origin;
    spawn_exfil_techo( var_0 );
    _id_12EA5( var_0 );
...
_id_12EA5( var_0 )
{
    ...
    _id_12EAA( var_0, var_0.owner, self.owner );
...
_id_12EAA( var_0, var_1, var_2 )
{
    ...
    var_3 = var_2;
    var_4 = var_1.origin;
    var_5 = scripts\mp\equipment\snapshot_grenade::_id_125F9( var_3, var_4 );
    scripts\mp\equipment\snapshot_grenade::_id_125F8( var_1, var_2, var_5 );
}
...
spawn_exfil_techo( var_0 )
{
    ...
    if ( !isdefined( self.handleimpact ) )
        return;

    getentitylessscriptablearray( "dlog_event_trophy_successful", [ "deploying_player", self.handleimpact, "grenade_owner", var_0.owner, "negated_target", var_0.weapon_name ] );
}
