...
molotov_init()
{
    var_0 = spawnstruct();
    level.molotov = var_0;
    var_0.start_mode_after_playerspawn = getdvarint( "scr_molotovMaxPools", 100 );
    var_0.start_drones_event = getdvarint( "scr_molotovMaxCastsPerFrame", 8 );
    var_0.printallteamsplundercount = getdvarint( "scr_molotovInstantCleanup", 1 ) > 0;
    var_0._id_12FC3 = 0;
    var_0._id_11AFA = [];
    var_0.scriptables = [];
    var_0.triggers = [];
...
molotov_used( var_0 )
{
    ...
    if ( isdefined( level._id_1249F ) && [[ level._id_1249F.hudextractnum ]]( var_0 ) )
    {
        thread scripts\mp\weapons::_id_125E9( var_0.origin );
    ...
    {
        if ( isdefined( level.lootchopper_createobjective ) )
            [[ level.lootchopper_createobjective ]]( var_0, self );
...
molotov_stuck_player( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !isdefined( level._id_1249F ) || ![[ level._id_1249F.enabledminimapdisable ]]( var_1 ) )
    ...
    if ( !isdefined( level._id_1249F ) || ![[ level._id_1249F.enabledskipdeathshield ]]( var_1 ) )
    {
        var_3 = var_3 * ( 0, 0, 1 );
        var_4 = var_0.origin;
        var_5 = ( 0, 0, -1 );
...
molotov_simulate_impact( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_22 = molotov_create_branch( var_18, var_20, var_21, undefined, var_13, var_34, var_3, 0, var_26, var_27 );
    var_18.branches[var_18.branches.size] = var_22;
    taccovertriggerblockers( var_18 );
...
tacinsert_brrespawnsplash( var_0 )
{
    ...
    if ( var_1.scriptables.size > var_1.start_mode_after_playerspawn )
...
tacinsert_cachespawnposition( var_0 )
{
    ...
    if ( var_1.triggers.size > var_1.start_mode_after_playerspawn )
        tac_cover_give_new();
}
...
tac_cover_spawn_with_door()
{
    ...
    if ( !isdefined( var_1 ) )
        var_0._id_11AFA = scripts\engine\utility::array_remove( var_0._id_11AFA, self.id );
...
tac_cover_get_stuck_to_ent( var_0 )
{
    ...
    foreach ( var_3 in var_1._id_11AFA )
    {
    ...
    var_0 = istrue( var_0 ) || var_1.printallteamsplundercount;

    if ( !isdefined( var_2 ) )
        tac_cover_on_destroyed_by_mover( var_3, var_0 );
}

tac_cover_give_new( var_0 )
{
    var_1 = tac_rover_initcollision();
    var_2 = undefined;
    var_3 = undefined;
...
tac_cover_on_destroyed_by_mover( var_0, var_1 )
{
    var_2 = tac_rover_initcollision();
    ...
    if ( isdefined( var_3 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            var_2._id_11AFA = scripts\engine\utility::array_remove( var_2._id_11AFA, var_0 );
            var_3 thread molotov_pool_end();
            return;
        }

        var_3 thread tac_cover_spawn_with_door();
    }

    var_4 = var_2.triggers[var_0];

    if ( isdefined( var_4 ) )
        var_4 thread tac_rover();
}

table_parseweaponvariantidvalue( var_0 )
{
    ...
    if ( var_1.caststhisframe >= var_1.start_drones_event )
        return 0;
...
tacinsert_deleteontoofar()
{
    ...
    if ( !isdefined( var_0.tut_bot_nameplate ) )
        var_0.tut_bot_nameplate = [];
    ...
    foreach ( var_2 in self.branches )
    {
        ...
        {
            if ( isdefined( var_4 ) )
                var_0.tut_bot_nameplate[var_0.tut_bot_nameplate.size] = var_4;
        }
    }
}
...
molotov_start_branch()
{
    ...
    else
    {
        ...
        for (;;)
        {
            ...
            if ( !table_parseweaponvariantidvalue( self.shareddata ) )
            {
                waitframe();
                continue;
            }
...
{
    taccovertriggerblockers( self.shareddata );
    self.casts++;
...
molotov_create_pool( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_11 thread tacinsert_destroyuselistener();
    return var_11;
}
...
molotov_branch_create_pool( var_0, var_1, var_2 )
{
    ...
    var_7.id = tac_rover_initomnvars();
    var_7 tacinsert_brrespawnsplash( self.shareddata );
    return var_7;
}
...
molotov_pool_start()
{
    ...
    if ( isdefined( self ) )
        ...
        level thread taccover_timeout( var_1, var_0 );
}
...
taccover_timeout( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
        var_0 thread tac_rover();
    ...
    if ( !isdefined( var_0 ) )
        var_2._id_11AFA = scripts\engine\utility::array_remove( var_2._id_11AFA, var_1 );
}

tacinsert_destroyuselistener()
{
    self endon( "death" );
...
molotov_create_pool_trigger( var_0, var_1, var_2 )
{
    ...
    var_4 tacinsert_cachespawnposition();
    return var_4;
}
...
molotov_watch_pool_trigger_enter()
{
    ...
    for (;;)
    {
        ...
        if ( !isplayer( var_0 ) && !istrue( var_0.blueprintextractspawns ) )
            continue;
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_13404( 7, "disconnect", "joined_team" );
    var_0 delete();
}
...
{
    var_0 = tac_rover_initcollision();
    var_1 = var_0._id_12FC3;
    var_0._id_12FC3++;
    var_0._id_11AFA = scripts\engine\utility::array_add( var_0._id_11AFA, var_1 );
    return var_1;
}

molotov_get_cast_data( var_0 )
{
    var_1 = tac_rover_horn();
    var_2 = spawnstruct();
...
molotov_start_burning( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level._id_1249F ) && [[ level._id_1249F.enabledminimapdisable ]]( self ) )
        return;
...
tabletreplacefrequency( var_0, var_1 )
{
    if ( isdefined( var_0.shareddata ) )
    {
        if ( isdefined( var_0.shareddata.branches ) )
        {
            foreach ( var_3 in var_0.shareddata.branches )
                tabletreplace( var_3, var_1 );
        }

        if ( isdefined( var_0.shareddata.tut_bot_nameplate ) )
        {
            foreach ( var_6 in var_0.shareddata.tut_bot_nameplate )
            {
                if ( isdefined( var_6 ) )
