...
ammobox_init()
{
    level.binoculars_used = [];
    scripts\common\interactive::interactive_addusedcallback( ::ammobox_usedcallback, "equip_ammo_box" );
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::bonus_target_domage );
    ...
    {
        bomber_spawner( "weapon_sniper", var_0 );
        bomber_spawner( "weapon_sniper", var_0 );
        bomber_spawner( "weapon_sniper", var_0 );
        bomber_spawner( "weapon_sniper", var_0 );
        bomber_spawner( "weapon_sniper", var_0 );
    ...
    {
        bomber_spawner( "weapon_assault", var_0 );
        bomber_spawner( "weapon_assault", var_0 );
        bomber_spawner( "weapon_smg", var_0 );
        bomber_spawner( "weapon_smg", var_0 );
        bomber_spawner( "weapon_lmg", var_0 );
        bomber_spawner( "weapon_lmg", var_0 );
        bomber_spawner( "weapon_sniper", var_0 );
        bomber_spawner( "weapon_dmr", var_0 );
        bomber_spawner( "weapon_shotgun", var_0 );
        bomber_spawner( "weapon_pistol", var_0 );
...
{
    var_2 = scripts\mp\utility\weapon::old_load_hvt( var_0 );
    bomber_spawns( var_2, var_1 );
}

bonus_target_domage( var_0 )
{
    foreach ( var_2 in level.binoculars_used )
    {
        if ( isdefined( var_2 ) )
            var_2 scripts\mp\equipment\support_box::_id_12AEC( var_0 );
    }
}
...
ammobox_settled( var_0 )
{
    ...
    level.binoculars_used[var_0 getentitynumber()] = var_0;
...
ammobox_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::unlink_on_ai_death( "super_weapon_drop", self.usedcount, var_0, var_2 );
    ...
    foreach ( var_1 in self.playersused )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) && isdefined( self.playersused[var_2] ) )
            {
                ...
                scripts\mp\equipment\support_box::_id_12AEC( var_1 );
            }
        }
    }
}
...
bombzone_is_active( var_0 )
{
    ...
    if ( isdefined( level.update_health_value_for_special_cases ) )
        var_0 [[ level.update_health_value_for_special_cases ]]( var_2 );
...
{
    if ( !isdefined( var_0.defuse_spawners ) )
    {
        var_1 = spawnstruct();
        var_1.buffered = undefined;
        var_1.last = undefined;
        var_1.breaker = undefined;
        var_1.brevent4 = undefined;
        var_1.brevent3 = undefined;
        var_0.defuse_spawners = var_1;
    }

    return var_0.defuse_spawners;
}
...
bombpuzzle_setup_marker_vfx( var_0 )
{
    var_1 = ammobox_getbufferedplayerdata( var_0 );

    if ( !isdefined( var_1.breaker ) )
    {
        ...
        if ( !bomber_vip_wait_to_engage( var_2 ) )
            return undefined;

        if ( !bomber_think( var_2 ) )
            return undefined;
...
bombs_setup( var_0 )
{
    bomber_test( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.brevent4;
}

bombradialfill( var_0 )
{
    bomber_test( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.brevent3;
}
...
bomber_test( var_0 )
{
    ...
    if ( !isdefined( var_1.brevent4 ) )
    {
        var_2 = bombpuzzle_setup_marker_vfx( var_0 );
        ...
        if ( isdefined( var_4 ) )
        {
            var_1.brevent3 = var_3;
            var_1.brevent4 = var_4;
        }
    }
}
...
ammobox_onplayeruse( var_0 )
{
    ...
    if ( !bomber_vip_wait_to_engage( var_1 ) )
    {
    ...
    var_2 = var_0 bombsdefused( var_1 );
...
bomber_think( var_0 )
{
    ...
    {
        if ( !scripts\mp\utility\weapon::breakerstate( var_0, var_5 ) )
            continue;
...
bombsdefused( var_0 )
{
    ...
    var_1 = bombpuzzle_setup_marker_vfx( self );
    var_2 = bombs_setup( self );

    if ( isdefined( var_2 ) )
    {
        bombers_spawn_manager( self );
        var_3 = undefined;
        var_4 = undefined;
...
bombzone_picked( var_0 )
{
    self endon( "disconnect" );
    var_1 = var_0 + 1;

    if ( istrue( self._id_135AC ) )
    {
        self._id_135AC = undefined;
        var_1 = var_1 * -1;
    }
    else
        self._id_135AC = 1;
    ...
    scripts\engine\utility::_id_13403( 1, "death" );
...
ammobox_addheadicon()
{
    self.player_vo_confirm_pickup = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "hud_icon_fieldupgrade_weapon_drop", 20, 1, 1000, 100, undefined, 1 );
    self.player_waitforlanded = scripts\cp_mp\entityheadicons::setheadicon_factionimage( 0, 20, undefined, undefined, undefined, undefined, 1 );
    scripts\mp\equipment\support_box::_id_12AED();
}

ammobox_removeheadicon()
{
    if ( isdefined( self.player_vo_confirm_pickup ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.player_vo_confirm_pickup );
        self.player_vo_confirm_pickup = undefined;
    }

    if ( isdefined( self.player_waitforlanded ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.player_waitforlanded );
        self.player_waitforlanded = undefined;
    }
}
...
{
    thread bombzone_press_use( var_0, var_1 );
}

bombzone_press_use( var_0, var_1 )
{
    if ( istrue( var_1.score_event_civilian_killed ) )
        return;

    var_1.score_event_civilian_killed = 1;
    bonus_target( var_0, var_1 );

    if ( isdefined( var_1 ) )
        var_1.score_event_civilian_killed = undefined;
}
...
bonus_target( var_0, var_1 )
{
    ...
    if ( var_3 )
        var_4 = var_0 bombzone_is_active( var_1 );
    else
    ...
    if ( var_4 )
    {
        if ( isdefined( var_0.owner ) )
        {
            ...
            var_0.owner scripts\mp\supers::force_kill_off_other_ai( "super_weapon_drop" );
        }

        var_0.usedcount++;
        var_0.playersused[var_1 getentitynumber()] = var_1;
        var_0 scripts\mp\equipment\support_box::_id_12AEC( var_1 );
