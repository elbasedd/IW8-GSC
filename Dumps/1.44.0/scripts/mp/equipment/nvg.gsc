...
runnvg()
{
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) )
    {
        ...
        scripts\common\utility::blockade_get_bomb_icon_on_cell_phone( 1, undefined, 1 );
...
nvg_monitor()
{
    ...
    for (;;)
    {
        var_1 = scripts\engine\utility::_id_133F7( "night_vision_on", "night_vision_off" );
...
nvg_update3rdperson( var_0 )
{
    ...
    if ( istrue( self.round_smoke_molotov_logic ) )
        return;
