...
at_mine_use( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isent( var_3 ) && respawn_after_death( var_3 ) )
        {
...
at_mine_plant( var_0 )
{
    ...
    if ( istrue( var_0._id_12CFA ) )
        var_0 thread brcirclebattlechatter();
...
brcirclebattlechatter()
{
    self endon( "mine_triggered" );
    self endon( "mine_destroyed" );
    self endon( "death" );
    self.breadcrumb_update_func = ( 0, 0, 0 );
    var_0 = 0.2;
    ...
    for (;;)
    {
        var_1 = self.origin;
        wait( var_0 );
        self.breadcrumb_update_func = 1 / var_0 * ( self.origin - var_1 );
    }
}

removechevronsfromarray( var_0 )
{
    return isdefined( var_0 ) && isdefined( var_0.breadcrumb_update_func ) && length2dsquared( var_0.breadcrumb_update_func ) > 0.01;
}
...
{
    self endon( "death" );
    self.grenade scripts\engine\utility::_id_13404( var_0, "death", "mine_destroyed" );
...
at_mine_watch_flight()
{
    ...
    if ( var_0 > 0 )
    {
        ...
        if ( removechevronsfromarray( self ) )
            var_2 = var_2 + self.breadcrumb_update_func * var_0;
        ...
        if ( var_0 > 0 )
        {
            ...
            childthread scripts\mp\utility\equipment::_id_13489();
            scripts\engine\utility::_id_13403( var_0, "collision_with_platform" );
...
at_mine_watch_game_end()
{
    self endon( "mine_destroyed" );
    self endon( "death" );
    level scripts\engine\utility::_id_133EF( "game_ended", "bro_shot_start" );
    thread at_mine_destroy();
}
