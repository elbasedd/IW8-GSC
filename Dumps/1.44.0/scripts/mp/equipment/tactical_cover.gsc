...
tac_cover_init()
{
    ...
    level._id_12B38 = getentarray( "dcover_blocker", "targetname" );
    level._id_12B37 = getdvarfloat( "scr_tacCover_timeoutOverride", 150.0 );
}
...
tac_cover_on_fired( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = scripts\mp\vehicles\cargo_truck_mg_mp::_id_121A8( var_7, 140, 20 );
    var_9 = undefined;
    var_10 = 0;
    ...
    if ( scripts\cp_mp\auto_ascender::safehouse_regroup( var_7 ) )
        return 0;

    if ( scripts\cp\equipment\cp_adrenaline::safehouse_revive_and_move_players( var_7 ) )
        return 0;

    var_4 = scripts\engine\trace::get_bulletwhizby_alias();
    ...
    if ( isdefined( var_9 ) )
    {
        ...
        {
            if ( var_9 scripts\mp\vehicles\cargo_truck_mg_mp::_id_121A9( var_26 ) )
            {
                var_24 = var_26;
                break;
            }
        ...
        {
            var_30 = _id_12B2E( var_9 );

            if ( isdefined( var_24 ) )
                var_30 = var_30 | _id_12B2E( var_24 );
            ...
            var_32 = var_9.flag_progression + ( 0, 0, 24 );
            ...
            self.taccoverrefund = undefined;
            thread _id_12B30( var_9, var_24, var_3, var_4 );
    ...
    if ( isdefined( var_45 ) && !_id_12B2B( var_45 ) )
    {
        tac_cover_fire_failed();
        return 0;
    }
...
_id_12B2C( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( scripts\mp\vehicles\vehicle_compass_mp::respawn_after_death( var_0 ) || scripts\mp\vehicles\vehicle_compass_mp::resetstuckthermite( var_0 ) || scripts\mp\gametypes\br_gondola.gsc::repair_grill_fixing_short_sfx( var_0 ) || scripts\mp\gametypes\br_soa_tower.gsc::removespawnprotectiononads( var_0 ) )
            return var_0;
    }
...
tac_cover_adjust_for_player_space( var_0, var_1, var_2 )
{
    ...
    foreach ( var_9 in level._id_12B38 )
    {
...
_id_12B30( var_0, var_1, var_2, var_3 )
{
    self endon( "death_or_disconnect" );
    self endon( "tac_cover_taken" );
    level endon( "game_ended" );
    var_4 = anglestoforward( self.angles );
    var_5 = var_0.flag_on_vip_cash_collect + ( 0, 90, 0 );
    var_6 = anglestoforward( var_5 );
    var_7 = vectordot( var_4, var_6 );
    var_8 = var_7 > 0;
    var_9 = var_0 scriptabledoorangle();
    var_0 scripts\mp\vehicles\cargo_truck_mg_mp::increment_timer( 1, "tac_cover_door" );
    ...
    var_11 = ( 0, 0, -1 );
    var_12 = var_0.flag_progression + var_11;
    var_13 = combineangles( var_0.flag_on_vip_cash_collect, var_10 );
    var_14 = undefined;
...
tac_cover_spawn( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_8.deathoverridecallback = ::_id_12B2F;
    ...
    if ( isdefined( var_5 ) )
    {
        if ( isdefined( var_5.carepackage_unlink_from_heli ) )
            var_5.carepackage_unlink_from_heli tac_cover_destroy();

        var_7.carepackage_index = var_5;
        var_5.carepackage_unlink_from_heli = var_7;
    }

    if ( isdefined( var_6 ) )
    {
        var_7.carepackage_set_collision_model = var_6;
        var_6.carepackage_unlink_from_heli = var_7;
    }
...
tac_cover_spawn_internal( var_0 )
{
    ...
    if ( isdefined( var_0.carepackage_index ) )
...
tac_cover_destroy_around_radius( var_0, var_1 )
{
    var_2 = 100;
    ...
    for ( var_9 = 0; var_9 < var_8.size; var_9++ )
    {
        ...
        if ( isdefined( var_10.equipmentref ) )
        {
            if ( var_10.equipmentref == "equip_tac_cover" )
            {
                ...
                var_10.squadleaderbeacon_fxent = 1;
                continue;
            }
        }
    }
...
tac_cover_destroy( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\helicopter\chopper_boss::unlink_on_ai_death( "super_tac_cover", int( var_4 ), var_0, var_2 );
...
tac_cover_destroy_internal( var_0 )
{
    if ( isdefined( self.carepackage_index ) )
    {
        ...
        self.carepackage_index.carepackage_unlink_from_heli = undefined;
    }
    ...
    if ( isdefined( self.carepackage_set_collision_model ) )
    {
        ...
        self.carepackage_set_collision_model.carepackage_unlink_from_heli = undefined;
    }
...
{
    var_1 = _id_12B28( var_0 );

    if ( isdefined( self.owner ) )
    {
        var_2 = max( self.maxhealth - self.damagetaken, 0 );
        var_3 = int( min( var_2, var_1 ) );
        self.owner scripts\mp\supers::force_kill_off_other_ai( "super_tac_cover", var_3 );
    }
...
_id_12B28( var_0 )
{
    ...
    if ( scripts\mp\damage::saveendgamelocals( var_0.objweapon ) )
        return 0;
