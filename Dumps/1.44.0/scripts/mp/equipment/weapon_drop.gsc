...
{
    if ( istrue( self.player_has_respawn_munition ) )
        return;

    self.player_has_respawn_munition = 1;
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::round_enemies_push_logic() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            was_seq3_gassed( var_6, var_7, var_8, var_11 );
        }
    }
}

was_seq3_gassed( var_0, var_1, var_2, var_3 )
{
