...
{
    level.useobjs = [];
    scripts\engine\scriptable::_id_1219E( "hack_usable", ::isdeathshieldskippingenabled );
    thread _updateuseobjs();
}

isdeathshieldskippingenabled( var_0, var_1, var_2, var_3, var_4 )
{
    isdevbuild( var_0.entity, var_3 );
}

isdevbuild( var_0, var_1 )
{
    var_2 = var_0;
    var_2.isbeingused = 1;
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::addpowerbutton, undefined, undefined, ::_ontabletputaway );
...
addpowerbutton( var_0, var_1 )
{
    ...
    thread activate_laser_shut_down_interaction();
    thread activate_gas_trap_cloud_parent( var_0 );
    return 1;
}
...
activate_laser_shut_down_interaction()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    scripts\engine\utility::_id_133EF( "death", "tabletPutAway" );
