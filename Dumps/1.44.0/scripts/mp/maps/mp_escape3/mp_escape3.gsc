...
main()
{
    scripts\mp\maps\mp_escape3\mp_escape3_precache.gsc::main();
    scripts\mp\maps\mp_escape3\gen\mp_escape3_art.gsc::main();
    scripts\mp\maps\mp_escape3\mp_escape3_fx.gsc::main();
    scripts\mp\maps\mp_escape3\mp_escape3_lighting.gsc::main();
    scripts\mp\load::main();
    scripts\cp_mp\utility\game_utility::registerlargemap();
    scripts\cp_mp\utility\game_utility::_id_11E01();
    ...
    level.circle = "veh8_mil_air_acharlie130_atlantis_rigid";
    level.circle_acceleration = "br_fx_rebirth";
    setdvar( "MMNMQTSOSP", 0 );

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        brinit();
        level.unset_ignoreall_after_notify = ::unset_ignoreall_after_notify;
        level thread scripts\mp\maps\mp_escape2\mp_escape2_ee.gsc::register_seat_data_for_vehicle();
    }
    ...
    {
        level.updateteamplunderhud = getentarray( "OutOfBounds", "targetname" );
        level.outofboundstriggers = getentarray( "OutOfBounds", "targetname" );
        level.kill_border_triggers = getentarray( "kill_border_trigger", "targetname" );
    }

    if ( scripts\mp\utility\game::getgametype() == "war" )
        level.relic_healthpacks = ::relic_healthpacks_globalfunc;
    ...
    allow_forward_factor();
    thread hidehistoryhudfromplayer();
    thread runmisteffects();
    thread pe_chopper_zones();
    thread relic_grounded_reload_monitor();
    thread _id_126D3();
    thread _id_12586();
}
...
allow_forward_factor()
{
    ...
    foreach ( var_2 in var_0 )
        thread trap_door_nvg_reset_catch( var_2 );
}
...
trap_door_nvg_reset_catch( var_0 )
{
    for (;;)
    {
        ...
        var_2 = scripts\mp\gametypes\br_vehicles.gsc::currentnumber();
...
brinit()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::initnonbunkerdoors( "planeConstrainedFromMapCenter" );
    ...
    level.br_level.cleanup_target_stats = [];
    level.br_level.cleanup_target_stats[0] = ( var_3, var_5, 0 );
    level.br_level.cleanup_target_stats[1] = ( var_2, var_4, 0 );
    ...
    if ( getdvarint( "scr_br_alt_mode_nonstop", 0 ) )
    {
        ...
        level.br_level.circlesettingsassert = [ 60, 0, 0, 0, 0, 0, 0, 0 ];
    }
    ...
    else if ( scripts\mp\utility\game::onfieldupgradeendbuffer() == "mini" )
    {
        level.br_level.br_circleclosetimes = [ 0.055, 90, 75, 60, 60, 100 ];
        level.br_level.br_circledelaytimes = [ 0.055, 90, 90, 60, 45, 0 ];
        level.br_level.circlesettingsassert = [ 0, 0, 0, 0, 0, 0 ];
    }
    else if ( scripts\mp\utility\game::onfieldupgradeendbuffer() == "rebirth" )
    {
        level.br_level.br_circleclosetimes = [ 90, 75, 60, 60, 100 ];
        level.br_level.br_circledelaytimes = [ 150, 110, 75, 60, 0 ];
        level.br_level.circlesettingsassert = [ 120, 0, 0, 0, 0 ];
    }
    else
    {
        level.br_level.br_circleclosetimes = [ 90, 75, 60, 60, 100 ];
        level.br_level.br_circledelaytimes = [ 120, 90, 60, 45, 0 ];
        level.br_level.circlesettingsassert = [ 100, 0, 0, 0, 0 ];
    }

    if ( scripts\mp\utility\game::onfieldupgradeendbuffer() == "mini" )
    {
        level.br_level.circlesetup = [ 0, 0, 0, 0, 0, 0 ];
    ...
    {
        level.br_level.circlesetup = [ 0, 0, 0, 0, 0 ];
    ...
    if ( isdefined( level.circleposattime ) )
        [[ level.circleposattime ]]();

    scripts\mp\gametypes\br_circle.gsc::bot_hp_allow_predictive_capping();
    level.clear_padding_disables = [ scripts\mp\gametypes\br.gsc::createspawnlocation( ( 0, 400, 1000 ), 0, 1000 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -2000, -5211, 1000 ), 0, 1000 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( 4542, -3893, 1000 ), 0, 1000 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -1000, 10000, 1000 ), 0, 1000 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -4000, 3000, 1000 ), 0, 1000 ), scripts\mp\gametypes\br.gsc::createspawnlocation( ( -1500, -11500, 1000 ), 0, 1000 ) ];
    level.chuckerlogic = [ scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -18691, 12376, 200 ), 15000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -19459, -12712, 200 ), 15000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 19261, -12712, 200 ), 15000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 18493, 12376, 200 ), 15000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -707, 20888, 200 ), 8000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -707, -22632, 200 ), 8000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 5255, -15805, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 8323, -9836, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 8642, 3052, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 7015, 9413, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 4349, 13144, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -7087, 13998, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -8292, 8684, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -9920, 2816, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -8292, 8684, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -9088, -5312, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -7424, -12800, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -1600, -17344, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 9923, -2860, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -1859, 16600, 200 ), 4500 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 2388, -11256, 200 ), 2400 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -4140, -8184, 200 ), 2000 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -6085, 2857, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -92, 12848, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -4582, 10069, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 4957, 4374, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 4579, 6143, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -6700, -824, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( -3820, -9656, 200 ), 1100 ), scripts\mp\gametypes\br_circle.gsc::get_investigate_alias( ( 1556, -13880, 200 ), 1100 ) ];

    if ( scripts\mp\utility\game::onfieldupgradeendbuffer() == "rebirth" )
        thread flag_num_players_on_team();
}

unset_ignoreall_after_notify()
{
    if ( !scripts\mp\gametypes\br.gsc::spawn_trucks() )
        return;
...
hidehistoryhudfromplayer()
{
    ...
    var_0 = var_0 + ( 0, -90, 0 );
    level.tr_circletick = [];
    get_checking_area_alias( "control_center", ( -3200, -2400, 1700 ), var_0 );
    get_checking_area_alias( "quarantine_block", ( -360, 180, 2400 ), var_0 );
    get_checking_area_alias( "decon_zone", ( -1875, 7200, 1400 ), var_0 );
    get_checking_area_alias( "bioweapon_labs", ( -2150, 10400, 1500 ), var_0 );
    get_checking_area_alias( "harbor", ( 3850, 3750, 1200 ), var_0 );
    get_checking_area_alias( "headquarters", ( 1750, -3350, 2000 ), var_0 );
    get_checking_area_alias( "living_quarters", ( -50, -5900, 1500 ), var_0 );
    get_checking_area_alias( "chemical_engineering", ( 1375, 7475, 1600 ), var_0 );
    get_checking_area_alias( "nova_6_factory", ( 4500, -2000, 1400 ), var_0 );
    get_checking_area_alias( "security_area", ( -650, -10250, 1500 ), var_0 );
    get_checking_area_alias( "shore", ( -6200, -1100, 1200 ), var_0 );
    level thread gulagmatchclocksounds();
}

get_checking_area_alias( var_0, var_1, var_2 )
{
    get_chopper_boss_combat_action( var_0, var_1, var_2, "name_fx_rebirth" );
}

get_chopper_boss_combat_action( var_0, var_1, var_2, var_3 )
{
    var_4 = spawn( "script_model", var_1 );
    var_4 setmodel( "tag_origin_name_fx_rebirth" );
    var_4.angles = var_2;
    level.tr_circletick[level.tr_circletick.size] = var_4;
    var_4 setscriptablepartstate( var_3, var_0 );
    var_4 forcenetfieldhighlod( 1 );
}

gulagmatchclocksounds()
{
    level thread playersleftloop();
    ...
    foreach ( var_1 in level.tr_circletick )
        var_1 delete();
}
...
playersleftloop()
{
    ...
    while ( level.tr_circletick.size > 0 )
    {
        var_2 = level.players;
        ...
        for ( var_3 = 0; var_3 < var_2.size; var_3++ )
        {
            ...
            if ( isdefined( var_4 ) && isalive( var_4 ) )
            {
                ...
                {
                    for ( var_5 = 0; var_5 < level.tr_circletick.size; var_5++ )
                        level.tr_circletick[var_5] hidefromplayer( var_4 );
                }
            }
...
pe_chopper_zones()
{
    ...
    level._id_135FD._id_12D76[level._id_135FD._id_12D76.size] = var_5;
    level._id_135FD._id_12D76[level._id_135FD._id_12D76.size] = var_6;
    level._id_135FD._id_12D76[level._id_135FD._id_12D76.size] = var_7;
    var_6 linkto( var_5 );
    var_7 linkto( var_5 );
    thread brdisabledamagestattracking( var_5 );
    thread pendingtimer( var_8, var_5 );
    var_8 periodic_sound_events();
    var_8 thread percentagetokensdrop();
    var_8 thread perform_fixes();
...
brdisabledamagestattracking( var_0 )
{
    ...
    var_1.get_paired_bombvest_chair = 1;
}

pendingtimer( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "death" );
    var_1 endon( "death" );
...
periodic_sound_events()
{
    ...
    level.enable_leaderboard = ::pbexploitstarttime;
}

pbexploitstarttime( var_0 )
{
    return !istrue( var_0.round_smoke_semtex_logic );
}

percentagetokensdrop()
{
    self endon( "death" );
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_0 ) )
        {
            var_0.round_smoke_semtex_logic = 1;
...
perform_fixes()
{
    ...
    for (;;)
    {
        foreach ( var_2, var_1 in self.playersintrigger )
        {
            ...
            var_1.round_smoke_semtex_logic = undefined;
        }
...
botloadoutfavoritecamosecondary()
{
    ...
    foreach ( var_3 in var_0 )
        var_3 thread botloadoutfavoritecamoprimary( var_1 );
}

botloadoutfavoritecamoprimary( var_0 )
{
    self endon( "death" );
    var_1 = undefined;
...
flag_num_players_on_team()
{
    var_0 = scripts\mp\gametypes\br_gametype_rebirth.gsc::old_spectator_func();
    var_1 = 0;
    ...
    level waittill( "infils_ready" );
    wait( var_1 );
    thread get_consecutive_def( 5 );
}

_id_126D3()
{
    var_0 = [];
    var_0[var_0.size] = _id_126D2( ( -798.73, -11359.7, 97.375 ), 700 );
    var_0[var_0.size] = _id_126D2( ( -1932.73, -11450.4, 114.375 ), 900 );
    var_0[var_0.size] = _id_126D2( ( -1349.75, -9363.25, 83.25 ), 1400 );
    var_0[var_0.size] = _id_126D2( ( -474, -9503, 83.25 ), 700 );
    var_0[var_0.size] = _id_126D2( ( 168.75, -9167.75, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( 466.75, -8609, 83.25 ), 700 );
    var_0[var_0.size] = _id_126D2( ( -2085.25, -8068.75, 83.25 ), 700 );
    var_0[var_0.size] = _id_126D2( ( -2923.5, -7025.75, 83.25 ), 700 );
    var_0[var_0.size] = _id_126D2( ( 645.25, -4352.5, 171 ), 4700 );
    var_0[var_0.size] = _id_126D2( ( 4971, -3084.5, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( 4854.5, -2240.5, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( 4316, -1600.25, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( 3327.5, -883, 892.75 ), 1200 );
    var_0[var_0.size] = _id_126D2( ( 2524.75, 987, 892.75 ), 1500 );
    var_0[var_0.size] = _id_126D2( ( -4706.25, -3455.75, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( -5197.5, -2455.25, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( -3880, -2480.5, 892.75 ), 1500 );
    var_0[var_0.size] = _id_126D2( ( -4888.25, -1054.75, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( -5106.5, 409.5, 83.25 ), 500 );
    var_0[var_0.size] = _id_126D2( ( -3294, 394.75, 892.75 ), 2000 );
    var_0[var_0.size] = _id_126D2( ( -4906.5, 3983.75, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -4888.25, 4565.75, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -455.75, 3821.25, 171 ), 4100 );
    var_0[var_0.size] = _id_126D2( ( 3224.5, 5129.75, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( 3188, 5912, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( 2933.25, 6657.75, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( 1787.25, 7458, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( 201.25, 8467.5, 1038.25 ), 1700 );
    var_0[var_0.size] = _id_126D2( ( -1504, 9740.75, 1038.25 ), 1700 );
    var_0[var_0.size] = _id_126D2( ( -1759.75, 7912.75, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -2796.5, 7894.5, 83.25 ), 600 );
    var_0[var_0.size] = _id_126D2( ( -3196.75, 6985, 83.25 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -3840, 7384, 0 ), 600 );
    var_0[var_0.size] = _id_126D2( ( -3572, 8180, 0 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -3932, 6508, 0 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -4288, 5764, 0 ), 400 );
    var_0[var_0.size] = _id_126D2( ( -4576, 5228, 0 ), 400 );
    level.init_oscilloscopes = var_0;
    level._id_13103 = 1;
}

_id_126D2( var_0, var_1 )
{
