...
try_start_fake_infil_chopper( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
truckwarspawnlocations( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
try_to_do_first_passby_room_logic( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
