...
door_think()
{
    ...
    for (;;)
    {
        ...
        var_0 scripts\engine\utility::_id_133EF( "door_state_done", "door_state_interrupted" );
...
disownalarmmonitor()
{
    ...
    for (;;)
    {
        self.dooralarmowner scripts\engine\utility::_id_133F0( "joined_team", "joined_spectators", "disconnect" );
...
{
    scripts\engine\utility::_id_133EF( "remove_rig", "death_or_disconnect" );
}
