...
init()
{
    ...
    scripts\mp\supers\super_stoppingpower::_id_12A48();
    scripts\mp\utility\spawn_event_aggregator::registeronplayerspawncallback( ::_id_12ACC );
    level.setsuperweapondisabled = ::setsuperweapondisabled;
    scripts\cp_mp\utility\script_utility::registersharedfunc( "super", "watchSuperLastStandEnd", ::_id_13524 );
}
...
loadsupertable()
{
    ...
    for (;;)
    {
        ...
        var_2._id_11DA6 = readsupertablecell( var_0, 6, 1 );
        ...
        var_2.current_safehouse_spawn_structs = readsupertablecell( var_0, 19, 1 );
...
registersupers()
{
    ...
    registersuper( "super_select", ::_id_12AD9, ::_id_12ADA, ::superselectbeginuse, undefined );
    registersuper( "super_fulton", undefined, undefined, ::_id_12AD3, undefined );
    registersuper( "super_supply_drop", undefined, undefined, ::_id_12ADC, undefined );
    registersuper( "super_vehicle_drop", undefined, undefined, ::_id_12ADE, undefined );
    registersuper( "super_loot_drop", undefined, undefined, ::_id_12ADC, undefined );
    _id_11E04( "super_emp_drone", "emp_drone_player_mp" );
    _id_11E04( "super_emp_drone", "emp_drone_non_player_mp" );
    _id_11E04( "super_emp_drone", "emp_drone_non_player_direct_mp" );
    _id_11E04( "super_weapon_drop", "deploy_weapondrop_mp" );
}
...
_id_11E04( var_0, var_1 )
{
    ...
    var_2.jumpscenenode[var_2.jumpscenenode.size] = var_1;
    level.superglobals._id_12AD8[var_1] = var_2;
}
...
givesuper( var_0, var_1, var_2 )
{
    ...
    var_4.use_dropkit_marker = undefined;
    _id_123DF( 0 );
    _id_12AD6( var_0 );
...
clearsuper( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.staticdata ) )
        _id_12AD7( var_1.staticdata.ref );
    ...
    thread scripts\mp\trials\trial_utility::_id_1236A( "ui_super_state", 0 );
...
updatesuperuistate()
{
    ...
    if ( !isdefined( var_1 ) || var_2 != var_1 )
        thread scripts\mp\trials\trial_utility::_id_1236A( "ui_super_state", var_2 );
    ...
    if ( isdefined( var_0 ) && !var_0.isinuse )
    {
        ...
        else
        {
            ...
            if ( istrue( self.inlaststand ) )
                thread _id_13524( var_0.staticdata.weapon );
            else
                self setweaponammoclip( var_0.staticdata.weapon, 1 );
        }
    }
...
superusefinished( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        else if ( var_4.staticdata.current_safehouse_spawn_structs )
        {
            clearsuper();
            self setclientomnvar( "ui_perk_package_state", 0 );
            self setclientomnvar( "ui_super_progress", 0 );
    ...
    scripts\cp\helicopter\chopper_boss::untrack_enemy( var_4, var_5 );
}
...
handledeath()
{
    ...
    var_0 = getcurrentsuper();
    var_1 = var_0.staticdata._id_11DA6;
...
getsuperpointsneeded()
{
    ...
    if ( isdefined( var_0.use_dropkit_marker ) )
        var_1 = var_0.use_dropkit_marker;
...
ongulagendmatch( var_0 )
{
    ...
    if ( !isdefined( level.superglobals._id_12AD8[var_0] ) )
        return undefined;

    return level.superglobals._id_12AD8[var_0].ref;
}
...
updateactivesupers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_11 )
    {
        ...
        if ( var_8 && var_0 scripts\mp\utility\perk::_hasperk( "specialty_bulletdamage" ) )
            var_1 thread scripts\mp\supers\super_stoppingpower::_id_12A4D( var_5 );
    }
}
...
force_kill_off_other_ai( var_0, var_1 )
{
    if ( !scripts\mp\utility\stats::canrecordcombatrecordstats() )
        return;
    ...
    var_2 = mp_speedball_check_trigger_pos( var_0 );
...
scramblebeginuse()
{
    ...
    thread scripts\cp_mp\killstreaks\helper_drone::playersetomnvargulag( self );
    return 1;
}
...
_id_12AD9()
{
    ...
    self.super.use_dropkit_marker = var_5;
}
