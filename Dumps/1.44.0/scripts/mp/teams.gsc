...
init()
{
    ...
    level.multiteambased = level.teamnamelist.size > 2 || scripts\mp\utility\game::getgametype() == "br" && scripts\mp\menus::_id_128AB();
    level.teamdata = [];
    ...
    {
        scripts\mp\utility\teams::onkioskpurchaseitem( var_9 );
    ...
    if ( scripts\mp\utility\game::rotate_silo_gyro_lights() )
    {
    ...
    if ( isdefined( level.light_tank_addgunnerdamagemod ) )
        level thread [[ level.light_tank_addgunnerdamagemod ]]();

    if ( getdvarint( "scr_debug_teams", 0 ) == 1 )
        level thread getspecialdaycamos();
}
...
player_cam_disable( var_0 )
{
    if ( !isdefined( level._id_12FB8 ) )
    {
        var_1 = [];
        var_1["t9woods_western_v"] = "active_woods";
        var_1["t9weaver_western_b"] = "active_weaver";
        var_1["t9st3_western_r_pc"] = "active_stone";
        var_1["t9st3_western_r_sy"] = "active_stone";
        var_1["t9st3_western_r_ms"] = "active_stone";
        var_1["t9kgb_eastern_zc"] = "active_weed2";
        var_1["t9weaver_western_c"] = "active_orda";
...
createoperatorcustomization()
{
    ...
    var_10.clothtype = nvgwatcher( var_9 );
    var_10.superfaction = getoperatorsuperfaction( var_8 );
    var_10.execution = getoperatorexecution( var_8 );
    var_10.isplatepouch = nvidiaansel_allowduringcinematic( var_8 );
    var_10.isplayerbrsquadleader = nvidiaansel_overridecollisionradius( var_8 );
    var_10.suit = var_3;
    var_10.rebuild = 0;
    var_10.playerstarttimetracking = run_module_unpause_funcs( var_1 );

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_11 = nvgvisionsetoverride( var_9 );

        if ( var_11 != "" )
            var_10.computermakingnose = var_11;

        player_cam_disable( var_9 );
    }

    var_12 = spawnstruct();
    var_12.apc = onriskplayerkilled( "apc" );
    var_12.bot_get_stored_launcher_class = onspawn_fastspeed( "apc" );
    var_12.brjugg_oncratedestroy = onriskplayerkilled( "atv" );
    var_12.domflag_hideiconfromplayer = onriskplayerkilled( "cargo_truck" );
    var_12.scriptable_used_by_part_funcs = onriskplayerkilled( "jeep" );
    var_12.silo_door_cover_spawners = onriskplayerkilled( "little_bird" );
    var_12._id_12B31 = onriskplayerkilled( "tac_rover" );
    var_12._id_12B7C = onriskplayerkilled( "tank_east" );
    var_12._id_12B7D = onspawn_fastspeed( "tank_east" );
    var_12._id_12B87 = onriskplayerkilled( "tank_west" );
    var_12._id_12B88 = onspawn_fastspeed( "tank_west" );
    var_12.teamextractedvictory = onriskplayerkilled( "motorcycle" );
    var_12.bot_gametype_human_player_always_considered_defender = onscavengerbagpickup( "apc", 4 );
    var_12.brjugg_oncrateuse = onscavengerbagpickup( "atv", 6 );
    var_12.domflag_onbeginuse = onscavengerbagpickup( "cargo_truck", 8 );
    var_12.scriptableinit = onscavengerbagpickup( "jeep", 10 );
    var_12.silo_door_jugg = onscavengerbagpickup( "little_bird", 12 );
    var_12._id_12B32 = onscavengerbagpickup( "tac_rover", 14 );
    var_12.teamsassigned = onscavengerbagpickup( "motorcycle", 16 );
    var_12.brjugg_setjuggwatchers = onsoccerballreset( "atv" );
    var_12._id_12B36 = onsoccerballreset( "tac_rover" );
    var_12.skydiveontacinsertplacement = onsoccerballreset( "little_bird" );
    var_12.teleport_text_updated = onsoccerballreset( "motorcycle" );
...
lookupcurrentoperator( var_0 )
{
    ...
    if ( getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && !isagent( self ) && self isplayerheadless() )
    {
        ...
        if ( !isdefined( self.player_waitfortacmapused ) )
        {
            foreach ( var_9 in var_7 )
            {
                var_10 = getarraykeys( level.operatorcustomization[var_9] );

                if ( !isdefined( level.playerattractiontriggerexit ) )
                    level.playerattractiontriggerexit = [];

                if ( !isdefined( level.playerattractiontriggerexit[var_9] ) || level.playerattractiontriggerexit[var_9] > var_10.size )
                    level.playerattractiontriggerexit[var_9] = 0;

                for ( var_11 = var_10[level.playerattractiontriggerexit[var_9]]; isdefined( var_11 ) && ( var_11 == "default_western" || var_11 == "default_eastern" ); var_11 = var_10[level.playerattractiontriggerexit[var_9]] )
                {
                    level.playerattractiontriggerexit[var_9] = level.playerattractiontriggerexit[var_9] + 1;

                    if ( level.playerattractiontriggerexit[var_9] > var_10.size )
                        level.playerattractiontriggerexit[var_9] = 0;
                }
            ...
            self.player_waitfortacmapused = 1;
        }
    ...
    else
    {
        if ( getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && !isagent( self ) && self isplayerheadless() )
        {
            if ( !isdefined( level.playercustomizationdata[var_3][var_0].operatorskinindex ) )
            {
                ...
                var_5 = level.playerattractiontriggerenter[var_1]["curIndex"];
                level.playercustomizationdata[var_3][var_0].operatorskinindex = level.playerattractiontriggerenter[var_1]["lootIDs"][var_5];
                level.playerattractiontriggerenter[var_1]["curIndex"] = level.playerattractiontriggerenter[var_1]["curIndex"] + 1;

                if ( level.playerattractiontriggerenter[var_1]["curIndex"] >= level.playerattractiontriggerenter[var_1]["maxIndex"] )
                    level.playerattractiontriggerenter[var_1]["curIndex"] = 0;
            }
        }
        else if ( !isdefined( level.playercustomizationdata[var_3][var_0].operatorskinindex ) )
        {
            if ( isai( self ) )
            {
                if ( !isdefined( self.botskinid ) )
                    chopperexfil_sfx_before_sh070( var_1 );
...
getoperatorcustomization()
{
    ...
    if ( isdefined( level.super_enemy_spawning ) )
        [var_0, var_1] = [[ level.super_enemy_spawning ]]( self, var_0, var_1 );
...
checkforafk()
{
    ...
    if ( istrue( self.create_vehicle_vehicledata ) )
        return;
    ...
    if ( istrue( self.player_latespawn_safehouse ) )
        return;
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && istrue( self.convoy4_roof_rpgs ) )
    {
        self.convoy4_roof_rpgs = undefined;
        var_10 = 30;
    }
    else if ( var_11 > 0 )
        var_10 = var_11;
    ...
    if ( scripts\mp\utility\game::isroundbased() && scripts\mp\utility\game::getgametype() != "ctf" )
    {
        ...
        if ( var_0 && !isgamebattlematch() && !istrue( self.areanygulagfightsactive ) )
        {
            self.areanygulagfightsactive = 1;
            self.pers["roundsAFK"]++;

            if ( self.pers["roundsAFK"] > 1 )
                level thread seq3_elevator_init( self );
        }
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_133EF( "death_or_disconnect", "joined_team" );
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_133F0( "death_or_disconnect", "joined_team", "joined_squad" );
    scripts\mp\utility\outline::outlinedisable( var_0, self );
}
...
nvidiaansel_allowduringcinematic( var_0 )
{
    ...
    if ( var_1 == 0 )
        self.sol_1_pool = tablelookup( "operators.csv", 1, var_0, 23 );
    else
        self.sol_1_pool = tablelookup( "operatorquips.csv", 0, var_1, 6 );

    return self.sol_1_pool;
}

nvidiaansel_overridecollisionradius( var_0 )
{
    self.sol_2_pool = tablelookup( "mp_cp/executiontable.csv", 1, self.loadoutexecution, 19 );
    return self.sol_2_pool;
}
...
onscavengerbagpickup( var_0, var_1 )
{
    var_2 = 0;
...
register_vehicle_max_ai()
{
    ...
    level.playerattractiontriggerenter = [];
    ...
    for ( var_1 = 0; var_1 < var_0; var_1++ )
    {
        if ( tablelookupbyrow( "operatorskins.csv", var_1, 18 ) != "" )
        {
            ...
            if ( !isdefined( level.playerattractiontriggerenter[var_2] ) )
            {
                level.playerattractiontriggerenter[var_2]["lootIDs"] = [];
                level.playerattractiontriggerenter[var_2]["curIndex"] = 0;
                level.playerattractiontriggerenter[var_2]["maxIndex"] = 0;
            }

            level.playerattractiontriggerenter[var_2]["lootIDs"][level.playerattractiontriggerenter[var_2]["lootIDs"].size] = int( var_3 );
            level.playerattractiontriggerenter[var_2]["maxIndex"] = level.playerattractiontriggerenter[var_2]["maxIndex"] + 1;
        }
    }
}
...
initoperatorcustomization()
{
    ...
    for (;;)
    {
        ...
        var_5 = obit_destroy_old_vehicles( var_1 );
...
vehicleparent()
{
    ...
    if ( istrue( level.onlinegame ) )
    {
        ...
        if ( isdefined( var_2 ) && var_2.size > 0 )
        {
            foreach ( var_4 in var_2 )
            {
                ...
                {
                    var_0 = var_4.team;
                    self._id_12BF0 = var_4._id_12BF0;
                    break;
                }
            }
        }
    ...
    if ( !isdefined( var_0 ) )
        var_0 = last_vampire_sound( var_1 );

    if ( !isdefined( self._id_12BF0 ) )
        self._id_12BF0 = gettime();
...
last_vampire_sound( var_0 )
{
    ...
    foreach ( var_3 in level.teamnamelist )
    {
        ...
        if ( var_4 > 0 )
        {
            ...
            if ( isdefined( var_6[0]._id_12BF0 ) && gettime() > var_6[0]._id_12BF0 + 300000 )
                continue;
        }
...
_id_124DB()
{
    return getdvarint( "scr_br_zombie_encounters", 0 ) > 0 || scripts\mp\utility\game::clip_ent();
}
