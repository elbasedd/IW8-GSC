...
killstreak_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistDataForceCredit", scripts\mp\killstreaks\killstreaks::_id_130B4 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistData", scripts\mp\killstreaks\killstreaks::_id_130B3 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "processScrapAssist", scripts\mp\events::_id_11BB5 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayersInRange", scripts\mp\gametypes\br_killstreaks.gsc::getfirespoutlaunchvectors );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayer", scripts\mp\gametypes\br_killstreaks.gsc::getfilterformodifier );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "teamJuggMaxReached", scripts\mp\juggernaut::brjugg_initdialog );
}
...
entity_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "entity", "isGondolaBrush", scripts\mp\gametypes\br_gondola.gsc::repair_grill_fixing_short_sfx );
}
...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "freezeControlsDebug", scripts\mp\utility\player::add_pack_camanim );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "getStanceTop", scripts\mp\utility\player::oneoffuavsweeps );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "loadout_finalizeWeapons", scripts\mp\class::smuggler_killed_early );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInLastStand", scripts\mp\utility\player::round_spawn_enemies );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isPlayerOnIntelChallenge", scripts\mp\gametypes\br_maphints.gsc::runleadmarkers );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "carriable_useAscender", scripts\cp\vehicles\little_bird_mg_cp::drop_usb_stick );
}
...
game_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "getSubGameType", scripts\mp\utility\game::onfieldupgradeendbuffer );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "brGetOperatorTeam", scripts\mp\gametypes\br_public.gsc::computer_debugtestloop );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "gameFlag", scripts\mp\flags::gameflag );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "isPointInBounds", scripts\mp\outofbounds::round_mortars_logic );
}
...
weapons_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getDefaultWeaponBaseName", scripts\mp\utility\weapon::nag_get_in_heli );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "attachmentIsSelectable", scripts\mp\utility\weapon::breakerstate );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "remapAttachmentParentName", scripts\mp\utility\weapon::_id_11E83 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponMenuCategory", scripts\mp\utility\weapon::onteammatereviveweapontaken );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponRarity", scripts\mp\utility\weapon::onteamproximitysteppedclose );
}
...
sound_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sound", "playKillstreakDeployDialog", scripts\mp\battlechatter_mp::_id_11A6E );
...
rank_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "rank", "getBattlePassXPultiplierTotal", scripts\mp\rank::movement_vector );
}
...
supers_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "supers", "combatRecordSuperMisc", scripts\mp\supers::force_kill_off_other_ai );
}
...
dropspecialistbonus()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onFieldUpgradeEnd", scripts\cp\helicopter\chopper_boss::unlink_on_ai_death );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onKillStreakEnd", scripts\cp\helicopter\chopper_boss::unset_bullet_shields );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "resetChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_11F25 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "startChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_129AD );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "stopChallengeTimer", scripts\cp\helicopter\chopper_boss::_id_12A36 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onPing", scripts\cp\helicopter\chopper_boss::unset_relic_dogtags );
}

_id_12BC9()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "team_utility", "init", scripts\mp\utility\teams::_id_12BCA );
}
