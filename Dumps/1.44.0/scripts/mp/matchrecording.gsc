...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6._id_12570 ) )
            var_0 = var_6._id_12570;

        if ( isdefined( var_6.is_station_active ) )
            var_3 = var_6.is_station_active;

        if ( isdefined( var_6.is_station_track_available ) )
            var_4 = var_6.is_station_track_available;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_133FE( "log_user_event_end", "log_user_event_generic_event" );
