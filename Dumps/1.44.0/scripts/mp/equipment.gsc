...
inititems()
{
    ...
    var_0.callbacks["equip_binoculars"]["onGive"] = _attachmentblocks::calloutmarkerpingvohandlerpool;
    var_0.callbacks["equip_binoculars"]["onTake"] = _attachmentblocks::camera_loadout_showcase_preview_sticker_alt3;
...
loadtable()
{
    ...
    for (;;)
    {
        ...
        var_3.sat_wait_for_connection_think = tablelookupbyrow( "mp/equipment.csv", var_0, 8 ) != "-1";
...
rocket_fuel_x1( var_0 )
{
    if ( isdefined( level.equipment.table[var_0] ) )
        return istrue( level.equipment.table[var_0].sat_wait_for_connection_think );
    else
        return 0;
}
...
executeoffhandfired( var_0 )
{
    foreach ( var_6, var_2 in self.equipment )
    {
        ...
        if ( isdefined( var_3.objweapon ) && var_0 == var_3.objweapon )
        {
            ...
            scripts\mp\damage::force_interrupt_all_current_combat_actions( var_4 );
...
watchlethaldelay()
{
    ...
    var_0 = get_subway_car_available_to_deploy();
...
watchlethaldelayplayer( var_0, var_1 )
{
    ...
    if ( !isdefined( self.shouldblockdamage ) || !istrue( self.shouldblockdamage[var_1] ) )
    {
        if ( !isdefined( self.shouldblockdamage ) )
            self.shouldblockdamage = [];

        self.shouldblockdamage[var_1] = 1;
    ...
    if ( isdefined( self.shouldblockdamage ) && istrue( self.shouldblockdamage[var_1] ) )
    {
        self.shouldblockdamage[var_1] = undefined;

        if ( self.shouldblockdamage.size == 0 )
            self.shouldblockdamage = undefined;
...
watchlethaldelayfeedbackplayer( var_0, var_1 )
{
    ...
    var_3 = get_subway_car_available_to_deploy();
...
cancellethaldelay()
{
    ...
    if ( get_subway_car_available_to_deploy() )
        level.lethaldelaystarttime = gettime();
    else
        level.lethaldelaystarttime = scripts\mp\utility\game::gettimepassed();
...
hackequipment( var_0 )
{
    ...
    var_0 scripts\cp\helicopter\chopper_boss::unlocked_armory( self.equipmentref );
    changeowner( var_0 );
...
packs( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4._id_121F1 = var_4 getcurrentequipment( var_1 );
        var_4._id_121F0 = getequipmentslotammo( var_1 );
        var_4 takeequipment( var_1 );
        var_4 giveequipment( var_2, var_1 );
    }
}

_id_12B68( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        var_7 = var_5._id_121F1;
        var_8 = var_5._id_121F0;

        if ( isdefined( var_7 ) )
        {
            var_5 giveequipment( var_7, var_1 );
            var_5._id_121F1 = undefined;

            if ( isdefined( var_8 ) )
            {
                var_5 setequipmentammo( var_7, var_8 );
                var_5._id_121F0 = undefined;
            }
        }
    }
}
...
registerpreviousprop()
{
    level.shouldbekilledoff = [];
    var_0 = 0;

    foreach ( var_2 in level.equipment.table )
    {
        if ( !var_2.sat_wait_for_connection_think )
            continue;
        ...
        level.shouldbekilledoff[var_2.ref] = 1 << var_0;
        var_0++;
    }
}
