...
tryusehoverjetfromstruct( var_0 )
{
    ...
    var_4 = ai_dropgren_override_hint( var_0 );
    var_4 = istrue( var_4 );
    level.incomingallhoverjets--;
...
ai_dropgren_override_hint( var_0 )
{
    ...
    scripts\common\utility::_id_12ED6( level.stack_patch_waittill_leaf, "hover_jet", self.origin );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread plunder_infils_ready();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::expiredlootleaders( var_5.player ) )
            continue;
