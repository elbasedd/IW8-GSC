...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::battletracksowner );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo._id_12A6F;
...
battletracksowner( var_0 )
{
    ...
    var_2._id_12A6F = self.matchdatalifeindex;
    var_2.owner = self;
    var_2.useweaponpickups = self getxuid();
    var_2.allow_ascender_use = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.allow_ascender_use, self.origin );
