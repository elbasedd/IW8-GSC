...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "watchForPlayerEnteringLastStand", ::spawnvehicles );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "handleMovingPlatform", ::spawnvector );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "allowPickupOfTurret", ::spawnuniqueboardroomloot );
}
...
spawnvector( var_0 )
{
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_1.sidekillcount = var_0.time_passed_no_target_threshold;
        var_1.angleoffset = var_0.time_on_floor;
        var_1.endonstring = "carried";
        var_1.deathoverridecallback = ::spectate3rdallowed;
...
spawnvehicles()
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::spawnzombiedogtags( "last_stand_start" );
