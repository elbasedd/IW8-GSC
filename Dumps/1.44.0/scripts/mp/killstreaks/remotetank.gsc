...
starttankdropoff( var_0 )
{
    ...
    scripts\common\utility::_id_12ED6( level.stack_patch_waittill_leaf, "pac_sentry", self.origin );
...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11 thread _id_12B85();
    var_11 thread _id_12B86();
...
_id_12B86()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::_id_13179( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.isverdansksubmap = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::_id_11F70( var_0 );
    }
}
