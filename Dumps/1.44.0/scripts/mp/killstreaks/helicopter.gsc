...
starthelicopter( var_0, var_1 )
{
    ...
    scripts\common\utility::_id_12ED6( level.stack_patch_waittill_leaf, var_3, self.origin );
...
heli_existance()
{
    ...
    scripts\engine\utility::_id_133F0( "death", "crashing", "leaving" );
...
fireontarget( var_0 )
{
    ...
    scripts\engine\utility::_id_13403( 4, "facing" );
    ...
    scripts\engine\utility::_id_13403( 3, "near_goal" );
}
...
heli_leave( var_0 )
{
    ...
    if ( isdefined( self.helitype ) && self.helitype == "osprey" && isdefined( self.pathgoal ) )
    {
        ...
        scripts\engine\utility::_id_13403( 5, "goal" );
    }
    ...
    scripts\engine\utility::_id_13403( 12, "goal" );
    self notify( "gone" );
    self notify( "death" );
    waitframe();
