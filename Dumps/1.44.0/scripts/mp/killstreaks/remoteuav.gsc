...
tryuseremoteuav( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        scripts\common\utility::_id_12ED6( level.stack_patch_waittill_leaf, var_1, self.origin );
...
createcarryremoteuav( var_0, var_1 )
{
    ...
    {
        var_4 = scripts\cp_mp\utility\killstreak_utility::nuclear_core_on_chopper();
...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        var_1 = soldier_agent_lwfn9( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement", "death_or_disconnect" );
...
soldier_agent_lwfn9( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
carryremoteuav_handleexistence()
{
    ...
    self.owner scripts\engine\utility::_id_133F0( "death_or_disconnect", "joined_team", "joined_spectators" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_133F7( "death_or_disconnect", "remoteuav_unlock" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_133F8( "death_or_disconnect", "carried", "leaving" );
...
remoteuav_watch_distance()
{
    ...
    {
        var_0 = scripts\cp_mp\utility\killstreak_utility::nuclear_core_on_chopper();
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_133EF( "joined_team", "joined_spectators" );
    self notify( "death" );
}
