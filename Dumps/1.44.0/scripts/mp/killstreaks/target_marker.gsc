...
gettargetmarker( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            if ( isdefined( var_3 ) && var_3.string == "equip_deploy_succeeded" )
            {
                ...
                else if ( scripts\mp\vehicles\vehicle_compass_mp::rungwperif_largeexplosions() )
                {
    ...
    if ( isdefined( var_3.location ) && isdefined( var_3.angles ) )
    {
        ...
        if ( isdefined( var_8["entity"] ) )
        {
            ...
            var_3.time_passed_no_target_threshold = ( var_11, var_12, var_13 );
            var_3.time_on_floor = combineangles( invertangles( var_9.angles ), var_3.angles );
        }
