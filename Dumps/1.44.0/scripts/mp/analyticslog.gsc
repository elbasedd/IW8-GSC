...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13401( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
...
watchforplayermovementevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_133FF( "doubleJumpBegin", "doubleJumpEnd", "sprint_slide_begin" );
...
watchforusermessageevents()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_133F7( "log_user_event_end", "log_user_event_generic_event" );
...
spawn_deceleration( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        return;
...
spawn_elevator_gate( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "";
...
spawn_double_cargo( var_0, var_1 )
{
...
spawn_corpse_hiders( var_0, var_1, var_2, var_3 )
{
