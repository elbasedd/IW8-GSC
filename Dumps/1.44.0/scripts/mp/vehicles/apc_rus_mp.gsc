...
apc_rus_mp_initspawning()
{
    ...
    var_0.ai_spawn_intel_extras = 180;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
        var_0._id_11F52 = level.bot_get_stored_custom_classes;
}
...
apc_rus_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_1328A( "apc_russian", var_1, var_2 );
