...
light_tank_mp_initspawning()
{
    ...
    var_0.ai_shooting_watch = scripts\cp_mp\vehicles\light_tank::light_tank_timeout;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
    {
        var_0.ai_spawn_intel_extras = 105;
        var_0._id_11F52 = level._id_12B8D;
    }
    else
        var_0.ai_spawn_intel_extras = 40;
}
...
light_tank_mp_createownercaptureobject( var_0, var_1 )
{
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, "tur_bradley_mp" );
...
light_tank_mp_createothercaptureobject( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, "tur_bradley_mp" );
...
light_tank_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_1328A( "light_tank", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            if ( istrue( level._id_1255B ) )
                scripts\mp\gametypes\arm.gsc::_id_131B1( var_3, var_3.team );
