...
_id_121A7( var_0 )
{
    ...
    {
        var_1 = "bash_left_90";
        var_2 = self.flag_on_vip_cash_collect + ( 0, 90, 0 );
    }
    else
    {
        var_1 = "bash_right_90";
...
_id_121A9( var_0 )
{
    ...
    var_1 = self.flag_progression;
    var_2 = var_0.flag_progression;
...
increase_total_count_per_module_call()
{
