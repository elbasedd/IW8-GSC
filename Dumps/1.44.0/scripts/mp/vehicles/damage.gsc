...
callback_vehicledamage_internal( var_0 )
{
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        if ( isdefined( var_5 ) && var_5 == "radar_drone_recon" )
        {
            ...
            var_0.attacker scripts\cp_mp\pet_watch::_id_12D36( self );
    }

    if ( isdefined( level.switcharray ) )
        var_0.damage = self [[ level.switcharray ]]( var_0 );
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        ...
        else
        {
            ...
            if ( isdefined( level.sunpoissonfiltering ) )
                var_8 = self [[ level.sunpoissonfiltering ]]( var_0 );
    ...
    {
        if ( isdefined( level.super_has_targets ) && self [[ level.super_has_targets ]]( var_0 ) )
            var_0.damage = 0;
        else if ( scripts\mp\damage::saveendgamelocals( var_0.objweapon ) )
            var_0.damage = 0;
    ...
    {
        if ( scripts\mp\damage::saw_pickup_think( var_0.objweapon ) )
            var_0.damage = scripts\mp\damage::_id_1288D( self, var_0.attacker, var_0.objweapon, var_0.damage, var_0.idflags );
        else if ( scripts\mp\damage::riotshieldmodeltag( var_0.objweapon ) )
        {
            if ( scripts\mp\damage::_id_124E5( var_0.objweapon ) )
                var_0.damage = 1;
            else
                var_0.damage = 0;
        }
        else if ( scripts\mp\damage::script_end( var_0.objweapon ) )
        {
            if ( !scripts\mp\damage::_id_1251C( var_0.objweapon ) )
                var_0.damage = 0;
        }
        else if ( scripts\mp\damage::respawn_waits( var_0.objweapon, var_0.meansofdeath ) )
            var_0.damage = 0;
        else if ( isdefined( var_5 ) )
    ...
    var_10 = scripts\cp_mp\vehicles\vehicle_damage::_id_131F0( var_0 );

    if ( !var_10 )
    {
        var_11 = scripts\cp_mp\vehicles\vehicle_damage::_id_131C7();
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_131F2( var_0, 1 );
    else
        scripts\cp_mp\vehicles\vehicle_damage::_id_131F1( var_0, var_10, 1 );
    ...
    var_17 = istrue( var_0.sat_missing_pieces ) || istrue( var_0.sat_wait_for_radar );
        ...
        switch ( var_0.objweapon.basename )
        {
            ...
            case "lighttank_tur_mp":
                if ( isdefined( var_0.meansofdeath ) && var_0.meansofdeath != "MOD_RIFLE_BULLET" )
                    var_0.attacker thread scripts\mp\utility\points::patch_far_wait( "critical_vehicle_damage" );
    ...
    if ( isdefined( level.update_health_bar_to_players ) )
        self thread [[ level.update_health_bar_to_players ]]( var_0 );

    if ( var_16 )
    {
        if ( isdefined( var_0.attacker ) && isplayer( var_0.attacker ) )
            var_0.attacker scripts\cp_mp\pet_watch::enable_motionblur( self );
    ...
    if ( level.teambased )
    {
        if ( !var_3 )
        {
            if ( isdefined( var_2 ) && !isdefined( var_1 ) )
                return scripts\cp_mp\vehicles\vehicle::_id_1322A( var_0, var_2 );
            else
                return scripts\cp_mp\vehicles\vehicle::_id_13229( var_0, var_1 );
        }
