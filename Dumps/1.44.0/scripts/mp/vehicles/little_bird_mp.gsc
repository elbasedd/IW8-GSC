...
little_bird_mp_init()
{
    ...
    if ( istrue( level._id_1255A ) )
        scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird", "endEnterInternal", ::skiptofound );
}
...
little_bird_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_1328A( "little_bird", var_1, var_2 );
...
skiptofound( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level._id_1255A ) )
