...
init()
{
    ...
    registerscriptperk( "specialty_specialist_bonus", scripts\mp\perks\perkfunctions::_id_123DA, scripts\mp\perks\perkfunctions::_id_13020 );
    ...
    registerscriptperk( "specialty_chain_killstreaks", scripts\mp\perks\perkfunctions::_id_12364, scripts\mp\perks\perkfunctions::_id_1301B );
    ...
    registerscriptperk( "specialty_reduce_regen_delay_on_kill", scripts\mp\perks\perkfunctions::_id_123D1, scripts\mp\perks\perkfunctions::_id_1301E );
    ...
    registerscriptperk( "specialty_br_better_mission_rewards", scripts\mp\perks\perkfunctions::_id_12359, scripts\mp\perks\perkfunctions::_id_1301A );
    registerscriptperk( "specialty_br_extra_killstreak_chance" );
    registerscriptperk( "specialty_br_ping_on_damage", scripts\mp\perks\perkfunctions::_id_123B6, scripts\mp\perks\perkfunctions::_id_1301D );
    registerscriptperk( "specialty_br_stronger_armor", scripts\mp\perks\perkfunctions::_id_123DD, scripts\mp\perks\perkfunctions::_id_13021 );
...
initspecialistkillstreaks()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "specialist_perk_bonus", undefined, ::unset_vehicle_only_wave );
}
...
apc_rus_damagecancriticalhit()
{
    ...
    {
        var_2 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", istrue( var_1._id_1284D ), istrue( var_1.specialist ) );
...
giveperksafterspawn()
{
    ...
    if ( self.avoidkillstreakonspawntimer > 0 )
    {
        ...
        if ( istrue( self.inspawncamera ) )
            var_0 = var_0 + scripts\mp\spawncamera::oncontractend();
...
updateactiveperks( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    {
        var_1.setmapcirclesize = gettime();
