...
updatesharpfocus()
{
    ...
    var_1 = undefined;
    var_2 = scripts\mp\utility\weapon::_id_135A2( var_0 );
...
updatedefaultflinchreduction()
{
    ...
    var_0 = undefined;
    var_1 = scripts\mp\utility\weapon::_id_135A2( self.currentweapon );
...
ammodisabling_run( var_0 )
{
    ...
    scripts\engine\utility::_id_13403( 0.8, "death" );
...
setviewkickoverride()
{
    ...
    self.use_nvg_think = 0.05;
    self.use_struct = 0.08;
    self.use_respawn_rules = 0.02;
...
unsetviewkickoverride()
{
    ...
    self.use_nvg_think = undefined;
    self.use_struct = undefined;
    self.use_respawn_rules = undefined;
...
watchpainted( var_0, var_1 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_13403( var_1, "death" );
    self.painted = 0;
...
watchpaintedagain( var_0 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_133EF( "painted_again", "painted_end" );
    scripts\mp\utility\outline::outlinedisable( var_0, self );
}
...
boomtrackplayerdeath( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::_id_13403( 7.0, "death" );
...
unsetcustomjuicedondeath()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    scripts\engine\utility::_id_133EF( "death", "faux_spawn" );
...
unsetcustomjuicedonmatchend()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    level scripts\engine\utility::_id_133EF( "round_end_finished", "game_ended" );
    thread unsetcustomjuiced();
}
...
watchlifepackoutlinestate( var_0 )
{
    ...
    for (;;)
    {
        var_0 scripts\engine\utility::_id_133EF( "enabled_life_pack_boost", "disabled_life_pack_boost" );
        setlifepackoutlinestate( var_0 );
    }
}
...
{
    self endon( "death" );
    var_0 scripts\engine\utility::_id_133EF( "death_or_disconnect", "toughen_up_end" );
...
_id_1258D( var_0, var_1, var_2, var_3 )
{
    var_4 = var_1 - var_2;
    ...
    var_8 = scripts\engine\math::givematchplacementchallenge( var_7 );
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( var_2 && !isbot( var_8 ) )
        {
            ...
            foreach ( var_13 in var_11 )
            {
                ...
                if ( !var_8 _id_1258D( var_13, var_10, var_14, var_15 ) )
                    continue;

                var_9 = var_9 | var_8 onattackerdamagenottracked( var_13 );
            }
        }
        else
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                if ( _id_1258E( var_18, var_10, var_14 ) )
                {
                    var_3 = var_3 + 2;
                    var_20 = [ var_8 ];
        ...
        if ( scripts\mp\gametypes\br_gametypes.gsc::revive_stim( "sixthSenseThink" ) )
            var_9 = var_9 | scripts\mp\gametypes\br_gametypes.gsc::_id_1209E( "sixthSenseThink", var_8 );
...
onattackerdamagenottracked( var_0 )
{
...
setovercharge()
{
    thread scripts\mp\trials\trial_utility::_id_1236A( "ui_overcharge", 1 );
}

unsetovercharge()
{
    thread scripts\mp\trials\trial_utility::_id_1236A( "ui_overcharge", 0 );
}
...
outlinekillstreaks_enablemarksafterprematch()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        _applysalesdiscount::_id_131A6( self );
    }
}
...
{
    self giveweapon( self._id_12C64 );
    self assignweaponmeleeslot( self._id_12C64 );
    thread watchthrowingknifescavenge();

    if ( self._id_12C64 == "iw8_throwingknife_fire_melee_mp" )
        thread _id_13527();
    else if ( self._id_12C64 == "iw8_throwingknife_electric_melee_mp" )
        thread _id_13526();
}

unsetthrowingknifemelee()
{
    if ( isdefined( self._id_12C64 ) && self hasweapon( self._id_12C64 ) )
        self takeweapon( self._id_12C64 );

    self notify( "specialty_equip_throwingKnife_end" );

    if ( isdefined( self._id_12C64 ) && self._id_12C64 == "iw8_throwingknife_fire_melee_mp" )
        set_relic_aggressive_melee_params();
    else if ( isdefined( self._id_12C64 ) && self._id_12C64 == "iw8_throwingknife_electric_melee_mp" )
        set_relic_aggressive_melee();
}
...
{
    self.player scripts\engine\utility::_id_133EF( "disconnect", "unsetBulletOutline" );
...
markempsignatures( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_133EF( "death", "cloak_end" );
...
startgpsjammer()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\class::scramblebink( var_0 ) )
            continue;
...
open_sliding_door()
{
    ...
    if ( !isdefined( level.allowassassinationdamage ) || !isdefined( level.activeadvanceduavs ) )
        return var_0;
    ...
    if ( istrue( var_1 ) && getdvarint( "scr_uav_for_squad_only", 1 ) )
    {
        ...
        var_0 = level.allowassassinationdamage - var_2 > 0;
    }
    else
        var_0 = level.allowassassinationdamage - level.activeadvanceduavs[self.team] > 0;
...
{
    self endon( "groundPoundShield_deleteShield" );
    scripts\engine\utility::_id_133EF( "death_or_disconnect", "groundPound_unset" );
    thread groundpoundshield_deleteshield( var_0 );
}
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_133EF( "death_or_disconnect", "battleSlide_unset" );
    var_0 delete();
}
...
thrusterstopfx()
{
    self endon( "death_or_disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_133EF( "doubleJumpBoostEnd", "thruster_unset" );
    waitframe();
}
...
{
    scripts\engine\utility::_id_133EF( "ADSTargetMarkUnset", "death_or_disconnect" );
...
setkillstreaktoscorestreak()
{
    ...
    if ( isdefined( self.pers["killstreakToScorestreak_lifeId"] ) && self.pers["killstreakToScorestreak_lifeId"] == self.lifeid )
    {
        ...
        var_0 = set_player_hurt_trigger( self.streakpoints );
...
unsetkillstreaktoscorestreak()
{
    ...
    var_0 = set_player_munition_currency( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakcosts();
    scripts\mp\killstreaks\killstreaks::setstreakpoints( var_0 );
    scripts\mp\killstreaks\killstreaks::checkstreakreward( self.streakpoints, 1 );
    scripts\mp\killstreaks\killstreaks::updatestreakmeterui();
...
proximityrevivethink()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            if ( istrue( var_7.inlaststand ) && !istrue( var_7.stuckinlaststand ) && !istrue( var_7.laststandhealisactive ) && !istrue( var_7 scripts\mp\playerlogic::movenavobstaclemonitor() ) && !isdefined( var_0.owner ) )
        ...
        if ( isdefined( level.revivetriggers ) )
        {
            foreach ( var_10 in level.revivetriggers )
            {
                ...
                {
                    if ( !istrue( var_10.trigger.owner scripts\mp\playerlogic::movenavobstaclemonitor() ) && !isdefined( var_0.owner ) )
                    {
...
proximityrevive( var_0, var_1, var_2 )
{
    ...
    var_0 scripts\mp\playerlogic::_id_12358( 1 );
    var_1.owner = var_0;
...
watchproximityrevivefail( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 scripts\mp\playerlogic::_id_12358( 0 );
        var_0 scripts\mp\gameobjects::updateuiprogress( var_1, 0 );
        var_0 scripts\mp\utility\player::_freezecontrols( 0, undefined, "proximityRevive" );
...
_id_123D1()
{
    if ( isdefined( self.setmapcirclesize ) && self.setmapcirclesize == gettime() )
        regendelayreduce_onkill();
}
...
rechargeequipment_updateslot( var_0, var_1 )
{
    ...
    if ( isdefined( level.lootchopper_findunoccupiedpatrolzone ) )
        var_7 = level.lootchopper_findunoccupiedpatrolzone;
    else
    ...
    while ( isdefined( self.markequipmentstate.markingent ) && !istrue( self.ishacking ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( self.markequipmentstate.markedents, self.markequipmentstate.markingent ) )
        {
            if ( scripts\mp\utility\player::isplayerads() )
            {
                ...
                if ( level.teambased && _applysalesdiscount::_id_1319C( self.markequipmentstate.markingent ) )
                {
                    self.markequipmentstate.markingent._id_12BDA = self.team;
                    var_7 = scripts\mp\utility\player::getteamarray( self.markequipmentstate.markingent._id_12BDA );

                    foreach ( var_9 in var_7 )
                        _applysalesdiscount::_id_131A8( self.markequipmentstate.markingent, var_9 );
                }
...
unmarkafterduration( var_0 )
{
    ...
    scripts\engine\utility::_id_13409( var_1, "disconnect" );
    unmarkent( var_0 );
}
...
unmarkent( var_0 )
{
    ...
    if ( isdefined( var_0._id_12BDA ) )
    {
        if ( level.teambased && _applysalesdiscount::_id_1319C( var_0 ) )
        {
            var_1 = scripts\mp\utility\player::getteamarray( var_0._id_12BDA );

            foreach ( var_3 in var_1 )
                _applysalesdiscount::_id_131A8( var_0, var_3 );
        }

        var_0._id_12BDA = undefined;
    }
...
squadleaderbeacon_circleorigin( var_0, var_1 )
{
    var_2 = [];
...
markedentities_think()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( isdefined( self.markequipmentstate ) )
            {
                self.markequipmentstate.markedents = squadleaderbeacon_circleorigin( self.markequipmentstate.markedents, var_0 );
...
ground_detection_think()
{
    ...
    scripts\engine\utility::_id_133EF( "spawned_player", "disconnect" );

    if ( isdefined( self ) )
        self.player_has_ammo_crate = undefined;
...
_id_130BD( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::object_is_valid( var_0 );

    if ( !isdefined( level.calloutmarkerping_islethalequipment ) )
        level.calloutmarkerping_islethalequipment = [];

    var_2 = 0;

    if ( isdefined( level.calloutmarkerping_islethalequipment[var_0] ) )
        var_2 = level.calloutmarkerping_islethalequipment[var_0];

    var_3 = var_1 - var_2;

    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util.gsc::anyone_can_see_spawner( var_0, var_3 );

    level.calloutmarkerping_islethalequipment[var_0] = var_1;
}
...
_id_123B6()
{
    self.vo_stealth_exchange = spawnstruct();
    self.vo_stealth_exchange._id_12BA6 = [];
    self.vo_stealth_exchange.targetids = [];
    self.vo_stealth_exchange.vo_paratroopers = [];
    self.vo_stealth_exchange.get_total_successful_vehicle_spawns_from_module = 0;

    for ( var_0 = 0; var_0 < 4; var_0++ )
        self.vo_stealth_exchange.vo_paratroopers[var_0] = -1;
}

infil_lbravo_damage_monitor( var_0 )
{
    ...
    if ( isdefined( self.vo_stealth_exchange ) )
    {
        vo_ten_remain( var_0 );
...
vo_ten_remain( var_0 )
{
    ...
    if ( isdefined( var_0._id_12BA4 ) )
        return;

    var_6 = self.vo_stealth_exchange._id_12BA6[var_0 getentitynumber()];

    if ( !isdefined( var_6 ) )
    {
        self.vo_stealth_exchange._id_12BA6[var_0 getentitynumber()] = var_0;
        var_6 = var_0;
        var_7 = self.vo_stealth_exchange.get_total_successful_vehicle_spawns_from_module;
        self.vo_stealth_exchange.get_total_successful_vehicle_spawns_from_module = ( self.vo_stealth_exchange.get_total_successful_vehicle_spawns_from_module + 1 ) % 4;

        if ( isdefined( self.vo_stealth_exchange._id_12BA6[self.vo_stealth_exchange.vo_paratroopers[var_7]] ) )
        {
            var_8 = self.vo_stealth_exchange._id_12BA6[self.vo_stealth_exchange.vo_paratroopers[var_7]];
            self.vo_stealth_exchange.vo_paratroopers[var_7] = -1;
            var_8 thread vo_use_computer( var_8, var_8.headicon );
            thread vote_player_init( var_8 );
        }

        self.vo_stealth_exchange.vo_paratroopers[var_7] = var_0 getentitynumber();
        var_9 = scripts\mp\gametypes\br_public.gsc::ondefuse( self.team, self.squadindex );
        ...
        scripts\mp\gametypes\br_public.gsc::_id_11A87( "br_perk_advanced_scout_marking", self.team, var_0 );
        var_0 thread vocalloutstring( var_0, var_6.headicon );
        thread vote_player_reset( var_0 );
    }
}
...
vo_three_remain( var_0 )
{
    ...
    var_0 thread voqueue( var_1, var_0 );
}

vocalloutstring( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "disconnect" );
    var_2 = var_0 getentitynumber();
...
vote_player_reset( var_0 )
{
    ...
    if ( isdefined( self.vo_stealth_exchange ) && isdefined( self.vo_stealth_exchange._id_12BA6 ) )
    {
        var_2 = self.vo_stealth_exchange._id_12BA6[var_1];

        if ( isdefined( var_2 ) )
        {
            var_0._id_12BA4 = undefined;
            self.vo_stealth_exchange._id_12BA6[var_1] = undefined;
        }
    }

    foreach ( var_5, var_4 in self.vo_stealth_exchange.vo_paratroopers )
    {
        if ( var_4 == var_1 )
        {
            self.vo_stealth_exchange.vo_paratroopers[var_5] = -1;
            return;
        }
    }
}

vo_use_computer( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "disconnect" );
    var_2 = var_0 getentitynumber();
...
vote_player_set()
{
    ...
    if ( isdefined( self.sr_next_ammo_restock_time ) )
        return;

    self.sr_next_ammo_restock_time = 1;
    self iprintlnbold( &"KILLSTREAKS_HINTS/RECON_NO_MARK" );
    self playlocalsound( "br_perk_advanced_scout_marking_resist_plr", self );
    wait 1.0;
    self.sr_next_ammo_restock_time = undefined;
}

_id_1301D()
{
    if ( isdefined( self.vo_stealth_exchange._id_12BA6 ) && self.vo_stealth_exchange._id_12BA6.size > 0 )
    {
        foreach ( var_1 in self.vo_stealth_exchange._id_12BA6 )
            thread vote_player_init( var_1 );
    }

    self.vo_stealth_exchange = undefined;
    self notify( "pingOnDamageDeactivate" );
}

utilflare_shootflare( var_0 )
{
    var_1 = scripts\mp\gametypes\br_public.gsc::ondamagerelicsquadlink( self.team, self.squadindex, "ui_squad_reinforced_perk" );
    ...
    scripts\mp\gametypes\br_public.gsc::_id_123DB( self.team, self.squadindex, "ui_squad_reinforced_perk", var_4 );
...
_id_13021()
{
    ...
    if ( istrue( self.instantclassswapallowed ) )
        scripts\mp\gametypes\br_armor.gsc::participantplunder( 0 );

    utilflare_shootflare( 0 );
}
