...
hqmainloop()
{
    ...
    for (;;)
    {
        ...
        var_5 = level scripts\engine\utility::_id_133F7( "hq_captured", "hq_destroyed" );
...
onradiodestroy( var_0 )
{
    ...
    var_0 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "destroy", var_0.origin );
    ...
    if ( isdefined( level.radioobject ) )
    {
        ...
        if ( var_13 != var_10 )
        {
            if ( var_11 istouching( level.radioobject.trigger ) )
            {
                ...
                thread scripts\common\utility::_id_12ED6( level.stack_patch_thread_node.stadium_puzzle, var_9, "defending" );
            }
        }
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isplayer( var_5 ) )
    {
        ...
        {
            var_5 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "capture", var_5.origin );
