...
init()
{
    level.vehomn_getleveldata = spawnstruct();
    level.vehomn_getleveldata.settings = spawnstruct();
    level.vehomn_getleveldata.settings._id_11BEF = getdvarint( "scr_br_prop_hide_time", 30 );
    level.vehomn_getleveldata.settings._id_11C20 = getdvarint( "scr_br_prop_whistle_time", 30 );
    level.vehomn_getleveldata.settings._id_11BD9 = getdvarint( "scr_br_prop_num_changes", 2 );
    level.vehomn_getleveldata.settings._id_11C01 = getdvarint( "scr_br_prop_num_flahes", 1 );
    level.vehomn_getleveldata.settings._id_11C00 = getdvarint( "scr_br_prop_num_clones", 3 );
    level.vehomn_getleveldata.settings._id_11C11 = getdvarfloat( "scr_br_prop_speed_scale", 1.4 );
    level.vehomn_getleveldata.settings.supportbox_updateheadicon = getdvarint( "scr_br_prop_mode", 0 );
    level.vehomn_getleveldata.settings.trial_vehicle_outline_id = getdvarint( "scr_br_prop_hunters", 20 );
    level.vehomn_getleveldata.settings.trial_white_phosphorus_activate = getdvarint( "scr_br_prop_num_per_area", 30 );

    if ( level.vehomn_getleveldata.settings.supportbox_updateheadicon == 1 )
    {
        ...
        level.end_game_tutorial_func = ::vehomn_getleveldataforvehicle;
        level.next_threshold = ::nextareanags;
        level.lootcontentsadjusteconomy_bottomtier = ::lootcontentsadjusteconomy_bottomtier;
    }

    level.sandbox_combat_area_bits = 1;
    level.allowlatecomers = 1;
    level.brking_onplayerconnect = 1;
    level.custom_death_sound = ::wasflagspawned;
    level.helis_assault3_fob_check_size = ::helis_assault3_fob;
    level.enemy_targets_headshot = ::enemy_targets_headshot;
    scripts\mp\gametypes\br_gametypes.gsc::_id_11DDC( "onStartGameType", ::onstartgametype );
    scripts\mp\gametypes\br_gametypes.gsc::_id_11DDC( "modifyPlayerDamage", ::gamemodemodifyplayerdamage );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::_id_11DDC( "playerPreSpawnGulagJail", ::_id_11976 );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::helihint_wait( "squadLeader" );
    level.vehomn_getleveldata.sortbylastzombietime = [];
    level.vehomn_getleveldata._id_11BF4 = [];
    level.vehomn_getleveldata.ai_truck_rider_think = [ "FLASH", "CLONE" ];
    level thread usbserver();
...
relic_amped_reset_deathshield_on_revived()
{
    ...
    level.bypassclasschoicefunc = ::velstartid;
...
onstartgametype()
{
    if ( level.vehomn_getleveldata.settings.supportbox_updateheadicon == 1 )
    {
        if ( [[ level.end_game_tutorial_func ]]() )
        {
    ...
    level thread _id_1246D();
    level thread _id_11C10();
    level thread scripts\mp\gametypes\_prop_controls.gsc::playerstreamhintlocationinternal();
    level thread target_found_speed();
    level thread gunship_watchownerexitaction();
    level thread _id_123B5();
    level thread _id_12A0D();
    level thread _id_12D53();
    level thread _id_129D8();
}

onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    _id_11BEA( var_1.pers["team"] );
...
nextareanags( var_0, var_1 )
{
    ...
    if ( level.gameended )
    {
        ...
        if ( isdefined( level._id_135D0 ) && level._id_135D0 )
            var_3 = "teamScores";

        level._id_11C12 = "none";

        if ( game[var_3]["allies"] == game[var_3]["axis"] )
        {
            level._id_11C12 = "kills";

            if ( game["propScore"]["axis"] == game["propScore"]["allies"] )
            {
                level._id_11C12 = "time";
            ...
            if ( var_2 != "tie" )
                level thread parachutecancutparachute( var_2 );
        }
...
setspecialloadouts()
{
    ...
    level.vehomn_hidecontrols[var_0] = needs_antenna();
    var_1 = game["attackers"];
    level.vehomn_hidecontrols[var_1] = needs_antenna();
    level.vehomn_hidecontrols[var_1]["loadoutPrimary"] = "iw8_ar_akilo47";
    level.vehomn_hidecontrols[var_1]["loadoutPrimaryAttachment"] = "xmags";
    level.vehomn_hidecontrols[var_1]["loadoutPrimaryAttachment2"] = "laser";
    level.vehomn_hidecontrols[var_1]["loadoutSecondary"] = "iw8_pi_mike1911";
    level.vehomn_hidecontrols[var_1]["loadoutEquipmentSecondary"] = "equip_concussion";
    level.vehomn_hidecontrols[var_1]["loadoutPerks"] = [ "specialty_restock", "specialty_hustle" ];
}
...
velstartid()
{
    ...
    self.pers["lastClass"] = "";
    self.pers["gamemodeLoadout"] = level.vehomn_hidecontrols[self.pers["team"]];
...
_id_1246D()
{
    if ( _id_13120() && level.vehomn_getleveldata.settings._id_11BEF > 0 )
    {
        level.vehomn_getleveldata.gas_emit_vfx = scripts\mp\hud_util::createservertimer( "default", 1.4 );
        level.vehomn_getleveldata.gas_emit_vfx scripts\mp\hud_util::setpoint( "CENTER", undefined, 0, 50 );
        level.vehomn_getleveldata.gas_emit_vfx.label = &"MP_PH/STARTS_IN";
        level.vehomn_getleveldata.gas_emit_vfx.alpha = 0;
        level.vehomn_getleveldata.gas_emit_vfx.archived = 0;
        level.vehomn_getleveldata.gas_emit_vfx.hidewheninmenu = 1;
        level.vehomn_getleveldata.gas_emit_vfx.sort = 1;
    }

    if ( _id_13120() )
    {
        level.vehomn_getleveldata._id_135CC = scripts\mp\hud_util::createservertimer( "default", 0.9 );
        level.vehomn_getleveldata._id_135CC.x = -6;
        level.vehomn_getleveldata._id_135CC.y = 2;
        level.vehomn_getleveldata._id_135CC.alignx = "right";
        level.vehomn_getleveldata._id_135CC.aligny = "top";
        level.vehomn_getleveldata._id_135CC.horzalign = "right_adjustable";
        level.vehomn_getleveldata._id_135CC.vertalign = "top_adjustable";
        level.vehomn_getleveldata._id_135CC.label = &"MP_PH/WHISTLE_IN";
        level.vehomn_getleveldata._id_135CC.alpha = 0;
        level.vehomn_getleveldata._id_135CC.archived = 1;
        level.vehomn_getleveldata._id_135CC.hidewheninmenu = 1;
        level.vehomn_getleveldata._id_135CC settimer( 120 );
    }
    else
        _id_135CA( 120 );
    ...
    if ( _id_13120() )
    {
        level._id_135CD = get_next_open_stop( "default", 1 );
        level._id_135CD.label = &"MP_PH/WHISTLING";
        level._id_135CD.x = -5;
        level._id_135CD.y = 2;
        level._id_135CD.alignx = "right";
        level._id_135CD.aligny = "top";
        level._id_135CD.horzalign = "right_adjustable";
        level._id_135CD.vertalign = "top_adjustable";
        level._id_135CD.archived = 1;
        level._id_135CD.alpha = 0;
        level._id_135CD.glowalpha = 0.2;
        level._id_135CD.hidewheninmenu = 0;
    }

    if ( _id_13120() )
    {
        if ( !isdefined( level.initbunkerbackwallkeypads ) )
            level.initbunkerbackwallkeypads = [];

        level.initbunkerbackwallkeypads = get_next_open_stop( "default", 0.9 );
        level.initbunkerbackwallkeypads.label = &"MP_PH/ALIVE";
        level.initbunkerbackwallkeypads setvalue( 0 );
        level.initbunkerbackwallkeypads.x = -5;
        level.initbunkerbackwallkeypads.y = 14;
        level.initbunkerbackwallkeypads.alignx = "right";
        level.initbunkerbackwallkeypads.aligny = "top";
        level.initbunkerbackwallkeypads.horzalign = "right_adjustable";
        level.initbunkerbackwallkeypads.vertalign = "top_adjustable";
        level.initbunkerbackwallkeypads.archived = 1;
        level.initbunkerbackwallkeypads.fontscale = 1.0;
        level.initbunkerbackwallkeypads.alpha = 1;
        level.initbunkerbackwallkeypads.glowalpha = 0;
        level.initbunkerbackwallkeypads.hidewheninmenu = 0;
        level thread initchallengeandeventglobals();
    }
}
...
initchallengeandeventglobals()
{
    ...
    for (;;)
    {
        var_0 = manualadjustlittlebirdlocs( game["defenders"] );
        level.initbunkerbackwallkeypads setvalue( var_0.size );
        level scripts\engine\utility::_id_133F2( "player_spawned", "playerCountChanged", "propCountChanged", "playerDisconnected" );
    }
}
...
onplayerdisconnect( var_0 )
{
    ...
    if ( isdefined( var_0._id_11BF5 ) )
        var_0 _id_11C04();
    else if ( isdefined( var_0._id_11BDB ) )
        var_0 _id_11C03();
}

seq3_gate( var_0, var_1 )
{
    if ( isbot( var_0 ) )
        return;
...
_id_135B7()
{
    var_0 = scripts\engine\utility::_id_133F9( "weapon_fired", "sprint_begin", "specialGrenade", "end_weapon_check_usage" );

    if ( var_0 == "end_weapon_check_usage" )
    {
        if ( istrue( self.player_in_heli ) )
            return 1;

        seq3_gate( self, "EXE_PLAYERKICKED_INACTIVE" );
        return 0;
    }
...
_id_129AE()
{
    level endon( "game_ended" );
    self endon( "death_or_disconnect" );
    self.hvt_visual_leaving_callout = 1;
    _id_13438();
    childthread _id_135B7();
...
onspawnplayer()
{
    ...
    {
        self._id_125A6 = 1;
        self.overrideweaponspeed_speedscale = level.vehomn_getleveldata.settings._id_11C11;

        if ( !isdefined( self.ai_weapons_free ) )
            self.ai_weapons_free = 0;

        if ( !isdefined( self.firstinfectedsplash ) )
            self.firstinfectedsplash = 0;

        if ( !isdefined( self.pers["ability"] ) )
            self.pers["ability"] = 0;

        self.get_start_ang = level.vehomn_getleveldata.ai_truck_rider_think[self.pers["ability"]];

        if ( _id_13120() )
            thread scripts\mp\gametypes\_prop_controls.gsc::_id_11BE2();

        self.respawntokenclosewithgulag = 0;
        var_0 = int( level.vehomn_getleveldata.settings._id_11BD9 );
        var_1 = undefined;
        var_2 = undefined;

        if ( isdefined( self._id_127C9 ) && isdefined( self.elements_hidden ) )
        {
            var_0 = self.elements_hidden;
            var_1 = self.ai_weapons_free;
            var_2 = self.firstinfectedsplash;
        }

        scripts\mp\gametypes\_prop_controls.gsc::_id_11C07( var_0 );
        scripts\mp\gametypes\_prop_controls.gsc::_id_1239B( self.get_start_ang, var_1 );
        scripts\mp\gametypes\_prop_controls.gsc::_id_1239B( "CLONE", var_2 );
        thread scripts\mp\gametypes\_prop_controls.gsc::fake_magic_grenade_watch_individual();
        thread playboxuseanimation();
    }
    else
    {
        self._id_125A6 = undefined;
        self.ai_weapons_free = undefined;
        self.firstinfectedsplash = undefined;
        self.overrideweaponspeed_speedscale = undefined;

        if ( !isdefined( self._id_12C66 ) )
            self._id_12C66 = 0;

        thread paired_lasers();
        var_3 = 1;

        if ( var_3 && !isdefined( self.hvt_visual_leaving_callout ) )
            thread _id_129AE();
    }
...
target_found_speed()
{
    ...
    if ( _id_13120() )
    {
        if ( level.vehomn_getleveldata.settings._id_11BEF > 0 )
        {
            level.vehomn_getleveldata.gas_emit_vfx settimer( level.vehomn_getleveldata.settings._id_11BEF );
            level.vehomn_getleveldata.gas_emit_vfx.alpha = 1;
        }

        level.vehomn_getleveldata._id_135CC settimer( level.vehomn_getleveldata.settings._id_11C20 + level.vehomn_getleveldata.settings._id_11BEF );
        level.vehomn_getleveldata._id_135CC.alpha = 1;
    }
    else if ( level.vehomn_getleveldata.settings._id_11BEF > 0 || level.vehomn_getleveldata.settings._id_11C20 > 0 )
        _id_135CA( level.vehomn_getleveldata.settings._id_11C20 + level.vehomn_getleveldata.settings._id_11BEF );

    if ( level.vehomn_getleveldata.settings._id_11BEF > 0 )
        wait( level.vehomn_getleveldata.settings._id_11BEF );
    ...
    if ( level.vehomn_getleveldata.settings._id_11C20 > 0 )
        _id_11C1F();
}
...
playboxuseanimation()
{
    ...
    thread _id_1246A();
    thread scripts\mp\gametypes\_prop_controls.gsc::_id_1245C();
    thread _id_1243F();
    thread scripts\mp\gametypes\_prop_controls.gsc::_id_11BF2();
    thread _id_11C1D();
    thread _id_11C1B();
    thread _id_11C1C();
    thread _id_11C1E();
    self.prop thread playerwatchspectate( game["defenders"], "outline_nodepth_cyan", self );
    self.friendly_hvi_vehicle_extra_riders_intro_scene = undefined;
}
...
bot_loadout()
{
    if ( !isdefined( self.prop._id_1368A ) )
        return;

    self.prop.angles = self.angles;
    var_0 = anglestoforward( self.prop.angles ) * self.prop._id_1368A[0];
    var_1 = anglestoright( self.prop.angles ) * self.prop._id_1368A[1];
    var_2 = anglestoup( self.prop.angles ) * self.prop._id_1368A[2];
...
{
    if ( !isdefined( self.prop.bot_abort_tactical_goal_for_revive ) )
        return;

    self.prop.angles = self.angles;
    self.prop.angles = self.prop.angles + self.prop.bot_abort_tactical_goal_for_revive;
    self.respawntokenclosewithgulag = 1;
}
...
gettimeremaining()
{
    ...
    if ( isdefined( level.br_level ) && isdefined( level.br_level.circleradius ) )
    {
        ...
        var_0 = var_0 * 1000;
        var_4 = gettime() - level.vehomn_getleveldata.settings._id_135C9;
        var_0 = var_0 - var_4;
...
{
    level endon( "game_ended" );
    level.vehomn_getleveldata.settings._id_135C9 = gettime();
    var_0 = gettime();
    var_1 = level.vehomn_getleveldata.settings._id_11C20 * 1000;
    var_2 = 20000;
    var_3 = var_2;
    var_4 = 500;
    var_5 = 5000;
    ...
    wait( level.vehomn_getleveldata.settings._id_11C20 );
    ...
    for (;;)
    {
        if ( var_0 + var_1 - var_4 < gettime() )
        {
            ...
            foreach ( var_10 in var_8 )
            {
                ...
                {
                    level.vehomn_getleveldata._id_135CC.alpha = 0;
                    level._id_135CD.alpha = 0.6;
                }

                if ( var_10 zombieingas() && isalive( var_10 ) )
                {
                    if ( _id_13120() )
                    {
                        level._id_135CD.alpha = 1;
                        level._id_135CD fadeovertime( 0.75 );
                        level._id_135CD.alpha = 0.6;
                    }
            ...
            else
            {
                ...
                {
                    if ( _id_13120() )
                        level.vehomn_getleveldata._id_135CC.label = &"MP_PH/FINAL_WHISTLE";
                    else
                ...
                if ( _id_13120() )
                    level.vehomn_getleveldata._id_135CC settimer( int( var_1 / 1000 ) );
                else
                    _id_135CA( int( var_1 / 1000 ) );
...
get_max_from_call_count()
{
    self._id_12853 = nuke_hostmigration_waitlongdurationwithpause( game["defenders"] );
}
    ...
    if ( isplayer( var_0.attacker ) )
    {
        ...
        if ( var_0.objweapon.basename == "concussion_grenade_mp" )
        {
            ...
            if ( istrue( self.owner.lock ) )
                self.owner scripts\mp\gametypes\_prop_controls.gsc::_id_12FD4();
        }
    }
...
_id_11BDD()
{
    thread _id_11BDE( [ self.prop, self._id_11BD5, self._id_11BE7 ] );
}
...
_id_11C1D()
{
    ...
    self.getnextcombatareaid = "prop_death";
    self._id_11BE3 = "propDeathFX";
    self waittill( "death" );
    var_0 = self.body;
    playsoundatpos( self.prop.origin + ( 0, 0, 4 ), self.getnextcombatareaid );
    playfx( scripts\engine\utility::getfx( self._id_11BE3 ), self.prop.origin + ( 0, 0, 4 ) );
...
_id_11C1B()
{
    ...
    {
        if ( istrue( var_1._id_11C10 ) && isdefined( var_1._id_1285B ) && self == var_1._id_1285B )
...
_id_11BDF()
{
    ...
    {
        foreach ( var_1 in self._id_11BE1 )
        {
            if ( isdefined( var_1 ) )
                var_1 delete();
        }
...
updateleadmarkers()
{
    foreach ( var_5, var_1 in level.vehomn_getleveldata._id_11BF4 )
    {
        if ( var_5 != "any" )
        {
            foreach ( var_4, var_3 in level.vehomn_getleveldata._id_11BF4["any"] )
                level.vehomn_getleveldata._id_11BF4[var_5][var_4] = scripts\engine\utility::array_combine( level.vehomn_getleveldata._id_11BF4[var_5][var_4], var_3 );
        }
    }
}
...
_id_11CDE( var_0 )
{
    var_1 = level.vehomn_getleveldata._id_11BF4[var_0];
...
num_shot_taken_to_next_damage_state( var_0 )
{
    var_1 = var_0 _id_11BE9();
    var_2 = level.vehomn_getleveldata._id_11BF4[var_1];
    var_3 = _id_11CDE( var_1 );
    ...
    for ( var_10 = 0; var_10 < var_5.size; var_10++ )
    {
        ...
        for ( var_12 = 0; var_12 < var_11.size; var_12++ )
        {
            ...
            if ( isdefined( var_0._id_13101 ) && var_0._id_13101.size )
            {
                for ( var_14 = 0; var_14 < var_0._id_13101.size; var_14++ )
                {
                    if ( var_9.modelname == var_0._id_13101[var_14].modelname )
                    {
                        var_13 = 1;
                        break;
                    }
...
_id_11AFE()
{
    ...
    if ( tableexists( var_1 ) )
    {
        ...
        for ( var_3 = 0; var_3 < var_2; var_3++ )
        {
            ...
            if ( var_4 == "prop" )
            {
                ...
                var_18 = obj_room_fire_10( var_6 );

                if ( !isdefined( var_13 ) || var_13 == "" )
                    var_13 = onpickupitem( var_18 );
                else
                    var_13 = int( var_13 );

                if ( !isdefined( var_14 ) || var_14 == "" )
                    var_14 = onping( var_18 );
                else
                    var_14 = int( var_14 );

                any_rider_still_alive_at_seat( var_5, var_18, var_16, var_17, var_6, var_13, var_14, var_15 );
                continue;
            }
            ...
            if ( var_4 == "loc" )
            {
                ...
                registerquestcategorytablevalues( var_15, var_19, var_20, var_21 );
                continue;
            }
        }
    }
    ...
    if ( var_2 == 0 )
        any_rider_still_alive_at_seat( "tag_origin", 250, ( 0, 0, 0 ), ( 0, 0, 0 ), "medium", onpickupitem( 250 ), onping( 250 ), "any" );
...
_id_1246A()
{
    var_0 = self._id_11BF1;

    if ( !isdefined( var_0 ) )
        var_0 = num_shot_taken_to_next_damage_state( self );

    self._id_11BD5 = spawn( "script_model", self.origin );
    self._id_11BD5.targetname = "propAnchor";
    self._id_11BD5 linkto( self );
    self._id_11BE7 = spawn( "script_model", self.origin );
    self._id_11BE7 setmodel( "generic_prop_raven_x3" );
    self._id_11BE7.targetname = "propEnt";
    self._id_11BE7 linkto( self._id_11BD5 );
    self.prop = spawn( "script_model", self._id_11BE7.origin );
    ...
    self._id_11BE7 scriptmodelplayanim( "prop_hunt_prop_spin", "propSpinAnim", undefined, 1.5 );
    ...
    if ( !isdefined( self._id_127C9 ) )
        self._id_13101 = [];

    self.maxhealth = obj_room_fire_08( var_0 );
...
any_rider_still_alive_at_seat( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( !isdefined( level.vehomn_getleveldata._id_11BF4[var_7] ) )
        level.vehomn_getleveldata._id_11BF4[var_7] = [];

    if ( !isdefined( level.vehomn_getleveldata._id_11BF4[var_7][var_1] ) )
        level.vehomn_getleveldata._id_11BF4[var_7][var_1] = [];

    var_8 = spawnstruct();
    var_8.modelname = var_0;
    var_8._id_11C0A = int( var_1 );
    var_8._id_11C0B = var_4;
    var_8.location = var_7;

    if ( isdefined( var_2 ) )
        var_8._id_1368A = var_2;

    if ( isdefined( var_3 ) )
        var_8.bot_abort_tactical_goal_for_revive = var_3;

    var_8._id_11C02 = var_6;
    var_8._id_11BEE = var_5;
    var_10 = level.vehomn_getleveldata._id_11BF4[var_7][var_1].size;
    level.vehomn_getleveldata._id_11BF4[var_7][var_1][var_10] = var_8;
}

vehomn_getrotationentangles( var_0, var_1 )
{
    if ( istrue( level.intro_techos_deposit_backseats ) )
        return;

    level.intro_techos_deposit_backseats = 1;
    vehomn_showcontrols( var_0 );
    thread scripts\mp\gamelogic::endgame( var_0, var_1 );
    level thread parachutecancutparachute( var_0 );
}
...
parachutecancutparachute( var_0 )
{
    level endon( "game_ended" );
...
ontimelimit()
{
    if ( !istrue( level.lootcachesopened ) )
    {
        ...
        enter_numbers_end();
        vehomn_getrotationentangles( game["defenders"], game["end_reason"]["time_limit_reached"] );
    }
}

enter_numbers_end()
{
    var_0 = nuke_hostmigration_waitlongdurationwithpause( game["defenders"] );

    if ( var_0.size < 1 )
        return;

    var_1 = nuke_hostmigration_waitlongdurationwithpause( game["attackers"] );

    if ( var_1.size < 1 )
        return;

    var_2 = enter_combat_after_call( var_0, var_1 );
...
enter_combat_after_call( var_0, var_1 )
{
    var_2 = undefined;
    var_3 = 1073741824;
...
paired_lasers()
{
    ...
    self playershow();
    self.friendly_hvi_vehicle_extra_riders_intro_scene = 1;
...
_id_12A0D()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level.players )
        {
            ...
            if ( !var_1 zombieingas() )
                continue;

            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) )
                continue;

            var_1 thread padcorner3to0dist( "still_alive" );

            switch ( var_1.prop.info._id_11C0A )
            {
                case 250:
                    var_1 thread padcorner3to0dist( "still_alive_medium_bonus" );
                    break;
                case 450:
                    var_1 thread padcorner3to0dist( "still_alive_large_bonus" );
                    break;
                case 550:
                    var_1 thread padcorner3to0dist( "still_alive_extra_large_bonus" );
                    break;
                default:
                    break;
            }
...
gamemodemodifyplayerdamage( var_0 )
{
    ...
    {
        if ( var_0.victim zombieingas() )
            var_1 = swayingcrate( var_0 );
        else
            var_1 = swayingcord( var_0 );
    ...
    {
        if ( !isdefined( var_0.attacker.player_in_heli ) )
            var_0.attacker.player_in_heli = 1;
...
brgetloadoutoptionforname()
{
    ...
    var_4 = var_4 - self._id_12C66;
    var_4 = int( max( var_4, 0 ) );
    self setweaponammostock( "concussion_grenade_mp", var_4 );

    if ( var_4 > 0 )
        thread scripts\mp\gametypes\_prop_controls.gsc::_id_13520();
}
...
end_node()
{
    ...
    {
        self.pers["lives"]--;
        level.slamcamoverlay[self.team]--;
...
onplayerkilled( var_0 )
{
    ...
    if ( var_1 )
        var_0.attacker thread weapon_xp_iw8_sn_awhiskey( "prop_finalblow" );

    foreach ( var_3 in level.players )
    {
        if ( istrue( var_3._id_11C10 ) && isdefined( var_3._id_1285B ) && var_0.victim == var_3._id_1285B )
            var_3 notify( "endPropSpectate" );

        if ( var_3 != var_0.attacker && var_3 zombieingas() && isalive( var_3 ) && var_0.victim zombieingas() )
            var_3 thread weapon_xp_iw8_sn_awhiskey( "prop_survived" );
    }
}

weapon_xp_iw8_sn_awhiskey( var_0 )
{
    var_1 = undefined;
...
ondeadevent( var_0 )
{
    if ( var_0 == game["defenders"] )
        level thread _id_11BF3();
}

onplayerjointeam( var_0 )
{
    if ( level.teambased )
        var_0 scripts\mp\gametypes\br.gsc::_id_123C4( 1 );

    if ( !var_0 zombieingas() )
    {
        if ( isdefined( var_0._id_11BF5 ) )
            var_0 _id_11C04();
        else if ( isdefined( var_0._id_11BDB ) )
...
_id_11BF3()
{
    if ( istrue( level.plundertotal ) )
        return;

    if ( istrue( level.lootcachesopened ) )
        return;

    level.plundertotal = 1;
    var_0 = scripts\mp\utility\game::gettimepassed();
    game["propSurvivalTime"][game["defenders"]] = game["propSurvivalTime"][game["defenders"]] + var_0;
    game["hunterKillTime"][game["attackers"]] = game["hunterKillTime"][game["attackers"]] + var_0;
    level.lootcachesopened = 1;
    wait 3;
    thread vehomn_getrotationentangles( game["attackers"], game["end_reason"][game["defenders"] + "_eliminated"] );
}

wasflagspawned( var_0, var_1, var_2 )
{
...
lootcontentsadjusteconomy_bottomtier( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_3 ) && isdefined( level._id_11C12 ) )
    {
        if ( level._id_11C12 == "kills" )
        {
...
_id_11A16()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_133F8( "joined_spectators", "spectating_cycle", "death" );
...
playerwelcomesplashes( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_3 ) )
        var_3 = 1;
...
playerwatchspectate( var_0, var_1, var_2, var_3 )
{
...
enemy_targets_headshot( var_0 )
{
    foreach ( var_2 in level.players )
    {
        if ( var_2 zombieingas() )
        {
            if ( isdefined( var_2._id_127E9 ) && isdefined( var_2._id_127E9.spawnpoint ) && var_2._id_127E9.spawnpoint == var_0 )
                return 0;
        }
    }
...
_id_119CA( var_0 )
{
    return zombieingas() || level.proper_damage;
}

padcorner3to0dist( var_0 )
{
...
vehicle_occupancy_mp_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !istrue( var_3.playerdisconnect ) && !istrue( var_3.playerdeath ) && var_2 zombieingas() )
        var_2 setcamerathirdperson( 1, var_2._id_12C4A, var_2._id_12C49 );
}
...
nogroundfoundtime()
{
    ...
    var_1 = level.vehomn_getleveldata.settings.trial_vehicle_outline_id;
    ...
    thread _id_12459( var_3 );
    thread _id_1246B( var_4 );
    return var_3;
}

weapondrop_createdropondeath()
{
    self endon( "disconnect" );
    self notify( "death_or_disconnect" );
    self notify( "death" );
    waittillframeend;
    scripts\mp\gametypes\br_infils.gsc::prophasflashesleft();
}
...
_id_12459( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( var_2 zombieingas() )
        {
            ...
            var_2 thread weapondrop_createdropondeath();
        }
...
obj_room_fire_09()
{
    if ( !isdefined( level.vehomn_getleveldata.settings._id_11CF3 ) )
        level.vehomn_getleveldata.settings._id_11CF3 = randomint( level.vehomn_getleveldata.sortbylastzombietime.size );
    else
        level.vehomn_getleveldata.settings._id_11CF3 = ( level.vehomn_getleveldata.settings._id_11CF3 + 1 ) % level.vehomn_getleveldata.sortbylastzombietime.size;

    var_0 = level.vehomn_getleveldata.sortbylastzombietime[level.vehomn_getleveldata.settings._id_11CF3];
    return var_0;
}

obj_room_fire_11( var_0, var_1 )
{
    var_2 = 10;
    var_3 = 200.0;
    var_4 = 100.0;
...
_id_133B1( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        ...
        var_2 scripts\mp\gametypes\br_infils.gsc::investigate_someone_using_bomb();

        if ( !var_2 zombieingas() )
        {
            var_2 _id_119ED();
            var_2.forcespawnorigin = var_2._id_11C0C;
            var_2 thread weapondrop_createdropondeath();
        }
        else if ( !isalive( var_2 ) )
        {
            var_2.forcespawnorigin = var_2._id_11C0C;
            var_2 scripts\mp\gametypes\br_infils.gsc::prophasflashesleft();
        }
        else
        {
            var_2 _id_119F2( var_2._id_11C0C );
            var_2.br_infilstarted = 1;
            var_2 scripts\mp\gametypes\_prop_controls.gsc::_id_11BD8( 1 );
            var_2 scripts\mp\gametypes\_prop_controls.gsc::_id_11C07( int( level.vehomn_getleveldata.settings._id_11BD9 ) );
            var_2 scripts\mp\gametypes\_prop_controls.gsc::_id_1239B( var_2.get_start_ang );
            var_2 scripts\mp\gametypes\_prop_controls.gsc::_id_1239B( "CLONE" );
        }
...
_id_1246B( var_0 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        var_5 = obj_room_fire_11( var_2, var_1.origin );
        var_4._id_11C0C = var_5;
        var_2++;

        if ( var_2 >= level.vehomn_getleveldata.settings.trial_white_phosphorus_activate )
        {
            var_1 = obj_room_fire_09();
            var_2 = 0;
        }
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        var_4 predictstreampos( var_4._id_11C0C, 1 );
    }
...
registerquestcategorytablevalues( var_0, var_1, var_2, var_3 )
{
    ...
    level.vehomn_getleveldata.sortbylastzombietime[level.vehomn_getleveldata.sortbylastzombietime.size] = var_4;
}

relic_amped_victim()
{
    level.vehomn_getleveldata._id_11BDC = [];
    var_0 = level.maxteamsize - level.vehomn_getleveldata.settings.trial_vehicle_outline_id;

    for ( var_1 = 0; var_1 < var_0; var_1++ )
    {
        level.vehomn_getleveldata._id_11BDC[var_1] = getmaxobjectivecount( 0, 0, 500 );
        level.vehomn_getleveldata._id_11BDC[var_1] setmapcirclecolorindex( 1 );
        level.vehomn_getleveldata._id_11BDC[var_1] hide( 1 );
        level.vehomn_getleveldata._id_11BDC[var_1].inuse = 0;
        level.vehomn_getleveldata._id_11BDC[var_1].count = 0;
        level.vehomn_getleveldata._id_11BDC[var_1].radius = 500;
        level.vehomn_getleveldata._id_11BDC[var_1]._id_11CD0 = 250000;
    }
}
...
_id_129D8()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.vehomn_getleveldata.killstreak_update_hint_logic ) )
            var_1 = level.vehomn_getleveldata.killstreak_update_hint_logic;

        foreach ( var_3 in var_1 )
        {
            if ( isdefined( var_3._id_11BF5 ) )
            {
                var_4 = level.vehomn_getleveldata.sortbylastzombietime[var_3._id_11BF5];
                var_5 = distance2dsquared( var_4.origin, var_3.origin );

                if ( var_5 <= var_4._id_11CD0 )
                    continue;
                else
                    var_3 _id_11C04();
            }
            else if ( isdefined( var_3._id_11BDB ) )
            {
                var_6 = level.vehomn_getleveldata._id_11BDC[var_3._id_11BDB];
                var_5 = distance2dsquared( var_6.origin, var_3.origin );

                if ( var_5 > var_6._id_11CD0 )
                    var_3 _id_11C03();
            }
            ...
            for ( var_9 = 0; var_9 < level.vehomn_getleveldata.sortbylastzombietime.size; var_9++ )
            {
                var_4 = level.vehomn_getleveldata.sortbylastzombietime[var_9];
                var_5 = distance2dsquared( var_4.origin, var_3.origin );

                if ( var_5 <= var_4._id_11CD0 && ( !isdefined( var_8 ) || var_5 < var_8 ) )
                {
                    var_8 = var_5;
                    var_7 = var_9;
                }
            ...
            if ( isdefined( var_7 ) )
            {
                if ( isdefined( var_3._id_11BDB ) )
                    var_3 _id_11C03();

                var_3 _id_11BD4( var_7 );
                continue;
            }
...
_id_11BE9()
{
    if ( isdefined( self._id_11BF5 ) )
        return level.vehomn_getleveldata.sortbylastzombietime[self._id_11BF5].name;
...
_id_11BD4( var_0 )
{
    self._id_11BF5 = var_0;
    var_1 = level.vehomn_getleveldata.sortbylastzombietime[var_0];
    var_1.count++;
...
_id_11C04()
{
    ...
    self._id_11BF5 = undefined;
}

_id_11BD3()
{
    var_0 = num_of_frame_frozen();
    self._id_11BDB = var_0;
    var_1 = level.vehomn_getleveldata._id_11BDC[var_0];
    var_1.count++;
...
num_of_frame_frozen()
{
    for ( var_0 = 0; var_0 < level.vehomn_getleveldata._id_11BDC.size; var_0++ )
    {
        var_1 = level.vehomn_getleveldata._id_11BDC[var_0];
