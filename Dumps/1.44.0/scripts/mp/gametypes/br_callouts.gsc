...
init()
{
    level.calloutglobals.tr_entergulag = [];
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            level.calloutglobals.tr_entergulag[var_11] = var_12;
        }
...
nuke_mercyending_init( var_0 )
{
    var_1 = "";

    foreach ( var_4, var_3 in level.calloutglobals.tr_entergulag )
    {
...
nuke_killplayerwithattacker( var_0 )
{
    var_1 = "none";
    var_2 = -1;
    var_3 = 144000000;
    ...
    foreach ( var_11, var_9 in level.calloutglobals.tr_entergulag )
    {
