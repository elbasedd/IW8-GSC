...
main()
{
    ...
    level.dlog_analytics_init = ::dlog_analytics_init;
...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::spawn_boss_wave_section( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
getnextzone()
{
    ...
    else if ( isdefined( level._id_11E86 ) )
    {
        level.prevzoneindex++;
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::spawn_boss_wave_section( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
setupzones()
{
    ...
    var_0 = lb_impulse_dmg_threshold_mid( var_0 );
    var_1 = [];
    var_2 = 0;
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.assisttouchlist ) )
    {
        ...
        if ( var_5.assisttouchlist[var_2].size > 0 )
            var_5 thread parachute_deploy( var_2 );
    }
}
