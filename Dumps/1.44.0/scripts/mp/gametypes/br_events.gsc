...
completepayloadpunish()
{
    ...
    thread _id_1209D( var_0 );
}

completepayloadexfilobjective( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;

    if ( istrue( var_0.clean_up_search ) || !isalive( var_0 ) || istrue( var_0.gulag ) )
        return 0;
...
_id_1209D( var_0 )
{
    ...
    {
        if ( !completepayloadexfilobjective( var_7 ) )
            continue;
