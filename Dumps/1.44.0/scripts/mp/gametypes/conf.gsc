...
updategametypedvars()
{
    ...
    level.set_number_of_subway_cars_on_track = scripts\mp\utility\dvars::dvarintvalue( "killstreakConfirmed", 0, 0, 1 );
}
...
dogtagenemyonusecb( var_0 )
{
    if ( isplayer( var_0 ) )
    {
        ...
        if ( istrue( level.set_number_of_subway_cars_on_track ) )
        {
