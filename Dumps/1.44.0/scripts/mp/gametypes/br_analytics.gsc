...
close_doors()
{
    level.stack_patch_thread = ::unset_relic_aggressive_melee_params;

    if ( getdvarint( "NNNQSOPLKR", 0 ) )
    {
        level.grenadeboxes_init = [];
        analyticsaddevent();
    }
}
...
{
    return isdefined( level.grenadeboxes_init );
}
...
_utilflare_isvalidflaretype()
{
    ...
    if ( !isdefined( level._id_11B60 ) )
        var_0 = 0;
    else
        var_0 = var_0 - level._id_11B60;

    return var_0;
}

_tryusehoverjetfromstructinternal( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_1 ) )
        var_1 = ( 0, 0, 0 );
    ...
    var_4 = _utilflare_isvalidflaretype();
...
_utilflare_flareexplode( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_3 ) )
        var_3 = "";

    if ( !isdefined( level.grenadeboxes_init[var_0] ) )
        level.grenadeboxes_init[var_0] = [];
    ...
    var_4.data = var_3;
    var_4.state = 0;
    var_4.time = _utilflare_isvalidflaretype();
    var_5 = level.grenadeboxes_init[var_0].size;
    level.grenadeboxes_init[var_0][var_5] = var_4;
}

cluster_child_spawnpoint_scoring( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) || !isdefined( level.grenadeboxes_init ) || !isdefined( level.grenadeboxes_init[var_0] ) )
        return;

    foreach ( var_4 in level.grenadeboxes_init[var_0] )
    {
        if ( var_4.ent == var_1 )
        {
            var_4.time = _utilflare_isvalidflaretype();
...
branalytics_down( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_18 = _utilflare_lerpflare( [], var_1, "victim" );
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "down", var_1.origin, add_pilot_setup( var_3 ), var_7 );
}
...
branalytics_revive( var_0, var_1 )
{
    ...
    var_7 = _utilflare_lerpflare( [], var_1, "revivee" );
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "revive", var_1.origin );
}
...
cloudref( var_0 )
{
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "selfRevive", var_0.origin );
}

cloudorigin( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !codenumber() )
        return;
    ...
    var_16 = _utilflare_lerpflare( [], var_1, "laststandattacker" );

    foreach ( var_14 in var_16 )
        var_11[var_11.size] = var_14;

    var_19 = _utilflare_lerpflare( [], var_2, "victim" );
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "secondWind", var_0.origin );
}

codephonescriptableused( var_0, var_1, var_2 )
{
    if ( !codenumber() )
        return;
...
close_trap_room_door( var_0 )
{
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "land", var_0.origin );
}
...
closedcenter( var_0 )
{
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "playerCount", ( 0, 0, 0 ), 0, var_0 );
}
...
close_c130crate_gate( var_0, var_1 )
{
    if ( !codenumber() )
        return;
...
close_assassination_door( var_0, var_1 )
{
    if ( !codenumber() )
        return;
    ...
    if ( _unlinkcorpsefromvehicle() )
    {
        ...
        _tryusehoverjetfromstructinternal( "gulag", ( 0, 0, 0 ), var_3 );
    }
}

cloudcoverfx( var_0, var_1 )
{
    if ( !codenumber() )
        return;

    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "respawn", ( 0, 0, 0 ), var_1 );
}
...
closeobjectiveiconid( var_0, var_1, var_2 )
{
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "PlunderRespawn", var_0, var_1, var_2 );
}
...
clone_brushmodel_to_script_model( var_0, var_1 )
{
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "disconnect", ( 0, 0, 0 ), var_1 );
}

code_generation_init( var_0, var_1, var_2 )
{
    if ( !codenumber() )
        return;
...
cloned_collision( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
    ...
    if ( _unlinkcorpsefromvehicle() )
        _utilflare_flareexplode( "dropkit", var_1, var_3, 0 );
}

clonekey( var_0, var_1, var_2 )
{
    if ( !codenumber() )
        return;
    ...
    if ( _unlinkcorpsefromvehicle() )
        cluster_child_spawnpoint_scoring( "dropkit", var_2, 1 );
}
...
closedangles( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
...
cloneprop( var_0 )
{
    ...
    var_10 = int( _id_120D3( var_2, var_0.size ) );
    var_11 = int( _id_120D3( var_2, var_1.size ) );
    var_12 = [];
    var_12[var_12.size] = "num_players_alive";
    var_12[var_12.size] = _id_120CE( var_0.size );
    var_12[var_12.size] = "num_teams_alive";
    var_12[var_12.size] = _id_120CE( var_1.size );
    var_12[var_12.size] = "total_plunder_held";
    var_12[var_12.size] = _id_120CE( var_2 );
    var_12[var_12.size] = "top_player_plunder_held";
    var_12[var_12.size] = _id_120CE( var_3 );
    var_12[var_12.size] = "top_team_total_plunder_held";
    var_12[var_12.size] = _id_120CE( var_5 );
    var_12[var_12.size] = "avg_player_plunder_held";
    var_12[var_12.size] = _id_120CE( var_10 );
    var_12[var_12.size] = "avg_team_total_plunder_held";
    var_12[var_12.size] = _id_120CE( var_11 );
    var_12[var_12.size] = "min_player_plunder_held";
    var_12[var_12.size] = _id_120CE( var_4 );
    var_12[var_12.size] = "min_team_total_plunder_held";
    var_12[var_12.size] = _id_120CE( var_6 );
    var_12[var_12.size] = "plunder_items_picked_up";

    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder._id_11AAA );
    else
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder._id_11AC7 );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder._id_11AA9 );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder._id_11AC6 );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder._id_11A9E );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.set_relic_doomslayer );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.set_relic_dogtags );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.jugg_protect_jammer );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.jugg_objective_struct );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.jugg_pursue_players );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.jugg_protect_jammer_internal );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_uncommon_1"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_uncommon_2"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_uncommon_3"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_rare_1"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_rare_2"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_epic_1"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_epic_2"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["brloot_plunder_cash_legendary_1"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["br_loot_cache"] );
    else
        var_12[var_12.size] = 0;
    ...
    if ( isdefined( level.br_plunder ) )
        var_12[var_12.size] = _id_120CE( level.br_plunder.scriptable_autouse_funcs["missionTablets"] );
    else
        var_12[var_12.size] = 0;
...
close_kioskgate( var_0, var_1 )
{
    ...
    var_2 = claymore_stunned( var_0 );
    var_3 = _branalytics_header( var_0 );
    var_3[var_3.size] = "reason";
    var_3[var_3.size] = var_1;
    var_3[var_3.size] = "primary_weapon";
    var_3[var_3.size] = _id_120D1( var_2[0] );
    var_3[var_3.size] = "secondary_weapon";
    var_3[var_3.size] = _id_120D1( var_2[1] );
    var_3[var_3.size] = "primary_equipment";
    var_3[var_3.size] = _id_120CF( var_0.equipment["primary"] );
    var_3[var_3.size] = "secondary_equipment";
    var_3[var_3.size] = _id_120CF( var_0.equipment["secondary"] );
    var_3[var_3.size] = "field_equipment";
    var_3[var_3.size] = _id_120CF( var_0.equipment["super"] );
    ...
    var_3[var_3.size] = _id_120CE( var_0 scripts\mp\equipment::getequipmentslotammo( "health" ) );
    var_3[var_3.size] = "plunder_total";
    var_3[var_3.size] = _id_120CE( var_0.plundercount );
    var_3[var_3.size] = "plunder_banked";
    var_3[var_3.size] = _id_120CE( var_0.plunderbanked );
    var_3[var_3.size] = "ammo_smg";
    var_3[var_3.size] = _id_120CE( var_0.br_ammo["brloot_ammo_919"] );
    var_3[var_3.size] = "ammo_ar_lmg";
    var_3[var_3.size] = _id_120CE( var_0.br_ammo["brloot_ammo_762"] );
    var_3[var_3.size] = "ammo_shotgun";
    var_3[var_3.size] = _id_120CE( var_0.br_ammo["brloot_ammo_12g"] );
    var_3[var_3.size] = "ammo_sniper";
    var_3[var_3.size] = _id_120CE( var_0.br_ammo["brloot_ammo_50cal"] );
    var_3[var_3.size] = "ammo_rockets";
    var_3[var_3.size] = _id_120CE( var_0.br_ammo["brloot_ammo_rocket"] );
    var_4 = [];
    ...
    {
        var_3[var_7 + 1] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0]._id_11D75 ) );
        var_3[var_7 + 3] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].frontpiece ) );
        var_3[var_7 + 5] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].backpiece ) );
        var_3[var_7 + 7] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].magazine ) );
        var_3[var_7 + 9] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].override ) );
        var_3[var_7 + 11] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].scope ) );
        var_3[var_7 + 13] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].underbarrel ) );
        var_3[var_7 + 15] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].modifier ) );
        var_3[var_7 + 17] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].visual ) );
        var_3[var_7 + 19] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].muzzle ) );
        var_3[var_7 + 21] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].reargrip ) );
        var_3[var_7 + 23] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].trigger ) );
        var_3[var_7 + 25] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[0].extra ) );
        var_3[var_7 + 27] = "";
        var_8 = var_2[0].others;

        foreach ( var_11, var_10 in var_8 )
        {
            var_3[var_7 + 27] = var_3[var_7 + 27] + scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_10 ) );
    ...
    {
        var_3[var_7 + 1] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1]._id_11D75 ) );
        var_3[var_7 + 3] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].frontpiece ) );
        var_3[var_7 + 5] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].backpiece ) );
        var_3[var_7 + 7] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].magazine ) );
        var_3[var_7 + 9] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].override ) );
        var_3[var_7 + 11] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].scope ) );
        var_3[var_7 + 13] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].underbarrel ) );
        var_3[var_7 + 15] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].modifier ) );
        var_3[var_7 + 17] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].visual ) );
        var_3[var_7 + 19] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].muzzle ) );
        var_3[var_7 + 21] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].reargrip ) );
        var_3[var_7 + 23] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].trigger ) );
        var_3[var_7 + 25] = scripts\mp\utility\weapon::attachmentmap_tobase( _id_120D0( var_2[1].extra ) );
        var_3[var_7 + 27] = "";
...
close_teleport_room_door( var_0, var_1, var_2 )
{
    if ( !codenumber() )
        return;
    ...
    var_3[var_3.size] = "primary_weapon";
    var_3[var_3.size] = _id_120CF( var_2.loadoutprimaryfullname );
    var_3[var_3.size] = "secondary_weapon";
    var_3[var_3.size] = _id_120CF( var_2.loadoutsecondaryfullname );
    var_3[var_3.size] = "primary_equipment";
    var_3[var_3.size] = _id_120CF( var_2.loadoutequipmentprimary );
    var_3[var_3.size] = "secondary_equipment";
    var_3[var_3.size] = _id_120CF( var_2.loadoutequipmentsecondary );
    var_3[var_3.size] = "perk_1";
    var_3[var_3.size] = _id_120CF( var_2.loadoutperks[0] );
    var_3[var_3.size] = "perk_2";
    var_3[var_3.size] = _id_120CF( var_2.loadoutperks[1] );
    var_3[var_3.size] = "perk_3";
    var_3[var_3.size] = _id_120CF( var_2.loadoutperks[2] );
    var_0 dlog_recordplayerevent( "dlog_event_br_kiosk_purchase_loadout", var_3 );
}

close_silo_entrance_doors( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
    ...
    var_4[var_4.size] = _id_120CE( var_1 );
    var_4[var_4.size] = "player_plunder_after_purchase";
    var_4[var_4.size] = _id_120CE( var_0.plundercount );
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "purchase", var_0.origin, var_0 getentitynumber(), var_3 );
}

close_safehouse_doors( var_0, var_1, var_2 )
{
    if ( !codenumber() )
        return;
    ...
    if ( isdefined( var_0.clean_up_vandalize ) )
        var_3[var_3.size] = var_0.clean_up_vandalize.index;
    else
        var_3[var_3.size] = -1;
    ...
    if ( var_1 != "menu_close" && !isdefined( var_0.clean_up_vandalize ) )
...
closenukecrate( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
...
closeelevatordoors( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !codenumber() )
        return;
...
closedpos( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
...
clipleft( var_0, var_1 )
{
    ...
    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "bonusXpDebug", ( 0, 0, 0 ), var_0, var_2 );
}
...
closeplundergate( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
...
closerightblimadoor( var_0, var_1 )
{
    if ( !codenumber() )
        return;
...
closestplayer( var_0, var_1, var_2 )
{
    if ( !codenumber() )
        return;
...
codephonescodeenteredringingfrenzy( var_0, var_1 )
{
    if ( scripts\mp\utility\game::getgametype() != "br" )
        return;
    ...
    if ( _unlinkcorpsefromvehicle() && isdefined( level._id_11B60 ) )
        _utilflare_flareexplode( "vehicle", var_0.origin, var_0, var_1 );
}

close_exit_doors( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;
...
code( var_0 )
{
    ...
    getentitylessscriptablearray( "dlog_event_br_mission_spawn", [ "id", scripts\engine\utility::ter_op( isdefined( var_0.index ), "" + var_0.index, "invalid" ), "type", var_0._id_12B26, "origin_x", var_0.origin[0], "origin_y", var_0.origin[1], "origin_z", var_0.origin[2] ] );

    if ( _unlinkcorpsefromvehicle() && isdefined( var_0.index ) )
        _utilflare_flareexplode( "mission", var_0.origin, "" + var_0.index, var_0._id_12B26 );
}
...
close_gunshop_door( var_0 )
{
    ...
    getentitylessscriptablearray( "dlog_event_br_mission_invalid", [ "id", scripts\engine\utility::ter_op( isdefined( var_0.index ), "" + var_0.index, "invalid" ), "type", var_0._id_12B26, "origin_x", var_0.origin[0], "origin_y", var_0.origin[1], "origin_z", var_0.origin[2] ] );
}
...
nuke_vault_runner_internal( var_0 )
{
    ...
    {
        if ( isdefined( var_0.juggernauts_spawned ) )
            var_1 = var_0.juggernauts_spawned;
    }
...
closed_position( var_0, var_1 )
{
    ...
    var_2 = _validateitempurchase( var_2, var_3 );
    var_2[var_2.size] = "id";
    var_2[var_2.size] = scripts\engine\utility::ter_op( isdefined( var_0.subtract_from_spawn_count_from_group ), var_0.subtract_from_spawn_count_from_group, "invalid" );

    if ( isdefined( level.br_circle ) )
        var_4 = scripts\engine\utility::nonnvgnightmap( level.br_circle.circleindex );
    else
        var_4 = -1;
    ...
    var_2[var_2.size] = nuke_vault_runner_internal( var_0 );
    var_1 dlog_recordplayerevent( "dlog_event_br_mission_start", var_2 );

    if ( _unlinkcorpsefromvehicle() && isdefined( var_0.subtract_from_spawn_count_from_group ) )
        cluster_child_spawnpoint_scoring( "mission", var_0.subtract_from_spawn_count_from_group, -1 );
}

close_tut_gate( var_0, var_1, var_2, var_3 )
{
    if ( !codenumber() )
        return;

    getentitylessscriptablearray( "dlog_event_br_mission_end", [ "id", scripts\engine\utility::ter_op( isdefined( var_0.subtract_from_spawn_count_from_group ), var_0.subtract_from_spawn_count_from_group, "invalid" ), "result", scripts\engine\utility::ter_op( isdefined( var_0.result ), var_0.result, "unknown" ), "reward_tier", var_1, "xp", scripts\engine\utility::ter_op( isdefined( var_2["xp"] ), var_2["xp"], 0 ), "weapon_xp", scripts\engine\utility::ter_op( isdefined( var_2["weapon_xp"] ), var_2["weapon_xp"], 0 ), "plunder", scripts\engine\utility::ter_op( isdefined( var_2["plunder"] ), var_2["plunder"], 0 ), "num_teammates_awarded", scripts\engine\utility::ter_op( isdefined( var_3 ), var_3, 0 ), "type", var_0.questcategory, "blueprint_loot_id", nuke_vault_runner_internal( var_0 ) ] );

    if ( _unlinkcorpsefromvehicle() && isdefined( var_0.subtract_from_spawn_count_from_group ) )
    {
        if ( isdefined( var_0.result ) && var_0.result == "success" )
            cluster_child_spawnpoint_scoring( "mission", var_0.subtract_from_spawn_count_from_group, var_1 );
        else
            cluster_child_spawnpoint_scoring( "mission", var_0.subtract_from_spawn_count_from_group, -1 );
    }
}
...
_branalytics_header( var_0, var_1 )
{
    ...
    var_2 = _utilflare_lerpflare( var_2, var_0, var_1 );

    if ( isdefined( level.br_circle ) )
        var_3 = scripts\engine\utility::nonnvgnightmap( level.br_circle.circleindex );
    else
        var_3 = -1;
...
_utilflare_lerpflare( var_0, var_1, var_2 )
{
    if ( !isstring( var_2 ) )
        var_2 = "player";
...
clonesleft()
{
    if ( _unlinkcorpsefromvehicle() )
    {
        if ( isdefined( level.grenadeboxes_init["vehicle"] ) )
        {
            foreach ( var_1 in level.grenadeboxes_init["vehicle"] )
            {
        ...
        {
            var_6 = level.br_level.circleradius.size - 1;
            var_7 = 0;

            for ( var_8 = 0; var_8 < var_6; var_8++ )
            {
                var_9 = level.br_level.circleradius[var_8 + 1];
        ...
        foreach ( var_14 in level.grenadeboxes_init )
        {
...
{
    level.dropcircle = [];
    level.dropcircle[level.dropcircle.size] = "loot";
    level.dropcircle[level.dropcircle.size] = "mission";
    level.dropcircle[level.dropcircle.size] = "combat";
    level.dropcircle[level.dropcircle.size] = "cache";
    level.dropcircle[level.dropcircle.size] = "cache_legendary";
    level.dropcircle[level.dropcircle.size] = "cache_scavenger";
    level.dropcircle[level.dropcircle.size] = "loot_chopper";
    level.dropcircle[level.dropcircle.size] = "c130_box";
    level.dropbrweapon = [];
    ...
    foreach ( var_1 in level.teamnamelist )
    {
        ...
        foreach ( var_4 in level.dropcircle )
        {
            var_2.sources[var_4] = 0;
            var_2._id_12CED[var_4] = 0;
        }

        level.dropbrweapon[var_1] = var_2;
    }

    level waittill( "prematch_done" );
    level thread _id_11D85();
}
...
_id_11D85()
{
    for ( var_0 = 60.0; !istrue( level.gameended ); var_0 = max( 60.0 - var_12, 0 ) )
    {
        ...
        {
            if ( level scripts\mp\utility\game::script_model_spawn_and_use( var_4 ) )
                continue;
            ...
            foreach ( var_8 in level.dropcircle )
            {
                var_9 = level.dropbrweapon[var_4].sources[var_8];
                var_6[var_6.size] = "cash_source_" + var_8;
                var_6[var_6.size] = var_9;
                level.dropbrweapon[var_4]._id_12CED[var_8] = level.dropbrweapon[var_4]._id_12CED[var_8] + var_9;
                level.dropbrweapon[var_4].sources[var_8] = 0;
            }
    ...
    foreach ( var_4 in level.teamnamelist )
    {
        ...
        foreach ( var_8 in level.dropcircle )
        {
            var_9 = level.dropbrweapon[var_4]._id_12CED[var_8];
            var_6[var_6.size] = "cash_source_" + var_8;
            var_6[var_6.size] = var_9;
        }
...
_id_12D37( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_0.team ) )
        return;

    if ( _unlinkcorpsefromvehicle() )
        _tryusehoverjetfromstructinternal( "plunder_award", var_0.origin, var_2, var_0.team + "; " + var_0 getentitynumber() + "; " + var_1 );

    if ( !isdefined( level.dropbrweapon ) )
        return;

    var_3 = var_0.team;
    level.dropbrweapon[var_3].sources[var_1] = level.dropbrweapon[var_3].sources[var_1] + var_2;
}

unset_relic_aggressive_melee_params()
{
    thread addpostlaunchspawns();
}

addpostlaunchspawns()
{
    waittillframeend;
    var_0 = level.completesmokinggunquest.name;
    var_1 = scripts\engine\utility::nonnvgnightmap( level.maxteamsize );
    var_2 = scripts\engine\utility::nonnvgnightmap( level.players.size );
    var_3 = scripts\engine\utility::nonnvgnightmap( level.teamswithplayers.size );
    var_4 = 0;
    ...
    if ( isdefined( level.br_armory_kiosk ) )
        var_8 = scripts\engine\utility::nonnvgnightmap( level.br_armory_kiosk._id_12BE9 );
    else
        var_8 = 0;

    var_9 = scripts\engine\utility::nonnvgnightmap( level.usegulag );

    if ( isdefined( level.gulag ) )
    {
        var_10 = scripts\engine\utility::nonnvgnightmap( level.gulag.maxuses );
        var_11 = scripts\engine\utility::nonnvgnightmap( level.gulag.trial_trigger_activated_func );
        var_12 = scripts\engine\utility::nonnvgnightmap( level.gulag._id_127F4 );
    }
    else
    {
        var_10 = 0;
    ...
    var_18 = scripts\engine\utility::nonnvgnightmap( getplaylistid() );

    if ( isdefined( level._id_11B60 ) )
        var_19 = level._id_11B60;
    else
        var_19 = -1;
