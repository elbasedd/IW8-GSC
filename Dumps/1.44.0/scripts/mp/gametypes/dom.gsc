...
initspawns()
{
    ...
    else if ( istrue( level.aq_ontimerupdate ) )
...
domflags()
{
    ...
    foreach ( var_9 in var_6 )
    {
        ...
        switch_weapon_from_minigun( var_9 );
...
_id_130C6()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.suicidemonitorcrouchbuttonpress ) || var_1.suicidemonitorcrouchbuttonpress != var_2 )
            {
                var_1 setmlgdominationpoint( var_2 );
                var_1.suicidemonitorcrouchbuttonpress = var_2;
