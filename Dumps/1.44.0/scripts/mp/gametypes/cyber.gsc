...
initspawns()
{
    ...
    {
        assignteamspawns();
        level.get_wave_spawn_total["allies"] = "allies";
        level.get_wave_spawn_total["axis"] = "axis";
...
getspawnpoint()
{
    ...
    if ( scripts\mp\utility\game::getgametypenumlives() != 1 )
    {
        if ( scripts\mp\spawnlogic::shoulduseteamstartspawn() )
        {
            ...
            var_1 = scripts\mp\spawnlogic::getspawnpoint( self, var_0, level.get_wave_spawn_total[var_0], "neutral" );
    }
...
assignteamspawns()
{
    ...
    else
    {
        foreach ( var_9 in var_0 )
        {
            var_9.teambase = num_hackers( var_9 );
...
_id_129CE()
{
    ...
    level.cyberemp scripts\mp\gameobjects::_id_12398( "mlg_icon_waypoint_emp_planted" );
    ...
    level.cyberemp scripts\mp\gameobjects::_id_123A1( "icon_waypoint_escort_emp", "waypoint_capture_kill", "mlg_icon_waypoint_emp_planted", var_0 );
...
hidebombsitesaftermatchstart()
{
    ...
    scripts\mp\objidpoolmanager::try_to_do_first_passby_room_logic( level.objectives["allies"].objidnum, 1 );
    ...
    scripts\mp\objidpoolmanager::try_to_do_first_passby_room_logic( level.objectives["axis"].objidnum, 1 );
...
allowedwhileplanting( var_0 )
{
    ...
    if ( var_0 )
    {
        scripts\engine\utility::_id_13403( 0.8, "bomb_allow_offhands" );
        scripts\common\utility::allow_melee( var_0 );
...
onenduse( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_1.isdefusing )
            scripts\mp\gameobjects::_id_123A1( "icon_waypoint_defuse_empsite_nt", "icon_waypoint_defend_empsite_nt", "mlg_icon_waypoint_emp_planted" );
        else
            scripts\mp\gameobjects::_id_123A1( "icon_waypoint_defend_empsite", "icon_waypoint_target_empsite", "mlg_icon_waypoint_emp_planted" );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    scripts\mp\objidpoolmanager::try_to_do_first_passby_room_logic( level.objectives["allies"].objidnum, 0 );
    scripts\mp\objidpoolmanager::try_to_do_first_passby_room_logic( level.objectives["axis"].objidnum, 0 );
...
onuse( var_0 )
{
    ...
    if ( !scripts\mp\gameobjects::isfriendlyteam( var_0.pers["team"] ) && !level.bombplanted )
    {
        ...
        var_0 scripts\cp\helicopter\chopper_boss::unset_relic_doomslayer();
        var_0 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "plant", var_0.origin );
        ...
        level.bombplanted = 1;
        scripts\mp\gameobjects::_id_12398( "mlg_icon_waypoint_emp_planted" );
    ...
    else
    {
        ...
        var_0 scripts\cp\helicopter\chopper_boss::umbra();
...
setupfordefusing( var_0, var_1 )
{
    ...
    thread scripts\mp\gametypes\obj_bombzone.gsc::changecirclestateatlowtime( var_1.team, "icon_waypoint_planted_empsite", "icon_waypoint_defuse_empsite" );
...
weaponswapwatcher()
{
    ...
    for (;;)
    {
        if ( self.currentprimaryweapon.basename == "iw8_cyberemp_mp" )
        {
            if ( !istrue( self._id_12539 ) )
            {
                scripts\mp\utility\player::showminimap();
                self._id_12539 = 1;
            }
        }
        else if ( istrue( self._id_12539 ) )
        {
