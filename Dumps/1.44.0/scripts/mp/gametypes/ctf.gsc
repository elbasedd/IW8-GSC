...
createflagsandhud()
{
    ...
    scripts\mp\objidpoolmanager::try_to_do_first_passby_room_logic( level.capzones[game["defenders"]].objidnum, 1 );
    scripts\mp\objidpoolmanager::try_to_do_first_passby_room_logic( level.capzones[game["attackers"]].objidnum, 1 );
}
...
createteamflag( var_0, var_1 )
{
    ...
    var_9 scripts\mp\gameobjects::_id_123A1( level.iconescort, level.iconkill, level.suicideandskydive );
    ...
    var_9 scripts\mp\gameobjects::_id_11DDE( ::lb_mg_wood_surf_dmg_scalar );
    var_9.allowweapons = 1;
    var_9.updateondamagepredamagemodrelicsfunc = var_8;
    var_9.onpickup = ::onpickup;
    var_9.onpickupfailed = ::onpickup;
    var_9.ondrop = ::ondrop;
    var_9.onreset = ::onreset;
    var_9.rewardscriptable = 1;
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_9 scripts\mp\gameobjects::_id_123A1( level.iconescort, level.iconkill, level.suicideandskydive, var_10 );
    }
    else
    {
        var_9.objidpingfriendly = 1;
...
createcapzone( var_0, var_1 )
{
    ...
    var_6 scripts\mp\gameobjects::_id_123A1( level.icondefendflag, level.iconcaptureflag, level.suicideandskydive );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != var_3 )
    {
        ...
        if ( level.codcasterenabled )
            level.capzones[var_0.team] scripts\mp\gameobjects::_id_11F2B();

        thread returnflag();
        var_0 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "obj_return", var_0.origin );
        ...
        if ( self.updateondamagepredamagemodrelicsfunc == "allies" )
            setomnvar( "ui_ctf_flag_axis", -2 );
        else
            setomnvar( "ui_ctf_flag_allies", -2 );
    }
    else
    {
        ...
        level.capzones[var_5] scripts\mp\gameobjects::_id_12398( level.suicide_on_end_remote );
...
ondrop( var_0 )
{
    if ( isdefined( var_0.leaving_team ) )
    {
        ...
        self.droppedteam = self.updateondamagepredamagemodrelicsfunc;
    else
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::_id_123A1( level.iconreturnflag, level.iconcaptureflag, level.suicideandskydive );
    else
    {
        scripts\mp\gameobjects::_id_123A1( level.icondefendflag, level.iconcaptureflag, level.suicideandskydive );
    ...
    scripts\mp\utility\dialog::leaderdialog( "enemy_flag_dropped", self.updateondamagepredamagemodrelicsfunc, "status" );
    scripts\mp\utility\dialog::leaderdialog( "flag_dropped", scripts\mp\utility\game::getotherteam( self.updateondamagepredamagemodrelicsfunc )[0], "status" );
...
onreset()
{
    ...
    level.capzones[var_1] scripts\mp\gameobjects::_id_123A1( level.icondefendflag, level.iconcaptureflag, level.suicideandskydive );
...
onuse( var_0 )
{
    if ( !level.gameended )
    {
        ...
        var_0 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "capture", var_0.origin );
        ...
        if ( level.codcasterenabled )
            level.capzones[var_2] scripts\mp\gameobjects::_id_11F2B();
...
superabilitywatcher()
{
    ...
    for (;;)
    {
        ...
        {
            case "super_rewind":
                scripts\engine\utility::_id_133EF( "teleport_success", "rewind_success" );
...
placeflag()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_12 scripts\mp\gameobjects::_id_123A1( level.icondefendflag, level.iconcaptureflag, level.suicideandskydive );
