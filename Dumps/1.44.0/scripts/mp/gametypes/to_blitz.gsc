...
rpgcrateenduse( var_0 )
{
    ...
    var_0 scripts\mp\weapons::_id_12391( getcompleteweaponname( "iw8_la_rpapa7_mp" ) );
}
...
watchiconupdater()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_133F0( "bradley_driverUpdate", "death", "bradley_vehicleExit" );
...
ontimelimit()
{
    if ( isdefined( level.onphaseend ) )
    {
        var_0 = scripts\mp\gamescore::destroy_vehicle_on_pilot_death( 0 );
