...
init()
{
    scripts\mp\gametypes\br_gametypes.gsc::initnonbunkerdoors( "ignoreZombiesLastStandWipe" );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::_id_11DDC( "remainingPlayersAliveOnTeam", ::_id_11E82 );
    ...
    level.completesmokinggunquest.start_preserverroom_spawners = getdvarint( "scr_br_zxp_maxTagsVisible", 0 );
    ...
    level.completesmokinggunquest._id_136BE = getdvarint( "scr_br_zxp_zombie_drop_tags", 0 );
    level.completesmokinggunquest.start_firing_minigun = getdvarint( "scr_br_zxp_max_tags", 0 );
    level.completesmokinggunquest.plundersilentcountdownendtime = getdvarint( "scr_br_zxp_human_loadout_restore", 0 );
...
relic_amped_reset_deathshield_on_revived()
{
    ...
    thread tank_die_from_turret_damage();
}

tank_die_from_turret_damage()
{
    for (;;)
    {
        foreach ( var_1 in level.teamnamelist )
        {
            var_2 = scripts\mp\gametypes\br_public.gsc::ondamagerelicsteelballs( var_1 );

            for ( var_3 = 0; var_3 < var_2.size; var_3++ )
            {
                var_4 = var_2[var_3];
                var_5 = scripts\mp\gametypes\br_public.gsc::ondamagerelicfocusfire( var_1, var_4 );

                if ( var_5 > 0 )
                {
                    var_6 = sat_setup_access_cards( var_1, var_4 );

                    if ( !var_6 )
                    {
                        set_recent_spawn_time_threshold_override( var_1, var_4 );
                        scripts\mp\utility\script::handle_train_veh_collision( "monitorAllZombieTeamFixup - found invalid team" );
                    }
                }
            }
        }
...
{
    var_2 = 0;
    var_3 = sat_setup_access_cards( var_0.team, var_0.squadindex, var_0 );

    if ( !istrue( self.gulag ) && scripts\mp\gametypes\br_zones.gsc::rungwperif_tracers( "plague", var_0 ) )
    {
        if ( var_3 )
            var_2 = var_0 scripts\mp\gametypes\br_alt_mode_zxp.gsc::_id_119FD( var_1 );
    }
    else if ( !var_0 scripts\mp\gametypes\br_public.gsc::zombiejumping() )
    ...
    if ( scripts\mp\flags::gameflag( "prematch_done" ) && !var_2 )
    {
        if ( var_0 scripts\mp\gametypes\br_public.gsc::zombiejumping() )
            thread scripts\mp\gametypes\br_alt_mode_zxp.gsc::weapon_xp_iw8_la_mike32();

        scripts\mp\gametypes\br.gsc::ss_circletick( var_0 );

        if ( !var_3 )
            set_recent_spawn_time_threshold_override( var_0.team, var_0.squadindex, var_0 );
    }

    return !var_2;
}

sat_setup_access_cards( var_0, var_1, var_2 )
{
    var_3 = isdefined( level.gulag ) && !istrue( level.gulag.shutdown );
    var_4 = scripts\mp\gametypes\br_public.gsc::ondefuse( var_0, var_1 );
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        if ( istrue( var_3 ) && var_6 scripts\mp\gametypes\br_public.gsc::rungwperif_flak() )
            return 1;

        var_7 = var_6 scripts\mp\gametypes\br_public.gsc::zombiejumping() || var_6 scripts\mp\gametypes\br_alt_mode_zxp.gsc::z_delta();

        if ( !var_7 && isalive( var_6 ) && !istrue( var_6.inlaststand ) )
            return 1;

        if ( istrue( var_6.inlaststand ) && ( istrue( var_6.player_move ) || var_6 scripts\mp\gametypes\br_gulag.gsc::waypoint_radius_think() ) )
            return 1;
    }
...
set_recent_spawn_time_threshold_override( var_0, var_1, var_2 )
{
    var_3 = scripts\mp\gametypes\br_public.gsc::ondefuse( var_0, var_1 );
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( var_5 scripts\mp\gametypes\br_alt_mode_zxp.gsc::z_delta() )
        {
            var_5 scripts\mp\gametypes\br_alt_mode_zxp.gsc::_id_119B1( 0, 0 );
            scripts\mp\gametypes\br.gsc::ss_circletick( var_5 );
...
_id_11A1E( var_0 )
{
    ...
    if ( level.completesmokinggunquest.plunderstructreplenish )
        [var_2, var_3, var_1] = xmike109projectiles();
    else
    {
        [var_2, var_3, var_4] = xpperplayerpershare();
        var_1 = var_2;
    }
    ...
    if ( level.completesmokinggunquest.plunderstructreplenish )
    {
        ...
        scripts\mp\gametypes\br_alt_mode_zxp.gsc::_id_119EB( var_2, var_3, var_1 );
    }
    else
    {
        if ( !var_4 )
    ...
    {
        var_7 = scripts\mp\gametypes\br.gsc::computer_animation_off();
        scripts\mp\gametypes\br.gsc::partenum( var_7, 0 );
    }
    ...
    {
        if ( self != var_9 )
            scripts\mp\gametypes\br_public.gsc::cpcpammoarmorcratecapturecallback( "zmb_teammate_back_human", var_9 );
    }
}
...
_id_13321( var_0, var_1 )
{
    if ( scripts\mp\gametypes\br_public.gsc::zombiejumping() )
        ...
        scripts\mp\gametypes\br_vip_quest.gsc::_id_1331B( self, var_0, var_1 );
}
...
_id_11E82( var_0 )
{
    return scripts\mp\gametypes\br_alt_mode_zxp.gsc::_id_11E82( var_0 );
}
