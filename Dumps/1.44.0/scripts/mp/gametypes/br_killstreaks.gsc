...
getfirespoutlaunchvectors( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        if ( isdefined( var_6 ) && scripts\mp\utility\player::isreallyalive( var_6 ) && var_6.team != self.team )
            getfilterformodifier( var_6, var_2, var_3 );
    }
}
...
getfilterformodifier( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_4 = scripts\mp\gametypes\br_public.gsc::computer_debugtestloop( self );
    ...
    var_0 scripts\mp\gametypes\br_gametypes.gsc::_id_1209E( "onKillstreakDanger", var_6 );
}
