...
main()
{
    level.unlocked_escape_door = ::unlocked_escape_door;
}
...
redbutton_init()
{
    ...
    if ( isplayer( self ) )
    {
        ...
        scripts\mp\equipment\armor_plate::choppersupport_watchtargetrange( 0 );
    }
}
...
participantplunder( var_0 )
{
    ...
    var_1 packsplashparambits( var_2 );
}
...
popoffhelmet( var_0, var_1, var_2 )
{
    ...
    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        ...
        {
            var_14 = scripts\mp\gametypes\br_pickups.gsc::nospectatablepropswatch( var_4.origin, var_4.angles );
            var_4 delete();
...
unlocked_escape_door( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
