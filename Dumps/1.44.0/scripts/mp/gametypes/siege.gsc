...
main()
{
    ...
    level.rotationrefsbyseatandweapon = 0;
    var_0 = getdvarint( "LTSNLQNRKO" ) && !getdvarint( "LSTLQTSSRM" );

    if ( var_0 )
        level.rotationrefsbyseatandweapon = getdvarint( "scr_siege_groundwarSiege", 0 );

    level.blueprintextract_trygetreward = [];

    if ( level.rotationrefsbyseatandweapon )
        level.blueprintextract_trygetreward[level.blueprintextract_trygetreward.size] = "arm";
    ...
    if ( istrue( level.rotationrefsbyseatandweapon ) )
    ...
    if ( level.rotationrefsbyseatandweapon )
    {
        ...
        level.maxhqtanks = 0;
        level.trial_white_phosphorus = getdvarint( "scr_siege_numNonRallyVehicles", 25 );
        level._id_125B7 = 1;
...
onstartgametype()
{
    ...
    if ( level.rotationrefsbyseatandweapon )
    {
        ...
        scripts\mp\gametypes\arm.gsc::_id_12454();
        scripts\mp\gametypes\arm.gsc::calculatehqmidpoint();
        level.trialympic_fires = getdvarint( "scr_siege_flagcount", 3 );
        setomnvar( "ui_num_dom_flags", level.trialympic_fires );
        ...
        thread relic_nuketimer_timerloop();
...
onspawn_slowspeed( var_0, var_1 )
{
    ...
    level.brjugg_watchheatreduction = var_4;
    level.brjugg_watchgasdamage = var_5;
...
updategametypedvars()
{
    ...
    level.playerzombieprestream = scripts\mp\utility\dvars::dvarfloatvalue( "holdAllTimer", 7.5, 0, 60 );
}
...
onplayerconnect( var_0 )
{
    ...
    if ( level.rotationrefsbyseatandweapon && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] != 0 && !scripts\mp\flags::gameflag( "prematch_done" ) )
...
domflags()
{
    ...
    level.trialympic_fires = 3;
    setomnvar( "ui_num_dom_flags", level.trialympic_fires );

    if ( level.trialympic_fires == 3 )
    {
    ...
    foreach ( var_24 in level.objectives )
    {
        ...
        var_24._id_12A14 = ::unsetreduceregendelayonkills;
...
watchflagenduse( var_0 )
{
    ...
    if ( var_1 == level.trialympic_fires )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_2 == level.trialympic_fires )
...
onuse( var_0 )
{
    ...
    if ( var_2 == "neutral" )
    {
        ...
        {
            if ( var_4 == 2 && level.trialympic_fires == 3 )
            {
    ...
    thread enemy_right_monitor( var_1 );
}
...
{
    if ( isdefined( self._id_1347E ) )
        self._id_1347E = undefined;
...
checkendgame()
{
    ...
    if ( var_0 == level.trialympic_fires )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_1 == level.trialympic_fires )
        setwinner( "axis", "siege_allflags_win", "siege_allflags_loss" );
}
...
runobjectives( var_0 )
{
    ...
    foreach ( var_2 in level.allfobs )
    {
        ...
        var_2.trigger.gameobject._id_12A14 = ::unsetreduceregendelayonkills;
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom.gsc::precap( level.trialympic_fires == 5 );

    scripts\mp\gametypes\dom.gsc::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm.gsc::bmoovertime();
}
...
_id_11E85( var_0 )
{
    if ( level.mapname == "mp_downtown_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
        {
            var_0.tut_bots_forcelaststand_onspawn = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_c" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
        {
            var_0.tut_bots_forcelaststand_onspawn = "_c";
            var_0.objkey = "_b";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
        {
            var_0.tut_bots_forcelaststand_onspawn = "_d";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    else if ( level.mapname == "mp_boneyard_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
        {
            var_0.tut_bots_forcelaststand_onspawn = "_b";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
    ...
    {
        if ( var_0.objkey == "_a" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
        {
            var_0.tut_bots_forcelaststand_onspawn = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        ...
        else if ( var_0.objkey == "_e" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
        {
            var_0.tut_bots_forcelaststand_onspawn = "_e";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    ...
    else if ( var_0.objkey == "_b" && !isdefined( var_0.tut_bots_forcelaststand_onspawn ) )
    {
        var_0.tut_bots_forcelaststand_onspawn = "_b";
        var_0.objkey = "_a";
        var_0.script_label = var_0.objkey;
