...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_8 thread changecirclestateatlowtime( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
...
changecirclestateatlowtime( var_0, var_1, var_2 )
{
...
getbombmodel( var_0 )
{
    if ( istrue( level.play_hud_reminder_vo ) && istrue( var_0 ) )
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( !level.bombdefused )
    {
        ...
        if ( istrue( self.firstpickup ) )
        {
            ...
            if ( istrue( level.play_hud_reminder_vo ) )
            {
                ...
                playfx( level.post_loadout_spawn_func["vanish_hw_fr"], self.trigger.origin + ( 0, 0, -9970 ) );
            }
        }
        else
            var_3 = "bomb_pickup";
    ...
    scripts\mp\utility\game::spawn_chopper_carepackage( var_0, undefined, "Bomb Picked Up", var_0.origin );
