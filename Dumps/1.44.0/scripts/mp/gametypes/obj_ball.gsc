...
ball_on_pickup( var_0, var_1 )
{
    ...
    if ( var_4 )
    {
        ...
        else
        {
            ...
            if ( isplayer( var_0 ) )
                var_0 thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "pickup_interception", var_0.origin );
        }
    }
    else
    {
...
ball_on_reset()
{
    ...
    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context_patch, "obj_return", var_0.baseorigin );
}
...
ball_return_home( var_0, var_1 )
{
    ...
    if ( istrue( level.possessionresetcondition ) )
    {
        if ( istrue( level.lb_mg_impulse_dmg_factor_mid_low ) )
...
waitforreset( var_0 )
{
    ...
    if ( level.lb_mg_impulse_dmg_factor_mid_low != 0 )
        scripts\mp\hostmigration::waitlongdurationwithhostmigrationpause( level.lb_mg_impulse_dmg_factor_mid_low );
...
ball_location_hud()
{
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_133F9( "pickup_object", "dropped", "reset", "ball_ready" );
...
updatetimers( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_2 ) )
    {
        if ( istrue( level.lb_mg_impulse_dmg_factor_mid_low ) && !istrue( level.ballreset ) )
            var_5 = 1000 * level.lb_mg_impulse_dmg_factor_mid_low;
    }
