...
main()
{
    ...
    level.supportbox_watch_flight = ::dmztut_endgamewithreward;
...
initrules()
{
    ...
    updategametypedvars();
    level.ontimelimitgraceperiod = notify_planter_on_whizby();
...
initrugbyents()
{
    level.remove_player_rig_laser_panel = scripts\engine\utility::array_combine( level.outofboundstriggers, level.minetriggers, level.hurttriggers, level.radtriggers );
    initendzoneents();
...
initjuggcratesetupents()
{
    ...
    foreach ( var_3 in var_1 )
    {
        var_3 = lb_dmg_factor_tail_rotor( var_3 );
...
{
    if ( isdefined( level._id_12072 ) )
        var_0 setclientomnvar( "ui_rugby_jugg_friendly", scripts\engine\utility::ter_op( var_0.team == level._id_12072.team, 0, 1 ) );
}
...
onplayerspawned( var_0 )
{
    ...
    if ( isdefined( level._id_12072 ) && isdefined( level._id_12072.team ) && isdefined( var_0.team ) )
        var_0 setclientomnvar( "ui_rugby_jugg_friendly", scripts\engine\utility::ter_op( var_0.team == level._id_12072.team, 0, 1 ) );
}
...
awardgenericmedals( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( level._id_12072 ) )
    {
        ...
        {
            if ( var_1 == level._id_12072 )
                var_1 thread scripts\mp\utility\points::giveunifiedpoints( "kill_as_juggernaut" );
            else if ( var_12 == level._id_12072 )
                var_1 thread scripts\mp\utility\points::giveunifiedpoints( "kill_juggernaut" );
            else if ( var_1.team == level._id_12072.team && var_1 != level._id_12072 )
            {
                var_16 = distancesquared( level._id_12072.origin, var_14 );
            ...
            else if ( var_1.team != level._id_12072.team && var_12.team == level._id_12072.team )
            {
                var_16 = distancesquared( level._id_12072.origin, var_13 );

                if ( var_16 < 105625 )
                {
                    var_1 thread scripts\mp\rank::scoreeventpopup( "assault" );
                    var_1 thread scripts\mp\awards::givemidmatchaward( "mode_x_assault" );
                    thread scripts\common\utility::_id_12ED6( level.stack_patch_waittill_context, var_9, "assaulting" );
                }
            }
        }
    }
...
ontimelimitot()
{
    if ( level.rugby.activejuggernauts.size > 0 )
    {
        ...
        {
            setomnvar( "ui_overtime_time", gettime() + notify_planter_on_whizby() * 1000 );
            level.rugby.inot = 1;
            level.canprocessot = 1;
            _id_1238D();
            level thread see_killstreak_dist();
        }
    }
    else
    {
...
_id_1243C( var_0 )
{
    ...
    var_0 thread branalytics_secondwind( var_1, var_0.trigger.targetname );
    var_0 thread updatechevrons( "idle" );
}

branalytics_secondwind( var_0, var_1 )
{
    wait 1.0;
    var_2 = getentitylessscriptablearrayinradius( var_0, "targetname" );
    var_2 = _id_11B18( var_2, var_1 );
    var_3 = [];
...
get_offset_from_stance( var_0, var_1, var_2 )
{
    var_0.origin = var_1;
    var_0.angles = var_2;
    return var_0;
...
activatenewjuggernaut( var_0 )
{
    ...
    level thread wam_interaction_structs( var_0.team, var_6 );
...
wam_interaction_structs( var_0, var_1 )
{
    wait 3;
...
deactivatejuggernaut( var_0 )
{
    ...
    level.rugby.infil_light_dvars = undefined;
    level.rugby._id_11BC0 = undefined;
    level.rugby.select_mountain_one_spawners = undefined;
    level.rugby.select_mid_roof_spawners = undefined;
...
watchjuggprogress()
{
    ...
    for (;;)
    {
        ...
        if ( var_9 > 0.8 )
            level thread enemy_molotov_launch( var_9, var_0, var_2 );
        ...
        if ( isdefined( level._id_12072 ) )
        {
            ...
            {
                var_7 = var_9;
                level._id_12072 thread scripts\mp\utility\points::giveunifiedpoints( "rugby_obj_push" );
            }
        }
...
enemy_molotov_launch( var_0, var_1, var_2 )
{
    if ( !isdefined( level.rugby.infil_light_dvars ) )
    {
        level.rugby.infil_light_dvars = 1;
        level.rugby._id_11BC0 = gettime();
        level.rugby.select_mountain_one_spawners = var_0;
        level.rugby.select_mid_roof_spawners = var_0;
    }
    else if ( isdefined( level.rugby._id_11BC0 ) && level.rugby._id_11BC0 + 30000 < gettime() )
    {
        level.rugby.infil_light_dvars = 1;
        level.rugby._id_11BC0 = gettime();
        level.rugby.select_mountain_one_spawners = var_0;
    ...
    if ( istrue( level.rugby.infil_light_dvars ) )
    {
    ...
    level.rugby.infil_light_dvars = 0;
}
...
handlejuggjumpspam()
{
    ...
    for (;;)
    {
        ...
        for (;;)
        {
            var_2 = scripts\engine\utility::_id_13403( 1, "jugg_jumped" );
...
{
    var_0 = 0;
    level.select_mountain_three_spawners = spawnstruct();
    level.select_mountain_three_spawners.objidnum = scripts\mp\objidpoolmanager::requestreservedid( var_0 );
}
...
activatejuggcrate( var_0, var_1, var_2 )
{
    ...
    if ( !score_init( var_0 ) )
    {
        var_0 = level.get_actor_stance;
        var_1 = level.get_active_station_names;
    }
...
score_init( var_0 )
{
    ...
    foreach ( var_3 in level.remove_player_rig_laser_panel )
    {
...
createjuggcrate( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_2 ) )
    {
        level.get_actor_stance = var_0;
        level.get_active_station_names = var_1;
...
juggcratemanageuse( var_0 )
{
    ...
    var_1.score_event_civilian_hit = 1;
    self._id_13108 = scripts\mp\gameobjects::createholduseobject( "neutral", var_1, self.visuals, ( 0, 0, 64 ) );

    foreach ( var_3 in level.teamnamelist )
        self._id_13108.teamprogress = undefined;

    self._id_13108.trigger._id_1311D = 16900;
    self._id_13108.trigger setuserange( 130 );
    self._id_13108.trigger sethintstring( &"MP_MODE_RUGBY/CRATE_USE" );
    self._id_13108.trigger makeusable();
    self._id_13108.trigger setcursorhint( "HINT_BUTTON" );
    self._id_13108.trigger setuseholdduration( "duration_none" );
    self._id_13108.trigger setusehideprogressbar( 1 );
    self._id_13108.trigger setusepriority( -3 );
    self._id_13108.trigger sethintonobstruction( "hide" );
    self._id_13108 scripts\mp\gameobjects::setusetime( nostand() );
    self._id_13108.interactteam = "any";
    self._id_13108.curprogress = 0;
    self._id_13108.defaultusetime = self._id_13108._id_1312D;
    self._id_13108.userate = 1;
    self._id_13108.id = "rugby_jugg";
    self._id_13108.exclusiveuse = 0;
    self._id_13108.exclusiveclaim = 0;
    self._id_13108.skiptouching = 1;
    self._id_13108.onbeginuse = ::_id_1206F;
    self._id_13108.onuse = ::_id_1206E;
    self._id_13108.onenduse = ::_id_12070;
    self._id_13108.oncantuse = ::_id_12071;
    self._id_13108.inuse = 0;

    foreach ( var_6 in level.teamnamelist )
    {
        self._id_13108.numtouching[var_6] = 0;
        self._id_13108.touchlist[var_6] = [];
    }

    self._id_13108.cancontestclaim = 0;
    self._id_13108.stalemate = 0;
    self._id_13108.wasstalemate = 0;
    self._id_13108.cancontestclaim = 0;
    self._id_13108.majoritycapprogress = 1;
    self._id_13108.wasmajoritycapprogress = 0;
    self._id_13108.resetprogress = 1;

    if ( !scripts\mp\flags::gameflag( "prematch_done" ) )
        level scripts\engine\utility::_id_133EF( "prematch_done", "start_mode_setup" );

    self._id_13108.type = "useObject";
    self._id_13108.offset3d = ( 0, 0, 32 );
    self._id_13108 scripts\mp\gameobjects::requestid( 1, 1 );
    self._id_13108 scripts\mp\gameobjects::setobjectivestatusicons( "icon_waypoint_jugg_crate" );
    self._id_13108 scripts\mp\gameobjects::setvisibleteam( "any" );
    scripts\mp\objidpoolmanager::objective_set_play_intro( self._id_13108.objidnum, 0 );
    scripts\mp\objidpoolmanager::objective_set_play_outro( self._id_13108.objidnum, 0 );
}
...
_id_1206E( var_0 )
{
    ...
    if ( isdefined( self._id_13108 ) )
        self._id_13108 delete();
...
dmztut_endgamewithreward( var_0 )
{
    var_1 = level.rugby.juggconfig;
    ...
    var_2 = var_0 scripts\mp\juggernaut::search_acceleration( var_1 );
...
updateoverheadcamerapos( var_0 )
{
    ...
    var_10 = scripts\cp_mp\utility\killstreak_utility::nuclear_core_on_chopper();
