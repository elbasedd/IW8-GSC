...
rewardspawn( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        case "brloot_killstreak_clusterstrike":
            var_4 = scripts\mp\gametypes\br_pickups.gsc::nospectatablepropswatch( var_0.origin + ( 0, 0, 0.1 ), var_0.angles );
...
smoking_idle( var_0 )
{
    ...
    for (;;)
    {
        ...
        scripts\asm\shared\mp\utility::bot_ctf_enemy_team_flag_is_picked_up( var_0 );
...
standing_cellphone_loop( var_0, var_1 )
{
    self endon( "death" );
    self endon( "damage" );
    scripts\asm\shared\mp\utility::bot_ctf_ai_director_update( var_0, var_1 );
}
...
reset_guy( var_0 )
{
    ...
    var_0 scripts\asm\shared\mp\utility::bot_choose_attack_zone();
