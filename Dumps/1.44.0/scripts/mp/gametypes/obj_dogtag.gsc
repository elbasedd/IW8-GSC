...
spawndogtags( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level.dogtags[var_0.guid] ) )
    {
        if ( istrue( level.lootchopper_initspawninfo ) )
            ...
            playfx( level.post_loadout_spawn_func["vanish_hw_fr"], level.dogtags[var_0.guid].curorigin );
        else
...
removetags( var_0, var_1, var_2 )
{
    if ( isdefined( level.dogtags[var_0] ) )
    {
        ...
        if ( istrue( level.lootchopper_initspawninfo ) )
        {
            if ( isdefined( level._id_12849 ) )
                level [[ level._id_12849 ]]( level.dogtags[var_0], var_2 );
        }
        else if ( istrue( level.play_hud_reminder_vo ) )
        {
            if ( isdefined( var_2 ) && var_2.team == level.dogtags[var_0].ownerteam )
            {
                ...
                playfx( level.post_loadout_spawn_func["vanish_hw_fr"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
                playfx( level.post_loadout_spawn_func["vanish_hw_en"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
        }
        else
            playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
...
_id_12848( var_0, var_1 )
{
    ...
    {
        playfx( level.conf_fx["vanish_gos"], var_0.curorigin );
        playfx( level.perkpackage_resetoverridefieldupgrades["gos_fireworks"], var_0.curorigin );
        level thread scripts\mp\gametypes\common.gsc::_id_133E1( var_0.curorigin );
    }
}
