...
init()
{
    ...
    if ( level.choppergunner_watchexplosioninfluencepoint != 0 )
        level.choppergunner_watchexplosioninfluencepoint = 0;

    scripts\mp\gametypes\br_gametypes.gsc::helihint_wait( "drogBagLoadout" );
    scripts\mp\gametypes\br_gametypes.gsc::helihint_wait( "dropBagLoop" );
    scripts\mp\gametypes\br_gametypes.gsc::_id_12FDC( "playerNakedDropLoadout" );
    scripts\mp\gametypes\br_gametypes.gsc::_id_11DDC( "playerNakedDropLoadout", ::shsn_playernakeddroploadout );
}

shsn_playernakeddroploadout()
{
    var_0 = self;
    level.clear_trap_console_activation = shsn_getstartingclassloadout();
