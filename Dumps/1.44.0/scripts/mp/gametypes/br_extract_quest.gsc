...
init()
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::_id_11E05( "blueprintextract", ::juggernaut_update_hint_logic );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "blueprintextract", ::juggernaut_logic );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestlocale( "blueprintextract_locale" );
    scripts\mp\gametypes\br_quest_util.gsc::registercreatequestlocale( "blueprintextract_locale", ::jugg_watchfordoors );
    scripts\mp\gametypes\br_quest_util.gsc::registercheckiflocaleisavailable( "blueprintextract_locale", ::jugg_watchammo );
    scripts\mp\gametypes\br_quest_util.gsc::registerremovequestinstance( "blueprintextract_locale", ::jugg_watchmanualreload );
    scripts\mp\gametypes\br_quest_util.gsc::registerquestcircletick( "blueprintextract_locale", ::jugg_watchearlyexit );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11DF5( "blueprintextract_locale", ::jugg_watchforremovejugg );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11DF8( "blueprintextract_locale", ::jugg_watchherodrop );
    scripts\mp\gametypes\br_quest_util.gsc::getquestdata( "blueprintextract_locale" ).nextid = 0;
    scripts\mp\gametypes\br_quest_util.gsc::_id_11C73( "blueprintextract", 1 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_11DF9( "blueprintextract", ::jugg_enter_combat_callback );
    ...
    level.juggernaut_state = getdvarint( "scr_br_extract_max_search_radius", 30000 );
...
juggernaut_update_hint_logic()
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::lastgunkilltime( "blueprintextract", var_0 );
...
jugg_watchforfire( var_0 )
{
    var_1 = spawnstruct();
    var_1.origin = var_0;
    var_2 = omnvardata( var_1 );
    var_3 = scripts\mp\gametypes\br_quest_util.gsc::lastgunkilltime( "blueprintextract", var_2 );
...
takequestitem( var_0 )
{
    ...
    scripts\mp\gametypes\br_quest_util.gsc::_id_129E2( "blueprintextract", self, self.team );
    ...
    var_12._id_11AEF = scripts\mp\gametypes\br_quest_util.gsc::objective_hide_for_mlg_spectator( "blueprintextract", scripts\mp\gametypes\br_quest_util.gsc::objectiveids( self.team ) );
    ...
    scripts\mp\gametypes\br_quest_util.gsc::hint_obj_name( var_5.team, self, 6, scripts\mp\gametypes\br_quest_util.gsc::getquestindex( "blueprintextract" ) );
...
highlighttoteam( var_0 )
{
    ...
    var_5 = scripts\mp\gametypes\br_quest_util.gsc::objective_origin( scripts\mp\gametypes\br_quest_util.gsc::objective_minimapupdate( "blueprintextract" ) );
...
omnvardata( var_0 )
{
    ...
    var_1._id_121E6 = level.juggernaut_state;
    var_1._id_121E7 = 0;
    ...
    {
        var_1._id_121E1 = 0;
        var_1._id_121E6 = 200000;
        var_1._id_12DE6 = scripts\mp\gametypes\br_alt_mode_bblitz.gsc::bblitzsearchtravelspeed();
        var_1.mintime = scripts\mp\gametypes\br_alt_mode_bblitz.gsc::bblitzsearchmintime();
    }
