...
watchhvts()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::array_sort_with_func( level.players, ::_id_1267C );
        ...
        for ( var_3 = 0; var_3 < var_0.size; var_3++ )
        {
            ...
            {
                var_4 becomehvt();
                var_4.select_patrol_two_spawners = 1;
            }
        ...
        for ( var_3 = 0; var_3 < var_0.size; var_3++ )
        {
            ...
            if ( var_4 ishvt() )
            {
                if ( isdefined( var_4.select_patrol_two_spawners ) )
                {
                    var_4.select_patrol_two_spawners = undefined;
                    var_1--;
                    continue;
                }
