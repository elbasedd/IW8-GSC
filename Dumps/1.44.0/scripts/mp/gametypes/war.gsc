...
main()
{
    ...
    if ( getdvarint( "scr_hotfoot", 0 ) != 0 )
        level.onplayerkilled = ::unlockprop;
...
onstartgametype()
{
    ...
    if ( isdefined( level.relic_healthpacks ) )
        [[ level.relic_healthpacks ]]();
    else
        initspawns();
    ...
    if ( getdvarint( "scr_hotfoot", 0 ) != 0 )
        thread tank_watchpiggybackexploit();
}
...
tank_watchpiggybackexploit()
{
    ...
    level.plunder_addanchoredwidgettorepositoryinstance = 0;
    var_0 = 0;
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_2.plunder_allowrepositoryuse ) )
            {
                var_2.plunder_allowallrepositoryuseforplayer = 0;
                var_2.plunder_allowrepositoryuse = var_2.origin;
                var_2.aigroundturret_cancel = var_2.origin;
            }

            var_2.plunder_allowallrepositoryuseforplayer = var_2.plunder_allowallrepositoryuseforplayer + distancesquared( var_2.plunder_allowrepositoryuse, var_2.origin );
            var_2.plunder_allowrepositoryuse = var_2.origin;
        }
        ...
        if ( var_0 > 3.0 )
        {
            if ( level.plunder_addanchoredwidgettorepositoryinstance >= 2 )
            {
                level.plunder_addanchoredwidgettorepositoryinstance = 0;

                foreach ( var_2 in level.players )
                {
                    if ( !isdefined( var_2.aigroundturret_cancel ) )
                        var_2.aigroundturret_cancel = var_2.origin;

                    var_2.little_bird_initcollision = distancesquared( var_2.aigroundturret_cancel, var_2.origin ) < 4225;
                    var_2.aigroundturret_cancel = var_2.origin;
                }
            }
            ...
            foreach ( var_2 in level.players )
            {
                ...
                if ( isalive( var_2 ) && ( istrue( var_2.little_bird_initcollision ) || var_2.plunder_allowallrepositoryuseforplayer < 4225 && !istrue( var_2.plunder_allowrepositoryuseforplayer ) ) )
                {
                    var_2.little_bird_initcollision = 0;
                ...
                {
                    if ( isalive( var_2 ) )
                        var_2.plunder_allowrepositoryuseforplayer = 0;
        ...
        level.plunder_addanchoredwidgettorepositoryinstance++;
        waitframe();
    }
}

unlockprop( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    self.plunder_allowrepositoryuseforplayer = 1;
}
