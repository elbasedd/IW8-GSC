...
onenteroob( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.supplydropprice ) )
            var_1 = level.supplydropprice;
        else
    ...
    else
    {
        ...
        var_5 = getoutofboundstime( var_3, var_0._id_11F78 );
...
onexitoob( var_0, var_1, var_2 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.support_box_delay_max_ammo_hint ) )
            var_3 = level.support_box_delay_max_ammo_hint;
        else
...
watchoobtriggerenter( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && scripts\mp\utility\game::runextractreroll( var_1 ) )
            continue;
...
{
    if ( istrue( var_1 ) )
        return scripts\mp\utility\game::nuke_vault_jugg();

    if ( isdefined( var_1 ) && !var_1 )
        return scripts\mp\utility\game::nuke_vault_escape();
    ...
    switch ( var_0 )
    {
        ...
        case "br":
            return scripts\mp\utility\game::nuke_vault_door_sounds();
        case "default":
