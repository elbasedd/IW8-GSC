...
handlesplashqueue()
{
    ...
    {
        if ( scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\utility\game::onfieldupgradeendbuffer() == "dmz" || scripts\mp\utility\game::onfieldupgradeendbuffer() == "risk" || scripts\mp\utility\game::onfieldupgradeendbuffer() == "rumble" ) )
            scripts\engine\utility::_id_133EF( "splash_list_cleared", "can_show_splashes" );
        else
            scripts\engine\utility::_id_133EF( "splash_list_cleared", "spawned_player" );
