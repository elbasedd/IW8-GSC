...
bot_choose_difficulty_for_default()
{
    ...
    if ( !isdefined( level.chopper_boss_explosion ) )
        level.chopper_boss_explosion = [];

    if ( !isdefined( level.chopper_boss_explosion["allies"] ) )
        level.chopper_boss_explosion["allies"] = 0;

    if ( !isdefined( level.chopper_boss_explosion["axis"] ) )
        level.chopper_boss_explosion["axis"] = 0;

    if ( !isdefined( level.chopper_boss_explosion["all"] ) )
        level.chopper_boss_explosion["all"] = 0;
    ...
    if ( !isdefined( self.pers["bot_chosen_difficulty"] ) )
    {
        ...
        var_0 = level.chopper_boss_explosion[var_1];
        var_2 = level.bot_difficulty_defaults[var_0];
        self.pers["bot_chosen_difficulty"] = maxdogtags( var_2 );
        level.chopper_boss_explosion[var_1] = ( level.chopper_boss_explosion[var_1] + 1 ) % level.bot_difficulty_defaults.size;
    }
...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::_id_13406( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
bot_allowed_to_use_killstreaks()
{
    ...
    if ( istrue( self.chopperexfil_music_sh025 ) )
        return 0;
...
chooseanim_vehicleturretdeath( var_0, var_1 )
{
    switch ( var_0 )
    {
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13403( 0.5, "still_watching_nodes" );
...
chopper_respawn_timer( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = level.heli_boss_logic;
...
chopper_carepackage( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.heli_boss_logic;
