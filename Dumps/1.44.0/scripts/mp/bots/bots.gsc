...
main()
{
    ...
    if ( isdefined( level.choosebestpropforkillcam ) )
        [[ level.choosebestpropforkillcam ]]();
    else
    ...
    foreach ( var_1 in level.players )
    {
        if ( isbot( var_1 ) )
        {
            if ( isalive( var_1 ) )
            {
                ...
                var_1.chopper_gunner_assigntargetmarkers = 1;
...
{
    var_0 scripts\engine\utility::_id_133EF( "bots_human_spawned", "bots_human_disconnected" );
    ...
    for (;;)
    {
        ...
        if ( var_46 )
        {
            ...
            if ( var_45 > 0 && var_44 > 0 )
                level scripts\engine\utility::_id_133E9( "spawned_enemies", "spawned_allies" );
            else if ( var_45 > 0 )
                level waittill( "spawned_enemies" );
            else if ( var_44 > 0 )
...
bot_think()
{
    ...
    {
        var_1 = 1;
        self.chopper_gunner_assigntargetmarkers = 1;
    ...
    for (;;)
    {
        ...
        scripts\mp\bots\bots_loadout::chopper_boss_combat_actions();
        chopper_boss_damage_monitor();
...
bot_think_seek_dropped_weapons()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\bots\bots_util::checkrequiredteamstreamcount( 0.33 ) )
        {
...
bot_crate_valid( var_0 )
{
    ...
    else if ( cheesewedgeprompt( var_0 ) )
        return 0;
...
revive_watch_for_finished( var_0 )
{
    ...
    self endon( "bad_path" );
    self endon( "goal" );
    var_0 scripts\engine\utility::_id_133EF( "death", "revived" );
...
handle_smoke()
{
    ...
    thread get_control_station_side_array( var_0 );
}
