...
bot_loadout_item_allowed( var_0, var_1, var_2 )
{
    ...
    if ( !checkpoint_carepackage_munitions_role_init() )
        return 0;
...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", chopper_boss(), var_13, "class", "inUse" ) )
            {
                var_1 = choosepubliceventtype( var_13, "loadoutPrimary" );
...
checkpoint_create_carepackage()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", chopper_boss(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
    ...
    foreach ( var_5 in level.bot_loadout_fields )
    {
        ...
        var_3[var_5] = choosepubliceventtype( var_2, var_5 );
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::mountstringtodlogenum( var_0 );
...
init_bot_weap_statstable()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !scripts\mp\weapons::scr_br_collection_findpath( var_2 ) )
            {
                var_0++;
                continue;
            }
...
choosepubliceventtype( var_0, var_1 )
{
    var_2 = chopper_boss();
...
bot_loadout_valid_choice( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "loadoutPrimaryBuff":
            break;
        case "loadoutPrimaryCamo":
            var_4 = !isdefined( self.chopperexfil_pack ) || var_3 == self.chopperexfil_pack;
            break;
        case "loadoutSecondary":
        ...
        case "loadoutSecondaryBuff":
            break;
        case "loadoutSecondaryCamo":
            var_4 = !isdefined( self.chopperexfil_set_brcircle ) || var_3 == self.chopperexfil_set_brcircle;
            break;
        case "loadoutStreak3":
        case "loadoutStreak2":
        case "loadoutStreak1":
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( !isdefined( self.give_deployable_crate ) )
            self.give_deployable_crate = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );

        var_0 = [ self.give_deployable_crate ];
    }
...
{
    if ( checkstayingbehindcover().size > 0 )
    {
...
{
    if ( istrue( self.chopper_boss_loc ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( !isdefined( self.choosegulagloadouttable ) )
        self.checkpoint_add_spawnpoint = 0;

    self.choosegulagloadouttable = self.checkpoint_add_spawnpoint;
    ...
    var_8 = !var_7 && checkcarpuncherprogress();
    ...
    self.chopper_boss_loc = undefined;

    if ( !var_7 )
    {
        var_12 = checkunscoredspawnpoint();
        var_13 = undefined;

        if ( isdefined( self.respawn_with_launcher ) && isdefined( var_12 ) )
        {
            self.respawn_with_launcher = undefined;
            self.chopper_boss_loc = 1;
            var_13 = var_12;
        }

        if ( !isdefined( var_13 ) )
        {
            var_14 = checkstayingbehindcover();
            var_15 = 0;
        ...
        if ( isdefined( var_13 ) )
        {
            self.checkpoint_add_spawnpoint++;
    ...
    var_16 = undefined;
    var_17 = checkpoint_carepackage_munitions_role_init();
    ...
    if ( var_17 )
    {
        ...
        if ( chopper_boss_combat( var_1 ) )
            var_17 = 0;
    }

    if ( !var_17 )
    {
        var_1 = checkpoint_create_carepackage();
    ...
    {
        if ( isdefined( var_1["loadoutPrimaryCamo"] ) && var_1["loadoutPrimaryCamo"] != "none" && !isdefined( self.chopperexfil_pack ) )
            self.chopperexfil_pack = var_1["loadoutPrimaryCamo"];

        if ( isdefined( var_1["loadoutSecondaryCamo"] ) && var_1["loadoutSecondaryCamo"] != "none" && !isdefined( self.chopperexfil_set_brcircle ) )
            self.chopperexfil_set_brcircle = var_1["loadoutSecondaryCamo"];
