...
{
    if ( istrue( var_2 ) && roof_spawners( var_0, var_1 ) )
        return 1;
...
islethalmeleeweapon( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\weapon::run_and_stop_group_after( var_2 ) )
        return 1;
...
attackerishittingteam( var_0, var_1 )
{
    ...
    if ( !level.teambased )
        ...
        return 0;
    else if ( isagent( var_0 ) && istrue( var_0._id_125AE ) )
        return 0;
