...
incpersstat( var_0, var_1 )
{
    ...
    if ( isdefined( self.setupx1timelimit[var_0] ) )
        self.setupx1timelimit[var_0] = self.setupx1timelimit[var_0] + var_1;

    objective_sethideformlgspectator( self, var_0, var_1 );
}

registerpickupcreatedcallback( var_0 )
{
    if ( !isdefined( self.setupx1timelimit[var_0] ) )
        self.setupx1timelimit[var_0] = 0;
}
...
setextrascore0( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && level.completesmokinggunquest.name == "rebirth" )
        return;
...
getplayerdataloadoutgroup()
{
    ...
    var_0 = istrue( level._id_1347B ) && getdvarint( "LNLMORMPTS" );
