...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.helidestroyvehiclestouchtrace ) )
        return;

    if ( isdefined( level.support_box_get_close_anim_length ) && self [[ level.support_box_get_close_anim_length ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public.gsc::computer_debugtestloop( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && revive_txt_hint( var_0 ) )
            var_7 = "dx_bra_";
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public.gsc::computer_debugtestloop( self );
    ...
    if ( level.teambased )
    {
        var_5 = displaycodes( var_0, 1 );
        var_6 = displaycodes( var_0 );
