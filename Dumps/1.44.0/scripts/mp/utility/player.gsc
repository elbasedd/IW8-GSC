...
updatesessionstate( var_0, var_1 )
{
    ...
    _id_11B9C( "player::updateSessionState() " + var_0 );
}
...
restorebasevisionset( var_0 )
{
    ...
    if ( isdefined( level._id_13324 ) )
        self visionsetnakedforplayer( level._id_13324, var_0 );
    else
