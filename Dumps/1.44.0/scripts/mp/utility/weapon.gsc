...
getweapongroup( var_0 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        if ( issuperweapon( var_0 ) )
            ...
            var_2 = "gamemode";
        else if ( retrieve_data_objective( var_0 ) )
            var_2 = "weapon_ballisticSpecial";
        else if ( riskspawn_initialset( var_0 ) )
...
attachmentsconflict( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _testing_ending( var_3, var_4 ) )
        return var_0;

    if ( _testing_ending( var_4, var_3 ) )
        return var_0;
...
{
    var_2 = brevent1playervalid( var_0 );
    var_3 = brevent1playerthink( var_1 );
...
{
    return revivingteammate( getweapongroup( var_0 ), var_0 );
}
...
{
    return rewardangles( getweapongroup( var_0 ), var_0 );
}
...
iscacprimaryorsecondary( var_0 )
{
    ...
    return revivingteammate( var_1, var_0 ) || rewardangles( var_1, var_0 );
}
...
{
    if ( isdefined( level.brenableagents[var_0] ) )
        return level.brenableagents[var_0];
...
{
    if ( isdefined( level.brevent2[var_0] ) )
        return level.brevent2[var_0];

    var_1 = attachmentmap_tobase( var_0 );

    if ( isdefined( level.brevent1[var_1] ) )
        return level.brevent1[var_1];
...
old_load_hvt( var_0 )
{
    var_1 = randomintrange( 0, level._id_135A5[var_0].size );
    return level._id_135A5[var_0][var_1];
}
...
_id_135AA( var_0 )
{
    if ( isdefined( level.weaponmapdata[var_0] ) && isdefined( level.weaponmapdata[var_0].startuseweapon ) )
        return level.weaponmapdata[var_0].startuseweapon;
...
onupdatefunc( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( !level.weaponlootmapdata[var_4].rpg_shoot_at_trigs && !scripts\engine\utility::array_contains( var_1, var_2 ) )
...
onteamproximitybecameinvalidplayer( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = [];

    var_2 = 0;
    var_3 = onupdatefunc( var_0, var_1 );
...
_id_135A8( var_0, var_1 )
{
    ...
    if ( var_2 )
    {
        ...
        {
            var_4 = var_0 + "|" + var_1;
            var_3 = isdefined( level.weaponlootmapdata[var_4] ) && !level.weaponlootmapdata[var_4].rpg_shoot_at_trigs;
        }
    }
...
breakerstate( var_0, var_1 )
{
    var_2 = getweaponrootname( var_0 );
    return breakgasmaskbr( var_2, var_1 );
}

breakgasmaskbr( var_0, var_1 )
{
...
weaponbypassspawnprotection( var_0 )
{
    ...
    if ( iskillstreakweapon( var_0 ) && var_2 != "manual_turret_mp" && var_2 != "pac_sentry_turret_mp" && !run_cleanup_funcs_for_unused_objectives( var_2 ) )
        var_1 = 0;
...
run_and_stop_group_after( var_0 )
{
    if ( issameweapon( var_0 ) )
        var_1 = var_0.basename;
    else
...
{
    if ( run_and_stop_group_after( var_0 ) )
        return 1;
...
onteamproximitysteppedclose( var_0 )
{
    if ( isdefined( level.br_pickups ) && isdefined( level.br_pickups.br_weapontoscriptable ) && isdefined( level.br_pickups.clean_up_strafe ) )
    {
        var_1 = createheadicon( var_0 );
        var_2 = level.br_pickups.br_weapontoscriptable[var_1];

        if ( isdefined( var_2 ) )
            return level.br_pickups.clean_up_strafe[var_2];
    }
...
onteamproximitysteppedfar( var_0 )
{
    if ( isdefined( level.br_pickups ) && isdefined( level.br_pickups.br_weapontoscriptable ) && isdefined( level.br_pickups.clean_up_strafe ) )
    {
        var_1 = createheadicon( var_0 );
