...
support_box_is_scriptable_model()
{
...
support_box_make_entity_usable()
{
    switch ( scripts\mp\utility\game::getgametype() )
    {
        case "oic":
...
relic_shieldsonly_set_player_stats_after_spawn( var_0, var_1 )
{
    if ( !isdefined( level.br_level ) )
        return 1;

    var_2 = nuke_startexfilcountdown( var_1 );
...
nuke_startexfilcountdown( var_0 )
{
    ...
    var_2 = isdefined( level.br_level.cleanup_target_stats );
    var_3 = istrue( var_0 );

    if ( var_2 && var_3 )
        var_1 = level.br_level.cleanup_target_stats;

    return var_1;
}

nuke_timescalefactor( var_0 )
{
    var_1 = nuke_startexfilcountdown( var_0 );
    var_2 = var_1[1][0];
    var_3 = var_1[0][0];
