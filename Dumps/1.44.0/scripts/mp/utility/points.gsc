...
giveunifiedpoints( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_16 = run_hud_logic( var_1 );
    var_17 = scripts\mp\utility\perk::_hasperk( "specialty_killstreak_to_scorestreak" );
    var_18 = !istrue( level.set_number_of_subway_cars_on_track );
    ...
    if ( isdefined( level.unset_relic_mythic ) )
        [[ level.unset_relic_mythic ]]( self, var_9, var_0, var_7 );
