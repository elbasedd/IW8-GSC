...
addtoteamlives( var_0, var_1, var_2, var_3 )
{
    ...
    _id_1314D( "add", var_1, var_0 );

    if ( isdefined( level.suncascademult2 ) )
        [[ level.suncascademult2 ]]( var_0, var_1, var_3 );
...
removefromteamlives( var_0, var_1, var_2, var_3 )
{
    ...
    _id_1314D( "remove", var_1, var_0 );

    if ( isdefined( level.support_box_get_open_anim_length ) )
        [[ level.support_box_get_open_anim_length ]]( var_0, var_1, var_3 );
    ...
    if ( istrue( var_2 ) && isgameplayteam( var_1 ) && !scripts\cp_mp\utility\game_utility::isrealismenabled() )
    {
        ...
        var_6 = scripts\mp\gametypes\br_public.gsc::ondefuse( var_1, var_0.squadindex );
...
_id_1314D( var_0, var_1, var_2 )
{
    ...
    if ( var_7 != var_8 || var_4 || var_5 )
    {
        ...
        scripts\mp\utility\script::handle_train_veh_collision( var_9 );
...
getenemyteams( var_0 )
{
    ...
    if ( isdefined( level._id_13693 ) || scripts\mp\utility\game::clip_ent() )
