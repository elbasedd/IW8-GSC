...
codecallback_playeractive()
{
    ...
    if ( isdefined( level.detonatefunc ) )
        [[ level.detonatefunc ]]();
}
...
setupdamageflags()
{
    ...
    level.prematchmusic = 512;
    level.prematchloadouts = 1024;
    level.prepdoorsforunload = 2048;
    level.premount_goalradius = 4096;
    level.prematchspawnoriginteamcount = 8192;
    level.prepare_mission_failed_text = 16384;
    level.prematchrandomloadout = 32768;
    level.prematchplayedwelcomevo = 65536;
...
abortlevel()
{
    ...
    level.detonatefunc = ::callbackvoid;
