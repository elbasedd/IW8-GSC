...
init()
{
    ...
    level.spectateprop = getdvarint( "scr_map_use10v10_objectives", 0 );
    level.teambased = 0;
...
_id_11DE8()
{
    if ( ( scripts\mp\utility\game::getgametype() == "arm" || scripts\mp\utility\game::rotateviptoplayer() || scripts\mp\utility\game::scout_drone() ) && getdvarint( "scr_game_forceDefaultFallHeight", 0 ) != 1 )
    {
...
setdefaultcallbacks()
{
    ...
    level.detonatefunc = scripts\mp\playerlogic::determine_starting_breadcrumb;
