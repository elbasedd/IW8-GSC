...
score_event_nuked( var_0, var_1 )
{
    var_2 = getdvarint( "scr_checkValidAttachmentUnlock", 0 ) == 1;

    if ( var_2 )
        return scripts\mp\utility\weapon::breakgasmaskbr( var_0, var_1 );
...
validateloadout( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( scrambler_cleanup_player( var_0.loadoutprimary ) )
        var_2 = 1;
    ...
    if ( !scripts\mp\weapons::scr_br_collection_findpath( var_0.loadoutprimary ) )
    {
        var_2 = 1;
        var_3 = 1;
    }
    ...
    {
        if ( screen( var_0.loadoutprimary, var_0.loadoutprimaryvariantid ) )
            var_0.loadoutprimaryvariantid = -1;
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutprimaryattachments.size; var_5++ )
        {
            ...
            if ( restoreweaponstates( var_0.loadoutprimary, var_0.loadoutprimaryvariantid, var_6, var_7 ) )
                var_0.loadoutprimaryattachmentids[var_5] = 0;

            if ( var_6 != "none" && ( perkisrestricted( var_6, var_0.loadoutprimary ) || !score_event_nuked( var_0.loadoutprimary, var_6 ) ) )
            {
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( scrambler_cleanup_player( var_0.loadoutsecondary ) )
        var_2 = 1;
    ...
    {
        if ( screen( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid ) )
            var_0.loadoutsecondaryvariantid = -1;
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutsecondaryattachments.size; var_5++ )
        {
            ...
            if ( restoreweaponstates( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid, var_6, var_7 ) )
                var_0.loadoutsecondaryattachmentids[var_5] = 0;

            if ( var_6 != "none" && ( perkisrestricted( var_6, var_0.loadoutsecondary ) || !score_event_nuked( var_0.loadoutsecondary, var_6 ) ) )
            {
    ...
    if ( !scripts\mp\equipment::isequipmentprimary( var_0.loadoutequipmentprimary ) || !scripts\mp\equipment::rocket_fuel_x1( var_0.loadoutequipmentprimary ) )
    ...
    if ( !scripts\mp\equipment::isequipmentsecondary( var_0.loadoutequipmentsecondary ) || !scripts\mp\equipment::rocket_fuel_x1( var_0.loadoutequipmentsecondary ) )
...
validateattachments( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_17, var_12 in var_1 )
    {
        ...
        if ( isdefined( var_12 ) && var_12 != "none" )
        {
            ...
            if ( !scripts\mp\utility\weapon::breakerstate( var_3, var_12 ) )
            {
...
scrambler_cleanup_player( var_0 )
{
    return isdefined( level.weaponmapdata[var_0] ) && istrue( level.weaponmapdata[var_0]._id_12FB6 );
}
...
screen( var_0, var_1 )
{
    ...
    var_2 = var_0 + "|" + var_1;
    return isdefined( level.weaponlootmapdata[var_2] ) && istrue( level.weaponlootmapdata[var_2].rpg_shoot_at_trigs );
}

restoreweaponstates( var_0, var_1, var_2, var_3 )
{
    if ( scripts\mp\utility\game::isanymlgmatch() )
        return 1;
    ...
    for (;;)
    {
        ...
        {
            if ( !level.weaponlootmapdata[var_10].rpg_shoot_at_trigs )
            {
