...
scriptable_door_postinit()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        var_2.flag_progression = var_4;
        var_2.flag_on_vip_cash_collect = var_2.angles;
    }
}
...
system_init()
{
    ...
    scripts\engine\scriptable::_id_1219E( "door", ::scriptable_door_scriptable_used_callback );
