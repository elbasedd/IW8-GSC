...
_id_133F9( var_0, var_1, var_2, var_3 )
{
...
_id_133FA( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_133FB( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_133FC( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
_id_13400( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_13401( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_13402( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_13405( var_0, var_1, var_2, var_3 )
{
...
_id_13406( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_13407( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_13408( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( ( !isdefined( var_1 ) || var_1 != "death" ) && ( !isdefined( var_2 ) || var_2 != "death" ) && ( !isdefined( var_3 ) || var_3 != "death" ) && ( !isdefined( var_4 ) || var_4 != "death" ) && ( !isdefined( var_5 ) || var_5 != "death" ) && ( !isdefined( var_6 ) || var_6 != "death" ) )
        self endon( "death" );
...
_id_1340B( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_1340C( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_1340D( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_133F1( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_133F2( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_133F3( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_133F4( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_133F5( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
deletestruct_ref( var_0 )
{
    ...
    if ( isdefined( level.struct ) )
    {
        if ( level.struct.size > 5000 )
        {
            ...
            _id_11EE8( var_0, 0, level.struct.size );
    }
}

_id_11EE8( var_0, var_1, var_2 )
{
...
br_laststandfinishplayerisincapacitated( var_0, var_1 )
{
...
{
    var_3 = var_1 _id_133F7( var_2, "death" );
...
flag_wait_either_return( var_0, var_1 )
{
    for (;;)
    {
        ...
        var_2 = level _id_133F7( var_0, var_1 );
        return var_2;
    }
}
...
flag_wait_any_return( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        var_6 = level _id_133FA( var_0, var_1, var_2, var_3, var_4 );
        return var_6;
    }
}
...
is_train_ent( var_0, var_1, var_2, var_3 )
{
...
safefromnuke( var_0, var_1, var_2 )
{
...
run_debug_start_objective()
{
    ...
    if ( is_player_gamepad_enabled() )
        var_1 = _id_11EFE( "mountButtonConfig" );
    else
        var_1 = _id_11EFE( "mountButtonConfigKBM" );
