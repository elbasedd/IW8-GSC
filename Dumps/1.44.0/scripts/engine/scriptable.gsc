...
_id_1219E( var_0, var_1 )
{
    if ( !isdefined( level._id_121AE ) )
        level._id_121AE = [];

    if ( !isdefined( level._id_121AE[var_0] ) )
        level._id_121AE[var_0] = [];

    level._id_121AE[var_0][level._id_121AE[var_0].size] = var_1;
}

_id_1219B( var_0 )
{
    if ( !isdefined( level._id_1219F ) )
        level._id_1219F = [];

    level._id_1219F = scripts\engine\utility::array_add( level._id_1219F, var_0 );
}

_id_1219C( var_0 )
{
    if ( !isdefined( level._id_121A1 ) )
        level._id_121A1 = [];

    level._id_121A1 = scripts\engine\utility::array_add( level._id_121A1, var_0 );
}
...
scriptable_engineused( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( istrue( var_5 ) )
    {
        if ( isdefined( level._id_121A1 ) )
        {
            foreach ( var_7 in level._id_121A1 )
    ...
    if ( istrue( var_4 ) )
    {
        if ( isdefined( level._id_1219F ) )
        {
            foreach ( var_7 in level._id_1219F )
    ...
    else
    {
        ...
        if ( isdefined( level._id_121AE ) && isdefined( level._id_121AE[var_1] ) )
        {
            foreach ( var_7 in level._id_121AE[var_1] )
                [[ var_7 ]]( var_0, var_1, var_2, var_3, 1 );
        }
    }
}
...
_id_1219D( var_0 )
{
    if ( !isdefined( level._id_121A6 ) )
        level._id_121A6 = [];

    level._id_121A6 = scripts\engine\utility::array_add( level._id_121A6, var_0 );
}

_id_121AA( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( isdefined( level._id_121A6 ) )
    {
        foreach ( var_12 in level._id_121A6 )
