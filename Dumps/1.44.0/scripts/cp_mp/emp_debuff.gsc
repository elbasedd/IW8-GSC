...
waittill_num_and_all_spawns_dead_and_time_and_player_reset( var_0, var_1 )
{
    var_0 play_emp_scramble( var_1 );
    scripts\engine\utility::_id_133EF( "emp_cleared", "death" );
...
emp_update_ents()
{
    ...
    if ( isdefined( level.juggheli_spawner_jammer5_3 ) )
    {
        foreach ( var_28 in level.juggheli_spawner_jammer5_3 )
