...
empdrone_explodeemp()
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_9 = scripts\cp_mp\vehicles\vehicle_occupancy::_id_1324D( var_5 );
...
empdrone_applyemp( var_0 )
{
    ...
    if ( isplayer( var_0.victim ) )
    {
        ...
        if ( isdefined( var_0.attacker ) )
            var_0.attacker scripts\cp\helicopter\chopper_boss::onempdronehit( var_0.victim );
    }
