...
manualturret_delayplacementinstructions( var_0 )
{
    ...
    thread spawnzombiedogtags( "death" );
    thread spawnzombiedogtags( "turret_placement_finished" );
}

spawnzombiedogtags( var_0 )
{
...
manualturret_create( var_0, var_1 )
{
    ...
    var_3.focus_fire_is_activated.moverdoesnotkill = 1;
    var_3.focus_fire_is_activated._id_12F4B = var_3;
    return var_3;
}
...
manualturret_setplaced( var_0, var_1 )
{
    ...
    if ( !var_6 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
            var_0.minimapid = var_0.focus_fire_is_activated [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_7, var_0.team, undefined, 1, 1 );
    }
...
manualturret_setcarried( var_0 )
{
    ...
    if ( isdefined( self.moving_platform ) )
    {
        ...
        self.time_passed_no_target_threshold = undefined;
        self.time_on_floor = undefined;
        self unlink();
    }
    ...
    var_0 scripts\cp_mp\utility\weapon_utility::_id_1211E();
...
manualturret_switchbacklastweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::_id_11F71( self.lastdroppableweaponobj );
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        self._id_11A0B = var_3;
        manualturret_makealltriggersusable( 0 );
        var_3 scripts\cp_mp\utility\weapon_utility::_id_1211E();
        ...
        {
            var_7 = specialistbr( var_3, var_3.useweapon );
        ...
        if ( !istrue( var_7 ) )
        {
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    var_3 spectatekey( 1 );
                    var_8 = var_3 scripts\cp_mp\utility\weapon_utility::_id_11F71( var_3.lastdroppableweaponobj );
        ...
        if ( scripts\cp_mp\utility\game_utility::isnightmap() )
            var_3 scripts\common\utility::blockade_get_bomb_icon_on_cell_phone( 0 );

        manualturret_applyoverlay( var_3 );
        thread manualturret_disablefire( var_3, 0.5, 1 );
        thread manualturret_watchammotracker( var_3 );
        thread specialistperk( var_3 );
        thread spectatableprops( var_3 );
...
specialistbr( var_0, var_1 )
{
    self endon( "kill_turret" );
    self endon( "turret_switch_weapon_timeout" );
    var_0 endon( "death_or_disconnect" );
    level endon( "game_ended" );
    thread spectatepoint( 1.0 );
...
manualturret_endplayeruse( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( !istrue( var_0.sat_wait_for_power_think ) )
...
manualturret_endturretonplayer( var_0 )
{
    var_0 endon( "end_turret_use" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_133EF( "death_or_disconnect", "last_stand_start" );
    var_0 manualturret_endplayeruse( self );
}
...
manualturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0 scripts\cp_mp\utility\killstreak_utility::_id_11D86( self.streakinfo );
    }

    if ( isdefined( self._id_11A0B ) )
        self._id_11A0B manualturret_endplayeruse( self );
    ...
    if ( isdefined( self.focus_fire_is_activated ) )
...
manualturret_watchtimeout( var_0 )
{
    ...
    while ( self.timeelapsed < var_1 )
    {
        ...
        if ( isdefined( self._id_11A0B ) )
            self._id_11A0B setclientomnvar( "ui_killstreak_countdown", int( var_2 ) );

        self.timeelapsed = self.timeelapsed + level.framedurationseconds;

        if ( self.timeelapsed >= var_1 - 1.5 && !istrue( self._id_12A41 ) )
            self._id_12A41 = 1;
