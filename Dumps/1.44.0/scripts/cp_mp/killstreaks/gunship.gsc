...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread placing_c4_interaction_use_monitor( var_0 );
    var_9 thread plane_collmap( var_0, "disconnect" );
    var_9 thread plane_collmap( var_0, "joined_team" );
    var_9 thread plane_collmap( var_0, "joined_spectators" );
    var_9 thread plane_collmap( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        ...
        else if ( isdefined( level.placementstatsset ) )
            level.gunship.origin = level.placementstatsset;
        else
    ...
    level.gunship_intromodel thread plane( "disconnect", var_1 );
    level.gunship_intromodel thread plane( "joined_team", var_1 );
    level.gunship_intromodel thread plane( "joined_spectators", var_1 );
    waitframe();
...
plane( var_0, var_1 )
{
    ...
    place_weapons_at_pos( var_2, var_1 );
}

place_weapons_at_pos( var_0, var_1 )
{
    var_2 = 0;
...
placing_c4_interaction_use_monitor( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "crashing" );
