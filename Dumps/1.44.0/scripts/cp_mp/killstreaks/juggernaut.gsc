...
initconfig()
{
    ...
    if ( isdefined( level.animscripted_single ) )
        var_1 [[ level.animscripted_single ]]();
}
...
watchmarkeractivate( var_0 )
{
    ...
    else
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "juggernaut", "dropCrateFromScriptedHeli" ) && level.gametype != "br" )
        {
            ...
            var_2 thread scripts\cp_mp\killstreaks\airdrop::beaker_end_time( var_0, "airdrop" );
        ...
        {
            var_5 = 1;
            var_2 thread scripts\cp_mp\killstreaks\airdrop::_id_127ED( var_3, var_5 );
        }
    }
}
...
activatejugg( var_0 )
{
    ...
    thread _id_134ED( var_0 );
    thread watchforjuggernautend( var_0 );
    thread _id_134EC( var_0 );

    if ( level.gametype != "br" && !scripts\common\utility::iscp() )
        thread init_relic_headbullets();
}

init_relic_headbullets()
{
...
createjuggobjective()
{
    ...
    if ( istrue( level.select_cliff_two_spawners ) )
    {
        var_0 = 0;
    ...
    else
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            if ( level.teambased )
                ...
                scripts\mp\objidpoolmanager::_id_1304F( var_2, self );
        }
    }
}
...
watchjuggernautweaponswitch( var_0 )
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_133EF( "manual_switch_from_minigun", "weapon_pickup" );
