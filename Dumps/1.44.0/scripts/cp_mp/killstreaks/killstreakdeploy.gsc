...
ondeploystart( var_0 )
{
    ...
    var_0.owner scripts\common\utility::blink_wheelson_chosen_spawn( 0 );
}
...
ondeployfinished( var_0, var_1 )
{
    ...
    var_0.owner scripts\common\utility::blink_wheelson_chosen_spawn( 1 );
}
    ...
    for (;;)
    {
        ...
        if ( var_4 == var_2 )
        {
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    if ( isdefined( level.set_pressure_stability_reading ) )
                        [[ level.set_pressure_stability_reading ]]();
...
watchdeployweaponanimtransition( var_0, var_1, var_2 )
{
    ...
    var_4 = scripts\engine\utility::_id_13405( var_1, "death", "weapon_change", "cancel_all_killstreak_deployments" );
...
{
    self endon( "disconnect" );
    var_1 = scripts\engine\utility::_id_13403( var_0, "cancel_remote_sequence" );
    ...
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        var_1 = scripts\engine\utility::_id_13403( 0.7, "death" );
...
cleanupdeployweapon( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_6 = scripts\cp_mp\utility\killstreak_utility::sat_play_unfolding_sounds( var_2.basename );
        ...
        if ( isdefined( var_4 ) )
            ...
            oldest_targeted_by_chopper_time( var_2 );
