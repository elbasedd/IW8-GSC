...
tryusetomastrikefromstruct( var_0 )
{
    ...
    else if ( var_1 == 5 && isdefined( self.set_spawn_scoring_params_for_level ) )
    {
...
tomastrikeatlocation( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
    var_3.origin = var_0;
    var_3.angles = var_1;
    ...
    var_2.owner = var_3;
    var_2._id_12BB0 = var_0;
    var_2.ownerlookforward = anglestoforward( var_1 );
    var_2.skipobjectives = 1;
    var_3 thread starttomastrike( 5, undefined, undefined, var_2 );
}

createtomastrikedrone( var_0, var_1 )
{
    var_2 = scripts\cp_mp\utility\killstreak_utility::nuclear_core_on_chopper();
    var_3 = ( 0, 0, 0 );
...
tomastrike_watchowner()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_133F0( "disconnect", "joined_team", "joined_spectators" );
    self notify( "death" );
}
...
tomastrike_watchcameraswitch( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_6 = scripts\engine\utility::_id_133F7( "switch_camera_left", "switch_camera_right" );
...
tomastrike_getownerlookat( var_0 )
{
    ...
    var_5 = var_0 scripts\cp_mp\utility\killstreak_utility::zombienumhitscar();
...
tomastrike_attacktarget( var_0, var_1, var_2, var_3 )
{
    ...
    else
    {
        ...
        if ( !istrue( var_3.select_reception_spawners ) )
    ...
    {
        if ( var_0 == 5 && isdefined( var_3._id_12BB0 ) )
            var_6 = var_3._id_12BB0;
        else
            var_6 = tomastrike_getownerlookat( self );

        if ( !istrue( var_3.trap_array ) )
        {
            ...
            if ( !istrue( var_3.skipobjectives ) )
    ...
    if ( var_0 == 5 )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
        {
            ...
            var_9._id_12BB8 = var_6;
            self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "br", "challengeEvaluator" ) ]]( "br_mastery_pointBlank_tomahawk", var_9 );
        }

        var_7 = 6;

        if ( isdefined( var_3.trigger_elevator_spawners ) )
            var_7 = var_3.trigger_elevator_spawners;

        var_8 = 900;

        if ( isdefined( var_3.radiusoverwrite ) )
            var_8 = var_3.radiusoverwrite;

        if ( !istrue( var_3.skipdangernotify ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "dangerNotifyPlayersInRange" ) )
    ...
    else if ( var_0 == 1 || var_0 == 3 || var_0 == 4 || var_0 == 5 )
    {
        ...
        if ( isdefined( var_3.ownerlookforward ) )
            var_13 = var_3.ownerlookforward;
        else
...
findunobstructedfiringinfo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        ...
        var_7 = _id_12CD4( var_0, var_2, var_3, var_4 );

    var_8 = vectornormalize( var_0 - ( var_7[0], var_7[1], 0 ) );
    var_9 = _id_12CD5( var_0, var_1, var_8 );
    ...
    var_6.isbotmedicrole = var_9.isbotmedicrole;
    var_6.isbotpracticematch = var_9.isbotpracticematch;
...
delayscriptablechangethread( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    self.owner scripts\engine\utility::_id_13403( var_0, "stop_marker_guide" );
...
_id_12CD5( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_12["entity"] ) )
    {
        ...
        var_10.isbotmedicrole = var_13;

        if ( _id_12CD7( var_13 ) || _id_12CD6( var_13 ) )
            var_10.isbotpracticematch = "flying";
    }
...
tomastrike_firestrike( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1.usereload ) )
        var_5 = var_1.usereload;
    else
    ...
    var_4 thread _id_12CD3();
    var_4 thread toma_strike_watch_airexplosion( var_0.preexplpos, var_0.isbotmedicrole, var_0.isbotpracticematch );
...
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_13403( 10, "death" );
...
toma_strike_missile_explode( var_0 )
{
    ...
    if ( isdefined( level._id_12CD0 ) )
        self [[ level._id_12CD0 ]]();
...
toma_strike_create_explosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.usequesttimer ) )
        var_7 = var_5.usequesttimer;
    else
...
_id_12CD4( var_0, var_1, var_2, var_3 )
{
