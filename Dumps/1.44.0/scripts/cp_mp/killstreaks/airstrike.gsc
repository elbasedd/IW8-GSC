...
init()
{
    ...
    init_airstrike_vo();
    level.allowattackfromexposednonode = [];
    level.binoculars_onstatemarkpendingenter = 0;
}
...
weapongivenairstrike( var_0 )
{
    ...
    var_2 = binoculars_onstateinvalidupdate( self.origin );
...
{
    if ( !isdefined( var_0._id_12BB0 ) )
    {
        var_3 = airstrike_getownerlookatpos( self );
        var_4 = binoculars_onstateinvalidupdate( var_3 );
    ...
    switch ( var_0.streakname )
    {
        case "precision_airstrike":
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
            {
                ...
                if ( var_3 == "br" && isdefined( self.set_spawn_scoring_params_for_level ) )
                {
                    var_0._id_12BB0 = self.set_spawn_scoring_params_for_level;
                    self.set_spawn_scoring_params_for_level = undefined;
                }
            }
...
selectairstrikelocation( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        var_8 = binoculars_onstateinvalidupdate( var_2 );
...
finishmapselectairstrikeusage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 = binoculars_onstateinvalidexit( self.origin, self );
    thread airstrike_watchkills( var_7 * 2, var_8 );
    thread watchairstrikeowner( var_8 );
    thread binoculars_onstatemarkedenter( var_4, var_8 );
    ...
    binoculars_onstatelospendingexit( self, var_8 );
    ...
    scripts\cp_mp\utility\killstreak_utility::_id_11D86( var_4 );
}
...
finishstandardairstrikeusage( var_0, var_1, var_2 )
{
    ...
    var_6 = binoculars_onstateinvalidexit( var_0, self );
    thread airstrike_watchkills( var_5 * 2, var_6 );
    thread watchairstrikeowner( var_6 );
    thread binoculars_onstatemarkedenter( var_2, var_6 );
...
watchairstrikeowner( var_0 )
{
    ...
    level endon( "game_ended" );
    scripts\engine\utility::_id_133EF( "disconnect", "joined_team" );
    binoculars_onstatelospendingexit( self, var_0 );
}

callstrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 0;
    var_8 = scripts\cp_mp\utility\killstreak_utility::nuclear_core_on_chopper();
    var_9 = 24000;
    var_10 = 6500;
    var_11 = 2500;
    var_7 = 1500;
    ...
    if ( level.mapname == "mp_br_mechanics" || scripts\cp_mp\utility\game_utility::riskspawn_debugdvar() )
        var_11 = var_11 + 2500;
...
_id_134E7( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "air_strike_complete" );
    var_1 waittill( "disconnect" );

    if ( isdefined( var_0.level_killstreak_spawn ) )
        var_0.level_killstreak_spawn delete();
...
doplanestrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_15.owner = var_7;
    var_16 = istrue( level.script_deplay_post ) && ( isdefined( level._id_1360F ) && level._id_1360F == 6 );
    var_17 = var_16 || istrue( var_5.bomb_sites_spawn );
    ...
    var_15.binoculars_onstatemarkpendingupdate = var_8;
    ...
    {
        var_18 = spawnstruct();
        var_18.wait_for_tank_death = var_15;
        var_18._id_12BB8 = var_0;
    ...
    if ( !istrue( var_5.player_completed ) )
        level thread airstrike_playplaneattackfx( var_15, var_20, var_5 );

    if ( istrue( var_5.use_csm ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "airstrike", "overridePlayFlyFX" ) )
    ...
    wait_spawn_sidehouse_trucks( var_15 );
}
...
airstrike_playflyfx( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_0.level_killstreak_spawn thread airstrike_playapproachfx( 0.05 );
    var_0.level_killstreak_spawn thread airstrike_playflybyfx( 6.397 );
    var_0.level_killstreak_spawn thread airstrike_playflyoutfx( var_4 );
    var_0.level_killstreak_spawn thread airstrike_handleflyoutfxdeath( var_5 );
    var_0.level_killstreak_spawn thread binoculars_onstatelospendingenter( var_0 );
}
...
airstrike_watchkills( var_0, var_1 )
{
    ...
    self.binoculars_onstatemarkpendingexit = 0;
    var_2 = "airstrike_finished_" + var_1;
    childthread airstrike_watchkillscount( var_2 );
    scripts\engine\utility::_id_13409( var_0, var_2 );
    var_3 = isdefined( self.airstrikekillcount ) && self.airstrikekillcount >= 1;
    var_4 = isdefined( self.binoculars_onstatemarkpendingexit ) && self.binoculars_onstatemarkpendingexit >= 1;
    ...
    self.binoculars_onstatemarkpendingexit = undefined;
}
...
callstrike_precisionbulleteffect( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = var_6;
    var_10 = istrue( level.script_deplay_post ) && ( isdefined( level._id_1360F ) && level._id_1360F == 6 );
...
airstrike_getownerlookatpos( var_0, var_1 )
{
    ...
    var_6 = var_0 scripts\cp_mp\utility\killstreak_utility::zombienumhitscar();
...
airstrike_watchforads( var_0, var_1 )
{
    ...
    var_2 thread binoculars_onstatemarkedexit( self );
    var_2 thread airstrike_watchdeployended( self );
    var_2 thread binoculars_onstatelospendingupdate( self );
...
airstrike_watchdeployended( var_0 )
{
    ...
    self endon( "death" );
    level endon( "game_ended" );
    var_1 = var_0 scripts\engine\utility::_id_133F7( "cancel_fire", "successful_fire" );
...
binoculars_onstatemarkedenter( var_0, var_1 )
{
    self endon( "airstrike_finished_" + var_1 );
    self endon( "disconnect" );
    level waittill( "game_ended" );
    scripts\cp_mp\utility\killstreak_utility::_id_11D86( var_0 );
}

binoculars_onstateinvalidexit( var_0, var_1 )
{
    level.binoculars_onstatemarkpendingenter++;
    var_2 = spawnstruct();
    var_2.origin = var_0;
    var_2.owner = var_1;
    var_2.id = var_1.name + "_" + level.binoculars_onstatemarkpendingenter;
    level.allowattackfromexposednonode[var_2.id] = var_2;
    return var_2.id;
}

binoculars_onstatelospendingexit( var_0, var_1 )
{
    level.allowattackfromexposednonode = scripts\engine\utility::array_remove_index( level.allowattackfromexposednonode, var_1, 1 );
...
binoculars_onstateinvalidupdate( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        if ( level.allowattackfromexposednonode.size > 0 )
        {
            var_3 = 1;
            ...
            if ( level.allowattackfromexposednonode.size >= var_3 )
                var_1 = "KILLSTREAKS/AIR_SPACE_TOO_CROWDED";
            else
            {
                foreach ( var_6 in level.allowattackfromexposednonode )
                {
...
disable_fulton_group_interactions( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = spawnstruct();
    ...
    var_5.damage = 0;
    var_5.kills = 0;
    var_5.player_completed = istrue( var_1 );
    var_5.bomb_sites_spawn = istrue( var_2 );
    var_6 = var_3;
    var_7 = undefined;
