...
initcratedata()
{
    ...
    level.cratedata._id_12FDF = pow( getdvarfloat( "scr_crateUnresolvedCollisionToleranceSqr", 2 ), 2 );
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "registerPlayerFrameUpdateCallback" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "registerPlayerFrameUpdateCallback" ) ]]( ::_id_12D39 );
...
getemptyleveldata()
{
    ...
    var_0.play_get_in_sequence_for_convoy_vehicle = 27.5;
...
createcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( level.gametype == "infect" )
        var_11.scn_infil_hackney_heli_npc1 = 1;
    ...
    if ( isdefined( var_11.owner ) )
        var_11.owner.roof_rpg_behavior = 1;
...
activatecrate( var_0 )
{
    ...
    self.roof_rpg_behavior_internal = undefined;
...
capturecrate( var_0 )
{
    ...
    if ( isdefined( self.owner ) && istrue( self.owner.roof_rpg_behavior ) )
        self.owner.roof_rpg_behavior = 0;
...
destroycrate( var_0 )
{
    ...
    if ( !istrue( var_0 ) )
    {
        ...
        if ( !istrue( self.physicsactivated ) || !istrue( self.vfx_struct ) )
        {
...
initcratedropdata()
{
    var_0 = spawnstruct();
    var_0.helis = [];
    var_1 = scripts\cp_mp\utility\killstreak_utility::nuclear_core_on_chopper();
...
watchdropcratefrommanualheliinternal()
{
    ...
    {
        self.heli scripts\engine\utility::_id_133EF( "death", "goal" );
...
watchcrateuse( var_0, var_1 )
{
    ...
    if ( var_0 == 1 )
    {
        ...
        self.owner endon( "joined_team" );
        self.owner endon( "joined_spectators" );
        self.owner.roof_rpg_behavior = 1;
    }
    ...
    if ( isdefined( var_3._id_1312F ) )
        var_3.usetime = var_3._id_1312F;
    ...
    for (;;)
    {
        ...
        if ( level.gametype == "br" )
        {
                ...
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "teamJuggMaxReached" ) )
                {
                    ...
                    if ( var_5 )
                    {
                        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
                            var_4 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "hud", "showErrorMessage" ) ]]( "VOV/JUGG_LIMIT_REACHED" );
            ...
            if ( istrue( var_4.isjuggernaut ) && !var_4 see_recently_override( self.cratetype ) )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
...
beacon()
{
    ...
    level endon( "game_ended" );
    scripts\cp_mp\utility\weapon_utility::_id_1211E();
...
bears( var_0 )
{
    ...
    else
    {
        ...
        {
            var_1 = scripts\cp_mp\utility\weapon_utility::_id_11F71( self.lastdroppableweaponobj );
...
spawnheliactorsfunc( var_0, var_1 )
{
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_5 in var_2 )
            {
                ...
                if ( var_6 )
                    spawnheliactorsfunc( var_1, var_5 );
            }
        }
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_3 in level.players )
                spawnheliactorsfunc( var_1, var_3 );
        }
...
gesture_checker( var_0, var_1 )
{
    var_2 = getleveldata( self.cratetype );

    if ( isdefined( var_2.get_active_bombzones ) )
        self thread [[ var_2.get_active_bombzones ]]();
    ...
    createdangerzone();
    thread tank_durations();
    thread tank_westturret();
    thread tanks_killed();
}
...
genuine_cypher_pieces()
{
    ...
    self.vfx_struct = undefined;
    self physicsstopserver();
    findeventforchosenweight();
    tank_x1();
...
tank_durations()
{
    ...
    var_0 = 0.1;
    thread tank_do_extra_damage( var_0, 8 );
    var_1 = 0;
    var_2 = 0;
    self.roof_rpg_behavior_internal = 1;
    var_3 = undefined;
    var_4 = undefined;
    ...
    for (;;)
    {
        var_5 = move_to_track_end();
        var_6 = move_to_new_node();
        ...
        if ( isdefined( var_5 ) && isdefined( var_6 ) )
        {
            if ( var_5 <= 5.0 && var_6 <= 1.0 )
            {
                ...
                if ( var_1 == 6 )
                {
                    self.vfx_struct = 1;
                    var_3 = self.origin;
                    thread activatecrate( self.roof_rpg_behavior_internal );
                    ...
                    var_0 = 0.1;
                    thread tank_do_extra_damage( var_0, 3, 3 );
                    hanging_crate_think();
                }
            }
            else
...
tank_do_extra_damage( var_0, var_1, var_2 )
{
    findeventforchosenweight();
    self endon( "death" );
    self endon( "clear_average_velocities" );
    self.signal_yaw = [];
    self.bot_add_landing_spot = [];
    self._id_132ED = 0;
    self._id_132E8 = 0;
    self._id_132EA = var_1;
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_2 > 0 )
        {
            ...
            {
                self.signal_yaw[self._id_132ED + var_3] = 0;
                self.bot_add_landing_spot[self._id_132ED + var_3] = 0;
            }
        }
    }
    ...
    for (;;)
    {
        ...
        self.signal_yaw[self._id_132E8] = length( var_5 );
        self.bot_add_landing_spot[self._id_132E8] = length( var_6 );
        self._id_132E8++;
        var_7 = self._id_132E8 - self._id_132ED;
        ...
        if ( var_7 > var_1 )
        {
            ...
            {
                self.signal_yaw[self._id_132ED + var_3] = undefined;
                self.bot_add_landing_spot[self._id_132ED + var_3] = undefined;
            }

            self._id_132ED = self._id_132ED + var_8;
        }

        self.brplayerkilledspawn = undefined;
        self.brplayerhudoutlineupdatefromnotify = undefined;
        wait( var_0 );
    }
}
...
move_to_track_end()
{
    if ( isdefined( self.brplayerkilledspawn ) )
        return self.brplayerkilledspawn;

    if ( !isdefined( self.signal_yaw ) )
        return undefined;

    if ( self._id_132E8 - self._id_132ED < self._id_132EA )
        return undefined;
...
move_to_new_node()
{
    if ( isdefined( self.brplayerhudoutlineupdatefromnotify ) )
        return self.brplayerhudoutlineupdatefromnotify;

    if ( !isdefined( self.bot_add_landing_spot ) )
        return undefined;
...
deployed()
{
    ...
    for ( var_2 = self._id_132ED; var_2 < self._id_132E8; var_2++ )
    {
        var_0 = var_0 + self.signal_yaw[var_2];
        var_1 = var_1 + self.bot_add_landing_spot[var_2];
    }

    self.brplayerkilledspawn = var_0 / self._id_132EA;
    self.brplayerhudoutlineupdatefromnotify = var_1 / self._id_132EA;
}

findeventforchosenweight()
{
    self notify( "clear_average_velocities" );
    self.signal_yaw = undefined;
    self.bot_add_landing_spot = undefined;
    self._id_132EA = undefined;
    self._id_132ED = undefined;
    self._id_132E8 = undefined;
    self.brplayerkilledspawn = undefined;
    self.brplayerhudoutlineupdatefromnotify = undefined;
}
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) )
        {
            if ( isdefined( var_9.classname ) && var_9.classname == "scriptable_iw8_chicken_01" )
                thread bdroppingshield( var_9 );

            end_nuke_vault( var_9 );
        }

        if ( isdefined( var_9 ) && process_elevator_request( var_9 ) )
        {
            if ( var_9 scripts\cp_mp\killstreaks\helper_drone::round_enemies_push_logic() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            _id_11A5E( var_6, var_7, var_8, var_11 );
        }
    }
}

end_nuke_vault( var_0 )
{
    if ( isdefined( var_0.script_noteworthy ) && isstartstr( var_0.script_noteworthy, "train_" ) && !isdefined( self getlinkedparent() ) )
    {
        if ( isdefined( self._id_12DB1 ) )
        {
            if ( self._id_12DB1 == var_0 )
                return;
            else
                disconnecting();
        }

        self._id_12DB1 = var_0;
        self._id_12DB0 = 4;
        thread end_origin( var_0 );
    }
}
...
end_origin( var_0 )
{
    ...
    while ( self._id_12DB7 < 5 )
    {
        var_7 = self.origin + anglestoup( self.angles ) * var_1.play_get_in_sequence_for_convoy_vehicle;
        var_8 = var_7 + ( 0, 0, -200 );
        var_9 = scripts\engine\trace::ray_trace( var_7, var_8, var_3, var_2 );

        if ( var_9.size > 0 && isdefined( var_9["entity"] ) && var_9["entity"] == self._id_12DB1 )
        {
            var_10 = combineangles( invertangles( var_0.angles ), var_0.origin - var_9["position"] );

            if ( !isdefined( self._id_12DB8 ) )
            {

            }
            else if ( distancesquared( var_10, self._id_12DB8 ) > 25 )
            {
                self._id_12DB7++;
                self._id_12DB9 = 0;
            }
            else if ( vectordot( var_10, self._id_12DB8 ) < 0.997 )
            {
                self._id_12DB7++;
                self._id_12DB9 = 0;
            }
            else
            {
                ...
                {
                    self linkto( var_0 );
                    activatecrate( self.roof_rpg_behavior_internal );
                    thread genuine_cypher_pieces();
                    break;
                }
            }

            self._id_12DB8 = var_10;
        }
        else
            break;
...
disconnecting()
{
    ...
    self._id_12DB1 = undefined;
    self._id_12DB8 = undefined;
    self._id_12DB7 = undefined;
    self._id_12DB9 = undefined;
}
...
tank_x1()
{
    if ( !istrue( self.tank_x2 ) )
        return;

    self notify( "monitorImpactEnd" );
    self.tank_x2 = undefined;
...
process_elevator_request( var_0 )
{
    if ( !istrue( self.vfx_struct ) )
    {
        if ( isdefined( var_0.classname ) )
        {
            ...
            {
                if ( var_0 scripts\cp_mp\killstreaks\helper_drone::round_enemies_push_logic() )
                {
                    var_1 = getleveldata( self.cratetype );
                    var_2 = self.origin + anglestoup( self.angles ) * var_1.play_get_in_sequence_for_convoy_vehicle;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && ( isplayer( var_2 ) || isagent( var_2 ) ) && var_2 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( var_2 tagexists( "j_mainroot" ) )
            {
                ...
                var_8 = self.origin + anglestoup( self.angles ) * var_7.play_get_in_sequence_for_convoy_vehicle;
...
_id_11A5E( var_0, var_1, var_2, var_3 )
{
...
{
    if ( level.cratedata._id_12FDF > 0 )
    {
        if ( lengthsquared( var_1 ) <= level.cratedata._id_12FDF )
            return;
    }

    var_2 = self.objweapon;

    if ( isdefined( self.get_ai_within_range ) )
...
_id_12D39()
{
    if ( !isdefined( self.iscacprimaryweapongroup ) )
    {
        if ( self ismantling() )
        {
            ...
            {
                self.isbunkeraltenabled = var_0;
                self.isburstweapon = var_0.crate;
            }

            self.iscacprimaryweapongroup = gettime() + 1000;
        }
    }
    else if ( gettime() >= self.iscacprimaryweapongroup )
    {
        self.isbunkeraltenabled = undefined;
    ...
    else
    {
        ...
        {
            if ( isdefined( var_2 ) && istrue( var_2.physicsactivated ) && !istrue( var_2.vfx_struct ) )
            {
                if ( isdefined( self.isbunkeraltenabled ) )
                {
                    if ( isdefined( var_2.mountmantlemodel ) )
                    {
                        if ( self.isbunkeraltenabled != var_2.mountmantlemodel )
                        {
...
dropkillstreakcratefromscriptedheli( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 thread beaker_end_time( var_7 );
...
airdrop_watchplayerweapon( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_133F7( "cancel_deploy", "weapon_switch_started" );
...
airdropmarkeractivate( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::_id_11D86( var_2 );
}
...
initbattleroyaleloadoutcratedata()
{
    ...
    var_0.dummymodel = multieventdebug();
    ...
    var_0.destroycallback = ::create_passengers_unload_groups;
...
redeployspawn()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::col_localethink_objectivevisibility;
    var_0.capturecallback = ::col_removelocaleinstance;
    var_0.destroycallback = ::col_removequestinstance;
    var_0.get_active_bombzones = ::collbrush;
    var_0.destroyoncapture = 1;
}
...
init_pipe_room_obj( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 250;
    var_8 = level.delete_race;
    var_9 = 1000;
    var_10 = 10500;
    var_11 = 7500;
    var_12 = 3000;
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( !var_5 && var_13[2] < var_0[2] )
        {
            ...
            if ( isdefined( var_16 ) )
            {
                ...
                var_15 thread _id_134CD();
                var_20 thread _id_134CE( var_19 );
            }
            else
                var_15 gesture_checker();
        }
        else
            var_15 gesture_checker();
        ...
        var_15._id_125EB = spawn( "script_model", var_1 );
        var_15._id_125EB setmodel( "ks_airdrop_crate_br" );

        if ( !istrue( var_6 ) )
            var_15._id_125EB setscriptablepartstate( "smoke_signal", "on", 0 );

        var_23 = getleveldata( var_14 );

        if ( isdefined( var_23._id_11B10 ) )
            var_15 thread [[ var_23._id_11B10 ]]();
    }
...
redlight()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::create_rocket_death_fx;
    var_0.capturecallback = ::create_saw_interaction;
    var_0.destroycallback = ::create_score_message;
    var_0.destroyoncapture = 1;
}
...
init_player_health( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_125EB = spawn( "script_model", var_1 );
        var_2._id_125EB setmodel( "ks_airdrop_crate_br" );
        var_2._id_125EB setscriptablepartstate( "smoke_signal", "on", 0 );
    }
...
init_player_plane_exit_anims( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_125EB = spawn( "script_model", var_1 );
        var_2._id_125EB setmodel( "ks_airdrop_crate_br" );
        var_2._id_125EB setscriptablepartstate( "smoke_signal", "pe_chopper_on", 0 );
    }
...
redeployspawns()
{
    ...
    var_0.dummymodel = multieventdebug( "battle_royale_juggernaut" );
    var_0.friendlymodel = undefined;
    var_0.enemymodel = undefined;
    var_0.mountmantlemodel = undefined;
    var_0.supportsownercapture = 0;
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::convoy4_actively_hacking;
    var_0.destroycallback = ::convoy4_failed_extract;
    var_0.activatecallback = ::convert_remaining_to_ai;
    var_0.get_active_bombzones = ::convoy4_module_snipers;
    var_0._id_11B10 = ::convoy4_mortar_guys;
    var_0.destroyoncapture = 1;
}

convert_remaining_to_ai( var_0 )
{
...
convoy4_actively_hacking( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
convoy4_module_snipers( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}
...
init_relic_doubletap( var_0, var_1, var_2 )
{
...
_id_127ED( var_0, var_1 )
{
    ...
    if ( istrue( self.risk_flagspawncountchange ) )
        var_2 = 10000;

    var_3 = init_relic_doubletap( self.team, var_0 + ( 0, 0, var_2 ), var_0 + ( 0, 0, 512 ) );
    var_3 endon( "death" );
    initoperationcratedata( var_3 );
    entercodenumber( var_3 );
    var_4 = [];
...
redployanywhere()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::current_zone;
    var_0.activatecallback = ::current_volume_num;
    var_0.destroycallback = ::currentability;
    var_0.get_active_bombzones = ::currentbestdist;
    var_0.destroyoncapture = 1;
}
...
init_respawns( var_0 )
{
    ...
    var_3 = var_0 + ( 0, 0, 512 );
    level._id_11F92.lower_door_coll = spawnfx( level._effect["smoke_tactical_device"], level._id_11F92.hastargetmarker - ( 0, 0, 60 ) );
    triggerfx( level._id_11F92.lower_door_coll );
    var_4 = dropcrate( undefined, undefined, "battle_royale_tactical_device", var_2, ( 0, randomfloat( 360 ), 0 ), var_3 );
    var_4.skipminimapicon = 1;
    currentbestpos( var_4 );
}
...
currentbestdist( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}

currentbestpos( var_0 )
{
...
multieventdebug( var_0 )
{
    ...
    else if ( isdefined( var_0 ) && var_0 == "battle_royale_juggernaut" && istrue( level.overridejuggcratevisual ) )
        var_2 = "military_carepackage_01_br_jugg";
    else
        var_2 = "military_carepackage_01_br";
