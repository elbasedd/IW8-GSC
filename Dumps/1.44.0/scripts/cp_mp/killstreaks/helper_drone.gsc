...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].sq_movequestlocale = 1;
    level.helperdronesettings["radar_drone_recon"].sq_ontimerexpired = 1;
    level.helperdronesettings["radar_drone_recon"].ss_ontimerexpired = 3062500;
    level.helperdronesettings["radar_drone_recon"].ss_playerdisconnect = 6250000;
    ...
    level.helperdronesettings["assault_drone"].primarymodefunc = ::_id_12357;
    ...
    level.helperdronesettings["assault_drone"].sq_movequestlocale = 0;
    level.helperdronesettings["assault_drone"].sq_ontimerexpired = 0;
    level.helperdronesettings["assault_drone"].ss_ontimerexpired = 73984;
    level.helperdronesettings["assault_drone"].ss_playerdisconnect = 73984;
    level.helperdronesettings["assault_drone"].hasdropped = 1;
    level.helperdronesettings["assault_drone"].hasdonestartmusic = undefined;
    level.helperdronesettings["assault_drone"].hasexiteddriver = 1;
    level.helperdronesettings["assault_drone"].usbvm = undefined;
    var_0 = "br";
    ...
    level.branalytics_disconnect = getdvarfloat( "scr_assault_drone_enemy_notify_dist", 3000.0 );
    level.branalytics_delayedshowtablets = getdvarint( "scr_assault_drone_freeze_debug", 0 );
    level.init_global_cp_script_funcs = getdvarint( "scr_drone_freeze_switch_debug", 1 );
}
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    var_5 = self.projectiledeletethread;
    self.projectiledeletethread = undefined;
    ...
    {
        if ( istrue( level.init_global_cp_script_funcs ) )
        ...
        var_10 = 0.6;
        var_11 = 2;
        var_12 = scripts\engine\utility::_id_13404( var_10, "death", "weapon_switch_started" );
        ...
        var_12 = scripts\engine\utility::_id_13403( var_11 - var_10, "death" );
    ...
    else if ( var_6 == "scrambler_drone_guard" )
    {
        ...
        if ( isdefined( level._id_12D28 ) )
        {
            var_15 = [[ level._id_12D28 ]]( self.origin );
    ...
    if ( level.gametype == "br" )
    {
        if ( var_6 == "scrambler_drone_guard" )
            scripts\cp_mp\killstreaks\uav::_id_12F91( self.team, 15000, "scrambler_drone_guard" );
    }
...
tryusehelperdroneearlyout( var_0, var_1 )
{
    ...
    if ( ( var_0.streakname == "radar_drone_recon" || var_0.streakname == "assault_drone" ) && ( !self isonground() && !self isonladder() || scripts\mp\vehicles\vehicle_compass_mp::rungwperif_largeexplosions() ) )
    {
        if ( var_1 )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    if ( isdefined( level.enable_lbravo_player_infil ) )
    {
        if ( ![[ level.enable_lbravo_player_infil ]]( self ) )
        {
            if ( var_1 )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
            ...
            case "radar_drone_recon":
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
                {
                    if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br" )
                    {
                        ...
                        var_9 playersetispropgameextrainfo( var_2 );
                    }
                }
...
playersetispropgameextrainfo( var_0 )
{
    ...
    if ( var_0 == "assault_drone" )
        var_1 = level.branalytics_disconnect;
...
helperdrone_endscramblereffect()
{
    ...
    if ( isdefined( self.is_ascender_use_allowed ) && self.is_ascender_use_allowed.size > 0 )
    {
        foreach ( var_1 in self.is_ascender_use_allowed )
        {
            if ( isdefined( var_1 ) )
            {
                var_2 = var_1;
...
{
    scripts\engine\utility::_id_133EF( "death_or_disconnect", "scramble_off" );
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( var_1.is_ascender_use_allowed, var_3 ) )
            var_1.is_ascender_use_allowed[var_1.is_ascender_use_allowed.size] = var_3;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_133EF( "death", "scramble_off" );

    if ( isdefined( self ) )
    {
        helperdrone_setscramblerjammed( 0, var_0, var_1 );

        if ( isdefined( var_0 ) && isdefined( var_0.is_ascender_use_allowed ) )
            var_0.is_ascender_use_allowed = scripts\engine\utility::array_remove( var_0.is_ascender_use_allowed, self );
    }
    else if ( isdefined( var_0 ) && isdefined( var_0.is_ascender_use_allowed ) )
        var_0.is_ascender_use_allowed = scripts\engine\utility::array_removeundefined( var_0.is_ascender_use_allowed );
}
        ...
        foreach ( var_5 in level.supportdrones )
        {
            ...
            if ( level.teambased )
            {
                if ( !isdefined( var_1 ) && var_5.team == self.team )
                    ...
                    var_3 = var_5.is_ascender_use_allowed;
            }
...
starthelperdrone( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        if ( var_2 == "br" )
            var_0 thread playersetiszombieextrainfo( self );
    }
...
helperdrone_overwatchplayer()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_133EF( "goal", "begin_evasive_maneuvers" );
...
helperdrone_pingnearbyenemies()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_4 in var_2 )
        {
            ...
            if ( var_4 playersetgulagdataomnvar( self ) )
                continue;
...
helperdrone_watchpingedstatus( var_0, var_1 )
{
    ...
    self.vo_stealth_broken[self.vo_stealth_broken.size] = var_0;
    var_0 scripts\engine\utility::_id_13403( 3, "death" );
    self.vo_stealth_broken = scripts\engine\utility::array_remove( self.vo_stealth_broken, var_0 );
}
...
playersetgulagdataomnvar( var_0 )
{
    ...
    foreach ( var_3 in var_0.vo_stealth_broken )
    {
...
setreconmodesettings( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::time_reduction_bonus( self.owner );

    if ( !istrue( var_1 ) )
    {
        self.owner _id_123D0( 1, self );
    ...
    thread playersetkeypadcodelengthindex( var_0 );
    thread helperdrone_handlethermalswitch();
    thread playersetisbecomingzombie( var_0 );
    return 1;
}
...
_id_12357( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        ...
        scripts\cp_mp\utility\weapon_utility::setlockedonremovedcallback( self, ::helperdrone_lockedonremovedcallback );
        thread helperdrone_watchouterreticletargets( var_0 );
        thread playersetomnvarattraction( var_0 );
        thread playersetignoreattractions( var_0 );
    }
    ...
    if ( istrue( level.branalytics_delayedshowtablets ) )
        thread playersetattractiontype( 2 );
...
helperdrone_watchearlyexit( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "allowRideKillstreakPlayerExit" ) )
        self thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "allowRideKillstreakPlayerExit" ) ]]( "death", var_0.usbvm );

    self waittill( "killstreakExit" );
    thread helperdroneexplode( 0, istrue( var_0.hasdonestartmusic ) );
}

playersetkeypadcodelengthindex( var_0 )
{
    if ( !istrue( var_0.hasdropped ) )
        return;
...
playersetisbecomingzombie( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            ...
            var_2 = var_1.vehicle;
        else if ( istrue( var_1.seq3_sequences_correct ) )
            var_2 = var_1;
        ...
        if ( istrue( var_0.hasexiteddriver ) )
        {
...
playersetattractiontype( var_0 )
{
    ...
    self endon( "death" );
    wait( var_0 );
    self.owner thread scripts\cp_mp\utility\player_utility::add_pack_camanim();
}
...
helperdrone_markplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.bot_gametype_get_players_by_role = 0;
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_2++;
            _id_123E1( self.targetmarkergroup, var_5, 1 );
            ...
            if ( var_8 )
                self.bot_gametype_get_players_by_role = 1;

            if ( var_9 )
            {
                _id_123E1( self.targetmarkergroup, var_5, 3 );
                continue;
            }

            if ( !var_8 || !var_6 )
            {
                _id_123E1( self.targetmarkergroup, var_5, 0 );
                continue;
            }
...
playersetignoreattractions( var_0 )
{
    var_1 = self.owner;
    var_1 endon( "disconnect" );
    self endon( "death" );
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_3 )
        {
            ...
            var_2++;
            _id_123E1( self.targetmarkergroup, var_6, 1 );
            var_7 = canseetarget( var_6 );
            var_8 = isinmarkingrange( var_6 );

            if ( !var_8 || !var_7 )
            {
                _id_123E1( self.targetmarkergroup, var_6, 0 );
                continue;
            }

            var_4 = 1;
            _id_123E1( self.targetmarkergroup, var_6, 2 );
        }

        self._id_12BAB = var_4;
        var_2 = 0;
        waitframe();
    }
}
...
playersetomnvarattraction( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "switch_modes" );
    ...
    for (;;)
    {
        if ( istrue( self._id_12BAB ) && var_1 == 0 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 1 );
            var_1 = 1;
        }
        else if ( !istrue( self._id_12BAB ) && var_1 == 1 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 0 );
            var_1 = 0;
        }
...
helperdrone_watchnotificationstate( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( !istrue( self.bot_gametype_get_players_by_role ) )
...
helperdrone_watchouterreticletargets( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.animscripted_loop_for_time ) )
        {
            ...
            {
                if ( isdefined( var_6.getgametypeweaponxpmultiplier ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "gameFlag" ) )
                    {
                        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "gameFlag" ) ]]( "prematch_done" ) )
                        {
                            ...
                            {
                                if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isPlayerOnIntelChallenge" ) ]]( self.owner, var_6.getgametypeweaponxpmultiplier ) )
        ...
        foreach ( var_10 in var_8 )
        {
            if ( isplayer( var_10 ) )
            {
                ...
                if ( !istrue( var_0.sq_movequestlocale ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                    {
            ...
            if ( istrue( var_0.sq_ontimerexpired ) && !self.owner helperdrone_istargetinreticle( var_10, 70, 300 ) )
                continue;
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_0._id_11D7B ) )
        var_2 = var_0._id_11D7B;
    else
        var_2 = scripts\engine\trace::create_contents( 0, 1, 0, 1, 1, 1, 0, 1 );

    var_3 = var_0.origin;

    if ( isdefined( var_0._id_11D7C ) )
        var_3 = var_3 + var_0._id_11D7C;
...
startmarkingpassivetarget( var_0 )
{
    ...
    _id_123E1( self.targetmarkergroup, var_0, 0 );
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( istrue( var_2.sq_ontimerexpired ) && !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0._id_11D79 ) )
        [[ var_0._id_11D79 ]]( var_4, var_0 );
    ...
    self.owner stoplocalsound( "recon_drone_marking_owner" );
    self.owner _id_123D0( 4, self );
    _id_123E1( self.targetmarkergroup, var_0, 2 );
...
isinmarkingrange( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( var_2, var_1.ss_playerdisconnect, var_1.ss_ontimerexpired );

    if ( isdefined( var_0.sq_playerdisconnect ) )
        var_3 = var_0.sq_playerdisconnect;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_13404( var_2, "death", "explode" );
...
helperdrone_watchforgoal()
{
    ...
    var_0 = scripts\engine\utility::_id_133F8( "goal", "near_goal", "hit_goal" );
    self.intransit = 0;
    self.inactive = 0;
...
helperdrone_watchroundend()
{
    ...
    self.owner endon( "disconnect" );
    self endon( "owner_gone" );
    level scripts\engine\utility::_id_133F0( "round_end_finished", "game_ended", "prematch_cleanup" );
    thread helperdrone_leave();
}
...
removehelperdrone( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.owner ) )
    {
        ...
        self.streakinfo.isverdansksubmap = istrue( var_2 );
        self.owner scripts\cp_mp\utility\killstreak_utility::_id_11D86( self.streakinfo );
    }
...
helperdrone_returnplayer( var_0 )
{
    ...
    var_0 thread playersetcontrols();
    var_0 cameraunlink( self );
    var_0 remotecontrolvehicleoff();
    scripts\cp_mp\utility\killstreak_utility::time_watcher( var_0 );
...
helperdrone_destroyongameend()
{
    ...
    self endon( "leaving" );
    self endon( "explode" );
    level scripts\engine\utility::_id_133F0( "bro_shot_start", "game_ended", "ending_sequence" );
...
helperdrone_istargetinreticle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0._id_11D7C ) )
        var_4 = var_4 + var_0._id_11D7C;

    var_5 = [ var_4 ];

    if ( isplayer( var_0 ) )
    {
        var_6 = var_0 scripts\mp\utility\player::oneoffuavsweeps();
