...
{
    if ( !istrue( var_1 ) )
        scripts\cp_mp\killstreaks\killstreakdeploy::oldest_targeted_by_chopper_time( var_2 );
}
...
tryusesentryturretfromstruct( var_0 )
{
    ...
    scripts\cp_mp\killstreaks\manual_turret::spectatecommands( 0 );
    var_2 = sentryturret_create( "sentry_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        scripts\cp_mp\killstreaks\manual_turret::spectatecommands( 1 );
        self.bgivensentry = 0;
        return 0;
    }
...
sentryturret_delayplacementinstructions( var_0 )
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::spawnzombiedogtags( "death" );
    thread scripts\cp_mp\killstreaks\manual_turret::spawnzombiedogtags( "turret_placement_finished" );
}
...
sentryturret_create( var_0, var_1 )
{
    ...
    var_3.focus_fire_is_activated = spawn( "script_model", var_3.origin );
    var_3.focus_fire_is_activated.team = var_3.team;
    var_3.focus_fire_is_activated.owner = var_3.owner;
    var_3.focus_fire_is_activated setmodel( "weapon_vm_mg_sentry_turret_invis_base" );
    var_3.focus_fire_is_activated dontinterpolate();
    var_3.focus_fire_is_activated hide();
    var_8 = 0;
    ...
    if ( var_8 )
    {
        var_3.focus_fire_outline_enabled = spawn( "script_model", var_3.origin );
        var_3.focus_fire_outline_enabled.team = var_3.team;
        var_3.focus_fire_outline_enabled.owner = var_3.owner;
        var_3.focus_fire_outline_enabled setmodel( "weapon_vm_mg_sentry_turret_invis_base_vehicle" );
        var_3.focus_fire_outline_enabled dontinterpolate();
        var_3.focus_fire_outline_enabled hide();
    }
...
sentryturret_setplaced( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.moving_platform ) )
    {
        ...
        var_0.time_passed_no_target_threshold = var_1.time_passed_no_target_threshold;
        var_0.time_on_floor = var_1.time_on_floor;
    }

    self.bgivensentry = 0;
    var_0.origin = var_1.location;
    var_0 playsound( "sentry_gun_plant" );
    var_0.focus_fire_is_activated show();
    var_0.focus_fire_is_activated.angles = var_0.angles;
    var_0.focus_fire_is_activated.origin = var_0.origin;
    var_5 = var_0.focus_fire_is_activated;

    if ( var_4 )
    {
        var_0.focus_fire_outline_enabled show();
        var_0.focus_fire_outline_enabled.angles = var_0.angles;
        var_0.focus_fire_outline_enabled.origin = var_0.origin;
        var_0.focus_fire_is_activated linkto( var_0, "tag_turret" );
        var_0.focus_fire_outline_enabled linkto( var_0, "tag_turret" );
        var_0.focus_fire_outline_enabled linkto( var_0, "tag_aim_pivot" );
        var_5 = var_0.focus_fire_outline_enabled;
    }
    else
        var_0.focus_fire_is_activated linkto( var_0, "tag_aim_pivot" );

    var_0 thread _id_1225E( var_0, var_5 );
...
sentryturret_setcarried( var_0 )
{
    ...
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_0.time_passed_no_target_threshold = undefined;
        var_0.time_on_floor = undefined;
        var_0 unlink();
    }
    ...
    var_0.focus_fire_is_activated unlink();
    var_0.focus_fire_is_activated hide();

    if ( var_5 )
    {
        var_0.focus_fire_outline_enabled unlink();
        var_0.focus_fire_outline_enabled hide();
    }
...
sentryturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        var_0.streakinfo.isverdansksubmap = istrue( var_2 );
        scripts\cp_mp\utility\killstreak_utility::_id_11D86( var_0.streakinfo );
    }
    ...
    if ( isdefined( var_0.focus_fire_is_activated ) )
        var_0.focus_fire_is_activated delete();

    if ( isdefined( var_0.focus_fire_outline_enabled ) )
        var_0.focus_fire_outline_enabled delete();
...
sentryturret_watchdisown( var_0 )
{
    var_0 endon( "kill_turret" );
    var_0 endon( "carried" );
    scripts\engine\utility::_id_133F0( "disconnect", "joined_team", "joined_spectators" );
    var_0 notify( "kill_turret", 0, 0 );
}
...
_id_1225B()
{
    var_0 = scripts\mp\vehicles\cargo_truck_mg_mp::_id_121A8( self.origin, 140, 20 );
    var_1 = undefined;
    var_2 = 0;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        foreach ( var_11 in var_0 )
        {
            ...
            if ( distancesquared( var_11.flag_progression, var_1.flag_progression ) < 3600 )
            {
                var_9 = var_11;
                break;
            }
        ...
        if ( var_2 < 3600 && var_8 )
        {
            var_1.returntoprop = 1;
            var_1 scripts\mp\vehicles\cargo_truck_mg_mp::increment_timer( 1, "tac_cover_door" );
            self.carepackage_index = var_1;

            if ( isdefined( var_9 ) && var_13 )
            {
                var_9.returntoprop = 1;
                var_9 scripts\mp\vehicles\cargo_truck_mg_mp::increment_timer( 1, "tac_cover_door" );
                self.carepackage_set_collision_model = var_9;
            }
        }
    }
...
_id_1225C()
{
    if ( isdefined( self.carepackage_index ) )
    {
        self.carepackage_index scripts\mp\vehicles\cargo_truck_mg_mp::increment_timer( 0, "tac_cover_door" );
        self.carepackage_index.returntoprop = undefined;
        self.carepackage_index = undefined;
    }

    if ( isdefined( self.carepackage_set_collision_model ) )
    {
        self.carepackage_set_collision_model scripts\mp\vehicles\cargo_truck_mg_mp::increment_timer( 0, "tac_cover_door" );
        self.carepackage_set_collision_model.returntoprop = undefined;
        self.carepackage_set_collision_model = undefined;
    }
}
