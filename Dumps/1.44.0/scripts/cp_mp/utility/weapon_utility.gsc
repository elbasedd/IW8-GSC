...
clearlockedon( var_0 )
{
    ...
    {
        if ( isdefined( var_0.processed_tilt ) )
            var_0 thread [[ var_0.processed_tilt ]]();
    }

    var_0.hasincoming = undefined;
    var_0.processcommonplayerdataforplayer = undefined;
    var_0.processed_tilt = undefined;
}
...
animscripted_loop_earlyend( var_0 )
{
    ...
    {
        if ( isdefined( var_0.processcommonplayerdataforplayer ) )
            var_0 thread [[ var_0.processcommonplayerdataforplayer ]]();
    }
...
_id_12389( var_0, var_1 )
{
    var_0.processcommonplayerdataforplayer = var_1;
}

_id_1238A( var_0, var_1 )
{
    var_0.processed_tilt = var_1;
}
...
watchtargetlockedontobyprojectile( var_0, var_1 )
{
    ...
    addlockedon( var_0 );
    animscripted_loop_earlyend( var_0 );
    var_1 scripts\engine\utility::_id_133EF( "death", "clearTargetLockedOntoByProjectile" );
