...
_id_11D86( var_0 )
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "challenges", "onKillStreakEnd" ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            var_3 = gettime();
            var_4 = var_3 - var_1.allow_ascender_use;
            var_5 = var_0.kills;
            var_6 = 0;
            var_7 = 0;
            var_8 = 0;
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "dlog", "killStreakExpired" ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_9 = var_1._id_12A6F;
            var_10 = var_1.streakname;
            var_11 = var_1.isgimme;
            var_3 = gettime();
            var_12 = self.origin;
            var_13 = istrue( var_0.isverdansksubmap );
...
time_reduction_bonus( var_0 )
{
    var_1 = var_0 getmovingplatformparent();

    if ( isdefined( var_1 ) && scripts\mp\vehicles\vehicle_compass_mp::reset_attack_next_available_time( var_1 ) || scripts\cp_mp\utility\script_utility::issharedfuncdefined( "entity", "isGondolaBrush" ) && [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "entity", "isGondolaBrush" ) ]]( var_1 ) )
    {
        var_0 playerlinkto( var_1 );
        var_0 playerlinkedoffsetenable();
        var_0.timed_death = var_1;
    }
}

time_watcher( var_0 )
{
    if ( isdefined( var_0.timed_death ) )
    {
        var_0.timed_death = undefined;
        var_0 unlink();
    }
}
