...
{
    var_0 = spawnstruct();
    level.vehicle.tutkioskpurchase = var_0;
    var_0.vehicledata = [];
}

vehomn_setvehicle( var_0, var_1 )
{
    var_2 = _id_132E1( var_0 );
    var_3 = var_2.id;
...
{
    var_4 = _id_132E1( var_0 );
    var_5 = var_4.bonus_targets[var_1];
    var_6 = undefined;
...
{
    var_3 = _id_132E1( var_2 );
    var_4 = var_3._id_13469[var_0];

    if ( isdefined( var_1 ) )
    {
        var_5 = var_3._id_1346D[var_0];
...
vehomn_clearwarnings( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
            var_2 = _id_132E1( var_1, undefined, 1 );
        ...
        if ( isarray( var_0 ) )
        {
            foreach ( var_4 in var_0 )
            {
                if ( isdefined( var_4 ) && isplayer( var_4 ) )
                {
                    ...
                    if ( isdefined( var_2 ) )
                    {
                        foreach ( var_6 in var_2._id_1346A )
                        {
                            if ( isdefined( var_6 ) )
                                thread [[ var_6 ]]( var_4 );
                        }
...
_id_132DE( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( isarray( var_0 ) )
        {
            ...
            {
                if ( isdefined( var_2 ) && isplayer( var_2 ) )
                    thread _id_132DF( var_2 );
            }
        }
        else if ( isplayer( var_0 ) )
            thread _id_132DF( var_0 );
    }
}
...
_id_132DF( var_0 )
{
    ...
    if ( !isdefined( var_0._id_132E7 ) || var_0._id_132E7 != "hide" && var_0._id_132E7 != "fadeOut" )
    {
        var_0._id_132E7 = "fadeOut";
        var_0 setclientomnvar( "ui_veh_controls", 2 );
        wait 3;
        thread _id_132E3( var_0 );
    }
}
...
_id_132DD( var_0 )
{
    return !isdefined( var_0._id_132E7 ) || var_0._id_132E7 == "fadeOut" || var_0._id_132E7 == "hide";
}

_id_132E0()
{
    return level.vehicle.tutkioskpurchase;
}

_id_132E1( var_0, var_1, var_2 )
{
    var_3 = _id_132E0();
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_1 ) )
        {
            ...
            var_4._id_12042 = [];
            var_4.id = undefined;
            var_4._id_13469["burningDown"] = 1;
            var_4._id_13469["missileLocking"] = 2;
            var_4._id_13469["missileIncoming"] = 4;
            var_4._id_13469["movementDisabled"] = 3;
        }
...
_id_132DC( var_0, var_1, var_2 )
{
    var_3 = _id_132E1( var_0, var_1, var_2 );
...
vehomn_updateomnvarsonseatenter( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_8._id_13469["movementDisabled"] ) )
            vehomn_showwarning( "movementDisabled", var_3, var_0.vehiclename );
    }

    if ( var_0 scripts\cp_mp\vehicles\vehicle_damage::_id_131D0() )
    {
        if ( isdefined( var_8._id_13469["burningDown"] ) )
...
_id_132E5( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = spawnstruct();

    var_2 = _id_132E1( var_0.vehiclename, undefined, 1 );
        ...
        if ( isdefined( var_3 ) && var_3.size > 0 )
        {
            foreach ( var_6, var_5 in var_3 )
            {
                if ( isdefined( var_5 ) && isplayer( var_5 ) && var_5 scripts\cp_mp\utility\player_utility::_isalive() )
                    _id_13175( var_0, var_5, var_6, var_1 );
            }
        }
    }
}

_id_13175( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_2 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getoccupantseat( var_0, var_1 );

    _id_132E6( var_0, var_1, var_2, var_3 );
}
...
_id_132E6( var_0, var_1, var_2, var_3 )
{
    var_4 = _id_132E1( var_0.vehiclename );

    if ( var_4._id_12042.size > 0 && isdefined( var_4._id_12042[var_2] ) )
    {
        var_5 = 0;

        if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1324E( var_0, var_2 ) )
            var_5 = 1;
        else
        {
        ...
        if ( var_5 )
        {
            ...
            {
                var_8 = var_4._id_12042[var_2][var_0.objweapon.basename];
        ...
        var_13 = _id_132E2( var_0, var_3 );

        if ( isdefined( var_13 ) )
        {
            foreach ( var_15, var_8 in var_4._id_12042[var_2] )
            {
...
_id_132E2( var_0, var_1 )
{
    if ( isdefined( var_1 ) && isdefined( var_1.soldier_encounter_test ) )
        return var_1._id_12040;
