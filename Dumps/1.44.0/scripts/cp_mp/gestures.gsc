...
init()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) && isdefined( var_4 ) && var_4 != "" )
            level.mangagedeathsdoor[var_3] = var_4;
...
nextcombatareaid( var_0 )
{
    return level.mangagedeathsdoor[var_0];
}
...
x1stash_entergulag()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_133F0( "skydive_deployparachute", "skydive_end", "skydive_beginfreefall" );
        thread _id_12EE5();
    }
}
...
_id_129AB()
{
    if ( istrue( self.cargo_truck_mg_exitend ) )
        return;

    self setscriptablepartstate( "watchVFXPlayer", "bluntWatchOn" );
    self setclientomnvar( "ui_pet_watch_state", 0 );
    self setwristwatchtime( 4, 20, 1 );
    self.cargo_truck_mg_exitend = 1;
    thread cargo_truck_mg_exitendinternal();
}

cargo_truck_mg_exitendinternal()
{
    self endon( "disconnect" );
    self endon( "game_ended" );
    wait 4.2;
    self.cargo_truck_mg_exitend = undefined;
...
_id_12EE5()
{
    ...
    if ( var_0 )
    {
        ...
        if ( var_3 && ( !isdefined( self._id_125DB ) || !istrue( self._id_125DB ) ) )
        {
            if ( var_3 )
            {
                _id_129BC();
    ...
    else if ( var_1 )
    {
        ...
        if ( var_4 && ( !isdefined( self._id_125DB ) || !istrue( self._id_125DB ) ) )
        {
            if ( var_4 )
            {
                _id_129BD();
    ...
    else if ( var_2 )
    {
        ...
        if ( var_5 && ( !isdefined( self._id_125DB ) || !istrue( self._id_125DB ) ) )
        {
            if ( var_5 )
                _id_129BE();
        }
...
watchradialgestureactivation( var_0, var_1 )
{
    ...
    if ( var_0 == "radial_menu_selection_gesture" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            {
                if ( !isdefined( self._id_125DB ) )
                    self._id_125DB = 0;

                self._id_125DB = !self._id_125DB;
                self setclientomnvar( "ui_smart_watch_interact", self._id_125DB );
                ...
                if ( isdefined( self.accessorylogic ) )
                {
                    ...
                    else if ( self.accessorylogic == "holo3" )
                    {
                        ...
                        scripts\cp\laser_traps\cp_laser_traps::_id_1350D();
                }
            }
            else if ( var_2 == "iw8_ges_plyr_gesture023" )
            {
                if ( !isdefined( self._id_134D1 ) )
                    self._id_134D1 = 0;

                self._id_134D1 = !self._id_134D1;
                self setclientomnvar( "ui_smart_watch_check", self._id_134D1 );
...
_id_13521( var_0 )
{
    ...
    while ( gettime() < var_1 )
    {
        ...
        if ( self isgestureplaying( "iw8_ges_plyr_spray" ) )
        {
            ...
            scripts\cp\helicopter\chopper_boss::unsetbettermissionrewards();
            return;
        }
    }
}
