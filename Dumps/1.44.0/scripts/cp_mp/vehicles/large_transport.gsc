...
set_total_successful_vehicle_spawns_from_module()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "large_transport", 1 );
    var_0.id = 5;
...
set_tier_lights()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "large_transport_mp", 3 );
}
...
large_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "large_transport", var_0 );
