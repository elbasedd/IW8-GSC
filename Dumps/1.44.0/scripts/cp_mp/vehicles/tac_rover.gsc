...
tac_rover_initoccupancy()
{
    ...
    var_3.underbridge_reinforce_enemy_monitor = "ping_vehicle_driver";
    var_2 = "fr_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
    ...
    var_3.underbridge_reinforce_enemy_monitor = "ping_vehicle_rider";
    var_2 = "bl_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
...
tac_rover_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "tac_rover", "single", [ "driver", "fr_passenger", "bl_passenger", "br_passenger" ] );
}

_id_12B35()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "tac_rover", 1 );
    var_0.id = 3;
...
_id_12B34()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "tac_rover", 750 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "tac_rover" );
    var_0.class = "light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "tac_rover" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "tac_rover", 5 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_131EC( "tac_rover", 8, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "tac_rover", ::tac_rover_deathcallback );
}

_id_12B33()
{
    var_0 = _applydvarstosettings::_id_13185( "tac_rover", 1 );
    var_0.bridge_one_death_func = 1.83333;
    var_0.givebmodevloadouts = 0.79166;
    var_0.getcombatrecordsupermisc = 350;
    var_0.getcoremapdropzones = 525;
    var_0.getcodecomputerdisplaycode = 875;
    var_0.getcrossbowammotype = 6.25;
    var_0.getcrossbowimpactfunc = 25;
    var_0.getcrateusetime = 50;
...
tac_rover_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "tac_rover", var_0 );
