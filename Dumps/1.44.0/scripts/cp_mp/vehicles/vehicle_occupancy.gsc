...
vehicle_occupancy_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            var_3.tank_empupdate = undefined;
            var_3.restrictions = [];
...
vehicle_occupancy_getleveldataforseat( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_2 ) )
        {
            ...
            var_4._id_12532 = undefined;
            var_4._id_12F49 = undefined;
        }
    }
...
vehicle_occupancy_deregisterinstance( var_0 )
{
    ...
    var_0._id_11B85 = undefined;
    var_0.boltunlink = undefined;
...
vehicle_occupancy_enter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( vehicle_occupancy_seatisavailable( var_0, var_1, var_2 ) ) )
    {
        ...
        if ( var_10 )
        {
            ...
            if ( istrue( var_2.relic_squadlink_onsteppedfar ) )
                var_2 notify( "br_try_armor_cancel" );

            if ( isdefined( var_9 ) )
            {
                var_11 = _id_1324E( var_0, var_9 );
            ...
            if ( isdefined( var_1 ) )
            {
                var_11 = _id_1324E( var_0, var_1 );

                if ( istrue( var_11 ) && !istrue( level.helis_assault2 ) )
                {
                    var_12 = 0;
                    var_13 = "";
                    var_14 = "";
                    ...
                    {
                        case "apc_russian":
                            var_13 = var_2._id_132A5.apc;
                            var_14 = var_2._id_132A5.bot_get_stored_launcher_class;
                            var_12 = 1;
                            var_15 = var_2._id_132A5.bot_gametype_human_player_always_considered_defender;
                            break;
                        case "atv":
                            var_13 = var_2._id_132A5.brjugg_oncratedestroy;
                            var_15 = var_2._id_132A5.brjugg_oncrateuse;
                            var_16 = var_2._id_132A5.brjugg_setjuggwatchers;
                            break;
                        case "cargo_truck_mg":
                        case "cargo_truck":
                            var_13 = var_2._id_132A5.domflag_hideiconfromplayer;
                            var_15 = var_2._id_132A5.domflag_onbeginuse;
                            break;
                        case "jeep":
                            var_13 = var_2._id_132A5.scriptable_used_by_part_funcs;
                            var_15 = var_2._id_132A5.scriptableinit;
                            break;
                        case "little_bird_mg":
                        case "little_bird":
                            var_13 = var_2._id_132A5.silo_door_cover_spawners;
                            var_15 = var_2._id_132A5.silo_door_jugg;
                            var_16 = var_2._id_132A5.skydiveontacinsertplacement;
                            break;
                        case "tac_rover":
                            var_13 = var_2._id_132A5._id_12B31;
                            var_15 = var_2._id_132A5._id_12B32;
                            var_16 = var_2._id_132A5._id_12B36;
                            break;
                        case "light_tank":
                            var_13 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_132A5._id_12B7C, var_2._id_132A5._id_12B87 );
                            var_14 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_132A5._id_12B7D, var_2._id_132A5._id_12B88 );
                            var_12 = 1;
                            break;
                        case "motorcycle":
                            var_13 = var_2._id_132A5.teamextractedvictory;
                            var_15 = var_2._id_132A5.teamsassigned;
                            var_16 = var_2._id_132A5.teleport_text_updated;
                            break;
                        default:
                            var_13 = "";
                            var_15 = "";
                    ...
                    if ( var_13 != "" && !isdefined( var_0.disabledstate ) )
                    {
            ...
            _initignoredtabspergamemode::cachedomnars( var_0, var_2, var_1, var_9 );
            scripts\cp_mp\vehicles\vehicle_dlog::_id_131FC( var_0, var_2, var_1, var_20 );
        }
...
_id_13251( var_0, var_1 )
{
    if ( level.teambased )
        return _id_13252( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.loadout_updateammo ) )
            var_0 _id_13237( var_0 );

        return isdefined( var_0.weapongetflinchtype ) && var_0.weapongetflinchtype == var_1;
    }
}

_id_1324F( var_0, var_1 )
{
    if ( level.teambased )
        return _id_13250( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.loadout_updateammo ) )
            var_0 _id_13237( var_0 );
...
_id_13253( var_0, var_1 )
{
    if ( level.teambased )
        return _id_13254( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.loadout_updateammo ) )
            var_0 _id_13237( var_0 );

        return !isdefined( var_0.weapongetflinchtype );
    }
}
...
_id_13244( var_0 )
{
    if ( !level.teambased )
    {
        ...
        return var_0.weapongetflinchtype;
    }
...
_id_13252( var_0, var_1 )
{
    if ( level.teambased )
    {
        ...
        return isdefined( var_0._id_12BD5 ) && var_0._id_12BD5 == var_1;
    }
...
_id_13254( var_0, var_1 )
{
    if ( level.teambased )
    {
        ...
        return !isdefined( var_0._id_12BD5 );
    }
...
_id_13237( var_0 )
{
    ...
    {
        var_1 = 0;
        var_2 = var_0._id_12BD5;

        if ( isdefined( var_0.team ) && var_0.team != "neutral" )
        {
            var_0._id_12BD5 = var_0.team;
            var_0.loadout_updateammo = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            var_0._id_12BD5 = undefined;
            var_0.loadout_updateammo = undefined;
        }

        if ( !isdefined( var_2 ) && !isdefined( var_0._id_12BD5 ) )
            return 0;

        if ( isdefined( var_2 ) && isdefined( var_0._id_12BD5 ) && var_2 == var_0._id_12BD5 )
            return 0;

        _id_13243( var_0, var_2, var_0._id_12BD5 );
        return 1;
    }
    else
    {
        var_1 = 0;
        var_6 = var_0.weapongetflinchtype;

        if ( isdefined( var_0.originalowner ) )
        {
            var_0.weapongetflinchtype = var_0.originalowner;
            var_0.loadout_updateammo = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            ...
            foreach ( var_4 in var_7 )
            {
                if ( isdefined( var_4 ) )
                {
                    var_0.weapongetflinchtype = var_4;
                    var_0.loadout_updateammo = undefined;
                    return;
                }
            }
        ...
        if ( !isdefined( var_6 ) && !isdefined( var_0.weapongetflinchtype ) )
            return 0;

        if ( isdefined( var_6 ) && isdefined( var_0.weapongetflinchtype ) && var_6 == var_0.weapongetflinchtype )
            return 0;

        _id_13243( var_0, var_6, var_0.weapongetflinchtype );
        return 1;
    }
}

_id_13243( var_0, var_1, var_2 )
{
    _applysalesdiscount::_id_13197( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( !isdefined( var_3.loadout_giveweaponobj ) )
        return;

    thread [[ var_3.loadout_giveweaponobj ]]( var_0, var_1, var_2 );
}
...
vehicle_occupancy_init()
{
    ...
    var_0.vehicledata = [];
    var_0._id_12DC9 = getdvarint( "scr_transitionHideEnabled", 1 ) > 0;
...
vehicle_occupancy_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
    {
        ...
        _id_1324A( var_0, var_1, var_3, var_4 );
        ...
        if ( !isdefined( var_2 ) )
        {
            ...
            if ( isdefined( var_5.underbridge_reinforce_enemy_monitor ) )
                thread _id_13249( var_3, var_5, 1 );
        }
        else
        {
            ...
            if ( isdefined( var_5.underbridge_reinforce_enemy_monitor ) )
                thread _id_13249( var_3, var_5, 0 );
        }
    }
    else
    {
...
vehicle_occupancy_exitend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_4.success )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            _id_13264( var_0, var_1, var_3, var_4 );
        }

        if ( !isdefined( var_2 ) )
            vehicle_occupancy_onexitvehicle( var_0, var_1, var_3, var_4 );

        if ( !var_0 scripts\common\vehicle_code::vehicle_is_stopped() && _id_1324E( var_0, var_1 ) )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
            {
                var_6 = spawnstruct();
                var_6.isusingremotekillstreak = 1;
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( !isdefined( var_2 ) )
        {
            if ( isdefined( var_3._id_132DA ) )
                var_3._id_132DA = undefined;

            if ( isdefined( var_3._id_132D9 ) )
                var_3._id_132D9 = undefined;
        }
    }
}
...
_id_13249( var_0, var_1, var_2 )
{
    var_3 = 5000;

    if ( istrue( var_2 ) )
    {
        var_0._id_132DA = var_1.underbridge_reinforce_enemy_monitor;
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.underbridge_reinforce_enemy_monitor, undefined, 1 );
        var_0._id_132D9 = gettime();
    }
    else if ( isdefined( var_0._id_132DA ) && isdefined( var_0._id_132D9 ) && var_0._id_132DA != var_1.underbridge_reinforce_enemy_monitor && gettime() - var_0._id_132D9 > var_3 )
    {
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.underbridge_reinforce_enemy_monitor );
        var_0._id_132DA = var_1.underbridge_reinforce_enemy_monitor;
        var_0._id_132D9 = gettime();
    }
}
...
{
    _id_13263( var_0 );
    var_0 scripts\cp_mp\vehicles\vehicle_spawn::_id_13288();
    var_2 setstance( "stand" );
    var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 0 );
    thread _id_13267( var_2, var_0, var_1 );
    _initignoredtabspergamemode::c130_drop( var_0, var_2 );
...
vehicle_occupancy_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        ...
        if ( !istrue( var_3.playerdeath ) )
        {
            if ( istrue( var_3.playerlaststand ) )
                var_3.isvalidattachmentunlock = "DEATH";
            else if ( !isdefined( var_3.isvalidattachmentunlock ) )
                var_3.isvalidattachmentunlock = "VOLUNTARY";

            var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 1 );
            thread scripts\cp_mp\vehicles\vehicle::_id_13272( var_0, var_2 );
        }
        else
            var_3.isvalidattachmentunlock = "DEATH";

        thread _id_13248( var_2, var_3.playerdeath, var_3.playerlaststand );
    }
    else
        var_3.isvalidattachmentunlock = "DISCONNECT";

    _id_13263( var_0 );

    if ( scripts\cp_mp\vehicles\vehicle_spawn::_id_13283() && var_0.occupants.size == 0 )
        var_0 thread scripts\cp_mp\vehicles\vehicle_spawn::_id_1328B();
    ...
    scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_exitevent( var_0, var_2, var_1, var_3.isvalidattachmentunlock );
    _initignoredtabspergamemode::c130_lights( var_0, var_2, var_1 );
}
...
_id_1324C()
{
    if ( !isdefined( level.playertimedinvunerable ) )
        level.playertimedinvunerable = getdvarint( "scr_hideOccupantWithStack", 1 );

    return level.playertimedinvunerable;
}
...
vehicle_occupancy_hideoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        ...
        if ( _id_1324C() )
            var_2 scripts\cp_mp\utility\player_utility::addspawnlocation();
        else
            var_2 playerhide();
    }
}

_id_1324B( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    var_3 = var_2._id_12DCA;
    var_2._id_12DCA++;
    var_0 scripts\cp_mp\utility\player_utility::addspawnlocation();
    var_2._id_12DCB[var_3] = var_0;

    if ( !isdefined( var_1._id_12DCB ) )
        var_1._id_12DCB = [];

    var_1._id_12DCB[var_3] = var_0;
    return var_3;
}

_id_13266( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3._id_12DCB[var_0] ) )
        return;

    var_4 = var_3._id_12DCB[var_0];

    if ( isdefined( var_1 ) && isdefined( var_1._id_12DCB ) )
        var_1._id_12DCB[var_0] = undefined;

    if ( isdefined( var_4 ) )
        var_4 scripts\cp_mp\utility\player_utility::addspecialistbonus();
}

_id_13265( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    if ( !isdefined( var_0._id_12DCB ) )
        return;

    foreach ( var_5, var_4 in var_0._id_12DCB )
    {
        if ( isdefined( var_2._id_12DCB[var_5] ) )
        {
            var_2._id_12DCB[var_5] = undefined;
...
_id_13238()
{
    ...
    foreach ( var_3, var_2 in var_0._id_12DCB )
    {
        if ( !isdefined( var_2 ) )
            var_0._id_12DCB[var_3] = undefined;
    }
}
...
vehicle_occupancy_showoccupant( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) || istrue( var_4 ) )
    {
        if ( _id_1324C() )
        {
            if ( istrue( var_4 ) )
            {
                var_2 scripts\cp_mp\utility\player_utility::x1spyplane();
                var_2 playershow();
            }
            else
                var_2 scripts\cp_mp\utility\player_utility::addspecialistbonus();
        }
        else
            var_2 playershow();
    }
...
_id_13257( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132DD( var_1 ) )
        return;

    if ( 1 )
        wait 1.5;

    childthread _id_13259( var_0, var_1, var_2 );
    childthread _id_1325A( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( isdefined( var_3.tank_empupdate ) )
        childthread [[ var_3.tank_empupdate ]]( var_0, var_1, var_2, "vehicle_occupancy_monitorControls" );
}

_id_13241( var_0 )
{
    scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132DE( var_0 );
    var_0 notify( "vehicle_occupancy_monitorControls" );
}

_id_13259( var_0, var_1, var_2 )
{
...
_id_1325A( var_0, var_1, var_2 )
{
    var_3 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_2 );

    if ( isdefined( var_3._id_12F49 ) )
    {
        var_4 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, var_3._id_12F49 );

        if ( isdefined( var_4 ) )
        {
            var_4 scripts\engine\utility::_id_133EF( "turret_fire", "turret_reload" );
            _id_13241( var_1 );
        }
    }
}
...
vehicle_occupancy_raceplayerdeathdisconnect( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\engine\utility::_id_133FF( "death", "disconnect", "last_stand_start" );
...
vehicle_occupancy_watchownerjoinedteam( var_0, var_1 )
{
    ...
    var_1 scripts\engine\utility::_id_133EF( "joined_team", "joined_spectators" );
...
vehicle_occupancy_animateplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        addproptolist( var_4, var_5 );
        thread addquestrewardtier( 1 );
    }
    ...
    if ( vehicle_occupancy_checkvalidanimtype( var_9, var_3 ) )
    {
        ...
        scripts\engine\utility::_id_133EF( "death_or_disconnect", "last_stand_start" );
...
{
    if ( istrue( level.little_bird_mg_cp_waitandspawn ) )
    {
...
vehicle_occupancy_findplayerexit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( istrue( var_5.isvalidcustomweapon ) )
        {
...
vehicle_occupancy_taketurret( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0 hasweapon( var_2 ) )
    {
        ...
        {
            if ( isdefined( var_5 ) )
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_13203( var_1, var_5 );
            else
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_1, var_2 );
...
vehicle_occupancy_ejectalloccupants( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_5.isvalidattachmentunlock = "INVOLUNTARY";
...
_id_1324A( var_0, var_1, var_2, var_3 )
{
...
_id_13264( var_0, var_1, var_2, var_3 )
{
...
vehicle_occupancy_assignseatcorpse( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_3 )
        var_0.in_world_scriptables_visible = 1;
}

_id_1323B( var_0, var_1, var_2 )
{
    if ( isdefined( var_1.corpses ) && isdefined( var_1.corpses[var_2] ) )
        var_1.corpses[var_2] = undefined;

    var_0.in_world_scriptables_visible = undefined;
}
...
vehicle_occupancy_deleteseatcorpse( var_0, var_1, var_2 )
{
    if ( isdefined( var_0.corpses ) && isdefined( var_0.corpses[var_1] ) )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            if ( !istrue( var_3.in_world_scriptables_visible ) || !var_2 )
            {
...
_id_13236( var_0 )
{
    ...
    if ( isdefined( var_0._id_11B85 ) && var_0._id_11B85 > 0 )
        return 0;
...
vehicle_occupancy_killoccupants( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isdefined( var_6 ) && var_6 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            {
                if ( isdefined( var_6.juggcontext.juggconfig._id_132A0 ) && var_6.health > var_6.juggcontext.juggconfig._id_132A0 )
                    var_8 = 1;
            }
            ...
            if ( !istrue( var_8 ) )
            {
                ...
                if ( isdefined( level._id_132BE ) )
                    var_6 thread [[ level._id_132BE ]]();
            }
