...
technical_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "technical", "single", [ "driver", "fl_rear", "fr_rear", "bl_rear", "br_rear" ] );
}

_id_12BFD()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "technical", 1 );
    var_0.id = 0;
...
_id_12BFB()
{
    var_0 = _applydvarstosettings::_id_13185( "technical", 1 );
    var_0.bridge_one_death_func = 1.16666;
    var_0.givebmodevloadouts = 0.95833;
    var_0.getcombatrecordsupermisc = 350;
    var_0.getcoremapdropzones = 525;
    var_0.getcodecomputerdisplaycode = 875;
    var_0.getcrossbowammotype = 11.25;
    var_0.getcrossbowimpactfunc = 45;
    var_0.getcrateusetime = 90;
...
_id_12BFC()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "technical", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "technical" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "technical" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "technical", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "technical", ::technical_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "technical_mp", 3 );
}
...
technical_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "technical", var_0 );
...
technical_enterstart( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.shut_down_laser_trap ) )
        var_3.shut_down_laser_trap hide();
}
...
technical_exitendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.shut_down_laser_trap ) )
        var_3.shut_down_laser_trap show();
