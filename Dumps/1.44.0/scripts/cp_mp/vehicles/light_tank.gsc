...
light_tank_init()
{
    ...
    var_0._id_13071 = ::showdangercircle;
...
light_tank_initoccupancy()
{
    ...
    var_4._id_12F49 = getcompleteweaponname( "tur_bradley_mp" );
    ...
    var_4._id_12F49 = getcompleteweaponname( "tur_gun_lighttank_mp" );
    var_4.underbridge_reinforce_enemy_monitor = "ping_vehicle_gunner";
}

show_players_breadcrumbs_to_safe_house()
{
    var_0 = _applydvarstosettings::_id_13185( "light_tank", 1 );
    var_0.bridge_one_death_func = 2.5;
    var_0.givebmodevloadouts = 0.625;
    var_0.getcombatrecordsupermisc = 350;
    var_0.getcoremapdropzones = 525;
    var_0.getcodecomputerdisplaycode = 875;
    var_0.getcrossbowammotype = 1.25;
    var_0.getcrossbowimpactfunc = 5;
    var_0.getcrateusetime = 10;
...
light_tank_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "light_tank", "single", [ "driver", "gunner" ] );
}

show_regroup_text()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.bonus_targets["turret"] = 0;
    var_0.bonus_targets["missile"] = 1;
    var_0.bonus_targets["smoke"] = 2;
    var_0._id_12041[0] = 0;
    var_0._id_12041[1] = 1;
    var_0._id_12042["driver"]["lighttank_mp"] = 0;
    var_0._id_12042["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_12042["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0._id_12042["gunner"]["tur_bradley_mp"] = 0;
    var_0._id_12042["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0._id_12042["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_12042["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

show_plunderboxes()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "light_tank", 15 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E9( "light_tank", ::light_tank_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E8( "light_tank", ::light_tank_postmoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    var_2.room_door_windows = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::_id_13276( var_2, var_3, getcompleteweaponname( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::_id_13276( var_2, var_3, getcompleteweaponname( "tur_gun_lighttank_mp" ) );
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "light_tank", var_0 );
    var_2.objweapon = getcompleteweaponname( "lighttank_mp" );
    var_2 light_tank_updateheadicon();
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::_id_131C1( var_2, 1 );
    var_4.has_current_combat_action = "none";
    ...
    var_2 thread show_rocket_fuel_readings();
    var_2 thread showassassinationtargethud();
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.isverdansksubmap = 1;

        if ( !istrue( self._id_11D83 ) )
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        if ( showdebugresult( self.spawndata ) )
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::_id_13205( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::_id_13205( self.vehicle );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::_id_133F7( "turret_fire", "turret_reload" );
...
show_rocket_fuel_readings()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getseatoccupant( self, "driver" );
        var_1 thread showemergencyhint( var_2 );
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_bradley_mp" );
...
showdroplocations()
{
    ...
    for (;;)
    {
        var_0 = show_on_minimap();
        self notifyonplayercommand( "light_tank_missile", var_0 );
        var_1 = scripts\engine\utility::_id_133FE( "input_type_changed", "missile_handling_ended" );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_bradley_mp" );
    ...
    if ( istrue( self.room_door_windows ) )
...
showassassinationtargethud()
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_gun_lighttank_mp" );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, "tur_bradley_mp" );
        var_5.owner = var_3;
        ...
        var_3 thread showdroplocations();
    ...
    else if ( var_1 == "gunner" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, "tur_gun_lighttank_mp" );
        var_5.owner = var_3;
        var_5 setotherent( var_3 );
        var_5 setentityowner( var_3 );
        var_5 setsentryowner( var_3 );
        ...
        show_marker_to_tv_station( var_3 );
    }
...
show_marker_to_tv_station( var_0 )
{
    ...
    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::show_player_clip );
}
...
show_player_clip( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.sat_missing_pieces = canweapondealcriticaldamage( var_0 );
...
{
    if ( istrue( var_0.sat_missing_pieces ) )
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::_id_12385( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::_id_12384( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::_id_12385( self.headicon, var_0 );
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::_id_13205( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread showdiscountsplash( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_13205( var_0 );
