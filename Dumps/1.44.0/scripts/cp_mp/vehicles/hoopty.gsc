...
playerzombiestatechange()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "hoopty", 1 );
    var_0.id = 9;
...
playerzombiesetupkeybindings()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "hoopty", var_0 );
