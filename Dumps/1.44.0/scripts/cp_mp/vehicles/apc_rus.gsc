...
apc_rus_initoccupancy()
{
    ...
    var_4._id_12F49 = getcompleteweaponname( "tur_apc_rus_mp" );
...
apc_rus_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "apc_russian", "single", [ "driver", "front_right", "back_right", "back", "back_left", "front_left" ] );
}

bot_gametype_set_role()
{
    var_0 = _applydvarstosettings::_id_13185( "apc_russian", 1 );
    var_0.bridge_one_death_func = 2.33333;
    var_0.givebmodevloadouts = 0.66666;
    var_0.getcombatrecordsupermisc = 350;
    var_0.getcoremapdropzones = 525;
    var_0.getcodecomputerdisplaycode = 875;
    var_0.getcrossbowammotype = 2.5;
    var_0.getcrossbowimpactfunc = 10;
    var_0.getcrateusetime = 20;
...
bot_get_active_tactical_goals_of_type()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "apc_russian", 1 );
    var_0.id = 15;
    ...
    var_0.bonus_targets["driverTurret"] = 0;
    var_0._id_12041["chassis"] = 0;
    var_0._id_12041["turret"] = 1;
    var_0._id_12042["driver"]["apc_rus_mp"] = "chassis";
    var_0._id_12042["driver"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12042["front_left"]["apc_rus_mp"] = "chassis";
    var_0._id_12042["front_left"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12042["front_right"]["apc_rus_mp"] = "chassis";
    var_0._id_12042["front_right"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12042["back_right"]["apc_rus_mp"] = "chassis";
    var_0._id_12042["back_right"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12042["back_left"]["apc_rus_mp"] = "chassis";
    var_0._id_12042["back_left"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12042["back"]["apc_rus_mp"] = "chassis";
    var_0._id_12042["back"]["tur_apc_rus_mp"] = "turret";
}

bot_gametype_zones_precached()
{
    var_0 = getdvarint( "scr_gw_apc_health_override", 4000 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "apc_russian", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "apc_russian" );
    var_1.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "apc_russian" );
    var_2 = getdvarint( "scr_gw_apc_hits_override", 18 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "apc_russian", var_2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E9( "apc_russian", ::apc_rus_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E8( "apc_russian", ::bot_get_flag_carrier );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "apc_russian", ::apc_rus_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "tur_apc_rus_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "apc_rus_mp", 5 );
}
...
apc_rus_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_13276( var_2, var_3, getcompleteweaponname( "tur_apc_rus_mp" ), 1 );
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "apc_russian", var_0 );
    ...
    var_4.hangar_doors_opening_quadrace = "kill_apc_rus";
    var_4.hangar_juggs = 1;
    ...
    var_2 thread bot_get_angles_to_goal();
...
apc_rus_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < var_8 )
        var_0.sat_missing_pieces = bot_gametype_initialize_attacker_defender_role( var_0 );

    return 1;
}

bot_get_flag_carrier( var_0 )
{
...
bot_gametype_initialize_attacker_defender_role( var_0 )
{
...
apc_rus_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_13204( var_0, "tur_apc_rus_mp" );
    ...
    if ( var_1 == "driver" )
        var_0 thread bot_get_distance_to_goal( var_3 );
}
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_apc_rus_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 14;
    bot_get_landing_spot();
    ...
    for (;;)
    {
        ...
        bot_gametype_human_player_always_defender( -1 );
...
bot_gametype_radios_precached()
{
    ...
    wait 2.7;
    bot_gametype_human_player_always_defender( 14 );
    wait 0.15;
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_apc_rus_mp" );
...
bot_gametype_human_player_always_defender( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_13204( self, "tur_apc_rus_mp" );
