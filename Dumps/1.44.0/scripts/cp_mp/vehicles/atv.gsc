...
atv_init()
{
    ...
    atv_initoccupancy();
    atv_initinteract();
    brjugg_playerwelcomesplashes();
    brjugg_ontimelimit();
    brjugg_onplayerkilled();
    atv_initfx();
...
atv_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "atv", "single", [ "driver", "rear" ] );
}

brjugg_playerwelcomesplashes()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "atv", 1 );
    var_0.id = 4;
...
brjugg_ontimelimit()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "atv", 500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "atv" );
    var_0.class = "super_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "atv" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "atv", 4 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_131EC( "atv", 6, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "atv", ::atv_deathcallback );
}

brjugg_onplayerkilled()
{
    var_0 = _applydvarstosettings::_id_13185( "atv", 1 );
    ...
    var_1.givebmodevloadouts["atv"] = [];
    var_1.givebmodevloadouts["atv"]["cargo_truck"] = 2;
}
...
atv_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "atv", var_0 );
