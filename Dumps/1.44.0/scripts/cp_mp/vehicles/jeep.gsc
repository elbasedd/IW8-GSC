...
jeep_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "jeep", "single", [ "driver", "front_right", "back_left", "back_right" ] );
}

scriptablescurid()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "jeep", 1 );
    var_0.id = 10;
...
scriptablescleanupbatchsize()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "jeep", 1500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "jeep" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "jeep" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "jeep", 9 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "jeep", ::jeep_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "jeep_mp", 3 );
}

scriptablenousestate()
{
    var_0 = _applydvarstosettings::_id_13185( "jeep", 1 );
    var_0.bridge_one_death_func = 1.33333;
    var_0.givebmodevloadouts = 0.91666;
    var_0.getcombatrecordsupermisc = 350;
    var_0.getcoremapdropzones = 525;
    var_0.getcodecomputerdisplaycode = 875;
    var_0.getcrossbowammotype = 10;
    var_0.getcrossbowimpactfunc = 40;
    var_0.getcrateusetime = 80;
...
jeep_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "jeep", var_0 );
