...
cargo_truck_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_1320F( "cargo_truck", "single", [ "driver" ] );
}

domflagupdateiconsframeend()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "cargo_truck", 1 );
    var_0.id = 8;
...
domflag_usecondition()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "cargo_truck", 3500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cargo_truck" );
    var_0.class = "heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "cargo_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "cargo_truck", 20 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "cargo_truck", ::cargo_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "cargo_truck_mp", 5 );
}

domflag_showicontoplayer()
{
    var_0 = _applydvarstosettings::_id_13185( "cargo_truck", 1 );
...
cargo_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "cargo_truck", var_0 );
