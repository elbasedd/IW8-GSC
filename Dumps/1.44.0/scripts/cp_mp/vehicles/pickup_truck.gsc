...
vo_do_loudspeaker()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "pickup_truck", 1 );
    var_0.id = 7;
...
vo_death_drop_and_cash_protection()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "pickup_truck_mp", 3 );
}
...
pickup_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "pickup_truck", var_0 );
