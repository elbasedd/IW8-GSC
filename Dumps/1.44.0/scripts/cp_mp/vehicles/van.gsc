...
_id_13164()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "van", 1 );
    var_0.id = 13;
...
_id_13163()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "van", ::van_deathcallback );
}
...
van_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "van", var_0 );
