...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3._id_12C8B = undefined;
        var_3._id_11F52 = undefined;
        var_3._id_12C8C = undefined;
    }
...
vehicle_spawn_init()
{
    ...
    var_0._id_11F53 = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0.ai_stop_shooting_watch = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0._id_11F52 = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0.ai_spawn_intel_extras = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
_id_1328A( var_0, var_1, var_2 )
{
    ...
    if ( var_4._id_11F53 != 0 )
        var_5 = var_4._id_11F53;
    else if ( isdefined( var_3._id_11F52 ) )
        var_5 = var_3._id_11F52;
    else
        var_5 = var_4._id_11F52;
...
_id_1328B()
{
    ...
    if ( istrue( self.impactfunc_stun ) )
        return;
    ...
    if ( !isdefined( var_0.ai_shooting_watch ) )
        return;
    ...
    if ( var_1.ai_stop_shooting_watch != 0 )
        var_2 = var_1.ai_stop_shooting_watch;
    else if ( isdefined( var_0.ai_spawn_intel_extras ) )
        var_2 = var_0.ai_spawn_intel_extras;
    else
        var_2 = var_1.ai_spawn_intel_extras;
...
{
    _id_13288();
    self.impactfunc_stun = 1;
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0.ai_shooting_watch ]]();
}

_id_13280()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::_id_131C7();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::_id_131EA( "heavy", var_0 );
    }
}
