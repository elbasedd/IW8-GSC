...
startdeliveries()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_132E1( "medium_transport", 1 );
    var_0.id = 11;
...
startdeadsilence()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_131DF( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_131B3( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EB( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131E4( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_131EE( "med_transport_mp", 3 );
}
...
med_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_131AE( var_2, "medium_transport", var_0 );
