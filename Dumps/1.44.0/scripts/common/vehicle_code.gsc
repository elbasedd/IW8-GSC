...
vehicle_killriders()
{
    ...
    foreach ( var_1 in self.riders )
    {
        ...
        if ( isdefined( var_1._blackboard ) && isdefined( var_1._blackboard.chosenvehicleanimpos ) && istrue( var_1._blackboard.chosenvehicleanimpos.getmaxoutofboundsbrtime ) )
        {
            var_2 = 100.0;
        ...
        if ( scripts\common\utility::iscp() && isdefined( self.getaltbunkerkeypadindexforscriptable ) )
        {
            if ( isdefined( self.getaltbunkerkeypadindexforscriptable.attacker ) && isplayer( self.getaltbunkerkeypadindexforscriptable.attacker ) )
                var_1 dodamage( var_1.maxhealth, self.getaltbunkerkeypadindexforscriptable.attacker.origin, self.getaltbunkerkeypadindexforscriptable.attacker, self.getaltbunkerkeypadindexforscriptable.attacker, self.getaltbunkerkeypadindexforscriptable.meansofdeath, self.getaltbunkerkeypadindexforscriptable.objweapon );
            else
                var_1 kill();
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        foreach ( var_11 in self.riders )
        {
            if ( isalive( var_11 ) && isdefined( var_6[var_11.vehicle_position] ) )
            {
                ...
                if ( isdefined( var_8 ) && istrue( var_8.hostvictimoverride ) )
                    continue;
...
death_firesound( var_0 )
{
    ...
    scripts\engine\utility::_id_133EF( "fire_extinguish", "stop_crash_loop_sound" );
...
vehicle_damagelogic()
{
    ...
    while ( self.health > 0 )
    {
        ...
        if ( istrue( self.get_tv_station_infil_rider_start_targetname ) )
            return;
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            if ( scripts\engine\utility::func_ref_exist( "vehicle_damage_modifier" ) )
            {
                ...
                if ( isdefined( level.level_logic ) )
                    var_15 = [[ level.level_logic ]]( var_3, self, var_2, var_11, var_6, undefined, var_5, var_4, var_7, var_9, var_8, var_10 );

                if ( isdefined( var_15 ) )
                    self.getaltbunkerkeypadindexforscriptable = var_15;
                else
                    self.getaltbunkerkeypadindexforscriptable = undefined;
...
helicopter_crash_move( var_0, var_1 )
{
    ...
    if ( var_5 )
    {
        ...
        scripts\engine\utility::_id_133EF( "goal", "near_goal" );
    ...
    else
    {
        ...
        while ( var_8 != "death" )
        {
            var_8 = scripts\engine\utility::_id_133F0( "goal", "near_goal", "death" );
