...
{
    if ( !isdefined( self._blackboard.back_field_clip ) )
    {
        self._blackboard.back_field_clip = 1;
        self._blackboard.back_door_enemy_watcher = var_0;
        return 1;
    }
...
awardbunker11blueprint()
{
    if ( isdefined( self._blackboard.back_field_clip ) && self._blackboard.back_field_clip == 1 )
        self._blackboard.back_field_clip = 2;
}
...
avoidclosetodefenderflagspawn()
{
    if ( isdefined( self._blackboard.back_field_clip ) )
    {
        if ( self._blackboard.back_field_clip == 1 )
        {
            self._blackboard.back_field_clip = undefined;
            self._blackboard.back_door_enemy_watcher = undefined;
            return 1;
        }
        else if ( self._blackboard.back_field_clip == 2 )
        {
            self._blackboard.back_field_clip = 3;
            return 1;
        }
    }
...
avoids_recently_cleared_area()
{
    if ( isdefined( self._blackboard.back_field_clip ) && self._blackboard.back_field_clip == 3 )
    {
        self._blackboard.back_field_clip = undefined;
        self._blackboard.back_door_enemy_watcher = undefined;
    }
...
attackerswaittime( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_2 = var_0 awardmasterychallenge( var_1 );
...
ascendermodelworld( var_0 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_1 = var_0 avoidclosetodefenderflagspawn();
