...
_id_124E1( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.riskspawn_initialset ) )
        return 1;
...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && _id_124E1( self.damageweapon ) )
            return 1;
...
allow_init()
{
    ...
    allow_add( "usability_auto_use", ::blockreviveanimation );
    ...
    allow_add( "offhand_throwback", ::blockclasschange );
    ...
    allow_add( "cp_munitions", ::blinking_light_thread );
    allow_add( "nvg", ::blockade_get_bomb_icon_on_cell_phone );
    allow_add( "ascender_use", ::blink_wheelson_chosen_spawn );
}
...
blockade_get_bomb_icon_on_cell_phone( var_0, var_1, var_2 )
{
    var_3 = 2;
...
_id_12ED6( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
