...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::_id_133F8( "long_death", "death", "enteredvehicle" );
...
{
    scripts\engine\utility::_id_133EF( "unload", "death" );
...
guy_unload_que( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_133EF( "death", "jumpedout" );
...
_id_11B75()
{
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.infil_chopper_dialogue[var_2] = spawnstruct();
            self.infil_chopper_dialogue[var_2].open = 0;
            self.infil_chopper_dialogue[var_2].updatecirclepulse = 0;
        }
    }
}
...
wait_for_open_door( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.vehicle_getoutanim ) )
    {
        ...
        if ( !self.infil_chopper_dialogue[var_2].open )
        {
            ...
            self.infil_chopper_dialogue[var_2].open = 1;
        }
