...
{
    level.spawn_new_ents = 1;
    level.player playsound( "trial_sfx_completed" );
    scripts\engine\utility::delaythread( lookupsoundlength( "trial_sfx_completed" ) / 1000, scripts\mp\gametypes\trial.gsc::trial_end_score_dialogue );
    wait 0.5;
    ...
    else
    {
        ...
        wait 3;
        scripts\mp\utility\lui_game_event_aggregator::registeronluieventcallback( ::his_detectplayers );
...
_id_134D9( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_1 ) )
        var_1 = 0;
    ...
    _id_1351C( "standard", var_1, 0, var_2 );
}

_id_1351C( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_0 ) )
        return;
