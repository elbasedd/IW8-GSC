...
init_relic_thirdperson()
{
    if ( !isdefined( level._id_134DF ) )
        level._id_134DF = [];

    level._id_134DF["jugg"] = ::jugg_init;
}
...
jugg_init()
{
    ...
    thread onteammatereviveweaponswitchcomplete();
    thread dialog_init();
    thread _id_12770();
    thread ai_init();
...
_id_12183()
{
    ...
    thread last_unresolved_collision_time();
    level.player waittill( "juggernaut_start" );
    var_0 = gettime();
    _maphint_offerscriptableused::_id_13516();
    _maphint_offerscriptableused::_id_13517( 0 );
    thread onsoccerballreset();
    thread _id_12282();
    level._id_134F8 = 1;
    ...
    level._id_134B3 = 1;
    level._id_137B7 = "enemy_mp_trial_jugg_noob";
    level._id_134CE = 5;
    level._id_134F5 = 2;
    _id_13A80( var_0 + 15000 );
    level._id_134B3 = 0;
    level._id_134CE = 6;
    level._id_134F5 = 3;
    _id_13A80( var_0 + 30000 );
    level._id_134CE = 7;
    level._id_134F5 = 4;
    _id_13A80( var_0 + 45000 );
    thread _id_13379();
    level._id_137B7 = "enemy_mp_trial_jugg_average";
    _id_13A80( var_0 + 60000 );
    level._id_134CE = 8;
    level._id_134DB = 1;
    _id_13A80( var_0 + 85000 );
    var_1 = gettime();
    level._id_134CE = 0;

    while ( level._id_134B1.size )
    {
    ...
    level._id_134CE = 8;
    level._id_134F5 = 5;
    level._id_137B7 = "enemy_mp_trial_jugg_elite";
    _id_13A80( var_2 + 15000 );
    level notify( "white_phosphorus_end" );
    level._id_134F5 = 6;
    level._id_134DB = 2;
    _id_13A80( var_2 + 15000 + 15000 );
    level._id_134B3 = 1;
    ...
    level._id_134B3 = 0;
    wait 5;
    little_bird_mg_takegunnerturret();
    level._id_134CE = 0;
}
...
_id_12181()
{
    ...
    level._id_134CE = 7;
    level._id_134F5 = 2;
    _id_13A80( var_0 + 20000 );
    level._id_134CE = 8;
    level._id_134F5 = 3;
    _id_13A80( var_0 + 35000 );
    level._id_134CE = 9;
    level._id_134F5 = 4;
    _id_13A80( var_0 + 50000 );
    thread _id_13379();
    level._id_137B7 = "enemy_mp_trial_jugg_average";
    _id_13A80( var_0 + 65000 );
    level._id_134CE = 10;
    level._id_134DB = 2;
    _id_13A80( var_0 + 75000 );
    var_1 = gettime();
    level._id_134CE = 0;
    ...
    level._id_134F5 = 5;
    level._id_137B7 = "enemy_mp_trial_jugg_elite";
    _id_13A80( var_2 + 30000 );
    level notify( "white_phosphorus_end" );
    level._id_134F5 = 6;
    level._id_134DB = 3;
    _id_13A80( var_2 + 30000 + 30000 );
    level._id_134CE = 0;
    level.chopper = spawn_chopper();
    level.chopper waittill( "death" );
    _id_1276D( 1000 );
...
onsoccerballreset()
{
    ...
    foreach ( var_2 in level._id_134B1 )
...
last_unresolved_collision_time()
{
    ...
    var_2.mpstreaksysteminfo.announcedomplatespawns = gettime();
...
_id_12DE6()
{
    ...
    var_1.mpstreaksysteminfo.announcedomplatespawns = gettime();
    ...
    foreach ( var_7, var_3 in var_0 )
    {
        ...
        var_5 = var_3.angles;
        level.player thread scripts\cp_mp\killstreaks\white_phosphorus::_id_13CFD( "disconnect" );
        level.player thread scripts\cp_mp\killstreaks\white_phosphorus::_id_13CFD( "joined_team" );
        level.player thread scripts\cp_mp\killstreaks\white_phosphorus::_id_13CFD( "joined_spectator" );
        ...
        var_6 thread scripts\cp_mp\killstreaks\white_phosphorus::_id_13D01();
...
spawn_chopper()
{
    while ( level._id_134B2.size )
    {
        foreach ( var_1 in level._id_134B2 )
        {
    ...
    var_5.mpstreaksysteminfo.announcedomplatespawns = gettime();
    var_6 = ( 0, 0, 1750 );
    ...
    var_17.gunnerdamagemodifier = var_6[2] - 750;
    var_17.health = 1200;
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "killstreakSetPostModDamageCallback" ) )
        var_17 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "killstreakSetPostModDamageCallback" ) ]]( var_5.streakname, ::get_players_at_zone );
    ...
    level.vehicles.damagecallbacks.deathcallbacks["chopper_support"] = ::get_minigun_path;
    ...
    level.sharedfuncs["dlog"]["killStreakExpired"] = ::linkedtoent;
    var_17 thread scripts\cp_mp\killstreaks\chopper_support::choppersupport_neargoalsettings();
    var_17 thread get_next_cypher_id_from_pool();
...
little_bird_mg_takegunnerturret()
{
    ...
    level thread _blankfunc::nuke_startprelaunchalarm( var_0 );
    wait( var_0 );
    playsoundatpos( var_4, "iw8_nuke_dist_launch" );
    level thread _blankfunc::nuke_launchmissile( undefined, undefined, var_4, var_2, var_1 );
    wait( var_1 );
    _id_1276E();
    level thread _blankfunc::setnuketimescalefactor();
    level thread _blankfunc::nuke_explosion( undefined, var_5 );
    level thread _blankfunc::nuke_earthquake( undefined, var_5 );
    visionsetnaked( "nuke_global_flash", 0.05 );
    setdvar( "r_materialBloomHQScriptMasterEnable", 0 );
    wait 0.5;
    level thread _blankfunc::nuke_fadeflashvision( 1, 2 );
    wait 4.5;
    _blankfunc::wave_revive();
    level.little_bird_mg_mp_initspawning = level.player.health;
    level.player kill();
    level thread _blankfunc::wave_goto_on_spawn( 2 );

    foreach ( var_7 in level._id_134B1 )
        var_7 dodamage( 99999, var_2 );

    level notify( "nuke_death" );
}

linkedtoent( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17, var_18, var_19, var_20, var_21, var_22, var_23, var_24, var_25 )
{
...
ai_init()
{
    ...
    for (;;)
    {
        while ( level._id_134CE <= level.agentarray.size - scripts\mp\mp_agent::getfreeagentcount() )
            waitframe();

        if ( istrue( level._id_134DB ) )
        {
            _id_12D35();
            level._id_134DB--;
        }
...
_id_12CE4()
{
    ...
    if ( !isdefined( level.agent_funcs["actor_" + level._id_137B7] ) )
    {
        level.agent_funcs["actor_" + level._id_137B7] = [];
        level.agent_funcs["actor_" + level._id_137B7]["gametype_on_damaged"] = ::_id_134B6;
        level.agent_funcs["actor_" + level._id_137B7]["gametype_on_killed"] = ::_id_134B7;
    }

    var_0 = scripts\mp\mp_agent::spawnnewagentaitype( level._id_137B7, movelatejoinerstospectators(), ( 0, 0, 0 ) );
    var_0.a.disablelongdeath = 1;
    var_0 enabletraversals( 0 );
    var_0.goalradius = 750;
    level._id_134B1 = scripts\engine\utility::array_add( level._id_134B1, var_0 );
    var_0 thread binoculars_addheadicon();
    var_0 thread binoculars_clearexpirationtimer();
...
_id_12D35()
{
    ...
    if ( !isdefined( level.agent_funcs["actor_enemy_mp_trial_juggernaut"] ) )
    {
        ...
        level.agent_funcs["actor_enemy_mp_trial_juggernaut"]["gametype_on_damaged"] = ::_id_134B6;
        level.agent_funcs["actor_enemy_mp_trial_juggernaut"]["gametype_on_killed"] = ::_id_134B7;
    }

    var_0 = scripts\mp\mp_agent::spawnnewagentaitype( "enemy_mp_trial_juggernaut", movelatejoinerstospectators(), ( 0, 0, 0 ) );
    var_0.a.disablelongdeath = 1;
    var_0 enabletraversals( 0 );
    level._id_134B1 = scripts\engine\utility::array_add( level._id_134B1, var_0 );
    level._id_134B2 = scripts\engine\utility::array_add( level._id_134B2, var_0 );
    var_0 setgoalentity( level.player );
    var_0 agentsetfavoriteenemy( level.player );
...
bink_save_hack()
{
    ...
    level._id_134F4[self.entity_number] = self;
    var_0 = gettime() + 750;

    while ( var_0 > gettime() && self.health > 0 )
        waitframe();

    level._id_134F4 = scripts\engine\utility::array_remove_key( level._id_134F4, self.entity_number );
}

binoculars_clearexpirationtimer()
{
    self endon( "death" );
    ...
    for (;;)
    {
        var_0 = level._id_134F4.size >= level._id_134F5;
        var_1 = !isdefined( level._id_134F4[self.entity_number] );
...
_id_134B6( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
...
_id_134B7( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    level._id_134B1 = scripts\engine\utility::array_remove( level._id_134B1, self );
    level._id_134B2 = scripts\engine\utility::array_remove( level._id_134B2, self );

    if ( var_4.basename == level.player.primaryweaponobj.basename )
    {
        if ( self.agent_type == "actor_enemy_mp_trial_juggernaut" )
            thread _id_1276D( 500 );
        else
            thread _id_1276D( 100 );
    }
}

_id_12770()
{
    _maphint_offerscriptableused::_id_1351A( 4000 );
    level.score = [];
    ...
    _maphint_offerscriptableused::trial_ui_set_best_score( level.score["best"] );
    level.score["total"] = 0;
...
score_calculate( var_0 )
{
    ...
    _maphint_offerscriptableused::trial_ui_set_stat_and_bonus_score( 1, "enemies_killed_no_ratio", level.score["enemies_killed_count"], 0 );
    _maphint_offerscriptableused::trial_ui_set_stat_and_bonus_score( 2, "highest_combo", level.score["highest_combo"], 0 );
    _maphint_offerscriptableused::trial_ui_set_subscore( level.score["subtotal"] );
    hud_set_reward_tier();

    if ( var_0 )
    {
        _maphint_offerscriptableused::trial_ui_set_main_score( level.score["total"] );
        ...
        thread _maphint_offerscriptableused::trial_ui_open_results_screen();
    }
}
...
hud_set_reward_tier( var_0 )
{
    ...
    if ( var_0 )
        _maphint_offerscriptableused::trial_ui_set_reward_tier( var_2 );
    else
        _maphint_offerscriptableused::trial_ui_set_reward_tier_preview( var_2 );
}

_id_1276D( var_0 )
{
    if ( !isdefined( level.start_puzzle ) )
        level.start_puzzle = 1;

    var_1 = min( 100000, var_0 * level.start_puzzle );
    _maphint_offerscriptableused::_id_13519( level.start_puzzle );
    level.start_puzzle++;

    if ( level.score["highest_combo"] < level.start_puzzle )
        level.score["highest_combo"] = level.start_puzzle;
...
_id_1276E()
{
    ...
    _maphint_offerscriptableused::trial_ui_set_stat_and_bonus_score( 3, "stat_nuked", 0, level.score["nuked"] );
    score_calculate();
}
...
getsuperrefforsuperextraweapon()
{
    ...
    wait 0.25;
    level.start_puzzle = 1;
    _maphint_offerscriptableused::_id_13519( 0 );
}
...
dialog_init()
{
    ...
    thread is_suicidebomber();
    thread is_wave_hud_enabled();
}
...
onteammatereviveweaponswitchcomplete()
{
    level.gameskill = 1;
    ...
    _maphint_offerscriptableused::waittill_player_isdefined();
    level.player onteammatereviveweapontaken( level.gameskill );
}

onteammatereviveweapontaken( var_0 )
{
