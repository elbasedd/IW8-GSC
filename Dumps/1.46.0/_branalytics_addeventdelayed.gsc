...
_id_127A8( var_0 )
{
    ...
    {
        var_1 = "bash_left_90";
        var_2 = self.getnextsafecircleradius + ( 0, 90, 0 );
    }
    else
    {
        var_1 = "bash_right_90";
...
_id_127AA( var_0 )
{
    ...
    var_1 = self.getnextspectatecandidatefromchain;
    var_2 = var_0.getnextspectatecandidatefromchain;
...
killoff_vis_passed( var_0, var_1 )
{
    var_2 = !var_0;
