...
init()
{
    thread set_force_aitype_armored();
}
...
set_force_aitype_armored()
{
    ...
    {
        waitframe();
        level._id_134F3[level._id_134F3.size] = _id_12A19( var_2 );
    }
...
_id_12A19( var_0, var_1 )
{
    ...
    var_4 thread holdoutafterspawnfunc();
    ...
    var_4.getscrapassistplayers setmodel( "weapon_vm_mg_sentry_turret_invis_base" );
    var_4.getscrapassistplayers dontinterpolate();
    var_4.getscrapassistplayers.angles = var_4.angles;
    var_4.getscrapassistplayers.origin = var_4.origin;
    var_4.getscrapassistplayers linkto( var_4, "tag_aim_pivot" );
    var_5 = "icon_minimap_sentry";
    var_4.minimapid = var_4.getscrapassistplayers scripts\mp\objidpoolmanager::createobjective( var_5, var_4.team, undefined, 1, 1 );

    if ( isdefined( level._id_13513 ) )
        var_4 thread [[ level._id_13513 ]]();
...
sentry_handledeath()
{
    ...
    if ( isdefined( level._id_13512 ) )
    {
        if ( isdefined( self.cac_getaccessorylogic ) && gettime() < self.cac_getaccessorylogic + 4000 )
            self [[ level._id_13512 ]]();
    }
...
sentry_handledamage()
{
    for (;;)
    {
        ...
        if ( var_1 == level.player )
        {
            ...
            self.cac_getaccessorylogic = gettime();
        }
    }
}
