...
playerattackedmonitor()
{
    for (;;)
    {
        level scripts\engine\utility::_id_13AD9( "an_enemy_shot", "enemy_grenade_fire" );
...
stealthhints_aimonitor( var_0, var_1 )
{
    ...
    if ( var_0 [[ var_0.fnisinstealthhunt ]]() )
    {
        ...
        var_0 scripts\engine\utility::_id_13ADA( "stealth_combat", "death", "stealthHints_timeout" );
    }
    else if ( var_0 [[ var_0.fnisinstealthinvestigate ]]() )
        var_0 scripts\engine\utility::_id_13ADA( "stealth_idle", "stealth_combat", "death" );
