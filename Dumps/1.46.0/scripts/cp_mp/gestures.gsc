...
init()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) && isdefined( var_4 ) && var_4 != "" )
            level.parachute_deploy[var_3] = var_4;
...
playerpreloadintrocinematic( var_0 )
{
    return level.parachute_deploy[var_0];
}
...
_id_11EB4()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_13ADA( "skydive_deployparachute", "skydive_end", "skydive_beginfreefall" );
        thread _id_135A2();
    }
}
...
_id_13010()
{
    if ( istrue( self.chopperexfil_skip_ascend1 ) )
        return;

    self setscriptablepartstate( "watchVFXPlayer", "bluntWatchOn" );
    self setclientomnvar( "ui_pet_watch_state", 0 );
    self setwristwatchtime( 4, 20, 1 );
    self.chopperexfil_skip_ascend1 = 1;
    thread chopperexfil_skip_ascend2();
}
...
_id_135A2()
{
    ...
    if ( var_0 )
    {
        ...
        if ( var_3 && ( !isdefined( self._id_12C20 ) || !istrue( self._id_12C20 ) ) )
        {
            if ( var_3 )
            {
                _id_13023();
    ...
    else if ( var_1 )
    {
        ...
        if ( var_4 && ( !isdefined( self._id_12C20 ) || !istrue( self._id_12C20 ) ) )
        {
            if ( var_4 )
            {
                _id_13024();
    ...
    else if ( var_2 )
    {
        ...
        if ( var_5 && ( !isdefined( self._id_12C20 ) || !istrue( self._id_12C20 ) ) )
        {
            if ( var_5 )
                _id_13025();
        }
...
watchradialgestureactivation( var_0, var_1 )
{
    ...
    if ( var_0 == "radial_menu_selection_gesture" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            {
                if ( !isdefined( self._id_12C20 ) )
                    self._id_12C20 = 0;

                self._id_12C20 = !self._id_12C20;
                self setclientomnvar( "ui_smart_watch_interact", self._id_12C20 );
                ...
                if ( isdefined( self.accessorylogic ) )
                {
                    ...
                    else if ( self.accessorylogic == "holo3" )
                    {
                        ...
                        scripts\cp\vehicles\cargo_truck_mg_cp::_id_13C03();
                }
            }
            else if ( var_2 == "iw8_ges_plyr_gesture023" )
            {
                if ( !isdefined( self._id_13BC1 ) )
                    self._id_13BC1 = 0;

                self._id_13BC1 = !self._id_13BC1;
                self setclientomnvar( "ui_smart_watch_check", self._id_13BC1 );
            ...
            {
                var_4 = playerpreloadintrocinematic( var_1 );
...
_id_13C17( var_0 )
{
    ...
    while ( gettime() < var_1 )
    {
        ...
        if ( self isgestureplaying( "iw8_ges_plyr_spray" ) )
        {
            ...
            scripts\cp\utility\cp_controlled_callbacks::_id_119CC();
            return;
        }
    }
}
