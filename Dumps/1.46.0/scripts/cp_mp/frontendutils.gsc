...
_id_12A12()
{
    level._id_12B8D = getdvarint( "MONKPPPQR", 0 );
    level.onjoinedteamcb = ::init_relic_aggressive_melee;
    level.onjointeamnospectatorcallbacks = ::init_relic_damage_from_above;
    level.onjoinspectators = ::init_relic_ammo_drain;
}
...
init_relic_aggressive_melee()
{
    wait 0.1;
    waittillframeend;
    level.notifyteamonvehicledeath = getent( "mp_lobby_floor_01", "targetname" );
    level.notifyteamonvehicledeath.getquestplunderreward = getentarray( "floor_01_clutter", "targetname" );
    level.notifyteamonvehicledeath.lights = getentarray( "floor_01_lights", "script_noteworthy" );
    level.npcbodies = getent( "mp_lobby_floor_02", "targetname" );
    level.npcbodies.getquestplunderreward = getentarray( "floor_02_clutter", "targetname" );
    level.npcbodies.lights = getentarray( "floor_02_lights", "script_noteworthy" );

    if ( level.notifyteamonvehicledeath.getquestplunderreward.size )
        scripts\engine\utility::array_call( level.notifyteamonvehicledeath.getquestplunderreward, ::linkto, level.notifyteamonvehicledeath );

    if ( level.npcbodies.getquestplunderreward.size )
        scripts\engine\utility::array_call( level.npcbodies.getquestplunderreward, ::linkto, level.npcbodies );

    var_0 = scripts\engine\utility::array_combine( level.notifyteamonvehicledeath.lights, level.npcbodies.lights );

    foreach ( var_2 in var_0 )
        var_2.originalpos = var_2.origin;

    var_4 = level.notifyteamonvehicledeath.origin;
    var_5 = level.npcbodies.origin;
    ...
    for (;;)
    {
        if ( var_11 )
        {
            var_12 = level.npcbodies;
            var_13 = level.notifyteamonvehicledeath;
        }
        else
        {
            var_12 = level.notifyteamonvehicledeath;
            var_13 = level.npcbodies;
        }
...
init_relic_ammo_drain()
{
    ...
    level.waitfor_trigger_near_obit = [];
        ...
        foreach ( var_7 in var_5 )
        {
            ...
            if ( isdefined( var_7.script_noteworthy ) )
            {
                ...
                if ( scripts\engine\utility::array_contains_key( level._effect, var_9[0] ) )
                {
                    ...
                    var_10 = level.waitfor_trigger_near_obit.size;
                    level.waitfor_trigger_near_obit[var_10] = scripts\engine\utility::spawn_tag_origin();
                    level.waitfor_trigger_near_obit[var_10].origin = var_7.origin;

                    if ( isdefined( var_7.angles ) )
                        level.waitfor_trigger_near_obit[var_10].angles = var_7.angles;

                    level.waitfor_trigger_near_obit[var_10].fxname = var_9[0];
                    level.waitfor_trigger_near_obit[var_10] show();

                    if ( isdefined( var_7.script_label ) && var_7.script_label == "non_moving" )
                        continue;

                    var_11 = scripts\engine\utility::getclosest( var_7.origin, var_4 );
                    level.waitfor_trigger_near_obit[var_10] linkto( var_11 );
                }
                else
    ...
    if ( level.waitfor_trigger_near_obit.size )
    {
        foreach ( var_15 in level.waitfor_trigger_near_obit )
...
old_accuracy()
{
    level thread [[ level.onjoinedteamcb ]]();
}

old_getspawnpoint_func()
{
    level thread [[ level.onjointeamnospectatorcallbacks ]]();
}

old_getspawnpoint()
{
    level thread [[ level.onjoinspectators ]]();
}
...
oilfire_burning_player_watch()
{
    level.expiredlootleaderinstance = getent( "lobby_cam_rig", "targetname" );
    level.expiredlootleaderinstance._id_12AE3 = [ "j_prop_1", "j_prop_2", "j_prop_3", "j_prop_4", "j_prop_5" ];
    level.expiredlootleaderinstance scriptmodelplayanim( "chr_menu_mp_genpropx5_cam" );
    var_0 = level.leaderboard_enabled;
    level.camera_anchor = spawn( "script_model", level.expiredlootleaderinstance gettagorigin( var_0 ) );
    level.camera_anchor setmodel( "tag_origin" );
    level.camera_anchor.angles = level.expiredlootleaderinstance gettagangles( var_0 );
    level.camera_anchor linkto( level.expiredlootleaderinstance, var_0 );
}
...
_id_1372A()
{
    if ( isdefined( level.active_scene_data._id_12EEB ) )
        setdvar( "LTQMSPKRKO", level.active_scene_data._id_12EEB );
    else
...
_id_1372B()
{
    if ( isdefined( level.active_scene_data._id_12EEC ) )
        setdvar( "LLNMKLQQP", level.active_scene_data._id_12EEC );
    else
        setdvar( "LLNMKLQQP", 2 );
}
    ...
    switch ( var_0 )
    {
        case "small":
            foreach ( var_2 in level.ui_bg_images_2d )
                var_2.origin = level._id_122C8.origin;

            break;
        case "medium":
            foreach ( var_2 in level.ui_bg_images_2d )
                var_2.origin = level._id_122C7.origin;

            break;
        case "large":
            foreach ( var_2 in level.ui_bg_images_2d )
                var_2.origin = level._id_122C6.origin;

            break;
        case "watch":
            foreach ( var_2 in level.ui_bg_images_2d )
                var_2.origin = level._id_122C9.origin;
...
get_section_state( var_0 )
{
    ...
    switch ( var_0.name )
    {
        ...
        case "character_preview_select":
            var_1["scene"] = level.expiredbydeath;
            var_1["camera"] = level.expiredbydeath.basecam;
            break;
        case "character_preview_select_detail":
            var_1["scene"] = level.expiredlootleaderenabled;
            var_1["camera"] = level.expiredlootleaderenabled.basecam;
            break;
        ...
        case "character_gamebattles":
            var_1["scene"] = level.expirationtimer;
            var_1["camera"] = level.expirationtimer.basecam;
        ...
        case "loadout_showcase_preview_barrel_alt2":
            var_1["scene"] = level.expiredlootleaders;
            var_1["camera"] = level.expiredlootleaders.basecam;
            break;
        ...
        case "loadout_showcase_preview_charm_alt4":
            var_1["scene"] = level.exploboltexplode;
            var_1["camera"] = level.exploboltexplode.basecam;
            break;
        case "loadout_showcase_preview_charm_alt5":
            var_1["scene"] = level.explode_fx;
            var_1["camera"] = level.explode_fx.basecam;
            break;
        case "loadout_showcase_preview_charm_alt6":
            var_1["scene"] = level.exploder_ref;
            var_1["camera"] = level.exploder_ref.basecam;
            break;
        case "loadout_showcase_preview_small_charm_alt1":
            var_1["scene"] = level.extendcirclelist;
            var_1["camera"] = level.extendcirclelist.basecam;
            break;
        ...
        case "loadout_showcase_preview_sticker":
            var_1["scene"] = level.extra_delay;
            var_1["camera"] = level.extra_delay.basecam;
            break;
        case "loadout_showcase_preview_sticker_alt1":
            var_1["scene"] = level.extra_enemies;
            var_1["camera"] = level.extra_enemies.basecam;
            break;
        case "loadout_showcase_preview_sticker_alt2":
            var_1["scene"] = level.extra_glow_sticks_init;
            var_1["camera"] = level.extra_glow_sticks_init.basecam;
            break;
        case "loadout_showcase_preview_sticker_alt3":
            var_1["scene"] = level.extra_riders_func;
            var_1["camera"] = level.extra_riders_func.basecam;
            break;
        case "loadout_showcase_preview_sticker_alt4":
            var_1["scene"] = level.extra_riders_getin_anim_func;
            var_1["camera"] = level.extra_riders_getin_anim_func.basecam;
            break;
        ...
        case "loadout_showcase_preview_large_charm_alt3":
            var_1["scene"] = level.explosion_init;
            var_1["camera"] = level.explosion_init.basecam;
            break;
        case "loadout_showcase_preview_large_charm_alt4":
            var_1["scene"] = level.explosionspots;
            var_1["camera"] = level.explosionspots.basecam;
            break;
        case "loadout_showcase_preview_large_charm_alt5":
            var_1["scene"] = level.explosive_barrel;
            var_1["camera"] = level.explosive_barrel.basecam;
            break;
        case "loadout_showcase_preview_large_charm_alt6":
            var_1["scene"] = level.explosive_barrels;
            var_1["camera"] = level.explosive_barrels.basecam;
            break;
        ...
        case "loadout_showcase_preview_large_laser_alt1":
            var_1["scene"] = level.explosive_cars;
            var_1["camera"] = level.explosive_cars.basecam;
            break;
        ...
        case "loadout_showcase_preview_large_optic_alt1":
            var_1["scene"] = level.explosivemodoverride;
            var_1["camera"] = level.explosivemodoverride.basecam;
            break;
        case "loadout_showcase_preview_large_optic_alt2":
            var_1["scene"] = level.explozone;
            var_1["camera"] = level.explozone.basecam;
            break;
        ...
        case "loadout_showcase_preview_large_sticker":
            var_1["scene"] = level.exposed_node;
            var_1["camera"] = level.exposed_node.basecam;
            break;
        case "loadout_showcase_preview_large_sticker_alt1":
            var_1["scene"] = level.exposed_to_chopper_boss_time;
            var_1["camera"] = level.exposed_to_chopper_boss_time.basecam;
            break;
        case "loadout_showcase_preview_large_sticker_alt2":
            var_1["scene"] = level.extactioncancel;
            var_1["camera"] = level.extactioncancel.basecam;
            break;
        case "loadout_showcase_preview_large_sticker_alt3":
            var_1["scene"] = level.extactioncomplete;
            var_1["camera"] = level.extactioncomplete.basecam;
            break;
        ...
        case "loadout_showcase_preview_large_stock_alt1":
            var_1["scene"] = level.extactionstart;
            var_1["camera"] = level.extactionstart.basecam;
            break;
        ...
        case "loadout_showcase_preview_small_laser_alt1":
            var_1["scene"] = level.exterior_goal_func;
            var_1["camera"] = level.exterior_goal_func.basecam;
            break;
        ...
        case "loadout_showcase_preview_small_reargrip_alt1":
            var_1["scene"] = level.extra_bomb_explode_vfx_func;
            var_1["camera"] = level.extra_bomb_explode_vfx_func.basecam;
            break;
        case "loadout_showcase_preview_small_sticker":
            var_1["scene"] = level.extra_collision;
            var_1["camera"] = level.extra_collision.basecam;
            break;
        ...
        case "loadout_showcase_armory":
            var_1["scene"] = level.expiredlootleadermarks;
            var_1["camera"] = level.expiredlootleadermarks.basecam;
            break;
...
create_camera_position_list()
{
    ...
    level.camera_loadout_showcase._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_overview._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_watch._id_12EEB = 6;
    level.expiredlootleadermarks = spawnstruct();
    level.expiredlootleadermarks.basecam = getent( "camera_mp_gunsmith_armory", "targetname" );
    level.expiredlootleadermarks.basecam.depthoffieldvalues = [ 7, 67 ];
    level.expiredlootleadermarks.myfov = 44;
    level.expiredlootleadermarks.weapon_locs[0] = getent( "weapon_loc_hq1", "targetname" );
    level.expiredlootleadermarks.weapon_locs[1] = getent( "weapon_loc_hq2", "targetname" );
    level.expiredlootleadermarks.weapon_locs[3] = getent( "weapon_loc_watch", "targetname" );
    level.expiredlootleadermarks._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_p._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_p_large._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_s._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_o._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_o_large._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_l._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_t._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_perks._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_x._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_y._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_z._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_specialist._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_watch._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_riot._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_barrel._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_barrel_alt1._id_12EEB = 6;
    level.expiredlootleaders = spawnstruct();
    level.expiredlootleaders.basecam = getent( "camera_mp_gunsmith_preview_barrel_alt2", "targetname" );
    level.expiredlootleaders.basecam.depthoffieldvalues = [ 8, 54 ];
    level.expiredlootleaders.myfov = 36;
    level.expiredlootleaders.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.expiredlootleaders._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_charm._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_charm_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_charm_alt2._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_charm_alt3._id_12EEB = 6;
    level.exploboltexplode = spawnstruct();
    level.exploboltexplode.basecam = getent( "camera_mp_gunsmith_preview_charm_alt4", "targetname" );
    level.exploboltexplode.basecam.depthoffieldvalues = [ 21, 18 ];
    level.exploboltexplode.myfov = 36;
    level.exploboltexplode.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.exploboltexplode._id_12EEB = 6;
    level.explode_fx = spawnstruct();
    level.explode_fx.basecam = getent( "camera_mp_gunsmith_preview_charm_alt5", "targetname" );
    level.explode_fx.basecam.depthoffieldvalues = [ 22, 18 ];
    level.explode_fx.myfov = 36;
    level.explode_fx.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explode_fx._id_12EEB = 6;
    level.exploder_ref = spawnstruct();
    level.exploder_ref.basecam = getent( "camera_mp_gunsmith_preview_charm_alt6", "targetname" );
    level.exploder_ref.basecam.depthoffieldvalues = [ 21, 16 ];
    level.exploder_ref.myfov = 36;
    level.exploder_ref.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.exploder_ref._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_laser._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_laser_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_laser_alt2._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_magazine._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_magazine_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_magazine_alt2._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_muzzle._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_muzzle_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_optic._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_optic_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_reargrip._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_reargrip_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_reargrip_alt2._id_12EEB = 6;
    level.extra_delay = spawnstruct();
    level.extra_delay.basecam = getent( "camera_mp_gunsmith_preview_sticker", "targetname" );
    level.extra_delay.basecam.depthoffieldvalues = [ 20, 32 ];
    level.extra_delay.myfov = 36;
    level.extra_delay.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_delay._id_12EEB = 6;
    level.extra_enemies = spawnstruct();
    level.extra_enemies.basecam = getent( "camera_mp_gunsmith_preview_sticker_alt1", "targetname" );
    level.extra_enemies.basecam.depthoffieldvalues = [ 20, 32 ];
    level.extra_enemies.myfov = 36;
    level.extra_enemies.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_enemies._id_12EEB = 6;
    level.extra_glow_sticks_init = spawnstruct();
    level.extra_glow_sticks_init.basecam = getent( "camera_mp_gunsmith_preview_sticker_alt2", "targetname" );
    level.extra_glow_sticks_init.basecam.depthoffieldvalues = [ 20, 34 ];
    level.extra_glow_sticks_init.myfov = 36;
    level.extra_glow_sticks_init.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_glow_sticks_init._id_12EEB = 6;
    level.extra_riders_func = spawnstruct();
    level.extra_riders_func.basecam = getent( "camera_mp_gunsmith_preview_sticker_alt3", "targetname" );
    level.extra_riders_func.basecam.depthoffieldvalues = [ 20, 34 ];
    level.extra_riders_func.myfov = 36;
    level.extra_riders_func.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_riders_func._id_12EEB = 6;
    level.extra_riders_getin_anim_func = spawnstruct();
    level.extra_riders_getin_anim_func.basecam = getent( "camera_mp_gunsmith_preview_sticker_alt4", "targetname" );
    level.extra_riders_getin_anim_func.basecam.depthoffieldvalues = [ 20, 34 ];
    level.extra_riders_getin_anim_func.myfov = 36;
    level.extra_riders_getin_anim_func.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_riders_getin_anim_func._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_stock._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_stock_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_stock_alt2._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_underbarrel._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_barrel._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_charm._id_12EEB = 6;
    level.extendcirclelist = spawnstruct();
    level.extendcirclelist.basecam = getent( "camera_mp_gunsmith_preview_small_charm_alt1", "targetname" );
    level.extendcirclelist.basecam.depthoffieldvalues = [ 25, 19 ];
    level.extendcirclelist.myfov = 36;
    level.extendcirclelist.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extendcirclelist._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_laser._id_12EEB = 6;
    level.exterior_goal_func = spawnstruct();
    level.exterior_goal_func.basecam = getent( "camera_mp_gunsmith_preview_small_laser_alt1", "targetname" );
    level.exterior_goal_func.basecam.depthoffieldvalues = [ 8, 25 ];
    level.exterior_goal_func.myfov = 36;
    level.exterior_goal_func.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.exterior_goal_func._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_magazine._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_magazine_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_muzzle._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_optic._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_reargrip._id_12EEB = 6;
    level.extra_bomb_explode_vfx_func = spawnstruct();
    level.extra_bomb_explode_vfx_func.basecam = getent( "camera_mp_gunsmith_preview_small_reargrip_alt1", "targetname" );
    level.extra_bomb_explode_vfx_func.basecam.depthoffieldvalues = [ 12, 20 ];
    level.extra_bomb_explode_vfx_func.myfov = 36;
    level.extra_bomb_explode_vfx_func.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_bomb_explode_vfx_func._id_12EEB = 6;
    level.extra_collision = spawnstruct();
    level.extra_collision.basecam = getent( "camera_mp_gunsmith_preview_small_sticker", "targetname" );
    level.extra_collision.basecam.depthoffieldvalues = [ 16, 22 ];
    level.extra_collision.myfov = 36;
    level.extra_collision.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extra_collision._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_stock._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_small_trigger._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_barrel._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_charm._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_charm_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_charm_alt2._id_12EEB = 6;
    level.explosion_init = spawnstruct();
    level.explosion_init.basecam = getent( "camera_mp_gunsmith_preview_large_charm_alt3", "targetname" );
    level.explosion_init.basecam.depthoffieldvalues = [ 25, 19 ];
    level.explosion_init.myfov = 36;
    level.explosion_init.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explosion_init._id_12EEB = 6;
    level.explosionspots = spawnstruct();
    level.explosionspots.basecam = getent( "camera_mp_gunsmith_preview_large_charm_alt4", "targetname" );
    level.explosionspots.basecam.depthoffieldvalues = [ 21, 16 ];
    level.explosionspots.myfov = 36;
    level.explosionspots.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explosionspots._id_12EEB = 6;
    level.explosive_barrel = spawnstruct();
    level.explosive_barrel.basecam = getent( "camera_mp_gunsmith_preview_large_charm_alt5", "targetname" );
    level.explosive_barrel.basecam.depthoffieldvalues = [ 21, 17 ];
    level.explosive_barrel.myfov = 36;
    level.explosive_barrel.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explosive_barrel._id_12EEB = 6;
    level.explosive_barrels = spawnstruct();
    level.explosive_barrels.basecam = getent( "camera_mp_gunsmith_preview_large_charm_alt6", "targetname" );
    level.explosive_barrels.basecam.depthoffieldvalues = [ 21, 17 ];
    level.explosive_barrels.myfov = 36;
    level.explosive_barrels.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explosive_barrels._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_barrel_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_laser._id_12EEB = 6;
    level.explosive_cars = spawnstruct();
    level.explosive_cars.basecam = getent( "camera_mp_gunsmith_preview_large_laser_alt1", "targetname" );
    level.explosive_cars.basecam.depthoffieldvalues = [ 12, 26 ];
    level.explosive_cars.myfov = 36;
    level.explosive_cars.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explosive_cars._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_magazine._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_magazine_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_magazine_alt2._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_muzzle._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_muzzle_alt1._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_optic._id_12EEB = 6;
    level.explosivemodoverride = spawnstruct();
    level.explosivemodoverride.basecam = getent( "camera_mp_gunsmith_preview_large_optic_alt1", "targetname" );
    level.explosivemodoverride.basecam.depthoffieldvalues = [ 21.5, 25 ];
    level.explosivemodoverride.myfov = 36;
    level.explosivemodoverride.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explosivemodoverride._id_12EEB = 6;
    level.explozone = spawnstruct();
    level.explozone.basecam = getent( "camera_mp_gunsmith_preview_large_optic_alt2", "targetname" );
    level.explozone.basecam.depthoffieldvalues = [ 21.5, 25 ];
    level.explozone.myfov = 36;
    level.explozone.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.explozone._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_reargrip._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_reargrip_alt1._id_12EEB = 6;
    level.exposed_node = spawnstruct();
    level.exposed_node.basecam = getent( "camera_mp_gunsmith_preview_large_sticker", "targetname" );
    level.exposed_node.basecam.depthoffieldvalues = [ 20, 32 ];
    level.exposed_node.myfov = 36;
    level.exposed_node.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.exposed_node._id_12EEB = 6;
    level.exposed_to_chopper_boss_time = spawnstruct();
    level.exposed_to_chopper_boss_time.basecam = getent( "camera_mp_gunsmith_preview_large_sticker_alt1", "targetname" );
    level.exposed_to_chopper_boss_time.basecam.depthoffieldvalues = [ 20, 35 ];
    level.exposed_to_chopper_boss_time.myfov = 36;
    level.exposed_to_chopper_boss_time.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.exposed_to_chopper_boss_time._id_12EEB = 6;
    level.extactioncancel = spawnstruct();
    level.extactioncancel.basecam = getent( "camera_mp_gunsmith_preview_large_sticker_alt2", "targetname" );
    level.extactioncancel.basecam.depthoffieldvalues = [ 20, 32 ];
    level.extactioncancel.myfov = 36;
    level.extactioncancel.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extactioncancel._id_12EEB = 6;
    level.extactioncomplete = spawnstruct();
    level.extactioncomplete.basecam = getent( "camera_mp_gunsmith_preview_large_sticker_alt3", "targetname" );
    level.extactioncomplete.basecam.depthoffieldvalues = [ 20, 35 ];
    level.extactioncomplete.myfov = 36;
    level.extactioncomplete.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extactioncomplete._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_stock._id_12EEB = 6;
    level.extactionstart = spawnstruct();
    level.extactionstart.basecam = getent( "camera_mp_gunsmith_preview_large_stock_alt1", "targetname" );
    level.extactionstart.basecam.depthoffieldvalues = [ 16, 43 ];
    level.extactionstart.myfov = 36;
    level.extactionstart.weapon_locs[2] = getent( "weapon_loc_preview", "targetname" );
    level.extactionstart._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_underbarrel._id_12EEB = 6;
    ...
    level.camera_loadout_showcase_preview_large_underbarrel_alt1._id_12EEB = 6;
    ...
    level.camera_character_tango._id_12EEB = 6;
    ...
    level.camera_character_faction_select_l.update_char_loc = ::_id_13720;
    level.camera_character_faction_select_l._id_12EEB = 6;
    ...
    level.camera_character_faction_select_l_detail.update_char_loc = ::_id_13720;
    level.camera_character_faction_select_l_detail._id_12EEB = 6;
    ...
    level.camera_character_faction_select_r.update_char_loc = ::_id_1371F;
    level.camera_character_faction_select_r.char_index = 1;
    level.camera_character_faction_select_r._id_12EEB = 6;
    ...
    level.camera_character_faction_select_r_detail.update_char_loc = ::_id_1371F;
    level.camera_character_faction_select_r_detail.char_index = 1;
    level.camera_character_faction_select_r_detail._id_12EEB = 6;
    level.expiredbydeath = spawnstruct();
    level.expiredbydeath.basecam = getent( "char_preview_detail", "targetname" );
    level.expiredbydeath.basecam.depthoffieldvalues = [ 22, 60 ];
    level.expiredbydeath.myfov = 37;
    level.expiredbydeath.char_loc = getent( "charroom_char_preview", "targetname" );
    level.expiredbydeath._id_12EEB = 6;
    level.expiredlootleaderenabled = spawnstruct();
    level.expiredlootleaderenabled.basecam = getent( "char_preview", "targetname" );
    level.expiredlootleaderenabled.basecam.depthoffieldvalues = [ 22, 181 ];
    level.expiredlootleaderenabled.myfov = 37;
    level.expiredlootleaderenabled.char_loc = getent( "charroom_char_preview", "targetname" );
    level.expiredlootleaderenabled._id_12EEB = 6;
    ...
    if ( isdefined( level.old_spectator_func ) && level.old_spectator_func == 1 )
        level.camera_lobby._id_12EEB = 5;

    if ( isdefined( level.oldkey ) && level.oldkey == 1 || isdefined( level.oldest_targeted_by_chopper_time ) && level.oldest_targeted_by_chopper_time == 1 )
        level.camera_lobby._id_12EEB = 8;

    if ( isdefined( level.oldkey ) && level.oldkey == 1 || isdefined( level.oldest_targeted_by_chopper_time ) && level.oldest_targeted_by_chopper_time == 1 )
        level.camera_lobby._id_12EEC = 6;

    if ( isdefined( level.oldlatespawnplayer ) && level.oldlatespawnplayer == 1 )
        level.camera_lobby._id_12EEB = 8;

    if ( isdefined( level.oldlatespawnplayer ) && level.oldlatespawnplayer == 1 )
        level.camera_lobby._id_12EEC = 6;

    if ( isdefined( level.omnvar_bit ) && level.omnvar_bit == 1 )
        level.camera_lobby._id_12EEB = 8;
    ...
    if ( isdefined( level.on_killed_tutorial ) && level.on_killed_tutorial == 1 )
        level.camera_lobby._id_12EEB = 8;
    ...
    if ( isdefined( level.old_spectator_func ) && level.old_spectator_func == 1 )
        level.camera_lobby_detail._id_12EEB = 5;

    if ( isdefined( level.oldkey ) && level.oldkey == 1 || isdefined( level.oldest_targeted_by_chopper_time ) && level.oldest_targeted_by_chopper_time == 1 )
        level.camera_lobby_detail._id_12EEB = 8;

    if ( isdefined( level.oldkey ) && level.oldkey == 1 || isdefined( level.oldest_targeted_by_chopper_time ) && level.oldest_targeted_by_chopper_time == 1 )
        level.camera_lobby_detail._id_12EEC = 6;
    ...
    level.expirationtimer = spawnstruct();
    level.expirationtimer.basecam = getent( "char_tournament_overcam", "targetname" );
    level.expirationtimer.basecam.depthoffieldvalues = [ 22, 256 ];
    level.expirationtimer.myfov = 36;
    level.expirationtimer.update_char_loc = ::_id_13706;
}
...
setup_initial_entities()
{
    ...
    for ( var_3 = 0; var_3 < 4; var_3++ )
    {
        ...
        level.characters[var_0] = spawn( "script_character", var_1.origin, 0, 0, var_0, "MPClientCharacter" );
        level.characters[var_0].spawn_removefromarrays = 1;
    }
...
transitionplayerstoac130cinematic()
{
    ...
    {
        level.rpg_shoot_at_trigs = loadfx( "vfx/iw8_mp/watches/vfx_mp_holo_watch" );
        wait 1;
    }

    level._id_13BFD = spawnfx( level.rpg_shoot_at_trigs, level.weapons[3].origin );
    level._id_13BFD.angles = ( 221, -34.753, 181.997 );
    level._id_13BFD.origin = level._id_13BFD.origin + ( 1, -0.66, 0.98 );
    waitframe();
    triggerfx( level._id_13BFD );
}
...
wait_to_play_intro_vo( var_0 )
{
    ...
    var_4 = level._id_13BFD.angles;
    var_5 = level._id_13BFD.origin + ( var_1, var_2, var_3 );
    level._id_13BFD delete();
    level._id_13BFD = spawnfx( level.rpg_shoot_at_trigs, var_5 );
    level._id_13BFD.angles = var_4;
    triggerfx( level._id_13BFD );
}
...
_id_12620( var_0 )
{
    ...
    var_4 = level._id_13BFD.angles + ( var_1, var_2, var_3 );
    level._id_13BFD delete();
    level._id_13BFD = spawnfx( level.rpg_shoot_at_trigs, level.weapons[3].origin + ( 1, -0.66, 1.1 ) );
    level._id_13BFD.angles = var_4;
    triggerfx( level._id_13BFD );
}
...
_id_12A34()
{
    ...
    level._id_122C8 = scripts\engine\utility::getstruct( "weapRaritySmall", "targetname" );
    level._id_122C7 = scripts\engine\utility::getstruct( "weapRarityMedium", "targetname" );
    level._id_122C6 = scripts\engine\utility::getstruct( "weapRarityLarge", "targetname" );
    level._id_122C9 = scripts\engine\utility::getstruct( "weapRarityWatch", "targetname" );
    devui_bg_swap( 0 );
}
