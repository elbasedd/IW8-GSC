...
init()
{
    ...
    if ( !isdefined( level.helistoreplunder ) )
        level.helistoreplunder = 0;

    if ( !isdefined( level._id_13394 ) )
        level._id_13394 = 0;
    ...
    initanimtree();
    scripts\engine\scriptable::_id_1279F( "ascender", ::ascenderscriptableused );
}
...
intel_pieces()
{
    ...
    if ( isdefined( level.brtruck_initfeatures ) )
        self [[ level.brtruck_initfeatures ]]( "ascender_blocked_generic", 4 );
    else
    {
...
intel_spawn_listener()
{
    ...
    if ( isdefined( level.brtruck_initfeatures ) )
        self [[ level.brtruck_initfeatures ]]( "ascender_blocked_laststand", 4 );
    else
    {
...
denyascendmessage()
{
    ...
    if ( isdefined( level.brtruck_initfeatures ) )
        self [[ level.brtruck_initfeatures ]]( "ascender_blocked", 4 );
    else
    {
...
ascenddeathlistener( var_0 )
{
    ...
    var_1 = spawnstruct();
    var_1._id_11EA0 = self.guid;
    var_1.brtruck_initdialog = self.brtruck_initdialog;
    var_1.brtruck_initexternalfeatures = self.brtruck_initexternalfeatures;
    self waittill( "death_or_disconnect" );

    if ( isdefined( self ) )
        self stopanimscriptsceneevent();

    var_0.isprogressionmismatch = var_1;
...
f14_3pastcodes( var_0, var_1 )
{
    ...
    {
        var_1 thread intel_spawn_listener();
        return 0;
    }
    ...
    if ( isdefined( level.deadblue ) && isdefined( level.deadblue.name ) && getdvarint( "scr_br_alt_mode_zxp", 0 ) )
    {
        var_2 = istrue( var_1.iszombie ) && isdefined( var_1.startpayloadtanksobjective );
    ...
    if ( !var_1 scripts\common\utility::silo_door_runners() )
    {
        var_1 thread intel_pieces();
        return 0;
    }
    ...
    if ( gettime() - var_4.tag_to_shoot_from < getdvarint( "scr_ascender_min_time_between" ) )
    {
        var_1 thread intel_pieces();
        return 0;
    }

    var_5 = max( level._id_13394, 30 );
    var_6 = getdvarint( "scr_ascender_override_max_active", var_5 );

    if ( var_6 != -1 )
        var_5 = var_6;

    if ( level.helistoreplunder >= var_5 )
    {
        var_1 thread intel_pieces();
        return 0;
    }

    if ( isdefined( var_4._id_12CC1 ) && istrue( var_4._id_12CC1.inuse ) )
    {
        var_1 thread denyascendmessage();
        return 0;
    }

    if ( isdefined( var_1.footprint_mask_clipheight ) )
    {
...
ascenderuse( var_0, var_1 )
{
    ...
    var_1.brtruck_playerwelcomesplashes = var_2;
    var_1.brtruck_initdialog = var_6;
    var_1.brtruck_initexternalfeatures = var_7;
    ...
    if ( !var_2.dir )
    {
        if ( scripts\common\utility::iscp() )
            var_9 = getdvarfloat( "scr_descender_speed_cp", playerattractiontriggerenter() );
        else
            var_9 = getdvarfloat( "scr_descender_speed", playerapplyjumpvelocity() );
    }
    else
        var_9 = getdvarfloat( "scr_ascender_speed", player_weapon_fired_monitor() );

    var_10 = var_8 / var_9;
    var_11 = player_waittilljumpedfromc130() * var_10;
    var_12 = player_xp() * var_10;
...
cleanupascenduse( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0.tag_convoy_with_objectives = gettime();
        ...
        else if ( !istrue( var_0.inlaststand ) )
        {
            ...
            var_0 thread target_found_speed();

        if ( isdefined( var_0.brtruck_initdialog ) )
        {
            var_0.brtruck_initdialog unlink();
            var_0.brtruck_initdialog delete();
        }

        if ( isdefined( var_0.brtruck_initexternalfeatures ) )
        {
            var_0.brtruck_initexternalfeatures unlink();
            var_0.brtruck_initexternalfeatures delete();
        }
    }
    else if ( isdefined( self.isprogressionmismatch ) )
    {
        if ( isdefined( self.isprogressionmismatch.brtruck_initdialog ) )
        {
            self.isprogressionmismatch.brtruck_initdialog unlink();
            self.isprogressionmismatch.brtruck_initdialog delete();
        }

        if ( isdefined( self.isprogressionmismatch.brtruck_initexternalfeatures ) )
        {
            self.isprogressionmismatch.brtruck_initexternalfeatures unlink();
            self.isprogressionmismatch.brtruck_initexternalfeatures delete();
        }
    }
    ...
    if ( isdefined( self.isprogressionmismatch ) )
    {
        var_2 = self.isprogressionmismatch._id_11EA0;
        self.isprogressionmismatch = undefined;
    }

    if ( isdefined( var_0 ) )
    {
        var_0.brtruck_playerwelcomesplashes = undefined;
        var_0.brtruck_initdialog = undefined;
        var_0.brtruck_initexternalfeatures = undefined;
...
target_found_speed()
{
    level endon( "game_ended" );
    var_0 = self;
    var_0 scripts\engine\utility::_id_13AD9( "death_or_disconnect", "last_stand_finished" );
    var_0 enableoffhandweapons();
    var_0 enableweaponswitch();
    var_0 scripts\common\utility::allow_killstreaks( 1 );
    var_0 thread scripts\mp\utility\infilexfil::takegunless();
...
brtruck_cleanupents()
{
    ...
    var_1 = var_0.brtruck_playerwelcomesplashes.ascendstructout.origin;
    var_2 = var_0.brtruck_playerwelcomesplashes.ascendstructout.angles;
    var_0.brtruck_playerwelcomesplashes cleanupascenduse( var_0 );
...
spawner_recently_used( var_0 )
{
    ...
    {
        if ( distance2dsquared( var_2.origin, var_0 ) < playerbloodrestricted() )
        {
            if ( abs( var_0[2] - var_2.origin[2] ) < playerattractiontriggerexit() )
                return 1;
        }
    }
