...
init()
{
    if ( !isdefined( level.petconsts ) && !scripts\common\utility::iscp() )
        level thread calloutmarkerpingvo_getcalloutaliasstringvehicle();
    ...
    level._id_11C01 = [];
    level._id_11C01["assist"] = 1;
    level._id_11C01["longshot"] = 1;
    level._id_11C01["pointblank"] = 1;
    level._id_11C01["headshot"] = 1;
    level._id_11C01["avenger"] = 1;
    level._id_11C01["save_teammate"] = 1;
    level._id_11C01["posthumous"] = 1;
    level._id_11C01["revenge"] = 1;
    level._id_11C01["firstblood"] = 1;
    level._id_11C01["comeback"] = 1;
    level._id_11C01["backfire"] = 1;
    level._id_11C01["quad_feed"] = 1;
    level._id_11C01["first_place_kill"] = 1;
    level._id_11C01["gun_butt"] = 1;
    level._id_11C01["mode_x_wipeout"] = 1;
    level._id_11C01["grenade_double"] = 1;
}
...
initpet( var_0, var_1, var_2 )
{
    if ( !isdefined( self.petwatch ) )
    {
        ...
        self.petwatch._id_11C0C = var_1;

        if ( var_1 == "pet_black" )
            self.petwatch._id_11E18 = "petWatchDataBlack";
        else if ( var_1 == "pet_turbo" )
        {
            self.petwatch._id_11E18 = "petWatchDataTurbo";
            thread _id_135BC();
        }
        else
            self.petwatch._id_11E18 = "petWatchData";
        ...
        if ( var_0 && !istrue( var_2 ) )
        {
            ...
            setphase( self getplayerdata( "common", self.petwatch._id_11E18, "phase" ) );
    }
    else
    {
        if ( var_0 )
    ...
    self.petwatch.init_intro_obj = 0;
    ...
    else
    {
        ...
        self.petwatch.colmaps = 0;
        self.petwatch.lastupdatetime = self getplayerdata( "common", self.petwatch._id_11E18, "lastUpdateTime" );
        self.petwatch.bored = self getplayerdata( "common", self.petwatch._id_11E18, "boredDmg" );
        self.petwatch.dirty = self getplayerdata( "common", self.petwatch._id_11E18, "dirtyDmg" );
        self.petwatch.unruly = self getplayerdata( "common", self.petwatch._id_11E18, "unrulyDmg" );
        self.petwatch.hungry = self getplayerdata( "common", self.petwatch._id_11E18, "hungryDmg" );
        self.petwatch.colmaps = self getplayerdata( "common", self.petwatch._id_11E18, "bonusTime" );
        self.petwatch.charged = self getplayerdata( "common", self.petwatch._id_11E18, "charged" );
        self.petwatch.growthtime = self getplayerdata( "common", self.petwatch._id_11E18, "growthTime" );
        self.petwatch.reproductionstreak = self getplayerdata( "common", self.petwatch._id_11E18, "reproductionStreak" );
        self.petwatch.damage = self getplayerdata( "common", self.petwatch._id_11E18, "damage" );
        self.petwatch.tag_usb_with_head_icon = self.petwatch.bored;
        self.petwatch.takequesttablet = self.petwatch.dirty;
        self.petwatch.tarmac_techo_start_first = self.petwatch.unruly;
        self.petwatch.tank_death = self.petwatch.hungry;
        var_3 = self.petwatch.reproductionstreak % 10;
        var_4 = var_3 / 10;
        self.petwatch.growthtime = self.petwatch.growthtime + var_4;
        self.petwatch.colmaps = self.petwatch.colmaps + var_4;
        self.petwatch.reproductionstreak = int( self.petwatch.reproductionstreak / 10 );
        self.petwatch._id_13687 = self getplayerdata( "common", self.petwatch._id_11E18, "orcaPoints" );
        self.petwatch._id_1383C = self getplayerdata( "common", self.petwatch._id_11E18, "apachePoints" );
        self.petwatch.dragonpoints = self getplayerdata( "common", self.petwatch._id_11E18, "dragonPoints" );
        self.petwatch.collorigin1 = self getplayerdata( "common", self.petwatch._id_11E18, "killstreakCharge" );
        self.petwatch.colmodel = self getplayerdata( "common", self.petwatch._id_11E18, "winGamesCharge" );
        self.petwatch.collorigin2 = self getplayerdata( "common", self.petwatch._id_11E18, "objectiveScoreCharge" );
        self.petwatch.collisioncheck = self getplayerdata( "common", self.petwatch._id_11E18, "killsCharge" );
        self.petwatch.topkillstreakcharge = self getplayerdata( "common", self.petwatch._id_11E18, "topKillstreakCharge" );
        self.petwatch.nukecharge = self getplayerdata( "common", self.petwatch._id_11E18, "nukeCharge" );
        self.petwatch.wingamestop3 = self getplayerdata( "common", self.petwatch._id_11E18, "winGamesTop3" );
        self.petwatch.plantscharge = self getplayerdata( "common", self.petwatch._id_11E18, "plantsCharge" );
        self.petwatch.executionscharge = self getplayerdata( "common", self.petwatch._id_11E18, "executionsCharge" );
        ...
        self.petwatch.tank_deaths = 0;
        self.petwatch.tagautopickup = 0;
        self.petwatch.team_planted_bomb = 0;
        self.petwatch.takerevivepickup = 0;
    }
...
testtiming()
{
    ...
    var_7 = var_6 - 43200;
    var_8 = var_0 - 604800;
    var_9 = hoursawakesincelastupdate( var_0, var_1 ).runbrgametypefunc;
    var_10 = hoursawakesincelastupdate( var_0, var_3 ).runbrgametypefunc;
    var_11 = hoursawakesincelastupdate( var_0, var_4 ).runbrgametypefunc;
    var_12 = hoursawakesincelastupdate( var_0, var_2 ).runbrgametypefunc;
    var_13 = hoursawakesincelastupdate( var_0, var_5 ).runbrgametypefunc;
    var_14 = hoursawakesincelastupdate( var_0, var_6 ).runbrgametypefunc;
    var_15 = hoursawakesincelastupdate( var_0, var_7 ).runbrgametypefunc;
    var_16 = hoursawakesincelastupdate( var_0, var_8 ).runbrgametypefunc;
    var_17 = 1;
}

printplayerdatastats()
{
    var_0 = self getplayerdata( "common", self.petwatch._id_11E18, "phase" );
    var_1 = self getplayerdata( "common", self.petwatch._id_11E18, "lastUpdateTime" );
    var_2 = self getplayerdata( "common", self.petwatch._id_11E18, "boredDmg" );
    var_3 = self getplayerdata( "common", self.petwatch._id_11E18, "dirtyDmg" );
    var_4 = self getplayerdata( "common", self.petwatch._id_11E18, "unrulyDmg" );
    var_5 = self getplayerdata( "common", self.petwatch._id_11E18, "hungryDmg" );
    var_6 = self getplayerdata( "common", self.petwatch._id_11E18, "bonusTime" );
    var_7 = self getplayerdata( "common", self.petwatch._id_11E18, "charged" );
    var_8 = self getplayerdata( "common", self.petwatch._id_11E18, "growthTime" );
    var_9 = self getplayerdata( "common", self.petwatch._id_11E18, "reproductionStreak" );
    var_10 = self getplayerdata( "common", self.petwatch._id_11E18, "damage" );
    var_11 = self getplayerdata( "common", self.petwatch._id_11E18, "orcaPoints" );
    var_12 = self getplayerdata( "common", self.petwatch._id_11E18, "apachePoints" );
    var_13 = self getplayerdata( "common", self.petwatch._id_11E18, "dragonPoints" );
    var_14 = self getplayerdata( "common", self.petwatch._id_11E18, "killstreakCharge" );
    var_15 = self getplayerdata( "common", self.petwatch._id_11E18, "winGamesCharge" );
    var_16 = self getplayerdata( "common", self.petwatch._id_11E18, "objectiveScoreCharge" );
    var_17 = self getplayerdata( "common", self.petwatch._id_11E18, "killsCharge" );
    var_18 = self getplayerdata( "common", self.petwatch._id_11E18, "topKillstreakCharge" );
    var_19 = self getplayerdata( "common", self.petwatch._id_11E18, "nukeCharge" );
    var_20 = self getplayerdata( "common", self.petwatch._id_11E18, "winGamesTop3" );
    var_21 = self getplayerdata( "common", self.petwatch._id_11E18, "plantsCharge" );
    var_22 = self getplayerdata( "common", self.petwatch._id_11E18, "executionsCharge" );
}
...
{
    if ( isdefined( self.petwatch ) && self.petwatch._id_11C0C == "pet_turbo" )
    {
...
_id_13735()
{
    ...
    foreach ( var_2 in level.teamnamelist )
    {
        ...
        {
            if ( isdefined( var_7.petwatch ) && var_7.petwatch._id_11C0C == "pet_turbo" )
                var_7 _id_135AB( var_4, 2 );
        }
    }
}

_id_135AB( var_0, var_1 )
{
    if ( isdefined( self.petwatch ) && self.petwatch._id_11C0C == "pet_turbo" )
    {
        var_0 = min( 1.0, var_0 );
...
_id_133E4( var_0 )
{
    if ( isdefined( self.petwatch ) && self.petwatch._id_11C0C == "pet_turbo" )
    {
        if ( !isdefined( var_0.follow_players_when_close ) )
        {
            var_0.follow_players_when_close = [];
            var_0.fogenabled = [];
        }

        var_1 = -1;

        foreach ( var_4, var_3 in var_0.follow_players_when_close )
        {
            if ( var_3 == self )
            {
                var_1 = var_4;
        ...
        if ( var_1 == -1 )
        {
            var_1 = var_0.follow_players_when_close.size;
            var_0.follow_players_when_close[var_1] = self;
            var_0.fogenabled[var_1] = 1;
        }
        else
            var_0.fogenabled[var_1]++;

        _id_135AB( var_0.fogenabled[var_1] / 10, 3 );
    }
}

garbage_bin_clip()
{
    if ( isdefined( self.follow_players_when_close ) )
    {
        var_0 = 0;

        foreach ( var_4, var_2 in self.follow_players_when_close )
        {
            var_3 = isdefined( var_2.petwatch ) && var_2.petwatch._id_11C0C == "pet_turbo";

            if ( !var_3 )
                continue;

            var_0 = self.fogenabled[var_4];
...
gametypeweaponxpmodifier( var_0 )
{
    if ( isdefined( self.petwatch ) && self.petwatch._id_11C0C == "pet_turbo" )
    {
        if ( isdefined( var_0.follow_players_when_close ) )
...
addnukecharge()
{
    if ( isdefined( self.petwatch ) )
    {
        ...
        if ( self.petwatch._id_11C0C == "pet_turbo" )
            var_0 = var_0 + 100;
...
{
    if ( isdefined( self.petwatch ) && self.petwatch._id_11C0C != "pet_turbo" && ( !istrue( level._id_11C01[var_0] ) && !issubstr( var_0, "kill" ) ) )
    {
        self.petwatch.collorigin2 = self.petwatch.collorigin2 + var_1;
...
assaultkill()
{
    if ( isdefined( self.petwatch ) )
    {
        ...
        self.petwatch.collisioncheck = self.petwatch.collisioncheck + 10;
...
_id_119AC()
{
    if ( isdefined( self.petwatch ) && self.petwatch._id_11C0C == "pet_turbo" )
    {
        ...
        {
            if ( !isdefined( self.petwatch._id_120A6 ) )
                thread _id_11C02();
        }
        else if ( isdefined( self.petwatch._id_120A6 ) )
        {
            self notify( "cancel_pet_plunder_timer" );
            self.petwatch._id_120A6 = undefined;
            _id_135AB( 0, 0 );
        }
    }
}
...
_id_1250B()
{
    ...
    self.petwatch.bonustime = 0;
    self.petwatch.damage = 0;
    self.petwatch._id_13687 = 0;
    self.petwatch._id_1383C = 0;
    self.petwatch.dragonpoints = 0;
    self.petwatch.collorigin1 = 0;
    self.petwatch.killstreakcharge = 0;
    self.petwatch.colmodel = 0;
    self.petwatch.wingamescharge = 0;
    self.petwatch.collorigin2 = 0;
    self.petwatch.objectivescorecharge = 0;
    self.petwatch.collisioncheck = 0;
    self.petwatch.killscharge = 0;
...
feedaction()
{
    ...
    var_4 = self.petwatch.tank_deaths < var_3;
    var_5 = self.petwatch.takerevivepickup < var_1;
    var_6 = self.petwatch.tagautopickup < var_0;
    var_7 = self.petwatch.team_planted_bomb < var_2;
    ...
    self.petwatch.tank_deaths = var_3;
    self.petwatch.takerevivepickup = var_1;
    self.petwatch.tagautopickup = var_0;
    self.petwatch.team_planted_bomb = var_2;
    self.petwatch.topkillstreakcharge = 0;
    self.petwatch.nukecharge = 0;
    self.petwatch.wingamestop3 = 0;
    self.petwatch.plantscharge = 0;
