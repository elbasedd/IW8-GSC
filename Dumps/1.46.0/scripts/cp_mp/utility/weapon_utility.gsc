...
clearlockedon( var_0 )
{
    ...
    if ( hasincoming( var_0 ) )
    {
        if ( isdefined( var_0.searchradiusmax ) )
            var_0 thread [[ var_0.searchradiusmax ]]();
    }

    var_0.hasincoming = undefined;
    var_0.searchradiusidealmin = undefined;
    var_0.searchradiusmax = undefined;
}
...
array_convert_keys_to_ints( var_0 )
{
    ...
    {
        if ( isdefined( var_0.searchradiusidealmin ) )
            var_0 thread [[ var_0.searchradiusidealmin ]]();
    }
...
_id_12999( var_0, var_1 )
{
    var_0.searchradiusidealmin = var_1;
}

_id_1299A( var_0, var_1 )
{
    var_0.searchradiusmax = var_1;
}
...
watchtargetlockedontobyprojectile( var_0, var_1 )
{
    ...
    addlockedon( var_0 );
    array_convert_keys_to_ints( var_0 );
    var_1 scripts\engine\utility::_id_13AD9( "death", "clearTargetLockedOntoByProjectile" );
