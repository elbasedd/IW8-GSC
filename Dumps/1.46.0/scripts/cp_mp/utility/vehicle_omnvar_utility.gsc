...
{
    var_0 = spawnstruct();
    level.vehicle.zlimit = var_0;
    var_0.vehicledata = [];
}

vehomn_setvehicle( var_0, var_1 )
{
    var_2 = _id_139C2( var_0 );
    var_3 = var_2.id;
...
{
    var_4 = _id_139C2( var_0 );
    var_5 = var_4.br_pickupdenyparachuting[var_1];
    var_6 = undefined;
...
{
    var_3 = _id_139C2( var_2 );
    var_4 = var_3._id_13B54[var_0];

    if ( isdefined( var_1 ) )
    {
        var_5 = var_3._id_13B58[var_0];
...
vehomn_clearwarnings( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
            var_2 = _id_139C2( var_1, undefined, 1 );
        ...
        if ( isarray( var_0 ) )
        {
            foreach ( var_4 in var_0 )
            {
                if ( isdefined( var_4 ) && isplayer( var_4 ) )
                {
                    ...
                    if ( isdefined( var_2 ) )
                    {
                        foreach ( var_6 in var_2._id_13B55 )
                        {
                            if ( isdefined( var_6 ) )
                                thread [[ var_6 ]]( var_4 );
                        }
...
_id_139BF( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( isarray( var_0 ) )
        {
            ...
            {
                if ( isdefined( var_2 ) && isplayer( var_2 ) )
                    thread _id_139C0( var_2 );
            }
        }
        else if ( isplayer( var_0 ) )
            thread _id_139C0( var_0 );
    }
}
...
_id_139C0( var_0 )
{
    ...
    if ( !isdefined( var_0._id_139C8 ) || var_0._id_139C8 != "hide" && var_0._id_139C8 != "fadeOut" )
    {
        var_0._id_139C8 = "fadeOut";
        var_0 setclientomnvar( "ui_veh_controls", 2 );
        wait 3;
        thread _id_139C4( var_0 );
    }
}
...
_id_139BE( var_0 )
{
    return !isdefined( var_0._id_139C8 ) || var_0._id_139C8 == "fadeOut" || var_0._id_139C8 == "hide";
}

_id_139C1()
{
    return level.vehicle.zlimit;
}

_id_139C2( var_0, var_1, var_2 )
{
    var_3 = _id_139C1();
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_1 ) )
        {
            ...
            var_4.seatids = [];
            var_4.br_pickupdenyparachuting = [];
            var_4._id_12628 = [];
            var_4._id_13B54 = [];
            var_4._id_13B58 = [];
            var_4._id_13B56 = [];
            ...
            var_4._id_12629 = [];
            var_4.id = undefined;
            var_4._id_13B54["burningDown"] = 1;
            var_4._id_13B54["missileLocking"] = 2;
            var_4._id_13B54["missileIncoming"] = 4;
            var_4._id_13B54["movementDisabled"] = 3;
        }
...
_id_139BD( var_0, var_1, var_2 )
{
    var_3 = _id_139C2( var_0, var_1, var_2 );

    if ( isdefined( var_3 ) )
    {
        var_3.seatids = [];
        var_3.br_pickupdenyparachuting = [];
        var_3._id_12628 = [];
        var_3._id_13B54 = [];
        var_3._id_13B58 = [];
        var_3._id_13B56 = [];
...
vehomn_updateomnvarsonseatenter( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_8._id_13B54["movementDisabled"] ) )
            vehomn_showwarning( "movementDisabled", var_3, var_0.vehiclename );
    }

    if ( var_0 scripts\cp_mp\vehicles\vehicle_damage::_id_138AD() )
    {
        if ( isdefined( var_8._id_13B54["burningDown"] ) )
...
_id_139C6( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = spawnstruct();

    var_2 = _id_139C2( var_0.vehiclename, undefined, 1 );
        ...
        if ( isdefined( var_3 ) && var_3.size > 0 )
        {
            foreach ( var_6, var_5 in var_3 )
            {
                if ( isdefined( var_5 ) && isplayer( var_5 ) && var_5 scripts\cp_mp\utility\player_utility::_isalive() )
                    _id_13852( var_0, var_5, var_6, var_1 );
            }
        }
    }
}

_id_13852( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_2 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getoccupantseat( var_0, var_1 );

    _id_139C7( var_0, var_1, var_2, var_3 );
}
...
_id_139C7( var_0, var_1, var_2, var_3 )
{
    var_4 = _id_139C2( var_0.vehiclename );

    if ( var_4._id_12629.size > 0 && isdefined( var_4._id_12629[var_2] ) )
    {
        var_5 = 0;

        if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1392D( var_0, var_2 ) )
            var_5 = 1;
        else
        {
        ...
        if ( var_5 )
        {
            ...
            {
                var_8 = var_4._id_12629[var_2][var_0.objweapon.basename];
        ...
        var_13 = _id_139C3( var_0, var_3 );

        if ( isdefined( var_13 ) )
        {
            foreach ( var_15, var_8 in var_4._id_12629[var_2] )
            {
...
_id_139C3( var_0, var_1 )
{
    if ( isdefined( var_1 ) && isdefined( var_1.trial_dlog_race ) )
        return var_1._id_12627;
