...
spawn_overwatch_extra_atvs( var_0 )
{
    var_1 = 0;
...
_id_12356( var_0 )
{
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "challenges", "onKillStreakEnd" ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            ...
            var_3 = gettime();
            var_4 = var_3 - var_1.announcedomplatespawns;
            var_5 = var_0.kills;
            var_6 = 0;
            var_7 = 0;
            var_8 = 0;
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "dlog", "killStreakExpired" ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            var_9 = var_1._id_130DD;
            var_10 = var_1.streakname;
            var_11 = var_1.isgimme;
            var_3 = gettime();
            var_12 = self.origin;
            var_13 = istrue( var_0.maxxpcap );
...
waitforhvttrigger( var_0 )
{
    ...
    if ( isdefined( var_1 ) && _branalytics_headerplayer::skipweapondropondeath( var_1 ) || scripts\cp_mp\utility\script_utility::issharedfuncdefined( "entity", "isGondolaBrush" ) && [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "entity", "isGondolaBrush" ) ]]( var_1 ) )
    {
        var_0 playerlinkto( var_1 );
        var_0 playerlinkedoffsetenable();
        var_0.waitfornukecarriernearlz = var_1;
    }
}

waitformeleedamage( var_0 )
{
    if ( isdefined( var_0.waitfornukecarriernearlz ) )
    {
        var_0.waitfornukecarriernearlz = undefined;
        var_0 unlink();
    }
}
