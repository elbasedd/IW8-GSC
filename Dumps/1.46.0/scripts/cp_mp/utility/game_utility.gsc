...
_id_123CA()
{
    level.spawn_origin = 1;
}

spawn_origin()
{
    return istrue( level.spawn_origin );
}

_id_123BB()
{
    level.spawn_exfil_juggs = 1;
}

spawn_exfil_juggs()
{
    return istrue( level.spawn_exfil_juggs );
}

_id_123BC()
{
    level.kidnapperdebug = 1;
}

spawn_exfil_paratroopers()
{
    return istrue( level.kidnapperdebug );
}

_id_123DD( var_0 )
{
    level.spawnproplist = 1;

    if ( !isdefined( var_0 ) )
        var_0 = "default";

    level.unset_relic_punchbullets = var_0;
}

spawnproplist()
{
    return istrue( level.spawnproplist );
}
...
_id_123D0()
{
    level.watchfornewdrop = 1;
}

spawn_techo_turret_2()
{
    return istrue( level.watchfornewdrop );
}
...
playerstartbesttimeupdate( var_0, var_1 )
{
...
playerstartjailsetcontrols( var_0, var_1 )
{
    var_2 = scripts\engine\utility::getstructarray( var_0, "targetname" );
    var_3 = [];
...
startkeyearning()
{
    ...
    _id_1299F( 255 );
    var_0 = scripts\cp\utility\cp_controlled_callbacks::playergettotaltime();
...
stopkeyearning( var_0 )
{
    ...
    if ( !isdefined( self.stealth_enabled ) )
        _id_1299F( 255 );
    ...
    var_4 = scripts\cp\utility\cp_controlled_callbacks::playergettotaltime();
    var_5 = 0;
    var_6 = 0;
    ...
    var_8 = scripts\cp\utility\cp_controlled_callbacks::playerzombiepingoutofgas();
    var_9 = int( gettimesincegamestart() / 1000.0 );

    if ( self.stealth_enabled != 255 )
        scripts\cp\utility\cp_controlled_callbacks::_id_11999( self.stealth_enabled );
    ...
    if ( istrue( level.ismp ) )
        self reportchallengeuserevent( "end_match", var_4, var_1, var_5, var_6, var_7, var_8, var_9, self.stealth_enabled, var_10, var_12, var_13 );
    else
    {
        ...
        self reportchallengeuserevent( "end_match", var_4, var_1, var_5, 0, 0, var_8, var_9, self.stealth_enabled, var_10, var_12, var_13 );
    }
    ...
    foreach ( var_4 in var_2 )
    {
        if ( isdefined( var_4.model ) && var_4.model == var_0 )
        {
            if ( istrue( var_1 ) && isdefined( var_4.target ) )
                _id_124AF( var_4.target, "targetname" );
...
{
    var_0 = spawnstruct();
    level.fuel_stability_event_start = var_0;
    var_0.game_type_col = [];
