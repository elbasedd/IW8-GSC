...
callbacksoldieragentdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    {
        if ( _id_12B0F( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 ) )
            return;
    ...
    if ( var_32 )
    {
        if ( istrue( self.signal_strength ) )
        {
            var_2 = 0;
    ...
    if ( var_22 )
    {
        ...
        {
            if ( var_24 )
                var_2 = assignvehiclestoteams( var_2, var_5, var_17, var_4, var_1 );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            ...
            if ( scripts\mp\damage::armorvest_washit( var_1 ) || scripts\mp\damage::helmet_washit( var_1 ) )
                var_3 = var_3 | level.scriptable_callback;

            if ( scripts\mp\damage::armorvest_wasbroke( var_1 ) || scripts\mp\damage::helmet_wasbroke( var_1 ) )
                var_3 = var_3 | level.scriptable_autouse_funcs;

            if ( isdefined( level.zombiesdamagezombies ) )
                var_3 = var_3 | [[ level.zombiesdamagezombies ]]( var_13 );
        }
    }
    ...
    if ( var_22 || var_23 || var_30 )
    {
        if ( isdefined( var_12 ) )
        {
            ...
            atv_trail( self, var_1, var_0, var_12, var_2, var_6, var_7, var_8, var_9, var_4 );
        }
...
callbacksoldieragentgametypekilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( self.increase_hp_from_relic_mythic ) )
    {
        var_9 = spawnstruct();
        ...
        thread [[ self.increase_hp_from_relic_mythic ]]( var_9 );
    }
...
assignvehiclestoteams( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_0;
...
atv_trail( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
...
process_damage_feedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_14 ) && var_14 != var_10 && var_2 + var_11 + var_12 > 0 && ( !isdefined( var_8 ) || var_8 != "shield" ) )
    {
        ...
        if ( isdefined( var_10.nuke_vault_runner_internal ) && var_10.nuke_vault_runner_internal.size > 1 )
...
_id_12B0F( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_0 ) && ( issubstr( var_13, "thermite" ) || isdefined( var_12.magazine ) && issubstr( var_12.magazine, "boltfire" ) || isdefined( var_0.weapon_name ) && issubstr( var_0.weapon_name, "incendiary" ) ) )
    {
        ...
        if ( var_15 )
        {
            ...
            {
                self.check_player_used_tacmap = 1;
                self._id_132DD = 0;
            }
        }
        else if ( var_8 != "none" )
        {
            self.check_player_used_tacmap = undefined;
            self._id_132DD = undefined;
        }
    }
    ...
    else if ( var_8 == "none" && isdefined( var_0 ) )
    {
        ...
        if ( istrue( self.check_player_used_tacmap ) && var_14 && isdefined( var_23 ) && var_23 == self )
        {
            if ( !isdefined( self._id_132DF ) )
                self._id_132DF = [ var_0 ];
            else if ( !scripts\engine\utility::array_contains( self._id_132DF, var_0 ) )
                self._id_132DF[self._id_132DF.size] = var_0;
