...
switch_timer()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "large_transport", 1 );
    var_0.id = 5;
...
switch_structs()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "large_transport_mp", 3 );
}
...
large_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "large_transport", var_0 );
