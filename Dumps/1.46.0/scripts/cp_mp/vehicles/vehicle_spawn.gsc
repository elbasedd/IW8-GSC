...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3._id_13333 = undefined;
        var_3._id_12531 = undefined;
        var_3._id_13334 = undefined;
    }
...
vehicle_spawn_init()
{
    ...
    var_0._id_12532 = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0.allowattackfromexposednonode = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0._id_12531 = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0.allowassassinationdamage = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
_id_13969( var_0, var_1, var_2 )
{
    ...
    if ( var_4._id_12532 != 0 )
        var_5 = var_4._id_12532;
    else if ( isdefined( var_3._id_12531 ) )
        var_5 = var_3._id_12531;
    else
        var_5 = var_4._id_12531;
...
_id_1396A()
{
    ...
    if ( istrue( self.kill_drone_turret ) )
        return;
    ...
    if ( !isdefined( var_0.allow_player_skip_laststand ) )
        return;
    ...
    if ( var_1.allowattackfromexposednonode != 0 )
        var_2 = var_1.allowattackfromexposednonode;
    else if ( isdefined( var_0.allowassassinationdamage ) )
        var_2 = var_0.allowassassinationdamage;
    else
        var_2 = var_1.allowassassinationdamage;
...
{
    _id_13967();
    self.kill_drone_turret = 1;
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0.allow_player_skip_laststand ]]();
}

_id_1395F()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::_id_138A4();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::_id_138C7( "heavy", var_0 );
    }
}
