...
tac_rover_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_138ED( "tac_rover", "single", [ "driver", "fr_passenger", "bl_passenger", "br_passenger" ] );
}

_id_131BE()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "tac_rover", 1 );
    var_0.id = 3;
...
_id_131BD()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "tac_rover", 750 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "tac_rover" );
    var_0.class = "light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "tac_rover" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "tac_rover", 5 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_138C9( "tac_rover", 8, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "tac_rover", ::tac_rover_deathcallback );
}

_id_131BC()
{
    var_0 = _calloutmarkerping_isenemy::_id_13862( "tac_rover", 1 );
...
tac_rover_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "tac_rover", var_0 );
