...
vehicle_occupancy_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            var_3.vehomn_fadeoutcontrolsforclient = undefined;
            var_3.restrictions = [];
...
vehicle_occupancy_getleveldataforseat( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_2 ) )
        {
            ...
            var_4._id_12B64 = undefined;
            var_4._id_1360D = undefined;
            var_4._id_1360E = undefined;
            var_4._id_13615 = undefined;
        }
    }
...
vehicle_occupancy_deregisterinstance( var_0 )
{
    ...
    var_0._id_12147 = undefined;
    var_0.br_ammo_update_ammotype_weapons = undefined;
...
vehicle_occupancy_seatisavailable( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0.br_ammo_update_ammotype_weapons ) )
        return 0;
    ...
    if ( istrue( vehicle_occupancy_seatisavailable( var_0, var_1, var_2 ) ) )
    {
        ...
        else
        {
            ...
            if ( var_10 )
            {
                ...
                if ( istrue( var_2.shouldpickup ) )
                    var_2 notify( "br_try_armor_cancel" );

                if ( isdefined( var_9 ) )
                {
                    var_11 = _id_1392D( var_0, var_9 );
                ...
                if ( isdefined( var_1 ) )
                {
                    var_11 = _id_1392D( var_0, var_1 );

                    if ( istrue( var_11 ) && !istrue( level.isplayerbrsquadleader ) )
                    {
                        var_12 = 0;
                        var_13 = "";
                        var_14 = "";
                        ...
                        {
                            case "apc_russian":
                                var_13 = var_2._id_13984.apc;
                                var_14 = var_2._id_13984.breventflagset;
                                var_12 = 1;
                                var_15 = var_2._id_13984.brdownedbyairstriketime;
                                break;
                            case "atv":
                                var_13 = var_2._id_13984.call_in_carepackage;
                                var_15 = var_2._id_13984.callback;
                                var_16 = var_2._id_13984.callback_trigger;
                                break;
                            case "cargo_truck_mg":
                            case "cargo_truck":
                                var_13 = var_2._id_13984.findenemytype;
                                var_15 = var_2._id_13984.findeventforchosenweight;
                                break;
                            case "jeep":
                                var_13 = var_2._id_13984.start_conceal_add;
                                var_15 = var_2._id_13984.start_coop_defuse_infiltrate;
                                break;
                            case "little_bird_mg":
                            case "little_bird":
                                var_13 = var_2._id_13984.trackriotshield_tryarm;
                                var_15 = var_2._id_13984.trackriotshield_tryback;
                                var_16 = var_2._id_13984.traintracefails;
                                break;
                            case "tac_rover":
                                var_13 = var_2._id_13984._id_131BA;
                                var_15 = var_2._id_13984._id_131BB;
                                var_16 = var_2._id_13984._id_131BF;
                                break;
                            case "light_tank":
                                var_13 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_13984._id_13206, var_2._id_13984._id_13211 );
                                var_14 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_13984._id_13207, var_2._id_13984._id_13212 );
                                var_12 = 1;
                                break;
                            case "motorcycle":
                                var_13 = var_2._id_13984.vo_hangar_door;
                                var_15 = var_2._id_13984.vo_while_reviving;
                                var_16 = var_2._id_13984.wait_and_destroy;
                                break;
                            case "veh_a10fd":
                                var_13 = var_2._id_13984.bomber_death_thread;
                                var_16 = var_2._id_13984.bomber_disable_movement_for_time;
                                break;
                            case "bomber":
                                var_13 = var_2._id_13984.cleanupkeybindingsondeath;
                                var_16 = var_2._id_13984.clonedeath;
                                break;
                            default:
                                var_13 = "";
                                var_15 = "";
                        ...
                        if ( var_13 != "" && !isdefined( var_0.extracthideiconfromplayer ) )
                        {
                ...
                _start_rooftop_raid_heli::cave_initial_enemy_goto_struct_on_spawn_and_wait_till_seen( var_0, var_2, var_1, var_9 );
                scripts\cp_mp\vehicles\vehicle_dlog::_id_138DA( var_0, var_2, var_1, var_20 );
                return;
            }

            if ( isdefined( var_9 ) && !istrue( var_3.vehicledeath ) )
            {
...
_id_13930( var_0, var_1 )
{
    if ( level.teambased )
        return _id_13931( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.oic_hasspawned ) )
            var_0 _id_13916( var_0 );

        return isdefined( var_0._id_11E48 ) && var_0._id_11E48 == var_1;
    }
}

_id_1392E( var_0, var_1 )
{
    if ( level.teambased )
        return _id_1392F( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.oic_hasspawned ) )
            var_0 _id_13916( var_0 );
...
_id_13932( var_0, var_1 )
{
    if ( level.teambased )
        return _id_13933( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.oic_hasspawned ) )
            var_0 _id_13916( var_0 );

        return !isdefined( var_0._id_11E48 );
    }
}
...
_id_13923( var_0 )
{
    if ( !level.teambased )
    {
        ...
        return var_0._id_11E48;
    }

    return undefined;
}

_id_13931( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.oic_hasspawned ) )
        ...
        return isdefined( var_0._id_13262 ) && var_0._id_13262 == var_1;
    }

    return undefined;
}

_id_1392F( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.oic_hasspawned ) )
...
_id_13933( var_0, var_1 )
{
    if ( level.teambased )
    {
        ...
        return !isdefined( var_0._id_13262 );
    }
...
_id_13916( var_0 )
{
    ...
    {
        var_1 = 0;
        var_2 = var_0._id_13262;

        if ( isdefined( var_0.team ) && var_0.team != "neutral" )
        {
            var_0._id_13262 = var_0.team;
            var_0.oic_hasspawned = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            var_0._id_13262 = undefined;
            var_0.oic_hasspawned = undefined;
        }

        if ( !isdefined( var_2 ) && !isdefined( var_0._id_13262 ) )
            return 0;

        if ( isdefined( var_2 ) && isdefined( var_0._id_13262 ) && var_2 == var_0._id_13262 )
            return 0;

        _id_13922( var_0, var_2, var_0._id_13262 );
        return 1;
    }
    else
    {
        var_1 = 0;
        var_6 = var_0._id_11E48;

        if ( isdefined( var_0.originalowner ) )
        {
            var_0._id_11E48 = var_0.originalowner;
            var_0.oic_hasspawned = undefined;
            var_1 = 1;
        }
        ...
        if ( !isdefined( var_6 ) && !isdefined( var_0._id_11E48 ) )
            return 0;

        if ( isdefined( var_6 ) && isdefined( var_0._id_11E48 ) && var_6 == var_0._id_11E48 )
            return 0;

        _id_13922( var_0, var_6, var_0._id_11E48 );
        return 1;
    }
}

_id_13922( var_0, var_1, var_2 )
{
    _calloutmarkerping_iskiosk::_id_13874( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( !isdefined( var_3.oic_guns ) )
        return;

    thread [[ var_3.oic_guns ]]( var_0, var_1, var_2 );
}
...
vehicle_occupancy_init()
{
    ...
    var_0.vehicledata = [];
    var_0._id_1347D = getdvarint( "scr_transitionHideEnabled", 1 ) > 0;
...
vehicle_occupancy_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
    {
        ...
        _id_13929( var_0, var_1, var_3, var_4 );
        ...
        if ( !isdefined( var_2 ) )
        {
            ...
            if ( isdefined( var_5._id_11969 ) )
                thread _id_13928( var_3, var_5, 1 );
        }
        else
        {
            ...
            if ( isdefined( var_5._id_11969 ) )
                thread _id_13928( var_3, var_5, 0 );
        }
    }
    else
    {
        if ( isdefined( var_3 ) )
        {
            ...
            if ( isdefined( var_5._id_13615 ) )
                vehicle_occupancy_taketurret( var_3, var_0, var_5._id_13615, var_4, 1 );
...
vehicle_occupancy_exitend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_4.success )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            _id_13943( var_0, var_1, var_3, var_4 );
        }

        if ( !isdefined( var_2 ) )
            vehicle_occupancy_onexitvehicle( var_0, var_1, var_3, var_4 );

        if ( !var_0 scripts\common\vehicle_code::vehicle_is_stopped() && _id_1392D( var_0, var_1 ) )
        {
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( !isdefined( var_2 ) )
        {
            if ( isdefined( var_3._id_139BB ) )
                var_3._id_139BB = undefined;

            if ( isdefined( var_3._id_139BA ) )
                var_3._id_139BA = undefined;
        }
    }
}
...
_id_13928( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_2 ) )
    {
        var_0._id_139BB = var_1._id_11969;
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1._id_11969, undefined, 1 );
        var_0._id_139BA = gettime();
    }
    else if ( isdefined( var_0._id_139BB ) && isdefined( var_0._id_139BA ) && var_0._id_139BB != var_1._id_11969 && gettime() - var_0._id_139BA > var_3 )
    {
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1._id_11969 );
        var_0._id_139BB = var_1._id_11969;
        var_0._id_139BA = gettime();
    }
}
...
{
    _id_13942( var_0 );
    var_0 scripts\cp_mp\vehicles\vehicle_spawn::_id_13967();
    var_2 setstance( "stand" );
    var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 0 );
    thread _id_13946( var_2, var_0, var_1 );
    _start_rooftop_raid_heli::carriable_pickup_wait( var_0, var_2 );
...
vehicle_occupancy_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        ...
        if ( !istrue( var_3.playerdeath ) )
        {
            if ( istrue( var_3.playerlaststand ) )
                var_3.maxplunderextractions = "DEATH";
            else if ( !isdefined( var_3.maxplunderextractions ) )
                var_3.maxplunderextractions = "VOLUNTARY";

            var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 1 );
            thread scripts\cp_mp\vehicles\vehicle::_id_13951( var_0, var_2 );
        }
        else
            var_3.maxplunderextractions = "DEATH";

        thread _id_13927( var_2, var_3.playerdeath, var_3.playerlaststand );
    }
    else
        var_3.maxplunderextractions = "DISCONNECT";

    _id_13942( var_0 );

    if ( scripts\cp_mp\vehicles\vehicle_spawn::_id_13962() && var_0.occupants.size == 0 )
        var_0 thread scripts\cp_mp\vehicles\vehicle_spawn::_id_1396A();
    ...
    scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_exitevent( var_0, var_2, var_1, var_3.maxplunderextractions );
    _start_rooftop_raid_heli::carriable_player_death_watch( var_0, var_2, var_1 );
}
...
vehicle_occupancy_applyrestrictionstooccupant( var_0, var_1, var_2, var_3 )
{
    ...
    var_2 _calloutmarkerping_handleluinotify_added::isnokillstreakprogressweapon( "vehicle enter" );
}
...
vehicle_occupancy_removerestrictionsfromoccupant( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdeath ) )
    {
        ...
        var_2 _calloutmarkerping_handleluinotify_added::little_bird_mg_explode( "vehicle exit" );
    }
}

_id_1392B()
{
    if ( !isdefined( level.rocket_missile ) )
        level.rocket_missile = getdvarint( "scr_hideOccupantWithStack", 1 );

    return level.rocket_missile;
}
...
vehicle_occupancy_hideoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        ...
        if ( _id_1392B() )
            var_2 scripts\cp_mp\utility\player_utility::ai_hold_debug();
        else
            var_2 playerhide();
    }
}

_id_1392A( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    var_3 = var_2._id_1347E;
    var_2._id_1347E++;
    var_0 scripts\cp_mp\utility\player_utility::ai_hold_debug();
    var_2._id_1347F[var_3] = var_0;

    if ( !isdefined( var_1._id_1347F ) )
        var_1._id_1347F = [];

    var_1._id_1347F[var_3] = var_0;
    return var_3;
}

_id_13945( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3._id_1347F[var_0] ) )
        return;

    var_4 = var_3._id_1347F[var_0];

    if ( isdefined( var_1 ) && isdefined( var_1._id_1347F ) )
        var_1._id_1347F[var_0] = undefined;

    if ( isdefined( var_4 ) )
        var_4 scripts\cp_mp\utility\player_utility::ai_hold_free();
}

_id_13944( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    if ( !isdefined( var_0._id_1347F ) )
        return;

    foreach ( var_5, var_4 in var_0._id_1347F )
    {
        if ( isdefined( var_2._id_1347F[var_5] ) )
        {
            var_2._id_1347F[var_5] = undefined;
...
_id_13917()
{
    ...
    foreach ( var_3, var_2 in var_0._id_1347F )
    {
        if ( !isdefined( var_2 ) )
            var_0._id_1347F[var_3] = undefined;
    }
}
...
vehicle_occupancy_showoccupant( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) || istrue( var_4 ) )
    {
        if ( _id_1392B() )
        {
            if ( istrue( var_4 ) )
            {
                var_2 scripts\cp_mp\utility\player_utility::_id_11EB2();
                var_2 playershow();
            }
            else
                var_2 scripts\cp_mp\utility\player_utility::ai_hold_free();
        }
        else
            var_2 playershow();
    }
...
_id_13936( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139BE( var_1 ) )
        return;

    if ( 1 )
        wait 1.5;

    childthread _id_13938( var_0, var_1, var_2 );
    childthread _id_13939( var_0, var_1, var_2, 0 );
    var_3 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_2 );

    if ( isdefined( var_3._id_1360E ) )
        childthread _id_13939( var_0, var_1, var_2, 1 );

    var_4 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( isdefined( var_4.vehomn_fadeoutcontrolsforclient ) )
        childthread [[ var_4.vehomn_fadeoutcontrolsforclient ]]( var_0, var_1, var_2, "vehicle_occupancy_monitorControls" );
}

_id_13920( var_0 )
{
    scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139BF( var_0 );
    var_0 notify( "vehicle_occupancy_monitorControls" );
}

_id_13938( var_0, var_1, var_2 )
{
...
_id_13939( var_0, var_1, var_2, var_3 )
{
    var_4 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_2 );
    var_5 = var_4._id_1360D;

    if ( istrue( var_3 ) )
        var_5 = var_4._id_1360E;

    if ( var_0 _calloutmarkerping_handleluinotify_added::spawn_guys_into_truck() || var_0 _branalytics_headerplayerposrow::spawn_headicon() )
        return;

    if ( isdefined( var_5 ) )
    {
        var_6 = scripts\cp_mp\vehicles\vehicle::_id_138E2( var_0, var_5 );

        if ( isdefined( var_6 ) )
        {
            var_6 scripts\engine\utility::_id_13AD9( "turret_fire", "turret_reload" );
            _id_13920( var_1 );
        }
    }
}
...
vehicle_occupancy_raceplayerdeathdisconnect( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\engine\utility::_id_13AE9( "death", "disconnect", "last_stand_start" );
...
vehicle_occupancy_watchownerjoinedteam( var_0, var_1 )
{
    ...
    var_1 scripts\engine\utility::_id_13AD9( "joined_team", "joined_spectators" );
...
vehicle_occupancy_animateplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        ai_goal_distribution( var_4, var_5 );
        thread ai_goal_distribution_debug( 1 );
    }
    ...
    if ( istrue( var_6._id_13CF7 ) )
    {
        self.animrig._id_13CF7 = 1;
    ...
    if ( vehicle_occupancy_checkvalidanimtype( var_10, var_3 ) )
    {
        ...
        scripts\engine\utility::_id_13AD9( "death_or_disconnect", "last_stand_start" );
...
vehicle_occupancy_stopanimatingplayer()
{
    ...
    if ( istrue( self.animrig._id_13CF7 ) )
...
{
    if ( istrue( level.obj_hangar_bombs ) )
    {
...
vehicle_occupancy_findplayerexit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( istrue( var_5.maxpools ) )
        {
            var_4.exitposition = var_1.origin;
...
vehicle_occupancy_taketurret( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0 hasweapon( var_2 ) )
    {
        ...
        {
            if ( isdefined( var_5 ) )
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_138E1( var_1, var_5 );
            else
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_138E2( var_1, var_2 );
...
vehicle_occupancy_ejectalloccupants( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_5.maxplunderextractions = "INVOLUNTARY";
...
_id_13929( var_0, var_1, var_2, var_3 )
{
...
_id_13943( var_0, var_1, var_2, var_3 )
{
...
vehicle_occupancy_assignseatcorpse( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_3 )
        var_0.kill_rate_watcher = 1;
}

_id_1391A( var_0, var_1, var_2 )
{
    if ( isdefined( var_1.corpses ) && isdefined( var_1.corpses[var_2] ) )
        var_1.corpses[var_2] = undefined;

    var_0.kill_rate_watcher = undefined;
}
...
vehicle_occupancy_deleteseatcorpse( var_0, var_1, var_2 )
{
    if ( isdefined( var_0.corpses ) && isdefined( var_0.corpses[var_1] ) )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            if ( !istrue( var_3.kill_rate_watcher ) || !var_2 )
            {
...
_id_13915( var_0 )
{
    ...
    if ( isdefined( var_0._id_12147 ) && var_0._id_12147 > 0 )
        return 0;
...
vehicle_occupancy_killoccupants( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isdefined( var_6 ) && var_6 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            {
                if ( isdefined( var_6.juggcontext.juggconfig._id_1397F ) && var_6.health > var_6.juggcontext.juggconfig._id_1397F )
                    var_8 = 1;
            }
            ...
            if ( !istrue( var_8 ) )
            {
                ...
                if ( isdefined( level._id_1399E ) )
                    var_6 thread [[ level._id_1399E ]]();
            }
