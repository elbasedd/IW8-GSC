...
total_successful_vehicle_spawns()
{
    var_0 = _calloutmarkerping_isenemy::_id_13862( "light_tank", 1 );
    var_0.calculate_zone_node_extents = 2.5;
    var_0.init_relic_steelballs = 0.625;
    var_0.hudkothbesttimelabel = 350;
    var_0.hudkothtimer = 525;
    var_0.hudkothbesttime = 875;
    var_0.humanpowersenabled = 1.25;
    var_0.humanspawninair = 5;
    var_0.hudzombie = 10;
...
light_tank_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_138ED( "light_tank", "single", [ "driver", "gunner" ] );
}

totalcashongroundatstart()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.br_pickupdenyparachuting["turret"] = 0;
    var_0.br_pickupdenyparachuting["missile"] = 1;
    var_0.br_pickupdenyparachuting["smoke"] = 2;
    var_0._id_12628[0] = 0;
    var_0._id_12628[1] = 1;
    var_0._id_12629["driver"]["lighttank_mp"] = 0;
    var_0._id_12629["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_12629["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0._id_12629["gunner"]["tur_bradley_mp"] = 0;
    var_0._id_12629["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0._id_12629["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0._id_12629["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

totalapacheresponses()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "light_tank", 15 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C6( "light_tank", ::light_tank_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C5( "light_tank", ::light_tank_postmoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    var_2.spawn_loot_pickups = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::_id_13955( var_2, var_3, getcompleteweaponname( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::_id_13955( var_2, var_3, getcompleteweaponname( "tur_gun_lighttank_mp" ) );
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "light_tank", var_0 );
    var_2.objweapon = getcompleteweaponname( "lighttank_mp" );
    var_2 light_tank_updateheadicon();
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::_id_1389E( var_2, 1 );
    var_4.is_correct_wire_color_sync = "none";
    ...
    var_2 thread totalcollecteditems();
    var_2 thread totaldamage();
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_138E2( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.maxxpcap = 1;

        if ( !istrue( self._id_12353 ) )
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        if ( totalroundtime( self.spawndata ) )
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::_id_138E3( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::_id_138E3( self.vehicle );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_138E2( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::_id_13AE1( "turret_fire", "turret_reload" );
...
totalcollecteditems()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getseatoccupant( self, "driver" );
        var_1 thread totalweaponxpearned( var_2 );
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_138E2( self, "tur_bradley_mp" );
...
totaltrainlootcrates()
{
    ...
    for (;;)
    {
        var_0 = total_puddle_count();
        self notifyonplayercommand( "light_tank_missile", var_0 );
        var_1 = scripts\engine\utility::_id_13AE8( "input_type_changed", "missile_handling_ended" );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_138E2( self, "tur_bradley_mp" );
    ...
    if ( istrue( self.spawn_loot_pickups ) )
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_138E2( self, "tur_gun_lighttank_mp" );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_3 thread totaltrainlootcrates();
...
total_killed( var_0 )
{
    ...
    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::total_spawns );
}
...
total_spawns( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
totalstructs( var_0 )
{
    ...
    self._id_12353 = 1;
    self.owner scripts\cp_mp\utility\killstreak_utility::_id_12356( var_0 );
}
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.spawnprojectile = canweapondealcriticaldamage( var_0 );
...
{
    if ( istrue( var_0.spawnprojectile ) )
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::_id_12995( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::_id_12994( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::_id_12995( self.headicon, var_0 );
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::_id_138E3( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread totalstructs( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_138E3( var_0 );
