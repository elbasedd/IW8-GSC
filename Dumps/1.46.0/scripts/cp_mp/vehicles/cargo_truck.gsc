...
cargo_truck_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_138ED( "cargo_truck", "single", [ "driver" ] );
}

findloadoutperks()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "cargo_truck", 1 );
    var_0.id = 8;
...
findgunsmithattachments()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "cargo_truck", 3500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cargo_truck" );
    var_0.class = "heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "cargo_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "cargo_truck", 20 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "cargo_truck", ::cargo_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "cargo_truck_mp", 5 );
}

findfirstaliveplayer()
{
    var_0 = _calloutmarkerping_isenemy::_id_13862( "cargo_truck", 1 );
...
cargo_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "cargo_truck", var_0 );
