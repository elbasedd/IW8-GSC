...
little_bird_init()
{
    level.teamrevivecost = getdvarfloat( "scr_little_bird_dmg_factor_fuselage", 1.0 );
    level.teamspawnfunc = getdvarfloat( "scr_little_bird_dmg_factor_tail_stabilizer", 1.0 );
    level.teamreviveperkdiscount = getdvarfloat( "scr_little_bird_dmg_factor_main_rotor", 1.2 );
    level.teamsassigned = getdvarfloat( "scr_little_bird_dmg_factor_tail_rotor", 1.0 );
    level.teamrevivefiresalediscount = getdvarfloat( "scr_little_bird_dmg_factor_landing_gear", 0.5 );
    level.teamrefundplunder = getdvarfloat( "scr_little_bird_dmg_factor_driverless_collision", 3.0 );
    level.teamwipedobituary = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_high", 0.9 );
    level.teamvehicles = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_mid", 0.9 );
    level.teamuseonly = getdvarfloat( "scr_little_bird_impulse_dmg_threshold_low", 0.1 );
    level.teamsplashbr = getdvarfloat( "scr_little_bird_impulse_dmg_factor_low", 0.1 );
    level.teamswithcirclepeek = getdvarfloat( "scr_little_bird_impulse_dmg_factor_mid_low", 0.2 );
    level.teamstarttime = getdvarfloat( "scr_little_bird_impulse_dmg_factor_mid_high", 0.75 );
    level.tell_player_to_pick_up_intel = getdvarfloat( "scr_little_bird_dmg_pitch_roll_threshold", 55.0 );
    level.teleportplayertoselection = getdvarfloat( "scr_little_bird_dmg_pitch_roll_factor", 10.0 );
    level.temp_debug_wait_and_stop_music_loop = getdvarfloat( "scr_little_bird_wood_surf_dmg_scalar", 0.6 );
...
little_bird_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_138ED( "little_bird", "single", [ "pilot", "fl_platform", "fr_platform", "bl_platform", "br_platform" ] );
}

trackriotshield_updateoffhandstowignorec4()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "little_bird", 1 );
...
trackriotshield_tryreset()
{
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "little_bird", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "little_bird" );
    var_1.class = "medium_heavy";
    var_2 = scripts\cp_mp\vehicles\vehicle_damage::_id_1389F( "little_bird", "heavy" );
    var_2._id_1196A = ::trainent;
    var_2._id_1196F = ::trainmove;
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "little_bird" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "little_bird", 12 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "little_bird", ::little_bird_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "little_bird_mp", 5 );
}

trackriotshield_trydetach()
{
    var_0 = _calloutmarkerping_isenemy::_id_13862( "little_bird", 1 );
    var_0.calculate_zone_node_extents = 1.5;
    var_0.init_relic_steelballs = 0.875;
    var_0.hudkothbesttimelabel = 350;
    var_0.hudkothtimer = 525;
    var_0.hudkothbesttime = 875;
    var_0.humanpowersenabled = 8.75;
    var_0.humanspawninair = 35;
    var_0.hudzombie = 70;
...
little_bird_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "little_bird", var_0 );
...
getrandompointinsafecirclenearby()
{
    ...
    for (;;)
    {
        ...
        {
            case 0:
                var_9 = level.teamrevivecost;
                break;
            case 1:
                var_9 = level.teamspawnfunc;
                break;
            case 2:
                var_9 = level.teamreviveperkdiscount;
                break;
            case 3:
                var_9 = level.teamsassigned;
                break;
            case 4:
                var_9 = level.teamrevivefiresalediscount;
                break;
        }
        ...
        if ( !isdefined( var_11 ) )
            var_10 = var_10 * level.teamrefundplunder;
        ...
        if ( abs( var_12 > level.tell_player_to_pick_up_intel ) )
            var_10 = var_10 * level.teleportplayertoselection;
        ...
        if ( abs( var_13 > level.tell_player_to_pick_up_intel ) )
            var_10 = var_10 * level.teleportplayertoselection;

        var_14 = 0;

        if ( var_10 > level.teamwipedobituary )
            var_14 = self.maxhealth;
        else if ( var_10 > level.teamvehicles )
        {
            var_15 = level.teamwipedobituary - level.teamvehicles;
            var_16 = ( var_10 - level.teamvehicles ) / var_15;
            var_17 = self.maxhealth * level.teamswithcirclepeek;
            var_18 = self.maxhealth * level.teamstarttime;
            var_14 = scripts\engine\math::lerp( var_17, var_18, var_16 );
        }
        else if ( var_10 > level.teamuseonly )
            var_14 = self.maxhealth * level.teamsplashbr;

        if ( var_14 > 0 )
        {
            if ( isdefined( var_11 ) && var_3 == 11534336 )
                var_14 = var_14 * level.temp_debug_wait_and_stop_music_loop;
...
_id_138E4( var_0 )
{
    ...
    scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_setammo( "little_bird", "flares", scripts\engine\utility::ter_op( self.nocrash, 1, 0 ), var_0 );
