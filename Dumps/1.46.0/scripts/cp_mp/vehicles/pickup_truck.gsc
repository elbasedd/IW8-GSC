...
_id_11C4B()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "pickup_truck", 1 );
    var_0.id = 7;
...
_id_11C4A()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "pickup_truck_mp", 3 );
}
...
pickup_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "pickup_truck", var_0 );
