...
rpggetclosetoapc()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "hoopty", 1 );
    var_0.id = 9;
...
rpgafterspawnfunc()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "hoopty", var_0 );
