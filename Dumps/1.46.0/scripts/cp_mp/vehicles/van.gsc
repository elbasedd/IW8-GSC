...
_id_13841()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "van", 1 );
    var_0.id = 13;
...
_id_13840()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "van", ::van_deathcallback );
}
...
van_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "van", var_0 );
