...
apc_rus_init()
{
    ...
    var_0._id_13742 = ::brevent1playerthink;
...
apc_rus_initoccupancy()
{
    ...
    var_4._id_1360D = getcompleteweaponname( "tur_apc_rus_mp" );
...
apc_rus_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_138ED( "apc_russian", "single", [ "driver", "front_right", "back_right", "back", "back_left", "front_left" ] );
}

breakarmor()
{
    var_0 = _calloutmarkerping_isenemy::_id_13862( "apc_russian", 1 );
    var_0.calculate_zone_node_extents = 2.33333;
    var_0.init_relic_steelballs = 0.66666;
    var_0.hudkothbesttimelabel = 350;
    var_0.hudkothtimer = 525;
    var_0.hudkothbesttime = 875;
    var_0.humanpowersenabled = 2.5;
    var_0.humanspawninair = 10;
    var_0.hudzombie = 20;
...
breakerstate()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "apc_russian", 1 );
    var_0.id = 15;
    ...
    var_0.br_pickupdenyparachuting["driverTurret"] = 0;
    var_0._id_12628["chassis"] = 0;
    var_0._id_12628["turret"] = 1;
    var_0._id_12629["driver"]["apc_rus_mp"] = "chassis";
    var_0._id_12629["driver"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12629["front_left"]["apc_rus_mp"] = "chassis";
    var_0._id_12629["front_left"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12629["front_right"]["apc_rus_mp"] = "chassis";
    var_0._id_12629["front_right"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12629["back_right"]["apc_rus_mp"] = "chassis";
    var_0._id_12629["back_right"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12629["back_left"]["apc_rus_mp"] = "chassis";
    var_0._id_12629["back_left"]["tur_apc_rus_mp"] = "turret";
    var_0._id_12629["back"]["apc_rus_mp"] = "chassis";
    var_0._id_12629["back"]["tur_apc_rus_mp"] = "turret";
}

breaker()
{
    var_0 = getdvarint( "scr_gw_apc_health_override", 4000 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "apc_russian", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "apc_russian" );
    var_1.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "apc_russian" );
    var_2 = getdvarint( "scr_gw_apc_hits_override", 18 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "apc_russian", var_2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C6( "apc_russian", ::apc_rus_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C5( "apc_russian", ::brevent1 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "apc_russian", ::apc_rus_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "tur_apc_rus_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "apc_rus_mp", 5 );
}
...
apc_rus_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_13955( var_2, var_3, getcompleteweaponname( "tur_apc_rus_mp" ), 1 );
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "apc_russian", var_0 );
    ...
    var_4.is_area_in_verdansk = "kill_apc_rus";
    var_4.is_ascender_use_allowed = 1;
...
apc_rus_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < var_8 )
        var_0.spawnprojectile = break_window_glass( var_0 );
...
apc_rus_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_138E2( var_0, "tur_apc_rus_mp" );
    ...
    if ( var_1 == "driver" )
        var_0 thread brenableagents( var_3 );
}
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_138E2( self, "tur_apc_rus_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 14;
    brevent1playervalid();
...
breakable_gate_clip()
{
    ...
    wait 2.7;
    breadcrumb_update_func( 14 );
    wait 0.15;
    var_0 turretfireenable();
}

brenableagents( var_0 )
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_138E2( self, "tur_apc_rus_mp" );
