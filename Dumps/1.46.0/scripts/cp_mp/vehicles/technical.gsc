...
technical_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_138ED( "technical", "single", [ "driver", "fl_rear", "fr_rear", "bl_rear", "br_rear" ] );
}

_id_1328B()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "technical", 1 );
    var_0.id = 0;
...
_id_13289()
{
    var_0 = _calloutmarkerping_isenemy::_id_13862( "technical", 1 );
    var_0.calculate_zone_node_extents = 1.16666;
    var_0.init_relic_steelballs = 0.95833;
    var_0.hudkothbesttimelabel = 350;
    var_0.hudkothtimer = 525;
    var_0.hudkothbesttime = 875;
    var_0.humanpowersenabled = 11.25;
    var_0.humanspawninair = 45;
    var_0.hudzombie = 90;
...
_id_1328A()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "technical", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "technical" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "technical" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "technical", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "technical", ::technical_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "technical_mp", 3 );
}
...
technical_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "technical", var_0 );
...
technical_enterstart( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.track_is_operational ) )
        var_3.track_is_operational hide();
}
...
technical_exitendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.track_is_operational ) )
        var_3.track_is_operational show();
