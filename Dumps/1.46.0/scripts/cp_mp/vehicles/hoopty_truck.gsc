...
run_and_stop_group_after()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "hoopty_truck", 1 );
    var_0.id = 12;
...
rpgs()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "hoopty_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty_truck" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "hoopty_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "hoopty_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "hoopty_truck", ::hoopty_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "hoopty_truck_mp", 3 );
}
...
hoopty_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "hoopty_truck", var_0 );
