...
usedropspawn()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "medium_transport", 1 );
    var_0.id = 11;
...
usedpropsindex()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "med_transport_mp", 3 );
}
...
med_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "medium_transport", var_0 );
