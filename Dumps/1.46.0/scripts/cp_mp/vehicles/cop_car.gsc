...
grenadeboxes_init()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_139C2( "cop_car", 1 );
    var_0.id = 6;
...
grenadebox_think()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_138BC( "cop_car", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cop_car" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_13890( "cop_car" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C8( "cop_car", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "cop_car", ::cop_car_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_138CB( "cop_car_mp", 3 );
}
...
cop_car_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_1388B( var_2, "cop_car", var_0 );
