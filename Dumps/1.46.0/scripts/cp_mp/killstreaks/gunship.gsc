...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread rear_spotlight_target_found_dist_sq( var_0 );
    var_9 thread rear_spotlight_turret_info( var_0, "disconnect" );
    var_9 thread rear_spotlight_turret_info( var_0, "joined_team" );
    var_9 thread rear_spotlight_turret_info( var_0, "joined_spectators" );
    var_9 thread rear_spotlight_turret_info( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        ...
        else if ( isdefined( level.rear_spotlight_speed ) )
            level.gunship.origin = level.rear_spotlight_speed;
        else
    ...
    level.gunship_intromodel thread rear_spotlight_target_found_speed( "disconnect", var_1 );
    level.gunship_intromodel thread rear_spotlight_target_found_speed( "joined_team", var_1 );
    level.gunship_intromodel thread rear_spotlight_target_found_speed( "joined_spectators", var_1 );
    waitframe();
...
rear_spotlight_target_found_speed( var_0, var_1 )
{
    self endon( "death" );
    ...
    rear_spotlight_origin_offset( var_2, var_1 );
}

rear_spotlight_origin_offset( var_0, var_1 )
{
    var_2 = 0;
...
rear_spotlight_target_found_dist_sq( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "crashing" );
...
rear_spotlight_turret_info( var_0, var_1 )
{
    self endon( "death" );
    self endon( "crashing" );
    self endon( "leaving" );
