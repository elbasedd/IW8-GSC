...
startchoppergunnerintro( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\killstreak_utility::playerspawn();
    var_4 = ( 0, 0, 0 );
    ...
    else if ( istrue( var_0.semtex_used ) && level.script == "cp_so_aniyah" )
    {
        ...
        while ( level.wp_playimpactsound.size == 0 )
            waitframe();

        var_20 = scripts\engine\utility::getclosest( var_19, level.wp_playimpactsound );
    ...
    if ( istrue( var_0.semtex_used ) && level.script == "cp_so_aniyah" )
    ...
    var_24.semtex_used = istrue( var_0.semtex_used );
    var_24 setvehicleteam( var_24.team );
    var_24 thread get_player_munition_currency( "disconnect", var_1 );
    var_24 thread get_player_munition_currency( "joined_team", var_1 );
    var_24 thread get_player_munition_currency( "joined_spectator", var_1 );
    var_27 = 2000;
    ...
    var_29 = var_24 get_player_enemy( 4.25 );
...
get_player_munition_currency( var_0, var_1 )
{
    var_2 = self.owner;
    self endon( "death" );
...
choppergunner_startremotecontrol( var_0 )
{
    ...
    thread get_player_planting_zone( "disconnect" );
    thread get_player_planting_zone( "joined_team" );
    thread get_player_planting_zone( "joined_spectator" );
    thread get_player_planting_zone( "team_kill_punish" );
...
choppergunner_updatetargetmarkergroups( var_0 )
{
    ...
    if ( istrue( level.isplayerusingtablet ) )
        return;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_13ADA( "leaving", "death", "explode" );
...
choppergunner_watchendstrobefx( var_0 )
{
    self endon( "death" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_13AD9( "death", "leaving" );
    self delete();
}
...
choppergunner_handlemissilefire( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self.semtex_used && self.missilesleft == 8 )
            childthread get_player_drone();
        ...
        var_17 thread get_player_info_proc( self.owner, 2, 300, 300 );
...
choppergunner_watchturretfire( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.streakinfo.shots_fired++;
        var_1 thread get_player_info_proc( self.owner, 0.5, 256, 200 );
    }
}
...
choppergunner_returnplayer( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            level thread scripts\cp_mp\utility\killstreak_utility::_id_12551( var_2 );
            var_2 setclientomnvar( "ui_apache_screens_state", 0 );
            var_2 painvisionon();
            var_2 scripts\cp_mp\utility\killstreak_utility::killstreak_restorenvgstate();
...
{
    thread scripts\cp_mp\emp_debuff::_id_11D0E( self.owner, 5 );
    choppergunner_updatetargetmarkergroups();
}
...
get_player_info_proc( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
