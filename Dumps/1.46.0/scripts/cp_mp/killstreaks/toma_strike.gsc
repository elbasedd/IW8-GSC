...
tryusetomastrikefromstruct( var_0 )
{
    ...
    else if ( var_1 == 5 && isdefined( self.survivorsupertwo ) )
    {
...
_id_13383( var_0, var_1, var_2 )
{
    ...
    var_2.owner = var_3;
    var_2._id_1323C = var_0;
    var_2._id_11AC9 = anglestoforward( var_1 );
    var_2._id_12BF4 = 1;
...
{
    var_2 = scripts\cp_mp\utility\killstreak_utility::playerspawn();
    var_3 = ( 0, 0, 0 );
...
tomastrike_watchowner()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_13ADA( "disconnect", "joined_team", "joined_spectators" );
    self notify( "death" );
}
...
tomastrike_watchcameraswitch( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_6 = scripts\engine\utility::_id_13AE1( "switch_camera_left", "switch_camera_right" );
...
tomastrike_getownerlookat( var_0 )
{
    ...
    var_5 = var_0 scripts\cp_mp\utility\killstreak_utility::_id_11EDA();
...
tomastrike_attacktarget( var_0, var_1, var_2, var_3 )
{
    ...
    else
    {
        ...
        if ( !istrue( var_3.startusingbomb ) )
    ...
    {
        if ( var_0 == 5 && isdefined( var_3._id_1323C ) )
            var_6 = var_3._id_1323C;
        else
            var_6 = tomastrike_getownerlookat( self );

        if ( !istrue( var_3.watchforjuggernautgameend ) )
        {
            ...
            var_7 = scripts\cp_mp\utility\script_utility::_id_13838( "game", "isGameTypeBR", 0 );
    ...
    if ( var_0 == 5 )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
        {
            ...
            var_10._id_13244 = var_6;
            self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "br", "challengeEvaluator" ) ]]( "br_mastery_pointBlank_tomahawk", var_10 );
        }

        var_8 = 6;

        if ( isdefined( var_3.weapon_xp_iw8_sn_sbeta ) )
            var_8 = var_3.weapon_xp_iw8_sn_sbeta;

        var_9 = 900;

        if ( isdefined( var_3.radiusoverride ) )
            var_9 = var_3.radiusoverride;

        var_11 = var_9;

        if ( isdefined( var_3.notifyradiusoverride ) )
            var_11 = var_3.notifyradiusoverride;

        if ( !istrue( var_3._id_12BE3 ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "dangerNotifyPlayersInRange" ) )
    ...
    else if ( var_0 == 1 || var_0 == 3 || var_0 == 4 || var_0 == 5 )
    {
        ...
        if ( isdefined( var_3._id_11AC9 ) )
            var_15 = var_3._id_11AC9;
        else
...
findunobstructedfiringinfo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        ...
        var_7 = _id_1337E( var_0, var_2, var_3, var_4 );

    var_8 = vectornormalize( var_0 - ( var_7[0], var_7[1], 0 ) );
    var_9 = _id_1337F( var_0, var_1, var_8 );
    ...
    var_6.losqueuelowindex = var_9.losqueuelowindex;
    var_6.lossendgame = var_9.lossendgame;
...
delayscriptablechangethread( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    self.owner scripts\engine\utility::_id_13AED( var_0, "stop_marker_guide" );
...
_id_1337F( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level._id_1337C ) )
        var_9 = level._id_1337C;
    ...
    if ( isdefined( var_12["entity"] ) )
    {
        ...
        var_10.losqueuelowindex = var_13;

        if ( _id_13381( var_13 ) || _id_13380( var_13 ) )
            var_10.lossendgame = "flying";
    }
...
tomastrike_firestrike( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1._id_11AC4 ) )
        var_5 = var_1._id_11AC4;
    else
    ...
    var_4 thread _id_1337D();
    var_4 thread toma_strike_watch_airexplosion( var_0.preexplpos, var_0.losqueuelowindex, var_0.lossendgame );
...
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_13AED( 10, "death" );
...
toma_strike_missile_explode( var_0 )
{
    ...
    if ( isdefined( level._id_1337A ) )
        self [[ level._id_1337A ]]();
...
toma_strike_create_explosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5._id_11AC3 ) )
        var_7 = var_5._id_11AC3;
    else
...
_id_1337E( var_0, var_1, var_2, var_3 )
{
