...
initconfig()
{
    ...
    if ( isdefined( level.array_sort_by_script_index ) )
        var_1 [[ level.array_sort_by_script_index ]]();
}
...
watchmarkeractivate( var_0 )
{
    ...
    else
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "juggernaut", "dropCrateFromScriptedHeli" ) && level.gametype != "br" )
        {
            ...
            var_2 thread scripts\cp_mp\killstreaks\airdrop::bomb_detonator_bomb_type( var_0, "airdrop" );
        ...
        {
            var_5 = 1;
            var_2 thread scripts\cp_mp\killstreaks\airdrop::_id_12E4E( var_3, var_5 );
        }
    }
}
...
activatejugg( var_0 )
{
    ...
    thread _id_13BE3( var_0 );
    thread watchforjuggernautend( var_0 );
    thread _id_13BE2( var_0 );
    ...
    else
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            if ( level.teambased )
                ...
                scripts\mp\objidpoolmanager::_id_1371D( var_3, self );
        }
    }
}
...
watchjuggernautweaponswitch( var_0 )
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_13AD9( "manual_switch_from_minigun", "weapon_pickup" );
