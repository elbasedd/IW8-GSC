...
link_player_to_rig_laser_panel()
{
    self.owner endon( "disconnect" );
    self endon( "death" );
...
empdrone_explodeemp()
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_9 = scripts\cp_mp\vehicles\vehicle_occupancy::_id_1392C( var_5 );
...
empdrone_applyemp( var_0 )
{
    ...
    if ( isplayer( var_0.victim ) )
    {
        ...
        if ( isdefined( var_0.attacker ) )
            var_0.attacker scripts\cp\utility\cp_controlled_callbacks::_id_11967( var_0.victim );
    }
