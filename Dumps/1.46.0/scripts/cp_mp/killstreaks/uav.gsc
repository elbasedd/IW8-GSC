...
init()
{
    ...
    level._id_13660 = getuavstrengthmin();
    level._id_1365B = getuavstrengthmax();
    level._id_1365C = getuavstrengthlevelshowenemydirectional();
    level._id_1365E = getuavstrengthlevelneutral();
    level._id_1365D = getuavstrengthlevelshowenemyfastsweep();

    if ( !isdefined( level._id_1365F ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "squadAsTeamEnabled" ) )
        level._id_1365F = level [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "squadAsTeamEnabled" ) ]]() && getdvarint( "scr_uav_for_squad_only", 1 );

    if ( level.teambased && !istrue( level._id_1365F ) )
    {
...
onplayerconnect()
{
    ...
    var_1 = level.teambased && istrue( level._id_1365F );
...
tryuseuavfromstruct( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::useww2killstreakcallindevice() )
    ...
    var_3 = useuav( var_0.streakname, var_0 );
    return istrue( var_3 );
}
...
useuav( var_0, var_1 )
{
    ...
    scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_call_in_uav_for_operator_mission", 1 );
    scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_call_in_uav_for_operator_mission_op2", 1 );

    if ( getdvarint( "LRTSSKLKPK", 1 ) >= 8 )
        scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_call_in_uav_for_operator_mission_op3", 1 );
        ...
        case "directional_uav":
            ...
            if ( level.teambased )
            {
                foreach ( var_7 in level.players )
                {
                    ...
                    {
                        if ( istrue( level._id_1365F ) && var_7.squadindex != var_3 )
                            continue;
...
shouldreplacestandarduavwithdirectionaluav( var_0 )
{
    if ( level.gametype != "br" )
        return 0;
...
launchuav( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_0 shouldreplacestandarduavwithdirectionaluav( var_1 ) )
    ...
    if ( level.gametype == "br" )
        var_0 _id_13657( var_4, 15000, var_13 );
    ...
    if ( isdefined( var_7 ) && var_7.damagetaken < var_7.maxhealth )
    {
        ...
        {
            var_7 unlink();
            var_7.introcinematic = var_7.origin + anglestoforward( var_7.angles ) * 50000;
            var_7 moveto( var_7.introcinematic, 50 );
        ...
        if ( isdefined( var_7 ) && var_7.damagetaken < var_7.maxhealth )
        {
            ...
            if ( isent( var_7 ) )
                var_7 moveto( var_7.introcinematic, 15 );
    ...
    if ( isdefined( var_7 ) )
    {
        ...
        var_7.streakinfo.maxxpcap = !istrue( var_7.leftplayspace );

        if ( !istrue( self._id_12353 ) )
            var_7.owner scripts\cp_mp\utility\killstreak_utility::_id_12356( var_7.streakinfo );
    ...
    if ( var_1 == "directional_uav" )
    {
        ...
        if ( level.teambased )
        {
            foreach ( var_35 in level.players )
            {
                ...
                {
                    if ( istrue( level._id_1365F ) && var_35.squadindex != var_5 )
                        continue;
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_13AD9( "disconnect", "joined_team" );
        ...
        if ( level.teambased )
        {
            foreach ( var_1 in level.teamnamelist )
            {
                if ( istrue( level._id_1365F ) )
                {
                    ...
                    {
                        var_4 = var_1 + var_6;
                        var_5 = addvehicularmanslaughtercharge( var_4 );
                        aigroundturret_cancel( var_1, var_6, var_5 );
                    }

                    continue;
                }

                var_5 = addwatch2v2topscore( var_1 );
...
updateteamuavstatus( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
        ...
        var_2 = addwatch2v2topscore( var_0 );

    _id_13756( var_2, var_0 );
}
...
_id_1378F( var_0, var_1, var_2 )
{
    ...
    {
        var_4 = var_0 + var_1;
        var_3 = addvehicularmanslaughtercharge( var_4 );
    }

    _id_13756( var_3, var_0, var_1 );
}

_id_13756( var_0, var_1, var_2 )
{
    var_0 = int( max( min( var_0, level._id_1365B ), level._id_13660 ) );
    var_3 = var_0 == level._id_13660;
    var_4 = !var_3;
    var_5 = var_0 >= level._id_1365C;
    var_6 = !var_3;

    if ( var_0 == level._id_1365E )
    {
        var_7 = "normal_radar";
        var_4 = 0;
    }
    else if ( var_0 == level._id_1365B || var_5 )
        var_7 = "constant_radar";
    else if ( var_0 == level._id_1365D )
        var_7 = "fast_radar";
    else
        var_7 = "normal_radar";
    ...
    foreach ( var_10 in var_8 )
    {
        ...
        if ( istrue( var_10.shouldrecorddamagestats ) )
            continue;

        if ( istrue( var_10._id_12BFF ) )
            continue;
...
updateplayersuavstatus()
{
    foreach ( var_1 in level.players )
    {
        if ( istrue( var_1.shouldrecorddamagestats ) )
            continue;
        ...
        if ( var_3 > 0 )
            var_2 = level._id_13660;

        var_2 = int( max( min( var_2, level._id_1365B ), level._id_13660 ) );
        var_1.radarstrength = var_2;
        var_4 = var_1.team == "spectator" || var_1.team == "follower" || var_1.team == "free";

        if ( var_2 <= level._id_1365E || var_4 )
        {
            var_1.hasradar = 0;
        ...
        if ( var_2 >= level._id_1365D )
            var_1.radarmode = "fast_radar";
        else
            var_1.radarmode = "normal_radar";

        var_1.radarshowenemydirection = var_2 >= level._id_1365C;
...
watchhighlightfadetime( var_0, var_1, var_2, var_3 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_13AF3( var_2, "leave" );
        ...
        if ( istrue( level._id_1365F ) )
        {
            ...
            foreach ( var_8 in level.teamnamelist )
            {
                foreach ( var_12, var_10 in level.squaddata[var_8] )
                {
                    ...
                    var_6++;
                    aigroundturret_cancel( var_8, var_12, var_2 );
                }
            }

            level.apc_rus_initomnvars = var_6;
        }
        else
        {
