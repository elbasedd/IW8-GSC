...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].update2v2progress = 1;
    level.helperdronesettings["radar_drone_recon"].update_ai_array = 1;
    level.helperdronesettings["radar_drone_recon"].update_health_bar_to_player = 3062500;
    level.helperdronesettings["radar_drone_recon"].update_health_bar_to_players = 6250000;
    ...
    level.helperdronesettings["assault_drone"].primarymodefunc = ::_id_12961;
    ...
    level.helperdronesettings["assault_drone"].update2v2progress = 0;
    level.helperdronesettings["assault_drone"].update_ai_array = 0;
    level.helperdronesettings["assault_drone"].update_health_bar_to_player = 73984;
    level.helperdronesettings["assault_drone"].update_health_bar_to_players = 73984;
    level.helperdronesettings["assault_drone"].is_main_pilot = 1;
    level.helperdronesettings["assault_drone"].is_lower = undefined;
    level.helperdronesettings["assault_drone"].is_minimap_forcedisabled = 1;
    level.helperdronesettings["assault_drone"]._id_11A9A = undefined;
    var_0 = "br";
    ...
    level.buildweapon_blueprint = getdvarfloat( "scr_assault_drone_enemy_notify_dist", 3000.0 );
    level.buildspecialdaypickupweapon = getdvarint( "scr_assault_drone_freeze_debug", 0 );
    level.last_saydefuse_time = getdvarint( "scr_drone_freeze_switch_debug", 1 );
}
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    var_5 = self.select_bunker_courtyard_spawners;
    self.select_bunker_courtyard_spawners = undefined;
    ...
    {
        if ( istrue( level.last_saydefuse_time ) )
        ...
        var_10 = 0.6;
        var_11 = 2;
        var_12 = scripts\engine\utility::_id_13AEE( var_10, "death", "weapon_switch_started" );
        ...
        var_12 = scripts\engine\utility::_id_13AED( var_11 - var_10, "death" );
    ...
    else if ( var_6 == "scrambler_drone_guard" )
    {
        ...
        if ( isdefined( level._id_133D6 ) )
        {
            var_15 = [[ level._id_133D6 ]]( self.origin );
    ...
    if ( level.gametype == "br" )
    {
        if ( var_6 == "scrambler_drone_guard" )
            scripts\cp_mp\killstreaks\uav::_id_13657( self.team, 15000, "scrambler_drone_guard" );
    }
...
tryusehelperdroneearlyout( var_0, var_1 )
{
    ...
    if ( ( var_0.streakname == "radar_drone_recon" || var_0.streakname == "assault_drone" ) && ( !self isonground() && !self isonladder() || _branalytics_headerplayer::spawnboardroomblueprintweapons() ) )
    {
        if ( var_1 )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    if ( isdefined( level.gametypeoverridescavsearchparams ) )
    {
        if ( ![[ level.gametypeoverridescavsearchparams ]]( self ) )
        {
            if ( var_1 )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    self.select_bunker_courtyard_spawners = 1;
    return 0;
}
    ...
    else
    {
        ...
        switch ( var_2 )
        {
            ...
            case "scrambler_drone_guard":
                if ( istrue( level.underbridge_reinforce_enemy_monitor ) )
                {
            ...
            case "radar_drone_recon":
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
                {
                    if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br" )
                    {
                        ...
                        var_9 riotshield_checkshield( var_2 );
                    }
                }
...
riotshield_checkshield( var_0 )
{
    ...
    if ( var_0 == "assault_drone" )
        var_1 = level.buildweapon_blueprint;
...
helperdrone_endscramblereffect()
{
    ...
    if ( isdefined( self.lockscriptabledoors ) && self.lockscriptabledoors.size > 0 )
    {
        foreach ( var_1 in self.lockscriptabledoors )
        {
            if ( isdefined( var_1 ) )
            {
                var_2 = var_1;
...
riotshieldiscurrentprimary( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "explode" );
...
{
    scripts\engine\utility::_id_13AD9( "death_or_disconnect", "scramble_off" );
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( var_1.lockscriptabledoors, var_3 ) )
            var_1.lockscriptabledoors[var_1.lockscriptabledoors.size] = var_3;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_13AD9( "death", "scramble_off" );

    if ( isdefined( self ) )
    {
        helperdrone_setscramblerjammed( 0, var_0, var_1 );

        if ( isdefined( var_0 ) && isdefined( var_0.lockscriptabledoors ) )
            var_0.lockscriptabledoors = scripts\engine\utility::array_remove( var_0.lockscriptabledoors, self );
    }
    else if ( isdefined( var_0 ) && isdefined( var_0.lockscriptabledoors ) )
        var_0.lockscriptabledoors = scripts\engine\utility::array_removeundefined( var_0.lockscriptabledoors );
}
        ...
        foreach ( var_5 in level.supportdrones )
        {
            ...
            if ( level.teambased )
            {
                if ( !isdefined( var_1 ) && var_5.team == self.team )
                    ...
                    var_3 = var_5.lockscriptabledoors;
            }
...
starthelperdrone( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        if ( var_2 == "br" )
            var_0 thread riotshield_init_cp( self );
    }
...
helperdrone_overwatchplayer()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_13AD9( "goal", "begin_evasive_maneuvers" );
...
helperdrone_watchpingedstatus( var_0, var_1 )
{
    ...
    self._id_11C5E[self._id_11C5E.size] = var_0;
    var_0 scripts\engine\utility::_id_13AED( 3, "death" );
    self._id_11C5E = scripts\engine\utility::array_remove( self._id_11C5E, var_0 );
}
...
ringing( var_0 )
{
    ...
    foreach ( var_3 in var_0._id_11C5E )
    {
...
setreconmodesettings( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::waitforhvttrigger( self.owner );

    if ( !istrue( var_1 ) )
    {
        self.owner _id_129EA( 1, self );
    ...
    thread riotshield_init_sp( var_0 );
...
_id_12961( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        ...
        scripts\cp_mp\utility\weapon_utility::setlockedonremovedcallback( self, ::helperdrone_lockedonremovedcallback );
        thread helperdrone_watchouterreticletargets( var_0 );
        thread riotshieldclearvars( var_0 );
        thread ringphoneoccasionally( var_0 );
    }
    ...
    if ( istrue( level.buildspecialdaypickupweapon ) )
        thread ring( 2 );
...
setguardmode( var_0 )
{
    ...
    thread riotshieldiscurrentprimary();
    return 1;
}
...
helperdrone_watchearlyexit( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "allowRideKillstreakPlayerExit" ) )
        self thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "allowRideKillstreakPlayerExit" ) ]]( "death", var_0._id_11A9A );

    self waittill( "killstreakExit" );
    thread helperdroneexplode( 0, istrue( var_0.is_lower ) );
}

riotshield_init_sp( var_0 )
{
    if ( !istrue( var_0.is_main_pilot ) )
        return;
...
rings( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            ...
            var_2 = var_1.vehicle;
        else if ( istrue( var_1.stop_station_closed_vo ) )
            var_2 = var_1;
        ...
        if ( istrue( var_0.is_minimap_forcedisabled ) )
        {
...
ring( var_0 )
{
    ...
    self endon( "death" );
    wait( var_0 );
    self.owner thread scripts\cp_mp\utility\player_utility::addquestrewardtierframeend();
}
...
helperdrone_markplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.brdoesloadoutoptiongivestandardloadoutimmediately = 0;
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_2++;
            _id_129FB( self.targetmarkergroup, var_5, 1 );
            ...
            if ( var_8 )
                self.brdoesloadoutoptiongivestandardloadoutimmediately = 1;

            if ( var_9 )
            {
                _id_129FB( self.targetmarkergroup, var_5, 3 );
                continue;
            }

            if ( !var_8 || !var_6 )
            {
                _id_129FB( self.targetmarkergroup, var_5, 0 );
                continue;
            }
...
ringphoneoccasionally( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_3 )
        {
            ...
            var_2++;
            _id_129FB( self.targetmarkergroup, var_6, 1 );
            var_7 = canseetarget( var_6 );
            var_8 = isinmarkingrange( var_6 );

            if ( !var_8 || !var_7 )
            {
                _id_129FB( self.targetmarkergroup, var_6, 0 );
                continue;
            }

            var_4 = 1;
            _id_129FB( self.targetmarkergroup, var_6, 2 );
        }

        self._id_13235 = var_4;
        var_2 = 0;
        waitframe();
    }
}
...
riotshieldclearvars( var_0 )
{
    ...
    for (;;)
    {
        if ( istrue( self._id_13235 ) && var_1 == 0 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 1 );
            var_1 = 1;
        }
        else if ( !istrue( self._id_13235 ) && var_1 == 1 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 0 );
            var_1 = 0;
        }
...
helperdrone_watchnotificationstate( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( !istrue( self.brdoesloadoutoptiongivestandardloadoutimmediately ) )
...
helperdrone_watchouterreticletargets( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.array_init_distribute ) )
        {
            ...
            {
                if ( isdefined( var_6.i_see_player_vehicle_watcher ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "gameFlag" ) )
                    {
                        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "gameFlag" ) ]]( "prematch_done" ) )
                        {
                            ...
                            {
                                if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isPlayerOnIntelChallenge" ) ]]( self.owner, var_6.i_see_player_vehicle_watcher ) )
        ...
        foreach ( var_10 in var_8 )
        {
            if ( isplayer( var_10 ) )
            {
                ...
                if ( !istrue( var_0.update2v2progress ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                    {
            ...
            if ( istrue( var_0.update_ai_array ) && !self.owner helperdrone_istargetinreticle( var_10, 70, 300 ) )
                continue;
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_0._id_1234B ) )
        var_2 = var_0._id_1234B;
    else
        var_2 = scripts\engine\trace::create_contents( 0, 1, 0, 1, 1, 1, 0, 1 );

    var_3 = var_0.origin;

    if ( isdefined( var_0._id_1234C ) )
        var_3 = var_3 + var_0._id_1234C;
...
startmarkingpassivetarget( var_0 )
{
    ...
    _id_129FB( self.targetmarkergroup, var_0, 0 );
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( istrue( var_2.update_ai_array ) && !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0._id_12349 ) )
        [[ var_0._id_12349 ]]( var_4, var_0 );
    ...
    self.owner stoplocalsound( "recon_drone_marking_owner" );
    self.owner _id_129EA( 4, self );
    _id_129FB( self.targetmarkergroup, var_0, 2 );
...
isinmarkingrange( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( var_2, var_1.update_health_bar_to_players, var_1.update_health_bar_to_player );

    if ( isdefined( var_0.update_ai_volumes ) )
        var_3 = var_0.update_ai_volumes;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_13AEE( var_2, "death", "explode" );
...
helperdrone_watchforgoal()
{
    ...
    var_0 = scripts\engine\utility::_id_13AE2( "goal", "near_goal", "hit_goal" );
    self.intransit = 0;
    self.inactive = 0;
...
helperdrone_watchroundend()
{
    ...
    self.owner endon( "disconnect" );
    self endon( "owner_gone" );
    level scripts\engine\utility::_id_13ADA( "round_end_finished", "game_ended", "prematch_cleanup" );
    thread helperdrone_leave();
}
...
removehelperdrone( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.owner ) )
    {
        ...
        self.streakinfo.maxxpcap = istrue( var_2 );
        self.owner scripts\cp_mp\utility\killstreak_utility::_id_12356( self.streakinfo );
    }
...
helperdrone_returnplayer( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::waitformeleedamage( var_0 );
...
helperdrone_destroyongameend()
{
    ...
    self endon( "leaving" );
    self endon( "explode" );
    level scripts\engine\utility::_id_13ADA( "bro_shot_start", "game_ended", "ending_sequence" );
...
helperdrone_istargetinreticle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0._id_1234C ) )
        var_4 = var_4 + var_0._id_1234C;

    var_5 = [ var_4 ];

    if ( isplayer( var_0 ) )
    {
        var_6 = var_0 scripts\mp\utility\player::postspawn_rescued_allies();
