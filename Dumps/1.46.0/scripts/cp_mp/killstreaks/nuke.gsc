...
init_battlechatter()
{
    ...
    anim._id_132F5 = 120000;
    bcs_setup_countryids();
    level.damagedisabledfeedback = 1;
}
...
{
    return istrue( level.damagedisabledfeedback );
}

applymovingcircles( var_0 )
{
    ...
    var_0 setnpcid();
    thread _id_12486( var_0 );
    var_0 thread watch_for_driver_death();
}
...
{
    level._battlechatter.targets_killed_stat_row = var_0;
    level._battlechatter.targetsite = gettime();
}

callouttypewillrepeat( var_0 )
{
    if ( !isdefined( level._battlechatter.targets_killed_stat_row ) )
        return 0;

    if ( !isdefined( level._battlechatter.targetsite ) )
        return 0;

    var_1 = level._battlechatter.targets_killed_stat_row;
    var_2 = level._battlechatter.targetsite;
    var_3 = anim._id_132F5;
...
playphrase( var_0, var_1, var_2 )
{
    ...
    var_1 thread _id_1299B( var_1.curevent.eventaction, var_1.curevent.eventtype );
...
_id_1299B( var_0, var_1 )
{
    self.battlechatter.isspeaking = 1;
    scripts\engine\utility::_id_13AD9( "playPhrase_done", "death" );
