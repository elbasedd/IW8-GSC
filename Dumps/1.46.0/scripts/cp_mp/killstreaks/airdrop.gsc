...
initcratedata()
{
    ...
    level.cratedata._id_136A8 = pow( getdvarfloat( "scr_crateUnresolvedCollisionToleranceSqr", 2 ), 2 );
    ...
    switch ( var_2 )
    {
        ...
        case "br":
            ...
            setplayeringulagarenaextrainfo();
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "registerPlayerFrameUpdateCallback" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "registerPlayerFrameUpdateCallback" ) ]]( ::_id_133E7 );
...
getemptyleveldata()
{
    ...
    var_0.register_valid_objectives_for_create_script = 27.5;
...
createcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( level.gametype == "infect" )
        var_11.spotlight_sweep_to_loc_safe = 1;
    ...
    if ( isdefined( var_11.owner ) )
        var_11.owner.spawn_killstreak_package_on_ground = 1;
    ...
    if ( var_11.hasnophysics )
        ...
        var_11 hack_console_activation_func();
...
capturecrate( var_0 )
{
    ...
    if ( isdefined( self.owner ) && istrue( self.owner.spawn_killstreak_package_on_ground ) )
        self.owner.spawn_killstreak_package_on_ground = 0;
...
destroycrate( var_0 )
{
    ...
    if ( !istrue( var_0 ) )
    {
        ...
        if ( !istrue( self.physicsactivated ) || !istrue( self._id_11C2A ) )
        {
...
initcratedropdata()
{
    var_0 = spawnstruct();
    var_0.helis = [];
    var_1 = scripts\cp_mp\utility\killstreak_utility::playerspawn();
...
watchdropcratefrommanualheliinternal()
{
    ...
    {
        self.heli scripts\engine\utility::_id_13AD9( "death", "goal" );
...
docratedropfrommanualheli()
{
    ...
    var_0 hack_console_activation_func();
}
...
watchcrateuse( var_0, var_1 )
{
    ...
    if ( var_0 == 1 )
    {
        ...
        self.owner endon( "joined_team" );
        self.owner endon( "joined_spectators" );
        self.owner.spawn_killstreak_package_on_ground = 1;
    }
    ...
    if ( isdefined( var_3._id_13807 ) )
        var_3.usetime = var_3._id_13807;
    ...
    for (;;)
    {
        ...
        if ( level.gametype == "br" )
        {
                ...
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "teamJuggMaxReached" ) )
                {
                    ...
                    if ( var_5 )
                    {
                        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
                            var_4 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "hud", "showErrorMessage" ) ]]( "KILLSTREAKS/JUGG_LIMIT_REACHED" );
            ...
            if ( istrue( var_4.isjuggernaut ) && !var_4 start_waypoint( self.cratetype ) )
            {
                if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
        ...
        if ( canstartusingcrate( var_4, var_1 ) )
        {
            ...
            var_4.spawn_killstreak_package_on_ground = 1;
            ...
            {
                if ( isdefined( var_4 ) )
                    var_4.spawn_killstreak_package_on_ground = 0;
...
startusingcrate( var_0, var_1 )
{
    ...
    else
    {
        ...
        if ( var_4 )
            var_0 thread bomb_count_down_end_time_stamp_ms();
...
bomb_detonator_interact( var_0 )
{
    ...
    else
    {
        ...
        {
            var_1 = scripts\cp_mp\utility\weapon_utility::_id_12552( self.lastdroppableweaponobj );
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_5 in var_2 )
            {
                ...
                if ( var_6 )
                    unblockclasschange( var_1, var_5 );
            }
        }
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_3 in level.players )
                unblockclasschange( var_1, var_3 );
        }
...
hack_console_activation_func( var_0, var_1 )
{
    ...
    if ( isdefined( var_2.hack_index ) )
        self thread [[ var_2.hack_index ]]();
...
vehomn_clearleveldataforvehicle()
{
    ...
    var_0 = 0.1;
    thread vehomn_clearcontrols( var_0, 8 );
    var_1 = 0;
    var_2 = 0;
    self.spawn_lbravo = 1;
    var_3 = undefined;
    ...
    for (;;)
    {
        var_5 = playercleanupinfilondisconnect();
        var_6 = playercleanupentondisconnect();
        ...
        if ( isdefined( var_5 ) && isdefined( var_6 ) )
        {
            if ( var_5 <= 5.0 && var_6 <= 1.0 )
            {
                ...
                if ( var_1 == 6 )
                {
                    self._id_11C2A = 1;
                    var_3 = self.origin;
                    thread activatecrate( self.spawn_lbravo );
                    ...
                    var_0 = 0.1;
                    thread vehomn_clearcontrols( var_0, 3, 3 );
                    is_at_mine_moving();
                }
            }
            else
...
vehomn_clearcontrols( var_0, var_1, var_2 )
{
    getgametypekillspermatchmaximum();
    self endon( "death" );
    self endon( "clear_average_velocities" );
    self.trackendangeredobjs = [];
    self.brallowclasschoicefunc = [];
    self._id_139CE = 0;
    self._id_139C9 = 0;
    self._id_139CB = var_1;
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_2 > 0 )
        {
            ...
            {
                self.trackendangeredobjs[self._id_139CE + var_3] = 0;
                self.brallowclasschoicefunc[self._id_139CE + var_3] = 0;
            }
        }
    }
    ...
    for (;;)
    {
        ...
        self.trackendangeredobjs[self._id_139C9] = length( var_5 );
        self.brallowclasschoicefunc[self._id_139C9] = length( var_6 );
        self._id_139C9++;
        var_7 = self._id_139C9 - self._id_139CE;
        ...
        if ( var_7 > var_1 )
        {
            ...
            {
                self.trackendangeredobjs[self._id_139CE + var_3] = undefined;
                self.brallowclasschoicefunc[self._id_139CE + var_3] = undefined;
            }

            self._id_139CE = self._id_139CE + var_8;
        }

        self.can_path_to_target = undefined;
        self.can_node_be_added = undefined;
        wait( var_0 );
    }
}
...
{
    if ( isdefined( self.can_path_to_target ) )
        return self.can_path_to_target;

    if ( !isdefined( self.trackendangeredobjs ) )
        return undefined;

    if ( self._id_139C9 - self._id_139CE < self._id_139CB )
        return undefined;

    enemygunship_getshotgoal();
    return self.can_path_to_target;
}

playercleanupentondisconnect()
{
    if ( isdefined( self.can_node_be_added ) )
        return self.can_node_be_added;

    if ( !isdefined( self.brallowclasschoicefunc ) )
        return undefined;
...
enemygunship_getshotgoal()
{
    ...
    for ( var_2 = self._id_139CE; var_2 < self._id_139C9; var_2++ )
    {
        var_0 = var_0 + self.trackendangeredobjs[var_2];
        var_1 = var_1 + self.brallowclasschoicefunc[var_2];
    }

    self.can_path_to_target = var_0 / self._id_139CB;
    self.can_node_be_added = var_1 / self._id_139CB;
}

getgametypekillspermatchmaximum()
{
    self notify( "clear_average_velocities" );
    self.trackendangeredobjs = undefined;
    self.brallowclasschoicefunc = undefined;
    self._id_139CB = undefined;
    self._id_139CE = undefined;
    self._id_139C9 = undefined;
    self.can_path_to_target = undefined;
    self.can_node_be_added = undefined;
}

vehomncontrols( var_0 )
{
    velendid();
    self endon( "monitorImpactEnd" );
    self.velnumdatapoints = 1;
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) )
        {
            if ( isdefined( var_9.classname ) && var_9.classname == "scriptable_iw8_chicken_01" )
                thread bomb_case_explode_vfx_sequence( var_9 );

            gasmasktype( var_9 );
        }

        if ( isdefined( var_9 ) && search_activate_battle_station( var_9 ) )
        {
            if ( var_9 scripts\cp_mp\killstreaks\helper_drone::spawn_module_lmg_1() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            _id_12013( var_6, var_7, var_8, var_11 );
        }
    }
}
...
gasmasktype( var_0 )
{
    ...
    {
        if ( isdefined( self._id_1345F ) )
        {
            if ( self._id_1345F == var_0 )
                return;
            else
                extractquest_helipadid();
        }

        self._id_1345F = var_0;
        self._id_1345E = 4;
        thread gasmodel( var_0 );
    }
}
...
gasmodel( var_0 )
{
    ...
    while ( self._id_13465 < 5 )
    {
        var_7 = self.origin + anglestoup( self.angles ) * var_1.register_valid_objectives_for_create_script;
        var_8 = var_7 + ( 0, 0, -200 );
        var_9 = scripts\engine\trace::ray_trace( var_7, var_8, var_3, var_2 );

        if ( var_9.size > 0 && isdefined( var_9["entity"] ) && var_9["entity"] == self._id_1345F )
        {
            var_10 = combineangles( invertangles( var_0.angles ), var_0.origin - var_9["position"] );

            if ( !isdefined( self._id_13466 ) )
            {

            }
            else if ( distancesquared( var_10, self._id_13466 ) > 25 )
            {
                self._id_13465++;
                self._id_13467 = 0;
            }
            else if ( vectordot( var_10, self._id_13466 ) < 0.997 )
            {
                self._id_13465++;
                self._id_13467 = 0;
            }
            else
            {
                ...
                {
                    self linkto( var_0 );
                    activatecrate( self.spawn_lbravo );
                    thread hack_airport_combat_init();
                    break;
                }
            }

            self._id_13466 = var_10;
        }
        else
            break;
    ...
    thread extractquest_helipadid();
}

extractquest_helipadid()
{
    self notify( "cancel_link_to_train" );
    self._id_1345F = undefined;
    self._id_13466 = undefined;
    self._id_13465 = undefined;
    self._id_13467 = undefined;
}

bomb_case_explode_vfx_sequence( var_0 )
{
    self endon( "death" );
    var_1 = gettime();
...
velendid()
{
    if ( !istrue( self.velnumdatapoints ) )
        return;
...
search_activate_battle_station( var_0 )
{
    if ( !istrue( self._id_11C2A ) )
    {
        if ( isdefined( var_0.classname ) )
        {
            ...
            {
                if ( var_0 scripts\cp_mp\killstreaks\helper_drone::spawn_module_lmg_1() )
                {
                    var_1 = getleveldata( self.cratetype );
                    var_2 = self.origin + anglestoup( self.angles ) * var_1.register_valid_objectives_for_create_script;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && ( isplayer( var_2 ) || isagent( var_2 ) ) && var_2 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( var_2 tagexists( "j_mainroot" ) )
            {
                ...
                var_8 = self.origin + anglestoup( self.angles ) * var_7.register_valid_objectives_for_create_script;
...
_id_12013( var_0, var_1, var_2, var_3 )
{
...
{
    if ( level.cratedata._id_136A8 > 0 )
    {
        if ( lengthsquared( var_1 ) <= level.cratedata._id_136A8 )
            return;
    }

    var_2 = self.objweapon;

    if ( isdefined( self.hacking_vo ) )
...
_id_133E7()
{
    if ( !isdefined( self.lowpopallowtweaks ) )
    {
        if ( self ismantling() )
        {
            ...
            {
                self.lower_door_coll = var_0;
                self.lower_target_when_close = var_0.crate;
            }

            self.lowpopallowtweaks = gettime() + 1000;
        }
    }
    else if ( gettime() >= self.lowpopallowtweaks )
    {
        self.lower_door_coll = undefined;
        self.lower_target_when_close = undefined;
        self.lowpopallowtweaks = undefined;
    }
    else
    {
        foreach ( var_2 in level.cratedata.crates )
        {
            if ( isdefined( var_2 ) && istrue( var_2.physicsactivated ) && !istrue( var_2._id_11C2A ) )
            {
                if ( isdefined( self.lower_door_coll ) )
                {
                    if ( isdefined( var_2.mountmantlemodel ) )
                    {
                        if ( self.lower_door_coll != var_2.mountmantlemodel )
                        {
                    ...
                    if ( self.lower_target_when_close != var_2 )
                    {
...
dropkillstreakcratefromscriptedheli( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 thread bomb_detonator_bomb_type( var_7 );
...
airdrop_watchplayerweapon( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_13AE1( "cancel_deploy", "weapon_switch_started" );
...
airdropmarkeractivate( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::_id_12356( var_2 );
}
...
initbattleroyaleloadoutcratedata()
{
    ...
    var_0.dummymodel = playerjailtimeout();
    ...
    var_0.destroycallback = ::deploy_emp_drone;
...
deploy_subway_cars_on_track( var_0 )
{
...
setplayeringulagarenaextrainfo()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::damagefactorlow;
    var_0.capturecallback = ::damagefactormedium;
    var_0.destroycallback = ::damagepercent;
    var_0.hack_index = ::damagepercenthigh;
    var_0.destroyoncapture = 1;
}

damagefactorlow( var_0 )
{
...
laststand_dogtag_monitor( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 250;
    var_8 = level.ending_zplanes;
    var_9 = 1000;
    var_10 = 10500;
    var_11 = 7500;
    var_12 = 3000;
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( !var_5 && var_13[2] < var_0[2] )
        {
            ...
            if ( isdefined( var_16 ) )
            {
                ...
                var_15 thread _id_13BBD();
                var_20 thread _id_13BBE( var_19 );
            }
            else
                var_15 hack_console_activation_func();
        }
        else
            var_15 hack_console_activation_func();
        ...
        var_15._id_12C31 = spawn( "script_model", var_1 );
        var_15._id_12C31 setmodel( "ks_airdrop_crate_br" );

        if ( !istrue( var_6 ) )
            var_15._id_12C31 setscriptablepartstate( "smoke_signal", "on", 0 );

        var_23 = getleveldata( var_14 );

        if ( isdefined( var_23._id_120D0 ) )
            var_15 thread [[ var_23._id_120D0 ]]();
    }
...
setplayermostwantedextrainfo()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::deployable_cover_cancel;
    var_0.capturecallback = ::deployed;
    var_0.destroycallback = ::deployingplayer;
    var_0.destroyoncapture = 1;
}

deployable_cover_cancel( var_0 )
{
...
laststandattackermodifiers( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_12C31 = spawn( "script_model", var_1 );
        var_2._id_12C31 setmodel( "ks_airdrop_crate_br" );
        var_2._id_12C31 setscriptablepartstate( "smoke_signal", "on", 0 );
    }

    return var_2;
}

laststanddowneddata( var_0, var_1 )
{
    var_2 = dropcrate( undefined, undefined, "battle_royale_chopper_loot", var_0, ( 0, randomfloat( 360 ), 0 ), var_1 );
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_12C31 = spawn( "script_model", var_1 );
        var_2._id_12C31 setmodel( "ks_airdrop_crate_br" );
        var_2._id_12C31 setscriptablepartstate( "smoke_signal", "pe_chopper_on", 0 );
    }
...
setplayeringulagjailextrainfo()
{
    ...
    var_0.dummymodel = playerjailtimeout( "battle_royale_juggernaut" );
    var_0.friendlymodel = undefined;
    var_0.enemymodel = undefined;
    var_0.mountmantlemodel = undefined;
    var_0.supportsownercapture = 0;
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::debug_printcode;
    var_0.destroycallback = ::debug_reach_exhaust_waste;
    var_0.activatecallback = ::debug_pre_start_coop_escape;
    var_0.hack_index = ::debug_reach_icbm_launch;
    var_0._id_120D0 = ::debug_reach_pipe_room;
    var_0.destroyoncapture = 1;
}
...
debug_reach_icbm_launch( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}
...
lastunrulyscore( var_0, var_1, var_2 )
{
...
_id_12E4E( var_0, var_1 )
{
    ...
    if ( istrue( self.spawn_ending_individual_guys_death ) )
        var_2 = 10000;

    var_3 = lastunrulyscore( self.team, var_0 + ( 0, 0, var_2 ), var_0 + ( 0, 0, 512 ) );
    var_3 endon( "death" );
    little_bird_mg_enterstart( var_3 );
    get_has_combined_counters_alias( var_3 );
    var_4 = [];
...
get_has_combined_counters_alias( var_0 )
{
    var_0 setotherent( self );
    var_0 setscriptablepartstate( "model", "friendly" );
}

start_waypoint( var_0 )
{
    var_1 = 1;
...
setplayerselfrevivingextrainfo()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::disabledamagestattrackingfunc;
    var_0.activatecallback = ::disabledamagestattracking;
    var_0.destroycallback = ::disabledcurrstate;
    var_0.hack_index = ::disabledebugdialogue;
    var_0.destroyoncapture = 1;
}

disabledamagestattrackingfunc( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
lb_mg_pitch_roll_dmg_factor( var_0 )
{
    var_1 = 4096;
    var_2 = var_0 + ( 0, 0, var_1 );
    var_3 = var_0 + ( 0, 0, 512 );
    level._id_12573.original_disablelongdeath = spawnfx( level._effect["smoke_tactical_device"], level._id_12573.is_position_open - ( 0, 0, 60 ) );
    triggerfx( level._id_12573.original_disablelongdeath );
    var_4 = dropcrate( undefined, undefined, "battle_royale_tactical_device", var_2, ( 0, randomfloat( 360 ), 0 ), var_3 );
    var_4.skipminimapicon = 1;
    disabledfeatures( var_4 );
}
...
disabledebugdialogue( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}

disabledfeatures( var_0 )
{
...
playerjailtimeout( var_0 )
{
    ...
    else if ( isdefined( var_0 ) && var_0 == "battle_royale_juggernaut" && istrue( level._id_11AA0 ) )
