...
{
    if ( !istrue( var_1 ) )
        scripts\cp_mp\killstreaks\killstreakdeploy::plunderrepositorywidget( var_2 );
}
...
tryusesentryturretfromstruct( var_0 )
{
    ...
    scripts\cp_mp\killstreaks\manual_turret::unset_relic_ammo_drain( 0 );
    var_2 = sentryturret_create( "sentry_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        scripts\cp_mp\killstreaks\manual_turret::unset_relic_ammo_drain( 1 );
        self.bgivensentry = 0;
        return 0;
    }
...
sentryturret_delayplacementinstructions( var_0 )
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::unset_ignoreall_after_notify( "death" );
    thread scripts\cp_mp\killstreaks\manual_turret::unset_ignoreall_after_notify( "turret_placement_finished" );
}
...
sentryturret_create( var_0, var_1 )
{
    ...
    var_3.getscrapassistplayers = spawn( "script_model", var_3.origin );
    var_3.getscrapassistplayers.team = var_3.team;
    var_3.getscrapassistplayers.owner = var_3.owner;
    var_3.getscrapassistplayers setmodel( "weapon_vm_mg_sentry_turret_invis_base" );
    var_3.getscrapassistplayers dontinterpolate();
    var_3.getscrapassistplayers hide();
    var_8 = 0;
    ...
    if ( var_8 )
    {
        var_3.getsearchparams = spawn( "script_model", var_3.origin );
        var_3.getsearchparams.team = var_3.team;
        var_3.getsearchparams.owner = var_3.owner;
        var_3.getsearchparams setmodel( "weapon_vm_mg_sentry_turret_invis_base_vehicle" );
        var_3.getsearchparams dontinterpolate();
        var_3.getsearchparams hide();
    }
...
sentryturret_setplaced( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.moving_platform ) )
    {
        ...
        var_0.waitforallcrates = var_1.waitforallcrates;
    }

    self.bgivensentry = 0;
    var_0.origin = var_1.location;
    var_0 playsound( "sentry_gun_plant" );
    var_0.getscrapassistplayers show();
    var_0.getscrapassistplayers.angles = var_0.angles;
    var_0.getscrapassistplayers.origin = var_0.origin;
    var_5 = var_0.getscrapassistplayers;

    if ( var_4 )
    {
        var_0.getsearchparams show();
        var_0.getsearchparams.angles = var_0.angles;
        var_0.getsearchparams.origin = var_0.origin;
        var_0.getscrapassistplayers linkto( var_0, "tag_turret" );
        var_0.getsearchparams linkto( var_0, "tag_turret" );
        var_0.getsearchparams linkto( var_0, "tag_aim_pivot" );
        var_5 = var_0.getsearchparams;
    }
    else
        var_0.getscrapassistplayers linkto( var_0, "tag_aim_pivot" );

    var_0 thread _id_12862( var_0, var_5 );
...
sentryturret_setcarried( var_0 )
{
    ...
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_0.waitforanyplayernearpoint = undefined;
        var_0.waitforallcrates = undefined;
        var_0 unlink();
    }
    ...
    var_0.getscrapassistplayers unlink();
    var_0.getscrapassistplayers hide();

    if ( var_5 )
    {
        var_0.getsearchparams unlink();
        var_0.getsearchparams hide();
    }
...
sentryturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        var_0.streakinfo.maxxpcap = istrue( var_2 );
        scripts\cp_mp\utility\killstreak_utility::_id_12356( var_0.streakinfo );
    }
    ...
    if ( isdefined( var_0.getscrapassistplayers ) )
        var_0.getscrapassistplayers delete();

    if ( isdefined( var_0.getsearchparams ) )
        var_0.getsearchparams delete();
...
sentryturret_watchdisown( var_0 )
{
    var_0 endon( "kill_turret" );
    var_0 endon( "carried" );
    scripts\engine\utility::_id_13ADA( "disconnect", "joined_team", "joined_spectators" );
    var_0 notify( "kill_turret", 0, 0 );
}
...
_id_1285F()
{
    var_0 = _branalytics_addeventdelayed::_id_127A9( self.origin, 140, 20 );
    var_1 = undefined;
    var_2 = 0;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        foreach ( var_11 in var_0 )
        {
            ...
            if ( distancesquared( var_11.getnextspectatecandidatefromchain, var_1.getnextspectatecandidatefromchain ) < 3600 )
            {
                var_9 = var_11;
                break;
            }
        ...
        if ( var_2 < 3600 && var_8 )
        {
            var_1.spawn_and_enter_cargo_truck_mg = 1;
            var_1 _branalytics_addeventdelayed::killoff_vis_passed( 1, "tac_cover_door" );
            self.chopper_gunner_assigntargetmarkers = var_1;

            if ( isdefined( var_9 ) && var_13 )
            {
                var_9.spawn_and_enter_cargo_truck_mg = 1;
                var_9 _branalytics_addeventdelayed::killoff_vis_passed( 1, "tac_cover_door" );
                self.chopper_kill = var_9;
            }
        }
    }
...
_id_12860()
{
    if ( isdefined( self.chopper_gunner_assigntargetmarkers ) )
    {
        self.chopper_gunner_assigntargetmarkers _branalytics_addeventdelayed::killoff_vis_passed( 0, "tac_cover_door" );
        self.chopper_gunner_assigntargetmarkers.spawn_and_enter_cargo_truck_mg = undefined;
        self.chopper_gunner_assigntargetmarkers = undefined;
    }

    if ( isdefined( self.chopper_kill ) )
    {
        self.chopper_kill _branalytics_addeventdelayed::killoff_vis_passed( 0, "tac_cover_door" );
        self.chopper_kill.spawn_and_enter_cargo_truck_mg = undefined;
        self.chopper_kill = undefined;
    }
}
