...
ondeploystart( var_0 )
{
    ...
    var_0.owner scripts\common\utility::bot_loadout_team( 0 );
}
...
ondeployfinished( var_0, var_1 )
{
    ...
    var_0.owner scripts\common\utility::bot_loadout_team( 1 );
}
...
watchdeployweaponanimtransition( var_0, var_1, var_2 )
{
    ...
    var_4 = scripts\engine\utility::_id_13AEF( var_1, "death", "weapon_change", "cancel_all_killstreak_deployments" );
...
{
    self endon( "disconnect" );
    var_1 = scripts\engine\utility::_id_13AED( var_0, "cancel_remote_sequence" );
    ...
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        var_1 = scripts\engine\utility::_id_13AED( 0.7, "death" );
...
cleanupdeployweapon( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        var_6 = scripts\cp_mp\utility\killstreak_utility::spawnregions( var_2.basename );
