...
init()
{
    ...
    init_airstrike_vo();
    level.apc_rus_monitordriverturretfire = [];
    level.bot_dd_think = 0;
}
...
weapongivenairstrike( var_0 )
{
    ...
    var_2 = bot_ctf_recover_flag( self.origin );
...
weaponfiredairstrike( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0._id_1323C ) )
    {
        ...
        var_4 = bot_ctf_recover_flag( var_3 );
    ...
    switch ( var_0.streakname )
    {
        case "precision_airstrike":
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
            {
                ...
                if ( var_3 == "br" && isdefined( self.survivorsupertwo ) )
                {
...
selectairstrikelocation( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        var_8 = bot_ctf_recover_flag( var_2 );
...
finishmapselectairstrikeusage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 = bot_ctf_player_has_flag( self.origin, self );
    thread airstrike_watchkills( var_7 * 2, var_8 );
    thread watchairstrikeowner( var_8 );
    thread bot_dd_clear_role( var_4, var_8 );
    ...
    bot_custom_classes_allowed( self, var_8 );
    ...
    scripts\cp_mp\utility\killstreak_utility::_id_12356( var_4 );
}
...
finishstandardairstrikeusage( var_0, var_1, var_2 )
{
    ...
    var_6 = bot_ctf_player_has_flag( var_0, self );
    thread airstrike_watchkills( var_5 * 2, var_6 );
    thread watchairstrikeowner( var_6 );
    thread bot_dd_clear_role( var_2, var_6 );
...
watchairstrikeowner( var_0 )
{
    ...
    bot_custom_classes_allowed( self, var_0 );
}

callstrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 0;
    var_8 = scripts\cp_mp\utility\killstreak_utility::playerspawn();
    var_9 = 24000;
    var_10 = 6500;
    var_11 = 2500;
    var_7 = 1500;
    ...
    if ( level.mapname == "mp_br_mechanics" || scripts\cp_mp\utility\game_utility::spawn_exfil_juggs() )
        var_11 = var_11 + 2500;
...
_id_13BDD( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "air_strike_complete" );
    var_1 waittill( "disconnect" );

    if ( isdefined( var_0.nuke_hostmigration_waittillhostmigrationdone ) )
        var_0.nuke_hostmigration_waittillhostmigrationdone delete();
...
doplanestrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_15.owner = var_7;
    var_16 = istrue( level.stack_patch_waittill_root ) && ( isdefined( level._id_13D18 ) && level._id_13D18 == 6 );
    var_17 = var_16 || istrue( var_5.br_displayperkinfo );
    ...
    var_15.bot_destination_spots = var_8;
    ...
    {
        var_18 = spawnstruct();
        var_18._id_11C96 = var_15;
        var_18._id_13244 = var_0;
    ...
    if ( !istrue( var_5.relic_laststand_modifyplayerdamage ) )
        level thread airstrike_playplaneattackfx( var_15, var_20, var_5 );

    if ( istrue( var_5._id_11AA2 ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "airstrike", "overridePlayFlyFX" ) )
...
airstrike_playflyfx( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::useww2modelswaps() )
        var_0.nuke_hostmigration_waittillhostmigrationdone setmodel( "ks_airstrike_br_ch3" );

    var_0.nuke_hostmigration_waittillhostmigrationdone dontinterpolate();
    var_0.nuke_hostmigration_waittillhostmigrationdone thread airstrike_playapproachfx( 0.05 );
    var_0.nuke_hostmigration_waittillhostmigrationdone thread airstrike_playflybyfx( 3.397 );
    var_0.nuke_hostmigration_waittillhostmigrationdone thread airstrike_playflyoutfx( var_4 );
    var_0.nuke_hostmigration_waittillhostmigrationdone thread airstrike_handleflyoutfxdeath( var_5 );
    var_0.nuke_hostmigration_waittillhostmigrationdone thread bot_cur_loadout_num( var_0 );
}
...
callstrike_precisionbulleteffect( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = var_6;
    var_10 = istrue( level.stack_patch_waittill_root ) && ( isdefined( level._id_13D18 ) && level._id_13D18 == 6 );
...
airstrike_watchforads( var_0, var_1 )
{
    ...
    var_2 hide();
    var_3 = scripts\cp_mp\utility\script_utility::_id_13838( "game", "isGameTypeBR", 0 );
    ...
    var_2 thread bot_dd_set_role( self );
    var_2 thread airstrike_watchdeployended( self );
    var_2 thread bot_dd_ai_director_update( self );
...
bot_ctf_player_has_flag( var_0, var_1 )
{
    ...
    var_2.origin = var_0;
    var_2.owner = var_1;
    var_2.id = var_1.name + "_" + level.bot_dd_think;
    level.apc_rus_monitordriverturretfire[var_2.id] = var_2;
    return var_2.id;
}

bot_custom_classes_allowed( var_0, var_1 )
{
    level.apc_rus_monitordriverturretfire = scripts\engine\utility::array_remove_index( level.apc_rus_monitordriverturretfire, var_1, 1 );

    if ( isdefined( var_0 ) )
        var_0 notify( "airstrike_finished_" + var_1 );
}

bot_ctf_recover_flag( var_0 )
{
    var_1 = "success";
    var_2 = 625000000;
    ...
    if ( isdefined( var_0 ) )
    {
        if ( level.apc_rus_monitordriverturretfire.size > 0 )
        {
            var_3 = 1;
            ...
            if ( level.apc_rus_monitordriverturretfire.size >= var_3 )
                var_1 = "KILLSTREAKS/AIR_SPACE_TOO_CROWDED";
            else
            {
                foreach ( var_6 in level.apc_rus_monitordriverturretfire )
                {
...
exittype( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = spawnstruct();
    ...
    var_5.damage = 0;
    var_5.kills = 0;
    var_5.relic_laststand_modifyplayerdamage = istrue( var_1 );
    var_5.br_displayperkinfo = istrue( var_2 );
    var_6 = var_3;
    var_7 = undefined;
