...
tryusemanualturretfromstruct( var_0 )
{
    ...
    unset_relic_ammo_drain( 0 );
    var_2 = manualturret_create( "manual_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        unset_relic_ammo_drain( 1 );
        return 0;
    }
...
manualturret_delayplacementinstructions( var_0 )
{
    ...
    thread unset_ignoreall_after_notify( "death" );
    thread unset_ignoreall_after_notify( "turret_placement_finished" );
}

unset_ignoreall_after_notify( var_0 )
{
...
manualturret_create( var_0, var_1 )
{
    ...
    var_3.getscrapassistplayers.moverdoesnotkill = 1;
    var_3.getscrapassistplayers._id_13610 = var_3;
    return var_3;
}
...
manualturret_setplaced( var_0, var_1 )
{
    ...
    if ( !var_6 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
            var_0.minimapid = var_0.getscrapassistplayers [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_7, var_0.team, undefined, 1, 1 );
    }
    ...
    var_0 thread unset_relic_bang_and_boom();
...
manualturret_setcarried( var_0 )
{
    ...
    if ( istrue( self.inuse ) )
    {
        ...
        var_0 unset_relic_amped( 1 );
    }

    if ( isdefined( self.moving_platform ) )
    {
        self.moving_platform = undefined;
        self.waitforanyplayernearpoint = undefined;
        self.waitforallcrates = undefined;
        self unlink();
    }
    ...
    var_0 scripts\cp_mp\utility\weapon_utility::_id_1271D();
...
manualturret_switchbacklastweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::_id_12552( self.lastdroppableweaponobj );
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        self._id_11FBA = var_3;
        manualturret_makealltriggersusable( 0 );
        var_3 scripts\cp_mp\utility\weapon_utility::_id_1271D();
        ...
        {
            var_7 = unset_just_keep_moving( var_3, var_3.useweapon );
        ...
        if ( !istrue( var_7 ) )
        {
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    var_3 unset_relic_amped( 1 );
                    var_8 = var_3 scripts\cp_mp\utility\weapon_utility::_id_12552( var_3.lastdroppableweaponobj );
        ...
        if ( scripts\cp_mp\utility\game_utility::isnightmap() )
            var_3 scripts\common\utility::bot_pick_dd_zone_with_fewer_defenders( 0 );

        manualturret_applyoverlay( var_3 );
        thread manualturret_disablefire( var_3, 0.5, 1 );
        thread manualturret_watchammotracker( var_3 );
        thread unset_maze_ai_stealth_settings( var_3 );
        thread unset_relic_aggressive_melee( var_3 );
...
unset_just_keep_moving( var_0, var_1 )
{
    self endon( "kill_turret" );
    self endon( "turret_switch_weapon_timeout" );
    var_0 endon( "death_or_disconnect" );
    level endon( "game_ended" );
    thread unset_relic_damage_from_above( 1.0 );
...
manualturret_endplayeruse( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( !istrue( var_0.spawnx1stashlootcache ) )
        ...
        thread unset_jugg_ignoreall_after_notify();
...
unset_jugg_ignoreall_after_notify()
{
    self endon( "death_or_disconnect" );
...
manualturret_endturretonplayer( var_0 )
{
    var_0 endon( "end_turret_use" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_13AD9( "death_or_disconnect", "last_stand_start" );
    var_0 manualturret_endplayeruse( self );
}
...
manualturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0 scripts\cp_mp\utility\killstreak_utility::_id_12356( self.streakinfo );
    }

    if ( isdefined( self._id_11FBA ) )
        self._id_11FBA manualturret_endplayeruse( self );
    ...
    if ( isdefined( self.getscrapassistplayers ) )
...
manualturret_watchtimeout( var_0 )
{
    ...
    while ( self.timeelapsed < var_1 )
    {
        ...
        if ( isdefined( self._id_11FBA ) )
            self._id_11FBA setclientomnvar( "ui_killstreak_countdown", int( var_2 ) );

        self.timeelapsed = self.timeelapsed + level.framedurationseconds;

        if ( self.timeelapsed >= var_1 - 1.5 && !istrue( self._id_130AE ) )
            self._id_130AE = 1;
