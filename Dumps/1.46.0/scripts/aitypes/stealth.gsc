...
idle_updatecurious( var_0 )
{
    ...
    {
        var_9 = scripts\stealth\utility::play_intel_collect_vo();
...
idle_update( var_0 )
{
    ...
    if ( istrue( self.stealth.chopper_watch_death ) )
...
triggermatchendtimer()
{
    if ( isdefined( level.stealth.nuke_vault_door_sounds ) )
        self [[ level.stealth.nuke_vault_door_sounds ]]();
}
