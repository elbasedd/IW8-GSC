...
startarmsracedef4obj( var_0, var_1 )
{
    var_2 = 0;
    var_3 = var_0;
...
juggernaut_move( var_0 )
{
    ...
    if ( var_3 >= var_1.nextupdatetime )
    {
        ...
        var_1._id_1323B = !self iswithinscriptgoalradius( var_1.targetpos );
    ...
    if ( var_1._id_1323B && var_8 )
        self setbtgoalradius( 0, max( min( self.startenemyhelis, self.goalradius / 2 ), 25 ) );
    else
        self setbtgoalradius( 0, self.juggernautgoalradius );
    ...
    if ( var_11 )
    {
        ...
        else
        {
            ...
            else if ( !istrue( var_1.stopping ) )
            {
                ...
                var_10 = startarmsracedef4obj( var_10, var_1.enemy );
...
startdeadsilence( var_0 )
{
    ...
    if ( var_2 && !istrue( self.cargo_truck_initomnvars ) )
        return anim.failure;

    if ( isdefined( self._id_13330 ) && gettime() - self._id_13330 < var_1 )
        return anim.failure;

    if ( istrue( self._id_11996 ) )
    {
