...
callback_playerdamage_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15 )
{
    ...
    if ( istrue( var_2._id_11997 ) && isdefined( var_6 ) )
    {
        if ( !site_boss_spawn_think( var_6.basename ) )
            return;
    }
    ...
    else
    {
        ...
        if ( isdefined( var_0 ) && istrue( var_0.end_intro_obj ) )
            var_21 = 0;
        ...
        {
            if ( istrue( game["inLiveLobby"] ) || !scripts\mp\flags::gameflag( "prematch_done" ) || istrue( level.select_patrol_six_spawners ) )
            {
        ...
        if ( istrue( var_2.spawnprotection ) || var_2 _meth_87D1() )
        {
        ...
        if ( isdefined( var_1 ) && istrue( var_1.cranked ) )
            var_1 thread scripts\mp\cranked::_id_11952( var_2 );
        ...
        {
            var_25 = scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, var_1 );
            var_3 = previousplacements( var_25, var_6, var_9, var_3, var_14 );
        }

        var_4 = var_4 | level.idflags_no_knockback;

        if ( ( splashtime_drops( var_6 ) || var_6 hasattachment( "ammo_incendiary", 1 ) ) && scripts\mp\utility\damage::validshotcheck( var_5, var_1 ) )
        {
            if ( isdefined( var_6.spawn_field_ai_manager_middle ) )
                var_2 thread laser_shut_down_interact_monitor( var_9, var_1, var_6 );

            if ( var_6.basename != "iw8_pi_t9pistolshot_mp" )
                var_3 = _id_12EF0( var_2, var_1, var_6, var_3, var_4 );
            else if ( var_3 == 0 )
                return;
        }

        var_26 = var_6.basename;
        var_27 = scripts\mp\utility\weapon::getequipmenttype( var_26 );
        ...
        if ( isdefined( var_27 ) )
        {
            ...
            var_28 = scripts\cp_mp\utility\damage_utility::packdamagedata( var_1, var_2, var_3, var_6, var_5, var_0, var_7, var_8, undefined, var_12, undefined, var_4 );
            var_29 = scripts\mp\equipment::equiponplayerdamaged( var_28 );
        ...
        {
            var_30 = isdefined( var_6 ) && isdefined( var_6.basename ) && var_6.basename == "minefield_mp";

            if ( !var_30 )
            {
                var_31 = istrue( var_6.isalternate );

                if ( isdefined( var_27 ) && !scripts\mp\utility\weapon::isthrowingknife( var_26 ) || var_31 || var_5 == "MOD_EXPLOSIVE" )
                {
                    var_32 = int( max( var_2.health / 5, 1 ) );
        ...
        var_33 = scripts\mp\utility\weapon::getweapontype( var_26 );

        if ( isdefined( var_33 ) && var_33 == "killstreak" )
        {
        ...
        {
            var_35 = cac_modified_damage( var_2, var_1, var_3, var_5, var_6, var_7, var_8, var_9, var_0, 0, var_4, var_22, var_14 );
            var_3 = var_35[0];
            var_36 = var_35[1];
            var_37 = var_35[2];
            var_38 = var_36 != 0 || var_37 != 0;
            var_9 = var_35[3];
        }
        else
        {
        ...
        if ( spawn_para_and_heli_logic( var_1, var_2, var_3, var_5, var_6, var_13 ) )
            return;
        ...
        if ( isplayer( var_1 ) && ( var_26 == "smoke_grenade_mp" || scripts\mp\utility\weapon::isthrowingknife( var_26 ) ) )
            var_1 thread scripts\mp\gamelogic::threadedsetweaponstatbyname( var_26, 1, "hits" );

        var_39 = var_8;

        if ( isdefined( var_4 ) && var_4 & level.idflags_ricochet && var_3 < self.health )
            var_39 = var_2.origin - var_1.origin;

        if ( spawn_heli_assault3_hangar_end( var_0 ) )
            var_3 = 0;

        if ( isdefined( var_1 ) && ( isplayer( var_1 ) || istrue( var_1.bots_create_landing_spots ) ) && scripts\mp\utility\game::getgametype() == "br" )
        {
            if ( armorvest_washit( var_1 ) || helmet_washit( var_1 ) )
                var_4 = var_4 | level.scriptable_callback;

            if ( armorvest_wasbroke( var_1 ) || helmet_wasbroke( var_1 ) )
                var_4 = var_4 | level.scriptable_autouse_funcs;

            if ( isdefined( level._id_119A6 ) )
                var_4 = var_4 | [[ level._id_119A6 ]]( var_2 );
        }

        if ( spawntvfix( var_1 ) )
            var_3 = _id_127C8( var_1, var_3, var_5 );

        if ( isdefined( level._id_119A5 ) )
        {
            if ( ![[ level._id_119A5 ]]( var_5 ) )
                return;
        }

        var_40 = 5;

        if ( isplayer( var_1 ) && var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ping_on_damage" ) && var_34 >= var_40 )
        {
            if ( isplayer( var_2 ) && var_2 scripts\mp\utility\perk::_hasperk( "specialty_coldblooded" ) && var_2 != var_1 )
                var_1 thread scripts\mp\perks\perkfunctions::_id_11C6A();
            else
                var_1 scripts\mp\perks\perkfunctions::kioskreviveplayer( var_2 );
        }

        if ( getdvarint( "scr_serpentine_perk_test", 0 ) == 1 )
        {
            if ( isdefined( var_0 ) && !var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            {
                if ( var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_serpentine" ) && var_2 issprinting() )
                {
                    var_41 = var_3;
                    var_3 = int( var_41 * getdvarfloat( "scr_perk_serpentine_drmod", 0.85 ) );

                    if ( getdvarint( "scr_serpentine_perk_test_debugtext", 0 ) == 1 )
                    {
                        var_42 = "Target has Serpentine,";
                        var_1 iprintlnbold( var_42 + " Old Damage: " + var_41 + ", New Damage: " + var_3 );
                    }
                }
            }
        }

        preplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_39, var_9, var_10, var_11, var_12 );
        var_2 finishplayerdamagewrapper( var_0, var_1, var_3, var_4, var_5, var_6, var_7, var_39, var_9, var_10, var_11, var_12, var_38 );
        postplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_39, var_9, var_10, var_11, var_12, var_36, var_37, var_19, var_22 );
    }
}

previousplacements( var_0, var_1, var_2, var_3, var_4 )
{
...
laser_shut_down_interact_monitor( var_0, var_1, var_2 )
{
    self notify( "newDragonsBreathHitLoc" );
    self endon( "newDragonsBreathHitLoc" );

    if ( !isdefined( self.laser_shut_down_button ) )
        self.laser_shut_down_button = scripts\cp\utility\script::_id_12E20();

    self.laser_shut_down_button.watch_for_driver_spawned = scripts\engine\utility::array_add( self.laser_shut_down_button.watch_for_driver_spawned, var_0 );
    waittillframeend;
    var_3 = [];
    ...
    if ( isdefined( self.laser_shut_down_button ) )
    {
        var_3 = self.laser_shut_down_button.watch_for_driver_spawned;
        self.laser_shut_down_button.watch_for_driver_spawned = [];
    }

    if ( scripts\mp\utility\player::isreallyalive( self ) )
        scripts\cp\utility\script::_id_1297D( var_3, var_1, var_2 );
    else
        scripts\cp\utility\script::_id_1297E();
}
...
preplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    var_2 thread scripts\cp\utility\cp_controlled_callbacks::playerdamaged( var_0, var_1, var_3, var_5, var_6, var_9 );
...
postplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16 )
{
    ...
    if ( isdefined( var_1 ) && var_3 > 0 )
    {
        ...
        if ( var_18 && ( var_6 hasattachment( "ammomod_slow" ) || var_6 hasattachment( "gunperk_disable" ) ) && scripts\mp\utility\damage::islowerbodyshot( var_9, var_5, var_1 ) )
    ...
    else if ( isdefined( var_4 ) && var_4 & level.idflags_penetration && !( var_4 & level.scriptable_door_freeze_open ) )
    {
...
meleestagger( var_0 )
{
    ...
    if ( isdefined( level.onstompeenemyprogressupdate ) )
        self setviewkickscale( scripts\engine\utility::ter_op( var_0 scripts\mp\utility\perk::_hasperk( "specialty_hardmelee" ), level.onstompeenemyprogressupdate * 2, level.onstompeenemyprogressupdate ) );
    else
...
{
    scripts\engine\utility::_id_13AED( 2.0, "death_or_disconnect" );
    var_0 destroy();
}
...
allowdamageflash( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _id_1317A( var_0, var_1, var_2, var_3, var_4 ) )
        return 0;

    return 1;
}

_id_1317A( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_2 ) )
    {
...
_id_13CA5( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = var_3.basename;

    if ( site_boss_spawn_think( var_7 ) )
        return 1;

    if ( isdefined( level.deadblue ) && isdefined( var_7 ) )
    {
        if ( istrue( level.deadblue._id_13DD4 ) && var_7 == "iw8_fists_mp_zmb" || istrue( level.deadblue.progression_update ) && var_7 == "iw8_fists_mp_gxp" )
            return 1;
    }
...
cac_modified_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    var_14 = 0;
    var_15 = 0;
    var_16 = var_0 scripts\mp\gametypes\br_public.gsc::hasarmor();
    var_17 = var_0 scripts\mp\gametypes\br_public.gsc::hashelmet();

    if ( isplayer( var_1 ) || isdefined( var_1 ) && istrue( var_1.bots_create_landing_spots ) )
    {
    ...
    if ( scripts\engine\utility::isbulletdamage( var_3 ) )
    {
        ...
        if ( scripts\mp\utility\weapon::spawn_set_jugg_value( var_18 ) && scripts\mp\utility\game::getgametype() == "br" )
            var_2 = var_2 * scripts\mp\gametypes\br_jugg_common.gsc::playerusehealslot();
        ...
        var_24 = istrue( var_1.take_time_away_from_bomb_vest_timer ) && scripts\mp\utility\weapon::getweaponrootname( var_4 ) == "iw8_sn_crossbow";
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "nova_rounds", "hitByNovaRounds" ) )
            [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "nova_rounds", "hitByNovaRounds" ) ]]( var_1, var_5, var_6, var_0 );
        ...
        if ( var_22 && !istrue( var_0.inlaststand ) )
        {
            ...
            var_29 = var_0 scripts\mp\gametypes\br_public.gsc::damagehelmet( var_2, var_28, var_6 );
            var_2 = var_2 * var_29;
        }
        ...
        if ( issubstr( var_18, "s4_" ) )
        {
            ...
            if ( scripts\mp\utility\game::spawn_maint_wave_1() )
        ...
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
            var_2 = vehicle_lights_manager( var_4, var_2, var_26, 0, var_1 );

        if ( isdefined( var_1 ) && isdefined( var_1._id_139A1 ) && var_1._id_139A1 == "loot_chopper" )
            var_2 = int( var_2 / 3 );
    }
    else if ( isexplosivedamagemod( var_3 ) )
    {
        ...
        var_2 = vehicle_occupancy_clearseatcorpse( var_2, var_8, var_4 );
        ...
        {
            var_40 = vehicle_isneutraltoteam( var_2, var_1, var_0 );
    ...
    else if ( var_3 == "MOD_FIRE" )
    {
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
        {
            if ( isdefined( var_4.basename ) && var_4.basename == "thermite_ap_mp" || var_4.basename == "thermite_bolt_mp" )
                var_2 = vehicle_lights_manager( var_4, var_2, 0, 1, var_1 );
        }
    ...
    var_41 = _id_13CA5( var_1, var_0, var_2, var_4, var_3, var_8, var_7 );
    ...
    {
        var_44 = var_0 scripts\mp\gametypes\br_public.gsc::damagearmor( var_2 );
        ...
        if ( isplayer( var_1 ) )
        {
            ...
            else if ( isdefined( level.zombievehiclelaststand ) )
                var_1 [[ level.zombievehiclelaststand ]]( var_45 );
        }
        else if ( isdefined( var_1 ) && istrue( var_1.bots_create_landing_spots ) )
            armorvest_sethit( var_1 );
    }
    else if ( var_43 && istrue( var_1.remaphardpointorder ) )
    {
        if ( !isdefined( var_0.watchsnowballpickup ) )
        {
            var_0.watchsnowballpickup = [];
            level thread _findgivearmoramountanddropleftovers::_id_12165( var_1, var_0 );
        }

        var_46 = spawnstruct();
        var_46.damage = var_2 * 0.05;
        var_46.point = var_5;
        var_46.attacker = var_1;
        var_46.dir = var_6;
        var_0.watchsnowballpickup[var_0.watchsnowballpickup.size] = var_46;
    }

    var_47 = scripts\mp\equipment\trophy_system::trophy_modifieddamage( var_1, var_0, var_4.basename, var_2, var_13 );
    var_2 = var_47[0];
    var_13 = var_47[1];

    if ( var_0 scripts\mp\heavyarmor::hasheavyarmor() )
    {
        var_47 = scripts\mp\heavyarmor::heavyarmormodifydamage( var_0, var_1, var_2, var_13, var_3, var_4.basename, var_5, var_6, var_7, var_8, var_9 );
        var_14 = var_47[0] > 0;
        var_2 = var_47[1];
        var_13 = var_47[2];
    }
    ...
    {
        var_47 = scripts\mp\lightarmor::lightarmor_modifydamage( var_0, var_1, var_2, var_13, var_3, var_4.basename, var_5, var_6, var_7, var_8, var_9 );
        var_15 = var_47[0] > 0;
        var_2 = var_47[1];
        var_13 = var_47[2];
    }
    ...
    if ( isplayer( var_1 ) || isdefined( var_1 ) && istrue( var_1.bots_create_landing_spots ) )
    {
        var_48 = var_0 scripts\mp\gametypes\br_public.gsc::hasarmor();
        var_49 = var_0 scripts\mp\gametypes\br_public.gsc::hashelmet();
    ...
    if ( istrue( var_0.inlaststand ) && getdvarfloat( "scr_player_lastStandHealthScalar", 0 ) > 0 )
    {
        ...
        if ( isdefined( level.vehicle_handleflarefire ) )
        {
            var_51 = scripts\cp_mp\utility\damage_utility::packdamagedata( var_1, var_0, var_2, var_4, var_3, var_8 );
            var_50 = self [[ level.vehicle_handleflarefire ]]( var_51 );
        }
...
vehicle_isneutraltoteam( var_0, var_1, var_2 )
{
...
vehicle_lights_manager( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_4 ) && var_4 scripts\mp\utility\killstreak::isjuggernaut() && scripts\mp\utility\game::getgametype() == "br" )
        var_6 = scripts\mp\gametypes\br_jugg_common.gsc::playersetomnvargulag();
    ...
    switch ( var_5 )
    {
        ...
        case "mg":
        case "rifle":
            if ( scripts\mp\utility\weapon::spawn_set_jugg_value( var_0.basename ) && scripts\mp\utility\game::getgametype() == "br" )
                var_1 = min( 50, var_1 );
            else
                var_1 = min( 20, var_1 );
...
spawn_para_and_heli_logic( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_0 ) && isplayer( var_0 ) && ( !isalive( var_0 ) || scripts\mp\utility\player::spawn_module_trickle( var_0 ) ) )
    {
...
spawn_default_player_spawns( var_0 )
{
...
_id_12EF0( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) && isdefined( var_0 ) )
    {
        if ( var_4 & level.scriptable_door_get_in_radius )
            var_5 = "lHandWeap";
        else
            var_5 = "rHandWeap";

        if ( !isdefined( var_1._id_11BEC ) )
            var_1._id_11BEC = [];

        var_6 = "" + var_0 getentitynumber();
        var_7 = gettime();

        foreach ( var_13, var_9 in var_1._id_11BEC )
        {
            foreach ( var_12, var_11 in var_9 )
            {
                if ( ( var_7 - var_11.time ) / 1000 > 0.1 )
                {
                    var_1._id_11BEC[var_13] = scripts\engine\utility::array_remove_key( var_1._id_11BEC[var_13], var_12 );

                    if ( var_1._id_11BEC[var_13].size == 0 )
                        var_1._id_11BEC = scripts\engine\utility::array_remove_key( var_1._id_11BEC, var_13 );
                }
            }
        }

        if ( !isdefined( var_1._id_11BEC[var_5] ) )
            var_1._id_11BEC[var_5] = [];

        if ( !isdefined( var_1._id_11BEC[var_5][var_6] ) )
        {
            var_1._id_11BEC[var_5][var_6] = spawnstruct();
            var_1._id_11BEC[var_5][var_6].time = var_7;
            var_1._id_11BEC[var_5][var_6]._id_11BEB = [];
        }

        var_14 = post_loadout_spawn_func( var_1, var_2 );
        var_15 = var_1._id_11BEC[var_5][var_6]._id_11BEB;

        if ( var_1._id_11BEC[var_5][var_6]._id_11BEB.size >= var_14 )
        {
            if ( getdvarint( "scr_spread_use_highest_damage_pellets", 0 ) )
            {
                foreach ( var_18, var_17 in var_1._id_11BEC[var_5][var_6]._id_11BEB )
                {
                    if ( var_3 > var_17 )
                    {
                        var_1._id_11BEC[var_5][var_6]._id_11BEB[var_18] = var_3;
                        var_1._id_11BEC[var_5][var_6]._id_11BEB = scripts\engine\utility::array_sort_with_func( var_1._id_11BEC[var_5][var_6]._id_11BEB, ::skipprematch );
                        return var_3 - var_17;
                    }
                }
            }
        ...
        {
            var_1._id_11BEC[var_5][var_6]._id_11BEB = scripts\engine\utility::array_add( var_1._id_11BEC[var_5][var_6]._id_11BEB, var_3 );
            var_1._id_11BEC[var_5][var_6]._id_11BEB = scripts\engine\utility::array_sort_with_func( var_1._id_11BEC[var_5][var_6]._id_11BEB, ::skipprematch );
        }
    }
...
post_loadout_spawn_func( var_0, var_1 )
{
...
applystoppingpower( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_6 == 2 )
    {
        if ( _id_130C0( var_0, var_1, var_2, var_3 ) )
            return var_5;
        else
            return 0.9 * var_5;
    }
...
_id_130C0( var_0, var_1, var_2, var_3 )
{
...
killstreakdamagefilter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.onsupportboxusedbyplayer ) )
        var_5 = [[ level.onsupportboxusedbyplayer ]]( var_0, var_1, var_2, var_3, var_4 );
...
handlefriendlyfiredamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13 )
{
    ...
    if ( level.friendlyfire != 0 )
    {
        if ( level.maxallowedteamkills == -1 )
            ...
            var_14 = istrue( var_2.spawn_killstreak_package_on_ground ) || istrue( var_2.isdefusing ) || istrue( var_2.isplanting );

        var_15 = spawn_lmg_soldiers_05( var_1 );
    ...
    else if ( level.friendlyfire == 1 )
    {
        ...
        trial_white_phosphorus( var_2, var_1, var_3, var_5 );
...
vehicle_mp_deletenextframe( var_0, var_1 )
{
    var_2 = scripts\mp\utility\weapon::getweaponrootname( var_1.basename );
...
vehicle_occupancy_cp_updateriotshield( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
    {
        if ( soldier_agent_lwfn9( var_0, var_4 ) )
        {
            if ( var_2.health > 0 && var_3 >= var_2.health )
                var_3 = var_2.health - 1;
        }
        else if ( isdefined( var_0._id_12ED6 ) )
        {
            if ( !isdefined( var_1._id_12ED1 ) )
                var_1._id_12ED1 = [];

            var_5 = "" + var_2 getentitynumber();
            var_6 = gettime();
            var_1._id_12ED1[var_5] = spawnstruct();
            var_1._id_12ED1[var_5].time = var_6;
            var_1._id_12ED1[var_5].scriptedphysicaldofenabled = var_0._id_12ED6.basename;
        }
        else if ( isdefined( var_1._id_12ED1 ) )
        {
            var_6 = gettime();

            foreach ( var_9, var_8 in var_1._id_12ED1 )
            {
                if ( var_6 != var_8.time )
                    var_1._id_12ED1 = scripts\engine\utility::array_remove_key( var_1._id_12ED1, var_9 );
            }

            var_9 = "" + var_2 getentitynumber();

            if ( scripts\engine\utility::array_contains_key( var_1._id_12ED1, var_9 ) && var_1._id_12ED1[var_9].scriptedphysicaldofenabled == var_0.basename )
            {
                var_3 = 0;
                var_1._id_12ED1 = scripts\engine\utility::array_remove_key( var_1._id_12ED1, var_9 );
            }

            if ( var_1._id_12ED1.size == 0 )
                var_1._id_12ED1 = undefined;
        }
    }
...
vehicle_damage_onexitstatemedium( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::isanymlgmatch() && isdefined( var_0 ) && isplayer( var_0 ) && !nullweapon( var_3 ) && scripts\mp\utility\weapon::isprimaryweapon( var_3 ) && scripts\engine\utility::isbulletdamage( var_2 ) && vehicle_damage_onenterstatemedium( var_4 ) )
    {
...
vehicle_occupancy_cp_giveriotshield( var_0, var_1, var_2 )
{
    var_3 = var_1;
    ...
    {
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
            var_3 = var_0 scripts\mp\juggernaut::start_silo_jump();
    }

    return var_3;
}

vehicle_occupancy_friendlystatuschangedcallback( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_3;
    ...
    if ( isdefined( var_0 ) && var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() )
    {
        if ( var_2 scripts\mp\utility\killstreak::isjuggernaut() )
            var_5 = var_2 scripts\mp\juggernaut::start_silo_thrust( var_3, var_4 );
    }
...
vehicle_occupancy_forceweaponswitchallowed( var_0, var_1 )
{
    ...
    if ( isdefined( var_3 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_damage::_id_138B2( var_3, var_0, var_1 );

    return var_2;
}

vehicle_occupancy_cleanfriendlystatus( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_3;
    ...
    if ( isdefined( var_4 ) && var_4 == "MOD_CRUSH" )
    {
        if ( isdefined( var_0 ) && isdefined( var_1 ) && var_0 == var_1 && var_1 scripts\mp\utility\killstreak::isjuggernaut() && var_2 scripts\mp\utility\killstreak::isjuggernaut() )
            var_5 = var_2 scripts\mp\juggernaut::start_silo_jump_menu( var_3 );
    }
...
{
    var_3 = vehicle_mp_createlate( var_3, var_6 );
    var_3 = vehicle_mp_deletenextframe( var_3, var_6 );
    var_3 = vehicle_damage_onexitstatemedium( var_1, var_3, var_5, var_6, var_9 );
    var_3 = vehicle_occupancy_cp_giveriotshield( var_2, var_3, var_5 );
    var_3 = vehicle_occupancy_friendlystatuschangedcallback( var_0, var_1, var_2, var_3, var_5 );
    var_3 = vehicle_occupancy_forceweaponswitchallowed( var_2, var_3 );
    var_3 = vehicle_occupancy_cleanfriendlystatus( var_0, var_1, var_2, var_3, var_5 );
    var_3 = vehicle_occupancy_cp_updateriotshield( var_6, var_1, var_2, var_3, var_5 );
    ...
    {
        if ( istrue( var_6.isalternate ) && scripts\mp\weapons::spawn_acceleration( var_6.underbarrel ) )
        {
...
{
    if ( var_8 != "shield" || istrue( var_2.remaphardpointorder ) )
        return var_3;
    ...
    if ( var_4 == "MOD_PISTOL_BULLET" || var_4 == "MOD_RIFLE_BULLET" || var_4 == "MOD_EXPLOSIVE_BULLET" )
    {
        ...
        var_1 scripts\mp\utility\stats::incpersstat( "riotShieldDamageAbsorbed", var_14 );
        ...
        if ( var_1.shieldbullethits >= level.riotshieldxpbullets && var_19 )
        {
            ...
            var_1 thread scripts\mp\utility\points::giveunifiedpoints( "shield_damage", var_1.currentweapon, var_21 * var_20 );
    ...
    else if ( istrue( var_2.remaphardpointorder ) )
        return var_3;
    else
        return 0;
...
filterdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( scripts\cp_mp\vehicles\vehicle::_id_1394F( var_0, var_2, var_4, var_5 ) )
...
logattacker( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.owner ) && isplayer( var_1.owner ) )
    {
        var_10 = var_2.owner.team != var_0.team || level.friendlyfire == 1;

        if ( var_10 && !istrue( var_2.owner._id_137E8 ) && !isdefined( self.attackerdata[var_2.owner.guid] ) )
...
handledamagefeedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 != var_2 && var_3 + var_8 + var_9 > 0 && ( !isdefined( var_6 ) || var_6 != "shield" ) )
    {
        ...
        else if ( var_2 _meth_87D1() )
            var_13 = "hitlaststand";
        else if ( istrue( var_2._id_12C05 ) && !armorvest_wasbroke( var_1 ) )
        ...
        var_18 = !splashtime_drops( var_5 ) && scripts\mp\utility\damage::isheadshot( var_6, var_4, var_1 );
        var_19 = 1;
        var_20 = var_4 == "MOD_MELEE";
        var_21 = "" + var_2 getentitynumber();
        var_22 = 0;

        if ( !var_17 && splashtime_drops( var_5 ) && isdefined( var_12._id_11BEC ) )
        {
            foreach ( var_24 in var_12._id_11BEC )
            {
                if ( isdefined( var_24[var_21] ) && var_24[var_21]._id_11BEB.size > 1 )
                    var_22 = 1;
            }
        }
...
lethalequipmentdamagemod( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( level._id_12ACA ) )
        var_3 = var_3 * [[ level._id_12ACA.playersplash ]]( var_0 );

    loggrenadedata( var_0, var_1, var_2, var_3, var_5, var_6 );
    var_1 scripts\common\utility::_id_13592( level.update_restock_ui, scripts\mp\utility\weapon::getweaponrootname( var_6 ), "damage", min( var_2.health, var_3 ), -1, var_6 );
    return var_3;
}
...
playerkilled_initdeathdata( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    var_12.disablewinonscore = undefined;
    return var_12;
}
...
playerkilled_fixupattacker( var_0 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            if ( istrue( var_0.victim._id_12F24 ) && isdefined( var_0.victim.attackerdata[var_2.guid].inflictor ) )
...
playerkilled_precalc( var_0 )
{
    ...
    var_0.disablewinonscore = scripts\mp\utility\player::spawn_module_trickle( var_2 );
}
...
playerkilled_sharedlogic_early( var_0 )
{
    ...
    if ( scripts\mp\utility\weapon::spawn_overwatch_soldiers_01( var_3 ) && isdefined( var_4 ) && var_4.basename == "none" )
    {
    ...
    var_2 scripts\mp\equipment\molotov::vehicle_occupancy_monitorturretcontrols();
    var_2 scripts\mp\equipment\throwing_knife_mp::_id_13303();
    var_2 scripts\cp\utility\script::_id_130A9();
    ...
    if ( var_1 != var_2 )
    {
        if ( isdefined( var_1.petwatch ) )
        {
            ...
            else if ( var_2 _id_11ED8( var_6, var_3 ) )
                var_1 scripts\cp_mp\pet_watch::assignedteam();
        }
        else if ( isdefined( var_2._id_11C0B ) )
            var_2 scripts\cp\vehicles\cargo_truck_mg_cp::onplayerkilled( var_1 );
    }
    ...
    {
        var_12 = [[ level.bot_funcs["get_attacker_ent"] ]]( var_1, var_3 );

        if ( isdefined( var_12 ) )
        {
            if ( scripts\mp\utility\entity::isaigameparticipant( var_2 ) )
                var_2 botmemoryevent( "death", var_0.weaponfullstring, var_12.origin, var_2.origin, var_12 );
            ...
            if ( scripts\mp\utility\entity::isaigameparticipant( var_1 ) )
            {
                ...
                if ( var_13 )
                    var_1 botmemoryevent( "kill", var_0.weaponfullstring, var_12.origin, var_2.origin, var_2 );
            }
        }
    }
    ...
    if ( scripts\mp\utility\game::isteamreviveenabled() && scripts\mp\flags::gameflag( "prematch_done" ) )
    {
        if ( var_6 == "MOD_FALLING" && var_2 scripts\mp\teamrevive::isvalidrevivetriggerspawnposition() )
            var_2 scripts\mp\teamrevive::_id_12AAC();
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        {
            var_2 scripts\cp\utility\cp_controlled_callbacks::_id_130A3( "alive_in_gas" );
            var_2 scripts\cp\utility\cp_controlled_callbacks::_id_130A3( "alive_not_downed" );

            if ( istrue( level.br_prematchstarted ) && !scripts\mp\gametypes\br_public.gsc::isplayeringulag() )
                scripts\mp\gametypes\br_analytics.gsc::custom_helicopter_firendly_dmg_func( self, "player_death" );
        }
    }
    ...
    if ( !var_17 )
    {
        if ( !isdefined( level.vehicle_damage_visualwatchspeedchange ) || [[ level.vehicle_damage_visualwatchspeedchange ]]( var_2 ) )
            var_2 scripts\mp\playerlogic::removefromalivecount( 0, "playerKilled" );
    }
    ...
    if ( isdefined( var_0.idflags ) && var_0.idflags & level.idflags_penetration && !( var_0.idflags & level.scriptable_door_freeze_open ) )
    {
        if ( isdefined( var_1.bulletkillsinaframecount ) && var_1.bulletkillsinaframecount == 0 )
        {
            ...
            if ( isplayer( var_1 ) )
            {
                ...
                {
                    var_19 = scripts\mp\rank::getscoreinfovalue( "penetration_kill" ) * getdvarfloat( "scr_gunperk_driller_xp_bonus", 2.0 );
                    var_1 thread scripts\mp\utility\points::quarry_mortar_guys( "penetration_kill", var_19 );
                }
                else
                    var_1 thread scripts\mp\utility\points::quarry_mortar_guys( "penetration_kill" );
            }
        }
    }
    ...
    if ( isdefined( var_0.inflictor ) && ( istrue( var_0.inflictor.stack_patch_waittill_node ) || istrue( var_0.inflictor.stack_patch_waittill_leaf ) ) )
        var_18 = "MOD_CRUSH";
    ...
    if ( level.gametype == "br" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            var_21 = scripts\mp\gametypes\br_public.gsc::postplunder( var_2.team, var_2.squadindex );
        ...
        if ( isdefined( var_1 ) && isplayer( var_1 ) )
        {
            var_22 = scripts\mp\gametypes\br_public.gsc::postplunder( var_1.team, var_1.squadindex );
        ...
        if ( var_20.size > 0 )
        {
            var_23 = scripts\engine\utility::ter_op( scripts\cp_mp\vehicles\vehicle::_id_13857( var_0 ), "MOD_EXPLOSIVE", var_18 );

            if ( getdvarint( "scr_br_alt_mode_zxp", 0 ) || getdvarint( "scr_br_alt_mode_gxp", 0 ) )
                var_23 = scripts\mp\gametypes\br_gametype_zxp.gsc::usedprops( var_0, var_23 );
    ...
    {
        if ( var_2.pers["shortestLife"] == 0 || var_25 < var_2.pers["shortestLife"] )
            var_2.pers["shortestLife"] = var_25;
    }

    if ( isdefined( var_2.pers["shortestLife"] ) )
    {
        if ( var_2.pers["longestLife"] == 0 || var_25 > var_2.pers["longestLife"] )
            var_2.pers["longestLife"] = var_25;
    }
}
...
playerkilled_logkill( var_0 )
{
    ...
    var_6 = var_0.meansofdeath;
    var_7 = var_0.lifeid;
    var_2 scripts\common\utility::_id_13592( level.getitemdropinfo, var_1 );

    if ( !istrue( level.ignorescoring ) )
        var_2 scripts\common\utility::_id_13592( level.update_operator_west_char_loc, var_7, var_1, var_0.damage, var_6, var_5, var_0.primaryweapon, var_0.hitloc, var_4 );
    ...
    if ( isdefined( level.matchrecording_logeventmsg ) && isdefined( var_3 ) && isplayer( var_3 ) && scripts\engine\utility::isbulletdamage( var_6 ) )
    {
        ...
        if ( !isdefined( var_2.lootchopper_initcircleinfo ) )
        {
            var_2.lootchopper_initcircleinfo = 0;
            var_2.lootchopper_handledeathdamage = 0;
        }

        var_2.lootchopper_initcircleinfo = var_2.lootchopper_initcircleinfo + var_16;
        var_2.lootchopper_handledeathdamage++;
...
playerkilled_sharedlogic_late( var_0 )
{
    ...
    thread scripts\cp\utility\cp_controlled_callbacks::ondeath( var_0.inflictor, var_0.attacker, var_0.damage, var_0.damageflags, var_0.meansofdeath, var_0.objweapon, var_0.hitloc, var_0.attacker.modifiers );
...
playerkilled_handlecorpse( var_0 )
{
    ...
    if ( !isdefined( self.nocorpse ) && !istrue( var_2._id_12BE2 ) )
        var_2.body = var_2 cloneplayer( var_0.deathanimduration, var_1 );

    if ( !isdefined( self.nocorpse ) && !istrue( var_2._id_12BE2 ) && isdefined( var_2.body ) )
    {
    ...
    else if ( isdefined( var_2.nocorpse ) && !istrue( var_2._id_12BE2 ) )
    {
...
_startragdoll( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
    {
        ...
        if ( var_11 || var_12 )
        {
            ...
            var_0.trackedlittlebirds = scripts\cp_mp\vehicles\vehicle_occupancy::_id_13935( var_6, var_8 );
        }
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            var_0 thread airstrikeid( var_6, var_8, var_9, var_10, var_5, var_4 );
            var_0 notify( "cancel_delete_corpse" );
            scripts\cp_mp\vehicles\vehicle_occupancy::_id_1391A( var_0, var_6, var_8 );
        }
        else
        {
            if ( !var_0 isragdoll() )
            ...
            var_0 thread add_rider_to_decho( var_9, var_10, var_5, var_4 );
        }
    }
}

add_rider_to_decho( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
...
airstrikeid( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self;
    ...
    if ( isdefined( var_6 ) )
    {
        if ( isdefined( var_6.trackedlittlebirds ) && isdefined( var_0 ) )
        {
            var_11 = ( 0, 0, 0 );
            var_12 = scripts\cp_mp\vehicles\vehicle_occupancy::_id_13935( var_0, var_1 );
            var_11 = var_12.origin - var_6.trackedlittlebirds.origin;
        ...
        var_6 thread add_rider_to_decho( var_2, var_3, var_4, var_5 );
    }
}

airduct_locations( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) )
        return;
...
playerkilled_deletecorpseoutofvehicle( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_1 scripts\engine\utility::_id_13AED( var_3, "death" );

    if ( isdefined( var_0 ) )
        var_0 delete();
}

_id_11ED8( var_0, var_1 )
{
    if ( var_0 != "MOD_CRUSH" )
        return 0;
...
playerkilled_killcam( var_0 )
{
    ...
    if ( getdvarint( "scr_killcam_on_down", 1 ) && isdefined( var_1.victim.target_remap_key_value_pairs ) )
    {
        var_1 = var_1.victim.target_remap_key_value_pairs;
        var_1.victim.target_remap_key_value_pairs = undefined;
    ...
    if ( isdefined( level.vehicle_isenemytoteam ) )
        [[ level.vehicle_isenemytoteam ]]( var_1 );
...
{
    if ( isdefined( level.vehicle_deregisterturret ) && [[ level.vehicle_deregisterturret ]]( var_0, 1 ) )
        return;
...
handlefriendlyfiredeath( var_0, var_1 )
{
    ...
    if ( var_3 > 0 )
    {
        ...
        if ( var_0 scripts\mp\utility\player::isusingremote() )
            var_0 thread scripts\mp\utility\damage::_id_1312E();
        else
            var_0 thread scripts\mp\utility\damage::_id_1312D();
    }
...
handleinlaststanddeath( var_0 )
{
    ...
    if ( isdefined( self.target_group ) )
        self.target_group _id_11EC5();

    if ( isdefined( self.target_group ) && var_0.attacker != self.target_group )
    {
        thread scripts\cp\utility\cp_controlled_callbacks::onplayerkilled( self.target_group, self.target_group, 0, var_0.damageflags, self.targetdata, self.targetoverride, var_0.hitloc, self.target_located, self.target_pity_outline_think );
        self.target_group thread scripts\mp\rank::scoreeventpopup( "kill_confirmed" );
    }
    ...
    self.target_group = undefined;
    self.targetdata = undefined;
    self.targetoverride = undefined;
    self.target_located = undefined;
    self.target_pity_outline_think = undefined;
}
...
handlenormaldeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !istrue( level.disablestattracking ) )
    {
        ...
        var_5 thread scripts\cp\utility\cp_controlled_callbacks::onplayerkilled( var_2, var_1, var_7.damage, var_7.damageflags, var_4, var_3, var_7.hitloc, var_9, var_10 );
        var_5.target_play_death_anim = undefined;
        ...
        if ( isdefined( var_2 ) && istrue( var_2.isequipment ) )
        {
            switch ( var_2.equipmentref )
            {
                ...
                case "equip_throwing_knife":
                    ...
                    var_1 scripts\cp_mp\pet_watch::assertcirclesettings();
                    break;
                case "equip_c4":
    ...
    if ( !istrue( var_11.pers["ignoreWeaponMatchBonus"] ) && ( scripts\mp\utility\weapon::iscacprimaryweapon( var_3 ) || scripts\mp\utility\weapon::iscacsecondaryweapon( var_3 ) ) )
    {
        ...
        if ( var_11.pers["weaponMatchBonusKills"] > scripts\mp\weaponrank::playerpowershud() )
        {
        ...
        else
        {
            ...
            if ( !var_13 )
            {
                ...
                var_15._id_11A5D = var_11.pers["killsPerWeapon"].size;
    ...
    if ( !var_6 && !scripts\mp\utility\weapon::spawn_overwatch_soldiers_01( var_2 ) || scripts\mp\utility\points::spawn_lmg_soldiers_04( var_3 ) )
    {
    ...
    if ( istrue( var_1.inlaststand ) )
        var_1 thread scripts\mp\laststand::_id_1198E( var_7 );
    ...
    if ( isdefined( self.attackers ) )
    {
        foreach ( var_24 in self.attackers )
        {
            ...
            if ( isdefined( self.target_group ) && self.target_group == var_24 )
                continue;
    ...
    if ( level.teambased )
    {
        ...
        if ( istrue( var_32 ) && getdvarint( "scr_uav_for_squad_only", 1 ) && isdefined( var_1.squadindex ) && isdefined( var_1.team ) )
            var_31 = var_1.team + var_1.squadindex;
        ...
        if ( isdefined( var_31 ) && isdefined( level.uavmodels ) && isdefined( level.uavmodels[var_31] ) && level.uavmodels[var_31].size > 0 )
        {
            ...
            foreach ( var_35 in level.uavmodels[var_31] )
            {
                if ( isdefined( var_35 ) && isdefined( var_35.owner ) && var_35.owner != var_1 && !scripts\engine\utility::array_contains( var_33, var_35.uavtype ) )
                {
                    ...
                    if ( !isdefined( var_35.buttonmashcount ) )
                        var_35.buttonmashcount = 0;

                    var_38 = scripts\engine\utility::ter_op( var_35.uavtype == "directional_uav", 15, 10 );

                    if ( var_35.buttonmashcount < var_38 )
                        ...
                        var_35.owner thread scripts\mp\utility\points::quarry_mortar_guys( var_36, var_37 );

                    var_35.buttonmashcount++;
                    ...
                    scripts\cp\utility\cp_controlled_callbacks::processuavassist( var_35.owner, var_35.uavtype );
            ...
            foreach ( var_41 in level.supportdrones )
            {
                if ( level.teambased && var_41.team == var_1.team && var_41.owner != var_1 )
                {
                    if ( isdefined( var_41.enemiesmarked ) && isdefined( var_41.enemiesmarked[self getentitynumber()] ) )
                    {
                        ...
                        var_1 scripts\cp\utility\cp_controlled_callbacks::_id_119B9();
                    }
                }
                ...
                if ( var_41.helperdronetype == "scrambler_drone_guard" )
                {
                    if ( var_1 != var_41.owner )
                    {
                        ...
                        if ( !isdefined( var_41.buttonmashcount ) )
                            var_41.buttonmashcount = 0;

                        if ( var_41.buttonmashcount < 10 )
                            ...
                            var_41.owner thread scripts\mp\utility\points::quarry_mortar_guys( var_36 );

                        var_41.buttonmashcount++;
                    ...
                    {
                        if ( !istrue( var_1._id_124D6 ) )
                        {
                            var_1 scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_kill_scrambled_enemies_s1", 1 );
                            continue;
                        }

                        var_1._id_124D6 = undefined;
                    }
                }
            }
        }

        _calloutmarkerping_poolidisdanger::checkifteamrewardsareenabled( var_1, self );
        ...
        if ( isdefined( var_1.team ) && isdefined( level.activewpzones ) && level.activewpzones.size > 0 )
        {
            ...
            if ( var_1.team == var_45 && var_1 != var_44 )
            {
                if ( istrue( var_5.wpdisorient ) || istrue( var_5.wpburning ) )
                {
                    ...
                    if ( !isdefined( var_43.buttonmashcount ) )
                        var_43.buttonmashcount = 0;

                    if ( var_43.buttonmashcount < 15 )
                        ...
                        var_44 thread scripts\mp\utility\points::quarry_mortar_guys( var_36 );

                    var_43.buttonmashcount++;
...
resetplayervariables()
{
    ...
    self.hideplacementuntilpercent = 0;
    self.useshouldsucceedcallback = 0;
    self._id_12C24 = 0;
    self.removematchingents_bymodel = 0;
    self.fulton_ac130_model = undefined;

    if ( !isdefined( self.carepackage_glowsticks ) )
        self._id_1196D = 0;

    self.store_platform_models = undefined;
    self.strafe = undefined;
    self.str = undefined;
    self.strafe_acceleration = undefined;
    self.stopusingbomb = undefined;
    self._id_12153 = undefined;
    self._id_12154 = undefined;
    self._id_13CA7 = undefined;
    self.make_bomb_detonator_interact = undefined;
    self.toggle_custom_death_anim_settings = undefined;
    self._id_13385 = undefined;
    self._id_11C71 = undefined;
    self.bullet = undefined;
    self._id_137DD = undefined;
    self.target_group = undefined;
    self.target_located = undefined;
    self.target_pity_outline_think = undefined;
    self._id_122C4 = undefined;
    self.freight_lift_attacker_internal = undefined;
    self.throwingknifekillthislife = undefined;
...
addattacker( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_0.attackerdata[var_1.guid].vehicle_isfriendlytoteam = var_1 scripts\mp\events::playerbrsquadleaderscore( 0, var_0, var_3, var_9, var_2 );
    var_0.attackerdata[var_1.guid].vehicle_isneutraltoplayer = var_1 scripts\mp\events::playercanbuyrespawn( 0, var_0, var_3, var_9, var_2 );
...
addattackerkillstreak( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    var_0.attackerdata[var_2.guid].vehicle_isfriendlytoteam = 0;
    var_0.attackerdata[var_2.guid].vehicle_isneutraltoplayer = 0;
...
recordattackerdamagestats( var_0, var_1, var_2, var_3 )
{
    if ( _id_12B3E( self ) )
    {
        var_0 scripts\mp\utility\stats::incpersstat( "damage", var_1 );

        if ( !isdefined( var_0.hvt_can_lose_health ) )
            var_0.hvt_can_lose_health = var_1;
        else
            var_0.hvt_can_lose_health = var_0.hvt_can_lose_health + var_1;

        if ( scripts\mp\codcasterclientmatchdata::shouldlogcodcasterclientmatchdata() )
        {
            if ( isplayer( var_0 ) )
            {
                var_0 scripts\common\utility::_id_13592( level.update_restock_ui, scripts\mp\utility\weapon::getweaponrootname( var_3 ), "damage", min( self.health, var_2 ), -1, var_3 );
        ...
        var_0 [[ level.zombievehiclelaststand ]]( var_1 );
}
...
finishplayerdamagewrapper( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    else if ( isdefined( var_0 ) && var_0 _calloutmarkerping_handleluinotify_added::isentityairplaneturret() )
    {
        ...
        if ( isdefined( var_15.owner ) && isplayer( var_15.owner ) )
            recordattackerdamagestats( var_15.owner, var_13, var_2, var_5 );
    }

    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_5 ) )
    {
        if ( scripts\mp\utility\killstreak::getkillstreaknamefromweapon( var_5 ) == "precision_airstrike" && istrue( level.stack_patch_waittill_root ) )
            return;
    }
    ...
    else
    {
        ...
        if ( isplayer( self ) )
        {
            ...
            var_18 = !( var_4 != "MOD_TRIGGER_HURT" && isdefined( self.spawn_queue_think ) );
            self finishplayerdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, 0.0, var_10, var_11, var_12, var_18 );
            bomber_radiusdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 );
        }
    }
...
callback_playerlaststand( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !istrue( var_9 ) )
    {
        ...
        if ( isdefined( level.vehicle_damage_setweaponhitdamagedata ) && !self [[ level.vehicle_damage_setweaponhitdamagedata ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 ) )
            return 0;
    }

    if ( isdefined( level._id_11AEA ) )
        self [[ level._id_11AEA ]]();
    ...
    if ( isdefined( var_1 ) && var_1.classname != "worldspawn" )
    {
        ...
        {
            self.target_group = var_1;
            self.targetdata = var_11.meansofdeath;
            self.targetoverride = var_4;
            var_1 thread scripts\mp\events::burningstate( var_10, self, var_4, var_3, var_0, var_11 );
            self.target_located = var_1.modifiers["mask"];
            self.target_pity_outline_think = var_1.modifiers["mask2"];
        }
        ...
        if ( getdvarint( "scr_killcam_on_down", 1 ) )
            self.target_remap_key_value_pairs = var_11;
        ...
        if ( !var_11.isfriendlyfire && var_1 != self )
        {
            if ( scripts\mp\utility\game::getgametype() == "br" )
            {
                if ( isplayer( var_1 ) && var_1 != self )
                {
                    ...
                    if ( var_13 )
                    {
                        if ( isdefined( var_1.bot_default_class_random ) )
    ...
    scripts\common\utility::bot_loadout_team( 0 );

    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder.gsc::_id_12058( self, 0, 1 );
    ...
    {
        if ( [[ level.gas_triggers_init ]]( self ) )
            return 0;
    }
...
damageshellshockandrumble( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !isai( self ) && scripts\common\utility::getdamagetype( var_2 ) != "bullet" )
    {
        ...
        if ( isdefined( var_0 ) && istrue( var_0.stack_patch_waittill_node ) )
        {
            self playsound( "train_veh_impact_body" );

            if ( isdefined( level._id_13D06._id_13424 ) )
            {
                var_6 = level._id_13D06._id_13424[0].track_get_reward_time_string;
...
gamemodemodifyplayerdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( isdefined( var_2 ) && isplayer( var_2 ) && isalive( var_2 ) )
    {
        ...
        if ( istrue( level.registeraccesscardlocs ) && scripts\mp\utility\game::getgametype() == "infect" && isdefined( var_5 ) )
        {
...
monitordamageoneshot( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    if ( isdefined( var_1 ) && !scripts\mp\utility\entity::isgameparticipant( var_1 ) && !istrue( var_1._id_11A97 ) )
        return 1;
    ...
    if ( !istrue( self._id_12BED ) && scripts\mp\utility\damage::non_player_should_ignore_damage( var_1, var_9, var_10, var_4 ) )
        return 1;
...
onkillstreakdamaged( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_4 ) )
        thread scripts\cp\utility\cp_controlled_callbacks::killstreakdamaged( var_0, self.owner, var_4, var_2, var_3 );
}
...
onkillstreakkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( var_10 ) )
    {
        ...
        thread scripts\cp\utility\cp_controlled_callbacks::killstreakkilled( var_0, self.owner, self, var_10, var_4, var_3, var_2, var_5 );
        scripts\cp_mp\gestures::processcalloutdeath( self, var_10 );
        var_9 = 1;
    }

    thread scripts\mp\events::_id_1217B( var_10 );
...
setdeathtimerlength( var_0 )
{
    ...
    if ( var_1 scripts\mp\playerlogic::mayspawn() && !level.isplayerinsiderectangularzone )
    {
...
{
    if ( scripts\mp\weapons::spawn_soldiers_in_convoy_truck( var_3 ) )
        enqueuecorpsetablefunc( "8bitDeath", scripts\mp\weapons::waittill_any_return_no_endon_death_5 );
    else if ( scripts\mp\weapons::spawn_spawners_multi( var_3 ) )
        enqueuecorpsetablefunc( "teslaDeath", scripts\mp\weapons::waittill_any_return_no_endon_death_6 );
}
...
_id_12B3E( var_0 )
{
    if ( istrue( level.iskingofthehillactive ) )
        return 0;

    if ( isdefined( level.iskioskfiresaleactiveforplayer ) && ![[ level.iskioskfiresaleactiveforplayer ]]( var_0 ) )
        return 0;

    return 1;
}

trial_white_phosphorus( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) || !isdefined( var_3 ) )
        return;

    var_4 = var_2 >= var_0.health;
    var_1 scripts\common\utility::_id_13592( level.update_restock_ui, scripts\mp\utility\weapon::getweaponrootname( var_1.currentweapon ), "friendly_fire_damage", int( min( var_2, var_0.health ) ), -1, var_1.currentweapon );
...
bomber_radiusdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    var_14 = isdefined( var_5 ) && var_5.basename == "little_bird_mp";

    if ( !istrue( var_14 ) && !var_1 _calloutmarkerping_handleluinotify_added::spawn_guys_into_truck() && !var_1 _branalytics_headerplayerposrow::spawn_headicon() )
        return;

    if ( !isdefined( var_1.bot_ctf_player_always_attacker ) )
        var_1.bombers_spawn_manager = [ "run_over_driverless", 0, "run_over", 0, "airplane_explode", 0, "bomb", 0, "bomber_turret", 0, "dauntless", 0, "dauntless_ads", 0, "self_elimination", 0, "other", 0 ];
    ...
    else if ( ( var_1 _calloutmarkerping_handleluinotify_added::spawn_guys_into_truck() || var_1 _branalytics_headerplayerposrow::spawn_headicon() ) && var_4 == "MOD_CRUSH" )
    {
    ...
    else if ( isdefined( var_5 ) && var_5.basename == "tur_gun_fd_mp" )
        var_16 = "dauntless";
    ...
    switch ( var_16 )
    {
        case "run_over_driverless":
            var_1.bombers_spawn_manager[1] = var_1.bombers_spawn_manager[1] + 1;
            break;
        case "run_over":
            var_1.bombers_spawn_manager[3] = var_1.bombers_spawn_manager[3] + 1;
            break;
        case "airplane_explode":
            var_1.bombers_spawn_manager[5] = var_1.bombers_spawn_manager[5] + 1;
            break;
        case "bomb":
            var_1.bombers_spawn_manager[7] = var_1.bombers_spawn_manager[7] + 1;
            break;
        case "bomber_turret":
            var_1.bombers_spawn_manager[9] = var_1.bombers_spawn_manager[9] + 1;
            break;
        case "dauntless":
            var_1.bombers_spawn_manager[11] = var_1.bombers_spawn_manager[11] + 1;
            break;
        case "dauntless_ads":
            var_1.bombers_spawn_manager[13] = var_1.bombers_spawn_manager[13] + 1;
            break;
        case "self_elimination":
            var_1.bombers_spawn_manager[15] = var_1.bombers_spawn_manager[15] + 1;
            break;
        case "other":
            var_1.bombers_spawn_manager[17] = var_1.bombers_spawn_manager[17] + 1;
            break;
        default:
            break;
    }

    var_1.bombers_spawn_manager[var_1.bombers_spawn_manager.size] = "last_victim_ent_num";
    var_1.bombers_spawn_manager[var_1.bombers_spawn_manager.size] = var_13 getentitynumber();

    if ( isplayer( var_1 ) )
        var_1 dlog_recordplayerevent( "dlog_event_plane_kill_type", var_1.bombers_spawn_manager );
    else if ( isdefined( var_1.owner ) && isplayer( var_1.owner ) )
        var_1.owner dlog_recordplayerevent( "dlog_event_plane_kill_type", var_1.bombers_spawn_manager );
}
