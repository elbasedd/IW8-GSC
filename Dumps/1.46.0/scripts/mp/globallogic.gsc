...
init()
{
    ...
    level.unset_relic_doubletap = getdvarint( "scr_map_use10v10_objectives", 0 );
    level.teambased = 0;
...
_id_123C3()
{
    if ( ( scripts\mp\utility\game::getgametype() == "arm" || scripts\mp\utility\game::spawn_ml_p2_player_heli() || scripts\mp\utility\game::ss_playerdisconnect() ) && getdvarint( "scr_game_forceDefaultFallHeight", 0 ) != 1 )
    {
...
setupcallbacks()
{
    ...
    scripts\cp_mp\vehicles\vehicle_collision::register_ai_damage_callbacks();
}

setdefaultcallbacks()
{
    level.callbackstartgametype = scripts\mp\gamelogic::callback_startgametype;
    level.entmantlingendtime = scripts\mp\playerlogic::entityhittype;
