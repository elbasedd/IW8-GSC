...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13AEB( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
...
watchforplayermovementevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13AE9( "doubleJumpBegin", "doubleJumpEnd", "sprint_slide_begin" );
...
watchforusermessageevents()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_13AE1( "log_user_event_end", "log_user_event_generic_event" );
...
trial_ui_set_combo_bar_combo( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        return;
...
trial_weapon_defined( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "";
...
trial_updatehitmarker( var_0, var_1 )
{
...
trial_turret_kill_func( var_0, var_1, var_2, var_3 )
{
