...
init()
{
    ...
    level.spotlight_model = 0;

    if ( var_3 == "sd" || var_3 == "cyber" || var_3 == "arena" )
        level.spotlight_model = 1;
...
onplayerspawned()
{
    ...
    self.change_keypad_display_digit = 0;
    ...
    if ( !level.teambased || level.spotlight_model || istrue( level.disablebattlechatter ) || scripts\mp\utility\game::isanymlgmatch() )
        self.bcdisabled = 1;
    else
    {
        if ( !scripts\mp\utility\game::runleanthreadmode() || istrue( level.current_carrier ) )
        {
...
dosound( var_0, var_1 )
{
    ...
    {
        if ( isdefined( self.operatorcustomization.maphint_cheesescriptableused ) && self.operatorcustomization.maphint_cheesescriptableused != "" )
            var_2 = self.operatorcustomization.maphint_cheesescriptableused;
        else
        {
            var_4 = self.operatorcustomization.maphint_cheese2scriptableused;
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        _id_11D48( var_7, var_8, var_0, var_6, var_5 );
    else if ( self issplitscreenplayer() )
        _id_11D49( var_7, var_8, var_0, var_6, var_5 );
    else
        _id_11D47( var_7, var_8, var_0, var_6, var_5 );
    ...
    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        ...
        if ( soundexists( var_11 ) )
        {
            ...
            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                _id_11D48( 1, 1, var_12, undefined, var_11, var_13 );
            else if ( self issplitscreenplayer() )
                _id_11D49( 1, 1, var_12, undefined, var_11, var_13 );
            else
                _id_11D47( 1, 1, var_12, undefined, var_11, var_13 );
        }
    }
    ...
    scripts\engine\utility::_id_13AD9( var_5, "death_or_disconnect" );
    level removespeaker( self, var_15 );
    return 1;
}

_id_11D47( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
_id_11D48( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
_id_11D49( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
{
    var_2 = scripts\engine\utility::_id_13AE1( var_0, "death_or_disconnect" );
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    if ( !isdefined( level.tank_die_from_turret_damage ) )
        level.tank_die_from_turret_damage = [];

    level.tank_die_from_turret_damage[var_1] = var_2;
}
...
plane( var_0 )
{
    if ( isdefined( level.tank_die_from_turret_damage ) && isdefined( level.tank_die_from_turret_damage[var_0] ) )
        return level.tank_die_from_turret_damage[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.current_carrier ) )
        return;
    ...
    if ( gettime() > var_0.change_keypad_display_digit + level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        var_0.bcinfoqueued = "none";
        var_0.change_keypad_display_digit = 0;
    }

    if ( comparesoundpriorities( var_1, var_0.bcinfoqueued ) )
    {
        var_0.bcinfoqueued = var_1;
        var_0.change_keypad_display_digit = gettime();
    }
    else
        return;
...
saylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    while ( var_0 <= level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        ...
        {
            var_5 = gettime();
            var_4["higher"]["player"] scripts\engine\utility::_id_13ADA( var_4["higher"]["sound_alias"], "death", "disconnect" );
            waitframe();
