...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "gunship", "getBombingPoint", ::rear_spotlight_reach_goal_node_dist_sq );
...
rear_spotlight_reach_goal_node_dist_sq( var_0, var_1 )
{
    var_2 = scripts\cp_mp\killstreaks\toma_strike::_id_1337F( var_0, var_1 );
    return var_2.point;
}
