...
starthelicopter( var_0, var_1 )
{
    ...
    scripts\common\utility::_id_13592( level.update_objective_ownerclient, var_3, self.origin );
...
heli_existance()
{
    ...
    scripts\engine\utility::_id_13ADA( "death", "crashing", "leaving" );
...
fireontarget( var_0 )
{
    ...
    scripts\engine\utility::_id_13AED( 4, "facing" );
    ...
    scripts\engine\utility::_id_13AED( 3, "near_goal" );
}
...
heli_leave( var_0 )
{
    ...
    if ( isdefined( self.helitype ) && self.helitype == "osprey" && isdefined( self.pathgoal ) )
    {
        ...
        scripts\engine\utility::_id_13AED( 5, "goal" );
    }
    ...
    scripts\engine\utility::_id_13AED( 12, "goal" );
    self notify( "gone" );
    self notify( "death" );
    waitframe();
