...
tryuseautosentry( var_0, var_1 )
{
    ...
    if ( var_2 )
        scripts\common\utility::_id_13592( level.update_objective_ownerclient, level.sentrysettings["sentry_minigun"].streakname, self.origin );
...
tryusesam( var_0, var_1 )
{
    ...
    if ( var_2 )
        scripts\common\utility::_id_13592( level.update_objective_ownerclient, level.sentrysettings["sam_turret"].streakname, self.origin );
...
tryuseshocksentry( var_0 )
{
    ...
    if ( var_1 )
        scripts\common\utility::_id_13592( level.update_objective_ownerclient, var_0.streakname, self.origin );
    else
        waitframe();
...
setcarryingsentry( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        var_4 = scripts\engine\utility::_id_13AE3( "place_sentry", "cancel_sentry", "force_cancel_placement", "emp_applied" );
...
sentry_oncarrierdeathoremp( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_13AD9( "death", "emp_applied" );
...
sentry_oncarrierchangedteam( var_0 )
{
    self endon( "placed" );
    self endon( "death" );
    var_0 scripts\engine\utility::_id_13AD9( "joined_team", "joined_spectators" );
    self delete();
}
...
sentryshocktargets()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13AED( 1, "turret_on_target" );
...
marktargetlaser( var_0 )
{
    ...
    self laseron();
    self.laser_on = 1;
    scripts\engine\utility::_id_13AD9( "done_firing", "carried" );
    self laseroff();
    self.laser_on = 0;
}
