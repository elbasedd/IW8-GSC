...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "playOperatorUseLine", ::jugg_playoperatoruseline );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "canReload", scripts\mp\juggernaut::start_player_links );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "canUseWeaponPickups", scripts\mp\juggernaut::start_preserverroom_spawners );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "juggernaut", "getMinigunWeapon", scripts\mp\juggernaut::start_safehouse_gunshop );
}
...
jugg_cantriggerjuggernaut( var_0 )
{
    ...
    if ( scripts\mp\juggernaut::calculatepurchasexp() )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
