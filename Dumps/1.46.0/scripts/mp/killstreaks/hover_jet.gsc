...
airstrikecount( var_0 )
{
    ...
    scripts\common\utility::_id_13592( level.update_objective_ownerclient, "hover_jet", self.origin );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread rungwperif_largeexplosions();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::get_player_who_most_recently_fired_weapon( var_5.player ) )
            continue;
