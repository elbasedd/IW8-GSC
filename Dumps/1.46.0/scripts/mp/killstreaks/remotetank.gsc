...
starttankdropoff( var_0 )
{
    ...
    scripts\common\utility::_id_13592( level.update_objective_ownerclient, "pac_sentry", self.origin );
...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11 thread _id_1320F();
    var_11 thread _id_13210();
...
_id_13210()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::_id_13856( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.maxxpcap = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::_id_12551( var_0 );
    }
}
