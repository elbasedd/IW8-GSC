...
createhelipilot( var_0 )
{
    ...
    var_7.owner scripts\common\utility::_id_13592( level.update_objective_ownerclient, level.helipilotsettings[var_7.helipilottype].streakname, var_7.targetpos );
    return var_7;
}
