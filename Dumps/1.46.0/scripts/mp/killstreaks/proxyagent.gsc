...
watchplayerkillstreakdeath( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( var_3 != self && isplayer( var_3 ) )
        {
            ...
            thread scripts\cp\utility\cp_controlled_callbacks::killstreakkilled( var_1, self, self, var_3, var_4, var_6, var_8, "destroyed_" + var_1 );
...
{
    scripts\engine\utility::_id_13AD9( var_0, "level_game_ended" );
    stopcontrol();
}
