...
tryuseremoteuav( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        scripts\common\utility::_id_13592( level.update_objective_ownerclient, var_1, self.origin );
...
createcarryremoteuav( var_0, var_1 )
{
    ...
    {
        var_4 = scripts\cp_mp\utility\killstreak_utility::playerspawn();
...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        var_1 = trial_dlog_pitcher( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement", "death_or_disconnect" );
...
trial_dlog_pitcher( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
carryremoteuav_handleexistence()
{
    ...
    self.owner scripts\engine\utility::_id_13ADA( "death_or_disconnect", "joined_team", "joined_spectators" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_13AE1( "death_or_disconnect", "remoteuav_unlock" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_13AE2( "death_or_disconnect", "carried", "leaving" );
...
remoteuav_watch_distance()
{
    ...
    {
        var_0 = scripts\cp_mp\utility\killstreak_utility::playerspawn();
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_13AD9( "joined_team", "joined_spectators" );
    self notify( "death" );
}
