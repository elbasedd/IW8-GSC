...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "watchForPlayerEnteringLastStand", ::unset_force_aitype_suicidebomber );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "handleMovingPlatform", ::unset_force_aitype_sniper );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "allowPickupOfTurret", ::unset_force_aitype_shotgun );
}
...
unset_force_aitype_sniper( var_0 )
{
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_1.trackcashevent = var_0.waitforanyplayernearpoint;
        var_1.angleoffset = var_0.waitforallcrates;
        var_1.endonstring = "carried";
        var_1.deathoverridecallback = ::unset_relic_aggressive_melee_params;
...
unset_force_aitype_suicidebomber()
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::unset_ignoreall_after_notify( "last_stand_start" );
    self waittill( "last_stand_start" );
    self notify( "equip_deploy_cancel" );
}

unset_force_aitype_shotgun()
{
