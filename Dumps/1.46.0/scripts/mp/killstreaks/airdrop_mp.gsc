...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::bomb_case_detonator_think );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo._id_130DD;
...
bomb_case_detonator_think( var_0 )
{
    ...
    var_2._id_130DD = self.matchdatalifeindex;
    var_2.owner = self;
    var_2._id_11ACA = self getxuid();
    var_2.announcedomplatespawns = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.announcedomplatespawns, self.origin );
