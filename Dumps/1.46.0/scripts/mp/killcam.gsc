...
killcam( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17, var_18 )
{
    ...
    scripts\mp\utility\player::_id_12161( "killcam::killcam() START" );
    ...
    if ( istrue( var_18 ) )
        thread scripts\mp\final_killcam::move_window_light();
    ...
    killcamcleanup( 1, undefined, var_18 );
    scripts\mp\utility\player::_id_12161( "killcam::killcam() COMPLETE" );
}

_id_12513()
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_13AEE( 0.15, "killcam_canceled", "spawned" );
    self clearpredictedstreampos();

    if ( istrue( level.showingfinalkillcam ) )
        scripts\mp\gamelogic::_id_1211C();
}
...
dokillcamslowmo( var_0 )
{
    ...
    if ( !isdefined( level.stoppingpower_onweaponcreated ) )
    {
        createheadiconatorigin( "killcam" );
        level.stoppingpower_onweaponcreated = 1;
    }
...
setkillcamnormalweaponomnvars( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_2.quarry_train_model ) )
        {
            var_4 = undefined;
            var_0 = var_2.quarry_train_model;
            var_2 = undefined;
        }
        else
...
waittillkillcamover()
{
    ...
    scripts\mp\utility\player::_id_12161( "killcam::waittillKillcamOver() START" );
    wait( self.killcamlength - level.frameduration / 1000.0 );
    scripts\mp\utility\player::_id_12161( "killcam::waittillKillcamOver() COMPLETE" );
}
...
waitskipkillcambutton( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        scripts\mp\utility\player::_id_12161( "killcam::waitSkipKillcamButton() Killcam SKIPPED" );
...
waitskipkillcamkbm()
{
    ...
    scripts\mp\utility\stats::incpersstat( "skippedKillcams", 1 );
    scripts\mp\utility\player::_id_12161( "killcam::waitSkipKillcamKBM() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
endkillcamifnothingtoshow()
{
    ...
    scripts\mp\utility\player::_id_12161( "killcam::endKillcamIfNothingToShow() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
{
    if ( isdefined( var_0._id_11AF1 ) )
        var_0 = var_0._id_11AF1;
    ...
    if ( var_2 != "iw8_knife" )
    {
        ...
        for ( var_7 = 0; var_7 < var_5.size; var_7++ )
        {
            ...
            if ( scripts\mp\utility\weapon::c130airdrop_startdelivery( var_2, var_9 ) )
            {
                if ( var_6 >= 8 )
                    break;
