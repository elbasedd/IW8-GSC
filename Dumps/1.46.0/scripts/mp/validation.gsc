...
squadleaderbeacon_fxent( var_0, var_1 )
{
    var_2 = getdvarint( "scr_checkValidAttachmentUnlock", 0 ) == 1;

    if ( var_2 )
        return scripts\mp\utility\weapon::c130deliveriesinprogress( var_0, var_1 );
...
validateloadout( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( stack_patch_thread_node( var_0.loadoutprimary ) )
        var_2 = 1;
    ...
    if ( !scripts\mp\weapons::stab_blink_black_fade( var_0.loadoutprimary ) )
    {
        var_2 = 1;
        var_3 = 1;
    }
    ...
    {
        if ( stack_patch_waittill_context( var_0.loadoutprimary, var_0.loadoutprimaryvariantid ) )
            var_0.loadoutprimaryvariantid = -1;
        ...
        for ( var_6 = 0; var_6 < var_0.loadoutprimaryattachments.size; var_6++ )
        {
            ...
            if ( spawn_addtoarrays( var_0.loadoutprimary, var_0.loadoutprimaryvariantid, var_7, var_8 ) )
                var_0.loadoutprimaryattachmentids[var_6] = 0;

            if ( var_7 != "none" && ( perkisrestricted( var_7, var_0.loadoutprimary ) || !squadleaderbeacon_fxent( var_0.loadoutprimary, var_7 ) ) )
            {
    ...
    if ( !isdefined( var_1 ) )
        var_2 = 1;
    else if ( stack_patch_thread_node( var_0.loadoutsecondary ) )
        var_2 = 1;
    ...
    {
        if ( stack_patch_waittill_context( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid ) )
            var_0.loadoutsecondaryvariantid = -1;
        ...
        for ( var_6 = 0; var_6 < var_0.loadoutsecondaryattachments.size; var_6++ )
        {
            ...
            if ( spawn_addtoarrays( var_0.loadoutsecondary, var_0.loadoutsecondaryvariantid, var_7, var_8 ) )
                var_0.loadoutsecondaryattachmentids[var_6] = 0;

            if ( var_7 != "none" && ( perkisrestricted( var_7, var_0.loadoutsecondary ) || !squadleaderbeacon_fxent( var_0.loadoutsecondary, var_7 ) ) )
            {
    ...
    if ( !scripts\mp\equipment::isequipmentprimary( var_0.loadoutequipmentprimary ) || !scripts\mp\equipment::spawn_helicoper_enemy( var_0.loadoutequipmentprimary ) )
        var_26 = 1;
    ...
    if ( !scripts\mp\equipment::isequipmentsecondary( var_0.loadoutequipmentsecondary ) || !scripts\mp\equipment::spawn_helicoper_enemy( var_0.loadoutequipmentsecondary ) )
        var_28 = 1;
...
validateattachments( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    foreach ( var_17, var_12 in var_1 )
    {
        ...
        if ( isdefined( var_12 ) && var_12 != "none" )
        {
            ...
            if ( !scripts\mp\utility\weapon::c130airdrop_startdelivery( var_3, var_12 ) )
            {
...
{
    return isdefined( level.weaponmapdata[var_0] ) && istrue( level.weaponmapdata[var_0]._id_1367C );
}

stack_patch_waittill_context( var_0, var_1 )
{
    ...
    var_2 = var_0 + "|" + var_1;
    return isdefined( level.weaponlootmapdata[var_2] ) && istrue( level.weaponlootmapdata[var_2].spawn_riders_and_play_intro_idle_anim );
}

spawn_addtoarrays( var_0, var_1, var_2, var_3 )
{
    if ( scripts\mp\utility\game::isanymlgmatch() )
        return 1;
    ...
    for (;;)
    {
        ...
        {
            if ( !level.weaponlootmapdata[var_10].spawn_riders_and_play_intro_idle_anim )
            {
