...
trophy_deploy()
{
    ...
    thread trophy_watchprotection( 45, 105625, ::_id_13563, ::trophy_protectionsuccessful );
    thread _id_13566();
    ...
    while ( [[ var_2 ]]() )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_11 )
            {
                ...
                if ( var_12 scripts\cp_mp\vehicles\vehicle::isvehicle() && isdefined( var_12._id_1357F ) && isdefined( var_10.team ) && var_12._id_1357F == var_10.team )
                    continue;
            }
            else if ( var_9 == self )
                continue;
...
trophy_protectionsuccessful( var_0 )
{
    ...
    self.owner scripts\mp\supers::getsquadspawnstruct( "super_trophy" );
    self.usedcount++;
    var_1 = var_0.origin;
...
_id_1355F( var_0 )
{
    ...
    var_0.exploding = 1;
    var_0 stopsounds();
    scripts\cp\utility\cp_controlled_callbacks::ondestroyedbytrophy();
    trophy_notifytrophytargetowner( var_0, "trophy_mp", self.owner );
    _id_13564( var_0, var_0.owner, self.owner );
...
_id_13564( var_0, var_1, var_2 )
{
    ...
    var_3 = var_2;
    var_4 = var_1.origin;
    var_5 = scripts\mp\equipment\snapshot_grenade::_id_12C3F( var_3, var_4 );
    scripts\mp\equipment\snapshot_grenade::_id_12C3E( var_1, var_2, var_5 );
}
...
trophy_modifiedprotectiondistsqr( var_0, var_1 )
{
    ...
    if ( var_0 _branalytics_headerplayerposrow::spawn_heli_assault2() && isdefined( var_0.owner ) )
    {
        if ( 202500 > var_1 )
            var_1 = 202500;
    }
...
trigger_water_fx( var_0 )
{
    ...
    if ( !isdefined( self.internal_isplayerindanger_think ) )
        return;

    getentitylessscriptablearray( "dlog_event_trophy_successful", [ "deploying_player", self.internal_isplayerindanger_think, "grenade_owner", var_0.owner, "negated_target", var_0.weapon_name ] );
}
