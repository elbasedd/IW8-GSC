...
{
    if ( istrue( self.relic_vampire_feedback ) )
        return;

    self.relic_vampire_feedback = 1;
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::spawn_module_lmg_1() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            _id_11D50( var_6, var_7, var_8, var_11 );
        }
    }
}

_id_11D50( var_0, var_1, var_2, var_3 )
{
