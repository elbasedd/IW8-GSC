...
gas_createtrigger( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = open_trap_room_door( var_0, var_3 );

    if ( isdefined( var_5 ) )
        var_4 thread open_starting_safehouse_door( var_5, var_2 );
...
open_trap_room_door( var_0, var_1 )
{
...
open_starting_safehouse_door( var_0, var_1 )
{
...
gas_watchtriggerenter()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( var_0.originalsubtype ) )
            continue;
...
gas_applycough( var_0, var_1 )
{
    ...
    if ( istrue( self.originalsubtype ) )
        return;
...
gas_begincoughing( var_0 )
{
    ...
    scripts\engine\utility::_id_13ADA( "gas_coughWeaponFired", "gas_coughWeaponTaken", "gas_coughDuration" );
