...
at_mine_use( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isent( var_3 ) && so_setplayerdata( var_3 ) )
        {
...
at_mine_plant( var_0 )
{
    ...
    if ( istrue( var_0._id_133A6 ) )
        var_0 thread buy_point_loop();
...
buy_point_loop()
{
    ...
    self endon( "death" );
    self.c130airdrop_heightoverride = ( 0, 0, 0 );
    var_0 = 0.2;
    ...
    for (;;)
    {
        var_1 = self.origin;
        wait( var_0 );
        self.c130airdrop_heightoverride = 1 / var_0 * ( self.origin - var_1 );
    }
}

silo_platforms( var_0 )
{
    return isdefined( var_0 ) && isdefined( var_0.c130airdrop_heightoverride ) && length2dsquared( var_0.c130airdrop_heightoverride ) > 0.01;
}
...
{
    self endon( "death" );
    self.grenade scripts\engine\utility::_id_13AEE( var_0, "death", "mine_destroyed" );
...
at_mine_watch_flight()
{
    ...
    if ( var_0 > 0 )
    {
        ...
        if ( silo_platforms( self ) )
            var_2 = var_2 + self.c130airdrop_heightoverride * var_0;
        ...
        if ( var_0 > 0 )
        {
            ...
            childthread scripts\mp\utility\equipment::_id_13B74();
            scripts\engine\utility::_id_13AED( var_0, "collision_with_platform" );
...
at_mine_watch_game_end()
{
    self endon( "mine_destroyed" );
    self endon( "death" );
    level scripts\engine\utility::_id_13AD9( "game_ended", "bro_shot_start" );
    thread at_mine_destroy();
}
