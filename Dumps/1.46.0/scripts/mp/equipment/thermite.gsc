...
thermite_used( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
    {
        ...
        var_0.quarry_mortars = var_2;
        var_0.angles = var_2.angles;
        var_0.quarry_train_model = self getcurrentweapon();
        var_0 linkto( var_2 );
        var_0.exploding = 1;
        var_0 setscriptablepartstate( "visibility", "hide", 0 );
    }

    if ( isdefined( level.onteamleadgained ) )
        [[ level.onteamleadgained ]]( var_0, self );

    var_0 thread thermite_watchdisowned();
    var_0 thread _id_132D4();
...
thermite_watchstuck( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( isdefined( self.quarry_mortars ) )
            self.quarry_mortars delete();
    }
    else
    {
    ...
    if ( isdefined( level._id_12ACA ) && [[ level._id_12ACA.jugg_setherodropscriptable ]]( self ) )
    {
        if ( isdefined( level._id_12ACA ) && isdefined( level._id_12ACA.handlethermite ) )
        {
            [[ level._id_12ACA.handlethermite ]]( self );
            return;
        }
    }
    ...
    if ( isdefined( self.quarry_train_model ) )
        var_5._id_11AF1 = self.quarry_train_model;
    ...
    if ( isdefined( self.quarry_train_model ) )
    {
        var_6._id_11AF1 = self.quarry_train_model;
        var_7._id_11AF1 = self.quarry_train_model;
    }
...
_id_132D3()
{
    self.quarry_mortars endon( "death" );
    self.owner endon( "disconnect" );
    self.owner endon( "joined_team" );
    self.owner endon( "joined_spectators" );
    self.quarry_mortars waittill( "missile_stuck", var_0, var_1, var_2, var_3, var_4, var_5 );
    self.quarry_mortars.surfacetype = var_2;
...
_id_132D0( var_0 )
{
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        {
            if ( isdefined( level._id_12ACA ) && [[ level._id_12ACA.gas_linger_vfx ]]( var_5 ) )
            {
                thread thermite_destroy();
                return;
            }
            ...
            var_5 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "thermiteStuck", 0, 0, ::_id_132CF );
        }
        else
            var_5 = undefined;
    }
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_13ADA( "joined_team", "joined_spectators", "disconnect" );
    thread thermite_destroy();
}
