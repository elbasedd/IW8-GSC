...
claymore_use( var_0 )
{
    ...
    if ( _id_11DE2() )
    {
        ...
        var_1.contents = has_drop_kit_marker();
    }
...
claymore_plant()
{
    ...
    thread get_track_location_index();
    wait 1;
        ...
        foreach ( var_3 in var_1 )
        {
            if ( isdefined( var_3.classname ) )
            {
                ...
                if ( var_3.classname == "agent" || var_3.classname == "player" )
                {
                    ...
                    if ( var_3 scripts\mp\gametypes\br_public.gsc::_id_11ECE() )
                        continue;
...
claymore_explodeonnotify()
{
    ...
    self.is_moving_platform_train = var_1;
    thread claymore_explode( var_1 );
}
...
claymore_modifieddamage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( isdefined( self.get_track_star_times ) )
        {
            foreach ( var_6 in self.get_track_star_times )
            {
    ...
    else if ( var_1 == getcompleteweaponname( "claymore_radial_mp" ) )
    {
        ...
        thread get_too_far_dist_sq( var_2 );
    }
    else
        return var_4;
    ...
    if ( isdefined( var_2.is_moving_platform_train ) )
    {
        var_14 = isdefined( var_2.owner ) && var_2.is_moving_platform_train == var_2.owner;
        var_15 = var_2.is_moving_platform_train == var_0;
...
get_too_far_dist_sq( var_0 )
{
    ...
    if ( !isdefined( self.get_track_star_times ) )
        self.get_track_star_times = [];

    self.get_track_star_times[self.get_track_star_times.size] = var_0;
    waittillframeend;
    self.get_track_star_times = undefined;
}
...
get_track_star_time_from_col( var_0 )
{
    self endon( "death" );
