...
_id_11971( var_0, var_1 )
{
    ...
    foreach ( var_3 in level.mines )
    {
        ...
        if ( distancesquared( var_1, var_3.origin ) < 262144 )
            var_3 thread scripts\mp\equipment\claymore::get_track_star_time_from_col( var_0 );
    }
}
...
applyconcussion( var_0, var_1 )
{
    ...
    if ( istrue( self.give_player_grenade_on_respawn ) )
        return;
    ...
    var_7 = scripts\mp\utility\game::spawn_maint_wave_1();

    if ( var_7 )
        var_6 = var_6 * getdvarfloat( "scr_br_stunscalar", 0.75 );

    var_6 = scripts\mp\perks\perkfunctions::applystunresistence( var_1, self, var_6 );
    var_1 scripts\cp\utility\cp_controlled_callbacks::_id_119D3( "equip_concussion" );
