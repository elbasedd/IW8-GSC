...
ammobox_init()
{
    level.bot_get_player_enemy = [];
    scripts\common\interactive::interactive_addusedcallback( ::ammobox_usedcallback, "equip_ammo_box" );
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::br_pickupdenyalreadyhaverevive );
    ...
    {
        br_loadout_option( "weapon_sniper", var_0 );
        br_loadout_option( "weapon_sniper", var_0 );
        br_loadout_option( "weapon_sniper", var_0 );
        br_loadout_option( "weapon_sniper", var_0 );
        br_loadout_option( "weapon_sniper", var_0 );
    ...
    {
        br_loadout_option( "weapon_assault", var_0 );
        br_loadout_option( "weapon_assault", var_0 );
        br_loadout_option( "weapon_smg", var_0 );
        br_loadout_option( "weapon_smg", var_0 );
        br_loadout_option( "weapon_lmg", var_0 );
        br_loadout_option( "weapon_lmg", var_0 );
        br_loadout_option( "weapon_sniper", var_0 );
        br_loadout_option( "weapon_dmr", var_0 );
        br_loadout_option( "weapon_shotgun", var_0 );
        br_loadout_option( "weapon_pistol", var_0 );
...
br_loadout_option( var_0, var_1 )
{
    var_2 = scripts\mp\utility\weapon::plunderrankupdate( var_0 );
    br_mapboundsfull( var_2, var_1 );
}

br_pickupdenyalreadyhaverevive( var_0 )
{
    foreach ( var_2 in level.bot_get_player_enemy )
    {
        if ( isdefined( var_2 ) )
            var_2 scripts\mp\equipment\support_box::_id_13173( var_0 );
    }
}
...
ammobox_settled( var_0 )
{
    ...
    level.bot_get_player_enemy[var_0 getentitynumber()] = var_0;
...
ammobox_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\utility\cp_controlled_callbacks::_id_11972( "super_weapon_drop", self.usedcount, var_0, var_2 );
...
ammobox_internalpreloadweapons( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = [ var_2 ];
        br_movingcirclemovedistmin( var_1 );
        var_4 = br_pe_chopper_damage_time( var_1 );
    ...
    foreach ( var_1 in self.playersused )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) && isdefined( self.playersused[var_2] ) )
            {
                ...
                scripts\mp\equipment\support_box::_id_13173( var_1 );
            }
        }
    }
}
...
br_pelletmaxdamage( var_0 )
{
    ...
    if ( isdefined( level._id_119EC ) )
        var_0 [[ level._id_119EC ]]( var_2 );
...
{
    if ( !isdefined( var_0.eliminate_drone_minigun_speed ) )
    {
        var_1 = spawnstruct();
        var_1.buffered = undefined;
        var_1.last = undefined;
        var_1.c130airdrop_spawn = undefined;
        var_1.c4_obj_and_progress_clear = undefined;
        var_1.c4_crate_use = undefined;
        var_0.eliminate_drone_minigun_speed = var_1;
    }

    return var_0.eliminate_drone_minigun_speed;
}
...
br_pe_chopper_crate_index( var_0 )
{
    ...
    if ( !isdefined( var_1.c130airdrop_spawn ) )
    {
        ...
        if ( !br_movingcirclemovedistmax( var_2 ) )
            return undefined;

        if ( !br_movingcirclegulagcloseoffset( var_2 ) )
            return undefined;
        ...
        var_1.c130airdrop_spawn = var_3;
    }

    return var_1.c130airdrop_spawn;
}
...
br_pe_chopper_damage_time( var_0 )
{
    ...
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.c4_obj_and_progress_clear;
}
...
br_movingcirclecount( var_0 )
{
    ...
    if ( !isdefined( var_1.c4_obj_and_progress_clear ) )
    {
        var_2 = br_pe_chopper_crate_index( var_0 );
        ...
        if ( isdefined( var_4 ) )
        {
            var_1.c4_crate_use = var_3;
            var_1.c4_obj_and_progress_clear = var_4;
        }
    }
}
...
{
    var_1 = br_pe_chopper_crates( var_0 );
    var_2 = 0;
...
ammobox_onplayeruse( var_0 )
{
    ...
    if ( !br_movingcirclemovedistmax( var_1 ) )
    {
    ...
    if ( !br_movingcirclegulagcloseoffset( var_1 ) )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
...
br_movingcirclegulagcloseoffset( var_0 )
{
    ...
    {
        if ( !scripts\mp\utility\weapon::c130airdrop_startdelivery( var_0, var_5 ) )
            continue;
...
br_pe_data( var_0 )
{
    ...
    var_1 = br_pe_chopper_crate_index( self );
    var_2 = br_pe_chopper_damage_time( self );

    if ( isdefined( var_2 ) )
    {
        br_onvehicledeath( self );
        var_3 = undefined;
        var_4 = undefined;
        ...
        if ( !isdefined( var_17 ) )
        {
            ...
            thread br_pickupalreadyhavespecialistbonus( var_17 );
...
br_pickupalreadyhavespecialistbonus( var_0 )
{
    self endon( "disconnect" );
    var_1 = var_0 + 1;

    if ( istrue( self._id_13CB1 ) )
    {
        self._id_13CB1 = undefined;
        var_1 = var_1 * -1;
    }
    else
        self._id_13CB1 = 1;
    ...
    scripts\engine\utility::_id_13AED( 1, "death" );
...
ammobox_addheadicon()
{
    self.remove_usability_crutch_on_death = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "hud_icon_fieldupgrade_weapon_drop", 20, 1, 1000, 100, undefined, 1 );
    self.remove_veh_spawners_from_passive_wave_spawning = scripts\cp_mp\entityheadicons::setheadicon_factionimage( 0, 20, undefined, undefined, undefined, undefined, 1 );
    scripts\mp\equipment\support_box::_id_13174();
}

ammobox_removeheadicon()
{
    if ( isdefined( self.remove_usability_crutch_on_death ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.remove_usability_crutch_on_death );
        self.remove_usability_crutch_on_death = undefined;
    }

    if ( isdefined( self.remove_veh_spawners_from_passive_wave_spawning ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.remove_veh_spawners_from_passive_wave_spawning );
        self.remove_veh_spawners_from_passive_wave_spawning = undefined;
    }
}
...
{
    thread br_pickupdenyalreadyhaveplatepouch( var_0, var_1 );
}

br_pickupdenyalreadyhaveplatepouch( var_0, var_1 )
{
    if ( istrue( var_1.sq_playerdisconnect ) )
        return;

    var_1.sq_playerdisconnect = 1;
    br_pickupdenyalreadyhavequest( var_0, var_1 );

    if ( isdefined( var_1 ) )
        var_1.sq_playerdisconnect = undefined;
}
...
br_pickupdenyalreadyhavequest( var_0, var_1 )
{
    ...
    if ( var_3 )
        var_4 = var_0 br_pelletmaxdamage( var_1 );
    else
    ...
    if ( var_4 )
    {
        if ( isdefined( var_0.owner ) )
        {
            ...
            var_0.owner scripts\mp\supers::getsquadspawnstruct( "super_weapon_drop" );
        }

        var_0.usedcount++;
        var_0.playersused[var_1 getentitynumber()] = var_1;
        var_0 scripts\mp\equipment\support_box::_id_13173( var_1 );
