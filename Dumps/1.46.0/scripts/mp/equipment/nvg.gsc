...
runnvg()
{
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) )
    {
        ...
        thread bots_with_player_enemy();
    }
    else
        scripts\common\utility::bot_pick_dd_zone_with_fewer_defenders( 1, undefined, 1 );
...
nvg_monitor()
{
    ...
    for (;;)
    {
        var_1 = scripts\engine\utility::_id_13AE1( "night_vision_on", "night_vision_off" );
...
nvg_update3rdperson( var_0 )
{
    ...
    if ( istrue( self.spawn_module_p3_form_c ) )
        return;
