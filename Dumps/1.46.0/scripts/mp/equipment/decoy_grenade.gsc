...
decoy_init()
{
    ...
    var_0.isassaultdrone = getdvarint( "scr_decoy_BR_diceroll_low", 1 );
    var_0.isapcblockedbyplayer = getdvarint( "scr_decoy_BR_diceroll_high", 4 );
}
...
decoy_debuffenemiesinrange()
{
    ...
    foreach ( var_4 in var_1 )
    {
        ...
        if ( var_2 )
        {
            var_5 = randomintrange( var_0.isassaultdrone, var_0.isapcblockedbyplayer );

            if ( var_5 == 1 )
                thread init_post_bsp_fx( var_4 );
        }
