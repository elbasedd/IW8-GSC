...
snapshot_grenade_watch_flight( var_0 )
{
    ...
    if ( istrue( var_1._id_133A6 ) )
        var_1 thread loscheckpassed();
    ...
    if ( var_8 > 0 )
    {
        ...
        if ( isdefined( var_1.tank_watchforgameend ) )
        {
            var_5 = _branalytics_headerplayer::skipweapondropondeath( var_1.tank_watchforgameend );

            if ( var_5 )
                var_4 linkto( var_1.tank_watchforgameend );
        }
        ...
        var_1 childthread scripts\mp\utility\equipment::_id_13B74();
        var_1 scripts\engine\utility::_id_13AED( var_11, "collision_with_platform" );
    }
    else
    {
        var_4.angles = var_9;
...
snapshot_grenade_detect()
{
    ...
    var_5 = scripts\mp\utility\game::spawn_maint_wave_1();
    var_6 = scripts\common\utility::playersinsphere( var_1, scripts\engine\utility::ter_op( var_5, 1080, 540 ) );
    var_7 = autoassignfirstquest( var_1, scripts\engine\utility::ter_op( var_5, 1080, 540 ) );
    ...
    foreach ( var_9 in var_6 )
    {
        ...
        _id_12C3E( var_9, var_0, var_3 );
    }

    if ( 1 )
        triggerportableradarping( var_1, var_0, scripts\engine\utility::ter_op( var_5, 1080, 540 ), 500, "specialty_snapshot_immunity" );
}
...
_id_12C3E( var_0, var_1, var_2 )
{
    ...
    if ( 1 )
    {
        var_3 = scripts\mp\utility\game::spawn_maint_wave_1();
...
autoassignfirstquest( var_0, var_1 )
{
    var_2 = autoassignlowteamconsistent( var_0, var_1 );
    var_3 = [];
    var_4 = var_1 * var_1;
...
autoassignlowteamconsistent( var_0, var_1 )
{
