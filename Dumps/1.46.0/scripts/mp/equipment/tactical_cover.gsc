...
tac_cover_init()
{
    ...
    level._id_131C1 = getentarray( "dcover_blocker", "targetname" );
    level._id_131C0 = getdvarfloat( "scr_tacCover_timeoutOverride", 150.0 );
}
...
tac_cover_on_fired( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = _branalytics_addeventdelayed::_id_127A9( var_7, 140, 20 );
    var_9 = undefined;
    var_10 = 0;
    ...
    if ( scripts\cp_mp\auto_ascender::spawner_recently_used( var_7 ) )
        return 0;

    if ( scripts\cp\laser_traps\cp_laser_traps::spawnerindex( var_7 ) )
        return 0;

    var_4 = scripts\engine\trace::handleheadshotkillrewardbullets();
    ...
    if ( isdefined( var_9 ) )
    {
        ...
        {
            if ( var_9 _branalytics_addeventdelayed::_id_127AA( var_26 ) )
            {
                var_24 = var_26;
                break;
            }
        ...
        {
            var_30 = _id_131B7( var_9 );

            if ( isdefined( var_24 ) )
                var_30 = var_30 | _id_131B7( var_24 );
            ...
            var_32 = var_9.getnextspectatecandidatefromchain + ( 0, 0, 24 );
            ...
            self.taccoverrefund = undefined;
            thread _id_131B9( var_9, var_24, var_3, var_4 );
    ...
    if ( isdefined( var_45 ) && !_id_131B3( var_45 ) )
    {
        tac_cover_fire_failed();
        return 0;
    }
...
_id_131B5( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( _branalytics_headerplayer::so_setplayerdata( var_0 ) || _branalytics_headerplayer::so_displaygameend( var_0 ) || scripts\mp\gametypes\br_gondola.gsc::skipdeath( var_0 ) || scripts\mp\gametypes\br_soa_tower.gsc::skip_player_pos_memory( var_0 ) )
            return var_0;
    }
...
tac_cover_adjust_for_player_space( var_0, var_1, var_2 )
{
    ...
    foreach ( var_9 in level._id_131C1 )
    {
...
_id_131B1( var_0 )
{
    ...
    {
        foreach ( var_2 in level.allow_pickup_atmine )
        {
            if ( !isdefined( var_2 ) )
                continue;
...
_id_131B9( var_0, var_1, var_2, var_3 )
{
    self endon( "death_or_disconnect" );
    self endon( "tac_cover_taken" );
    level endon( "game_ended" );
    var_4 = anglestoforward( self.angles );
    var_5 = var_0.getnextsafecircleradius + ( 0, 90, 0 );
    var_6 = anglestoforward( var_5 );
    var_7 = vectordot( var_4, var_6 );
    var_8 = var_7 > 0;
    var_9 = var_0 scriptabledoorangle();
    var_0 _branalytics_addeventdelayed::killoff_vis_passed( 1, "tac_cover_door" );
    ...
    var_11 = ( 0, 0, -1 );
    var_12 = var_0.getnextspectatecandidatefromchain + var_11;
    var_13 = combineangles( var_0.getnextsafecircleradius, var_10 );
    var_14 = undefined;
...
tac_cover_spawn( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_8.deathoverridecallback = ::_id_131B8;
    ...
    if ( isdefined( var_5 ) )
    {
        if ( isdefined( var_5.chopper_playfx ) )
            var_5.chopper_playfx tac_cover_destroy();

        var_7.chopper_gunner_assigntargetmarkers = var_5;
        var_5.chopper_playfx = var_7;
    }

    if ( isdefined( var_6 ) )
    {
        var_7.chopper_kill = var_6;
        var_6.chopper_playfx = var_7;
    }
...
tac_cover_spawn_internal( var_0 )
{
    ...
    if ( isdefined( var_0.chopper_gunner_assigntargetmarkers ) )
    ...
    for ( var_9 = 0; var_9 < var_8.size; var_9++ )
    {
        ...
        if ( isdefined( var_10.equipmentref ) )
        {
            if ( var_10.equipmentref == "equip_tac_cover" )
            {
                ...
                var_10.update_current_solution = 1;
                continue;
            }
        }
    }
...
tac_cover_destroy( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\utility\cp_controlled_callbacks::_id_11972( "super_tac_cover", int( var_4 ), var_0, var_2 );
...
{
    var_1 = _id_131B0( var_0 );

    if ( isdefined( self.owner ) )
    {
        var_2 = max( self.maxhealth - self.damagetaken, 0 );
        var_3 = int( min( var_2, var_1 ) );
        self.owner scripts\mp\supers::getsquadspawnstruct( "super_tac_cover", var_3 );
    }
...
_id_131B0( var_0 )
{
    ...
    if ( scripts\mp\damage::spectate3rdallowed( var_0.objweapon ) )
        return 0;
