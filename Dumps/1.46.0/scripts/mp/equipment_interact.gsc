...
{
    level.useobjs = [];
    scripts\engine\scriptable::_id_1279F( "hack_usable", ::make_building_ai_excluder );
    thread _updateuseobjs();
}

make_building_ai_excluder( var_0, var_1, var_2, var_3, var_4 )
{
    make_c4_pick_up_interact( var_0.entity, var_3 );
}
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::ai_give_flashlight, undefined, undefined, ::_ontabletputaway );
...
actorid()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    scripts\engine\utility::_id_13AD9( "death", "tabletPutAway" );
