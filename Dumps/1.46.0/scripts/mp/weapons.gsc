...
init()
{
    ...
    init_function_refs();
    level._id_119EA = _branalytics_addevent::entisvehicle();
    level._id_119EB = _branalytics_addevent::entisvehicle();
...
dochangeweapon( var_0 )
{
    if ( istrue( self.extraweapons ) )
        trial_thermite_watcher( var_0 );
...
_id_127CA()
{
    ...
    scripts\engine\utility::_id_13AD9( "death", "weapon_change" );
...
_id_1376F( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
        thread waittill_any_timeout_3( var_2 );

    return 1;
}

waittill_any_timeout_3( var_0 )
{
    ...
    var_1 = "cancel_" + var_0;
    thread waittill_any_timeout_1( var_1 );
    childthread waittill_any_timeout_5( var_0, var_1 );
    childthread waittill_any_timeout_no_endon_death_2( var_0, var_1 );
    childthread waittill_any_timeout_no_endon_death_1( var_0, var_1 );
}

waittill_any_timeout_no_endon_death_2( var_0, var_1 )
{
    for (;;)
    {
        ...
        if ( self isonladder() )
            waittill_any_timeout_2( var_0, var_1 );
    }
}

waittill_any_timeout_no_endon_death_1( var_0, var_1 )
{
    for (;;)
    {
...
waittill_any_timeout_2( var_0, var_1 )
{
    ...
    childthread waittill_any_timeout_6( var_0, var_1 );
}

waittill_any_timeout_5( var_0, var_1 )
{
    self notify( var_1 );
    self endon( var_1 );
    self._id_1201C = 1;
...
waittill_any_timeout_6( var_0, var_1 )
{
    self notify( var_1 );
    self endon( var_1 );
    self._id_1201C = 1;
...
waittill_any_timeout_4( var_0 )
{
    self notify( var_0 );

    if ( istrue( self._id_1201C ) )
    {
        self setscriptablepartstate( "weaponVFXViewmodel", "neutral" );
        self setscriptablepartstate( "weaponVFXWorldModel", "neutral" );
    }

    self._id_1201C = undefined;
}

waittill_any_timeout_1( var_0 )
{
    self endon( "disconnect" );
    self endon( "newMTXVFXStateSet" );
    scripts\engine\utility::_id_13AD9( "death", "weapon_change" );
...
_id_13749( var_0 )
{
    ...
    {
        if ( scripts\cp\utility\script::spawn_field_ai_manager_wall( var_0 ) )
            thread scripts\cp\utility\script::setup_comms_obj_crate( var_0 );
    }
}
...
updatelauncherusage()
{
    ...
    switch ( var_1 )
    {
        ...
        case "iw8_sn_crossbow":
            thread scripts\cp\utility\cp_safehouse_util::setteamplunderhud();
            break;
        case "iw8_sn_xmike109":
            thread scripts\cp\vehicles\little_bird_mg_cp::should_wait_before_spawn_chopper_boss();
            break;
        case "iw8_sh_aalpha12":
            thread scripts\cp\killstreaks\nuke_cp::should_wait_before_spawn_chopper_boss();
            break;
        case "iw8_me_t9ballisticknife":
            thread scripts\cp\stealth\manager::should_wait_before_spawn_chopper_boss();
            break;
    }
    ...
    switch ( var_1 )
    {
        ...
        case "iw8_sn_t9crossbow":
        case "iw8_sn_crossbow":
            thread scripts\cp\utility\cp_safehouse_util::heli_hover_between_points( var_0 );
            break;
        case "iw8_sn_xmike109":
            thread scripts\cp\vehicles\little_bird_mg_cp::_id_137AB( var_0 );
            break;
        case "iw8_sh_aalpha12":
            thread scripts\cp\killstreaks\nuke_cp::_id_137AB( var_0 );
            break;
        case "iw8_me_t9ballisticknife":
            thread scripts\cp\stealth\manager::_id_137AB( var_0 );
            break;
    }
}
...
onplayerspawned()
{
    ...
    _id_129A2( scripts\engine\utility::ter_op( isdefined( self.spawnweaponobj ), self.spawnweaponobj, isundefinedweapon() ) );
...
savetogglescopestates()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( !getqueuedspleveltransients( self.primaryweaponobj ) && var_2 == self.primaryweaponobj || !getqueuedspleveltransients( self.secondaryweaponobj ) && var_2 == self.secondaryweaponobj )
        {
            if ( isdefined( var_2.scope ) && istogglescope( var_2.scope ) && !_id_13080( var_2.backpiece ) )
            {
                var_3 = scripts\mp\utility\weapon::getcompleteweaponnamenoalt( var_2 );
...
{
    return spawn_additional_covernode( var_0 );
}
...
sniperglint_supported( var_0 )
{
    ...
    if ( var_0.basename == "s4_mr_gecho43_mp" || var_0.basename == "s4_mr_m1golf_mp" || var_0.basename == "s4_mr_svictor40_mp" )
        return 0;
...
sniperglint_manage()
{
    ...
    if ( self.currentweapon hasattachment( "gunperk_shrouded" ) )
        var_0 = getdvarfloat( "scr_gunperk_shrouded_zoom_level", 0.95 );
    else
        var_0 = 0.5;
...
sniperglint_cleanup()
{
    scripts\engine\utility::_id_13AD9( "death_or_disconnect", "weapon_change" );
...
{
    self endon( "death" );
    level._id_119EA _branalytics_addevent::entityplunderlosealldeposited( self, var_0, self.objweapon );
    ...
    for (;;)
    {
        ...
        if ( var_6 )
        {
            ...
            if ( var_7.size > 2 )
            {
                ...
                foreach ( var_12 in var_7 )
                {
                    ...
                    if ( scripts\mp\utility\weapon::spawn_sentries_from_targetname( var_12 ) )
                        var_9 = 1;
        ...
        level._id_119EB _branalytics_addevent::entityplunderlosealldeposited( self, var_2, self.objweapon );
...
watchpickupcomplete( var_0, var_1, var_2 )
{
    ...
    if ( var_4 )
    {
        ...
        if ( isdefined( level._id_119ED ) )
            [[ level._id_119ED ]]( var_0 );
        else if ( var_2 )
...
usegraverobber( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
    {
        ...
        var_2 = var_1;
        var_3 = getweaponsource( var_1.name );
...
getrandomgraverobberattachment( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
        ...
        var_4 = scripts\mp\utility\weapon::player_test_ending_teleport( var_2 );
    ...
    foreach ( var_8, var_6 in var_3 )
    {
        ...
        if ( !scripts\mp\utility\weapon::c130airdrop_startdelivery( var_0, var_7 ) )
        {
    ...
    var_4 = scripts\engine\utility::bronattackerdamagenottracked( var_4 );
...
{
    if ( !scripts\mp\utility\weapon::c130airdrop_startdelivery( var_0, var_1 ) )
        return 0;
...
_id_119BF( var_0 )
{
    if ( isdefined( level._id_119BF ) )
        [[ level._id_119BF ]]( var_0 );
    else
    {
...
handlescavengerbagpickup( var_0 )
{
    ...
    var_1 scripts\cp\utility\cp_controlled_callbacks::_id_1199E( "scavengerAmmo", 0 );
...
scavengerbagcleanupthink()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_13ADA( "death_or_disconnect", "joined_team", "bag_timeout" );
...
checkhit( var_0, var_1 )
{
    ...
    else
    {
        ...
        scripts\cp\utility\cp_controlled_callbacks::zvelscale( var_0, self.consecutivehitsperweapon[var_3] );
    }
    ...
    thread scripts\cp\utility\cp_controlled_callbacks::onsuccessfulhit( var_0 );
...
watchgrenadethrows()
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "trophy_mp":
            ...
            break;
        case "airpocket_mp":
            thread _calloutmarkerping_onpingchallenge::bot_ctf_enemy_team_flag_is_picked_up( var_0 );
            break;
        case "claymore_mp":
        ...
        case "support_box_mp":
            ...
            break;
        case "armor_box_mp":
            thread scripts\mp\equipment\support_box::brloadoutupdateammo( var_0 );
            break;
        ...
        case "geiger_counter_mp":
            thread _calloutmarkerping_poolidisloot::overtime_music( var_0 );
            break;
        case "offhand_spotter_scope_mp":
            thread _calloutmarkerping_poolidisdanger::checkstayingbehindcover( var_0 );
            break;
        case "tac_cover_mp":
        ...
        case "advanced_vehicle_drop_marker_mp":
            thread scripts\mp\equipment\advanced_supply_drop::attackfactormod( var_0 );
            break;
        case "advanced_loot_drop_marker_mp":
            thread scripts\mp\equipment\advanced_supply_drop::attackerisinflictorforradiusexplosiveweapon( var_0 );
            break;
        case "deploy_weapondrop_mp":
            thread scripts\mp\equipment\weapon_drop::weapondrop_used( var_0 );
            break;
        case "concussion_grenade_mp":
            var_0 thread give_player_juggernaut();
            break;
        default:
            if ( isdefined( level._id_1197B ) )
                [[ level._id_1197B ]]( var_0.weapon_name, var_0 );

            break;
    }

    trial_trigger_think( var_0.weapon_name );
}
...
give_player_juggernaut()
{
    thread scripts\mp\utility\script::notifyafterframeend( "death", "end_explode" );
    self endon( "end_explode" );
    var_0 = self.owner;
    self waittill( "explode", var_1 );
    thread scripts\mp\equipment\concussion_grenade::_id_11971( var_0, var_1 );
}
...
smokegrenadeused( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        thread _id_12C2F( var_5 );
        thread scripts\mp\bots\bots::handleweaponreloadammodrop( var_5 );
    }
    else
...
monitorsmokeactive()
{
    ...
    var_0 = scripts\engine\utility::_id_13AED( 9.25, "death" );
...
lockonlaunchers_gettargetarray( var_0 )
{
    ...
    if ( level.teambased )
    {
        ...
        foreach ( var_14 in var_3 )
        {
            ...
            {
                if ( isdefined( var_17 ) && ( !scripts\cp_mp\vehicles\vehicle::_id_13907( var_17, self ) || var_2 ) )
...
{
    var_0 = [ "apc_russian", "atv", "big_bird", "cargo_truck", "cargo_truck_mg", "cop_car", "hoopty", "hoopty_truck", "jeep", "large_transport", "light_tank", "little_bird", "little_bird_mg", "medium_transport", "pickup_truck", "tac_rover", "technical", "van", "loot_chopper", "motorcycle", "veh_a10fd", "veh_bt" ];

    if ( isdefined( level.onstim ) )
        var_0 = level.onstim;
...
updatemissilefire( var_0 )
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "iw8_la_t9standard_mp":
            ...
            level thread scripts\mp\battlechatter_mp::teammateoutlineids( var_0 );
    ...
    {
        var_0.trial_target_arm_damage = var_1;
...
monitordisownedequipment( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_2 ) )
        var_0 scripts\engine\utility::_id_13AD9( "joined_team", "disconnect" );
    else
        var_0 scripts\engine\utility::_id_13ADA( "joined_team", "joined_spectators", "disconnect" );
...
updateplantedarray( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        scripts\mp\utility\script::intel_location_vo( var_4 );
    }
...
makeexplosiveusabletag( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) )
        {
            switch ( var_3 )
            {
                case "trophy_mp":
                    ...
                    break;
                case "airpocket_mp":
                    thread _calloutmarkerping_onpingchallenge::bot_capture_koth_zone();
            }
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            else if ( isdefined( level._id_1199B ) )
                [[ level._id_1199B ]]( self.owner, var_4 );
        }
...
explosivehandlemovers( var_0, var_1 )
{
    ...
    if ( _branalytics_headerplayer::so_setplayerdata( var_0 ) )
    {
        var_2._id_11CA8 = 1;
        self _meth_87B9( 1 );
    }
...
explosivetrigger( var_0, var_1, var_2 )
{
    ...
    {
        var_0 thread scripts\cp\utility\cp_controlled_callbacks::triggereddelayedexplosion();
...
updateviewkickscale( var_0 )
{
    ...
    else if ( isdefined( self.overrideviewkickscale ) )
    {
        ...
        var_1 = scripts\mp\utility\weapon::_id_13C9F( self getcurrentweapon() );

        if ( var_1 == 1 )
            var_0 = self.overrideviewkickscalepistol;
        else if ( var_1 == 4 )
            var_0 = self._id_11AA8;
        else if ( var_1 == 2 )
            var_0 = self._id_11AA9;
        else if ( var_1 == 3 )
            var_0 = self._id_11AAA;
        else if ( var_1 == 5 )
...
getplayerspeedbyweapon( var_0 )
{
    ...
    else
    {
        ...
        if ( !isdefined( var_2 ) )
            ...
            var_1 = 0.85;
        else if ( scripts\mp\utility\weapon::spawn_module_intro3( var_2.basename ) )
            var_1 = 0.85;
        else
        {
            if ( var_2.inventorytype != "primary" && var_2.inventorytype != "altmode" || scripts\mp\utility\weapon::spawn_sentries_from_targetname( var_2 ) )
            {
...
stancerecoiladjuster()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_13ADA( "adjustedStance", "sprint_begin", "weapon_change" );
        wait 0.5;
...
minedamagemonitor()
{
    ...
    if ( isplayer( var_16 ) )
    {
        ...
        if ( var_16 != self.owner && var_16.team != self.owner.team )
        {
            ...
            scripts\cp\utility\cp_controlled_callbacks::equipmentdestroyed( var_15, var_0, var_3, var_10, undefined, var_11, undefined, var_16.modifiers );
        }
    }
    ...
    scripts\cp\utility\cp_controlled_callbacks::minedestroyed( self, var_16, var_6 );
...
buildattachmentmaps()
{
    ...
    for ( var_3 = scripts\mp\utility\game::spawn_maint_wave_1(); var_2 != ""; var_2 = tablelookupbyrow( "mp/attachmentmap.csv", var_1, 0 ) )
    {
        if ( var_3 || scripts\cp_mp\utility\weapon_utility::stack_patch_thread( var_2 ) || sstablet_init() )
    ...
    level.c4_charge_detonate_think = [];
    var_13 = [];
    var_1 = 1;
    ...
    foreach ( var_14 in var_13 )
    {
        foreach ( var_9, var_16 in var_15 )
        {
            ...
            if ( !isdefined( level.c4_charge_detonate_think[var_14] ) )
                level.c4_charge_detonate_think[var_14] = [];

            level.c4_charge_detonate_think[var_14][var_16] = var_19;
        }
    }
    ...
    level.c130deliverydirection = [];
    level.c130successfulairdrops = [];
    level.c4_crate_update_hint_logic_alt = [];
    ...
    foreach ( var_34 in var_32 )
    {
        ...
        {
            var_37 = level.c130successfulairdrops[var_36];

            if ( !isdefined( var_37 ) )
                level.c130successfulairdrops[var_36] = var_35;
            else if ( var_35 != var_37 )
                level.c4_crate_update_hint_logic_alt[var_34] = var_35;
        }
        ...
        if ( var_40 != "" )
            level.c130deliverydirection[var_34] = var_40;
    }

    level.attachmentmap_conflicts_by_game = [];
    level.attachmentmap_conflicts_by_game["default"] = buildattachmentcomboconflicts( "mp/attachmentcombos.csv" );
    level.attachmentmap_conflicts_by_game["s4"] = buildattachmentcomboconflicts( "mp/attachmentcombos_s4.csv" );
    level.attachmentmapcombos_by_game = [];
    level.attachmentmapcombos_by_game["default"] = "mp/attachmentcombos.csv";
    level.attachmentmapcombos_by_game["s4"] = "mp/attachmentcombos_s4.csv";
}

buildattachmentcomboconflicts( var_0 )
{
    var_4 = [];
    var_1 = 1;
...
shoulddropbrprimary()
{
    ...
    for (;;)
    {
        ...
        level._id_13CB8[var_3] = var_2;
        var_0++;
    }
}

getweaponsource( var_0 )
{
    if ( !isdefined( level._id_13CB8 ) )
        shoulddropbrprimary();

    var_1 = level._id_13CB8[var_0];
...
buildweaponmap()
{
    ...
    for ( var_2 = 0; var_2 < var_1; var_2++ )
    {
        ...
        if ( var_4 != "" && ( var_0 || scripts\cp_mp\utility\weapon_utility::stack_patch_thread( var_4 ) || sstablet_init() ) )
        {
            ...
            if ( var_6 != "" )
            {
                ...
                if ( var_7 != "" )
                {
                    ...
                    if ( var_8 > -1 && stab_blink_black_fade( var_4 ) && !var_9 )
                    {
                        if ( !isdefined( level._id_13CA3[var_6] ) )
                            level._id_13CA3[var_6] = [];

                        level._id_13CA3[var_6][level._id_13CA3[var_6].size] = var_4;
                    }
                    else
                        level.weaponmapdata[var_4]._id_1367C = 1;
                }
            }
            ...
            if ( var_11 != "" )
                level.weaponmapdata[var_4].valid_carriable_pickup_weapon = var_11;
    ...
    for (;;)
    {
        ...
        if ( !var_0 && !scripts\cp_mp\utility\weapon_utility::stack_patch_thread( var_4 ) && !sstablet_init() )
            continue;
        ...
        level.weaponlootmapdata[var_22].spawn_riders_and_play_intro_idle_anim = int( var_21 ) != 0 && int( var_24 ) == 99;
        level.weaponlootmapdata[var_22].spawn_ai_group = stab_blink_black_fade( var_4 );
    ...
    foreach ( var_41, var_38 in var_17 )
    {
        for ( var_39 = 1; var_39 <= var_38; var_39++ )
        {
            ...
            if ( !isdefined( level.weaponlootmapdata[var_40] ) )
            {
                ...
                level.weaponlootmapdata[var_40].spawn_riders_and_play_intro_idle_anim = 1;
                level.weaponlootmapdata[var_40].spawn_ai_group = 0;
            }
        }
    }
}
...
{
    if ( isdefined( var_0 ) )
        var_0 scripts\engine\utility::_id_13AED( var_2, "death_or_disconnect" );
...
weaponhasselectableoptic( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        if ( var_5 == "rail" )
        {
            ...
            if ( scripts\mp\utility\weapon::c130airdrop_startdelivery( var_1, var_6 ) )
                return 1;
        }
    }
...
watchdropweapons()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && isdefined( var_1 ) && !scripts\mp\utility\weapon::ismeleeonly( var_1 ) && !scripts\mp\utility\weapon::spawn_sentries_from_targetname( var_1 ) && !scripts\mp\utility\weapon::isknifeonly( var_1 ) )
        {
...
_id_122F6()
{
    ...
    foreach ( var_1 in level.players )
    {
        if ( isdefined( var_1 ) && isdefined( var_1._id_122F9 ) )
        {
            var_1._id_122F9 = undefined;
...
{
    var_0._id_12F40 = var_1;

    if ( var_2 == 1 )
        self setscriptablepartstate( "activeCamo", "stage" + var_0._id_12F40 );
    else
        self setscriptablepartstate( "activeCamo", "init_stage" + var_0._id_12F40 );
}

_id_122F8( var_0 )
{
    if ( !isdefined( self._id_122F9 ) )
        self._id_122F9 = [];

    if ( !isdefined( self._id_122F9[var_0] ) )
    {
        self._id_122F9[var_0] = spawnstruct();
        self._id_122F9[var_0].kills = 0;
        self._id_122F9[var_0]._id_12F40 = 0;
    }
}
...
_id_122F3( var_0 )
{
    ...
    if ( !isdefined( level._id_122F5 ) && !scripts\mp\flags::gameflag( "prematch_done" ) )
    {
        level._id_122F5 = 1;
        level thread _id_122F6();
    }

    var_1 = _id_13CA0( var_0 );
    _id_122F8( var_1 );
    var_2 = self._id_122F9[var_1];
    _id_122F7( var_2, var_2._id_12F40, 0 );
    ...
    while ( var_2._id_12F40 < var_4 )
    {
        scripts\engine\utility::waittill_either( "got_a_kill", "scr_advancereactivecamo" );
        var_6 = int( var_5[var_2._id_12F40 + 1] );
        var_2.kills++;

        if ( var_2.kills >= var_6 )
        {
            _id_122F7( var_2, var_2._id_12F40 + 1, 1 );
...
spawn_soldiers_in_convoy_truck( var_0 )
{
...
waittill_any_return_no_endon_death_6( var_0 )
{
    _id_1200C( "j_shoulder_ri", "teslaLimb" );
    _id_1200C( "j_shoulder_le", "teslaLimb" );
    _id_1200C( "j_elbow_ri", "teslaLimb" );
    _id_1200C( "j_elbow_le", "teslaLimb" );
    _id_1200C( "j_hip_ri", "teslaLimb" );
    _id_1200C( "j_hip_le", "teslaLimb" );
    _id_1200C( "j_knee_ri", "teslaLimb" );
    _id_1200C( "j_knee_le", "teslaLimb" );
    _id_1200C( "j_spineupper", "teslaTorso" );
    _id_1200C( "j_head", "teslaHead" );
...
{
    _id_1200C( "j_shoulder_ri", "8BitLimb" );
    _id_1200C( "j_shoulder_le", "8BitLimb" );
    _id_1200C( "j_elbow_ri", "8BitLimb" );
    _id_1200C( "j_elbow_le", "8BitLimb" );
    _id_1200C( "j_hip_ri", "8BitLimb" );
    _id_1200C( "j_hip_le", "8BitLimb" );
    _id_1200C( "j_knee_ri", "8BitLimb" );
    _id_1200C( "j_knee_le", "8BitLimb" );
    _id_1200C( "j_spineupper", "8BitTorso" );
    _id_1200C( "j_head", "8BitHead" );
    self playsound( "8bit_death_sfx" );
    var_0 hide();
}

_id_1200C( var_0, var_1 )
{
...
{
    if ( !isdefined( self.end_leave_cave ) )
        self.end_leave_cave = [];
    ...
    self.end_leave_cave[playerforcespectatorclientwait( var_1 )] = var_1;
    thread startburnfx();
}
...
players_recent_position_delay( var_0 )
{
    var_1 = 3;
...
enableburnsfx()
{
    ...
    if ( !isdefined( self.burnsfx ) )
    {
        ...
        thread end_module_if_weapons_free( self.burnsfx );
        wait 0.05;
    }
...
disableburnfx( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
    {
        if ( self.end_leave_cave[playerforcespectatorclientwait( var_1 )] == var_1 )
            self.end_leave_cave[playerforcespectatorclientwait( var_1 )] = undefined;
    }
    else
        self.end_leave_cave = [];

    if ( self.end_leave_cave.size > 0 )
        thread startburnfx();
    else
    {
        thread stopburnfx();
...
startburnfx()
{
    ...
    var_0 = players_recent_position_delay( self.end_leave_cave );
...
_id_12857( var_0 )
{
    ...
    if ( isplayer( var_1 ) )
    {
        ...
        if ( isalive( var_1 ) )
            thread _id_12855( var_0, var_1 );
    }
}

_id_12855( var_0, var_1 )
{
    self endon( "disconnect" );
    ...
    thread _id_12856( var_1, var_2 );
}

_id_12856( var_0, var_1 )
{
    ...
    var_0 scripts\cp_mp\utility\damage_utility::obj_riverbed();
    var_0 dodamage( var_0.maxhealth, var_1, self, undefined, "MOD_EXPLOSIVE", getcompleteweaponname( "semtex_mp" ) );
    var_0 scripts\cp_mp\utility\damage_utility::obj_room_fire_01();
}
