...
init()
{
    if ( !isdefined( level.isplayerinsiderectangularzone ) )
        level.isplayerinsiderectangularzone = getdvarint( "scr_game_disablespawncamera", 0 ) == 1;
...
startspawncamera( var_0, var_1, var_2 )
{
    ...
    scripts\mp\utility\player::_id_12161( "spawnCamera::startSpawnCamera() START" );
    scripts\mp\utility\player::hideminimap( 1 );
    heli_bosses();

    if ( !isdefined( self.spawncameraent ) )
    {
        scripts\mp\utility\player::_id_12161( "spawnCamera::startSpawnCamera() UNDEFINED SPAWNCAMERAENT!!!" );
    ...
    scripts\engine\utility::_id_13AF3( 0.1, "force_spawn" );
    thread removecameraondisconnect( self.spawncameraent );
    self cameralinkto( self.spawncameraent, "tag_origin", 1, 1 );
    scripts\mp\utility\player::_id_12161( "spawnCamera::startSpawnCamera() CameraLinkTo()" );
...
getspawncamera()
{
    ...
    if ( scripts\mp\utility\game::spawn_ml_p2_player_heli() )
    ...
    else if ( istrue( level.evaluatespawnforcameraselection ) && isdefined( level.tanks_help_reminder ) && isdefined( level.tanks_help_reminder[self.team] ) )
    {
        var_14 = level.tanks_help_reminder[self.team];
        var_15 = undefined;
        var_16 = undefined;
...
snaptospawncamera()
{
    ...
    scripts\mp\utility\player::_id_12161( "spawnCamera::snapToSpawnCamera()" );
...
{
    self endon( "disconnect" );
    scripts\mp\utility\player::_id_12161( "spawnCamera::runSlamZoomOnSpawn() START" );
    self waittill( "spawncamera_start" );
    scripts\mp\utility\player::_id_12161( "spawnCamera::runSlamZoomOnSpawn() spawncamera_start PASSED" );
    ...
    scripts\mp\utility\player::_id_12161( "spawnCamera::runSlamZoomOnSpawn() CameraLinkTo()" );
    handlemovetoblended();
    deletespawncamera();
    ...
    scripts\mp\utility\player::_id_12161( "spawnCamera::runSlamZoomOnSpawn() COMPLETE" );
}
...
handlemovetoblended( var_0 )
{
    ...
    scripts\mp\utility\player::_id_12161( "spawnCamera::handleMoveTo() START" );
    ...
    if ( !var_3 || !var_4 )
    {
        ...
        scripts\mp\utility\player::_id_12161( "spawnCamera::handleMoveTo() FULL Blend Set" );
    ...
    else
    {
        ...
        scripts\mp\utility\player::_id_12161( "spawnCamera::handleMoveTo() FIRST HALF Blend Set" );
        ...
        scripts\mp\utility\player::_id_12161( "spawnCamera::handleMoveTo() SECOND HALF Blend Set" );
        wait 0.3;
        wait 0.2;
    }

    scripts\mp\utility\player::_id_12161( "spawnCamera::handleMoveTo() COMPLETE" );
...
fadeblackforgeo( var_0 )
{
    ...
    if ( istrue( self.spawningintovehicle ) || scripts\cp_mp\utility\game_utility::isnightmap() )
    {
        ...
        if ( isdefined( self._id_139AD ) && self._id_139AD == "light_tank" )
        {
...
startoperatorsound()
{
    ...
    self._id_11A56 = spawn( "script_origin", ( 0, 0, 0 ) );
    self._id_11A56 showonlytoplayer( self );
    ...
    self._id_11A57 = var_1;
    self._id_11A56 playloopsound( var_1 );
    thread locationpad();
}
...
locationpad()
{
    ...
    var_0 = self._id_11A56;
    var_1 = self._id_11A57;
    self waittill( "disconnect" );
