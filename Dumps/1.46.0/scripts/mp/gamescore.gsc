...
getthirdpersonheightoffsetforsize( var_0, var_1 )
{
...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::_id_13592( level.update_player_enemy_on_death, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( level.roundscorelimit > 1 && !istrue( level.dontendonscore ) )
    {
        ...
        {
            if ( level scripts\mp\utility\game::stadium_two_death_func( var_7 ) )
                continue;
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = enter_combat_maze_ai( var_2 );

    if ( !istrue( var_4 ) )
        _id_12039( var_9, var_2, level.waswinning );
    ...
    if ( !level.onlinegame )
        trial_white_phosphorus_activate();
}
...
playleadtakendialog( var_0 )
{
    ...
    level.lastscorestatustime = gettime();
    var_1 = enter_combat_maze_ai( var_0 );
...
updateteamscore( var_0 )
{
    if ( scripts\mp\utility\game::stadium_two_death_func( var_0 ) )
        return;
...
processassist_regularmp( var_0, var_1, var_2 )
{
    ...
    thread scripts\cp\utility\cp_controlled_callbacks::onplayerkillassist( var_0 );
}
