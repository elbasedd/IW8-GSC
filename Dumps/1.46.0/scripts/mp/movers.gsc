...
player_update_unresolved_collision( var_0, var_1 )
{
    ...
    if ( self.unresolved_collision_count >= var_2 )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_4 = isdefined( self.tag_convoy_with_objectives ) && gettime() - self.tag_convoy_with_objectives <= 250;

                if ( var_4 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::_id_138DB( var_0, self ) )
                {
...
_id_11DA7( var_0 )
{
    ...
    if ( istrue( var_0.move_closest_chopper_boss_vandalize_node_down ) )
        var_1 = 1;

    if ( isdefined( var_0.forest_barrel_damage_watch ) )
        var_1 = 1;
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level.give_player_saw ) )
    {
        var_3 = self [[ level.give_player_saw ]]( var_0, var_1, var_2 );
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            else if ( isdefined( level.vehicle_interact_initdev ) && [[ level.vehicle_interact_initdev ]]( var_0, var_2 ) )
                return;
        }
        else
        {
...
handle_moving_platform_touch( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0._id_11CA8 ) && var_0._id_11CA8 )
        {
            if ( scripts\mp\equipment\claymore::so_setplayerdata( var_1 ) )
            {
                waitframe();
                continue;
            }
        ...
        if ( !istrue( var_0._id_12BE4 ) )
            thread process_moving_platform_death( var_0, var_1 );

        self._id_133A6 = 1;
        self.tank_watchforgameend = var_1;
        thread _id_11CAD();
        break;
    }
}
...
{
    self endon( "death" );
    self.tank_watchforgameend waittill( "death" );
    self.tank_watchforgameend = undefined;
}
...
handle_moving_platforms( var_0 )
{
    ...
    if ( isdefined( var_0.linkparent ) )
    {
        ...
        {
            if ( isdefined( var_0.trackcashevent ) )
                self linkto( var_0.linkparent, "", var_0.trackcashevent, var_0.angleoffset );
            else
