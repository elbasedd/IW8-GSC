...
codecallback_playeractive()
{
    ...
    if ( isdefined( level.entmantlingendtime ) )
        [[ level.entmantlingendtime ]]();
}
...
codecallback_playerdisconnect( var_0 )
{
    ...
    self.spawn_enemy_juggernaut_single = 1;
...
setupdamageflags()
{
    ...
    level.scriptable_callback = 512;
    level.scriptable_autouse_funcs = 1024;
    level.scriptable_door_get_in_radius = 2048;
    level.scriptable_damaged_funcs = 4096;
    level.scriptable_carriable_use = 8192;
    level.scriptable_door_freeze_open = 16384;
    level.scriptable_carriable_damage_internal = 32768;
    level.scriptable_carriable_damage = 65536;
...
abortlevel()
{
    ...
    level.entmantlingendtime = ::callbackvoid;
