...
killstreak_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistDataForceCredit", scripts\mp\killstreaks\killstreaks::_id_13788 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistData", scripts\mp\killstreaks\killstreaks::_id_13787 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "processScrapAssist", scripts\mp\events::_id_1217B );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayersInRange", scripts\mp\gametypes\br_killstreaks.gsc::hvt_waittill_pickup_players_gobackup );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayer", scripts\mp\gametypes\br_killstreaks.gsc::hvt_visual_leaving_callout );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "teamJuggMaxReached", scripts\mp\juggernaut::calculatepurchasexp );
}
...
entity_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "entity", "isGondolaBrush", scripts\mp\gametypes\br_gondola.gsc::skipdeath );
}
...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "freezeControlsDebug", scripts\mp\utility\player::addquestrewardtierframeend );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "getStanceTop", scripts\mp\utility\player::postspawn_rescued_allies );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "loadout_finalizeWeapons", scripts\mp\class::trap_door_nvg_reset_catch );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInLastStand", scripts\mp\utility\player::spawn_module_trickle );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isPlayerOnIntelChallenge", scripts\mp\gametypes\br_maphints.gsc::spawndistancemax );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "carriable_useAscender", scripts\cp_mp\utility\train_utility::forcehideottimer );
}
...
game_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "isGameTypeBR", scripts\mp\utility\game::spawn_maint_wave_1 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "getGameType", scripts\mp\utility\game::getgametype );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "getSubGameType", scripts\mp\utility\game::postupdategameevents );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "brGetOperatorTeam", scripts\mp\gametypes\br_public.gsc::deadyellow );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "gameFlag", scripts\mp\flags::gameflag );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "isPointInBounds", scripts\mp\outofbounds::spawn_module_lmg_5 );
}
...
weapons_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getDefaultWeaponBaseName", scripts\mp\utility\weapon::playernumlivesvo );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "attachmentIsSelectable", scripts\mp\utility\weapon::c130airdrop_startdelivery );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "remapAttachmentParentName", scripts\mp\utility\weapon::_id_1245F );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponMenuCategory", scripts\mp\utility\weapon::printdata );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponRarity", scripts\mp\utility\weapon::printspawnmessage );
}
...
sound_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sound", "playKillstreakDeployDialog", scripts\mp\battlechatter_mp::_id_12023 );
...
rank_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "rank", "getBattlePassXPultiplierTotal", scripts\mp\rank::playercreatehudelement );
}
...
supers_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "supers", "combatRecordSuperMisc", scripts\mp\supers::getsquadspawnstruct );
}
...
fulton()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onVehicleKilled", scripts\cp\utility\cp_controlled_callbacks::vehiclekilled );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onFieldUpgradeEnd", scripts\cp\utility\cp_controlled_callbacks::_id_11972 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onKillStreakEnd", scripts\cp\utility\cp_controlled_callbacks::_id_11989 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "resetChallengeTimer", scripts\cp\utility\cp_controlled_callbacks::_id_12504 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "startChallengeTimer", scripts\cp\utility\cp_controlled_callbacks::_id_13012 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "stopChallengeTimer", scripts\cp\utility\cp_controlled_callbacks::_id_130A3 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onPing", scripts\cp\utility\cp_controlled_callbacks::_id_119A0 );
}

_id_13256()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "team_utility", "init", scripts\mp\utility\teams::_id_13257 );
}
