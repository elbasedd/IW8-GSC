...
init()
{
    ...
    scripts\mp\supers\super_stoppingpower::_id_130B5();
    _findgivearmoramountanddropleftovers::watchspawnwallplayerexit();
    scripts\mp\utility\spawn_event_aggregator::registeronplayerspawncallback( ::_id_13140 );
    _calloutmarkerping_onpingchallenge::bot_can_switch_to_defender();
    level.setsuperweapondisabled = ::setsuperweapondisabled;
    scripts\cp_mp\utility\script_utility::registersharedfunc( "super", "watchSuperLastStandEnd", ::_id_13C1A );
}
...
loadsupertable()
{
    ...
    for (;;)
    {
        ...
        var_4._id_12379 = readsupertablecell( var_1, 6, 1 );
        ...
        var_4.disable_weapon_swap_until_swap_finished = readsupertablecell( var_1, 19, 1 );
...
registersupers()
{
    ...
    registersuper( "super_select", ::_id_1314D, ::_id_1314E, ::superselectbeginuse, undefined );
    registersuper( "super_fulton", undefined, undefined, ::_id_13147, undefined );
    registersuper( "super_supply_drop", undefined, undefined, ::_id_13150, undefined );
    registersuper( "super_vehicle_drop", undefined, undefined, ::_id_13152, undefined );
    registersuper( "super_loot_drop", undefined, undefined, ::_id_13150, undefined );

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        registersuper( "super_airpocket", ::bot_ctf_my_team_flag_is_picked_up, undefined, undefined, undefined );
        registersuper( "super_nova_box", undefined, ::supportboxunset, ::watchspawninput, undefined );
    }

    _id_123E0( "super_emp_drone", "emp_drone_player_mp" );
    _id_123E0( "super_emp_drone", "emp_drone_non_player_mp" );
    _id_123E0( "super_emp_drone", "emp_drone_non_player_direct_mp" );
    _id_123E0( "super_weapon_drop", "deploy_weapondrop_mp" );
}
...
_id_123E0( var_0, var_1 )
{
    if ( !isstring( var_1 ) )
        var_1 = var_1.basename;

    var_2 = level.superglobals.staticsuperdata[var_0];
    var_2.missed_shots[var_2.missed_shots.size] = var_1;
    level.superglobals._id_1314C[var_1] = var_2;
}
...
clearsuper( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.staticdata ) )
        _id_1314B( var_1.staticdata.ref );
    ...
    thread _branalytics_addeventallowed::_id_12975( "ui_super_state", 0 );
...
_id_13790()
{
    ...
    if ( !isdefined( var_0.z_below_check ) || var_1 != var_0.z_below_check )
        self setclientomnvar( "ui_super_progress", var_1 );

    self setplayersupermeterprogress( var_1 );
    var_0.z_below_check = var_1;
}
...
updatesuperuistate()
{
    ...
    if ( !isdefined( var_1 ) || var_2 != var_1 )
        thread _branalytics_addeventallowed::_id_12975( "ui_super_state", var_2 );
    ...
    if ( isdefined( var_0 ) && !var_0.isinuse )
    {
        ...
        else
        {
            ...
            if ( istrue( self.inlaststand ) )
                thread _id_13C1A( var_0.staticdata.weapon );
            else
                self setweaponammoclip( var_0.staticdata.weapon, 1 );
        }
    }
...
superusefinished( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        else if ( var_4.staticdata.disable_weapon_swap_until_swap_finished )
        {
            clearsuper();
            self setclientomnvar( "ui_perk_package_state", 0 );
            self setclientomnvar( "ui_super_progress", 0 );
    ...
    scripts\cp\utility\cp_controlled_callbacks::_id_119D4( var_4, var_5 );
}
...
handledeath()
{
    ...
    var_0 = getcurrentsuper();
    var_1 = var_0.staticdata._id_12379;
...
getsuperpointsneeded()
{
    ...
    if ( isdefined( var_0._id_11AA3 ) )
        var_1 = var_0._id_11AA3;
...
power_wave_mode_reset_playerdata( var_0 )
{
    if ( !isstring( var_0 ) )
        var_0 = var_0.basename;

    if ( !isdefined( level.superglobals._id_1314C[var_0] ) )
        return undefined;

    return level.superglobals._id_1314C[var_0].ref;
}
...
getsuperrefforsuperweapon( var_0 )
{
    ...
    var_2 = power_wave_mode_reset_playerdata( var_0 );
...
updateactivesupers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_11 )
    {
        ...
        if ( var_8 && var_0 scripts\mp\utility\perk::_hasperk( "specialty_bulletdamage" ) )
            var_1 thread scripts\mp\supers\super_stoppingpower::_id_130BA( var_5 );
    }
}
...
scramblebeginuse()
{
    ...
    thread scripts\cp_mp\killstreaks\helper_drone::riotshieldiscurrentprimary( self );
    return 1;
}
...
{
    return _calloutmarkerping_onpingchallenge::bot_capture_hq_zone();
}
...
watchspawninput()
{
    return _findgivearmoramountanddropleftovers::watchspawninput();
}
