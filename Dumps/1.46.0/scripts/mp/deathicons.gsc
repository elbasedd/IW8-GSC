...
adddeathicon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_2.takeaccesscardpickup ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_2.takeaccesscardpickup );
        var_2.takeaccesscardpickup = undefined;
    }
    ...
    var_13 = var_5;
    var_14 = var_5;
    var_2.takeaccesscardpickup = var_2 scripts\cp_mp\entityheadicons::setheadicon_singleimage( var_10, var_9, undefined, 1, 0, 0, undefined, undefined, var_13, var_12, var_14 );

    if ( isdefined( var_2.takeaccesscardpickup ) )
    {
        if ( var_5 || var_6 )
            var_2 thread relic_fastbleedout_returnfunc( var_7 );
        else
...
relic_fastbleedout_returnfunc( var_0 )
{
    ...
    var_1 = self.team;
    var_2 = self.takeaccesscardpickup;

    if ( !var_0 )
        relic_amped_do_explosion( var_2, var_1 );
    ...
    if ( isdefined( self ) )
        self.takeaccesscardpickup = undefined;
}

relic_amped_do_explosion( var_0, var_1 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        scripts\cp_mp\entityheadicons::_id_12995( var_0, var_6 );
    }
...
destroyslowly( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
        var_1.takeaccesscardpickup = undefined;
}

riskspawn_initialset( var_0 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_0.takeaccesscardpickup ) )
        return;

    scripts\cp_mp\entityheadicons::_id_12995( var_0.takeaccesscardpickup, var_0 );
}
...
_id_124A0( var_0 )
{
    ...
    scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_0.takeaccesscardpickup );
    var_0.takeaccesscardpickup = undefined;
...
addenemydeathicon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_1.takelaststandtransitionweapon ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_1.takelaststandtransitionweapon );
        var_1.takelaststandtransitionweapon = undefined;
    }
    ...
    var_10 = var_1.origin;
    var_1.takelaststandtransitionweapon = var_1 scripts\cp_mp\entityheadicons::setheadicon_singleimage( var_2, var_6, undefined, var_7, var_8, var_9, undefined, undefined, undefined, var_10 );
...
destroyenemyiconslowly( var_0 )
{
    ...
    var_1 = self;
    var_2 = self.takelaststandtransitionweapon;
    wait( var_0 );
    scripts\cp_mp\entityheadicons::setheadicon_deleteicon( var_2 );
