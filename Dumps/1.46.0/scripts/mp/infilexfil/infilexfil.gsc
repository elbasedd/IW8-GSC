...
infil_init()
{
    ...
    if ( game["roundsPlayed"] > 0 || getdvarint( "scr_skip_infils", 0 ) == 1 || getdvarint( "scr_game_infilSkip", 0 ) == 1 || scripts\mp\utility\game::getgametype() == "br" || getdvarint( "scr_game_matchstarttime" ) < 15 || scripts\mp\utility\game::getgametype() == "war" && scripts\cp_mp\utility\game_utility::spawn_exfil_juggs() )
    {
        game["infil"] = undefined;
    ...
    if ( scripts\mp\gamelogic::_id_12B2D() )
    ...
    var_0 = undefined;
    level.select_top_roof_spawners = 0;
...
infil_player_rig( var_0, var_1, var_2 )
{
    ...
    scripts\engine\utility::_id_13AD9( "remove_rig", "player_free_spot" );
...
heli_wait_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.radius ) )
    {
        ...
        scripts\engine\utility::_id_13AD9( "near_goal", "goal" );
    }
    else
        self waittill( "goal" );
...
_id_13A9F()
{
    ...
    while ( level.select_top_roof_spawners != 0 )
        waitframe();
