...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.isgunlessweapon ) )
        return;

    if ( isdefined( level.vehicle_docollisiondamagetoplayer ) && self [[ level.vehicle_docollisiondamagetoplayer ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public.gsc::deadyellow( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && spawn_backup_helispawner_jammer2( var_0 ) )
            var_7 = "dx_bra_";
        ...
        else if ( istrue( self.s4operator ) )
...
spawn_backup_helispawner_jammer2( var_0 )
{
    var_1 = 0;
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public.gsc::deadyellow( self );
    ...
    if ( level.teambased )
    {
        var_5 = f14_keypadnumstr( var_0, 1 );
        var_6 = f14_keypadnumstr( var_0 );
