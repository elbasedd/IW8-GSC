...
getweapongroup( var_0 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        if ( issuperweapon( var_0 ) )
            ...
            var_2 = "gamemode";
        else if ( spawn_ai_single( var_0 ) )
            var_2 = "weapon_ballisticSpecial";
        else if ( spawn_field_ai_manager_middle( var_0 ) )
...
player_test_ending_teleport( var_0 )
{
    var_1 = getweaponrootname( var_0 );
...
attachmentscompatible( var_0, var_1, var_2 )
{
    ...
    if ( var_1 == var_2 )
        var_3 = 0;
    else if ( isdefined( level.attachmentmap_conflicts_by_game ) )
    {
        if ( !isdefined( level.attachmentmap_conflicts_by_game[var_0] ) )
            var_0 = "default";

        var_3 = !( isdefined( level.attachmentmap_conflicts_by_game[var_0][var_1] ) && isdefined( level.attachmentmap_conflicts_by_game[var_0][var_1][var_2] ) );
    }
    else if ( var_1 != "none" && var_2 != "none" )
    {
        if ( !isdefined( level.attachmentmapcombos_by_game[var_0] ) )
            var_0 = "default";

        var_4 = level.attachmentmapcombos_by_game[var_0];
...
attachmentsconflict( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( activate_chopper_boss_ammo_crates( var_3, var_4 ) )
        return var_0;

    if ( activate_chopper_boss_ammo_crates( var_4, var_3 ) )
        return var_0;

    var_0 = attachmentmap_tobase( var_0 );
    var_1 = attachmentmap_tobase( var_1 );
    var_6 = scripts\mp\weapons::getweaponsource( var_5 );

    if ( isdefined( level.attachmentmap_conflicts_by_game ) && !isdefined( level.attachmentmap_conflicts_by_game[var_6] ) )
        var_6 = "default";
    ...
    if ( var_0 == var_1 )
        var_7 = var_0;
    else if ( isdefined( level.attachmentmap_conflicts_by_game ) && isdefined( level.attachmentmap_conflicts_by_game[var_6] ) && isdefined( level.attachmentmap_conflicts_by_game[var_6][var_0] ) )
    {
        var_8 = level.attachmentmap_conflicts_by_game[var_6][var_0][var_1];
...
activate_chopper_boss_ammo_crates( var_0, var_1 )
{
    var_2 = c4_crate_spawn( var_0 );
    var_3 = c4_crate_player_at_max_ammo( var_1 );
...
{
    return spawn_boxes( getweapongroup( var_0 ), var_0 );
}

spawn_boxes( var_0, var_1 )
{
    switch ( var_0 )
    {
        case "weapon_melee":
...
{
    return spawn_cache4_rpgs( getweapongroup( var_0 ), var_0 );
}

spawn_cache4_rpgs( var_0, var_1 )
{
    switch ( var_0 )
    {
...
iscacprimaryorsecondary( var_0 )
{
    ...
    return spawn_boxes( var_1, var_0 ) || spawn_cache4_rpgs( var_1, var_0 );
}
...
{
    if ( isdefined( level.c130deliverydirection[var_0] ) )
        return level.c130deliverydirection[var_0];
...
{
    if ( isdefined( level.c4_crate_update_hint_logic_alt[var_0] ) )
        return level.c4_crate_update_hint_logic_alt[var_0];

    var_1 = attachmentmap_tobase( var_0 );

    if ( isdefined( level.c130successfulairdrops[var_1] ) )
        return level.c130successfulairdrops[var_1];
...
{
    var_1 = randomintrange( 0, level._id_13CA3[var_0].size );
    return level._id_13CA3[var_0][var_1];
}
...
_id_13CAE( var_0 )
{
    if ( isdefined( level.weaponmapdata[var_0] ) && isdefined( level.weaponmapdata[var_0].valid_carriable_pickup_weapon ) )
        return level.weaponmapdata[var_0].valid_carriable_pickup_weapon;
...
process_entities_inside_subway_car( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = [];
    ...
    for (;;)
    {
        ...
        if ( !level.weaponlootmapdata[var_4].spawn_riders_and_play_intro_idle_anim && !scripts\engine\utility::array_contains( var_1, var_2 ) )
...
printer( var_0, var_1 )
{
    ...
    var_2 = 0;
    var_3 = process_entities_inside_subway_car( var_0, var_1 );
...
_id_13CA6( var_0, var_1 )
{
    ...
    if ( var_2 )
    {
        ...
        {
            var_4 = var_0 + "|" + var_1;
            var_3 = isdefined( level.weaponlootmapdata[var_4] ) && !level.weaponlootmapdata[var_4].spawn_riders_and_play_intro_idle_anim;
        }
    }
...
attachmentlogsstats( var_0, var_1 )
{
    ...
    if ( !c130airdrop_startdelivery( var_1, var_0 ) )
        return 0;
...
c130airdrop_startdelivery( var_0, var_1 )
{
    ...
    return c130deliveriesinprogress( var_2, var_1 );
}

c130deliveriesinprogress( var_0, var_1 )
{
...
weaponbypassspawnprotection( var_0 )
{
    ...
    if ( iskillstreakweapon( var_0 ) && var_2 != "manual_turret_mp" && var_2 != "pac_sentry_turret_mp" && !spawn_set_jugg_value( var_2 ) )
        var_1 = 0;
...
spawn_sentries_from_targetname( var_0 )
{
    if ( issameweapon( var_0 ) )
        var_1 = var_0.basename;
    else
...
{
    if ( spawn_sentries_from_targetname( var_0 ) )
        return 1;
...
spawn_jugg_backup_trigger( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
{
    if ( isdefined( level.br_pickups ) && isdefined( level.br_pickups.br_weapontoscriptable ) && isdefined( level.br_pickups.createinvalidcirclearea ) )
    {
        var_1 = createheadicon( var_0 );
        var_2 = level.br_pickups.br_weapontoscriptable[var_1];

        if ( isdefined( var_2 ) )
            return level.br_pickups.createinvalidcirclearea[var_2];
    }
