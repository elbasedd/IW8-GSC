...
addtoteamlives( var_0, var_1, var_2, var_3 )
{
    ...
    _id_13827( "add", var_1, var_0 );

    if ( isdefined( level.vehicle_damage_registervisualpercentcallback ) )
        [[ level.vehicle_damage_registervisualpercentcallback ]]( var_0, var_1, var_3 );
...
removefromteamlives( var_0, var_1, var_2, var_3 )
{
    ...
    _id_13827( "remove", var_1, var_0 );

    if ( isdefined( level.vehicle_fob_think ) )
        [[ level.vehicle_fob_think ]]( var_0, var_1, var_3 );
    ...
    if ( istrue( var_2 ) && isgameplayteam( var_1 ) && !scripts\cp_mp\utility\game_utility::isrealismenabled() )
    {
        ...
        var_6 = scripts\mp\gametypes\br_public.gsc::postplunder( var_1, var_0.squadindex );
...
_id_13827( var_0, var_1, var_2 )
{
    ...
    if ( var_7 != var_8 || var_4 || var_5 )
    {
        ...
        scripts\mp\utility\script::intel_location_vo( var_9 );
...
getenemyteams( var_0 )
{
    ...
    if ( isdefined( level._id_13D9C ) || scripts\mp\utility\game::currentmultikill() )
