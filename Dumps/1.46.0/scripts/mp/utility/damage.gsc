...
{
    if ( istrue( var_2 ) && spawn_lmg_soldiers_02( var_0, var_1 ) )
        return 1;
...
spawn_lmg_soldiers_02( var_0, var_1 )
{
...
islethalmeleeweapon( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\weapon::spawn_sentries_from_targetname( var_2 ) )
        return 1;
...
attackerishittingteam( var_0, var_1 )
{
    ...
    if ( !level.teambased )
        ...
        return 0;
    else if ( isagent( var_0 ) && istrue( var_0._id_12BEB ) )
        return 0;
