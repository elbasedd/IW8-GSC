...
quarry_mortar_guys( var_0, var_1 )
{
    if ( istrue( level.ignorescoring ) )
        return;
...
giveunifiedpoints( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_16 = spawn_techo_lmgs( var_1 );
    var_17 = scripts\mp\utility\perk::_hasperk( "specialty_killstreak_to_scorestreak" );
    var_18 = !istrue( level.subway_death_or_disconnect_monitor );
    ...
    if ( isdefined( level._id_119B2 ) )
        [[ level._id_119B2 ]]( self, var_9, var_0, var_7 );
    ...
    if ( !istrue( var_3 ) )
    {
        ...
        if ( var_0 == "kill" )
        {
            var_21 = var_1 hasattachment( "gunperk_xp", 1 ) || scripts\mp\utility\perk::_hasperk( "specialty_gunperk_xp" );
