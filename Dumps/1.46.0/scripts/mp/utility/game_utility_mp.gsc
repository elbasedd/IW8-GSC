...
shouldgamelobbyremainintact( var_0, var_1 )
{
    if ( !isdefined( level.br_level ) )
        return 1;

    var_2 = playerstreamwaittillcomplete( var_1 );
...
playerstreamwaittillcomplete( var_0 )
{
    ...
    var_2 = isdefined( level.br_level.createpropspeclist );
    var_3 = istrue( var_0 );

    if ( var_2 && var_3 )
        var_1 = level.br_level.createpropspeclist;
...
{
    var_1 = playerstreamwaittillcomplete( var_0 );
    var_2 = var_1[1][0];
    var_3 = var_1[0][0];
