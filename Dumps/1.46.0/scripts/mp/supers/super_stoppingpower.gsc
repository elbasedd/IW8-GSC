...
_id_130B5()
{
    level._id_119EA _branalytics_addevent::entityplunderbankalldeposited( ::_id_130BB, level );
    level._id_119EB _branalytics_addevent::entityplunderbankalldeposited( ::_id_130BC, level );
}
...
stoppingpower_beginuse()
{
    ...
    if ( !scripts\mp\weapons::isnormallastweapon( var_0 ) || scripts\mp\utility\weapon::ismeleeonly( var_0 ) || scripts\mp\utility\weapon::isgamemodeweapon( var_0 ) || scripts\mp\utility\weapon::issinglehitweapon( var_0.basename ) || !_id_130B8( var_0 ) || _id_130B6( var_0 ) )
    {
        ...
        if ( isnullweapon( var_7, var_0, 0 ) )
        {
            ...
            if ( 1 )
            {
                if ( var_8 )
                {
                    ...
                    var_11 = var_9 + var_4;
                    var_12 = int( min( _id_130B2( var_7, var_11 ), var_11 + var_10 ) );
    ...
    thread _id_130BE( var_0, var_4, var_5 );
    return 1;
}

_id_130B2( var_0, var_1 )
{
    var_2 = var_0.maxammo;
...
_id_130B4( var_0, var_1 )
{
    ...
    var_1 thread _id_130B0();
    var_1 thread _id_130B1();
...
stoppingpower_watchhcrweaponchange()
{
    ...
    {
        if ( _id_130B7( self.player getcurrentweapon() ) )
        {
            if ( !self.gavehcr )
            {
...
stoppingpower_watchhcrweaponfire()
{
    ...
    self.player thread _id_130BD( self.objweapon );
    thread stoppingpower_removehcr();
}
...
_id_130AF()
{
    if ( isdefined( self.player.hcrdata ) )
    {
        ...
        self.player scripts\cp\utility\cp_controlled_callbacks::_id_11972( "super_support_box", self.kills );
