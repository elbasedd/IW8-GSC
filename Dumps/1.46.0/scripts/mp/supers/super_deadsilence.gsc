...
superdeadsilence_endsuper( var_0 )
{
    ...
    scripts\cp\utility\cp_controlled_callbacks::_id_11972( "super_deadsilence", self.deadsilencekills );
...
superdeadsilence_onkill()
{
    if ( scripts\mp\utility\game::getgametype() != "infect" )
    {
        ...
        var_0 = scripts\mp\supers::playerinlaststandhold( "super_deadsilence" );

        if ( self.deadsilencekills > var_0 )
        {
            var_1 = self.deadsilencekills - var_0;
            scripts\mp\supers::getsquadspawnstruct( "super_deadsilence", var_1 );
        }
    }

    var_2 = scripts\mp\utility\game::spawn_maint_wave_1();
    var_3 = 1;
    ...
    if ( var_2 )
    {
        ...
        if ( istrue( var_4.remove_closest_chopper_boss_vandalize_node_down ) )
            var_3 = 0;
        else
            var_4.remove_closest_chopper_boss_vandalize_node_down = 1;
    }
...
applyfovpresentation()
{
    ...
    var_1 = var_0 - 2;
    scripts\engine\utility::_id_13AF3( var_1, "super_use_finished" );
...
_id_13146()
{
    ...
    level scripts\engine\utility::_id_13AD9( "game_ended", "prematch_cleanup" );
