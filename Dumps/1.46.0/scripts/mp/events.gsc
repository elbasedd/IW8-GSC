...
init()
{
    ...
    for (;;)
    {
        ...
        var_3 = tablelookupbyrow( "mp/score_event_table.csv", var_1, level.fuel_stability_event_start.game_type_col[var_0] );
...
cacheentity( var_0, var_1, var_2, var_3 )
{
    var_4 = 1;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        else if ( caclulate_track_distance( var_2, var_1, var_3 ) )
        {
...
caclulate_track_distance( var_0, var_1, var_2 )
{
    var_3 = 0;
...
burningstate( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isplayer( self ) )
        return;
    ...
    {
        var_10 = cacheentity( self, var_4, var_2, var_3 );
        ...
        if ( isdefined( var_1._id_130FE ) && var_1._id_130FE == self )
        {
            self.modifiers["grenadestuck"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 8;
        }

        if ( scripts\mp\utility\game::source( var_1 ) )
        {
        ...
        if ( var_3 == "MOD_HEAD_SHOT" || stadium_puzzle( var_2, var_5 ) || soldier_encounter_test( var_2, var_5 ) )
        {
        ...
        if ( var_10 )
        {
            ...
            switch ( var_24 )
            {
                ...
                case "longshot":
                    ...
                    self setclientomnvar( "ui_longshot_special", spawn_router_model( var_11, var_1, var_2 ) );
                    break;
                case "very_longshot":
                    self.modifiers["longshot"] = 1;
                    self.modifiers["mask"] = self.modifiers["mask"] | 262144;
            ...
            if ( scripts\mp\class::stack_patch_thread_leaf( var_2 ) )
            {
            ...
            if ( spawn_enemies_intro( self, var_1 ) )
            {
                self.modifiers["detectedimpairedkill"] = 1;
            ...
            if ( isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::playertakeextractionplunder() > gettime() )
            ...
            if ( isdefined( var_5.damageflags ) && var_5.damageflags & level.idflags_penetration && !( var_5.damageflags & level.scriptable_door_freeze_open ) )
            {
                self.modifiers["coverkill"] = 1;
                self.modifiers["mask2"] = self.modifiers["mask2"] | 262144;
            }

            if ( scripts\mp\equipment\gas_grenade::openbunkerdoor( self, var_1 ) )
            {
        ...
        if ( scripts\mp\utility\player::spawn_module_trickle( self ) )
        {
            self.modifiers["last_stand"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 1024;
        }

        if ( scripts\mp\utility\player::spawn_module_trickle( var_1 ) || istrue( var_5.disablewinonscore ) )
        {
    ...
    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) || scripts\mp\utility\weapon::spawn_overwatch_soldiers_01( var_4 ) )
    ...
    if ( scripts\mp\utility\game::getgametype() != "br" )
    {
        if ( self.modifiers["mask"] & 1048576 && self.modifiers["mask"] & 262144 )
            gasgrenade_crate_spawn( var_2 );
    }

    if ( var_7 == "other" )
        gasmaskmaxhealth( var_2 );
}

playerbrsquadleaderscore( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
    return var_5;
}

playercanbuyrespawn( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
...
killedplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_2._id_11AF1 ) )
        var_2 = var_2._id_11AF1;
    ...
    thread gas_linger_large_vfx( var_1 );
    var_7 = var_1.guid;
    var_8 = self.guid;
    ...
    thread _id_1375C( var_3, var_4, var_1 );
    ...
    if ( !scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) && !scripts\mp\utility\perk::_hasperk( "specialty_explosivebullets" ) )
    {
        ...
        var_12 = cacheentity( self, var_4, var_2, var_3 );
        ...
        if ( var_12 )
        {
            ...
            if ( self ismantling() )
                unset_force_aitype_riotshield( var_0 );
        ...
        if ( scripts\mp\utility\game::getgametypenumlives() >= 1 )
        {
            ...
            var_27 = scripts\mp\utility\game::_id_1359B();
...
{
    var_3 = scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) || scripts\mp\utility\weapon::spawn_overwatch_soldiers_01( var_2 );
    var_4 = scripts\mp\utility\points::spawn_lmg_soldiers_04( var_0 );
    ...
    if ( var_3 && !var_4 )
    {
        if ( isdefined( var_2 ) && isdefined( var_2.streakinfo ) )
        {
            ...
            if ( isdefined( var_2.streakinfo.mpstreaksysteminfo ) )
            {
                ...
                if ( var_2.streakinfo.mpstreaksysteminfo._id_11ACA != self getxuid() )
                    var_5 = 0;
            }
            ...
            if ( isdefined( var_2.streakinfo.streakname ) )
            {
                ...
                if ( isdefined( var_2.streakinfo.kills ) )
                {
                    ...
                    if ( !istrue( var_2.streakinfo.waittill_drone_timeout ) && var_2.streakinfo.kills > 1 )
                    {
                        scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_scorestreak_kill_two_or_more_s1", 1 );
                        var_2.streakinfo.waittill_drone_timeout = 1;
                    }
                }
...
killedplayerwithsuperweapon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    scripts\cp\utility\cp_controlled_callbacks::updatesuperweaponkills( var_2, var_1 );
...
superkill( var_0, var_1 )
{
    ...
    var_4.numkills++;
    scripts\cp\utility\cp_controlled_callbacks::updatesuperkills( var_0, var_1, var_4.numkills );
...
_id_1217B( var_0 )
{
    var_1 = scripts\mp\killstreaks\killstreaks::plundertimer( var_0 );
...
spawn_router_model( var_0, var_1, var_2 )
{
...
spawn_enemies_intro( var_0, var_1 )
{
    var_2 = isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::playertakeextractionplunder() > gettime();
    var_3 = isdefined( var_0.radarstrength ) && var_0.radarstrength > 3 && !var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ghost" );
    var_4 = istrue( var_1.spawn_real_number );
...
longshot( var_0 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "longshot" );
    ...
    if ( self.currentweapon hasattachment( "gunperk_acquisition" ) || self.currentweapon hasattachment( "gunperk_acquisition_ch2" ) )
        thread scripts\mp\perks\perkfunctions::_id_1295A();
}
...
pointblank( var_0 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "pointblank" );
...
headshot( var_0 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "headshot" );
...
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "avenger" );
...
assistedsuicide( var_0, var_1 )
{
    ...
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "assistedsuicide" );
...
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "defender" );
...
postdeathkill( var_0 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "posthumous" );
...
revenge( var_0, var_1 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "revenge" );
...
{
    if ( !isdefined( self.hideconesifinfil ) )
        self.hideconesifinfil = var_1;

    if ( var_1 < self.hideconesifinfil )
        return;
    ...
    thread scripts\common\utility::_id_13592( level.update_objective_setmlgbackground, var_0, var_1 );
...
firstblood( var_0 )
{
    ...
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "firstblood" );
...
buzzkill( var_0, var_1 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "buzzkill" );
...
comeback( var_0 )
{
    thread scripts\common\utility::_id_13592( level.update_keypad_currentdisplay_models, var_0, "comeback" );
...
updaterecentkills( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::source( var_1 ) )
    {
        ...
        if ( scripts\mp\utility\script::isnumbermultipleof( self._id_12334, 3 ) )
            _id_1355A( var_0 );
    }
    ...
    if ( !isdefined( self._id_12337[var_2.basename] ) )
        self._id_12337[var_2.basename] = 1;
    else
        self._id_12337[var_2.basename]++;
    ...
    self._id_1233A = 0;
    self.recentstoppingpowerkillcount = undefined;
    self.recentkillsperweapon = undefined;
    self._id_12337 = undefined;
    self.waittill_drone_timeout = 0;
}

_id_1375C( var_0, var_1, var_2 )
{
    if ( scripts\mp\utility\game::getgametype() != "br" )
        return;
    ...
    var_3.victim = var_2;
    var_3.tutorialprint_number = 1;
    scripts\mp\gametypes\br_challenges.gsc::fuelsequencestability( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::fuelsequencestability( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::fuelsequencestability( "br_mastery_ghostRideWhip", var_3 );
}
...
bombdefused( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
        var_0 thread scripts\common\utility::_id_13592( level.update_objective_mlgicon_reset, "defuse", var_0.origin );

    if ( var_1 )
        scripts\mp\utility\game::trial_targs_combo( var_0, undefined, "Bomb Defused", var_0.origin, "last_alive" );
    else
        scripts\mp\utility\game::trial_targs_combo( var_0, undefined, "Bomb Defused", var_0.origin );
...
revivedplayer( var_0, var_1 )
{
    ...
    var_0 scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_revived_teammate_for_operator_mission", 1 );
...
killeventtextpopup( var_0, var_1, var_2 )
{
    ...
    var_6._id_12175 = 0;
    var_6._id_12174 = 0;
    var_6.kill_tac_covers = istrue( var_2 );
...
_id_1217C()
{
    ...
    foreach ( var_1 in self.splashpriorityqueue )
    {
        ...
        if ( !istrue( level.removekilleventsplash ) && istrue( var_1.showassplash ) && ( !self._id_11D58 || var_1.alwaysshowsplash ) )
        {
            var_2 = 1;
    ...
    foreach ( var_1 in self.splashpriorityqueue )
    {
        if ( var_1._id_12174 || var_1.kill_tac_covers )
            continue;
...
soldier_encounter_test( var_0, var_1 )
{
...
gasmaskmaxhealth( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.toggle_ambient_vehicles_on_module[var_1] ) )
        return;

    if ( self.pers["lethalEquipmentKillMask"] & level.toggle_ambient_vehicles_on_module[var_1] )
        return;
    else
        self.pers["lethalEquipmentKillMask"] = self.pers["lethalEquipmentKillMask"] | level.toggle_ambient_vehicles_on_module[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.toggle_ambient_vehicles_on_module )
    {
...
gasgrenade_crate_spawn( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.removeminigunrestrictions[var_1] ) )
        return;

    if ( self.pers["headshotLongshotMask"] & level.removeminigunrestrictions[var_1] )
        return;
    else
        self.pers["headshotLongshotMask"] = self.pers["headshotLongshotMask"] | level.removeminigunrestrictions[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.removeminigunrestrictions )
    {
...
gas_linger_large_vfx( var_0 )
{
    ...
    {
        self._id_1234A = undefined;
        return;
    }

    if ( isplayer( var_0 ) && isdefined( self._id_1234A ) )
    {
        if ( self.modifiers["mask2"] & 32768 )
            var_1 = 1;
    }

    level scripts\engine\utility::_id_13AED( 1, "game_ended" );
    ...
    if ( level.gameended )
    {
        if ( var_1 )
        {
            ...
            if ( isdefined( self._id_1234A ) )
                self._id_1234A reportchallengeuserevent( "collect_item", "recon_drone_achievement" );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges.gsc::fuelsequencestability( "br_mastery_roundKillExecute", var_2 );
        }
    }
