...
autoattachtoplayer()
{
    ...
    level.target_active_fob_watcher = game["lastSpectatedPlayer"];
    ...
    for (;;)
    {
        ...
        {
            if ( level.currentround > 1 && isdefined( level.target_active_fob_watcher ) && self.team != "follower" )
                var_0 = level.target_active_fob_watcher;
...
updatemlgspectator()
{
    ...
    for (;;)
    {
        if ( self ismlgspectator() && self isspectatingplayer() )
        {
            ...
            if ( isdefined( var_0 ) )
                level.target_active_fob_watcher = var_0.clientid;
        }
...
_id_1271C()
{
    ...
    game["lastSpectatedPlayer"] = level.target_active_fob_watcher;
}
