...
inititems()
{
    ...
    var_0.callbacks["equip_airpocket"]["onGive"] = _calloutmarkerping_onpingchallenge::bot_choose_defend_zone;
    var_0.callbacks["equip_airpocket"]["onTake"] = _calloutmarkerping_onpingchallenge::bot_ctf_can_switch_to_defender;
    ...
    var_0.callbacks["equip_binoculars"]["onGive"] = _calloutmarkerping_poolidisdanger::checkpoint_add_carepackage_munitions;
    var_0.callbacks["equip_binoculars"]["onTake"] = _calloutmarkerping_poolidisdanger::checkpoint_fx_set;
...
loadtable()
{
    ...
    for (;;)
    {
        ...
        var_3.spawnuniqueboardroomloot = tablelookupbyrow( "mp/equipment.csv", var_0, 8 ) != "-1";
...
spawn_helicoper_enemy( var_0 )
{
    if ( isdefined( level.equipment.table[var_0] ) )
        return istrue( level.equipment.table[var_0].spawnuniqueboardroomloot );
    else
        return 0;
}
...
executeoffhandfired( var_0 )
{
    foreach ( var_6, var_2 in self.equipment )
    {
        ...
        if ( isdefined( var_3.objweapon ) && var_0 == var_3.objweapon )
        {
            ...
            scripts\mp\damage::getspreadpelletspershot( var_4 );
...
watchlethaldelayplayer( var_0, var_1 )
{
    ...
    if ( !isdefined( self.toggle_apc_objective ) || !istrue( self.toggle_apc_objective[var_1] ) )
    {
        if ( !isdefined( self.toggle_apc_objective ) )
            self.toggle_apc_objective = [];

        self.toggle_apc_objective[var_1] = 1;
    ...
    if ( isdefined( self.toggle_apc_objective ) && istrue( self.toggle_apc_objective[var_1] ) )
    {
        self.toggle_apc_objective[var_1] = undefined;

        if ( self.toggle_apc_objective.size == 0 )
...
hackequipment( var_0 )
{
    ...
    var_0 scripts\cp\utility\cp_controlled_callbacks::_id_1197D( self.equipmentref );
    changeowner( var_0 );
...
proxy_include( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4._id_127F3 = var_4 getcurrentequipment( var_1 );
        var_4._id_127F2 = getequipmentslotammo( var_1 );
        var_4 takeequipment( var_1 );
        var_4 giveequipment( var_2, var_1 );
    }
}

_id_131F1( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        var_7 = var_5._id_127F3;
        var_8 = var_5._id_127F2;

        if ( isdefined( var_7 ) )
        {
            var_5 giveequipment( var_7, var_1 );
            var_5._id_127F3 = undefined;

            if ( isdefined( var_8 ) )
            {
                var_5 setequipmentammo( var_7, var_8 );
                var_5._id_127F2 = undefined;
            }
        }
    }
}
...
setuphunters()
{
    level.toggle_ambient_vehicles_on_module = [];
    var_0 = 0;

    foreach ( var_2 in level.equipment.table )
    {
        if ( !var_2.spawnuniqueboardroomloot )
            continue;
        ...
        level.toggle_ambient_vehicles_on_module[var_2.ref] = 1 << var_0;
        var_0++;
    }
}
