...
handlesplashqueue()
{
    ...
    {
        if ( scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\utility\game::postupdategameevents() == "dmz" || scripts\mp\utility\game::postupdategameevents() == "risk" || scripts\mp\utility\game::postupdategameevents() == "rumble" ) )
            scripts\engine\utility::_id_13AD9( "splash_list_cleared", "can_show_splashes" );
        else
            scripts\engine\utility::_id_13AD9( "splash_list_cleared", "spawned_player" );
...
getinventoryslotscriptabletypeinfo()
{
