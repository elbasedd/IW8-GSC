...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !istrue( level.isplayerinsiderectangularzone ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0._id_12B23 = 1;
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level._id_127CE[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level._id_127CE ) && isdefined( level._id_127CE[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level._id_127CE[var_0] );
...
finalizespawnpointchoice( var_0 )
{
    ...
    else
    {
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0._id_1380F, var_0.threatsight, var_0.damagemod );
    }
...
playerzombiesetupkeybindings( var_0 )
{
...
checkmodifiedspawnpoint( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        var_2 = playerzombiesetupkeybindings( var_0 );
...
heli_audio( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
assassination_target( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level._id_127CE[var_3] ) )
            level._id_127CE[var_3] = [];
        ...
        level._id_127CE[var_3][level._id_127CE[var_3].size] = var_8;
    }

    level thread _id_127CF();
}
...
_id_127CF()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level._id_127CE )
        {
            foreach ( var_3 in var_1 )
            {
