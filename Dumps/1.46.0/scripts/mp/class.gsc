...
init()
{
    ...
    else if ( scripts\mp\utility\game::spawn_chopper_carepackage() )
    {
...
enemy_mine_damaged_think( var_0, var_1, var_2 )
{
...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::player_pushing_vehicle_monitor( var_0 );
}
...
_id_131A9( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    return _id_131AA( var_3, var_4 );
}

_id_131AA( var_0, var_1 )
{
    if ( var_0 == "none" )
        return 0;

    if ( !isdefined( level.chopper_kill_vehicle ) )
    {
        level.chopper_kill_vehicle = [];
        level.chopper_kill_vehicle["iw8_ar_tango21"] = [ 1 ];
        level.chopper_kill_vehicle["iw8_ar_mike4"] = [ 5 ];
        level.chopper_kill_vehicle["iw8_ar_kilo433"] = [ 3 ];
        level.chopper_kill_vehicle["iw8_ar_scharlie"] = [ 3 ];
        level.chopper_kill_vehicle["iw8_sm_uzulu"] = [ 4 ];
        level.chopper_kill_vehicle["iw8_sh_romeo870"] = [ 5 ];
        level.chopper_kill_vehicle["iw8_sh_dpapa12"] = [ 3 ];
        level.chopper_kill_vehicle["iw8_lm_mgolf34"] = [ 4 ];
        level.chopper_kill_vehicle["iw8_sn_kilo98"] = [ 16 ];
        level.chopper_kill_vehicle["iw8_sn_alpha50"] = [ 2 ];
        level.chopper_kill_vehicle["iw8_sn_hdromeo"] = [ 4 ];
        level.chopper_kill_vehicle["iw8_pi_golf21"] = [ 3 ];
        level.chopper_kill_vehicle["iw8_pi_cpapa"] = [ 15 ];
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.chopper_kill_vehicle[var_7] ) )
                        level.chopper_kill_vehicle[var_7] = [];

                    level.chopper_kill_vehicle[var_7][level.chopper_kill_vehicle[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.chopper_kill_vehicle[var_0] ) )
        var_10 = level.chopper_kill_vehicle[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::printer( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::_id_13CA6( var_0, var_11 );
...
loadout_clearplayer( var_0 )
{
    ...
    scripts\mp\perks\perkpackage::_id_11BF9();
...
trap_consoles( var_0 )
{
    ...
    if ( isdefined( var_0.trial_combo_died ) )
        var_1.trial_combo_died = var_0.trial_combo_died;
    ...
    if ( isdefined( var_0.trial_delete_out_of_bounds ) )
        var_1.trial_delete_out_of_bounds = var_0.trial_delete_out_of_bounds;
    ...
    var_1.spawn_custom_type = var_0.spawn_custom_type;
...
loadout_updateclasscustom( var_0, var_1 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        ...
        scripts\mp\utility\script::intel_location_vo( "loadout_updateClassCustom() called on " + var_3 + " with invalid class = " + var_4 );
    }
    ...
    for ( var_5 = 0; var_5 < 10; var_5++ )
    {
        ...
        var_0.loadoutprimaryattachmentids[var_5] = enemy_mine_damaged_think( var_2, 0, var_5 );
    }
    ...
    for ( var_5 = 0; var_5 < 10; var_5++ )
    {
        ...
        var_0.loadoutsecondaryattachmentids[var_5] = enemy_mine_damaged_think( var_2, 1, var_5 );
    }
    ...
    var_0.loadoutaccessorylogic = enemy_left_monitor();
    var_0.loadoutstreaksfilled = 1;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.trial_combo_died = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.trial_delete_out_of_bounds = var_3["loadoutSecondaryAddBlueprintAttachments"];
    ...
    var_0.trial_civilians_killed = isdefined( var_3["loadoutExtraPerks"] );
...
trap_trigger_logic( var_0, var_1 )
{
    var_2 = getclassindex( var_1 );
    self.class_num = var_2;
    var_3 = self.pers["gamemodeLoadout"];
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.trial_combo_died = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.trial_delete_out_of_bounds = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        ...
        scripts\mp\utility\script::intel_location_vo( "loadout_updateClassDefault() called on " + var_3 + " with invalid class = " + var_4 );
    }

    if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        traversal_disabled_by_management( var_0 );
    else
        travelspeed( var_0, var_2 );
...
traversal_disabled_by_management( var_0 )
{
    if ( !isdefined( self.removedeathicon ) )
    {
        if ( !isdefined( level.removedeathicon ) )
        {
            var_1 = randomint( 200 );
            level.removedeathicon = var_1;
            level.removeextracthelipad = var_1;
        }
        else
        {
            level.removedeathicon++;
            level.removeextracthelipad++;
        }

        self.removedeathicon = level.removedeathicon;
        self.removeextracthelipad = level.removeextracthelipad;
    }

    var_2 = traps_disabled( self.removedeathicon, 1 );
    var_3 = traps_disabled( self.removeextracthelipad, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
traps_disabled( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_6.variantid == 0 || var_6.spawn_riders_and_play_intro_idle_anim || !isdefined( var_6.attachcustomtoidmap ) )
                continue;

            if ( var_4 && isdefined( var_6.spawn_ai_group ) && !var_6.spawn_ai_group )
                continue;
...
loadout_updateabilities( var_0, var_1 )
{
    ...
    if ( var_0.loadoutperksfromgamemode )
    {
        ...
        if ( var_0.trial_civilians_killed )
...
loadout_updateclass( var_0, var_1 )
{
    ...
    if ( !isbot( self ) && isdefined( level.rear_minigun_wait_between_shots ) && level.rear_minigun_wait_between_shots )
        traversenotvalid( var_0 );
    else
        loadout_updateclassfinalweapons( var_0 );

    if ( isdefined( level.vehicle_invalid_seats ) )
        self [[ level.vehicle_invalid_seats ]]( var_0 );
...
loadout_updateclassfistweapons( var_0 )
{
    if ( isdefined( level.rear_minigun_wait_between_shots ) && level.rear_minigun_wait_between_shots && issameweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimary = var_0.loadoutprimary;
    else if ( var_0.loadoutprimary == "none" )
        var_0.loadoutprimary = "iw8_fists";

    if ( scripts\mp\utility\game::get_to_z_and_fly_off() )
    {
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.trial_combo_died ) )
    ...
    {
        if ( istrue( var_0.trial_delete_out_of_bounds ) )
            var_0.loadoutsecondaryobject = enable_spawner( var_0.loadoutsecondary, var_0.loadoutsecondaryattachments, var_0.loadoutsecondarycamo, var_0.loadoutsecondaryreticle, var_0.loadoutsecondaryvariantid, var_0.loadoutsecondaryattachmentids, var_0.loadoutsecondarycosmeticattachment, var_0.loadoutsecondarystickers, istrue( var_0.loadouthasnvg ) );
        else
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    trap_toggle_fx_logic( var_0, var_7, var_8, var_4, var_5, var_6 );
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = trap_room_wave_settings( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = trap_room_wave_settings( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
trap_room_wave_settings( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.semtex_stuckplayer ) )
        {
...
trap_toggle_fx_logic( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.reload_use_trigger = var_8 hasattachment( "maxammo", 1 );

    if ( isdefined( level.vehicle_damage_updatestate ) )
        self [[ level.vehicle_damage_updatestate ]]( var_6 );
    ...
    else
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.reload_use_trigger ) )
            {
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.reload_use_trigger ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.reload_use_trigger ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::sort_wave_spawning_ai( var_8 ) )
...
loadout_updateplayernvgs()
{
    ...
    if ( istrue( self.inspawncamera ) )
        scripts\engine\utility::_id_13AD9( "spawned_player", "fadeUp_start" );
...
trap_timer_running( var_0 )
{
    var_1 = getdvarint( "scr_t9_watch_suppression", 0 );

    if ( var_1 && isdefined( var_0.loadoutaccessorydata ) )
    {
        var_2 = scripts\mp\accessories::player_reenable_collect_leads( var_0.loadoutaccessorydata );
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::spectatenumber() )
    {
        var_2 = 0;
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            self.loadoutfieldupgrade1 = new_objective( self.loadoutfieldupgrade1 );
            self.loadoutfieldupgrade2 = new_objective( self.loadoutfieldupgrade2 );
        ...
        {
            var_3 = never_delete_suicide_bomber( self.loadoutfieldupgrade1 );
    ...
    {
        self.triage_glass_break = never_delete_suicide_bomber( self.loadoutfieldupgrade1 );
...
swaploadout()
{
    ...
    var_0 = scripts\mp\utility\game::spawn_maint_wave_1() && !scripts\mp\flags::gameflag( "prematch_done" );

    if ( var_0 && isdefined( level.brinfilsmokesuffix ) )
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = trap_room_ents();
    var_5 = tread_sfx( var_5, var_1 );
    self.questbasetimer = var_5;
    var_6 = undefined;
...
loadout_lognewlygivenloadout( var_0, var_1, var_2 )
{
    ...
    if ( var_8 == -1 || var_1.spawn_custom_type )
    {
...
_id_133FC()
{
    if ( !istrue( self._id_119BB ) )
    {
        var_0 = self getheldoffhand();

        if ( !nullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && sprint_hint( var_0 ) )
            self._id_119BB = 1;
    }
}
...
_id_133FE()
{
    self._id_125D8 = undefined;
    self._id_125D7 = undefined;
...
_id_133F7( var_0 )
{
    ...
    childthread _id_133F6();

    if ( isdefined( var_0 ) )
        self._id_13B6C = var_0;
    else if ( !isdefined( self._id_13B6C ) )
        self._id_13B6C = 0;
    ...
    while ( scripts\mp\riotshield::riotshield_hasweapon() )
    {
        ...
        if ( !istrue( self.inlaststand ) )
        {
            if ( self._id_13B6C )
            {
                self.target_show_damage_damage_watch = 1;
                self.target_show_dist = gettime() + 1000;
            }
            else if ( isdefined( self.target_show_dist ) && gettime() >= self.target_show_dist )
            {
                self.target_show_damage_damage_watch = undefined;
                self.target_show_dist = undefined;
            }
        ...
        if ( self isonladder() )
            ...
            _id_133F9();
        else if ( istrue( self.target_show_damage_damage_watch ) )
            _id_133F9();
        else if ( istrue( self._id_119BB ) )
        {
            if ( nullweapon( self getheldoffhand() ) )
            {
                self._id_119BB = undefined;
                _id_133FB();
            }
            else
                _id_133F9();
...
enable_spawner( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::c4_crate_player_at_max_ammo( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::c4_crate_spawn( var_14 );
...
enable_oob_immunity_on_riders( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    {
        var_6 = never_kill_off_old( var_6 );
        var_12[var_6] = 0;
    }
    ...
    foreach ( var_14 in var_1 )
    {
        ...
        {
            var_16 = scripts\mp\utility\weapon::attachmentmap_tobase( var_1[var_15] );

            if ( isdefined( level.c4_charge_detonate_think[var_14] ) && isdefined( level.c4_charge_detonate_think[var_14][var_16] ) )
            {
                var_17 = level.c4_charge_detonate_think[var_14][var_16];
                var_1[var_15] = var_17;
            }
        }
    }
    ...
    if ( !isdefined( var_9 ) || var_9 == "" )
        scripts\mp\utility\script::intel_location_vo( "buildWeapon - bad weaponAssetName - rootName: " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant: " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );

    var_19 = getcompleteweaponname( var_9, [], undefined, var_2, var_4 );

    if ( isdefined( var_9 ) && !isdefined( var_19 ) )
        scripts\mp\utility\script::intel_location_vo( "buildWeapon - null weapon: weaponAssetName = " + var_9 + ", rootName = " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant = " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );

    foreach ( var_14, var_21 in var_12 )
        var_19 = var_19 withattachment( var_14, var_21 );
    ...
    if ( isdefined( var_7 ) )
    {
        for ( var_22 = 0; var_22 < var_7.size; var_22++ )
        {
            ...
            if ( "i/" != getsubstr( var_23, 0, 2 ) )
                var_23 = "i/" + var_7[var_22];

            var_19 = var_19 setsticker( var_22, var_23 );
        }
    }

    if ( isdefined( var_19.scope ) && !isstartstr( var_19.scope, "ironsdefault" ) )
    {
        var_24 = getreticleindex( var_3 );

        if ( isdefined( var_24 ) )
            var_19 = var_19 withreticle( var_24 );
    }
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && spawn_caches_tank( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( specialistbr( var_19 ) || specialdayloadouts( var_20 ) ) )
            var_12 = 1;
    }
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        {
            if ( istrue( var_0.spawn_maint_wave_2 ) )
            {
        ...
        else if ( istrue( level.registeraccesscardlocs ) && scripts\mp\utility\game::getgametype() == "infect" && var_0.team == "axis" )
            var_0 _meth_87A8( "zombie" );
        else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 _meth_87A8( "female" );
        else
        ...
        if ( isdefined( var_0._id_11A56 ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0._id_11A56 stoploopsound( self._id_11A57 );
            var_0._id_11A56 delete();
            var_0._id_11A56 = undefined;
            var_0._id_11A57 = undefined;
        }
...
resetfunctionality()
{
    ...
    scripts\cp_mp\vehicles\vehicle_occupancy::_id_13918( self, 1 );
    ...
    scripts\mp\equipment\molotov::vehicle_occupancy_monitorturretcontrols();
    scripts\mp\equipment\throwing_knife_mp::_id_13303();
    scripts\mp\equipment\flash_grenade::clearflash( 1 );
    scripts\mp\equipment\gas_grenade::gas_clear( 1 );

    if ( !isagent( self ) )
    {
        scripts\mp\utility\player::risktokens();
    ...
    scripts\cp_mp\utility\player_utility::_id_11EB2();
}
...
updateinstantclassswapallowed()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_0 = scripts\mp\gamelogic::extractposition( scripts\mp\utility\game::postupdategameevents() );
...
_id_1375B()
{
    ...
    if ( scripts\mp\gamelogic::extractposition( scripts\mp\utility\game::postupdategameevents() ) )
    {
        while ( scripts\mp\utility\game::spawnboardroom_miniguns( self ) )
            waitframe();
...
trap_door_nvg_reset()
{
    var_0 = trap_room_ents();
    treerootnodesizebitcount();
    var_1 = trap_room_ents();
...
copyclassfornextlife( var_0 )
{
    ...
    self.pers["copiedClass"] = trap_consoles( var_1 );
    self.pers["lastKiller"] = var_0;
}

ai_deaf_event_active()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
...
spawnammocountoverride_giveweaponammo( var_0, var_1, var_2 )
{
    ...
    if ( var_4 && !spawn_sentry_at_pos( var_0 ) )
    {
        var_5 = 0;
        var_6 = 0;
...
{
    var_1 = scripts\mp\utility\weapon::isknifeonly( var_0.basename ) || scripts\mp\utility\weapon::sortbyhvttags( var_0.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_0.basename ) || scripts\mp\utility\weapon::spawn_sentries_from_targetname( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename );
    return var_1;
}
