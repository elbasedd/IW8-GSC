...
bot_choose_difficulty_for_default()
{
    ...
    if ( !isdefined( level.cp_raid_complex_behavior ) )
        level.cp_raid_complex_behavior = [];

    if ( !isdefined( level.cp_raid_complex_behavior["allies"] ) )
        level.cp_raid_complex_behavior["allies"] = 0;

    if ( !isdefined( level.cp_raid_complex_behavior["axis"] ) )
        level.cp_raid_complex_behavior["axis"] = 0;

    if ( !isdefined( level.cp_raid_complex_behavior["all"] ) )
        level.cp_raid_complex_behavior["all"] = 0;
    ...
    if ( !isdefined( self.pers["bot_chosen_difficulty"] ) )
    {
        ...
        var_0 = level.cp_raid_complex_behavior[var_1];
        var_2 = level.bot_difficulty_defaults[var_0];
        self.pers["bot_chosen_difficulty"] = phaseindex( var_2 );
        level.cp_raid_complex_behavior[var_1] = ( level.cp_raid_complex_behavior[var_1] + 1 ) % level.bot_difficulty_defaults.size;
    }
...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::_id_13AF0( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
bot_allowed_to_use_killstreaks()
{
    ...
    if ( istrue( self.crates_delete_early ) )
        return 0;
...
courtyard_intel_sequence( var_0, var_1 )
{
    switch ( var_0 )
    {
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13AED( 0.5, "still_watching_nodes" );
...
crate_weapons( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = level.isbulletpenetration;
...
cqb_laser_guy_internal( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.isbulletpenetration;
