...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", cp_dntsk_raid_specific_init(), var_13, "class", "inUse" ) )
            {
                var_1 = cp_dntsk_raid_sound_load( var_13, "loadoutPrimary" );
...
confirmed_pilot()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", cp_dntsk_raid_specific_init(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
    ...
    foreach ( var_5 in level.bot_loadout_fields )
    {
        ...
        var_3[var_5] = cp_dntsk_raid_sound_load( var_2, var_5 );
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::player_test_ending_teleport( var_0 );
    var_9 = scripts\mp\weapons::getweaponsource( var_0 );
    var_10 = bot_get_invalid_attachment_combos_for_game( var_9 );
    var_11 = bot_get_allow_double_attachment_combos_for_game( var_9 );
...
init_bot_weap_statstable()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !scripts\mp\weapons::stab_blink_black_fade( var_2 ) )
            {
                var_0++;
                continue;
            }
...
{
    var_2 = cp_dntsk_raid_specific_init();
...
init_bot_attachmenttable()
{
    ...
    if ( !isdefined( level.bot_invalid_attachment_combos_by_game ) )
    {
        level.bot_invalid_attachment_combos_by_game = [];
        level.allowable_double_attachments_by_game = [];
        [var_11, var_12] = init_bot_attachmentcombos( "mp/attachmentcombos.csv" );
        level.bot_invalid_attachment_combos_by_game["default"] = var_11;
        level.allowable_double_attachments_by_game["default"] = var_12;
        [var_11, var_12] = init_bot_attachmentcombos( "mp/attachmentcombos_s4.csv" );
        level.bot_invalid_attachment_combos_by_game["s4"] = var_11;
        level.allowable_double_attachments_by_game["s4"] = var_12;
    }
}

init_bot_attachmentcombos( var_0 )
{
    var_1 = [];
    var_2 = [];
    var_3 = 0;
...
bot_get_invalid_attachment_combos_for_game( var_0 )
{
    if ( isdefined( level.bot_invalid_attachment_combos_by_game[var_0] ) )
        return level.bot_invalid_attachment_combos_by_game[var_0];

    return level.bot_invalid_attachment_combos_by_game["default"];
}

bot_get_allow_double_attachment_combos_for_game( var_0 )
{
    if ( isdefined( level.allowable_double_attachments_by_game[var_0] ) )
        return level.allowable_double_attachments_by_game[var_0];

    return level.allowable_double_attachments_by_game["default"];
}
...
bot_loadout_valid_choice( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "loadoutPrimaryBuff":
            break;
        case "loadoutPrimaryCamo":
            var_4 = !isdefined( self.create ) || var_3 == self.create;
            break;
        case "loadoutSecondary":
        ...
        case "loadoutSecondaryBuff":
            break;
        case "loadoutSecondaryCamo":
            var_4 = !isdefined( self.create_agent_definition ) || var_3 == self.create_agent_definition;
            break;
        case "loadoutStreak3":
        case "loadoutStreak2":
        case "loadoutStreak1":
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 == "classtable_any" )
    {
        if ( !isdefined( self.init_reach_icbm_launch ) )
            self.init_reach_icbm_launch = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );

        var_0 = [ self.init_reach_icbm_launch ];
    }
...
{
    if ( coop_escort_get_vehicle_driver_hint_string_func().size > 0 )
    {
...
{
    if ( istrue( self.cpoperationcrateactivatecallback ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( !isdefined( self.coverupmodels ) )
        self.computerrebootused = 0;

    self.coverupmodels = self.computerrebootused;
    ...
    var_8 = !var_7 && comparescriptindexsmalltolarge();
    ...
    self.cpoperationcrateactivatecallback = undefined;

    if ( !var_7 )
    {
        var_12 = coop_escort_try_start_driving_func();
        var_13 = undefined;

        if ( isdefined( self.respawn_with_launcher ) && isdefined( var_12 ) )
        {
            self.respawn_with_launcher = undefined;
            self.cpoperationcrateactivatecallback = 1;
            var_13 = var_12;
        }

        if ( !isdefined( var_13 ) )
        {
            var_14 = coop_escort_get_vehicle_driver_hint_string_func();
            var_15 = 0;
    ...
    if ( var_17 )
    {
        ...
        if ( cp_dwn_twn_2_sound_load( var_1 ) )
            var_17 = 0;
    }

    if ( !var_17 )
    {
        var_1 = confirmed_pilot();
    ...
    {
        if ( isdefined( var_1["loadoutPrimaryCamo"] ) && var_1["loadoutPrimaryCamo"] != "none" && !isdefined( self.create ) )
            self.create = var_1["loadoutPrimaryCamo"];

        if ( isdefined( var_1["loadoutSecondaryCamo"] ) && var_1["loadoutSecondaryCamo"] != "none" && !isdefined( self.create_agent_definition ) )
            self.create_agent_definition = var_1["loadoutSecondaryCamo"];
