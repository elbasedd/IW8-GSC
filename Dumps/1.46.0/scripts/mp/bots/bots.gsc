    ...
    foreach ( var_1 in level.players )
    {
        if ( isbot( var_1 ) )
        {
            if ( isalive( var_1 ) )
            {
                ...
                var_1.crate_model_anim_setup = 1;
...
{
    var_0 scripts\engine\utility::_id_13AD9( "bots_human_spawned", "bots_human_disconnected" );
    ...
    for (;;)
    {
        ...
        if ( var_46 )
        {
            ...
            if ( var_45 > 0 && var_44 > 0 )
                level scripts\engine\utility::_id_13AD3( "spawned_enemies", "spawned_allies" );
            else if ( var_45 > 0 )
                level waittill( "spawned_enemies" );
            else if ( var_44 > 0 )
...
bot_think()
{
    ...
    if ( !isdefined( self.crate_model_anim_setup ) )
    {
        var_1 = 1;
        self.crate_model_anim_setup = 1;
    ...
    for (;;)
    {
        ...
        scripts\mp\bots\bots_loadout::cp_friendlyfire_enabled();
...
bot_think_seek_dropped_weapons()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\bots\bots_util::convoy_start_5b( 0.33 ) )
        {
...
bot_think_revive()
{
    ...
    for (;;)
    {
        ...
        if ( !bot_can_revive() )
        {
            self.spawn_another_group_and_run_regular_death = 0;
            continue;
        }
        ...
        for ( var_4 = 0; var_4 < var_1.size; var_4++ )
        {
            ...
            if ( distancesquared( self.origin, var_8 ) < 4194304 )
            {
                ...
                self.spawn_another_group_and_run_regular_death = 1;
...
revive_watch_for_finished( var_0 )
{
    ...
    self endon( "bad_path" );
    self endon( "goal" );
    var_0 scripts\engine\utility::_id_13AD9( "death", "revived" );
...
handle_smoke()
{
    ...
    thread handleweaponreloadammodrop( var_0 );
}
