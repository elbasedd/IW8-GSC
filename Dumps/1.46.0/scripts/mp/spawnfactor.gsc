...
init_spawn_factors()
{
    ...
    registerfactor( "avoidCloseToDefenderFlag", ::can_support_mindia8_min_spawn, 1, [ "activeCarrierPosition", "defenderFlagPosition", "avoidDefenderFlagDeadZoneDistSq" ] );
    registerfactor( "avoidCloseToDefenderFlagSpawn", ::can_trex_apply_to_player, 1, [ "avoidDefenderFlagDeadZoneDistSq" ] );
    initfrontline();
}
...
{
    var_2 = var_0.scriptdata.isvalidcustomweapon;
