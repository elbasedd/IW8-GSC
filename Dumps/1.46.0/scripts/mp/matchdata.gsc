...
init()
{
    ...
    level.extratimeincreasecountcap = scripts\mp\utility\game::getgametype() == "br" && getdvarint( "scr_log_br_weapon_stats", 0 ) == 1;
    level.update_spot_limit = ::onmatchstart;
    level.update_timer_for_bomb_case_detonator_holder = ::onroundend;
    level.update_objective_ownerclient = ::logkillstreakevent;
    level.update_objective_mlgicon_reset = ::loggameevent;
    level.update_keypad_currentdisplay_models = ::logattackerkillevent;
    level.update_readings = ::logvictimkillevent;
    level.update_objective_setmlgbackground = ::logmultikill;
    level.update_player_about_remaining_enemies = ::logplayerlife;
    level.update_operator_west_char_loc = ::logplayerdeath;
    level.update_operator_east_char_loc = ::logplayerdata;
    level.update_player_enemy_on_death = ::logscoreevent;
    level.update_timer_for_bomb_vest_detonator_holder = ::_id_12358;
    level.update_restock_ui = ::logweaponstat;
    level.update_jugg_targets = ::logattachmentstat;
    level.update_hint_logic_offhand = ::buildweaponrootlist;
    level.update_objective_mlgicon = ::logchallenge;
    level.update_last_stand_id = ::logaward;
...
onmatchstart()
{
    ...
    if ( var_0 == "br" )
        scripts\common\utility::_id_13592( level.update_hint_logic_munitions );
...
logplayerdeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isvalidclient( var_1 ) )
    {
        ...
        var_16 = scripts\mp\utility\weapon::pristinestatehealthadd( var_7 );
        var_17 = var_1;
        ...
        var_24 = var_1 wait_for_anyone_nearby_hint();
        var_25 = var_1.origin;
        var_26 = var_1.angles;
    ...
    if ( isdefined( self.lastweaponused ) )
    {
        ...
        var_35 = scripts\mp\utility\weapon::pristinestatehealthadd( var_32 );
    ...
    var_39 = wait_for_anyone_nearby_hint();
    var_40 = -1;
...
trigger_stop_bombticks( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "arm" && isdefined( self.recordedgameendstats ) )
    {
        var_36["press_rclick"] = istrue( self.recordedgameendstats["rightmouseup"] );
        var_36["press_lclick"] = istrue( self.recordedgameendstats["leftmouseup"] );
        var_36["press_activate"] = istrue( self.recordedgameendstats["activate"] );
        var_36["press_gostand"] = istrue( self.recordedgameendstats["gostand"] );
    }
...
logplayerdata( var_0 )
{
    ...
    {
        var_2 = scripts\mp\rank::helibankplunder( self );
        scripts\mp\rank::helicircleindex( self.helicopter_firendly_dmg_text_display, var_2 );
    }
    ...
    foreach ( var_23, var_6 in self.pers["matchdataWeaponStats"] )
    {
        ...
        self dlog_recordplayerevent( "dlog_event_player_weapon_stats_br", [ "weapon", var_6.weapon, "variant_id", var_6.variantid, "from_loadout", var_19, "died", var_20, "time_used_s", var_22, "longest_hit_distance", var_21, "deaths", var_9, "headshots", var_10, "hits", var_11, "kills", var_12, "shots", var_13, "damage", var_14, "attachment_0", var_6.attachments[0], "attachment_1", var_6.attachments[1], "attachment_2", var_6.attachments[2], "attachment_3", var_6.attachments[3], "attachment_4", var_6.attachments[4], "sticker_0", var_6._id_13078[0], "sticker_1", var_6._id_13078[1], "sticker_2", var_6._id_13078[2], "sticker_3", var_6._id_13078[3], "reticle", var_6.reticle, "cosmetic_attachment", var_6.groundz, "camo", var_6.camo, "match_time_created_s", var_6.pickuptime ] );
    }
}
...
logweaponstat( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && !istrue( level.extratimeincreasecountcap ) )
        return;
    ...
    {
        if ( !gasgrenade_crate_use( var_4, var_5 ) )
        {
            var_6 = 1;
            var_7 = var_5 + "_" + var_6;
            ...
            for (;;)
            {
                if ( !isdefined( self.pers["matchdataWeaponStats"][var_7] ) || gasgrenade_crate_use( var_4, var_7 ) )
                    break;
    ...
    if ( !isdefined( self.pers["matchdataWeaponStats"][var_5] ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && isdefined( var_4 ) )
        {
            ...
            self.pers["matchdataWeaponStats"][var_5].groundz = var_9;
            ...
            self.pers["matchdataWeaponStats"][var_5]._id_13078 = var_18;
        }
    }
...
gasgrenade_crate_use( var_0, var_1 )
{
    ...
    if ( var_3 != self.pers["matchdataWeaponStats"][var_1].groundz )
        return 0;
    ...
    if ( var_7.size != self.pers["matchdataWeaponStats"][var_1]._id_13078.size )
        return 0;

    for ( var_6 = 0; var_6 < var_7.size; var_6++ )
    {
        if ( var_7[var_6] != self.pers["matchdataWeaponStats"][var_1]._id_13078[var_6] )
            return 0;
    }
