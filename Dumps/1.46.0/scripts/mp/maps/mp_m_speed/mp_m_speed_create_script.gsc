...
cs_return_and_wait_for_flag( var_0, var_1, var_2, var_3 )
{
    ...
    var_2 scripts\cp\cp_rank::strike_setup_arrays( var_1, "mp_m_speed_create_script" );
    ...
    if ( istrue( var_0 ) )
        level thread scripts\cp\cp_rank::wait_for_flags( var_2, "mp_m_speed_create_script" );
    else
        scripts\cp\cp_rank::wait_for_flags( var_2, "mp_m_speed_create_script" );
}
