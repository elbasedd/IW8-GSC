        ...
        if ( !self.perkpackagedata.isusing && scripts\mp\supers::issuperready() )
        {
            if ( self.perkpackagedata.istwomode )
            {
                ...
                if ( 1 )
                {
                    ...
                    if ( isdefined( level._id_11BF7 ) )
                        [[ level._id_11BF7 ]]();
                }
            }

            if ( var_0 && !istrue( self._id_12BFD ) )
...
perkpackage_updateifchanged()
{
    ...
    if ( !var_2 || var_3 || var_4 || self.perkpackagedata.forcereset )
    {
        ...
        if ( scripts\mp\supers::issuperready() && !istrue( self._id_12BFD ) )
            thread scripts\mp\supers::showsuperremindersplash();
...
perkpackage_getfirstfieldupgrade()
{
    ...
    if ( isdefined( self._id_11A9B ) )
        var_0 = self._id_11A9B;
...
perkpackage_getsecondfieldupgrade()
{
    ...
    if ( isdefined( self._id_11A9C ) )
        var_0 = self._id_11A9C;
...
perkpackagemenu_menuthink()
{
    ...
    wait 0.3;
    var_0 = scripts\engine\utility::_id_13AE3( "perkPackageMenu_option1", "perkPackageMenu_option2", "perkPackageMenu_close", "death" );
    var_1 = 0;
...
_id_11BF8( var_0, var_1 )
{
    ...
    self._id_11A9B = var_0;
    self._id_11A9C = var_1;
    perkpackage_updateifchanged();
}

_id_11BF9()
{
    self._id_11A9B = undefined;
    self._id_11A9C = undefined;
}
