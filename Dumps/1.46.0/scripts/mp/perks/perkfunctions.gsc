...
_id_129E6()
{
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_13AE3( "sprint_begin", "sprint_end", "weapon_change", "death" );
        thread rear_spotlight_min_dist_sq_from_node( var_0 );
    }
}
...
updatesharpfocus()
{
    ...
    var_1 = undefined;
    var_2 = scripts\mp\utility\weapon::_id_13C9F( var_0 );
...
updatedefaultflinchreduction()
{
    ...
    var_0 = undefined;
    var_1 = scripts\mp\utility\weapon::_id_13C9F( self.currentweapon );
...
_id_12A01()
{
    thread vehoccupancy_lastseatbc();
}

vehoccupancy_lastseatbc()
{
    ...
    for (;;)
    {
        ...
        if ( self.currentweapon hasattachment( "gunperk_tightgrip" ) )
        {
            ...
            thread isplunderextractionenabled();
        }
    }
}
...
ammodisabling_run( var_0 )
{
    ...
    scripts\engine\utility::_id_13AED( 0.8, "death" );
...
unsetviewkickoverride()
{
    ...
    self._id_11AA8 = undefined;
    self._id_11AAA = undefined;
    self._id_11AA9 = undefined;
...
applystunresistence( var_0, var_1, var_2 )
{
    if ( var_1 scripts\mp\utility\perk::_hasperk( "specialty_stun_resistance" ) && var_0 != var_1 )
    {
        ...
        if ( istrue( scripts\cp_mp\utility\player_utility::playersareenemies( var_3, var_4 ) ) )
            var_1 scripts\cp\utility\cp_controlled_callbacks::resistedstun( var_3 );
    }
...
watchpainted( var_0, var_1 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_13AED( var_1, "death" );
    self.painted = 0;
...
watchpaintedagain( var_0 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_13AD9( "painted_again", "painted_end" );
    scripts\mp\utility\outline::outlinedisable( var_0, self );
}
...
boomtrackplayerdeath( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::_id_13AED( 7.0, "death" );
...
unsetcustomjuicedondeath()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    scripts\engine\utility::_id_13AD9( "death", "faux_spawn" );
...
unsetcustomjuicedonmatchend()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    level scripts\engine\utility::_id_13AD9( "round_end_finished", "game_ended" );
    thread unsetcustomjuiced();
}
...
watchlifepackoutlinestate( var_0 )
{
    ...
    for (;;)
    {
        var_0 scripts\engine\utility::_id_13AD9( "enabled_life_pack_boost", "disabled_life_pack_boost" );
        setlifepackoutlinestate( var_0 );
    }
}
...
{
    self endon( "death" );
    var_0 scripts\engine\utility::_id_13AD9( "death_or_disconnect", "toughen_up_end" );
...
_id_12BC8( var_0, var_1, var_2, var_3 )
{
    var_4 = var_1 - var_2;
    ...
    var_8 = scripts\engine\math::init_respawns( var_7 );
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( var_2 && !isbot( var_8 ) )
        {
            ...
            foreach ( var_13 in var_11 )
            {
                ...
                if ( !var_8 _id_12BC8( var_13, var_10, var_14, var_15 ) )
                    continue;

                var_9 = var_9 | var_8 pointinsquarewidth( var_13 );
            }
        }
        else
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                if ( _id_12BC9( var_18, var_10, var_14 ) )
                {
                    var_3 = var_3 + 2;
                    var_20 = [ var_8 ];
        ...
        if ( scripts\mp\gametypes\br_gametypes.gsc::spawn_atmines( "sixthSenseThink" ) )
            var_9 = var_9 | scripts\mp\gametypes\br_gametypes.gsc::_id_1268B( "sixthSenseThink", var_8 );
...
unsetsixthsense()
{
    thread getinfectedairdropposition();
}
...
setovercharge()
{
    thread _branalytics_addeventallowed::_id_12975( "ui_overcharge", 1 );
}

unsetovercharge()
{
    thread _branalytics_addeventallowed::_id_12975( "ui_overcharge", 0 );
}
...
outlinekillstreaks_enablemarksafterprematch()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        _calloutmarkerping_iskiosk::_id_13883( self );
    }
}
...
setmomentum()
{
    ...
    {
        self waittill( "killed_enemy" );
        thread vehicle_showvalidlittlebirds();
    }
}
...
{
    self giveweapon( self._id_1330C );
    self assignweaponmeleeslot( self._id_1330C );
    thread watchthrowingknifescavenge();

    if ( self._id_1330C == "iw8_throwingknife_fire_melee_mp" )
        thread _id_13C1D();
    else if ( self._id_1330C == "iw8_throwingknife_electric_melee_mp" )
        thread _id_13C1C();
}

unsetthrowingknifemelee()
{
    if ( isdefined( self._id_1330C ) && self hasweapon( self._id_1330C ) )
        self takeweapon( self._id_1330C );

    self notify( "specialty_equip_throwingKnife_end" );

    if ( isdefined( self._id_1330C ) && self._id_1330C == "iw8_throwingknife_fire_melee_mp" )
        suicide_on_alive();
    else if ( isdefined( self._id_1330C ) && self._id_1330C == "iw8_throwingknife_electric_melee_mp" )
        successfunction();
}
...
{
    self.player scripts\engine\utility::_id_13AD9( "disconnect", "unsetBulletOutline" );
...
markempsignatures( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_13AD9( "death", "cloak_end" );
...
startgpsjammer()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\class::stack_patch_thread_leaf( var_0 ) )
            continue;
...
processvoqueue()
{
    ...
    if ( !isdefined( level.apc_rus_initomnvars ) || !isdefined( level.activeadvanceduavs ) )
        return var_0;
    ...
    if ( istrue( var_1 ) && getdvarint( "scr_uav_for_squad_only", 1 ) )
    {
        ...
        var_0 = level.apc_rus_initomnvars - var_2 > 0;
    }
    else
        var_0 = level.apc_rus_initomnvars - level.activeadvanceduavs[self.team] > 0;
...
{
    self endon( "groundPoundShield_deleteShield" );
    scripts\engine\utility::_id_13AD9( "death_or_disconnect", "groundPound_unset" );
    thread groundpoundshield_deleteshield( var_0 );
}
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_13AD9( "death_or_disconnect", "battleSlide_unset" );
    var_0 delete();
}
...
thrusterstopfx()
{
    self endon( "death_or_disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_13AD9( "doubleJumpBoostEnd", "thruster_unset" );
    waitframe();
}
...
{
    scripts\engine\utility::_id_13AD9( "ADSTargetMarkUnset", "death_or_disconnect" );
...
setkillstreaktoscorestreak()
{
    ...
    if ( isdefined( self.pers["killstreakToScorestreak_lifeId"] ) && self.pers["killstreakToScorestreak_lifeId"] == self.lifeid )
    {
        ...
        var_0 = success_zone_width( self.streakpoints );
...
unsetkillstreaktoscorestreak()
{
    ...
    var_0 = successful_vehicle_spawns( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakcosts();
    scripts\mp\killstreaks\killstreaks::setstreakpoints( var_0 );
    scripts\mp\killstreaks\killstreaks::checkstreakreward( self.streakpoints, 1 );
    scripts\mp\killstreaks\killstreaks::updatestreakmeterui();
...
proximityrevivethink()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            if ( istrue( var_7.inlaststand ) && !istrue( var_7.stuckinlaststand ) && !istrue( var_7.laststandhealisactive ) && !istrue( var_7 scripts\mp\playerlogic::playerdatafield() ) && !isdefined( var_0.owner ) )
        ...
        if ( isdefined( level.revivetriggers ) )
        {
            foreach ( var_10 in level.revivetriggers )
            {
                ...
                {
                    if ( !istrue( var_10.trigger.owner scripts\mp\playerlogic::playerdatafield() ) && !isdefined( var_0.owner ) )
                    {
...
proximityrevive( var_0, var_1, var_2 )
{
    ...
    var_0 scripts\mp\playerlogic::_id_12963( 1 );
    var_1.owner = var_0;
...
watchproximityrevivefail( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 scripts\mp\playerlogic::_id_12963( 0 );
        var_0 scripts\mp\gameobjects::updateuiprogress( var_1, 0 );
        var_0 scripts\mp\utility\player::_freezecontrols( 0, undefined, "proximityRevive" );
...
_id_129EB()
{
    if ( isdefined( self.tank_check_player_firing ) && self.tank_check_player_firing == gettime() )
        regendelayreduce_onkill();
}
    ...
    while ( isdefined( self.markequipmentstate.markingent ) && !istrue( self.ishacking ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( self.markequipmentstate.markedents, self.markequipmentstate.markingent ) )
        {
            if ( scripts\mp\utility\player::isplayerads() )
            {
                ...
                if ( level.teambased && _calloutmarkerping_iskiosk::_id_13879( self.markequipmentstate.markingent ) )
                {
                    self.markequipmentstate.markingent._id_13267 = self.team;
                    var_7 = scripts\mp\utility\player::getteamarray( self.markequipmentstate.markingent._id_13267 );

                    foreach ( var_9 in var_7 )
                        _calloutmarkerping_iskiosk::_id_13885( self.markequipmentstate.markingent, var_9 );
                }
...
unmarkafterduration( var_0 )
{
    ...
    scripts\engine\utility::_id_13AF3( var_1, "disconnect" );
    unmarkent( var_0 );
}
...
unmarkent( var_0 )
{
    ...
    if ( isdefined( var_0._id_13267 ) )
    {
        if ( level.teambased && _calloutmarkerping_iskiosk::_id_13879( var_0 ) )
        {
            var_1 = scripts\mp\utility\player::getteamarray( var_0._id_13267 );

            foreach ( var_3 in var_1 )
                _calloutmarkerping_iskiosk::_id_13885( var_0, var_3 );
        }

        var_0._id_13267 = undefined;
    }
...
markedentities_think()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( isdefined( self.markequipmentstate ) )
            {
                self.markequipmentstate.markedents = update_bomb_vest_controller( self.markequipmentstate.markedents, var_0 );
...
initbunkerdooreffects()
{
    var_0 = self.team;
    self endon( "cancel_better_mission_rewards_unset" );
    scripts\engine\utility::_id_13AD9( "spawned_player", "disconnect" );
...
_id_13791( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::plunder_playerrepositoryuseshouldsucceed( var_0 );

    if ( !isdefined( level.check_if_player_is_downed ) )
        level.check_if_player_is_downed = [];

    var_2 = 0;

    if ( isdefined( level.check_if_player_is_downed[var_0] ) )
        var_2 = level.check_if_player_is_downed[var_0];

    var_3 = var_1 - var_2;

    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util.gsc::asm_playfacialaniminternalmp( var_0, var_3 );

    level.check_if_player_is_downed[var_0] = var_1;
}
...
_id_129CC()
{
    self._id_11C5F = spawnstruct();
    self._id_11C5F._id_13230 = [];
    self._id_11C5F.targetids = [];
    self._id_11C5F._id_11C5D = [];
    self._id_11C5F.hidehudintermission = 0;

    for ( var_0 = 0; var_0 < 4; var_0++ )
        self._id_11C5F._id_11C5D[var_0] = -1;
}
...
_id_11C60( var_0 )
{
    ...
    if ( isdefined( var_0._id_1322E ) )
        return;

    var_6 = self._id_11C5F._id_13230[var_0 getentitynumber()];

    if ( !isdefined( var_6 ) )
    {
        self._id_11C5F._id_13230[var_0 getentitynumber()] = var_0;
        var_6 = var_0;
        var_7 = self._id_11C5F.hidehudintermission;
        self._id_11C5F.hidehudintermission = ( self._id_11C5F.hidehudintermission + 1 ) % 4;

        if ( isdefined( self._id_11C5F._id_13230[self._id_11C5F._id_11C5D[var_7]] ) )
        {
            var_8 = self._id_11C5F._id_13230[self._id_11C5F._id_11C5D[var_7]];
            self._id_11C5F._id_11C5D[var_7] = -1;
            var_8 thread _id_11C63( var_8, var_8.headicon );
            thread _id_11C68( var_8 );
        }

        self._id_11C5F._id_11C5D[var_7] = var_0 getentitynumber();
        var_9 = scripts\mp\gametypes\br_public.gsc::postplunder( self.team, self.squadindex );
        ...
        scripts\mp\gametypes\br_public.gsc::_id_12041( "br_perk_advanced_scout_marking", self.team, var_0 );
        var_0 thread _id_11C65( var_0, var_6.headicon );
        thread _id_11C69( var_0 );
    }
}
...
_id_11C61( var_0 )
{
    ...
    var_0 thread _id_11C67( var_1, var_0 );
}

_id_11C65( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "disconnect" );
    var_2 = var_0 getentitynumber();
...
_id_11C69( var_0 )
{
    ...
    if ( isdefined( self._id_11C5F ) && isdefined( self._id_11C5F._id_13230 ) )
    {
        var_2 = self._id_11C5F._id_13230[var_1];

        if ( isdefined( var_2 ) )
        {
            var_0._id_1322E = undefined;
            self._id_11C5F._id_13230[var_1] = undefined;
        }
    }

    foreach ( var_5, var_4 in self._id_11C5F._id_11C5D )
    {
        if ( var_4 == var_1 )
        {
            self._id_11C5F._id_11C5D[var_5] = -1;
            return;
        }
    }
}

_id_11C63( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "disconnect" );
    var_2 = var_0 getentitynumber();
...
_id_11C6A()
{
    ...
    if ( isdefined( self.update_gamebattles_char_loc ) )
        return;

    self.update_gamebattles_char_loc = 1;
    self iprintlnbold( &"KILLSTREAKS_HINTS/RECON_NO_MARK" );
    self playlocalsound( "br_perk_advanced_scout_marking_resist_plr", self );
    wait 1.0;
    self.update_gamebattles_char_loc = undefined;
}

_id_136E9()
{
    if ( isdefined( self._id_11C5F._id_13230 ) && self._id_11C5F._id_13230.size > 0 )
    {
        foreach ( var_1 in self._id_11C5F._id_13230 )
            thread _id_11C68( var_1 );
    }

    self._id_11C5F = undefined;
    self notify( "pingOnDamageDeactivate" );
}

_id_11AD0( var_0 )
{
    var_1 = scripts\mp\gametypes\br_public.gsc::postgamestate( self.team, self.squadindex, "ui_squad_reinforced_perk" );
    ...
    scripts\mp\gametypes\br_public.gsc::_id_129F5( self.team, self.squadindex, "ui_squad_reinforced_perk", var_4 );
    var_5 = scripts\mp\gametypes\br_public.gsc::postplunder( self.team, self.squadindex );
...
_id_136EF()
{
    ...
    if ( istrue( self.instantclassswapallowed ) )
        scripts\mp\gametypes\br_armor.gsc::quarry2_ambient_sound_load( 0 );
