...
init()
{
    ...
    registerscriptperk( "specialty_hustle", undefined, undefined, [ "specialty_supersprint_enhanced", "specialty_fastcrouchmovement", "specialty_br_serpentine" ] );
    ...
    registerscriptperk( "specialty_specialist_bonus", scripts\mp\perks\perkfunctions::_id_129F4, scripts\mp\perks\perkfunctions::_id_136EE );
    ...
    registerscriptperk( "specialty_chain_killstreaks", scripts\mp\perks\perkfunctions::_id_1296F, scripts\mp\perks\perkfunctions::_id_136E4 );
    ...
    registerscriptperk( "specialty_reduce_regen_delay_on_kill", scripts\mp\perks\perkfunctions::_id_129EB, scripts\mp\perks\perkfunctions::_id_136EC );
    ...
    registerscriptperk( "specialty_br_better_mission_rewards", scripts\mp\perks\perkfunctions::_id_12964, scripts\mp\perks\perkfunctions::_id_136E3 );
    registerscriptperk( "specialty_br_extra_killstreak_chance" );
    registerscriptperk( "specialty_br_ping_on_damage", scripts\mp\perks\perkfunctions::_id_129CC, scripts\mp\perks\perkfunctions::_id_136E9 );
    registerscriptperk( "specialty_br_stronger_armor", scripts\mp\perks\perkfunctions::_id_129F7, scripts\mp\perks\perkfunctions::_id_136EF );
    ...
    registerscriptperk( "specialty_br_serpentine", undefined, undefined );
    registerscriptperk( "specialty_quick", scripts\mp\perks\perkfunctions::_id_129E6, scripts\mp\perks\perkfunctions::_id_136EA );
    registerscriptperk( "specialty_frenzy", undefined, undefined, [ "specialty_reduce_regen_delay_on_kill" ] );
    registerscriptperk( "specialty_shrouded", undefined, undefined, [ "specialty_glintreduce" ] );
    registerscriptperk( "specialty_quickscope", scripts\mp\perks\perkfunctions::_id_129E7, scripts\mp\perks\perkfunctions::_id_136EB );
    registerscriptperk( "specialty_hardscope", scripts\mp\perks\perkfunctions::_id_12990, scripts\mp\perks\perkfunctions::_id_136E5 );
    registerscriptperk( "specialty_nervesofsteel", scripts\mp\perks\perkfunctions::_id_129AD, scripts\mp\perks\perkfunctions::_id_136E6 );
    registerscriptperk( "specialty_panic", scripts\mp\perks\perkfunctions::_id_129C8, scripts\mp\perks\perkfunctions::_id_136E8 );
    registerscriptperk( "specialty_scr_tightgrip", scripts\mp\perks\perkfunctions::_id_12A01, scripts\mp\perks\perkfunctions::_id_136F0 );
...
initspecialistkillstreaks()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "specialist_perk_bonus", undefined, ::_id_119CB );
}
...
assault1_riverbed()
{
    ...
    {
        var_2 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", istrue( var_1._id_12EAF ), istrue( var_1.specialist ) );
...
giveperksafterspawn()
{
    ...
    if ( self.avoidkillstreakonspawntimer > 0 )
    {
        ...
        if ( istrue( self.inspawncamera ) )
            var_0 = var_0 + scripts\mp\spawncamera::populate_bomb_wires_to_cut();
...
updateactiveperks( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    {
        var_1.tank_check_player_firing = gettime();
