...
init()
{
    ...
    addaction( "cp_munitions", scripts\common\utility::bot_modify_behavior_from_loadout );
    addaction( "nvg", scripts\common\utility::bot_pick_dd_zone_with_fewer_defenders );
}
