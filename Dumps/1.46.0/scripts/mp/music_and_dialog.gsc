...
init()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "music", "isBRSuspenseMusicEnabled", ::spawn_bomb_hostage );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "music", "getMusicSet", ::playervisibilityrespawntags );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "music", "getRandomMusicSet", ::plunderextractalertnearby );
...
getgulagclosedcircleindex( var_0, var_1 )
{
    _id_1298C( var_0, var_1, undefined );
}

playerpowerscleanuphud( var_0, var_1 )
{
    var_2 = game[var_0][var_1];
    return var_2;
}

playerpowerscleanupkeybindings( var_0, var_1 )
{
    var_2 = playerpowerscleanuphud( var_0, var_1 );
...
{
    _id_1298C( "music", var_0, var_1 );
}

playervisibilityrespawntags( var_0 )
{
    var_1 = playerpowerscleanuphud( "music", var_0 );
...
plunderextractalertnearby( var_0 )
{
    var_1 = playerpowerscleanupkeybindings( "music", var_0 );
...
shoulddonodedrop()
{
    ...
    if ( var_1 == "br" || var_1 == "brtdm" )
    {
        ...
        _id_129AC( "br_lobby_intro", var_4 );
        _id_129AC( "br_lobby_outro", var_5 );
        var_6 = [ "br3_infil_intro_01", "br3_infil_intro_02", "br3_infil_intro_03", "br3_infil_intro_04", "br3_infil_intro_05" ];
        var_7 = [ "br3_plunder_infil_intro_01", "br3_plunder_infil_intro_02", "br3_plunder_infil_intro_03", "br3_plunder_infil_intro_04", "br3_plunder_infil_intro_05" ];
        var_8 = [ "br3_plane_jump_01", "br3_plane_jump_02", "br3_plane_jump_03", "br3_plane_jump_04", "br3_plane_jump_05" ];
        var_9 = [ "br3_plane_jump_parachute_01", "br3_plane_jump_parachute_02", "br3_plane_jump_parachute_03", "br3_plane_jump_parachute_04", "br3_plane_jump_parachute_05" ];
        _id_129AC( "br_infil_intro", var_7 );
        _id_129AC( "br_infil_jump", var_8 );
        _id_129AC( "br_infil_jump_parachute", var_9 );
        var_10 = [ "" ];
        var_11 = [ "br3_gulag_lose" ];
        var_12 = [ "br3_gulag_win" ];
        _id_129AC( "br_gulag_intro", var_10 );
        _id_129AC( "br_gulag_lose", var_11 );
        _id_129AC( "br_gulag_win", var_12 );
        var_13 = [ "br3_ring_low_01", "br3_ring_low_02", "br3_ring_low_03", "br3_ring_low_04", "br3_ring_low_05" ];
        var_14 = [ "br3_ring_med_01", "br3_ring_med_02", "br3_ring_med_03", "br3_ring_low_04", "br3_ring_med_05" ];
        var_15 = [ "br3_ring_high_01", "br3_ring_high_02", "br3_ring_high_03", "br3_ring_high_04", "br3_ring_high_05" ];
        var_16 = [ "br3_ring_final" ];
        _id_129AC( "br_ring_low", var_13 );
        _id_129AC( "br_ring_med", var_14 );
        _id_129AC( "br_ring_high", var_15 );
        _id_129AC( "br_ring_final", var_16 );
        var_17 = [ "br3_suspense_01", "br3_suspense_02", "br3_suspense_03", "br3_suspense_04", "br3_suspense_05", "br3_suspense_06", "br3_suspense_07", "br3_suspense_08", "br3_suspense_09", "br3_suspense_10", "br3_suspense_11", "br3_suspense_12", "br3_suspense_13", "br3_suspense_14", "br3_suspense_15", "br3_suspense_16", "br3_suspense_17", "br3_suspense_18", "br3_suspense_19", "br3_suspense_20", "br3_suspense_21", "br3_suspense_22", "br3_suspense_23", "br3_suspense_24", "br3_suspense_25", "br3_suspense_26", "br3_suspense_27" ];
        _id_129AC( "allies_suspense", var_17 );
        _id_129AC( "axis_suspense", var_17 );
    }

    if ( var_2 == "dmz" )
    {
        var_7 = [ "br3_plunder_infil_intro_01", "br3_plunder_infil_intro_02", "br3_plunder_infil_intro_03", "br3_plunder_infil_intro_04", "br3_plunder_infil_intro_05" ];
        var_18 = [ "br3_plunder_plane_jump_01", "br3_plunder_plane_jump_02", "br3_plunder_plane_jump_03", "br3_plunder_plane_jump_04", "br3_plunder_plane_jump_05" ];
        _id_129AC( "br_infil_intro", var_7 );
        _id_129AC( "br_infil_jump", var_18 );
        var_19 = [ "br3_plunder_tenpercent_1", "br3_plunder_tenpercent_2", "br3_plunder_tenpercent_3", "br3_plunder_tenpercent_4", "br3_plunder_tenpercent_5" ];
        ...
        _id_129AC( "plunder_tenpercent", var_19 );
        _id_129AC( "plunder_thirtypercent", var_20 );
        _id_129AC( "plunder_fiftypercent", var_21 );
        _id_129AC( "plunder_seventyfivepercent", var_22 );
        _id_129AC( "plunder_ninetypercent", var_23 );
        var_24 = [ "br3_plynder_defeat" ];
        var_25 = [ "br3_plunder_draw" ];
        var_26 = [ "br3_plunder_victory" ];
        _id_129AC( "br_plunder_defeat", var_24 );
        _id_129AC( "br_plunder_draw", var_25 );
        _id_129AC( "br_plunder_victory", var_26 );
    }
    ...
    if ( var_2 == "truckwar" )
    {
        ...
        var_13 = [ "mus_truckwars_ringlow_01", "mus_truckwars_ringlow_03", "mus_truckwars_ringlow_04", "mus_truckwars_ringlow_05", "mus_truckwars_ringlow_06" ];
        var_14 = [ "mus_truckwars_ringmed_01", "mus_truckwars_ringmed_02", "mus_truckwars_ringmed_03", "mus_truckwars_ringmed_04", "mus_truckwars_ringmed_05", "mus_truckwars_ringmed_06" ];
        var_15 = [ "mus_truckwars_ringhigh_01", "mus_truckwars_ringhigh_02", "mus_truckwars_ringhigh_03" ];
        var_16 = [ "mus_truckwars_ringfinal_01", "mus_truckwars_ringfinal_02" ];
        var_28 = [ "mus_truckwars_attacked_01", "mus_truckwars_attacked_02", "mus_truckwars_attacked_03", "mus_truckwars_attacked_04" ];
        _id_129AC( "truckwars_infil", var_27 );
        _id_129AC( "br_ring_low", var_13 );
        _id_129AC( "br_ring_med", var_14 );
        _id_129AC( "br_ring_high", var_15 );
        _id_129AC( "br_ring_final", var_16 );
        _id_129AC( "br_truck_attacked", var_28 );
    }

    if ( getdvarint( "scr_br_alt_mode_escape", 0 ) != 0 )
    {
        var_6 = [ "br_escape_infil_intro_01", "br_escape_infil_intro_02", "br_escape_infil_intro_03" ];
        var_29 = [ "br_escape_tenpercent_1", "br_escape_tenpercent_2", "br_escape_tenpercent_3" ];
        var_30 = [ "br_escape_thirtypercent_1", "br_escape_thirtypercent_2", "br_escape_thirtypercent_3" ];
        var_31 = [ "br_escape_fiftypercent_1", "br_escape_fiftypercent_2", "br_escape_fiftypercent_3" ];
        var_32 = [ "br_escape_seventypercent_1", "br_escape_seventypercent_2", "br_escape_seventypercent_3" ];
        var_33 = [ "br_escape_eightypercent_1", "br_escape_eightypercent_2", "br_escape_eightypercent_3" ];
        var_34 = [ "br_escape_ninetypercent_1", "br_escape_ninetypercent_2", "br_escape_ninetypercent_3" ];
        _id_129AC( "br_infil_intro", var_6 );
        _id_129AC( "br_escape_tenpercent", var_29 );
        _id_129AC( "br_escape_thirtypercent", var_30 );
        _id_129AC( "br_escape_fiftypercent", var_31 );
        _id_129AC( "br_escape_seventypercent", var_32 );
        _id_129AC( "br_escape_eightypercent", var_33 );
        _id_129AC( "br_escape_ninetypercent", var_34 );
    }
    ...
    if ( var_2 == "payload" )
    {
        ...
        _id_129AC( "br_infil_intro", var_6 );
        _id_129AC( "br_infil_jump", var_3 );
    }

    if ( var_2 == "zxp" || var_2 == "gxp" )
    {
        var_4 = [ "zxp_lobby_intro_01", "zxp_lobby_intro_02", "zxp_lobby_intro_03", "zxp_lobby_intro_04", "zxp_lobby_intro_05" ];
        var_5 = [ "zxp_lobby_outro_01", "zxp_lobby_outro_02", "zxp_lobby_outro_03", "zxp_lobby_outro_04", "zxp_lobby_outro_05", "zxp_lobby_outro_06" ];
        var_6 = [ "zxp_infil_intro_01", "zxp_infil_intro_02", "zxp_infil_intro_03", "zxp_infil_intro_04", "zxp_infil_intro_05" ];
        var_8 = [ "zxp_plane_jump_01", "zxp_plane_jump_02", "zxp_plane_jump_03", "zxp_plane_jump_04", "zxp_plane_jump_05" ];
        var_9 = [ "zxp_plane_jump_parachute_01", "zxp_plane_jump_parachute_02", "zxp_plane_jump_parachute_03", "zxp_plane_jump_parachute_04", "zxp_plane_jump_parachute_05" ];
        _id_129AC( "br_lobby_intro", var_4 );
        _id_129AC( "br_lobby_outro", var_5 );
        _id_129AC( "br_infil_intro", var_6 );
        _id_129AC( "br_infil_jump", var_8 );
        _id_129AC( "br_infil_jump_parachute", var_9 );
        var_35 = [ "zxp_zmb_spawn_01", "zxp_zmb_spawn_02", "zxp_zmb_spawn_03", "zxp_zmb_spawn_04" ];
        var_13 = [ "zxp_ring_low_01", "zxp_ring_low_02", "zxp_ring_low_03", "zxp_ring_low_04", "zxp_ring_low_05" ];
        var_14 = [ "zxp_ring_med_01", "zxp_ring_med_02", "zxp_ring_med_03", "zxp_ring_med_04", "zxp_ring_med_05" ];
        var_15 = [ "zxp_ring_high_01", "zxp_ring_high_02", "zxp_ring_high_03" ];
        var_16 = [ "zxp_ring_final" ];
        var_17 = [ "zxp_tension_01", "zxp_tension_02", "zxp_tension_03", "zxp_tension_04", "zxp_tension_05", "zxp_tension_06", "zxp_tension_07", "zxp_tension_08", "zxp_tension_09", "zxp_tension_10", "zxp_tension_11", "zxp_tension_12", "zxp_tension_13", "zxp_tension_14", "zxp_tension_15", "zxp_tension_16", "zxp_tension_17", "zxp_tension_18", "zxp_tension_19", "zxp_tension_20", "zxp_tension_21", "zxp_tension_22", "zxp_tension_23", "zxp_tension_24", "zxp_tension_25", "zxp_tension_26" ];
        _id_129AC( "br_zmb_spawn", var_35 );
        _id_129AC( "br_ring_low", var_13 );
        _id_129AC( "br_ring_med", var_14 );
        _id_129AC( "br_ring_high", var_15 );
        _id_129AC( "br_ring_final", var_16 );
        ...
        if ( var_2 == "gxp" )
        {
            _id_129AC( "br_lobby_intro", [ "gov_lobby_intro_01", "gov_lobby_intro_02" ] );
            _id_129AC( "br_lobby_outro", [ "gov_lobby_outro_01" ] );
            _id_129AC( "br_infil_intro", [ "gov_infil_intro_01" ] );
            _id_129AC( "br_infil_jump", [ "gov_plane_jump_01" ] );
            _id_129AC( "br_infil_jump_parachute", [ "gov_parachute_01" ] );
            _id_129AC( "br_zmb_spawn", [ "zxp_ghost_spawn_01" ] );
        }
    }

    if ( var_2 == "x2" )
    {
        _id_129AC( "br_infil_intro", [ "mx_plane_intro" ] );
        _id_129AC( "br_infil_jump", [ "mx_plane_jump" ] );
        _id_129AC( "br_infil_jump_parachute", [ "mx_plane_parachute" ] );
    }

    if ( var_0 == "mp_escape2" || var_0 == "mp_escape3" || var_0 == "mp_escape4" )
        return;
}
...
dointro()
{
    ...
    if ( !level.splitscreen && !isdefined( self._id_11D57 ) || level.splitscreen && !isdefined( level.playedstartingmusic ) )
    {
        if ( !self issplitscreenplayer() || self issplitscreenplayerprimary() )
        {
...
onroundswitch()
{
    ...
    if ( isdefined( level._id_119BE ) )
    {
        [[ level._id_119BE ]]( var_0 );
        return;
    }
...
_id_12060( var_0 )
{
    ...
    var_1 = scripts\mp\gamescore::prematchdialog();
    ...
    foreach ( var_3 in level.players )
    {
        ...
        if ( var_4 <= 10 )
        {
            var_5 = playervisibilityrespawntags( "br_plunder_victory" );
            var_3 setplayermusicstate( var_5 );
        }
        else
        {
            var_5 = playervisibilityrespawntags( "br_plunder_defeat" );
            var_3 setplayermusicstate( var_5 );
        }
        ...
        foreach ( var_4 in level.players )
        {
            if ( var_0 == "allies" )
            {
                if ( scripts\mp\utility\game::getgametype() != "arena" )
                {
                    ...
                    if ( istrue( level.spawn_module_building_chopper2 ) )
                        wait 4;
...
create_score_message()
{
    ...
    if ( istrue( level.watchcrategastimeout ) )
        return;
    ...
    if ( !var_0 )
        var_1 = var_1 - level.br_level.createscript_covernodes;
    ...
    if ( isdefined( level.br_level ) && isdefined( level.br_level.br_circleclosetimes ) )
    {
        ...
        if ( !var_0 )
            var_5 = var_5 - level.br_level.createscript_covernodes;
    ...
    foreach ( var_7 in level.players )
    {
        if ( !isbot( var_7 ) && !var_7 scripts\mp\gametypes\br_public.gsc::isplayeringulag() )
        {
            if ( var_2 < var_3 )
            {
                ...
                if ( isdefined( var_7.helihint_deposit ) && var_10 == var_7.helihint_deposit )
                {
                    if ( var_9 == 0 )
                        var_9++;
                    else
                ...
                var_7.helihint_deposit = "low" + var_9;
            }
            else if ( var_2 < var_4 )
            {
                ...
                var_7.helihint_deposit = "med" + var_9;
            }
            else
            {
                ...
                var_7.helihint_deposit = "high" + var_9;
            }
        }
    }
...
create_thrust_fire()
{
    ...
    if ( var_2 == var_1 )
    {
        var_3 = plunderextractalertnearby( "br_ring_final" );
        setmusicstate( var_3 );
    ...
    if ( isdefined( level.br_level ) && isdefined( level.br_level.br_circleclosetimes ) )
    {
        ...
        if ( !var_0 )
            var_6 = var_6 - level.br_level.createscript_covernodes;
    ...
    foreach ( var_8 in level.players )
    {
        if ( !isbot( var_8 ) && !var_8 scripts\mp\gametypes\br_public.gsc::isplayeringulag() )
        {
            if ( var_2 < var_5 )
            {
                ...
                if ( isdefined( var_8.helihint_deposit ) && var_11 == var_8.helihint_deposit )
                {
                    if ( var_10 == 0 )
                        var_10++;
                    else
                ...
                var_8.helihint_deposit = "med" + var_10;
            }
            else
            {
                ...
                var_8.helihint_deposit = "high" + var_10;
            }
        }
    }
...
create_silencer_pick_up( var_0 )
{
    ...
    foreach ( var_2 in level.players )
    {
        var_3 = spawn_bomb_hostage( var_2 );
...
_id_12080()
{
    ...
    if ( isdefined( level._id_132E4 ) && level._id_132E4 == 1 )
        return;
    ...
    level notify( "stop_suspense_music" );
    var_0 = plunderextractalertnearby( "plunder_tenpercent" );
    setmusicstate( var_0 );
    level._id_132E4 = 1;
}
...
_id_12062( var_0 )
{
    ...
    if ( isdefined( level.mousetrapwatcher ) && level.mousetrapwatcher == 1 )
        return;

    if ( scripts\mp\gametypes\br_public.gsc::spawn_exfil_enemies() )
        return;

    var_1 = plunderextractalertnearby( "plunder_thirtypercent" );
    setmusicstate( var_1 );
    level.mousetrapwatcher = 1;
...
_id_1207E( var_0 )
{
    ...
    if ( isdefined( level._id_12AB5 ) && level._id_12AB5 == 1 )
        return;

    if ( scripts\mp\gametypes\br_public.gsc::spawn_exfil_enemies() )
        return;

    var_1 = plunderextractalertnearby( "plunder_fiftypercent" );
    setmusicstate( var_1 );
    level._id_12AB5 = 1;
...
_id_12068( var_0 )
{
    if ( isdefined( level.watchaddminigunrestrictions ) && level.watchaddminigunrestrictions == 1 )
        return;

    if ( scripts\mp\gametypes\br_public.gsc::spawn_exfil_enemies() )
        return;

    var_1 = plunderextractalertnearby( "plunder_seventyfivepercent" );
    setmusicstate( var_1 );
    level.watchaddminigunrestrictions = 1;
    level notify( "ninetypercent_music" );
}

_id_12069()
{
    if ( isdefined( level._id_11AAB ) && level._id_11AAB == 1 )
        return;

    if ( scripts\mp\gametypes\br_public.gsc::spawn_exfil_enemies() )
        return;

    var_0 = plunderextractalertnearby( "plunder_ninetypercent" );
    setmusicstate( var_0 );
    level._id_11AAB = 1;
}
...
spawn_bomb_hostage( var_0 )
{
    ...
    if ( isdefined( var_0 ) && isplayer( var_0 ) && var_5 )
    {
        var_6 = isalive( var_0 );
        var_7 = isbot( var_0 );
        var_8 = isdefined( level.apcturret[var_0 getxuid()] );
