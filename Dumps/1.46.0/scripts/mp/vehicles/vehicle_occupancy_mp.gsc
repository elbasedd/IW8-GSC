...
vehicle_occupancy_mp_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "takeRiotShield", ::_id_1393E );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "giveRiotShield", ::_id_1393B );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "updateRiotShield", ::_id_13940 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "hideCashBag", ::_id_1393C );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "showCashBag", ::_id_1393D );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_occupancy", "changedSeats", ::_id_1393A );
    ...
    level.vehicle._id_13998 = getdvarint( "scr_vehicle_lights", 1 );
}
...
vehicle_occupancy_mp_onentervehicle( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_4 || scripts\cp_mp\vehicles\vehicle_occupancy::_id_1392D( var_0, var_1 ) )
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder.gsc::_id_12058( var_2, 0, 1 );
    ...
    if ( isdefined( var_2.team ) && isdefined( var_2.squadindex ) && istrue( var_0.israllypointvehicle ) )
        thread scripts\mp\spawnselection::_id_12377( var_2.team, var_2.squadindex );
...
vehicle_occupancy_mp_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) && isdefined( var_2 ) )
    {
        if ( !istrue( var_3.playerdeath ) )
        {
            ...
            if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
                scripts\mp\gametypes\br_plunder.gsc::_id_12058( var_2, 1, 1 );
        ...
        _id_1393B( var_2, var_3.playerdeath, var_3.playerlaststand );

        if ( isdefined( var_2.team ) && isdefined( var_2.squadindex ) && istrue( var_0.israllypointvehicle ) )
            thread scripts\mp\spawnselection::_id_12377( var_3.team, var_3.squadindex );
...
_id_1393A( var_0, var_1, var_2, var_3 )
{
    var_4 = level.gametype == "br";

    if ( var_4 && isdefined( var_2 ) && isdefined( var_3 ) )
    {
        if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1392D( var_1, var_2 ) )
        {
            var_0 scripts\mp\playeractions::allowactionset( "vehicle", 1 );
            var_0 scripts\mp\playeractions::allowactionset( "vehicle_passenger", 0 );
        }
        else if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1392D( var_1, var_3 ) )
        {
...
vehicle_occupancy_mp_updatemarkfilter( var_0 )
{
    ...
    if ( !isdefined( var_0.update_health_on_spawn ) )
        var_0.update_health_on_spawn = 1;

    var_1 = var_0.update_health_on_spawn;
    var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getalloccupants( var_0 );
    var_0.update_health_on_spawn = var_2.size > 0;

    if ( var_1 && !var_0.update_health_on_spawn )
        var_0 disableplayermarks( "killstreak" );
    else if ( !var_1 && var_0.update_health_on_spawn )
        var_0 enableplayermarks( "killstreak" );

    if ( var_0.update_health_on_spawn )
    {
        if ( level.teambased )
        {
            var_3 = [];
...
_id_1393C( var_0, var_1, var_2, var_3 )
{
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );

    if ( istrue( var_4._id_12B64 ) )
        return;

    if ( isdefined( level.turn_on_red_lights_along_track ) && scripts\engine\utility::array_contains( level.turn_on_red_lights_along_track, var_2 ) )
    {
        if ( isdefined( var_2.c130airdrop_getteamaveragepos ) )
        {
...
_id_1393D( var_0, var_1, var_2, var_3 )
{
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_1 );
...
_id_1393E( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        var_0._id_125D9 = var_3;
        var_0._id_125D5 = var_4;

        if ( istrue( var_4 ) )
            _id_13940( var_0, var_1, var_2 );
...
_id_1393B( var_0, var_1, var_2 )
{
    if ( isdefined( var_0._id_125D9 ) )
    {
        if ( !istrue( var_1 ) && !istrue( var_2 ) )
        {
            var_0 scripts\cp_mp\utility\inventory_utility::_giveweapon( var_0._id_125D9 );
            var_0 scripts\mp\class::_id_133FB();

            if ( istrue( var_0._id_125D5 ) )
            {
                var_0 notify( "modified_riot_shield" );
                var_0 endon( "modified_riot_shield" );
                var_0 childthread scripts\cp_mp\utility\inventory_utility::_switchtoweaponimmediate( var_0._id_125D9 );
            }
        }

        var_0._id_125D9 = undefined;
        var_0._id_125D5 = undefined;
        var_0 notify( "modified_riot_shield" );
    }
}
...
_id_13940( var_0, var_1, var_2 )
{
    if ( isdefined( var_0._id_125D9 ) && istrue( var_0._id_125D5 ) )
    {
        if ( !isdefined( var_2 ) )
            return;
...
_id_1393F( var_0 )
{
    ...
    if ( !isdefined( var_0.removeleadobjective ) )
        var_0.removeleadobjective = 0;

    var_1 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getalloccupants( var_0 );

    if ( var_1.size > 0 && !var_0.removeleadobjective )
    {
        var_0 setscriptablepartstate( "lights", "on", 1 );
        var_0.removeleadobjective = 1;
    }
    else if ( var_1.size == 0 && var_0.removeleadobjective )
    {
