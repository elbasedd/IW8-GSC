...
spawndogtags( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level.dogtags[var_0.guid] ) )
    {
        if ( istrue( level.onteamproximitybecameinvalidplayer ) )
            ...
            playfx( level.scalertoscaleinfo["vanish_hw_fr"], level.dogtags[var_0.guid].curorigin );
        else
...
removetags( var_0, var_1, var_2 )
{
    if ( isdefined( level.dogtags[var_0] ) )
    {
        ...
        if ( istrue( level.onteamproximitybecameinvalidplayer ) )
        {
            if ( isdefined( level._id_12EAB ) )
                level [[ level._id_12EAB ]]( level.dogtags[var_0], var_2 );
        }
        else if ( istrue( level.registeraccesscardlocs ) )
        {
            if ( isdefined( var_2 ) && var_2.team == level.dogtags[var_0].ownerteam )
            {
                ...
                playfx( level.scalertoscaleinfo["vanish_hw_fr"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
                playfx( level.scalertoscaleinfo["vanish_hw_en"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
        }
        else
            playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
...
_id_12EAA( var_0, var_1 )
{
    ...
    {
        playfx( level.conf_fx["vanish_gos"], var_0.curorigin );
        playfx( level.race_flow["gos_fireworks"], var_0.curorigin );
        level thread scripts\mp\gametypes\common.gsc::_id_13ACB( var_0.curorigin );
    }
}
