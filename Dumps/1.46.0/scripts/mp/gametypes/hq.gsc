...
main()
{
    ...
    level.failsafe_triggered = ::failsafe_triggered;
...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::trial_start_time( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
getnextzone()
{
    ...
    else if ( isdefined( level._id_12462 ) )
    {
        level.prevzoneindex++;
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::trial_start_time( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
setupzones()
{
    ...
    var_0 = new_objective_thread( var_0 );
    var_1 = [];
    var_2 = 0;
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.assisttouchlist ) )
    {
        ...
        if ( var_5.assisttouchlist[var_2].size > 0 )
            var_5 thread punchcard_use_think( var_2 );
    }
}
...
awardcapturepoints()
{
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.usehprules )
        {
            ...
            if ( !istrue( level._id_12776 ) )
                atmines_delete( var_3 );
