...
init()
{
    level.ai_event thread truck_04_node();
}

truck_04_node()
{
    level.ai_event.truckdoorrightcol = [];
    level.ai_event._id_125B0 = [];
...
truck_airdropinternal()
{
    ...
    trophy_protection_success( var_0, "loot_table_ammo" );
    var_0 = [];
    ...
    trophy_protection_success( var_0, "loot_table_cash" );
    var_0 = [];
    ...
    trophy_protection_success( var_0, "loot_table_gear" );
    var_0 = [];
    ...
    trophy_protection_success( var_0, "loot_table_brute" );
    var_0 = [];
    var_0["brloot_weapon_lm_t9slowfire_lege"] = 1;
    trophy_protection_success( var_0, "loot_table_brute_legendary_weapon" );
    var_0 = [];
    var_0["brloot_access_card_gold_vault_lockbox_3"] = 1;
    trophy_protection_success( var_0, "loot_table_brute_vault_key" );
    var_0 = [];
    ...
    trophy_protection_success( var_0, "loot_table_deployables" );
    var_0 = [];
    var_0["brloot_bodycount_dogtag"] = 1;
    trophy_protection_success( var_0, "loot_table_power_grab_dog_tags" );
    var_0 = [];
    ...
    trophy_protection_success( var_0, "loot_table_power_grab_revive_token" );
}

truckdoorleft( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_3 ) )
        var_3 = 0;

    wait( var_3 );
    var_4 = level.ai_event.truckdoorrightcol[var_0];
    var_2.dropstruct = scripts\mp\gametypes\br_pickups.gsc::setup_functions();
    var_2.dropstruct.laststandrevivedecayscale = scripts\engine\utility::ter_op( var_1 == 1, 6 + randomintrange( 1, 10 ), 6 );
    var_2.dropstruct.required_tank_capacity = 0;
    ...
    for ( var_5 = 0; var_5 < var_1; var_5++ )
    {
        ...
        foreach ( var_13, var_8 in var_4 )
        {
            ...
            if ( var_6 >= var_9 && var_6 <= var_10 )
            {
                ...
                var_2.dropstruct.laststandrevivedecayscale = var_2.dropstruct.laststandrevivedecayscale + 2;
                thread truckdoorleftcol( var_11, var_2 );
                wait 0.002;
            }
        }
    }
...
truckdoorleftcol( var_0, var_1 )
{
    ...
    if ( issubstr( var_0, "lege" ) )
    {
        ...
        var_1.dropstruct.laststandrevivedecayscale = var_3;
        var_1.legendary = 1;
    }
    ...
    var_4 = scripts\mp\gametypes\br_lootcache.gsc::turret_enemy_watcher_internal( var_0, var_1.dropstruct, var_1.origin + ( 0, 0, var_1.dropstruct.required_tank_capacity ), var_1.angles, 0, var_1.legendary, 0 );
...
trophy_protection_success( var_0, var_1 )
{
    ...
    level.ai_event.truckdoorrightcol[var_1] = var_2;
}

_id_125B1( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_0 ) )
        return;

    var_4 = var_0 scripts\mp\gametypes\br_soa_tower_ai_event.gsc::manifest_music_started();

    if ( !var_4 )
        return;

    if ( !isdefined( self._id_125B2 ) || self._id_125B2 != var_0 )
    {
        self._id_125B3 = self._id_125B2;
        self._id_125B2 = var_0;
    }
    ...
    if ( !isalive( self ) && isdefined( var_1 ) && isdefined( var_2 ) )
    {
        ...
        self._id_125AF = var_5 && !self.disablespawningforplayerfunc;
    }

    if ( !isalive( self ) )
    {
        if ( !isdefined( var_0.barkov_execution_path ) )
            var_0.barkov_execution_path = 1;
        else
            var_0.barkov_execution_path = var_0.barkov_execution_path + 1;
    }

    if ( self.disablespawningforplayerfunc && isalive( self ) )
    {
        if ( !isdefined( var_0.barkov_shooting_path_nostab ) )
            var_0.barkov_shooting_path_nostab = var_3;
        else
            var_0.barkov_shooting_path_nostab = var_0.barkov_shooting_path_nostab + var_3;
    }
}
...
_id_125AD( var_0 )
{
    ...
    {
        case "takedown":
            if ( isdefined( self._id_125B2 ) )
            {
                if ( !self.disablespawningforplayerfunc )
                {
                    var_1 = scripts\engine\utility::ter_op( self._id_125AF, "br_soa_tower_reward_kill_agent_headshot", "br_soa_tower_reward_kill_agent" );
                    var_3 = self.hoopty_initomnvars.smeansofdeath == "MOD_GRENADE" || self.hoopty_initomnvars.smeansofdeath == "MOD_GRENADE_SPLASH";
                    ...
                    if ( self._id_125B2 scripts\mp\gametypes\br_soa_tower_ai_event.gsc::mangagedeathsdoor() )
                        var_2 = 1;

                    self._id_125B2 thread scripts\mp\rank::giverankxp( var_1, var_2 );
                    self._id_125B2 thread scripts\mp\rank::scoreeventpopup( var_1 );

                    if ( getdvarint( "MLNNMOPQOP", 0 ) == 6 )
                        self._id_125B2 scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_eliminate_enemies_arms_deal_for_s3_5_event_wz", 1 );
                }
                else
                {
                    ...
                    foreach ( var_5 in level.ai_event._id_11F40 )
                    {
                        ...
                        if ( getdvarint( "MLNNMOPQOP", 0 ) == 6 )
                            var_5 scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_eliminate_enemies_arms_deal_for_s3_5_event_wz", 1 );
                    }
                }
            }
            ...
            break;
        case "assist":
            if ( isdefined( self._id_125B3 ) && !self.disablespawningforplayerfunc )
            {
                var_1 = "br_soa_tower_reward_kill_agent_assist";
                var_2 = scripts\mp\rank::getscoreinfovalue( var_1 );

                if ( self._id_125B3 scripts\mp\gametypes\br_soa_tower_ai_event.gsc::mangagedeathsdoor() )
                    var_2 = 1;

                self._id_125B3 thread scripts\mp\rank::giverankxp( var_1, var_2 );
                self._id_125B3 thread scripts\mp\rank::scoreeventpopup( var_1 );

                if ( getdvarint( "MLNNMOPQOP", 0 ) == 6 )
                    self._id_125B3 scripts\cp\utility\cp_controlled_callbacks::_id_124D8( "t9_ch_global_eliminate_enemies_arms_deal_for_s3_5_event_wz", 1 );
            }

            break;
        case "killing_blow":
            if ( isdefined( self._id_125B2 ) && self.disablespawningforplayerfunc )
            {
...
_id_125AC( var_0 )
{
    switch ( var_0 )
    {
        case "most_agent_kills":
            var_1 = scripts\engine\utility::array_sort_with_func( level.ai_event._id_11F40, ::_id_125AA );

            foreach ( var_3 in var_1 )
            {
                if ( !isdefined( var_3.barkov_execution_path ) || var_3.barkov_execution_path == 0 )
            ...
            if ( !var_5 scripts\mp\gametypes\br_soa_tower_ai_event.gsc::manifest_music_started() )
                return;
            ...
            scripts\mp\gametypes\br_soa_tower_ai_event.gsc::manageworldspawnedbolts( var_5, "br_soa_tower_reward_splash_agent_most_killed", var_5.barkov_execution_path );
            break;
        case "most_brute_damage":
            var_8 = scripts\engine\utility::array_sort_with_func( level.ai_event._id_11F40, ::_id_125AB );

            foreach ( var_3 in var_8 )
            {
                if ( !isdefined( var_3.barkov_shooting_path_nostab ) || var_3.barkov_shooting_path_nostab == 0 )
            ...
            var_5 thread scripts\mp\rank::giverankxp( var_6, var_7 );
            var_5 thread scripts\mp\rank::scoreeventpopup( var_6 );
            scripts\mp\gametypes\br_soa_tower_ai_event.gsc::manageworldspawnedbolts( var_5, "br_soa_tower_reward_splash_brute_most_damage", var_5.barkov_shooting_path_nostab );
            break;
    }
}
...
{
    var_2 = var_0.barkov_execution_path;
    var_3 = var_1.barkov_execution_path;
...
_id_125AB( var_0, var_1 )
{
    var_2 = var_0.barkov_shooting_path_nostab;
    var_3 = var_1.barkov_shooting_path_nostab;
