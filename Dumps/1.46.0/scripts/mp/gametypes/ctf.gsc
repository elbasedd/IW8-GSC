...
createflagsandhud()
{
    ...
    scripts\mp\objidpoolmanager::wrapindex( level.capzones[game["defenders"]].objidnum, 1 );
    scripts\mp\objidpoolmanager::wrapindex( level.capzones[game["attackers"]].objidnum, 1 );
}
...
createteamflag( var_0, var_1 )
{
    ...
    var_9 scripts\mp\gameobjects::_id_129B5( level.iconescort, level.iconkill, level.vehicle_damage_onexitstatelight );
    ...
    var_9 scripts\mp\gameobjects::_id_123B7( ::nextswitch );
    var_9.allowweapons = 1;
    var_9._id_11A6B = var_8;
    var_9.onpickup = ::onpickup;
    var_9.onpickupfailed = ::onpickup;
    var_9.ondrop = ::ondrop;
    var_9.onreset = ::onreset;
    var_9.spawn_carriables_from_prefabs_all = 1;
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_9 scripts\mp\gameobjects::_id_129B5( level.iconescort, level.iconkill, level.vehicle_damage_onexitstatelight, var_10 );
    }
    else
    {
        var_9.objidpingfriendly = 1;
...
createcapzone( var_0, var_1 )
{
    ...
    var_6 scripts\mp\gameobjects::_id_129B5( level.icondefendflag, level.iconcaptureflag, level.vehicle_damage_onexitstatelight );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != var_3 )
    {
        ...
        if ( level.codcasterenabled )
            level.capzones[var_0.team] scripts\mp\gameobjects::_id_1250A();

        thread returnflag();
        var_0 thread scripts\common\utility::_id_13592( level.update_objective_mlgicon_reset, "obj_return", var_0.origin );
    ...
    else
    {
        ...
        level.capzones[var_5] scripts\mp\gameobjects::_id_129A9( level.vehicle_damage_onexitstateheavy );
...
ondrop( var_0 )
{
    if ( isdefined( var_0.leaving_team ) )
    {
        ...
        self.droppedteam = self._id_11A6B;
    else
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::_id_129B5( level.iconreturnflag, level.iconcaptureflag, level.vehicle_damage_onexitstatelight );
    else
    {
        scripts\mp\gameobjects::_id_129B5( level.icondefendflag, level.iconcaptureflag, level.vehicle_damage_onexitstatelight );
    ...
    scripts\mp\utility\dialog::leaderdialog( "enemy_flag_dropped", self._id_11A6B, "status" );
    scripts\mp\utility\dialog::leaderdialog( "flag_dropped", scripts\mp\utility\game::getotherteam( self._id_11A6B )[0], "status" );
...
onreset()
{
    ...
    level.capzones[var_1] scripts\mp\gameobjects::_id_129B5( level.icondefendflag, level.iconcaptureflag, level.vehicle_damage_onexitstatelight );
...
onuse( var_0 )
{
    if ( !level.gameended )
    {
        ...
        var_0 thread scripts\common\utility::_id_13592( level.update_objective_mlgicon_reset, "capture", var_0.origin );
        ...
        if ( level.codcasterenabled )
            level.capzones[var_2] scripts\mp\gameobjects::_id_1250A();
...
superabilitywatcher()
{
    ...
    for (;;)
    {
        ...
        {
            case "super_rewind":
                scripts\engine\utility::_id_13AD9( "teleport_success", "rewind_success" );
...
placeflag()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_12 scripts\mp\gameobjects::_id_129B5( level.icondefendflag, level.iconcaptureflag, level.vehicle_damage_onexitstatelight );
