...
main()
{
    ...
    level.spawn_module_building_chopper2 = 0;
    var_0 = getdvarint( "LTSNLQNRKO" ) && !getdvarint( "LSTLQTSSRM" );

    if ( var_0 )
        level.spawn_module_building_chopper2 = getdvarint( "scr_siege_groundwarSiege", 0 );

    level.botpickskinid = [];

    if ( level.spawn_module_building_chopper2 )
        level.botpickskinid[level.botpickskinid.size] = "arm";
    ...
    if ( level.spawn_module_building_chopper2 )
    {
        ...
        level.maxhqtanks = 0;
        level.weapon_xp_iw8_sn_crossbow = getdvarint( "scr_siege_numNonRallyVehicles", 25 );
        level._id_12BF6 = 1;
...
onstartgametype()
{
    ...
    if ( level.spawn_module_building_chopper2 )
    {
        ...
        scripts\mp\gametypes\arm.gsc::_id_12A75();
        scripts\mp\gametypes\arm.gsc::calculatehqmidpoint();
        level.weapon_xp_iw8_sn_kilo98 = getdvarint( "scr_siege_flagcount", 3 );
        setomnvar( "ui_num_dom_flags", level.weapon_xp_iw8_sn_kilo98 );
...
preventspawninto( var_0, var_1 )
{
    ...
    level.calldropbag = var_4;
    level.callbackplayeractive = var_5;
...
updategametypedvars()
{
    ...
    level.rpg_guys_construction_spawners = scripts\mp\utility\dvars::dvarfloatvalue( "holdAllTimer", 7.5, 0, 60 );
}
...
onplayerconnect( var_0 )
{
    ...
    if ( level.spawn_module_building_chopper2 && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] != 0 && !scripts\mp\flags::gameflag( "prematch_done" ) )
...
domflags()
{
    ...
    level.weapon_xp_iw8_sn_kilo98 = 3;
    setomnvar( "ui_num_dom_flags", level.weapon_xp_iw8_sn_kilo98 );

    if ( level.weapon_xp_iw8_sn_kilo98 == 3 )
    {
...
watchflagenduse( var_0 )
{
    ...
    if ( var_1 == level.weapon_xp_iw8_sn_kilo98 )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_2 == level.weapon_xp_iw8_sn_kilo98 )
...
onuse( var_0 )
{
    ...
    if ( var_2 == "neutral" )
    {
        ...
        {
            if ( var_4 == 2 && level.weapon_xp_iw8_sn_kilo98 == 3 )
            {
    ...
    thread get_closest_living_player_not_in_laststand( var_1 );
}
...
{
    if ( isdefined( self._id_13B69 ) )
        self._id_13B69 = undefined;
...
checkendgame()
{
    ...
    if ( var_0 == level.weapon_xp_iw8_sn_kilo98 )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_1 == level.weapon_xp_iw8_sn_kilo98 )
        setwinner( "axis", "siege_allflags_win", "siege_allflags_loss" );
}
...
runobjectives( var_0 )
{
    ...
    foreach ( var_2 in level.allfobs )
    {
        ...
        var_2.trigger.gameobject._id_13081 = ::_id_119D0;
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom.gsc::precap( level.weapon_xp_iw8_sn_kilo98 == 5 );

    scripts\mp\gametypes\dom.gsc::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm.gsc::botstopmovingonlaststand();
}
...
_id_12461( var_0 )
{
    if ( level.mapname == "mp_downtown_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.yaw_delta ) )
        {
            var_0.yaw_delta = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_c" && !isdefined( var_0.yaw_delta ) )
        {
            var_0.yaw_delta = "_c";
            var_0.objkey = "_b";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.yaw_delta ) )
        {
            var_0.yaw_delta = "_d";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
    ...
    {
        if ( var_0.objkey == "_a" && !isdefined( var_0.yaw_delta ) )
        {
            var_0.yaw_delta = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        ...
        else if ( var_0.objkey == "_e" && !isdefined( var_0.yaw_delta ) )
        {
            var_0.yaw_delta = "_e";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
    ...
    else if ( var_0.objkey == "_b" && !isdefined( var_0.yaw_delta ) )
    {
        var_0.yaw_delta = "_b";
        var_0.objkey = "_a";
        var_0.script_label = var_0.objkey;
