...
brvehiclesinit()
{
    ...
    level.createattractionicontrigger = getdvarint( "scr_br_truck_max", -1 );
    level.createapcturret = getdvarint( "scr_br_dauntless_max", -1 );
    level.createandstartlights = getdvarint( "scr_br_bomber_max", -1 );
...
setupvehiclespawnvolumes()
{
    ...
    level.br_helospawns = [];
    level.currentability = [];
    level.create_trial_weapon_spawn = [];
    level.create_oscilloscope = [];
    ...
    foreach ( var_14, var_6 in var_4.databyref )
    {
        ...
        if ( isdefined( level.move_platform ) )
            var_7 = [[ level.move_platform ]]( var_7 );

        _id_13594( var_7 );
        global_relic_squadlink_func( var_7, "atv_spawn", "atv", "motorcycle_spawn", "motorcycle", "motorcycle_spawn_percent" );
        global_relic_squadlink_func( var_7, "cargotruck_spawn", "cargo_truck", "cargotrucksusp_spawn", "cargo_truck_susp", "cargotrucksusp_spawn_percent" );
        global_relic_squadlink_func( var_7, "cargotrucksusp_spawn", "cargo_truck_susp", "cargotrucksuspaa_spawn", "cargo_truck_susp_aa", "cargotrucksuspaa_spawn_percent" );
        global_relic_squadlink_func( var_7, "jeep_spawn", "jeep", "openjeep_spawn", "open_jeep", "openjeep_spawn_percent" );
        global_relic_squadlink_func( var_7, "veh_bt", "veh_bt", "veh_a10fd", "veh_a10fd", "bt_to_a10fd_spawn_percent" );
        level.br_vehicleallspawns = scripts\engine\utility::array_combine_unique( level.br_vehicleallspawns, var_7 );

        foreach ( var_9 in var_7 )
        {
            if ( isdefined( var_9.script_priority ) && var_9.script_priority > 0 && ( level.createattractionicontrigger < 0 || !spawn_carepackage( var_9 ) ) )
            {
            ...
            if ( level.createattractionicontrigger >= 0 && spawn_carepackage( var_9 ) )
            {
                level.currentability[level.currentability.size] = var_9;
                continue;
            }

            if ( level.createapcturret >= 0 && spawn_elevator_gate( var_9 ) )
            {
                level.create_trial_weapon_spawn[level.create_trial_weapon_spawn.size] = var_9;
                continue;
            }

            if ( level.createandstartlights >= 0 && spawn_and_enter_little_bird_mg( var_9 ) )
            {
                level.create_oscilloscope[level.create_oscilloscope.size] = var_9;
                continue;
            }
...
emptyallvehicles()
{
    ...
    foreach ( var_5, var_1 in level.vehicle.instances )
    {
        ...
        {
            if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1392C( var_3 ) )
...
deleteextantvehicles( var_0 )
{
    ...
    scripts\cp_mp\vehicles\vehicle_spawn::_id_13960();
    ...
    foreach ( var_7, var_2 in level.vehicle.instances )
    {
        ...
        foreach ( var_5 in var_2 )
        {
            ...
            scripts\cp_mp\vehicles\vehicle_spawn::_id_13966( var_5 );
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "vehicleSpawns" ) )
        return;

    if ( ( var_0 == "little_bird" || var_0 == "little_bird_mg" ) && scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "littleBirdSpawns" ) )
        return;

    if ( ( var_0 == "cargo_truck" || var_0 == "cargo_truck_mg" ) && scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "truckSpawns" ) )
        return;

    if ( var_0 == "jeep" && scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "jeepSpawns" ) )
        return;

    if ( var_0 == "tac_rover" && scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "tacRoverSpawns" ) )
        return;

    if ( var_0 == "atv" && scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "atvSpawns" ) )
        return;

    if ( var_0 == "motorcycle" && scripts\mp\gametypes\br_gametypes.gsc::spawn_juggernauts_fob( "motorcycleSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
    {
        if ( scripts\mp\gametypes\br_gametypes.gsc::spawn_atmines( "postSpawnVehicle" ) )
            scripts\mp\gametypes\br_gametypes.gsc::_id_1268B( "postSpawnVehicle", var_6, var_0 );

        scripts\mp\gametypes\br_analytics.gsc::damage_stage_final_watcher( var_6, var_0 );
    }
...
spawninitialvehicles()
{
    ...
    if ( level.createattractionicontrigger > 0 && level.br_totalvehiclesspawned < level.br_totalvehiclesmax )
    {
        var_30 = 0;
        var_31 = scripts\engine\utility::array_randomize( level.currentability );
        ...
        foreach ( var_6 in var_31 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                ...
                if ( var_30 >= level.createattractionicontrigger )
                    break;
    ...
    if ( level.createapcturret > 0 && level.br_totalvehiclesspawned < level.br_totalvehiclesmax )
    {
        var_34 = 0;
        var_35 = scripts\engine\utility::array_randomize( level.create_trial_weapon_spawn );
        ...
        foreach ( var_6 in var_35 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                ...
                if ( var_34 >= level.createapcturret )
                    break;
    ...
    if ( level.createandstartlights > 0 && level.br_totalvehiclesspawned < level.br_totalvehiclesmax )
    {
        var_38 = 0;
        var_39 = scripts\engine\utility::array_randomize( level.create_oscilloscope );
        ...
        foreach ( var_6 in var_39 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                ...
                if ( var_38 >= level.createandstartlights )
                    break;
    ...
    if ( level.createattractionicontrigger >= 0 )
        var_3 = scripts\engine\utility::array_remove_array( var_3, level.currentability );

    if ( level.createapcturret >= 0 )
        var_3 = scripts\engine\utility::array_remove_array( var_3, level.create_trial_weapon_spawn );

    if ( level.createandstartlights >= 0 )
        var_3 = scripts\engine\utility::array_remove_array( var_3, level.create_oscilloscope );
...
waitforvehiclestodeletethenspawninitial()
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::spawn_atmines( "spawnInitialVehicles" ) )
        scripts\mp\gametypes\br_gametypes.gsc::_id_1268B( "spawnInitialVehicles" );
    else
        spawninitialvehicles();
}
...
dangercircletick( var_0, var_1 )
{
    ...
    var_6 = disableuseotherplayerspents();
...
global_relic_squadlink_func( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        if ( ss_entergulag( var_9, var_1, var_2 ) )
...
ss_entergulag( var_0, var_1, var_2 )
{
...
spawn_and_enter_little_bird_mg( var_0 )
{
