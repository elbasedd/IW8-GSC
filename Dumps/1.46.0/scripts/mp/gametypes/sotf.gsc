...
playerjoinwatcher()
{
    for (;;)
    {
        ...
        if ( isdefined( self.crateiconid ) )
            scripts\cp_mp\entityheadicons::_id_12994( self.crateiconid, var_0 );
    }
}
...
getrandomattachments( var_0 )
{
    ...
    var_5 = scripts\mp\utility\weapon::player_test_ending_teleport( var_4 );
...
{
    var_3 = [];
    var_4 = scripts\mp\weapons::getweaponsource( var_0["name"] );
