...
init()
{
    level thread disablelootbunkercachelocations();
    level thread disablemount();
    level thread disablefeature();
    level thread disableheavystatedamagefloor();
    ...
    level._id_13650 = getdvarint( "scr_truckwar_circleMoving", 1 ) == 1;
    level._id_13654 = getdvarint( "scr_truckwar_useDefaultCircleSizes", 1 ) == 1;
    level._id_13646 = 15;
    ...
    if ( var_0 != "" )
    {
        ...
        foreach ( var_3 in var_1 )
            level._id_13652[level._id_13652.size] = float( var_3 );
    }
    ...
    if ( var_5 != "" )
    {
        ...
        foreach ( var_3 in var_6 )
            level._id_13645[level._id_13645.size] = float( var_3 );
    }
    ...
    if ( var_9 != "" )
    {
        ...
        foreach ( var_3 in var_10 )
            level._id_1364A[level._id_1364A.size] = float( var_3 );
    }

    level._id_13653 = getdvarfloat( "scr_truckwar_circleStartRadius", 50000 );
    level._id_1364D = getdvarfloat( "scr_truckwar_circleInnerSize", 40000 );
    level._id_1364E = getdvarfloat( "scr_truckwar_circleMinSize", 10000 );
    level._id_13642 = getdvarfloat( "scr_truckwar_circleCloseMinTime", 30 );
    level._id_13643 = getdvarfloat( "scr_truckwar_circleCloseTime", 220 );
    level._id_13644 = getdvarfloat( "scr_truckwar_circleCloseTimeChange", 40 );
    level._id_13648 = getdvarfloat( "scr_truckwar_circleDelayTime", 60 );
    level._id_13649 = getdvarfloat( "scr_truckwar_circleDelayTimeChange", 10 );
    level._id_13647 = getdvarfloat( "scr_truckwar_circleDelayMinTime", 10 );
    level._id_13651 = getdvarint( "scr_truckwar_circleOutOfBoundsPadding", 1 );
    level._id_1364C = getdvarfloat( "scr_truckwar_circleInitialDelayTime", 60 );
    level._id_1364B = getdvarfloat( "scr_truckwar_circleInitialCloseTime", 330 );
    level._id_1364F = getdvarfloat( "scr_truckwar_circleMoveDist", 1 );
...
disablelootbunkercachelocations()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::ismountconfigenabled( "c130PlaneLine" );
    scripts\mp\gametypes\br_gametypes.gsc::little_bird_mg_enterend( "tabletReplace" );
}

disablemount()
{
    scripts\mp\gametypes\br_gametypes.gsc::_id_123B5( "playerWelcomeSplashes", ::disableplayerkillrewards );
    ...
    level.ontimelimit = ::disablepersupdates;
    ...
    if ( level._id_13650 )
        level thread disablepercentageannouncements();
...
onstartgametype()
{
    ...
    level.create_opaque_ai_contents[level.create_opaque_ai_contents.size] = scripts\mp\gametypes\br_circle.gsc::headlessoperatorcustomization( ( -32000, 53750, 2266 ), 16000 );
    initspawns();
    level thread shouldburnfromdamage();
    level thread _id_12BA7();
}

disableplayerkillrewards( var_0 )
{
    ...
    scripts\mp\gametypes\br_public.gsc::decoyassists( "mode_intro", self, 0 );
...
shouldburnfromdamage()
{
    ...
    if ( getdvarint( "scr_allow_vehicle_cargo_truck_mg", 1 ) == 1 )
        registervehicletype( "cargo_truck_mg", _calloutmarkerping_checkforbuybackrequest::firesaleforplayers, ::_id_139A9 );
    ...
    if ( getdvarint( "scr_allow_vehicle_motorcycle", 1 ) == 1 )
        registervehicletype( "motorcycle", _calloutmarkerping_handleluinotify_cleared::vo_use_computer, ::_id_139AC );
...
bush_trig_debug()
{
    ...
    foreach ( var_1 in level.vehicleinfo )
    {
        ...
        {
            case "cargo_truck_mg":
                var_1.vehiclespawns = prepickupweapon( "cargo_truck_mg", "mkilo_physics_mg" );
                break;
        }
    ...
    scripts\mp\gametypes\br_vehicles.gsc::_id_13594( level.vehiclespawnlocs );
...
_id_12E8A()
{
    ...
    foreach ( var_5, var_2 in level._id_13283 )
    {
...
{
    level._id_13282[var_1] = var_0;
    level._id_1325D[var_1] = 1;
    level thread _id_13C23( var_0, var_1 );
    level thread _id_13C24( var_0, var_1 );
    level thread watchmidsideplayerexit( var_0, var_1 );
    level thread watchminigunweapon( var_0, var_1 );
    level thread watchoverheat( var_0, var_1 );
    ...
    {
        var_5 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_pockets", var_0.health );
        var_5 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_banked", var_0.maxhealth );

        if ( istrue( var_2 ) && getdvarint( "scr_truckwar_truck_replacement_respawn", 1 ) == 1 && !istrue( level._id_1357D ) )
        {
...
_id_13C23( var_0, var_1 )
{
    ...
    {
        if ( istrue( var_0.select_spot_light_nodes_from ) )
        {
            waitframe();
            continue;
        }
        ...
        {
            if ( !var_0._id_13B51 && gas_emit_vfx( var_0.origin, var_2 ) )
            {
            ...
            else if ( !var_0._id_13B53 && gas_emit_vfx( var_0.origin, var_3 ) )
            {
                showsplashtoteam( var_1, "br_gametype_truckwar_gas_is_approaching_medium" );
                var_0._id_13B53 = 1;
                var_0._id_13B52 = 1;
            }
            else if ( !var_0._id_13B52 && gas_emit_vfx( var_0.origin, var_4 ) )
            {
        ...
        {
            var_0 thread landmine_trigger_origin();

            if ( level._id_1325D[var_1] == 1 )
            {
                level._id_1325D[var_1] = 0;
                var_5 = scripts\mp\utility\teams::getteamdata( var_1, "players" );
        ...
        else if ( level._id_1325D[var_1] == 0 )
        {
...
landmine_trigger_origin()
{
    self endon( "death" );
    self endon( "vehicle_gas_exit" );

    if ( istrue( self._id_12176 ) )
        return;
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_6 ) && gettime() < var_6 || var_5 )
        {
            ...
            foreach ( var_10 in level.outofboundstriggers )
            {
                ...
                {
                    var_0._id_119F0 = var_0._id_119F0 + level.framedurationseconds;
                    var_7 = 1;
                    var_8 = var_10;
                    break;
                }
            ...
            var_0._id_119F0 = clamp( var_0._id_119F0, 0, var_3 );

            if ( var_0._id_119F0 == var_3 )
...
watchmidsideplayerexit( var_0, var_1 )
{
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        var_0 thread chopper_lights( var_1 );
        var_5 = scripts\mp\utility\teams::getteamdata( var_1, "players" );

        foreach ( var_7 in var_5 )
        {
            var_7 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_pockets", var_0.health );
            var_7 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_banked", var_0.maxhealth );
        }
...
watchoverheat( var_0, var_1 )
{
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        {
            var_3 = post_customization_func( var_2 );
...
watchminigunweapon( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        var_4 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_pockets", 0 );
        var_4 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_banked", 1 );
...
prepickupweapon( var_0, var_1 )
{
    if ( level.mapname != "mp_br_mechanics" )
        return plunder_economy_shapshot_loop( var_0, var_1 );
...
plunder_economy_shapshot_loop( var_0, var_1 )
{
    var_2 = [];
...
{
    if ( !isdefined( level._id_1325D ) )
        return 0;

    return scripts\mp\utility\teams::getteamdata( var_0, "aliveCount" ) == 0 && ( !istrue( level._id_1325D[var_0] ) || istrue( level._id_1357D ) );
}
...
playerrespawn( var_0, var_1, var_2 )
{
    ...
    if ( istrue( level._id_1357D ) || spotlight_speed( self.team ) || scripts\engine\utility::ent_flag_exist( "respawn_vehicle_death" ) && scripts\engine\utility::ent_flag( "respawn_vehicle_death" ) )
    {
    ...
    if ( scripts\engine\utility::ent_flag_exist( "respawn_vehicle_death" ) && scripts\engine\utility::ent_flag( "respawn_vehicle_death" ) )
        thread scripts\mp\gametypes\br_spectate.gsc::_id_1296A();
    else if ( scripts\engine\utility::ent_flag( "respawn_vehicle_in_gas" ) )
        scripts\mp\utility\lower_message::setlowermessageomnvar( 79 );

    while ( scripts\engine\utility::ent_flag_exist( "respawn_vehicle_death" ) && !scripts\engine\utility::ent_flag( "respawn_vehicle_death" ) && !level._id_1325D[self.team] || scripts\cp_mp\utility\player_utility::isusingremote() )
        waitframe();

    if ( scripts\engine\utility::ent_flag_exist( "respawn_vehicle_death" ) && scripts\engine\utility::ent_flag( "respawn_vehicle_death" ) )
        thread scripts\mp\gametypes\br_spectate.gsc::_id_1296A();

    if ( spotlight_speed( self.team ) || scripts\engine\utility::ent_flag_exist( "respawn_vehicle_death" ) && scripts\engine\utility::ent_flag( "respawn_vehicle_death" ) )
    {
    ...
    var_9 = getspawnpoint();
    var_10 = scripts\mp\gametypes\br_gulag.gsc::_id_11F1F( var_9 );
    var_11 = level._id_13282[self.team].origin;
    ...
    if ( scripts\mp\gametypes\br_public.gsc::spawn_exfil_enemies() && isdefined( level._id_11DD6 ) )
        var_9 = scripts\engine\utility::getstruct( level._id_11DD6, "targetname" );
    ...
    if ( isdefined( level._id_13282[self.team] ) )
    {
        var_11 = level._id_13282[self.team].origin;
        _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_pockets", level._id_13282[self.team].health );
        _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_banked", level._id_13282[self.team].maxhealth );
    }

    level thread scripts\mp\gametypes\br_quest_util.gsc::_id_13813( var_11, "revive" );
    _branalytics_addeventallowed::_id_1296B( "ui_br_transition_type", 0 );
    _id_1379B( self.team );
}
...
modemayconsiderplayerdead( var_0 )
{
    ...
    if ( spotlight_speed( self.team ) || !level._id_1325D[self.team] )
        return;
...
fadeoutin()
{
    ...
    var_0 = scripts\engine\utility::_id_13AE9( "spawned_player", "respawn_vehicle_in_gas", "gulag_auto_win" );
...
initspawns()
{
    level._id_12E43 = getdvarfloat( "scr_spawn_height", 2500 );
}
...
getspawnpoint( var_0 )
{
    if ( !isdefined( self._id_1235F ) )
    {
        ...
        return packsplashparambits( istrue( var_0 ) );
    }
    ...
    else if ( self._id_1235F.team != self.team || self._id_1235F.lifeid != self.lifeid || istrue( self._id_1235F.spawnangle ) )
        return packsplashparambits( istrue( var_0 ) );
...
{
    var_1 = level._id_13282[self.team].origin;
    ...
    var_1 = ( var_1[0], var_1[1], var_3[2] + level._id_12E43 );

    if ( istrue( level._id_13650 ) && getdvarint( "scr_truckwar_respawn_lookahead", 1 ) == 1 )
    {
        if ( istrue( level.get_recently_shot_at_by_rpg ) )
        {
            ...
            if ( var_7 > var_5 )
            {
                ...
                {
                    var_12 = level.br_level.create_silencer_pick_ups[level.br_circle.circleindex];
    ...
    self._id_1235F.origin = var_1;
    self._id_1235F.angles = level._id_13282[self.team].angles;
    self._id_1235F.time = gettime();
    self._id_1235F.team = self.team;
    self._id_1235F.index = -1;
    self._id_1235F.lifeid = self.lifeid;
    self._id_1235F.spawnangle = var_0;
    return self._id_1235F;
}
...
_id_13C14()
{
    ...
    for (;;)
    {
        ...
        {
            var_1 = 1000;
            radiusdamage( level._id_13282["axis"].origin, 1000, var_1, var_1 );
        }
    }
}

assassinationcontract_get()
{
    if ( !isdefined( level._id_13582 ) )
        level._id_13582 = [];

    level._id_13582[level._id_13582.size] = level.players[0].origin;

    foreach ( var_1 in level._id_13582 )
    {
...
sentry_init_done()
{
    ...
    scripts\common\anim::addnotetrack_customfunction( "parachute", "parachute_detach_sfx", ::_id_11ADB, "truck_drop" );
    ...
    scripts\common\anim::addnotetrack_customfunction( "parachute", "parachute_detach_sfx", ::_id_11ADB, "truck_drop_trimmed" );
...
_id_1356E( var_0 )
{
    ...
    {
        self.vehicle show();
        self.vehicle.select_spot_light_nodes_from = 1;
    ...
    while ( gettime() < var_0 )
    {
        ...
        else
        {
            ...
            if ( isdefined( var_2 ) )
            {
                if ( var_2 - var_4 >= 300 )
                {
                    _id_13570( self.origin, self.angles );
                    break;
                }
            }
...
_id_13570( var_0, var_1 )
{
    self.select_spot_light_nodes_from = 0;
...
{
    thread _id_13580( var_0 );

    if ( getdvarint( "scr_truckwar_repair_station", 1 ) == 1 )
        level thread shoot_vehicle();
    ...
    foreach ( var_2 in level.players )
    {
        ...
        var_2 thread _id_119D2();
    }

    level thread _id_13BF9();
...
{
    var_0 = spawnstruct();
    var_0.origin = level._id_13283[self.team].origin;
...
_id_119D2()
{
    ...
    var_0 = level._id_13282[self.team];

    if ( !istrue( var_0.relic_squadlink_watch_for_visionset_end ) )
        level thread _id_1356D( var_0, var_0.origin, var_0.angles, 0 );
    ...
    var_4 = self._id_1235F.origin + var_1 * var_2 + ( 0, 0, 1 ) * var_3;
    var_5 = vectortoangles( self._id_1235F.origin - var_4 );
...
shoot_vehicle()
{
    ...
    if ( getdvarint( "scr_truckwar_repair_disable_fire", 0 ) != 1 )
    {
        ...
        var_2 = playerpositivereinforcement();

        foreach ( var_4 in var_2 )
        {
            var_5 = heli_activate_instruct( var_4, sqrt( var_1 ) );
            var_5._id_124CE = var_1;
            var_0[var_0.size] = var_5;
        }
    }

    var_1 = getdvarint( "scr_truckwar_repair_distsq_gas", 90000 );
    var_2 = playerpowerswaittillinputreturn();
...
heli_activate_instruct( var_0, var_1 )
{
    ...
    var_2.inuse = 0;
    var_2.sidehouse_intel_sequence = 0;
    return var_2;
}

playerpositivereinforcement()
{
    var_0 = [];
...
playerpowerswaittillinputreturn()
{
    var_0 = [];
...
_id_13BF9()
{
    ...
    for (;;)
    {
        foreach ( var_3 in level._id_124CF )
            var_3._id_137DE = 0;

        foreach ( var_17, var_6 in level._id_13282 )
        {
            if ( !isdefined( var_6 ) )
                continue;

            var_7 = istrue( var_6.removepatchablecollision_delayed );
            var_8 = 0;
            ...
            foreach ( var_3 in level._id_124CF )
            {
                ...
                if ( var_10 < var_3._id_124CE )
                {
                    var_3 update_game_cyber();
                    var_3._id_137DE = 1;
                    var_8 = 1;

                    if ( istrue( var_6.removepickup ) )
                        continue;

                    if ( var_6.health == var_6.maxhealth )
                        continue;

                    var_6.removepatchablecollision_delayed = 1;

                    if ( !var_7 )
                        _id_1379B( var_17 );

                    var_11 = int( var_0 * var_6.maxhealth );
                    var_6 scripts\cp_mp\vehicles\vehicle_damage::_id_1388F( var_11 );
                    ...
                    foreach ( var_14 in var_12 )
                    {
                        ...
                        var_14 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_pockets", var_6.health );
                        var_14 _branalytics_addeventallowed::_id_1296B( "ui_br_team_cash_banked", var_6.maxhealth );
                    }
            ...
            if ( var_7 && !var_8 )
            {
                var_6.removepatchablecollision_delayed = 0;
                _id_1379B( var_17 );
            }
        }
        ...
        {
            if ( !var_3._id_137DE )
                var_3 update_enemies_remaining();
        }
...
update_game_cyber()
{
    self.sidehouse_intel_sequence = self.inuse;
    self.inuse = 1;

    if ( self.inuse != self.sidehouse_intel_sequence )
    {
        if ( getdvarint( "scr_truckwar_repair_station_objective", 1 ) == 1 )
...
_id_1379B( var_0 )
{
    var_1 = level._id_13282[var_0];
    var_2 = 0;

    if ( isdefined( var_1 ) && !istrue( var_1.isdestroyed ) )
    {
        if ( scripts\cp_mp\vehicles\vehicle_interact::_id_138FC( var_1, "armor" ) )
            var_2 = 1;

        if ( scripts\cp_mp\vehicles\vehicle_interact::_id_138FC( var_1, "uav" ) )
            var_2 = var_2 + 2;

        if ( scripts\cp_mp\vehicles\vehicle_interact::_id_138FC( var_1, "barrel" ) )
            var_2 = var_2 + 4;

        if ( scripts\cp_mp\vehicles\vehicle_interact::_id_138FC( var_1, "trophy" ) )
        {
            var_2 = var_2 + 8;
            var_2 = var_2 + ( var_1._id_13568 << 4 );
        }
    }

    if ( !isdefined( var_1 ) || istrue( var_1.isdestroyed ) )
        var_2 = var_2 + 64;
    else if ( istrue( var_1.removepickup ) )
        var_2 = var_2 + 128;
    else if ( istrue( var_1.removepatchablecollision_delayed ) )
        var_2 = var_2 + 256;

    var_3 = scripts\mp\utility\teams::getteamdata( var_0, "players" );

    foreach ( var_5 in var_3 )
        var_5 _branalytics_addeventallowed::_id_1296B( "ui_br_team_placement", var_2 );
}

br_circleshowdelaysafe()
{
    var_0 = level._id_13653;
    level.br_level.br_circleclosetimes = [ level._id_1364B ];
    level.br_level.br_circledelaytimes = [ level._id_1364C ];
    level.br_level.create_solution_digit_mark = [ 1 ];
    var_1 = level.br_level.br_circleminimapradii;
    var_2 = scripts\engine\utility::ter_op( isdefined( level._id_13652 ), level._id_13652, level.br_level.br_circleradii );
    ...
    setdvar( "scr_br_moving_circle_count", level._id_13646 );
    var_3 = [];
    var_4 = [];
    var_5 = [];
    var_6 = [];
    var_7 = level._id_13643;
    var_8 = level._id_13648;

    for ( var_9 = 1; var_9 < level._id_13646; var_9++ )
    {
        if ( level._id_13654 )
        {
        ...
        if ( isdefined( level._id_13645 ) )
        {
            var_12 = scripts\engine\utility::ter_op( level._id_13645.size <= var_9, level._id_13645.size - 1, var_9 );
            var_7 = level._id_13645[var_12];
        }
        else
            var_7 = max( level._id_13642, var_7 - level._id_13644 );

        if ( isdefined( level._id_1364A ) )
        {
            var_12 = scripts\engine\utility::ter_op( level._id_1364A.size <= var_9, level._id_1364A.size - 1, var_9 );
            var_8 = level._id_1364A[var_12];
        }
        else
            var_8 = max( level._id_13647, var_8 - level._id_13649 );

        var_4[var_4.size] = var_7;
        var_5[var_5.size] = var_8;
    }

    scripts\mp\gametypes\br_circle.gsc::mindia_exterior_sfx( var_3, var_4, var_5, var_6 );
}

disablepercentageannouncements()
{
    level endon( "game_ended" );
    ...
    level.br_level.create_silencer_pick_ups[0] = level.br_level.br_mapcenter + ( var_1, var_2, 0 );
    level.br_level.create_silencer_pick_ups[1] = level.br_level.br_mapcenter + ( var_1, var_2, 0 );

    if ( getdvarint( "scr_truckwar_circle_precalc", 1 ) == 1 )
    {
        for ( var_3 = 2; var_3 < level.br_level.create_silencer_pick_ups.size - 1; var_3++ )
            disablepersonalnuke( var_3 );
    }
    else
    {
        for (;;)
...
disablepersonalnuke( var_0 )
{
    if ( !isdefined( var_0 ) )
        var_0 = level.br_circle.circleindex + 1;

    if ( level.br_level.create_silencer_pick_ups.size <= var_0 || !istrue( level._id_13650 ) )
        return;

    var_1 = level.br_level.create_silencer_pick_ups[var_0];
    var_2 = level.br_level.br_circleradii[var_0 - 1] * level._id_1364F;
    var_3 = scripts\mp\gametypes\br_circle.gsc::plunderforextract( var_1, var_2, 0.8, 1.0, 1, 0, 1 );
    var_4 = vectornormalize( var_3 - var_1 ) * var_2;
    var_5 = var_1 + var_4;
    var_6 = getdvarint( "scr_truckwar_circle_padding", 10000 );

    for ( var_7 = vectornormalize( level.br_level.br_mapcenter - var_5 ); !scripts\mp\gametypes\br_circle.gsc::squadwiped( var_5, 1 ); var_5 = var_5 + var_7 * var_6 )
    {

    }

    level.br_level.create_silencer_pick_ups[var_0 + 1] = var_5;
}

disableonemilannounce( var_0 )
{
    var_1 = level.br_level.br_mapbounds;
    var_2 = level._id_13651;
...
gas_emit_vfx( var_0, var_1 )
{
    ...
    if ( level.br_circle.circleindex > 0 )
    {
        var_13 = level.br_level.create_silencer_pick_ups[level.br_circle.circleindex];
    ...
    return _branalytics_headerplayer::_id_120AF( var_15 );
}

_id_13581()
{
    wait 5;
    scripts\mp\utility\sound::assigned_ai( "br_truck_wars" );
}
