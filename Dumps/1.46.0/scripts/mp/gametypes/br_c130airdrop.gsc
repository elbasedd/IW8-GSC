...
init()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "br_c130Airdrop", "c130Airdrop_onCrateUse", ::endmatchcamerastriggered );
    level.endoperatorsfxondisconnect = [];
    level.endptui = [];
    level.ending_zplanes = getdvarint( "scr_bmo_airdropCrateHeightOverride", 12000 );
}
...
endingpropspecate()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( level._id_137F1 ) && istrue( var_0 ) )
        ...
        if ( var_7 < var_3 )
        {
            ...
            for ( var_12 = 0; var_12 < var_10; var_12++ )
            {
                ...
                var_14 = endgamevo( var_12 );
                var_15 = distance( var_14.startpt, var_14.endpt );
                var_16 = scripts\mp\gametypes\br_c130.gsc::getc130speed();
                var_17 = var_15 / var_16;
                var_18 = endmatchcameratransitions( var_14, var_15, var_16, var_17 );

                if ( var_12 == 0 )
                    scripts\mp\gametypes\br_gametype_dmz.gsc::_id_12B8E( "br_c130airdrop_incoming" );

                var_18 endofmatchdatasent( var_13 );
...
ending_fade_in( var_0, var_1, var_2 )
{
    ...
    var_5 = scripts\mp\gametypes\br_c130.gsc::playjumpsoundtosquad();
    ...
    if ( !isdefined( var_0 ) || var_0 == 0 )
    {
        if ( !istrue( var_2 ) )
        {
            var_7 = ending_winning_players_setup();
            var_8 = ending_viewing_players_setup( var_7 );
            var_6 = vectortoangles( var_4 - var_8 * ( 1, 1, 0 ) );
            level.endprematchskydiving = var_6;
        }

        var_4 = var_4 + ( 0, 0, scripts\cp_mp\parachute::playerfriendlyto() );
    }
    else
    {
        if ( isdefined( level.endprematchskydiving ) )
        {
            var_6 = level.endprematchskydiving;
            var_9 = 1;
        ...
        var_10 = var_10 + ( 0, 0, scripts\cp_mp\parachute::playerfriendlyto() );
        var_4 = var_4 + var_10;
    }

    var_3 = scripts\mp\gametypes\br_c130.gsc::_id_12E03( var_4, var_6 );
    return var_3;
}
...
endmatchcameratransitions( var_0, var_1, var_2, var_3 )
{
    ...
    var_4._id_11B14 = var_1;
    var_4.speed = var_2;
    var_4.lifetime = var_3;
    var_4.fusesound = spawn( "script_model", var_4.startpt );
    var_4.fusesound setmodel( "veh8_mil_air_acharlie130_magma_rigid" );
    var_4.fusesound linkto( var_4, "", ( 0, 0, 0 ), ( 0, 0, 0 ) );
    ...
    level.endoperatorsfxondisconnect[level.endoperatorsfxondisconnect.size] = var_4;
    return var_4;
}

endofmatchdatasent( var_0, var_1, var_2, var_3 )
{
    self setscriptablepartstate( "audio_lp_dmz", "on", 0 );
    self moveto( self.endpt, self.lifetime );
    thread ending_fade_out();
    thread ending_mortars( var_0, var_1, var_2, var_3 );
}
...
ending_fade_out()
{
    ...
    wait 1;
    level.endoperatorsfxondisconnect = scripts\engine\utility::array_remove( level.endoperatorsfxondisconnect, self );
    self setscriptablepartstate( "audio_lp_dmz", "off", 0 );

    if ( isdefined( self.minimapid ) )
        scripts\mp\objidpoolmanager::returnobjectiveid( self.minimapid );

    if ( isdefined( self.fusesound ) )
        self.fusesound delete();

    if ( isdefined( self ) )
        self delete();
}

ending_mortars( var_0, var_1, var_2, var_3 )
{
    self endon( "death" );

    if ( isdefined( self.lasttuttxt ) )
        self [[ self.lasttuttxt ]]( var_0, var_1, var_2, var_3 );
    else
    {
        var_4 = self.lifetime;
        var_5 = var_4 * 0.4;
        ...
        while ( var_12 < var_0 )
        {
            ...
            var_13 = ending_player_disconnect_thread( self.origin + anglestoforward( self.angles ) * 500 );
            ...
            var_14 = scripts\cp_mp\killstreaks\airdrop::laststand_dogtag_monitor( var_13 + ( 0, 0, level.ending_zplanes - 100 ), var_13, self.angles, var_1, var_2 );
            ...
            var_15._id_13807 = 5;
            level.endptui[level.endptui.size] = var_14;
        }
    }
}
...
ending_player_disconnect_thread( var_0, var_1 )
{
    ...
    {
        var_7 = scripts\mp\gametypes\br_c130.gsc::ispointinbounds( var_2, 1, 0 ) && !endingph( var_2 );
...
endmatchcamerastriggered( var_0 )
{
    ...
    if ( !scripts\mp\gametypes\br_public.gsc::spawn_exfil_enemies() && getdvarint( "scr_dmz_airdrop_drop_tablet", 0 ) == 1 )
    {
    ...
    if ( isdefined( level.bomb_detonator_waiting_for_pick_up ) )
        var_5 = level.bomb_detonator_waiting_for_pick_up;

    if ( istrue( level.choppergunner_handledangerzone ) )
        var_5 = int( var_5 * level._id_11AAD );
    ...
    foreach ( var_8 in var_2 )
        var_8.turret_aimed_at_last_known = "c130_box";
