...
init()
{
    ...
    level.calloutglobals.waittill_usebutton_released_or_time_or_bomb_planted = [];
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            level.calloutglobals.waittill_usebutton_released_or_time_or_bomb_planted[var_11] = var_12;
        }
...
playerstartrecondronewait( var_0 )
{
    ...
    foreach ( var_4, var_3 in level.calloutglobals.waittill_usebutton_released_or_time_or_bomb_planted )
    {
...
playerstartpowers( var_0 )
{
    ...
    foreach ( var_11, var_9 in level.calloutglobals.waittill_usebutton_released_or_time_or_bomb_planted )
    {
