    ...
    for (;;)
    {
        ...
        if ( istrue( level.registeraccesscardlocs ) )
        {
            if ( isdefined( var_1 ) && var_1.team == var_0.team )
            {
                ...
                playfx( level.scalertoscaleinfo["vanish_hw_fr"], var_0.trigger.origin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], var_0.trigger.origin );
                playfx( level.scalertoscaleinfo["vanish_hw_en"], var_0.trigger.origin + ( 0, 0, 45 ) );
            }
        }
        else
...
createzones()
{
    ...
    foreach ( var_3 in level.objectives )
    {
        ...
        var_3 scripts\mp\gametypes\obj_grindzone.gsc::_id_129B3();
...
droptags( var_0, var_1 )
{
    ...
    if ( istrue( level.registeraccesscardlocs ) && !isdefined( level.musictriggerthink ) )
    {
        level.musictriggerthink = 1;
        var_2 = 4;
    }
