...
hqmainloop()
{
    ...
    for (;;)
    {
        ...
        var_5 = level scripts\engine\utility::_id_13AE1( "hq_captured", "hq_destroyed" );
...
onradiodestroy( var_0 )
{
    ...
    var_0 thread scripts\common\utility::_id_13592( level.update_objective_mlgicon_reset, "destroy", var_0.origin );
    ...
    if ( isdefined( level.radioobject ) )
    {
        ...
        if ( var_13 != var_10 )
        {
            if ( var_11 istouching( level.radioobject.trigger ) )
            {
                ...
                thread scripts\common\utility::_id_13592( level.update_icon_for_bomb_case_detonator_holder.update_readings, var_9, "defending" );
            }
        }
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isplayer( var_5 ) )
    {
        ...
        {
            var_5 thread scripts\common\utility::_id_13592( level.update_objective_mlgicon_reset, "capture", var_5.origin );
