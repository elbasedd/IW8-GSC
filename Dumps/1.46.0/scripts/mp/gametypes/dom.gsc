...
initspawns()
{
    ...
    else if ( istrue( level.attached_bag ) )
...
domflags()
{
    ...
    foreach ( var_9 in var_6 )
    {
        ...
        vehicle_occupancy_errormessage( var_9 );
...
vehicle_occupancy_errormessage( var_0 )
{
    switch ( level.mapname )
    {
        case "mp_piccadilly":
            ...
            break;
        case "mp_malyshev":
            if ( level.unset_relic_doubletap )
            {
                switch ( var_0.script_label )
                {
                    case "_a":
...
_id_1379A()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.vehicle_damage_registerdefaultstates ) || var_1.vehicle_damage_registerdefaultstates != var_2 )
            {
                var_1 setmlgdominationpoint( var_2 );
                var_1.vehicle_damage_registerdefaultstates = var_2;
