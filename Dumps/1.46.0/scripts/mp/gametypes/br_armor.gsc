...
setplayerbrsquadleader()
{
    ...
    if ( isplayer( self ) )
    {
        ...
        scripts\mp\equipment\armor_plate::create_mp_version_of_vehicle( 0 );
    }
}
...
quarry2_ambient_sound_load( var_0 )
{
    ...
    {
        if ( getdvarint( "scr_game_hcmode" ) == 1 )
            var_2 = 50 * getdvarint( "scr_hcplatnum", 1 );
        else
            var_2 = 150;
    }
...
popoffhelmet( var_0, var_1, var_2 )
{
    ...
    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        ...
        {
            var_14 = scripts\mp\gametypes\br_pickups.gsc::playersetkeypadcodelengthindex( var_4.origin, var_4.angles );
            var_4 delete();
