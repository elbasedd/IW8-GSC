...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_8 thread col_checkiflocaleisavailable( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
...
col_checkiflocaleisavailable( var_0, var_1, var_2 )
{
...
getbombmodel( var_0 )
{
    if ( istrue( level.registeraccesscardlocs ) && istrue( var_0 ) )
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( !level.bombdefused )
    {
        ...
        if ( istrue( self.firstpickup ) )
        {
            ...
            if ( istrue( level.registeraccesscardlocs ) )
            {
                ...
                playfx( level.scalertoscaleinfo["vanish_hw_fr"], self.trigger.origin + ( 0, 0, -9970 ) );
            }
        }
        else
            var_3 = "bomb_pickup";
    ...
    scripts\mp\utility\game::trial_targs_combo( var_0, undefined, "Bomb Picked Up", var_0.origin );
