...
initspawns()
{
    ...
    {
        assignteamspawns();
        level.his_playerdisconnect["allies"] = "allies";
        level.his_playerdisconnect["axis"] = "axis";
...
getspawnpoint()
{
    ...
    if ( scripts\mp\utility\game::getgametypenumlives() != 1 )
    {
        if ( scripts\mp\spawnlogic::shoulduseteamstartspawn() )
        {
            ...
            var_1 = scripts\mp\spawnlogic::getspawnpoint( self, var_0, level.his_playerdisconnect[var_0], "neutral" );
    }
...
assignteamspawns()
{
    ...
    else
    {
        foreach ( var_9 in var_0 )
        {
            var_9.teambase = playerwaittillstreamhintcomplete( var_9 );
...
playerwaittillstreamhintcomplete( var_0 )
{
    var_1 = scripts\mp\spawnlogic::ispathdataavailable();
    var_2 = undefined;
    var_3 = undefined;
...
_id_13035()
{
    ...
    level.cyberemp scripts\mp\gameobjects::_id_129A9( "mlg_icon_waypoint_emp_planted" );
    ...
    level.cyberemp scripts\mp\gameobjects::_id_129B5( "icon_waypoint_escort_emp", "waypoint_capture_kill", "mlg_icon_waypoint_emp_planted", var_0 );
...
hidebombsitesaftermatchstart()
{
    ...
    scripts\mp\objidpoolmanager::wrapindex( level.objectives["allies"].objidnum, 1 );
    ...
    scripts\mp\objidpoolmanager::wrapindex( level.objectives["axis"].objidnum, 1 );
...
allowedwhileplanting( var_0 )
{
    ...
    if ( var_0 )
    {
        scripts\engine\utility::_id_13AED( 0.8, "bomb_allow_offhands" );
        scripts\common\utility::allow_melee( var_0 );
...
onenduse( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_1.isdefusing )
            scripts\mp\gameobjects::_id_129B5( "icon_waypoint_defuse_empsite_nt", "icon_waypoint_defend_empsite_nt", "mlg_icon_waypoint_emp_planted" );
        else
            scripts\mp\gameobjects::_id_129B5( "icon_waypoint_defend_empsite", "icon_waypoint_target_empsite", "mlg_icon_waypoint_emp_planted" );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    scripts\mp\objidpoolmanager::wrapindex( level.objectives["allies"].objidnum, 0 );
    scripts\mp\objidpoolmanager::wrapindex( level.objectives["axis"].objidnum, 0 );
...
onuse( var_0 )
{
    ...
    if ( !scripts\mp\gameobjects::isfriendlyteam( var_0.pers["team"] ) && !level.bombplanted )
    {
        ...
        var_0 scripts\cp\utility\cp_controlled_callbacks::_id_119A1();
        var_0 thread scripts\common\utility::_id_13592( level.update_objective_mlgicon_reset, "plant", var_0.origin );
        ...
        level.bombplanted = 1;
        scripts\mp\gameobjects::_id_129A9( "mlg_icon_waypoint_emp_planted" );
    ...
    else
    {
        ...
        var_0 scripts\cp\utility\cp_controlled_callbacks::_id_11965();
...
setupfordefusing( var_0, var_1 )
{
    ...
    thread scripts\mp\gametypes\obj_bombzone.gsc::col_checkiflocaleisavailable( var_1.team, "icon_waypoint_planted_empsite", "icon_waypoint_defuse_empsite" );
...
onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0.isplanting )
    {
        thread scripts\common\utility::_id_13592( level.update_readings, var_2, "planting" );
        var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
        var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
    }
    else if ( var_0.isbombcarrier )
        thread scripts\common\utility::_id_13592( level.update_readings, var_2, "carrying" );
    else if ( var_0.isdefusing )
        thread scripts\common\utility::_id_13592( level.update_readings, var_2, "defusing" );
}
...
weaponswapwatcher()
{
    ...
    for (;;)
    {
        if ( self.currentprimaryweapon.basename == "iw8_cyberemp_mp" )
        {
            if ( !istrue( self._id_12B6D ) )
            {
                scripts\mp\utility\player::showminimap();
                self._id_12B6D = 1;
            }
        }
        else if ( istrue( self._id_12B6D ) )
        {
