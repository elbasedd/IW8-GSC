...
updategametypedvars()
{
    ...
    level.subway_death_or_disconnect_monitor = scripts\mp\utility\dvars::dvarintvalue( "killstreakConfirmed", 0, 0, 1 );
}
...
dogtagenemyonusecb( var_0 )
{
    if ( isplayer( var_0 ) )
    {
        ...
        if ( istrue( level.subway_death_or_disconnect_monitor ) )
        {
