...
rpgcrateenduse( var_0 )
{
    ...
    var_0 scripts\mp\weapons::_id_129A2( getcompleteweaponname( "iw8_la_rpapa7_mp" ) );
}
...
watchiconupdater()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_13ADA( "bradley_driverUpdate", "death", "bradley_vehicleExit" );
...
ontimelimit()
{
    if ( isdefined( level.onphaseend ) )
    {
        var_0 = scripts\mp\gamescore::enter_combat_maze_ai( 0 );
