...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6._id_12BAB ) )
            var_0 = var_6._id_12BAB;

        if ( isdefined( var_6.lootchopper_handledeathdamage ) )
            var_3 = var_6.lootchopper_handledeathdamage;

        if ( isdefined( var_6.lootchopper_initcircleinfo ) )
            var_4 = var_6.lootchopper_initcircleinfo;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_13AE8( "log_user_event_end", "log_user_event_generic_event" );
