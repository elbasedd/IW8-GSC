...
dopotgkillcamforplayer()
{
    ...
    var_1 = scripts\engine\utility::_id_13AE8( "begin_killcam", "killcam_ended" );
...
dofinalkillcam()
{
    ...
    level thread scripts\cp\utility\cp_controlled_callbacks::processfinalkillchallenges( var_2, var_3 );
...
skipkillcamduringdeathtimer( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        var_1 = scripts\engine\utility::_id_13AE1( "killcam_death_done_waiting", "killcam_death_button_cancel" );
