...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::_id_13AE2( "long_death", "death", "enteredvehicle" );
...
{
    scripts\engine\utility::_id_13AD9( "unload", "death" );
...
guy_unload_que( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_13AD9( "death", "jumpedout" );
    ...
    if ( !self.unloadque.size )
    {
        ...
        self.kingslayerkills = undefined;
    }
}
...
_id_12137()
{
    if ( isdefined( self.kingslayerkills ) )
        return;

    self.kingslayerkills = [];
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.kingslayerkills[var_2] = spawnstruct();
            self.kingslayerkills[var_2].open = 0;
            self.kingslayerkills[var_2]._id_11A4D = 0;
        }
    }
}
...
wait_for_open_door( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.vehicle_getoutanim ) )
    {
        ...
        if ( !self.kingslayerkills[var_2].open )
        {
            ...
            self.kingslayerkills[var_2].open = 1;
        }
