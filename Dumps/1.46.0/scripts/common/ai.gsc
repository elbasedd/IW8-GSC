...
{
    if ( !isdefined( self._blackboard.binoculars_onstateinvalidenter ) )
    {
        self._blackboard.binoculars_onstateinvalidenter = 1;
        self._blackboard.binoculars_onstateexitfunc = var_0;
        return 1;
    }
...
{
    if ( isdefined( self._blackboard.binoculars_onstateinvalidenter ) && self._blackboard.binoculars_onstateinvalidenter == 1 )
        self._blackboard.binoculars_onstateinvalidenter = 2;
}
...
binoculars_isads()
{
    if ( isdefined( self._blackboard.binoculars_onstateinvalidenter ) )
    {
        if ( self._blackboard.binoculars_onstateinvalidenter == 1 )
        {
            self._blackboard.binoculars_onstateinvalidenter = undefined;
            self._blackboard.binoculars_onstateexitfunc = undefined;
            return 1;
        }
        else if ( self._blackboard.binoculars_onstateinvalidenter == 2 )
        {
            self._blackboard.binoculars_onstateinvalidenter = 3;
            return 1;
        }
    }
...
{
    if ( isdefined( self._blackboard.binoculars_onstateinvalidenter ) && self._blackboard.binoculars_onstateinvalidenter == 3 )
    {
        self._blackboard.binoculars_onstateinvalidenter = undefined;
        self._blackboard.binoculars_onstateexitfunc = undefined;
    }
...
battle_tracks_vehicleoccupancyenter( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_2 = var_0 binoculars_iswithinprojectiondistance( var_1 );
