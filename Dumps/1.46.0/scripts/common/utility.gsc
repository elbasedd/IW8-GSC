...
_id_12B10( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.spawn_field_ai_manager_middle ) )
        return 1;
...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && _id_12B10( self.damageweapon ) )
            return 1;
...
allow_init()
{
    ...
    allow_add( "usability_auto_use", ::bot_should_cap_next_zone );
    ...
    allow_add( "offhand_throwback", ::bot_pick_new_loadout_next_spawn );
    ...
    allow_add( "cp_munitions", ::bot_modify_behavior_from_loadout );
    allow_add( "nvg", ::bot_pick_dd_zone_with_fewer_defenders );
    allow_add( "ascender_use", ::bot_loadout_team );
}
...
bot_should_cap_next_zone( var_0, var_1 )
{
    var_2 = scripts\common\input_allow::allow_input_internal( "usability", var_0, var_1 );
...
bot_pick_new_loadout_next_spawn( var_0, var_1 )
{
...
bot_pick_dd_zone_with_fewer_defenders( var_0, var_1, var_2 )
{
    var_3 = 2;
...
_id_13592( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
