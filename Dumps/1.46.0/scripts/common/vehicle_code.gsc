...
vehicle_killriders()
{
    ...
    foreach ( var_1 in self.riders )
    {
        ...
        if ( isdefined( var_1._blackboard ) && isdefined( var_1._blackboard.chosenvehicleanimpos ) && istrue( var_1._blackboard.chosenvehicleanimpos.increase_accuracy_after_delay ) )
        {
            var_2 = 100.0;
        ...
        if ( scripts\common\utility::iscp() && isdefined( self.hitsperattackforvehicle ) )
        {
            if ( isdefined( self.hitsperattackforvehicle.attacker ) && isplayer( self.hitsperattackforvehicle.attacker ) )
                var_1 dodamage( var_1.maxhealth, self.hitsperattackforvehicle.attacker.origin, self.hitsperattackforvehicle.attacker, self.hitsperattackforvehicle.attacker, self.hitsperattackforvehicle.meansofdeath, self.hitsperattackforvehicle.objweapon );
            else
                var_1 kill();
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        foreach ( var_11 in self.riders )
        {
            if ( isalive( var_11 ) && isdefined( var_6[var_11.vehicle_position] ) )
            {
                ...
                if ( isdefined( var_8 ) && istrue( var_8.joininprogresstimeout ) )
                    continue;
...
death_firesound( var_0 )
{
    ...
    scripts\engine\utility::_id_13AD9( "fire_extinguish", "stop_crash_loop_sound" );
...
vehicle_damagelogic()
{
    ...
    while ( self.health > 0 )
    {
        ...
        if ( istrue( self.hidex1finhudfromplayer ) )
            return;
        ...
        if ( isdefined( var_3 ) )
        {
            ...
            if ( scripts\engine\utility::func_ref_exist( "vehicle_damage_modifier" ) )
            {
                ...
                if ( isdefined( level.nuke_killplayerwithattacker ) )
                    var_15 = [[ level.nuke_killplayerwithattacker ]]( var_3, self, var_2, var_11, var_6, undefined, var_5, var_4, var_7, var_9, var_8, var_10 );

                if ( isdefined( var_15 ) )
                    self.hitsperattackforvehicle = var_15;
                else
                    self.hitsperattackforvehicle = undefined;
        ...
        if ( !istrue( self._id_1355D ) && self.health <= self.healthbuffer )
...
{
    if ( !istrue( self._id_1355D ) && isdefined( self.script_team ) && self.script_team == "allies" && isdefined( var_0 ) && isplayer( var_0 ) )
        return 1;
...
helicopter_crash_move( var_0, var_1 )
{
    ...
    if ( var_5 )
    {
        ...
        scripts\engine\utility::_id_13AD9( "goal", "near_goal" );
    ...
    else
    {
        ...
        while ( var_8 != "death" )
        {
            var_8 = scripts\engine\utility::_id_13ADA( "goal", "near_goal", "death" );
