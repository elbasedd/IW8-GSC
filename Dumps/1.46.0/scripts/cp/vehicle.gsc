...
init_vehicles()
{
    ...
    scripts\engine\utility::create_func_ref( "vehicle_door_anim", ::killable_targets );
...
_id_13978()
{
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_apc", ::_id_12944 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_asierra", ::_id_12945 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_blima", ::_id_12946 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_decho_civ", ::_id_12948 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_decho_police", ::_id_12949 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_decho_rebel", ::_id_1294A );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_mkilo", ::_id_1294B );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_mkilo23_ai_infil", ::_id_1294C );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_skilo", ::_id_1294F );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_techo", ::_id_12950 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_tromeo", ::_id_12951 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_umike", ::_id_12952 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_vindia", ::_id_12953 );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_ralfa", ::_id_1294E );
    scripts\engine\utility::create_func_ref( "use_turret", ::_id_137CA );
}
