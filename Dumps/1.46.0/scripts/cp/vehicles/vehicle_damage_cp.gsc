...
init()
{
    scripts\engine\scriptable::_id_1279F( "military_ammo_restock", ::br_pickups_init );
    ...
    if ( isdefined( level.localeid ) && level.localeid == "locale_6" )
        br_pickupdenyplunderpickup();
}

br_pickups_init( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        if ( create_model_at( var_3 ) )
        {
            if ( scripts\mp\flags::gameflag( "prematch_done" ) && ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "rumble" ) )
                ...
                thread br_pickupdenyweaponpickupap( var_0, var_3, 5 );
        }
        else
            thread br_pickupdenyweaponpickupap( var_0, var_3, 0.1 );
    }
...
br_pickupdenyweaponpickupap( var_0, var_1, var_2 )
{
...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons.gsc::createextractionlocation( var_9, 2 );
            continue;
        }

        var_21 = scripts\mp\weapons::getammooverride( var_9 );

        if ( scripts\mp\utility\weapon::sort_wave_spawning_ai( var_9 ) )
        {
...
create_model_at( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::spawn_set_jugg_value( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons.gsc::createextractionlocation( var_8, 2 );
            var_1 = 1;
        }
    }
