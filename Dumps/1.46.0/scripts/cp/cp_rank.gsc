...
_id_123A4( var_0 )
{
    if ( !isdefined( level.bot_tdef_think ) )
        level.bot_tdef_think = [];

    level.bot_tdef_think = scripts\engine\utility::array_add( level.bot_tdef_think, var_0 );
}

_id_123A5( var_0 )
{
    if ( !isdefined( level.bot_thanks ) )
        level.bot_thanks = [];

    level.bot_thanks = scripts\engine\utility::array_add( level.bot_thanks, var_0 );
}
...
strike_additem( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15 )
{
    ...
    else
    {
        if ( isdefined( var_0.targetname ) )
        {
            ...
            if ( istrue( var_0.sixthsenselastvotime ) )
            {
                var_0.sixthsenselastvotime = undefined;
                _id_130EB( var_0, var_1 );
                return;
            }
...
wp_isactivewpzone()
{
    ...
    if ( isdefined( level.bot_tdef_think ) )
    {
        ...
        {
            for ( var_2 = 0; var_2 < level.bot_tdef_think.size; var_2++ )
            {
                if ( getsubstr( level.bot_tdef_think[var_2], 0, 1 ) == "!" )
                    var_3 = 1;
                else
                    var_3 = 0;

                if ( skydivestreamhintdvars( self.script_gameobjectname, level.bot_tdef_think[var_2] ) != var_3 )
                {
                    var_0 = 1;
                    break;
                }
    ...
    if ( isdefined( level.bot_thanks ) )
    {
        if ( isdefined( self.script_gameobjectname ) )
        {
            for ( var_2 = 0; var_2 < level.bot_thanks.size; var_2++ )
            {
                if ( getsubstr( level.bot_thanks[var_2], 0, 1 ) == "!" )
                    var_3 = 1;
                else
                    var_3 = 0;

                if ( skydivestreamhintdvars( self.script_gameobjectname, level.bot_thanks[var_2] ) != var_3 )
                {
                    var_1 = 1;
                    break;
                }
...
skydivestreamhintdvars( var_0, var_1 )
{
...
strike_modelcreate( var_0, var_1 )
{
    ...
    var_2.struct = var_0;
    var_0.is_cs_model = undefined;
    var_0.skip_basic_combat = undefined;
...
{
    if ( isdefined( var_0.target ) )
        heli_orbit_logic( "target", var_0.target, var_0 );

    if ( isdefined( var_0.script_linkname ) )
        heli_orbit_logic( "script_linkname", var_0.script_linkname, var_0 );

    if ( isdefined( var_0.targetname ) )
        heli_orbit_logic( "targetname", var_0.targetname, var_0 );

    if ( isdefined( var_0.script_noteworthy ) )
        heli_orbit_logic( "script_noteworthy", var_0.script_noteworthy, var_0 );
}

heli_orbit_logic( var_0, var_1, var_2 )
{
...
should_wait_for_cs_flag( var_0 )
{
    ...
    var_1 = scripts\engine\utility::array_combine( var_1, level.apc_horn );
...
{
    level.apc_horn[level.apc_horn.size] = var_0;
}
...
_id_12D1B( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        switch ( var_3.watchforentervehicle )
        {
            case "cover_left":
                var_4 = "Cover Left";
                break;
        ...
        if ( isdefined( var_3.watchfordeathwhilereviving ) )
            var_5 = var_3.watchfordeathwhilereviving;

        var_6 = 0;

        if ( isdefined( var_3.watchforteammatedeathwhilereviving ) && int( var_3.watchforteammatedeathwhilereviving ) != 0 && var_3.watchforteammatedeathwhilereviving != "false" )
            var_6 = 4;

        if ( isdefined( var_3.watchdumpsterplayerexit ) && int( var_3.watchdumpsterplayerexit ) != 0 && var_3.watchdumpsterplayerexit != "false" )
            var_6 = var_6 + 8;

        if ( isdefined( var_3.watchforpayloadstage ) && int( var_3.watchforpayloadstage ) != 0 && var_3.watchforpayloadstage != "false" )
            var_6 = var_6 + 16;
