...
escape_if_player_is_in_hangar()
{
    level thread exfil_objective();
}
...
equipprimarypickup( var_0, var_1 )
{
    ...
    var_2 thread active_healthpacks( var_5 );
    active_fob_think( "Enemy switched to danger" );
}
...
active_healthpacks( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( activatemeleeblood( var_0 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( var_7 && activate_trap_object( var_6, var_3 ) )
            {
                if ( isdefined( level.turn_on_red_lights_along_track ) && getdvar( "scr_br_gametype", "" ) == "kingslayer" && scripts\engine\utility::array_contains( level.turn_on_red_lights_along_track, var_6 ) )
                ...
                var_5 = var_6;
                active_fob_think( "Enemy tracked!" );

                if ( !istrue( var_2 ) )
                    var_6.spawn_real_number = 1;
            }

            var_3 thread execute_combat_action( var_0, var_6 );
    ...
    else if ( var_0 == 0 )
    {
        if ( getdvarint( "scr_calloutmarkerping_navigation_proximity_cancel", 0 ) )
            var_3 thread escort_intro_pre_anim_wait();
    }
    else if ( var_0 == 8 )
    {
        var_8 = var_3 calloutmarkerping_getent( var_0 );
        var_3 thread execute_combat_action( var_0, var_8 );
        var_3 thread evaluateallaccolades( var_0, var_8 );
    }
    else if ( var_0 == 7 )
    {
        ...
        {
            var_3 thread executionquip( var_0, var_9 );
            var_3 thread executioncashmultiplier( var_0, var_9 );
        }
    }
    else if ( var_0 == 12 )
        var_3 thread execution_debug( 12, var_1 );

    if ( !isdefined( var_5 ) )
        var_4 = var_3 equipsecondarypickup( var_0 );

    active_fob_think( "Timeout value before wait: " + var_4 + " | poolID: " + var_0 );
    wait( var_4 );

    if ( isdefined( var_5 ) && isdefined( var_3 ) )
    {
        if ( isdefined( var_5.spawn_real_number ) )
            var_5.spawn_real_number = undefined;

        var_3 thread equipprimarypickup( var_0, var_5 );
    }
    else
    {
        active_fob_think( "Pool timed out: " + var_0 );
...
active_drones()
{
    ...
    for (;;)
    {
        ...
        active_fob_think( "Notification " + var_1 + " on pool " + var_2 );

        switch ( var_1 )
        {
            case "calloutmarkerping_added":
                var_0 activate_switch_cooldown( var_2 );
                break;
            case "calloutmarkerping_cleared":
                var_0 activate_target_group( var_2 );
                break;
            case "calloutmarkerping_acknowledged":
                var_0 activate_subway_track_trigger_hurt( var_2, var_3 );
                break;
            case "calloutmarkerping_acknowledged_cancel":
                var_0 activate_subway_track_trigger_hurt_internal( var_2 );
                break;
            case "calloutmarkerping_enemy_repinged":
                var_0 activate_timed_laser_trap( var_2 );
                break;
            case "map_ping_delete_marker":
                var_0 activate_timed_laser_traps();
                break;
            case "br_inventory_slot_request":
                var_0 activate_target( var_2 );
                break;
            default:
                break;
        }
...
calloutmarkerping_initplayer()
{
    ...
    if ( !isdefined( var_0.exit_open ) )
        var_0.exit_open = [];

    if ( !isdefined( var_0.exfil ) )
        var_0.exfil = [];

    var_0 thread active_drones();
}
...
activate_trap_object( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
escort_friendly_ai_riders( var_0 )
{
...
equipmentscriptableused( var_0, var_1 )
{
...
evaluatecontrolledcallback( var_0 )
{
    ...
    if ( !equipmentscriptableused( var_1 ) )
        return;
    ...
    if ( var_2 )
    {
        ...
        if ( var_3 == var_0 )
        {
            var_1 escort_vehicle_push_clip( "br_ping_cancel", 12 );
            return;
        }
    }
    ...
    var_1 thread active_healthpacks( 12, var_0 );
    var_1 thread exit_level( var_0 );
}
...
exit_level( var_0 )
{
    ...
    var_2 = playersetiszombie( var_0 );

    if ( isdefined( var_2 ) && isdefined( var_1 ) )
        var_1 exfill_chopper_dialogue( var_2, 12 );
}
...
activate_server_for_interact( var_0 )
{
    ...
    if ( !activate_trophy_protection( var_2 ) )
        return;
...
exfil_heli_landing( var_0 )
{
    ...
    if ( activatemusictrigger( var_0 ) )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_8 = active_neurotoxin_clouds( var_4 );
        }
        ...
        {
            if ( activate_trap_from_interaction( var_4.entity ) )
                var_3 = "ping_killstreaks_carepkg";
            else if ( istrue( var_4.entity.isjuggernaut ) )
                var_3 = "ping_killstreaks_juggernaut";
            else if ( activate_upload_station_for_interact( var_2 ) )
                var_3 = "ping_plunder_bank";
            else if ( activate_track_timer( var_4.entity ) )
                var_3 = "ping_vehicle_heavy";
            else if ( istrue( var_4.entity.spawnsystem_init ) )
                var_3 = "ping_pickup_generic";
        }
        else
            var_3 = var_1 exfil_smoke_vfx( var_0, var_2 );
    }
    else if ( activatemeleeblood( var_0 ) )
        var_3 = var_1 exfil_sequence( var_0, var_2 );
    else if ( activategastrap( var_0 ) )
    ...
    else
    {
        switch ( var_0 )
        {
            case 0:
                ...
                break;
            case 8:
                var_3 = var_1 exfil_spawners_triggered( var_0, var_2 );
                break;
            case 7:
                var_3 = var_1 exfil_spawnfunc( var_0 );
                break;
            default:
                break;
        }
    ...
    var_1 exfill_chopper_dialogue( var_3, var_0 );
}
...
activatefunc( var_0 )
{
    ...
    else if ( activatemeleeblood( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            if ( activate_trap_object( var_1, self ) )
            {
...
exfil_spawners_triggered( var_0, var_1 )
{
    var_2 = self;
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "ping", "ping_cp_getCPVehicleCallout" ) )
    {
        ...
        if ( isdefined( var_4 ) && istrue( var_4.dropmenu_tut ) )
            return var_4._id_13A2D;
    }

    if ( !isdefined( var_3.vehiclename ) )
        return "ping_vehicle_concat_no_driver";

    var_5 = activatedtime( var_3, var_2.team );
...
exfil_spawnfunc( var_0 )
{
    ...
    switch ( var_8 )
    {
        ...
        case "assassination":
            if ( var_1 exfil_regroup_spot( "ping_objective_contract" ) )
...
exfil_smoke_vfx( var_0, var_1 )
{
    ...
    if ( !isdefined( var_6 ) )
    {
        ...
        {
            if ( var_2 exfil_regroup_spot( "ping_vehicle_cash_deposit_helo" ) )
    ...
    else if ( issubstr( var_6, "CONTRACT" ) )
    {
        ...
        if ( var_9 != "" && !var_2 exfil_regroup_spot( var_9 ) )
            var_9 = "";
    ...
    {
        if ( var_2 exfil_regroup_spot( "ping_gasmask" ) )
            var_9 = "ping_gasmask";
        else
            var_9 = "ping_pickup_generic";
    }
    ...
    {
        if ( var_2 exfil_regroup_spot( "ping_loot_accesscard" ) )
    ...
    {
        if ( var_2 exfil_regroup_spot( "ping_cash_deposit_balloon" ) )
...
exfil_retreat( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( !isdefined( var_7 ) )
    {
        ...
        {
            if ( var_2 exfil_regroup_spot( "ping_plunder_bank_confirm" ) )
    ...
    if ( issubstr( var_7, "CONTRACT" ) )
    {
        ...
        if ( var_10 != "" && !var_2 exfil_regroup_spot( var_10 ) )
            var_10 = "";
    ...
    {
        if ( var_2 exfil_regroup_spot( "ping_gasmask_confirm" ) )
            var_10 = "ping_gasmask_confirm";
    }
    else if ( issubstr( var_7, "ARMORY_KIOSK" ) )
    {
        if ( var_2 exfil_regroup_spot( "ping_plunder_vendor_confirm" ) )
            var_10 = "ping_plunder_vendor_confirm";
    }
    else if ( issubstr( var_7, "_PLUNDER_EXTRACT" ) )
    {
        if ( var_2 exfil_regroup_spot( "ping_cash_deposit_confirm" ) )
...
calloutmarkerping_removecallout( var_0 )
{
    ...
    active_fob_think( "Remove Callout ID Start: " + var_0 );
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        active_fob_think( "Remove Callout ID Notify: " + var_0 );
...
executionquip( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            active_fob_think( "gscObjectiveStartedProgress: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
executioncashmultiplier( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) && var_2 == var_1 )
        {
            active_fob_think( "gscObjectiveDeleted: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
execute_combat_action( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    active_fob_think( "Watch Entity Death or Enemy Disconnect: " + var_0 );
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        var_1 scripts\engine\utility::_id_13ADA( "death", "pickup", "explode" );

    if ( isdefined( var_1.spawn_real_number ) )
        var_1.spawn_real_number = undefined;

    calloutmarkerping_removecallout( var_0 );
}

execution_debug( var_0, var_1 )
{
    self endon( "predictiveCalloutClear_" + var_0 );
    active_fob_think( "watchPlayerDeathOrDisconnect: " + var_0 );
    var_2 = playersetispropgameextrainfo( var_1 );
    scripts\engine\utility::_id_13AD9( "death_or_disconnect", "self_pickedupitem_" + var_2 );
    calloutmarkerping_removecallout( var_0 );
}
...
calloutmarkerping_watchscriptabledeath( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    active_fob_think( "Watch scriptable death ID: " + var_0 );
    ...
    else if ( var_1.type == "equip_fulton_mp" )
    {
        ...
        var_2 scripts\engine\utility::_id_13AD9( "death", "fulton_takeoff" );
    }
    else
        level scripts\engine\utility::_id_13ADC( "pickedupweapon_kill_callout_" + var_1.type + var_1.origin, "lootcache_opened_kill_callout" + var_1.origin, "dropbag_kill_callout_" + var_1.origin, "tablethide_kill_callout_" + var_1.origin, "carriable_kill_callout_" + var_1.origin );

    active_fob_think( "Watch scriptable death Remove ID: " + var_0 );
    calloutmarkerping_removecallout( var_0 );
}
...
equipsecondarypickup( var_0 )
{
    ...
    if ( activate_vehicle_spawner( var_0 ) )
        var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
    else if ( activatemusictrigger( var_0 ) )
    {
        if ( activate_upload_station( var_0 ) )
            var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
        else if ( escort_b( var_0 ) )
...
exfilchopper( var_0 )
{
    ...
    if ( !isdefined( var_1.exit_open[var_0] ) )
        return 0;

    return 1;
}

exfilallyturning( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = var_4.exit_open.size;

    if ( var_5 > 10 )
        return 0;

    var_6 = var_4 exfil_clear_objective( var_0, var_3 );
    var_7 = var_6 + var_1;
    var_8 = spawnstruct();
    var_8._id_12CD6 = var_7;
    var_8.poolid = var_0;
    var_8.extractquest_missionweapon = 0;
    var_4.exit_open[var_2] = var_8;
    return 1;
}

exfil_enemy_spawning( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( istrue( var_3.isplacementplayerobstructed ) )
        return 0;

    var_4 = gettime();
    var_5 = "pool" + var_0;
    var_6 = var_3 exfilchopper( var_5 );

    if ( var_6 )
    {
        var_7 = var_3.exit_open[var_5]._id_12CD6;

        if ( var_4 >= var_7 )
        {
            var_8 = var_3 exfilallyturning( var_0, var_4, var_5, var_2 );
            return istrue( var_8 );
        }

        if ( var_1 == "ping_response_cancel" && var_3.exit_open[var_5].extractquest_missionweapon == 0 )
        {
            var_3.exit_open[var_5].extractquest_missionweapon = 1;
            return 1;
        }
...
exfil_objective()
{
    ...
    for (;;)
    {
        ...
        for ( var_1 = 0; var_1 < level.players.size; var_1++ )
        {
            ...
            if ( !isdefined( var_2 ) || !isdefined( var_2.exit_open ) )
                continue;

            foreach ( var_5, var_4 in var_2.exit_open )
            {
                if ( var_0 > var_4._id_12CD6 )
                    var_2.exit_open[var_5] = undefined;
            }
        }
    }
}

exfil_spots_objs_settings( var_0, var_1, var_2, var_3 )
{
    var_4 = 0;
...
escort_vehicle_push_clip( var_0, var_1 )
{
    var_2 = self;
    ...
    foreach ( var_7 in var_5 )
    {
        ...
        if ( isdefined( var_8.spotlight_turret_info ) )
            var_8 delete();
...
exfil_regroup_spot( var_0 )
{
    var_1 = self;
    var_2 = var_1 exfil_spawning_logic( var_0 );
    var_3 = var_1 exfil_speed( var_0 );
...
exfill_chopper_dialogue( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    var_5 = var_4 exfil_spawning_logic( var_0 );
    var_6 = var_4 exfil_speed( var_0 );
    var_7 = soundexists( var_5 );
    var_8 = soundexists( var_6 );
    var_9 = exfil_spots_objs_settings( var_7, var_5, var_8, var_6 );
    var_10 = var_4 exfil_enemy_spawning( var_1, var_0, var_9 );
...
escort_intro_pre_anim_wait()
{
    ...
    for (;;)
    {
        ...
        if ( var_6 < var_3 )
        {
            escort_vehicle_push_clip( "br_ping_cancel", 0 );
...
escort_vehicle_push_volume( var_0 )
{
    var_1 = 0;

    foreach ( var_3 in level.players )
    {
        var_3 evade_start_targetname();
...
exit_laststand_usability( var_0 )
{
    ...
    var_1 escort_vehicle_push_clip( "br_ping_cancel", var_0 );
    wait( getdvarfloat( "scr_calloutmarkerping_delay_between_vo_and_sfx_secs_cleared", 0.5 ) );

    if ( isdefined( var_1 ) )
        var_1 exfill_chopper_dialogue( "ping_response_cancel", var_0 );
}

existingkills( var_0 )
{
    var_1 = self;
    var_1 exit_laststand_usability( var_0 );
}

exfill_vehicle( var_0, var_1 )
{
    var_2 = self;
    ...
    if ( activatemusictrigger( var_0 ) )
    {
        ...
        var_4 = var_2 exfil_retreat( var_0, var_3, var_1 );
    }
    else if ( activatemeleeblood( var_0 ) )
    ...
    else
    {
        ...
        {
            case 0:
                if ( var_1 exfil_regroup_spot( "ping_generic_ping_response" ) )
            ...
            case 7:
                ...
                break;
            case 8:
                if ( var_1 exfil_regroup_spot( "ping_vehicle_confirm" ) )
    ...
    if ( isplayer( var_1 ) )
        var_2 exfill_chopper_dialogue( var_4, var_0, var_1 );
    else if ( isdefined( var_2 ) )
        var_2 exfill_chopper_dialogue( var_4, var_0 );
}
...
exit_laser_panel_anim_sequence( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
        var_1 exfil_heli_landing( var_0 );
}
...
escort_b( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2._id_131AE ) )
        return 1;
...
activate_upload_station( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.classname ) && issubstr( var_2.classname, "scriptable" ) && !isdefined( var_2.entity ) && var_2 getscriptableisreserved() )
    {
        if ( var_2 _meth_87B7() )
        {
            ...
            return _branalytics_headerplayer::skipweapondropondeath( var_3 );
        }
    }
...
evaluateallaccolades( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    var_2 = 0.25;
    ...
    for (;;)
    {
        var_5 = active_relic_bang_and_boom( var_0, var_1, var_4 );
        ...
        var_6 = activatedtime( var_1, var_4 );
        ...
        if ( var_6 )
        {
            ...
            if ( var_3 >= 3 )
            {
                ...
                if ( isdefined( var_7 ) )
                    thread equipprimarypickup( var_0, var_7 );
                else
                    calloutmarkerping_removecallout( var_0 );
...
activate_station( var_0 )
{
    ...
    if ( !isdefined( var_1.exfil ) )
        var_1.exfil = [];

    if ( !isdefined( var_1.exfil[var_0] ) )
        var_1.exfil[var_0] = 0;
    else
        var_1.exfil[var_0]++;
    ...
    var_2[var_2.size] = var_1.exfil[var_0];
...
activate_subway_fast_travel()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            if ( var_0 calloutmarkerping_getactive( var_1 ) )
                var_0 activate_stealth_settings( var_1, "clear_all" );
        }
    }
}
...
activate_stealth_settings( var_0, var_1 )
{
    ...
    var_3[var_3.size] = var_2.exfil[var_0];
...
{
    var_1 = self;
    var_1 activate_stealth_settings( var_0, "clear_single" );
    var_1 notify( "predictiveCalloutClear_" + var_0 );
    var_1 thread exit_laststand_usability( var_0 );
}

activate_subway_track_trigger_hurt( var_0, var_1 )
{
    var_2 = self;
    var_2 thread active_healthpacks( var_0, 0, 1 );
    var_2 thread exfill_vehicle( var_0, var_1 );
...
{
    var_1 = self;
    var_1 thread existingkills( var_0 );
}
...
activate_switch_cooldown( var_0 )
{
    ...
    if ( istrue( level.select_patrol_six_spawners ) && !istrue( var_1 istacmapactive() ) )
    {
        calloutmarkerping_removecallout( var_0 );
        return;
    }

    var_1 activate_station( var_0 );
    var_1 thread active_healthpacks( var_0 );
    var_1 activate_server_for_interact( var_0 );
    var_1 thread exit_laser_panel_anim_sequence( var_0 );
    var_1 activatefunc( var_0 );
...
{
    var_1 = self;
    var_1 thread active_healthpacks( var_0, 0, 1 );
    var_1 escort_vehicle_push_clip( "br_ping_enemy", var_0 );
}

activate_timed_laser_traps()
{
    var_0 = self;
    var_1 = active_cs_files();

    if ( var_1 != -1 )
    {
        var_0 activate_subway_fast_travel();
        var_0 escort_vehicle_push_clip( "br_ping_cancel", var_1 );
        var_0 exfill_chopper_dialogue( "ping_response_cancel", var_1 );
    }
...
{
    var_1 = self;
    var_1 thread evaluatecontrolledcallback( var_0 );
}
