...
get_footstepsprint_alias( var_0, var_1, var_2 )
{
...
_id_11D3F( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self._blackboard.currentvehicle.mgturret ) )
        thread _id_139B3( self._blackboard.currentvehicle.mgturret[0] );
...
playanim_exitvehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self._blackboard.currentvehicle ) && isdefined( self._blackboard.chosenvehicleanimpos.vehicle_getoutanim ) )
    {
        ...
        self._blackboard.currentvehicle.kingslayerkills[var_3]._id_11A4D = 1;
    }

    scripts\engine\utility::set_movement_speed( 60 );
    self aisettargetspeed( 60 );
    self.maxrangesq = self.turnrate;
    self.turnrate = 0.3;
...
exitvehicle_terminate( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.maxrangesq ) )
    {
        self.turnrate = self.maxrangesq;
        self.maxrangesq = undefined;
    }
...
spawn_trucks( var_0, var_1, var_2, var_3 )
{
...
_id_13980()
{
    ...
    if ( isdefined( self._blackboard.currentvehicle.kingslayerkills ) && ( self._blackboard.currentvehicle.kingslayerkills[var_0].open || self._blackboard.currentvehicle.kingslayerkills[var_0]._id_11A4D ) )
        return 1;

    if ( !isdefined( self._blackboard.currentvehicle.f ) || self._blackboard.currentvehicle.f )
        return 1;
