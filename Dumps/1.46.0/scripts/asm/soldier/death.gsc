...
{
    if ( isscriptedagent( self ) && !nullweapon( self.damageweapon ) && self.unittype != "juggernaut" && scripts\common\utility::_id_12B10( self.damageweapon ) )
    {
...
is_exploder()
{
    self detachshieldmodel( self.riotshieldmodel, self._id_125D6 );
    self.check_missiles_reloaded_vo = undefined;
}
...
chooseexplosivedeathanim( var_0, var_1, var_2 )
{
    ...
    if ( !nullweapon( var_4 ) && self.unittype != "juggernaut" && scripts\common\utility::_id_12B10( var_4 ) )
    {
