...
asm_init( var_0, var_1 )
{
    ...
    self.fnasm_playfacialanim = ::buildblueprintpickupweapon;
    ...
    level.nuke_slamtoblack = ::branalytics_inittablets;
    level.nuke_startexfilcountdown = ::branalytics_init;
    level.nuke_shouldnukeendgame = ::branalytics_init;
    hack_setup_a_struct();
    var_2 = var_0;
...
{
    build_wheelson_duration( var_0, var_1, var_2, var_3, "end" );
}

build_wheelson_duration( var_0, var_1, var_2, var_3, var_4 )
{
...
doorneedstoclose( var_0 )
{
    ...
    var_4 = angleclamp180( var_3 - var_0.getnextsafecircleradius[1] );
    var_5 = angleclamp180( var_0.angles[1] - var_0.getnextsafecircleradius[1] );
...
build_vehicle_drop_off_list( var_0 )
{
    if ( !animisleaf( var_0 ) )
        return 0;
...
buildblueprintpickupweapon( var_0, var_1, var_2 )
{
    self setfacialindexfromasm( var_0, var_1, var_2 );
}

building_magic_grenade_damage( var_0, var_1 )
{
    if ( !scripts\asm\shared\utility::isfacialstateallowed( "asm" ) )
        return;

    if ( isdefined( var_0 ) && build_vehicle_drop_off_list( var_0 ) )
        return;
