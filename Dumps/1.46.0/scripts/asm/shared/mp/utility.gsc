...
animscriptmp_internal( var_0, var_1, var_2, var_3 )
{
    ...
    scripts\asm\asm_mp::building_magic_grenade_kill_watch();
...
branalytics_planepath( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::building_magic_grenade_kill_watch();
...
branalytics_plunder_extraction_failure( var_0, var_1 )
{
    scripts\asm\asm_mp::building_magic_grenade_kill_watch();
...
branalytics_kiosk_purchaseitem( var_0 )
{
    scripts\asm\asm_mp::building_magic_grenade_kill_watch();
...
branalytics_missionstart( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::building_magic_grenade_kill_watch();
...
branalytics_playercount( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::building_magic_grenade_kill_watch();
