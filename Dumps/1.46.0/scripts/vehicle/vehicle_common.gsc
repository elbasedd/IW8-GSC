...
waitforentervehicle()
{
    var_0 = scripts\engine\utility::_id_13AE3( "entervehicle", "death", "long_death", "failedentervehicle" );
...
exitingvehicle()
{
    ...
    self._blackboard.currentvehicle.f = 0;
    self._blackboard.currentvehicle thread maxtagradius();
}
