...
_id_1279F( var_0, var_1 )
{
    if ( !isdefined( level._id_127AF ) )
        level._id_127AF = [];

    if ( !isdefined( level._id_127AF[var_0] ) )
        level._id_127AF[var_0] = [];

    level._id_127AF[var_0][level._id_127AF[var_0].size] = var_1;
}

_id_1279C( var_0 )
{
    if ( !isdefined( level._id_127A0 ) )
        level._id_127A0 = [];

    level._id_127A0 = scripts\engine\utility::array_add( level._id_127A0, var_0 );
}

_id_1279D( var_0 )
{
    if ( !isdefined( level._id_127A2 ) )
        level._id_127A2 = [];

    level._id_127A2 = scripts\engine\utility::array_add( level._id_127A2, var_0 );
}
...
scriptable_engineused( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( istrue( var_5 ) )
    {
        if ( isdefined( level._id_127A2 ) )
        {
            foreach ( var_7 in level._id_127A2 )
    ...
    if ( istrue( var_4 ) )
    {
        if ( isdefined( level._id_127A0 ) )
        {
            foreach ( var_7 in level._id_127A0 )
    ...
    else
    {
        ...
        if ( isdefined( level._id_127AF ) && isdefined( level._id_127AF[var_1] ) )
        {
            foreach ( var_7 in level._id_127AF[var_1] )
                [[ var_7 ]]( var_0, var_1, var_2, var_3, 1 );
        }
    }
}
...
_id_1279E( var_0 )
{
    if ( !isdefined( level._id_127A7 ) )
        level._id_127A7 = [];

    level._id_127A7 = scripts\engine\utility::array_add( level._id_127A7, var_0 );
}

_id_127AB( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( isdefined( level._id_127A7 ) )
    {
        foreach ( var_12 in level._id_127A7 )
