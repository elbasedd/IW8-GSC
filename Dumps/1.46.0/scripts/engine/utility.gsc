...
_id_13AE3( var_0, var_1, var_2, var_3 )
{
...
_id_13AE4( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_13AE5( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_13AE6( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
_id_13AEA( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_13AEB( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_13AEC( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_13AEF( var_0, var_1, var_2, var_3 )
{
...
_id_13AF0( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_13AF1( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_13AF2( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( ( !isdefined( var_1 ) || var_1 != "death" ) && ( !isdefined( var_2 ) || var_2 != "death" ) && ( !isdefined( var_3 ) || var_3 != "death" ) && ( !isdefined( var_4 ) || var_4 != "death" ) && ( !isdefined( var_5 ) || var_5 != "death" ) && ( !isdefined( var_6 ) || var_6 != "death" ) )
        self endon( "death" );
...
_id_13AF5( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_13AF6( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_13AF7( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_13ADB( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13ADC( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13ADD( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13ADE( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_13ADF( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
deletestruct_ref( var_0 )
{
    ...
    if ( isdefined( level.struct ) )
    {
        if ( level.struct.size > 5000 )
        {
            ...
            _id_124C4( var_0, 0, level.struct.size );
    }
}

_id_124C4( var_0, var_1, var_2 )
{
...
{
    var_3 = var_1 _id_13AE1( var_2, "death" );
...
flag_wait_either_return( var_0, var_1 )
{
    for (;;)
    {
        ...
        var_2 = level _id_13AE1( var_0, var_1 );
        return var_2;
    }
}
...
flag_wait_any_return( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        var_6 = level _id_13AE4( var_0, var_1, var_2, var_3, var_4 );
        return var_6;
    }
}
...
lootchopper_patrolzone( var_0, var_1, var_2, var_3 )
{
...
spawner_dropoff( var_0, var_1, var_2 )
{
...
spawn_smoke_bombers()
{
    ...
    if ( is_player_gamepad_enabled() )
        var_1 = _id_124DC( "mountButtonConfig" );
    else
        var_1 = _id_124DC( "mountButtonConfigKBM" );
