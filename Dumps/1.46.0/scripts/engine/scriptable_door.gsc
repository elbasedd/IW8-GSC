...
scriptable_door_postinit()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        var_2.getnextspectatecandidatefromchain = var_4;
        var_2.getnextsafecircleradius = var_2.angles;
    }
}
...
system_init()
{
    ...
    scripts\engine\scriptable::_id_1279F( "door", ::scriptable_door_scriptable_used_callback );
