...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "monitorDamage", ::_id_1286F );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "createHintObject", ::_id_1286A );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "getTargetMarker", ::_id_1286B );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "initSentrySettings", ::_id_1286D );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "allowPickupOfTurret", ::_id_12869 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sentry_gun", "handleMovingPlatform", scripts\mp\killstreaks\manual_turret_mp::unset_force_aitype_sniper );
}
...
_id_1286A( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
...
_id_1286F( var_0 )
{
    var_0 thread scripts\mp\damage::monitordamage( var_0.maxhealth, "hitequip", ::_id_1286C, ::_id_1286E, 1 );
}
...
_id_12869()
{
    ...
    if ( scripts\cp_mp\utility\killstreak_utility::spawn_overwatch_extra_atvs( self getcurrentweapon() ) )
        return 0;
