...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "nuke", _blankfunc::tryusenukefromstruct );
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "nuke_select_location", _blankfunc::tryusenukefromstruct );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitLongDurationWithPause", ::wave_ai_spawned );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitTillHostMigrationDone", ::wave_airstrikes_allowed );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "delayEndGame", ::nuke_delayendgame );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "addTeamRankXPMultiplier", ::watchvehicleingas );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "cankill", ::nuke_cankill );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayer", ::wave_cooldown_sounds );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayerWithAttacker", ::wave_default );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "stopTheClock", ::wave_time_set );
}
...
watchvehicleingas( var_0, var_1, var_2 )
{
