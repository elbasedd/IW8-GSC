...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "circle_peek", ::_id_135AD, undefined, ::_id_13595 );
    var_0 = "circle_peak";
...
_id_13595()
{
    var_0 = scripts\cp_mp\utility\killstreak_utility::createstreakinfo( "circle_peek", self );
    var_0._id_12BE7 = 1;
    return _id_135AD( var_0, 1 );
}

_id_135AD( var_0, var_1 )
{
    ...
    var_4 = get_rid_of_minigun( var_0 );
...
get_rid_of_minigun( var_0 )
{
    if ( !isdefined( level._id_1327E ) )
        return 0;
    ...
    var_1 = level._id_1327E[self.team] + level.br_circle.circleindex + 1;

    for ( var_2 = var_1; var_2 < level.get_rpg_weapon.size; var_2++ )
        scripts\mp\gametypes\br_quest_util.gsc::_id_12231( self.team );
