...
seq3_displaymodels()
{
    ...
    level.clean_up_strafe = 0;
    level.clean_up_vandalize = ( 0, 0, 0 );
    level._id_132F9 = getdvarfloat( "scr_threat_max_radius_strikes_around_player", 3000 );
    level._id_132FA = getdvarfloat( "scr_threat_min_radius_strikes_around_player", 1500 );
    level._id_132F8 = getdvarint( "scr_threat_explosion_per_strikes", 10 );
    level._id_132FB = getdvarfloat( "scr_threat_thickness_radius_strikes_around_player", 400 );
    level._id_132F6 = getdvarfloat( "scr_threat_delay_between_strikes", 0.15 );
    level._id_132F7 = getdvarint( "scr_threat_explosion_damage", 10 );
...
{
    level.cleanupfunc = [];
    level.cleanupfunc[0] = spawnstruct();
    level.cleanupfunc[0].locname = "Vodianoy";
    level.cleanupfunc[0].refname = "ship_tac";
    level.cleanupfunc[0].trial_target_requisites = ( 39696, -42616, -556 );
    level.cleanupfunc[0].trial_target_think = 4000;
    level.cleanupfunc[1] = spawnstruct();
    level.cleanupfunc[1].locname = "Gulag";
    level.cleanupfunc[1].refname = "gulag_tac";
    level.cleanupfunc[1].trial_target_requisites = ( 51072, -39208, 1351 );
    level.cleanupfunc[1].trial_target_think = 4000;
    level.cleanupfunc[2] = spawnstruct();
    level.cleanupfunc[2].locname = "Hospital";
    level.cleanupfunc[2].refname = "hospital_tac";
    level.cleanupfunc[2].trial_target_requisites = ( 9072, -10984, -280 );
    level.cleanupfunc[2].trial_target_think = 3000;
    level.cleanupfunc[3] = spawnstruct();
    level.cleanupfunc[3].locname = "Stadium";
    level.cleanupfunc[3].refname = "stadium_tac";
    level.cleanupfunc[3].trial_target_requisites = ( 28720, 2272, -816 );
    level.cleanupfunc[3].trial_target_think = 6000;
    level.cleanupfunc[4] = spawnstruct();
    level.cleanupfunc[4].locname = "TV Station";
    level.cleanupfunc[4].refname = "tvstation_tac";
    level.cleanupfunc[4].trial_target_requisites = ( 15024, 18216, 152 );
    level.cleanupfunc[4].trial_target_think = 2000;
    level.cleanupfunc[5] = spawnstruct();
    level.cleanupfunc[5].locname = "Super";
    level.cleanupfunc[5].refname = "super_tac";
    level.cleanupfunc[5].trial_target_requisites = ( -12792, 7912, -392 );
    level.cleanupfunc[5].trial_target_think = 4000;
    level.cleanupfunc[6] = spawnstruct();
    level.cleanupfunc[6].locname = "Dam";
    level.cleanupfunc[6].refname = "dam_tac";
    level.cleanupfunc[6].trial_target_requisites = ( -22080, 46160, -364 );
    level.cleanupfunc[6].trial_target_think = 6000;
    level.cleanupfunc[7] = spawnstruct();
    level.cleanupfunc[7].locname = "Bank";
    level.cleanupfunc[7].refname = "bank_tac";
    level.cleanupfunc[7].trial_target_requisites = ( 22688, -19272, 48 );
    level.cleanupfunc[7].trial_target_think = 2000;
}
...
_id_12A54()
{
    level.cleanupfunc = [];
    level.cleanupfunc[0] = spawnstruct();
    level.cleanupfunc[0].locname = "Zombie Test Ground";
    level.cleanupfunc[0].refname = "ship_tac";
    level.cleanupfunc[0].trial_target_requisites = ( -3890, -6375, 100 );
    level.cleanupfunc[0].trial_target_think = 1500;
    level.cleanupfunc[1] = spawnstruct();
    level.cleanupfunc[1].locname = "Gulag Mechanics";
    level.cleanupfunc[1].refname = "gulag_tac";
    level.cleanupfunc[1].trial_target_requisites = ( 1800, -6400, 100 );
    level.cleanupfunc[1].trial_target_think = 4000;
    level.cleanupfunc[2] = spawnstruct();
    level.cleanupfunc[2].locname = "Mountan1";
    level.cleanupfunc[2].refname = "hospital_tac";
    level.cleanupfunc[2].trial_target_requisites = ( -8245, 17400, 1000 );
    level.cleanupfunc[2].trial_target_think = 3000;
    level.cleanupfunc[3] = spawnstruct();
    level.cleanupfunc[3].locname = "Jump Ramp";
    level.cleanupfunc[3].refname = "stadium_tac";
    level.cleanupfunc[3].trial_target_requisites = ( -2300, 1640, 600 );
    level.cleanupfunc[3].trial_target_think = 2000;
    level.cleanupfunc[4] = spawnstruct();
    level.cleanupfunc[4].locname = "Loot Pile";
    level.cleanupfunc[4].refname = "tvstation_tac";
    level.cleanupfunc[4].trial_target_requisites = ( 2400, 0, 100 );
    level.cleanupfunc[4].trial_target_think = 5000;
    level.cleanupfunc[5] = spawnstruct();
    level.cleanupfunc[5].locname = "Mountan2";
    level.cleanupfunc[5].refname = "super_tac";
    level.cleanupfunc[5].trial_target_requisites = ( -18200, 9800, 800 );
    level.cleanupfunc[5].trial_target_think = 4000;
    level.cleanupfunc[6] = spawnstruct();
    level.cleanupfunc[6].locname = "End of runway";
    level.cleanupfunc[6].refname = "dam_tac";
    level.cleanupfunc[6].trial_target_requisites = ( -9300, -11150, 100 );
    level.cleanupfunc[6].trial_target_think = 6000;
    level.cleanupfunc[7] = spawnstruct();
    level.cleanupfunc[7].locname = "Bank";
    level.cleanupfunc[7].refname = "bank_tac";
    level.cleanupfunc[7].trial_target_requisites = ( -3900, -2000, 480 );
    level.cleanupfunc[7].trial_target_think = 2000;
}

attemptrunbombardmentatcirclecenter( var_0 )
{
    var_1 = 20;
    ...
    var_6 = var_5;
    return level calculateweaponmatchbonus( var_6, var_0, var_2, var_4 );
}

calculateweaponmatchbonus( var_0, var_1, var_2, var_3 )
{
    if ( getdvarint( "scr_bombardment_killswitch", 0 ) )
        return 0;

    if ( istrue( level.clean_up_strafe ) )
        return 0;

    level thread check_crate_unreachable( var_0, var_1, var_2, var_3 );
    return 1;
}

calculatewinningteam( var_0, var_1, var_2 )
{
    ...
    level.cleanup_lights = var_2;
    level thread check_for_at_set_final_wave( var_0, var_1 );
}

check_crate_unreachable( var_0, var_1, var_2, var_3 )
{
    level.clean_up_strafe = 1;

    if ( !isdefined( level._id_12590 ) )
        watchleadchange( var_0, var_3, var_1 );

    var_4 = getdvarfloat( "scr_bombardment_delay_before_start", 8 );

    if ( getdvarint( "scr_bombardment_show_zone_debug", 0 ) )
        level thread unlink_on_ai_death( var_0, var_2 + var_4, var_3 );

    wait( var_4 );
    level thread cleanupallclones( var_0, var_1, var_2, var_3 );
}

cleanupallclones( var_0, var_1, var_2, var_3 )
{
    ...
    level thread cleanupexplosionleftovers( var_0, var_4, var_3 );
    ...
    while ( gettime() < var_4 )
    {
        ...
        foreach ( var_10 in var_6 )
        {
            ...
            if ( var_10 spawndistancemin() && ( scripts\mp\utility\player::isreallyalive( var_10 ) && !scripts\mp\utility\player::spawn_module_trickle( var_10 ) ) )
            {
        ...
        if ( var_8.size != 0 )
        {
            ...
            {
                level thread _id_12FEE( var_10.origin, var_1 );
                wait 1;
            }
        ...
        level thread _id_12FEE( var_16, var_1 );
        wait 1.5;
    }
...
cleanupexplosionleftovers( var_0, var_1, var_2 )
{
    var_3 = [];
    var_4 = 0;
...
unlink_on_ai_death( var_0, var_1, var_2 )
{
    var_3 = umbra( var_0, var_2 );
    wait( var_1 );
    var_3 delete();
}
...
watchleadchange( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in level.players )
    {
        ...
        if ( istrue( level.cs_flags_init ) )
            branalytics_validation( var_5 );
    }
...
_id_12FEE( var_0, var_1 )
{
    if ( !isdefined( level._id_130EC ) )
        level._id_130EC = 0;

    level._id_130EC++;

    if ( !isdefined( var_1 ) || !isplayer( var_1 ) )
        _id_126A8( var_0, undefined );
    else if ( level._id_130EC % 3 == 0 )
        _id_126A8( var_0, var_1 );
    else
    {
        if ( level._id_130EC % 3 == 1 )
        {
            _id_126AB( var_0, var_1 );
            return;
        }
...
_id_126AA( var_0, var_1 )
{
    ...
    {
        var_1 thread rear_spotlight_tag( var_4, var_2, var_0 + var_6 );
        wait 0.1;
    }

    wait 0.1;
    var_1 thread rear_spotlight_tag( getcompleteweaponname( "ac130_105mm_mp" ), var_2, var_0 );
}

rear_spotlight_tag( var_0, var_1, var_2 )
{
    level endon( "game_ended" );
...
_id_126A7( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level._id_132F4 ) )
        var_5 = level._id_132F4;
    else
        var_5 = "vfx_br_x2_bomber_exp";

    if ( istrue( level.cleanup_lights ) )
    {
    ...
    thread applystuneffect( var_0 );

    if ( istrue( level.cleanup_lights ) )
        thread object_is_valid( var_6, 1 );
    else
        thread objective_locations_logic( var_6, 1 );
}

applystuneffect( var_0 )
{
    self endon( "death" );
    self endon( "missile_dest_failed" );
    level endon( "game_ended" );

    if ( istrue( level.br_randombombardment_canstun ) )
    {
        var_1 = scripts\mp\utility\player::getplayersinradius( var_0, level.br_randombombardment_stunrange );
        ...
        foreach ( var_3 in var_1 )
        {
            if ( !istrue( var_3 scripts\mp\gametypes\br_public.gsc::isplayeringulag() ) )
            {
                ...
                var_3 thread scripts\mp\weapons::cleanupconcussionstun( level.br_randombombardment_stuntimer );
                var_3 scripts\cp_mp\utility\shellshock_utility::_stopshellshock();
                var_3 scripts\cp_mp\utility\shellshock_utility::_shellshock( "concussion_grenade_mp", "bottom", level.br_randombombardment_stuntimer, 1 );
            }
        }
    }
}

objective_locations_logic( var_0, var_1 )
{
    level.cleanuparenamolotovs++;
    wait( var_1 );
...
check_for_at_set_final_wave( var_0, var_1 )
{
    level endon( "bombardment_finished" );
    level.clean_up_strafe = 1;
    level thread unlocked_escape_door();
    thread unlocked_armory();
    thread _id_132F3( var_0, var_1 );
}
...
unlocked_escape_door()
{
    ...
    while ( level.clean_up_strafe )
    {
        level.cleanup_corpses = undefined;

        foreach ( var_1 in level.players )
        {
            if ( isdefined( var_1 ) && scripts\mp\utility\player::isreallyalive( var_1 ) )
                level.cleanup_corpses = var_1;
        }

        if ( isdefined( level.cleanup_corpses ) )
        {
            level.cleanup_corpses waittill( "disconnect" );
            continue;
        }
...
_id_132F3( var_0, var_1 )
{
    ...
    if ( !isdefined( level.cleanuparenamolotovs ) )
        level.cleanuparenamolotovs = 0;
    ...
    var_6 = level._id_132F9;
    var_7 = level._id_132F8;
    var_8 = 0;

    if ( isdefined( level.threatvarieddelaybetweenstrikes ) )
        var_8 = level.threatvarieddelaybetweenstrikes;

    var_9 = level._id_132F6 + randomfloat( var_8 );
    var_10 = level._id_132F7;
    var_11 = 0;
    ...
    while ( gettime() < var_2 )
    {
        foreach ( var_1 in var_4 )
        {
            ...
            var_14 = _id_132EF( var_0, var_2 );
            var_15 = scripts\mp\gametypes\br_circle.gsc::getrandompointincircle( var_13, var_6, var_14.vehicle_damage_getburndowntime, var_14.updatescavengerhud, 1, 0 );
            _id_126A7( var_15, var_10, level.cleanup_corpses );
            var_11++;
            var_11 = var_11 % var_7;
...
_id_132F0( var_0, var_1, var_2, var_3 )
{
...
_id_132F1( var_0, var_1, var_2 )
{
    ...
    while ( gettime() < var_2 )
    {
        ...
        var_5 = _id_132EF( var_1, var_2 );
        level thread _id_132F0( var_0.origin, var_3, var_4 * var_5.vehicle_damage_getburndowntime, 4 );
        level thread _id_132F0( var_0.origin, var_3, var_4 * var_5.updatescavengerhud, 4 );
        wait( var_3 );
    }

    var_0.init_first_button = 0;
}

_id_132EF( var_0, var_1 )
{
    var_2 = level._id_132F9;
    var_3 = level._id_132FA;
    var_4 = level._id_132FB;
    var_5 = var_3 / var_2;
    var_6 = var_4 / var_2;
    var_7 = var_1 - gettime();
    ...
    var_10 = spawnstruct();
    var_10.vehicle_damage_getburndowntime = clamp( var_6, 0, 1 );
    var_10.updatescavengerhud = clamp( var_9, 0, 1 );
    return var_10;
}
