...
_id_138B3()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveScore", ::_id_138A6 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveAward", ::_id_138A5 );
}

_id_138A6( var_0, var_1, var_2 )
{
    if ( istrue( var_2 ) )
