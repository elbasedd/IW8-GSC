...
{
    level._id_122EA = [];
    level._id_122EA["rcxd_rad"] = spawnstruct();
    level._id_122EA["rcxd_rad"].timeout = getdvarfloat( "scr_br_rcxd_rad_timeout", 45.0 );
    level._id_122EA["rcxd_rad"].maxhealth = 75;
    level._id_122EA["rcxd_rad"].hitstokill = 3;
    level._id_122EA["rcxd_rad"].speed = 140;
    level._id_122EA["rcxd_rad"].accel = 20;
    level._id_122EA["rcxd_rad"].halfsize = 27;
    level._id_122EA["rcxd_rad"].spawndist = 30;
    level._id_122EA["rcxd_rad"].streakname = "rcxd_rad";
    level._id_122EA["rcxd_rad"].vehicleinfo = "veh_rcxd_rad_mp";
    level._id_122EA["rcxd_rad"].modelbase = "lm_veh_t9_drone_rcxd";
    level._id_122EA["rcxd_rad"].teamsplash = "used_rcxd_rad";
    level._id_122EA["rcxd_rad"].destroyedsplash = "callout_destroyed_rcxd_rad";
    level._id_122EA["rcxd_rad"].heli_leaving_monitor = 0.5;
    level._id_122EA["rcxd_rad"].sound_explode = "recon_drone_explode";
    level._id_122EA["rcxd_rad"].vodestroyed = "ball_drone_backup_destroy";
    level._id_122EA["rcxd_rad"].votimedout = "ball_drone_backup_timeout";
    level._id_122EA["rcxd_rad"].scorepopup = "destroyed_rcxd_rad";
    level._id_122EA["rcxd_rad"].playfxcallback = scripts\cp_mp\killstreaks\helper_drone::helperdronefx;
    level._id_122EA["rcxd_rad"].primarymode = "MANUAL";
    level._id_122EA["rcxd_rad"].primarymodestring = &"KILLSTREAKS_HINTS/RCD_MANUAL";
    level._id_122EA["rcxd_rad"].primarymodefunc = scripts\cp_mp\killstreaks\helper_drone::setreconmodesettings;
    level._id_122EA["rcxd_rad"].premoddamagefunc = undefined;
    level._id_122EA["rcxd_rad"].postmoddamagefunc = scripts\cp_mp\killstreaks\helper_drone::helperdrone_modifydamageresponse;
    level._id_122EA["rcxd_rad"].deployweaponname = "ks_remote_rcxd_mp";
    level._id_122EA["rcxd_rad"].update2v2progress = 1;
    level._id_122EA["rcxd_rad"].update_ai_array = 1;
    level._id_122EA["rcxd_rad"].update_health_bar_to_player = 73984;
    level._id_122EA["rcxd_rad"].update_health_bar_to_players = 73984;
    level._id_122EA["rcxd_rad"].deathfunc = ::_id_122D8;
    level._id_122EA["rcxd_rad"].is_main_pilot = 1;
    level._id_122EA["rcxd_rad"].diewithowner = 1;
    level._id_122EA["rcxd_rad"].stringcannotplace = &"KILLSTREAKS_HINT_CANNOT_CALL_IN";
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "rcxd_rad", ::_id_135B5, undefined, ::_id_13599 );
    initmines();
    var_0 = getarraykeys( level._id_122EA );

    foreach ( var_2 in var_0 )
    {
        var_3 = level._id_122EA[var_2].hitstokill;
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_138C1( "rcxd_rad", ::_id_122D8 );
...
_id_135B6( var_0 )
{
    ...
    if ( !self isonground() && !self isonladder() || _branalytics_headerplayer::spawnboardroomblueprintweapons() )
        return 0;

    if ( isdefined( level.gametyperoundendscoresetomnvar ) )
    {
        if ( ![[ level.gametyperoundendscoresetomnvar ]]( var_1 ) )
            return 0;
    }
    ...
    var_3 = level._id_122EA[var_2].deployweaponname;
    var_4 = var_1 scripts\cp_mp\killstreaks\killstreakdeploy::streakdeploy_doweapontabletdeploy( var_0, ::_id_13CA2, undefined, undefined, ::deployweapontaken, var_3, 0, ::_id_13B37 );
    var_1 scripts\common\utility::allow_usability( 0 );
    var_1 thread scripts\cp_mp\utility\killstreak_utility::tabletdofset( 0, 1, 1 );

    if ( !istrue( var_4 ) )
    {
        var_1 _id_122E0( var_0 );
    ...
    var_5 = 0.4;
    var_6 = var_1 scripts\engine\utility::_id_13AEE( var_5, "death", "weapon_switch_started" );

    if ( !isdefined( var_6 ) || var_6 != "timeout" )
    {
        var_1 _id_122D6( var_0 );
    ...
    var_8 = level._id_122EA[var_2].teamsplash;
    var_6 = _id_13042( var_0 );
...
_id_13042( var_0 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::waitforhvttrigger( var_1 );
    var_5.owner = var_1;
    var_5.team = var_1.team;
    var_5.vehiclename = var_0.streakname;
    var_6 = level._id_122EA[var_0.streakname];
    ...
    var_5 thread _id_122E9();
    var_5 thread _id_122E6();
    var_5 thread _id_122E5();
    var_5 thread _id_122E8();
    var_5 thread _id_122D9();
    var_5 thread _id_122E2( var_6 );
    var_5 thread _id_122E4();
    var_5 thread _id_122E1();
    var_5 thread _id_122DE( var_6 );
    ...
    var_5 _id_122DF( "rcxd_enemy", 0, 1 );
    var_5 _id_122DF( "rcxd_friendly_use", 1, 0 );
...
_id_122DE( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( istrue( var_10.stop_station_closed_vo ) )
            var_12 = var_10;
        ...
        var_17 = var_1.maxhealth * var_0.heli_leaving_monitor;
...
_id_122E9()
{
    ...
    var_1 = level._id_122EA[var_0.vehiclename];
...
_id_122D7( var_0 )
{
    ...
    if ( !istrue( var_2.is_in_kill_zone_or_under_bridge_zone ) )
    {
        var_2 thread _id_122D4();
        var_2.is_in_kill_zone_or_under_bridge_zone = 1;
    }
    ...
    scripts\cp_mp\utility\killstreak_utility::waitformeleedamage( var_2.owner );
    var_2 setscriptablepartstate( "flash_light", "default", 0 );
    var_2.owner scripts\cp_mp\utility\killstreak_utility::_id_12356( var_0 );
    var_2.owner unlink();
    ...
    var_2 setscriptablepartstate( "flash_light", "default", 0 );
    var_3 = level._id_122EA[var_0.streakname].deployweaponname;
...
_id_122E0( var_0 )
{
    ...
    wait 1.5;
    var_2 = level._id_122EA[var_0.streakname].deployweaponname;
...
_id_122E6()
{
    ...
    var_0 endon( "death" );
    var_0 endon( "explode" );
    var_0 childthread _id_122E7( "disconnect" );
    var_0 childthread _id_122E7( "joined_team" );
    var_0 childthread _id_122E7( "joined_spectators" );
    var_0 childthread _id_122E7( "last_stand_start" );
}
...
_id_122E5()
{
    ...
    for (;;)
    {
        ...
        var_2 = level._id_122EA[var_0.vehiclename];
...
_id_122E8()
{
    ...
    var_0 endon( "owner_gone" );
    var_1 = var_0.streakinfo;
    level scripts\engine\utility::_id_13ADB( "round_end_finished", "game_ended", "prematch_cleanup", "ending_sequence" );
    var_0 thread _id_122D7( var_1 );
}
...
_id_122D9()
{
    ...
    var_0 endon( "explode" );
    var_1 = var_0.streakinfo;
    level scripts\engine\utility::_id_13AD9( "bro_shot_start", "game_ended" );
    var_0 thread _id_122D7( var_1 );
}
...
{
    var_1 = self;
    var_1 thread _id_122D4();
    var_1.is_in_kill_zone_or_under_bridge_zone = 1;
    var_1 thread _id_122D7( var_0 );
}
...
applygasdamageovertime( var_0, var_1 )
{
    ...
    while ( var_1 istouching( self ) )
    {
        ...
        var_2 = scripts\engine\utility::_id_13AED( 1, "death" );
...
_id_122DF( var_0, var_1, var_2 )
{
    ...
    var_4 = var_3 _id_122DC( var_1, var_2, 7500 );
