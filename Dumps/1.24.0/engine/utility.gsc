...
spinafterdelay( var_0, var_1, var_2 )
{
...
spinning( var_0, var_1, var_2, var_3 )
{
...
spinpropkey( var_0, var_1, var_2, var_3, var_4 )
{
...
splashtime_drops( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
splashtime_helis( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
spot_light_nodes( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
...
spotlight_angles_offset( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
spotlight_goal_node( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
spotlight_max_dist_sq_from_node( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
spotlight_model( var_0, var_1, var_2 )
{
...
spotlight_movement_think( var_0, var_1, var_2, var_3 )
{
...
spotlight_origin_offset( var_0, var_1, var_2, var_3, var_4 )
{
...
spotlight_reach_goal_node_dist_sq( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
spotlight_speed( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( ( !isdefined( var_1 ) || var_1 != "death" ) && ( !isdefined( var_2 ) || var_2 != "death" ) && ( !isdefined( var_3 ) || var_3 != "death" ) && ( !isdefined( var_4 ) || var_4 != "death" ) && ( !isdefined( var_5 ) || var_5 != "death" ) && ( !isdefined( var_6 ) || var_6 != "death" ) )
        self endon( "death" );
...
spotlight_sweep_to_loc( var_0, var_1 )
{
    var_2 = spawnstruct();
...
spotlight_sweep_to_loc_safe( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
...
spotlight_tag( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
spotlight_target_found_dist_sq( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
spotlight_target_found_speed( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
spectatenumber( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
spectatepoint( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
spectateprop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
spectatetestonprematchfadedone( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
spectatingthisplayer( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
deletestruct_ref( var_0 )
{
    ...
    if ( isdefined( level.struct ) )
    {
        if ( level.struct.size > 5000 )
        {
            ...
            var_9 = 0;
            var_10 = var_8;
            removestructfromlevelarray( var_0, var_9, var_10 );
            ...
            removestructfromlevelarray( var_0, 0, level.struct.size );
    }
}

removestructfromlevelarray( var_0, var_1, var_2 )
{
...
array_wait_proc( var_0, var_1, var_2 )
{
    ...
    var_1 spectatecommands( var_2, "death" );
...
{
    var_3 = var_1 spin_light( var_2, "death" );
...
flag_wait_either_return( var_0, var_1 )
{
    for (;;)
    {
        ...
        var_2 = level spin_light( var_0, var_1 );
        return var_2;
    }
}
...
flag_wait_any_return( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        var_6 = level spinpropkey( var_0, var_1, var_2, var_3, var_4 );
        return var_6;
    }
}
...
headshot_distance( var_0, var_1, var_2 )
{
...
pavelow_boss_damage_func( var_0 )
{
...
hastargetmarker()
{
    ...
    if ( is_player_gamepad_enabled() )
        var_1 = pavelow_boss_damage_func( "mountButtonConfig" );
    else
        var_1 = pavelow_boss_damage_func( "mountButtonConfigKBM" );
