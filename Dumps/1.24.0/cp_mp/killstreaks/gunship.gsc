...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread gas_at_computer( var_0 );
    var_9 thread gas_attack_deploy( var_0, "disconnect" );
    var_9 thread gas_attack_deploy( var_0, "joined_team" );
    var_9 thread gas_attack_deploy( var_0, "joined_spectators" );
    var_9 thread gas_attack_deploy( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        ...
        else if ( isdefined( level.garbage_bin_clip ) )
            level.gunship.origin = level.garbage_bin_clip;
        else
    ...
    level.gunship_intromodel thread gas_attack( "disconnect", var_1 );
    level.gunship_intromodel thread gas_attack( "joined_team", var_1 );
    level.gunship_intromodel thread gas_attack( "joined_spectators", var_1 );
    waitframe();
...
gas_attack( var_0, var_1 )
{
    ...
    gametyperoundendscoresetomnvar( var_2, var_1 );
}

gametyperoundendscoresetomnvar( var_0, var_1 )
{
    var_2 = 0;
