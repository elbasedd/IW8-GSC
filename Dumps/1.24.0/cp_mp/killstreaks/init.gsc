...
init()
{
    ...
    level thread scripts\cp\killstreaks\nuke_cp::init();
    goalyaw();
...
goalyaw()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_guys_into_truck( "killstreak", 1 );
    var_0.start_bomb_vest_global_timer["missileLocking"] = 2;
}
