...
init()
{
    ...
    level.heli_structs_entrances = scripts\cp_mp\utility\game_utility::find_plunder( "ks_heli_entrance" );
    level.heli_structs_goals = scripts\cp_mp\utility\game_utility::find_plunder( "ks_heli_goal" );
    level.heli_structs_paths = scripts\cp_mp\utility\game_utility::find_plunder( "ks_heli_path" );
...
spawnchopper( var_0, var_1 )
{
    ...
    var_22.check_lbravo_hover_retreat = var_2[2] - 750;
    var_22.relic_team_proximity_monitor = 50;
    var_22.relic_third_person = 25;
    var_22.relic_vampire = undefined;
    var_22.isanyplayertouching = 7;
    var_22.isanytutorialorbotpracticematch = 12;
...
choppersupport_monitorowner()
{
    ...
    self.owner scripts\engine\utility::spectatecommands( "joined_team", "disconnect" );
    thread choppersupport_leave();
}
...
choppersupport_engageturrettarget( var_0 )
{
    ...
    for (;;)
    {
        if ( !istrue( var_0.turreton ) || istrue( var_0.set_wave_num ) )
        {
            waitframe();
            continue;
        }
...
choppersupport_clearcurrenttarget( var_0 )
{
    ...
    if ( istrue( var_0.safechecknum ) )
        var_0.safechecknum = undefined;
...
choppersupport_fireonturrettarget( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    thread calculatespawndisttodefenderflagstart( var_0 );
    ...
    if ( isdefined( self.relic_team_proximity_monitor ) )
        var_7 = self.relic_team_proximity_monitor;

    var_8 = 20;

    if ( isdefined( self.isanyplayertouching ) )
        var_8 = self.isanyplayertouching;

    var_9 = 40;

    if ( isdefined( self.isanytutorialorbotpracticematch ) )
        var_9 = self.isanytutorialorbotpracticematch;

    if ( istrue( var_4 ) )
    {
        var_10 = 3750;

        while ( istrue( calculatehelispawndata( var_0, var_1 ) ) )
        {
    ...
    thread calculateweaponmatchbonus( var_0 );
    ...
    while ( istrue( calculatehelispawndata( var_0, var_1 ) ) )
    {
        ...
        else if ( var_0 choppersupport_turretlookingattarget() )
        {
            ...
            if ( var_6 == var_8 )
            {
                ...
                if ( isdefined( self.relic_third_person ) )
                    var_7 = self.relic_third_person;
            }
            else if ( var_6 == var_9 )
            {
                var_7 = undefined;

                if ( isdefined( self.relic_vampire ) )
                    var_7 = self.relic_vampire;
            }
...
calculatehelispawndata( var_0, var_1 )
{
...
calculatespawndisttodefenderflagstart( var_0 )
{
    ...
    if ( !scripts\cp_mp\utility\game_utility::haspassedsquadleader() )
        return;
    ...
    for (;;)
    {
        if ( isdefined( var_0.attackingtarget ) )
        {
            ...
            {
                if ( !istrue( self.get_silo_thrust_spawnpoint ) )
                    self.get_silo_thrust_spawnpoint = 1;
...
choppersupport_watchtargetlos( var_0, var_1 )
{
    ...
    for (;;)
    {
        if ( !istrue( var_0.safechecknum ) && isdefined( var_0.attackingtarget ) )
        {
...
choppersupport_patrolfield( var_0 )
{
    ...
    if ( isdefined( self.little_bird_mg_onenterheavydamagestate ) )
        self [[ self.little_bird_mg_onenterheavydamagestate ]]( var_0 );
    else
    {
        if ( self.currentaction != "patrol" )
...
choppersupport_movetolocation( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::spectatecommands( "near_goal", "begin_evasive_maneuvers" );
...
choppersupport_cleanup( var_0 )
{
    ...
    if ( isdefined( self.calloutmarkerpingvo_playpredictivepingacknowledgedcancel ) )
        self [[ self.calloutmarkerpingvo_playpredictivepingacknowledgedcancel ]]();

    if ( isdefined( self.streakinfo ) )
        self.streakinfo.destorder = istrue( var_0 );
...
choppersupport_gettargets( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_7 = 0; var_7 < var_5.size; var_7++ )
    {
        ...
        if ( istrue( var_10 ) )
        {
            var_13 = spawnstruct();
            var_13.player = var_8;
            var_13.playergetplunderomnvarbitpackinginfo = var_11;
            var_13.safehouse_vo_start = var_12;
...
choppersupport_istarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !calculatehelitimetoarrive( var_1 ) )
        return [ 0, 0, 0 ];
...
choppersupport_getbesttarget( var_0, var_1 )
{
    ...
    {
        if ( !calculatehelitimetoarrive( var_7.player ) )
            continue;

        if ( choppersupport_isactivetarget( var_7.player ) && !istrue( var_7.safehouse_vo_start ) )
            continue;
        ...
        if ( istrue( var_7.playergetplunderomnvarbitpackinginfo ) )
        {
            var_8 = 1;
            var_10 = var_10 + 40;
        }

        if ( istrue( var_7.safehouse_vo_start ) )
        {
            var_9 = 1;
            var_10 = var_10 + 20;
        }
...
{
    var_3 = self.origin;
    var_4 = self.check_lbravo_hover_retreat;
    var_5 = undefined;
...
beginevasivemaneuvers()
{
    ...
    var_0 = scripts\engine\utility::spotlight_min_dist_sq_from_node( 3.0, "death" );
