...
startchoppergunnerintro( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\killstreak_utility::finalkillcamplaybackbegin();
    var_4 = ( 0, 0, 0 );
    ...
    else if ( istrue( var_0.getheliflyheight ) && level.script == "cp_so_aniyah" )
    {
        ...
        while ( level.last_attacker.size == 0 )
            waitframe();

        var_20 = scripts\engine\utility::getclosest( var_19, level.last_attacker );
    ...
    if ( istrue( var_0.getheliflyheight ) && level.script == "cp_so_aniyah" )
    ...
    var_24.getheliflyheight = istrue( var_0.getheliflyheight );
    var_24 setvehicleteam( var_24.team );
    var_24 thread calculatebrbonusxp( "disconnect", var_1 );
    var_24 thread calculatebrbonusxp( "joined_team", var_1 );
    var_24 thread calculatebrbonusxp( "joined_spectator", var_1 );
    var_27 = 2000;
    ...
    var_29 = var_24 calculateandvalidatefuelstability( 4.25 );
...
calculatebrbonusxp( var_0, var_1 )
{
    var_2 = self.owner;
    self endon( "death" );
...
choppergunner_startremotecontrol( var_0 )
{
    ...
    thread calculateclientmatchdataextrainfopayload( "disconnect" );
    thread calculateclientmatchdataextrainfopayload( "joined_team" );
    thread calculateclientmatchdataextrainfopayload( "joined_spectator" );
    thread calculateclientmatchdataextrainfopayload( "team_kill_punish" );
    thread choppergunner_watchkills();
    thread choppergunner_handledestroyed( var_0 );
    thread choppergunner_notifyonkillstreakover();

    if ( !self.getheliflyheight )
    {
...
choppergunner_updatetargetmarkergroups( var_0 )
{
    ...
    if ( istrue( level.createinvalidcirclearea ) )
        return;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::spectatekey( "leaving", "death", "explode" );
...
choppergunner_watchendstrobefx( var_0 )
{
    self endon( "death" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::spectatecommands( "death", "leaving" );
    self delete();
}
...
choppergunner_handlemissilefire( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self.getheliflyheight && self.missilesleft == 8 )
            childthread calculateandsettotalfuel();
        ...
        var_17 thread calculateaveragevelocities( self.owner, 2, 300, 300 );
...
choppergunner_watchturretfire( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.streakinfo.shots_fired++;
        var_1 thread calculateaveragevelocities( self.owner, 0.5, 256, 200 );
    }
}
...
choppergunner_returnplayer( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            level thread scripts\cp_mp\utility\killstreak_utility::pickup_truck_initomnvars( var_2 );
            var_2 setclientomnvar( "ui_apache_screens_state", 0 );
            var_2 painvisionon();
            var_2 scripts\cp_mp\utility\killstreak_utility::killstreak_restorenvgstate();
...
{
    thread scripts\cp_mp\emp_debuff::make_emp_drone_pick_up_interact( self.owner, 5 );
    choppergunner_updatetargetmarkergroups();
}
...
calculateaveragevelocities( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
