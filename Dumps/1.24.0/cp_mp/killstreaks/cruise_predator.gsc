...
runcruisepredator( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::islargemap() || scripts\common\utility::iscp() || scripts\cp_mp\utility\game_utility::isdonetsksubmap() )
        var_5 = self.origin;
...
chopper_carepackage_pilot_selected( var_0, var_1, var_2 )
{
    self endon( "death" );
    ...
    if ( isdefined( self ) )
    {
        chopper_can_see( var_0, var_1, var_2 );
        self delete();
    }
}
...
cruisepredator_followmissilepod( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !istrue( var_2 ) )
    {
        ...
        var_0 thread chopper_carepackage_pilot_selected( var_3, var_12, var_13 );
        var_0 thread chopper_carepackage_set_useable( "disconnect" );
        var_0 thread chopper_carepackage_set_useable( "joined_team" );
        var_0 thread chopper_carepackage_set_useable( "joined_spectators" );
    }
...
cruisepredator_takecontrol( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 thread chopper_carepackage( var_1 );
    ...
    var_7 thread chopper_carepackage_set_useable( "disconnect" );
    var_7 thread chopper_carepackage_set_useable( "joined_team" );
    var_7 thread chopper_carepackage_set_useable( "joined_spectators" );
...
cruisepredator_watchmissileexplosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( !istrue( var_3 ) )
        {
            ...
            var_1 scripts\cp_mp\utility\killstreak_utility::oncooldown( var_9 );
        }
    }
...
cruisepredator_returnplayer( var_0, var_1 )
{
    ...
    level thread scripts\cp_mp\utility\killstreak_utility::pickup_truck_initomnvars( self );
    var_0 notify( "killstreak_finished_with_deploy_weapon" );
}
