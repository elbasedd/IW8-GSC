...
{
    var_1 = scripts\cp_mp\utility\killstreak_utility::finalkillcamplaybackbegin();
    var_2 = ( 0, 0, 1500 );
...
debug_test_kill_kidnapper( var_0 )
{
...
empdrone_explodeemp()
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_9 = scripts\cp_mp\vehicles\vehicle_occupancy::spawn_apache_chopper( var_5 );
