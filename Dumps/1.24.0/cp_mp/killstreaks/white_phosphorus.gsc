...
wp_finishdeployment( var_0, var_1, var_2 )
{
    ...
    level endon( "game_ended" );
    thread super_enemy_spawning( "disconnect" );
    thread super_enemy_spawning( "joined_team" );
    thread super_enemy_spawning( "joined_spectator" );
    ...
    var_3 thread superdeadsilence_watchforgameended();
...
super_onspawned()
{
    ...
    if ( sunpoissonfiltering( "smoke", self ) )
...
super_has_targets( var_0 )
{
    ...
    if ( sunpoissonfiltering( "inner", self ) )
...
wp_deliverpayloads( var_0 )
{
    ...
    self.owner thread super_paratrooper_logic( var_0 );
...
wp_watchend( var_0, var_1 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::oncooldown( var_0 );
}

super_paratrooper_logic( var_0 )
{
    self endon( "disconnect" );
...
wp_firesmoke( var_0, var_1, var_2, var_3 )
{
    ...
    var_10 thread super_onspawned();
    scripts\cp_mp\hostmigration::hostmigration_waitlongdurationwithpause( 1 );
    level thread super_displayed( var_10 );
    ...
    {
        if ( scripts\cp_mp\utility\game_utility::isnightmap() || scripts\cp_mp\utility\game_utility::have_players_reached_points() )
...
wp_fireflaregroup( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_14 in var_12 )
    {
        ...
        var_16 thread super_has_targets( "burn" );
