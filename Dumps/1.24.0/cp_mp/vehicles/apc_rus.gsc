...
apc_rus_init()
{
    ...
    var_0.shipment_spawnpatchtriggers = ::ally_charge_dialogue;
...
apc_rus_initoccupancy()
{
    ...
    var_4.setallclientomnvarot = makeweapon( "tur_apc_rus_mp" );
    ...
    var_4.exittag = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_animtagtoexittag( var_4.animtag );
    var_4.lasttimedamagecalledout = "ping_vehicle_rider";
    var_3 = "front_right";
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "apc_russian", var_3, 1 );
    var_4.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_3, var_2 );
...
allplayers_setfov()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "apc_russian", 1 );
    var_0.id = 15;
    ...
    var_0.allassassin_give["driverTurret"] = 0;
    var_0.play_extract_3mins["chassis"] = 0;
    var_0.play_extract_3mins["turret"] = 1;
    var_0.play_fake_vo_for_gunship["driver"]["apc_rus_mp"] = "chassis";
    var_0.play_fake_vo_for_gunship["driver"]["tur_apc_rus_mp"] = "turret";
    var_0.play_fake_vo_for_gunship["front_left"]["apc_rus_mp"] = "chassis";
    var_0.play_fake_vo_for_gunship["front_left"]["tur_apc_rus_mp"] = "turret";
    var_0.play_fake_vo_for_gunship["front_right"]["apc_rus_mp"] = "chassis";
    var_0.play_fake_vo_for_gunship["front_right"]["tur_apc_rus_mp"] = "turret";
    var_0.play_fake_vo_for_gunship["back_right"]["apc_rus_mp"] = "chassis";
    var_0.play_fake_vo_for_gunship["back_right"]["tur_apc_rus_mp"] = "turret";
    var_0.play_fake_vo_for_gunship["back_left"]["apc_rus_mp"] = "chassis";
    var_0.play_fake_vo_for_gunship["back_left"]["tur_apc_rus_mp"] = "turret";
    var_0.play_fake_vo_for_gunship["back"]["apc_rus_mp"] = "chassis";
    var_0.play_fake_vo_for_gunship["back"]["tur_apc_rus_mp"] = "turret";
}

allplayers_clearphysicaldof()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "apc_russian", 4000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "apc_russian" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "apc_russian" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "apc_russian", 18 );
    scripts\cp_mp\vehicles\vehicle_damage::snowfx( "apc_russian", ::apc_rus_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::snowballmeleewatcher( "apc_russian", ::ally1_intro_dialogue );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "apc_russian", ::apc_rus_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "tur_apc_rus_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "apc_rus_mp", 5 );
}
...
apc_rus_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::spawn_corpse_hiders( var_2, var_3, makeweapon( "tur_apc_rus_mp" ), 1 );
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "apc_russian", var_0 );
    ...
    var_4.cpoperationcrateactivatecallback = "kill_apc_rus";
    var_4.cpoperationcratecapturecallback = 1;
    ...
    var_2 thread allplayers_setphysicaldof();
...
apc_rus_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < var_8 )
        var_0.heli_anim = allowunresolvedcollision( var_0 );
...
allowunresolvedcollision( var_0 )
{
...
apc_rus_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( var_0, "tur_apc_rus_mp" );
    ...
    if ( var_1 == "driver" )
        var_0 thread allsupportboxes( var_3 );
}
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_apc_rus_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 14;
    ally_damage_thread();
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_apc_rus_mp" );
...
allowskydivecutparachute( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_apc_rus_mp" );
