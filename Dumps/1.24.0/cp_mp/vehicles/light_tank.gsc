...
light_tank_init()
{
    ...
    var_0.shipment_spawnpatchtriggers = ::init_cardprinter;
...
light_tank_initoccupancy()
{
    ...
    var_4.setallclientomnvarot = makeweapon( "tur_bradley_mp" );
    var_4.lasttimedamagecalledout = "ping_vehicle_driver";
    var_3 = "gunner";
    var_4 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "light_tank", var_3, 1 );
    var_4.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_3, var_2 );
    ...
    var_4.setallclientomnvarot = makeweapon( "tur_gun_lighttank_mp" );
    var_4.lasttimedamagecalledout = "ping_vehicle_gunner";
}
...
init_bomb_objective()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.allassassin_give["turret"] = 0;
    var_0.allassassin_give["missile"] = 1;
    var_0.allassassin_give["smoke"] = 2;
    var_0.play_extract_3mins[0] = 0;
    var_0.play_extract_3mins[1] = 1;
    var_0.play_fake_vo_for_gunship["driver"]["lighttank_mp"] = 0;
    var_0.play_fake_vo_for_gunship["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0.play_fake_vo_for_gunship["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0.play_fake_vo_for_gunship["gunner"]["tur_bradley_mp"] = 0;
    var_0.play_fake_vo_for_gunship["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0.play_fake_vo_for_gunship["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0.play_fake_vo_for_gunship["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

init_and_start_whack_a_mole_sequence_data()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "light_tank", 15 );
    scripts\cp_mp\vehicles\vehicle_damage::snowfx( "light_tank", ::light_tank_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::snowballmeleewatcher( "light_tank", ::light_tank_postmoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    var_2.has_zone = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::spawn_corpse_hiders( var_2, var_3, makeweapon( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::spawn_corpse_hiders( var_2, var_3, makeweapon( "tur_gun_lighttank_mp" ) );
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "light_tank", var_0 );
    var_2.objweapon = makeweapon( "lighttank_mp" );
    var_2 light_tank_updateheadicon();
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::skydivestreamhintdvars( var_2, 1 );
    var_4.cqb_laser_guy = "none";
    ...
    scripts\cp_mp\vehicles\vehicle::skipequippedstreakcheck( var_2, var_0 );
    ...
    var_2 thread init_bomb_sites();
    var_2 thread init_bombs();
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.destorder = 1;

        if ( !istrue( self.oncontractend ) )
            self.owner scripts\cp_mp\utility\killstreak_utility::oncooldown( self.streakinfo );
    }

    scripts\cp_mp\vehicles\vehicle_damage::snapplayertotoppos( var_0 );
...
{
    scripts\cp_mp\vehicles\vehicle::sol_3_4_pool( self );
    ...
    scripts\cp_mp\vehicles\vehicle::sol_5_6_pool( self );
}
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn7( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn7( self.vehicle );
...
light_tank_monitorotherentjoined( var_0, var_1 )
{
    var_0 endon( "death" );
    var_2 = var_1.team;
    var_1 scripts\engine\utility::spectatecommands( "joined_team", "joined_spectators" );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::spin_light( "turret_fire", "turret_reload" );
...
init_bomb_sites()
{
    ...
    for (;;)
    {
        ...
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getseatoccupant( self, "driver" );
        var_1 thread init_chopper_boss_battle( var_2 );
...
init_chopper_boss_battle( var_0 )
{
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_bradley_mp" );
...
init_chopper_boss()
{
    ...
    for (;;)
    {
        var_0 = init_airrop_vehicle_anims();
        self notifyonplayercommand( "light_tank_missile", var_0 );
        var_1 = scripts\engine\utility::splashtime_vip( "input_type_changed", "missile_handling_ended" );
    ...
    for (;;)
    {
        ...
        if ( gettime() - var_1.lastmissilefired >= 1330.0 )
        {
            if ( var_1.missilesleft > 0 )
            {
                ...
                scripts\cp_mp\vehicles\vehicle_occupancy::spawn_ai_single( var_0 );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_bradley_mp" );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( self, "tur_gun_lighttank_mp" );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( var_0, "tur_bradley_mp" );
        var_5.owner = var_3;
        ...
        var_3 thread init_chopper_boss();
    ...
    else if ( var_1 == "gunner" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( var_0, "tur_gun_lighttank_mp" );
        var_5.owner = var_3;
        var_5 setotherent( var_3 );
        var_5 setentityowner( var_3 );
        var_5 setsentryowner( var_3 );
        ...
        init_airlock_callbuttons( var_3 );
    }
...
init_airlock_callbuttons( var_0 )
{
    if ( isdefined( var_0.gametypeoverridedomsearchparams ) )
        return;

    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::init_ammo_boxes );
}

init_bot_game_cyber( var_0 )
{
    if ( !isdefined( var_0.gametypeoverridedomsearchparams ) )
        return;

    var_0.gametypeoverridedomsearchparams = undefined;
    var_0 scripts\cp_mp\utility\damage_utility::removedamagemodifier( "ltGunnerMissileRedux", 0 );
}

init_ammo_boxes( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
init_carepackages( var_0 )
{
    self endon( "death" );
    self.owner endon( "disconnect" );
    level waittill( "game_ended" );
    self.oncontractend = 1;
    self.owner scripts\cp_mp\utility\killstreak_utility::oncooldown( var_0 );
}
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.heli_anim = canweapondealcriticaldamage( var_0 );
...
light_tank_autodestruct( var_0 )
{
    ...
    if ( !istrue( self.autodestructactivated ) )
    {
        ...
        {
            var_1 = scripts\cp_mp\vehicles\vehicle_damage::skydiveontacinsertplacement( self );
            self.health = int( min( self.health, var_1 ) );
            scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_updateomnvarsondamage( self );
            scripts\cp_mp\vehicles\vehicle_damage::so_setplayerdata();
        }
        else
        {
            var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getalloccupants( self );
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::plunder_repositorywatchuse( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::plunder_repositorywatchcountdown( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::plunder_repositorywatchuse( self.headicon, var_0 );
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn7( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread init_carepackages( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn7( var_0 );
