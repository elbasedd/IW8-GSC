...
signal_yaw()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "van", 1 );
    var_0.id = 13;
...
signal_strength()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "van", ::van_deathcallback );
}
...
van_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "van", var_0 );
...
van_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "van_mp" );
