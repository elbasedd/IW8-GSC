...
get_spotlight_goal_node()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "hoopty", 1 );
    var_0.id = 9;
...
get_specific_truck()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "hoopty", var_0 );
...
hoopty_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "hoopty_mp" );
