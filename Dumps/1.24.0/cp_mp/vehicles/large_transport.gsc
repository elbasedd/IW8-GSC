...
hostskipburndownmedium()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "large_transport", 1 );
    var_0.id = 5;
...
hostskipburndownlow()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "large_transport_mp", 3 );
}
...
large_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "large_transport", var_0 );
...
large_transport_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "large_transport_mp" );
