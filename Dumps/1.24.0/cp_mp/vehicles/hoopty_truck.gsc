...
get_starting_ai_per_site()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "hoopty_truck", 1 );
    var_0.id = 12;
...
get_start_ang()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "hoopty_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty_truck" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "hoopty_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "hoopty_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "hoopty_truck", ::hoopty_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "hoopty_truck_mp", 3 );
}
...
hoopty_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "hoopty_truck", var_0 );
...
hoopty_truck_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "hoopty_truck_mp" );
