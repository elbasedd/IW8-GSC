...
change_apc_label()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "cop_car", 1 );
    var_0.id = 6;
...
challengetrackerforjuggkills()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "cop_car", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cop_car" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "cop_car" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "cop_car", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "cop_car", ::cop_car_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "cop_car_mp", 3 );
}
...
cop_car_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "cop_car", var_0 );
...
cop_car_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "cop_car_mp" );
