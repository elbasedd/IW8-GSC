...
logendofround()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "pickup_truck", 1 );
    var_0.id = 7;
...
logcodcasterdamage()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "pickup_truck_mp", 3 );
}
...
pickup_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "pickup_truck", var_0 );
...
pickup_truck_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "pickup_truck_mp" );
