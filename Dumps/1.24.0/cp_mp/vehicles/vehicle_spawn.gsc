...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3.script_end = undefined;
        var_3.pickclassbr = undefined;
        var_3.script_gameobject = undefined;
    }
...
vehicle_spawn_init()
{
    ...
    var_0.picked_up_weapon = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0._maphint_phonescriptableused = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0.pickclassbr = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0._maphint_offerscriptableused = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
spawn_elevators( var_0, var_1, var_2 )
{
    ...
    if ( var_4.picked_up_weapon != 0 )
        var_5 = var_4.picked_up_weapon;
    else if ( isdefined( var_3.pickclassbr ) )
        var_5 = var_3.pickclassbr;
    else
        var_5 = var_4.pickclassbr;
...
spawn_ending_individual_guys()
{
    ...
    if ( !isdefined( var_0._maphint_keypadscriptableused ) )
        return;
    ...
    if ( var_1._maphint_phonescriptableused != 0 )
        var_2 = var_1._maphint_phonescriptableused;
    else if ( isdefined( var_0._maphint_offerscriptableused ) )
        var_2 = var_0._maphint_offerscriptableused;
    else
        var_2 = var_1._maphint_offerscriptableused;
...
{
    spawn_elevator_gate();
    self.custom_damageshield_cooldown = 1;
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0._maphint_keypadscriptableused ]]();
}

spawn_default_player_spawns()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::smeansofdeathshitloc();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::so_displaygameend( "heavy", var_0 );
    }
}
