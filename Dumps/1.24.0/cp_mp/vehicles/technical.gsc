...
sat_wait_for_power_think()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "technical", 1 );
    var_0.id = 0;
...
sat_wait_for_power()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "technical", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "technical" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "technical" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "technical", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "technical", ::technical_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "technical_mp", 3 );
}
...
technical_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "technical", var_0 );
    var_2.objweapon = makeweapon( "technical_mp" );
    scripts\cp\stealth\manager::skip_overheat( var_2 );
...
technical_enterstart( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.init_escape_maze ) )
        var_3.init_escape_maze hide();
}
