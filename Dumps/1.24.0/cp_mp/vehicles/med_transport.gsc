...
invuln_to_veh_crush()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::spawn_heli_assault3_hangar_end( "medium_transport", 1 );
    var_0.id = 11;
...
investigate_someone_using_bomb()
{
    scripts\cp_mp\vehicles\vehicle_damage::sniper_init( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::skipfriendlyfire( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::so_endgame( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::snowballfight( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::so_getstarinfo( "med_transport_mp", 3 );
}
...
med_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::skipequipmentdropondeath( var_2, "medium_transport", var_0 );
...
med_transport_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "med_transport_mp" );
