...
clearlockedon( var_0 )
{
    ...
    {
        if ( isdefined( var_0.getchallengegamemode ) )
            var_0 thread [[ var_0.getchallengegamemode ]]();
    }

    var_0.hasincoming = undefined;
    var_0.getcashnags = undefined;
    var_0.getchallengegamemode = undefined;
}
...
activeadvanceduavcount( var_0 )
{
    ...
    {
        if ( isdefined( var_0.getcashnags ) )
            var_0 thread [[ var_0.getcashnags ]]();
    }

    var_0.hasincoming++;
}

patched_collision( var_0 )
{
    if ( !isdefined( var_0.hasincoming ) )
        return;
...
plunder_seventyfivepercent_music( var_0, var_1 )
{
    var_0.getcashnags = var_1;
}

plunder_tenpercent_music( var_0, var_1 )
{
...
watchtargetlockedontobyprojectile( var_0, var_1 )
{
    ...
    addlockedon( var_0 );
    activeadvanceduavcount( var_0 );
    var_1 scripts\engine\utility::spectatecommands( "death", "clearTargetLockedOntoByProjectile" );
