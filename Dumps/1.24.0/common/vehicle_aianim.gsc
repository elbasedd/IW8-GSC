...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::spinafterdelay( "long_death", "death", "enteredvehicle" );
...
{
    scripts\engine\utility::spectatecommands( "unload", "death" );
...
guy_unload_que( var_0 )
{
    ...
    var_0 scripts\engine\utility::spectatecommands( "death", "jumpedout" );
    ...
    if ( !self.unloadque.size )
    {
        ...
        self.cypher_current_string = undefined;
    }
}
...
movement_vector()
{
    if ( isdefined( self.cypher_current_string ) )
        return;

    self.cypher_current_string = [];
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.cypher_current_string[var_2] = spawnstruct();
            self.cypher_current_string[var_2].open = 0;
            self.cypher_current_string[var_2].level_ammo_crate_spawn = 0;
        }
    }
}
...
wait_for_open_door( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.vehicle_getoutanim ) )
    {
        ...
        if ( !self.cypher_current_string[var_2].open )
        {
            ...
            self.cypher_current_string[var_2].open = 1;
        }
