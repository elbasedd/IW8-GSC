...
agentclasscallback( var_0 )
{
    if ( !isdefined( self._blackboard.aggressive_melee_active ) )
    {
        self._blackboard.aggressive_melee_active = 1;
        self._blackboard.agentthink = var_0;
        return 1;
    }
...
{
    if ( isdefined( self._blackboard.aggressive_melee_active ) && self._blackboard.aggressive_melee_active == 1 )
        self._blackboard.aggressive_melee_active = 2;
}
...
after_spawn_func()
{
    if ( isdefined( self._blackboard.aggressive_melee_active ) )
    {
        if ( self._blackboard.aggressive_melee_active == 1 )
        {
            self._blackboard.aggressive_melee_active = undefined;
            self._blackboard.agentthink = undefined;
            return 1;
        }
        else if ( self._blackboard.aggressive_melee_active == 2 )
        {
            self._blackboard.aggressive_melee_active = 3;
            return 1;
        }
    }
...
{
    if ( isdefined( self._blackboard.aggressive_melee_active ) && self._blackboard.aggressive_melee_active == 3 )
    {
        self._blackboard.aggressive_melee_active = undefined;
        self._blackboard.agentthink = undefined;
    }
...
adjustmatchtimerpausedstatefromscore( var_0, var_1 )
{
    ...
    var_2 = var_0 agentclasscallback( var_1 );
