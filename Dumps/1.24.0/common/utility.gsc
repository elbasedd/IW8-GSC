...
projdistsq( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.has_headicon ) )
        return 1;
...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && projdistsq( self.damageweapon ) )
            return 1;
...
allow_init()
{
    ...
    allow_add( "offhand_throwback", ::airdrop_specialcasecanusecrate );
    ...
    allow_add( "cp_munitions", ::aigroundturretref );
    allow_add( "nvg", ::airdrop_playdeploydialog );
    allow_add( "ascender_use", ::allow_ascender_use );
}
...
airdrop_specialcasecanusecrate( var_0, var_1 )
{
...
airdrop_playdeploydialog( var_0, var_1, var_2 )
{
    var_3 = 2;
...
allow_ascender_use( var_0, var_1 )
{
...
set_showing_bomb_wire_pair_to_player( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
