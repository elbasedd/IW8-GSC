...
waitforentervehicle()
{
    var_0 = scripts\engine\utility::spinning( "entervehicle", "death", "long_death", "failedentervehicle" );
...
exitingvehicle()
{
    ...
    self._blackboard.currentvehicle.brevent1playervalid = 0;
    self._blackboard.currentvehicle thread desired_landing_spot();
}
