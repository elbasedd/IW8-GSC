...
init()
{
    scripts\engine\scriptable::player_xp( "military_ammo_restock", ::allassassin_initteamlist );
...
allassassin_initteamlist( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        if ( bintheplane( var_3 ) )
        {
            if ( scripts\mp\flags::gameflag( "prematch_done" ) && ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" ) )
                ...
                thread allassassin_init( var_0, var_3, 5 );
        }
        else
            thread allassassin_init( var_0, var_3, 0.1 );
    }
...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons.gsc::blockade_get_bomb_icon_on_cell_phone( var_9, 2 );
            continue;
        }
...
bintheplane( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::hasspecialistbonus( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons.gsc::blockade_get_bomb_icon_on_cell_phone( var_8, 2 );
            var_1 = 1;
        }
    }
