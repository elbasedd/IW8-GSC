...
playerbloodrestricted( var_0, var_1, var_2 )
{
...
playerattractiontriggerexit( var_0 )
{
...
playerbrsquadleaderscore( var_0 )
{
    ...
    var_1 = self.card_origin;
    var_2 = var_0.card_origin;
...
cyberteamspawnsetids( var_0, var_1 )
{
    var_2 = !var_0;
