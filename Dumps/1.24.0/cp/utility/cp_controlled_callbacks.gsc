...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "nuke", scripts\cp\killstreaks\nuke_cp::tryusenukefromstruct );
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "nuke_select_location", scripts\cp\killstreaks\nuke_cp::tryusenukefromstruct );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitLongDurationWithPause", ::kickplayer );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitTillHostMigrationDone", ::kickplayersatcircleedge );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "delayEndGame", ::nuke_delayendgame );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "addTeamRankXPMultiplier", ::keypadscriptableused_altbunker );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "cankill", ::nuke_cankill );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayer", ::kidnapperdebug );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayerWithAttacker", ::kill_all_enemies );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "stopTheClock", ::kill_rate_watcher );
}
...
nuke_delayendgame( var_0, var_1 )
{
    ...
    if ( istrue( level.is_ai_in_stealth ) )
