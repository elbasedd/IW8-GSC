...
missilelauncherusage()
{
    ...
    if ( self.missilelauncherstage == 1 )
    {
        ...
        if ( !var_1 && ( self.missilelaunchertarget scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::sort_wave_spawning_ai( self.missilelaunchertarget, self ) ) )
        {
            resetmissilelauncherlocking();
            return;
        }
