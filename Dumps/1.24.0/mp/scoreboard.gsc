...
setplayerscoreboardinfo()
{
    ...
    if ( var_0 < 200 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_12 = scripts\mp\gametypes\br.gsc::br_lerp_minimap_zoom( self );
            ...
            {
                var_15 = scripts\mp\gamescore::flytime();
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_dmz.gsc::linkedtotag();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;

                if ( isdefined( self.init_rpg_spawns ) )
                    var_18 = self.init_rpg_spawns;

                setclientmatchdata( "players", self.clientmatchdataid, "extrascore5", var_18 );
            }
            else if ( scripts\mp\utility\game::getgametype() == "kingslayer" )
            {
                var_15 = scripts\mp\gamescore::flytime();
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_kingslayer.gsc::linkedtotag();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;
            ...
            else if ( isdefined( self.sat_piece ) )
                setclientmatchdata( "players", self.clientmatchdataid, "placement", self.sat_piece );
        }
...
buildscoreboardtype( var_0 )
{
    ...
    if ( var_0 == "multiteam" )
    {
        ...
        foreach ( var_3 in level.teamnamelist )
        {
            ...
            {
                scripts\mp\gamelogic::aq_ontimerupdate( var_6 );
