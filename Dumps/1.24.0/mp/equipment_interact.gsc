...
{
    level.useobjs = [];
    scripts\engine\scriptable::player_xp( "hack_usable", ::deletecrateimmediate );
    thread _updateuseobjs();
}

deletecrateimmediate( var_0, var_1, var_2, var_3, var_4 )
{
    deletehistoryhud( var_0.entity, var_3 );
}
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::_debug_rooftop_heli_start, undefined, undefined, ::_ontabletputaway );
...
_debug_rooftop_heli_start( var_0, var_1 )
{
    _toggletabletallows( 1 );
    thread _blankfunc();
    thread _attachmentblocks( var_0 );
    return 1;
}

_attachmentblocks( var_0 )
{
    level endon( "game_ended" );
    self endon( "death_or_disconnect" );
...
_blankfunc()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    scripts\engine\utility::spectatecommands( "death", "tabletPutAway" );
