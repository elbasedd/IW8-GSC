...
door_think()
{
    ...
    for (;;)
    {
        ...
        var_0 scripts\engine\utility::spectatecommands( "door_state_done", "door_state_interrupted" );
...
disownalarmmonitor()
{
    ...
    for (;;)
    {
        self.dooralarmowner scripts\engine\utility::spectatekey( "joined_team", "joined_spectators", "disconnect" );
...
{
    scripts\engine\utility::spectatecommands( "remove_rig", "death_or_disconnect" );
}
