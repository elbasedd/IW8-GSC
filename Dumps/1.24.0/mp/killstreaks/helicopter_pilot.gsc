...
createhelipilot( var_0 )
{
    ...
    var_7.owner scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, level.helipilotsettings[var_7.helipilottype].streakname, var_7.targetpos );
    return var_7;
}
...
helipilot_watchownerloss()
{
    ...
    self endon( "death" );
    self endon( "leaving" );
    self.owner scripts\engine\utility::spectatekey( "disconnect", "joined_team", "joined_spectators" );
    thread helipilot_leave();
}
...
helipilot_watchroundend()
{
    ...
    self.owner endon( "joined_team" );
    self.owner endon( "joined_spectators" );
    level scripts\engine\utility::spectatecommands( "round_end_finished", "game_ended" );
    thread helipilot_leave();
}
