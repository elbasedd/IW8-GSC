...
starttankdropoff( var_0 )
{
    ...
    scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, "pac_sentry", self.origin );
...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11 thread run_to_retreat_spot();
    var_11 thread run_track_enemy_patrollers();
...
run_track_enemy_patrollers()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::site_spawn_think( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.destorder = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::pickup_truck_initomnvars( var_0 );
    }
}
