...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::aggressively_chase_down_target );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo.revive_icon_color_keep;
...
aggressively_chase_down_target( var_0 )
{
    ...
    var_2.revive_icon_color_keep = self.matchdatalifeindex;
    var_2.owner = self;
    var_2.linkedsaw = self getxuid();
    var_2.accuracy_bonus_factor = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.accuracy_bonus_factor, self.origin );
