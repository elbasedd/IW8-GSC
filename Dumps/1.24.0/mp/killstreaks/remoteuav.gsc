...
tryuseremoteuav( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, var_1, self.origin );
...
createcarryremoteuav( var_0, var_1 )
{
    ...
    {
        var_4 = scripts\cp_mp\utility\killstreak_utility::finalkillcamplaybackbegin();
...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        var_1 = init_player_characters( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement", "death_or_disconnect" );
...
init_player_characters( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
carryremoteuav_handleexistence()
{
    ...
    self.owner scripts\engine\utility::spectatekey( "death_or_disconnect", "joined_team", "joined_spectators" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::spin_light( "death_or_disconnect", "remoteuav_unlock" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::spinafterdelay( "death_or_disconnect", "carried", "leaving" );
...
remoteuav_watch_distance()
{
    ...
    {
        var_0 = scripts\cp_mp\utility\killstreak_utility::finalkillcamplaybackbegin();
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::spectatecommands( "joined_team", "joined_spectators" );
    self notify( "death" );
}
