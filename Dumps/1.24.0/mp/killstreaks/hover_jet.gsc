...
_ispointinbadarea( var_0 )
{
    ...
    scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, "hover_jet", self.origin );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread get_tag_to_target();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::calculatehelitimetoarrive( var_5.player ) )
            continue;
        ...
        if ( istrue( var_5.safehouse_vo_start ) )
        {
            var_7 = 1;
            var_8 = var_8 + 40;
        }
