...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "gunship", "getBombingPoint", ::gametypeweaponxpmodifier );
...
gametypeweaponxpmodifier( var_0, var_1 )
{
    var_2 = scripts\cp_mp\killstreaks\toma_strike::search_speed( var_0, var_1 );
    return var_2.point;
}
