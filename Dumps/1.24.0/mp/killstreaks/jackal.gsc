...
beginjackal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_7 = scripts\cp_mp\utility\killstreak_utility::finalkillcamplaybackbegin();
...
defendlocation( var_0, var_1 )
{
    ...
    else if ( isdefined( var_1 ) && isdefined( var_0.dropcrates ) )
    {
        ...
        var_0 scripts\engine\utility::spotlight_min_dist_sq_from_node( 10, "all_crates_gone" );
...
followplayer()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::spectatecommands( "goal", "begin_evasive_maneuvers" );
        self clearlookatent();
...
watchpatroltarget()
{
    ...
    self endon( "jackal_crashing" );
    self.owner endon( "disconnect" );
    var_0 = self.patroltarget scripts\engine\utility::spotlight_min_dist_sq_from_node( 5, "death_or_disconnect" );
    self.patroltarget = undefined;
}
...
watchforlosttarget( var_0, var_1, var_2, var_3 )
{
    ...
    var_5 = var_1 scripts\engine\utility::spotlight_min_dist_sq_from_node( var_3, "death_or_disconnect" );
...
{
    scripts\engine\utility::spectatecommands( "captured", "death" );
...
watchjackalcratepickup()
{
    ...
    for (;;)
    {
        scripts\engine\utility::spectatekey( "crate_captured_0", "crate_captured_1", "crate_captured_2" );
        var_0++;
