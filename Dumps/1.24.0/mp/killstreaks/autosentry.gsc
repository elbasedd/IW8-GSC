...
tryuseautosentry( var_0, var_1 )
{
    ...
    if ( var_2 )
        scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, level.sentrysettings["sentry_minigun"].streakname, self.origin );
...
tryusesam( var_0, var_1 )
{
    ...
    if ( var_2 )
        scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, level.sentrysettings["sam_turret"].streakname, self.origin );
...
tryuseshocksentry( var_0 )
{
    ...
    if ( var_1 )
        scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, var_0.streakname, self.origin );
    else
        waitframe();
...
setcarryingsentry( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        var_4 = scripts\engine\utility::spinning( "place_sentry", "cancel_sentry", "force_cancel_placement", "emp_applied" );
...
{
    self endon( "death" );
    level scripts\engine\utility::spectatecommands( "bro_shot_start", "game_ended" );
    self notify( "death" );
}
...
sentry_oncarrierdeathoremp( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::spectatecommands( "death", "emp_applied" );
...
sentry_oncarrierchangedteam( var_0 )
{
    self endon( "placed" );
    self endon( "death" );
    var_0 scripts\engine\utility::spectatecommands( "joined_team", "joined_spectators" );
    self delete();
}
...
sentryshocktargets()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::spotlight_min_dist_sq_from_node( 1, "turret_on_target" );
...
marktargetlaser( var_0 )
{
    ...
    self laseron();
    self.laser_on = 1;
    scripts\engine\utility::spectatecommands( "done_firing", "carried" );
    self laseroff();
    self.laser_on = 0;
}
