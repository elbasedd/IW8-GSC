...
rundronehive( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, var_2, var_10.origin );
    var_11 = 0;
    ...
    for (;;)
    {
        var_13 = var_10 scripts\engine\utility::spin_light( "death", "missileTargetSet" );
...
applygasdamageovertime( var_0, var_1, var_2 )
{
    ...
    while ( var_2 istouching( self ) )
    {
        ...
        var_3 = scripts\engine\utility::spotlight_min_dist_sq_from_node( 0.5, "death" );
