...
starthelicopter( var_0, var_1 )
{
    ...
    scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.insidecuavbunker, var_3, self.origin );
...
heli_existance()
{
    ...
    scripts\engine\utility::spectatekey( "death", "crashing", "leaving" );
...
fireontarget( var_0 )
{
    ...
    scripts\engine\utility::spotlight_min_dist_sq_from_node( 4, "facing" );
    ...
    scripts\engine\utility::spotlight_min_dist_sq_from_node( 3, "near_goal" );
}
...
heli_leave( var_0 )
{
    ...
    if ( isdefined( self.helitype ) && self.helitype == "osprey" && isdefined( self.pathgoal ) )
    {
        ...
        scripts\engine\utility::spotlight_min_dist_sq_from_node( 5, "goal" );
    }
    ...
    scripts\engine\utility::spotlight_min_dist_sq_from_node( 12, "goal" );
    self notify( "gone" );
    self notify( "death" );
    waitframe();
