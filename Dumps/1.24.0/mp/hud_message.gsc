...
handlesplashqueue()
{
    ...
    while ( isdefined( self.splashqueuehead ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\utility\game::fly_over_path() == "dmz" || scripts\mp\utility\game::fly_over_path() == "risk" ) )
            scripts\engine\utility::spectatecommands( "splash_list_cleared", "can_show_splashes" );
        else
            scripts\engine\utility::spectatecommands( "splash_list_cleared", "spawned_player" );
