...
callbacksoldieragentdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( var_32 )
    {
        if ( istrue( self.gun_buildoverrideattachmentlist ) )
        {
            var_2 = 0;
    ...
    if ( var_22 )
    {
        ...
        {
            if ( var_24 )
                var_2 = add_pack_playeranim( var_2, var_5, var_17, var_4, var_1 );
        }
...
callbacksoldieragentgametypekilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( self.clear_player_class_and_super ) )
    {
        var_9 = spawnstruct();
        ...
        thread [[ self.clear_player_class_and_super ]]( var_9 );
    }
...
add_pack_playeranim( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_0;
...
process_damage_feedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 != var_10 && var_2 > 0 && ( !isdefined( var_8 ) || var_8 != "shield" ) )
    {
        ...
        if ( isdefined( var_10.domlocale_onrespawn ) && var_10.domlocale_onrespawn.size > 1 )
...
shouldblockdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_0 ) && ( issubstr( var_13, "thermite" ) || isdefined( var_12.magazine ) && issubstr( var_12.magazine, "boltfire" ) || isdefined( var_0.weapon_name ) && issubstr( var_0.weapon_name, "incendiary" ) ) )
    {
        ...
        if ( var_15 )
        {
            ...
            {
                self.attach_turret = 1;
                self.scn_infil_tango_npc_3_sfx = 0;
            }
        }
        else if ( var_8 != "none" )
        {
            self.attach_turret = undefined;
            self.scn_infil_tango_npc_3_sfx = undefined;
        }
    }
    ...
    else if ( var_8 == "none" && isdefined( var_0 ) )
    {
        ...
        if ( istrue( self.attach_turret ) && var_14 && isdefined( var_23 ) && var_23 == self )
        {
            if ( !isdefined( self.scn_infil_tango_npc_5_sfx ) )
                self.scn_infil_tango_npc_5_sfx = [ var_0 ];
            else if ( !scripts\engine\utility::array_contains( self.scn_infil_tango_npc_5_sfx, var_0 ) )
                self.scn_infil_tango_npc_5_sfx[self.scn_infil_tango_npc_5_sfx.size] = var_0;

            self.scn_infil_tango_npc_3_sfx++;
            return 1;
        }
