        ...
        if ( !self.perkpackagedata.isusing && scripts\mp\supers::issuperready() )
        {
            if ( self.perkpackagedata.istwomode )
            {
                ...
                if ( 1 )
                {
                    ...
                    if ( isdefined( level.loadout_given ) )
                        [[ level.loadout_given ]]();
                }
            }
...
perkpackage_getsecondfieldupgrade()
{
    ...
    if ( isdefined( self.lighting_gate ) )
        var_0 = self.lighting_gate;
...
perkpackagemenu_menuthink()
{
    ...
    wait 0.3;
    var_0 = scripts\engine\utility::spinning( "perkPackageMenu_option1", "perkPackageMenu_option2", "perkPackageMenu_close", "death" );
    var_1 = 0;
...
loadout_giveweaponobj( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        var_0 = "none";
    ...
    self.lighting = var_0;
    self.lighting_gate = var_1;
    perkpackage_updateifchanged();
}

loadout_updateammo()
{
    self.lighting = undefined;
    self.lighting_gate = undefined;
}
