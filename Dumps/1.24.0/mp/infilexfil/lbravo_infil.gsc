...
lbravo_spawn( var_0, var_1, var_2, var_3 )
{
    ...
    mortar_wave( var_4, var_0, var_2, var_3 );
...
mp_emporium_hanging_crates( var_0, var_1, var_2 )
{
...
mortar_wave( var_0, var_1, var_2, var_3 )
{
...
playerthinkanim( var_0, var_1 )
{
    ...
    {
        if ( self.team == "allies" && ( var_0.level_spawnplayer == "alpha1" || var_0.level_spawnplayer == "alpha2" ) )
            var_2 = "bravo";

        if ( self.team == "axis" && var_0.level_spawnplayer == "bravo" )
            var_2 = "alpha";
    }
...
infilthink( var_0, var_1 )
{
    ...
    level.getgametypekillspermatchmaximum--;
    self delete();
}
...
{
    if ( self.level_spawnplayer != self.subtype && getdvar( "mapname" ) == "mp_downtown_gw" )
        var_2 = self.level_spawnplayer;

    if ( var_0 == "allies" && ( self.level_spawnplayer == "alpha" || self.level_spawnplayer == "alpha2" ) && getdvar( "mapname" ) == "mp_boneyard_gw" )
        var_2 = self.level_spawnplayer;
...
initanims( var_0, var_1, var_2 )
{
    ...
    scripts\common\anim::addnotetrack_customfunction( "slot_0", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_1", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_2", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_3", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_4", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_5", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_0", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_1", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_2", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_3", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_4", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_5", "fov_63_2", scripts\mp\utility\infilexfil::maphint_phonescriptableused, "lbravo_infil_bravo" );
...
giveinteractiveinfilweapon()
{
    var_0 = makeweapon( "iw8_sn_alpha50_mp", [ "rec_alpha50", "front_alpha50", "back_alpha50", "mag_alpha50", "acog_alpha50_light", "mod_infil_alpha50" ] );
