...
infil_init()
{
    ...
    if ( game["roundsPlayed"] > 0 || getdvarint( "scr_skip_infils", 0 ) == 1 || getdvarint( "scr_game_infilSkip", 0 ) == 1 || scripts\mp\utility\game::getgametype() == "br" || getdvarint( "scr_game_matchstarttime" ) < 15 || scripts\mp\utility\game::getgametype() == "war" && scripts\cp_mp\utility\game_utility::has_focus_fire_objective() )
    {
        game["infil"] = undefined;
    ...
    var_0 = undefined;
    level.getgametypekillspermatchmaximum = 0;
    ...
    if ( scripts\mp\utility\game::gamehasinfil() && isdefined( var_0 ) )
    {
        ...
        level thread spawnjuggernautcrateatposition();
...
player_join_infil()
{
    ...
    thread can_support_mindia8_min_spawn();
    player_ai_fill();
}
...
infil_player_rig( var_0, var_1, var_2 )
{
    ...
    scripts\engine\utility::spectatecommands( "remove_rig", "player_free_spot" );
...
heli_wait_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.radius ) )
    {
        ...
        scripts\engine\utility::spectatecommands( "near_goal", "goal" );
    }
    else
        self waittill( "goal" );
...
spawnjuggernautcrateatposition()
{
    scripts\mp\flags::gameflagwait( "prematch_done" );

    while ( level.getgametypekillspermatchmaximum != 0 )
        waitframe();
