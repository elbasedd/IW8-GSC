...
init()
{
    ...
    scripts\mp\utility\spawn_event_aggregator::registeronplayerspawncallback( ::risk_currentflagsactive );
...
loadsupertable()
{
    ...
    for (;;)
    {
        ...
        var_2.ondroprelics = readsupertablecell( var_0, 6, 1 );
        ...
        var_2.bot_is_protecting_hq_zone = readsupertablecell( var_0, 19, 1 );
...
registersupers()
{
    ...
    registersuper( "super_select", ::risk_flagspawnminactivetospawn, ::risk_flagspawnmincount, ::superselectbeginuse, undefined );
    registersuper( "super_fulton", undefined, undefined, ::risk_flagspawncount, undefined );
    registersuper( "super_supply_drop", undefined, undefined, ::risk_flagspawnradiuschange, undefined );
    onteamproximitysteppedfar( "super_emp_drone", "emp_drone_player_mp" );
    onteamproximitysteppedfar( "super_emp_drone", "emp_drone_non_player_mp" );
    onteamproximitysteppedfar( "super_emp_drone", "emp_drone_non_player_direct_mp" );
    onteamproximitysteppedfar( "super_weapon_drop", "deploy_weapondrop_mp" );
}
...
onteamproximitysteppedfar( var_0, var_1 )
{
    if ( !isstring( var_1 ) )
        var_1 = var_1.basename;

    var_2 = level.superglobals.staticsuperdata[var_0];
    var_2.disable_collect_leads[var_2.disable_collect_leads.size] = var_1;
    level.superglobals.risk_flagspawnmaxradius[var_1] = var_2;
}

risk_currentflagsactive()
{
    should_update_track_timer();
    updatesuperuistate();
}
...
givesuper( var_0, var_1, var_2 )
{
    ...
    var_4.lights_setup_plane = undefined;
    pointblank_airstrike( 0 );
    risk_flagspawncountchange( var_0 );
...
clearsuper( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.staticdata ) )
        risk_flagspawndebugobjicons( var_1.staticdata.ref );
...
should_update_track_timer()
{
    ...
    {
        var_0.lastmovingplatform = undefined;
        return;
    }
    ...
    if ( !isdefined( var_0.lastmovingplatform ) || var_1 != var_0.lastmovingplatform )
        self setclientomnvar( "ui_super_progress", var_1 );

    self setplayersupermeterprogress( var_1 );
    var_0.lastmovingplatform = var_1;
}
...
superusefinished( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        else if ( var_4.staticdata.bot_is_protecting_hq_zone )
        {
            clearsuper();
            self setclientomnvar( "ui_perk_package_state", 0 );
            self setclientomnvar( "ui_super_progress", 0 );
...
handledeath()
{
    ...
    var_0 = getcurrentsuper();
    var_1 = var_0.staticdata.ondroprelics;
...
getsuperpointsneeded()
{
    ...
    if ( isdefined( var_0.lights_setup_plane ) )
        var_1 = var_0.lights_setup_plane;
...
fly_over_start( var_0 )
{
    if ( !isstring( var_0 ) )
        var_0 = var_0.basename;

    if ( !isdefined( level.superglobals.risk_flagspawnmaxradius[var_0] ) )
        return undefined;

    return level.superglobals.risk_flagspawnmaxradius[var_0].ref;
}
...
updateactivesupers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_11 )
    {
        ...
        if ( var_8 && var_0 scripts\mp\utility\perk::_hasperk( "specialty_bulletdamage" ) )
            var_1 thread scripts\mp\supers\super_stoppingpower::restartwrapper( var_5 );
    }
}
...
cargo_truck_mg_initoccupancy( var_0, var_1 )
{
    if ( !scripts\mp\utility\stats::canrecordcombatrecordstats() )
        return;
...
risk_flagspawnminactivetospawn()
{
    ...
    risk_flagspawncountchange( var_1 );
    ...
    self.super.lights_setup_plane = var_5;
}

risk_flagspawnmincount()
{
    var_0 = self.super.firstupgrade;
    risk_flagspawndebugobjicons( var_0 );
    var_1 = self.super.secondupgrade;
    risk_flagspawndebugobjicons( var_1 );
}
