...
bot_choose_difficulty_for_default()
{
    ...
    if ( !isdefined( level.binoculars_onstatemarkedupdate ) )
        level.binoculars_onstatemarkedupdate = [];

    if ( !isdefined( level.binoculars_onstatemarkedupdate["allies"] ) )
        level.binoculars_onstatemarkedupdate["allies"] = 0;

    if ( !isdefined( level.binoculars_onstatemarkedupdate["axis"] ) )
        level.binoculars_onstatemarkedupdate["axis"] = 0;

    if ( !isdefined( level.binoculars_onstatemarkedupdate["all"] ) )
        level.binoculars_onstatemarkedupdate["all"] = 0;
    ...
    if ( !isdefined( self.pers["bot_chosen_difficulty"] ) )
    {
        ...
        var_0 = level.binoculars_onstatemarkedupdate[var_1];
        var_2 = level.bot_difficulty_defaults[var_0];
        self.pers["bot_chosen_difficulty"] = enemy_clear_scrambler( var_2 );
        level.binoculars_onstatemarkedupdate[var_1] = ( level.binoculars_onstatemarkedupdate[var_1] + 1 ) % level.bot_difficulty_defaults.size;
    }

    return self.pers["bot_chosen_difficulty"];
}

enemy_clear_scrambler( var_0 )
{
    if ( var_0 == "easy" )
        return "recruit";
...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::spotlight_origin_offset( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
bot_allowed_to_use_killstreaks()
{
    ...
    if ( istrue( self.binoculars_settargetmarkerstate ) )
        return 0;
...
binoculars_istargetinrange( var_0, var_1 )
{
    switch ( var_0 )
    {
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::spotlight_min_dist_sq_from_node( 0.5, "still_watching_nodes" );
...
{
    if ( !isdefined( var_1 ) )
        var_1 = level.create_laser_point_to_point;
...
binoculars_ontake( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.create_laser_point_to_point;
