...
bot_siege_manager_think()
{
    ...
    level.propspectating = [];
    level.propspectatekeys = [];
    ...
    for (;;)
    {
        ...
        foreach ( var_6, var_9 in var_3 )
        {
            if ( var_9 >= 2 )
            {
                ...
                if ( var_9 == 2 && !istrue( level.propspectating[var_6] ) )
                {
                    if ( randomint( 100 ) > 75 )
                        level.siege_bot_team_need_flags[var_6] = 1;
                    else
                        level.propspectating[var_6] = 0;

                    level.propspectatekeys[var_6] = 1;
                }

                continue;
            }

            if ( var_9 < 2 && istrue( level.propspectatekeys[var_6] ) )
            {
                level.propspectatekeys[var_6] = 0;
                level.propspectating[var_6] = 0;
            }
        }
