...
bot_get_ambush_trap_item( var_0, var_1, var_2 )
{
    ...
    foreach ( var_10 in var_3 )
    {
        ...
        {
            if ( scripts\mp\bots\bots_util::binoculars_istargetinrange( var_10, var_7 ) )
            {
    ...
    if ( isdefined( var_4 ) )
    {
        ...
        if ( var_18 )
        {
            ...
            if ( var_19 == "goal" )
            {
                ...
                {
                    thread scripts\mp\bots\bots_util::beardone( 4.0 );
                    var_20 = ( 0, 0, 0 );
                    ...
                    if ( isdefined( var_0["item_action"] ) )
                        binoculars_setcurrentstate( var_0["item_action"] );
                    ...
                    scripts\engine\utility::spotlight_model( var_21, "missile_fire", "grenade_fire" );
                    wait 0.05;
...
binoculars_setcurrentstate( var_0 )
{
...
bot_defend_think( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        var_22 = scripts\engine\utility::spotlight_reach_goal_node_dist_sq( var_29, "node_relinquished", "goal_changed", "script_goal_changed", "defend_force_node_recalculation", "bad_path" );
    ...
    for (;;)
    {
        if ( self.tactical_goals.size > 0 && !scripts\mp\bots\bots_util::bot_is_remote_or_linked() )
        {
            ...
            if ( !isdefined( var_0.abort ) )
            {
                ...
                if ( istrue( var_0.camper_damage_thread ) )
                    self botclearscriptgoal();

                self botsetscriptgoal( var_0.goal_position, var_0.goal_radius, var_1, var_0.goal_yaw, var_0.objective_radius, var_0.printdata );
...
bot_new_tactical_goal( var_0, var_1, var_2, var_3 )
{
    ...
    var_4.printdata = var_3.printdata;
    var_4.level_check_current_drop_amount = var_3.level_check_current_drop_amount;
    var_4.camper_damage_thread = var_3.camper_damage_thread;
