...
battletracksidstandingonvehicle()
{
    return 1;
}
...
bot_loadout_item_allowed( var_0, var_1, var_2 )
{
    ...
    if ( !battletracksidstandingonvehicle() )
        return 0;
...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", binoculars_onstateinvalidupdate(), var_13, "class", "inUse" ) )
            {
                var_1 = binoculars_onstateinvalidexit( var_13, "loadoutPrimary" );
...
binoculars_onstateinvalidupdate()
{
...
bdroppingshield()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", binoculars_onstateinvalidupdate(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
    ...
    foreach ( var_5 in level.bot_loadout_fields )
    {
        ...
        var_3[var_5] = binoculars_onstateinvalidexit( var_2, var_5 );
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::extractquest_missionitem( var_0 );
...
{
    var_2 = binoculars_onstateinvalidupdate();
...
bot_loadout_valid_choice( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "loadoutPrimaryBuff":
            break;
        case "loadoutPrimaryCamo":
            var_4 = !isdefined( self.binoculars_showtargetmarker ) || var_3 == self.binoculars_showtargetmarker;
            break;
        case "loadoutSecondary":
        ...
        case "loadoutSecondaryBuff":
            break;
        case "loadoutSecondaryCamo":
            var_4 = !isdefined( self.binoculars_targetismarked ) || var_3 == self.binoculars_targetismarked;
            break;
        case "loadoutStreak3":
        case "loadoutStreak2":
        case "loadoutStreak1":
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 == "classtable_any" )
    {
        if ( !isdefined( self.closest_target ) )
            self.closest_target = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );

        var_0 = [ self.closest_target ];
    }
...
binoculars_cleanupheadiconondisconnect()
{
    if ( binoculars_checkpendingtimer().size > 0 )
    {
...
{
    if ( istrue( self.binoculars_onstateunmarkedenter ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( !isdefined( self.binoculars_onstateexitfunc ) )
        self.battletracks = 0;

    self.binoculars_onstateexitfunc = self.battletracks;
    ...
    var_8 = !var_7 && battle_tracks_playerinlisteningzoneinternal();
    ...
    self.binoculars_onstateunmarkedenter = undefined;

    if ( !var_7 )
    {
        var_12 = binoculars_cleanupheadiconondisconnect();
        var_13 = undefined;

        if ( isdefined( self.respawn_with_launcher ) && isdefined( var_12 ) )
        {
            self.respawn_with_launcher = undefined;
            self.binoculars_onstateunmarkedenter = 1;
            var_13 = var_12;
        }

        if ( !isdefined( var_13 ) )
        {
            var_14 = binoculars_checkpendingtimer();
            var_15 = 0;
    ...
    var_16 = undefined;
    var_17 = battletracksidstandingonvehicle();
    ...
    if ( var_17 )
    {
        ...
        if ( binoculars_onstatelospendingenter( var_1 ) )
            var_17 = 0;
    }

    if ( !var_17 )
    {
        var_1 = bdroppingshield();
    ...
    {
        if ( isdefined( var_1["loadoutPrimaryCamo"] ) && var_1["loadoutPrimaryCamo"] != "none" && !isdefined( self.binoculars_showtargetmarker ) )
            self.binoculars_showtargetmarker = var_1["loadoutPrimaryCamo"];

        if ( isdefined( var_1["loadoutSecondaryCamo"] ) && var_1["loadoutSecondaryCamo"] != "none" && !isdefined( self.binoculars_targetismarked ) )
            self.binoculars_targetismarked = var_1["loadoutSecondaryCamo"];
