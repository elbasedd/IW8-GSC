...
bot_gun_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_3.basename != "none" && !scripts\mp\utility\weapon::iskillstreakweapon( var_3 ) && var_3.basename != var_1 && !scripts\mp\utility\weapon::hasspawnweapons( var_3 ) )
        {
            var_1 = var_3.basename;

            if ( self botgetdifficultysetting( "advancedPersonality" ) && self botgetdifficultysetting( "strategyLevel" ) > 0 )
                binoculars_getfov( var_3.basename, var_2 );
        }
