...
being_kicked_from_inactivity( var_0, var_1, var_2 )
{
    var_3 = bestplayer( "attacker", var_0 );

    foreach ( var_5 in level.players )
    {
        if ( !isai( var_5 ) && isdefined( var_5.team ) && var_5.team == var_0 )
        {
            if ( var_5 besttimestate() || distancesquared( var_1, var_5.origin ) > squared( var_2 ) )
...
being_pickedup( var_0, var_1, var_2 )
{
    var_3 = bestplayer( "defender", var_0 );

    foreach ( var_5 in level.players )
    {
        if ( !isai( var_5 ) && isdefined( var_5.team ) && var_5.team == var_0 )
        {
            if ( var_5 bettermissiontierbonuses() || distancesquared( var_1, var_5.origin ) <= squared( var_2 ) )
                var_3 = scripts\engine\utility::array_add( var_3, var_5 );
        }
    }
...
besttimestate()
{
    if ( isdefined( level.besttime ) )
        return self [[ level.besttime ]]();
...
{
    if ( isdefined( level.bhadriotshield ) )
        return self [[ level.bhadriotshield ]]();
...
{
    var_0 = [[ level.bears ]]( self.team );
    var_1 = [[ level.bearsetup ]]( self.team );
    var_2 = [[ level.begin_vo ]]( self.team );
    var_3 = [[ level.being_hacked ]]( self.team );
    ...
    if ( var_4 == "active" )
    {
        if ( var_0.size >= var_2 )
        {
            ...
            {
                if ( isai( var_7 ) && level.bot_personality_type[var_7.personality] == "stationary" && var_7 battle_tracks_stopbattletracksforplayer() )
                {
            ...
            if ( var_5 )
            {
                big_door_watcher( "attacker" );
                return;
            }

            big_door_watcher( "defender" );
            return;
        }
        else
            big_door_watcher( "attacker" );
    ...
    else if ( var_4 == "stationary" )
    {
        if ( var_1.size >= var_3 )
        {
            ...
            {
                if ( isai( var_10 ) && level.bot_personality_type[var_10.personality] == "active" && var_10 battle_tracks_standingonvehicletimeout() )
                {
...
begin_spectate()
{
    ...
    for (;;)
    {
        if ( gettime() > var_1 )
        {
            ...
            {
                var_4 = [[ level.bears ]]( var_3 );
                var_5 = [[ level.bearsetup ]]( var_3 );
                var_6 = [[ level.begin_vo ]]( var_3 );
                var_7 = [[ level.being_hacked ]]( var_3 );
                ...
                if ( var_4.size > var_6 )
                {
                    ...
                    {
                        if ( isai( var_11 ) && var_11 battle_tracks_stopbattletracksforplayer() )
                        {
                            if ( level.bot_personality_type[var_11.personality] == "stationary" )
                            {
                                var_11 big_door_watcher( "defender" );
                                var_9 = 1;
                                break;
                            }
                            else
                    ...
                    if ( !var_9 && var_8.size > 0 )
                        scripts\engine\utility::random( var_8 ) big_door_watcher( "defender" );
                }
                ...
                if ( var_5.size > var_7 )
                {
                    ...
                    {
                        if ( isai( var_16 ) && var_16 battle_tracks_standingonvehicletimeout() )
                        {
                            if ( level.bot_personality_type[var_16.personality] == "active" )
                            {
                                var_16 big_door_watcher( "attacker" );
                                var_14 = 1;
                                break;
                            }
                            else
                    ...
                    if ( !var_14 && var_13.size > 0 )
                        scripts\engine\utility::random( var_13 ) big_door_watcher( "attacker" );
                }
            }
        }
...
{
    if ( isdefined( level.bearsred ) )
        return self [[ level.bearsred ]]();
...
{
    if ( isdefined( level.bearwatch ) )
        return self [[ level.bearwatch ]]();
...
battle_tracks_standingonsamevehiclewithsametracksowner( var_0 )
{
    var_1 = [];
    var_2 = [];
    var_3 = 0;
    ...
    foreach ( var_5 in var_0 )
    {
        ...
        var_5.support_box_update_hint_logic = br_itemrarity( var_5 );
        var_5.brloadoutcratepostcapture = support_box_use_logic( var_5, 0, 0 );
        var_7 = [ ( 0, 0, 0 ), ( 1, 1, 0 ), ( 1, -1, 0 ), ( -1, 1, 0 ), ( -1, -1, 0 ) ];

        foreach ( var_9 in var_7 )
        {
            var_10 = support_box_use_logic( var_5, var_9[0], var_9[1] );
...
{
    var_1 = spawnstruct();
    var_1.is_dead = ( 999999, 999999, 999999 );
    var_1.interior_door_interaction = ( -999999, -999999, -999999 );

    foreach ( var_3 in var_0.nodes )
    {
        var_1.is_dead = ( min( var_3.origin[0], var_1.is_dead[0] ), min( var_3.origin[1], var_1.is_dead[1] ), min( var_3.origin[2], var_1.is_dead[2] ) );
        var_1.interior_door_interaction = ( max( var_3.origin[0], var_1.interior_door_interaction[0] ), max( var_3.origin[1], var_1.interior_door_interaction[1] ), max( var_3.origin[2], var_1.interior_door_interaction[2] ) );
    }

    var_1.center = ( ( var_1.is_dead[0] + var_1.interior_door_interaction[0] ) / 2, ( var_1.is_dead[1] + var_1.interior_door_interaction[1] ) / 2, ( var_1.is_dead[2] + var_1.interior_door_interaction[2] ) / 2 );
    var_1.gas_vfx_range_think = ( var_1.interior_door_interaction[0] - var_1.center[0], var_1.interior_door_interaction[1] - var_1.center[1], var_1.interior_door_interaction[2] - var_1.center[2] );
    var_1.radius = max( var_1.gas_vfx_range_think[0], var_1.gas_vfx_range_think[1] );
    return var_1;
}

support_box_use_logic( var_0, var_1, var_2 )
{
    var_3 = ( var_0.support_box_update_hint_logic.center[0] + var_1 * var_0.support_box_update_hint_logic.gas_vfx_range_think[0], var_0.support_box_update_hint_logic.center[1] + var_2 * var_0.support_box_update_hint_logic.gas_vfx_range_think[1], 0 );
    var_4 = undefined;
    var_5 = 9999999;
...
barkov_execution_path( var_0, var_1, var_2, var_3 )
{
    var_4 = 0;
    ...
    {
        childthread keypad_increase_failnum();
        childthread keypad_disable_for_time();
    }
...
enable_spawner_after_vehicle_death( var_0 )
{
    var_1 = [];
