...
init()
{
    ...
    if ( !isdefined( game["music"] ) )
    {
        ...
        game["music"]["br_lobby_outro"][game["music"]["br_lobby_outro"].size] = "br_lobby_outro_06";
        game["music"]["br_lobby_outro"][game["music"]["br_lobby_outro"].size] = "br_lobby_outro_07";
        game["music"]["br_lobby_outro"][game["music"]["br_lobby_outro"].size] = "br_lobby_outro_08";
        ...
        game["music"]["br_infil_intro"][game["music"]["br_infil_intro"].size] = "br_infil_intro_06";
        ...
        game["music"]["br_ring_med"][game["music"]["br_ring_med"].size] = "br_ring_med_11";
        ...
        game["music"]["br_ring_high"][game["music"]["br_ring_high"].size] = "br_ring_high_11";
        ...
        game["music"]["plunder_tenpercent"][game["music"]["plunder_tenpercent"].size] = "br_plunder_tenpercent_6";
        ...
        game["music"]["plunder_fiftypercent"][game["music"]["plunder_fiftypercent"].size] = "br_plunder_fiftypercent_4";
...
dointro()
{
    ...
    if ( !level.splitscreen && !isdefined( self.mangagedeathsdoor ) || level.splitscreen && !isdefined( level.playedstartingmusic ) )
    {
        if ( !self issplitscreenplayer() || self issplitscreenplayerprimary() )
        {
...
molotov_cleanup_pool( var_0 )
{
    ...
    var_1 = scripts\mp\gamescore::flytime();
...
ongameended()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && scripts\mp\utility\game::fly_over_path() != "dmz" && scripts\mp\utility\game::fly_over_path() == "risk" )
        return;
...
monitor_dropkit_marker_throw()
{
    ...
    if ( isdefined( level.score_event_civilian_killed ) && level.score_event_civilian_killed == 1 )
        return;
    ...
    level.score_event_civilian_killed = 1;
}

molotov_crate_player_at_max_ammo( var_0 )
{
    level endon( "seventyfivepercent_music" );

    if ( isdefined( level.disablespawningforplayerfunc ) && level.disablespawningforplayerfunc == 1 )
        return;
    ...
    level.disablespawningforplayerfunc = 1;
...
monitor_bush_trig( var_0 )
{
    ...
    if ( isdefined( level.prev_weapon_taccover ) && level.prev_weapon_taccover == 1 )
        return;
    ...
    level.prev_weapon_taccover = 1;
    level notify( "seventyfivepercent_music" );
}

molotov_delete_oldest_trigger( var_0 )
{
    if ( isdefined( level.juggheli_spawner_jammer5_2 ) && level.juggheli_spawner_jammer5_2 == 1 )
        return;
    ...
    level.juggheli_spawner_jammer5_2 = 1;
    level notify( "ninetypercent_music" );
}

molotov_delete_pool_by_id()
{
    if ( isdefined( level.lightsfloor02 ) && level.lightsfloor02 == 1 )
        return;
