...
weapondrop_deploydrone( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2 thread strafe_speed( var_3 );
    }
}
...
{
    if ( istrue( self.get_bulletwhizby_alias ) )
        return;

    self.get_bulletwhizby_alias = 1;
...
checkcarpuncherprogressgeneric()
{
    if ( istrue( self.location_tracker ) )
        return;
...
checkcarpuncherprogress()
{
    ...
    self.location_tracker = undefined;
...
watchcratesettle()
{
    ...
    thread checkcarpuncherprogress();
}
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::hasbrspecialistbonus() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            manageprematchfade( var_6, var_7, var_8, var_11 );
        }
    }
}

manageprematchfade( var_0, var_1, var_2, var_3 )
{
