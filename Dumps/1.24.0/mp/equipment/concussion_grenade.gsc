...
lastunrulyscore( var_0, var_1 )
{
    ...
    foreach ( var_3 in level.mines )
    {
        ...
        if ( distancesquared( var_1, var_3.origin ) < 262144 )
            var_3 thread scripts\mp\equipment\claymore::calloutmarkerping_removeallcalloutsforplayer( var_0 );
    }
}
...
applyconcussion( var_0, var_1 )
{
    ...
    if ( istrue( self.carriablemagicgrenades ) )
        return;
    ...
    var_1 scripts\cp\so_laststand::lbravo_spawner_jammer1( "equip_concussion" );
