...
molotov_init()
{
    var_0 = spawnstruct();
    level.molotov = var_0;
    var_0.intro_techos_deposit_fullcar = getdvarint( "scr_molotovMaxPools", 100 );
    var_0.intro_driver_logic = getdvarint( "scr_molotovMaxCastsPerFrame", 8 );
    var_0.getbestsepctatecandidatefromlist = getdvarint( "scr_molotovInstantCleanup", 1 ) > 0;
    var_0.setquestrewardtieromnvar = 0;
    var_0.monitortacmapusage = [];
    var_0.scriptables = [];
    var_0.triggers = [];
...
molotov_used( var_0 )
{
    ...
    if ( isdefined( level.dvarlocations ) )
        [[ level.dvarlocations ]]( var_0, self );
...
molotov_simulate_impact( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !istrue( level.cleanupkeybindings ) )
    {
...
molotov_create_shared_data( var_0, var_1, var_2, var_3 )
{
    ...
    var_4.burnid = var_3;
    var_4.branches = [];
    var_4.playercinematiccompletecallback = 0;
    var_4.caststotal = 0;
...
isnearactivejugg( var_0 )
{
    ...
    var_1 = isminigunweapon();
    var_1.caststhisframe++;
}

isnearajuggdrop( var_0 )
{
    var_0.playercinematiccompletecallback++;
    var_1 = isminigunweapon();
    var_1.scriptables[self.id] = self;

    if ( var_1.scriptables.size > var_1.intro_techos_deposit_fullcar )
...
isnokillstreakprogressweapon( var_0 )
{
    ...
    if ( var_1.triggers.size > var_1.intro_techos_deposit_fullcar )
        isloadinggulag();
}
...
islocked()
{
    ...
    if ( !isdefined( var_1 ) )
        var_0.monitortacmapusage = scripts\engine\utility::array_remove( var_0.monitortacmapusage, self.id );
...
islaststandskippingenabled( var_0 )
{
    ...
    foreach ( var_3 in var_1.monitortacmapusage )
    {
    ...
    var_0 = istrue( var_0 ) || var_1.getbestsepctatecandidatefromlist;

    if ( !isdefined( var_2 ) )
        isloadoutindexdefault( var_3, var_0 );
}
...
isloadoutindexdefault( var_0, var_1 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            var_2.monitortacmapusage = scripts\engine\utility::array_remove( var_2.monitortacmapusage, var_0 );
            var_3 thread molotov_pool_end();
            return;
        }

        var_3 thread islocked();
    }

    var_4 = var_2.triggers[var_0];

    if ( isdefined( var_4 ) )
        var_4 thread islongshotspecial();
}

isinrewardflow( var_0 )
{
    ...
    if ( var_1.caststhisframe >= var_1.intro_driver_logic )
        return 0;
...
molotov_shared_data_is_complete( var_0 )
{
    ...
    if ( self.caststotal >= var_2 )
        var_1 = 1;
    else if ( self.playercinematiccompletecallback >= var_3 )
        var_1 = 1;
...
isnonequippable()
{
    ...
    if ( !isdefined( var_0.lasthungryscore ) )
        var_0.lasthungryscore = [];
    ...
    foreach ( var_2 in self.branches )
    {
        ...
        {
            if ( isdefined( var_4 ) )
                var_0.lasthungryscore[var_0.lasthungryscore.size] = var_4;
        }
    }
}
...
molotov_start_branch()
{
    ...
    else
    {
        ...
        for (;;)
        {
            ...
            if ( !isinrewardflow( self.shareddata ) )
            {
                waitframe();
                continue;
            }
...
{
    isnearactivejugg( self.shareddata );
    self.casts++;
...
molotov_create_pool( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( var_4.weapon_name == "gas_can_mp" )
        var_10 = "equip_propane_tank_pool_br";

    var_11 = spawnscriptable( var_10, var_0, var_1 );
...
molotov_branch_create_pool( var_0, var_1, var_2 )
{
    ...
    var_7.id = ismountconfigenabled();
    var_7 isnearajuggdrop( self.shareddata );
    return var_7;
}
...
molotov_pool_end( var_0 )
{
    ...
    if ( isdefined( self.trigger ) )
        self.trigger thread islongshotspecial();
...
molotov_create_pool_trigger( var_0, var_1, var_2 )
{
    ...
    var_4 isnokillstreakprogressweapon();
    return var_4;
}
...
{
    var_0 endon( "death" );
    scripts\engine\utility::spectatecommands( "disconnect", "joined_team" );
    var_0 delete();
}
...
{
    var_0 = isminigunweapon();
    var_1 = var_0.setquestrewardtieromnvar;
    var_0.setquestrewardtieromnvar++;
    var_0.monitortacmapusage = scripts\engine\utility::array_add( var_0.monitortacmapusage, var_1 );
    return var_1;
}

molotov_get_cast_data( var_0 )
{
    var_1 = ismeleeoverrideweapon();
    var_2 = spawnstruct();
...
molotov_end_fx()
{
    ...
    if ( istrue( self.modifydamagetoprop ) )
    {
        self setscriptablepartstate( "equipMtovFXWorld", "neutral", 0 );
        self setscriptablepartstate( "equipMtovFXView", "neutral", 0 );
    }

    self.modifydamagetoprop = undefined;
}
    ...
    if ( isdefined( var_0.shareddata ) )
    {
        if ( isdefined( var_0.shareddata.branches ) )
        {
            foreach ( var_3 in var_0.shareddata.branches )
                iskillstreakdeployweapon( var_3, var_1 );
        }

        if ( isdefined( var_0.shareddata.lasthungryscore ) )
        {
            foreach ( var_6 in var_0.shareddata.lasthungryscore )
            {
                if ( isdefined( var_6 ) )
