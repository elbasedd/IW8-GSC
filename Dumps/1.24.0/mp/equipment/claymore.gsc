...
claymore_plant()
{
    ...
    thread calloutmarkerping_playteamsoundfx();
    wait 1;
...
claymore_explodeonnotify()
{
    ...
    self.crate_set_flag_on_use = var_1;
    thread claymore_explode( var_1 );
}
...
claymore_modifieddamage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( isdefined( self.calloutmarkerping_removevehiclecalloutonspecialconditions ) )
        {
            foreach ( var_6 in self.calloutmarkerping_removevehiclecalloutonspecialconditions )
            {
    ...
    else if ( var_1 == makeweapon( "claymore_radial_mp" ) )
    {
        ...
        thread calloutmarkerping_initcommon( var_2 );
    }
    else
        return var_4;
    ...
    if ( isdefined( var_2.crate_set_flag_on_use ) )
    {
        var_14 = isdefined( var_2.owner ) && var_2.crate_set_flag_on_use == var_2.owner;
        var_15 = var_2.crate_set_flag_on_use == var_0;
...
calloutmarkerping_initcommon( var_0 )
{
    ...
    if ( !isdefined( self.calloutmarkerping_removevehiclecalloutonspecialconditions ) )
        self.calloutmarkerping_removevehiclecalloutonspecialconditions = [];

    self.calloutmarkerping_removevehiclecalloutonspecialconditions[self.calloutmarkerping_removevehiclecalloutonspecialconditions.size] = var_0;
    waittillframeend;
    self.calloutmarkerping_removevehiclecalloutonspecialconditions = undefined;
}
...
is_train_ent( var_0 )
{
    if ( isdefined( level.supersbyextraweapon ) )
    {
        foreach ( var_2 in level.supersbyextraweapon.select_random_card_location )
        {
            if ( var_2 == var_0 )
                return 1;
            else if ( isdefined( var_2._id_11EF7 ) && var_2._id_11EF7 == var_0 )
                return 1;
        }
    }
