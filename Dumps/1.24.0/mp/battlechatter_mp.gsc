...
init()
{
    ...
    level.heli_extraction = 0;

    if ( var_3 == "sd" || var_3 == "cyber" || var_3 == "arena" )
        level.heli_extraction = 1;
...
onplayerspawned()
{
    ...
    if ( !level.teambased || level.heli_extraction || istrue( level.disablebattlechatter ) || scripts\mp\utility\game::isanymlgmatch() )
        self.bcdisabled = 1;
    else
    {
        if ( !scripts\mp\utility\game::runleanthreadmode() || istrue( level.bomb_carrier ) )
        {
...
immune_against_kick_for_inactivity( var_0 )
{
    var_0 endon( "death" );
...
modifytriggerlocation( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        return;
...
threatcallouttracking()
{
    ...
    for (;;)
    {
        ...
        var_4 = ent_delete_by_targetname( self.team );
...
dosound( var_0, var_1 )
{
    ...
    {
        if ( self.operatorcustomization.demo_update_hint_logic == "none" )
            return;

        var_2 = var_2 + self.operatorcustomization.demo_update_hint_logic;
    }
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        managejumpmasterinfodisplay( var_6, var_7, var_0, var_5, var_4 );
    else if ( self issplitscreenplayer() )
        manageminigunpickup( var_6, var_7, var_0, var_5, var_4 );
    else
        managedropbags( var_6, var_7, var_0, var_5, var_4 );
    ...
    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        ...
        if ( soundexists( var_10 ) )
        {
            ...
            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                managejumpmasterinfodisplay( 1, 1, var_11, undefined, var_10, var_12 );
            else if ( self issplitscreenplayer() )
                manageminigunpickup( 1, 1, var_11, undefined, var_10, var_12 );
            else
                managedropbags( 1, 1, var_11, undefined, var_10, var_12 );
        }
    }
    ...
    scripts\engine\utility::spectatecommands( var_4, "death_or_disconnect" );
    level removespeaker( self, var_14 );
    return 1;
}

managedropbags( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
managejumpmasterinfodisplay( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
manageminigunpickup( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
{
    var_2 = scripts\engine\utility::spin_light( var_0, "death_or_disconnect" );
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    if ( !isdefined( level.hvt_anim_and_close_doors ) )
        level.hvt_anim_and_close_doors = [];

    level.hvt_anim_and_close_doors[var_1] = var_2;
}
...
ent_delete_by_targetname( var_0 )
{
    if ( isdefined( level.hvt_anim_and_close_doors ) && isdefined( level.hvt_anim_and_close_doors[var_0] ) )
        return level.hvt_anim_and_close_doors[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.bomb_carrier ) )
        return;
...
saylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    while ( var_0 <= level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        ...
        {
            var_5 = gettime();
            var_4["higher"]["player"] scripts\engine\utility::spectatekey( var_4["higher"]["sound_alias"], "death", "disconnect" );
            waitframe();
