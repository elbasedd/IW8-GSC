...
little_bird_mp_init()
{
    ...
    if ( istrue( level.proprotate ) )
        scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird", "endEnterInternal", ::init_gastrap );
}
...
little_bird_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::spawn_elevators( "little_bird", var_1, var_2 );
...
init_gastrap( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.proprotate ) )
