...
callback_vehicledamage_internal( var_0 )
{
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        if ( isdefined( var_4 ) && var_4 == "radar_drone_recon" )
        {
            ...
            var_0.attacker scripts\cp_mp\pet_watch::select_hostage_room_three_spawners( self );
    }

    if ( isdefined( level.isfriendlyfireprotectedperiod ) )
        var_0.damage = self [[ level.isfriendlyfireprotectedperiod ]]( var_0 );
    ...
    {
        if ( isdefined( var_4 ) && var_4 == "radar_drone_recon" && scripts\mp\utility\weapon::isthrowingknife( var_0.objweapon ) )
        {
    ...
    {
        if ( scripts\mp\damage::heli_counter( var_0.objweapon ) )
            var_0.damage = scripts\mp\damage::relic_nuketimer_gettimeformission( self, var_0.attacker, var_0.objweapon, var_0.damage, var_0.idflags );
        else if ( scripts\mp\damage::has_access_card( var_0.objweapon ) )
        {
            if ( scripts\mp\damage::project_to_line( var_0.objweapon ) )
                var_0.damage = 1;
            else
                var_0.damage = 0;
        }
        else if ( scripts\mp\damage::isxmike109damage( var_0.objweapon ) )
        {
            if ( !scripts\mp\damage::shouldxmike109hitmarker( var_0.objweapon ) )
                var_0.damage = 0;
        }
        else if ( isdefined( var_4 ) )
    ...
    var_8 = scripts\cp_mp\vehicles\vehicle_damage::so_postmatchfx( var_0 );

    if ( !var_8 )
    {
        var_9 = scripts\cp_mp\vehicles\vehicle_damage::smeansofdeathshitloc();
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::so_try_restart( var_0, 1 );
    else
        scripts\cp_mp\vehicles\vehicle_damage::so_setplayerdata( var_0, var_8, 1 );
    ...
    var_15 = istrue( var_0.heli_anim ) || istrue( var_0.heli_boss_shoot );
        ...
        switch ( var_0.objweapon.basename )
        {
            ...
            case "lighttank_tur_mp":
                if ( isdefined( var_0.meansofdeath ) && var_0.meansofdeath != "MOD_RIFLE_BULLET" )
                    var_0.attacker thread scripts\mp\utility\points::freight_lift_run( "critical_vehicle_damage" );
    ...
    {
        if ( isdefined( var_0.attacker ) && isplayer( var_0.attacker ) )
            var_0.attacker scripts\cp_mp\pet_watch::brregendelayspeed( self );
    ...
    if ( level.teambased )
    {
        if ( !var_3 )
        {
            if ( isdefined( var_2 ) && !isdefined( var_1 ) )
                return scripts\cp_mp\vehicles\vehicle::sortbyhvttags( var_0, var_2 );
            else
                return scripts\cp_mp\vehicles\vehicle::sort_wave_spawning_ai( var_0, var_1 );
        }
