...
light_tank_mp_initspawning()
{
    ...
    var_0._maphint_keypadscriptableused = scripts\cp_mp\vehicles\light_tank::light_tank_timeout;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
    {
        var_0._maphint_offerscriptableused = 105;
        var_0.pickclassbr = level.runcontrolledcallback;
    }
    else
        var_0._maphint_offerscriptableused = 40;
}
...
light_tank_mp_createownercaptureobject( var_0, var_1 )
{
    var_2 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( var_0, "tur_bradley_mp" );
...
light_tank_mp_createothercaptureobject( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::soldier_agent_lwfn6( var_0, "tur_bradley_mp" );
...
light_tank_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::spawn_elevators( "light_tank", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            if ( istrue( level.propsetchangesleft ) )
                scripts\mp\gametypes\arm.gsc::skipfirstraise( var_3, var_3.team );
