...
apc_rus_mp_initspawning()
{
    ...
    var_0._maphint_offerscriptableused = 180;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
        var_0.pickclassbr = level.ally_spawns;
}
...
apc_rus_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::spawn_elevators( "apc_russian", var_1, var_2 );
