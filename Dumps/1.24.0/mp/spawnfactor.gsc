...
avoidclosetodefenderflag( var_0, var_1 )
{
    var_2 = undefined;
...
avoidclosetodefenderflagspawn( var_0, var_1 )
{
    var_2 = var_0.scriptdata.trap_toggle_fx_logic;
    var_3 = var_1[""];
    return _id_64000000::_id_73747369( var_2 < var_3, 0, 100 );
}
