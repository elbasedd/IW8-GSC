...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6.propspectateendwatch ) )
            var_0 = var_6.propspectateendwatch;

        if ( isdefined( var_6.delete_headicon ) )
            var_3 = var_6.delete_headicon;

        if ( isdefined( var_6.delete_headicon_on_death ) )
            var_4 = var_6.delete_headicon_on_death;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::splashtime_vip( "log_user_event_end", "log_user_event_generic_event" );
