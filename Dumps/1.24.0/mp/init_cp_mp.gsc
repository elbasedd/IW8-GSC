...
init()
{
    ...
    pers_init();
    dlog_init();
    brlootchoppercratecapturecallback();
...
killstreak_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistDataForceCredit", scripts\mp\killstreaks\killstreaks::should_start_cautious_approach_hq );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistData", scripts\mp\killstreaks\killstreaks::should_spawn_drones );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "processScrapAssist", scripts\mp\events::mp_piccadilly_patch );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayersInRange", scripts\mp\gametypes\br_killstreaks.gsc::cleanuparenamolotovs );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayer", scripts\mp\gametypes\br_killstreaks.gsc::cleanupallclones );
}
...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "loadout_finalizeWeapons", scripts\mp\class::init_jugg_maze );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInLastStand", scripts\mp\utility\player::hasexiteddriver );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isPlayerOnIntelChallenge", scripts\mp\gametypes\br_maphints.gsc::isplayeronintelchallenge );
}
...
game_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "brGetOperatorTeam", scripts\mp\gametypes\br_public.gsc::bot_capture_hq_zone );
...
weapons_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getDefaultWeaponBaseName", scripts\mp\utility\weapon::failx1stashquest );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "attachmentIsSelectable", scripts\mp\utility\weapon::areanygulagfightsactive );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "remapAttachmentParentName", scripts\mp\utility\weapon::overrideviewkickscaledmr );
...
sound_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sound", "playKillstreakDeployDialog", scripts\mp\battlechatter_mp::modifytriggerlocation );
...
supers_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "supers", "combatRecordSuperMisc", scripts\mp\supers::cargo_truck_mg_initoccupancy );
}
...
brlootchoppercratecapturecallback()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onVehicleKilled", scripts\cp\so_laststand::vehiclekilled );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onFieldUpgradeEnd", scripts\cp\so_laststand::lastweaponfiretimeend );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onKillStreakEnd", scripts\cp\so_laststand::lb_dmg_factor_fuselage );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "resetChallengeTimer", scripts\cp\so_laststand::ph_checkforovertime );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "startChallengeTimer", scripts\cp\so_laststand::repair_grill_fixing_long_sfx );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "stopChallengeTimer", scripts\cp\so_laststand::respawningbr );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onPing", scripts\cp\so_laststand::lb_mg_dmg_factor_landing_gear );
}
