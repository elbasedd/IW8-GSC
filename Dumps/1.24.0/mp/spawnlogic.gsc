...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_9.showplacementsplashesandmusic = 0;
    var_10 = var_9.showplacementsplashesandmusic;
    ...
    if ( isdefined( var_3 ) && getspawnsetsize( var_3 ) > 0 && var_9.bucket >= 2 )
    {
        ...
        {
            var_9 = var_13;
            var_9.showplacementsplashesandmusic = 1;
            var_10 = var_9.showplacementsplashesandmusic;
            var_11 = var_9.threatsight;
            var_12 = var_9.damagemod;
        }
    ...
    if ( var_9.bucket >= 2 )
    {
        if ( var_8 >= 3 )
        {
            ...
            if ( isdefined( var_7 ) )
            {
                ...
                var_7.bucket = 3;
                var_7.showplacementsplashesandmusic = var_10;
    ...
    if ( !istrue( level.createhistorydestination ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0.projectileunlinkonnote = 1;
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level.playerentercombatarea[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level.playerentercombatarea ) && isdefined( level.playerentercombatarea[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level.playerentercombatarea[var_0] );
...
finalizespawnpointchoice( var_0 )
{
    ...
    {
        if ( !isdefined( var_0.showplacementsplashesandmusic ) )
            var_0.showplacementsplashesandmusic = 0;
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0.showplacementsplashesandmusic, var_0.threatsight, var_0.damagemod );
    }
...
checkmodifiedspawnpoint( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        var_2 = firesaleforplayers( var_0 );
...
chopper_boss_combat( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
{
    if ( !isdefined( level.playerentercombatarea ) )
        level.playerentercombatarea = [];
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level.playerentercombatarea[var_3] ) )
            level.playerentercombatarea[var_3] = [];
        ...
        level.playerentercombatarea[var_3][level.playerentercombatarea[var_3].size] = var_8;
    }

    level thread playerentercombatareamessage();
}
...
playerentercombatareamessage()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_1 in level.playerentercombatarea )
        {
            foreach ( var_3 in var_1 )
            {
