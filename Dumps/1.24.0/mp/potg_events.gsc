...
{
    if ( !level.potgenabled || !( isdefined( self.petwatch ) && self.petwatch.loadout_updateglobalclassstruct == "pet_turbo" ) )
        return;
            ...
            if ( distancesquared( self.lastkillvictimpos, self.origin ) < 40000 )
            {
                ...
                if ( var_3 < 750 )
                {
                    ...
                    if ( !isdefined( var_1.lastteabagtime ) || var_2 - var_1.lastteabagtime > 5000 )
                    {
                        ...
                        self.pers["teaBags"]++;
                        scripts\cp_mp\pet_watch::add_collision_to_hack_point();
                    }
