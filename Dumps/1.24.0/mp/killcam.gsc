...
killcam( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16, var_17, var_18 )
{
    ...
    scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::killcam() START" );
    ...
    if ( istrue( var_18 ) )
        thread scripts\mp\final_killcam::dismount_after_accum_damage();
    ...
    killcamcleanup( 1, undefined, var_18 );
    scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::killcam() COMPLETE" );
}

phaseindex()
{
    self endon( "disconnect" );
    scripts\engine\utility::spotlight_model( 0.15, "killcam_canceled", "spawned" );
    self clearpredictedstreampos();

    if ( istrue( level.showingfinalkillcam ) )
        scripts\mp\gamelogic::move_molotov_mortar();
}
...
dokillcamslowmo( var_0 )
{
    ...
    if ( !isdefined( level.his_completemission ) )
    {
        soundsettimescalefactorfromtable( "killcam" );
        level.his_completemission = 1;
    }
...
setkillcamnormalweaponomnvars( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_2.freight_lift_waittill_progress ) )
        {
            var_4 = undefined;
            var_0 = var_2.freight_lift_waittill_progress;
            var_2 = undefined;
        }
        else
...
waittillkillcamover()
{
    ...
    scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::waittillKillcamOver() START" );
    wait( self.killcamlength - level.frameduration / 1000.0 );
    scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::waittillKillcamOver() COMPLETE" );
}
...
waitskipkillcambutton( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::waitSkipKillcamButton() Killcam SKIPPED" );
...
waitskipkillcamkbm()
{
    ...
    scripts\mp\utility\stats::incpersstat( "skippedKillcams", 1 );
    scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::waitSkipKillcamKBM() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
endkillcamifnothingtoshow()
{
    ...
    scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "killcam::endKillcamIfNothingToShow() Killcam SKIPPED" );
    self notify( "abort_killcam" );
}
...
{
    if ( isdefined( var_0.little_bird_mg_enterend ) )
        var_0 = var_0.little_bird_mg_enterend;
    ...
    if ( var_2 != "iw8_knife" )
    {
        ...
        for ( var_7 = 0; var_7 < var_5.size; var_7++ )
        {
            ...
            if ( scripts\mp\utility\weapon::areanygulagfightsactive( var_2, var_9 ) )
            {
                if ( var_6 >= 8 )
                    break;
