...
br_insert_armor( var_0, var_1, var_2 )
{
...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::extractplunderhelihealth( var_0 );
}
...
rotationrefsbyseatandweapon( var_0, var_1, var_2 )
{
...
round_at_max( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    return round_enemies_fallback_logic( var_3, var_4 );
}

round_enemies_fallback_logic( var_0, var_1 )
{
    if ( var_0 == "none" )
        return 0;

    if ( !isdefined( level.atv_initcollision ) )
    {
        level.atv_initcollision = [];
        level.atv_initcollision["iw8_ar_tango21"] = [ 1 ];
        level.atv_initcollision["iw8_ar_mike4"] = [ 5 ];
        level.atv_initcollision["iw8_ar_kilo433"] = [ 3 ];
        level.atv_initcollision["iw8_ar_scharlie"] = [ 3 ];
        level.atv_initcollision["iw8_sm_uzulu"] = [ 4 ];
        level.atv_initcollision["iw8_sh_romeo870"] = [ 5 ];
        level.atv_initcollision["iw8_sh_dpapa12"] = [ 3 ];
        level.atv_initcollision["iw8_lm_mgolf34"] = [ 4 ];
        level.atv_initcollision["iw8_sn_kilo98"] = [ 16 ];
        level.atv_initcollision["iw8_sn_alpha50"] = [ 2 ];
        level.atv_initcollision["iw8_sn_hdromeo"] = [ 4 ];
        level.atv_initcollision["iw8_pi_golf21"] = [ 3 ];
        level.atv_initcollision["iw8_pi_cpapa"] = [ 15 ];
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.atv_initcollision[var_7] ) )
                        level.atv_initcollision[var_7] = [];

                    level.atv_initcollision[var_7][level.atv_initcollision[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.atv_initcollision[var_0] ) )
        var_10 = level.atv_initcollision[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::fob_think( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::stream_time( var_0, var_11 );
...
loadout_clearplayer( var_0 )
{
    ...
    scripts\mp\perks\perkpackage::loadout_updateammo();
...
loadout_getclassstruct()
{
    ...
    var_0.hangar_juggs = 0;
    return var_0;
}

init_intro_heli_anims( var_0 )
{
    var_1 = spawnstruct();
    var_1.loadoutarchetype = var_0.loadoutarchetype;

    if ( isdefined( var_0.init_patches ) )
        var_1.init_patches = var_0.init_patches;
    ...
    if ( isdefined( var_0.init_petrograd_bsp_patch ) )
        var_1.init_petrograd_bsp_patch = var_0.init_petrograd_bsp_patch;
    ...
    var_1.hangar_juggs = var_0.hangar_juggs;
...
loadout_updateclasscustom( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutprimaryattachmentids[var_3] = br_insert_armor( var_2, 0, var_3 );
    }
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutsecondaryattachmentids[var_3] = br_insert_armor( var_2, 1, var_3 );
    }
    ...
    var_0.loadoutaccessorylogic = br_highlightlaststandfinishplayers();
    var_0.loadoutstreaksfilled = 1;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.init_patches = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.init_petrograd_bsp_patch = var_3["loadoutSecondaryAddBlueprintAttachments"];
    ...
    var_0.init_out_of_bounds_triggers = isdefined( var_3["loadoutExtraPerks"] );
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.init_patches = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.init_petrograd_bsp_patch = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isagent( self ) && self scriptablegetmidpoint() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        init_leave_cave( var_0 );
    else
        init_lbravo_spawn_after_level_restart( var_0, var_2 );
...
init_lbravo_spawn_after_level_restart( var_0, var_1 )
{
...
init_leave_cave( var_0 )
{
    if ( !isdefined( self.get_consecutive_def ) )
    {
        if ( !isdefined( level.get_consecutive_def ) )
        {
            var_1 = randomint( 200 );
            level.get_consecutive_def = var_1;
            level.get_control_station_side_array = var_1;
        }
        else
        {
            level.get_consecutive_def++;
            level.get_control_station_side_array++;
        }

        self.get_consecutive_def = level.get_consecutive_def;
        self.get_control_station_side_array = level.get_control_station_side_array;
    }

    var_2 = init_laser_traps( self.get_consecutive_def, 1 );
    var_3 = init_laser_traps( self.get_control_station_side_array, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
init_laser_traps( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_5.variantid == 0 || var_5.hasselfrevivetoken || !isdefined( var_5.attachcustomtoidmap ) )
                continue;
...
loadout_updateabilities( var_0, var_1 )
{
    ...
    if ( var_0.loadoutperksfromgamemode )
    {
        ...
        if ( var_0.init_out_of_bounds_triggers )
...
init_lethal_boxes( var_0, var_1 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "custom":
            break;
        case "gamemode":
            init_level_drop_structs( var_0, var_1 );
            break;
        case "callback":
            break;
        case "default":
...
{
    if ( !isagent( self ) && self scriptablegetmidpoint() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && scripts\mp\utility\game::getgametype() != "br" )
    ...
    if ( isdefined( level.isdragonsbreath ) )
        self [[ level.isdragonsbreath ]]( var_0 );
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.init_patches ) )
        var_0.loadoutprimaryobject = bot_snipers( var_0.loadoutprimary, var_0.loadoutprimaryattachments, var_0.loadoutprimarycamo, var_0.loadoutprimaryreticle, var_0.loadoutprimaryvariantid, var_0.loadoutprimaryattachmentids, var_0.loadoutprimarycosmeticattachment, var_0.loadoutprimarystickers, istrue( var_0.loadouthasnvg ) );
    else
    ...
    {
        if ( istrue( var_0.init_petrograd_bsp_patch ) )
            var_0.loadoutsecondaryobject = bot_snipers( var_0.loadoutsecondary, var_0.loadoutsecondaryattachments, var_0.loadoutsecondarycamo, var_0.loadoutsecondaryreticle, var_0.loadoutsecondaryvariantid, var_0.loadoutsecondaryattachmentids, var_0.loadoutsecondarycosmeticattachment, var_0.loadoutsecondarystickers, istrue( var_0.loadouthasnvg ) );
        else
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    init_laser_panel_anims( var_0, var_7, var_8, var_4, var_5, var_6 );
...
init_jugg_maze()
{
    ...
    init_laser_panel_anims( self.classstruct, self.primaryweaponobj, self.secondaryweaponobj, var_0, var_1, level.magcount );
}
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = init_laser( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = init_laser( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
init_laser( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.getgulagclosedcircleindex ) )
        {
...
init_laser_panel_anims( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.get_carry_item_omnvar = var_8 hasattachment( "maxammo" );

    if ( isdefined( level.iscrossbowbolt ) )
        self [[ level.iscrossbowbolt ]]( var_6 );
    ...
    else
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.get_carry_item_omnvar ) )
            {
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.get_carry_item_omnvar ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.get_carry_item_omnvar ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::handlelfo( var_8 ) )
...
loadout_updateplayernvgs()
{
    ...
    if ( istrue( self.inspawncamera ) )
        scripts\engine\utility::spectatecommands( "spawned_player", "fadeUp_start" );
        ...
        if ( !var_9 )
        {
            ...
            for ( var_14 = var_10.size - 1; var_14 >= 0; var_14-- )
            {
                ...
                if ( !var_13.isspecialist )
                    scripts\mp\killstreaks\killstreaks::awardkillstreakfromstruct( var_10[var_14], "other" );
            }
            ...
            for ( var_14 = 0; var_14 < var_11.size; var_14++ )
            {
                ...
                if ( !var_13.isspecialist )
                    scripts\mp\killstreaks\killstreaks::awardkillstreakfromstruct( var_11[var_14], "other" );
            }
        }
    }
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            var_2 = dmzlootleaderupdateonpickup( self.loadoutfieldupgrade1 );

            if ( isdefined( level.forcegivesuper ) )
                self [[ level.forcegivesuper ]]( var_2 );
        }
    }
    else if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        self.init_manned_turret_settings = dmzlootleaderupdateonpickup( self.loadoutfieldupgrade1 );
...
dmzlootleaderupdateonpickup( var_0 )
{
    if ( var_0 == "none" )
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = init_keypad_display_digits();
    var_5 = init_lethal_boxes( var_5, var_1 );
    self.friendlyicon = var_5;
    var_6 = undefined;
    ...
    if ( isdefined( self.preloadedclassstruct ) )
    {
        ...
        if ( scripts\mp\flags::gameflag( "prematch_done" ) )
            self unmarkkeyframedmover( self.class_num );
    }
    else
    {
...
select_new_spotlight_goal_node()
{
    for (;;)
    {
        self waittill( "grenade_pullback", var_0 );
        ...
        if ( !isnullweapon( var_0 ) && var_0.basename == "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) )
            self.lb_pitch_roll_dmg_factor = 1;
...
{
    if ( !istrue( self.lb_pitch_roll_dmg_factor ) )
    {
        var_0 = self getheldoffhand();

        if ( !isnullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && heli_intro_vo_done( var_0 ) )
            self.lb_pitch_roll_dmg_factor = 1;
    }
}
...
{
    self.play_ac130_approach_based_on = undefined;
    self.play_3p_anim_non_animscene = undefined;
    ...
    for (;;)
    {
        ...
        {
            self.play_ac130_approach_based_on = gettime() + 200;
            continue;
        }
...
select_patrol_eight_spawners( var_0 )
{
    ...
    childthread select_new_spotlight_goal_node();

    if ( isdefined( var_0 ) )
        self.start_coop_escort_enter_vehicles = var_0;
    else if ( !isdefined( self.start_coop_escort_enter_vehicles ) )
        self.start_coop_escort_enter_vehicles = 0;
    ...
    while ( scripts\mp\riotshield::riotshield_hasweapon() )
    {
        ...
        {
            if ( self.start_coop_escort_enter_vehicles )
            {
                self.i_see_player_shield_watcher = 1;
                self.i_see_player_vehicle_watcher = gettime() + 1000;
            }
            else if ( isdefined( self.i_see_player_vehicle_watcher ) && gettime() >= self.i_see_player_vehicle_watcher )
            {
                self.i_see_player_shield_watcher = undefined;
                self.i_see_player_vehicle_watcher = undefined;
            }
        ...
        else
        {
            self.i_see_player_shield_watcher = undefined;
            self.i_see_player_vehicle_watcher = undefined;
            self.start_coop_escort_enter_vehicles = 1;
        }

        if ( self isonladder() )
            select_patrol_four_spawners();
        else if ( self isinexecutionattack() )
            select_patrol_four_spawners();
        else if ( self isinexecutionvictim() )
            select_patrol_nine_spawners();
        else if ( self isparachuting() || self isskydiving() )
            select_patrol_four_spawners();
        else if ( istrue( self.i_see_player_shield_watcher ) )
            select_patrol_four_spawners();
        else if ( istrue( self.lb_pitch_roll_dmg_factor ) )
        {
            if ( isnullweapon( self getheldoffhand() ) )
            {
                self.lb_pitch_roll_dmg_factor = undefined;
                select_patrol_one_spawners();
            }
            else
                select_patrol_four_spawners();
        }
...
platform_cleanup_on_death( var_0 )
{
    self.i_see_player_shield_watcher = undefined;
    self.i_see_player_vehicle_watcher = undefined;
    self.start_coop_escort_enter_vehicles = undefined;
...
bot_snipers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::arena_bot_pickup_weapon( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::arena_bot_seek_dropped_weapon( var_14 );
...
bot_should_cap_next_zone( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && handleteamvisibility( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( heli_can_shoot( var_19 ) || heli_bravo_main_snd_ent( var_20 ) ) )
            var_12 = 1;
    }
...
heli_starts_addstart( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( heli_can_shoot( var_4 ) || heli_bravo_main_snd_ent( var_3 ) )
            return 1;
    }
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0.level_carepackage_give_player_killstreak_incendiary_launcher ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0.level_carepackage_give_player_killstreak_incendiary_launcher stoploopsound( self.level_carepackage_player_used_logic );
            var_0.level_carepackage_give_player_killstreak_incendiary_launcher delete();
            var_0.level_carepackage_give_player_killstreak_incendiary_launcher = undefined;
            var_0.level_carepackage_player_used_logic = undefined;
        }
...
resetfunctionality()
{
    ...
    scripts\cp_mp\vehicles\vehicle_occupancy::sp_stealth_broken_listener( self, 1 );
    ...
    scripts\mp\equipment\molotov::iskillstreakvehicleinflictor();
    scripts\mp\equipment\throwing_knife_mp::score_init();
    scripts\mp\equipment\flash_grenade::clearflash( 1 );
    scripts\mp\equipment\gas_grenade::gas_clear( 1 );

    if ( !isagent( self ) )
    {
        scripts\mp\utility\player::get_random_impact_point_on_line();
...
copyclassfornextlife( var_0 )
{
    ...
    self.pers["copiedClass"] = init_intro_heli_anims( var_1 );
    self.pers["lastKiller"] = var_0;
}

_cancelputawayonuseend()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
...
shouldskipfirstraise( var_0, var_1 )
{
    ...
    if ( istrue( self.start_coop_escort_protect_hvi ) )
        var_1 = 1;
...
setplayerselfrevivingextrainfo()
{
    if ( scripts\engine\utility::ent_flag_exist( "swapLoadout_blocked" ) && scripts\engine\utility::ent_flag( "swapLoadout_blocked" ) )
