...
smuggler_post_tele_kill()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveScore", ::smoke_door );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveAward", ::smodelcollections );
}

smoke_door( var_0, var_1, var_2 )
{
    if ( istrue( var_2 ) )
...
smodelcollections( var_0, var_1, var_2 )
{
