...
dopotgkillcamforplayer()
{
    ...
    var_1 = scripts\engine\utility::splashtime_vip( "begin_killcam", "killcam_ended" );
...
dofinalkillcam()
{
    ...
    level thread scripts\cp\so_laststand::processfinalkillchallenges( var_2, var_3 );
...
skipkillcamduringdeathtimer( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        var_1 = scripts\engine\utility::spin_light( "killcam_death_done_waiting", "killcam_death_button_cancel" );
