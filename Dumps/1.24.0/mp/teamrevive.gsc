...
updaterevivetriggerspawnposition()
{
    ...
    if ( !istrue( scripts\mp\flags::gameflag( "prematch_done" ) ) )
    {
        ...
        {
            level scripts\engine\utility::spectatekey( "prematch_done", "start_mode_setup", "infil_started" );
            var_0 = int( max( level.prematchperiodend - 5, 5 ) );
            wait( var_0 );
        }
        else
            level scripts\engine\utility::spectatekey( "prematch_done", "start_mode_setup", "match_start_real_countdown" );
    }
...
spawnrevivetrigger( var_0, var_1, var_2, var_3 )
{
    ...
    var_0 scripts\mp\playerlogic::plunder_items_picked_up( 0 );
...
revivetimeoutthink( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( !istrue( scripts\mp\playerlogic::extractupdateiconsframeend() ) )
        {
...
lifelimitedallyonuse( var_0 )
{
    ...
    if ( isdefined( self.victim ) )
    {
        ...
        scripts\cp\so_laststand::onplayerteamrevive( var_0, self.victim );
    }
...
revivetriggerholdonusebegin( var_0, var_1 )
{
    ...
    var_2 scripts\mp\playerlogic::plunder_items_picked_up( 1 );
    ...
    var_2 scripts\mp\utility\player::mp_euphrates_gunnonlinear_opendoor( "teamrevive::reviveTriggerHoldOnUseBegin() Killcam SKIPPED" );
...
revivetriggerholdonuseend( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( self.trigger.owner ) )
    {
        ...
        var_4 scripts\mp\playerlogic::plunder_items_picked_up( 0 );
