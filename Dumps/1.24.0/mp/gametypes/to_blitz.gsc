...
rpgcrateenduse( var_0 )
{
    ...
    var_0 scripts\mp\weapons::plunder_updateanchoredwidgetforplayers( makeweapon( "iw8_la_rpapa7_mp" ) );
}
...
watchiconupdater()
{
    ...
    for (;;)
    {
        scripts\engine\utility::spectatekey( "bradley_driverUpdate", "death", "bradley_vehicleExit" );
...
ontimelimit()
{
    if ( isdefined( level.onphaseend ) )
    {
        var_0 = scripts\mp\gamescore::br_pe_chopper_crates( 0 );
