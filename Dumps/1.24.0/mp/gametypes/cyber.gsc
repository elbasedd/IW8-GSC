...
initspawns()
{
    ...
    {
        assignteamspawns();
        level.claymore_crate_spawn["allies"] = "allies";
        level.claymore_crate_spawn["axis"] = "axis";
...
getspawnpoint()
{
    ...
    if ( scripts\mp\utility\game::getgametypenumlives() != 1 )
    {
        if ( scripts\mp\spawnlogic::shoulduseteamstartspawn() )
        {
            ...
            var_1 = scripts\mp\spawnlogic::getspawnpoint( self, var_0, level.claymore_crate_spawn[var_0], "neutral" );
    }
...
assignteamspawns()
{
    ...
    else
    {
        foreach ( var_9 in var_0 )
        {
            var_9.teambase = findminmaxangleovertime( var_9 );
...
reset_button_handler()
{
    ...
    level.cyberemp scripts\mp\gameobjects::plunderatcapacity( "mlg_icon_waypoint_emp_planted" );
    ...
    level.cyberemp scripts\mp\gameobjects::plundercountroll( "icon_waypoint_escort_emp", "waypoint_capture_kill", "mlg_icon_waypoint_emp_planted", var_0 );
...
hidebombsitesaftermatchstart()
{
    ...
    scripts\mp\objidpoolmanager::last_grenade_fire_time( level.objectives["allies"].objidnum, 1 );
    ...
    scripts\mp\objidpoolmanager::last_grenade_fire_time( level.objectives["axis"].objidnum, 1 );
...
allowedwhileplanting( var_0 )
{
    ...
    if ( var_0 )
    {
        scripts\engine\utility::spotlight_min_dist_sq_from_node( 0.8, "bomb_allow_offhands" );
        scripts\common\utility::allow_melee( var_0 );
...
onenduse( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_1.isdefusing )
            scripts\mp\gameobjects::plundercountroll( "icon_waypoint_defuse_empsite_nt", "icon_waypoint_defend_empsite_nt", "mlg_icon_waypoint_emp_planted" );
        else
            scripts\mp\gameobjects::plundercountroll( "icon_waypoint_defend_empsite", "icon_waypoint_target_empsite", "mlg_icon_waypoint_emp_planted" );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    scripts\mp\objidpoolmanager::last_grenade_fire_time( level.objectives["allies"].objidnum, 0 );
    scripts\mp\objidpoolmanager::last_grenade_fire_time( level.objectives["axis"].objidnum, 0 );
...
onuse( var_0 )
{
    ...
    if ( !scripts\mp\gameobjects::isfriendlyteam( var_0.pers["team"] ) && !level.bombplanted )
    {
        ...
        var_0 scripts\cp\so_laststand::lb_mg_dmg_factor_main_rotor();
        var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "plant", var_0.origin );
        ...
        level.bombplanted = 1;
        scripts\mp\gameobjects::plunderatcapacity( "mlg_icon_waypoint_emp_planted" );
    ...
    else
    {
        ...
        var_0 scripts\cp\so_laststand::laststandweaponobj();
        var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "defuse", var_0.origin );
        level.bombplanted = 0;
...
setupfordefusing( var_0, var_1 )
{
    ...
    thread scripts\mp\gametypes\obj_bombzone.gsc::baloon_deposit_death_check( var_1.team, "icon_waypoint_planted_empsite", "icon_waypoint_defuse_empsite" );
...
onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0.isplanting )
    {
        thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_collect_vo_func, var_2, "planting" );
        var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
        var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
    }
    else if ( var_0.isbombcarrier )
        thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_collect_vo_func, var_2, "carrying" );
    else if ( var_0.isdefusing )
        thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_collect_vo_func, var_2, "defusing" );
}
    ...
    foreach ( var_19 in level.objectives )
    {
        ...
        if ( var_20 != var_1.team )
        {
            ...
            if ( var_21 )
            {
                ...
                thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inner, var_9, "assaulting" );
                continue;
            }
        }
        else
        {
            ...
            if ( var_22 )
            {
                ...
                var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
                var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
                thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inner, var_9, "defending" );
                continue;
            }
        }
    }
...
weaponswapwatcher()
{
    ...
    for (;;)
    {
        if ( self.currentprimaryweapon.basename == "iw8_cyberemp_mp" )
        {
            if ( !istrue( self.propheight ) )
            {
                scripts\mp\utility\player::showminimap();
                self.propheight = 1;
            }
        }
        else if ( istrue( self.propheight ) )
        {
