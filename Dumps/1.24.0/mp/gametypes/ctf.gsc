...
createflagsandhud()
{
    ...
    scripts\mp\objidpoolmanager::last_grenade_fire_time( level.capzones[game["defenders"]].objidnum, 1 );
    scripts\mp\objidpoolmanager::last_grenade_fire_time( level.capzones[game["attackers"]].objidnum, 1 );
}
...
createteamflag( var_0, var_1 )
{
    ...
    var_9 scripts\mp\gameobjects::plundercountroll( level.iconescort, level.iconkill, level.iscacprimaryweapongroup );
    ...
    var_9 scripts\mp\gameobjects::onplayerkillednew( ::do_ascender_entrance );
    var_9.allowweapons = 1;
    var_9.level_should_run_sp_stealth = var_8;
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_9 scripts\mp\gameobjects::plundercountroll( level.iconescort, level.iconkill, level.iscacprimaryweapongroup, var_10 );
    }
    else
    {
        var_9.objidpingfriendly = 1;
...
createcapzone( var_0, var_1 )
{
    ...
    var_6 scripts\mp\gameobjects::plundercountroll( level.icondefendflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != var_3 )
    {
        ...
        if ( level.codcasterenabled )
            level.capzones[var_0.team] scripts\mp\gameobjects::phase_four_combat();

        thread returnflag();
        var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "obj_return", var_0.origin );
        ...
        if ( self.level_should_run_sp_stealth == "allies" )
            setomnvar( "ui_ctf_flag_axis", -2 );
        else
            setomnvar( "ui_ctf_flag_allies", -2 );
    }
    else
    {
        ...
        level.capzones[var_5] scripts\mp\gameobjects::plunderatcapacity( level.isburstweapon );
...
ondrop( var_0 )
{
    if ( isdefined( var_0.leaving_team ) )
    {
        ...
        self.droppedteam = self.level_should_run_sp_stealth;
    else
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::plundercountroll( level.iconreturnflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
    else
    {
        scripts\mp\gameobjects::plundercountroll( level.icondefendflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
    ...
    scripts\mp\utility\dialog::leaderdialog( "enemy_flag_dropped", self.level_should_run_sp_stealth, "status" );
    scripts\mp\utility\dialog::leaderdialog( "flag_dropped", scripts\mp\utility\game::getotherteam( self.level_should_run_sp_stealth )[0], "status" );
...
onreset()
{
    ...
    level.capzones[var_1] scripts\mp\gameobjects::plundercountroll( level.icondefendflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
...
onuse( var_0 )
{
    if ( !level.gameended )
    {
        ...
        var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "capture", var_0.origin );
        ...
        if ( level.codcasterenabled )
            level.capzones[var_2] scripts\mp\gameobjects::phase_four_combat();

        level.teamflags[var_2] returnflag();
        level scripts\mp\gamescore::giveteamscoreforobjective( var_1, 1, 0 );
        var_0 scripts\cp\so_laststand::laststand_player_in_focus();
    }
}
...
superabilitywatcher()
{
    ...
    for (;;)
    {
        ...
        {
            case "super_rewind":
                scripts\engine\utility::spectatecommands( "teleport_success", "rewind_success" );
...
placeflag()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_12 scripts\mp\gameobjects::plundercountroll( level.icondefendflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
