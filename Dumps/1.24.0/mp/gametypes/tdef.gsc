...
main()
{
    ...
    foreach ( var_2 in var_0 )
        level.defenderflag_starts[level.defenderflag_starts.size] = var_2.origin;
    ...
    foreach ( var_6 in var_4 )
    {
        ...
        {
            level.defenderflag_bflagstart = var_6.origin;
            break;
        }
    }
...
updategametypedvars()
{
    ...
    level.dmztutdropcash = scripts\mp\utility\dvars::dvarfloatvalue( "flagActivationDelay", 10, 0, 30 );
...
initspawns()
{
    ...
    foreach ( var_3 in level.spawnpoints )
        calculatespawndisttodefenderflagstart( var_3 );
}

calculatespawndisttodefenderflagstart( var_0 )
{
    var_0.scriptdata.distsqtodefenderflagstart = undefined;
    var_1 = getpathdist( var_0.origin, level.defenderflag_starts[0], 1000 );

    if ( var_1 < 0 )
        var_1 = scripts\engine\utility::distance_2d_squared( var_0.origin, level.defenderflag_starts[0] );
    else
        var_1 = var_1 * var_1;

    var_0.scriptdata.distsqtodefenderflagstart = var_1;
}
...
getspawnpoint()
{
    ...
    {
        var_3 = [];
        var_3["defenderFlagPosition"] = level.defenderflag.visuals[0].origin;

        if ( isdefined( level.defenderflag.carrier ) )
            var_3["activeCarrierPosition"] = level.defenderflag.carrier.origin;
        else
...
tdef()
{
    ...
    level.isburstweapon = "waypoint_mlg_empty_flag";
    level.iscacprimaryweapongroup = "waypoint_mlg_full_flag";
...
createflagstart()
{
    ...
    var_0 = level.defenderflag_starts[0] + ( 0, 0, 64 );
    var_1 = level.defenderflag_starts[0] + ( 0, 0, -64 );
    var_2 = scripts\engine\trace::ray_trace( var_0, var_1, undefined, scripts\engine\trace::create_default_contents( 1 ) );
    level.defenderflag_starts[0] = var_2["position"];
...
flaglockedtimer()
{
    ...
    if ( level.dmztutdropcash )
    {
        scripts\mp\flags::gameflagwait( "prematch_done" );
        level.defenderflagbase.objectiveicon thread scripts\mp\gametypes\obj_zonecapture.gsc::init_range_targets( level.dmztutdropcash, level.defenderflag.curorigin + level.defenderflag.offset3d );
        wait( level.dmztutdropcash );
        level.defenderflagbase.objectiveicon scripts\mp\gameobjects::plundercountroll( level.iconcaptureflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
...
createteamdefenderflag( var_0 )
{
    ...
    level.returntime = 0;
    var_1 = 32;
    var_2 = spawn( "trigger_radius", level.defenderflag_starts[0], 0, var_1, 128 );
    var_3 = [];
    var_3[0] = spawn( "script_model", level.defenderflag_starts[0] );
    ...
    var_5 scripts\mp\gameobjects::plundercountroll( level.iconescort, level.iconkill, level.iscacprimaryweapongroup );
    ...
    var_5 scripts\mp\gameobjects::onplayerkillednew( ::do_ascender_entrance );
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_5 scripts\mp\gameobjects::plundercountroll( level.iconescort, level.iconkill, level.iscacprimaryweapongroup, var_6 );
    }
    else
    {
        var_5.objidpingfriendly = 1;
    ...
    level.defenderflagbase = createteamdefenderflagbase( var_0, var_5 );
    return var_5;
}
...
createteamdefenderflagbase( var_0, var_1 )
{
    ...
    var_3.objectiveicon = scripts\mp\gameobjects::createobjidobject( var_2, "neutral", ( 0, 0, 85 ), undefined, "any", 0 );
    var_3.objectiveicon scripts\mp\gameobjects::setvisibleteam( "any" );

    if ( level.dmztutdropcash )
    {
        var_1.trigger scripts\engine\utility::trigger_off();
        var_3.objectiveicon scripts\mp\gameobjects::plundercountroll( level.icontarget, level.icontarget, level.iscacprimaryweapongroup );
    }
    else
        var_3.objectiveicon scripts\mp\gameobjects::plundercountroll( level.iconcaptureflag, level.iconcaptureflag, level.iscacprimaryweapongroup );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    level.defenderflagbase.objectiveicon scripts\mp\gameobjects::setvisibleteam( "none" );
    level.defenderflag.currentcarrier = var_0;
    var_0 thread awardobjtimeforcarrier();
    var_0 thread flagattachradar();
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        else
        {
            ...
            scripts\mp\objidpoolmanager::last_attack_time( self.pingobjidnum, 1 );
    ...
    scripts\mp\gameobjects::plundercountroll( level.iconescort, level.iconkill, level.iscacprimaryweapongroup );
    ...
    var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "pickup", var_0.origin );
...
ondrop( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
        var_0 should_enter_combat_after_checking_decoy_grenade();
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::plundercountroll( level.iconreturnflag, level.iconreturnflag, level.iscacprimaryweapongroup );
    else
    {
        scripts\mp\gameobjects::plundercountroll( level.iconreturnflag, level.iconreturnflag, level.iscacprimaryweapongroup );
        scripts\mp\objidpoolmanager::last_attack_time( self.objidnum, 1 );
    }
...
awardobjtimeforcarrier( var_0 )
{
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.gameended )
        {
            ...
            level.defenderflag.carrier scripts\mp\gamescore::giveplayerscore( "tdef_hold_obj", 10 );
        }
    }
}
...
flagattachradar( var_0 )
{
    ...
    var_2 = spawn( "script_model", level.defenderflag.visuals[0].origin );
    var_2.team = scripts\mp\utility\game::getotherteam( var_0 )[0];
    var_2.owner = var_1;
    var_2 makeportableradar( var_1 );
    level.defenderflag.portable_radar = var_2;
...
flagwatchradarownerlost()
{
    ...
    var_0 = scripts\mp\utility\game::getotherteam( var_0 )[0];
    self.portable_radar.owner scripts\engine\utility::spectatekey( "disconnect", "joined_team", "joined_spectators" );
...
getrespawndelay()
{
    var_0 = level.defenderflag scripts\mp\gameobjects::getownerteam();
...
onplayerkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_10 = level.ppkteamnoflag;

    if ( isdefined( level.defenderflag ) && level.defenderflag scripts\mp\gameobjects::getownerteam() == var_1.pers["team"] )
    {
        if ( isdefined( level.defenderflag.carrier ) && var_1 != level.defenderflag.carrier )
        {
            ...
            level.defenderflag.carrier thread scripts\mp\rank::giverankxp( "carrier_bonus", var_11 );
        ...
        var_10 = level.ppkteamwithflag;
    }
    else if ( isdefined( self.carryflag ) )
        var_10 = level.ppkflagcarrier;
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) && var_1.pers["team"] != self.pers["team"] )
    {
        ...
        if ( isdefined( self.carryflag ) )
        {
            ...
            thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_collect_vo_func, var_9, "carrying" );
        ...
        if ( !var_12 )
        {
            var_15 = 0;
            var_16 = 0;
            var_17 = distsquaredcheck( var_13, self.origin, level.defenderflag.curorigin );
            ...
            if ( var_15 )
            {
                ...
                thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_collect_vo_func, var_9, "defending" );
            ...
            else if ( var_16 )
            {
                ...
                var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
                var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
                thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_collect_vo_func, var_9, "assaulting" );
            }
        }
    }
