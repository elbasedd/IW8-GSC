...
cleanuparenamolotovs( var_0, var_1, var_2, var_3 )
{
    ...
    foreach ( var_6 in var_4 )
    {
        if ( isdefined( var_6 ) && scripts\mp\utility\player::isreallyalive( var_6 ) && var_6.team != self.team )
            cleanupallclones( var_6, var_2, var_3 );
    }
}
...
cleanupallclones( var_0, var_1, var_2, var_3 )
{
    ...
    {
        var_4 = scripts\mp\gametypes\br_public.gsc::bot_capture_hq_zone( self );
    ...
    if ( var_1 > 0 )
    {
        ...
        cleanupexplosionleftovers( var_0, var_3 );
    }
}

cleanupexplosionleftovers( var_0, var_1 )
{
    var_2 = var_0 getxuid();
    ...
    level thread start_trap_room( var_0, var_2, "death_or_disconnect" );
    level thread start_trap_room( var_0, var_2, undefined, var_1 );
}

start_trap_room( var_0, var_1, var_2, var_3 )
{
