...
ball_carrier_touched_goal( var_0 )
{
    ...
    {
        var_0 scripts\mp\utility\stats::setextrascore0( var_0.pers["touchdowns"] );
        var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "dunk", var_0.origin );
    }
...
ball_touched_goal( var_0 )
{
    ...
    if ( isdefined( self.lastcarrier ) )
    {
        ...
        if ( isplayer( self.lastcarrier ) )
        {
            ...
            self.lastcarrier thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "fieldgoal", self.lastcarrier.origin );
        }
    }
...
dogoalreset()
{
    ...
    level scripts\engine\utility::spotlight_min_dist_sq_from_node( 10, "goal_ready" );
