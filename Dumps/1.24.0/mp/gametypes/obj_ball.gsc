...
ball_on_pickup( var_0, var_1 )
{
    ...
    if ( var_4 )
    {
        ...
        else
        {
            ...
            if ( isplayer( var_0 ) )
                var_0 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "pickup_interception", var_0.origin );
        }
    }
    else
    {
...
ball_on_reset()
{
    ...
    thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "obj_return", var_0.baseorigin );
}
...
ball_return_home( var_0, var_1 )
{
    ...
    if ( istrue( level.possessionresetcondition ) )
    {
        if ( istrue( level.dmztutdropcash ) )
...
waitforreset( var_0 )
{
    ...
    if ( level.dmztutdropcash != 0 )
        scripts\mp\hostmigration::waitlongdurationwithhostmigrationpause( level.dmztutdropcash );
...
ball_location_hud()
{
    for (;;)
    {
        var_0 = scripts\engine\utility::spinning( "pickup_object", "dropped", "reset", "ball_ready" );
...
updatetimers( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_2 ) )
    {
        if ( istrue( level.dmztutdropcash ) && !istrue( level.ballreset ) )
            var_5 = 1000 * level.dmztutdropcash;
    }
