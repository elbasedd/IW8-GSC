...
main()
{
    ...
    {
        scripts\mp\gametypes\common.gsc::add_client_back_to_mask_after_delay();
...
setspecialloadout()
{
    ...
    if ( scripts\mp\utility\game::matchmakinggame() && getdvarint( "scr_dm_randomAONMelee", 1 ) > 0 )
    {
    ...
    level.aon_loadouts["allies"]["loadoutSecondary"] = var_0;
    ...
    level.aon_loadouts["allies"]["loadoutSecondaryVariantID"] = var_1;
