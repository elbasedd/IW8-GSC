...
initspawns()
{
    ...
    else if ( istrue( level.add_spawn_disable_struct ) )
...
domflags()
{
    ...
    foreach ( var_9 in var_6 )
    {
        ...
        isforcekillstreakprogressweapon( var_9 );
    ...
    foreach ( var_3 in level.objectives )
    {
        ...
        var_3 scripts\mp\gametypes\obj_dom.gsc::domflag_setneutral();
    }
    ...
    if ( level.codcasterenabled )
        thread shouldcrossbowhitmarker();
}
...
shouldcrossbowhitmarker()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.iscaliberattachment ) || var_1.iscaliberattachment != var_2 )
            {
                var_1 setisusingspecialist( var_2 );
                var_1.iscaliberattachment = var_2;
