...
main()
{
    level.latespawnsnatchtoc130 = ::latespawnsnatchtoc130;
}
...
popoffhelmet( var_0, var_1, var_2 )
{
    ...
    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        ...
        {
            var_14 = scripts\mp\gametypes\br_pickups.gsc::getitemdropinfo( var_4.origin, var_4.angles );
            var_4 delete();
...
latespawnsnatchtoc130( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
