...
main()
{
    ...
    if ( getdvarint( "scr_hotfoot", 0 ) != 0 )
        level.onplayerkilled = ::latetoinfil;
...
onstartgametype()
{
    ...
    if ( isdefined( level.goliath_init ) )
        [[ level.goliath_init ]]();
    else
        initspawns();
...
israndompistolloadouts()
{
    ...
    level.get_stealth_alert_music_alias = 0;
    var_0 = 0;
    ...
    for (;;)
    {
        ...
        {
            if ( !isdefined( var_2.get_stealth_broken_music_alias ) )
            {
                var_2.get_stealth_breaking_guilty_player_name = 0;
                var_2.get_stealth_broken_music_alias = var_2.origin;
                var_2._phonemorsesinglescriptableused = var_2.origin;
            }

            var_2.get_stealth_breaking_guilty_player_name = var_2.get_stealth_breaking_guilty_player_name + distancesquared( var_2.get_stealth_broken_music_alias, var_2.origin );
            var_2.get_stealth_broken_music_alias = var_2.origin;
        }
        ...
        if ( var_0 > 3.0 )
        {
            if ( level.get_stealth_alert_music_alias >= 2 )
            {
                level.get_stealth_alert_music_alias = 0;

                foreach ( var_2 in level.players )
                {
                    if ( !isdefined( var_2._phonemorsesinglescriptableused ) )
                        var_2._phonemorsesinglescriptableused = var_2.origin;

                    var_2.doors_opened_music = distancesquared( var_2._phonemorsesinglescriptableused, var_2.origin ) < 4225;
                    var_2._phonemorsesinglescriptableused = var_2.origin;
                }
            }
            ...
            foreach ( var_2 in level.players )
            {
                ...
                if ( isalive( var_2 ) && ( istrue( var_2.doors_opened_music ) || var_2.get_stealth_breaking_guilty_player_name < 4225 && !istrue( var_2.get_strafe_target_loc ) ) )
                {
                    var_2.doors_opened_music = 0;
...
latetoinfil( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
