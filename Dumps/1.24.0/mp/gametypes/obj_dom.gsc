...
setupobjective( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9.flagmodel.angles = buddyspawnplayer( var_9 );
...
dompoint_setcaptured( var_0, var_1 )
{
    ...
    if ( isdefined( self.assisttouchlist[var_0] ) )
    {
        ...
        foreach ( var_8 in var_6 )
        {
            ...
            var_9 scripts\cp\so_laststand::laststand_player_in_focus();
        }
    }
...
dompoint_onuse( var_0 )
{
    ...
    if ( !self.neutralized )
    {
        ...
        if ( isdefined( level.onobjectivecomplete ) )
        {
            ...
            var_5 = "Flag " + fire_rpg_to_target() + " Captured";

            if ( var_2 == "neutral" || var_2 == "none" )
                scripts\mp\utility\game::init_reach_wind_room( var_0, undefined, var_5, var_0.origin, "neutral_flag" );
            else
                scripts\mp\utility\game::init_reach_wind_room( var_0, undefined, var_5, var_0.origin );
        }
    }
...
dompoint_onuncontested( var_0 )
{
    ...
    var_2 = ( gettime() - self.carryobjects_onjuggernaut ) * 0.001;
    var_3 = "Flag " + fire_rpg_to_target() + " Contested";
    scripts\mp\utility\game::init_reach_wind_room( undefined, undefined, var_3, undefined, var_2 + " seconds" );
...
giveflagcapturexp( var_0, var_1, var_2 )
{
    ...
    if ( isplayer( var_3 ) )
    {
        ...
        var_3 thread scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.inside_bush, "capture", var_3.origin );
    }
