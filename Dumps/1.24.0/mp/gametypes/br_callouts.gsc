...
init()
{
    level.calloutglobals.jugg_removefromactivejugglist = [];
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            level.calloutglobals.jugg_removefromactivejugglist[var_11] = var_12;
        }
...
find_supply_station( var_0 )
{
    ...
    foreach ( var_4, var_3 in level.calloutglobals.jugg_removefromactivejugglist )
    {
