...
run_cleanup_funcs_for_unused_objectives()
{
...
watchhvts()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::array_sort_with_func( level.players, ::race_countdown_update );
        ...
        for ( var_3 = 0; var_3 < var_0.size; var_3++ )
        {
            ...
            {
                var_4 becomehvt();
                var_4.hideallunselectedextractpads = 1;
            }
        ...
        for ( var_3 = 0; var_3 < var_0.size; var_3++ )
        {
            ...
            if ( var_4 ishvt() )
            {
                if ( isdefined( var_4.hideallunselectedextractpads ) )
                {
                    var_4.hideallunselectedextractpads = undefined;
                    var_1--;
                    continue;
                }
