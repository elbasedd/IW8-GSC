...
main()
{
    ...
    level.brgetloadoutoptionforname = ::brgetloadoutoptionforname;
...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::init_range_targets( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::init_range_targets( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
awardcapturepoints()
{
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.usehprules )
        {
            ...
            if ( !istrue( level.player_retry_thread ) )
                add_rider_to_decho( var_3 );
