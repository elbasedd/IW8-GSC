...
default_on_damage_finished( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    {
        self notify( "pain" );
        scripts\asm\asm_mp::playanimwithdooropen();
    }
...
{
    var_10 = afkroundcounted( var_3, var_0 );
    ...
    if ( isdefined( self._blackboard.currentvehicle ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( self._blackboard.vehicledeathwait ) )
                ...
                self.body thread obj_leads_spawned_overall( self._blackboard.currentvehicle );
        }
    }
