...
incpersstat( var_0, var_1 )
{
    ...
    if ( isdefined( self.incrementobjectiveachievementkill[var_0] ) )
        self.incrementobjectiveachievementkill[var_0] = self.incrementobjectiveachievementkill[var_0] + var_1;
...
{
    if ( !isdefined( self.incrementobjectiveachievementkill[var_0] ) )
        self.incrementobjectiveachievementkill[var_0] = 0;
}
