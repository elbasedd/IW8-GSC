...
{
    scripts\engine\utility::spectatecommands( "death", "carried" );
...
killshouldaddtokillstreak( var_0 )
{
    ...
    return !scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) && !scripts\mp\utility\points::have_civilian( var_0 );
}
