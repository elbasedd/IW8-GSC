...
getweapongroup( var_0 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        if ( issuperweapon( var_0 ) )
            ...
            var_2 = "gamemode";
        else if ( handleplunderendgamesplash( var_0 ) )
            var_2 = "weapon_ballisticSpecial";
        else if ( has_headicon( var_0 ) )
...
attachmentsconflict( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( scripts/mp/trials/mp_oilrig_create_script( var_3, var_4 ) )
        return var_0;

    if ( scripts/mp/trials/mp_oilrig_create_script( var_4, var_3 ) )
        return var_0;
...
scripts/mp/trials/mp_oilrig_create_script( var_0, var_1 )
{
    var_2 = arena_bot_seek_dropped_weapon( var_0 );
    var_3 = arena_bot_pickup_weapon( var_1 );
...
{
    return handlesoloexclusionils( getweapongroup( var_0 ), var_0 );
}
...
{
    return handleteamplacement( getweapongroup( var_0 ), var_0 );
}

handleteamplacement( var_0, var_1 )
{
    switch ( var_0 )
    {
...
iscacprimaryorsecondary( var_0 )
{
    ...
    return handlesoloexclusionils( var_1, var_0 ) || handleteamplacement( var_1, var_0 );
}
...
{
    if ( isdefined( level.arena_bot_get_total_gun_ammo[var_0] ) )
        return level.arena_bot_get_total_gun_ammo[var_0];
...
{
    if ( isdefined( level.arena_bot_think_seek_dropped_weapons[var_0] ) )
        return level.arena_bot_think_seek_dropped_weapons[var_0];

    var_1 = attachmentmap_tobase( var_0 );

    if ( isdefined( level.arena_bot_out_of_ammo[var_1] ) )
        return level.arena_bot_out_of_ammo[var_1];
...
flash_crate_update_hint_logic_alt( var_0 )
{
    var_1 = randomintrange( 0, level.streakmatchlifeid[var_0].size );
    return level.streakmatchlifeid[var_0][var_1];
}
...
focus_fire_attacker_timeout( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = [];
    ...
    for (;;)
    {
        ...
        if ( !level.weaponlootmapdata[var_4].hasselfrevivetoken && !scripts\engine\utility::array_contains( var_1, var_2 ) )
...
fob_think( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = [];

    var_2 = 0;
    var_3 = focus_fire_attacker_timeout( var_0, var_1 );
...
stream_time( var_0, var_1 )
{
    ...
    if ( var_2 )
    {
        ...
        {
            var_4 = var_0 + "|" + var_1;
            var_3 = isdefined( level.weaponlootmapdata[var_4] ) && !level.weaponlootmapdata[var_4].hasselfrevivetoken;
        }
    }
...
attachmentlogsstats( var_0, var_1 )
{
    ...
    if ( !areanygulagfightsactive( var_1, var_0 ) )
        return 0;
...
areanygulagfightsactive( var_0, var_1 )
{
    ...
    return areas_remaining( var_2, var_1 );
}

areas_remaining( var_0, var_1 )
{
...
weaponbypassspawnprotection( var_0 )
{
    ...
    if ( iskillstreakweapon( var_0 ) && var_2 != "manual_turret_mp" && var_2 != "pac_sentry_turret_mp" && !hasspecialistbonus( var_2 ) )
        var_1 = 0;
...
hasspawnweapons( var_0 )
{
    ...
    return var_1 == "iw8_knifestab_mp" || var_1 == "iw8_knifestab_mp" || var_1 == "iw8_throwingknife_fire_melee_mp";
}
