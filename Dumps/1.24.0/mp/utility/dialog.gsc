...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.create_vehicle_vehicledata ) )
        return;

    if ( isdefined( level.isdisconnecting ) && self [[ level.isdisconnecting ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public.gsc::bot_capture_hq_zone( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && issubstr( var_0, "radar_drone_recon" ) )
            var_7 = "dx_bra_";
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public.gsc::bot_capture_hq_zone( self );
    ...
    if ( level.teambased )
    {
        var_5 = brevent3( var_0, 1 );
        var_6 = brevent3( var_0 );
