...
carriable_can_pickup( var_0, var_1 )
{
...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::set_showing_bomb_wire_pair_to_player( level.intel_active, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = br_pe_chopper_crates( var_2 );

    if ( !istrue( var_4 ) )
        module_has_data_for_call_count( var_9, var_2, level.waswinning );
    ...
    if ( !level.onlinegame )
        init_relic_laststand();
}

module_has_data_for_call_count( var_0, var_1, var_2 )
{
...
updateteamscore( var_0 )
{
    ...
    level thread shouldblockdamage();
}
...
processassist_regularmp( var_0, var_1, var_2 )
{
    ...
    thread scripts\cp\so_laststand::onplayerkillassist( var_0 );
}
