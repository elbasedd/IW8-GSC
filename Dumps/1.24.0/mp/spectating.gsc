...
onjoinedspectators( var_0 )
{
    ...
    if ( var_0 ismlgspectator() || isdefined( var_0.pers["mlgSpectator"] ) && var_0.pers["mlgSpectator"] )
    {
        ...
        var_0 thread player_give_intel_1_ks();
    }
}
...
autoattachtoplayer()
{
    ...
    level.hvt_visual_leaving_callout = game["lastSpectatedPlayer"];
    ...
    for (;;)
    {
        ...
        {
            if ( level.currentround > 1 && isdefined( level.hvt_visual_leaving_callout ) && self.team != "follower" )
                var_0 = level.hvt_visual_leaving_callout;
...
updatemlgspectator()
{
    ...
    for (;;)
    {
        if ( self ismlgspectator() && self isspectatingplayer() )
        {
            ...
            if ( isdefined( var_0 ) )
                level.hvt_visual_leaving_callout = var_0.clientid;
        }
...
player_give_intel_1_ks()
{
    ...
    game["lastSpectatedPlayer"] = level.hvt_visual_leaving_callout;
}
