...
{
    self endon( "disconnect" );
    var_1 = showintelscriptablestoplayer( var_0 );

    if ( isdefined( var_1 ) )
        thread activate_additional_ammo_crates( var_1 );
    else
    {
        var_2 = [ "death" ];
...
showintelscriptablestoplayer( var_0 )
{
    ...
    if ( scripts\engine\utility::string_starts_with( var_0.receiver, "me_hatchet" ) || scripts\engine\utility::string_starts_with( var_0.receiver, "me_sword" ) )
        return "bloodFX";
    else if ( scripts\engine\utility::string_starts_with( var_0.receiver, "me_kali" ) )
        return "bloodFXBlunt";
    else
        return undefined;
}
