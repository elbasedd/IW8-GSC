...
setupzombierespawnglobaltimer( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
setvalidreviveposition( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
last_grenade_fire_time( var_0, var_1 )
{
    if ( var_0 == -1 )
        return;
...
createobjective( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.teambased )
    {
        ...
        setupzombierespawnglobaltimer( var_5, self.owner );
