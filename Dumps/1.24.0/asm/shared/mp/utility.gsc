...
animscriptmp_internal( var_0, var_1, var_2, var_3 )
{
    ...
    scripts\asm\asm_mp::appliednukethreads();
...
allow_player_basejumping( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::appliednukethreads();
