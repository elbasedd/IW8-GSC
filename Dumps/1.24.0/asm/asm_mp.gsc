...
asm_init( var_0, var_1 )
{
    ...
    self.fnasm_playfacialanim = ::apcrespawntime;
    ...
    level.dointerrogationvo = ::allow_deleteme_on_path;
    level.dointrovo = ::allow_cp_munitions;
    level.doingcheck = ::allow_cp_munitions;
    hack_setup_a_struct();
    var_2 = var_0;
...
allow_deleteme_on_path( var_0, var_1, var_2, var_3 )
{
...
doorneedstoclose( var_0 )
{
    ...
    var_4 = angleclamp180( var_3 - var_0.card_angles[1] );
    var_5 = angleclamp180( var_0.angles[1] - var_0.card_angles[1] );
...
apcrespawntime( var_0, var_1, var_2 )
{
