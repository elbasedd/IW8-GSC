...
waitforentervehicle()
{
    var_0 = scripts\engine\utility::_id_12909( "entervehicle", "death", "long_death", "failedentervehicle" );
...
exitingvehicle()
{
    ...
    self._blackboard.currentvehicle.create_seatids_override = 0;
    self._blackboard.currentvehicle thread headlessopindex();
}
...
headlessopindex()
{
    self endon( "death" );
    waitframe();
    self.create_seatids_override = 1;
}
