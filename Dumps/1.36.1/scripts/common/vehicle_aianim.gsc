...
guy_runtovehicle_loaded( var_0, var_1 )
{
    ...
    if ( !getdvarint( "enable_vehicle_ai_using_BT" ) )
    {
        var_2 = var_0 scripts\engine\utility::_id_12908( "long_death", "death", "enteredvehicle" );
...
{
    scripts\engine\utility::_id_128FF( "unload", "death" );
...
guy_unload_que( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_128FF( "death", "jumpedout" );
    ...
    if ( !self.unloadque.size )
    {
        ...
        self.getbestspectatecandidate = undefined;
    }
}
...
trial_active_fob()
{
    if ( isdefined( self.getbestspectatecandidate ) )
        return;

    self.getbestspectatecandidate = [];
    ...
    for ( var_0 = 0; var_0 < level.vehicle.templates.aianims[scripts\common\vehicle_code::get_vehicle_classname()].size; var_0++ )
    {
        ...
        if ( isdefined( var_1.vehicle_getoutanim ) )
        {
            ...
            self.getbestspectatecandidate[var_2] = spawnstruct();
            self.getbestspectatecandidate[var_2].open = 0;
            self.getbestspectatecandidate[var_2].signalomnvar = 0;
        }
    }
}
...
wait_for_open_door( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.vehicle_getoutanim ) )
    {
        ...
        if ( !self.getbestspectatecandidate[var_2].open )
        {
            ...
            self.getbestspectatecandidate[var_2].open = 1;
        }
