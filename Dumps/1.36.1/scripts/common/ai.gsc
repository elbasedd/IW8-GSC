...
arenavday( var_0 )
{
    if ( !isdefined( self._blackboard.armor_target_vo ) )
    {
        self._blackboard.armor_target_vo = 1;
        self._blackboard.armor_piercing = var_0;
        return 1;
    }
...
arenastpday()
{
    if ( isdefined( self._blackboard.armor_target_vo ) && self._blackboard.armor_target_vo == 1 )
        self._blackboard.armor_target_vo = 2;
}

arenaloadouts_getoverrideweaponswithgroup()
{
    if ( isdefined( self._blackboard.armor_target_vo ) )
    {
        if ( self._blackboard.armor_target_vo == 1 )
        {
            self._blackboard.armor_target_vo = undefined;
            self._blackboard.armor_piercing = undefined;
            return 1;
        }
        else if ( self._blackboard.armor_target_vo == 2 )
        {
            self._blackboard.armor_target_vo = 3;
            return 1;
        }
    }
...
arenapickupattachments()
{
    if ( isdefined( self._blackboard.armor_target_vo ) && self._blackboard.armor_target_vo == 3 )
    {
        self._blackboard.armor_target_vo = undefined;
        self._blackboard.armor_piercing = undefined;
    }
...
aq_playerdisconnect( var_0, var_1 )
{
    if ( !isdefined( var_0 ) || !isalive( var_0 ) )
        return;

    var_2 = var_0 arenavday( var_1 );
...
any_player_in_laststand( var_0 )
{
    ...
    var_1 = var_0 arenaloadouts_getoverrideweaponswithgroup();
