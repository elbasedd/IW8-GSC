...
_id_11BB7( var_0 )
{
    if ( var_0.basename == "molotov" || var_0.basename == "molotov_mp" || istrue( var_0.play_priming_anim ) )
        return 1;
...
wasdamagedbyexplosive()
{
    if ( isdefined( self.damagemod ) )
    {
        ...
        if ( isdefined( self.damageweapon ) && _id_11BB7( self.damageweapon ) )
            return 1;
...
allow_init()
{
    ...
    allow_add( "offhand_throwback", ::atv_vehicle );
    ...
    allow_add( "cp_munitions", ::attraction_sr_range_hud );
    allow_add( "nvg", ::atv_trail );
    allow_add( "ascender_use", ::attackpressed );
}
...
attraction_sr_range_hud( var_0, var_1 )
{
...
_id_12456( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( !isdefined( var_0 ) )
        return;
