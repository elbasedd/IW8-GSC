...
scriptable_door_postinit()
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        var_2.disablebunker11cachelocations = var_4;
        var_2.disablearmorykiosk = var_2.angles;
    }
}
...
system_init()
{
    ...
    scripts\engine\scriptable::winindex( "door", ::scriptable_door_scriptable_used_callback );
