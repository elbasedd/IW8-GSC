...
_id_12909( var_0, var_1, var_2, var_3 )
{
...
_id_1290A( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_1290B( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_1290C( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
_id_12910( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_12911( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_12912( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_12915( var_0, var_1, var_2, var_3 )
{
...
_id_12916( var_0, var_1, var_2, var_3, var_4 )
{
...
_id_12917( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
_id_12918( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( ( !isdefined( var_1 ) || var_1 != "death" ) && ( !isdefined( var_2 ) || var_2 != "death" ) && ( !isdefined( var_3 ) || var_3 != "death" ) && ( !isdefined( var_4 ) || var_4 != "death" ) && ( !isdefined( var_5 ) || var_5 != "death" ) && ( !isdefined( var_6 ) || var_6 != "death" ) )
        self endon( "death" );
...
_id_1291B( var_0, var_1, var_2, var_3 )
{
    var_4 = spawnstruct();
...
_id_1291C( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
_id_1291D( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = spawnstruct();
...
_id_12901( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_12902( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_12903( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_12904( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
_id_12905( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    if ( isdefined( var_1 ) )
        self endon( var_1 );
...
deletestruct_ref( var_0 )
{
    ...
    if ( isdefined( level.struct ) )
    {
        if ( level.struct.size > 5000 )
        {
            ...
            var_9 = 0;
            var_10 = var_8;
            vehicle_showteamtanks( var_0, var_9, var_10 );
            ...
            vehicle_showteamtanks( var_0, 0, level.struct.size );
    }
}

vehicle_showteamtanks( var_0, var_1, var_2 )
{
...
{
    var_3 = var_1 _id_12907( var_2, "death" );
...
flag_wait_either_return( var_0, var_1 )
{
    for (;;)
    {
        ...
        var_2 = level _id_12907( var_0, var_1 );
        return var_2;
    }
}
...
flag_wait_any_return( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    for (;;)
    {
        ...
        var_6 = level _id_1290A( var_0, var_1, var_2, var_3, var_4 );
        return var_6;
    }
}
...
gw_fobs_init( var_0, var_1, var_2, var_3 )
{
...
player_is_just_guessing( var_0, var_1, var_2 )
{
...
vehicle_travel_player_disconnect_monitor( var_0 )
{
...
player_current_primary_is_rpg()
{
    ...
    if ( is_player_gamepad_enabled() )
        var_1 = vehicle_travel_player_disconnect_monitor( "mountButtonConfig" );
    else
        var_1 = vehicle_travel_player_disconnect_monitor( "mountButtonConfigKBM" );
