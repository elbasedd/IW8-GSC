...
init()
{
    scripts\engine\scriptable::winindex( "military_ammo_restock", ::battle_stations );
...
battle_stations( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        if ( cancelled( var_3 ) )
        {
            if ( scripts\mp\flags::gameflag( "prematch_done" ) && ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "risk" ) )
                var_0 disablescriptableplayeruse( var_3 );
            else
                thread battle_station_combat_logic( var_0, var_3, 5 );
        }
        else
            thread battle_station_combat_logic( var_0, var_3, 0.1 );
    }
...
battle_station_combat_logic( var_0, var_1, var_2 )
{
...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons.gsc::carepackage_get_dropped_entities( var_9, 2 );
            continue;
        }

        var_21 = scripts\mp\weapons::getammooverride( var_9 );

        if ( scripts\mp\utility\weapon::platform_cleanup_on_death( var_9 ) )
        {
...
cancelled( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::player_complete_trial( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons.gsc::carepackage_get_dropped_entities( var_8, 2 );
            var_1 = 1;
        }
    }
