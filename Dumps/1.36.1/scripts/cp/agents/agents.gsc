...
{
    level thread coverreloadnotetrackhandler();
}
...
convoy_anim_sequence( var_0, var_1 )
{
    ...
    var_2 thread _watchtoautoclosemenu( var_5 );
    _watchforcircleclosure( "Enemy switched to danger" );
}
...
_watchtoautoclosemenu( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( _utilflare_isvalidflaretype( var_0 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( var_7 && _stop_spawn_modules( var_6, var_3 ) )
            {
                if ( isdefined( level.registercarryobjectpickupcheck ) && getdvar( "scr_br_gametype", "" ) == "kingslayer" && scripts\engine\utility::array_contains( level.registercarryobjectpickupcheck, var_6 ) )
                ...
                var_5 = var_6;
                _watchforcircleclosure( "Enemy tracked!" );

                if ( !istrue( var_2 ) )
                    var_6.player_ammo_crate_hint_watcher = 1;
            }

            var_3 thread correctcodeentered( var_0, var_6 );
    ...
    else if ( var_0 == 0 )
    {
        if ( getdvarint( "scr_calloutmarkerping_navigation_proximity_cancel", 0 ) )
            var_3 thread cooldownsec();
    }
    else if ( var_0 == 8 )
    {
        var_8 = var_3 calloutmarkerping_getent( var_0 );
        var_3 thread correctcodeentered( var_0, var_8 );
        var_3 thread cop_car_initdamage( var_0, var_8 );
    }
    else if ( var_0 == 7 )
    {
        ...
        {
            var_3 thread countdowntimer( var_0, var_9 );
            var_3 thread countdownendcallback( var_0, var_9 );
        }
    }
    else if ( var_0 == 12 )
        var_3 thread cosfov( 12, var_1 );

    if ( !isdefined( var_5 ) )
        var_4 = var_3 convoy_handle_stuck_compromise( var_0 );

    _watchforcircleclosure( "Timeout value before wait: " + var_4 + " | poolID: " + var_0 );
    wait( var_4 );

    if ( isdefined( var_5 ) && isdefined( var_3 ) )
    {
        if ( isdefined( var_5.player_ammo_crate_hint_watcher ) )
            var_5.player_ammo_crate_hint_watcher = undefined;

        var_3 thread convoy_anim_sequence( var_0, var_5 );
    }
    else
    {
        _watchforcircleclosure( "Pool timed out: " + var_0 );
...
_waitforlui()
{
    ...
    for (;;)
    {
        ...
        _watchforcircleclosure( "Notification " + var_1 + " on pool " + var_2 );

        switch ( var_1 )
        {
            case "calloutmarkerping_added":
                var_0 _setplayerteamrank( var_2 );
                break;
            case "calloutmarkerping_cleared":
                var_0 _start_rooftop_raid_exfil( var_2 );
                break;
            case "calloutmarkerping_acknowledged":
                var_0 _setclientkillstreakavailability( var_2, var_3 );
                break;
            case "calloutmarkerping_acknowledged_cancel":
                var_0 _setclientkillstreakindexes( var_2 );
                break;
            case "calloutmarkerping_enemy_repinged":
                var_0 _start_rooftop_raid_heli( var_2 );
                break;
            case "map_ping_delete_marker":
                var_0 _start_rooftop_raid_sats();
                break;
            case "br_inventory_slot_request":
                var_0 _start_rooftop_obj( var_2 );
                break;
            default:
                break;
        }
...
calloutmarkerping_initplayer()
{
    ...
    if ( !isdefined( var_0.cprooftopcratecapturecallback ) )
        var_0.cprooftopcratecapturecallback = [];

    if ( !isdefined( var_0.countlefthand ) )
        var_0.countlefthand = [];

    var_0 thread _waitforlui();
}
...
_stop_spawn_modules( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
_tmtyl_bomber_squadafterspawnfunc( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
_startragdollwithvehiclefeature( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
convoy4_mortar_guys( var_0, var_1 )
{
...
cop_car_initomnvars( var_0 )
{
    var_1 = self;

    if ( !convoy4_mortar_guys( var_1 ) )
        return;
    ...
    if ( var_2 )
    {
        ...
        if ( var_3 == var_0 )
        {
            var_1 coop_escort_get_vehicle_driver_hint_string_func( "br_ping_cancel", 12 );
            return;
        }
    }
    ...
    var_1 thread _watchtoautoclosemenu( 12, var_0 );
    var_1 thread cpoperationcratecapturecallback( var_0 );
}

cpoperationcratecapturecallback( var_0 )
{
    var_1 = self;
    wait( getdvarfloat( "scr_calloutmarkerping_delay_between_vo_and_sfx_secs_inventory", 0.5 ) );
    var_2 = killplayerinstant( var_0 );

    if ( isdefined( var_2 ) && isdefined( var_1 ) )
        var_1 cp_raid_complex_behavior( var_2, 12 );
}

_questtimerwait( var_0 )
{
    var_1 = self;
...
cover_guys_debug( var_0 )
{
    ...
    if ( _utilflare_lerpflare( var_0 ) )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_8 = _x1opsassignnpctoteam( var_4 );
        }
        ...
        {
            if ( _startragdollwithvehiclefeature( var_4.entity ) )
                var_3 = "ping_killstreaks_carepkg";
            else if ( istrue( var_4.entity.isjuggernaut ) )
                var_3 = "ping_killstreaks_juggernaut";
            else if ( _tmtyl_bomber_squadafterspawnfunc( var_2 ) )
                var_3 = "ping_plunder_bank";
            else if ( _start_spawn_modules( var_4.entity ) )
                var_3 = "ping_vehicle_heavy";
            else if ( istrue( var_4.entity.player_tanks_spawned ) )
                var_3 = "ping_pickup_generic";
        }
        else
            var_3 = var_1 cp_arms_dealer_sound_load( var_0, var_2 );
    }
    else if ( _utilflare_isvalidflaretype( var_0 ) )
        var_3 = var_1 coverupmodels( var_0, var_2 );
    else if ( _utilflare_flareexplode( var_0 ) )
    ...
    else
    {
        switch ( var_0 )
        {
            case 0:
                ...
                break;
            case 8:
                var_3 = var_1 cp_dntsk_raid_sound_load( var_0, var_2 );
                break;
            case 7:
                var_3 = var_1 cp_dntsk_raid_specific_init( var_0 );
                break;
            default:
                break;
        }
    ...
    var_1 cp_raid_complex_behavior( var_3, var_0 );
}

_unlinkcorpsefromvehicle( var_0 )
{
    ...
    else if ( _utilflare_isvalidflaretype( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
        {
            if ( _stop_spawn_modules( var_1, self ) )
            {
...
cp_dntsk_raid_sound_load( var_0, var_1 )
{
    var_2 = self;
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "ping", "ping_cp_getCPVehicleCallout" ) )
    {
        ...
        if ( isdefined( var_4 ) && istrue( var_4.clear_tier_lights ) )
            return var_4._id_1285A;
    }

    if ( !isdefined( var_3.vehiclename ) )
        return "ping_vehicle_concat_no_driver";

    var_5 = _tryusehoverjetfromstructinternal( var_3, var_2.team );
...
cp_dntsk_raid_specific_init( var_0 )
{
    ...
    switch ( var_8 )
    {
        ...
        case "blueprintextract":
            if ( var_1 covertransitionrate( "ping_objective_contract" ) )
...
cp_arms_dealer_sound_load( var_0, var_1 )
{
    ...
    if ( !isdefined( var_6 ) )
    {
        ...
        {
            if ( var_2 covertransitionrate( "ping_vehicle_cash_deposit_helo" ) )
    ...
    {
        if ( var_2 covertransitionrate( "ping_pickup_fieldupgrade" ) )
    ...
    else if ( issubstr( var_6, "CONTRACT" ) )
    {
        ...
        if ( var_9 != "" && !var_2 covertransitionrate( var_9 ) )
            var_9 = "";
    ...
    {
        if ( var_2 covertransitionrate( "ping_gasmask" ) )
            var_9 = "ping_gasmask";
        else
            var_9 = "ping_pickup_generic";
    }
    ...
    {
        if ( var_2 covertransitionrate( "ping_loot_accesscard" ) )
    ...
    {
        if ( var_2 covertransitionrate( "ping_cash_deposit_balloon" ) )
...
coverupbrokenmodels( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( !isdefined( var_7 ) )
    {
        ...
        {
            if ( var_2 covertransitionrate( "ping_plunder_bank_confirm" ) )
    ...
    if ( issubstr( var_7, "CONTRACT" ) )
    {
        ...
        if ( var_10 != "" && !var_2 covertransitionrate( var_10 ) )
            var_10 = "";
    ...
    {
        if ( var_2 covertransitionrate( "ping_gasmask_confirm" ) )
            var_10 = "ping_gasmask_confirm";
    }
    else if ( issubstr( var_7, "ARMORY_KIOSK" ) )
    {
        if ( var_2 covertransitionrate( "ping_plunder_vendor_confirm" ) )
            var_10 = "ping_plunder_vendor_confirm";
    }
    else if ( issubstr( var_7, "_PLUNDER_EXTRACT" ) )
    {
        if ( var_2 covertransitionrate( "ping_cash_deposit_confirm" ) )
...
calloutmarkerping_removecallout( var_0 )
{
    ...
    _watchforcircleclosure( "Remove Callout ID Start: " + var_0 );
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        _watchforcircleclosure( "Remove Callout ID Notify: " + var_0 );
        var_1 notify( "predictiveCalloutClear_" + var_0 );
    }
}

countdowntimer( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            _watchforcircleclosure( "gscObjectiveStartedProgress: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
countdownendcallback( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) && var_2 == var_1 )
        {
            _watchforcircleclosure( "gscObjectiveDeleted: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
correctcodeentered( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    _watchforcircleclosure( "Watch Entity Death or Enemy Disconnect: " + var_0 );
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        var_1 scripts\engine\utility::_id_12900( "death", "pickup", "explode" );

    if ( isdefined( var_1.player_ammo_crate_hint_watcher ) )
        var_1.player_ammo_crate_hint_watcher = undefined;
...
{
    self endon( "predictiveCalloutClear_" + var_0 );
    _watchforcircleclosure( "watchPlayerDeathOrDisconnect: " + var_0 );
    var_2 = killoff_vis_passed( var_1 );
    scripts\engine\utility::_id_128FF( "death_or_disconnect", "self_pickedupitem_" + var_2 );
    calloutmarkerping_removecallout( var_0 );
}
...
calloutmarkerping_watchscriptabledeath( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    _watchforcircleclosure( "Watch scriptable death ID: " + var_0 );
    ...
    else if ( var_1.type == "equip_fulton_mp" )
    {
        ...
        var_2 scripts\engine\utility::_id_128FF( "death", "fulton_takeoff" );
    }
    else
        level scripts\engine\utility::_id_12902( "pickedupweapon_kill_callout_" + var_1.type + var_1.origin, "lootcache_opened_kill_callout" + var_1.origin, "dropbag_kill_callout_" + var_1.origin, "tablethide_kill_callout_" + var_1.origin, "carriable_kill_callout_" + var_1.origin );

    _watchforcircleclosure( "Watch scriptable death Remove ID: " + var_0 );
    calloutmarkerping_removecallout( var_0 );
}
...
convoy_handle_stuck_compromise( var_0 )
{
    ...
    if ( _tmtylsquadafterspawnfunc( var_0 ) )
        var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
    else if ( _utilflare_lerpflare( var_0 ) )
    {
        if ( _testing_ending( var_0 ) )
            var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
        else if ( convoy_start_5b( var_0 ) )
...
calloutmarkerping_onplayerdisconnect( var_0 )
{
    ...
    var_0 coop_handle_invuln_ac130();
}

course_triggers_expl( var_0, var_1 )
{
    var_2 = self;
...
cp_landlord_sound_load( var_0 )
{
    ...
    if ( !isdefined( var_1.cprooftopcratecapturecallback[var_0] ) )
        return 0;

    return 1;
}

cp_is_point_on_right( var_0, var_1, var_2, var_3 )
{
    var_4 = self;
    var_5 = var_4.cprooftopcratecapturecallback.size;

    if ( var_5 > 10 )
        return 0;

    var_6 = var_4 course_triggers_expl( var_0, var_3 );
    var_7 = var_6 + var_1;
    var_8 = spawnstruct();
    var_8._id_11CEB = var_7;
    var_8.poolid = var_0;
    var_8.create_opaque_ai_contents = 0;
    var_4.cprooftopcratecapturecallback[var_2] = var_8;
    return 1;
}

courtyard_intel_sequence( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( istrue( var_3.get_focus_fire_damage_multiplier ) )
        return 0;

    var_4 = gettime();
    var_5 = "pool" + var_0;
    var_6 = var_3 cp_landlord_sound_load( var_5 );

    if ( var_6 )
    {
        var_7 = var_3.cprooftopcratecapturecallback[var_5]._id_11CEB;

        if ( var_4 >= var_7 )
        {
            var_8 = var_3 cp_is_point_on_right( var_0, var_4, var_5, var_2 );
            return istrue( var_8 );
        }

        if ( var_1 == "ping_response_cancel" && var_3.cprooftopcratecapturecallback[var_5].create_opaque_ai_contents == 0 )
        {
            var_3.cprooftopcratecapturecallback[var_5].create_opaque_ai_contents = 1;
            return 1;
        }
...
coverreloadnotetrackhandler()
{
    ...
    for (;;)
    {
        ...
        for ( var_1 = 0; var_1 < level.players.size; var_1++ )
        {
            ...
            if ( !isdefined( var_2 ) || !isdefined( var_2.cprooftopcratecapturecallback ) )
                continue;

            foreach ( var_5, var_4 in var_2.cprooftopcratecapturecallback )
            {
                if ( var_0 > var_4._id_11CEB )
                    var_2.cprooftopcratecapturecallback[var_5] = undefined;
            }
        }
    }
}

cp_is_point_in_front( var_0, var_1, var_2, var_3 )
{
    var_4 = 0;
...
coop_escort_get_vehicle_driver_hint_string_func( var_0, var_1 )
{
    var_2 = self;
    ...
    foreach ( var_7 in var_5 )
    {
        ...
        if ( isdefined( var_8.playerentercombatarea ) )
            var_8 delete();
    }
}
...
{
    var_1 = self;
    var_2 = var_1 cp_dwn_twn_2_sound_load( var_0 );
    var_3 = var_1 cp_friendlyfire_enabled( var_0 );
...
cp_raid_complex_behavior( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    var_5 = var_4 cp_dwn_twn_2_sound_load( var_0 );
    var_6 = var_4 cp_friendlyfire_enabled( var_0 );
    var_7 = soundexists( var_5 );
    var_8 = soundexists( var_6 );
    var_9 = cp_is_point_in_front( var_7, var_5, var_8, var_6 );
    var_10 = var_4 courtyard_intel_sequence( var_1, var_0, var_9 );
...
cooldownsec()
{
    ...
    for (;;)
    {
        ...
        if ( var_6 < var_3 )
        {
            coop_escort_get_vehicle_driver_hint_string_func( "br_ping_cancel", 0 );
...
coop_escort_try_start_driving_func( var_0 )
{
    ...
    {
        var_3 coop_handle_invuln_ac130();
...
cpoperationcrateactivatecallback( var_0 )
{
    ...
    var_1 coop_escort_get_vehicle_driver_hint_string_func( "br_ping_cancel", var_0 );
    wait( getdvarfloat( "scr_calloutmarkerping_delay_between_vo_and_sfx_secs_cleared", 0.5 ) );

    if ( isdefined( var_1 ) )
        var_1 cp_raid_complex_behavior( "ping_response_cancel", var_0 );
}

cp_vehicle_damage_monitor( var_0 )
{
    var_1 = self;
    var_1 cpoperationcrateactivatecallback( var_0 );
}
...
cp_smuggler_sound_load( var_0, var_1 )
{
    ...
    if ( _utilflare_lerpflare( var_0 ) )
    {
        ...
        var_4 = var_2 coverupbrokenmodels( var_0, var_3, var_1 );
    }
    else if ( _utilflare_isvalidflaretype( var_0 ) )
    ...
    else
    {
        ...
        {
            case 0:
                if ( var_1 covertransitionrate( "ping_generic_ping_response" ) )
            ...
            case 7:
                ...
                break;
            case 8:
                if ( var_1 covertransitionrate( "ping_vehicle_confirm" ) )
    ...
    if ( isplayer( var_1 ) )
        var_2 cp_raid_complex_behavior( var_4, var_0, var_1 );
    else if ( isdefined( var_2 ) )
        var_2 cp_raid_complex_behavior( var_4, var_0 );
}

cpcpammoarmorcratecapturecallback( var_0 )
{
    var_1 = self;
    ...
    if ( isdefined( var_1 ) )
        var_1 cover_guys_debug( var_0 );
}

convoy_start_5b( var_0 )
{
    var_1 = self;
    var_2 = var_1 calloutmarkerping_getent( var_0 );

    if ( isdefined( var_2 ) && isdefined( var_2._id_120F6 ) )
        return 1;

    return 0;
}

_testing_ending( var_0 )
{
    var_1 = self;
    var_2 = var_1 calloutmarkerping_getent( var_0 );
    ...
    if ( isdefined( var_2 ) && isdefined( var_2.classname ) && issubstr( var_2.classname, "scriptable" ) && !isdefined( var_2.entity ) && var_2 getscriptableisreserved() )
    {
        if ( var_2 _meth_87B7() )
        {
            ...
            return scripts\mp\trials\mp_trl_gunslinger_knife_create_script::piccadilly_spawnpatchtriggers( var_3 );
        }
    }
...
cop_car_initdamage( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    var_2 = 0.25;
    ...
    for (;;)
    {
        var_5 = _x1opsnpcpulsecheckteamnearby( var_0, var_1, var_4 );
        ...
        var_6 = _tryusehoverjetfromstructinternal( var_1, var_4 );
        ...
        if ( var_6 )
        {
            ...
            if ( var_3 >= 3 )
            {
                ...
                if ( isdefined( var_7 ) )
                    thread convoy_anim_sequence( var_0, var_7 );
                else
                    calloutmarkerping_removecallout( var_0 );
...
_x1opsnpcpulsecheckteamnearby( var_0, var_1, var_2 )
{
    var_3 = self;
    var_4 = 0;
...
_tryusehoverjetfromstructinternal( var_0, var_1 )
{
...
_redbuttonused_internal( var_0 )
{
    var_1 = self;

    if ( !isdefined( var_1.countlefthand ) )
        var_1.countlefthand = [];

    if ( !isdefined( var_1.countlefthand[var_0] ) )
        var_1.countlefthand[var_0] = 0;
    else
        var_1.countlefthand[var_0]++;

    var_2 = [];
    var_2[var_2.size] = "ping_id";
    var_2[var_2.size] = var_1.countlefthand[var_0];
...
_safecircledurationforplayer()
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        {
            if ( var_0 calloutmarkerping_getactive( var_1 ) )
                var_0 _runmovequestlocale( var_1, "clear_all" );
        }
    }
}
...
_runmovequestlocale( var_0, var_1 )
{
    ...
    var_3[var_3.size] = var_2.countlefthand[var_0];
...
_start_rooftop_raid_exfil( var_0 )
{
    var_1 = self;
    var_1 _runmovequestlocale( var_0, "clear_single" );
    var_1 notify( "predictiveCalloutClear_" + var_0 );
    var_1 thread cpoperationcrateactivatecallback( var_0 );
}

_setclientkillstreakavailability( var_0, var_1 )
{
    var_2 = self;
    var_2 thread _watchtoautoclosemenu( var_0, 0, 1 );
    var_2 thread cp_smuggler_sound_load( var_0, var_1 );
...
{
    var_1 = self;
    var_1 thread cp_vehicle_damage_monitor( var_0 );
}

_setplayerteamrank( var_0 )
{
    var_1 = self;

    if ( istrue( level.nocrash ) && !istrue( var_1 istacmapactive() ) )
    {
        calloutmarkerping_removecallout( var_0 );
        return;
    }

    var_1 _redbuttonused_internal( var_0 );
    var_1 thread _watchtoautoclosemenu( var_0 );
    var_1 _questtimerwait( var_0 );
    var_1 thread cpcpammoarmorcratecapturecallback( var_0 );
    var_1 _unlinkcorpsefromvehicle( var_0 );
...
_start_rooftop_raid_heli( var_0 )
{
    var_1 = self;
    var_1 thread _watchtoautoclosemenu( var_0, 0, 1 );
    var_1 coop_escort_get_vehicle_driver_hint_string_func( "br_ping_enemy", var_0 );
}

_start_rooftop_raid_sats()
{
    var_0 = self;
    var_1 = _validateitempurchase();

    if ( var_1 != -1 )
    {
        var_0 _safecircledurationforplayer();
        var_0 coop_escort_get_vehicle_driver_hint_string_func( "br_ping_cancel", var_1 );
        var_0 cp_raid_complex_behavior( "ping_response_cancel", var_1 );
    }

    var_0 coop_handle_invuln_ac130();
}

_start_rooftop_obj( var_0 )
{
    var_1 = self;
    var_1 thread cop_car_initomnvars( var_0 );
}
