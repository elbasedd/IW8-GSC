...
callbacksoldieragentdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( istrue( self.brcirclebattlechatter ) )
    {
        if ( _id_11BB6( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 ) )
            return;
    ...
    if ( var_32 )
    {
        if ( istrue( self.pavelow_boss_hit_by_emp ) )
        {
            var_2 = 0;
    ...
    if ( var_22 )
    {
        ...
        {
            if ( var_24 )
                var_2 = ammo_cache_think( var_2, var_5, var_17, var_4, var_1 );
        }
    ...
    if ( var_22 || var_23 || var_30 )
    {
        if ( isdefined( var_12 ) )
        {
            ...
            amounttotal( self, var_1, var_0, var_12, var_2, var_6, var_7, var_8, var_9, var_4 );
        }
...
callbacksoldieragentgametypekilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( isdefined( self.eyeonnotehandler ) )
    {
        var_9 = spawnstruct();
        ...
        thread [[ self.eyeonnotehandler ]]( var_9 );
    }
...
ammo_cache_think( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_0;
...
amounttotal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
...
process_damage_feedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_14 ) && var_14 != var_10 && var_2 + var_11 + var_12 > 0 && ( !isdefined( var_8 ) || var_8 != "shield" ) )
    {
        ...
        if ( isdefined( var_10.infectbonussuperontacinsert ) && var_10.infectbonussuperontacinsert.size > 1 )
...
_id_11BB6( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_0 ) && ( issubstr( var_13, "thermite" ) || isdefined( var_12.magazine ) && issubstr( var_12.magazine, "boltfire" ) || isdefined( var_0.weapon_name ) && issubstr( var_0.weapon_name, "incendiary" ) ) )
    {
        ...
        if ( var_15 )
        {
            ...
            {
                self.brcirclecoughnexttime = 1;
                self._id_12203 = 0;
            }
        }
        else if ( var_8 != "none" )
        {
            self.brcirclecoughnexttime = undefined;
            self._id_12203 = undefined;
        }
    }
    ...
    else if ( var_8 == "none" && isdefined( var_0 ) )
    {
        ...
        if ( istrue( self.brcirclecoughnexttime ) && var_14 && isdefined( var_23 ) && var_23 == self )
        {
            if ( !isdefined( self._id_12205 ) )
                self._id_12205 = [ var_0 ];
            else if ( !scripts\engine\utility::array_contains( self._id_12205, var_0 ) )
                self._id_12205[self._id_12205.size] = var_0;
