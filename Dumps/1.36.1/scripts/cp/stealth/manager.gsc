...
init()
{
    level.his_respawn = getdvarint( "online_challenge_filter_shared_advanced", 1 ) != 0;
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "canSendT9UserEvent", ::create_vehicle_interact );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onAgentKilled", ::setupsoccerball );
}
...
lb_pitch_roll_dmg_threshold( var_0 )
{
    if ( !isdefined( level._id_120ED ) )
    {
        var_1 = "loot/battlepass_season" + level.cypher_iconid + ".csv";
        ...
        level._id_120ED = var_3;
    }

    for ( var_5 = 1; var_5 < level._id_120ED.size; var_5++ )
    {
        if ( level._id_120ED[var_5] >= var_0 )
            break;
    }

    if ( var_5 > level._id_120ED.size )
        var_5 = level._id_120ED.size;
...
create_vehicle_interact( var_0 )
{
    ...
    if ( var_2 >= 0 )
    {
        if ( !level.his_respawn )
            return 1;

        var_1 = 1;

        if ( playerclearspectatekillchainsystem( var_2 ) )
            return 0;

        if ( !player_gassed_effects( var_2 ) )
            return 0;
        ...
        if ( var_3 == "GUNSMITH" )
        {
            ...
            if ( var_4 != "" )
            {
                var_5 = scripts\mp\rank::level_create_timer( var_4 );
                var_6 = scripts\mp\weaponrank::lbravo_actor_keep_anim_loop( var_5 );
    ...
    else
    {
        ...
        if ( var_2 >= 0 )
        {
            ...
            if ( playerclearspectatekillchainsystem( var_10 + var_2 ) )
                return 0;
...
setupsoccerball( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    {
        var_1 thread scripts\mp\events::bomber_disable_movement_for_time( var_12.lifeid, self, var_6, var_5, var_0, var_12 );
        var_13 = 0;
        var_14 = 0;
        ...
        var_2 thread scripts\cp\agents\gametype_cp_specops::setupsoccerball( var_0, var_1, var_3, var_4, var_5, var_6, var_8, var_13, var_14 );
    }
}
