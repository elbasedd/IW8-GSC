...
gunship_startuse( var_0, var_1 )
{
    ...
    var_9 thread loop_station_closed_vo( var_0 );
    var_9 thread loopsound_origin( var_0, "disconnect" );
    var_9 thread loopsound_origin( var_0, "joined_team" );
    var_9 thread loopsound_origin( var_0, "joined_spectators" );
    var_9 thread loopsound_origin( var_0, "team_kill_punish" );
...
gunship_playintro( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gunship_islargemap() )
    {
        ...
        else if ( isdefined( level.loop_respawn_ready_splash ) )
            level.gunship.origin = level.loop_respawn_ready_splash;
        else
    ...
    level.gunship_intromodel thread looping_path( "disconnect", var_1 );
    level.gunship_intromodel thread looping_path( "joined_team", var_1 );
    level.gunship_intromodel thread looping_path( "joined_spectators", var_1 );
    waitframe();
