...
tryusetomastrikefromstruct( var_0 )
{
    ...
    else if ( var_1 == 5 && isdefined( self.plunder_playercanuserepository ) )
    {
...
{
    var_2 = scripts\cp_mp\utility\killstreak_utility::kingslayer();
    var_3 = ( 0, 0, 0 );
...
tomastrike_watchowner()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_12900( "disconnect", "joined_team", "joined_spectators" );
    self notify( "death" );
}
...
tomastrike_watchcameraswitch( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_6 = scripts\engine\utility::_id_12907( "switch_camera_left", "switch_camera_right" );
...
tomastrike_getownerlookat( var_0 )
{
    ...
    var_5 = var_0 scripts\cp_mp\utility\killstreak_utility::swivel_dogtag_revive();
...
tomastrike_attacktarget( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( var_0 == 5 && isdefined( var_3._id_1217E ) )
            var_6 = var_3._id_1217E;
        else
    ...
    else if ( var_0 == 1 || var_0 == 3 || var_0 == 4 || var_0 == 5 )
    {
        ...
        {
            var_11 = findunobstructedfiringinfo( var_6, var_8, var_13, var_14, var_15 );
...
{
    var_5 = spawnstruct();
    var_6 = _id_12287( var_0, var_2, var_3, var_4 );
    var_7 = vectornormalize( var_0 - ( var_6[0], var_6[1], 0 ) );
    var_8 = _id_12288( var_0, var_1, var_7 );
    ...
    var_5.handle_respawn_via_c130 = var_8.handle_respawn_via_c130;
    var_5.handle_roof_spawning = var_8.handle_roof_spawning;
...
delayscriptablechangethread( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    self.owner scripts\engine\utility::_id_12913( var_0, "stop_marker_guide" );
...
_id_12288( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level._id_12285 ) )
        var_9 = level._id_12285;
    ...
    if ( isdefined( var_12["entity"] ) )
    {
        ...
        var_10.handle_respawn_via_c130 = var_13;

        if ( _id_1228A( var_13 ) || _id_12289( var_13 ) )
            var_10.handle_roof_spawning = "flying";
    }
...
tomastrike_firestrike( var_0, var_1, var_2 )
{
    ...
    var_3 thread _id_12286();
    var_3 thread toma_strike_watch_airexplosion( var_0.preexplpos, var_0.handle_respawn_via_c130, var_0.handle_roof_spawning );
...
{
    self endon( "disconnect" );
    scripts\engine\utility::_id_12913( 10, "death" );
...
_id_12287( var_0, var_1, var_2, var_3 )
{
