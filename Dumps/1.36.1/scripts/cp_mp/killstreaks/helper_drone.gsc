...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].remove_bad_loot_drops = 1;
    level.helperdronesettings["radar_drone_recon"].remove_bank_lbravos = 1;
    level.helperdronesettings["radar_drone_recon"].remove_hover_direction_and_try_issue_retreat = 3062500;
    level.helperdronesettings["radar_drone_recon"].remove_hunter_class = 6250000;
    ...
    level.helperdronesettings["assault_drone"].primarymodefunc = ::_id_11A66;
    ...
    level.helperdronesettings["assault_drone"].remove_bad_loot_drops = 0;
    level.helperdronesettings["assault_drone"].remove_bank_lbravos = 0;
    level.helperdronesettings["assault_drone"].remove_hover_direction_and_try_issue_retreat = 73984;
    level.helperdronesettings["assault_drone"].remove_hunter_class = 73984;
    level.helperdronesettings["assault_drone"].gasmask_resist = 1;
    level.helperdronesettings["assault_drone"].gasmask_onpickupcreated = undefined;
    level.helperdronesettings["assault_drone"].gasmaskcarryinfo = 1;
    level.helperdronesettings["assault_drone"].skydivehintnotify = undefined;
    var_0 = "br";
    ...
    level.bomb_planted = getdvarfloat( "scr_assault_drone_enemy_notify_dist", 3000.0 );
    level.bomb_plant_allowed = getdvarint( "scr_assault_drone_freeze_debug", 0 );
    level.gethelinextgroupafterwait = getdvarint( "scr_drone_freeze_switch_debug", 1 );
}
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    var_5 = self.new_agent_def_main;
    self.new_agent_def_main = undefined;
    ...
    {
        if ( istrue( level.gethelinextgroupafterwait ) )
        ...
        var_10 = 0.6;
        var_11 = 2;
        var_12 = scripts\engine\utility::_id_12914( var_10, "death", "weapon_switch_started" );
        ...
        var_12 = scripts\engine\utility::_id_12913( var_11 - var_10, "death" );
    ...
    else if ( var_6 == "scrambler_drone_guard" )
    {
        ...
        if ( isdefined( level._id_122BF ) )
        {
            var_15 = [[ level._id_122BF ]]( self.origin );
    ...
    if ( level.gametype == "br" )
    {
        if ( var_6 == "scrambler_drone_guard" )
            scripts\cp_mp\killstreaks\uav::_id_12504( self.team, 15000, "scrambler_drone_guard" );
    }
...
tryusehelperdroneearlyout( var_0, var_1 )
{
    ...
    if ( ( var_0.streakname == "radar_drone_recon" || var_0.streakname == "assault_drone" ) && ( !self isonground() && !self isonladder() || scripts\mp\trials\mp_trl_gunslinger_knife_create_script::player_gun_game_randomize_weapon_list_think() ) )
    {
        if ( var_1 )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
...
helperdrone_endscramblereffect()
{
    ...
    if ( isdefined( self.grenadehealthatdeathframeupdatecallback ) && self.grenadehealthatdeathframeupdatecallback.size > 0 )
    {
        foreach ( var_1 in self.grenadehealthatdeathframeupdatecallback )
        {
            if ( isdefined( var_1 ) )
            {
                var_2 = var_1;
...
mix( var_0 )
{
    ...
    self.grenadehealthatdeathframeupdatecallback = [];
    var_1 = 0;
...
{
    scripts\engine\utility::_id_128FF( "death_or_disconnect", "scramble_off" );
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( var_1.grenadehealthatdeathframeupdatecallback, var_3 ) )
            var_1.grenadehealthatdeathframeupdatecallback[var_1.grenadehealthatdeathframeupdatecallback.size] = var_3;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_128FF( "death", "scramble_off" );

    if ( isdefined( self ) )
    {
        helperdrone_setscramblerjammed( 0, var_0, var_1 );

        if ( isdefined( var_0 ) && isdefined( var_0.grenadehealthatdeathframeupdatecallback ) )
            var_0.grenadehealthatdeathframeupdatecallback = scripts\engine\utility::array_remove( var_0.grenadehealthatdeathframeupdatecallback, self );
    }
    else if ( isdefined( var_0 ) && isdefined( var_0.grenadehealthatdeathframeupdatecallback ) )
        var_0.grenadehealthatdeathframeupdatecallback = scripts\engine\utility::array_removeundefined( var_0.grenadehealthatdeathframeupdatecallback );
}
        ...
        foreach ( var_5 in level.supportdrones )
        {
            ...
            if ( level.teambased )
            {
                if ( !isdefined( var_1 ) && var_5.team == self.team )
                    ...
                    var_3 = var_5.grenadehealthatdeathframeupdatecallback;
            }
...
helperdrone_overwatchplayer()
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_128FF( "goal", "begin_evasive_maneuvers" );
...
helperdrone_watchpingedstatus( var_0, var_1 )
{
    ...
    self.spawner_recently_used[self.spawner_recently_used.size] = var_0;
    var_0 scripts\engine\utility::_id_12913( 3, "death" );
    self.spawner_recently_used = scripts\engine\utility::array_remove( self.spawner_recently_used, var_0 );
}
...
missed_shots( var_0 )
{
    ...
    foreach ( var_3 in var_0.spawner_recently_used )
    {
...
setreconmodesettings( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::select_bridge_three_spawners( self.owner );

    if ( !istrue( var_1 ) )
    {
        self.owner _id_11AC7( 1, self );
    ...
    thread missionparticipation( var_0 );
    thread helperdrone_handlethermalswitch();
    thread missing_window_blockers( var_0 );
    return 1;
}
...
_id_11A66( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        ...
        scripts\cp_mp\utility\weapon_utility::setlockedonremovedcallback( self, ::helperdrone_lockedonremovedcallback );
        thread helperdrone_watchouterreticletargets( var_0 );
        thread missiontime( var_0 );
        thread missedinfilplayerhandler( var_0 );
    }
    ...
    if ( istrue( level.bomb_plant_allowed ) )
        thread minsteps( 2 );
...
helperdrone_watchearlyexit( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "allowRideKillstreakPlayerExit" ) )
        self thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "allowRideKillstreakPlayerExit" ) ]]( "death", var_0.skydivehintnotify );

    self waittill( "killstreakExit" );
    thread helperdroneexplode( 0, istrue( var_0.gasmask_onpickupcreated ) );
}
...
missing_window_blockers( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            ...
            var_2 = var_1.vehicle;
        else if ( istrue( var_1.playervisibilityrespawntags ) )
            var_2 = var_1;
...
minsteps( var_0 )
{
    ...
    self endon( "death" );
    wait( var_0 );
    self.owner thread scripts\cp_mp\utility\player_utility::activate_subway_track_trigger_hurt();
}
...
helperdrone_markplayers( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.being_kicked_from_inactivity = 0;
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_2++;
            _id_11AD6( self.targetmarkergroup, var_5, 1 );
            ...
            if ( var_8 )
                self.being_kicked_from_inactivity = 1;

            if ( var_9 )
            {
                _id_11AD6( self.targetmarkergroup, var_5, 3 );
                continue;
            }

            if ( !var_8 || !var_6 )
            {
                _id_11AD6( self.targetmarkergroup, var_5, 0 );
                continue;
            }
...
missedinfilplayerhandler( var_0 )
{
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_3 )
        {
            ...
            var_2++;
            _id_11AD6( self.targetmarkergroup, var_6, 1 );
            var_7 = canseetarget( var_6 );
            var_8 = isinmarkingrange( var_6 );

            if ( !var_8 || !var_7 )
            {
                _id_11AD6( self.targetmarkergroup, var_6, 0 );
                continue;
            }

            var_4 = 1;
            _id_11AD6( self.targetmarkergroup, var_6, 2 );
        }

        self._id_12179 = var_4;
        var_2 = 0;
        waitframe();
    }
}
...
missiontime( var_0 )
{
    ...
    for (;;)
    {
        if ( istrue( self._id_12179 ) && var_1 == 0 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 1 );
            var_1 = 1;
        }
        else if ( !istrue( self._id_12179 ) && var_1 == 1 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 0 );
            var_1 = 0;
        }
...
helperdrone_watchnotificationstate( var_0 )
{
    ...
    for (;;)
    {
        ...
        else if ( !istrue( self.being_kicked_from_inactivity ) )
...
helperdrone_watchouterreticletargets( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.allow_player_skip_laststand ) )
        {
            ...
            {
                if ( isdefined( var_6.extractionmethod ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "gameFlag" ) )
                    {
                        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "gameFlag" ) ]]( "prematch_done" ) )
                        {
                            ...
                            {
                                if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isPlayerOnIntelChallenge" ) ]]( self.owner, var_6.extractionmethod ) )
        ...
        foreach ( var_10 in var_8 )
        {
            if ( isplayer( var_10 ) )
            {
                ...
                if ( !istrue( var_0.remove_bad_loot_drops ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                    {
            ...
            if ( istrue( var_0.remove_bank_lbravos ) && !self.owner helperdrone_istargetinreticle( var_10, 70, 300 ) )
                continue;
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_0.updaterespawnstatus ) )
        var_2 = var_0.updaterespawnstatus;
    else
        var_2 = scripts\engine\trace::create_contents( 0, 1, 0, 1, 1, 1, 0, 1 );

    var_3 = var_0.origin;

    if ( isdefined( var_0.updaterotatedebug ) )
        var_3 = var_3 + var_0.updaterotatedebug;
...
startmarkingpassivetarget( var_0 )
{
    ...
    _id_11AD6( self.targetmarkergroup, var_0, 0 );
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( istrue( var_2.remove_bank_lbravos ) && !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( var_0.updateprestreamrespawn ) )
        [[ var_0.updateprestreamrespawn ]]( var_4, var_0 );
    ...
    self.owner stoplocalsound( "recon_drone_marking_owner" );
    self.owner _id_11AC7( 4, self );
    _id_11AD6( self.targetmarkergroup, var_0, 2 );
...
isinmarkingrange( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( var_2, var_1.remove_hunter_class, var_1.remove_hover_direction_and_try_issue_retreat );

    if ( isdefined( var_0.remove_carry_item ) )
        var_3 = var_0.remove_carry_item;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_12914( var_2, "death", "explode" );
...
helperdrone_watchforgoal()
{
    ...
    var_0 = scripts\engine\utility::_id_12908( "goal", "near_goal", "hit_goal" );
    self.intransit = 0;
    self.inactive = 0;
...
removehelperdrone( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.owner ) )
    {
        ...
        self.streakinfo.healdamage = istrue( var_2 );
        self.owner scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( self.streakinfo );
    }
...
helperdrone_returnplayer( var_0 )
{
    ...
    var_0 thread mintokensdropondeath();
    var_0 cameraunlink( self );
    var_0 remotecontrolvehicleoff();
    scripts\cp_mp\utility\killstreak_utility::select_bridge_two_spawners( var_0 );
...
helperdrone_istargetinreticle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.updaterotatedebug ) )
        var_4 = var_4 + var_0.updaterotatedebug;

    var_5 = [ var_4 ];

    if ( isplayer( var_0 ) )
    {
        var_6 = var_0 scripts\mp\utility\player::lb_mg_impulse_dmg_factor_low();
...
{
    self endon( "disconnect" );
    var_1 = updateprematchloadoutarray( var_0 );
