...
init()
{
    ...
    level._id_1250B = getuavstrengthmin();
    level._id_12507 = getuavstrengthmax();
    level._id_12508 = getuavstrengthlevelshowenemydirectional();
    level._id_1250A = getuavstrengthlevelneutral();
    level._id_12509 = getuavstrengthlevelshowenemyfastsweep();
    ...
    level.airlock_callbutton_think = 0;
...
useuav( var_0, var_1 )
{
    ...
    scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_call_in_uav_for_operator_mission", 1 );
    scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_call_in_uav_for_operator_mission_op2", 1 );

    if ( getdvarint( "LRTSSKLKPK", 1 ) >= 8 )
        scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_call_in_uav_for_operator_mission_op3", 1 );
...
launchuav( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.gametype == "br" )
        var_0 _id_12504( var_4, 15000, var_1 );
    ...
    if ( isdefined( var_6 ) && var_6.damagetaken < var_6.maxhealth )
    {
        ...
        {
            var_6 unlink();
            var_6.gametypefilter = var_6.origin + anglestoforward( var_6.angles ) * 50000;
            var_6 moveto( var_6.gametypefilter, 50 );
        ...
        if ( isdefined( var_6 ) && var_6.damagetaken < var_6.maxhealth )
        {
            ...
            if ( isent( var_6 ) )
                var_6 moveto( var_6.gametypefilter, 15 );
    ...
    if ( isdefined( var_6 ) )
    {
        ...
        var_6.streakinfo.healdamage = !istrue( var_6.leftplayspace );

        if ( !istrue( self.updatesecretstashhud ) )
            var_6.owner scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_6.streakinfo );
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_128FF( "disconnect", "joined_team" );
...
updateteamuavstatus( var_0, var_1 )
{
    ...
    var_2 = int( max( min( var_2, level._id_12507 ), level._id_1250B ) );
    var_3 = var_2 == level._id_1250B;
    var_4 = !var_3;
    var_5 = var_2 >= level._id_12508;
    var_6 = !var_3;

    if ( var_2 == level._id_1250A )
    {
        var_7 = "normal_radar";
        var_4 = 0;
    }
    else if ( var_2 == level._id_12507 || var_5 )
        var_7 = "constant_radar";
    else if ( var_2 == level._id_12509 )
        var_7 = "fast_radar";
    else
        var_7 = "normal_radar";
    ...
    foreach ( var_10 in var_8 )
    {
        ...
        if ( istrue( var_10.parachute_get_path ) )
            continue;

        if ( istrue( var_10._id_11C7C ) )
            continue;
...
updateplayersuavstatus()
{
    foreach ( var_1 in level.players )
    {
        if ( istrue( var_1.parachute_get_path ) )
            continue;
        ...
        if ( var_2 >= level._id_12509 )
            var_1.radarmode = "fast_radar";
        else
            var_1.radarmode = "normal_radar";

        var_1.radarshowenemydirection = var_2 >= level._id_12508;
...
addactiveuav()
{
    ...
    if ( level.teambased )
    {
        ...
        if ( self.uavtype == "directional_uav" || self.uavtype == "harp" )
        {
            ...
            level.airlock_callbutton_think++;
        }
    }
    else
    {
...
watchhighlightfadetime( var_0, var_1, var_2, var_3 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_12919( var_2, "leave" );
...
setforceradars( var_0, var_1 )
{
    ...
    if ( level.teambased )
    {
        foreach ( var_7 in level.teamnamelist )
        {
            ...
            level.airlock_callbutton_think = level.teamnamelist.size;
...
_id_12504( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        return;

    var_3 = _id_12505( var_0, var_1 );
