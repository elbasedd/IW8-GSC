...
runcruisepredator( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\game_utility::islargemap() || scripts\common\utility::iscp() || scripts\cp_mp\utility\game_utility::play_players_arrive_at_extraction() )
        var_5 = self.origin;
...
enemy_mine_proximity_think( var_0, var_1, var_2 )
{
    self endon( "death" );
    ...
    if ( isdefined( self ) )
    {
        enemy_left_monitor( var_0, var_1, var_2 );
        self delete();
    }
}
...
cruisepredator_followmissilepod( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !istrue( var_2 ) )
    {
        ...
        var_0 thread enemy_mine_proximity_think( var_3, var_12, var_13 );
        var_0 thread enemy_mines_init( "disconnect" );
        var_0 thread enemy_mines_init( "joined_team" );
        var_0 thread enemy_mines_init( "joined_spectators" );
    }
...
cruisepredator_takecontrol( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 thread enemy_mine_damaged_think( var_1 );
    ...
    var_7 thread enemy_mines_init( "disconnect" );
    var_7 thread enemy_mines_init( "joined_team" );
    var_7 thread enemy_mines_init( "joined_spectators" );
...
cruisepredator_watchmissileexplosion( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        if ( !istrue( var_3 ) )
        {
            ...
            var_1 scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_9 );
        }
    }
...
cruisepredator_returnplayer( var_0, var_1 )
{
    ...
    level thread scripts\cp_mp\utility\killstreak_utility::vo_manifest_scanned( self );
    var_0 notify( "killstreak_finished_with_deploy_weapon" );
}
