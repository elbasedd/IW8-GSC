...
tryusesentryturretfromstruct( var_0 )
{
    ...
    scripts\cp_mp\killstreaks\manual_turret::relic_squadlink_onbecameinvalidplayer( 0 );
    var_2 = sentryturret_create( "sentry_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        scripts\cp_mp\killstreaks\manual_turret::relic_squadlink_onbecameinvalidplayer( 1 );
        self.bgivensentry = 0;
        return 0;
    }
...
sentryturret_delayplacementinstructions( var_0 )
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::relic_punchbullets_track_previous_bullet_weapon( "death" );
    thread scripts\cp_mp\killstreaks\manual_turret::relic_punchbullets_track_previous_bullet_weapon( "turret_placement_finished" );
}
...
sentryturret_setplaced( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
        var_0.minimapid = var_0.displaysquadmessagetoteam [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_4, var_0.team, undefined, 1, 1 );
...
sentryturret_setcarried( var_0 )
{
    ...
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_0.select_boss_two_spawners = undefined;
        var_0.select_boss_one_spawners = undefined;
        var_0 unlink();
    }
    ...
    var_0.displaysquadmessagetoteam unlink();
    var_0.displaysquadmessagetoteam hide();
...
sentryturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        var_0.streakinfo.healdamage = istrue( var_2 );
        scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_0.streakinfo );
    }
    ...
    if ( isdefined( var_0.displaysquadmessagetoteam ) )
        var_0.displaysquadmessagetoteam delete();
...
sentryturret_watchdisown( var_0 )
{
    var_0 endon( "kill_turret" );
    var_0 endon( "carried" );
    scripts\engine\utility::_id_12900( "disconnect", "joined_team", "joined_spectators" );
    var_0 notify( "kill_turret", 0, 0 );
}
