...
initcratedata()
{
    ...
    level.cratedata._id_12536 = pow( getdvarfloat( "scr_crateUnresolvedCollisionToleranceSqr", 2 ), 2 );
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "registerPlayerFrameUpdateCallback" ) )
        [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "registerPlayerFrameUpdateCallback" ) ]]( ::_id_122CF );
...
getemptyleveldata()
{
    ...
    var_0.lootchopper_premodifydamage = 27.5;
...
createcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( level.gametype == "infect" )
        var_11.playerdelaydisablezombie = 1;
    ...
    if ( isdefined( var_11.owner ) )
        var_11.owner.play_tape_machine_animation = 1;
    ...
    if ( var_11.hasnophysics )
        ...
        var_11 dropoff_sound_playerwm_handler();
...
activatecrate( var_0 )
{
    ...
    self.play_tape_machine_animations = undefined;
...
capturecrate( var_0 )
{
    ...
    if ( isdefined( self.owner ) && istrue( self.owner.play_tape_machine_animation ) )
        self.owner.play_tape_machine_animation = 0;
...
destroycrate( var_0 )
{
    ...
    if ( !isdefined( var_0 ) )
    {
        ...
        {
            if ( !istrue( self.spawn_vindia_assault3 ) )
            {
                self.destroyonactivate = 1;
                return;
            }
    ...
    if ( !istrue( var_0 ) )
    {
        ...
        if ( !istrue( self.physicsactivated ) || !istrue( self.spawn_vindia_assault3 ) )
        {
        ...
        thread fulton_check_for_moving_platform();
}
...
fulton_check_for_moving_platform()
{
...
initcratedropdata()
{
    var_0 = spawnstruct();
    var_0.helis = [];
    var_1 = scripts\cp_mp\utility\killstreak_utility::kingslayer();
...
watchdropcratefrommanualheliinternal()
{
    ...
    {
        self.heli scripts\engine\utility::_id_128FF( "death", "goal" );
...
docratedropfrommanualheli()
{
    ...
    var_0 dropoff_sound_playerwm_handler();
}
...
watchcrateuse( var_0, var_1 )
{
    ...
    if ( var_0 == 1 )
    {
        ...
        self.owner endon( "joined_team" );
        self.owner endon( "joined_spectators" );
        self.owner.play_tape_machine_animation = 1;
    }
    ...
    if ( isdefined( var_3._id_1266C ) )
        var_3.usetime = var_3._id_1266C;
    ...
    for (;;)
    {
        ...
        {
            if ( istrue( var_4.isjuggernaut ) && !var_4 playerprespawngulagjail( self.cratetype ) )
            {
        ...
        if ( canstartusingcrate( var_4, var_1 ) )
        {
            ...
            var_4.play_tape_machine_animation = 1;
            ...
            {
                if ( isdefined( var_4 ) )
                    var_4.play_tape_machine_animation = 0;
...
startusingcrate( var_0, var_1 )
{
    ...
    else
    {
        ...
        if ( var_4 )
            var_0 thread armsrace_caches_defended();
...
armsrace_caches_defended()
{
    ...
    level endon( "game_ended" );
    scripts\cp_mp\utility\weapon_utility::wave_enemies_remaining();
    var_0 = makeweapon( "ks_use_crate_mp" );
    scripts\cp_mp\utility\inventory_utility::_giveweapon( var_0 );
    thread array_contains_solution( var_0 );
...
array_contains_solution( var_0 )
{
    ...
    else
    {
        ...
        {
            var_1 = scripts\cp_mp\utility\weapon_utility::vo_nag_hangar( self.lastdroppableweaponobj );
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_5 in var_2 )
            {
                ...
                if ( var_6 )
                    relic_bullet_reward_hud_display( var_1, var_5 );
            }
        }
    ...
    for (;;)
    {
        foreach ( var_1 in level.cratedata.usablecrates )
        {
            ...
            foreach ( var_3 in level.players )
                relic_bullet_reward_hud_display( var_1, var_3 );
        }
...
dropoff_sound_playerwm_handler( var_0, var_1 )
{
    ...
    if ( isdefined( var_2.droporigin ) )
        self thread [[ var_2.droporigin ]]();
    ...
    createdangerzone();
    thread sat_wait_for_piece_added();
...
dropoff_sound_playervm_handler()
{
    ...
    self.spawn_vindia_assault3 = undefined;
...
sat_wait_for_piece_added()
{
    ...
    var_0 = 0.1;
    thread sat_wait_for_controller( var_0, 8 );
    var_1 = 0;
    var_2 = 0;
    self.play_tape_machine_animations = 1;
    var_3 = undefined;
    var_4 = undefined;
    ...
    for (;;)
    {
        var_5 = jugg_assault3_check_size();
        var_6 = jugg_addtoactivejugglist();
        ...
        if ( isdefined( var_5 ) && isdefined( var_6 ) )
        {
            if ( var_5 <= 5.0 && var_6 <= 1.0 )
            {
                ...
                if ( var_1 == 6 )
                {
                    self.spawn_vindia_assault3 = 1;
                    var_3 = self.origin;
                    thread activatecrate( self.play_tape_machine_animations );
                    ...
                    var_0 = 0.1;
                    thread sat_wait_for_controller( var_0, 3, 3 );
                    gas_attack_deploy();
                }
            }
            else
...
sat_wait_for_controller( var_0, var_1, var_2 )
{
    did_ads_hint();
    self endon( "death" );
    self endon( "clear_average_velocities" );
    self.quest_scavdistmin = [];
    self.battle_tracks_onexitvehicle = [];
    self._id_12803 = 0;
    self._id_127FE = 0;
    self._id_12800 = var_1;
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        if ( var_2 > 0 )
        {
            ...
            {
                self.quest_scavdistmin[self._id_12803 + var_3] = 0;
                self.battle_tracks_onexitvehicle[self._id_12803 + var_3] = 0;
            }
        }
    }
    ...
    for (;;)
    {
        ...
        self.quest_scavdistmin[self._id_127FE] = length( var_5 );
        self.battle_tracks_onexitvehicle[self._id_127FE] = length( var_6 );
        self._id_127FE++;
        var_7 = self._id_127FE - self._id_12803;
        ...
        if ( var_7 > var_1 )
        {
            ...
            {
                self.quest_scavdistmin[self._id_12803 + var_3] = undefined;
                self.battle_tracks_onexitvehicle[self._id_12803 + var_3] = undefined;
            }

            self._id_12803 = self._id_12803 + var_8;
        }

        self.bot_should_cap_next_zone = undefined;
        self.bot_shotguns = undefined;
        wait( var_0 );
    }
}

jugg_assault3_check_size()
{
    if ( isdefined( self.bot_should_cap_next_zone ) )
        return self.bot_should_cap_next_zone;

    if ( !isdefined( self.quest_scavdistmin ) )
        return undefined;

    if ( self._id_127FE - self._id_12803 < self._id_12800 )
        return undefined;
...
{
    if ( isdefined( self.bot_shotguns ) )
        return self.bot_shotguns;

    if ( !isdefined( self.battle_tracks_onexitvehicle ) )
        return undefined;
...
computer_force_player_to_exit()
{
    ...
    for ( var_2 = self._id_12803; var_2 < self._id_127FE; var_2++ )
    {
        var_0 = var_0 + self.quest_scavdistmin[var_2];
        var_1 = var_1 + self.battle_tracks_onexitvehicle[var_2];
    }

    self.bot_should_cap_next_zone = var_0 / self._id_12800;
    self.bot_shotguns = var_1 / self._id_12800;
}

did_ads_hint()
{
    self notify( "clear_average_velocities" );
    self.quest_scavdistmin = undefined;
    self.battle_tracks_onexitvehicle = undefined;
    self._id_12800 = undefined;
    self._id_12803 = undefined;
    self._id_127FE = undefined;
    self.bot_should_cap_next_zone = undefined;
    self.bot_shotguns = undefined;
}

savedexecutionref( var_0 )
{
    saveendgamelocals();
    ...
    saveweaponstates( var_0 );

    if ( isdefined( self ) )
        thread saveendgamelocals();
}
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) )
        {
            if ( isdefined( var_9.classname ) && var_9.classname == "scriptable_iw8_chicken_01" )
                thread armsrace_c4_planter_super( var_9 );

            debug_blockade_phone_drop( var_9 );
        }

        if ( isdefined( var_9 ) && munitions_override_time( var_9 ) )
        {
            if ( var_9 scripts\cp_mp\killstreaks\helper_drone::playanim_aioperateturret() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            timedrun_finishlinevfx( var_6, var_7, var_8, var_11 );
        }
    }
}
...
debug_blockade_phone_drop( var_0 )
{
    ...
    {
        if ( isdefined( self._id_12342 ) )
        {
            if ( self._id_12342 == var_0 )
                return;
            else
                create_name_fx_base();
        }

        self._id_12342 = var_0;
        self._id_12341 = 4;
        thread debug_bunkerpuzzledebugdraw( var_0 );
    }
}
...
debug_bunkerpuzzledebugdraw( var_0 )
{
    ...
    while ( self._id_12345 < 5 )
    {
        var_7 = self.origin + anglestoup( self.angles ) * var_1.lootchopper_premodifydamage;
        var_8 = var_7 + ( 0, 0, -200 );
        var_9 = scripts\engine\trace::ray_trace( var_7, var_8, var_3, var_2 );

        if ( var_9.size > 0 && isdefined( var_9["entity"] ) && var_9["entity"] == self._id_12342 )
        {
            var_10 = combineangles( invertangles( var_0.angles ), var_0.origin - var_9["position"] );

            if ( !isdefined( self._id_12346 ) )
            {

            }
            else if ( distancesquared( var_10, self._id_12346 ) > 25 )
            {
                self._id_12345++;
                self._id_12347 = 0;
            }
            else if ( vectordot( var_10, self._id_12346 ) < 0.997 )
            {
                self._id_12345++;
                self._id_12347 = 0;
            }
            else
            {
                ...
                {
                    self linkto( var_0 );
                    activatecrate( self.play_tape_machine_animations );
                    thread dropoff_sound_playervm_handler();
                    break;
                }
            }

            self._id_12346 = var_10;
        }
        else
            break;
...
munitions_override_time( var_0 )
{
    if ( !istrue( self.spawn_vindia_assault3 ) )
    {
        if ( isdefined( var_0.classname ) )
        {
            ...
            {
                if ( var_0 scripts\cp_mp\killstreaks\helper_drone::playanim_aioperateturret() )
                {
                    var_1 = getleveldata( self.cratetype );
                    var_2 = self.origin + anglestoup( self.angles ) * var_1.lootchopper_premodifydamage;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) && ( isplayer( var_2 ) || isagent( var_2 ) ) && var_2 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            if ( var_2 tagexists( "j_mainroot" ) )
            {
                ...
                var_8 = self.origin + anglestoup( self.angles ) * var_7.lootchopper_premodifydamage;
...
timedrun_finishlinevfx( var_0, var_1, var_2, var_3 )
{
...
{
    if ( level.cratedata._id_12536 > 0 )
    {
        if ( lengthsquared( var_1 ) <= level.cratedata._id_12536 )
            return;
    }

    var_2 = self.objweapon;

    if ( isdefined( self.droppoint ) )
...
_id_122CF()
{
    if ( !isdefined( self.handle_truck_spawning ) )
    {
        if ( self ismantling() )
        {
            ...
            {
                self.handle_train_collision_items = var_0;
                self.handle_train_veh_collision = var_0.crate;
            }

            self.handle_truck_spawning = gettime() + 1000;
        }
    }
    else if ( gettime() >= self.handle_truck_spawning )
    {
        self.handle_train_collision_items = undefined;
        self.handle_train_veh_collision = undefined;
    ...
    else
    {
        ...
        {
            if ( isdefined( var_2 ) && istrue( var_2.physicsactivated ) && !istrue( var_2.spawn_vindia_assault3 ) )
            {
                if ( isdefined( self.handle_train_collision_items ) )
                {
                    if ( isdefined( var_2.mountmantlemodel ) )
                    {
                        if ( self.handle_train_collision_items != var_2.mountmantlemodel )
                        {
                    ...
                    if ( self.handle_train_veh_collision != var_2 )
                    {
...
dropkillstreakcratefromscriptedheli( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 thread armsrace_phase_hold_behavior( var_7 );
...
airdrop_watchplayerweapon( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_12907( "cancel_deploy", "weapon_switch_started" );
...
airdropmarkeractivate( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_2 );
}
...
initbattleroyaleloadoutcratedata()
{
    ...
    var_0.destroycallback = ::choosedropbagmodel;
...
onkioskpurchaseitem()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::change_goal_radius_weapons_free_internal;
    var_0.capturecallback = ::change_keypad_display_digit;
    var_0.destroycallback = ::change_stealth_state_to_combat_warpper;
    var_0.droporigin = ::change_yaw_angle;
    var_0.destroyoncapture = 1;
}
...
getmaxoutofboundsbrtime( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 250;
    var_8 = level.colmaps;
    var_9 = 1000;
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( !var_5 && var_13[2] < var_0[2] )
        {
            ...
            if ( isdefined( var_16 ) )
            {
                ...
                var_15 thread _id_129D0();
                var_20 thread _id_129D1( var_19 );
            }
            else
                var_15 dropoff_sound_playerwm_handler();
        }
        else
            var_15 dropoff_sound_playerwm_handler();
        ...
        var_15._id_11CA2 = spawn( "script_model", var_1 );
        var_15._id_11CA2 setmodel( "ks_airdrop_crate_br" );

        if ( !istrue( var_6 ) )
            var_15._id_11CA2 setscriptablepartstate( "smoke_signal", "on", 0 );

        var_23 = getleveldata( var_14 );

        if ( isdefined( var_23.postcreatecallback ) )
            var_15 thread [[ var_23.postcreatecallback ]]();
    }
...
_id_129D0()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        dropoff_sound_playerwm_handler();
    }
}
...
onlaststandrevive()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.activatecallback = ::chopper_boss_combat;
    var_0.capturecallback = ::chopper_boss_combat_actions;
    var_0.destroycallback = ::chopper_boss_damage_monitor;
    var_0.destroyoncapture = 1;
}

chopper_boss_combat( var_0 )
{

}

chopper_boss_combat_actions( var_0 )
{
    self setscriptablepartstate( "objective_map", "inactive", 0 );
...
getnextcombatareaid( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_11CA2 = spawn( "script_model", var_1 );
        var_2._id_11CA2 setmodel( "ks_airdrop_crate_br" );
        var_2._id_11CA2 setscriptablepartstate( "smoke_signal", "on", 0 );
    }

    return var_2;
}

getnexthelimodule( var_0, var_1 )
{
    var_2 = dropcrate( undefined, undefined, "battle_royale_chopper_loot", var_0, ( 0, randomfloat( 360 ), 0 ), var_1 );
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2._id_11CA2 = spawn( "script_model", var_1 );
        var_2._id_11CA2 setmodel( "ks_airdrop_crate_br" );
        var_2._id_11CA2 setscriptablepartstate( "smoke_signal", "pe_chopper_on", 0 );
    }
...
onlaststandkillenemy()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::checkpoint_edit_role;
    var_0.destroycallback = ::checkpoint_edit_role_limiter;
    var_0.activatecallback = ::checkpoint_edit_munitions_limiter;
    var_0.droporigin = ::checkpoint_fx;
    var_0.postcreatecallback = ::brjuggernautcratepostcreatecallback;
    var_0.destroyoncapture = 1;
}
...
checkpoint_fx( var_0, var_1 )
{
    self setscriptablepartstate( "crate_audio", "detach", 0 );
}

brjuggernautcratepostcreatecallback()
{
    self setscriptablepartstate( "model", "friendly", 0 );
}

getoverlordaliasfortimeleft( var_0, var_1, var_2 )
{
...
_id_11E29( var_0, var_1 )
{
    ...
    var_3 = getoverlordaliasfortimeleft( self.team, var_0 + ( 0, 0, var_2 ), var_0 + ( 0, 0, 512 ) );
    var_3 endon( "death" );
    give_xp_to_all_players_hack( var_3 );
    defuse_spawners( var_3 );
    var_4 = [];
...
give_xp_to_all_players_hack( var_0 )
{
...
onlineprimaryoverride()
{
    ...
    var_0.ownerusetime = 0.5;
    var_0.otherusetime = 0.5;
    var_0.capturecallback = ::clean_up_vandalize;
    var_0.activatecallback = ::clean_up_strafe;
    var_0.destroycallback = ::cleanup_corpses;
    var_0.droporigin = ::cleanup_fake_ai_on_death;
    var_0.destroyoncapture = 1;
}
...
getquestrewardstablevalue( var_0 )
{
    ...
    var_3 = var_0 + ( 0, 0, 512 );
    level.wait_between_stations.initbattleroyalejuggernautcratedata = spawnfx( level._effect["smoke_tactical_device"], level.wait_between_stations.gate_flares_think - ( 0, 0, 60 ) );
    triggerfx( level.wait_between_stations.initbattleroyalejuggernautcratedata );
    var_4 = dropcrate( undefined, undefined, "battle_royale_tactical_device", var_2, ( 0, randomfloat( 360 ), 0 ), var_3 );
    var_4.skipminimapicon = 1;
    cleanup_goal_population( var_4 );
}
