...
init()
{
    ...
    level thread scripts\mp\trials\mp_trl_boneyard_gw_race::init();
...
overridecountdownmusic()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F2( "killstreak", 1 );
    var_0._id_12976["missileLocking"] = 2;
}
