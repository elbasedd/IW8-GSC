...
{
    if ( !istrue( var_1 ) )
        scripts\cp_mp\killstreaks\killstreakdeploy::lasttimedamagecalledout( var_2 );
}
...
tryusemanualturretfromstruct( var_0 )
{
    ...
    relic_squadlink_onbecameinvalidplayer( 0 );
    var_2 = manualturret_create( "manual_turret", var_0 );

    if ( !isdefined( var_2 ) )
    {
        relic_squadlink_onbecameinvalidplayer( 1 );
        return 0;
    }
...
manualturret_delayplacementinstructions( var_0 )
{
    ...
    thread relic_punchbullets_track_previous_bullet_weapon( "death" );
    thread relic_punchbullets_track_previous_bullet_weapon( "turret_placement_finished" );
}
...
manualturret_create( var_0, var_1 )
{
    ...
    var_3.displaysquadmessagetoteam = spawn( "script_model", var_3.origin );
    var_3.displaysquadmessagetoteam.team = var_3.team;
    var_3.displaysquadmessagetoteam.owner = var_3.owner;
    var_3.displaysquadmessagetoteam setmodel( "weapon_vm_mg_sentry_turret_invis_base" );
    var_3.displaysquadmessagetoteam dontinterpolate();
    var_3.displaysquadmessagetoteam hide();
    var_3.displaysquadmessagetoteam.moverdoesnotkill = 1;
    var_3.displaysquadmessagetoteam._id_124C1 = var_3;
    return var_3;
}
...
manualturret_setplaced( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.moving_platform ) )
    {
        ...
        var_0.select_boss_two_spawners = var_1.select_boss_two_spawners;
        var_0.select_boss_one_spawners = var_1.select_boss_one_spawners;
    }
    ...
    var_0.displaysquadmessagetoteam show();
    var_0.displaysquadmessagetoteam.angles = var_0.angles;
    var_0.displaysquadmessagetoteam.origin = var_0.origin;
    var_0.displaysquadmessagetoteam linkto( var_0, "tag_aim_pivot" );
    ...
    if ( !var_6 )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
            var_0.minimapid = var_0.displaysquadmessagetoteam [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_7, var_0.team, undefined, 1, 1 );
    }
    ...
    var_0 thread relic_squadlink_onsteppedfar();
...
manualturret_setcarried( var_0 )
{
    ...
    if ( istrue( self.inuse ) )
    {
        ...
        var_0 relic_squadlink_onsteppedclose( 1 );
    }

    if ( isdefined( self.moving_platform ) )
    {
        self.moving_platform = undefined;
        self.select_boss_two_spawners = undefined;
        self.select_boss_one_spawners = undefined;
        self unlink();
    }
    ...
    self.displaysquadmessagetoteam hide();
    var_0 manualturret_setinactive( self );
    self hide();
    self.carriedby = var_0;
    self notify( "carried_turret" );
    self playsound( "sentry_pickup" );
    var_0 scripts\cp_mp\utility\weapon_utility::wave_enemies_remaining();
    ...
    var_0 relic_squadlink_onbecameinvalidplayer( 0 );
    var_5 = var_0 manualturret_watchplacement( self, self.streakinfo, 1, 2 );

    if ( !isdefined( var_5 ) )
    {
        var_0 relic_squadlink_onbecameinvalidplayer( 1 );
        return 0;
    }
...
manualturret_switchbacklastweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::vo_nag_hangar( self.lastdroppableweaponobj );
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        self.inuse = 1;
        var_3 relic_squadlink_onsteppedclose( 0 );
            ...
            if ( var_5 >= 0.25 )
            {
                ...
                if ( isdefined( var_3 ) )
                {
                    ...
                    if ( var_3 scripts\cp_mp\utility\player_utility::_isalive() )
                        var_3 relic_squadlink_onsteppedclose( 1 );
                }
        ...
        self.teleport_reference_juggmaze = var_3;
        manualturret_makealltriggersusable( 0 );
        var_3 scripts\cp_mp\utility\weapon_utility::wave_enemies_remaining();
        ...
        {
            var_7 = relic_squadlink_add_visionset( var_3, var_3.useweapon );
        ...
        {
            self.inuse = undefined;
            self.teleport_reference_juggmaze = undefined;
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    var_3 relic_squadlink_onsteppedclose( 1 );
                    var_8 = var_3 scripts\cp_mp\utility\weapon_utility::vo_nag_hangar( var_3.lastdroppableweaponobj );
        ...
        if ( scripts\cp_mp\utility\game_utility::isnightmap() )
            var_3 scripts\common\utility::atv_trail( 0 );

        manualturret_applyoverlay( var_3 );
        thread manualturret_disablefire( var_3, 0.5, 1 );
        thread manualturret_watchammotracker( var_3 );
        thread relic_squadlink_flash_squadlink_icon( var_3 );
        thread relic_squadlink_init_vfx( var_3 );
...
relic_squadlink_add_visionset( var_0, var_1 )
{
    ...
    var_0 endon( "death_or_disconnect" );
    level endon( "game_ended" );
    thread relic_squadlink_outline_monitor( 1.0 );
...
manualturret_endplayeruse( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        var_0.teleport_reference_juggmaze = undefined;
    ...
    if ( isdefined( self ) )
    {
        ...
        thread relic_shieldsonly_set_player_stats_after_spawn();
...
manualturret_endturretonplayer( var_0 )
{
    var_0 endon( "end_turret_use" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_128FF( "death_or_disconnect", "last_stand_start" );
    var_0 manualturret_endplayeruse( self );
}
...
manualturret_watchdeath( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_0 scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( self.streakinfo );
    }

    if ( isdefined( self.teleport_reference_juggmaze ) )
        self.teleport_reference_juggmaze manualturret_endplayeruse( self );
    ...
    if ( isdefined( self.displaysquadmessagetoteam ) )
...
manualturret_watchtimeout( var_0 )
{
    ...
    while ( self.timeelapsed < var_1 )
    {
        ...
        if ( isdefined( self.teleport_reference_juggmaze ) )
            self.teleport_reference_juggmaze setclientomnvar( "ui_killstreak_countdown", int( var_2 ) );

        self.timeelapsed = self.timeelapsed + level.framedurationseconds;

        if ( self.timeelapsed >= var_1 - 1.5 && !istrue( self._id_1202C ) )
            self._id_1202C = 1;
