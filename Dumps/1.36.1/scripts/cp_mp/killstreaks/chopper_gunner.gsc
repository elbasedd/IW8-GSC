...
startchoppergunnerintro( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\killstreak_utility::kingslayer();
    var_4 = ( 0, 0, 0 );
    ...
    else if ( istrue( var_0.normalspeed ) && level.script == "cp_so_aniyah" )
    {
        ...
        while ( level.setup_bot_arena.size == 0 )
            waitframe();

        var_20 = scripts\engine\utility::getclosest( var_19, level.setup_bot_arena );
    ...
    if ( istrue( var_0.normalspeed ) && level.script == "cp_so_aniyah" )
    ...
    var_24.normalspeed = istrue( var_0.normalspeed );
    var_24 setvehicleteam( var_24.team );
    var_24 thread delete_crate_objectives( "disconnect", var_1 );
    var_24 thread delete_crate_objectives( "joined_team", var_1 );
    var_24 thread delete_crate_objectives( "joined_spectator", var_1 );
    var_27 = 2000;
    ...
    var_29 = var_24 delete_corpses( 4.25 );
...
delete_crate_objectives( var_0, var_1 )
{
    var_2 = self.owner;
    self endon( "death" );
...
choppergunner_startremotecontrol( var_0 )
{
    ...
    thread delete_door_clip( "disconnect" );
    thread delete_door_clip( "joined_team" );
    thread delete_door_clip( "joined_spectator" );
    thread delete_door_clip( "team_kill_punish" );
...
choppergunner_updatetargetmarkergroups( var_0 )
{
    ...
    if ( istrue( level.get_goal_radius ) )
        return;
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_12900( "leaving", "death", "explode" );
...
choppergunner_watchendstrobefx( var_0 )
{
    self endon( "death" );
    level endon( "game_ended" );
    var_0 scripts\engine\utility::_id_128FF( "death", "leaving" );
    self delete();
}
...
choppergunner_handlemissilefire( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( self.normalspeed && self.missilesleft == 8 )
            childthread delete_breach_engine_loop_after_time();
        ...
        var_17 thread delete_covernodes( self.owner, 2, 300, 300 );
...
choppergunner_watchturretfire( var_0 )
{
    ...
    for (;;)
    {
        ...
        self.streakinfo.shots_fired++;
        var_1 thread delete_covernodes( self.owner, 0.5, 256, 200 );
    }
}
...
choppergunner_returnplayer( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            level thread scripts\cp_mp\utility\killstreak_utility::vo_manifest_scanned( var_2 );
            var_2 setclientomnvar( "ui_apache_screens_state", 0 );
            var_2 painvisionon();
            var_2 scripts\cp_mp\utility\killstreak_utility::killstreak_restorenvgstate();
...
{
    thread scripts\cp_mp\emp_debuff::start_authentication_timer( self.owner, 5 );
    choppergunner_updatetargetmarkergroups();
}
...
delete_covernodes( var_0, var_1, var_2, var_3 )
{
    level endon( "game_ended" );
