...
watchmarkeractivate( var_0 )
{
    ...
    else
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "juggernaut", "dropCrateFromScriptedHeli" ) && level.gametype != "br" )
        {
            ...
            var_2 thread scripts\cp_mp\killstreaks\airdrop::armsrace_phase_hold_behavior( var_0, "airdrop" );
        ...
        {
            var_5 = 1;
            var_2 thread scripts\cp_mp\killstreaks\airdrop::_id_11E29( var_3, var_5 );
        }
    }
}
...
createjuggobjective()
{
    ...
    if ( istrue( level.playerscoreeventref ) )
    ...
    else
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( level.teambased )
                ...
                scripts\mp\objidpoolmanager::_id_125A1( var_1, self );
        }
    }
}
...
watchjuggernautweaponswitch( var_0 )
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_128FF( "manual_switch_from_minigun", "weapon_pickup" );
