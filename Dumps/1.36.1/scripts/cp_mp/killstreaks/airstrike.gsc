...
init()
{
    ...
    init_airstrike_vo();
    level.airlock_callbuttons = [];
    level.assault_update_hint_logic = 0;
}
...
weapongivenairstrike( var_0 )
{
    ...
    var_2 = assassination_target( self.origin );
...
{
    if ( !isdefined( var_0._id_1217E ) )
    {
        var_3 = airstrike_getownerlookatpos( self );
        var_4 = assassination_target( var_3 );
    ...
    switch ( var_0.streakname )
    {
        case "precision_airstrike":
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
            {
                ...
                if ( var_3 == "br" && isdefined( self.plunder_playercanuserepository ) )
                {
                    var_0._id_1217E = self.plunder_playercanuserepository;
                    self.plunder_playercanuserepository = undefined;
                }
            }
...
selectairstrikelocation( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        var_8 = assassination_target( var_2 );
...
finishmapselectairstrikeusage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 = asm_setanimscripted( self.origin, self );
    thread airstrike_watchkills( var_7 * 2, var_8 );
    thread watchairstrikeowner( var_8 );
    thread assault1_riverbed( var_4, var_8 );
    ...
    assassinationcontract_get( self, var_8 );
    ...
    scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_4 );
}
...
watchairstrikeowner( var_0 )
{
    ...
    level endon( "game_ended" );
    scripts\engine\utility::_id_128FF( "disconnect", "joined_team" );
    assassinationcontract_get( self, var_0 );
}

callstrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 0;
    var_8 = scripts\cp_mp\utility\killstreak_utility::kingslayer();
    var_9 = 24000;
    var_10 = 6500;
    var_11 = 2500;
    var_7 = 1500;
    ...
    if ( level.mapname == "mp_br_mechanics" || scripts\cp_mp\utility\game_utility::play_players_arrive_at_exfil() )
        var_11 = var_11 + 2500;
...
doplanestrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_15.owner = var_7;
    var_16 = istrue( level.playerhastrock ) && ( isdefined( level._id_12AF8 ) && level._id_12AF8 == 6 );
    var_17 = var_16 || istrue( var_5.avoidclosetodefenderflagspawn );
    ...
    {
        var_18 = spawnstruct();
        var_18.spawnselectionmarker = var_15;
        var_18._id_12183 = var_0;
    ...
    if ( !istrue( var_5.make_use_prompt ) )
...
airstrike_playflyfx( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_7 thread assassinationcontract_complete( var_0 );
}
...
airstrike_watchkills( var_0, var_1 )
{
    ...
    scripts\engine\utility::_id_12919( var_0, var_2 );
...
callstrike_precisionbulleteffect( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = var_6;
    var_10 = istrue( level.playerhastrock ) && ( isdefined( level._id_12AF8 ) && level._id_12AF8 == 6 );
...
airstrike_getownerlookatpos( var_0, var_1 )
{
    ...
    var_6 = var_0 scripts\cp_mp\utility\killstreak_utility::swivel_dogtag_revive();
...
airstrike_watchforads( var_0, var_1 )
{
    ...
    var_2 thread assault2_fob( self );
    var_2 thread airstrike_watchdeployended( self );
    var_2 thread assassinationtimewarning( self );
...
airstrike_watchdeployended( var_0 )
{
    ...
    self endon( "death" );
    level endon( "game_ended" );
    var_1 = var_0 scripts\engine\utility::_id_12907( "cancel_fire", "successful_fire" );
...
assassinationtimewarning( var_0 )
{
    var_0 endon( "death_or_disconnect" );
    self endon( "death" );
    level endon( "game_ended" );
...
assault1_riverbed( var_0, var_1 )
{
    self endon( "airstrike_finished_" + var_1 );
    self endon( "disconnect" );
    level waittill( "game_ended" );
    scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_0 );
}

asm_setanimscripted( var_0, var_1 )
{
    level.assault_update_hint_logic++;
    var_2 = spawnstruct();
    var_2.origin = var_0;
    var_2.owner = var_1;
    var_2.id = var_1.name + "_" + level.assault_update_hint_logic;
    level.airlock_callbuttons[var_2.id] = var_2;
    return var_2.id;
}

assassinationcontract_get( var_0, var_1 )
{
    level.airlock_callbuttons = scripts\engine\utility::array_remove_index( level.airlock_callbuttons, var_1, 1 );
...
assassination_target( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        if ( level.airlock_callbuttons.size > 0 )
        {
            var_3 = 1;
            ...
            if ( level.airlock_callbuttons.size >= var_3 )
                var_1 = "KILLSTREAKS/AIR_SPACE_TOO_CROWDED";
            else
            {
                foreach ( var_6 in level.airlock_callbuttons )
                {
...
cqb_laser_guy( var_0, var_1, var_2 )
{
    var_3 = self;
    var_4 = spawnstruct();
    var_4.streakname = "precision_airstrike";
    var_4.owner = var_3;
    var_4.score = 0;
    var_4.shots_fired = 0;
    var_4.hits = 0;
    var_4.damage = 0;
    var_4.kills = 0;
    var_4.make_use_prompt = istrue( var_1 );
    var_4.avoidclosetodefenderflagspawn = istrue( var_2 );
    var_5 = undefined;
    var_6 = undefined;
    var_7 = %mp_alfa10_flyin;
    var_8 = undefined;
    level thread callstrike( var_3, var_0, var_5, var_6, var_4, var_7, var_8 );
}
