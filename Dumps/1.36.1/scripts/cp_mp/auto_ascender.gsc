...
init()
{
    ...
    initanimtree();
    scripts\engine\scriptable::winindex( "ascender", ::ascenderscriptableused );
}
...
fusesound()
{
    ...
    if ( isdefined( level.boltnumber ) )
        self [[ level.boltnumber ]]( "ascender_blocked_generic", 4 );
    else
    {
...
fx_ents()
{
    ...
    if ( isdefined( level.boltnumber ) )
        self [[ level.boltnumber ]]( "ascender_blocked_laststand", 4 );
    else
    {
...
denyascendmessage()
{
    ...
    if ( isdefined( level.boltnumber ) )
        self [[ level.boltnumber ]]( "ascender_blocked", 4 );
    else
    {
...
create_solution_digit_mark( var_0, var_1 )
{
    if ( var_1 isswitchingweapon() )
    {
        var_1 thread fusesound();
        return 0;
    }
    ...
    {
        var_2 = istrue( var_1.iszombie ) && isdefined( var_1.playersetiszombie );
    ...
    if ( !var_1 scripts\common\utility::periodic_sound_events() )
    {
        var_1 thread fusesound();
        return 0;
    }
    ...
    if ( isdefined( var_4._id_11CD8 ) && istrue( var_4._id_11CD8.inuse ) )
    {
        var_1 thread denyascendmessage();
        return 0;
    }
...
ascenderuse( var_0, var_1 )
{
    ...
    if ( !create_solution_digit_mark( var_0, var_1 ) )
        return;
    ...
    var_1.boltunlinkonnote = var_2;
    var_1.boltdeleteonnote = var_6;
    var_1.boltdeletethread = var_7;
    ...
    if ( !var_2.dir )
    {
        if ( scripts\common\utility::iscp() )
            var_9 = getdvarfloat( "scr_descender_speed_cp", jeep_initdamage() );
        else
            var_9 = getdvarfloat( "scr_descender_speed", jeep_initcollision() );
    }
    else
        var_9 = getdvarfloat( "scr_ascender_speed", jeep() );

    var_10 = var_8 / var_9;
    var_11 = javelin_interact_monitor() * var_10;
    var_12 = jeep_horn() * var_10;
...
cleanupascenduse( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        else if ( !istrue( var_0.inlaststand ) )
        {
            ...
            var_0 thread precacheitems();

        if ( isdefined( var_0.boltdeleteonnote ) )
        {
            var_0.boltdeleteonnote unlink();
            var_0.boltdeleteonnote delete();
        }

        if ( isdefined( var_0.boltdeletethread ) )
        {
            var_0.boltdeletethread unlink();
            var_0.boltdeletethread delete();
        }
    }
    ...
    if ( isdefined( var_0 ) )
    {
        var_0.boltunlinkonnote = undefined;
        var_0.boltdeleteonnote = undefined;
        var_0.boltdeletethread = undefined;
...
precacheitems()
{
    level endon( "game_ended" );
    var_0 = self;
    var_0 scripts\engine\utility::_id_128FF( "death_or_disconnect", "last_stand_finished" );
    var_0 enableoffhandweapons();
    var_0 enableweaponswitch();
    var_0 scripts\common\utility::allow_killstreaks( 1 );
    var_0 thread scripts\mp\utility\infilexfil::takegunless();
...
bolt_watchpickup()
{
    ...
    var_1 = var_0.boltunlinkonnote.ascendstructout.origin;
    var_2 = var_0.boltunlinkonnote.ascendstructout.angles;
    var_0.boltunlinkonnote cleanupascenduse( var_0 );
...
player_is_trying_self_revive( var_0 )
{
    foreach ( var_2 in level.ascendstructs )
    {
        if ( distance2dsquared( var_2.origin, var_0 ) < joininprogresstimeout() )
        {
            if ( abs( var_0[2] - var_2.origin[2] ) < jeep_initomnvars() )
                return 1;
        }
    }
