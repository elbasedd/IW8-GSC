...
{
    var_0 = spawnstruct();
    level.vehicle.setupkeybindings = var_0;
    var_0.vehicledata = [];
}

vehomn_setvehicle( var_0, var_1 )
{
    var_2 = _id_127F7( var_0 );
    var_3 = var_2.id;
...
{
    var_4 = _id_127F7( var_0 );
    var_5 = var_4.base_assault_intro_vo[var_1];
    var_6 = undefined;
...
{
    var_3 = _id_127F7( var_2 );
    var_4 = var_3._id_12976[var_0];

    if ( isdefined( var_1 ) )
    {
        var_5 = var_3._id_12979[var_0];
...
vehomn_clearwarnings( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_1 ) )
            var_2 = _id_127F7( var_1, undefined, 1 );
        ...
        if ( isarray( var_0 ) )
        {
            foreach ( var_4 in var_0 )
            {
                if ( isdefined( var_4 ) && isplayer( var_4 ) )
                {
                    ...
                    if ( isdefined( var_2 ) )
                    {
                        foreach ( var_6 in var_2._id_12977 )
                        {
                            if ( isdefined( var_6 ) )
                                thread [[ var_6 ]]( var_4 );
                        }
...
{
    var_4 = _id_127F7( var_0 );
    var_5 = var_4.waittill_player_dwells_or_wave_min_count[var_1];
    var_6 = undefined;
...
_id_127F4( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( isarray( var_0 ) )
        {
            ...
            {
                if ( isdefined( var_2 ) && isplayer( var_2 ) )
                    thread _id_127F5( var_2 );
            }
        }
        else if ( isplayer( var_0 ) )
            thread _id_127F5( var_0 );
    }
}
...
_id_127F5( var_0 )
{
    ...
    if ( !isdefined( var_0._id_127FD ) || var_0._id_127FD != "hide" && var_0._id_127FD != "fadeOut" )
    {
        var_0._id_127FD = "fadeOut";
        var_0 setclientomnvar( "ui_veh_controls", 2 );
        wait 3;
        thread _id_127F9( var_0 );
    }
}
...
_id_127F3( var_0 )
{
    return !isdefined( var_0._id_127FD ) || var_0._id_127FD == "fadeOut" || var_0._id_127FD == "hide";
}

_id_127F6()
{
    return level.vehicle.setupkeybindings;
}

_id_127F7( var_0, var_1, var_2 )
{
    var_3 = _id_127F6();
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_1 ) )
        {
            ...
            var_4.seatids = [];
            var_4.base_assault_intro_vo = [];
            var_4.waittill_player_dwells_or_wave_min_count = [];
            var_4._id_12976 = [];
            var_4._id_12979 = [];
            var_4._id_12978 = [];
            var_4._id_12977 = [];
            var_4.waittill_player_has_dropkit_marker = [];
            var_4.id = undefined;
            var_4._id_12976["burningDown"] = 1;
            var_4._id_12976["missileLocking"] = 2;
            var_4._id_12976["missileIncoming"] = 4;
            var_4._id_12976["movementDisabled"] = 3;
        }
...
_id_127F2( var_0, var_1, var_2 )
{
    var_3 = _id_127F7( var_0, var_1, var_2 );

    if ( isdefined( var_3 ) )
    {
        var_3.seatids = [];
        var_3.base_assault_intro_vo = [];
        var_3.waittill_player_dwells_or_wave_min_count = [];
        var_3._id_12976 = [];
        var_3._id_12979 = [];
        var_3._id_12978 = [];
        var_3._id_12977 = [];
...
vehomn_updateomnvarsonseatenter( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( isdefined( var_8._id_12976["movementDisabled"] ) )
            vehomn_showwarning( "movementDisabled", var_3, var_0.vehiclename );
    }

    if ( var_0 scripts\cp_mp\vehicles\vehicle_damage::_id_12706() )
    {
        if ( isdefined( var_8._id_12976["burningDown"] ) )
...
_id_127FB( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = spawnstruct();

    var_2 = _id_127F7( var_0.vehiclename, undefined, 1 );
        ...
        if ( isdefined( var_3 ) && var_3.size > 0 )
        {
            foreach ( var_6, var_5 in var_3 )
            {
                if ( isdefined( var_5 ) && isplayer( var_5 ) && var_5 scripts\cp_mp\utility\player_utility::_isalive() )
                    _id_126AB( var_0, var_5, var_6, var_1 );
            }
        }
    }
}

_id_126AB( var_0, var_1, var_2, var_3 )
{
    if ( !isdefined( var_2 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getoccupantseat( var_0, var_1 );

    _id_127FC( var_0, var_1, var_2, var_3 );
}
...
_id_127FC( var_0, var_1, var_2, var_3 )
{
    var_4 = _id_127F7( var_0.vehiclename );

    if ( var_4.waittill_player_has_dropkit_marker.size > 0 && isdefined( var_4.waittill_player_has_dropkit_marker[var_2] ) )
    {
        var_5 = 0;

        if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277E( var_0, var_2 ) )
            var_5 = 1;
        else
        {
        ...
        if ( var_5 )
        {
            ...
            {
                var_8 = var_4.waittill_player_has_dropkit_marker[var_2][var_0.objweapon.basename];
        ...
        var_13 = _id_127F8( var_0, var_3 );

        if ( isdefined( var_13 ) )
        {
            foreach ( var_15, var_8 in var_4.waittill_player_has_dropkit_marker[var_2] )
            {
...
_id_127F8( var_0, var_1 )
{
    if ( isdefined( var_1 ) && isdefined( var_1.rear_minigun ) )
        return var_1.waittill_player_dropkit_crate_used;
    ...
    if ( isdefined( var_2 ) && var_2.size > 0 )
    {
        ...
        if ( isdefined( var_1 ) )
            var_1.waittill_player_dropkit_crate_used = var_3;
