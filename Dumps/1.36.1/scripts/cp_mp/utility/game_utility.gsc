...
v_start_pos()
{
    level.play_players_arrive_at_exfil = 1;
}

play_players_arrive_at_exfil()
{
    return istrue( level.play_players_arrive_at_exfil );
}

va_cluster_spawnpoint_valid()
{
    level.get_wait_between_stations_time = 1;
}

play_players_arrive_at_extraction()
{
    return istrue( level.get_wait_between_stations_time );
}
...
van_initomnvars( var_0 )
{
    ...
    level.reload_currentsequence_button_handler = var_0;
}

player_rigs()
{
    return istrue( level.player_rigs );
}
...
validautoassignquests()
{
    level.set_relic_landlocked = 1;
}

player_equip_regen()
{
    return istrue( level.set_relic_landlocked );
}
...
getlocaleid()
{
    if ( !isdefined( level.localeid ) )
    {
        ...
        else if ( play_players_arrive_at_exfil() )
...
kiosksearchradiusidealmax( var_0, var_1 )
{
...
kiosksearchradiusidealmin( var_0, var_1 )
{
    var_2 = scripts\engine\utility::getstructarray( var_0, "targetname" );
    var_3 = [];
...
startkeyearning()
{
    ...
    _id_11A96( 255 );
    var_0 = scripts\cp\agents\gametype_cp_specops::jugg_watchforfire();
...
stopkeyearning( var_0 )
{
    ...
    if ( !isdefined( self.playersplash ) )
        _id_11A96( 255 );
    ...
    var_4 = scripts\cp\agents\gametype_cp_specops::jugg_watchforfire();
    var_5 = 0;
    var_6 = 0;
    ...
    var_8 = scripts\cp\agents\gametype_cp_specops::laser_traps_saved_origins();
    var_9 = int( gettimesincegamestart() / 1000.0 );

    if ( self.playersplash != 255 )
        scripts\cp\agents\gametype_cp_specops::should_start_cautious_approach_hq( self.playersplash );
    ...
    if ( istrue( level.ismp ) )
        self reportchallengeuserevent( "end_match", var_4, var_1, var_5, var_6, var_7, var_8, var_9, self.playersplash, var_10, var_12, var_13 );
    else
    {
        ...
        self reportchallengeuserevent( "end_match", var_4, var_1, var_5, 0, 0, var_8, var_9, self.playersplash, var_10, var_12, var_13 );
    }
...
vehicle_occupancy_setfriendlystatusdirty( var_0, var_1 )
{
    var_2 = getentarray();
    ...
    foreach ( var_4 in var_2 )
    {
        if ( isdefined( var_4.model ) && var_4.model == var_0 )
        {
            if ( istrue( var_1 ) && isdefined( var_4.target ) )
                vehicle_occupancy_mp_updateriotshield( var_4.target, "targetname" );
...
vehicle_occupancy_mp_updateriotshield( var_0, var_1 )
{
...
onplayereliminated_func()
{
    var_0 = spawnstruct();
    level.cypher_id_pool = var_0;
    var_0.game_type_col = [];
