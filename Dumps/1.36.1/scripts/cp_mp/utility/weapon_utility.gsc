...
clearlockedon( var_0 )
{
    ...
    {
        if ( isdefined( var_0.name_fx ) )
            var_0 thread [[ var_0.name_fx ]]();
    }

    var_0.hasincoming = undefined;
    var_0.nakeddrophandleloadout = undefined;
    var_0.name_fx = undefined;
}
...
allow_player_skip_deathshield( var_0 )
{
    ...
    {
        if ( isdefined( var_0.nakeddrophandleloadout ) )
            var_0 thread [[ var_0.nakeddrophandleloadout ]]();
    }
...
_id_11A91( var_0, var_1 )
{
    var_0.nakeddrophandleloadout = var_1;
}

_id_11A92( var_0, var_1 )
{
    var_0.name_fx = var_1;
}
...
watchtargetlockedontobyprojectile( var_0, var_1 )
{
    ...
    addlockedon( var_0 );
    allow_player_skip_deathshield( var_0 );
    var_1 scripts\engine\utility::_id_128FF( "death", "clearTargetLockedOntoByProjectile" );
