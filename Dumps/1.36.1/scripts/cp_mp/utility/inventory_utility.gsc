...
_takeweapon( var_0, var_1 )
{
    ...
    if ( isweapon( var_0 ) )
        ...
        var_2 = getcompleteweaponname( self gethighpriorityweapon() ) == var_0;

    if ( var_2 )
    {
        var_3 = scripts\engine\utility::ter_op( isstring( var_0 ), var_0, getcompleteweaponname( var_0 ) );
