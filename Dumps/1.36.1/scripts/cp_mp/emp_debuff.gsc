...
start_authentication_timer( var_0, var_1 )
{
    var_0 play_emp_scramble( var_1 );
    scripts\engine\utility::_id_128FF( "emp_cleared", "death" );
...
emp_update_ents()
{
    ...
    if ( isdefined( level.heliextractcallback ) )
    {
        foreach ( var_28 in level.heliextractcallback )
