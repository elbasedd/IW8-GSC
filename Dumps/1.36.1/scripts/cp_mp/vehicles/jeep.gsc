...
jeep_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "jeep", "single", [ "driver", "front_right", "back_left", "back_right" ] );
}

playerlocationselectinterrupt()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "jeep", 1 );
    var_0.id = 10;
...
playerkillstreakgetownerlookatignoreents()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "jeep", 1500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "jeep" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "jeep" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "jeep", 9 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "jeep", ::jeep_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "jeep_mp", 3 );
}

playerkilledspawn()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "jeep", 1 );
    var_0.bot_can_switch_to_defender = 1.33333;
    var_0.flashtheprops = 0.91666;
    var_0.exterior_goal_func = 350;
    var_0.extra_bomb_explode_vfx_func = 525;
    var_0.extendcirclelist = 875;
    var_0.extra_glow_sticks_init = 10;
    var_0.extra_riders_func = 40;
    var_0.extra_enemies = 80;
...
jeep_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "jeep", var_0 );
...
jeep_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "jeep_mp" );
