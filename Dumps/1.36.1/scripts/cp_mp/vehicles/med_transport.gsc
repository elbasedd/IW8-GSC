...
resetstuckthermite()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "medium_transport", 1 );
    var_0.id = 11;
...
resetstreamerposhint()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "medium_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "medium_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "medium_transport", 13 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "medium_transport", ::med_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "med_transport_mp", 3 );
}
...
med_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "medium_transport", var_0 );
