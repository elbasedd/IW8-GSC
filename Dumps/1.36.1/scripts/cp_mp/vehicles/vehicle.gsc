...
vehicle_init()
{
    ...
    scripts\mp\trials\trial_jugg::_id_126D1();
    scripts\cp_mp\utility\vehicle_omnvar_utility::vehomn_init();
    scripts\mp\trials\trial_gun_course::_id_126C0();
    ...
    scripts\mp\trials\mp_trl_gunslinger_memory_create_script::ctf_bot_attacker_limit_for_team();
    scripts\mp\trials\trial_enemy_sentry_turret::spawn_finale_wave();
    ...
    scripts\mp\trials\mp_trl_quarry_raceislava_trial_create_a_script::quickdropremoveplunderfrominventory();
    ...
    scripts\mp\trials\trial_arm_course::script_end();
}
...
_id_126E4( var_0, var_1, var_2 )
{
    ...
    scripts\cp_mp\utility\weapon_utility::_id_11A91( var_0, ::_id_1273F );
    scripts\cp_mp\utility\weapon_utility::_id_11A92( var_0, ::_id_12740 );
    ...
    thread _id_127BB( var_0 );
}

_id_126E5( var_0, var_1 )
{
...
_id_1272D( var_0 )
{
    ...
    scripts\mp\trials\trial_jugg::_id_126CF( var_0 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_126ED( var_0 );
...
_id_127BB( var_0 )
{
    ...
    thread scripts\mp\trials\trial_gun_course::_id_126C7( var_0 );

    while ( isdefined( var_0 ) )
    {
        var_2 = spawnstruct();
        scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127FB( var_0 );
        _id_126AF( var_0 );

        if ( isdefined( var_1._id_125C2 ) )
            var_0 [[ var_1._id_125C2 ]]( var_2 );
...
_id_126B1( var_0 )
{
    if ( isdefined( var_0._id_127E7 ) )
    {
        if ( var_0._id_127E7 != "" )
        {
            ...
            {
                if ( var_0 getscriptableparthasstate( "trail", var_0._id_127E7 ) )
                    var_0 setscriptablepartstate( "trail", var_0._id_127E7 );
            }
            else if ( var_0 getscriptableparthasstate( "trail", var_0._id_127E7 + "_idle" ) )
                var_0 setscriptablepartstate( "trail", var_0._id_127E7 + "_idle" );
        }
    }
}
...
_id_126AF( var_0 )
{
    if ( !var_0 scripts\cp_mp\vehicles\vehicle_tracking::_issuspendedvehicle() && !istrue( var_0 vehiclecanfly() ) && !var_0 vehicle_isonground() )
    {
        ...
        {
            if ( !isdefined( var_0.spawn_module_lmg_2 ) )
                var_0.spawn_module_lmg_2 = gettime();

            if ( gettime() - var_0.spawn_module_lmg_2 >= 650 )
            {
                var_2 = ( 128, 128, 128 );
                ...
                {
                    if ( isdefined( var_7 ) && var_7 scripts\cp_mp\killstreaks\helper_drone::playanim_aioperateturret() && !istrue( var_7.isdestroyed ) )
                    {
                        var_7 thread scripts\cp_mp\killstreaks\helper_drone::helperdroneexplode( 0 );
                        var_0.spawn_module_lmg_2 = undefined;
                    }
                }
...
_id_127A2( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( var_3 ) )
        thread _id_127B7( var_0, var_1 );
}

_id_12730( var_0, var_1 )
{
    if ( !isdefined( var_0.turrets ) )
        return;
...
_id_1275C( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12781( var_0, var_1 );
...
_id_1275A( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277F( var_0, var_1 );
    else if ( level.teambased )
    {
        var_2 = var_0.team;
...
_id_1275E( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12783( var_0, var_1 );
    else if ( level.teambased )
...
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12782( var_0, var_1 );
    else
    {
        if ( level.teambased )
...
_id_1275B( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12780( var_0, var_1 );
    else
    {
        if ( level.teambased )
            return isdefined( var_0.team ) && var_0.team != var_1;
...
_id_1275F( var_0, var_1 )
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12784( var_0, var_1 );
    else
    {
        if ( level.teambased )
...
{
    if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_0 ) )
        return scripts\cp_mp\vehicles\vehicle_occupancy::_id_12777( var_0 );
    else
    {
...
_id_1279B( var_0 )
{
    ...
    var_2 = scripts\cp_mp\utility\player_utility::keep_firing_minigun();
...
vehicle_watchflipped( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            if ( var_4 )
            {
                scripts\cp_mp\vehicles\vehicle_occupancy::_id_12766( var_0, 1 );
        ...
        if ( var_7 )
        {
            ...
            if ( !var_4 )
            {
                scripts\cp_mp\vehicles\vehicle_occupancy::_id_12766( var_0, 0 );
