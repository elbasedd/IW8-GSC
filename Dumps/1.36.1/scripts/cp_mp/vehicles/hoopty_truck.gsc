...
molotov_trigger_timeout()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "hoopty_truck", 1 );
    var_0.id = 12;
...
molotov_store_branch_ents()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "hoopty_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty_truck" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "hoopty_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "hoopty_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "hoopty_truck", ::hoopty_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "hoopty_truck_mp", 3 );
}
...
hoopty_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "hoopty_truck", var_0 );
