...
vehicle_spawn_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) && istrue( var_1 ) )
    {
        ...
        var_3._id_12241 = undefined;
        var_3.vip_respawnplayer = undefined;
        var_3._id_12242 = undefined;
    }
...
vehicle_spawn_init()
{
    ...
    var_0.vipbot_movesup = getdvarint( "scr_respawnVehicleDelayOverride", 0 );
    var_0.affect_hvt_healthdrain = getdvarint( "scr_abandonedVehicleTimeoutOverride", 0 );
    var_0.vip_respawnplayer = getdvarint( "scr_respawnVehicleDelay", 60 );
    var_0.advanced_supply_drop_refund_on_death = getdvarint( "scr_abandonedVehicleTimeout", 30 );
...
_id_127B2( var_0, var_1, var_2 )
{
    ...
    if ( var_4.vipbot_movesup != 0 )
        var_5 = var_4.vipbot_movesup;
    else if ( isdefined( var_3.vip_respawnplayer ) )
        var_5 = var_3.vip_respawnplayer;
    else
        var_5 = var_4.vip_respawnplayer;
...
_id_127B3()
{
    ...
    if ( !isdefined( var_0.advanced_supply_drop_marker_sfx ) )
        return;
    ...
    if ( var_1.affect_hvt_healthdrain != 0 )
        var_2 = var_1.affect_hvt_healthdrain;
    else if ( isdefined( var_0.advanced_supply_drop_refund_on_death ) )
        var_2 = var_0.advanced_supply_drop_refund_on_death;
    else
        var_2 = var_1.advanced_supply_drop_refund_on_death;
...
{
    _id_127B1();
    self.get_wave_data = 1;
    var_0 = vehicle_spawn_getleveldataforvehicle( self.vehiclename );
    self thread [[ var_0.advanced_supply_drop_marker_sfx ]]();
}

_id_127AA()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::_id_126FD();
    ...
    if ( var_0 != "heavy" )
    {
        ...
        scripts\cp_mp\vehicles\vehicle_damage::_id_12720( "heavy", var_0 );
    }
}
