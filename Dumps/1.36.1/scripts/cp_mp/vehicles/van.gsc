...
_id_1269A()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "van", 1 );
    var_0.id = 13;
...
_id_12699()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "van", 1350 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "van" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "van" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "van", 8 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "van", ::van_deathcallback );
}
...
van_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "van", var_0 );
