...
apc_rus_initoccupancy()
{
    ...
    var_4._id_124BF = makeweapon( "tur_apc_rus_mp" );
...
apc_rus_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "apc_russian", "single", [ "driver", "front_right", "back_right", "back", "back_left", "front_left" ] );
}

bhadriotshield()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "apc_russian", 1 );
    var_0.bot_can_switch_to_defender = 2.33333;
    var_0.flashtheprops = 0.66666;
    var_0.exterior_goal_func = 350;
    var_0.extra_bomb_explode_vfx_func = 525;
    var_0.extendcirclelist = 875;
    var_0.extra_glow_sticks_init = 2.5;
    var_0.extra_riders_func = 10;
    var_0.extra_enemies = 20;
...
bhasthermitestucktoshield()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "apc_russian", 1 );
    var_0.id = 15;
    ...
    var_0.base_assault_intro_vo["driverTurret"] = 0;
    var_0.waittill_player_dwells_or_wave_min_count["chassis"] = 0;
    var_0.waittill_player_dwells_or_wave_min_count["turret"] = 1;
    var_0.waittill_player_has_dropkit_marker["driver"]["apc_rus_mp"] = "chassis";
    var_0.waittill_player_has_dropkit_marker["driver"]["tur_apc_rus_mp"] = "turret";
    var_0.waittill_player_has_dropkit_marker["front_left"]["apc_rus_mp"] = "chassis";
    var_0.waittill_player_has_dropkit_marker["front_left"]["tur_apc_rus_mp"] = "turret";
    var_0.waittill_player_has_dropkit_marker["front_right"]["apc_rus_mp"] = "chassis";
    var_0.waittill_player_has_dropkit_marker["front_right"]["tur_apc_rus_mp"] = "turret";
    var_0.waittill_player_has_dropkit_marker["back_right"]["apc_rus_mp"] = "chassis";
    var_0.waittill_player_has_dropkit_marker["back_right"]["tur_apc_rus_mp"] = "turret";
    var_0.waittill_player_has_dropkit_marker["back_left"]["apc_rus_mp"] = "chassis";
    var_0.waittill_player_has_dropkit_marker["back_left"]["tur_apc_rus_mp"] = "turret";
    var_0.waittill_player_has_dropkit_marker["back"]["apc_rus_mp"] = "chassis";
    var_0.waittill_player_has_dropkit_marker["back"]["tur_apc_rus_mp"] = "turret";
}

bhasriotshieldattached()
{
    var_0 = getdvarint( "scr_gw_apc_health_override", 4000 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "apc_russian", var_0 );
    var_1 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "apc_russian" );
    var_1.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "apc_russian" );
    var_2 = getdvarint( "scr_gw_apc_hits_override", 18 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "apc_russian", var_2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271F( "apc_russian", ::apc_rus_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271E( "apc_russian", ::binding );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "apc_russian", ::apc_rus_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "tur_apc_rus_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "apc_rus_mp", 5 );
}
...
apc_rus_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_127A2( var_2, var_3, makeweapon( "tur_apc_rus_mp" ), 1 );
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "apc_russian", var_0 );
    var_2.objweapon = makeweapon( "apc_rus_mp" );
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::_id_126F7( var_2, 1 );
    var_4.gas_fx = "none";
    var_4.gas_at_computer = "kill_apc_rus";
    var_4.gas_attack = 1;
...
apc_rus_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "apc_rus_mp" );
        var_3 = scripts\engine\utility::ter_op( istrue( self.spawndata.usealtmodel ), "apc_rus_explode_alt", "apc_rus_explode" );
        playfx( scripts\engine\utility::getfx( var_3 ), var_2, anglestoforward( self.angles ), anglestoup( self.angles ) );
...
apc_rus_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < var_8 )
        var_0.player_rig_create = besttimestate( var_0 );
...
apc_rus_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, "tur_apc_rus_mp" );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12739( self, "tur_apc_rus_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 14;
    bink_save_hack();
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12739( self, "tur_apc_rus_mp" );
