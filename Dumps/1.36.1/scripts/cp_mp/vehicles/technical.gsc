...
technical_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "technical", "single", [ "driver", "fl_rear", "fr_rear", "bl_rear", "br_rear" ] );
}

_id_121C1()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "technical", 1 );
    var_0.id = 0;
...
_id_121BF()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "technical", 1 );
    var_0.bot_can_switch_to_defender = 1.16666;
    var_0.flashtheprops = 0.95833;
    var_0.exterior_goal_func = 350;
    var_0.extra_bomb_explode_vfx_func = 525;
    var_0.extendcirclelist = 875;
    var_0.extra_glow_sticks_init = 11.25;
    var_0.extra_riders_func = 45;
    var_0.extra_enemies = 90;
...
_id_121C0()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "technical", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "technical" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "technical" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "technical", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "technical", ::technical_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "technical_mp", 3 );
}
...
technical_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "technical", var_0 );
...
technical_enterstart( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) && isplayer( var_3 ) && isdefined( var_3.quarry_mortar_guys ) )
        var_3.quarry_mortar_guys hide();
}
