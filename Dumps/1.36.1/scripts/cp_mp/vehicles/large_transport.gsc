...
large_transport_init()
{
    ...
    plunder_repositorysendcountdownmessage();
...
plunder_repositorysendcountdownmessage()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "large_transport", 1 );
    var_0.id = 5;
...
plunder_repositoryplayerplundereventcallback()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "large_transport", 2000 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "large_transport" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "large_transport", 10 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "large_transport", ::large_transport_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "large_transport_mp", 3 );
}
...
large_transport_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "large_transport", var_0 );
