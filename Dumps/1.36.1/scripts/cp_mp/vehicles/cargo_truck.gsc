...
cargo_truck_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "cargo_truck", "single", [ "driver" ] );
}

createscriptedspawnpoint()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "cargo_truck", 1 );
    var_0.id = 8;
...
createscript_covernodes()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "cargo_truck", 3500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cargo_truck" );
    var_0.class = "heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "cargo_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "cargo_truck", 20 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "cargo_truck", ::cargo_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "cargo_truck_mp", 5 );
}

createscreeneffectext()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "cargo_truck", 1 );
    var_0.bot_can_switch_to_defender = 2;
    var_0.flashtheprops = 0.75;
    var_0.exterior_goal_func = 350;
    var_0.extra_bomb_explode_vfx_func = 525;
    var_0.extendcirclelist = 875;
    var_0.extra_glow_sticks_init = 5;
    var_0.extra_riders_func = 20;
    var_0.extra_enemies = 40;
...
cargo_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "cargo_truck", var_0 );
...
cargo_truck_explode( var_0, var_1 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_2, 256, 140, 70, self, "MOD_EXPLOSIVE", "cargo_truck_mp" );
