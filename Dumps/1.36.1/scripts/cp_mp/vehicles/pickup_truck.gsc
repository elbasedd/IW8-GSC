...
spawndangertriggers()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "pickup_truck", 1 );
    var_0.id = 7;
...
spawncrossbowbolt()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "pickup_truck", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "pickup_truck" );
    var_0.class = "medium";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "pickup_truck" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "pickup_truck", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "pickup_truck", ::pickup_truck_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "pickup_truck_mp", 3 );
}
...
pickup_truck_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "pickup_truck", var_0 );
