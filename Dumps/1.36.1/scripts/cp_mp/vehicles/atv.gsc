...
atv_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "atv", "single", [ "driver", "rear" ] );
}

bot_cur_loadout_num()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "atv", 1 );
    var_0.id = 4;
...
bot_ctf_recover_flag()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "atv", 500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "atv" );
    var_0.class = "super_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "atv" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "atv", 4 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12722( "atv", 6, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "atv", ::atv_deathcallback );
}

bot_ctf_player_has_flag()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "atv", 1 );
    ...
    var_1.flashtheprops["atv"] = [];
    var_1.flashtheprops["atv"]["cargo_truck"] = 2;
}
...
atv_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "atv", var_0 );
