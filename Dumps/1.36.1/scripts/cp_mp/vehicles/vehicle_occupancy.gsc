...
vehicle_occupancy_getleveldataforvehicle( var_0, var_1 )
{
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            var_3.sat_wait_for_power = undefined;
            var_3.restrictions = [];
...
vehicle_occupancy_getleveldataforseat( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        if ( istrue( var_2 ) )
        {
            ...
            var_4._id_11C00 = undefined;
            var_4._id_124BF = undefined;
        }
    }
...
vehicle_occupancy_deregisterinstance( var_0 )
{
    ...
    var_0.trial_dlog_gun = undefined;
...
vehicle_occupancy_enter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( vehicle_occupancy_seatisavailable( var_0, var_1, var_2 ) ) )
    {
        ...
        if ( var_10 )
        {
            ...
            if ( istrue( var_2.para_groups ) )
                var_2 notify( "br_try_armor_cancel" );

            if ( isdefined( var_9 ) )
            {
                var_11 = _id_1277E( var_0, var_9 );
            ...
            if ( isdefined( var_1 ) )
            {
                ...
                if ( istrue( var_11 ) )
                {
                    ...
                    {
                        case "apc_russian":
                            var_13 = var_2._id_127C6.apc;
                            var_14 = var_2._id_127C6.binoculars_checkexpirationtimer;
                            var_12 = 1;
                            var_15 = var_2._id_127C6.bestplayer;
                            break;
                        case "atv":
                            var_13 = var_2._id_127C6.bot_ctf_my_team_flag_is_picked_up;
                            var_15 = var_2._id_127C6.bot_ctf_player_always_attacker;
                            var_16 = var_2._id_127C6.bot_dd_ai_director_update;
                            break;
                        case "cargo_truck_mg":
                        case "cargo_truck":
                            var_13 = var_2._id_127C6.createquestobjicon;
                            var_15 = var_2._id_127C6.createrectangularzonebasedonent;
                            break;
                        case "jeep":
                            var_13 = var_2._id_127C6.playerjailtimeout;
                            var_15 = var_2._id_127C6.playerkilled_washitbyvehicle;
                            break;
                        case "little_bird_mg":
                        case "little_bird":
                            var_13 = var_2._id_127C6.questenabled;
                            var_15 = var_2._id_127C6.questinstance;
                            var_16 = var_2._id_127C6.race_ui_lap;
                            break;
                        case "tac_rover":
                            var_13 = var_2._id_127C6._id_12101;
                            var_15 = var_2._id_127C6._id_12102;
                            var_16 = var_2._id_127C6._id_12106;
                            break;
                        case "light_tank":
                            var_13 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_127C6._id_1214B, var_2._id_127C6._id_12156 );
                            var_14 = scripts\engine\utility::ter_op( isdefined( var_0.spawndata.usealtmodel ), var_2._id_127C6._id_1214C, var_2._id_127C6._id_12157 );
                            var_12 = 1;
                            break;
                        default:
                            var_13 = "";
                    ...
                    if ( var_13 != "" && !isdefined( var_0.create_cursor_hint_forced ) )
                    {
                        ...
                        var_0._id_127E7 = var_16;
                        var_0.create_cursor_hint_forced = 1;
                    }
            ...
            _computerrebootsequence_start::branalytics_bonusxp_debugdata( var_0, var_2, var_1, var_9 );
            scripts\cp_mp\vehicles\vehicle_dlog::_id_12732( var_0, var_2, var_1, var_20 );
        }
...
_id_12781( var_0, var_1 )
{
    if ( level.teambased )
        return _id_12782( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.init_keypad_display_digits ) )
            var_0 _id_12768( var_0 );

        return isdefined( var_0.subway_fast_travel_teleport_data ) && var_0.subway_fast_travel_teleport_data == var_1;
    }
}

_id_1277F( var_0, var_1 )
{
    if ( level.teambased )
        return _id_12780( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.init_keypad_display_digits ) )
            var_0 _id_12768( var_0 );
...
_id_12783( var_0, var_1 )
{
    if ( level.teambased )
        return _id_12784( var_0, var_1.team );
    else
    {
        if ( istrue( var_0.init_keypad_display_digits ) )
            var_0 _id_12768( var_0 );

        return !isdefined( var_0.subway_fast_travel_teleport_data );
    }
}
...
_id_12775( var_0 )
{
    if ( !level.teambased )
    {
        ...
        return var_0.subway_fast_travel_teleport_data;
    }

    return undefined;
}

_id_12782( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.init_keypad_display_digits ) )
        ...
        return isdefined( var_0._id_1219A ) && var_0._id_1219A == var_1;
    }

    return undefined;
}

_id_12780( var_0, var_1 )
{
    if ( level.teambased )
    {
        if ( istrue( var_0.init_keypad_display_digits ) )
...
_id_12784( var_0, var_1 )
{
    if ( level.teambased )
    {
        ...
        return !isdefined( var_0._id_1219A );
    }
...
_id_12792( var_0 )
{
    var_0.init_keypad_display_digits = 1;
...
_id_12768( var_0 )
{
    ...
    {
        var_1 = 0;
        var_2 = var_0._id_1219A;

        if ( isdefined( var_0.team ) && var_0.team != "neutral" )
        {
            var_0._id_1219A = var_0.team;
            var_0.init_keypad_display_digits = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            var_0._id_1219A = undefined;
            var_0.init_keypad_display_digits = undefined;
        }

        if ( !isdefined( var_2 ) && !isdefined( var_0._id_1219A ) )
            return 0;

        if ( isdefined( var_2 ) && isdefined( var_0._id_1219A ) && var_2 == var_0._id_1219A )
            return 0;

        _id_12774( var_0, var_2, var_0._id_1219A );
        return 1;
    }
    else
    {
        var_1 = 0;
        var_6 = var_0.subway_fast_travel_teleport_data;

        if ( isdefined( var_0.originalowner ) )
        {
            var_0.subway_fast_travel_teleport_data = var_0.originalowner;
            var_0.init_keypad_display_digits = undefined;
            var_1 = 1;
        }
        ...
        if ( !var_1 )
        {
            ...
            foreach ( var_4 in var_7 )
            {
                if ( isdefined( var_4 ) )
                {
                    var_0.subway_fast_travel_teleport_data = var_4;
                    var_0.init_keypad_display_digits = undefined;
                    return;
                }
            }
        ...
        if ( !isdefined( var_6 ) && !isdefined( var_0.subway_fast_travel_teleport_data ) )
            return 0;

        if ( isdefined( var_6 ) && isdefined( var_0.subway_fast_travel_teleport_data ) && var_6 == var_0.subway_fast_travel_teleport_data )
            return 0;

        _id_12774( var_0, var_6, var_0.subway_fast_travel_teleport_data );
        return 1;
    }
}
...
{
    scripts\mp\trials\trial_jugg::_id_126CD( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( !isdefined( var_3.init_key ) )
        return;

    thread [[ var_3.init_key ]]( var_0, var_1, var_2 );
}
...
vehicle_occupancy_init()
{
    ...
    var_0.vehicledata = [];
    var_0._id_12357 = getdvarint( "scr_transitionHideEnabled", 1 ) > 0;
...
vehicle_occupancy_enterend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
    {
        ...
        _id_1277A( var_0, var_1, var_3, var_4 );
        ...
        if ( !isdefined( var_2 ) )
        {
            ...
            if ( isdefined( var_5.shield ) )
                thread _id_12779( var_3, var_5, 1 );
        }
        else
        {
            ...
            if ( isdefined( var_5.shield ) )
                thread _id_12779( var_3, var_5, 0 );
        }
    }
    else
    {
...
vehicle_occupancy_exitend( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        ...
        if ( !isdefined( var_2 ) )
        {
            if ( isdefined( var_3._id_127F0 ) )
                var_3._id_127F0 = undefined;

            if ( isdefined( var_3._id_127EF ) )
                var_3._id_127EF = undefined;
        }
    }
}
...
_id_12779( var_0, var_1, var_2 )
{
    var_3 = 5000;

    if ( istrue( var_2 ) )
    {
        var_0._id_127F0 = var_1.shield;
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.shield, undefined, 1 );
        var_0._id_127EF = gettime();
    }
    else if ( isdefined( var_0._id_127F0 ) && isdefined( var_0._id_127EF ) && var_0._id_127F0 != var_1.shield && gettime() - var_0._id_127EF > var_3 )
    {
        thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "trySayLocalSound" ) ]]( var_0, var_1.shield );
        var_0._id_127F0 = var_1.shield;
        var_0._id_127EF = gettime();
    }
}
...
{
    _id_12792( var_0 );
    var_0 scripts\cp_mp\vehicles\vehicle_spawn::_id_127B1();
    var_2 setstance( "stand" );
    var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 0 );
    thread _id_12796( var_2, var_0, var_1 );
    _computerrebootsequence_start::br_pe_chopper_crate_index( var_0, var_2 );
...
vehicle_occupancy_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        ...
        if ( !istrue( var_3.playerdeath ) )
        {
            if ( istrue( var_3.playerlaststand ) )
                var_3.headlessloadoutindexsecondary = "DEATH";
            else if ( !isdefined( var_3.headlessloadoutindexsecondary ) )
                var_3.headlessloadoutindexsecondary = "VOLUNTARY";

            var_2 scripts\common\utility::allow_array( vehicle_occupancy_getoccupantrestrictions(), 1 );
            thread scripts\cp_mp\vehicles\vehicle::_id_1279E( var_0, var_2 );
        }
        else
            var_3.headlessloadoutindexsecondary = "DEATH";

        thread _id_12778( var_2, var_3.playerdeath, var_3.playerlaststand );
    }
    else
        var_3.headlessloadoutindexsecondary = "DISCONNECT";

    _id_12792( var_0 );

    if ( scripts\cp_mp\vehicles\vehicle_spawn::_id_127AD() && var_0.occupants.size == 0 )
        var_0 thread scripts\cp_mp\vehicles\vehicle_spawn::_id_127B3();
    ...
    scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_exitevent( var_0, var_2, var_1, var_3.headlessloadoutindexsecondary );
    _computerrebootsequence_start::br_pe_chopper_crates( var_0, var_2, var_1 );
}
...
_id_1277C()
{
    if ( !isdefined( level.modespawnclient ) )
        level.modespawnclient = getdvarint( "scr_hideOccupantWithStack", 1 );

    return level.modespawnclient;
}
...
vehicle_occupancy_hideoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        ...
        if ( _id_1277C() )
            var_2 scripts\cp_mp\utility\player_utility::add_object_to_trap_room_ents();
        else
            var_2 playerhide();
    }
}

_id_1277B( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    var_3 = var_2._id_12358;
    var_2._id_12358++;
    var_0 scripts\cp_mp\utility\player_utility::add_object_to_trap_room_ents();
    var_2._id_12359[var_3] = var_0;

    if ( !isdefined( var_1._id_12359 ) )
        var_1._id_12359 = [];

    var_1._id_12359[var_3] = var_0;
    return var_3;
}

_id_12795( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3._id_12359[var_0] ) )
        return;

    var_4 = var_3._id_12359[var_0];

    if ( isdefined( var_1 ) && isdefined( var_1._id_12359 ) )
        var_1._id_12359[var_0] = undefined;

    if ( isdefined( var_4 ) )
        var_4 scripts\cp_mp\utility\player_utility::add_outline();
}

_id_12794( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    if ( !isdefined( var_0._id_12359 ) )
        return;

    foreach ( var_5, var_4 in var_0._id_12359 )
    {
        if ( isdefined( var_2._id_12359[var_5] ) )
        {
            var_2._id_12359[var_5] = undefined;
...
_id_12769()
{
    ...
    foreach ( var_3, var_2 in var_0._id_12359 )
    {
        if ( !isdefined( var_2 ) )
            var_0._id_12359[var_3] = undefined;
    }
}
...
vehicle_occupancy_showoccupant( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) || istrue( var_4 ) )
    {
        if ( _id_1277C() )
        {
            if ( istrue( var_4 ) )
            {
                var_2 scripts\cp_mp\utility\player_utility::support_box_use_logic();
                var_2 playershow();
            }
            else
                var_2 scripts\cp_mp\utility\player_utility::add_outline();
        }
        else
            var_2 playershow();
    }
...
_id_12787( var_0, var_1, var_2 )
{
    ...
    if ( scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F3( var_1 ) )
        return;

    if ( 1 )
        wait 1.5;

    childthread _id_12789( var_0, var_1, var_2 );
    childthread _id_1278A( var_0, var_1, var_2 );
    var_3 = vehicle_occupancy_getleveldataforvehicle( var_0.vehiclename );

    if ( isdefined( var_3.sat_wait_for_power ) )
        childthread [[ var_3.sat_wait_for_power ]]( var_0, var_1, var_2, "vehicle_occupancy_monitorControls" );
}

_id_12772( var_0 )
{
    scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F4( var_0 );
    var_0 notify( "vehicle_occupancy_monitorControls" );
}

_id_12789( var_0, var_1, var_2 )
{
...
_id_1278A( var_0, var_1, var_2 )
{
    var_3 = vehicle_occupancy_getleveldataforseat( var_0.vehiclename, var_2 );

    if ( isdefined( var_3._id_124BF ) )
    {
        var_4 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, var_3._id_124BF );

        if ( isdefined( var_4 ) )
        {
            var_4 scripts\engine\utility::_id_128FF( "turret_fire", "turret_reload" );
            _id_12772( var_1 );
        }
    }
}
...
vehicle_occupancy_raceplayerdeathdisconnect( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\engine\utility::_id_1290F( "death", "disconnect", "last_stand_start" );
...
vehicle_occupancy_watchownerjoinedteam( var_0, var_1 )
{
    ...
    var_1 scripts\engine\utility::_id_128FF( "joined_team", "joined_spectators" );
...
vehicle_occupancy_animateplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        add_head_icon_on_allies( var_4, var_5 );
        thread add_module_ai_spawn_func_to_module( 1 );
    }
    ...
    if ( vehicle_occupancy_checkvalidanimtype( var_9, var_3 ) )
    {
        ...
        scripts\engine\utility::_id_128FF( "death_or_disconnect", "last_stand_start" );
...
vehicle_occupancy_taketurret( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0 hasweapon( var_2 ) )
    {
        ...
        {
            if ( isdefined( var_5 ) )
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_12738( var_1, var_5 );
            else
                var_7 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_1, var_2 );
...
vehicle_occupancy_ejectalloccupants( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            var_5.headlessloadoutindexsecondary = "INVOLUNTARY";
...
_id_1277A( var_0, var_1, var_2, var_3 )
{
...
_id_12793( var_0, var_1, var_2, var_3 )
{
...
vehicle_occupancy_assignseatcorpse( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !var_3 )
        var_0.get_weapon_ammo_matched = 1;
}
...
_id_1276C( var_0, var_1, var_2 )
{
    ...
    var_0.get_weapon_ammo_matched = undefined;
}
...
vehicle_occupancy_deleteseatcorpse( var_0, var_1, var_2 )
{
    if ( isdefined( var_0.corpses ) && isdefined( var_0.corpses[var_1] ) )
    {
        ...
        if ( isdefined( var_3 ) )
        {
            if ( !istrue( var_3.get_weapon_ammo_matched ) || !var_2 )
            {
...
_id_12766( var_0, var_1 )
{
    ...
    else
    {
        if ( var_1 )
        {
            var_0.trial_dlog_gun--;
            return;
        }

        if ( !isdefined( var_0.trial_dlog_gun ) )
            var_0.trial_dlog_gun = 0;
...
_id_12767( var_0 )
{
    ...
    if ( isdefined( var_0.trial_dlog_gun ) && var_0.trial_dlog_gun > 0 )
        return 0;
...
vehicle_occupancy_killoccupants( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isdefined( var_6 ) && var_6 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            {
                if ( isdefined( var_6.juggcontext.juggconfig._id_127C2 ) && var_6.health > var_6.juggcontext.juggconfig._id_127C2 )
                    var_8 = 1;
            }
            ...
            if ( !istrue( var_8 ) )
            {
                ...
                if ( isdefined( level._id_127DA ) )
                    var_6 thread [[ level._id_127DA ]]();
            }
