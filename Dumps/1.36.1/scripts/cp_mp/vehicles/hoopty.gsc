...
molotov_register_trigger()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "hoopty", 1 );
    var_0.id = 9;
...
molotov_register_scriptable()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "hoopty", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "hoopty" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "hoopty" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "hoopty", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "hoopty", ::hoopty_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "hoopty_mp", 3 );
}
...
hoopty_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "hoopty", var_0 );
