...
drone_instant_killed_monitor()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "cop_car", 1 );
    var_0.id = 6;
...
drone_death_cleanup()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "cop_car", 1000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "cop_car" );
    var_0.class = "medium_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "cop_car" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "cop_car", 6 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "cop_car", ::cop_car_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "cop_car_mp", 3 );
}
...
cop_car_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "cop_car", var_0 );
