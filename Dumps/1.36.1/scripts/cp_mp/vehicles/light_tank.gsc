...
light_tank_initoccupancy()
{
    ...
    var_4._id_124BF = makeweapon( "tur_bradley_mp" );
    ...
    var_4._id_124BF = makeweapon( "tur_gun_lighttank_mp" );
    var_4.shield = "ping_vehicle_gunner";
}

proximity_explode()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "light_tank", 1 );
    var_0.bot_can_switch_to_defender = 2.5;
    var_0.flashtheprops = 0.625;
    var_0.exterior_goal_func = 350;
    var_0.extra_bomb_explode_vfx_func = 525;
    var_0.extendcirclelist = 875;
    var_0.extra_glow_sticks_init = 1.25;
    var_0.extra_riders_func = 5;
    var_0.extra_enemies = 10;
...
light_tank_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "light_tank", "single", [ "driver", "gunner" ] );
}

proxy_include()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "light_tank", 1 );
    var_0.id = 1;
    var_0.seatids["driver"] = 0;
    var_0.seatids["gunner"] = 1;
    var_0.base_assault_intro_vo["turret"] = 0;
    var_0.base_assault_intro_vo["missile"] = 1;
    var_0.base_assault_intro_vo["smoke"] = 2;
    var_0.waittill_player_dwells_or_wave_min_count[0] = 0;
    var_0.waittill_player_dwells_or_wave_min_count[1] = 1;
    var_0.waittill_player_has_dropkit_marker["driver"]["lighttank_mp"] = 0;
    var_0.waittill_player_has_dropkit_marker["driver"]["tur_gun_lighttank_mp"] = 1;
    var_0.waittill_player_has_dropkit_marker["driver"]["tur_gun_lighttank_ks_mp"] = 1;
    var_0.waittill_player_has_dropkit_marker["gunner"]["tur_bradley_mp"] = 0;
    var_0.waittill_player_has_dropkit_marker["gunner"]["tur_bradley_ks_mp"] = 0;
    var_0.waittill_player_has_dropkit_marker["gunner"]["tur_gun_lighttank_mp"] = 1;
    var_0.waittill_player_has_dropkit_marker["driver"]["tur_gun_lighttank_ks_mp"] = 1;
}

proxtrigger()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "light_tank", 3000 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "light_tank" );
    var_0.class = "super_heavy";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "light_tank" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "light_tank", 15 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271F( "light_tank", ::light_tank_premoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271E( "light_tank", ::light_tank_postmoddamagecallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "light_tank", ::light_tank_deathcallback );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "lighttank_tur_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "lighttank_tur_ks_mp", 2 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "bradley_tow_proj_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "bradley_tow_proj_ks_mp", 7 );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12724( "lighttank_mp", 5 );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    var_2.play_travel_vo = var_0.spawntype == "KILLSTREAK";
    var_3 = light_tank_createdriverturret( var_2, var_0 );
    var_3.missilesleft = 2;
    var_3.lastmissilefired = 0;
    scripts\cp_mp\vehicles\vehicle::_id_127A2( var_2, var_3, makeweapon( "tur_bradley_mp" ), 1 );
    var_3 = light_tank_creategunnerturret( var_2, var_0 );
    scripts\cp_mp\vehicles\vehicle::_id_127A2( var_2, var_3, makeweapon( "tur_gun_lighttank_mp" ) );
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "light_tank", var_0 );
    var_2.objweapon = makeweapon( "lighttank_mp" );
    var_2 light_tank_updateheadicon();
    var_4 = scripts\cp_mp\vehicles\vehicle_damage::_id_126F7( var_2, 1 );
    var_4.gas_fx = "none";
    ...
    var_2 thread proxy_trigger();
    var_2 thread publiceventsenabled();
...
{
    var_2 = light_tank_getleveldata();
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, "tur_bradley_mp" );
    var_4 = undefined;
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    {
        self.streakinfo.healdamage = 1;

        if ( !istrue( self.updatesecretstashhud ) )
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        self radiusdamage( var_15, 256, 140, 70, self, "MOD_EXPLOSIVE", "lighttank_mp" );
        var_16 = self gettagorigin( "tag_origin" );
        var_17 = undefined;

        if ( puddle_structs( self.spawndata ) )
...
light_tank_airdrop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 hide();
    var_9 = scripts\cp_mp\vehicles\vehicle::_id_1273A( var_8 );
...
light_tank_airdropinternal()
{
    ...
    {
        self.vehicle show();
        var_0 = scripts\cp_mp\vehicles\vehicle::_id_1273A( self.vehicle );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12739( self, "tur_bradley_mp" );
    var_0 endon( "death" );
    var_0.shotsleft = 8;
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::_id_12907( "turret_fire", "turret_reload" );
...
{
    self endon( "death" );
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12739( self, "tur_bradley_mp" );
...
puhostagerestoreweapon()
{
    ...
    for (;;)
    {
        ...
        var_1 = scripts\engine\utility::_id_1290E( "input_type_changed", "missile_handling_ended" );
...
{
    wait 0.33;
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_12739( self, "tur_bradley_mp" );
...
{
    self endon( "death" );
    var_0 = scripts\cp_mp\vehicles\vehicle::_id_12739( self, "tur_gun_lighttank_mp" );
...
light_tank_enterendinternal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_1 == "driver" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, "tur_bradley_mp" );
        var_5.owner = var_3;
        ...
        var_3 thread puhostagerestoreweapon();
    ...
    else if ( var_1 == "gunner" )
    {
        ...
        var_5 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, "tur_gun_lighttank_mp" );
        var_5.owner = var_3;
        var_5 setotherent( var_3 );
        var_5 setentityowner( var_3 );
        var_5 setsentryowner( var_3 );
...
protect_jammer( var_0 )
{
    if ( isdefined( var_0.look_at_heli ) )
        return;

    var_0 scripts\cp_mp\utility\damage_utility::adddamagemodifier( "ltGunnerMissileRedux", 0.4, 0, ::protect_obj_a_internal );
}
...
protect_obj_a_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
puddle_triggers( var_0 )
{
    self endon( "death" );
    self.owner endon( "disconnect" );
    level waittill( "game_ended" );
    self.updatesecretstashhud = 1;
    self.owner scripts\cp_mp\utility\killstreak_utility::updatesmokinggunhud( var_0 );
}
...
light_tank_premoddamagecallback( var_0 )
{
    ...
    if ( vectordot( var_5, var_6 ) < -0.83 )
        var_0.player_rig_create = canweapondealcriticaldamage( var_0 );
...
{
    if ( istrue( var_0.player_rig_create ) )
...
light_tank_updateheadiconforplayer( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1 == self )
        scripts\cp_mp\entityheadicons::_id_11A8E( self.headicon, var_0 );
    else
    {
        var_2 = undefined;
        ...
        if ( level.teambased )
        {
            if ( var_3 == "neutral" )
            {
                ...
                {
                    if ( 1 )
                        scripts\cp_mp\entityheadicons::_id_11A8D( self.headicon, var_0 );
                    else
                        scripts\cp_mp\entityheadicons::_id_11A8E( self.headicon, var_0 );
...
light_tank_tryusefromstruct( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        var_6 = scripts\cp_mp\vehicles\vehicle::_id_1273A( var_5 );

        foreach ( var_8 in var_6 )
            var_8.streakinfo = var_0;

        var_5 thread puddle_triggers( var_0 );
    }
...
{
    var_3 = scripts\cp_mp\vehicles\vehicle::_id_1273A( var_0 );
