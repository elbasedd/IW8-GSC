...
tac_rover_initoccupancy()
{
    ...
    var_3.shield = "ping_vehicle_driver";
    var_2 = "fr_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
    ...
    var_3.shield = "ping_vehicle_rider";
    var_2 = "bl_passenger";
    var_3 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_getleveldataforseat( "tac_rover", var_2, 1 );
    var_3.seatswitcharray = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_generateseatswitcharray( var_2, var_1 );
...
tac_rover_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "tac_rover", "single", [ "driver", "fr_passenger", "bl_passenger", "br_passenger" ] );
}

_id_12105()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "tac_rover", 1 );
    var_0.id = 3;
...
_id_12104()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "tac_rover", 750 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "tac_rover" );
    var_0.class = "light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "tac_rover" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "tac_rover", 5 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12722( "tac_rover", 8, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "tac_rover", ::tac_rover_deathcallback );
}

_id_12103()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "tac_rover", 1 );
    var_0.bot_can_switch_to_defender = 1.83333;
    var_0.flashtheprops = 0.79166;
    var_0.exterior_goal_func = 350;
    var_0.extra_bomb_explode_vfx_func = 525;
    var_0.extendcirclelist = 875;
    var_0.extra_glow_sticks_init = 6.25;
    var_0.extra_riders_func = 25;
    var_0.extra_enemies = 50;
...
tac_rover_create( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "tac_rover", var_0 );
