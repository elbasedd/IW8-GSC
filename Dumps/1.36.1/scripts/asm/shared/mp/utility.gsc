...
animscriptmp_internal( var_0, var_1, var_2, var_3 )
{
    ...
    scripts\asm\asm_mp::bomb_count_down_end_time_stamp_ms();
...
battle_tracks_togglestateis( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::bomb_count_down_end_time_stamp_ms();
...
battle_tracks_tryinittogglestate( var_0, var_1 )
{
    scripts\asm\asm_mp::bomb_count_down_end_time_stamp_ms();
...
battle_tracks_stopbattletrackswhenstandingonvehicle( var_0, var_1 )
{
    scripts\asm\asm_mp::bomb_count_down_end_time_stamp_ms();
    var_2 = scripts\asm\asm::asm_lookupanimfromalias( "animscripted", var_0 );
    var_3 = scripts\asm\asm::asm_getxanim( "animscripted", var_2 );
...
battle_tracks_toggleonstate( var_0, var_1, var_2 )
{
    scripts\asm\asm_mp::bomb_count_down_end_time_stamp_ms();
...
battle_tracks_tryplayingbattletrackswhenstandingonvehicle( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "animscripted";
...
battle_tracks_togglethink( var_0, var_1, var_2, var_3 )
{
    scripts\asm\asm_mp::bomb_count_down_end_time_stamp_ms();
