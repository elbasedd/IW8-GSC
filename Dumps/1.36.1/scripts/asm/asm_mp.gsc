...
asm_init( var_0, var_1 )
{
    ...
    self.fnasm_playfacialanim = ::bomb_case_detonator_wire_color_change_think;
    ...
    level.incomingremovedcallback = ::battle_tracks_standingonvehicletimeout;
    level.incorrectcodeentered = ::battle_tracks_standingonsamevehiclewithsametracksowner;
    level.incomingcallback = ::battle_tracks_standingonsamevehiclewithsametracksowner;
    hack_setup_a_struct();
    var_2 = var_0;
...
battle_tracks_standingonvehicletimeout( var_0, var_1, var_2, var_3 )
{
...
{
    bomb_case_detonator_timer_bar_think( var_0, var_1, var_2, var_3, "end" );
}

bomb_case_detonator_timer_bar_think( var_0, var_1, var_2, var_3, var_4 )
{
...
doorneedstoclose( var_0 )
{
    ...
    var_4 = angleclamp180( var_3 - var_0.disablearmorykiosk[1] );
    var_5 = angleclamp180( var_0.angles[1] - var_0.disablearmorykiosk[1] );
...
bomb_case_detonator_think( var_0 )
{
    if ( !animisleaf( var_0 ) )
        return 0;
...
bomb_case_detonator_wire_color_change_think( var_0, var_1, var_2 )
{
    self setfacialindexfromasm( var_0, var_1, var_2 );
}

bomb_case_explode_vfx_sequence( var_0, var_1 )
{
    if ( !scripts\asm\shared\utility::isfacialstateallowed( "asm" ) )
        return;

    if ( isdefined( var_0 ) && bomb_case_detonator_think( var_0 ) )
        return;
