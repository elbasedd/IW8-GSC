...
main( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( !scripts\mp\spawnlogic::generatinglosdata() )
        {
            ...
            if ( isdefined( var_4 ) )
            {
                if ( level.relic_squadlink_turn_team_headobjectives == 1 )
                {
                    if ( var_4 == "10v10" )
                        continue;
                    else if ( var_4 == "6v6" )
...
onjuggernaut()
{
    ...
    {
        self.carryobject thread setdropped();
        self switchtoweapon( scripts\mp\juggernaut::playerplunderdeposit() );
    }
}
...
usingobject( var_0 )
{
    self.spawndistancemax[self.spawndistancemax.size] = var_0;
}
...
deactivate_laser_trap( var_0 )
{
    ...
    foreach ( var_3 in self.spawndistancemax )
...
carryobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( !play_thrust_fx() && var_0 scripts\mp\utility\weapon::grenadeinpullback() )
        {
...
setpickedup( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.carryobject ) || isdefined( self.carryweapon ) && !var_0 scripts\common\utility::is_weapon_allowed() || !deactivate_laser_trap( var_0 ) )
    {
...
updatecarryobjectorigin()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( self.carrier ) )
        {
            ...
            scripts\engine\utility::_id_1291A( self.objpingdelay, "dropped", "reset" );
            continue;
        }
...
setdropped( var_0, var_1 )
{
    ...
    if ( isdefined( self.carrier ) && self.carrier.team != "spectator" )
    {
        ...
        for ( var_16 = 0; var_16 < 4; var_16++ )
        {
            ...
            if ( isdefined( var_17 ) )
            {
                if ( isdefined( var_17.code_classname ) && var_17.code_classname == "script_vehicle" || isdefined( var_17.objweapon ) && isweapon( var_17.objweapon ) || isdefined( var_17 ) && istrue( var_17.issuper ) && ( var_17.equipmentref == "equip_ammo_box" || var_17.equipmentref == "equip_trophy" ) )
                {
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( isdefined( var_17 ) && !isplayer( var_17 ) && !isweapon( var_17 ) && ( isdefined( var_17.objweapon ) && !isweapon( var_17.objweapon ) ) && !isbot( var_17 ) && !isagent( var_17 ) && !scripts\mp\utility\entity::isturret( var_17 ) && ( !isdefined( var_17.classname ) || var_17.classname != "script_vehicle" && var_17.classname != "rocket" ) )
...
{
    if ( istrue( var_1.playerexitlaststand ) )
        var_7 = var_1;
    else
        var_7 = spawnstruct();
...
useobjectusethink()
{
    ...
    for (;;)
    {
        ...
        {
            if ( ![[ level.run_cleanup_funcs_for_unused_objectives ]]( var_0 ) )
                continue;
        }
...
getearliestclaimplayer()
{
    ...
    if ( isdefined( self.init_relic_no_ammo_mun ) && istrue( self.deal_damage_after_time ) )
    {
        if ( self.init_relic_no_ammo_mun[var_0].size > 0 )
        {
            var_2 = undefined;
            var_3 = getarraykeys( self.init_relic_no_ammo_mun[var_0] );

            for ( var_4 = 0; var_4 < var_3.size; var_4++ )
            {
                var_5 = self.init_relic_no_ammo_mun[var_0][var_3[var_4]];
...
{
    if ( isdefined( self._id_12002 ) )
        self [[ self._id_12002 ]]( var_0 );
...
proxtriggerthink()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( self.play_found_leads_counting_building_two ) && ( var_1 scripts\mp\utility\player::isusingremote() || isdefined( var_1.spawningafterremotedeath ) ) )
            continue;

        if ( istrue( var_1.inlaststand ) && !istrue( self.trigger.audio_jugg_death ) )
            continue;
...
triggertouchthink( var_0 )
{
    ...
    while ( scripts\mp\utility\player::isreallyalive( self ) && isdefined( var_0.trigger ) && self istouching( var_0.trigger ) && !level.gameended )
    {
        ...
        if ( istrue( self.inlaststand ) && !istrue( var_0.trigger.audio_jugg_death ) )
            break;
        ...
        if ( istrue( var_0.decoy_canseeplayer ) && isdefined( var_0.usecondition ) && !var_0 [[ var_0.usecondition ]]( self ) )
            break;
            ...
            if ( hasdomflags() && isdefined( var_0.id ) && ( var_0.id == "domFlag" || var_0.id == "hardpoint" || var_0.id == "bomb_site" || var_0.id == "rugby_jugg" ) )
            {
                ...
                else if ( var_1 && isdefined( self.ui_dom_securing ) && ( isdefined( var_0.stalemate ) && !var_0.stalemate && !istrue( var_0.majoritycapprogress ) ) && var_0.ownerteam != self.team )
                {
                    ...
                    if ( scripts\mp\utility\game::getgametype() == "hq" )
                    {
                        ...
                        self setclientomnvar( "ui_objective_state", var_0 scripts\mp\gametypes\obj_dom.gsc::keep_trying_to_kill_off_ai() );
                    else
                        self setclientomnvar( "ui_objective_state", 1 );
                }
                else
...
updateuisecuring( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && var_3.id == "laststand_reviver" )
        {
            ...
            scripts\mp\gametypes\br.gsc::_id_125FC( var_6, self, var_0 );
        }
    }
    else
    {
...
usetest( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.trigger ) && isdefined( self.trigger._id_1265A ) && distance2dsquared( self.trigger.origin, var_0.origin ) >= self.trigger._id_1265A )
        return 0;
    ...
    if ( istrue( self.decoy_canseeplayer ) && isdefined( self.usecondition ) && !self [[ self.usecondition ]]( var_0 ) )
        return 0;
...
_id_11AA7( var_0, var_1, var_2, var_3, var_4 )
{
        ...
        if ( var_1 != -1 )
        {
            if ( level.codcasterenabled )
            {
                if ( isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_1259F( var_1, var_12 );
                }
                else
                    scripts\mp\objidpoolmanager::_id_125A0( var_1 );
            }
            ...
            if ( !var_7 )
            {
                ...
                if ( level.codcasterenabled && isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::_id_125A2( var_1, var_20 );
                }
