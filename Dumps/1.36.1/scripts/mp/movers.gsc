...
player_update_unresolved_collision( var_0, var_1 )
{
    ...
    if ( self.unresolved_collision_count >= var_2 )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_4 = isdefined( self.poolids ) && gettime() - self.poolids <= 250;

                if ( var_4 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::_id_12733( var_0, self ) )
                {
...
staticmodelid( var_0 )
{
    ...
    if ( isdefined( var_0.currentgametypestopsclock ) )
        var_1 = 1;
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            else if ( isdefined( level.run_and_stop_group_after ) && [[ level.run_and_stop_group_after ]]( var_0, var_2 ) )
                return;
        }
        else
        {
...
handle_moving_platform_touch( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0.specialistbr ) && var_0.specialistbr )
        {
            if ( scripts\mp\equipment\claymore::pity_timer_end_time( var_1 ) )
            {
                waitframe();
                continue;
            }
        ...
        if ( !istrue( var_0._id_11C6A ) )
            thread process_moving_platform_death( var_0, var_1 );

        self._id_122A5 = 1;
        self.postupdategameevents = var_1;
        thread spectatekey();
        break;
    }
}
...
{
    self endon( "death" );
    self.postupdategameevents waittill( "death" );
    self.postupdategameevents = undefined;
}
...
handle_moving_platforms( var_0 )
{
    ...
    if ( isdefined( var_0.linkparent ) )
    {
        ...
        {
            if ( isdefined( var_0.quest_assdistmax ) )
                self linkto( var_0.linkparent, "", var_0.quest_assdistmax, var_0.angleoffset );
            else
