...
init()
{
    ...
    for (;;)
    {
        ...
        var_3 = tablelookupbyrow( "mp/score_event_table.csv", var_1, level.cypher_id_pool.game_type_col[var_0] );
...
bot_brtdm_think( var_0, var_1, var_2, var_3 )
{
    var_4 = 1;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        else if ( bot_cache_entrances_to_other_radios( var_2, var_1, var_3 ) )
        {
...
bot_cache_entrances_to_other_radios( var_0, var_1, var_2 )
{
    var_3 = 0;
...
bomber_disable_movement_for_time( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isplayer( self ) )
        return;
    ...
    {
        var_10 = bot_brtdm_think( self, var_4, var_2, var_3 );
        ...
        if ( isdefined( var_1._id_1206C ) && var_1._id_1206C == self )
        {
            self.modifiers["grenadestuck"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 8;
        }

        if ( scripts\mp\utility\game::play_alert_music_to_player( var_1 ) )
        {
        ...
        if ( var_3 == "MOD_HEAD_SHOT" || playerhudupdatenumconsumed( var_2, var_5 ) || plant_bomb_cleanup_on_death( var_2, var_5 ) )
        {
        ...
        if ( var_10 )
        {
            ...
            switch ( var_24 )
            {
                ...
                case "longshot":
                    ...
                    self setclientomnvar( "ui_longshot_special", player_can_mount( var_11, var_1, var_2 ) );
                    break;
                case "very_longshot":
                    self.modifiers["longshot"] = 1;
                    self.modifiers["mask"] = self.modifiers["mask"] | 262144;
            ...
            if ( scripts\mp\class::playergoingintols( var_2 ) )
            {
            ...
            if ( play_nuclear_core_vo( self, var_1 ) )
            {
                self.modifiers["detectedimpairedkill"] = 1;
            ...
            if ( isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::ks_circleclosetime() > gettime() )
            ...
            if ( isdefined( var_5.damageflags ) && var_5.damageflags & level.idflags_penetration && !( var_5.damageflags & level.mp_m_king_patch ) )
            {
                self.modifiers["coverkill"] = 1;
                self.modifiers["mask2"] = self.modifiers["mask2"] | 262144;
            }

            if ( scripts\mp\equipment\gas_grenade::init_trigger_spawn( self, var_1 ) )
            {
        ...
        if ( scripts\mp\utility\player::playbattlechattersound( self ) )
        {
            self.modifiers["last_stand"] = 1;
            self.modifiers["mask2"] = self.modifiers["mask2"] | 1024;
        }

        if ( scripts\mp\utility\player::playbattlechattersound( var_1 ) || istrue( var_5.cleanupkillcamlogic ) )
        {
            ...
            if ( var_4.equipmentref == "equip_c4" || var_4.equipmentref == "equip_claymore" )
            {
                ...
                if ( isdefined( var_42 ) && isdefined( var_42.helperdronetype ) && var_42.helperdronetype == "radar_drone_recon" )
                {
                    ...
                    if ( level.challengesallowed && isdefined( var_42.owner ) )
                        self.updaterectangularzone = var_42.owner;
                }
    ...
    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) || scripts\mp\utility\weapon::playdeathsoundph( var_4 ) )
    ...
    if ( scripts\mp\utility\game::getgametype() != "br" )
    {
        if ( self.modifiers["mask"] & 1048576 && self.modifiers["mask"] & 262144 )
            death_info_func( var_2 );
    }

    if ( var_7 == "other" )
        debug_ai_aggro( var_2 );
}

jug_encounter_test( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
    return var_5;
}

jug_reinforce( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
...
killedplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_2.sortbylastzombietime ) )
        var_2 = var_2.sortbylastzombietime;
    ...
    thread deactivate_trap_object( var_1 );
    var_7 = var_1.guid;
    var_8 = self.guid;
    ...
    thread _id_125D3( var_3, var_4, var_1 );
    ...
    if ( !scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) && !scripts\mp\utility\perk::_hasperk( "specialty_explosivebullets" ) )
    {
        ...
        var_12 = bot_brtdm_think( self, var_4, var_2, var_3 );
        ...
        if ( istrue( self.modifiers["launcher_impact"] ) )
            get_bcrumbstruct_proximity( var_0 );
        ...
        if ( scripts\mp\utility\game::getgametypenumlives() >= 1 )
        {
            ...
            var_27 = scripts\mp\utility\game::_id_1245D();
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() && !level.multiteambased )
    {
        ...
        if ( var_28 > 3 && self.killedplayers.size == var_28 )
        {
            ...
            if ( var_30 )
                playerzombiegetrespawnbyteam( var_0 );
        }
    }
...
{
    var_3 = scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) || scripts\mp\utility\weapon::playdeathsoundph( var_2 );
    var_4 = scripts\mp\utility\points::play_train_speaker_vo( var_0 );
    ...
    if ( var_3 && !var_4 )
    {
        if ( isdefined( var_2 ) && isdefined( var_2.streakinfo ) )
        {
            ...
            if ( isdefined( var_2.streakinfo.mpstreaksysteminfo ) )
            {
                ...
                if ( var_2.streakinfo.mpstreaksysteminfo.snowballfighthint != self getxuid() )
                    var_5 = 0;
            }
            ...
            if ( isdefined( var_2.streakinfo.streakname ) )
            {
                ...
                if ( isdefined( var_2.streakinfo.kills ) )
                {
                    ...
                    if ( !istrue( var_2.streakinfo.sendendofmatchdata ) && var_2.streakinfo.kills > 1 )
                    {
                        scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_scorestreak_kill_two_or_more_s1", 1 );
                        var_2.streakinfo.sendendofmatchdata = 1;
                    }
                }
...
killedplayerwithsuperweapon( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    scripts\cp\agents\gametype_cp_specops::updatesuperweaponkills( var_2, var_1 );
...
superkill( var_0, var_1 )
{
    ...
    var_4.numkills++;
    scripts\cp\agents\gametype_cp_specops::updatesuperkills( var_0, var_1, var_4.numkills );
...
trial_rpg_init( var_0 )
{
    var_1 = scripts\mp\killstreaks\killstreaks::lastunruly( var_0 );
...
player_can_mount( var_0, var_1, var_2 )
{
...
play_nuclear_core_vo( var_0, var_1 )
{
    var_2 = isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::ks_circleclosetime() > gettime();
    var_3 = isdefined( var_0.radarstrength ) && var_0.radarstrength > 3 && !var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ghost" );
    var_4 = istrue( var_1.player_ammo_crate_hint_watcher );
...
longshot( var_0 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "longshot" );
...
pointblank( var_0 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "pointblank" );
...
headshot( var_0 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "headshot" );
...
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "avenger" );
...
assistedsuicide( var_0, var_1 )
{
    ...
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "assistedsuicide" );
...
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "defender" );
...
postdeathkill( var_0 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "posthumous" );
...
revenge( var_0, var_1 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "revenge" );
...
{
    if ( !isdefined( self.escort_vehicle_push_clip ) )
        self.escort_vehicle_push_clip = var_1;

    if ( var_1 < self.escort_vehicle_push_clip )
        return;
    ...
    thread scripts\common\utility::_id_12456( level.remove_on_death, var_0, var_1 );
...
firstblood( var_0 )
{
    ...
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "firstblood" );
...
buzzkill( var_0, var_1 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "buzzkill" );
...
comeback( var_0 )
{
    thread scripts\common\utility::_id_12456( level.remove_munition_on_use, var_0, "comeback" );
...
updaterecentkills( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_4 == "smg" )
    {
        if ( !isdefined( self.updatematchstatushintonhasflag ) )
            self.updatematchstatushintonhasflag = 1;
        else
            self.updatematchstatushintonhasflag++;
    }
    ...
    if ( scripts\mp\utility\game::play_alert_music_to_player( var_1 ) )
    {
        self.updateleadmarkers++;

        if ( scripts\mp\utility\script::isnumbermultipleof( self.updateleadmarkers, 3 ) )
            _id_12425( var_0 );
    }
    ...
    if ( !isdefined( self.updatelootleadercirclesize ) )
        self.updatelootleadercirclesize = [];
    ...
    if ( !isdefined( self.updatelootleadercirclesize[var_2.basename] ) )
        self.updatelootleadercirclesize[var_2.basename] = 1;
    else
        self.updatelootleadercirclesize[var_2.basename]++;
    ...
    self.updatematchstatushintonhasflag = 0;
    self.recentkillsperweapon = undefined;
    self.updatelootleadercirclesize = undefined;
    self.sendendofmatchdata = 0;
}

_id_125D3( var_0, var_1, var_2 )
{
    if ( scripts\mp\utility\game::getgametype() != "br" )
        return;
    ...
    var_3.victim = var_2;
    var_3.regroup_all_alive_players_to_plane = 1;
    scripts\mp\gametypes\br_challenges.gsc::cypher_signal_strength_nag( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::cypher_signal_strength_nag( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::cypher_signal_strength_nag( "br_mastery_ghostRideWhip", var_3 );
}
...
bombdefused( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
        var_0 thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "defuse", var_0.origin );

    if ( var_1 )
        scripts\mp\utility\game::rear_spotlight_target_found_dist_sq( var_0, undefined, "Bomb Defused", var_0.origin, "last_alive" );
    else
        scripts\mp\utility\game::rear_spotlight_target_found_dist_sq( var_0, undefined, "Bomb Defused", var_0.origin );
...
revivedplayer( var_0, var_1 )
{
    ...
    var_0 scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_revived_teammate_for_operator_mission", 1 );
...
killeventtextpopup( var_0, var_1, var_2 )
{
    ...
    var_6.trial_race_uses_heli = 0;
    var_6.trial_race_lap_total_override = 0;
    var_6.getaccessorylogicbyindex = istrue( var_2 );
...
trial_rpg_settings()
{
    ...
    self.start_spawn_camera = 1;

    if ( !isdefined( self.splashpriorityqueue ) )
        self.start_spawn_camera = 0;

    foreach ( var_1 in self.splashpriorityqueue )
    {
        if ( var_1.trial_race_uses_heli )
            continue;

        if ( !istrue( level.removekilleventsplash ) && istrue( var_1.showassplash ) && ( !self.start_spawn_camera || var_1.alwaysshowsplash ) )
        {
            var_2 = 1;
            thread scripts\mp\hud_message::showsplash( var_1.scoreeventref );
        }

        var_1.trial_race_uses_heli = 1;
    }

    foreach ( var_1 in self.splashpriorityqueue )
    {
        if ( var_1.trial_race_lap_total_override || var_1.getaccessorylogicbyindex )
            continue;

        thread scripts\mp\rank::scoreeventpopup( var_1.scoreeventref );
        var_1.trial_race_lap_total_override = 1;
...
playerhudupdatenumconsumed( var_0, var_1 )
{
...
debug_ai_aggro( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.propmoveunlock[var_1] ) )
        return;

    if ( self.pers["lethalEquipmentKillMask"] & level.propmoveunlock[var_1] )
        return;
    else
        self.pers["lethalEquipmentKillMask"] = self.pers["lethalEquipmentKillMask"] | level.propmoveunlock[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.propmoveunlock )
    {
...
death_info_func( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.max_ammo_check[var_1] ) )
        return;

    if ( self.pers["headshotLongshotMask"] & level.max_ammo_check[var_1] )
        return;
    else
        self.pers["headshotLongshotMask"] = self.pers["headshotLongshotMask"] | level.max_ammo_check[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.max_ammo_check )
    {
...
new_angles()
{
    ...
    if ( self.setup_comms_obj_crate == -1 )
        return;

    self.setup_comms_obj_crate++;
    var_0 = undefined;
    ...
    if ( self.setup_comms_obj_crate >= var_0 )
    {
        self reportchallengeuserevent( "collect_item", "objective_player_achievement" );
        self.setup_comms_obj_crate = -1;
    }
}

deactivate_trap_object( var_0 )
{
    self endon( "disconnect" );
    var_1 = 0;
    ...
    {
        self.updaterectangularzone = undefined;
        return;
    }

    if ( isplayer( var_0 ) && isdefined( self.updaterectangularzone ) )
    {
        if ( self.modifiers["mask2"] & 32768 )
            var_1 = 1;
    }

    level scripts\engine\utility::_id_12913( 1, "game_ended" );
    ...
    if ( level.gameended )
    {
        if ( var_1 )
        {
            ...
            if ( isdefined( self.updaterectangularzone ) )
                self.updaterectangularzone reportchallengeuserevent( "collect_item", "recon_drone_achievement" );
        }
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges.gsc::cypher_signal_strength_nag( "br_mastery_roundKillExecute", var_2 );
        }
    }
