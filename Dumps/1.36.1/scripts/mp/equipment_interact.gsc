...
{
    level.useobjs = [];
    scripts\engine\scriptable::winindex( "hack_usable", ::handleenemygunshipdamage );
    thread _updateuseobjs();
}

handleenemygunshipdamage( var_0, var_1, var_2, var_3, var_4 )
{
    handleeventcallback( var_0.entity, var_3 );
}

handleeventcallback( var_0, var_1 )
{
    var_2 = var_0;
    var_2.isbeingused = 1;
...
_deployhacktablet( var_0, var_1 )
{
    ...
    var_4 = scripts\cp_mp\killstreaks\killstreakdeploy::switchtodeployweapon( var_2, var_3, ::_waituntilinteractfinished, ::add_collision_to_hack_point, undefined, undefined, ::_ontabletputaway );
...
add_collision_to_hack_point( var_0, var_1 )
{
    ...
    thread abandonedtimeoutdelay();
    thread _x1opsnpcwaittilluse( var_0 );
    return 1;
}
...
abandonedtimeoutdelay()
{
    level endon( "game_ended" );
    self endon( "disconnect" );
    scripts\engine\utility::_id_128FF( "death", "tabletPutAway" );
