...
init()
{
    ...
    else if ( scripts\mp\utility\game::play_hack_reminder_goto1() )
    {
...
complete_trap_room( var_0, var_1, var_2 )
{
...
{
    var_0 = self getplayerdata( level.loadoutsgroup, "customizationSetup", "operatorWatch" );
    return scripts\mp\accessories::isxmike109explosivedamage( var_0 );
}
...
_id_120F2( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
...
_id_120F3( var_0, var_1 )
{
    ...
    if ( !isdefined( level.brmini_addtoc130infil ) )
    {
        level.brmini_addtoc130infil = [];
        level.brmini_addtoc130infil["iw8_ar_tango21"] = [ 1 ];
        level.brmini_addtoc130infil["iw8_ar_mike4"] = [ 5 ];
        level.brmini_addtoc130infil["iw8_ar_kilo433"] = [ 3 ];
        level.brmini_addtoc130infil["iw8_ar_scharlie"] = [ 3 ];
        level.brmini_addtoc130infil["iw8_sm_uzulu"] = [ 4 ];
        level.brmini_addtoc130infil["iw8_sh_romeo870"] = [ 5 ];
        level.brmini_addtoc130infil["iw8_sh_dpapa12"] = [ 3 ];
        level.brmini_addtoc130infil["iw8_lm_mgolf34"] = [ 4 ];
        level.brmini_addtoc130infil["iw8_sn_kilo98"] = [ 16 ];
        level.brmini_addtoc130infil["iw8_sn_alpha50"] = [ 2 ];
        level.brmini_addtoc130infil["iw8_sn_hdromeo"] = [ 4 ];
        level.brmini_addtoc130infil["iw8_pi_golf21"] = [ 3 ];
        level.brmini_addtoc130infil["iw8_pi_cpapa"] = [ 15 ];
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.brmini_addtoc130infil[var_7] ) )
                        level.brmini_addtoc130infil[var_7] = [];

                    level.brmini_addtoc130infil[var_7][level.brmini_addtoc130infil[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.brmini_addtoc130infil[var_0] ) )
        var_10 = level.brmini_addtoc130infil[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::level_carepackage_player_used_logic( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::_id_12A99( var_0, var_11 );
...
loadout_clearplayer( var_0 )
{
    ...
    scripts\mp\perks\perkpackage::spawn_origin();
...
raid_player_start_pos_array( var_0 )
{
    ...
    if ( isdefined( var_0.re_open_station ) )
        var_1.re_open_station = var_0.re_open_station;
    ...
    if ( isdefined( var_0.reachhistorydestination ) )
        var_1.reachhistorydestination = var_0.reachhistorydestination;
    ...
    var_1.play_intro_hacking_vo = var_0.play_intro_hacking_vo;
...
loadout_updateclasscustom( var_0, var_1 )
{
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutprimaryattachmentids[var_3] = complete_trap_room( var_2, 0, var_3 );
    }
    ...
    for ( var_3 = 0; var_3 < 5; var_3++ )
    {
        ...
        var_0.loadoutsecondaryattachmentids[var_3] = complete_trap_room( var_2, 1, var_3 );
    }
    ...
    var_0.loadoutaccessorylogic = complete_hack_console();
    var_0.loadoutstreaksfilled = 1;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.re_open_station = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.reachhistorydestination = var_3["loadoutSecondaryAddBlueprintAttachments"];
    ...
    var_0.ray_trace_trigger_radius_2d = isdefined( var_3["loadoutExtraPerks"] );
    ...
    if ( !var_4 )
    {
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutprimaryattachmentids[var_5] = complete_trap_room( var_2, 0, var_5 );
            }
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutsecondaryattachmentids[var_5] = complete_trap_room( var_2, 1, var_5 );
            }
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.re_open_station = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.reachhistorydestination = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isagent( self ) && self isplayerheadless() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        ...
        randomcarepackagedrops( var_0, var_2 );
...
randomcarepackagedrops( var_0, var_1 )
{
...
randomcorner( var_0 )
{
    if ( !isdefined( self.matchdata_onroundend ) )
    {
        if ( !isdefined( level.matchdata_onroundend ) )
        {
            var_1 = randomint( 200 );
            level.matchdata_onroundend = var_1;
            level.matchdata_recordrecentlyplayeddata = var_1;
        }
        else
        {
            level.matchdata_onroundend++;
            level.matchdata_recordrecentlyplayeddata++;
        }

        self.matchdata_onroundend = level.matchdata_onroundend;
        self.matchdata_recordrecentlyplayeddata = level.matchdata_recordrecentlyplayeddata;
    }

    var_2 = random_loot_override( self.matchdata_onroundend, 1 );
    var_3 = random_loot_override( self.matchdata_recordrecentlyplayeddata, 0 );
    var_4 = var_2[0];
    var_5 = var_2[1];
    var_6 = var_3[0];
    var_7 = var_3[1];
...
random_loot_override( var_0, var_1 )
{
    var_2 = 0;
    var_3 = -1;
    ...
    for (;;)
    {
        ...
        {
            if ( var_6.variantid == 0 || var_6.player_cam_disable || !isdefined( var_6.attachcustomtoidmap ) )
                continue;

            if ( var_4 && isdefined( var_6.play_bank_intro_vo ) && !var_6.play_bank_intro_vo )
                continue;
...
loadout_updateabilities( var_0, var_1 )
{
    ...
    if ( var_0.loadoutperksfromgamemode )
    {
        ...
        if ( var_0.ray_trace_trigger_radius_2d )
...
randomize_stealth_broken_music_array( var_0, var_1 )
{
...
loadout_updateclass( var_0, var_1 )
{
    ...
    if ( !isbot( self ) && isdefined( level.longgulagstream ) && level.longgulagstream )
    ...
    if ( isdefined( level.run_blima_exfil_sequence ) )
        self [[ level.run_blima_exfil_sequence ]]( var_0 );
...
loadout_updateclassfistweapons( var_0 )
{
    if ( isdefined( level.longgulagstream ) && level.longgulagstream && isweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimary = var_0.loadoutprimary;
    else if ( var_0.loadoutprimary == "none" )
        var_0.loadoutprimary = "iw8_fists";

    if ( scripts\mp\utility\game::deletescriptableinstanceaftertime() )
    {
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.re_open_station ) )
        var_0.loadoutprimaryobject = clocksounds( var_0.loadoutprimary, var_0.loadoutprimaryattachments, var_0.loadoutprimarycamo, var_0.loadoutprimaryreticle, var_0.loadoutprimaryvariantid, var_0.loadoutprimaryattachmentids, var_0.loadoutprimarycosmeticattachment, var_0.loadoutprimarystickers, istrue( var_0.loadouthasnvg ) );
    else
    ...
    {
        if ( istrue( var_0.reachhistorydestination ) )
            var_0.loadoutsecondaryobject = clocksounds( var_0.loadoutsecondary, var_0.loadoutsecondaryattachments, var_0.loadoutsecondarycamo, var_0.loadoutsecondaryreticle, var_0.loadoutsecondaryvariantid, var_0.loadoutsecondaryattachmentids, var_0.loadoutsecondarycosmeticattachment, var_0.loadoutsecondarystickers, istrue( var_0.loadouthasnvg ) );
        else
...
loadout_updateplayerweapons( var_0, var_1, var_2, var_3 )
{
    ...
    randoexplodo( var_0, var_7, var_8, var_4, var_5, var_6 );
...
loadout_giveprimaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = rallypoint_showafterprematch( "primary", var_0.loadoutprimaryobject, var_1, var_2 );
...
loadout_givesecondaryweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = rallypoint_showafterprematch( "secondary", var_0.loadoutsecondaryobject, var_1, var_2 );
...
rallypoint_showafterprematch( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.nopropsspectate ) )
        {
...
randoexplodo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = [];
    ...
    foreach ( var_8 in var_6 )
        var_8.maphint_cheesescriptableused = var_8 hasattachment( "maxammo" );

    if ( isdefined( level.roundkillexecute ) )
        self [[ level.roundkillexecute ]]( var_6 );
    ...
    else
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.maphint_cheesescriptableused ) )
            {
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.maphint_cheesescriptableused ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.maphint_cheesescriptableused ), 8, 6 ) );

                continue;
            }

            if ( scripts\mp\utility\weapon::platform_cleanup_on_death( var_8 ) )
...
loadout_updateplayernvgs()
{
    ...
    if ( istrue( self.inspawncamera ) )
        scripts\engine\utility::_id_128FF( "spawned_player", "fadeUp_start" );
...
randgetpropsizetoallocate( var_0 )
{
    ...
    {
        var_2 = scripts\mp\accessories::isxmike109explosiveheadshot( var_0.loadoutaccessorydata );
...
loadout_updateplayeraccessory( var_0 )
{
    if ( !istrue( self.btestclient ) )
    {
        ...
        {
            if ( randgetpropsizetoallocate( var_0 ) )
                return;
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::playerattractiontriggerenter() )
    {
        var_2 = 0;
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            self.loadoutfieldupgrade1 = humanpowersenabled( self.loadoutfieldupgrade1 );
            self.loadoutfieldupgrade2 = humanpowersenabled( self.loadoutfieldupgrade2 );
        ...
        {
            var_3 = hudkothtimer( self.loadoutfieldupgrade1 );
    ...
    {
        self.randomized_primary_weapon_objs = hudkothtimer( self.loadoutfieldupgrade1 );
...
giveloadout( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_5 = raid_vindia_unload_func();
    var_5 = randomize_stealth_broken_music_array( var_5, var_1 );
    self.little_bird_mg_initdamage = var_5;
    var_6 = undefined;
...
loadout_lognewlygivenloadout( var_0, var_1, var_2 )
{
    ...
    if ( var_1.play_intro_hacking_vo )
    {
        var_3 = 99;
        var_4 = "copied";
    }
    ...
    if ( var_8 == -1 || var_1.play_intro_hacking_vo )
    {
...
_id_122E3()
{
    if ( !istrue( self.shouldreflect ) )
    {
        var_0 = self getheldoffhand();

        if ( !isnullweapon( var_0 ) && var_0.basename != "c4_mp_p" && scripts\mp\riotshield::isriotshield( self getcurrentweapon() ) && playerexitcombatarea( var_0 ) )
            self.shouldreflect = 1;
    }
}
...
_id_122E5()
{
    self.waitforstuck = undefined;
    self.waitforstreamsynccomplete = undefined;
...
_id_122DE( var_0 )
{
    ...
    childthread _id_122DD();

    if ( isdefined( var_0 ) )
        self._id_12986 = var_0;
    else if ( !isdefined( self._id_12986 ) )
        self._id_12986 = 0;
    ...
    while ( scripts\mp\riotshield::riotshield_hasweapon() )
    {
        ...
        if ( !istrue( self.inlaststand ) )
        {
            if ( self._id_12986 )
            {
                self.prematchdialog = 1;
                self.prematchendtime = gettime() + 1000;
            }
            else if ( isdefined( self.prematchendtime ) && gettime() >= self.prematchendtime )
            {
                self.prematchdialog = undefined;
                self.prematchendtime = undefined;
            }
        ...
        if ( self isonladder() )
            ...
            _id_122E0();
        else if ( istrue( self.prematchdialog ) )
            _id_122E0();
        else if ( istrue( self.shouldreflect ) )
        {
            if ( isnullweapon( self getheldoffhand() ) )
            {
                self.shouldreflect = undefined;
                _id_122E2();
            }
            else
                _id_122E0();
...
waitforplayerstospawn( var_0 )
{
    self.prematchdialog = undefined;
    self.prematchendtime = undefined;
    self._id_12986 = undefined;
...
clocksounds( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    foreach ( var_16, var_13 in var_10 )
    {
        ...
        var_15 = scripts\mp\utility\weapon::boss_fight_combat_laser_trap( var_14 );
    ...
    if ( isdefined( var_1 ) )
    {
        foreach ( var_19, var_16 in var_1 )
        {
            ...
            {
                var_14 = scripts\mp\utility\weapon::attachmentmap_tounique( var_16, var_9 );
                var_15 = scripts\mp\utility\weapon::boss_one_minion_watcher( var_14 );
...
clipright( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !isdefined( var_9 ) || var_9 == "" )
        scripts\mp\utility\script::fusefx( "buildWeapon - bad weaponAssetName - rootName: " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant: " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );

    var_13 = makeweapon( var_9, [], undefined, var_2, var_4 );

    if ( isdefined( var_9 ) && !isdefined( var_13 ) )
        scripts\mp\utility\script::fusefx( "buildWeapon - null weapon: weaponAssetName = " + var_9 + ", rootName = " + scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, "null" ) + ", variant = " + scripts\engine\utility::ter_op( isdefined( var_4 ), var_4, "none" ) );
...
buildweaponuniqueattachmenttoidmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_20, var_8 in var_6 )
    {
        ...
        if ( !isdefined( var_13 ) && play_found_leads_counting_building_one( var_19 ) )
            var_13 = var_20;

        if ( !var_12 && ( player_waitfortacmapused( var_19 ) || player_waitforlanded( var_20 ) ) )
            var_12 = 1;
    }
...
play_found_leads_counting_building_one( var_0 )
{
    return var_0 == "calcust" || var_0 == "calsmg" || var_0 == "calsmgdrums";
}

player_waitforlanded( var_0 )
{
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        else if ( istrue( level.lootcontentsadjusteconomy_toptier ) && scripts\mp\utility\game::getgametype() == "infect" && var_0.team == "axis" )
            var_0 _meth_87A8( "zombie" );
        else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 _meth_87A8( "female" );
        else
        ...
        if ( isdefined( var_0.silo_door_left ) )
        {
            var_0 clearsoundsubmix( "iw8_mp_spawn_camera" );
            var_0.silo_door_left stoploopsound( self.silo_door_right );
            var_0.silo_door_left delete();
            var_0.silo_door_left = undefined;
            var_0.silo_door_right = undefined;
        }
...
resetfunctionality()
{
    ...
    scripts\cp_mp\vehicles\vehicle_occupancy::_id_1276A( self, 1 );
    ...
    scripts\mp\equipment\molotov::rungwperif_planes();
    scripts\mp\equipment\throwing_knife_mp::_id_12217();
    scripts\mp\equipment\flash_grenade::clearflash( 1 );
    scripts\mp\equipment\gas_grenade::gas_clear( 1 );

    if ( !isagent( self ) )
    {
        scripts\mp\utility\player::modelpart();
    ...
    scripts\cp_mp\utility\player_utility::support_box_use_logic();
}
...
updateinstantclassswapallowed()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_0 = scripts\mp\utility\game::lb_mg_impulse_dmg_threshold_top() == "dmz" || scripts\mp\utility\game::lb_mg_impulse_dmg_threshold_top() == "risk" || scripts\mp\utility\game::lb_mg_impulse_dmg_threshold_top() == "kingslayer";
...
_id_125D2()
{
    ...
    {
        while ( scripts\mp\utility\game::player_grenade_fire_monitor( self ) )
            waitframe();
...
{
    var_0 = raid_vindia_unload_func();
    randomize_tv_station_player_start_pos();
    var_1 = raid_vindia_unload_func();
...
copyclassfornextlife( var_0 )
{
    ...
    self.pers["copiedClass"] = raid_player_start_pos_array( var_1 );
...
raid_umike_unload_func( var_0, var_1 )
{
    var_0.loadoutsuper = var_1.loadoutsuper;
...
spawnammocountoverride_giveweaponammo( var_0, var_1, var_2 )
{
    ...
    if ( var_4 && !player_closes_in( var_0 ) )
    {
        var_5 = 0;
        var_6 = 0;
...
{
    var_1 = scripts\mp\utility\weapon::isknifeonly( var_0.basename ) || scripts\mp\utility\weapon::platform_model( var_0.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_0.basename ) || scripts\mp\utility\weapon::player_choppergunnericon( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename );
    return var_1;
}
...
randomize_stealth_alert_music_array( var_0 )
{
    ...
    if ( isweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimaryfullname = getcompleteweaponname( var_0.loadoutprimaryobject );
