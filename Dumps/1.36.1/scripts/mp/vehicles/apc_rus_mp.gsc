...
apc_rus_mp_initspawning()
{
    ...
    var_0.advanced_supply_drop_refund_on_death = 180;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
        var_0.vip_respawnplayer = level.binoculars_cansee;
}
...
apc_rus_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_127B2( "apc_russian", var_1, var_2 );
