...
vehicle_mp_init()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "create", ::_id_12761 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "createLate", ::_id_12762 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "deleteNextFrame", ::_id_12763 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "deleteNextFrameLate", ::_id_12764 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "hide", ::_id_12765 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_compass", "init", _cancelputawayonuseend::_id_126D3 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "init", _cleanuptabletallows::_id_1270C );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_trophyDestroyTarget", "init", scripts\mp\equipment\trophy_system::_id_12429 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird_mg", "init", _calloutmarkerping_predicted_timeout::race_flow );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "cargo_truck_mg", "init", _calloutmarkerping_predicted_log::cumulative_damage_expire_time );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "payload_truck_mg", "init", _calloutmarkerping_shouldremovecalloutifwholesquadinvehicle::spawn_guys_into_truck );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "motorcycle", "init", _calloutmarkerping_scriptableisusable::scriptable_adddamagedcallback );
...
{
    var_0.maxhealth = scripts\cp_mp\vehicles\vehicle_damage::_id_126F9( var_0 );
