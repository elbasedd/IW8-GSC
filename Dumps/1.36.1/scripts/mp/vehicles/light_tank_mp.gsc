...
light_tank_mp_initspawning()
{
    ...
    var_0.advanced_supply_drop_marker_sfx = scripts\cp_mp\vehicles\light_tank::light_tank_timeout;

    if ( scripts\mp\utility\game::getgametype() == "arm" )
    {
        var_0.advanced_supply_drop_refund_on_death = 105;
        var_0.vip_respawnplayer = level._id_1215C;
    }
    else
        var_0.advanced_supply_drop_refund_on_death = 40;
}
...
light_tank_mp_createownercaptureobject( var_0, var_1 )
{
    var_2 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, "tur_bradley_mp" );
...
light_tank_mp_createothercaptureobject( var_0 )
{
    var_1 = scripts\cp_mp\vehicles\vehicle::_id_12739( var_0, "tur_bradley_mp" );
...
light_tank_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_127B2( "light_tank", var_1, var_2 );
    ...
    if ( isdefined( var_3 ) )
    {
        if ( scripts\mp\utility\game::getgametype() == "arm" )
        {
            ...
            if ( istrue( level._id_11C24 ) )
                scripts\mp\gametypes\arm.gsc::_id_126E7( var_3, var_3.team );
