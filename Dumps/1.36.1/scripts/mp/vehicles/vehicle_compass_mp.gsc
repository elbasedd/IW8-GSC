...
init()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "plague_box", ::_id_12470, undefined, ::_id_1245A );
}
...
_id_12470( var_0, var_1 )
{
    ...
    var_4 = spawnscavengerlootcache( var_0 );

    if ( !istrue( var_4 ) )
        return var_4;

    spawnsecretstashlootcache();
    return 1;
}
