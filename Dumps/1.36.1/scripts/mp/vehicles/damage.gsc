...
callback_vehicledamage_internal( var_0 )
{
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        if ( isdefined( var_4 ) && var_4 == "radar_drone_recon" )
        {
            ...
            var_0.attacker scripts\cp_mp\pet_watch::_id_122CC( self );
    }

    if ( isdefined( level.run_post_module_actions ) )
        var_0.damage = self [[ level.run_post_module_actions ]]( var_0 );
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        ...
        else
        {
            ...
            if ( isdefined( level.round_robin_spawners ) )
                var_7 = self [[ level.round_robin_spawners ]]( var_0 );
    ...
    {
        if ( isdefined( level.round_smoke_semtex_logic ) && self [[ level.round_smoke_semtex_logic ]]( var_0 ) )
            var_0.damage = 0;
        else if ( scripts\mp\damage::player_weapon_fired_monitor( var_0.objweapon ) )
            var_0.damage = 0;
    ...
    {
        if ( scripts\mp\damage::playercinematicfadein( var_0.objweapon ) )
            var_0.damage = scripts\mp\damage::_id_11EA4( self, var_0.attacker, var_0.objweapon, var_0.damage, var_0.idflags );
        else if ( scripts\mp\damage::play_lz_vo( var_0.objweapon ) )
        {
            if ( scripts\mp\damage::_id_11BBA( var_0.objweapon ) )
                var_0.damage = 1;
            else
                var_0.damage = 0;
        }
        else if ( scripts\mp\damage::playerhealthomnvarwatcher( var_0.objweapon ) )
        {
            if ( !scripts\mp\damage::_id_11BED( var_0.objweapon ) )
                var_0.damage = 0;
        }
        else if ( scripts\mp\damage::plant_add_zplanes_override( var_0.objweapon, var_0.meansofdeath ) )
            var_0.damage = 0;
        else if ( isdefined( var_4 ) )
    ...
    var_9 = scripts\cp_mp\vehicles\vehicle_damage::_id_12726( var_0 );

    if ( !var_9 )
    {
        var_10 = scripts\cp_mp\vehicles\vehicle_damage::_id_126FD();
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12728( var_0, 1 );
    else
        scripts\cp_mp\vehicles\vehicle_damage::_id_12727( var_0, var_9, 1 );
    ...
    var_16 = istrue( var_0.player_rig_create ) || istrue( var_0.player_vindia_spawn_monitor );
        ...
        switch ( var_0.objweapon.basename )
        {
            ...
            case "lighttank_tur_mp":
                if ( isdefined( var_0.meansofdeath ) && var_0.meansofdeath != "MOD_RIFLE_BULLET" )
                    var_0.attacker thread scripts\mp\utility\points::little_bird_mg_deletenextframe( "critical_vehicle_damage" );
    ...
    {
        if ( isdefined( var_0.attacker ) && isplayer( var_0.attacker ) )
            var_0.attacker scripts\cp_mp\pet_watch::deactivate_hacked_console( self );
    ...
    if ( level.teambased )
    {
        if ( !var_3 )
        {
            if ( isdefined( var_2 ) && !isdefined( var_1 ) )
                return scripts\cp_mp\vehicles\vehicle::_id_1275D( var_0, var_2 );
            else
                return scripts\cp_mp\vehicles\vehicle::_id_1275C( var_0, var_1 );
        }
