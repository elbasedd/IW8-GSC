...
little_bird_mp_init()
{
    ...
    if ( istrue( level._id_11C23 ) )
        scripts\cp_mp\utility\script_utility::registersharedfunc( "little_bird", "endEnterInternal", ::race_ui_add_critical_message );
}
...
little_bird_mp_waitandspawn()
{
    ...
    var_2 = spawnstruct();
    var_3 = scripts\cp_mp\vehicles\vehicle_spawn::_id_127B2( "little_bird", var_1, var_2 );
...
race_ui_add_critical_message( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level._id_11C23 ) )
