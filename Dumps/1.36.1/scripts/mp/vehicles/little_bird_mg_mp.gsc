...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "nuke", scripts\mp\trials\mp_trl_boneyard_gw_race::tryusenukefromstruct );
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "nuke_select_location", scripts\mp\trials\mp_trl_boneyard_gw_race::tryusenukefromstruct );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitLongDurationWithPause", ::set_tank_target_player );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "hostmigration_waitTillHostMigrationDone", ::set_thirdperson );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "delayEndGame", ::nuke_delayendgame );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "addTeamRankXPMultiplier", ::set_shouldrespawn );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "cankill", ::nuke_cankill );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayer", ::set_tier_lights );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "killPlayerWithAttacker", ::set_total_successful_vehicle_spawns_from_module );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "nuke", "stopTheClock", ::set_up_pilots );
}

set_tank_target_player( var_0 )
{
...
nuke_delayendgame( var_0, var_1 )
{
    ...
    if ( istrue( level.respawntagvisibility ) )
...
set_shouldrespawn( var_0, var_1, var_2 )
{
...
set_tier_lights( var_0 )
{
    if ( isplayer( var_0 ) )
    {
        var_1 = makeweapon( "nuke_mp" );
...
set_total_successful_vehicle_spawns_from_module( var_0 )
{
