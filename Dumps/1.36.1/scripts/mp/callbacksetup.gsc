...
codecallback_playeractive()
{
    ...
    if ( isdefined( level.controls_unlink_safe ) )
        [[ level.controls_unlink_safe ]]();
}
...
setupdamageflags()
{
    ...
    level.mp_hideout_patch = 512;
    level.mp_hardhat_patch = 1024;
    level.mp_m_overunder_patch = 2048;
    level.mp_m_cornfield_patch = 4096;
    level.mp_layover_patch = 8192;
    level.mp_m_king_patch = 16384;
...
abortlevel()
{
    ...
    level.controls_unlink_safe = ::callbackvoid;
