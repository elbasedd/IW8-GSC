...
dopotgkillcamforplayer()
{
    ...
    var_1 = scripts\engine\utility::_id_1290E( "begin_killcam", "killcam_ended" );
...
dofinalkillcam()
{
    ...
    level thread scripts\cp\agents\gametype_cp_specops::processfinalkillchallenges( var_2, var_3 );
...
skipkillcamduringdeathtimer( var_0 )
{
    ...
    if ( !isai( self ) )
    {
        ...
        var_1 = scripts\engine\utility::_id_12907( "killcam_death_done_waiting", "killcam_death_button_cancel" );
