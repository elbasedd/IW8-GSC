...
{
    if ( istrue( var_2 ) && play_track_damage_screen_vfx( var_0, var_1 ) )
        return 1;
...
play_track_damage_screen_vfx( var_0, var_1 )
{
...
islethalmeleeweapon( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\weapon::player_choppergunnericon( var_2 ) )
        return 1;
...
attackerishittingteam( var_0, var_1 )
{
    ...
    if ( !level.teambased )
        ...
        return 0;
    else if ( isagent( var_0 ) && istrue( var_0._id_11C71 ) )
        return 0;
