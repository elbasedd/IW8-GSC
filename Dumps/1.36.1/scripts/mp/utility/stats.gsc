...
{
    if ( get_farthest_living_player_not_in_laststand() )
        return;
    ...
    if ( isdefined( self.propaddtocircle[var_0] ) )
        self.propaddtocircle[var_0] = self.propaddtocircle[var_0] + var_1;
...
setextrascore0( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && level.checkbluemassacre.name == "rebirth" )
        return;
...
getplayerdataloadoutgroup()
{
    ...
    var_0 = istrue( level._id_12981 ) && getdvarint( "LNLMORMPTS" );
