...
getweapontype( var_0 )
{
    ...
    if ( var_0 == "armored_train_mg_turret_mp" || var_0 == "armored_train_tank_turret_mp" )
        return "turret";
...
getweapongroup( var_0 )
{
    ...
    if ( !isdefined( var_2 ) )
    {
        if ( issuperweapon( var_0 ) )
            ...
            var_2 = "gamemode";
        else if ( play_bcs( var_0 ) )
            var_2 = "weapon_ballisticSpecial";
        else if ( play_priming_anim( var_0 ) )
...
level_carepackage_give_player_killstreak_incendiary_launcher( var_0 )
{
    if ( isweapon( var_0 ) && isnullweapon( var_0 ) )
        return "other";
...
attachmentsconflict( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( _handlevehiclerepair( var_3, var_4 ) )
        return var_0;

    if ( _handlevehiclerepair( var_4, var_3 ) )
        return var_0;
...
{
    var_2 = boss_one_minion_watcher( var_0 );
    var_3 = boss_fight_combat_laser_trap( var_1 );
...
{
    return play_found_first_lead_vo( getweapongroup( var_0 ), var_0 );
}

play_found_first_lead_vo( var_0, var_1 )
{
    switch ( var_0 )
    {
        case "weapon_melee":
...
{
    return play_found_leads_counting( getweapongroup( var_0 ), var_0 );
}

play_found_leads_counting( var_0, var_1 )
{
    switch ( var_0 )
    {
...
iscacprimaryorsecondary( var_0 )
{
    ...
    return play_found_first_lead_vo( var_1, var_0 ) || play_found_leads_counting( var_1, var_0 );
}
...
{
    if ( isdefined( level.boss_fight_combat_cave[var_0] ) )
        return level.boss_fight_combat_cave[var_0];
...
{
    if ( isdefined( level.boss_two_minion_watcher[var_0] ) )
        return level.boss_two_minion_watcher[var_0];

    var_1 = attachmentmap_tobase( var_0 );

    if ( isdefined( level.boss_fight_combat_forest[var_1] ) )
        return level.boss_fight_combat_forest[var_1];
...
laststandweapon( var_0 )
{
    var_1 = randomintrange( 0, level._id_12A96[var_0].size );
    return level._id_12A96[var_0][var_1];
}
...
_id_12A9A( var_0 )
{
    if ( isdefined( level.weaponmapdata[var_0] ) && isdefined( level.weaponmapdata[var_0].respawns_on_failed_unload ) )
        return level.weaponmapdata[var_0].respawns_on_failed_unload;
...
level_check_current_drop_amount( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( !level.weaponlootmapdata[var_4].player_cam_disable && !scripts\engine\utility::array_contains( var_1, var_2 ) )
...
level_carepackage_player_used_logic( var_0, var_1 )
{
    ...
    var_2 = 0;
    var_3 = level_check_current_drop_amount( var_0, var_1 );
...
_id_12A99( var_0, var_1 )
{
    ...
    if ( var_2 )
    {
        ...
        {
            var_4 = var_0 + "|" + var_1;
            var_3 = isdefined( level.weaponlootmapdata[var_4] ) && !level.weaponlootmapdata[var_4].player_cam_disable;
        }
    }
...
borntime( var_0, var_1 )
{
    var_2 = getweaponrootname( var_0 );
    return boss_fight_combat( var_2, var_1 );
}

boss_fight_combat( var_0, var_1 )
{
    var_2 = level.weaponattachments[var_0];
    return isdefined( var_2 ) && isdefined( var_2[var_1] );
}

vehicle_damage_setweaponhitdamagedataforvehicle( var_0 )
{
    switch ( var_0 )
    {
        case "laserads":
...
weaponbypassspawnprotection( var_0 )
{
    ...
    if ( iskillstreakweapon( var_0 ) && var_2 != "manual_turret_mp" && var_2 != "pac_sentry_turret_mp" && !player_complete_trial( var_2 ) )
        var_1 = 0;
...
player_choppergunnericon( var_0 )
{
    if ( isweapon( var_0 ) )
        var_1 = var_0.basename;
    else
...
{
    if ( player_choppergunnericon( var_0 ) )
        return 1;
