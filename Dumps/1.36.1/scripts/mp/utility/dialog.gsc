...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( level.get_current_armor_ammo ) )
        return;

    if ( isdefined( level.rpg_enemy_damage_debug ) && self [[ level.rpg_enemy_damage_debug ]]( var_0 ) )
        return;
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public.gsc::checked_missiles( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && play_elevator_anim_when_group_is_spawned( var_0 ) )
            var_7 = "dx_bra_";
...
play_elevator_anim_when_group_is_spawned( var_0 )
{
    var_1 = 0;
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public.gsc::checked_missiles( self );
    ...
    if ( level.teambased )
    {
        var_5 = create_struct_at( var_0, 1 );
        var_6 = create_struct_at( var_0 );
