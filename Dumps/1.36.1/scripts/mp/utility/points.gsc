...
little_bird_mg_deletenextframe( var_0, var_1 )
{
    if ( istrue( level.ignorescoring ) )
        return;
...
giveunifiedpoints( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        var_11 = getcompleteweaponname( var_10 );
    ...
    if ( isdefined( level.shouldlink ) )
        [[ level.shouldlink ]]( self, var_9, var_0, var_7 );
