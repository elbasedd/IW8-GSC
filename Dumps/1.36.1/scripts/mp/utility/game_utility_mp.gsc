...
rpg_guys_construction_spawners()
{
...
packsplashparambits( var_0, var_1 )
{
    if ( !isdefined( level.br_level ) )
        return 1;

    var_2 = ks_airdropcratearmor( var_1 );
    var_3 = var_2[1][0];
    var_4 = var_2[1][1];
    var_5 = var_2[0][0];
    var_6 = var_2[0][1];
    var_7 = scripts\mp\gametypes\br_public.gsc::play_patrol_sequence_based_on_first_vehicle() || scripts\mp\gametypes\br_public.gsc::play_death_audio();

    if ( var_7 && isdefined( level.br_ac130 ) )
        return var_0[0] < var_3 && var_0[0] > var_5 && var_0[1] < var_4 && var_0[1] > var_6;
...
ks_airdropcratearmor( var_0 )
{
    ...
    var_2 = isdefined( level.br_level.cargo_truck_mg_cp_createfromstructs );
    var_3 = istrue( var_0 );

    if ( var_2 && var_3 )
        var_1 = level.br_level.cargo_truck_mg_cp_createfromstructs;

    return var_1;
}

ks_airdroppercircle( var_0 )
{
    var_1 = ks_airdropcratearmor( var_0 );
    var_2 = var_1[1][0];
    var_3 = var_1[0][0];
