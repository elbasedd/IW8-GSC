...
{
    scripts\engine\utility::_id_128FF( "death", "carried" );
...
killshouldaddtokillstreak( var_0 )
{
    ...
    return !scripts\mp\utility\weapon::iskillstreakweapon( var_0.basename ) && !scripts\mp\utility\points::player_enemy_cooldown( var_0 );
}
