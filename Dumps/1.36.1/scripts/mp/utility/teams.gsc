...
addtoteamlives( var_0, var_1, var_2 )
{
    ...
    _id_12684( "add", var_1, var_0 );

    if ( isdefined( level.round_mortars_logic ) )
        [[ level.round_mortars_logic ]]( var_0, var_1 );
...
removefromteamlives( var_0, var_1, var_2 )
{
    ...
    _id_12684( "remove", var_1, var_0 );

    if ( isdefined( level.rpg_guys ) )
        [[ level.rpg_guys ]]( var_0, var_1 );
...
_id_12684( var_0, var_1, var_2 )
{
    ...
    if ( var_7 != var_8 || var_4 || var_5 )
    {
        ...
        scripts\mp\utility\script::fusefx( var_9 );
