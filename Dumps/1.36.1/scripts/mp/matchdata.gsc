...
init()
{
    ...
    level.create_saw_interaction = scripts\mp\utility\game::getgametype() == "br" && getdvarint( "scr_log_br_weapon_stats", 0 ) == 1;
    level.remove_reduce_recoil = ::onmatchstart;
    level.remove_roof_nodes = ::onroundend;
    level.remove_old_wheelsons = ::logkillstreakevent;
    level.remove_objective_on_flag = ::loggameevent;
    level.remove_munition_on_use = ::logattackerkillevent;
    level.remove_prohibited_weapons = ::logvictimkillevent;
    level.remove_on_death = ::logmultikill;
    level.remove_player_from_focus_fire_attacker_list = ::logplayerlife;
    level.remove_padding_damage = ::logplayerdeath;
    level.remove_outline = ::logplayerdata;
    level.remove_player_rig_laser_panel = ::logscoreevent;
    level.remove_soldier_armor = ::updatesquadleaderpassstateforteam;
    level.remove_punchcard = ::logweaponstat;
    level.remove_medic_class = ::logattachmentstat;
    level.remove_marker_when_player_disconnects = ::buildweaponrootlist;
    level.remove_munitions_in_radius = ::logchallenge;
    level.remove_munitions_globally = ::logaward;
...
onmatchstart()
{
    ...
    if ( var_0 == "br" )
        var_1 = level.checkbluemassacre.name;
    ...
    if ( var_0 == "br" )
        scripts\common\utility::_id_12456( level.remove_map_hint );
...
logplayerdeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isvalidclient( var_1 ) )
    {
        ...
        var_22 = var_1 scriptable_enginedamaged();
        var_23 = var_1.origin;
        var_24 = var_1.angles;
    ...
    var_36 = scriptable_enginedamaged();
    var_37 = -1;
...
recondronemarkedcb( var_0 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "arm" && isdefined( self.lootcachesearchparams ) )
    {
        var_36["press_rclick"] = istrue( self.lootcachesearchparams["rightmouseup"] );
        var_36["press_lclick"] = istrue( self.lootcachesearchparams["leftmouseup"] );
        var_36["press_activate"] = istrue( self.lootcachesearchparams["activate"] );
        var_36["press_gostand"] = istrue( self.lootcachesearchparams["gostand"] );
    }
...
logplayerdata( var_0 )
{
    ...
    {
        var_2 = scripts\mp\rank::enemy_spawnnewscrambler( self );
        scripts\mp\rank::enemy_targets_headshot( self.enemy_validate_node_proximity, var_2 );
    }
    ...
    foreach ( var_23, var_6 in self.pers["matchdataWeaponStats"] )
    {
        ...
        self dlog_recordplayerevent( "dlog_event_player_weapon_stats_br", [ "weapon", var_6.weapon, "variant_id", var_6.variantid, "from_loadout", var_19, "died", var_20, "time_used_s", var_22, "longest_hit_distance", var_21, "deaths", var_9, "headshots", var_10, "hits", var_11, "kills", var_12, "shots", var_13, "damage", var_14, "attachment_0", var_6.attachments[0], "attachment_1", var_6.attachments[1], "attachment_2", var_6.attachments[2], "attachment_3", var_6.attachments[3], "attachment_4", var_6.attachments[4], "sticker_0", var_6._id_11FFC[0], "sticker_1", var_6._id_11FFC[1], "sticker_2", var_6._id_11FFC[2], "sticker_3", var_6._id_11FFC[3], "reticle", var_6.reticle, "cosmetic_attachment", var_6.drop_intel_on_death_regardless, "camo", var_6.camo, "match_time_created_s", var_6.pickuptime ] );
    }
}
...
updatesquadleaderpassstateforteam()
{
...
logweaponstat( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && !istrue( level.create_saw_interaction ) )
        return;
    ...
    {
        if ( !death_killstreak_watcher( var_4, var_5 ) )
        {
            var_6 = 1;
            var_7 = var_5 + "_" + var_6;
            ...
            for (;;)
            {
                if ( !isdefined( self.pers["matchdataWeaponStats"][var_7] ) || death_killstreak_watcher( var_4, var_7 ) )
                    break;
    ...
    if ( !isdefined( self.pers["matchdataWeaponStats"][var_5] ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && isdefined( var_4 ) )
        {
            ...
            self.pers["matchdataWeaponStats"][var_5].drop_intel_on_death_regardless = var_9;
            ...
            self.pers["matchdataWeaponStats"][var_5]._id_11FFC = var_18;
        }
    }
...
death_killstreak_watcher( var_0, var_1 )
{
    ...
    if ( var_3 != self.pers["matchdataWeaponStats"][var_1].drop_intel_on_death_regardless )
        return 0;
    ...
    if ( var_7.size != self.pers["matchdataWeaponStats"][var_1]._id_11FFC.size )
        return 0;

    for ( var_6 = 0; var_6 < var_7.size; var_6++ )
    {
        if ( var_7[var_6] != self.pers["matchdataWeaponStats"][var_1]._id_11FFC[var_6] )
            return 0;
    }
