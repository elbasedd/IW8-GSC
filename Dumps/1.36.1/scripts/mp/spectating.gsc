...
onjoinedspectators( var_0 )
{
    ...
    if ( var_0 ismlgspectator() || isdefined( var_0.pers["mlgSpectator"] ) && var_0.pers["mlgSpectator"] )
    {
        ...
        var_0 thread wave_default_internal();
    }
}
...
autoattachtoplayer()
{
    ...
    level.ppkteamwithflag = game["lastSpectatedPlayer"];
    ...
    for (;;)
    {
        ...
        {
            if ( level.currentround > 1 && isdefined( level.ppkteamwithflag ) && self.team != "follower" )
                var_0 = level.ppkteamwithflag;
...
updatemlgspectator()
{
    ...
    for (;;)
    {
        if ( self ismlgspectator() && self isspectatingplayer() )
        {
            ...
            if ( isdefined( var_0 ) )
                level.ppkteamwithflag = var_0.clientid;
        }
...
wave_default_internal()
{
    ...
    game["lastSpectatedPlayer"] = level.ppkteamwithflag;
}
