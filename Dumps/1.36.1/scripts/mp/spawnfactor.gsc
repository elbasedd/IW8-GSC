...
init_spawn_factors()
{
    ...
    registerfactor( "avoidCloseToDefenderFlag", ::bot_thanks, 1, [ "activeCarrierPosition", "defenderFlagPosition", "avoidDefenderFlagDeadZoneDistSq" ] );
    registerfactor( "avoidCloseToDefenderFlagSpawn", ::bot_try_switch_attack_zone, 1, [ "avoidDefenderFlagDeadZoneDistSq" ] );
    initfrontline();
}
...
bot_try_switch_attack_zone( var_0, var_1 )
{
    var_2 = var_0.scriptdata.get_objective_label;
