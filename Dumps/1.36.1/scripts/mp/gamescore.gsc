...
giveplayerscore( var_0, var_1, var_2 )
{
    ...
    var_5 scripts\common\utility::_id_12456( level.remove_player_rig_laser_panel, var_0 );
...
giveteamscoreforobjective( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( level.roundscorelimit > 1 && !istrue( level.dontendonscore ) )
    {
        ...
        {
            if ( level scripts\mp\utility\game::playerhumanconcusspushcleanup( var_7 ) )
                continue;
    ...
    if ( isdefined( var_5 ) )
        ...
        var_9 = connect_circlar_path( var_2 );

    if ( !istrue( var_4 ) )
        toggle_in_use( var_9, var_2, level.waswinning );
    ...
    if ( !level.onlinegame )
        recon_update_hint_logic();
}

toggle_in_use( var_0, var_1, var_2 )
{
...
playleadtakendialog( var_0 )
{
    ...
    level.lastscorestatustime = gettime();
    var_1 = connect_circlar_path( var_0 );
...
updateteamscore( var_0 )
{
    if ( scripts\mp\utility\game::playerhumanconcusspushcleanup( var_0 ) )
        return;
...
processassist_regularmp( var_0, var_1, var_2 )
{
    ...
    thread scripts\cp\agents\gametype_cp_specops::onplayerkillassist( var_0 );
}
