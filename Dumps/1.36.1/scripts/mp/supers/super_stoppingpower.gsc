...
_id_12033()
{
    level.showing_ui_record scripts\mp\trials\mp_trl_create_a_script_race_euphrates::control_station_interact( ::_id_12038, level );
    level.showintelinstancetoplayer scripts\mp\trials\mp_trl_create_a_script_race_euphrates::control_station_interact( ::_id_12039, level );
}
...
stoppingpower_beginuse()
{
    ...
    if ( scripts\mp\utility\weapon::ismeleeonly( var_0 ) || scripts\mp\utility\weapon::issuperweapon( var_0 ) || scripts\mp\utility\weapon::iskillstreakweapon( var_0 ) || scripts\mp\utility\weapon::isgamemodeweapon( var_0 ) || scripts\mp\utility\weapon::issinglehitweapon( var_0.basename ) || !_id_12035( var_0 ) || var_0.basename == "iw8_lm_dblmg_mp" || var_0.basename == "iw8_fists_mp" )
    {
    ...
    {
        var_8 = scripts\mp\utility\weapon::platform_cleanup_on_death( var_7 );
        ...
        if ( issameweapon( var_7, var_0, 0 ) )
        {
            ...
            if ( 1 )
            {
                if ( var_8 )
                {
                    ...
                    var_11 = var_9 + var_4;
                    var_12 = int( min( _id_12030( var_7, var_11 ), var_11 + var_10 ) );
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        {
                            var_16 = var_15 - var_4;
                            scripts\mp\gametypes\br_weapons.gsc::carepackage_drops( var_7, var_16 );
                        }
                        else
    ...
    thread _id_1203B( var_0, var_4, var_5 );
    return 1;
}
...
_id_12035( var_0 )
{
    ...
    return scripts\mp\weapons::play_animation_old( var_1 );
}

_id_1203B( var_0, var_1, var_2 )
{
...
{
    var_3 = end_reach_wind_room( var_0, var_1, var_2 );
    _id_12032( var_0, var_3 );
}

end_reach_wind_room( var_0, var_1, var_2 )
{
    var_3 = spawnstruct();
    var_3.player = var_0;
...
_id_12032( var_0, var_1 )
{
    ...
    var_1 thread _id_1202E();
    var_1 thread _id_1202F();
...
_id_12038( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0 ) || !isdefined( var_1 ) )
        return;

    var_3 = var_1 _id_12031( var_2 );

    if ( isdefined( var_3 ) )
    {
        var_4 = end_reach_wind_room( var_3.player, var_3.objweapon, var_3.rounds );
        var_0.hcrdata = var_4;
        var_3 thread stoppingpower_removehcr();
    }
}

_id_12039( var_0, var_1, var_2 )
{
    var_3 = var_0.hcrdata;
...
stoppingpower_watchhcrweaponchange()
{
    ...
    {
        if ( _id_12034( self.player getcurrentweapon() ) )
        {
            if ( !self.gavehcr )
            {
...
stoppingpower_watchhcrweaponfire()
{
    ...
    self.player thread _id_1203A( self.objweapon );
    thread stoppingpower_removehcr();
}
...
_id_1203A( var_0 )
{
    ...
    self.position_ref = 1;
    scripts\engine\utility::_id_1291A( 2, "weapon_fired", "weapon_change" );
...
_id_1202D()
{
    if ( isdefined( self.player.hcrdata ) )
    {
        ...
        self.player scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_support_box", self.kills );
...
_id_12037( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_kills_scorestreak_or_loadout_drop_weapons_s3", 1 );
            var_2.kills++;
        }
    }
}
...
stoppingpower_givefastreload()
{
    ...
    self.player scripts\engine\utility::_id_12900( "weapon_fired", "weapon_change", "stoppingPower_removeHCR" );
