...
superdeadsilence_endsuper( var_0 )
{
    ...
    scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_deadsilence", self.deadsilencekills );
...
superdeadsilence_onkill()
{
    if ( scripts\mp\utility\game::getgametype() != "infect" )
    {
        ...
        var_0 = scripts\mp\supers::juggernaut_update_hint_logic( "super_deadsilence" );

        if ( self.deadsilencekills > var_0 )
        {
            var_1 = self.deadsilencekills - var_0;
            scripts\mp\supers::dmg_trig( "super_deadsilence", var_1 );
        }
    }
...
applyfovpresentation()
{
    ...
    var_1 = var_0 - 2;
    scripts\engine\utility::_id_12919( var_1, "super_use_finished" );
...
_id_120A6()
{
    ...
    level scripts\engine\utility::_id_128FF( "game_ended", "prematch_cleanup" );
