...
inititems()
{
    ...
    var_0.callbacks["equip_binoculars"]["onGive"] = scripts\mp\trials\trial_pitcher::brgetloadoutammomultiplier;
    var_0.callbacks["equip_binoculars"]["onTake"] = scripts\mp\trials\trial_pitcher::brjugg_droponplayerdeath;
...
loadtable()
{
    ...
    for (;;)
    {
        ...
        if ( var_4 != "none" )
        {
            ...
            if ( var_5 != "" )
            {
                var_7 = makeweapon( var_4 );

                if ( !isnullweapon( var_7 ) )
                    var_6 = [ var_5 ];
            }

            var_3.objweapon = makeweapon( var_4, var_6 );
        }
        ...
        var_3.player_trigger_monitor = tablelookupbyrow( "mp/equipment.csv", var_0, 8 ) != "-1";
...
{
    if ( isdefined( level.equipment.table[var_0] ) )
        return istrue( level.equipment.table[var_0].player_trigger_monitor );
    else
        return 0;
}
...
executeoffhandfired( var_0 )
{
    foreach ( var_6, var_2 in self.equipment )
    {
        ...
        if ( isdefined( var_3.objweapon ) && var_0 == var_3.objweapon )
        {
            ...
            scripts\mp\damage::divide_living_ai( var_4 );
...
watchlethaldelayplayer( var_0, var_1 )
{
    ...
    if ( !isdefined( self.propnumclones ) || !istrue( self.propnumclones[var_1] ) )
    {
        if ( !isdefined( self.propnumclones ) )
            self.propnumclones = [];

        self.propnumclones[var_1] = 1;
    ...
    if ( isdefined( self.propnumclones ) && istrue( self.propnumclones[var_1] ) )
    {
        self.propnumclones[var_1] = undefined;

        if ( self.propnumclones.size == 0 )
            self.propnumclones = undefined;
...
hackequipment( var_0 )
{
    ...
    var_0 scripts\cp\agents\gametype_cp_specops::should_damage_player_on_bottom( self.equipmentref );
    changeowner( var_0 );
...
link_player_to_rig_laser_panel( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4.x1timehandler = var_4 getcurrentequipment( var_1 );
        var_4.x1timedivision = getequipmentslotammo( var_1 );
...
_id_12137( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        var_7 = var_5.x1timehandler;
        var_8 = var_5.x1timedivision;

        if ( isdefined( var_7 ) )
        {
            var_5 giveequipment( var_7, var_1 );
            var_5.x1timehandler = undefined;

            if ( isdefined( var_8 ) )
            {
                var_5 setequipmentammo( var_7, var_8 );
                var_5.x1timedivision = undefined;
            }
        }
    }
}
...
openpos()
{
    level.propmoveunlock = [];
    var_0 = 0;

    foreach ( var_2 in level.equipment.table )
    {
        if ( !var_2.player_trigger_monitor )
            continue;
        ...
        level.propmoveunlock[var_2.ref] = 1 << var_0;
        var_0++;
    }
}
