...
main()
{
    ...
    if ( isdefined( level.calloutmarkerpingvo_calculatesounddebouncelength ) )
        [[ level.calloutmarkerpingvo_calculatesounddebouncelength ]]();
    else
    ...
    foreach ( var_1 in level.players )
    {
        if ( isbot( var_1 ) )
        {
            if ( isalive( var_1 ) )
            {
                ...
                var_1.camera_loadout_showcase_preview_barrel_alt2 = 1;
...
{
    var_0 scripts\engine\utility::_id_128FF( "bots_human_spawned", "bots_human_disconnected" );
    ...
    for (;;)
    {
        ...
        if ( var_46 )
        {
            ...
            if ( var_45 > 0 && var_44 > 0 )
                level scripts\engine\utility::_id_128F9( "spawned_enemies", "spawned_allies" );
            else if ( var_45 > 0 )
                level waittill( "spawned_enemies" );
            else if ( var_44 > 0 )
...
bot_think()
{
    ...
    if ( !isdefined( self.camera_loadout_showcase_preview_barrel_alt2 ) )
    {
        var_1 = 1;
        self.camera_loadout_showcase_preview_barrel_alt2 = 1;
    ...
    for (;;)
    {
        ...
        scripts\mp\bots\bots_loadout::calloutmarkerpingvo_getcalloutaliasstringworld();
        calloutmarkerpingvo_getfulloperatorvoaliasfromsimplealias2d();
...
bot_think_seek_dropped_weapons()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\bots\bots_util::calloutmarkerping_gettimeoutforpoolid( 0.33 ) )
        {
...
bot_crate_valid( var_0 )
{
    ...
    else if ( calloutmarkerping_squadleaderbeaconcreate( var_0 ) )
        return 0;
...
bot_think_crate_blocking_path()
{
    ...
    for (;;)
    {
        ...
        for ( var_2 = 0; var_2 < var_1.size; var_2++ )
        {
            ...
            {
                if ( !calloutmarkerping_squadleaderbeaconcreate( var_3 ) )
                {
...
bot_think_revive()
{
    ...
    for (;;)
    {
        ...
        if ( !bot_can_revive() )
        {
            self.play_counter_beep_sfx_on_bomb_vests = 0;
            continue;
        }
...
revive_watch_for_finished( var_0 )
{
    ...
    self endon( "bad_path" );
    self endon( "goal" );
    var_0 scripts\engine\utility::_id_128FF( "death", "revived" );
...
handle_smoke()
{
    ...
    thread empty_collision_handler( var_0 );
}
