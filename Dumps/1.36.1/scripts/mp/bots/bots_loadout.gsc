...
bot_loadout_item_allowed( var_0, var_1, var_2 )
{
    ...
    if ( !calculate_teleport_data_for_player() )
        return 0;
...
bot_loadout_choose_fallback_primary( var_0 )
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", calloutmarkerpingvo_getcalloutaliasstringloot(), var_13, "class", "inUse" ) )
            {
                var_1 = calloutmarkerpingvo_getcalloutaliasstringentity( var_13, "loadoutPrimary" );
...
calculateclientmatchdataextrainfopayload()
{
    ...
    if ( isusingmatchrulesdata() )
    {
        ...
        {
            if ( scripts\mp\utility\game::getmatchrulesdatawithteamandindex( "defaultClasses", calloutmarkerpingvo_getcalloutaliasstringloot(), var_1, "class", "inUse" ) )
                var_0[var_1] = var_1;
        }
    }
    ...
    foreach ( var_5 in level.bot_loadout_fields )
    {
        ...
        var_3[var_5] = calloutmarkerpingvo_getcalloutaliasstringentity( var_2, var_5 );
    }
...
bot_validate_weapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_8 = scripts\mp\utility\weapon::iwbestscore( var_0 );
...
init_bot_weap_statstable()
{
    ...
    for (;;)
    {
        ...
        {
            if ( !scripts\mp\weapons::playergetzombiespawnlocation( var_2 ) )
            {
                var_0++;
                continue;
            }
...
{
    var_2 = calloutmarkerpingvo_getcalloutaliasstringloot();
...
bot_loadout_valid_choice( var_0, var_1, var_2, var_3 )
{
    ...
    switch ( var_2 )
    {
        ...
        case "loadoutPrimaryBuff":
            break;
        case "loadoutPrimaryCamo":
            var_4 = !isdefined( self.cameraentlinktag ) || var_3 == self.cameraentlinktag;
            break;
        case "loadoutSecondary":
        ...
        case "loadoutSecondaryBuff":
            break;
        case "loadoutSecondaryCamo":
            var_4 = !isdefined( self.cameraentmoving ) || var_3 == self.cameraentmoving;
            break;
        case "loadoutStreak3":
        case "loadoutStreak2":
        case "loadoutStreak1":
...
bot_loadout_choose_from_set( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        if ( !isdefined( self.flag_bot_defender_limit_for_team ) )
            self.flag_bot_defender_limit_for_team = scripts\engine\utility::random( [ "class1", "class2", "class3", "class4", "class5" ] );

        var_0 = [ self.flag_bot_defender_limit_for_team ];
    }
...
calloutmarkerping_ismunitionsbox()
{
    if ( calloutmarkerping_islootquesttablet().size > 0 )
    {
...
{
    if ( istrue( self.calloutmarkerpingvo_playpredictivepingacknowledgedcancel ) )
        return 0;
...
bot_loadout_class_callback( var_0 )
{
    ...
    if ( !isdefined( self.calloutmarkerpingvo_doesoperatorsupportalias ) )
        self.calculate_path_struct = 0;

    self.calloutmarkerpingvo_doesoperatorsupportalias = self.calculate_path_struct;
    ...
    var_8 = !var_7 && c130airdrop_getvalidteaminlastplace();
    ...
    self.calloutmarkerpingvo_playpredictivepingacknowledgedcancel = undefined;

    if ( !var_7 )
    {
        var_12 = calloutmarkerping_ismunitionsbox();
        var_13 = undefined;

        if ( isdefined( self.respawn_with_launcher ) && isdefined( var_12 ) )
        {
            self.respawn_with_launcher = undefined;
            self.calloutmarkerpingvo_playpredictivepingacknowledgedcancel = 1;
            var_13 = var_12;
        }

        if ( !isdefined( var_13 ) )
        {
            var_14 = calloutmarkerping_islootquesttablet();
            var_15 = 0;
    ...
    var_16 = undefined;
    var_17 = calculate_teleport_data_for_player();
    ...
    if ( var_17 )
    {
        ...
        if ( calloutmarkerpingvo_getcalloutaliasstringvehicle( var_1 ) )
            var_17 = 0;
    }

    if ( !var_17 )
    {
        var_1 = calculateclientmatchdataextrainfopayload();
    ...
    {
        if ( isdefined( var_1["loadoutPrimaryCamo"] ) && var_1["loadoutPrimaryCamo"] != "none" && !isdefined( self.cameraentlinktag ) )
            self.cameraentlinktag = var_1["loadoutPrimaryCamo"];

        if ( isdefined( var_1["loadoutSecondaryCamo"] ) && var_1["loadoutSecondaryCamo"] != "none" && !isdefined( self.cameraentmoving ) )
            self.cameraentmoving = var_1["loadoutSecondaryCamo"];
