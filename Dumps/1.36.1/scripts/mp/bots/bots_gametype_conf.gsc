...
bot_conf_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 && self bothasscriptgoal() )
        {
            ...
            else if ( scripts\mp\bots\bots_strategy::bot_has_tactical_goal( "kill_tag" ) && self.tag_getting c4_crate_player_at_max_ammo( self.team ) )
            {
...
bot_watch_new_tags()
{
    for (;;)
    {
        ...
        level thread camera_loadout_showcase_preview_sticker_alt1( self, var_0 );
    }
}

camera_loadout_showcase_preview_sticker_alt1( var_0, var_1 )
{
...
bot_find_visible_tags( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_3 ) && isdefined( level.dogtags ) )
    {
        ...
        {
            if ( var_7 c4_crate_player_at_max_ammo( self.team ) )
            {
                var_8 = 0;
...
bot_remove_invalid_tags( var_0 )
{
    ...
    {
        if ( var_3.tag c4_crate_player_at_max_ammo( self.team ) && scripts\mp\bots\bots_util::bot_vectors_are_equal( var_3.tag.curorigin, var_3.origin ) )
        {
