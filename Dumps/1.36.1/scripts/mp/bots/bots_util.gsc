...
bot_choose_difficulty_for_default()
{
    ...
    if ( !isdefined( level.calloutmarkerpingvo_handleraddnewelement ) )
        level.calloutmarkerpingvo_handleraddnewelement = [];

    if ( !isdefined( level.calloutmarkerpingvo_handleraddnewelement["allies"] ) )
        level.calloutmarkerpingvo_handleraddnewelement["allies"] = 0;

    if ( !isdefined( level.calloutmarkerpingvo_handleraddnewelement["axis"] ) )
        level.calloutmarkerpingvo_handleraddnewelement["axis"] = 0;

    if ( !isdefined( level.calloutmarkerpingvo_handleraddnewelement["all"] ) )
        level.calloutmarkerpingvo_handleraddnewelement["all"] = 0;
    ...
    if ( !isdefined( self.pers["bot_chosen_difficulty"] ) )
    {
        ...
        var_0 = level.calloutmarkerpingvo_handleraddnewelement[var_1];
        var_2 = level.bot_difficulty_defaults[var_0];
        self.pers["bot_chosen_difficulty"] = is_attack_available( var_2 );
        level.calloutmarkerpingvo_handleraddnewelement[var_1] = ( level.calloutmarkerpingvo_handleraddnewelement[var_1] + 1 ) % level.bot_difficulty_defaults.size;
    }
...
bot_usebutton_wait( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\engine\utility::_id_12916( var_0, var_1, var_2, "use_button_no_longer_pressed", "finished_use" );
...
bot_allowed_to_use_killstreaks()
{
    ...
    if ( istrue( self.camera_loadout_showcase_preview_sticker_alt3 ) )
        return 0;
...
watch_nodes_aborted()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12913( 0.5, "still_watching_nodes" );
...
camera_loadout_showcase_preview_large_stock_alt1( var_0, var_1 )
{
    if ( !isdefined( var_1 ) )
        var_1 = level.get_baseaccuracy;
...
callouts( var_0, var_1, var_2 )
{
    if ( !isdefined( var_2 ) )
        var_2 = level.get_baseaccuracy;
