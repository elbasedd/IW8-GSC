...
setup_callbacks()
{
    level.bot_funcs["gametype_think"] = ::calloutmarkerping_squadleaderbeaconshouldcreate;
    level.bot_funcs["should_start_cautious_approach"] = ::_id_11BAB;
}
...
_id_11AE5()
{
    ...
    if ( !var_0 )
    {
        ...
        level.callbackplayeractive[var_5.trigger getentitynumber()] = 1;
        level.bot_gametype_precaching_done = 1;
        thread c130airdrop_startdelivery( var_5 );
    }
}

c130airdrop_startdelivery( var_0 )
{
    for ( var_1 = scripts\engine\utility::array_remove( level.objectives, var_0 ); var_1.size > 0; var_1 = scripts\engine\utility::array_remove( var_1, var_2 ) )
    {
        ...
        level.callbackplayeractive[var_2.trigger getentitynumber()] = 1;
    }
}

calloutmarkerping_squadleaderbeaconshouldcreate()
{
    ...
    for (;;)
    {
        ...
        if ( !isdefined( var_0 ) || !istrue( var_0.active ) || !isdefined( level.callbackplayeractive[var_0.trigger getentitynumber()] ) )
        {
            c4_placed_bc();
        ...
        if ( self.team != var_1 )
        {
            if ( !calloutmarkerping_watchentitydeathorenemydisconnect( var_0 ) )
        ...
        if ( !calloutmarkerping_watchwhenobjectivedeleted( var_0 ) )
        {
            if ( calloutmarkerping_watchentitydeathorenemydisconnect( var_0 ) )
            {
                wait( randomfloat( 2 ) );
...
calloutmarkerping_watchentitydeathorenemydisconnect( var_0 )
{
    ...
    return isdefined( self.entityplunderbankalldeposited ) && self.entityplunderbankalldeposited == var_0;
}
...
{
    self.entityplunderbankalldeposited = var_0;
    var_1 = length( var_0._id_12BE2.lootchopper_postmodifydamage ) * 2;
    var_2["override_origin_node"] = var_0.customturret;
    scripts\mp\bots\bots_strategy::bot_protect_point( var_0.customturret.origin, var_1, var_2 );
}
