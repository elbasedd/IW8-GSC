...
matchrecording_loggameendstats()
{
    ...
    {
        if ( isdefined( var_6._id_11C35 ) )
            var_0 = var_6._id_11C35;

        if ( isdefined( var_6.gunship_origin_override ) )
            var_3 = var_6.gunship_origin_override;

        if ( isdefined( var_6.gunship_watchgameend ) )
            var_4 = var_6.gunship_watchgameend;
    }
...
matchrecording_usereventthink()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_1290E( "log_user_event_end", "log_user_event_generic_event" );
