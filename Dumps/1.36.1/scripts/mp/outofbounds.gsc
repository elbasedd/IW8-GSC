...
playercinematiccompletecallback( var_0 )
{
    var_1 = 16;
...
onenteroob( var_0 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.rpg_building_guys ) )
            var_1 = level.rpg_building_guys;
        else
    ...
    else
    {
        ...
        var_5 = getoutofboundstime( var_3, var_0.vo_stealth_broken );
...
onexitoob( var_0, var_1, var_2 )
{
    ...
    if ( isplayer( var_0 ) )
    {
        if ( isdefined( level.rpg_death_watcher ) )
            var_3 = level.rpg_death_watcher;
        else
...
watchoobtriggerenter( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isplayer( var_1 ) && scripts\mp\utility\game::player_grenade_fire_monitor( var_1 ) )
            continue;
...
{
    if ( istrue( var_1 ) )
        return scripts\mp\utility\game::ks_circlemoving();

    if ( isdefined( var_1 ) && !var_1 )
        return scripts\mp\utility\game::ks_circlemovedist();
    ...
    switch ( var_0 )
    {
        ...
        case "br":
            return scripts\mp\utility\game::ks_circleminimapradius();
        case "default":
