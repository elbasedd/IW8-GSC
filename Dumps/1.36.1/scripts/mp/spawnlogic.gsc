...
getspawnpoint( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !istrue( level.get_force_push_direction ) && !istrue( var_0.skipspawncamera ) && var_9.bucket >= 2 && var_9.threatsight < 300 )
        var_0._id_11BC7 = 1;
...
addstartspawnpoints( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( level.modifiedspawnpoints ) )
    {
        ...
        {
            if ( vo_nag_mark_crates( var_3[var_5] ) )
                continue;
...
getspawnpointarray( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        level.spawnpointarray[var_0] = level.x1ops7[var_0];
        return level.spawnpointarray[var_0];
    }

    if ( isdefined( level.x1ops7 ) && isdefined( level.x1ops7[var_0] ) )
        var_8 = scripts\engine\utility::array_combine( var_8, level.x1ops7[var_0] );
...
finalizespawnpointchoice( var_0 )
{
    ...
    else
    {
        ...
        self finalizespawnpointchoiceforplayer( var_0.index, var_0.bucket, var_0._id_12674, var_0.threatsight, var_0.damagemod );
    }
...
endmatchcameratransitions( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = spawnstruct();
...
allplayers_setfov( var_0 )
{
    ...
    foreach ( var_2 in var_0 )
    {
        ...
        if ( !isdefined( level.x1ops7[var_3] ) )
            level.x1ops7[var_3] = [];
        ...
        level.x1ops7[var_3][level.x1ops7[var_3].size] = var_8;
    }

    level thread x1opsbink();
}
