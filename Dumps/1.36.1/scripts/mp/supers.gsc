...
init()
{
    ...
    scripts\mp\supers\super_stoppingpower::_id_12033();
    scripts\mp\utility\spawn_event_aggregator::registeronplayerspawncallback( ::_id_120A4 );
...
loadsupertable()
{
    ...
    for (;;)
    {
        ...
        var_2.usbvm = readsupertablecell( var_0, 6, 1 );
        ...
        var_2.clean_up_ents = readsupertablecell( var_0, 19, 1 );
...
registersupers()
{
    ...
    registersuper( "super_select", ::_id_120AD, ::_id_120AE, ::superselectbeginuse, undefined );
    registersuper( "super_fulton", undefined, undefined, ::_id_120A7, undefined );
    registersuper( "super_supply_drop", undefined, undefined, ::_id_120B0, undefined );
    registersuper( "super_vehicle_drop", undefined, undefined, ::_id_120B2, undefined );
    registersuper( "super_loot_drop", undefined, undefined, ::_id_120B0, undefined );
    vandalize_attack_max_cooldown( "super_emp_drone", "emp_drone_player_mp" );
    vandalize_attack_max_cooldown( "super_emp_drone", "emp_drone_non_player_mp" );
    vandalize_attack_max_cooldown( "super_emp_drone", "emp_drone_non_player_direct_mp" );
    vandalize_attack_max_cooldown( "super_weapon_drop", "deploy_weapondrop_mp" );
}
...
vandalize_attack_max_cooldown( var_0, var_1 )
{
    if ( !isstring( var_1 ) )
        var_1 = var_1.basename;

    var_2 = level.superglobals.staticsuperdata[var_0];
    var_2.helihint_deposit_vo[var_2.helihint_deposit_vo.size] = var_1;
    level.superglobals._id_120AC[var_1] = var_2;
}
...
givesuper( var_0, var_1, var_2 )
{
    ...
    var_4.smartwatchinteract = undefined;
    _id_11AD4( 0 );
    _id_120AA( var_0 );
...
clearsuper( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1.staticdata ) )
        _id_120AB( var_1.staticdata.ref );
    ...
    thread scripts\mp\trials\mp_trl_floorislava::_id_11A77( "ui_super_state", 0 );
...
_id_125FD()
{
    ...
    {
        var_0.setuphumanpowers = undefined;
        return;
    }
    ...
    if ( !isdefined( var_0.setuphumanpowers ) || var_1 != var_0.setuphumanpowers )
        self setclientomnvar( "ui_super_progress", var_1 );

    self setplayersupermeterprogress( var_1 );
    var_0.setuphumanpowers = var_1;
}
...
updatesuperuistate()
{
    ...
    if ( !isdefined( var_1 ) || var_2 != var_1 )
        thread scripts\mp\trials\mp_trl_floorislava::_id_11A77( "ui_super_state", var_2 );
...
superusefinished( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        else if ( var_4.staticdata.clean_up_ents )
        {
            clearsuper();
            self setclientomnvar( "ui_perk_package_state", 0 );
            self setclientomnvar( "ui_super_progress", 0 );
...
getsuperpointsneeded()
{
    ...
    if ( isdefined( var_0.smartwatchinteract ) )
        var_1 = var_0.smartwatchinteract;
...
lb_mg_pitch_roll_dmg_factor( var_0 )
{
    ...
    if ( !isdefined( level.superglobals._id_120AC[var_0] ) )
        return undefined;

    return level.superglobals._id_120AC[var_0].ref;
}
...
getsuperrefforsuperweapon( var_0 )
{
    ...
    var_2 = lb_mg_pitch_roll_dmg_factor( var_0 );
...
updateactivesupers( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_11 )
    {
        ...
        if ( var_8 && var_0 scripts\mp\utility\perk::_hasperk( "specialty_bulletdamage" ) )
            var_1 thread scripts\mp\supers\super_stoppingpower::_id_12037( var_5 );
    }
}
...
dmg_trig( var_0, var_1 )
{
    ...
    var_2 = juggernaut_update_hint_logic( var_0 );
    self setplayerdata( "mp", "playerStats", "superStats", var_0, "misc1", var_2 + var_1 );
}

juggernaut_update_hint_logic( var_0 )
{
...
scramblebeginuse()
{
    ...
    thread scripts\cp_mp\killstreaks\helper_drone::mix( self );
    return 1;
}
...
_id_120AD()
{
    ...
    self.super.smartwatchinteract = var_5;
}
