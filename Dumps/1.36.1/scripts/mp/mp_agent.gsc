...
default_on_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( level.amped_victim_starttime ) )
        var_13 [[ level.amped_victim_starttime ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, 0.0, var_10, var_11 );
...
default_on_damage_finished( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    {
        self notify( "pain" );
        scripts\asm\asm_mp::watchalleyplayerexit();
    }
...
{
    var_10 = arenaflag_setvisibleplayer( var_3, var_0 );
    ...
    if ( isdefined( self._blackboard.currentvehicle ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( self._blackboard.vehicledeathwait ) )
                ...
                self.body thread unset_force_aitype_shotgun( self._blackboard.currentvehicle );
        }
    }
