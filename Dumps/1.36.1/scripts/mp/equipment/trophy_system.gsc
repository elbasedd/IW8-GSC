...
trophy_deploy()
{
    ...
    thread trophy_watchprotection( 45, 105625, ::_id_1242D, ::trophy_protectionsuccessful );
    thread _id_12430();
...
trophy_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_trophy", self.usedcount, var_0, var_2 );
...
trophy_protectionsuccessful( var_0 )
{
    ...
    self.owner scripts\mp\supers::dmg_trig( "super_trophy" );
    self.usedcount++;
    var_1 = var_0.origin;
...
_id_12429( var_0 )
{
    ...
    var_0.exploding = 1;
    var_0 stopsounds();
    scripts\cp\agents\gametype_cp_specops::ondestroyedbytrophy();
    trophy_notifytrophytargetowner( var_0, "trophy_mp", self.owner );
    _id_1242E( var_0, var_0.owner, self.owner );
...
_id_1242E( var_0, var_1, var_2 )
{
    ...
    var_3 = var_2;
    var_4 = var_1.origin;
    var_5 = scripts\mp\equipment\snapshot_grenade::_id_11CAD( var_3, var_4 );
    scripts\mp\equipment\snapshot_grenade::_id_11CAC( var_1, var_2, var_5 );
}
...
recondronetracecontents( var_0 )
{
    ...
    if ( !isdefined( self.game_end_watcher ) )
        return;

    dlog_recordevent( "dlog_event_trophy_successful", [ "deploying_player", self.game_end_watcher, "grenade_owner", var_0.owner, "negated_target", var_0.weapon_name ] );
}
