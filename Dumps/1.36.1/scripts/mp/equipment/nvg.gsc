...
runnvg()
{
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) )
    {
        ...
        scripts\common\utility::atv_trail( 1, undefined, 1 );
...
nvg_monitor()
{
    ...
    for (;;)
    {
        var_1 = scripts\engine\utility::_id_12907( "night_vision_on", "night_vision_off" );
...
nvg_update3rdperson( var_0 )
{
    ...
    if ( istrue( self.playapache_dialogue ) )
        return;
