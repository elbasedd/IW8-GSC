...
{
    if ( istrue( self.manualturret_watchturretusetimeout ) )
        return;

    self.manualturret_watchturretusetimeout = 1;
...
dropoff_sound_playerwm_handler()
{
    if ( istrue( self.spawn_vehicles ) )
        return;

    self.spawn_vehicles = 1;
...
watchcrateimpact( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_9 ) && var_9 scripts\cp_mp\killstreaks\helper_drone::playanim_aioperateturret() )
        ...
        if ( gettime() - var_1 >= 200 )
        {
            ...
            start_silo_elevator( var_6, var_7, var_8, var_11 );
        }
    }
}

start_silo_elevator( var_0, var_1, var_2, var_3 )
{
