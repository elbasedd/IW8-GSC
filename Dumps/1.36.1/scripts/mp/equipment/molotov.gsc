...
molotov_init()
{
    var_0 = spawnstruct();
    level.molotov = var_0;
    var_0.repair_grill_fixing_short_sfx = getdvarint( "scr_molotovMaxPools", 100 );
    var_0.removematchingents_bymodel = getdvarint( "scr_molotovMaxCastsPerFrame", 8 );
    var_0.mpweapon = getdvarint( "scr_molotovInstantCleanup", 1 ) > 0;
    var_0._id_1251F = 0;
    var_0.train_array = [];
    var_0.scriptables = [];
    var_0.triggers = [];
...
molotov_used( var_0 )
{
    ...
    if ( isdefined( level.init_silo_jump_obj ) )
        [[ level.init_silo_jump_obj ]]( var_0, self );
...
safedestroy( var_0 )
{
    ...
    if ( var_1.scriptables.size > var_1.repair_grill_fixing_short_sfx )
        runkilltriger();
}
...
safedivide( var_0 )
{
    ...
    if ( var_1.triggers.size > var_1.repair_grill_fixing_short_sfx )
        runleadmarkers();
}
...
runpain()
{
    ...
    if ( !isdefined( var_1 ) )
        var_0.train_array = scripts\engine\utility::array_remove( var_0.train_array, self.id );
...
runkilltriger( var_0 )
{
    ...
    foreach ( var_3 in var_1.train_array )
    {
    ...
    var_0 = istrue( var_0 ) || var_1.mpweapon;

    if ( !isdefined( var_2 ) )
        runlogicbasedoncircuitbreaker( var_3, var_0 );
}
...
runlogicbasedoncircuitbreaker( var_0, var_1 )
{
    var_2 = runspawnmodule_isolated();
    ...
    if ( isdefined( var_3 ) )
    {
        if ( !istrue( var_1 ) )
        {
            ...
            var_2.train_array = scripts\engine\utility::array_remove( var_2.train_array, var_0 );
            var_3 thread molotov_pool_end();
            return;
        }

        var_3 thread runpain();
    }

    var_4 = var_2.triggers[var_0];

    if ( isdefined( var_4 ) )
        var_4 thread runplunderextractsitetimer();
}

runextractreroll( var_0 )
{
    ...
    if ( var_1.caststhisframe >= var_1.removematchingents_bymodel )
        return 0;
...
safefromnuke()
{
    ...
    if ( !isdefined( var_0.setuphelitimer ) )
        var_0.setuphelitimer = [];
    ...
    foreach ( var_2 in self.branches )
    {
        ...
        {
            if ( isdefined( var_4 ) )
                var_0.setuphelitimer[var_0.setuphelitimer.size] = var_4;
        }
    }
}
...
molotov_start_branch()
{
    ...
    else
    {
        ...
        for (;;)
        {
            ...
            if ( !runextractreroll( self.shareddata ) )
            {
                waitframe();
                continue;
            }
...
{
    safecheckweapon( self.shareddata );
    self.casts++;
...
molotov_create_pool( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_11 thread safehouse_hotjoin_func();
    return var_11;
}
...
molotov_branch_create_pool( var_0, var_1, var_2 )
{
    ...
    var_7.id = safe_to_authenticate();
    var_7 safedestroy( self.shareddata );
    return var_7;
}
...
molotov_pool_start()
{
    ...
    if ( isdefined( self ) )
        ...
        level thread safecheckstring( var_1, var_0 );
}
...
molotov_pool_end( var_0 )
{
    ...
    if ( isdefined( self.trigger ) )
        self.trigger thread runplunderextractsitetimer();
...
safecheckstring( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
        var_0 thread runplunderextractsitetimer();
    ...
    if ( !isdefined( var_0 ) )
        var_2.train_array = scripts\engine\utility::array_remove( var_2.train_array, var_1 );
}
...
molotov_watch_pool_trigger_enter()
{
    ...
    for (;;)
    {
        ...
        if ( !isplayer( var_0 ) && !istrue( var_0.audio_play_littlebird_sfx ) )
            continue;
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_12914( 7, "disconnect", "joined_team" );
    var_0 delete();
}

runspawnmodule_isolated()
{
...
safe_to_authenticate()
{
    var_0 = runspawnmodule_isolated();
    var_1 = var_0._id_1251F;
    var_0._id_1251F++;
    var_0.train_array = scripts\engine\utility::array_add( var_0.train_array, var_1 );
    return var_1;
}

molotov_get_cast_data( var_0 )
{
    var_1 = runpubliceventoftype();
    var_2 = spawnstruct();
...
molotov_end_fx()
{
    ...
    if ( istrue( self.timer_active ) )
    {
        self setscriptablepartstate( "equipMtovFXWorld", "neutral", 0 );
        self setscriptablepartstate( "equipMtovFXView", "neutral", 0 );
    }

    self.timer_active = undefined;
}
...
rungwperif_largeexplosions( var_0, var_1 )
{
    if ( isdefined( var_0.shareddata ) )
    {
        if ( isdefined( var_0.shareddata.branches ) )
        {
            foreach ( var_3 in var_0.shareddata.branches )
                rungwperif_flak( var_3, var_1 );
        }

        if ( isdefined( var_0.shareddata.setuphelitimer ) )
        {
            foreach ( var_6 in var_0.shareddata.setuphelitimer )
            {
                if ( isdefined( var_6 ) )
