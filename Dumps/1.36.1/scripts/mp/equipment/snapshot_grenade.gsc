...
snapshot_grenade_watch_flight( var_0 )
{
    ...
    if ( istrue( var_1._id_122A5 ) )
        var_1 thread handle_no_ammo_mun();
    ...
    if ( var_8 > 0 )
    {
        ...
        if ( isdefined( var_1.postupdategameevents ) )
        {
            var_5 = scripts\mp\trials\mp_trl_gunslinger_knife_create_script::piccadilly_spawnpatchtriggers( var_1.postupdategameevents );

            if ( var_5 )
                var_4 linkto( var_1.postupdategameevents );
        }
        ...
        var_1 childthread scripts\mp\utility\equipment::_id_1298D();
        var_1 scripts\engine\utility::_id_12913( var_11, "collision_with_platform" );
    }
    else
    {
        var_4.angles = var_9;
...
snapshot_grenade_detect()
{
    ...
    var_6 = anchoredwidgetid( var_1, 540 );
...
anchoredwidgetid( var_0, var_1 )
{
    var_2 = angle_molotov_mortar( var_0, var_1 );
    var_3 = [];
    var_4 = var_1 * var_1;
...
angle_molotov_mortar( var_0, var_1 )
{
