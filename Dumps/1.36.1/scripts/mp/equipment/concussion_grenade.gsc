...
shooting_targets( var_0, var_1 )
{
    ...
    foreach ( var_3 in level.mines )
    {
        ...
        if ( distancesquared( var_1, var_3.origin ) < 262144 )
            var_3 thread scripts\mp\equipment\claymore::deletetmtylheadicon( var_0 );
    }
}
...
applyconcussion( var_0, var_1 )
{
    ...
    var_1 scripts\cp\agents\gametype_cp_specops::show_plunderboxes( "equip_concussion" );
