...
ammobox_init()
{
    ...
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::barkov_shooting_path_nostab );
    ...
    {
        ballistsglobalsettings( "weapon_sniper", var_0 );
        ballistsglobalsettings( "weapon_sniper", var_0 );
        ballistsglobalsettings( "weapon_sniper", var_0 );
        ballistsglobalsettings( "weapon_sniper", var_0 );
        ballistsglobalsettings( "weapon_sniper", var_0 );
    ...
    {
        ballistsglobalsettings( "weapon_assault", var_0 );
        ballistsglobalsettings( "weapon_assault", var_0 );
        ballistsglobalsettings( "weapon_smg", var_0 );
        ballistsglobalsettings( "weapon_smg", var_0 );
        ballistsglobalsettings( "weapon_lmg", var_0 );
        ballistsglobalsettings( "weapon_lmg", var_0 );
        ballistsglobalsettings( "weapon_sniper", var_0 );
        ballistsglobalsettings( "weapon_dmr", var_0 );
        ballistsglobalsettings( "weapon_shotgun", var_0 );
        ballistsglobalsettings( "weapon_pistol", var_0 );
...
ballon_deposit_nag_stopper( var_0, var_1 )
{
...
ballistsglobalsettings( var_0, var_1 )
{
    var_2 = scripts\mp\utility\weapon::laststandweapon( var_0 );
    ballon_deposit_nag_stopper( var_2, var_1 );
}

barkov_shooting_path_nostab( var_0 )
{
    foreach ( var_2 in level.attached_bag )
    {
        if ( isdefined( var_2 ) )
            var_2 scripts\mp\equipment\support_box::_id_120C0( var_0 );
    }
}
...
ammobox_settled( var_0 )
{
    ...
    level.attached_bag[var_0 getentitynumber()] = var_0;
...
ammobox_delete( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_weapon_drop", self.usedcount, var_0, var_2 );
...
ammobox_internalpreloadweapons( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_3 = [ var_2 ];
        balloon_deposit_monitor( var_1 );
        var_4 = baloon_deposit_death_check( var_1 );
    ...
    foreach ( var_1 in self.playersused )
    {
        if ( isdefined( var_1 ) )
        {
            ...
            if ( !scripts\mp\utility\player::isreallyalive( var_1 ) && isdefined( self.playersused[var_2] ) )
            {
                ...
                scripts\mp\equipment\support_box::_id_120C0( var_1 );
            }
        }
    }
}
...
bankplunderextractinstantly( var_0 )
{
    ...
    if ( isdefined( level.showintelscriptablestoplayer ) )
        var_0 [[ level.showintelscriptablestoplayer ]]( var_2 );
...
{
    if ( !isdefined( var_0.clear_trap_flag ) )
    {
        var_1 = spawnstruct();
        var_1.buffered = undefined;
        var_1.last = undefined;
        var_1.bootcampmodewatcher = undefined;
        var_1.bot1 = undefined;
        var_1.boss_wave = undefined;
        var_0.clear_trap_flag = var_1;
    }

    return var_0.clear_trap_flag;
}
...
balloons( var_0 )
{
    ...
    if ( !isdefined( var_1.bootcampmodewatcher ) )
    {
        ...
        if ( !balloon_deposit_cash_vo_explanation( var_2 ) )
            return undefined;

        if ( !balloon_deposit_cash_nags( var_2 ) )
            return undefined;
        ...
        var_1.bootcampmodewatcher = var_3;
    }

    return var_1.bootcampmodewatcher;
}

baloon_deposit_death_check( var_0 )
{
    balloon_deposit( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.bot1;
}

ballowexecutions( var_0 )
{
    balloon_deposit( var_0 );
    var_1 = ammobox_getbufferedplayerdata( var_0 );
    return var_1.boss_wave;
}
...
balloon_deposit( var_0 )
{
    ...
    if ( !isdefined( var_1.bot1 ) )
    {
        var_2 = balloons( var_0 );
...
ammobox_onplayeruse( var_0 )
{
    ...
    if ( !balloon_deposit_cash_vo_explanation( var_1 ) )
    {
    ...
    if ( !balloon_deposit_cash_nags( var_1 ) )
    {
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    var_2 = var_0 bankingoverlimitwillendot( var_1 );
...
balloon_deposit_cash_nags( var_0 )
{
    ...
    {
        if ( !scripts\mp\utility\weapon::borntime( var_0, var_5 ) )
            continue;
...
bankingoverlimitwillendot( var_0 )
{
    ...
    var_1 = balloons( self );
    var_2 = baloon_deposit_death_check( self );

    if ( isdefined( var_2 ) )
    {
        balloon_hint_logic( self );
        var_3 = undefined;
        var_4 = undefined;
...
barelem( var_0 )
{
    ...
    if ( istrue( self._id_12A9B ) )
    {
        self._id_12A9B = undefined;
        var_1 = var_1 * -1;
    }
    else
        self._id_12A9B = 1;
    ...
    scripts\engine\utility::_id_12913( 1, "death" );
...
ammobox_addheadicon()
{
    self.matchdata_logplayerlife = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], "hud_icon_fieldupgrade_weapon_drop", 20, 1, 1000, 100, undefined, 1 );
    self.matchdata_logscoreevent = scripts\cp_mp\entityheadicons::setheadicon_factionimage( 0, 20, undefined, undefined, undefined, undefined, 1 );
    scripts\mp\equipment\support_box::_id_120C1();
}

ammobox_removeheadicon()
{
    if ( isdefined( self.matchdata_logplayerlife ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.matchdata_logplayerlife );
        self.matchdata_logplayerlife = undefined;
    }

    if ( isdefined( self.matchdata_logscoreevent ) )
    {
        scripts\cp_mp\entityheadicons::setheadicon_deleteicon( self.matchdata_logscoreevent );
        self.matchdata_logscoreevent = undefined;
    }
}
...
{
    thread barkov_crawl_scene_nostab( var_0, var_1 );
}

barkov_crawl_scene_nostab( var_0, var_1 )
{
    if ( istrue( var_1.playerexitsafearea ) )
        return;

    var_1.playerexitsafearea = 1;
    barkov_execution_path( var_0, var_1 );

    if ( isdefined( var_1 ) )
        var_1.playerexitsafearea = undefined;
}
...
barkov_execution_path( var_0, var_1 )
{
    ...
    if ( var_3 )
        var_4 = var_0 bankplunderextractinstantly( var_1 );
    else
    ...
    if ( var_4 )
    {
        if ( isdefined( var_0.owner ) )
        {
            ...
            var_0.owner scripts\mp\supers::dmg_trig( "super_weapon_drop" );
        }

        var_0.usedcount++;
        var_0.playersused[var_1 getentitynumber()] = var_1;
        var_0 scripts\mp\equipment\support_box::_id_120C0( var_1 );
