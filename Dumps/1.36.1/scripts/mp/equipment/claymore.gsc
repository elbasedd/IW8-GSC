...
claymore_use( var_0 )
{
    ...
    if ( stop_visited_once() )
    {
        var_1.plantoffsetz = var_1.plantoffsetz + 2;
        var_1.contents = enable_oob_immunity_on_riders();
    }
...
claymore_modifieddamage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 == makeweapon( "claymore_mp" ) )
    {
        ...
        {
            foreach ( var_6 in self.deletex1finhud )
            {
    ...
    else if ( var_1 == makeweapon( "claymore_radial_mp" ) )
    {
        ...
        thread deletescriptableinstanceaftertime_proc( var_2 );
    }
    else
        return var_4;
    ...
    if ( isdefined( var_2.gasmaskmaxhealth ) )
    {
        var_14 = isdefined( var_2.owner ) && var_2.gasmaskmaxhealth == var_2.owner;
        var_15 = var_2.gasmaskmaxhealth == var_0;
...
deletescriptableinstanceaftertime_proc( var_0 )
{
    ...
    self.deletex1finhud[self.deletex1finhud.size] = var_0;
    waittillframeend;
    self.deletex1finhud = undefined;
}
