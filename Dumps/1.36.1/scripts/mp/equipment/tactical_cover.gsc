...
tac_cover_init()
{
    ...
    level._id_12108 = getentarray( "dcover_blocker", "targetname" );
    level._id_12107 = getdvarfloat( "scr_tacCover_timeoutOverride", 150.0 );
}
...
tac_cover_on_fired( var_0, var_1, var_2, var_3 )
{
    ...
    var_8 = scripts\mp\trials\mp_trl_gunslinger::woods_one_death_func( var_7, 140, 20 );
    var_9 = undefined;
    var_10 = 0;
    ...
    if ( scripts\cp_mp\auto_ascender::player_is_trying_self_revive( var_7 ) )
        return 0;

    if ( scripts\asm\soldier\cp::player_isusingtacmap( var_7 ) )
        return 0;

    var_4 = scripts\engine\trace::eliminate_drone();
    ...
    foreach ( var_14 in var_12 )
    {
        ...
        if ( var_14["surfaceflags"] & 8 )
            return 0;
    }

    foreach ( var_17 in var_8 )
    {
        var_18 = distancesquared( var_17.origin, var_7 );

        if ( isdefined( var_9 ) && var_10 <= var_18 )
            continue;
    ...
    if ( isdefined( var_9 ) )
    {
        var_20 = var_9 scriptabledoorangle();
        var_21 = abs( var_20 ) > 65;
        var_22 = undefined;

        foreach ( var_24 in var_8 )
        {
            if ( var_9 scripts\mp\trials\mp_trl_gunslinger::woods_three_death_func( var_24 ) )
            {
                var_22 = var_24;
                break;
            }
        ...
        if ( isdefined( var_22 ) )
        {
            var_27 = var_22 scriptabledoorangle();
            var_26 = abs( var_27 ) > 65;
        }

        if ( var_10 < 1600 && var_21 && var_26 )
        {
            var_28 = _id_120FE( var_9 );

            if ( isdefined( var_22 ) )
                var_28 = var_28 | _id_120FE( var_22 );
            ...
            var_29 = self gettagorigin( "j_spinelower" );
            var_30 = var_9.disablebunker11cachelocations + ( 0, 0, 24 );
            var_31 = physics_raycast( var_29, var_30, var_4, var_5, 0, "physicsquery_any", 1 );

            if ( isdefined( var_31 ) && var_31 > 0 )
            {
                tac_cover_fire_failed( 1 );
                return 0;
            }

            var_9.play_collected_key_vo = 1;
            self.taccoverrefund = undefined;
            thread _id_12100( var_9, var_22, var_3, var_4 );
    ...
    var_32 = self getplayerangles() * ( 0, 1, 0 );
    var_33 = self.origin + ( 0, 0, 24 );
    var_34 = anglestoforward( var_32 );
    var_35 = 29.5;
    var_36 = var_33 + var_34 * var_35;
    var_31 = physics_raycast( var_33, var_36, var_4, var_5, 0, "physicsquery_closest", 1 );

    if ( isdefined( var_31 ) && var_31.size > 0 )
    {
    ...
    var_38 = undefined;
    var_33 = var_36;
    var_34 = anglestoright( var_32 );
    var_35 = 55.5;
    var_39 = var_33 + var_34 * var_35;
    var_31 = physics_spherecast( var_33, var_39, 2.5, var_4, var_5, "physicsquery_closest" );

    if ( isdefined( var_31 ) && var_31.size > 0 )
    {
        var_40 = var_31[0]["shape_position"];
        var_37 = var_31[0]["fraction"];
    }
    else
        var_37 = 1;

    var_33 = var_36;
    var_34 = -1 * anglestoright( var_32 );
    var_35 = 55.5;
    var_39 = var_33 + var_34 * var_35;
    var_31 = physics_spherecast( var_33, var_39, 2.5, var_4, var_5, "physicsquery_closest" );
    ...
    if ( var_38 + var_37 < 1 )
    {
        ...
        var_36 = var_36 + var_34 * var_35 * ( 0.5 - var_37 );
    else if ( var_38 < 0.5 )
        var_36 = var_36 + var_34 * var_35 * ( 0.5 - var_38 ) * -1;
    ...
    var_35 = 60;
    var_39 = var_33 + var_34 * var_35;
    var_42 = combineangles( var_41, ( 0, 0, 90 ) );
    var_31 = physics_capsulecast( var_33, var_39, 2.5, 16.8, var_42, var_4, var_5, "physicsquery_closest" );
    ...
    var_43 = var_31[0]["entity"];

    if ( isdefined( var_43 ) && !_id_120FB( var_43 ) )
    {
        tac_cover_fire_failed();
        return 0;
    }

    var_44 = var_31[0]["shape_position"];
    var_40 = var_31[0]["position"];
    var_45 = var_44 - ( 0, 0, 2.5 );
    var_46 = _id_120FC( var_43 );
    var_47 = 25.025;
    var_48 = pow( var_47 * 0.14, 2 );
    var_49 = var_44;
    var_50 = distance2dsquared( var_49, var_40 );
    var_51 = var_44 + anglestoright( var_32 ) * 14.3 * 1.75;
    var_52 = distance2dsquared( var_51, var_40 );
    var_53 = var_44 + anglestoright( var_32 ) * 14.3 * 1.75 * -1;
    var_54 = distance2dsquared( var_53, var_40 );
    var_55 = [];
    var_56 = 0;

    if ( var_52 <= var_48 && var_52 < var_50 && var_52 < var_54 )
    {
        var_56++;
        var_55 = [ var_49, var_53 ];
    }
    else if ( var_54 <= var_48 && var_54 < var_50 && var_54 < var_52 )
    {
        var_56++;
        var_55 = [ var_49, var_51 ];
    }
    else if ( var_50 <= var_48 )
    {
        var_56++;
        var_55 = [ var_53, var_51 ];
    }
    else
        var_55 = [ var_49, var_53, var_51 ];

    var_34 = ( 0, 0, -1 );
    var_35 = 8.5;

    foreach ( var_33 in var_55 )
    {
        var_39 = var_33 + var_34 * var_35;
        var_31 = physics_raycast( var_33, var_39, var_4, var_5, 0, "physicsquery_closest", 1 );
    ...
    self.taccoverrefund = undefined;
    thread tac_cover_spawn( var_45, var_41, var_46, var_3, var_4 );
    scripts\mp\utility\stats::incpersstat( "deployableCoverUsed", 1 );
    return 1;
}
...
_id_120FC( var_0 )
{
    if ( isdefined( var_0 ) )
    {
        if ( scripts\mp\trials\mp_trl_gunslinger_knife_create_script::pity_timer_end_time( var_0 ) || scripts\mp\trials\mp_trl_gunslinger_knife_create_script::pit_locations( var_0 ) || scripts\mp\gametypes\br_gondola.gsc::phone_group_spawned( var_0 ) )
            return var_0;
    }
...
tac_cover_adjust_for_player_space( var_0, var_1, var_2 )
{
    ...
    foreach ( var_9 in level._id_12108 )
    {
...
_id_12100( var_0, var_1, var_2, var_3 )
{
    self endon( "death_or_disconnect" );
    self endon( "tac_cover_taken" );
    level endon( "game_ended" );
    var_4 = anglestoforward( self.angles );
    var_5 = var_0.disablearmorykiosk + ( 0, 90, 0 );
    var_6 = anglestoforward( var_5 );
    var_7 = vectordot( var_4, var_6 );
    var_8 = var_7 > 0;
    var_9 = var_0 scriptabledoorangle();
    var_0 scripts\mp\trials\mp_trl_gunslinger::getarenapickupattachmentoverrides( 1, "tac_cover_door" );

    if ( isdefined( var_1 ) )
        var_1 scripts\mp\trials\mp_trl_gunslinger::getarenapickupattachmentoverrides( 1, "tac_cover_door" );

    var_10 = scripts\engine\utility::ter_op( var_8, ( 0, 90, 0 ), ( 0, -90, 0 ) );
    var_11 = ( 0, 0, -1 );
    var_12 = var_0.disablebunker11cachelocations + var_11;
    var_13 = combineangles( var_0.disablearmorykiosk, var_10 );
    var_14 = undefined;
...
tac_cover_spawn( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_8.deathoverridecallback = ::_id_120FF;
    ...
    if ( isdefined( var_5 ) )
    {
        if ( isdefined( var_5.brmini_createc130pathstruct ) )
            var_5.brmini_createc130pathstruct tac_cover_destroy();

        var_7.brlootchoppercratedestroycallback = var_5;
        var_5.brmini_createc130pathstruct = var_7;
    }

    if ( isdefined( var_6 ) )
    {
        var_7.brmayconsiderplayerdead = var_6;
        var_6.brmini_createc130pathstruct = var_7;
    }
...
tac_cover_spawn_internal( var_0 )
{
    ...
    if ( isdefined( var_0.brlootchoppercratedestroycallback ) )
...
tac_cover_destroy( var_0, var_1, var_2 )
{
    ...
    self.owner scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_tac_cover", int( var_4 ), var_0, var_2 );
...
{
    if ( isdefined( self.brlootchoppercratedestroycallback ) )
    {
        self.brlootchoppercratedestroycallback scripts\mp\trials\mp_trl_gunslinger::getarenapickupattachmentoverrides( 0, "tac_cover_door" );
        self.brlootchoppercratedestroycallback.brmini_createc130pathstruct = undefined;
    }

    if ( isdefined( self.brmayconsiderplayerdead ) )
    {
        self.brmayconsiderplayerdead scripts\mp\trials\mp_trl_gunslinger::getarenapickupattachmentoverrides( 0, "tac_cover_door" );
        self.brmayconsiderplayerdead.brmini_createc130pathstruct = undefined;
    }
...
{
    var_1 = _id_120F8( var_0 );

    if ( isdefined( self.owner ) )
    {
        var_2 = max( self.maxhealth - self.damagetaken, 0 );
        var_3 = int( min( var_2, var_1 ) );
        self.owner scripts\mp\supers::dmg_trig( "super_tac_cover", var_3 );
    }
...
_id_120F8( var_0 )
{
    ...
    if ( scripts\mp\damage::player_weapon_fired_monitor( var_0.objweapon ) )
        return 0;
