...
gas_watchtriggerenter()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( var_0.initbunkeranims ) )
            continue;
...
gas_applycough( var_0, var_1 )
{
    ...
    if ( istrue( self.initbunkeranims ) )
        return;
...
gas_begincoughing( var_0 )
{
    ...
    scripts\engine\utility::_id_12900( "gas_coughWeaponFired", "gas_coughWeaponTaken", "gas_coughDuration" );
...
init_trigger_spawn( var_0, var_1 )
{
