...
supportbox_init()
{
    level.autoassignquest = [];
    scripts\common\interactive::interactive_addusedcallback( ::supportbox_usedcallback, "equip_supportBox" );
    scripts\common\interactive::interactive_addusedcallback( ::bischildthread, "equip_armorBox" );
    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::_id_120C2 );
...
_id_120C2( var_0 )
{
    foreach ( var_2 in level.autoassignquest )
    {
        if ( isdefined( var_2 ) )
            var_2 _id_120C0( var_0 );
    }
}

can_man_turret( var_0, var_1, var_2, var_3 )
{
    var_0 endon( "death" );
    var_0 thread supportbox_watchdisownedtimeout();
    var_0 thread supportbox_hideandshowaftertime();
    var_0 thread _id_120C3( self );
    ...
    level.autoassignquest[var_0 getentitynumber()] = var_0;
...
_id_120C3( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_12913( 2, "touching_platform" );

    if ( var_1 == "timeout" )
        return;

    var_2 = undefined;
    var_3 = vehicle_getarrayinradius( self.origin, 500, 500 );
...
{
    var_0 endon( "death" );
    var_0._id_12245 = "vfx/iw8_mp/equipment/vfx_offhand_wm_supportbox_timeout.vfx";
    can_man_turret( var_0, "equip_supportBox", "super_ammo_drop", "hud_icon_equipment_support_box" );
...
{
    var_0 endon( "death" );
    var_0._id_12245 = "vfx/iw8_mp/equipment/vfx_offhand_wm_armorbox_timeout.vfx";
    can_man_turret( var_0, "equip_armorBox", "super_armor_drop", "ui_mp_br_loot_icon_health_armor_box" );
...
supportbox_destroy( var_0 )
{
    ...
    if ( isdefined( self._id_12245 ) )
        var_1 = self._id_12245;
...
supportbox_delete( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( self.equipmentref ) && self.equipmentref == "equip_armorBox" )
        self.owner scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_armor_drop", self.usedcount, var_0, var_2 );
    else
        self.owner scripts\cp\agents\gametype_cp_specops::short_term_goal( "super_ammo_drop", self.usedcount, var_0, var_2 );
...
{
    self.matchdata_logplayerlife = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], var_0, 20, 1, 1000, 100, undefined, 1 );
...
supportbox_givexpforuse( var_0 )
{
    if ( isdefined( self.owner ) && !scripts\cp_mp\utility\player_utility::playersareenemies( self.owner, var_0 ) )
    {
        if ( self.owner != var_0 )
        {
            ...
            self.owner scripts\cp\agents\gametype_cp_specops::vehicle_tracker( "t9_ch_global_resupply_teammates_for_operator_mission", 1 );
        }

        self.owner scripts\mp\utility\stats::incpersstat( "munitionsBoxUsed", 1 );
        self.owner scripts\mp\supers::dmg_trig( "super_ammo_drop" );
        self.usedcount++;
    }
}
...
supportbox_handlemovingplatforms( var_0 )
{
    ...
    if ( isdefined( var_0 ) && scripts\mp\equipment\claymore::pity_timer_end_time( var_0 ) )
    {
        var_1.specialistbr = 1;
        self _meth_87B9( 1 );
    }
...
_id_120C0( var_0 )
{
    ...
    var_1 = self.matchdata_logplayerlife;

    if ( !isdefined( var_1 ) )
        return;

    var_2 = self.matchdata_logscoreevent;
    ...
    if ( var_3 && !var_4 )
    {
        scripts\cp_mp\entityheadicons::_id_11A8D( var_1, var_0 );
        scripts\cp_mp\entityheadicons::_id_11A8E( var_2, var_0 );
    }
    else if ( var_3 )
    {
        scripts\cp_mp\entityheadicons::_id_11A8E( var_1, var_0 );
        scripts\cp_mp\entityheadicons::_id_11A8D( var_2, var_0 );
    }
    else
    {
        scripts\cp_mp\entityheadicons::_id_11A8E( var_1, var_0 );
...
supportbox_usedcallback( var_0, var_1 )
{
    ...
    {
        if ( isdefined( level.show_regroup_text ) )
            var_2 = var_0 [[ level.show_regroup_text ]]( var_1 );
        else
        ...
        if ( var_2 )
        {
            ...
            var_0 _id_120C0( var_1 );
            var_0 supportbox_givexpforuse( var_1 );
        }
    }
}

bischildthread( var_0, var_1 )
{
    ...
    if ( var_0 supportbox_playercanuse( var_1 ) )
    {
        if ( isdefined( level.setupspecialdaypickupweapons ) )
            var_2 = var_0 [[ level.setupspecialdaypickupweapons ]]( var_1 );
        else
            var_2 = 0;
