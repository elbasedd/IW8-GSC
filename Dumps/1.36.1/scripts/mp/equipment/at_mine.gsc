...
at_mine_use( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isent( var_3 ) && pity_timer_end_time( var_3 ) )
        {
...
at_mine_plant( var_0 )
{
    ...
    if ( istrue( var_0._id_122A5 ) )
        var_0 thread bombradialfill();
...
bombradialfill()
{
    ...
    self endon( "death" );
    self.bonuskillstreakcharge = ( 0, 0, 0 );
    var_0 = 0.2;
    ...
    for (;;)
    {
        var_1 = self.origin;
        wait( var_0 );
        self.bonuskillstreakcharge = 1 / var_0 * ( self.origin - var_1 );
    }
}

perkpackage_checkifready_callback( var_0 )
{
    return isdefined( var_0 ) && isdefined( var_0.bonuskillstreakcharge ) && length2dsquared( var_0.bonuskillstreakcharge ) > 0.01;
}
...
{
    self endon( "death" );
    self.grenade scripts\engine\utility::_id_12914( var_0, "death", "mine_destroyed" );
...
at_mine_watch_flight()
{
    ...
    if ( var_0 > 0 )
    {
        ...
        if ( perkpackage_checkifready_callback( self ) )
            var_2 = var_2 + self.bonuskillstreakcharge * var_0;
        ...
        if ( var_0 > 0 )
        {
            ...
            childthread scripts\mp\utility\equipment::_id_1298D();
            scripts\engine\utility::_id_12913( var_0, "collision_with_platform" );
...
at_mine_watch_game_end()
{
    self endon( "mine_destroyed" );
    self endon( "death" );
    level scripts\engine\utility::_id_128FF( "game_ended", "bro_shot_start" );
    thread at_mine_destroy();
}
