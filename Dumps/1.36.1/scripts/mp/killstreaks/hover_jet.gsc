...
addteabagcharge( var_0 )
{
    ...
    scripts\common\utility::_id_12456( level.remove_old_wheelsons, "hover_jet", self.origin );
...
starthoverjetairstrikepass( var_0, var_1, var_2 )
{
    ...
    var_19 thread monitorexitbutton();
...
hoverjet_getbestgroundtarget()
{
    ...
    {
        if ( !scripts\cp_mp\killstreaks\chopper_support::delete_ent( var_5.player ) )
            continue;
