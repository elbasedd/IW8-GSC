...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "watchForPlayerEnteringLastStand", ::relic_nuketimer_waitforobjectives );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "handleMovingPlatform", ::relic_nuketimer_waitforcompleteobjectives );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "allowPickupOfTurret", ::relic_nuketimer_timerloop );
}
...
relic_nuketimer_waitforcompleteobjectives( var_0 )
{
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_1.quest_assdistmax = var_0.select_boss_two_spawners;
        var_1.angleoffset = var_0.select_boss_one_spawners;
        var_1.endonstring = "carried";
        var_1.deathoverridecallback = ::relic_squadlink_modifyplayerdamage;
...
relic_nuketimer_waitforobjectives()
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::relic_punchbullets_track_previous_bullet_weapon( "last_stand_start" );
...
relic_nuketimer_timerloop()
{
    ...
    if ( scripts\cp_mp\utility\killstreak_utility::playcrateimpactfx( self getcurrentweapon() ) )
        return 0;
