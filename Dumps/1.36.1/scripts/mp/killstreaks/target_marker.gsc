...
gettargetmarker( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            if ( isdefined( var_3 ) && var_3.string == "equip_deploy_succeeded" )
            {
                ...
                else if ( scripts\mp\trials\mp_trl_gunslinger_knife_create_script::player_gun_game_randomize_weapon_list_think() )
                {
    ...
    if ( isdefined( var_3.location ) && isdefined( var_3.angles ) )
    {
        ...
        if ( isdefined( var_8["entity"] ) )
        {
            ...
            var_3.select_boss_two_spawners = ( var_11, var_12, var_13 );
            var_3.select_boss_one_spawners = combineangles( invertangles( var_9.angles ), var_3.angles );
        }
