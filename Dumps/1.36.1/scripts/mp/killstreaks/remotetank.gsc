...
starttankdropoff( var_0 )
{
    ...
    scripts\common\utility::_id_12456( level.remove_old_wheelsons, "pac_sentry", self.origin );
...
createtank( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_11.objweapon = makeweapon( var_6.mgturretinfo );
    ...
    var_11 thread _id_12154();
    var_11 thread _id_12155();
...
_id_12155()
{
    ...
    for (;;)
    {
        scripts\cp_mp\vehicles\vehicle::_id_126AF( self );
        waitframe();
    }
}
...
tank_destroy( var_0, var_1 )
{
    ...
    self.streakinfo.healdamage = istrue( var_1 );
...
tank_driverexit( var_0 )
{
    ...
    if ( var_0 scripts\cp_mp\utility\player_utility::_isalive() )
    {
        ...
        level thread scripts\cp_mp\utility\killstreak_utility::vo_manifest_scanned( var_0 );
    }
}
