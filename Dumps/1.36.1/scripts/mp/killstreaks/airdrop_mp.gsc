...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "airdrop", "applyImmediateJuggernaut", ::armsrace_c4_planter_backlot );
}
...
airdrop_awardkillstreak( var_0, var_1, var_2 )
{
    ...
    else
    {
        ...
        var_4 = var_2.streakinfo.mpstreaksysteminfo._id_12052;
...
armsrace_c4_planter_backlot( var_0 )
{
    var_1 = "juggernaut";
    ...
    var_2._id_12052 = self.matchdatalifeindex;
    var_2.owner = self;
    var_2.snowballfighthint = self getxuid();
    var_2.airdrop_crushchicken = scripts\mp\matchdata::gettimefrommatchstart( gettime() );
    scripts\mp\analyticslog::logevent_killstreakactivated( self, var_2.streaklifeid, var_2.streakname, var_2.isgimme, var_2.airdrop_crushchicken, self.origin );
