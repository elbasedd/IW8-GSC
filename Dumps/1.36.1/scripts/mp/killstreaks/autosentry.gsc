...
tryuseautosentry( var_0, var_1 )
{
    ...
    if ( var_2 )
        scripts\common\utility::_id_12456( level.remove_old_wheelsons, level.sentrysettings["sentry_minigun"].streakname, self.origin );
...
tryusesam( var_0, var_1 )
{
    ...
    if ( var_2 )
        scripts\common\utility::_id_12456( level.remove_old_wheelsons, level.sentrysettings["sam_turret"].streakname, self.origin );
...
tryuseshocksentry( var_0 )
{
    ...
    if ( var_1 )
        scripts\common\utility::_id_12456( level.remove_old_wheelsons, var_0.streakname, self.origin );
    else
        waitframe();
...
setcarryingsentry( var_0, var_1, var_2, var_3 )
{
    ...
    for (;;)
    {
        var_4 = scripts\engine\utility::_id_12909( "place_sentry", "cancel_sentry", "force_cancel_placement", "emp_applied" );
...
sentry_oncarrierdeathoremp( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_128FF( "death", "emp_applied" );
...
sentry_oncarrierchangedteam( var_0 )
{
    self endon( "placed" );
    self endon( "death" );
    var_0 scripts\engine\utility::_id_128FF( "joined_team", "joined_spectators" );
    self delete();
}
...
sentryshocktargets()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12913( 1, "turret_on_target" );
...
marktargetlaser( var_0 )
{
    ...
    self laseron();
    self.laser_on = 1;
    scripts\engine\utility::_id_128FF( "done_firing", "carried" );
    self laseroff();
    self.laser_on = 0;
}
