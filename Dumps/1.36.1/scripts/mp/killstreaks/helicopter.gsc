...
starthelicopter( var_0, var_1 )
{
    ...
    scripts\common\utility::_id_12456( level.remove_old_wheelsons, var_3, self.origin );
...
heli_existance()
{
    ...
    scripts\engine\utility::_id_12900( "death", "crashing", "leaving" );
...
fireontarget( var_0 )
{
    ...
    scripts\engine\utility::_id_12913( 4, "facing" );
    ...
    scripts\engine\utility::_id_12913( 3, "near_goal" );
}
...
heli_leave( var_0 )
{
    ...
    if ( isdefined( self.helitype ) && self.helitype == "osprey" && isdefined( self.pathgoal ) )
    {
        ...
        scripts\engine\utility::_id_12913( 5, "goal" );
    }
    ...
    scripts\engine\utility::_id_12913( 12, "goal" );
    self notify( "gone" );
    self notify( "death" );
    waitframe();
