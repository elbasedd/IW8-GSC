...
tryuseremoteuav( var_0, var_1 )
{
    ...
    if ( var_3 )
    {
        scripts\common\utility::_id_12456( level.remove_old_wheelsons, var_1, self.origin );
...
createcarryremoteuav( var_0, var_1 )
{
    ...
    {
        var_4 = scripts\cp_mp\utility\killstreak_utility::kingslayer();
...
setcarryingremoteuav( var_0 )
{
    ...
    for (;;)
    {
        var_1 = rear_door_collision_brush( "place_carryRemoteUAV", "cancel_carryRemoteUAV", "weapon_switch_started", "force_cancel_placement", "death_or_disconnect" );
...
rear_door_collision_brush( var_0, var_1, var_2, var_3, var_4, var_5 )
{
...
carryremoteuav_handleexistence()
{
    ...
    self.owner scripts\engine\utility::_id_12900( "death_or_disconnect", "joined_team", "joined_spectators" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_12907( "death_or_disconnect", "remoteuav_unlock" );
...
{
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_12908( "death_or_disconnect", "carried", "leaving" );
...
remoteuav_watch_distance()
{
    ...
    {
        var_0 = scripts\cp_mp\utility\killstreak_utility::kingslayer();
...
{
    self endon( "death" );
    self.owner scripts\engine\utility::_id_128FF( "joined_team", "joined_spectators" );
    self notify( "death" );
}
