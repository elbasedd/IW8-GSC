...
setupvehiclespawnvolumes()
{
    ...
    foreach ( var_14, var_6 in var_4.databyref )
    {
        ...
        if ( isdefined( level.hit_pilot_head ) )
            var_7 = [[ level.hit_pilot_head ]]( var_7 );
...
emptyallvehicles()
{
    ...
    foreach ( var_5, var_1 in level.vehicle.instances )
    {
        ...
        {
            if ( scripts\cp_mp\vehicles\vehicle_occupancy::_id_1277D( var_3 ) )
...
deleteextantvehicles( var_0 )
{
    ...
    scripts\cp_mp\vehicles\vehicle_spawn::_id_127AB();
    ...
    foreach ( var_7, var_2 in level.vehicle.instances )
    {
        ...
        foreach ( var_5 in var_2 )
        {
            ...
            scripts\cp_mp\vehicles\vehicle_spawn::_id_127B0( var_5 );
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::play_station_closed_vo( "vehicleSpawns" ) )
        return;

    if ( ( var_0 == "little_bird" || var_0 == "little_bird_mg" ) && scripts\mp\gametypes\br_gametypes.gsc::play_station_closed_vo( "littleBirdSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
        scripts\mp\gametypes\br_analytics.gsc::challengetimersenabled( var_6, var_0 );
...
waitforvehiclestodeletethenspawninitial()
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::play_disguise_vo( "spawnInitialVehicles" ) )
        scripts\mp\gametypes\br_gametypes.gsc::watch_for_player_going_belowmap_or_oob( "spawnInitialVehicles" );
    else
        spawninitialvehicles();
}
...
dangercircletick( var_0, var_1 )
{
    ...
    var_6 = cleanupkeybindingsondeath();
...
_id_12458( var_0 )
{
    ...
    {
        if ( player_already_has_overwatch_gunship( var_4 ) )
