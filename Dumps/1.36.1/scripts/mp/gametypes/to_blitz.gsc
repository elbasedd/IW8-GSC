...
rpgcrateenduse( var_0 )
{
    ...
    var_0 scripts\mp\weapons::_id_11A97( makeweapon( "iw8_la_rpapa7_mp" ) );
}
...
watchiconupdater()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_12900( "bradley_driverUpdate", "death", "bradley_vehicleExit" );
...
ontimelimit()
{
    if ( isdefined( level.onphaseend ) )
    {
        var_0 = scripts\mp\gamescore::connect_circlar_path( 0 );
