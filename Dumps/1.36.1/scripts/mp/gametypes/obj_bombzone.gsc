...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_8 thread bunkervaults( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
    ...
    else
    {
        ...
        var_8.useweapon = makeweapon( "briefcase_bomb_defuse_mp" );
    }
...
getbombmodel( var_0 )
{
    if ( istrue( level.lootcontentsadjusteconomy_toptier ) && istrue( var_0 ) )
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( !level.bombdefused )
    {
        ...
        if ( istrue( self.firstpickup ) )
        {
            ...
            if ( istrue( level.lootcontentsadjusteconomy_toptier ) )
            {
                ...
                playfx( level.movequestlocale["vanish_hw_fr"], self.trigger.origin + ( 0, 0, -9970 ) );
            }
        }
        else
            var_3 = "bomb_pickup";
    ...
    scripts\mp\utility\game::rear_spotlight_target_found_dist_sq( var_0, undefined, "Bomb Picked Up", var_0.origin );
