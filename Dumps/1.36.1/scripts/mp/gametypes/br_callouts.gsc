...
init()
{
    level.calloutglobals.seq3_reset_switch = [];
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            level.calloutglobals.seq3_reset_switch[var_11] = var_12;
        }
...
kiosksearchradiusmin( var_0 )
{
    ...
    foreach ( var_4, var_3 in level.calloutglobals.seq3_reset_switch )
    {
...
kiosksearchradiusmax( var_0 )
{
    ...
    foreach ( var_11, var_9 in level.calloutglobals.seq3_reset_switch )
    {
