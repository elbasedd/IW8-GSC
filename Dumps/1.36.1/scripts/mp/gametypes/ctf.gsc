...
createflagsandhud()
{
    ...
    scripts\mp\objidpoolmanager::setup_comms_obj_a_goals_and_cover( level.capzones[game["defenders"]].objidnum, 1 );
    scripts\mp\objidpoolmanager::setup_comms_obj_a_goals_and_cover( level.capzones[game["attackers"]].objidnum, 1 );
}
...
createteamflag( var_0, var_1 )
{
    ...
    var_9 scripts\mp\gameobjects::_id_11AA7( level.iconescort, level.iconkill, level.round_enemies_fallback_logic );
    ...
    var_9 scripts\mp\gameobjects::usingobject( ::hvt_drop_from_truck_to_ground );
    var_9.allowweapons = 1;
    var_9.sixthsenselastvotime = var_8;
    var_9.onpickup = ::onpickup;
    var_9.onpickupfailed = ::onpickup;
    var_9.ondrop = ::ondrop;
    var_9.onreset = ::onreset;
    var_9.play_found_leads_counting_building_two = 1;
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_9 scripts\mp\gameobjects::_id_11AA7( level.iconescort, level.iconkill, level.round_enemies_fallback_logic, var_10 );
    }
    else
    {
        var_9.objidpingfriendly = 1;
...
createcapzone( var_0, var_1 )
{
    ...
    var_6 scripts\mp\gameobjects::_id_11AA7( level.icondefendflag, level.iconcaptureflag, level.round_enemies_fallback_logic );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    if ( var_4 != var_3 )
    {
        ...
        if ( level.codcasterenabled )
            level.capzones[var_0.team] scripts\mp\gameobjects::velstartid();

        thread returnflag();
        var_0 thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "obj_return", var_0.origin );
        ...
        if ( self.sixthsenselastvotime == "allies" )
            setomnvar( "ui_ctf_flag_axis", -2 );
        else
            setomnvar( "ui_ctf_flag_allies", -2 );
    }
    else
    {
        ...
        level.capzones[var_5] scripts\mp\gameobjects::_id_11A9E( level.round_at_max );
...
ondrop( var_0 )
{
    if ( isdefined( var_0.leaving_team ) )
    {
        ...
        self.droppedteam = self.sixthsenselastvotime;
    else
    ...
    if ( level.returntime >= 0 )
        scripts\mp\gameobjects::_id_11AA7( level.iconreturnflag, level.iconcaptureflag, level.round_enemies_fallback_logic );
    else
    {
        scripts\mp\gameobjects::_id_11AA7( level.icondefendflag, level.iconcaptureflag, level.round_enemies_fallback_logic );
    ...
    scripts\mp\utility\dialog::leaderdialog( "enemy_flag_dropped", self.sixthsenselastvotime, "status" );
    scripts\mp\utility\dialog::leaderdialog( "flag_dropped", scripts\mp\utility\game::getotherteam( self.sixthsenselastvotime )[0], "status" );
...
onreset()
{
    ...
    level.capzones[var_1] scripts\mp\gameobjects::_id_11AA7( level.icondefendflag, level.iconcaptureflag, level.round_enemies_fallback_logic );
...
onuse( var_0 )
{
    if ( !level.gameended )
    {
        ...
        var_0 thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "capture", var_0.origin );
        ...
        if ( level.codcasterenabled )
            level.capzones[var_2] scripts\mp\gameobjects::velstartid();
...
superabilitywatcher()
{
    ...
    for (;;)
    {
        ...
        {
            case "super_rewind":
                scripts\engine\utility::_id_128FF( "teleport_success", "rewind_success" );
...
placeflag()
{
    ...
    for (;;)
    {
        if ( getdvar( "scr_devPlaceDomFlag", "" ) != "" )
        {
            ...
            var_12 scripts\mp\gameobjects::_id_11AA7( level.icondefendflag, level.iconcaptureflag, level.round_enemies_fallback_logic );
