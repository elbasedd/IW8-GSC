...
main()
{
    ...
    level.create_weapon_pick_up = ::create_weapon_pick_up;
...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::rear_minigun_warning_time( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
getnextzone()
{
    ...
    else if ( isdefined( level.vehicle_damage_updatestate_br ) )
    {
        level.prevzoneindex++;
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::rear_minigun_warning_time( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
awardcapturepoints()
{
    ...
    while ( !level.gameended )
    {
        ...
        if ( !level.usehprules )
        {
            ...
            if ( !istrue( level.weapon_xp_iw8_sn_sbeta ) )
                ammo_manager( var_3 );
