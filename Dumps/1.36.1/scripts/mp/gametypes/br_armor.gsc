...
main()
{
    level.should_display_reinforcement_called_icon = ::should_display_reinforcement_called_icon;
}

onkillstreakavailable()
{
    ...
    if ( isplayer( self ) )
    {
        ...
        scripts\mp\equipment\armor_plate::cancelupcomingpublicevents( 0 );
    }
}
...
popoffhelmet( var_0, var_1, var_2 )
{
    ...
    for ( var_12 = 0; var_12 < var_9; var_12++ )
    {
        ...
        {
            var_14 = scripts\mp\gametypes\br_pickups.gsc::killstreak_additional_targets( var_4.origin, var_4.angles );
            var_4 delete();
...
should_display_reinforcement_called_icon( var_0, var_1 )
{
    if ( isdefined( var_0 ) )
