...
ball_on_pickup( var_0, var_1 )
{
    ...
    if ( var_4 )
    {
        ...
        else
        {
            ...
            if ( isplayer( var_0 ) )
                var_0 thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "pickup_interception", var_0.origin );
        }
    }
    else
    {
...
ball_on_reset()
{
    ...
    thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "obj_return", var_0.baseorigin );
}
...
ball_return_home( var_0, var_1 )
{
    ...
    if ( istrue( level.possessionresetcondition ) )
    {
        if ( istrue( level.hvi_patrol_intro ) )
...
waitforreset( var_0 )
{
    ...
    if ( level.hvi_patrol_intro != 0 )
        scripts\mp\hostmigration::waitlongdurationwithhostmigrationpause( level.hvi_patrol_intro );
...
ball_location_hud()
{
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12909( "pickup_object", "dropped", "reset", "ball_ready" );
...
updatetimers( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_2 ) )
    {
        if ( istrue( level.hvi_patrol_intro ) && !istrue( level.ballreset ) )
            var_5 = 1000 * level.hvi_patrol_intro;
    }
