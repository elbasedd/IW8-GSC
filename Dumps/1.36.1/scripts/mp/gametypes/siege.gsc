...
main()
{
    ...
    level.playac130animinternal = 0;
    var_0 = getdvarint( "LTSNLQNRKO" ) && !getdvarint( "LSTLQTSSRM" );

    if ( var_0 )
        level.playac130animinternal = getdvarint( "scr_siege_groundwarSiege", 0 );

    level.audio_play_bodyfalls_for_htf_anims = [];

    if ( level.playac130animinternal )
        level.audio_play_bodyfalls_for_htf_anims[level.audio_play_bodyfalls_for_htf_anims.size] = "arm";
    ...
    if ( istrue( level.playac130animinternal ) )
    ...
    if ( level.playac130animinternal )
    {
        ...
        level.maxhqtanks = 0;
        level.setherodropscriptable = getdvarint( "scr_siege_numNonRallyVehicles", 25 );
        level._id_11C75 = 1;
...
onstartgametype()
{
    ...
    if ( level.playac130animinternal )
    {
        ...
        scripts\mp\gametypes\arm.gsc::_id_11B3E();
        scripts\mp\gametypes\arm.gsc::calculatehqmidpoint();
        level.setjailtimeouthud = getdvarint( "scr_siege_flagcount", 3 );
        setomnvar( "ui_num_dom_flags", level.setjailtimeouthud );
...
letters( var_0, var_1 )
{
    ...
    level.bot_dd_start = var_4;
    level.bot_dd_set_role = var_5;
...
updategametypedvars()
{
    ...
    level.molotov_get_pool_level_data = scripts\mp\utility\dvars::dvarfloatvalue( "holdAllTimer", 7.5, 0, 60 );
}
...
onplayerconnect( var_0 )
{
    ...
    if ( level.playac130animinternal && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] != 0 && !scripts\mp\flags::gameflag( "prematch_done" ) )
...
domflags()
{
    ...
    level.setjailtimeouthud = 3;
    setomnvar( "ui_num_dom_flags", level.setjailtimeouthud );

    if ( level.setjailtimeouthud == 3 )
    {
    ...
    foreach ( var_24 in level.objectives )
    {
        ...
        var_24._id_12002 = ::show_player_clip;
...
watchflagenduse( var_0 )
{
    ...
    if ( var_1 == level.setjailtimeouthud )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_2 == level.setjailtimeouthud )
...
onuse( var_0 )
{
    ...
    if ( var_2 == "neutral" )
    {
        ...
        {
            if ( var_4 == 2 && level.setjailtimeouthud == 3 )
            {
...
{
    if ( isdefined( self._id_12984 ) )
        self._id_12984 = undefined;
...
checkendgame()
{
    ...
    if ( var_0 == level.setjailtimeouthud )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_1 == level.setjailtimeouthud )
        setwinner( "axis", "siege_allflags_win", "siege_allflags_loss" );
}
...
runobjectives( var_0 )
{
        ...
        if ( level.setjailtimeouthud == 3 )
        {
            if ( level.mapname == "mp_downtown_gw" )
            {
                if ( var_2.trigger.objkey == "_a" || var_2.trigger.objkey == "_e" )
                    ...
                    vehicle_damage_updatestate( var_2.trigger );
            }
    ...
    foreach ( var_2 in level.allfobs )
    {
        ...
        var_2.trigger.gameobject._id_12002 = ::show_player_clip;
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom.gsc::precap( level.setjailtimeouthud == 5 );

    scripts\mp\gametypes\dom.gsc::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm.gsc::audio_player_spawn_mud_loop();
}
...
vehicle_damage_updatestate( var_0 )
{
    if ( level.mapname == "mp_downtown_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.setuphudelemninfilblack ) )
        {
            var_0.setuphudelemninfilblack = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_c" && !isdefined( var_0.setuphudelemninfilblack ) )
        {
            var_0.setuphudelemninfilblack = "_c";
            var_0.objkey = "_b";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.setuphudelemninfilblack ) )
        {
            var_0.setuphudelemninfilblack = "_d";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    else if ( level.mapname == "mp_boneyard_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.setuphudelemninfilblack ) )
        {
            var_0.setuphudelemninfilblack = "_b";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.setuphudelemninfilblack ) )
    ...
    {
        if ( var_0.objkey == "_a" && !isdefined( var_0.setuphudelemninfilblack ) )
        {
            var_0.setuphudelemninfilblack = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        ...
        else if ( var_0.objkey == "_e" && !isdefined( var_0.setuphudelemninfilblack ) )
        {
            var_0.setuphudelemninfilblack = "_e";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
        }
    }
    ...
    else if ( var_0.objkey == "_b" && !isdefined( var_0.setuphudelemninfilblack ) )
    {
        var_0.setuphudelemninfilblack = "_b";
        var_0.objkey = "_a";
        var_0.script_label = var_0.objkey;
