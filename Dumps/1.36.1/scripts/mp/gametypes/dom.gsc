...
initspawns()
{
    ...
    else if ( istrue( level.ammobox_bufferedattachmentweapon ) )
...
run_openexfil_spawn( var_0 )
{
    switch ( level.mapname )
    {
        case "mp_piccadilly":
            ...
            break;
        case "mp_malyshev":
            if ( level.relic_squadlink_turn_team_headobjectives )
            {
                switch ( var_0.script_label )
                {
                    case "_a":
...
_id_12607()
{
    ...
    while ( !level.gameended )
    {
        foreach ( var_1 in level.players )
        {
            ...
            if ( !isdefined( var_1.round_enemy_stuck_logic ) || var_1.round_enemy_stuck_logic != var_2 )
            {
                var_1 setmlgdominationpoint( var_2 );
                var_1.round_enemy_stuck_logic = var_2;
