...
main()
{
    ...
    if ( scripts\mp\utility\game::matchmakinggame() )
    {
        ...
        level.vehicle_watchmarkedtankdeath = 1;
        level.requiredplayercount["allies"] = var_1;
        level.requiredplayercount["axis"] = var_1;
    }

    scripts\mp\utility\join_team_aggregator::registeronplayerjointeamcallback( ::should_drop_minigun );
    ...
    level.binoculars_updatetargetmarker = kingslayerkills();

    if ( level.binoculars_updatetargetmarker )
    {
        level.init_silo_thrust_obj = 0.5;
        level.init_spawn_modules = 0.05;
    }

    if ( scripts\cp_mp\utility\game_utility::getmapname() == "mp_m_overwinter" )
    {
        level._id_11CB4 = 1;
        level.awardbunker11blueprint = getdvarint( "scr_always_snowfight", 0 );

        if ( level.awardbunker11blueprint )
    ...
    {
        level.binoculars_watchraceadson = 1;
        level._id_11E68 = 1;
    }
    else if ( getdvarint( "scr_arena_stpday" ) == 1 )
    {
        level.binoculars_watchforads = 1;
        level._id_11E68 = 1;
    }
...
onstartgametype()
{
    ...
    if ( istrue( level._id_11CB4 ) )
    {
        if ( !level.awardbunker11blueprint && game["roundsPlayed"] == 0 && istrue( game["practiceRound"] ) )
        {
            level.extratime = 30;
            game["didSnowFight"] = 1;
        ...
        else if ( level.awardbunker11blueprint )
        {
            level.arenaloadouts = 3;
            var_5 = 0;
        }

        level._id_11CB7["vanish"] = loadfx( "vfx/core/impacts/small_snowhit" );
        level._id_11CB7["screen"] = loadfx( "vfx/iw8/weap/_impact/snowball/vfx_imp_snowball_scrn.vfx" );
    ...
    if ( var_5 )
    {
        if ( israndomloadouts() || player_pushing_vehicle_monitor() || player_parachute_watcher() || player_pined_danger_feedback() )
        ...
        else if ( ispickuploadouts() )
        {
            ...
            if ( !isdefined( game["roundsPlayed"] ) || isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] == 0 )
            {
                ...
                level.startweapon.variantid = jugg_idle_until_shot_or_near( level.startweapon.weapon );
                level.arenaweapont1.variantid = jugg_idle_until_shot_or_near( level.arenaweapont1.weapon );
                level.arenaweapont2.variantid = jugg_idle_until_shot_or_near( level.arenaweapont2.weapon );
                level.arenaweapont3.variantid = jugg_idle_until_shot_or_near( level.arenaweapont3.weapon );
                level.arenaweapont4.variantid = jugg_idle_until_shot_or_near( level.arenaweapont4.weapon );
                level.arenaweapont5.variantid = jugg_idle_until_shot_or_near( level.arenaweapont5.weapon );
                level.arenaweapont6.variantid = jugg_idle_until_shot_or_near( level.arenaweapont6.weapon );
                level.arenaweapont7.variantid = jugg_idle_until_shot_or_near( level.arenaweapont7.weapon );
                level.arenaweapont8.variantid = jugg_idle_until_shot_or_near( level.arenaweapont8.weapon );
            }
...
updategametypedvars()
{
    ...
    level.binoculars_used = getdvarint( "scr_arena_arenaAttachments", 0 );
    level.binoculars_watchraceadsoff = getdvar( "scr_arena_arenaSuper", "none" );

    if ( level.binoculars_watchraceadsoff == "none" )
        ...
        if ( !isdefined( var_0 ) )
        {
            ...
            if ( !isdefined( var_0 ) )
            {
                ...
                if ( var_4 > 3 )
                {
                    ...
                    foreach ( var_6 in scripts\mp\utility\teams::getteamdata( self.pers["team"], "players" ) )
                    {
                        if ( istrue( var_6.clear_trap_console_activation ) )
                        {
                            var_9++;
                            continue;
                        }
                    ...
                    foreach ( var_6 in scripts\mp\utility\teams::getteamdata( self.pers["team"], "players" ) )
                    {
                        ...
                        if ( isdefined( var_6.pers["arena_spawn_pos"] ) )
                        {
                            ...
                            if ( var_6.pers["arena_spawn_pos"] == "1" && level.usedspawnposone[self.pers["team"]] == 0 )
                            {
                                ...
                                var_6.clear_trap_console_activation = 1;
                                var_8 = var_6;
                                break;
                            }
                    ...
                    if ( isdefined( var_8 ) )
                    {
                        ...
                        if ( isdefined( var_8._id_11E3D ) )
                            var_0.angles = var_8._id_11E3D;
                    }
                }
            }
    ...
    if ( !isnormalloadouts() )
    {
        ...
        foreach ( var_2 in level.teamnamelist )
        {
            if ( isdefined( var_0.pers["team"] ) && game["roundWinStreak"][var_2] > 0 && var_0.pers["team"] == var_2 )
            {
                ...
                var_0.pers["gamemodeLoadout"]["roundWinStreakPrimaryCamo"] = _id_11ACC();
                var_0.pers["gamemodeLoadout"]["roundWinStreakecondaryCamoTeam"] = var_2;
                var_0.pers["gamemodeLoadout"]["roundWinStreakSecondaryCamo"] = _id_11ACC();
            }
        }
    }
...
onjoinedteam()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_128FF( "joined_team", "joined_spectators" );
        _id_11AD8();
    }
}
...
onspawnfinished()
{
    ...
    if ( istrue( game["practiceRound"] ) || istrue( level.awardbunker11blueprint ) )
        thread _id_11CB6();
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) && game["roundsPlayed"] == 0 )
    {
        ...
        level scripts\engine\utility::_id_128FF( "prematch_done", "removeArenaOutlines" );
    }
...
onplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13 )
{
    ...
    {
        if ( istrue( level._id_11CB4 ) && ( var_6.basename == "snowball_mp" || var_6.basename == "pball_mp" ) )
            playfxontagforclients( level._id_11CB7["screen"], var_2, "tag_eye", var_2 );
...
arena_endgame( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    scripts\cp_mp\pet_watch::_id_125B6();
...
runarenaloadoutrulesonplayer()
{
    if ( israndomloadouts() || israndompreviewloadouts() || player_parachute_watcher() || player_pined_danger_feedback() )
    {
        if ( israndompreviewloadouts() )
        {
...
buildloadoutsforweaponstreaming()
{
    ...
    if ( ispickuploadouts() )
    {
        ...
        else
        {
            ...
            else if ( istrue( level.lootcontentsadjusteconomy_toptier ) )
            {
                var_4 = game["arenaRandomLoadout"][0]["loadoutPrimaryCamo"];
                var_8 = game["arenaRandomLoadout"][0]["loadoutPrimaryCosmeticAttachment"];
                var_9[0] = game["arenaRandomLoadout"][0]["loadoutPrimarySticker"];
            ...
            if ( player_get_sniper_weapon_object() )
                var_1 = scripts\mp\class::clipright( var_2, var_4, var_5, level.startweapon.variantid, var_7, var_8, var_9 );
            else
...
buildsecondaries( var_0, var_1, var_2 )
{
    ...
    else if ( istrue( level.lootcontentsadjusteconomy_toptier ) && istrue( var_2 ) )
    {
        var_7 = lb_dmg_factor_fuselage();
        game["arenaRandomLoadout"][game["arenaRandomLoadoutIndex"]]["loadoutSecondaryCamo"] = var_7;
...
lb_dmg_factor_fuselage()
{
    var_0 = "none";

    if ( istrue( level.binoculars_watchraceadson ) )
    {
        var_1 = [ "camo_06g", "camo_07i", "camo_08j", "camo_10i", "camo_10j", "camo_07i" ];
        var_0 = scripts\engine\utility::random( var_1 );
    }
    else if ( istrue( level.binoculars_watchforads ) )
    {
...
_id_11B56()
{
    level.arenaweapont1 = clip_ent( level.arenaweapont1 );
    level.arenaweapont2 = clip_ent( level.arenaweapont2 );
    level.arenaweapont3 = clip_ent( level.arenaweapont3 );
    level.arenaweapont4 = clip_ent( level.arenaweapont4 );
    level.arenaweapont5 = clip_ent( level.arenaweapont5 );
    level.arenaweapont6 = clip_ent( level.arenaweapont6 );
    level.arenaweapont7 = clip_ent( level.arenaweapont7 );
    level.arenaweapont8 = clip_ent( level.arenaweapont8 );
}
...
clip_ent( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_2 = lb_dmg_factor_fuselage();
        var_0.create_crate_objectives = var_2;

        if ( _id_12690( var_0.weapon ) )
        {
            var_6 = lb_dmg_factor_landing_gear();
            var_0.drop_jugg_crate = var_6;
        }

        if ( _id_12691( var_0.weapon ) )
        {
            var_7 = lb_dmg_factor_main_rotor();
            var_0._id_11FFC[0] = var_7[0];
            var_0._id_11FFC[1] = var_7[1];
            var_0._id_11FFC[2] = var_7[2];
            var_0._id_11FFC[3] = var_7[3];
        }
...
_id_11B20()
{
    level.arenaweapont1 = clearaveragevelocities( level.arenaweapont1 );
    level.arenaweapont2 = clearaveragevelocities( level.arenaweapont2 );
    level.arenaweapont3 = clearaveragevelocities( level.arenaweapont3 );
    level.arenaweapont4 = clearaveragevelocities( level.arenaweapont4 );
    level.arenaweapont5 = clearaveragevelocities( level.arenaweapont5 );
    level.arenaweapont6 = clearaveragevelocities( level.arenaweapont6 );
    level.arenaweapont7 = clearaveragevelocities( level.arenaweapont7 );
    level.arenaweapont8 = clearaveragevelocities( level.arenaweapont8 );
}
...
clearaveragevelocities( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_7[3] = "none";
        var_8 = scripts\mp\utility\weapon::getweaponrootname( var_0.weapon );
        var_0.weaponobj = scripts\mp\class::clipright( var_8, undefined, undefined, var_4, undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
    }
...
_id_11B58()
{
    level.startweapon = _id_11B61( level.startweapon );
    level.arenaweapont1 = _id_11B61( level.arenaweapont1 );
    level.arenaweapont2 = _id_11B61( level.arenaweapont2 );
    level.arenaweapont3 = _id_11B61( level.arenaweapont3 );
    level.arenaweapont4 = _id_11B61( level.arenaweapont4 );
    level.arenaweapont5 = _id_11B61( level.arenaweapont5 );
    level.arenaweapont6 = _id_11B61( level.arenaweapont6 );
    level.arenaweapont7 = _id_11B61( level.arenaweapont7 );
    level.arenaweapont8 = _id_11B61( level.arenaweapont8 );
}
...
_id_11B61( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_1 = javelin_forceclear( var_5 + "_mp" );
...
jug_spawn_func( var_0 )
{
    var_1 = scripts\mp\utility\weapon::getweaponrootname( var_0 );
    var_2 = javelin_forceclear( var_1 + "_mp" );
    return var_2;
}
...
defineplayerloadout( var_0 )
{
    ...
    if ( isdefined( level.startweapon.weapon ) && level.startweapon.weapon != "none" && !issubstr( level.startweapon.weapon, "equip" ) )
    {
        ...
        if ( istrue( level._id_11E68 ) )
        {
            ...
            if ( _id_12690( level.startweapon.weapon ) )
            {
                var_6 = lb_dmg_factor_landing_gear();
                game["arenaRandomLoadout"][0]["loadoutPrimaryCosmeticAttachment"] = var_6;
            }

            if ( _id_12691( level.startweapon.weapon ) )
            {
                var_7 = lb_dmg_factor_main_rotor();
        ...
        else if ( istrue( level.lootcontentsadjusteconomy_toptier ) )
        {
            ...
            var_1 = jug_spawn_func( level.startweapon.weapon );
    }
    else
    {
        var_11 = "none";
        ...
        {
            if ( playerentercombatareamessage( level.startweapon.weapon ) )
            {
                ...
                if ( level.binoculars_updatetargetmarker )
                {
                    ...
                    if ( level.binoculars_updatetargetmarker == 2 )
                    {
                        var_12 = scripts\engine\utility::ter_op( player_parachute_watcher(), "mp/classtable_arena_blueprints.csv", "mp/classTable_arena.csv" );
                        var_4 = int( scripts\mp\gametypes\gun.gsc::kicknullmusicondeath( "iw8_knife" ) );
    ...
    if ( level.allowsupers )
    {
        ...
        if ( issubstr( var_14, "mp_m_" ) && var_14 != "mp_m_speed" )
            level.binoculars_watchraceadsoff = hudzombie();
    }
    else
    {
        level.binoculars_watchraceadsoff = "none";
        setomnvar( "ui_disable_fieldupgrades", 1 );
    }
    ...
    level.arena_loadouts["default"]["loadoutFieldUpgrade1"] = level.binoculars_watchraceadsoff;
    ...
    if ( !istrue( level._id_11E68 ) && !istrue( level.lootcontentsadjusteconomy_toptier ) )
    {
        foreach ( var_16 in level.teamnamelist )
        {
            level.arena_loadouts[var_16]["loadoutPrimaryCamo"] = _id_11ACC();
            level.arena_loadouts[var_16]["loadoutSecondaryCamo"] = _id_11ACC();
        }
    }
}
...
cacherandomloadouts()
{
    ...
    var_0 = [];
    var_1 = 0;
    var_2 = scripts\engine\utility::ter_op( player_parachute_watcher(), "mp/classtable_arena_blueprints.csv", "mp/classTable_arena.csv" );
    ...
    if ( israndompreviewloadouts() )
        var_1 = 144;
    else if ( player_origin_inside_subway_car() )
        var_1 = 0;
    else if ( player_respawn_struct() )
        var_1 = 57;
    else if ( player_reenable_collect_leads() )
        var_1 = 93;
    else if ( player_respawn() )
        var_1 = 123;
    else if ( player_retry_thread() )
        var_1 = 146;
    else if ( player_pinged_armor_feedback() )
        var_1 = 188;
    ...
    if ( var_5 != "" && var_6 > 0.0 )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_10.size == 2 )
            {
                var_11 = var_10[0];
                var_12 = int( var_10[1] );
                var_13 = scripts\mp\utility\weapon::_id_12A99( var_11, var_12 );
                ...
                if ( var_13 )
                {
                    ...
                    var_14 = spawnstruct();
                    var_14.waittill_num_and_all_spawns_dead_and_time_and_player_reset = var_11;
...
updateloadoutarray( var_0, var_1 )
{
    ...
    if ( player_parachute_watcher() || player_pined_danger_feedback() )
    ...
    if ( player_parachute_watcher() || player_pined_danger_feedback() )
        var_2["loadoutSecondaryVariantID"] = scripts\mp\class::_id_120F2( var_0, var_1, 1, var_2["loadoutSecondary"] );
    else
    ...
    if ( level.allowsupers )
    {
        ...
        var_2["loadoutFieldUpgrade1"] = level.binoculars_watchraceadsoff;
    ...
    if ( player_pushing_vehicle_monitor() )
    {
...
arenaloadouts_select( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_6 = 0; var_6 < var_1 && var_0.size > 0; var_6++ )
    {
        ...
        if ( isdefined( var_2 ) && isdefined( var_3 ) )
        {
            ...
            var_10 = binoculars_updateuidata( var_2, var_9 );
            ...
            if ( var_10.size > 0 )
            {
                if ( randomfloat( 1.0 ) < var_3 )
                {
                    ...
                    var_7["loadoutPrimary"] = var_12.waittill_num_and_all_spawns_dead_and_time_and_player_reset;
...
binoculars_updateuidata( var_0, var_1 )
{
    var_2 = [];

    foreach ( var_4 in var_0 )
    {
        if ( arenaloadouts_getweapongroup( var_4.waittill_num_and_all_spawns_dead_and_time_and_player_reset ) == var_1 )
...
{
    if ( player_get_sniper_weapon_object() && !issubstr( var_0, "equip" ) && var_0 != "none" )
    {
        ...
        if ( var_4 != "" )
        {
            var_5 = scripts\mp\class::_id_120F2( "mp/classtable_arena_blueprints.csv", var_2, 0, var_4 );
            return var_5;
        }
...
setupweapons()
{
    ...
    if ( istrue( level._id_11E68 ) || istrue( level.lootcontentsadjusteconomy_toptier ) )
        _id_11B56();
    else if ( player_get_sniper_weapon_object() )
        _id_11B20();
    else
        _id_11B58();
...
javelin_forceclear( var_0 )
{
    var_1 = [];

    if ( level.binoculars_used == 1 )
    {
...
spawnweapon( var_0, var_1, var_2 )
{
    ...
    if ( var_9 != "" )
    {
        if ( istrue( level._id_11CB4 ) && var_3 == "equip_snowball" )
        {
            if ( isplayer( var_0 ) )
                var_8 = "single";
            ...
            if ( !isplayer( var_0 ) && var_0.script_label == "6" && !level.spawnballooncash )
            {
                if ( distance( var_0.origin, ( 0, 0, 138 ) ) < 10 )
                {
                    level.spawnballooncash = 1;
                    var_3 = "equip_pball";
                    var_8 = "single";
                }
            }
            else if ( !isplayer( var_0 ) && var_0.script_label == "8" && !level.spawnballooncash )
            {
        ...
        if ( isdefined( var_0.angles ) )
        {
            ...
            {
                if ( isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy == "wall" || isdefined( var_0.winbycaptures ) && var_0.winbycaptures == "wall" )
        ...
        var_10.try_to_play_custom_death_animation = spawn( "trigger_radius", var_10.origin, 0, 32, 32 );
        var_10 thread playerhunterpostloadout();

        if ( istrue( level._id_11CB4 ) )
        {
            var_10 thread _id_12A14( var_0, var_8 );
    ...
    else
    {
        ...
        if ( istrue( level._id_11E68 ) || istrue( level.lootcontentsadjusteconomy_toptier ) || player_get_sniper_weapon_object() )
            var_17 = var_1.weaponobj;
        else
        {
            var_16 = javelin_forceclear( var_15 + "_mp" );
        ...
        if ( isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy == "wall" )
        {
            ...
            var_19.calloutmarkerpingvo_playpredictivepingcleared = var_22;
        }
...
playerhunterpostloadout()
{
    ...
    {
        wait 0.05;
        self.try_to_play_custom_death_animation waittill( "trigger", var_1 );
...
spawngameendflagzone( var_0 )
{
    ...
    var_1.onuncontested = ::binoculars_settargetmarkerstate;
    var_1.isarena = 1;
...
binoculars_settargetmarkerstate( var_0 )
{
    var_1 = scripts\mp\gameobjects::getownerteam();
...
deleteotpreview()
{
    level scripts\engine\utility::_id_128FF( "prematch_done", "start_mode_setup" );
    disableotflag();
}
...
giveflagcapturexp( var_0, var_1 )
{
    ...
    if ( isplayer( var_2 ) )
    {
        ...
        var_2 thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "capture", var_2.origin );
    }
...
_id_11BD6()
{
    ...
    if ( istrue( level.arenaflag.teamspawnfunc ) )
        return;
...
getoutlineasset( var_0, var_1 )
{
    ...
    if ( istrue( level._id_11CB4 ) && isdefined( var_1 ) && var_1 == "equip_pball" )
        var_2 = "outline_depth_yellow";
...
player_respawn_struct()
{
    return level.arenaloadouts == 8;
}

player_reenable_collect_leads()
{
...
player_get_sniper_weapon_object()
{
    return level.arenaloadouts == 14;
}

player_pined_danger_feedback()
{
    return level.arenaloadouts == 15;
}

player_pushing_vehicle_monitor()
{
...
_id_11B54()
{
    ...
    if ( !istrue( level.awardbunker11blueprint ) && !istrue( game["practiceRound"] ) )
    {
    ...
    level.spawnballooncash = 0;
    var_0 = scripts\engine\utility::getstructarray( "weapon_pickup", "targetname" );

    foreach ( var_2 in var_0 )
    {
        if ( istrue( level.awardbunker11blueprint ) || istrue( game["practiceRound"] ) || level.arenaloadouts != 3 )
        {
            spawnweapon( var_2, level.arenaweapont1 );
            continue;
        }
...
_id_12A14( var_0, var_1 )
{
    ...
    else
    {
        ...
        playfx( level._id_11CB7["vanish"], self.origin );
        clearweaponoutlines();

        if ( !isplayer( var_0 ) )
            level thread _id_128F2( var_0 );
...
_id_128F2( var_0 )
{
    level endon( "game_ended" );
    wait 15;
    playfx( level._id_11CB7["vanish"], var_0.origin );
...
kingslayerkills()
{
    ...
    else if ( playerentercombatareamessage( level.arenaweapont1.weapon ) && playerentercombatareamessage( level.arenaweapont2.weapon ) && playerentercombatareamessage( level.arenaweapont3.weapon ) && playerentercombatareamessage( level.arenaweapont4.weapon ) && playerentercombatareamessage( level.arenaweapont5.weapon ) && playerentercombatareamessage( level.arenaweapont6.weapon ) && playerentercombatareamessage( level.arenaweapont7.weapon ) && playerentercombatareamessage( level.arenaweapont8.weapon ) )
    {
        if ( playerentercombatareamessage( level.startweapon.weapon ) )
            return 2;
        else
...
hudzombie()
{
    switch ( level.binoculars_watchraceadsoff )
    {
        case "super_weapon_drop":
        case "super_emp_drone":
        case "super_recon_drone":
            level.binoculars_watchraceadsoff = "super_ammo_drop";
            break;
        default:
            break;
    }

    return level.binoculars_watchraceadsoff;
}
