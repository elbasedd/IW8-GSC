...
initspawns()
{
    ...
    {
        assignteamspawns();
        level.exfill_chopper_dialogue["allies"] = "allies";
        level.exfill_chopper_dialogue["axis"] = "axis";
...
getspawnpoint()
{
    ...
    if ( scripts\mp\utility\game::getgametypenumlives() != 1 )
    {
        if ( scripts\mp\spawnlogic::shoulduseteamstartspawn() )
        {
            ...
            var_1 = scripts\mp\spawnlogic::getspawnpoint( self, var_0, level.exfill_chopper_dialogue[var_0], "neutral" );
    }
...
_id_11FC4()
{
    ...
    level.cyberemp scripts\mp\gameobjects::_id_11A9E( "mlg_icon_waypoint_emp_planted" );
    ...
    level.cyberemp scripts\mp\gameobjects::_id_11AA7( "icon_waypoint_escort_emp", "waypoint_capture_kill", "mlg_icon_waypoint_emp_planted", var_0 );
...
hidebombsitesaftermatchstart()
{
    ...
    scripts\mp\objidpoolmanager::setup_comms_obj_a_goals_and_cover( level.objectives["allies"].objidnum, 1 );
    ...
    scripts\mp\objidpoolmanager::setup_comms_obj_a_goals_and_cover( level.objectives["axis"].objidnum, 1 );
...
allowedwhileplanting( var_0 )
{
    ...
    if ( var_0 )
    {
        scripts\engine\utility::_id_12913( 0.8, "bomb_allow_offhands" );
        scripts\common\utility::allow_melee( var_0 );
...
onenduse( var_0, var_1, var_2 )
{
    ...
    {
        if ( var_1.isdefusing )
            scripts\mp\gameobjects::_id_11AA7( "icon_waypoint_defuse_empsite_nt", "icon_waypoint_defend_empsite_nt", "mlg_icon_waypoint_emp_planted" );
        else
            scripts\mp\gameobjects::_id_11AA7( "icon_waypoint_defend_empsite", "icon_waypoint_target_empsite", "mlg_icon_waypoint_emp_planted" );
...
onpickup( var_0, var_1, var_2 )
{
    ...
    scripts\mp\objidpoolmanager::setup_comms_obj_a_goals_and_cover( level.objectives["allies"].objidnum, 0 );
    scripts\mp\objidpoolmanager::setup_comms_obj_a_goals_and_cover( level.objectives["axis"].objidnum, 0 );
...
onuse( var_0 )
{
    ...
    if ( !scripts\mp\gameobjects::isfriendlyteam( var_0.pers["team"] ) && !level.bombplanted )
    {
        ...
        var_0 scripts\cp\agents\gametype_cp_specops::should_wait_before_spawn_chopper_boss();
        var_0 thread scripts\common\utility::_id_12456( level.remove_objective_on_flag, "plant", var_0.origin );
        ...
        level.bombplanted = 1;
        scripts\mp\gameobjects::_id_11A9E( "mlg_icon_waypoint_emp_planted" );
    ...
    else
    {
        ...
        var_0 scripts\cp\agents\gametype_cp_specops::sg_think();
...
setupfordefusing( var_0, var_1 )
{
    ...
    thread scripts\mp\gametypes\obj_bombzone.gsc::bunkervaults( var_1.team, "icon_waypoint_planted_empsite", "icon_waypoint_defuse_empsite" );
...
onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_0.isplanting )
    {
        thread scripts\common\utility::_id_12456( level.remove_prohibited_weapons, var_2, "planting" );
        var_1 scripts\mp\utility\stats::incpersstat( "defends", 1 );
        var_1 scripts\mp\persistence::statsetchild( "round", "defends", var_1.pers["defends"] );
    }
    else if ( var_0.isbombcarrier )
        thread scripts\common\utility::_id_12456( level.remove_prohibited_weapons, var_2, "carrying" );
    else if ( var_0.isdefusing )
        thread scripts\common\utility::_id_12456( level.remove_prohibited_weapons, var_2, "defusing" );
}
...
weaponswapwatcher()
{
    ...
    for (;;)
    {
        if ( self.currentprimaryweapon.basename == "iw8_cyberemp_mp" )
        {
            if ( !istrue( self._id_11C07 ) )
            {
                scripts\mp\utility\player::showminimap();
                self._id_11C07 = 1;
            }
        }
        else if ( istrue( self._id_11C07 ) )
        {
