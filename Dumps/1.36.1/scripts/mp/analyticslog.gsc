...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_12911( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
...
watchforplayermovementevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_1290F( "doubleJumpBegin", "doubleJumpEnd", "sprint_slide_begin" );
...
watchforusermessageevents()
{
    ...
    for (;;)
    {
        ...
        var_0 = scripts\engine\utility::_id_12907( "log_user_event_end", "log_user_event_generic_event" );
...
recentghostridekillcount( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        return;
...
rechargenvg( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( var_4 ) )
        var_4 = "";
...
recharge_equipment_init( var_0, var_1 )
{
...
rebirthloadout( var_0, var_1, var_2, var_3 )
{
