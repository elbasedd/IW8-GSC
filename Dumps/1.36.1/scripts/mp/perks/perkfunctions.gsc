...
updatesharpfocus()
{
    ...
    var_1 = undefined;
    var_2 = scripts\mp\utility\weapon::_id_12A93( var_0 );
...
updatedefaultflinchreduction()
{
    ...
    var_0 = undefined;
    var_1 = scripts\mp\utility\weapon::_id_12A93( self.currentweapon );
...
ammodisabling_run( var_0 )
{
    ...
    scripts\engine\utility::_id_12913( 0.8, "death" );
...
setviewkickoverride()
{
    ...
    self.smoke_door = 0.05;
    self.smoke_enemy_think = 0.08;
    self.smoke_emitter = 0.02;
...
unsetviewkickoverride()
{
    ...
    self.smoke_door = undefined;
    self.smoke_enemy_think = undefined;
    self.smoke_emitter = undefined;
...
applystunresistence( var_0, var_1, var_2 )
{
    if ( var_1 scripts\mp\utility\perk::_hasperk( "specialty_stun_resistance" ) && var_0 != var_1 )
    {
        ...
        if ( istrue( scripts\cp_mp\utility\player_utility::playersareenemies( var_3, var_4 ) ) )
            var_1 scripts\cp\agents\gametype_cp_specops::resistedstun( var_3 );
    }
...
watchpainted( var_0, var_1 )
{
    ...
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_12913( var_1, "death" );
    self.painted = 0;
...
watchpaintedagain( var_0 )
{
    self endon( "disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_128FF( "painted_again", "painted_end" );
    scripts\mp\utility\outline::outlinedisable( var_0, self );
}
...
boomtrackplayerdeath( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::_id_12913( 7.0, "death" );
...
unsetcustomjuicedondeath()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    scripts\engine\utility::_id_128FF( "death", "faux_spawn" );
...
unsetcustomjuicedonmatchend()
{
    self endon( "disconnect" );
    self endon( "unset_custom_juiced" );
    level scripts\engine\utility::_id_128FF( "round_end_finished", "game_ended" );
    thread unsetcustomjuiced();
}
...
watchlifepackoutlinestate( var_0 )
{
    ...
    for (;;)
    {
        var_0 scripts\engine\utility::_id_128FF( "enabled_life_pack_boost", "disabled_life_pack_boost" );
        setlifepackoutlinestate( var_0 );
    }
}
...
{
    self endon( "death" );
    var_0 scripts\engine\utility::_id_128FF( "death_or_disconnect", "toughen_up_end" );
...
_id_11C51( var_0, var_1, var_2, var_3 )
{
    var_4 = var_1 - var_2;
    ...
    var_8 = scripts\engine\math::floor1lights( var_7 );
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( var_2 && !isbot( var_8 ) )
        {
            ...
            foreach ( var_13 in var_11 )
            {
                ...
                if ( !var_8 _id_11C51( var_13, var_10, var_14, var_15 ) )
                    continue;

                var_9 = var_9 | var_8 launch_smoke_mortar( var_13 );
            }
        }
        else
        {
            ...
            foreach ( var_13 in level.players )
            {
                ...
                if ( _id_11C52( var_18, var_10, var_14 ) )
                {
                    var_3 = var_3 + 2;
                    var_20 = [ var_8 ];
...
setovercharge()
{
    thread scripts\mp\trials\mp_trl_floorislava::_id_11A77( "ui_overcharge", 1 );
}

unsetovercharge()
{
    thread scripts\mp\trials\mp_trl_floorislava::_id_11A77( "ui_overcharge", 0 );
}
...
outlinekillstreaks_enablemarksafterprematch()
{
    ...
    if ( isdefined( self ) )
    {
        ...
        scripts\mp\trials\trial_jugg::_id_126DC( self );
    }
}
...
{
    self giveweapon( self._id_12220 );
    self assignweaponmeleeslot( self._id_12220 );
    thread watchthrowingknifescavenge();

    if ( self._id_12220 == "iw8_throwingknife_fire_melee_mp" )
        thread _id_12A1B();
    else if ( self._id_12220 == "iw8_throwingknife_electric_melee_mp" )
        thread _id_12A1A();
}

unsetthrowingknifemelee()
{
    if ( isdefined( self._id_12220 ) && self hasweapon( self._id_12220 ) )
        self takeweapon( self._id_12220 );

    self notify( "specialty_equip_throwingKnife_end" );

    if ( isdefined( self._id_12220 ) && self._id_12220 == "iw8_throwingknife_fire_melee_mp" )
        playerzombiethermalupdate();
    else if ( isdefined( self._id_12220 ) && self._id_12220 == "iw8_throwingknife_electric_melee_mp" )
        playerzombiethermalcleanup();
}
...
{
    self.player scripts\engine\utility::_id_128FF( "disconnect", "unsetBulletOutline" );
...
markempsignatures( var_0, var_1 )
{
    ...
    var_0 scripts\engine\utility::_id_128FF( "death", "cloak_end" );
...
startgpsjammer()
{
    ...
    for (;;)
    {
        ...
        if ( scripts\mp\class::playergoingintols( var_0 ) )
            continue;
...
ghostadvanceduavwatcher()
{
    ...
    for (;;)
    {
        if ( level.teambased )
        {
            var_0 = level.airlock_callbutton_think - level.activeadvanceduavs[self.team] > 0;
...
{
    self endon( "groundPoundShield_deleteShield" );
    scripts\engine\utility::_id_128FF( "death_or_disconnect", "groundPound_unset" );
    thread groundpoundshield_deleteshield( var_0 );
}
...
{
    var_0 endon( "death" );
    scripts\engine\utility::_id_128FF( "death_or_disconnect", "battleSlide_unset" );
    var_0 delete();
}
...
thrusterstopfx()
{
    self endon( "death_or_disconnect" );
    level endon( "game_ended" );
    scripts\engine\utility::_id_128FF( "doubleJumpBoostEnd", "thruster_unset" );
    waitframe();
}
...
{
    scripts\engine\utility::_id_128FF( "ADSTargetMarkUnset", "death_or_disconnect" );
...
setkillstreaktoscorestreak()
{
    ...
    if ( isdefined( self.pers["killstreakToScorestreak_lifeId"] ) && self.pers["killstreakToScorestreak_lifeId"] == self.lifeid )
    {
        ...
        var_0 = playerzombiestatechange( self.streakpoints );
...
unsetkillstreaktoscorestreak()
{
    ...
    var_0 = playerzombiestreamwaittillcomplete( self.streakpoints );
    scripts\mp\killstreaks\killstreaks::updatestreakcosts();
    scripts\mp\killstreaks\killstreaks::setstreakpoints( var_0 );
    scripts\mp\killstreaks\killstreaks::checkstreakreward( self.streakpoints, 1 );
    scripts\mp\killstreaks\killstreaks::updatestreakmeterui();
...
proximityrevivethink()
{
    ...
    for (;;)
    {
        ...
        foreach ( var_7 in var_5 )
        {
            if ( istrue( var_7.inlaststand ) && !istrue( var_7.stuckinlaststand ) && !istrue( var_7.laststandhealisactive ) && !istrue( var_7 scripts\mp\playerlogic::jugg_enter_combat_callback() ) && !isdefined( var_0.owner ) )
        ...
        if ( isdefined( level.revivetriggers ) )
        {
            foreach ( var_10 in level.revivetriggers )
            {
                ...
                {
                    if ( !istrue( var_10.trigger.owner scripts\mp\playerlogic::jugg_enter_combat_callback() ) && !isdefined( var_0.owner ) )
                    {
...
proximityrevive( var_0, var_1, var_2 )
{
    ...
    var_0 scripts\mp\playerlogic::_id_11A67( 1 );
    var_1.owner = var_0;
...
watchproximityrevivefail( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_0 scripts\mp\playerlogic::_id_11A67( 0 );
        var_0 scripts\mp\gameobjects::updateuiprogress( var_1, 0 );
        var_0 scripts\mp\utility\player::_freezecontrols( 0, undefined, "proximityRevive" );
...
_id_11AC8()
{
    if ( isdefined( self.postgamestate ) && self.postgamestate == gettime() )
        regendelayreduce_onkill();
}
...
rechargeequipment_updateslot( var_0, var_1 )
{
    ...
    if ( isdefined( level.init_spawn_modules ) )
        var_7 = level.init_spawn_modules;
    else
    ...
    while ( isdefined( self.markequipmentstate.markingent ) && !istrue( self.ishacking ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( self.markequipmentstate.markedents, self.markequipmentstate.markingent ) )
        {
            if ( scripts\mp\utility\player::isplayerads() )
            {
                ...
                if ( level.teambased && scripts\mp\trials\trial_jugg::_id_126D2( self.markequipmentstate.markingent ) )
                {
                    self.markequipmentstate.markingent._id_1219F = self.team;
                    var_7 = scripts\mp\utility\player::getteamarray( self.markequipmentstate.markingent._id_1219F );

                    foreach ( var_9 in var_7 )
                        scripts\mp\trials\trial_jugg::_id_126DE( self.markequipmentstate.markingent, var_9 );
                }
...
unmarkafterduration( var_0 )
{
    ...
    scripts\engine\utility::_id_12919( var_1, "disconnect" );
    unmarkent( var_0 );
}
...
unmarkent( var_0 )
{
    ...
    if ( isdefined( var_0._id_1219F ) )
    {
        if ( level.teambased && scripts\mp\trials\trial_jugg::_id_126D2( var_0 ) )
        {
            var_1 = scripts\mp\utility\player::getteamarray( var_0._id_1219F );

            foreach ( var_3 in var_1 )
                scripts\mp\trials\trial_jugg::_id_126DE( var_0, var_3 );
        }

        var_0._id_1219F = undefined;
    }
...
remove_crusader_class( var_0, var_1 )
{
    var_2 = [];
...
markedentities_think()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) )
        {
            ...
            if ( isdefined( self.markequipmentstate ) )
            {
                self.markequipmentstate.markedents = remove_crusader_class( self.markequipmentstate.markedents, var_0 );
...
_id_11A68()
{
    ...
    self.manualturret_endturretuseonexecution = 1;
    _id_125FE( self.team );
    thread forceexplosivedeath();
}
...
forceexplosivedeath()
{
    ...
    scripts\engine\utility::_id_128FF( "spawned_player", "disconnect" );

    if ( isdefined( self ) )
        self.manualturret_endturretuseonexecution = undefined;
...
_id_125FE( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::lastdirty( var_0 );

    if ( !isdefined( level.brbonusxpallowed ) )
        level.brbonusxpallowed = [];

    var_2 = 0;

    if ( isdefined( level.brbonusxpallowed[var_0] ) )
        var_2 = level.brbonusxpallowed[var_0];

    var_3 = var_1 - var_2;

    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util.gsc::allowvipdamage( var_0, var_3 );

    level.brbonusxpallowed[var_0] = var_1;
}
