...
init()
{
    ...
    registerscriptperk( "specialty_specialist_bonus", scripts\mp\perks\perkfunctions::_id_11AD1, scripts\mp\perks\perkfunctions::_id_12576 );
    ...
    registerscriptperk( "specialty_chain_killstreaks", scripts\mp\perks\perkfunctions::_id_11A72, scripts\mp\perks\perkfunctions::_id_12572 );
    ...
    registerscriptperk( "specialty_reduce_regen_delay_on_kill", scripts\mp\perks\perkfunctions::_id_11AC8, scripts\mp\perks\perkfunctions::_id_12574 );
    ...
    registerscriptperk( "specialty_br_better_mission_rewards", scripts\mp\perks\perkfunctions::_id_11A68, scripts\mp\perks\perkfunctions::_id_12571 );
...
initspecialistkillstreaks()
{
    ...
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "specialist_perk_bonus", undefined, ::show_hint_after_delay );
}
...
show_hint_after_delay( var_0 )
{
    ally1_intro_dialogue();
}
...
ally1_intro_dialogue()
{
    ...
    {
        var_2 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", istrue( var_1._id_11E6D ), istrue( var_1.specialist ) );

        if ( !var_2 )
            continue;

        if ( perkisrestricted( var_1.ref ) )
            continue;
...
giveperksafterspawn()
{
    ...
    if ( self.avoidkillstreakonspawntimer > 0 )
    {
        ...
        if ( istrue( self.inspawncamera ) )
            var_0 = var_0 + scripts\mp\spawncamera::lb_dmg_factor_driverless_collision();
