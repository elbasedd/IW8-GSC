        ...
        if ( !self.perkpackagedata.isusing && scripts\mp\supers::issuperready() )
        {
            if ( self.perkpackagedata.istwomode )
            {
                ...
                if ( 1 )
                {
                    ...
                    if ( isdefined( level.spawn_obit_struct ) )
                        [[ level.spawn_obit_struct ]]();
                }
            }
...
perkpackage_getfirstfieldupgrade()
{
    ...
    if ( isdefined( self.skydiveontacinsertplacement ) )
        var_0 = self.skydiveontacinsertplacement;
...
perkpackage_getsecondfieldupgrade()
{
    ...
    if ( isdefined( self.skydivestreamhintdvars ) )
        var_0 = self.skydivestreamhintdvars;
...
perkpackagemenu_menuthink()
{
    ...
    wait 0.3;
    var_0 = scripts\engine\utility::_id_12909( "perkPackageMenu_option1", "perkPackageMenu_option2", "perkPackageMenu_close", "death" );
    var_1 = 0;
...
spawn_objective( var_0, var_1 )
{
    ...
    self.skydiveontacinsertplacement = var_0;
    self.skydivestreamhintdvars = var_1;
    perkpackage_updateifchanged();
}
...
spawn_origin()
{
    ...
    self.skydivestreamhintdvars = undefined;
}
