...
init()
{
    ...
    registerbcsoundtype( "ges_mtx_t9_yawn", "mtx_gst_emote_tired", 1.0, 1.0, 3, 10, 0 );
    registerbcsoundtype( "ges_mtx_t9_devil_horns", "mtx_gst_emote_cheer", 1.0, 1.0, 3, 10, 0 );
    registerbcsoundtype( "ges_mtx_t9_death_grip", "mtx_gst_taunt_wave_crush_you", 1.0, 1.0, 3, 10, 0 );
    registerbcsoundtype( "ges_mtx_t9_blow_kiss", "mtx_gst_emote_kiss", 1.0, 1.0, 3, 10, 0 );
    registerbcsoundtype( "ges_mtx_t9_finger_frame", "mtx_gst_social_clip_it", 1.0, 1.0, 3, 10, 0 );
    registerbcsoundtype( "ges_mtx_t9_heart", "mtx_gst_emote_happy_sigh", 1.0, 1.0, 3, 10, 0 );
    registerbcsoundtype( "ges_mtx_t9_slit_throat", "mtx_gst_taunt_point_ill_make_quick", 1.0, 1.0, 3, 10, 0 );

    if ( !scripts\mp\utility\game::play_vo_internal() )
    {
    ...
    level.playerclearstreamhintorigin = 0;

    if ( var_3 == "sd" || var_3 == "cyber" || var_3 == "arena" )
        level.playerclearstreamhintorigin = 1;
...
onplayerspawned()
{
    ...
    if ( !level.teambased || level.playerclearstreamhintorigin || istrue( level.disablebattlechatter ) || scripts\mp\utility\game::isanymlgmatch() )
        self.bcdisabled = 1;
    else
    {
        if ( !scripts\mp\utility\game::runleanthreadmode() || istrue( level.cargo_truck_mg_mp_ondeathrespawncallback ) )
        {
...
threatcallouttracking()
{
    ...
    for (;;)
    {
        ...
        var_4 = is_subway_car_deployed( self.team );
...
dosound( var_0, var_1 )
{
    ...
    {
        if ( isdefined( self.operatorcustomization.has_keycard ) && self.operatorcustomization.has_keycard != "" )
            var_2 = self.operatorcustomization.has_keycard;
        else
        {
            if ( self.operatorcustomization.has_intel == "none" )
                return;

            var_2 = var_2 + self.operatorcustomization.has_intel;
        }
    }
    ...
    if ( !scripts\mp\utility\game::lpcfeaturegated() )
        start_reach_wind_room( var_6, var_7, var_0, var_5, var_4 );
    else if ( self issplitscreenplayer() )
        start_safehouse_gunshop( var_6, var_7, var_0, var_5, var_4 );
    else
        start_reach_pipe_room( var_6, var_7, var_0, var_5, var_4 );
    ...
    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        ...
        if ( soundexists( var_10 ) )
        {
            ...
            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                start_reach_wind_room( 1, 1, var_11, undefined, var_10, var_12 );
            else if ( self issplitscreenplayer() )
                start_safehouse_gunshop( 1, 1, var_11, undefined, var_10, var_12 );
            else
                start_reach_pipe_room( 1, 1, var_11, undefined, var_10, var_12 );
        }
    }
    ...
    scripts\engine\utility::_id_128FF( var_4, "death_or_disconnect" );
    level removespeaker( self, var_14 );
    return 1;
}

start_reach_pipe_room( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
start_reach_wind_room( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
start_safehouse_gunshop( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
{
    var_2 = scripts\engine\utility::_id_12907( var_0, "death_or_disconnect" );
...
location_add_last_callout_time( var_0, var_1 )
{
    ...
    if ( !isdefined( level.postshipmodifychevrons ) )
        level.postshipmodifychevrons = [];

    level.postshipmodifychevrons[var_1] = var_2;
}
...
{
    if ( isdefined( level.postshipmodifychevrons ) && isdefined( level.postshipmodifychevrons[var_0] ) )
        return level.postshipmodifychevrons[var_0];
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( level.bcinfo["req_friendly"][var_1] && !var_0 friendly_nearby( 4840000 ) && !istrue( level.cargo_truck_mg_mp_ondeathrespawncallback ) )
        return;
    ...
    if ( gettime() > var_0.branalytics_init + level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        var_0.bcinfoqueued = "none";
        var_0.branalytics_init = 0;
    }

    if ( comparesoundpriorities( var_1, var_0.bcinfoqueued ) )
    {
        var_0.bcinfoqueued = var_1;
        var_0.branalytics_init = gettime();
    }
    else
        return;
...
saylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    while ( var_0 <= level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        ...
        {
            var_5 = gettime();
            var_4["higher"]["player"] scripts\engine\utility::_id_12900( var_4["higher"]["sound_alias"], "death", "disconnect" );
            waitframe();
