...
init()
{
    ...
    init_function_refs();
    level.showing_ui_record = scripts\mp\trials\mp_trl_create_a_script_race_euphrates::control_room_button();
    level.showintelinstancetoplayer = scripts\mp\trials\mp_trl_create_a_script_race_euphrates::control_room_button();
...
dochangeweapon( var_0 )
{
    if ( istrue( self.create_score_message ) )
        rear_spotlight_target_found_speed( var_0 );

    self.create_score_message = 1;
...
x1ops4()
{
    ...
    scripts\engine\utility::_id_128FF( "death", "weapon_change" );
...
_id_125E0( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
        thread selfrevivemonitorrevivebuttonpressed( var_2 );

    return 1;
}

selfrevivemonitorrevivebuttonpressed( var_0 )
{
    ...
    var_1 = "cancel_" + var_0;
    thread selfrevivebuttonpresscleanup( var_1 );
    childthread semtex_killstuckplayer( var_0, var_1 );
    childthread send_all_ai_to_players( var_0, var_1 );
    childthread semtex_used( var_0, var_1 );
}

send_all_ai_to_players( var_0, var_1 )
{
    for (;;)
    {
...
selfrevivebuttonpressed( var_0, var_1 )
{
    ...
    childthread semtex_stuckplayer( var_0, var_1 );
}
...
selfrevivethink( var_0 )
{
    self notify( var_0 );

    if ( istrue( self.timer_sequence ) )
    {
        self setscriptablepartstate( "weaponVFXViewmodel", "neutral" );
        self setscriptablepartstate( "weaponVFXWorldModel", "neutral" );
    }

    self.timer_sequence = undefined;
}

selfrevivebuttonpresscleanup( var_0 )
{
    self endon( "disconnect" );
    self endon( "newMTXVFXStateSet" );
    scripts\engine\utility::_id_128FF( "death", "weapon_change" );
...
_id_125C7( var_0 )
{
    ...
    {
        if ( scripts\cp\drone\emp_drone::play_pullout_sequence( var_0 ) )
            thread scripts\cp\drone\emp_drone::onspawn_fastspeed( var_0 );
    }
}
...
updatelauncherusage()
{
    ...
    switch ( var_1 )
    {
        ...
        case "iw8_sn_crossbow":
            thread scripts\cp\agents\gametype_cp_wave_sv::onprematchfadedone2();
            break;
        case "iw8_sn_xmike109":
            thread scripts\cp\equipment\cp_decoy_grenade::ownerxuid();
            break;
        case "iw8_sh_aalpha12":
            thread scripts\aitypes\riotshield\riotshield::ownerxuid();
            break;
        case "iw8_me_t9ballisticknife":
            thread scripts\asm\soldier\ground_turret::ownerxuid();
            break;
    }
    ...
    switch ( var_1 )
    {
        ...
        case "iw8_sn_t9crossbow":
        case "iw8_sn_crossbow":
            thread scripts\cp\agents\gametype_cp_wave_sv::enemy_groups( var_0 );
            break;
        case "iw8_sn_xmike109":
            thread scripts\cp\equipment\cp_decoy_grenade::_id_12617( var_0 );
            break;
        case "iw8_sh_aalpha12":
            thread scripts\aitypes\riotshield\riotshield::_id_12617( var_0 );
            break;
        case "iw8_me_t9ballisticknife":
            thread scripts\asm\soldier\ground_turret::_id_12617( var_0 );
            break;
    }
}
...
_id_11A97( var_0 )
{
    ...
    if ( isdefined( level.post_safeges_weapon ) )
        self [[ level.post_safeges_weapon ]]();
}
...
onplayerspawned()
{
    ...
    _id_11A97( scripts\engine\utility::ter_op( isdefined( self.spawnweaponobj ), self.spawnweaponobj, nullweapon() ) );
...
savetogglescopestates()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( !isundefinedweapon( self.primaryweaponobj ) && var_2 == self.primaryweaponobj || !isundefinedweapon( self.secondaryweaponobj ) && var_2 == self.secondaryweaponobj )
        {
            if ( isdefined( var_2.scope ) && istogglescope( var_2.scope ) && !_id_12001( var_2.backpiece ) )
            {
                var_3 = scripts\mp\utility\weapon::getcompleteweaponnamenoalt( var_2 );
...
{
    return play_animation_old( var_0 );
}

play_animation_old( var_0 )
{
    var_1 = scripts\mp\utility\weapon::attachmentmap_tobase( var_0 );
...
sniperglint_cleanup()
{
    scripts\engine\utility::_id_128FF( "death_or_disconnect", "weapon_change" );
...
{
    self endon( "death" );
    level.showing_ui_record scripts\mp\trials\mp_trl_create_a_script_race_euphrates::controlledcallbacks( self, var_0, self.objweapon );
    ...
    for (;;)
    {
        ...
        if ( var_6 )
        {
            ...
            if ( var_7.size > 2 )
            {
                ...
                foreach ( var_12 in var_7 )
                {
                    ...
                    if ( scripts\mp\utility\weapon::player_choppergunnericon( var_12 ) )
                        var_9 = 1;
        ...
        level.showintelinstancetoplayer scripts\mp\trials\mp_trl_create_a_script_race_euphrates::controlledcallbacks( self, var_2, self.objweapon );
...
watchpickupcomplete( var_0, var_1, var_2 )
{
    ...
    if ( var_4 )
    {
        ...
        if ( isdefined( level.showmapchyron ) )
            [[ level.showmapchyron ]]( var_0 );
        else if ( var_2 )
...
getrandomgraverobberattachment( var_0, var_1 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
        ...
        var_4 = scripts\mp\utility\weapon::iwbestscore( var_2 );
    ...
    foreach ( var_8, var_6 in var_3 )
    {
        ...
        if ( !scripts\mp\utility\weapon::borntime( var_0, var_7 ) )
        {
    ...
    var_4 = scripts\engine\utility::blockdrive( var_4 );
...
{
    if ( !scripts\mp\utility\weapon::borntime( var_0, var_1 ) )
        return 0;
...
{
    if ( isdefined( level.shouldxmike109hitmarker ) )
        [[ level.shouldxmike109hitmarker ]]( var_0 );
    else
    {
...
handlescavengerbagpickup( var_0 )
{
    ...
    shouldxmike109hitmarker( var_1 );

    if ( !isdefined( var_1.pers["scavengerPickedUp"] ) )
        var_1.pers["scavengerPickedUp"] = 0;

    var_1 scripts\cp\agents\gametype_cp_specops::should_update_track_timer( "scavengerAmmo" );
...
scavengerbagcleanupthink()
{
    self endon( "death" );
    level endon( "game_ended" );
    self.owner scripts\engine\utility::_id_12900( "death_or_disconnect", "joined_team", "bag_timeout" );
...
checkhit( var_0, var_1 )
{
    ...
    thread scripts\cp\agents\gametype_cp_specops::onsuccessfulhit( var_0 );
...
watchgrenadethrows()
{
    ...
    {
        self _meth_87A7();
        var_3 = makeweapon( var_0.weapon_name );
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "support_box_mp":
            ...
            break;
        case "armor_box_mp":
            thread scripts\mp\equipment\support_box::birds_in_square_monitor( var_0 );
            break;
        ...
        case "geiger_counter_mp":
            thread scripts\mp\trials\trial_sniper::initialize_flag_role( var_0 );
            break;
        case "offhand_spotter_scope_mp":
            thread scripts\mp\trials\trial_pitcher::brjuggernautcratecapturecallback( var_0 );
            break;
        case "tac_cover_mp":
        ...
        case "advanced_vehicle_drop_marker_mp":
            thread scripts\mp\equipment\advanced_supply_drop::ammoids( var_0 );
            break;
        case "advanced_loot_drop_marker_mp":
            thread scripts\mp\equipment\advanced_supply_drop::ammobox_tryuse( var_0 );
            break;
        case "deploy_weapondrop_mp":
            thread scripts\mp\equipment\weapon_drop::weapondrop_used( var_0 );
            break;
        case "concussion_grenade_mp":
            var_0 thread dokidnapsequence();
            break;
        default:
            if ( isdefined( level.should_break_stealth_immediately_func ) )
                [[ level.should_break_stealth_immediately_func ]]( var_0.weapon_name, var_0 );

            break;
    }

    rebel_flood_spawn_wait( var_0.weapon_name );
}
...
dokidnapsequence()
{
    ...
    thread scripts\mp\equipment\concussion_grenade::shooting_targets( var_0, var_1 );
}
...
smokegrenadeused( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        thread _id_11CA0( var_5 );
        thread scripts\mp\bots\bots::empty_collision_handler( var_5 );
    }
    else
...
monitorsmokeactive()
{
    ...
    var_0 = scripts\engine\utility::_id_12913( 9.25, "death" );
...
lockonlaunchers_gettargetarray( var_0 )
{
    ...
    if ( level.teambased )
    {
        ...
        foreach ( var_14 in var_3 )
        {
            ...
            {
                if ( isdefined( var_17 ) && ( !scripts\cp_mp\vehicles\vehicle::_id_1275C( var_17, self ) || var_2 ) )
...
{
    var_0 = [ "apc_russian", "atv", "big_bird", "cargo_truck", "cargo_truck_mg", "payload_truck_mg", "cop_car", "hoopty", "hoopty_truck", "jeep", "large_transport", "light_tank", "little_bird", "little_bird_mg", "medium_transport", "pickup_truck", "tac_rover", "technical", "van", "loot_chopper" ];

    if ( isdefined( level.init_silo_platforms ) )
        var_0 = level.init_silo_platforms;
...
updatemissilefire( var_0 )
{
    ...
    switch ( var_0.weapon_name )
    {
        ...
        case "iw8_la_t9standard_mp":
            ...
            level thread scripts\mp\battlechatter_mp::primesneeded( var_0 );
...
monitordisownedequipment( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_2 ) )
        var_0 scripts\engine\utility::_id_128FF( "joined_team", "disconnect" );
    else
        var_0 scripts\engine\utility::_id_12900( "joined_team", "joined_spectators", "disconnect" );
...
updateplantedarray( var_0 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        scripts\mp\utility\script::fusefx( var_4 );
    }
...
makeexplosiveusabletag( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_4 ) )
        {
            ...
            else if ( isdefined( level.should_take_damage ) )
                [[ level.should_take_damage ]]( self.owner, var_4 );
        }
...
explosivehandlemovers( var_0, var_1 )
{
    ...
    if ( scripts\mp\equipment\claymore::pity_timer_end_time( var_0 ) )
    {
        var_2.specialistbr = 1;
        self _meth_87B9( 1 );
    }
...
explosivetrigger( var_0, var_1, var_2 )
{
    ...
    {
        var_0 thread scripts\cp\agents\gametype_cp_specops::triggereddelayedexplosion();
...
updateviewkickscale( var_0 )
{
    ...
    else if ( isdefined( self.overrideviewkickscale ) )
    {
        ...
        var_1 = scripts\mp\utility\weapon::_id_12A93( self getcurrentweapon() );

        if ( var_1 == 1 )
            var_0 = self.overrideviewkickscalepistol;
        else if ( var_1 == 4 )
            var_0 = self.smoke_door;
        else if ( var_1 == 2 )
            var_0 = self.smoke_emitter;
        else if ( var_1 == 3 )
            var_0 = self.smoke_enemy_think;
        else if ( var_1 == 5 )
...
getplayerspeedbyweapon( var_0 )
{
    ...
    else
    {
        ...
        if ( !isdefined( var_2 ) )
            ...
            var_1 = 0.85;
        else if ( scripts\mp\utility\weapon::playanim_aidismountturret( var_2.basename ) )
            var_1 = 0.85;
        else
        {
            if ( var_2.inventorytype != "primary" && var_2.inventorytype != "altmode" || scripts\mp\utility\weapon::player_choppergunnericon( var_2 ) )
            {
...
stancerecoiladjuster()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_12900( "adjustedStance", "sprint_begin", "weapon_change" );
        wait 0.5;
...
minedamagemonitor()
{
    ...
    if ( isplayer( var_16 ) )
    {
        ...
        if ( var_16 != self.owner && var_16.team != self.owner.team )
        {
            ...
            scripts\cp\agents\gametype_cp_specops::equipmentdestroyed( var_15, var_0, var_3, var_10, undefined, var_11, undefined, var_16.modifiers );
        }
    }
    ...
    scripts\cp\agents\gametype_cp_specops::minedestroyed( self, var_16, var_6 );
...
buildattachmentmaps()
{
    ...
    level.boss_fight_combat_cave = [];
    level.boss_fight_combat_forest = [];
    level.boss_two_minion_watcher = [];
    ...
    foreach ( var_23 in var_21 )
    {
        ...
        {
            var_26 = level.boss_fight_combat_forest[var_25];

            if ( !isdefined( var_26 ) )
                level.boss_fight_combat_forest[var_25] = var_24;
            else if ( var_24 != var_26 )
                level.boss_two_minion_watcher[var_23] = var_24;
        }
        ...
        if ( var_29 != "" )
            level.boss_fight_combat_cave[var_23] = var_29;
    }
...
getattachmentlistuniquenames()
{
    ...
    var_3 = scripts\mp\utility\game::getgametype() == "br" || level.mapname == "mp_firingrange";
...
{
    if ( !isdefined( level._id_12AA2 ) )
        packextrascore0();

    var_1 = level._id_12AA2[var_0];

    if ( isdefined( var_1 ) && var_1 == "t9" )
    {
        if ( !istrue( level._id_12981 ) )
            return 0;
...
buildweaponmap()
{
        ...
        if ( var_3 != "" )
        {
            ...
            if ( var_5 != "" )
            {
                ...
                if ( var_6 != "" )
                {
                    ...
                    if ( var_7 > -1 && playergetzombiespawnlocation( var_3 ) && !var_8 )
                    {
                        if ( !isdefined( level._id_12A96[var_5] ) )
                            level._id_12A96[var_5] = [];

                        level._id_12A96[var_5][level._id_12A96[var_5].size] = var_3;
                    }
                    else
                        level.weaponmapdata[var_3]._id_12513 = 1;
                }
            }
            ...
            if ( var_10 != "" )
                level.weaponmapdata[var_3].respawns_on_failed_unload = var_10;
    ...
    for (;;)
    {
        ...
        level.weaponlootmapdata[var_21].player_cam_disable = int( var_20 ) != 0 && int( var_23 ) == 99;
        level.weaponlootmapdata[var_21].play_bank_intro_vo = playergetzombiespawnlocation( var_3 );
            ...
            if ( isdefined( level.weaponlootmapdata[var_42] ) )
            {
                ...
                if ( var_41.size )
                {
                    foreach ( var_44 in var_41 )
                    {
                        ...
                        level.weaponlootmapdata[var_45].player_cam_disable = 1;
                        level.weaponlootmapdata[var_45].play_bank_intro_vo = 0;
                    }
...
{
    if ( isdefined( var_0 ) )
        var_0 scripts\engine\utility::_id_12913( var_2, "death_or_disconnect" );
...
weaponhasselectableoptic( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        if ( var_5 == "rail" )
        {
            ...
            if ( scripts\mp\utility\weapon::borntime( var_1, var_6 ) )
                return 1;
        }
    }
...
watchdropweapons()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_0 ) && isdefined( var_1 ) && !scripts\mp\utility\weapon::ismeleeonly( var_1 ) && !scripts\mp\utility\weapon::player_choppergunnericon( var_1 ) && !scripts\mp\utility\weapon::isknifeonly( var_1 ) )
        {
...
runcamoscripts( var_0 )
{
    ...
    if ( _id_12A97( var_0 ) )
        thread update_focus_fire_objective( var_0 );
    else
        self setscriptablepartstate( "activeCamo", "stage0" );
...
update_gamebattles_char_loc()
{
    ...
    foreach ( var_1 in level.players )
    {
        if ( isdefined( var_1 ) && isdefined( var_1.update_health_bar_to_player ) )
        {
            var_1.update_health_bar_to_player = undefined;
...
{
    var_0._id_11EDB = var_1;
    self setscriptablepartstate( "activeCamo", "stage" + var_0._id_11EDB );
}

update_hack_objective_marker( var_0 )
{
    if ( !isdefined( self.update_health_bar_to_player ) )
        self.update_health_bar_to_player = [];

    if ( !isdefined( self.update_health_bar_to_player[var_0] ) )
    {
        self.update_health_bar_to_player[var_0] = spawnstruct();
        self.update_health_bar_to_player[var_0].kills = 0;
        self.update_health_bar_to_player[var_0]._id_11EDB = 0;
    }
}
...
update_focus_fire_objective( var_0 )
{
    ...
    if ( !isdefined( level.update_game_cyber ) && !scripts\mp\flags::gameflag( "prematch_done" ) )
    {
        level.update_game_cyber = 1;
        level thread update_gamebattles_char_loc();
    }

    var_1 = _id_12A94( var_0 );
    update_hack_objective_marker( var_1 );
    var_2 = self.update_health_bar_to_player[var_1];
    update_goal_population( var_2, var_2._id_11EDB );
    ...
    while ( var_2._id_11EDB < var_4 )
    {
        scripts\engine\utility::waittill_either( "got_a_kill", "scr_advancereactivecamo" );
        var_6 = int( var_5[var_2._id_11EDB + 1] );
        var_2.kills++;

        if ( var_2.kills >= var_6 )
        {
            update_goal_population( var_2, var_2._id_11EDB + 1 );
...
player_disable_invulnerability( var_0 )
{
...
{
    time_reduction_bonus( "j_shoulder_ri", "teslaLimb" );
    time_reduction_bonus( "j_shoulder_le", "teslaLimb" );
    time_reduction_bonus( "j_elbow_ri", "teslaLimb" );
    time_reduction_bonus( "j_elbow_le", "teslaLimb" );
    time_reduction_bonus( "j_hip_ri", "teslaLimb" );
    time_reduction_bonus( "j_hip_le", "teslaLimb" );
    time_reduction_bonus( "j_knee_ri", "teslaLimb" );
    time_reduction_bonus( "j_knee_le", "teslaLimb" );
    time_reduction_bonus( "j_spineupper", "teslaTorso" );
    time_reduction_bonus( "j_head", "teslaHead" );
...
{
    time_reduction_bonus( "j_shoulder_ri", "8BitLimb" );
    time_reduction_bonus( "j_shoulder_le", "8BitLimb" );
    time_reduction_bonus( "j_elbow_ri", "8BitLimb" );
    time_reduction_bonus( "j_elbow_le", "8BitLimb" );
    time_reduction_bonus( "j_hip_ri", "8BitLimb" );
    time_reduction_bonus( "j_hip_le", "8BitLimb" );
    time_reduction_bonus( "j_knee_ri", "8BitLimb" );
    time_reduction_bonus( "j_knee_le", "8BitLimb" );
    time_reduction_bonus( "j_spineupper", "8BitTorso" );
    time_reduction_bonus( "j_head", "8BitHead" );
    self playsound( "8bit_death_sfx" );
    var_0 hide();
}

time_reduction_bonus( var_0, var_1 )
{
...
{
    if ( !isdefined( self.closeelevatordoors ) )
        self.closeelevatordoors = [];
    ...
    self.closeelevatordoors[jugg_pursue_players( var_1 )] = var_1;
    thread startburnfx();
}
...
disableburnfx( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
    {
        if ( self.closeelevatordoors[jugg_pursue_players( var_1 )] == var_1 )
            self.closeelevatordoors[jugg_pursue_players( var_1 )] = undefined;
    }
    else
        self.closeelevatordoors = [];

    if ( self.closeelevatordoors.size > 0 )
        thread startburnfx();
    else
    {
        thread stopburnfx();
...
clearburnfx()
{
    ...
    self.closeelevatordoors = undefined;
}
...
startburnfx()
{
    ...
    var_0 = kill_off_remaining_ai( self.closeelevatordoors );
...
_id_11972( var_0, var_1 )
{
    ...
    thread _id_11971( var_1, var_2 );
}

_id_11971( var_0, var_1 )
{
    var_0 scripts\cp_mp\utility\damage_utility::init_cp_execution();
    var_0 dodamage( var_0.maxhealth, var_1, self, undefined, "MOD_EXPLOSIVE", makeweapon( "semtex_mp" ) );
    var_0 scripts\cp_mp\utility\damage_utility::init_cp_vehicle();
}
