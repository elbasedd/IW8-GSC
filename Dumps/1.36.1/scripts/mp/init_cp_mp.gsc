...
killstreak_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistDataForceCredit", scripts\mp\killstreaks\killstreaks::_id_125F6 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "updateScrapAssistData", scripts\mp\killstreaks\killstreaks::_id_125F5 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "processScrapAssist", scripts\mp\events::trial_rpg_init );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayersInRange", scripts\mp\gametypes\br_killstreaks.gsc::extraction_balloon_total_plunder );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "killstreak", "dangerNotifyPlayer", scripts\mp\gametypes\br_killstreaks.gsc::extraction_balloon_num_completed );
}
...
entity_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "entity", "isGondolaBrush", scripts\mp\gametypes\br_gondola.gsc::phone_group_spawned );
}
...
player_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "freezeControlsDebug", scripts\mp\utility\player::activate_subway_track_trigger_hurt );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "getStanceTop", scripts\mp\utility\player::lb_mg_impulse_dmg_factor_low );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "loadout_finalizeWeapons", scripts\mp\class::raid_seq4_objectives_func );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isInLastStand", scripts\mp\utility\player::playbattlechattersound );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "player", "isPlayerOnIntelChallenge", scripts\mp\gametypes\br_maphints.gsc::player_helis );
}
...
game_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "getSubGameType", scripts\mp\utility\game::lb_mg_impulse_dmg_threshold_top );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "game", "brGetOperatorTeam", scripts\mp\gametypes\br_public.gsc::checked_missiles );
...
weapons_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getDefaultWeaponBaseName", scripts\mp\utility\weapon::justbecamehvt );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "attachmentIsSelectable", scripts\mp\utility\weapon::borntime );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "remapAttachmentParentName", scripts\mp\utility\weapon::vehicle_damage_setweaponhitdamagedataforvehicle );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "weapons", "getWeaponMenuCategory", scripts\mp\utility\weapon::level_carepackage_give_player_killstreak_incendiary_launcher );
}
...
sound_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "sound", "playKillstreakDeployDialog", scripts\mp\battlechatter_mp::times_shot );
...
rank_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "rank", "getBattlePassXPultiplierTotal", scripts\mp\rank::jugg_dmg_debug );
}
...
supers_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "supers", "combatRecordSuperMisc", scripts\mp\supers::dmg_trig );
}
...
cypher_vo_complete()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onVehicleKilled", scripts\cp\agents\gametype_cp_specops::vehiclekilled );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onFieldUpgradeEnd", scripts\cp\agents\gametype_cp_specops::short_term_goal );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onKillStreakEnd", scripts\cp\agents\gametype_cp_specops::should_enter_combat_after_checking_throwingknife );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "resetChallengeTimer", scripts\cp\agents\gametype_cp_specops::vehomn_updaterotationomnvarsperframeforclient );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "startChallengeTimer", scripts\cp\agents\gametype_cp_specops::_id_11FAA );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "stopChallengeTimer", scripts\cp\agents\gametype_cp_specops::_id_12022 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "challenges", "onPing", scripts\cp\agents\gametype_cp_specops::should_use_velo_forward );
}

_id_1218E()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "team_utility", "init", scripts\mp\utility\teams::_id_1218F );
}
