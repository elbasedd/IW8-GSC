...
missilelauncherusage()
{
    ...
    if ( self.missilelauncherstage == 1 )
    {
        ...
        if ( !var_1 && ( self.missilelaunchertarget scripts\cp_mp\vehicles\vehicle::isvehicle() && scripts\cp_mp\vehicles\vehicle::_id_1275C( self.missilelaunchertarget, self ) ) )
        {
            resetmissilelauncherlocking();
            return;
        }
...
stingtargstruct_getoffsets()
{
    ...
    else if ( scripts\mp\utility\entity::play_alarms_onto( self.target ) )
    {
        self.offsets[self.offsets.size] = ( 0, 0, 10 );
        self.useoldlosverification = 0;
    }
    ...
    else if ( isdefined( self.target.vehiclename ) && ( self.target.vehiclename == "cargo_truck" || self.target.vehiclename == "cargo_truck_mg" || self.target.vehiclename == "payload_truck_mg" ) )
    {
        self.offsets[self.offsets.size] = ( 0, 0, 60 );
        self.useoldlosverification = 0;
    }
