...
infil_init()
{
    ...
    if ( game["roundsPlayed"] > 0 || getdvarint( "scr_skip_infils", 0 ) == 1 || getdvarint( "scr_game_infilSkip", 0 ) == 1 || scripts\mp\utility\game::getgametype() == "br" || getdvarint( "scr_game_matchstarttime" ) < 15 || scripts\mp\utility\game::getgametype() == "war" && scripts\cp_mp\utility\game_utility::play_players_arrive_at_exfil() )
    {
        game["infil"] = undefined;
    ...
    if ( scripts\mp\gamelogic::_id_11BCF() )
...
player_join_infil()
{
    ...
    thread difficulty_update_time();
    player_ai_fill();
}

difficulty_update_time()
{
    self endon( "disconnect" );
...
infil_player_rig( var_0, var_1, var_2 )
{
    ...
    scripts\engine\utility::_id_128FF( "remove_rig", "player_free_spot" );
...
heli_wait_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.radius ) )
    {
        ...
        scripts\engine\utility::_id_128FF( "near_goal", "goal" );
    }
    else
        self waittill( "goal" );
