...
handlesplashqueue()
{
    ...
    {
        if ( scripts\mp\utility\game::getgametype() == "br" && ( scripts\mp\utility\game::lb_mg_impulse_dmg_threshold_top() == "dmz" || scripts\mp\utility\game::lb_mg_impulse_dmg_threshold_top() == "risk" ) )
            scripts\engine\utility::_id_128FF( "splash_list_cleared", "can_show_splashes" );
        else
            scripts\engine\utility::_id_128FF( "splash_list_cleared", "spawned_player" );
