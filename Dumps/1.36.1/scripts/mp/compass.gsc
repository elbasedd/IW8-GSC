...
setupminimap( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( scripts\cp_mp\utility\game_utility::getlocaleid() ) && scripts\mp\utility\game::getgametype() != "war" && !scripts\cp_mp\utility\game_utility::play_players_arrive_at_exfil() )
    {
    ...
    else if ( scripts\cp_mp\utility\game_utility::play_players_arrive_at_exfil() || scripts\cp_mp\utility\game_utility::getmapname() == "mp_br_quarry" )
    {
        var_4 = [];
