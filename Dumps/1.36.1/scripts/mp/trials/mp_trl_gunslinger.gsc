...
woods_one_death_func( var_0, var_1, var_2 )
{
...
withinprojectiondistance( var_0 )
{
    ...
    {
        var_1 = "bash_left_90";
        var_2 = self.disablearmorykiosk + ( 0, 90, 0 );
    }
    else
    {
        var_1 = "bash_right_90";
...
woods_three_death_func( var_0 )
{
    if ( self == var_0 )
        return 0;

    var_1 = self.disablebunker11cachelocations;
    var_2 = var_0.disablebunker11cachelocations;
...
getaltbunkerkeypadindexforscriptable()
{
