...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "circle_peek", ::_id_1246D, undefined, ::_id_12459 );
    var_0 = "circle_peak";
...
_id_12459()
{
    var_0 = scripts\cp_mp\utility\killstreak_utility::createstreakinfo( "circle_peek", self );
    var_0._id_11C6D = 1;
    return _id_1246D( var_0, 1 );
}

_id_1246D( var_0, var_1 )
{
    ...
    var_4 = delete_script_object( var_0 );
...
delete_script_object( var_0 )
{
    ...
    var_1 = level._id_121B5[self.team] + level.br_circle.circleindex + 1;

    for ( var_2 = var_1; var_2 < level.delete_smoke_fx.size; var_2++ )
        scripts\mp\gametypes\br_quest_util.gsc::turretoverridefunc( self.team );
