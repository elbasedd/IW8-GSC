...
script_end()
{
    ...
    var_0.destroycallback = ::screenent_d;
    script_struct_add();
    script_model_spawn_and_use();
    script_struct_autotarget();
    script_gameobjetname();
    script_gameobject();
    script_model_pilot_kill_watch();
...
script_model_spawn_and_use()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::_id_12742( "motorcycle", "single", [ "driver", "rear" ] );
}

script_struct_autotarget()
{
    var_0 = scripts\cp_mp\utility\vehicle_omnvar_utility::_id_127F7( "motorcycle", 1 );
    var_0.id = 20;
...
script_gameobjetname()
{
    scripts\cp_mp\vehicles\vehicle_damage::_id_12715( "motorcycle", 500 );
    var_0 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getleveldataforvehicle( "motorcycle" );
    var_0.class = "super_light";
    scripts\cp_mp\vehicles\vehicle_damage::_id_126E9( "motorcycle" );
    scripts\cp_mp\vehicles\vehicle_damage::_id_12721( "motorcycle", 4 );

    if ( level.gametype == "br" )
        scripts\cp_mp\vehicles\vehicle_damage::_id_12722( "motorcycle", 6, "semtex_aalpha12_mp" );

    scripts\cp_mp\vehicles\vehicle_damage::_id_1271A( "motorcycle", ::scrapassistdamage );
}

script_gameobject()
{
    var_0 = scripts\mp\trials\trial_gun_course::_id_126BB( "motorcycle", 1 );
    ...
    var_0.extra_glow_sticks_init = 12.5;
    var_0.extra_riders_func = 50;
    var_0.extra_enemies = 100;
    var_0.extract_removemissionweapon = 0;
    var_0.extractcallback = 0;
    var_0.extract_ontimerexpired = 1;
    var_1 = scripts\mp\trials\trial_gun_course::_id_126BA();
    var_1.flashtheprops["motorcycle"] = [];
    var_1.flashtheprops["motorcycle"]["cargo_truck"] = 2;
}

script_model_pilot_kill_watch()
{
    level._effect["motorcycle_explode"] = loadfx( "vfx/iw8/veh/scriptables/vfx_veh_explosion_atv.vfx" );
}
...
scrambler_cleanup_player( var_0, var_1 )
{
    ...
    scripts\cp_mp\vehicles\vehicle::_id_126E4( var_2, "motorcycle", var_0 );
...
scrapassistdamage( var_0 )
{
    thread screenent_d( var_0 );
    return 1;
}

screenent( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
        screenent_a( var_0, var_1, var_2, var_3, var_4 );
}
...
screenent_b( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_4.success ) )
        screenent_c( var_0, var_1, var_2, var_3, var_4 );
}
...
scriptable_addautousecallback()
{
    ...
    var_0.priority = 75;
    var_0.getspawnstructscallback = ::script_deplay_post;
