...
_id_1270C()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveScore", ::_id_126FF );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "giveAward", ::_id_126FE );
}

_id_126FF( var_0, var_1, var_2 )
{
    if ( istrue( var_2 ) )
