...
_id_1248D()
{
    if ( isdefined( level._id_12489 ) )
        level.player scripts\mp\equipment::giveequipment( level._id_12489, "primary" );

    if ( isdefined( level._id_1248B ) )
        level.player scripts\mp\equipment::giveequipment( level._id_1248B, "secondary" );
...
enemy_move_and_cover( var_0 )
{
    ...
    while ( isalive( var_0 ) )
    {
        if ( isdefined( var_6 ) )
        {
            ...
            var_0 scripts\engine\utility::_id_143A7( "goal", "badpath", "grenade danger", "bullet_whizby" );
