...
init_trial_patches()
{
    ...
    switch ( level.trial["missionScript"] )
    {
        ...
        case "pitcher":
            break;
        case "race":
            level._id_142A5 = loadfx( "vfx/core/mp/core/vfx_flare_glow_en.vfx" );
            level._id_14297 = loadfx( "vfx/iw7/levels/europa/vfx_eu_icecave_flare_01.vfx" );
...
_id_11DCC()
{
    ...
    else if ( level.trial["missionScript"] == "race" )
    {
        ...
        {
            level._id_13D5B = 1;
            level._id_13D3A = "trialympic_dogtag";
            return;
        }
...
_id_11DE7( var_0, var_1, var_2 )
{
    if ( var_0 == "clear" )
    {
        ...
        level._id_12489 = "equip_frag";
        level._id_1248B = "equip_flash";
        level._id_1248A = 1;
...
_id_11DD7()
{
    ...
    register_create_script_arrays( "mp_harbor_floorislava_create_script", "mp_harbor_trial_floor_is_lava", _maphint_offerscriptableused::main );
}
...
_id_11DCA()
{
    ...
    level._id_12489 = "equip_c4";
    level._id_1248B = "equip_thermite";
    level._id_1248A = 1;
    level._id_124C9 = 1;
    level._id_13D59 = [];
    level._id_13D59 = scripts\engine\utility::array_add( level._id_13D59, "specialty_fastreload" );
    level._id_13D3F = 1;
    level._id_13D41 = 1;
    thread scripts\mp\trials\mp_trl_cleararea::init_trap_room_debug();
...
_id_11DED( var_0, var_1 )
{
    if ( var_1 == "gunslinger" || var_1 == "pitcher" )
    {
        ...
        if ( var_0 == "reflex" && _tablethide::_id_13D4C() )
        {
...
_id_11DDB( var_0 )
{
    if ( var_0 == "lava" )
    {
        ...
        register_create_script_arrays( "mp_m_cornfield_floor_is_lava_create_script", "mp_m_cornfield_trial_floor_is_laval", _maphint_phonescriptableused::main );
    }
    else
    {
        ...
        foreach ( var_4 in var_1 )
        {
            if ( isdefined( var_4.script_noteworthy ) )
            {
                if ( int( var_4.script_noteworthy ) == var_2 )
                {
                    ...
                    playfxontag( level._id_14297, var_4, "j_top" );
                }
            }
        }
...
player_isusingtacmap( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( istrue( var_1 ) )
        {
            var_5._id_1341F = spawn( "script_model", var_5.origin );
            var_5._id_1341F.angles = var_5.angles;
            var_5._id_1341F setmodel( "tag_origin" );
            var_5._id_1341F linkto( var_6, "tag_fire_fx", ( 1, 0, 0 ), ( 90, 0, 0 ) );
        }
    }
    ...
    for (;;)
    {
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            if ( istrue( var_1 ) )
                playfxontag( level._effect["trial_smoke"], var_5._id_1341F, "tag_origin" );
        }
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            if ( istrue( var_1 ) )
                stopfxontag( level._effect["trial_smoke"], var_5._id_1341F, "tag_origin" );
        }
    }
}
...
_id_13D6D()
{
    ...
    level._id_13D9B = getentarray( "trial_flames", "targetname" );
...
{
    level._id_13D2A = getentarray( "trial_celebration_flares", "targetname" );
    level._id_13D3C = getentarray( "trial_end_flares", "targetname" );
    ...
    for (;;)
    {
        ...
        {
            level._id_13D7F = getomnvar( "ui_trial_reward_tier" );
...
_id_13D58( var_0 )
{
    ...
    if ( isdefined( var_0 ) && var_0 == "0" && level._id_13D7F >= 3 )
    {
        wait 2;
        playfxontag( scripts\engine\utility::getfx( proptiebreaker() ), self, "j_top" );
    }
