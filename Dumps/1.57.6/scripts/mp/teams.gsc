...
lookupcurrentoperator( var_0 )
{
    ...
    if ( getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && !isagent( self ) && self calloutmarkerping_getactive() )
    {
...
getjointeampermissions( var_0 )
{
    ...
    if ( level.maxteamsize == 0 || var_1 < level.maxteamsize )
        ...
        return 1;
    else if ( scripts\mp\utility\game::getgametype() == "br" && ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "rat_race" || getdvar( "scr_br_gametype", "" ) == "risk" ) )
        return 1;
    else
    {
