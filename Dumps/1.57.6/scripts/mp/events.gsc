...
cargo_truck_mg_initoccupancy( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) && !scripts\mp\utility\perk::_hasperk( "specialty_explosivebullets" ) )
    {
        ...
        var_24 = isdefined( var_4 ) && istrue( var_4.isequipment ) && isdefined( var_4.equipmentref ) && var_4.equipmentref == "equip_throwing_knife";
        ...
        if ( var_10 || var_24 || var_25 )
        {
            ...
            switch ( var_26 )
            {
                ...
                case "longshot":
                    ...
                    self setclientomnvar( "ui_longshot_dist", var_27 );
                    self setclientomnvar( "ui_longshot_special", update_future_stations_track_timers( var_11, var_1, var_2 ) );
                    break;
                case "very_longshot":
                    self.modifiers["longshot"] = 1;
                    self.modifiers["mask"] = self.modifiers["mask"] | 262144;
        ...
        if ( isdefined( var_4 ) && isdefined( var_4.equipmentref ) )
        {
            if ( var_4.equipmentref == "equip_c4" || var_4.equipmentref == "equip_claymore" )
            {
                ...
                if ( isdefined( var_45 ) && isdefined( var_45.helperdronetype ) && var_45.helperdronetype == "radar_drone_recon" )
                {
    ...
    {
        var_48 = scripts\mp\utility\teams::getteamdata( self.team, "players" );
        ...
        foreach ( var_54, var_50 in var_1.damagedplayers )
        {
            if ( !istrue( var_47 ) )
            {
                foreach ( var_52 in var_48 )
                {
                    ...
                    {
                        if ( var_7 == "weapon_sniper" && isalive( var_52 ) && var_52.team == self.team && var_6 - var_50 < 1750 )
                        {
...
_id_13FE5( var_0, var_1, var_2 )
{
    ...
    var_3.victim = var_2;
    var_3._id_11A6C = 1;
    scripts\mp\gametypes\br_challenges.gsc::getallspawninstances( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::getallspawninstances( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::getallspawninstances( "br_mastery_ghostRideWhip", var_3 );
}
...
getgulagclosedcircleindex( var_0 )
{
    ...
    if ( level.gameended )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges.gsc::getallspawninstances( "br_mastery_roundKillExecute", var_2 );
        }
    }
