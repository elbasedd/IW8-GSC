...
traceselectedmaplocation()
{
    ...
    if ( getdvarint( "scr_br_alt_mode_escape", 0 ) != 0 )
    {
        ...
        var_29 = [ "br3_plunder_tenpercent_1", "br3_plunder_tenpercent_2", "br3_plunder_tenpercent_3", "br3_plunder_tenpercent_4", "br3_plunder_tenpercent_5" ];
    ...
    if ( var_2 == "zxp" || var_2 == "gxp" )
    {
        ...
        var_7 = [ "zxp_plane_jump_01", "zxp_plane_jump_02", "zxp_plane_jump_03", "zxp_plane_jump_04", "zxp_plane_jump_05" ];
        var_8 = [ "zxp_plane_jump_parachute_01", "zxp_plane_jump_parachute_02", "zxp_plane_jump_parachute_03", "zxp_plane_jump_parachute_04", "zxp_plane_jump_parachute_05" ];
        _id_13175( "br_lobby_intro", var_4 );
        _id_13175( "br_lobby_outro", var_5 );
        _id_13175( "br_infil_intro", var_6 );
        _id_13175( "br_infil_jump", var_7 );
    ...
    {
        if ( var_2 == "payload" || var_2 == "dmz" || var_2 == "rat_race" || getdvarint( "scr_br_alt_mode_escape", 0 ) != 0 )
            return;
...
ongameended()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" && scripts\mp\utility\game::round_vehicle_logic() != "dmz" && scripts\mp\utility\game::round_vehicle_logic() != "rat_race" && scripts\mp\utility\game::round_vehicle_logic() != "risk" && scripts\mp\utility\game::round_vehicle_logic() != "kingslayer" && scripts\mp\utility\game::round_vehicle_logic() != "rumble" )
        return;
