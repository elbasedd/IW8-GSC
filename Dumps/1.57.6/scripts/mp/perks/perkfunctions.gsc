...
updatedefaultflinchreduction()
{
    ...
    else if ( var_1 == 2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
            var_0 = getdvarfloat( "scr_marksman_flinchscalar", 0.08 );
        else
            var_0 = 0.08;
    }
    else if ( var_1 == 3 )
...
setviewkickoverride()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        self._id_1218E = getdvarfloat( "scr_marksman_flinchscalar", 0.08 ) * getdvarfloat( "scr_br_focusperk_scalar", 0.8 );
    else
        self._id_1218E = 0.02;
...
sixthsense_think_internal()
{
    ...
    foreach ( var_28, var_8 in level.sixth_sense_players )
    {
        ...
        if ( scripts\mp\gametypes\br_gametypes.gsc::tutorial_showtext( "sixthSenseThink" ) )
            var_9 = var_9 | scripts\mp\gametypes\br_gametypes.gsc::_id_12E05( "sixthSenseThink", var_8 );
...
rechargeequipment_updateslot( var_0, var_1 )
{
    ...
    if ( isdefined( level.playerzombiewaittillinputreturn ) )
        ...
        var_8 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", 0.02, 0.02 );
...
rechargeequipment_updateui( var_0 )
{
    ...
    var_0 trajectoryupdateoriginandangles( "primary", var_1 );
    var_0 trajectoryupdateoriginandangles( "secondary", var_2 );
}
...
_id_14022( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::rewardangles( var_0 );
    ...
    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util.gsc::battletracksmusicstate( var_0, var_3 );
...
_id_13716()
{
    ...
    self._id_11B14 = 1;
    self iprintlnbold( &"PERKS_WZ335/SERPENTINE_DR_MSG" );
    self playlocalsound( "br_perk_advanced_scout_marking_resist_plr", self );
    wait 1.0;
    self._id_11B14 = undefined;
}
