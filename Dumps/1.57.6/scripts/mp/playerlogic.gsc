...
_id_119CD()
{
    ...
    var_20 = _func_042D();
    self dlog_recordplayerevent( "dlog_event_player_match_start", [ "utc_connect_time_s", self.pers["utc_connect_time_s"], "gamertag", self.name, "team", self.sessionteam, "join_type", self getjointype(), "is_bot", var_0, "skill", self getskill(), "party_id", self isguest(), "is_party_host", var_19, "ip_a", var_14[0], "ip_b", var_14[1], "ip_c", var_14[2], "ip_d", var_14[3], "is_guest", self getmissilevelocity(), "start_xp", var_1, "start_kills", var_2, "start_deaths", var_3, "start_wins", var_4, "start_losses", var_5, "start_hits", var_6, "start_misses", var_7, "start_wall_bangs", var_8, "start_nearmisses", var_9, "start_games_played", var_10, "start_time_played_total", var_11, "start_score", var_12, "start_prestige", var_13, "operator_allies", var_15[0], "operator_axis", var_15[1], "operator_allies_skin", var_16[0], "operator_axis_skin", var_16[1], "operator_allies_execution_ref", var_17[0], "operator_axis_execution_ref", var_17[1], "is_headless", self calloutmarkerping_getactive(), "playlist_name", var_20, "mm_party_id", self _meth_87C3() ] );
}
...
callback_playerconnect()
{
    ...
    if ( !isdefined( self.pers["team"] ) )
    {
        ...
        else if ( ( scripts\mp\utility\game::matchmakinggame() || scripts\mp\utility\game::lobbyteamselectenabled() || isgamebattlematch() ) && self.sessionteam != "none" )
        {
            ...
            if ( ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "rat_race" || getdvar( "scr_br_gametype", "" ) == "risk" ) && getdvarint( "scr_br_manual_team_assignment", 0 ) == 1 )
...
totaldisttracking( var_0 )
{
    ...
    for (;;)
    {
        var_4 = scripts\engine\utility::_id_143BD( 5.0, "death", "vehicle_enter", "vehicle_change_seat", "vehicle_exit", "afk_tracking_resume" );
