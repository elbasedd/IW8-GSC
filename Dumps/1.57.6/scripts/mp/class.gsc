...
zone_get_node_nearest_2d_bounds( var_0, var_1 )
{
    ...
    else
    {
        ...
        else if ( !isagent( self ) && self calloutmarkerping_getactive() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
            zoomkey( var_0 );
        else
        {
...
loadout_updateclassdefault( var_0, var_1 )
{
    ...
    if ( !isagent( self ) && self calloutmarkerping_getactive() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 )
        zoomkey( var_0 );
    else
...
{
    if ( !isagent( self ) && self calloutmarkerping_getactive() && getdvarint( "scr_forceHeadlessCustomization", 1 ) == 1 && scripts\mp\utility\game::getgametype() != "br" )
