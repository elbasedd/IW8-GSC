...
setselectedkillstreak( var_0 )
{
    ...
    if ( scripts\mp\utility\game::unset_relic_grounded() )
    {
        ...
        scripts\mp\gametypes\br_public.gsc::updatebrscoreboardstat( "selectedKillstreakId", var_2 );
    }
}
...
clearkillstreakselection()
{
    ...
    if ( scripts\mp\utility\game::unset_relic_grounded() )
        scripts\mp\gametypes\br_public.gsc::updatebrscoreboardstat( "selectedKillstreakId", 0 );
}
