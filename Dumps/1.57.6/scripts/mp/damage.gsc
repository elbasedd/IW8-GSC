...
callback_playerdamage_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15 )
{
    ...
    else
    {
        ...
        if ( isdefined( var_26 ) )
        {
            ...
            else if ( var_26 == "equipment_other" )
            {
        ...
        if ( isplayer( var_1 ) && ( var_25 == "smoke_grenade_mp" || scripts\mp\utility\weapon::isthrowingknife( var_25 ) ) )
            var_1 thread scripts\mp\gamelogic::threadedsetweaponstatbyname( var_25, 1, "hits" );
        ...
        if ( isdefined( var_1 ) && ( isplayer( var_1 ) || istrue( var_1.brking_getcenterofcircle ) ) && scripts\mp\utility\game::getgametype() == "br" )
        {
        ...
        if ( isplayer( var_1 ) && var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ping_on_damage" ) && var_33 >= var_39 )
        {
        ...
        {
            if ( var_5 == "MOD_RIFLE_BULLET" || var_5 == "MOD_PISTOL_BULLET" || var_5 == "MOD_FIRE" || var_5 == "MOD_EXPLOSIVE" )
            {
                if ( var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_sprinting_dr" ) && ( var_2 issprinting() || var_2 issupersprinting() || var_2 issprintsliding() ) )
                {
                    var_40 = var_3;
                    var_3 = int( var_40 * getdvarfloat( "scr_perk_serpentine_drmod", 0.85 ) );
...
postplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16 )
{
    ...
    if ( isdefined( var_1 ) && var_3 > 0 )
    {
        ...
        if ( isplayer( var_2 ) && isplayer( var_1 ) )
            scripts\mp\gametypes\br_alt_mode_ff.gsc::play_animation_old( var_1, var_2 );
    }
...
{
    scripts\engine\utility::_id_143B9( 2.0, "death_or_disconnect" );
    var_0 destroy();
}
...
_id_1458B( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    {
        if ( istrue( level.disable_super_in_turret._id_146BF ) && var_7 == "iw8_fists_mp_zmb" || istrue( level.disable_super_in_turret.sat_wait_for_antenna ) && var_7 == "iw8_fists_mp_gxp" )
            return 1;
    }
...
cac_modified_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( scripts\engine\utility::isbulletdamage( var_3 ) )
    {
        ...
        if ( scripts\mp\utility\weapon::update_health_on_spawn( var_18 ) && scripts\mp\utility\game::getgametype() == "br" )
            var_2 = var_2 * scripts\mp\gametypes\br_jugg_common.gsc::reservedplacement();
        ...
        if ( isdefined( var_1 ) && isdefined( var_1._id_14258 ) && var_1._id_14258 == "loot_chopper" )
            var_2 = int( var_2 / 3 );
    }
    ...
    if ( isplayer( var_1 ) || isdefined( var_1 ) && istrue( var_1.brking_getcenterofcircle ) )
    {
        var_47 = var_0 scripts\mp\gametypes\br_public.gsc::hasarmor();
        var_48 = var_0 scripts\mp\gametypes\br_public.gsc::hashelmet();
...
_id_11C90( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_4 ) && var_4 scripts\mp\utility\killstreak::isjuggernaut() && scripts\mp\utility\game::getgametype() == "br" )
        var_6 = scripts\mp\gametypes\br_jugg_common.gsc::remove_spawners_that_can_be_seen();
...
handledamagefeedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 != var_2 && var_3 + var_8 + var_9 > 0 && ( !isdefined( var_6 ) || var_6 != "shield" ) )
    {
        ...
        if ( var_2 scripts\mp\utility\perk::_hasperk( "specialty_pistoldeath" ) && isdefined( var_2.inlaststand ) && var_2.inlaststand == 1 && !var_2.hasshownlaststandicon )
        {
            ...
            var_13 = "hitarmorreinforced";
        else if ( var_8 == 0 && var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_serpentine" ) )
...
lethalequipmentdamagemod( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_1 scripts\common\utility::_id_13E0A( level._id_11B31, scripts\mp\utility\weapon::getweaponrootname( var_6 ), "damage", min( var_2.health, var_3 ), -1, var_6 );
    return var_3;
}
...
playerkilled_sharedlogic_early( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        ...
        {
            var_2 scripts\cp\vehicles\vehicle_compass_cp::_id_138D5( "alive_in_gas" );
            var_2 scripts\cp\vehicles\vehicle_compass_cp::_id_138D5( "alive_not_downed" );

            if ( istrue( level.br_prematchstarted ) && !scripts\mp\gametypes\br_public.gsc::isplayeringulag() )
                scripts\mp\gametypes\br_analytics.gsc::destroyscorelaunchonly( self, "player_death" );
        }
    }
        ...
        if ( isdefined( var_1.bulletkillsinaframecount ) && var_1.bulletkillsinaframecount == 0 )
        {
            ...
            if ( isplayer( var_1 ) )
            {
                if ( var_4 hasattachment( "gunperk_driller" ) )
                {
                    ...
                    var_1 thread scripts\mp\utility\points::sec_sys_struct_1( "penetration_kill", var_19 );
                }
                else
                    var_1 thread scripts\mp\utility\points::sec_sys_struct_1( "penetration_kill" );
            }
        }
    }
    ...
    if ( level.gametype == "br" )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            var_21 = scripts\mp\gametypes\br_public.gsc::round_enemy_stuck_logic( var_2.team, var_2.squadindex );
        ...
        if ( isdefined( var_1 ) && isplayer( var_1 ) )
        {
            var_22 = scripts\mp\gametypes\br_public.gsc::round_enemy_stuck_logic( var_1.team, var_1.squadindex );
        ...
        if ( var_20.size > 0 )
        {
            var_23 = scripts\engine\utility::ter_op( scripts\cp_mp\vehicles\vehicle::_id_14104( var_0 ), "MOD_EXPLOSIVE", var_18 );

            if ( getdvarint( "scr_br_alt_mode_zxp", 0 ) || getdvarint( "scr_br_alt_mode_gxp", 0 ) )
                var_23 = scripts\mp\gametypes\br_gametype_zxp.gsc::_id_11BA8( var_0, var_23 );
...
playerkilled_deletecorpseoutofvehicle( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_1 scripts\engine\utility::_id_143B9( var_3, "death" );
...
handlenormaldeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    scripts\mp\gametypes\br_alt_mode_ff.gsc::play_airport_success_vo( var_1 );
    scripts\mp\gametypes\br_gametype_respect.gsc::_id_12CBA( var_1 );
    ...
    if ( !istrue( var_12.pers["ignoreWeaponMatchBonus"] ) && ( scripts\mp\utility\weapon::iscacprimaryweapon( var_3 ) || scripts\mp\utility\weapon::iscacsecondaryweapon( var_3 ) ) )
    {
        ...
        else
        {
            ...
            foreach ( var_17, var_16 in var_12.pers["killsPerWeapon"] )
            {
                if ( var_17 == var_13 )
                {
                    var_16.killcount++;
            ...
            if ( !var_14 )
            {
                ...
                var_16._id_1213C = var_12.pers["killsPerWeapon"].size;
            ...
            foreach ( var_42 in level.supportdrones )
            {
                ...
                if ( var_42.helperdronetype == "scrambler_drone_guard" )
                {
                    ...
                    if ( isdefined( var_42.owner ) && var_1 == var_42.owner )
                    {
                        ...
                        {
                            var_1 scripts\cp\vehicles\vehicle_compass_cp::_id_12C3F( "t9_ch_global_kill_scrambled_enemies_s1", 1 );
                            continue;
                        }
...
_id_12AA2( var_0, var_1, var_2, var_3 )
{
    if ( _id_1331E( self ) )
    {
        ...
        if ( scripts\mp\codcasterclientmatchdata::shouldlogcodcasterclientmatchdata() )
        {
            if ( isplayer( var_0 ) )
            {
                var_0 scripts\common\utility::_id_13E0A( level._id_11B31, scripts\mp\utility\weapon::getweaponrootname( var_3 ), "damage", min( self.health, var_2 ), -1, var_3 );
...
finishplayerdamagewrapper( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( _id_1331E( self ) )
    {
        ...
        if ( var_13 > 1000 )
            scripts\mp\gametypes\br_analytics.gsc::determine_starting_breadcrumb( self, var_13, var_4 );
    }
...
callback_playerlaststand( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
        ...
        if ( !var_11.isfriendlyfire && var_1 != self )
        {
            if ( scripts\mp\utility\game::getgametype() == "br" )
            {
                if ( isplayer( var_1 ) && var_1 != self )
                {
                    ...
                    if ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "rat_race" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "rumble" && getdvar( "scr_br_gametype", "" ) != "kingslayer" && level.teamdata[self.team]["alivePlayers"].size > 0 )
                        obituary( self, var_1, var_4, "MOD_DOWN", level.teamdata[var_1.team]["alivePlayers"] );
                }

                if ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "rat_race" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "kingslayer" && getdvar( "scr_br_gametype", "" ) != "rumble" )
                {
    ...
    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "rat_race" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder.gsc::_id_12781( self, 0, 1 );
...
enqueueweapononkillcorpsetablefuncs( var_0, var_1, var_2, var_3, var_4 )
{
    if ( scripts\mp\weapons::update_icon_for_bomb_case_detonator_holder( var_3 ) )
        enqueuecorpsetablefunc( "8bitDeath", scripts\mp\weapons::_id_11DF5 );
    else if ( scripts\mp\weapons::update_jugg_targets( var_3 ) )
        enqueuecorpsetablefunc( "teslaDeath", scripts\mp\weapons::_id_11DF6 );
}
...
_id_119C0( var_0, var_1, var_2, var_3 )
{
    ...
    var_1 scripts\common\utility::_id_13E0A( level._id_11B31, scripts\mp\utility\weapon::getweaponrootname( var_1.currentweapon ), "friendly_fire_damage", int( min( var_2, var_0.health ) ), -1, var_1.currentweapon );
