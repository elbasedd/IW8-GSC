    ...
    if ( var_0 < 200 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            ...
            if ( scripts\mp\utility\game::round_vehicle_logic() == "dmz" || scripts\mp\utility\game::round_vehicle_logic() == "rat_race" || scripts\mp\utility\game::round_vehicle_logic() == "risk" )
            {
                ...
                var_17 = scripts\mp\gametypes\br_gametype_dmz.gsc::_id_121B4();
            ...
            else if ( scripts\mp\utility\game::round_vehicle_logic() == "kingslayer" )
            {
                var_15 = scripts\mp\gamescore::run_common_functions_stealth();
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_kingslayer.gsc::_id_121B4();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;
            ...
            else if ( scripts\mp\utility\game::round_vehicle_logic() == "treasure_hunt" )
            {
                if ( isdefined( self._id_13AB8 ) )
                    setclientmatchdata( "players", self.clientmatchdataid, "placement", self._id_13AB8 );

                var_17 = scripts\mp\gametypes\br_gametype_treasure_hunt.gsc::_id_121B2();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
            }
            else if ( scripts\mp\utility\game::round_vehicle_logic() == "rebirth" )
            {
                if ( isdefined( self._id_13AB8 ) )
                    setclientmatchdata( "players", self.clientmatchdataid, "placement", self._id_13AB8 );

                var_17 = scripts\mp\gametypes\br_gametype_rebirth.gsc::end_health();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
            }
            else if ( scripts\mp\utility\game::round_vehicle_logic() == "rebirth_reverse" )
            {
