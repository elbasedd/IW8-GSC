        ...
        foreach ( var_7 in level.teamnamelist )
        {
            ...
            if ( var_27 == 1 || var_27 == 2 )
            {
                ...
                if ( var_28 == 0 )
                {
                    ...
                    else if ( getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "rat_race" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "kingslayer" && getdvar( "scr_br_gametype", "" ) != "rumble" && var_27 == 2 && var_30.size > 2 )
                    {
...
_id_128AF( var_0 )
{
    ...
    if ( getdvarint( "MTKSQRQLKN" ) != 0 )
    {
        ...
        setclientmatchdata( "players", var_0.clientmatchdataid, "nameSuffix", var_0 _meth_87D1() );
...
{
    return isdefined( var_0 ) && ( var_0 == "dmz" || var_0 == "rat_race" || var_0 == "risk" || var_0 == "kingslayer" || var_0 == "rumble" || var_0 == "payload" || var_0 == "carpoc" );
}
