...
_id_11A41( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::tutorial_showtext( "pickupModifyCount" ) )
        var_14 = scripts\mp\gametypes\br_gametypes.gsc::_id_12E07( "pickupModifyCount", var_0, var_4, var_14, var_1 );

    if ( isdefined( self.intro_moveplayercliphack ) )
        var_14 = [[ self.intro_moveplayercliphack ]]( var_0, var_14 );

    var_16 = scripts\mp\gametypes\br_pickups.gsc::relics_monitor_on_player( var_0 );
...
lootcacheused( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( ( var_2 == "closed" || var_2 == "closed_nocol" ) && !isdefined( var_0.entity ) )
    {
        ...
        var_5 = scripts\mp\gametypes\br_vip_quest.gsc::getplayervipquest( var_3 );

        if ( isdefined( var_5 ) )
        {
            var_3 thread scripts\mp\events::killeventtextpopup( "br_vip_loot", 0, 0 );
            var_5 scripts\mp\gametypes\br_quest_util.gsc::questtimersubtract( getdvarint( "scr_br_VIP_cacheTimeReduction", 5 ) );
        }
...
allow_forward_factor( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    {
        var_12 = ( 0, 0, 0 );
        var_13 = "mp/loot_set_cache_contents_base.csv";

        if ( getdvarint( "scr_br_alt_mode_cash", 0 ) )
            var_13 = "mp/loot_set_cache_contents_base_cash.csv";
        else if ( getdvarint( "scr_br_alt_mode_gg", 0 ) )
            var_13 = "mp/loot_set_cache_contents_base_gg.csv";
        else if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "rat_race" || getdvar( "scr_br_gametype", "" ) == "risk" )
        {
            var_12 = ( 0, 45, 0 );

            if ( var_0.type == "br_loot_cache_lege" )
                var_13 = "mp/loot_set_cache_contents_lege_dmz_ground_tablets.csv";
            else if ( var_0.type == "br_loot_cache" )
                var_13 = "mp/loot_set_cache_contents_rare_dmz_ground_tablets.csv";
        }

        var_14 = var_0 chooseandspawnitems( 2, 1, "weapon", var_13, var_12 );
        var_5[var_5.size] = var_14[0];
        var_14 = var_0 chooseandspawnitems( 0, 1, "ammo", var_13, var_12 );
        var_5[var_5.size] = var_14[0];
        var_14 = var_0 chooseandspawnitems( 0, 1, undefined, var_13, var_12 );
        var_5[var_5.size] = var_14[0];
        var_14 = var_0 chooseandspawnitems( 0, 1, undefined, var_13, var_12 );
        var_5[var_5.size] = var_14[0];
        var_14 = var_0 chooseandspawnitems( 2, 1, "plunder", var_13, var_12 );
        var_5[var_5.size] = var_14[0];
...
_id_1373A()
{
    ...
    var_10 = scripts\mp\gametypes\br_armory_kiosk.gsc::ai_push_to_position( level.br_armory_kiosk._id_13AC2, 0, var_7, var_8, var_9 );
