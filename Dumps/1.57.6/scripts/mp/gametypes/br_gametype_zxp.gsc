...
init()
{
    ...
    level.disable_super_in_turret._id_11B76 = getdvarint( "scr_br_zxp_maxTagsVisible", 12 );
...
_id_126FA( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_public.gsc::_id_125F3() || istrue( self._id_1443F );
    ...
    if ( level.disable_super_in_turret.spawndragonsbreathstruct )
    {
        ...
        scripts\mp\gametypes\br_alt_mode_zxp.gsc::_id_126BD( var_3, var_4, var_2 );
    }
    else
    {
        if ( !var_5 )
...
spawndogtags()
{
    ...
    else
    {
        ...
        var_5[0] hudoutlineenable( "outline_nodepth_stim" );
