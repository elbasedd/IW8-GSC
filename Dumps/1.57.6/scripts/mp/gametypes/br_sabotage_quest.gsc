...
init()
{
    if ( getdvarint( "scr_br_sabotage_award_truck", 1 ) == 1 )
    {
    ...
    var_0 = scripts\mp\gametypes\br_quest_util.gsc::registerquestcategory( "sabotage", 1 );

    if ( !var_0 )
        return;

    var_0 = scripts\mp\gametypes\br_quest_util.gsc::registerquestcategory( "sabotage_redacted", 1 );
...
_id_12E3B()
{
    ...
    if ( getdvarint( "scr_br_sabotage_award_truck", 1 ) == 1 )
    {
        ...
        var_6 = gettruckspawnstruct( var_5 );
        sabotage_spawntruck( var_5, var_6 );
    }

    thread scripts\mp\gametypes\br_quest_util.gsc::removequestinstance();
}

gettruckspawnstruct( var_0 )
{
    var_1 = spawn( "script_model", var_0.origin );
    var_1 setmodel( "ks_airdrop_crate_br" );
    var_1 setscriptablepartstate( "smoke_signal", "on", 0 );
    var_1 scripts\mp\gametypes\br_quest_util.gsc::init_tactical_boxes( 11, 17, 2, var_0.origin );
...
sabotage_spawntruck( var_0, var_1 )
{
    var_2 = spawnstruct();
    var_2.origin = var_0.origin + ( 0, 0, 50000 );
    var_3 = scripts\mp\gametypes\br_gametype_truckwar.gsc::_id_14263( var_2 );

    if ( isdefined( var_3 ) )
        level thread scripts\mp\gametypes\br_gametype_truckwar.gsc::_id_13DE4( var_3, var_1.location.origin, var_1.location.angles, 1 );

    thread scripts\mp\gametypes\br_publicevent_armoredtruck.gsc::_id_14235( var_3, var_1 );
    thread scripts\mp\gametypes\br_publicevent_armoredtruck.gsc::_id_14248( var_1 );
}
