...
init()
{
    if ( scripts\mp\utility\game::round_vehicle_logic() != "mendota" || !isdefined( level._id_11E18 ) )
        return;
    ...
    game["dialog"]["public_events_fresno_start"] = "oshkosh_defend";
    game["dialog"]["public_events_fresno_greenbay"] = "greenbay_titan_retreat";
    game["dialog"]["public_events_fresno_kenosha"] = "kenosha_titan_retreat";
    game["dialog"]["public_events_fresno_reward"] = "oshkosh_reward";
...
activatetomahs()
{
    ...
    {
        var_0 = getdvar( "scr_br_pe_fresno_die_roll" );
    ...
    {
        var_3 = "Both Fresno actors were unavailable!!";
...
activateevent()
{
    ...
    scripts\mp\gametypes\br_public.gsc::brleaderdialog( "public_events_fresno_start", undefined, undefined, undefined, 1.0 );
    ...
    foreach ( var_4 in var_1 )
    {
        if ( istrue( level.disable_super_in_turret._id_12CA4 ) )
            var_5 = scripts\mp\gametypes\br_public.gsc::round_enemy_stuck_logic( var_4 );
        else
            var_5 = scripts\mp\gametypes\br_public.gsc::rotationrefsbyseatandweapon( var_4 );
...
vehicle_rider_think( var_0 )
{
    ...
    scripts\mp\gametypes\fresno\fresno_state_machines.gsc::kreturntonormal();
...
sentry_init_done( var_0 )
{
    ...
    if ( !isdefined( var_0.cashtorefund ) )
    {
        var_7 = spawn( "trigger_radius", var_4, 0, level._id_11E18.playerredeploy, 50000 );
    ...
    if ( isdefined( level._id_11E18.screamergg ) )
        level thread activatescreamerdrop( var_7, 0 );
...
mp_port2_gw_patch()
{
    ...
    for ( var_2 = 0; var_2 < var_0.size; var_2++ )
    {
        ...
        if ( var_2 == 0 )
        {
            scripts\mp\gametypes\br_public.gsc::dmztut_luicallback( "public_events_fresno_reward", var_3, undefined, 1.0 );
...
gz_onkilled()
{
    ...
    scripts\mp\gametypes\br_public.gsc::brleaderdialog( "public_events_fresno_greenbay", undefined, undefined, undefined, 1.0 );
    wait 1;
...
kk_onkilled()
{
    ...
    scripts\mp\gametypes\br_public.gsc::brleaderdialog( "public_events_fresno_kenosha", undefined, undefined, undefined, 1.0 );
    wait 1;
