...
playergulagdonesplash()
{
    ...
    if ( istrue( level.br_pickups._id_12CB5 ) && scripts\mp\gametypes\br_public.gsc::hasrespawntoken() )
    {
...
_id_12642( var_0, var_1 )
{
    ...
    if ( istrue( self._id_14439 ) )
    {
        ...
        {
            scripts\mp\gametypes\br.gsc::_id_13F21( self, "playerPullOutOfGulagWin" );
...
_id_12568( var_0, var_1, var_2 )
{
    ...
    {
        if ( scripts\mp\utility\game::round_vehicle_logic() == "dmz" || scripts\mp\utility\game::round_vehicle_logic() == "rat_race" || scripts\mp\utility\game::round_vehicle_logic() == "risk" )
        {
...
_id_125BE( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3 ) && var_7 >= 0 && isdefined( self.lastdeathpos ) )
    {
        ...
        if ( isdefined( var_8 ) )
        {
            var_3 = scripts\mp\gametypes\br_public.gsc::modifyplayer_damage( var_8 );
    ...
    if ( !isdefined( var_3 ) )
    {
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            {
                var_16 = getdvarfloat( "scr_br_closestSafePointTimeOffset", 2.0 );
                var_3 = scripts\mp\gametypes\br_circle.gsc::helibankplunder( self, var_1, var_16 );
            }

            if ( !isdefined( var_3 ) )
            {
                var_17 = scripts\mp\gametypes\br_circle.gsc::getsafecircleorigin();
                var_18 = scripts\mp\gametypes\br_circle.gsc::getsafecircleradius();
                var_19 = getdvarfloat( "scr_br_minRespawnRadiusPct", 0.5 );
                var_20 = getdvarfloat( "scr_br_maxRespawnRadiusPct", 0.9 );
                var_21 = getdvarint( "scr_br_maxRespawnDropToGround", 1 );
                var_22 = getdvarint( "scr_br_maxRespawnSnapToNavMesh", 1 );
                var_3 = scripts\mp\gametypes\br_circle.gsc::risk_flagspawnshiftingpercent( var_17, var_18, var_20, var_20, var_21, var_22, 0, var_1 );
            }
        }
    ...
    if ( !isdefined( var_4 ) )
    {
        var_27 = scripts\mp\gametypes\br_circle.gsc::getsafecircleorigin();
    ...
    if ( var_6 )
    {
        ...
        var_32 = ( 0, 0, var_5 );
        var_3 = scripts\mp\gametypes\br.gsc::resetcircuitbreakers( var_3, var_32 );
    }
...
gulagwinnerrespawn( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    scripts\mp\gametypes\br_armor.gsc::searchcirclesize( var_16 );
    scripts\mp\gametypes\br_quest_util.gsc::_id_12072();
    scripts\mp\gametypes\br_rewards.gsc::_id_12072();
    scripts\mp\gametypes\br_publicevent_auavscan.gsc::_id_12072();
    ...
    if ( istrue( getdvar( "scr_br_gametype", "" ) == "dmz" ) || istrue( getdvar( "scr_br_gametype", "" ) == "rat_race" ) || istrue( getdvar( "scr_br_gametype", "" ) == "kingslayer" ) || istrue( getdvar( "scr_br_gametype", "" ) == "rumble" ) || istrue( getdvar( "scr_br_gametype", "" ) == "risk" ) || istrue( getdvar( "scr_br_gametype", "" ) == "sandbox" ) || istrue( getdvar( "scr_br_gametype", "" ) == "rumble_invasion" ) )
    {
        var_17 = "br_gulag_winner_redeploy_mogulag";
        var_18 = undefined;
    }
...
_id_125EB()
{
    ...
    var_0 = self weaponswitchbuttonpressed( "ui_br_bink_overlay_state" );
...
_id_12523( var_0 )
{
    ...
    if ( _id_125EB() )
    {
        ...
        if ( getdvarint( "scr_br_bink_overlay_log", 0 ) == 1 )
        {
            ...
            logstring( "bnk_Player " + self.name + " ui_br_bink_overlay_state : " + self weaponswitchbuttonpressed( "ui_br_bink_overlay_state", 0 ) );
        }
