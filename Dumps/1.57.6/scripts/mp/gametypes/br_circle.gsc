...
_id_131AD( var_0 )
{
    if ( scripts\mp\utility\game::round_vehicle_logic() != "reveal" && scripts\mp\utility\game::round_vehicle_logic() != "x2" )
...
_id_13322()
{
    return scripts\mp\utility\game::round_vehicle_logic() == "mini" || getdvarint( "scr_br_alt_mode_escape_skip_initial_circle", 0 ) || scripts\mp\utility\game::round_vehicle_logic() == "reveal" || isdefined( level.disable_heli_lights ) && level.disable_heli_lights._id_14291 == 3 || getdvarint( "scr_br_alt_mode_rebirth_skip_initial_circle", 0 ) != 0;
}
