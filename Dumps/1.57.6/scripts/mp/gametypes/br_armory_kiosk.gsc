...
init()
{
    ...
    level.delay_put_vehicles_on_compass = getdvarint( "scr_loadout_purchase_restricted", 1 );
...
_parsepurchaseitemtables()
{
    ...
    for ( var_9 = 0; var_9 < var_8; var_9++ )
    {
        ...
        if ( var_11.ref == "specialist_perk" )
        {
            var_13 = getdvarint( "scr_br_kiosk_specialistcost", 500 );
...
aigroundturretref( var_0, var_1, var_2 )
{
    ...
    switch ( var_0.ref )
    {
        ...
        case "pds":
            ...
            break;
        case "redacted_ar":
            var_4 = scripts\mp\gametypes\br_black_market_quest.gsc::redacted_weapon_purchase( var_3, "brloot_weapon_rebirth_ar_t9", 1, undefined, 1, var_2 );
            break;
        case "redacted_smg":
            var_4 = scripts\mp\gametypes\br_black_market_quest.gsc::redacted_weapon_purchase( var_3, "brloot_weapon_rebirth_sm_t9_02", 1, undefined, 1, var_2 );
            break;
        case "redacted_shotgun":
            var_4 = scripts\mp\gametypes\br_black_market_quest.gsc::redacted_weapon_purchase( var_3, "brloot_weapon_rebirth_sh_t9", 1, undefined, 1, var_2 );
            break;
        case "redacted_lmg":
            var_4 = scripts\mp\gametypes\br_black_market_quest.gsc::redacted_weapon_purchase( var_3, "brloot_weapon_rebirth_lm_iw8", 1, undefined, 1, var_2 );
            break;
        case "nebula_v_special":
            var_4 = var_3 _luidecision::give_player_nebula_v_special();
            break;
        default:
            break;
    }
...
onarmorykioskpurchase( var_0, var_1 )
{
    ...
    else if ( var_0 == "br_loadout_purchase" )
    {
        ...
        if ( istrue( var_13 ) )
            scripts\mp\gametypes\br_analytics.gsc::destructiblecarlightssetup( self, var_18, "defaultLoadout", "loadout_" + var_14 );
        else
            scripts\mp\gametypes\br_analytics.gsc::destructiblevehiclesetup( self, var_18, var_20 );
    }
    else if ( var_0 == "br_team_revive" )
    {
        ...
        var_22 = !scripts\mp\gametypes\br_gametypes.gsc::unset_relic_aggressive_melee( "useTokenToReviveTeammate" );
        ...
        if ( !var_25 scripts\mp\gametypes\br_public.gsc::unlockscriptabledoors() && !getdvarint( "scr_br_all_assassin_version", 0 ) )
        {
            if ( scripts\mp\gametypes\br_public.gsc::use_csm( var_25 ) )
        ...
        if ( scripts\mp\gametypes\br_gametypes.gsc::tutorial_showtext( "kioskRevivePlayer" ) )
            var_25 thread scripts\mp\gametypes\br_gametypes.gsc::_id_12E05( "kioskRevivePlayer", var_2, var_23 );
        else
...
_makekioskpurchase( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !( scripts\mp\gametypes\br_gametypes.gsc::unset_relic_aggressive_melee( "kioskXP" ) || scripts\mp\gametypes\br_public.gsc::turret_headicon() ) )
        var_4 thread scripts\mp\utility\points::giveunifiedpoints( "br_kioskBuy", undefined, scripts\mp\gametypes\br.gsc::freeze_bomb_vest_timer( var_0 ), undefined, undefined, undefined, undefined, var_3 );

    var_0 = ai_push_to_position( var_0, var_5, var_1, var_6, var_2 );

    if ( var_0 > 0 )
        var_4 scripts\mp\gametypes\br_plunder.gsc::_id_12622( var_0 );
