...
init()
{
    ...
    thread ammoids();
    level._id_13364 = 1;
    level.disable_super_in_turret.loadoutrestore = getdvarint( "scr_br_loadout_restore", 1 );
    level._id_133EA = getdvarint( "scr_escape_skipWeaponDropOnDeath", 0 );
}
...
obit_destroy_old_vehicles( var_0, var_1 )
{
    ...
    {
        if ( !var_3 scripts\mp\gametypes\br_public.gsc::updateinstantclassswapallowedinternal() )
            var_3 scripts\mp\hud_message::showsplash( "br_escape_radio_on_ground" );
    }
...
mlgmodifyheadshotdamage( var_0 )
{
    ...
    level.obit_activation.radio = scripts\mp\gametypes\br_pickups.gsc::spawnpickup( "brloot_escape_radio", var_7, 0, 1 );
    ...
    for (;;)
    {
        if ( isdefined( level.obit_activation.radio ) )
        {
            if ( isdefined( var_0 ) && var_0 == level.obit_activation.radio.origin )
            {
                ...
                var_3 = getentarray( "trigger_hurt_no_heli", "classname" );
...
ai_delete_after_level_notify( var_0, var_1 )
{
    ...
    for ( var_8 = 0; var_8 < var_7.size; var_8++ )
    {
        var_5 = var_7[var_8];
        var_9 = var_8 + 1;
        thread scripts\mp\gametypes\br.gsc::_id_1209B( var_5, var_9, 0, 1 );
    }
    ...
    foreach ( var_5, var_11 in level.teamdata )
    {
        ...
        var_12 = scripts\mp\utility\teams::getteamdata( var_5, "alivePlayers" );
