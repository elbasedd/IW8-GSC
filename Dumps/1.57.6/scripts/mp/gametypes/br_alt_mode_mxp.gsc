...
tr_vis_radius_override_lod2()
{
    ...
    level._id_11E18.gchallengetriggerheight = getdvarint( "scr_br_mxp_g_challenge_trig_height", 1250 );
    level._id_11E18.gchallengetriggerradius = getdvarint( "scr_br_mxp_g_challenge_trig_radius", 750 );
    ...
    level._id_11E18.gstandonheadduration = getdvarfloat( "scr_br_mxp_g_stand_on_head_dur", 2.5 );
    ...
    level._id_11E18.kswataggroheight = getdvarint( "scr_br_mxp_k_swat_aggro_height", 2500 );
    level._id_11E18.kswatheightoffset = getdvarint( "scr_br_mxp_k_swat_height_offset", 1000 );
    ...
    level._id_11E18.kidles = [ "s4_mp_kenosha_idle_breath_01", "s4_mp_kenosha_idle_lookaround_01", "s4_mp_kenosha_idle_taunt_01", "s4_mp_kenosha_idle_knuckles_01", "s4_mp_kenosha_idle_knuckles_02", "s4_mp_kenosha_idle_lookingdown_01" ];
...
{
    waittillframeend;
    scripts\mp\utility\sound::besttime( "br_mode_mxp" );
...
set_mission_ai_cap( var_0, var_1 )
{
    ...
    if ( var_2 )
    {
        ...
        level._id_11E18.setincomingremovedcallback.breathattachent markkeyframedmover( 1 );
...
sendendofmatchdata( var_0 )
{
    ...
    {
        if ( var_0.chopper_carepackage == level._id_11E18.setlastdroppableweaponobj && istrue( var_0.tofinalnode ) )
            return 0;
        else
            return 1;
    }
...
sandbox_safe_area()
{
    ...
    {
        if ( var_1.trial_flares.type == "g" && var_1.trial_flares.index == level._id_11E18.setlastdroppableweaponobj && gettime() >= var_1.trial_flares.expiretime )
            return var_1;
    }
}
...
sandbox_safe_area_count()
{
    foreach ( var_1 in level.train_hurt_damage_watcher )
    {
        if ( var_1.trial_flares.type == "g" && var_1.trial_flares.index == level._id_11E18.setlastdroppableweaponobj )
            return var_1;
    }
}
...
gupdateintelcrates( var_0, var_1 )
{
    ...
    {
        if ( isdefined( var_3 ) && var_3.trial_flares.type == "g" && var_3.trial_flares.index == var_0 )
...
vehiclespawninginto()
{
    foreach ( var_1 in level.train_hurt_damage_watcher )
    {
        if ( var_1.trial_flares.type == "k" && var_1.trial_flares.index == level._id_11E18.wait_for_open && gettime() >= var_1.trial_flares.expiretime )
            return var_1;
    }
}
...
kshoulddelaykillstreak( var_0 )
{
    ...
    if ( kiskillstreakplayerinitiated( var_0 ) )
        return var_1 < getdvarint( "scr_br_mxp_k_ks_player_delay", 9000 );
    else
        return var_1 < getdvarint( "scr_br_mxp_k_ks_delay", 4000 );
}
...
waitforremoteend( var_0 )
{
    ...
    var_19 = kgetjumpinfo( var_1, var_5 );
    var_13 = var_18 / var_19.jumpspeed;
    var_20 = -1 * var_19.jumpgravity;
    var_21 = trajectorycalculateinitialvelocity( var_1, var_17, ( 0, 0, var_20 ), var_13 );
    level._id_11E18.wait_for_next_hack_complete.x1fin_respawn movegravity( var_21, var_13, var_19.jumpgravity );
    wait( var_13 );
...
kenemiesinview( var_0 )
{
    ...
    var_4 = getentarrayinradius( "script_vehicle", "classname", var_1, var_2 );
    ...
    foreach ( var_8 in var_5 )
    {
        ...
        if ( var_9 < level._id_11E18.kswataggroheight )
...
modifydamagebyweapon( var_0, var_1, var_2 )
{
    ...
    var_5 = "scr_br_mxp_max_" + var_3;
    var_6 = 50;

    if ( var_3 == "sniper" )
        var_6 = 150;
    else if ( var_1 == "MOD_EXPLOSIVE" )
        var_6 = level._id_11E18.damageperintel;
    else if ( var_3 == "rocketlauncher" )
        var_6 = level._id_11E18.damageperintel;
    ...
    var_8 = "scr_br_mxp_scale_" + var_4;
    var_6 = 0;

    if ( issubstr( var_4, "manual_turret_flak" ) )
        var_6 = 3;
    else if ( issubstr( var_4, "_la_" ) )
        var_6 = 10;
...
{
    var_0 = level._id_11E18.setincomingremovedcallback;
    var_1 = level._id_11E18.gchallengetriggerradius;
    var_2 = level._id_11E18.gchallengetriggerheight;
    var_3 = "j_head";
    ...
    var_0 scripts\mp\utility\trigger::makeenterexittrigger( var_5, ::g_challengetriggerenter, ::g_challengetriggerexit, undefined, "g_challengeTriggerExit", ::g_challengetriggerfilter );
}

g_challengetriggerfilter( var_0, var_1 )
{
    if ( isplayer( var_0 ) && isalive( var_0 ) && ( !isdefined( var_0.isongzhead ) || !var_0.isongzhead ) )
        return 0;

    return 1;
}

g_challengetriggerenter( var_0, var_1 )
{
    var_0.isongzhead = 1;
    var_0 thread gstandingonheadwatcher();
}

g_challengetriggerexit( var_0, var_1 )
{
    if ( istrue( var_0.isongzhead ) )
        var_0.isongzhead = 0;
}

gstandingonheadwatcher()
{
    self endon( "g_challengeTriggerExit" );
    self endon( "disconnect" );
    scripts\engine\utility::waittill_notify_or_timeout( "death", level._id_11E18.gstandonheadduration );
...
kinitializeplayercollision()
{
    ...
    wait( var_1 );
    var_19 = var_0 gkkilltriggercreate( 320, 1300, "j_knee_le", 1, ( -100, 100, 0 ), ( 90, 0, 0 ) );
    var_20 = var_0 gkkilltriggercreate( 320, 1300, "j_knee_ri", 1, ( -100, 100, 0 ), ( 90, 0, 0 ) );
    wait( var_1 );
    var_21 = var_0 gkkilltriggercreate( 320, 60, "j_ankle_le", 1, ( 500, -80, 0 ), ( 0, -30, 90 ) );
    var_22 = var_0 gkkilltriggercreate( 320, 60, "j_ankle_ri", 1, ( 500, 20, 0 ), ( 0, -20, 90 ) );
