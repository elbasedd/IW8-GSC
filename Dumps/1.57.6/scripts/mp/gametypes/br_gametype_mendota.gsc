...
_id_126F1( var_0 )
{
    ...
    wait 1;
    scripts\mp\gametypes\br_public.gsc::dmztut_endgamewithreward( "objective_kill", self, 0 );
}
...
{
    wait 1;
    game["dialog"]["gametype"] = "gametype_battleroyale";
    game["dialog"]["objective_kill"] = "objective_battleroyale";
    game["dialog"]["respawn_crate"] = "event_respawn_crate";
    game["dialog"]["no_respawns"] = "powergrab_respawn_0";
    game["dialog"]["intel_reward"] = "powergrab_unlock";
    game["dialog"]["collect_own_intel"] = "powergrab_your_tag";
}
...
triage_door_clip( var_0 )
{
    if ( train_vfx_init( var_0 ) )
        ...
        var_0 scripts\mp\rank::giverankxp( "tag_collected", 25 );
}
...
{
    thread scripts\mp\hud_message::showsplash( "br_gametype_mendota_intel_self_revive" );
    scripts\mp\gametypes\br_pickups.gsc::br_forcegivecustompickupitem( self, "brloot_self_revive", 1 );
}

trap_room_ents()
{
    thread scripts\mp\hud_message::showsplash( "br_gametype_mendota_intel_heavy_weapons" );
...
{
    thread scripts\mp\hud_message::showsplash( "br_gametype_mendota_intel_gas_mask" );
    scripts\mp\gametypes\br_pickups.gsc::br_forcegivecustompickupitem( self, "brloot_equip_gasmask", 1 );
}
...
trap_trigger_logic()
{
    scripts\mp\gametypes\br_pickups.gsc::br_forcegivecustompickupitem( self, "brloot_offhand_kioskdrop", 1 );
}
...
trap_timer_running()
{
    thread scripts\mp\hud_message::showsplash( "br_gametype_mendota_intel_loadout_drop" );
...
get_chopper_minigun_start_node( var_0 )
{
    ...
    if ( scripts\mp\gametypes\br_pickups.gsc::isinteltype( var_0.scriptablename ) )
    {
...
skippickupfeedback( var_0, var_1, var_2 )
{
    if ( scripts\mp\gametypes\br_pickups.gsc::isinteltype( var_0 ) && istrue( var_1 ) )
        return 1;
}
