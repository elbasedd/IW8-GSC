...
spawnplayertoc130()
{
    ...
    if ( istrue( self.tutorial_usingparachute ) && getdvar( "scr_br_gametype", "" ) != "dmz" && getdvar( "scr_br_gametype", "" ) != "rat_race" && getdvar( "scr_br_gametype", "" ) != "risk" && getdvar( "scr_br_gametype", "" ) != "bodycount" )
...
orbitcam( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_infils.gsc::remove_old_wheelsons( self );
