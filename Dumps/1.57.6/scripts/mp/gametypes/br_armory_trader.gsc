...
init()
{
    ...
    level.debug_trap_room.play_lighting_sequence = strtok( getdvar( "scr_br_armory_trader_filter", "brloot_offhand_kioskdrop brloot_plunder_extract brloot_super_nova_rounds" ), " " );
    tr_detectwinners();
...
advance_bomb_wire_list( var_0, var_1, var_2, var_3 )
{
    ...
    self dlog_recordplayerevent( "dlog_event_armory_trade", [ "weapon_rarity", var_2, "trade_rarity", var_3, "circle_index", level.br_circle.circleindex ] );
}
