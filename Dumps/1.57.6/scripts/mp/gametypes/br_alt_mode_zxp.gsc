...
init()
{
    ...
    level.disable_super_in_turret._id_146D2 = getdvarint( "scr_br_zxp_num_consume", 2 );
...
modifyplayerdamage( var_0 )
{
    ...
    var_2 = 100;
    var_3 = var_0.damage;
    var_4 = isplayer( var_0.attacker ) && var_0.attacker scripts\mp\gametypes\br_public.gsc::_id_125F3();
    var_5 = isdefined( var_0.attacker ) && var_0.attacker nukefridgewatcher();
    var_6 = isplayer( var_0.victim ) && var_0.victim scripts\mp\gametypes\br_public.gsc::_id_125F3();
    ...
    else if ( var_6 )
    {
        ...
        var_16 = scripts\mp\gametypes\br.gsc::tutzonetriggerlogic( var_0.idflags );
        ...
        if ( !var_16 )
        {
            switch ( var_15 )
            {
                case "sniper":
                    ...
                    {
                        if ( scripts\mp\gametypes\br.gsc::usefailvehiclemsg( var_14 ) )
...
_id_12723( var_0 )
{
    ...
    if ( scripts\mp\gametypes\br_gametypes.gsc::tutorial_showtext( "playerGetZombieSpawnLocation" ) )
        [var_2, var_3] = scripts\mp\gametypes\br_gametypes.gsc::_id_12E05( "playerGetZombieSpawnLocation" );
    else
    ...
    if ( istrue( level.disable_super_in_turret._id_146B2 ) )
        thread scripts\mp\gametypes\br_gametype_zxp.gsc::_id_12730();
    ...
    if ( !isdefined( level._id_12D05 ) && scripts\mp\utility\game::round_vehicle_logic() != "brz" )
    {
        foreach ( var_10 in level.teamdata[self.team]["players"] )
        {
            if ( self == var_10 )
            {
                scripts\mp\gametypes\br_public.gsc::dmztut_endgamewithreward( "zmb_player_into_zombie", var_10 );
                continue;
            }

            scripts\mp\gametypes\br_public.gsc::dmztut_endgamewithreward( "zmb_teammate_into_zombie", var_10 );
        }
    }
}
...
_id_14033( var_0, var_1 )
{
    ...
    var_6 = ~( var_4 << var_2 );
    var_7 = self weaponswitchbuttonpressed( "ui_br_zombie_powers" );
    var_8 = var_7 & var_6;
    var_9 = var_8 + var_5;
