...
_id_13245( var_0 )
{
    ...
    iprintln( "FTD: Found " + var_1.size + " doors" );
    var_5 = 0;
...
{
    if ( var_1 == "part_door" && var_2 == "closed" )
    {
...
{
    var_0 setscriptablepartstate( "part_door", "closed" );
...
_id_1386A( var_0, var_1, var_2 )
{
    ...
    iprintln( "FTD: Player " + var_3.name + " entered door!" );
...
registerdonetsksubmap( var_0, var_1 )
{
    ...
    if ( var_1 )
    {
        ...
        iprintln( "FTD: Player " + var_2.name + " is looking for a position!" );

        for ( var_6 = 0; var_6 < level.petplundertimer.size; var_6++ )
        {
            var_7 = ( var_4 + var_6 ) % 4;
            iprintln( "FTD: Player " + var_2.name + " is evaluating offset " + var_7 );
            var_8 = var_3 + level.petplundertimer[var_7] * var_5;

            if ( capsuletracepassed( var_8, 16, 32, var_2 ) )
            {
                iprintln( "FTD: Player " + var_2.name + " accepted offset " + var_7 + " which is position " + var_8 );
                return var_8;
            }
            ...
            for ( var_10 = 0; var_10 < var_9; var_10++ )
            {
                ...
                {
                    iprintln( "FTD: Player " + var_2.name + " accepted randomized shift which is position " + var_12 );
                    return var_12;
                }
            }

            iprintln( "FTD: Player " + var_2.name + " rejected offset " + var_7 + " because it was occupied!" );
        }
    }

    iprintln( "FTD: Player " + var_2.name + " placed at base position " + var_3 );
    return var_3;
}
...
heli_land_logic( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( istrue( var_0 ), "disabled", "closed" );

    if ( var_2 != "inactive" && var_2 != var_3 )
        var_1 setscriptablepartstate( "part_door", var_3 );
...
_id_13145( var_0 )
{
    ...
    if ( isdefined( var_1 ) && isdefined( var_1._id_1388E ) )
        var_1._id_1388E setscriptablepartstate( "part_light", var_0 );
}
