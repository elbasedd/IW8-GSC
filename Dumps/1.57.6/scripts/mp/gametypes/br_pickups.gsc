...
initarrays()
{
            ...
            if ( var_5 == "item" )
            {
                ...
                if ( var_6 == "weapon" )
                {
                    ...
                    if ( isdefined( var_9 ) && var_9.size > 0 )
                    {
                        ...
                        if ( var_12 == "" )
                        {
                            scripts\mp\utility\script::laststand_dogtags( "lootID not found in weapon_ids.csv - lootID: " + var_9 + " in row " + var_4 + " from table " + level.brloottablename );
                            continue;
                        }
                ...
                else
                {
                    ...
                    if ( var_40 != "" )
                    {
                        switch ( var_40 )
                        {
                            case "1":
                                if ( isdefined( var_39 ) && var_39.size > 0 )
                                    level.equipment.table[var_39].defaultslot = "primary";

                                level.br_throwables[level.br_throwables.size] = var_7;
                                break;
                            case "2":
                                if ( isdefined( var_39 ) && var_39.size > 0 )
                                    level.equipment.table[var_39].defaultslot = "secondary";

                                level.br_usables[level.br_usables.size] = var_7;
                                break;
                            case "3":
                                if ( isdefined( var_39 ) && var_39.size > 0 )
                                    level.equipment.table[var_39].defaultslot = "health";

                                break;
                            case "4":
                                if ( isdefined( var_39 ) && var_39.size > 0 )
                                    level.equipment.table[var_39].defaultslot = "super";
                ...
                var_46 = strtok( var_46, "&" );
                level.br_pickups.delay_give_lethal_grenade[var_7] = scripts\engine\utility::array_contains( var_46, "noSpawn" );
                continue;
            }
    ...
    level.br_pickups._id_12CB5 = getdvarint( "scr_br_respawn_token_gulag", 0 );
...
lootused( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_0 getscriptableisloot() && !_id_11A48( var_0 ) )
    {
        ...
        else
        {
            ...
            if ( istrue( scripts\mp\gametypes\br_gametypes.gsc::_id_12E06( "skipPickupFeedback", var_5.scriptablename, var_4, var_2 ) ) )
                var_8 = 0;
...
{
    var_2 = var_0.type == "br_loot_cache" || var_0.type == "br_loot_cache_lege" || var_0.type == "br_reusable_loot_cache";
...
battle_tracks_tryplayingbattletrackswhenstandingonvehicle( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_public.gsc::updatebrscoreboardstat( "hasPlatePouch", 1 );
...
_id_12C16()
{
    ...
    var_0 scripts\mp\gametypes\br_public.gsc::updatebrscoreboardstat( "hasPlatePouch", 0 );
...
takesuperpickup( var_0, var_1 )
{
    ...
    if ( isdefined( self.equipment["super"] ) && ( scripts\mp\equipment::getequipmentslotammo( "super" ) > 0 || mortar_add_fov_user_scale() ) )
    {
        var_4 = test_ai_anim();
...
numkilled()
{
    ...
    if ( isdefined( self.operatorcustomization.gender ) && self.operatorcustomization.gender == "female" )
        self _meth_87A9( "gasmask_female" );
    else
        self _meth_87A9( "gasmask_male" );
...
cantakepickup( var_0 )
{
    ...
    if ( updatecollectionui( var_0.scriptablename ) )
    {
        ...
        if ( getdvarint( "scr_enablePouchRecycle", 0 ) == 1 )
        {
            ...
            {
                var_9 = scripts\engine\utility::ter_op( isdefined( self.equipment["health"] ), scripts\mp\equipment::getequipmentslotammo( "health" ), 0 );
                var_10 = scripts\mp\equipment::getequipmentmaxammo( level.br_pickups.br_equipname["brloot_armor_plate"] );
    ...
    if ( var_0.scriptablename == "brloot_ammo_grenade" )
    {
        ...
        var_12 = scripts\mp\equipment::getequipmentslotammo( "primary" );
        var_13 = scripts\mp\equipment::getequipmentslotammo( "secondary" );
...
spawnpickup( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( var_9 == "brloot_weapon_me_riotshield_epic" || var_9 == "brloot_weapon_s4_me_rindigo_epic" || scripts\mp\gametypes\br_weapons.gsc::vandalize_attack_max_cooldown( var_4 ) && scripts\mp\riotshield::isriotshield( var_4 ) )
