...
init()
{
    ...
    if ( var_0 )
    {
        ...
        level._id_133F5 = getdvarint( "scr_skydiveSpawnProtectionScaleHeightTop", 800 );
        level._id_133F4 = getdvarint( "scr_skydiveSpawnProtectionScaleHeightBottom", 50 );
        level._id_133F3 = getdvarfloat( "scr_skydiveSpawnProtectionModifierTop", 0.1 );
        level._id_133F2 = getdvarfloat( "scr_skydiveSpawnProtectionModifierBottom", 0.9 );
        level.skydive_spawnprotectionsafetydistance = getdvarfloat( "scr_skydiveSpawnProtectionSafetyDistance", 1200 );
    }
}
