...
init()
{
    ...
    level.shrink_poi_into_the_bank._id_13EFF = [ [ "brloot_killstreak_auav", 0 ], [ "brloot_equip_gasmask_durable", 0 ], [ "brloot_specialist_bonus", 0 ], [ "brloot_weapon_la_mike32_lege", "brloot_ammo_rocket" ] ];
    ...
    level.shrink_poi_into_the_bank.waypoint_icon = [ [ "brloot_killstreak_precision_airstrike", 0 ], [ "brloot_equip_gasmask", 0 ], [ "brloot_plate_pouch", 8 ], [ "brloot_killstreak_clusterstrike", 0 ] ];
