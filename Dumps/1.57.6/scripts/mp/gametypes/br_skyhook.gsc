...
reader()
{
    ...
    switch ( getdvar( "mapname" ) )
    {
        case "mp_wz_island":
            ...
            if ( isdefined( level.disable_super_in_turret ) && isdefined( level.disable_super_in_turret.name ) && level.disable_super_in_turret.name != "mendota" )
...
modevalidatekillcam()
{
    ...
    foreach ( var_1 in self.capacity )
    {
        ...
        var_1._id_133FF stoploopsound( "br_auto_ascender_device_lp_npc" );
...
skyhookrepairwatcher()
{
    ...
    var_0 scripts\mp\gametypes\br_plunder.gsc::_id_1261E( 5 );
...
atv_vehicle( var_0, var_1 )
{
    ...
    if ( getdvarint( "scr_skyhook_carriable_interaction_enabled", 1 ) )
    {
        if ( isdefined( var_1.get_search_turret_target_player ) )
        {
            ...
            {
                if ( var_1 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "carriable_useSkyhook" ) ]]( var_0 ) )
                    return 0;
            }
        }
    }
    ...
    var_1 setclientomnvar( "ui_br_altimeter_state", 3 );
...
_id_133FB( var_0, var_1, var_2 )
{
    ...
    var_11 = getanimlength( level.scr_anim["player"][var_4] ) - var_10;
    wait( var_11 * 0.55 );
