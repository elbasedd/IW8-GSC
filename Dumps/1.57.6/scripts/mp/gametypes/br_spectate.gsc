...
_id_13132()
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "dmz" && scripts\mp\utility\game::getgametype() != "rat_race" && !var_0 )
    {
        _id_143FA( self );
    ...
    for (;;)
    {
        ...
        foreach ( var_2 in level.players )
        {
            if ( isdefined( var_2 ) )
            {
                ...
                var_10 = var_2 weaponswitchbuttonpressed( "ui_br_active_spectators" );
