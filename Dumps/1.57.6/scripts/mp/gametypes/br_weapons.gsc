...
takeweaponpickup( var_0 )
{
    ...
    if ( var_7 )
    {
        ...
        if ( var_8.basename != "none" )
        {
            ...
            if ( var_21 )
            {
                var_22 = scripts\mp\gametypes\br_pickups.gsc::remove_roof_nodes( var_0.origin, ( 0, var_20, 0 ) );
                ...
                if ( var_28["fraction"] < 1.0 )
                    var_22.set_force_aitype_armored = var_28["entity"];

                var_29 = weaponspawn( var_8, self, var_22, 0 );

                if ( isdefined( var_29 ) )
                {
                    scripts\mp\gametypes\br_pickups.gsc::_id_119F5( var_29, var_13, var_14, var_15 );
                    var_30 = 1;
