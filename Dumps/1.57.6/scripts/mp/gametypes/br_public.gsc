...
damagearmor( var_0, var_1 )
{
    ...
    if ( isplayer( self ) )
    {
        ...
        scripts\mp\gametypes\br_gametypes.gsc::_id_12E05( "onPlayerArmorDamaged", var_6 );
    }
...
_id_1285E( var_0 )
{
    ...
    level thread scripts\mp\gametypes\br_infils.gsc::stop_priming_gesture();
...
{
    var_2 = self weaponswitchbuttonpressed( "br_archived_flags" );
