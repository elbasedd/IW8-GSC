...
onstartgametype()
{
    ...
    scripts\mp\gametypes\br_events.gsc::disable_spawnpoints_in_hangar();
    ...
    if ( var_3 > 0 )
    {
        ...
        else if ( var_4 == "MOD_MELEE" )
        {
            ...
            if ( isdefined( var_0 ) )
            {
                ...
                if ( isdefined( var_16 ) && var_16 == "serum_gadget" )
                {
        ...
        if ( scripts\mp\gametypes\br_gametypes.gsc::tutorial_showtext( "modifyPlayerDamage" ) )
        {
            ...
            var_3 = thread scripts\mp\gametypes\br_gametypes.gsc::_id_12E05( "modifyPlayerDamage", var_19 );
        }
...
onnormaldeath( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_6 == "dmz" || var_6 == "rat_race" || var_6 == "risk" || var_6 == "kingslayer" || var_6 == "rumble" || var_6 == "payload" || var_6 == "rumble_invasion" )
        return;
...
onplayerdisconnect( var_0 )
{
    ...
    if ( istrue( level.br_prematchstarted ) )
    {
        ...
        if ( isdefined( var_0 ) && istrue( var_0.inlaststand ) && scripts\mp\utility\game::round_vehicle_logic() != "dmz" && scripts\mp\utility\game::round_vehicle_logic() != "rat_race" && scripts\mp\utility\game::round_vehicle_logic() != "risk" && scripts\mp\utility\game::round_vehicle_logic() != "kingslayer" && scripts\mp\utility\game::round_vehicle_logic() != "rumble" )
        {
...
ondeadevent( var_0 )
{
    if ( istrue( level.br_debugsolotest ) || scripts\mp\utility\game::round_vehicle_logic() == "dmz" || scripts\mp\utility\game::round_vehicle_logic() == "rat_race" || scripts\mp\utility\game::round_vehicle_logic() == "risk" || scripts\mp\utility\game::round_vehicle_logic() == "kingslayer" || scripts\mp\utility\game::round_vehicle_logic() == "rumble" )
        return;
...
scriptableusepart( var_0, var_1, var_2 )
{
    ...
    {
        if ( scripts\mp\utility\game::round_vehicle_logic() == "rebirth" || scripts\mp\utility\game::round_vehicle_logic() == "rebirth_reverse" || scripts\mp\utility\game::round_vehicle_logic() == "treasure_hunt" )
            return;
    }
...
handleendgamesplash( var_0 )
{
    ...
    if ( scripts\mp\utility\game::round_vehicle_logic() == "dmz" || scripts\mp\utility\game::round_vehicle_logic() == "rat_race" || scripts\mp\utility\game::round_vehicle_logic() == "risk" || scripts\mp\utility\game::round_vehicle_logic() == "kingslayer" || scripts\mp\utility\game::round_vehicle_logic() == "rumble" )
...
_id_144AE()
{
    ...
    for (;;)
    {
        ...
        if ( var_3 == "dmz" || var_3 == "rat_race" || var_3 == "sandbox" || var_3 == "risk" || var_3 == "rumble" || var_3 == "payload" )
...
emp_drone_damage_monitor( var_0, var_1 )
{
    ...
    if ( isdefined( var_2 ) )
        return var_2;
    else if ( scripts\mp\utility\game::round_vehicle_logic() == "dmz" || scripts\mp\utility\game::round_vehicle_logic() == "rat_race" || scripts\mp\utility\game::round_vehicle_logic() == "risk" || scripts\mp\utility\game::round_vehicle_logic() == "kingslayer" || scripts\mp\utility\game::round_vehicle_logic() == "rumble" )
    {
...
bush_zones()
{
    var_0 = scripts\mp\utility\game::round_vehicle_logic() == "dmz" || scripts\mp\utility\game::round_vehicle_logic() == "rat_race" || scripts\mp\utility\game::round_vehicle_logic() == "risk" || scripts\mp\utility\game::round_vehicle_logic() == "kingslayer" || istrue( level.vehicle_collision_getleveldata ) || isdefined( level._id_12D05 ) || isdefined( level._id_12CE8 );
...
_id_12065()
{
    if ( !isdefined( self.sessionteam ) || self.sessionteam == "spectator" || self.sessionteam == "none" || isdefined( self.thrust_fx_model ) || self calloutmarkerping_getactive() )
        return 0;
