...
init()
{
    ...
    var_1._id_11B78 = getdvarint( "scr_br_pe_juggernaut_max_times", 1 );
    var_1.guard_door_clip = scripts\mp\gametypes\br_publicevents.gsc::relic_squadlink_init_vfx( "juggernaut", "10   5   0   0           0   0   0   0" );
    scripts\mp\gametypes\br_publicevents.gsc::_id_12B35( 4, var_1 );
