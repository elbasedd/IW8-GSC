...
_id_14029( var_0, var_1, var_2 )
{
    ...
    foreach ( var_5 in var_0 )
    {
        if ( isdefined( var_5 ) )
        {
            if ( var_3 < 0 )
            {
                var_3 = var_5 weaponswitchbuttonpressed( "rebirth_tracked_teams" );
...
{
    var_0 = self weaponswitchbuttonpressed( "ui_rebirthRespawnTimer" );
    var_1 = var_0 & ~16384;
...
{
    var_1 = self weaponswitchbuttonpressed( "ui_rebirthRespawnTimer" );
    var_2 = var_1 & ~16383;
    var_3 = var_2 | var_0;
...
end_unlock_silo()
{
    ...
    if ( !isalive( var_0 ) )
    {
        if ( isdefined( var_0.team ) )
        {
            ...
            foreach ( var_4 in level.teamdata[var_0.team]["alivePlayers"] )
            {
...
end_intro_obj()
{
    ...
    if ( !isdefined( self.player_enable_invulnerability ) )
    {
        ...
        var_2 = getdvarint( "scr_br_give_specialist_on_spawn", 0 );
