                ...
                foreach ( var_8 in var_6 )
                {
                    foreach ( var_1 in scripts\mp\gametypes\br_public.gsc::round_enemy_stuck_logic( var_8.player.team, var_8.player.squadindex ) )
                    {
                        ...
                        if ( var_1._id_1227E >= 20 )
                        {
                            ...
                            var_1 thread scripts\mp\gametypes\br_analytics.gsc::deregisterscriptableinstance( var_10, "br_payload_squad_on_payload" );
                            var_1._id_1227E = 0;
                        }
                    }
                }
...
_id_1255E()
{
    ...
    if ( self.team == game["attackers"] && level.disable_super_in_turret._id_13602 > -1 )
        thread _id_1253A();
...
_id_126A4( var_0 )
{
    ...
    if ( !istrue( level.skipprematchdropspawn ) && self._id_12204.getquestplunderrewardinstance == 0 && self.team == game["attackers"] )
        thread _id_1253A();
    ...
    if ( istrue( self.hostdefensefactormod ) )
    {
        ...
        if ( isdefined( var_0 ) )
        {
            foreach ( var_4 in level.teamdata[var_0.team]["players"] )
            {
                ...
                var_4 thread scripts\mp\gametypes\br.gsc::scriptableusestate( "br_payload_obstacle_destroyed", int( 75.0 ), var_4.currentweapon, 1 );
                var_4 thread scripts\mp\rank::scoreeventpopup( "br_payload_obstacle_destroyed" );
                var_4 thread scripts\mp\gametypes\br_analytics.gsc::deregisterscriptableinstance( 150, "br_payload_obstacle_destroyed" );
            }
        }
    ...
    else
    {
        ...
        if ( isdefined( var_0 ) )
        {
            foreach ( var_4 in level.teamdata[var_0.team]["players"] )
            {
                ...
                var_4 thread scripts\mp\gametypes\br.gsc::scriptableusestate( "br_payload_obstacle_built", int( 250.0 ), var_4.currentweapon, 1 );
                var_4 thread scripts\mp\rank::scoreeventpopup( "br_payload_obstacle_built" );
                var_4 thread scripts\mp\gametypes\br_analytics.gsc::deregisterscriptableinstance( 500, "br_payload_obstacle_built" );
            }
        }
        ...
        foreach ( var_4 in var_12 )
        {
            ...
            var_28 = scripts\mp\gametypes\br_public.gsc::modifyplayer_damage( var_28, 100, -100 );
