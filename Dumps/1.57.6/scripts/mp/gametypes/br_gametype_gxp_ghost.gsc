...
modifyplayerdamage( var_0 )
{
    ...
    var_2 = 100;
    var_3 = var_0.damage;
    var_4 = isplayer( var_0.attacker ) && var_0.attacker scripts\mp\gametypes\br_public.gsc::_id_125EC();
    var_5 = isdefined( var_0.attacker ) && var_0.attacker nukefridgewatcher();
    var_6 = isplayer( var_0.victim ) && var_0.victim scripts\mp\gametypes\br_public.gsc::_id_125EC();
