...
debug_test_kill_kidnapper()
{
    ...
    var_1 = scripts\engine\utility::ter_op( scripts\mp\utility\perk::_hasperk( "specialty_br_stronger_armor" ), 75, 50 );
    ...
    scripts\mp\gametypes\br_gametypes.gsc::_id_12E05( "onArmorPlate" );
...
delay_end_soldiers_spawns()
{
    ...
    var_2 = istrue( self._id_12D1E ) || istrue( self.isjuggernaut ) || scripts\mp\supers::issuperinuse() && self.super.staticdata.ref != "super_deadsilence";
