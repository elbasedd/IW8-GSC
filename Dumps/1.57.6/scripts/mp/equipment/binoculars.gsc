...
get_stay_at_station_time( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_143A8( "weapon_change", "weapon_taken", "weapon_switch_invalid", "death_or_disconnect", "on_ladder" );
...
{
    self disableweaponswitch();
    scripts\engine\utility::_id_143A6( "weapon_change", "death_or_disconnect", "drop_object" );
    self enableweaponswitch();
}
