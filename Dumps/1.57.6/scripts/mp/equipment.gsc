...
inititems()
{
    ...
    var_0.callbacks["equip_serum_gadget"]["onFired"] = _findnewlocaleplacement::_id_13057;
    var_0.callbacks["equip_serum_gadget"]["onTake"] = _findnewlocaleplacement::_id_13058;
...
updateuiammocount( var_0 )
{
    ...
    if ( var_0 == "primary" )
    {
        ...
        self setpowerprogress( "primary", var_1 );
    }
    else if ( var_0 == "secondary" )
    {
        self setclientomnvar( "ui_power_secondary_num_charges", var_1 );
        self setpowerprogress( "secondary", var_1 );
    }
    else if ( var_0 == "health" )
    {
        ...
        if ( scripts\mp\utility\game::unset_relic_grounded() )
            scripts\mp\gametypes\br_public.gsc::updatebrscoreboardstat( "armorPlateCount", var_1 );
    }
}
