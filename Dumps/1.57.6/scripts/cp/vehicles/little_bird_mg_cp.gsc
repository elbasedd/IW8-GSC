...
addlaststandoverheadiconcallback( var_0 )
{
    ...
    return var_0.model == "br_skyhook_extraction_base_01_ch3" || var_0.model == "lm_military_skyhook_extraction_01_ch3";
}
...
fulton_repositoryusecallback( var_0 )
{
    ...
    if ( addpostlaunchspawns( var_0 ) )
    {
        ...
        else if ( isdefined( var_4 ) && isdefined( var_4.entity ) )
        {
            ...
            else if ( istrue( var_4.entity.isportablekiosk ) )
...
fx_ents( var_0 )
{
    ...
    var_7 = var_1 weaponswitchbuttonpressed( "ui_br_objective_index" );
...
fusesound( var_0, var_1 )
{
    ...
    if ( !isdefined( var_6 ) )
    {
        if ( var_3 == "brloot_plunder_extraction_site_01" || var_3 == "brloot_plunder_extraction_site_02" || var_3 == "equip_fulton_mp" )
        {
            ...
            return "ping_ammo_grenadelethal";
        else if ( var_3 == "scriptable_skyhook_placed" )
            return "ping_location_generic";
    ...
    else if ( issubstr( var_6, "CONCUSSION" ) || issubstr( var_6, "DECOY" ) || issubstr( var_6, "FLASH" ) || issubstr( var_6, "GAS_BR" ) || issubstr( var_6, "SMOKE" ) || issubstr( var_6, "SNAPSHOT" ) )
