...
ascenderuse( var_0, var_1 )
{
    ...
    if ( !var_2.dir )
    {
        if ( scripts\common\utility::iscp() )
            var_9 = getdvarfloat( "scr_descender_speed_cp", registerhandlecommand() );
        else
            var_9 = getdvarfloat( "scr_descender_speed", registerfalldamagedvars() );
    }
    else
        var_9 = getdvarfloat( "scr_ascender_speed", registered_checkpoints() );
...
watch_for_ashes_achievement()
{
    level endon( "game_ended" );
    var_0 = self;
    var_0 scripts\engine\utility::_id_143A5( "death_or_disconnect", "last_stand_finished" );
    var_0 enableoffhandweapons();
    var_0 enableweaponswitch();
    var_0 scripts\common\utility::allow_killstreaks( 1 );
    var_0 thread scripts\mp\utility\infilexfil::takegunless();
