...
stopkeyearning( var_0 )
{
    ...
    if ( istrue( level.ismp ) )
        self reportchallengeuserevent( "end_match", var_4, var_1, var_5, var_6, var_7, var_8, var_9, self.vehicle_tracking_cp_post_spawn, int( var_10 * 100.0 ), int( var_11 * 100.0 ), int( var_12 * 100.0 ), var_13, var_14, var_15 );
    else
    {
        ...
        self reportchallengeuserevent( "end_match", var_4, var_1, var_5, 0, 0, var_8, var_9, self.vehicle_tracking_cp_post_spawn, var_10, var_11, var_12, var_13, var_14, var_15 );
    }
