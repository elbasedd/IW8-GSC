...
{
    if ( isscriptedagent( self ) && !nullweapon( self.damageweapon ) && self.unittype != "juggernaut" && scripts\common\utility::_id_132EC( self.damageweapon ) )
    {
...
chooseexplosivedeathanim( var_0, var_1, var_2 )
{
    ...
    if ( !nullweapon( var_4 ) && self.unittype != "juggernaut" && scripts\common\utility::_id_132EC( var_4 ) )
    {
