...
playerattackedmonitor()
{
    for (;;)
    {
        level scripts\engine\utility::_id_143A5( "an_enemy_shot", "enemy_grenade_fire" );
...
stealthhints_aimonitor( var_0, var_1 )
{
    ...
    if ( var_0 [[ var_0.fnisinstealthhunt ]]() )
    {
        ...
        var_0 scripts\engine\utility::_id_143A6( "stealth_combat", "death", "stealthHints_timeout" );
    }
    else if ( var_0 [[ var_0.fnisinstealthinvestigate ]]() )
        var_0 scripts\engine\utility::_id_143A6( "stealth_idle", "stealth_combat", "death" );
