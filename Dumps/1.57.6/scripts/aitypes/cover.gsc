...
exposed_shouldlookforbettercover()
{
    ...
    if ( isdefined( self setmlgdamagedone() ) )
        return 1;
...
coverexpose( var_0 )
{
    ...
    var_22 = self aicalcsuppressspot( var_10, var_11, scripts\engine\utility::getcornerstepoutsdisabled(), scripts\asm\asm_bb::bb_isshort(), var_5 - self.a.paintime );
