...
main()
{
    ...
    level._effect["zmb_ai_crawling_out_of_ground"] = loadfx( "vfx/iw7/core/zombie/spawn/vfx_zmb_spawn_ground" );
    level._effect["zmb_ai_base_death"] = loadfx( "vfx/iw7/levels/cp_disco/rat_king/ratking_ch/vfx_zmb_ratking_skirt_rat_dead" );
...
_id_146FA( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        if ( isdefined( var_5.model ) && var_5.model == "fullbody_zombie_a_br" )
        {
...
carriablemagicgrenades( var_0, var_1 )
{
    ...
    level endon( "game_ended" );
    var_2 endon( "terminate_ai_threads" );
    wait 0.25;
