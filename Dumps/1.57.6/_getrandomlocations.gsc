...
init()
{
    scripts\mp\killstreaks\killstreaks::registerkillstreak( "greenbay_strike", ::_id_13E2A );
...
_id_14582( var_0, var_1, var_2 )
{
    ...
    if ( !isdefined( var_3 ) || !istrue( var_3.success ) )
    {
        if ( isdefined( var_3 ) && !istrue( var_3.success ) && scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
        {
            if ( var_3.string == "oob" )
                [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "hud", "showErrorMessage" ) ]]( "KILLSTREAKS/INVALID_POINT" );
            else if ( var_3.string == "fresno_start" )
                [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "hud", "showErrorMessage" ) ]]( "BR_MENDOTA/FRENZY_UNAVAILABLE" );
        }
...
greenbaystrike_attackray( var_0, var_1 )
{
    ...
    var_4 = getdvarint( "scr_br_mxp_g_length_ray", 200000 );
...
greenbaystrike_preparestreakinfo( var_0, var_1 )
{
    ...
    var_0._id_134E3 = scripts\mp\gametypes\br_alt_mode_mxp.gsc::sandbox_combat_area();
...
server_structs( var_0 )
{
    ...
    if ( isdefined( var_2 ) && isplayer( var_2 ) )
    {
        ...
        var_2 thread scripts\mp\hud_message::showsplash( "br_gametype_mendota_greenbay_streak" );
    }
...
greenbaystrike_continueattack( var_0, var_1, var_2 )
{
    ...
    while ( gettime() < var_4 )
    {
        [var_6, var_7] = getnextgreenbayaimdamagepos( var_0 );
        scripts\mp\gametypes\br_alt_mode_mxp.gsc::set_maze_ai_state( var_7 );
        var_0.start_area_fx_end.origin = var_7;
        var_8 = getgroundnormal( var_7 );
...
isaltbunkerscriptable( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( isdefined( level.train_hurt_damage_watcher ) )
    {
        foreach ( var_10 in level.train_hurt_damage_watcher )
        {
            if ( isdefined( var_10 ) )
            {
                ...
                if ( var_11 < var_8 )
                    var_10 thread scripts\mp\gametypes\br_gametype_mendota.gsc::train_get_anim_ents_index();
            }
        }
    }
    ...
    if ( istrue( var_7 ) )
    {
        ...
        if ( isdefined( var_14["entity"] ) )
        {
            var_15 = var_14["entity"];
...
seq3_keypad_init( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_7 = spawn( "trigger_radius", var_6, 0, var_0, var_4 );
    var_7.angles = var_3;
    var_7.count = 0;
...
makepreviewimpactcircle( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    var_8 = getdvarint( "scr_br_mxp_g_extend", 500 );
    ...
    for ( var_12 = 0; var_12 < var_7 - 1; var_12++ )
    {
        ...
        if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "dangerNotifyPlayersInRange" ) )
            self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "dangerNotifyPlayersInRange" ) ]]( var_13, var_4 + var_8, "greenbay_strike", 0 );
    }

    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "dangerNotifyPlayersInRange" ) )
        self [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "dangerNotifyPlayersInRange" ) ]]( var_2, var_4 + var_8, "greenbay_strike", 0 );
...
kenoshastrike_setuptarget( var_0, var_1 )
{
    ...
    if ( var_6 <= level.vehicle_shoulddocollisiondamagetoplayer.strikeradius )
    {
        var_1.origin = var_3;
        var_1.change_fronttruck_label = level.vehicle_shoulddocollisiondamagetoplayer.strikeradius;
        var_1.change_goal_radius_weapons_free_internal = 2;
    }
    else if ( var_6 <= level.vehicle_shoulddocollisiondamagetoplayer.midrange )
...
vehicle_spawn_cancelpendingrespawns( var_0 )
{
    ...
    if ( var_0.change_goal_radius_weapons_free_internal == 0 || var_0.change_goal_radius_weapons_free_internal == 1 )
    {
        ...
        var_4 = level.vehicle_shoulddocollisiondamagetoplayer.rock_speed_long_range;
        var_5 = level.vehicle_shoulddocollisiondamagetoplayer.rock_gravity_long_range;

        if ( var_0.change_goal_radius_weapons_free_internal == 1 )
        {
            var_4 = level.vehicle_shoulddocollisiondamagetoplayer.rock_speed_mid_range;
            var_5 = level.vehicle_shoulddocollisiondamagetoplayer.rock_gravity_mid_range;
        }
    ...
    isaltbunkerscriptable( var_0.origin + ( 0, 0, 100 ), var_0.change_fronttruck_label, 1000, var_10, "MOD_EXPLOSIVE", getcompleteweaponname( "kenosha_strike" ), var_0._id_134E3 );
    isaltbunkerscriptable( var_0.origin + ( 0, 0, 500 ), var_0.change_fronttruck_label, 1000, var_10, "MOD_EXPLOSIVE", getcompleteweaponname( "kenosha_strike" ), var_0._id_134E3 );
    isaltbunkerscriptable( var_0.origin + ( 0, 0, 1000 ), var_0.change_fronttruck_label, 1000, var_10, "MOD_EXPLOSIVE", getcompleteweaponname( "kenosha_strike" ), var_0._id_134E3 );

    if ( isdefined( var_10 ) && isplayer( var_10 ) )
    {
        var_10 notify( "greenbay_strike_finished" );
