...
test_bag_pickup()
{
    ...
    level.getserverroomspawnpoint.get_ai_within_range = getdvarint( "scr_chem_rounds_canister_gas_cloud_size", 210 );
}
...
_id_1447F( var_0 )
{
    ...
    var_1 = scripts\engine\utility::_id_143B9( level.getserverroomspawnpoint._id_127E0, "death" );
    ...
    var_2 = self.origin;
    var_3 = easepower( "super_nova_rounds_audio", var_2 );
    var_4 = spawn( "trigger_radius", var_2, 0, level.getserverroomspawnpoint.plunder_clearrepositorywidgetforplayer, level.getserverroomspawnpoint.plunder_clearrepositorywidgetforplayer );
    var_4.attacker = var_0;
    waitframe();
    var_5 = easepower( "vfx_chem_rounds_enemy_death", var_2 );
    var_3 setscriptablepartstate( "sfx_gas_npc", "npc_gas_expl" );
    ...
    foreach ( var_7 in var_4.triggerenterents )
    {
        if ( var_7 getstreamedinplayercount() )
            var_7 scripts\mp\gametypes\br_pickups.gsc::plunderrankupdate( "chem_rounds_gas" );
    }

    var_3 freescriptable();
    var_4 notify( "gas_cloud_disipate" );
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            if ( scripts\mp\gametypes\br_public.gsc::hasarmor() )
                ...
                self dodamage( level.getserverroomspawnpoint.plunder_getleveldataforrepository, var_0.origin, var_0.attacker, undefined, "MOD_TRIGGER_HURT", "danger_circle_br" );
...
give_player_nebula_v_special()
{
    self giveweapon( "iw8_lm_dblmg_mp" );
    self switchtoweapon( "iw8_lm_dblmg_mp" );
    self givemaxammo( "iw8_lm_dblmg_mp" );

    while ( self.currentweapon.basename != "iw8_lm_dblmg_mp" )
        waitframe();
