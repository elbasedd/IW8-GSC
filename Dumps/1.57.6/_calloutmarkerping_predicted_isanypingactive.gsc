...
_id_120D5()
{
    ...
    if ( getdvarint( "LKSKLOQPTT", 0 ) )
    {
        level._effect["open_jeep_carpoc_speedboost_sparks"] = loadfx( "vfx/iw8_br/gameplay/veh/nitro/vfx_br_s4_nitro_explosion.vfx" );
        level._effect["open_jeep_carpoc_speedboost_exhaust_loop"] = loadfx( "vfx/iw8_br/gameplay/veh/nitro/vfx_br_s4_nitro_exhaust.vfx" );
    }
}
    ...
    if ( var_2 == "driver" )
    {
        for (;;)
        {
            ...
            if ( var_6 )
            {
                if ( !var_4 )
                {
                    playfxontag( scripts\engine\utility::getfx( "open_jeep_carpoc_speedboost_exhaust_loop" ), var_0, "tag_exhaust" );
                    playfxontag( scripts\engine\utility::getfx( "open_jeep_carpoc_speedboost_sparks" ), var_0, "tag_exhaust" );
            ...
            {
                stopfxontag( scripts\engine\utility::getfx( "open_jeep_carpoc_speedboost_exhaust_loop" ), var_0, "tag_exhaust" );
                stopfxontag( scripts\engine\utility::getfx( "open_jeep_carpoc_speedboost_sparks" ), var_0, "tag_exhaust" );
...
open_jeep_carpoc_speed_boost_vfx_cleanup( var_0, var_1 )
{
    killfxontag( scripts\engine\utility::getfx( "open_jeep_carpoc_speedboost_exhaust_loop" ), var_0, "tag_exhaust" );
    killfxontag( scripts\engine\utility::getfx( "open_jeep_carpoc_speedboost_sparks" ), var_0, "tag_exhaust" );
    var_1 setclientomnvar( "ui_deadsilence_overlay", 2 );
}
