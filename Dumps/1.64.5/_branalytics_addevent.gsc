...
_id_11D51()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "motorcycle", "initLate", ::_id_11D52 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "motorcycle", "create", ::_id_11D4F );
    scripts\engine\utility::create_func_ref( "motorcycle", ::_id_134FB );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "motorcycle", "spawnCallback", ::_id_11D54 );
    scripts\cp\vehicles\vehicle_oob_cp::vehicle_oob_cp_registeroutoftimecallback( "motorcycle", _calloutmarkerping_poolidisentity::_id_11D5D );
}
