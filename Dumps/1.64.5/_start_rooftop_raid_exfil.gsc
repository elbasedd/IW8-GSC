...
game_start()
{
    ...
    for (;;)
    {
        ...
        level._id_13D6F = 1;
        _tablethide::trial_ui_set_stat_and_bonus_time( level._id_13D6F, "accuracy", 0, 0 );
        level._id_13D6F++;
        ...
        if ( level.trial["missionScript"] != "gun_nonlinear" )
        {
            ...
            level._id_13D6F++;
            _tablethide::trial_ui_set_stat_and_bonus_time( level._id_13A88, "enemy_targets_hit_ratio", 0, 0 );
        }
...
game_end()
{
    ...
    for (;;)
    {
        ...
        {
            var_7.activated = 0;
            var_7 thread _stop_spawn_modules::_id_13D74( "down" );
        }
...
targets_missed_calculate()
{
    ...
    if ( level.trial["missionScript"] != "gun_nonlinear" )
        _tablethide::trial_ui_set_stat_and_bonus_time( level._id_13A88, "enemy_targets_hit_ratio", level.enemy_targets.size - level.enemies_missed, level.missed_time_penalty );
}
...
accuracy_think()
{
    ...
    for (;;)
    {
        level.player scripts\engine\utility::_id_143A5( "weapon_fired", "fake_weapon_fired" );
        level.shots_fired++;
