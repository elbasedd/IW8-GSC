...
start_coop_push( var_0 )
{
    ...
    level.unloading_func["mindia8"] = scripts\cp\raid_utility::_id_129E7;
    level.unloading_func["vindia_a2"] = ::_id_129ED;
    level.unloading_func["umike_covered_physics"] = ::_id_129EC;
...
{
    var_1 endon( "death" );
    var_0 scripts\engine\utility::_id_143AD( "disconnect", "last_stand" );
    var_1 delete();
}
...
cp_donetsk_spawning()
{
    scripts\cp\cp_modular_spawning::registerambientgroup( "left_enemy_turret", 1, 1, 999999, [ ::_id_143CE, 1, 10, 20 ], undefined, ::select_left_turret_spawners, undefined, undefined, undefined );
    scripts\cp\cp_modular_spawning::registerambientgroup( "right_enemy_turret", 1, 1, 999999, [ ::_id_143CE, 1, 10, 20 ], undefined, ::select_right_turret_spawners, undefined, undefined, undefined );
    scripts\cp\cp_modular_spawning::registerambientgroup( "middle_enemy_turret", 1, 1, 999999, [ ::_id_143CE, 1, 7, 15 ], undefined, ::select_middle_turret_spawners, undefined, undefined, undefined );
    scripts\cp\cp_modular_spawning::registerambientgroup( "enemy_mortar", 1, 1, 999999, [ ::_id_143CE, 1, 25, 35 ], undefined, ::select_mortar_spawners, undefined, undefined, undefined );
    scripts\cp\cp_modular_spawning::registerambientgroup( "enemy_sniper", 1, ::get_enemy_sniper_max_spawn, 999999, [ ::_id_143CE, ::get_enemy_sniper_max_spawn, 15, 25 ], undefined, ::select_enemy_sniper_spawners, undefined, undefined, undefined );
    ...
    scripts\cp\cp_modular_spawning::register_module_ai_spawn_func( "under_bridge_reinforce", ::_id_13F04 );
...
{
    var_1 = 20;
    var_2 = var_0 scripts\engine\utility::_id_143AD( "revive", "disconnect" );
...
{
    var_0 endon( "death" );
    var_0 scripts\engine\utility::_id_143A5( "goal", "goal_reached" );
...
sniper_target_think( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_3 ) && is_new_target( var_3, var_0 ) )
        {
            ...
            var_8 = var_3 scripts\engine\utility::_id_143B9( randomfloatrange( 1.5, 2 ), "last_stand" );
...
watchgastrapdamage( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_2 = var_0 scripts\engine\utility::_id_143B5( "hover_attack", "increase_accuracy", "hover_retreat" );
...
player_vo_confirm_pickup( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_143A5( "near_goal", "goal" );
    return var_1;
}
...
getdismembermentlist( var_0 )
{
    ...
    {
        _id_12BD4( var_0, "counterclockwise" );
        return;
    }

    if ( !c130_lights( var_0, [ 5, 6, 7 ] ) )
    {
        _id_12BD4( var_0, "clockwise" );
        return;
    }
}
...
landmine_run_on_player( var_0 )
{
    ...
    else
    {
        ...
        var_0 scripts\engine\utility::_id_143B9( 1, "death" );
        var_0.shouldskipdeathsshield = undefined;
        var_0.landmine_active = 0;
        var_0.shouldskiplaststand = 0;
