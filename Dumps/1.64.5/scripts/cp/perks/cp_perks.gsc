...
init_core_mp_perks()
{
    ...
    registerscriptperk( "specialty_reduce_regen_delay_on_kill", ::_id_131B9, ::_id_13F6D );
    ...
    registerscriptperk( "specialty_hardmelee", ::_id_13094, ::_id_13F31 );
}
...
_id_11A8D()
{
    ...
    {
        level._id_1215F[var_1] = spawn( "script_model", ( 0, 0, 0 ) );
        level._id_1215F[var_1].angles = ( 0, 0, 0 );
        level._id_1215F[var_1] setmodel( "container_ammo_box_01_nophysics_cp" );
        level._id_1215F[var_1] enableplayermarks( "equipment" );
    }
...
recharge_lethals_over_time( var_0 )
{
    ...
    for (;;)
    {
        self._id_12141 = register_chopper_boss_combat_actions( self, "primary" );
        self._id_12142 = register_chopper_boss_combat_actions( self, "secondary" );
...
kill_drone_turret( var_0, var_1 )
{
    ...
    thread _id_138C5( "ui_lethal_recharge_progress", "primary" );
    var_0._id_14387 = 1;
    _id_13FAC( "ui_lethal_recharge_progress", var_1, 0 );
    var_0._id_14387 = 0;
...
kill_furthest_enemy( var_0, var_1 )
{
    ...
    thread _id_138C5( "ui_tactical_recharge_progress", "secondary" );
    var_0._id_14388 = 1;
    _id_13FAC( "ui_tactical_recharge_progress", var_1, 1 );
    var_0._id_14388 = 0;
