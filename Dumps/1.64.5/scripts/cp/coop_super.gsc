...
activate_thermite_launcher()
{
    ...
    scripts\cp\cp_analytics::_id_119BE( self, "thermite_launcher" );
...
at_mine_movingplatform_update()
{
    ...
    if ( var_0 )
    {
        var_1 = scripts\engine\utility::_id_143AE( "super_use_succeeded", "super_use_failed", "laststand" );
        ...
        if ( var_1 == "super_use_succeeded" )
        {
            ...
            scripts\cp\cp_analytics::_id_119BE( self, "scout drone" );
            thread drain_super_meter( 1 );
            _id_14356();
            return;
        }
...
deactivate_mark_enemies( var_0 )
{
    ...
    level endon( "game_ended" );
    var_1 = scripts\engine\utility::_id_143B9( var_0, "force_end_super" );
...
activate_team_auto_revive( var_0 )
{
    ...
    if ( var_2 )
    {
        ...
        scripts\cp\cp_analytics::_id_119BE( self, "team auto-revive" );
        drain_super_meter( 1 );
    }
...
activate_team_armor_buff()
{
    ...
    scripts\cp\cp_analytics::_id_119BE( self, "team armor" );
...
deactivate_team_armor_buff( var_0 )
{
    ...
    level endon( "game_ended" );
    var_1 = self getentitynumber();
    var_2 = scripts\engine\utility::_id_143B9( var_0, "force_end_super" );
    setomnvar( "ui_class_power_reloading", var_1 );
...
activate_team_stopping_power()
{
    ...
    level endon( "game_ended" );
    self.super_activated = 1;
    scripts\cp\cp_analytics::_id_119BE( self, "team stopping_power" );
...
monitormounted()
{
    ...
    scripts\cp\cp_analytics::_id_119BE( self, "emp drone" );
    thread drain_super_meter( 1 );
}
