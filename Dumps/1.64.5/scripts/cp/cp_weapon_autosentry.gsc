...
watch_dpad()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_143AD( "pullout_sentry", "pullout_ammocrate" );
...
setcarryingsentry( var_0, var_1 )
{
    ...
    for (;;)
    {
        var_2 = scripts\engine\utility::_id_143B1( "place_sentry", "cancel_sentry_left", "cancel_sentry_right", "cancel_sentry_down", "force_cancel_placement", "cancel_sentry" );
