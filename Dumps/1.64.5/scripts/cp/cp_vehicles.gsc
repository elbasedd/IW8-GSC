...
{
    self endon( "death" );
    var_2 = scripts\engine\utility::_id_143AD( "stop_follow_path", "unload_guys" );
    wait 0.75;
...
delete_on_end()
{
    ...
    self endon( "death" );
    wait 0.25;
    scripts\engine\utility::_id_143A5( "unloaded", "stop_follow_path" );
}
...
stop_vehicle_on_damage()
{
    ...
    var_0 = self.vehicle;
    var_1 = scripts\engine\utility::_id_143AD( "damage", "death" );
    ...
    if ( var_4.size > 0 )
    {
        foreach ( var_6 in var_4 )
        {
            ...
            if ( isdefined( var_7 ) )
            {
                ...
                if ( _id_141B4( var_2 ) || getdvarint( "scr_script_model_drivers", 0 ) )
    ...
    if ( var_4.size > 0 )
    {
        foreach ( var_6 in var_4 )
        {
            ...
            if ( isdefined( var_8 ) )
            {
                ...
                if ( _id_141B4( var_2 ) || getdvarint( "scr_script_model_drivers", 0 ) || scripts\cp\utility::turn_off_sniper_laser() )
...
decrement_vehicles_active( var_0, var_1 )
{
    ...
    var_4 = scripts\engine\utility::_id_143AD( "death", "unloaded" );
...
allow_infil_after_full_or_timeout( var_0, var_1 )
{
    ...
    if ( isdefined( level.ai_spawn_vehicle_func[var_1].max_wait_for_infil ) )
        scripts\engine\utility::_id_143B9( level.ai_spawn_vehicle_func[var_1].max_wait_for_infil, "stop_waiting_for_spawns" );
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        {
            childthread _id_1301B( "spawning_done" );

            if ( isdefined( self.group ) )
                self.group scripts\engine\utility::_id_143B9( 3, "death" );
            else
                wait 3;
...
vehicle_registrations( var_0, var_1, var_2, var_3 )
{
    ...
    level thread init_ammo_boxes( "lbravo_ambient", "veh8_mil_air_lbravo_personnel_cp", "lbravo_infil_cp", "script_vehicle_iw8_lbravo_ambient" );
    ...
    level thread _id_12B05( "mindia8_jugg", undefined, undefined, undefined, undefined, undefined, undefined, 3, undefined, undefined );
    ...
    _id_12AFD( "techo_phys" );
    _id_12AFD( "techo_white" );
...
{
    level endon( "game_ended" );
    scripts\engine\utility::_id_143A5( "death", "deleting_vehicle" );
...
heli_move_to_target( var_0 )
{
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        scripts\engine\utility::_id_143B9( 15, "near_goal" );
    }
