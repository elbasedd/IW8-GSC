...
main()
{
    ...
    scripts\engine\utility::create_func_ref( "spawn_ai", ::_id_134EC );
...
pausemenu_think()
{
    ...
    for (;;)
    {
        ...
        if ( var_0 == "vote_retry" )
        {
            scripts\cp\laser_traps\cp_laser_traps::_id_1430E( "retry", 30 );
            scripts\cp\laser_traps\cp_laser_traps::_id_1430B( "retry", 1 );
        }
    }
}
...
resetplayerhud()
{
    foreach ( var_1 in level.players )
    {
        if ( isdefined( var_1.current_vehicle_seat ) )
        {
            ...
            var_1 scripts\cp\maps\cp_br_syrk\vehicle_travel.gsc::enter_seat_omnvar( var_1, var_2 );
        }
    }
}
