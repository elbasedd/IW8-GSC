...
nopropsspectate( var_0 )
{
    ...
    {
        self._id_1459F = [ "ac130_105mm_mp", "ac130_40mm_mp", "ac130_25mm_mp" ];
    ...
    for (;;)
    {
        var_1 = scripts\engine\utility::_id_143AD( "gunship_switch_debug_weapon", "gunship_shoot_debug_location" );
