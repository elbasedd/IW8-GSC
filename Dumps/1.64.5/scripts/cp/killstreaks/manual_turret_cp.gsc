...
init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "munitionUsed", ::_id_11AC3 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "watchForPlayerEnteringLastStand", ::_id_11AC2 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "manual_turret", "allowPickupOfTurret", ::_id_11ABF );
}
...
_id_11AC2()
{
    ...
    thread scripts\cp_mp\killstreaks\manual_turret::_id_11AC6( "last_stand" );
