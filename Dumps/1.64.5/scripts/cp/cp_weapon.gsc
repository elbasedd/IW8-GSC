...
beginc4tracking()
{
    ...
    self endon( "death" );
    self endon( "disconnect" );
    scripts\engine\utility::_id_143A6( "grenade_fire", "weapon_change", "offhand_end" );
    self.changingweapon = undefined;
}
...
{
    scripts\engine\utility::_id_143A7( "mine_triggered", "mine_destroyed", "mine_selfdestruct", "death" );
...
recordthrowingknifetraveldist()
{
    ...
    for (;;)
    {
        var_1 = scripts\engine\utility::_id_143BA( 0.15, "death", "missile_stuck" );
...
throwingknifeused_recordownerinvalid( var_0, var_1 )
{
    ...
    var_1 endon( "death" );
    var_0 scripts\engine\utility::_id_143A5( "death", "disconnect" );
