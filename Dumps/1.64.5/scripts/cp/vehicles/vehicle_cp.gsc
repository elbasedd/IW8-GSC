...
vehicle_cp_init()
{
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "create", ::_id_14133 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "createLate", ::_id_14134 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "deleteNextFrame", ::_id_14135 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "deleteNextFrameLate", ::_id_14136 );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle", "hide", ::_id_14137 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_compass", "init", _branalytics_geteventtimestamp::_id_1411E );
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_damage", "init", _branalytics_headerplayer::_id_1413F );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "motorcycle", "init", _branalytics_addevent::_id_11D51 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "vehicle_tracking", "vehicle_spawned", ::_id_14220 );
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "open_jeep", "init", _branalytics_addeventallowed::_id_120F4 );
