...
start_heli_trip_sequence( var_0, var_1, var_2, var_3 )
{
    ...
    level.heli_trip_vehicle scripts\engine\utility::_id_143A5( "all_players_on_board", "heli_trip_timed_out" );
...
_id_13BC7( var_0 )
{
    ...
    {
        var_1._id_121FB = spawn( "script_model", var_1.origin - ( 0, 0, 100 ) );
...
waitforhvtonboard()
{
    ...
    var_0 thread _id_14371( var_5, "left", "hvt_triggered_right" );
