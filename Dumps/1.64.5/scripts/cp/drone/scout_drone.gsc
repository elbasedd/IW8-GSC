...
playremotesequence( var_0, var_1 )
{
    ...
    var_4 = scripts\engine\utility::_id_143B9( 1.8, "death" );
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    var_7 = 30;
    var_0 scripts\engine\utility::_id_143BA( var_7, "death", "set_noscopeoutline" );
...
markent_watchmarkingentstatus( var_0 )
{
    ...
    scripts\engine\utility::_id_143A6( "explode", "death", "leaving" );
    wait 3;
    unmark( var_0 );
}
...
markent_watchtargetstatus( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_1 ) )
        var_0 scripts\engine\utility::_id_143BB( var_1, "death", "disconnect", var_2 );
    else
        var_0 scripts\engine\utility::_id_143A6( "death", "disconnect", var_2 );
