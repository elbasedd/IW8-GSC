...
deploy_drone( var_0, var_1 )
{
    ...
    if ( istrue( var_1.play_intro ) )
    {
        ...
        var_2 = var_0 scripts\engine\utility::_id_143BA( 0.6, "last_stand", "cancel_deploy_helper_drone" );
        ...
        var_2 = var_0 scripts\engine\utility::_id_143B9( 1.4, "last_stand" );
...
player_exit_monitor( var_0, var_1 )
{
    ...
    var_2 = var_0 scripts\engine\utility::_id_143A6( "last_stand", "disconnect", "exit_drone" );
    exit_drone( var_0, var_1 );
    drone_explode( var_1 );
}
