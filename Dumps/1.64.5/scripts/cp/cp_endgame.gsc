...
_id_1252D()
{
    for (;;)
    {
        ...
        {
            var_0 setclientomnvar( "post_game_state", level._id_127FF );
...
_id_13446()
{
    level thread _id_13445( "axis", get_end_game_string_index( "host_end" ) );
}
...
_id_13445( var_0, var_1 )
{
    ...
    if ( var_20._id_1376C > 0 )
        setomnvar( "ui_so_stars_given", var_20._id_1376C );

    setomnvar( "ui_so_next_score", var_20._id_11E84 );
    ...
    if ( getdvarint( "LTSNLQNRKO" ) )
    {
        foreach ( var_3 in level.players )
        {
            if ( var_20._id_1376C > 0 )
            {
                ...
                var_3 reportchallengeuserevent( "spec_ops_end", var_23, var_20._id_1376C );
            }
        }
    }
...
_id_13448( var_0 )
{
    ...
    var_1.vehicle_compass_cp_init = int( tablelookupbyrow( "cp/cp_so_mission_table.csv", var_2, 5 ) );
    return var_1;
}
...
{
    kill_em_all();
    level scripts\engine\utility::_id_143B9( 15, "intermission_over" );
