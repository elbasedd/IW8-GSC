...
_id_13529( var_0 )
{
    ...
    foreach ( var_3 in var_1 )
    {
        ...
        if ( isdefined( var_3._id_11EBF ) && int( var_3._id_11EBF ) != 0 && var_3._id_11EBF != "false" )
            var_6 = 4;

        if ( isdefined( var_3._id_11E99 ) && int( var_3._id_11E99 ) != 0 && var_3._id_11E99 != "false" )
            var_6 = var_6 + 8;

        if ( isdefined( var_3._id_11EB6 ) && int( var_3._id_11EB6 ) != 0 && var_3._id_11EB6 != "false" )
            var_6 = var_6 + 16;
