...
jugg_music()
{
    ...
    scripts\engine\utility::_id_143A6( "juggernaut_end", "disconnect", "death" );
    var_0 delete();
}
...
debug_kill_soldier( var_0 )
{
    ...
    var_0 scripts\engine\utility::_id_143A5( "goal_reached", "goal" );
    wait 2;
...
registerambientgroup( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_10.set_chosen_spawner_from_uid = [ "frag_grenade_mp", "molotov_mp", "semtex_mp", "flash_grenade_mp", "concussion_grenade_mp", "smoke_grenade_mp", "gas_mp" ];
...
remove_headicon_on_death()
{
    ...
    var_0 = self.headicon;
    var_1 = scripts\engine\utility::_id_143A5( "death", "remove_headicon" );
...
_id_12DF3()
{
    level endon( "game_ended" );
    self endon( "death" );
    var_0 = level scripts\engine\utility::_id_143AD( "spawn_module_" + self.moduleid + "_completed", "spawnModuleTimedOut_" + self.moduleid );
    ...
    if ( isdefined( self.post_module_delay ) )
    {
        ...
        if ( isdefined( var_1 ) && isnumberandgreaterthanzero( var_1 ) )
            level scripts\engine\utility::_id_143B9( var_1, "new_module_requested" );
...
fake_flashlight( var_0 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        if ( isdefined( self gettagorigin( var_4, 1 ) ) )
        {
            ...
            scripts\engine\utility::_id_143A8( "alerted", "spotted_player", "enter_combat", "alertNearbyEnemiesAfterDelay", "shooting" );
...
{
    if ( isdefined( var_1 ) )
        level scripts\engine\utility::_id_143B9( var_1, "module_group " + var_0.group_name + " completed" );
    else
...
{
    if ( isdefined( var_1 ) )
        var_0 scripts\engine\utility::_id_143B9( var_1, "group_spawning_completed" );
    else
        var_0 waittill( "group_spawning_completed" );
}
...
go_to_node_end()
{
    ...
    var_0 = scripts\engine\utility::_id_143AD( "reached_path_end", "stop_going_to_node" );
...
decrement_door_count_on_death( var_0, var_1, var_2, var_3 )
{
    ...
    var_1 scripts\engine\utility::_id_143A5( "death", "door_infil_anim_completed" );
