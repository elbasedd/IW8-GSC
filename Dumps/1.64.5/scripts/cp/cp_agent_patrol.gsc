...
removeifalerted( var_0, var_1 )
{
    ...
    var_0 endon( "stalled" );
    var_0 endon( "death" );
    var_0 scripts\engine\utility::_id_143A5( "death", "alerted" );
...
alertnearbyloop( var_0 )
{
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::_id_143AC( "shooting" );
...
setweaponsfree( var_0 )
{
    ...
    for (;;)
    {
        var_1 = var_0 scripts\engine\utility::_id_143BA( 5, "shooting", "spotted_player" );
