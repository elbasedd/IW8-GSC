...
heli_think_default( var_0, var_1, var_2 )
{
    ...
    for (;;)
    {
        ...
        var_0 scripts\engine\utility::_id_143BA( 60, "target_engaged", "needs_to_evade" );
        var_0.nocircle = 0;
    }
}
...
heli_rocket_think_default( var_0 )
{
    ...
    for (;;)
    {
        ...
        var_0 scripts\engine\utility::_id_143A5( "target_engaged", "needs_to_evade" );
    }
}
...
heli_move_to_target( var_0 )
{
    ...
    scripts\engine\utility::_id_143BB( 15, "goal", "goal_reached", "near_goal" );
}
...
heli_go_search( var_0, var_1, var_2 )
{
    ...
    scripts\engine\utility::_id_143BA( 15, "goal", "goal_reached" );
