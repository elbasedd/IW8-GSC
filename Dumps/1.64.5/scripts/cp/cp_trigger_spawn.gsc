...
go_fight( var_0 )
{
    ...
    scripts\engine\utility::_id_143A5( "goal_reached", "goal" );
...
patrol_path( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        scripts\engine\utility::_id_143BA( 15, "goal_reached", "goal" );
    ...
    if ( !istrue( self.has_alert_icon ) )
    {
        ...
        if ( !istrue( var_3 ) )
        {
            ...
            if ( isdefined( var_5 ) && var_5 != "can_see" )
                var_5 = scripts\engine\utility::_id_143BE( var_0, var_2, "can_see", "death", "near_me", "damage", "hear_turret" );
        }
...
detected_temp_stealth_meter( var_0, var_1 )
{
    self notify( "icon_cancel_delete" );
    self endon( "icon_deleted" );
    scripts\engine\utility::_id_143BA( var_1, "death", "alerted" );
    wait 0.5;
...
fallback_to_closest_spot( var_0 )
{
    ...
    scripts\engine\utility::_id_143A5( "goal", "goal_reached" );
