...
_id_119CC( var_0 )
{
    ...
    self dlog_recordplayerevent( "dlog_event_cp_player_match_end", [ "utc_connect_time_s", var_28, "utc_disconnect_time_s", getsystemtime(), "player_xp_modifier", int( scripts\cp\drone\emp_drone::getrankxpmultipliertotal() ), "team_xp_modifier", var_2, "weapon_xp_modifier", int( scripts\cp\cp_weaponrank::getweaponrankxpmultipliertotal() ), "battlepass_xp_modifier", int( scripts\cp\drone\emp_drone::registerpublicevent() ), "total_xp", var_3, "score_xp", var_4, "challenge_xp", var_5, "match_xp", var_6, "medal_xp", var_7, "bonus_xp", var_8, "misc_xp", var_9, "rank", var_10, "end_xp", var_12, "end_time_played_total", var_20, "end_prestige", var_22, "disconnect_reason", var_1, "average_speed_during_match", var_26, "percent_time_moving", var_27, "active_objective", level.active_objectives_string, "last_completed_objective", var_29, "result", var_1 ] );
}
...
watchforbasicplayerevents()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_143B6( "adjustedStance", "jumped", "weapon_fired", "reload_start", "spawned_player" );
