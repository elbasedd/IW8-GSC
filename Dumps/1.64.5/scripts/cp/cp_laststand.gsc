...
wait_to_be_revived( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    else
    {
        ...
        if ( var_14 == "timeout" && _id_124C4( var_0 ) )
            var_14 = var_12 scripts\engine\utility::_id_143AD( "revive_success", "revive_fail" );
...
init_laststand_anims()
{
    ...
    scripts\common\anim::addnotetrack_customfunction( "ls_revive_helper", "stim_attach", ::_id_139DE );
    scripts\common\anim::addnotetrack_customfunction( "ls_revive_helper", "syringe_inject", ::_id_139DD );
    scripts\common\anim::addnotetrack_customfunction( "ls_revive_helper", "syringe_finish", ::_id_139DA );
    scripts\common\anim::addnotetrack_customfunction( "ls_revive_helper", "syringe_finish_crouching", ::_id_139DB );
    scripts\common\anim::addnotetrack_customfunction( "ls_revive_helper", "syringe_finish_standing", ::_id_139DC );
}
