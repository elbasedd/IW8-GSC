...
{
    var_1 endon( "death" );
    var_2 = var_0 scripts\engine\utility::_id_143AD( "death", "perform_airburst" );
...
stopremotesequence( var_0 )
{
    ...
    scripts\engine\utility::_id_143B9( 1.3, "death" );
    ...
    for (;;)
    {
        while ( !isdefined( self.owner ) )
        {
            ...
            else
            {
                ...
                self.mgturret scripts\engine\utility::_id_143B9( 5, "turret_on_target" );
