...
zombiescriptedstealth( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        var_2 = var_0 scripts\engine\utility::_id_143AF( "alerted", "damage", "reset_stealth", "alerted_by_ai" );
...
removeifalerted( var_0, var_1 )
{
    ...
    var_0 endon( "goal" );
    var_0 endon( "stalled" );
    var_0 scripts\engine\utility::_id_143A6( "death", "alerted", "alerted_by_ai" );
...
_setgoalpos( var_0, var_1, var_2 )
{
    ...
    var_15 = var_0 scripts\engine\utility::_id_143AD( "goal", "goal_reached" );
}
