    ...
    if ( !isdefined( var_4 ) )
    {
        if ( isdefined( level._id_12880 ) && level._id_12880.size > 0 )
        {
            for ( var_6 = level._id_12880.size - 1; var_6 >= 0; var_6-- )
            {
                ...
                {
                    var_7 = scripts\engine\utility::getstructarray( level._id_12880[var_6], "targetname" );
...
_id_131D9()
{
    ...
    {
        case "cp_scaletest":
            level._id_12880 = [ "plant_jammers", "infil_plane" ];
            break;
        case "cp_dwn_twn_2":
            level._id_12880 = [ "ml_p1_intel" ];
            break;
        case "cp_armsdealer_2":
            level._id_12880 = [ "plant_jammers" ];
            break;
        case "cp_arms_dealer":
            level._id_12880 = [ "morales_1" ];
            break;
        case "cp_smuggler":
            level._id_12880 = [ "obj_caches" ];
            break;
        case "cp_landlord":
            level._id_12880 = [ "obj_tmtyl" ];
            break;
        case "cp_landlord_2":
            level._id_12880 = [ "ba_mnu" ];
            break;
    }
}
...
start_black_screen( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        ...
        var_0 thread scripts\cp\respawn\cp_respawn::_id_12768( 0.0, 1.5, 1, "white" );
...
{
    scripts\engine\utility::_id_143A6( "parachute_complete", "parachute_landed", "skydive_land" );
    self setcandamage( 1 );
...
setup_comms_obj_crate( var_0 )
{
    ...
    var_0 thread scripts\cp\respawn\cp_respawn::_id_12768( 0.0, 1, 1, "white" );
