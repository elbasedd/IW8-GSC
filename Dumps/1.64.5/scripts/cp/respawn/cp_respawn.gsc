...
respawn_bleedout_func( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    for (;;)
    {
        var_23 = var_0 scripts\engine\utility::_id_143AE( "respawn_player", "auto_respawn", "forced_revive_to_regroup" );
...
_id_12BFA()
{
    ...
    scripts\engine\utility::_id_143A5( "death", "last_stand" );
    scripts\common\utility::allow_usability( 1 );
    self.waitgiveammo = undefined;
}
...
show_respawn_hint()
{
    ...
    scripts\engine\utility::_id_143B9( 6, "br_jump" );
...
camera_setup_for_lerping( var_0, var_1 )
{
    ...
    var_0 thread _id_12768( 0.0, 1, 0.25, "black" );
