...
playerhealthregen()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_143A5( "damage", "health_perk_upgrade" );
...
playerarmor()
{
    ...
    for (;;)
    {
        scripts\engine\utility::_id_143A5( "player_damaged", "enable_armor" );
...
item_oncarrierdeath( var_0 )
{
    ...
    self endon( "death" );
    var_0 endon( "disconnect" );
    var_1 = var_0 scripts\engine\utility::_id_143AD( "death", "last_stand" );
...
segmented_health_regen( var_0 )
{
    ...
    for (;;)
    {
        var_0 scripts\engine\utility::_id_143AD( "damage", "revive" );
