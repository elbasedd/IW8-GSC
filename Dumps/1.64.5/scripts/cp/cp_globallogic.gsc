...
init()
{
    ...
    level._id_12D73 = "vfx/iw8/core/blima/vfx_blima_explosion.vfx";
    ...
    level._id_12376 = getdvarint( "LOPLPOKTOP", 0 );
...
{
    var_0 scripts\engine\utility::_id_143BA( var_2, "death", "disconnect" );
    var_3 delete();
    var_1 delete();
}
...
demo_debug_outline_button_watcher()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::_id_143BF( 2, "first" );

        if ( var_0 == "timeout" )
            continue;

        var_0 = scripts\engine\utility::_id_143BF( 2, "second" );
        ...
        var_0 = scripts\engine\utility::_id_143BF( 2, "third" );
...
spawnplayer_actual( var_0 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        else
        {
            ...
            thread scripts\cp\respawn\cp_respawn::_id_12768( 0.0, 1.5, 1, "black" );
    ...
    else if ( !scripts\cp\cp_endgame::gamealreadyended() && !istrue( var_0 ) )
    {
        if ( !scripts\cp\utility::turn_off_sniper_laser() && !istrue( self.unset_relic_oneclip ) )
        {
            ...
            scripts\engine\utility::_id_143A5( "loadout_given", "start_hotjoining_via_c130" );
