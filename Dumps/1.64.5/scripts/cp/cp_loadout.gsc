...
change_loadout_watcher( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 == "weapon_purchased" && scripts\cp\utility::turn_off_sniper_laser() )
        {
            _id_139D7();
        ...
        if ( var_1 == "attachment_purchased" && scripts\cp\utility::turn_off_sniper_laser() )
        {
            _id_139D7();
        ...
        if ( var_1 == "tactical_purchased" && scripts\cp\utility::turn_off_sniper_laser() )
        {
            _id_139D7();
        ...
        if ( var_1 == "lethal_purchased" && scripts\cp\utility::turn_off_sniper_laser() )
        {
            _id_139D7();
        ...
        if ( var_1 == "shrapnel_perk_purchased" && scripts\cp\utility::turn_off_sniper_laser() )
        {
            _id_139D7();
        ...
        if ( var_1 == "ammo_purchased" && scripts\cp\utility::turn_off_sniper_laser() )
        {
            var_5 = scripts\cp\utility::getvalidtakeweapon();
            _id_139D7();
        ...
        if ( isdefined( self.play_disguise_vo ) )
        {
            ...
            if ( isdefined( level.outofboundstriggers ) && level.outofboundstriggers.size > 0 )
            {
                if ( istrue( self.oob ) )
                {
                    ...
                    level._id_11EDF.origin = getent( "nuclear_core_crashed", "targetname" ).origin;
                    level._id_11EDF.angles = getent( "nuclear_core_crashed", "targetname" ).angles;
                }
            }
