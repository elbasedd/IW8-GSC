...
patrol_notehandler_cellphone( var_0, var_1 )
{
    ...
    {
        case "attach":
            self.idle_prop = scripts\common\anim::anim_link_tag_model( _id_12209(), "tag_accessory_right" );
            wait 2;
...
patrol_playidlesittingloop( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        [[ level.playercanplaynotcriticalgesture ]]( "idle_chair", var_2, var_3, self._blackboard.idlenode.angles );
...
patrol_playdeathanim_sitting( var_0, var_1, var_2 )
{
    if ( isdefined( self.animated_prop ) )
        self [[ level.playercanseedangercircleworld ]]( "idle_chair", var_2 );
...
patrol_playidlesittingreact( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        self [[ level.playercanbuyrespawn ]]( "idle_chair", var_2 );
