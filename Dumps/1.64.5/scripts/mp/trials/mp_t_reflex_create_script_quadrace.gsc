...
{
    if ( scripts\asm\asm::asm_eventfired( var_0, "code_move" ) && _id_134BC( var_0, var_1, var_2, var_3 ) )
        return 1;
...
soldier_br_chooseexposedidle( var_0, var_1, var_2 )
{
    if ( !soldier_br_isalert() )
...
soldier_br_isalert( var_0, var_1, var_2, var_3 )
{
    return self.spec == "soldier_lw_br_rpg" || self.alertlevel != "noncombat";
}

soldier_br_playturnanim( var_0, var_1, var_2 )
{
...
soldier_br_chooseturnanim( var_0, var_1, var_2 )
{
    if ( !soldier_br_isalert() )
    {
...
soldier_br_playturnanim_cleanup( var_0, var_1, var_2 )
{
