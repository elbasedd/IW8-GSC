...
playerthinkanim( var_0, var_1 )
{
    ...
    {
        if ( self.team == "allies" && ( var_0._id_1214C == "alpha1" || var_0._id_1214C == "alpha2" ) )
            var_2 = "bravo";

        if ( self.team == "axis" && var_0._id_1214C == "bravo" )
            var_2 = "alpha";
    }
...
{
    if ( self._id_1214C != self.subtype && getdvar( "mapname" ) == "mp_downtown_gw" )
        var_2 = self._id_1214C;

    if ( var_0 == "allies" && ( self._id_1214C == "alpha" || self._id_1214C == "alpha2" ) && getdvar( "mapname" ) == "mp_boneyard_gw" )
        var_2 = self._id_1214C;
...
initanims( var_0, var_1, var_2 )
{
    ...
    scripts\common\anim::addnotetrack_customfunction( "slot_0", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_1", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_2", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_3", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_4", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_5", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_alpha" );
    scripts\common\anim::addnotetrack_customfunction( "slot_0", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_1", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_2", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_3", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_4", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_bravo" );
    scripts\common\anim::addnotetrack_customfunction( "slot_5", "fov_63_2", scripts\mp\utility\infilexfil::_id_12497, "lbravo_infil_bravo" );
