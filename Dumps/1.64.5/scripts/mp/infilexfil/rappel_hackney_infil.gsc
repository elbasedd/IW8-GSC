...
initanims( var_0 )
{
    ...
    if ( !isdefined( level.scr_notetrack ) || !isdefined( level.scr_notetrack["commander"] ) )
    {
        ...
        scripts\common\anim::addnotetrack_customfunction( "commander", "scn_infil_hackney_heli1_rope", ::_id_13293 );
        scripts\common\anim::addnotetrack_customfunction( "commander", "scn_infil_hackney_heli2_rope", ::_id_13294 );
    }
...
script_model_alpha_anims( var_0 )
{
    switch ( var_0 )
    {
        case "alpha":
            ...
            scripts\common\anim::addnotetrack_customfunction( "slot_0", "scn_infil_hackney_heli_npc1", ::_id_12EEE );
            ...
            scripts\common\anim::addnotetrack_customfunction( "slot_1", "scn_infil_hackney_heli_npc2", ::_id_12EEF );
            ...
            scripts\common\anim::addnotetrack_customfunction( "slot_2", "scn_infil_hackney_heli_npc3", ::_id_12EF0 );
            break;
        case "bravo":
            level.scr_animtree["pilot"] = #animtree;
            ...
            scripts\common\anim::addnotetrack_customfunction( "slot_0", "scn_infil_hackney_heli_npc4", ::_id_12EF1 );
            level.scr_animtree["slot_1"] = #animtree;
            ...
            scripts\common\anim::addnotetrack_customfunction( "slot_1", "scn_infil_hackney_heli_npc5", ::_id_12EF2 );
            level.scr_animtree["slot_2"] = #animtree;
            ...
            scripts\common\anim::addnotetrack_customfunction( "slot_2", "scn_infil_hackney_heli_npc6", ::_id_12EF3 );
            break;
    }
}
