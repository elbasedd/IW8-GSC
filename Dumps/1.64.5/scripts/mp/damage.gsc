...
callback_playerdamage_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15 )
{
    ...
    else
    {
        ...
        {
            if ( var_5 == "MOD_RIFLE_BULLET" || var_5 == "MOD_PISTOL_BULLET" )
            {
                if ( var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_sprinting_dr" ) && ( var_2 issupersprinting() || var_2 issprintsliding() ) )
                {
                    var_40 = var_3;
...
handledamagefeedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 != var_2 && var_3 + var_8 + var_9 > 0 && ( !isdefined( var_6 ) || var_6 != "shield" ) )
    {
        ...
        if ( var_2 scripts\mp\utility\perk::_hasperk( "specialty_pistoldeath" ) && isdefined( var_2.inlaststand ) && var_2.inlaststand == 1 && !var_2.hasshownlaststandicon )
        {
            ...
            var_13 = "stun";
        else if ( scripts\mp\utility\damage::istacticaldamage( var_5, var_4 ) && var_2 scripts\mp\utility\perk::_hasperk( "specialty_stun_resistance" ) && !var_2 scripts\mp\utility\perk::_hasperk( "penalty_stun_more" ) )
            var_13 = "hittacresist";
            ...
            var_13 = "hitarmorreinforced";
        else if ( var_8 == 0 && var_2 scripts\mp\utility\perk::_hasperk( "specialty_br_serpentine" ) && ( var_2 issupersprinting() || var_2 issprintsliding() ) )
