...
main()
{
    ...
    scripts\mp\maps\mp_cave\mp_cave_precache.gsc::main();
    scripts\mp\maps\mp_cave\gen\mp_cave_art.gsc::main();
    scripts\mp\maps\mp_cave\mp_cave_fx.gsc::main();
...
{
    var_0 = [];
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( -548, 2268, 100 ), ( 0, 330, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 655, 2395, 149 ), ( 0, 315, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 576, 1152, 176 ), ( 0, 315, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 177, 1394, 108 ), ( 0, 15, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 1847, 1074, 112 ), ( 0, 225, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 1555, -52, 92 ), ( 0, 135, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 1292, 1024, 129 ), ( 0, 270, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 1554, -223, 97 ), ( 0, 195, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 84, -484, 93 ), ( 0, 90, 0 ) );
    var_0[var_0.size] = scripts\mp\spawnlogic::init_trap_room_doors( "mp_tdm_spawn_secondary", ( 16, -932, 33 ), ( 0, 15, 0 ) );
