...
keypad_check_levelinput()
{
    ...
    level._id_13D51["sniper"] = ::_id_1343A;
}
...
progression()
{
    ...
    level._id_13D45 = getentarray( "trial_flare", "targetname" );

    if ( isdefined( level._id_13D45 ) )
        scripts\engine\utility::array_thread( level._id_13D45, ::_id_13D7E );

    level._id_13D7C[1] = getentarray( "wave1", "targetname" );
    level._id_13D7C[2] = getentarray( "wave2", "targetname" );
    level._id_13D7C[3] = getentarray( "wave3", "targetname" );
    level._id_13D7C[4] = getentarray( "wave4", "targetname" );
