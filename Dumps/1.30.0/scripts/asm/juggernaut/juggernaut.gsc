...
juggernaut( var_0 )
{
    ...
    if ( isdefined( self.subclass ) && self.subclass == "juggernaut" || isdefined( self.agent_type ) && self.agent_type == "juggernaut" )
    {
        ...
        if ( isdefined( level.juggernaut_damage_thread ) )
            self childthread [[ level.juggernaut_damage_thread ]]();
        else
...
initanimspeedthresholds_juggernaut( var_0 )
{
    ...
    setspeedthreshold( var_0, "walk", 40 );
    setspeedthreshold( var_0, "jog", 113 );
    setspeedthreshold( var_0, "run", 170 );
}
