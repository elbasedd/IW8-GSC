...
{
    if ( animspeedthresholdsexist( var_0 ) )
        return;

    if ( var_0 == "boss" || var_0 == "boss2" )
        setspeedthreshold( var_0, "shuffle", 30 );
    else
        setspeedthreshold( var_0, "shuffle", 23 );

    setspeedthreshold( var_0, "walk", 56 );
    setspeedthreshold( var_0, "fast", 120 );
    setspeedthreshold( var_0, "jog", 170 );
    setspeedthreshold( var_0, "run", 220 );
    setspeedthreshold( var_0, "sprint", 250 );
}
