...
patrol_playidlesittingloop( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        [[ level.fnanimatedprop_setup ]]( "idle_chair", var_2, var_3, self._blackboard.idlenode.angles );
...
patrol_playdeathanim_sitting( var_0, var_1, var_2 )
{
    if ( isdefined( self.animated_prop ) )
        self [[ level.fnanimatedprop_startanim ]]( "idle_chair", var_2 );
...
patrol_playidlesittingreact( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
        self [[ level.fnanimatedprop_setanim ]]( "idle_chair", var_2 );
