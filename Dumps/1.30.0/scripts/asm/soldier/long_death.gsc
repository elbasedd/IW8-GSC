...
playshootinglongdeathidle( var_0, var_1, var_2 )
{
    ...
    self.a.nextlongdeathshoottime = gettime() + randomintrange( 500, 1000 );
    self.a.timestartwaitingtoshoot = gettime();
    setupaiming( var_1 );
    var_3 = [[ self.asm.longdeathanims.loopfunc ]]( var_0, var_1, var_2 );
...
shouldfinishshootinglongdeath( var_0, var_1, var_2, var_3 )
{
    if ( isdefined( self.a.timestartwaitingtoshoot ) )
    {
        var_4 = 3000;

        if ( gettime() > self.a.timestartwaitingtoshoot + var_4 )
            return 1;
    }
