...
chooseanim_exitsoldier( var_0, var_1, var_2 )
{
    ...
    if ( scripts\asm\shared\utility::isentasoldier() && scripts\asm\shared\utility::demeanorhasblendspace() )
    {
        ...
        var_3 = getnextlowestspeedthresholdstring( var_5, var_4 );
        self.exitspeedtarget = getanimspeedthreshold( var_5, var_3 );
    }
    else
...
shoulddosharpturn( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_9 && self pathdisttogoal() > 90 || lengthsquared( self.velocity ) > var_11 )
    {
        ...
        if ( scripts\asm\shared\utility::demeanorhasblendspace() && scripts\asm\shared\utility::isentnotabomber() )
        {
            ...
            var_15 = getnearestspeedthresholdname( var_19, var_18 );

            if ( var_15 == "sprint" )
                var_15 = "run";

            var_19 = scripts\asm\shared\utility::getbasearchetype();
            self.turnspeedtarget = getanimspeedthreshold( var_19, var_15 );
        }
        else
...
shouldstrafeaimchange( var_0, var_1, var_2, var_3 )
{
    ...
    if ( scripts\asm\shared\utility::isentasoldier() && scripts\asm\shared\utility::demeanorhasblendspace() )
    {
        ...
        var_19 = getnearestspeedthresholdname( var_20, var_6 );
        ...
        self.strafepoispeedtarget = getanimspeedthreshold( var_20, var_19 );
    }
    else
...
shouldstrafearrive( var_0, var_1, var_2, var_3 )
{
    ...
    var_13 = "fast";
    var_14 = hasanimspeedthresholdstring( var_11, "shuffle" );
    var_15 = hasanimspeedthresholdstring( var_11, "fast" );

    if ( !var_14 && !var_15 )
        var_13 = "walk";
    else if ( var_14 && var_12 < getanimspeedbetweenthresholds( var_11, "shuffle", "walk", 0.2 ) )
        var_13 = "shuffle";
    else if ( var_15 )
    {
        if ( var_12 < getanimspeedbetweenthresholds( var_11, "walk", "fast", 0.2 ) )
            var_13 = "walk";
        else
            var_13 = "fast";
    }
    ...
    self.asm.strafearrival_rate = clamp( var_12 / getanimspeedthreshold( var_11, var_13 ), var_24, var_25 );
...
shouldstumble( var_0, var_1, var_2 )
{
    ...
    var_4 = getanimspeedthreshold( var_3, "jog" );
...
stumblechooseanim( var_0, var_1, var_2 )
{
    ...
    var_4 = getanimspeedthreshold( var_3, "run" );
    var_5 = getanimspeedthreshold( var_3, "sprint" );
