...
vehicleaniminit()
{
    ...
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_blima", ::set_vehicle_anims_blima );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_decho_civ", ::set_vehicle_anims_decho_civ );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_decho_police", ::set_vehicle_anims_decho_police );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_decho_rebel", ::set_vehicle_anims_decho_rebel );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_mkilo", ::set_vehicle_anims_mkilo );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_mkilo23_ai_infil", ::set_vehicle_anims_mkilo23_ai_infil );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_skilo", ::set_vehicle_anims_skilo );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_techo", ::set_vehicle_anims_techo );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_tromeo", ::set_vehicle_anims_tromeo );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_umike", ::set_vehicle_anims_umike );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_vindia", ::set_vehicle_anims_vindia );
    scripts\engine\utility::create_func_ref( "set_vehicle_anims_ralfa", ::set_vehicle_anims_ralfa );
    scripts\engine\utility::create_func_ref( "use_turret", ::use_vehicle_turret );
}

#using_animtree("mp_vehicles_always_loaded");

set_vehicle_anims_apc( var_0 )
{
...
set_vehicle_anims_asierra( var_0 )
{
...
set_vehicle_anims_decho_civ( var_0 )
{
    set_vehicle_anims_decho( var_0 );
...
set_vehicle_anims_decho_police( var_0 )
{
    set_vehicle_anims_decho( var_0 );
...
set_vehicle_anims_decho_rebel( var_0 )
{
    set_vehicle_anims_decho( var_0 );
...
set_vehicle_anims_vindia( var_0 )
{
...
use_vehicle_turret( var_0, var_1 )
{
