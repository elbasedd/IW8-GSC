...
{
    var_2 = jugg_getvalidstance( var_0 );
    ...
    else
    {
        ...
        foreach ( var_11 in var_9 )
        {
            ...
            if ( jugg_canreload() )
            {
                ...
                thread jugg_managestockammo( var_11 );
            }
        }
    }
...
jugg_createconfig( var_0, var_1 )
{
    ...
    var_2.maxvehicledamagedivisor = 5;

    if ( level.gametype == "br" )
        var_2.maxvehicledamagedivisor = 3;
...
jugg_seteventfx()
{
    if ( jugg_canaccesseventmodel() )
    {
        ...
        if ( var_0 )
        {
            ...
            if ( jugg_ishalloweenmodel( var_0 ) )
                var_1 = "flames";
...
jugg_getjuggmodels()
{
    ...
    if ( jugg_canaccesseventmodel() )
    {
        ...
        if ( var_1 )
        {
            if ( jugg_ishalloweenmodel( var_1 ) )
            {
...
jugg_getvalidstance( var_0 )
{
    ...
    if ( var_2 != "stand" )
    {
        ...
        else if ( var_2 == "crouch" )
        {
            if ( !var_3 )
            {
                var_6 = scripts\engine\trace::ray_trace_passed( self.origin, scripts\mp\utility\player::getstancetop( "stand" ), self, var_5 );
        ...
        else if ( var_2 == "prone" )
        {
            if ( !var_4 )
            {
                if ( var_3 )
                {
                    var_7 = scripts\engine\trace::ray_trace_passed( self.origin, scripts\mp\utility\player::getstancetop( "crouch" ), self, var_5 );
...
jugg_managestockammo( var_0 )
{
    ...
    thread jugg_watchmanualreload( var_0, var_1 );
    thread jugg_watchammo( var_0, var_1 );
...
jugg_watchmanualreload( var_0, var_1 )
{
    self endon( "death_or_disconnect" );
    self endon( "juggernaut_end" );
    level endon( "game_ended" );
...
jugg_watchherodrop()
{
    ...
    for (;;)
    {
        ...
        if ( !istrue( var_0.herodrop ) )
        {
            var_0.herodrop = 1;
            self radiusdamage( self.origin, 500, 2000, 500, self, "MOD_CRUSH" );
            thread jugg_setherodropscriptable( var_0 );
        }
    }
}
...
jugg_modifyvehicletoplayerdamage( var_0, var_1 )
{
    ...
    {
        var_4 = 7;
        var_5 = var_3.maxvehicledamagedivisor;
    }
...
jugg_ishalloweenmodel( var_0 )
{
    return istrue( level._id_1208B ) && var_0 == 1;
}
