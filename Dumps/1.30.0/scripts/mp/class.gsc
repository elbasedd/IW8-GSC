...
init()
{
    ...
    else if ( scripts\mp\utility\game::isclasstableoverridemode() )
    {
...
table_getaddblueprintattachments( var_0, var_1, var_2 )
{
...
table_getweaponvariantid( var_0, var_1, var_2, var_3 )
{
    var_4 = undefined;
    ...
    return table_parseweaponvariantidvalue( var_3, var_4 );
}
...
table_parseweaponvariantidvalue( var_0, var_1 )
{
        ...
        if ( var_2 != "" )
        {
            ...
            foreach ( var_5 in var_3 )
            {
                ...
                if ( var_6.size == 2 )
                {
                    ...
                    if ( !isdefined( level.blockedvariantidsmap[var_7] ) )
                        level.blockedvariantidsmap[var_7] = [];

                    level.blockedvariantidsmap[var_7][level.blockedvariantidsmap[var_7].size] = var_8;
                }
            }
        }
    }
    ...
    if ( isdefined( level.blockedvariantidsmap[var_0] ) )
        var_10 = level.blockedvariantidsmap[var_0];

    var_11 = 0;
    var_12 = getdvarint( "scr_forceClassTableVariantRandom", 0 );

    if ( var_12 == 1 )
        var_11 = scripts\mp\utility\weapon::getweaponrandomvariantid( var_0, var_10 );
    else
    {
        var_13 = strtok( var_1, " " );
        var_14 = [];
    ...
    var_19 = scripts\mp\utility\weapon::weaponisvalid( var_0, var_11 );
...
loadout_copyclassstruct( var_0 )
{
    ...
    if ( isdefined( var_0.loadoutprimaryaddblueprintattachments ) )
        var_1.loadoutprimaryaddblueprintattachments = var_0.loadoutprimaryaddblueprintattachments;
    ...
    if ( isdefined( var_0.loadoutsecondaryaddblueprintattachments ) )
        var_1.loadoutsecondaryaddblueprintattachments = var_0.loadoutsecondaryaddblueprintattachments;
...
loadout_updateclassgamemode( var_0, var_1 )
{
    ...
    if ( isdefined( var_3["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.loadoutprimaryaddblueprintattachments = var_3["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_3["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.loadoutsecondaryaddblueprintattachments = var_3["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclasscustomgamemode( var_0, var_1 )
{
    var_2 = getclassindex( var_1 );
    self.class_num = var_2;
    var_3 = self.pers["gamemodeLoadout"];
    ...
    if ( !var_4 )
    {
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutprimaryattachmentids[var_5] = cac_getweaponattachmentid( var_2, 0, var_5 );
            }
        ...
        else
        {
            ...
            for ( var_5 = 0; var_5 < 5; var_5++ )
            {
                ...
                var_0.loadoutsecondaryattachmentids[var_5] = cac_getweaponattachmentid( var_2, 1, var_5 );
            }
...
loadout_updateclasscallback( var_0 )
{
    ...
    if ( isdefined( var_1["loadoutPrimaryAddBlueprintAttachments"] ) )
        var_0.loadoutprimaryaddblueprintattachments = var_1["loadoutPrimaryAddBlueprintAttachments"];
    ...
    if ( isdefined( var_1["loadoutSecondaryAddBlueprintAttachments"] ) )
        var_0.loadoutsecondaryaddblueprintattachments = var_1["loadoutSecondaryAddBlueprintAttachments"];
...
loadout_updateclassdefault_headlessgetweaponn( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( var_6.variantid == 0 || var_6.islocked || !isdefined( var_6.attachcustomtoidmap ) )
                continue;

            if ( var_4 && isdefined( var_6.isavailabletocoremp ) && !var_6.isavailabletocoremp )
                continue;
...
loadout_updateclass( var_0, var_1 )
{
    ...
    if ( !isbot( self ) && isdefined( level.gungameweapons ) && level.gungameweapons )
        loadout_updateclassfinalgungameweapons( var_0 );
    else
...
loadout_updateclassfistweapons( var_0 )
{
    if ( isdefined( level.gungameweapons ) && level.gungameweapons && isweapon( var_0.loadoutprimary ) )
        var_0.loadoutprimary = var_0.loadoutprimary;
    else if ( var_0.loadoutprimary == "none" )
        var_0.loadoutprimary = "iw8_fists";

    if ( scripts\mp\utility\game::classoverrideremovesfists() )
    {
...
loadout_updateclassfinalweapons( var_0 )
{
    if ( istrue( var_0.loadoutprimaryaddblueprintattachments ) )
    ...
    {
        if ( istrue( var_0.loadoutsecondaryaddblueprintattachments ) )
...
loadout_giveweaponobj( var_0, var_1, var_2, var_3 )
{
    ...
    {
        if ( scripts\mp\riotshield::isriotshield( var_4 ) && !scripts\mp\flags::gameflag( "prematch_done" ) && isdefined( self.infil ) && !istrue( self.infilweaponraise ) )
        {
...
loadout_updateammo( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( level.modeloadoutupdateammo ) )
        self [[ level.modeloadoutupdateammo ]]( var_6 );
    ...
    if ( !istrue( var_4 ) && var_5 == 3 )
    {
        foreach ( var_8 in var_6 )
        {
            if ( istrue( var_8.hasalternate ) )
            {
                ...
                if ( var_16 == "grenade" && istrue( var_8.hasmaxammo ) )
                    self setweaponammostock( var_15, 1 );
                else if ( var_16 == "spread" )
                    self setweaponammoclip( var_15, scripts\engine\utility::ter_op( istrue( var_8.hasmaxammo ), 8, 6 ) );
...
loadout_updateplayerkillstreaks( var_0, var_1 )
{
    ...
    if ( scripts\mp\utility\game::issnipersonlyclasstableoverridemode() )
    {
        var_2 = 0;
...
loadout_updatefieldupgrades( var_0, var_1 )
{
    ...
    if ( level.allowsupers )
    {
        ...
        {
            self.loadoutfieldupgrade1 = fixupsupersforgunfightmaps( self.loadoutfieldupgrade1 );
            self.loadoutfieldupgrade2 = fixupsupersforgunfightmaps( self.loadoutfieldupgrade2 );
        ...
        {
            var_3 = fixsuperforbr( self.loadoutfieldupgrade1 );
...
fixupsupersforgunfightmaps( var_0 )
{
    switch ( var_0 )
    {
...
buildweapon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    {
        var_6 = fixupcosmeticattachmentname( var_6 );
        var_12[var_6] = 0;
    }
...
fixupcosmeticattachmentname( var_0 )
{
    switch ( var_0 )
    {
...
onplayerspawned()
{
    ...
    for (;;)
    {
        ...
        else if ( scripts\mp\utility\game::getgametype() == "infect" && var_0.team == "axis" )
            var_0 _meth_87A8( "zombie" );
        else if ( isdefined( var_0.operatorcustomization ) && isdefined( var_0.operatorcustomization.gender ) && var_0.operatorcustomization.gender == "female" )
            var_0 _meth_87A8( "female" );
        else
...
resetfunctionality()
{
    ...
    scripts\mp\equipment\throwing_knife_mp::throwingknife_clear_fx();
    ...
    scripts\cp_mp\utility\player_utility::playerhidereset();
}
...
updateinstantclassswapallowed()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_0 = scripts\mp\utility\game::getsubgametype() == "dmz" || scripts\mp\utility\game::getsubgametype() == "risk" || scripts\mp\utility\game::getsubgametype() == "kingslayer";
...
ismeleeweapon( var_0 )
{
    var_1 = scripts\mp\utility\weapon::isknifeonly( var_0.basename ) || scripts\mp\utility\weapon::isakimbomeleeweapon( var_0.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_0.basename ) || scripts\mp\utility\weapon::ismeleeoverrideweapon( var_0 ) || scripts\mp\riotshield::isriotshield( var_0.basename );
    return var_1;
}
