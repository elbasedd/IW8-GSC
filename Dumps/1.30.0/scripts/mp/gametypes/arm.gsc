...
main()
{
    ...
    level.enablelittlebirdmg = getdvarint( "scr_arm_enableLittleBirdMG", 0 );
    ...
    level.usepingsystem = getdvarint( "scr_arm_usePingSystem", 1 );
    ...
    if ( istrue( level.useobjectives ) )
    {
        ...
        foreach ( var_2 in level.allfobs )
        {
            ...
            if ( istrue( level.gamesofsummercallbacks ) )
                var_2.specialeventonuse = scripts\mp\gametypes\obj_dom.gsc::specialeventonusegos;
...
nuke_triggermercywin( var_0 )
{
    ...
    if ( isdefined( level.teamdata[var_0]["alivePlayers"][0] ) )
    {
        ...
        var_7 scripts\cp_mp\killstreaks\nuke::tryusenuke();
    }
    else
...
init_rallyvehicles()
{
    ...
    if ( !istrue( level.disablelittlebirdrally ) )
    {
        foreach ( var_2 in var_0 )
        {
            ...
            if ( level.enablelittlebirdmg )
                var_6 = scripts\mp\vehicles\little_bird_mg_mp::little_bird_mg_mp_spawncallback( var_4, var_5 );
            else
...
arm_initoutofbounds()
{
    ...
    foreach ( var_2 in var_0 )
    {
        if ( isdefined( scripts\cp_mp\utility\game_utility::getlocaleid() ) && isdefined( var_2.script_noteworthy ) && var_2.script_noteworthy == level.localeid && scripts\mp\utility\game_utility_mp::modeusesgroundwarteamoobtriggers( var_2 ) )
        {
