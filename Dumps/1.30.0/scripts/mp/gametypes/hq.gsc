...
hqmainloop()
{
    ...
    if ( level.firstzoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::lockedradialunfill( level.firstzoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
hqactivatenextzone( var_0, var_1 )
{
    ...
    else if ( level.zoneactivationdelay )
    {
        ...
        level.zone thread scripts\mp\gametypes\obj_zonecapture.gsc::lockedradialunfill( level.zoneactivationdelay, level.zone.visuals[0].origin + ( 0, 0, 70 ) );
...
setupzones()
{
    ...
    var_0 = fixuptrigspostship( var_0 );
    var_1 = [];
    var_2 = 0;
...
waitthenforcespawn()
{
    ...
    for ( var_1 = 0; var_1 < var_0.size; var_1++ )
    {
        ...
        {
            var_2 thread waitforkillcamforcespawn();
            continue;
        }
...
give_capture_credit( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_5.assisttouchlist ) )
    {
        ...
        if ( var_5.assisttouchlist[var_2].size > 0 )
            var_5 thread givehqcaptureassistxp( var_2 );
    }
}

givehqcaptureassistxp( var_0 )
{
    level endon( "game_ended" );
