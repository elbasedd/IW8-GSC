...
freefallstartfunc()
{
    ...
    thread scripts\cp_mp\parachute::playertoggleallowfire();
}
...
waitforc130andforcespawnallplayers( var_0, var_1, var_2 )
{
    ...
    if ( !scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "squadLeader" ) )
    {
        if ( level.teambased )
        {
            ...
            {
                var_9 = scripts\mp\utility\teams::getteamdata( var_8, "players" );
                var_10 = setupbrsquadleader( var_9 );

                if ( isdefined( var_10 ) )
                {
                    registerbrsquadleaderjumpcommands( var_10 );
                    var_10 thread watchbrsquadleaderdisconnect( var_8 );
                }

                scripts\mp\gametypes\br.gsc::updatesquadleaderpassstateforteam( var_8 );
            }
        }
        else
        {
            ...
            {
                if ( isdefined( var_5 ) )
                    registerbrsquadleaderjumpcommands( var_5 );
            }
        }
    }
...
latespawnplayer()
{
    self endon( "disconnect" );
    var_0 = self;
    var_1 = scripts\mp\gametypes\br_public.gsc::istutorial() || scripts\mp\gametypes\br_public.gsc::isdmztutorial();
    ...
    else if ( !isalive( var_0 ) )
    {
        ...
        {
            var_2 = isbot( var_0 ) && scripts\mp\gametypes\br_public.gsc::isbotpracticematch();

            while ( !istrue( level.br_latejoininfilready ) && !var_2 )
            {
                if ( !var_2 )
                {
...
latespawnsnatchtoc130()
{
    ...
    if ( var_0 scripts\mp\gametypes\br_public.gsc::isplayerbrsquadleader() )
    ...
    if ( !isdefined( var_0.infilanimindex ) && level.teambased )
    {
        ...
        for ( var_3 = 0; var_3 < var_2.size; var_3++ )
        {
            ...
            {
                if ( var_6 != var_0 && var_6 scripts\mp\gametypes\br_public.gsc::isplayerbrsquadleader() )
                    continue;
...
setupbrsquadleader( var_0 )
{
    ...
    {
        if ( isdefined( var_3 ) && var_3 scripts\mp\gametypes\br_public.gsc::isplayerbrsquadleader() )
            return var_3;
    }
    ...
    var_1 scripts\mp\gametypes\br.gsc::setplayerbrsquadleader( 1 );

    foreach ( var_3 in var_0 )
    {
        if ( var_3 != var_1 )
            var_3 scripts\mp\gametypes\br.gsc::setplayerbrsquadleader( 0 );

        var_16 = scripts\engine\utility::ter_op( var_3 scripts\mp\gametypes\br_public.gsc::isplayerbrsquadleader(), 2, 1 );
...
watchinfiljumpanim( var_0 )
{
    ...
    if ( var_6 )
    {
        ...
        foreach ( var_4 in var_2 )
        {
            ...
            var_4 scripts\mp\gametypes\br.gsc::playerexecutionsenable();
        }
...
{
    var_2 = getanimlength( %sdr_mp_infil_ac130_redux_player1 );
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        var_5 scripts\mp\gametypes\br.gsc::playerexecutionsdisable();
        var_5.c130 = var_0.movingc130;
        var_5.plotarmor = 1;
        var_5 unlink();
        var_5 playerlinktopositionent( var_0 );
        var_6 = "sdr_mp_infil_ac130_redux_player" + var_5.infilanimindex;
...
playerwind( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_2 )
    {
        ...
        var_4 scripts\mp\utility\player::setwind( "100", 1 );
    }
...
{
    thread setsoundsubmixfadetoblackamb( var_1 );
    playac130animinternal( var_0, var_1 );
    transitionac130tomovinganim( var_0, var_1 );
    endac130infilanimsinternal( var_0, var_1 );
}
...
setuphudelemninfilcover( var_0 )
{
    ...
    var_0.sort = -1;
    var_0.color = ( 0.88, 0.88, 0.88 );
    var_0.alpha = 0;
    var_0 setshowinrealism( 1 );
}

fade_cover( var_0, var_1 )
{
    ...
    var_2 = scripts\engine\utility::ter_op( isdefined( var_1 ), var_1, level.players );
    var_3 = level.players.size == var_2.size;

    if ( var_3 )
    {
        level.infilcoveroverlay = newhudelem();
        setuphudelemninfilcover( level.infilcoveroverlay );
    }
    else
    {
        foreach ( var_5 in var_2 )
        {
            ...
            var_5.infilcoveroverlay = newclienthudelem( var_5 );
            setuphudelemninfilcover( var_5.infilcoveroverlay );
        }
    }
    ...
    if ( var_3 )
    {
        level.infilcoveroverlay fadeovertime( var_7 );
        level.infilcoveroverlay.alpha = 1;
    }
    else
    {
        foreach ( var_5 in var_2 )
        {
            ...
            var_5.infilcoveroverlay fadeovertime( var_7 );
            var_5.infilcoveroverlay.alpha = 1;
        }
    }
    ...
    if ( var_3 )
    {
        level.infilcoveroverlay fadeovertime( var_8 );
        level.infilcoveroverlay.alpha = 0;
    }
    else
    {
        foreach ( var_5 in var_2 )
        {
            ...
            var_5.infilcoveroverlay fadeovertime( var_8 );
            var_5.infilcoveroverlay.alpha = 0;
        }
    }

    waitandpause( var_8 + 0.1 );

    if ( var_3 )
    {
        level.infilcoveroverlay destroy();
        level.infilcoveroverlay = undefined;
    }
    else
    {
        foreach ( var_5 in var_2 )
        {
            ...
            var_5.infilcoveroverlay destroy();
        }
    }
}
...
playac130animinternal( var_0, var_1 )
{
    ...
    if ( var_0.infil_anim_type == "player" )
    {
        if ( !isdefined( var_1 ) )
        {
            foreach ( var_4 in level.teamnamelist )
            {
                ...
                for ( var_7 = 0; var_7 < var_5.size - 1; var_7++ )
                    var_6[var_7] = var_7 + 2;
                ...
                foreach ( var_14, var_9 in var_5 )
                {
                    ...
                    if ( var_9 scripts\mp\gametypes\br_public.gsc::isplayerbrsquadleader() )
                        var_9.infilanimindex = 1;
                    else
                    {
                        var_10 = scripts\engine\utility::random( var_6 );
                        var_9.infilanimindex = var_10;
                        var_6 = scripts\engine\utility::array_remove( var_6, var_10 );
                    }

                    foreach ( var_12 in var_5 )
                        var_9 showtoplayer( var_12 );
                }
            }
        }
        else
    ...
    var_27 = scripts\mp\gametypes\br_public.gsc::isusinginfilselection();
    var_0.aidoorchief hide();
    var_19 = scripts\engine\utility::ter_op( isdefined( var_1 ), var_1, level.players );
    ...
    foreach ( var_9 in var_19 )
    {
        ...
        if ( !var_27 )
        {
            ...
            var_9 setclienttriggeraudiozone( "mp_donetsk_infil_int", 1.0 );
        }

        var_0.cameraentlinktag = "j_prop_" + var_9.infilanimindex;
        var_9 cameraunlink();
        var_9 cameralinkto( var_0.cameraent, var_0.cameraentlinktag, 1, 1 );
        var_9 setclientdvar( "QTSPTNLOL", var_22 );
        var_9 enablephysicaldepthoffieldscripting();
        var_9 setphysicaldepthoffield( var_23, var_24, var_25, var_26 );
        var_9 scripts\mp\utility\player::_freezelookcontrols( 1 );
        var_0.aidoorchief showtoplayer( var_9 );
    }

    thread clearsoundsubmixmpbrinfilanim( var_1 );
    ...
    level thread playerwind( var_0, var_1 );
    level thread cloud_cover( var_0 );
    level thread fade_cover( var_0, var_1 );
    level thread infil_light_dvars( var_0 );
    level thread delaystreamtomovingplane( var_0, var_1 );
    ...
    level clearplayerwind( var_0, var_1 );
    var_30 = 0.1;
    var_31 = 0.0;
    var_32 = 0.2;
}
...
delaystreamtomovingplane( var_0, var_1 )
{
    ...
    {
        var_2 = getdvarint( "scr_br_streamToMovingPlaneDelay", 8 );
        wait( var_2 );
        var_3 = var_0.movingc130.origin;
        var_4 = getdvarint( "scr_br_streamToMovingPlaneForward", 0 );

        if ( var_4 > 0 )
        {
            var_5 = anglestoforward( var_0.movingc130.angles );
            var_3 = var_0.movingc130.origin + var_5 * var_4;
        }

        var_6 = scripts\engine\utility::ter_op( isdefined( var_1 ), var_1, level.players );
        ...
        foreach ( var_8 in var_6 )
        {
            ...
            var_8 setpredictedstreamloaddist( 0.0 );
            var_8 scripts\mp\gametypes\br_public.gsc::playerstreamhintlocation( var_3 );
        }
    }
}
...
stopstreamtomovingplane( var_0, var_1 )
{
    if ( isdefined( var_0.movingc130 ) && getdvarint( "scr_br_streamToMovingPlane", 1 ) == 1 )
    {
        var_2 = getdvarint( "scr_br_streamToMovingPlaneEndDelay", 5 );
        wait( var_2 );
        var_3 = scripts\engine\utility::ter_op( isdefined( var_1 ), var_1, level.players );
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            var_5 thread scripts\mp\gametypes\br_public.gsc::playerclearstreamhintorigin();
        }
    }
}
...
transitionac130tomovinganim( var_0, var_1 )
{
    ...
    if ( isdefined( var_0.cameraentmoving ) )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            var_0.cameraentlinktag = "j_prop_" + var_9.infilanimindex;
            var_9 cameraunlink();
            var_9 cameralinkto( var_0.cameraentmoving, var_0.cameraentlinktag, 1, 1 );
            var_9 setclientdvar( "QTSPTNLOL", var_2 );
            var_9 setphysicaldepthoffield( var_3, var_4, var_5, var_6 );
        }

        thread clearsoundsubmixfadetoblackamb( var_1 );
    }
    else
    {
        var_7 = scripts\engine\utility::ter_op( isdefined( var_1 ), var_1, level.players );
    ...
    thread clearsoundsubmixmpbrinfilac130( var_1 );
    ...
    thread unfreezeplayercontrols( 1.2, var_1 );
}
...
endac130infilanimsinternal( var_0, var_1 )
{
    ...
    level thread stopstreamtomovingplane( var_0, var_1 );
}
...
infilvideoplay( var_0 )
{
    var_1 = scripts\engine\utility::ter_op( isdefined( var_0 ), var_0, level.players );
    var_2 = level.players.size == var_1.size;
    ...
    foreach ( var_4 in var_1 )
    {
        ...
        if ( !var_2 )
            var_4 setentitysoundcontext( "lobby_fade", "", 2 );

        var_4 playlocalsound( "br_infil_part1_lr" );
        var_4 clearsoundsubmix( "mp_br_lobby_fade", 1.5 );
        var_4 setsoundsubmix( "fade_to_black_all_except_music_and_scripted5", 0.5 );
        var_5 = game["music"]["br_infil_intro"].size - 1;
        var_6 = randomint( var_5 );
        var_4 setplayermusicstate( game["music"]["br_infil_intro"][var_6] );
    }

    var_8 = "mp_donetsk_c130_intro";

    if ( istrue( level.isx1ops ) )
        var_8 = "mp_donetsk_c130_intro_x1";
    else if ( isdefined( level.brgametype ) && isdefined( level.brgametype.name ) && level.brgametype.name == "zxp" )
        var_8 = "mp_donetsk_c130_intro_zxp";
    else if ( level.mapname == "mp_kstenod" )
        var_8 = "mp_donetsk_c130_intro_zxp";

    if ( var_2 )
    {
        if ( istrue( level.isx1ops ) )
            playencryptedcinematicforall( var_8 );
        else
            playcinematicforall( var_8 );
    }
    else
    {
        foreach ( var_4 in var_1 )
        {
            ...
            if ( istrue( level.isx1ops ) )
            {
                var_4 playencryptedcinematicforplayer( var_8 );
                continue;
            }

            var_4 playcinematicforplayer( var_8 );
        }
    }
    ...
    foreach ( var_4 in var_1 )
    {
        ...
        if ( !istrue( var_4.latetoinfil ) )
            var_4 setclientomnvar( "ui_br_bink_overlay_state", 3 );
    }
}
...
infilvideowaituntilcomplete( var_0 )
{
...
beginbrc130playeraniminfilsequence( var_0, var_1, var_2 )
{
    level endon( "game_ended" );
    ...
    level.infilstruct.transporttime = scripts\mp\gametypes\br_c130.gsc::spawnc130( level.infilstruct.c130pathstruct );
    level.infilstruct.firstc130endtime = level.infilstruct.transporttime + gettime();
    var_7 = buildac130infilanimstruct( level.br_ac130, var_1 );
    level.latejoinersanimstruct = var_7;
    infilvideopreload( var_2 );

    if ( isdefined( level.preinfilstreamfunc ) )
        [[ level.preinfilstreamfunc ]]( var_7 );

    level.infilcinematicactive = 1;
    level.allowprematchdamage = 0;
    level.br_ac130 thread gunship_updateplayercount();
    var_3 = scripts\engine\utility::ter_op( isdefined( var_2 ), var_2, level.players );
    transitionplayerstoac130cinematic( var_3, var_1, var_7.staticc130 );

    if ( scripts\mp\gametypes\br_public.gsc::isbotpracticematch() || scripts\mp\gametypes\br_public.gsc::isdmzbotpracticematch() )
    {
        var_3 = scripts\engine\utility::ter_op( isdefined( var_2 ), var_2, level.players );
    ...
    infilvideoplay( var_2 );
    infilvideowaituntilcomplete( var_2 );
    level thread infilallfadetoblack( 0.0, 3.45, 0.6, undefined, var_2 );
    playac130infilanim( var_7, var_2 );
    var_3 = scripts\engine\utility::ter_op( isdefined( var_2 ), var_2, level.players );
    transitionplayersoutofac130cinematic( var_3, var_1 );
    level.infilcinematicactive = 0;
    level.infilstruct.infil_anim_type = var_1;

    if ( isdefined( level.escape_mode ) )
        scripts\mp\gametypes\br_public.gsc::brleaderdialog( "escape_gametype", 0, var_2 );
    else
    {
        scripts\mp\gametypes\br_public.gsc::brleaderdialog( "escape_radio_lost" );
        thread scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "onInfilSequenceEnd", var_2 );

        if ( !scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "match_start_VO" ) )
            scripts\mp\gametypes\br_public.gsc::brleaderdialog( "match_start", 0, var_2 );
    }

    var_10 = scripts\mp\gametypes\br_public.gsc::istutorial() || scripts\mp\gametypes\br_public.gsc::isdmztutorial();

    if ( !var_10 )
    {
        var_11 = getdvar( "scr_br_lateSpawnFallback" ) == "";
        var_3 = scripts\engine\utility::ter_op( isdefined( var_2 ), var_2, level.players );
        ...
        foreach ( var_5 in var_3 )
        {
            ...
            if ( !istrue( var_5.br_isininfil ) && var_11 )
                continue;

            var_5 thread playerjoininfil();

            if ( var_5 isplayerheadless() )
                registerheadlessinfil( var_5 );
        }

        if ( scripts\mp\gametypes\br_gametypes.gsc::isbrgametypefuncdefined( "addToC130Infil" ) )
            level.br_ac130 scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "addToC130Infil" );
    }
...
infilallfadetoblack( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    else if ( !var_7 )
    {
        foreach ( var_9 in var_6 )
        {
            ...
            setuphudelemninfilblack( var_9.infilblackoverlay );
        }
    }
...
transitionplayerstoac130cinematic( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4 scripts\mp\class::blockclasschange();
    }

    scripts\mp\deathicons::removealldeathicons();
    setomnvar( "ui_hide_player_icons", 1 );
    thread infilallfadetoblack( 1, 1.5, 1, "prematch_respawn_finished", var_0 );
    ...
    waitforc130andforcespawnallplayers( var_0, var_2.origin, var_2 );
...
transitionplayersoutofac130cinematic( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        var_4 scripts\mp\class::unblockclasschange();
...
playerjoininfil()
{
    ...
    var_0 scripts\mp\gametypes\br_public.gsc::playerresetgrenadethrowbackstate();
...
headlessinfils()
{
    ...
    var_1 = var_0 / scripts\mp\gametypes\br_c130.gsc::getc130speed() / level.headlessinfilplayers.size;
