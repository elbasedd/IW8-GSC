...
createspawnweaponatpos( var_0, var_1, var_2 )
{
    ...
    var_5 = scripts\mp\gametypes\br_pickups.gsc::getitemdropinfo( var_0, var_1 );
...
createspawnweaponatposfromname( var_0, var_1 )
{
    ...
    var_4 = scripts\mp\gametypes\br_pickups.gsc::getitemdropinfo( var_0, ( 0, 0, 90 ) );
...
playerdropweaponfrominventory( var_0 )
{
    ...
    if ( isdefined( var_8 ) )
    {
        ...
        var_14 = scripts\mp\gametypes\br_pickups.gsc::getitemdroporiginandangles( 0, self.origin, self.angles, self );
        var_15 = weaponspawn( var_8, self, var_14, 0 );
        var_15.count = var_13;
...
weaponspawn( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    level.onweapondropcreated scripts\cp_mp\utility\callback_group::callback_trigger( var_6, var_1, var_0 );
    return var_6;
}
...
takeweaponpickup( var_0 )
{
    ...
    if ( !isdefined( var_0.weapon ) )
    {
        ...
        {
            var_3 = scripts\mp\gametypes\br_pickups.gsc::getfullweaponobjforpickup( var_0 );
    ...
    if ( var_7 )
    {
        ...
        if ( var_8.basename != "none" )
        {
            ...
            if ( var_8.hasalternate )
            {
                ...
                if ( !br_alt_weapon_shares_ammo( var_8, var_16 ) )
            ...
            var_21 = !scripts\mp\gametypes\br_extract_quest.gsc::extract_ismissionweapon( var_8 );

            if ( var_21 )
            {
                var_22 = scripts\mp\gametypes\br_pickups.gsc::getitemdropinfo( var_0.origin, ( 0, var_20, 0 ) );
                ...
                if ( var_28["fraction"] < 1.0 )
                    var_22.groundentity = var_28["entity"];

                var_29 = weaponspawn( var_8, self, var_22, 0 );

                if ( isdefined( var_29 ) )
                {
                    scripts\mp\gametypes\br_pickups.gsc::loot_setitemcount( var_29, var_13, var_14, var_15 );
                    var_30 = 1;
    ...
    else
    {
        ...
        {
            var_36 = var_0.countalt;
            var_37 = var_3 getaltweapon();

            if ( !br_alt_weapon_shares_ammo( var_3, var_37 ) )
            {
    ...
    if ( isdefined( var_0.instance ) )
        level.onweapondroppickedup scripts\cp_mp\utility\callback_group::callback_trigger( var_0.instance, self, var_3 );
}
...
br_forcegiveweapon( var_0, var_1, var_2 )
{
    ...
    var_3.count = 0;
    var_3.countlefthand = 0;
    var_3.countalt = 0;
    var_1 takeweaponpickup( var_3 );
}

br_getrandomlootweapon( var_0, var_1 )
{
    if ( !isdefined( var_0 ) )
        var_0 = "ar";
...
br_forcegivecustomweapon( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( scripts\mp\utility\weapon::isakimbo( var_1 ) )
        var_7.countlefthand = var_7.count;

    if ( var_1.hasalternate )
    {
        var_10 = var_1 getaltweapon();

        if ( !br_alt_weapon_shares_ammo( var_1, var_10 ) )
        {
            var_11 = weaponclipsize( var_10 );
            var_7.countalt = var_11;
    ...
    for (;;)
    {
        ...
        if ( !scripts\mp\flags::gameflag( "prematch_done" ) )
        {
            ...
            foreach ( var_2 in var_0 )
            {
                ...
                if ( isdefined( var_3 ) )
                {
                    if ( scripts\mp\utility\weapon::isakimbo( var_2 ) )
                    {
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "weapons" ) )
        return;
...
{
    br_ammo_update_ammotype_reloading( var_0, var_1 );
...
br_alt_weapon_shares_ammo( var_0, var_1 )
{
...
{
    if ( istrue( level.br_allowloadout ) && !scripts\mp\gametypes\br_public.gsc::isdmztutorial() )
        return 1;
}
...
{
    foreach ( var_2 in var_0 )
        loadout_updatebrammo( var_2, istrue( var_2.hasmaxammo ) );
}
