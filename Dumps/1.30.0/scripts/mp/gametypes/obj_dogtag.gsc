...
init()
{
    ...
    if ( istrue( level.gamesofsummercallbacks ) )
        level.specialeventonuse = ::specialeventobjcallback;
...
spawndogtags( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( level.dogtags[var_0.guid] ) )
    {
        if ( istrue( level.gamesofsummercallbacks ) )
            ...
            playfx( level.hween_fx["vanish_hw_fr"], level.dogtags[var_0.guid].curorigin );
        else
...
removetags( var_0, var_1, var_2 )
{
    if ( isdefined( level.dogtags[var_0] ) )
    {
        ...
        if ( istrue( level.gamesofsummercallbacks ) )
        {
            if ( isdefined( level.specialeventonuse ) )
                level [[ level.specialeventonuse ]]( level.dogtags[var_0], var_2 );
        }
        else if ( istrue( level.halloweendvar ) )
        {
            if ( isdefined( var_2 ) && var_2.team == level.dogtags[var_0].ownerteam )
            {
                ...
                playfx( level.hween_fx["vanish_hw_fr"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
            else
            {
                playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
                playfx( level.hween_fx["vanish_hw_en"], level.dogtags[var_0].curorigin + ( 0, 0, 45 ) );
            }
        }
        else
            playfx( level.conf_fx["vanish"], level.dogtags[var_0].curorigin );
...
specialeventobjcallback( var_0, var_1 )
{
    var_2 = 20;
    var_3 = 600;
    ...
    {
        playfx( level.conf_fx["vanish_gos"], var_0.curorigin );
        playfx( level.gos_fx["gos_fireworks"], var_0.curorigin );
        level thread scripts\mp\gametypes\common.gsc::waitthenplayfireworkexplode( var_0.curorigin );
    }
}
