...
setupvehiclespawnvolumes()
{
    ...
    foreach ( var_14, var_6 in var_4.databyref )
    {
        ...
        if ( isdefined( level.filtervehiclespawnstructsfunc ) )
            var_7 = [[ level.filtervehiclespawnstructsfunc ]]( var_7 );

        tryconverttolbmgspawner( var_7 );
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "vehicleSpawns" ) )
        return;

    if ( ( var_0 == "little_bird" || var_0 == "little_bird_mg" ) && scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "littleBirdSpawns" ) )
        return;
...
spawnavehicle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_6 ) )
        scripts\mp\gametypes\br_analytics.gsc::branalytics_vehiclespawned( var_6, var_0 );
