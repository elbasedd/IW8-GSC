...
ball_return_home( var_0, var_1 )
{
    ...
    if ( istrue( level.possessionresetcondition ) )
    {
        if ( istrue( level.flagactivationdelay ) )
...
waitforreset( var_0 )
{
    ...
    if ( level.flagactivationdelay != 0 )
        scripts\mp\hostmigration::waitlongdurationwithhostmigrationpause( level.flagactivationdelay );
...
updatetimers( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( var_2 ) )
    {
        if ( istrue( level.flagactivationdelay ) && !istrue( level.ballreset ) )
            var_5 = 1000 * level.flagactivationdelay;
    }
