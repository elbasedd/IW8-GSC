...
setgunsfinal()
{
    ...
    for ( var_0 = 0; var_0 < level.gun_guns.size; var_0++ )
    {
        ...
        if ( level.ladderindex == 4 || level.ladderindex == 5 )
        {
            var_6 = getggweapontablelootvariants( var_3 );
            var_7 = scripts\mp\class::table_parseweaponvariantidvalue( var_3, var_6 );
            var_4 = scripts\mp\class::buildweapon_blueprint( var_3, undefined, undefined, var_7, undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
        }
        else
        {
            var_7 = 0;
            ...
            var_4 = gun_createrandomweapon( var_3, var_5, var_7, scripts\cp_mp\utility\game_utility::isnightmap() );
        }
...
buildrandomweapontable()
{
    ...
    for (;;)
    {
        ...
        if ( var_2 == "" || getdvarint( var_2, 0 ) == 1 )
        {
            ...
            if ( !scripts\mp\weapons::isweaponavailable( var_3["weapon"] ) )
            {
                var_0++;
                continue;
            }
...
getrandomweaponfromcategory( var_0 )
{
    ...
    if ( isdefined( var_1 ) && var_1.size > 0 )
    {
        ...
        if ( level.ladderindex == 4 || level.ladderindex == 6 )
        {
            var_9 = getggweapontablelootvariants( var_3["weapon"] );
            var_3["variantID"] = scripts\mp\class::table_parseweaponvariantidvalue( var_3["weapon"], var_9 );
        }
        else if ( level.ladderindex == 5 )
            var_3["variantID"] = scripts\mp\class::table_parseweaponvariantidvalue( var_3["weapon"], "-1" );
...
gun_createrandomweapon( var_0, var_1, var_2, var_3 )
{
    if ( level.ladderindex == 6 )
    {
        ...
        var_5 = gun_buildoverrideattachmentlist( var_0 );
        var_6 = [];
        ...
        var_4 = scripts\mp\class::buildweapon_blueprintwithcustomattachments( var_0, var_6, undefined, undefined, var_2, undefined, undefined, undefined, var_3 );
        return var_4;
    }
    else
    {
