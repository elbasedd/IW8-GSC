...
updategametypedvars()
{
    ...
    level.arenasuper = getdvar( "scr_arena_arenaSuper", "none" );
...
runarenaloadoutrulesonplayer()
{
    if ( israndomloadouts() || israndompreviewloadouts() || israndomblueprintsloadouts() || israndomcustomblueprintsloadouts() )
    {
        if ( israndompreviewloadouts() )
        {
...
buildloadoutsforweaponstreaming()
{
    ...
    if ( ispickuploadouts() )
    {
        ...
        else
        {
            ...
            else if ( istrue( level.halloweendvar ) )
            {
                var_4 = game["arenaRandomLoadout"][0]["loadoutPrimaryCamo"];
                var_8 = game["arenaRandomLoadout"][0]["loadoutPrimaryCosmeticAttachment"];
                var_9[0] = game["arenaRandomLoadout"][0]["loadoutPrimarySticker"];
            ...
            if ( ispickupblueprintloadouts() )
                var_1 = scripts\mp\class::buildweapon_blueprint( var_2, var_4, var_5, level.startweapon.variantid, var_7, var_8, var_9 );
            else
...
buildsecondaries( var_0, var_1, var_2 )
{
    ...
    else if ( istrue( level.halloweendvar ) && istrue( var_2 ) )
    {
        var_7 = getspecialdaycamos();
        game["arenaRandomLoadout"][game["arenaRandomLoadoutIndex"]]["loadoutSecondaryCamo"] = var_7;
...
buildblueprintpickupweapon( var_0 )
{
    var_0.weapon = var_0.weapon;
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_7[3] = "none";
        var_8 = scripts\mp\utility\weapon::getweaponrootname( var_0.weapon );
        var_0.weaponobj = scripts\mp\class::buildweapon_blueprint( var_8, undefined, undefined, var_4, undefined, undefined, scripts\cp_mp\utility\game_utility::isnightmap() );
    }
...
setupweaponattachmentoverrides( var_0 )
{
    ...
    if ( !issubstr( var_0.weapon, "equip" ) && var_0.weapon != "none" )
    {
        ...
        var_1 = getarenapickupattachmentoverrides( var_5 + "_mp" );
...
{
    var_1 = scripts\mp\utility\weapon::getweaponrootname( var_0 );
    var_2 = getarenapickupattachmentoverrides( var_1 + "_mp" );
    return var_2;
}
...
defineplayerloadout( var_0 )
{
    ...
    if ( isdefined( level.startweapon.weapon ) && level.startweapon.weapon != "none" && !issubstr( level.startweapon.weapon, "equip" ) )
    {
        ...
        else if ( istrue( level.halloweendvar ) )
        {
            ...
            var_1 = getattachmentoverride( level.startweapon.weapon );
    }
    else
    {
        var_11 = "none";
        ...
        if ( issubstr( level.startweapon.weapon, "equip" ) )
        {
            if ( isthrowingknifeequipment( level.startweapon.weapon ) )
            {
                ...
                if ( level.arenaknivesout )
                {
                    ...
                    {
                        var_12 = scripts\engine\utility::ter_op( israndomblueprintsloadouts(), "mp/classtable_arena_blueprints.csv", "mp/classTable_arena.csv" );
                        var_4 = int( scripts\mp\gametypes\gun.gsc::getggweapontablelootvariants( "iw8_knife" ) );
    ...
    level.arena_loadouts["default"]["loadoutFieldUpgrade1"] = level.arenasuper;
    ...
    if ( !istrue( level.specialdayloadouts ) && !istrue( level.halloweendvar ) )
    {
        foreach ( var_16 in level.teamnamelist )
        {
            level.arena_loadouts[var_16]["loadoutPrimaryCamo"] = setroundwinstreakspecialcamos();
            level.arena_loadouts[var_16]["loadoutSecondaryCamo"] = setroundwinstreakspecialcamos();
        }
    }
}
    ...
    if ( var_5 != "" && var_6 > 0.0 )
    {
        ...
        foreach ( var_9 in var_7 )
        {
            ...
            if ( var_10.size == 2 )
            {
                var_11 = var_10[0];
                var_12 = int( var_10[1] );
                var_13 = scripts\mp\utility\weapon::weaponisvalid( var_11, var_12 );
...
updateloadoutarray( var_0, var_1 )
{
    ...
    if ( israndomblueprintsloadouts() || israndomcustomblueprintsloadouts() )
        var_2["loadoutSecondaryVariantID"] = scripts\mp\class::table_getweaponvariantid( var_0, var_1, 1, var_2["loadoutSecondary"] );
    else
    ...
    if ( level.allowsupers )
    {
        ...
        var_2["loadoutFieldUpgrade1"] = level.arenasuper;
...
arenaloadouts_select( var_0, var_1, var_2, var_3 )
{
    ...
    for ( var_6 = 0; var_6 < var_1 && var_0.size > 0; var_6++ )
    {
        ...
        if ( isdefined( var_2 ) && isdefined( var_3 ) )
        {
            ...
            var_10 = arenaloadouts_getoverrideweaponswithgroup( var_2, var_9 );
            ...
            if ( var_10.size > 0 )
            {
                if ( randomfloat( 1.0 ) < var_3 )
                {
                    ...
                    var_7["loadoutPrimary"] = var_12.rootweapon;
...
arenaloadouts_getoverrideweaponswithgroup( var_0, var_1 )
{
    ...
    foreach ( var_4 in var_0 )
    {
        if ( arenaloadouts_getweapongroup( var_4.rootweapon ) == var_1 )
...
{
    if ( ispickupblueprintloadouts() && !issubstr( var_0, "equip" ) && var_0 != "none" )
    {
        ...
        if ( var_4 != "" )
        {
            var_5 = scripts\mp\class::table_getweaponvariantid( "mp/classtable_arena_blueprints.csv", var_2, 0, var_4 );
            return var_5;
        }
...
spawnweapon( var_0, var_1, var_2 )
{
    ...
    if ( var_9 != "" )
    {
        ...
        if ( isdefined( var_0.angles ) )
        {
            ...
            {
                if ( isdefined( var_0.script_noteworthy ) && var_0.script_noteworthy == "wall" || isdefined( var_0.script_note_override ) && var_0.script_note_override == "wall" )
        ...
        var_10.proxtrigger = spawn( "trigger_radius", var_10.origin, 0, 32, 32 );
        var_10 thread itemproxtriggerthink();
    ...
    else
    {
        ...
        if ( istrue( level.specialdayloadouts ) || istrue( level.halloweendvar ) || ispickupblueprintloadouts() )
            var_17 = var_1.weaponobj;
        else
        {
            var_16 = getarenapickupattachmentoverrides( var_15 + "_mp" );
...
fixuppickuporigin( var_0 )
{
    ...
    else if ( level.mapname == "mp_m_stadium" )
    {
        if ( var_0.script_label == "5" && distance( var_0.origin, ( 400.748, 762, -291.005 ) ) < 10 )
            var_0.script_note_override = "wall";
...
itemproxtriggerthink()
{
    ...
    {
        wait 0.05;
        self.proxtrigger waittill( "trigger", var_1 );
...
spawngameendflagzone( var_0 )
{
    ...
    var_1.onuncontested = ::arenaflag_onuncontested;
    var_1.isarena = 1;
