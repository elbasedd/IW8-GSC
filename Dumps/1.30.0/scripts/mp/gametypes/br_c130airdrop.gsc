    ...
    for (;;)
    {
        ...
        if ( var_7 < var_3 )
        {
            ...
            for ( var_12 = 0; var_12 < var_10; var_12++ )
            {
                ...
                if ( var_12 == 0 )
                    scripts\mp\gametypes\br_gametype_dmz.gsc::showsplashtoall( "br_c130airdrop_incoming" );
...
c130airdrop_createpathstruct( var_0, var_1, var_2 )
{
    ...
    var_5 = scripts\mp\gametypes\br_c130.gsc::getplanepathsaferadiusfromcenter();
    ...
    var_3 = scripts\mp\gametypes\br_c130.gsc::spawnc130pathstructnewinternal( var_4, var_6 );
    return var_3;
}
...
c130airdrop_startdelivery( var_0, var_1, var_2, var_3 )
{
    ...
    thread c130airdrop_dropcrates( var_0, var_1, var_2, var_3 );
}
...
c130airdrop_dropcrates( var_0, var_1, var_2, var_3 )
{
    self endon( "death" );

    if ( isdefined( self.dropfunc ) )
        self [[ self.dropfunc ]]( var_0, var_1, var_2, var_3 );
    else
    {
        var_4 = self.lifetime;
        var_5 = var_4 * 0.4;
        ...
        while ( var_12 < var_0 )
        {
            ...
            var_13 = c130airdrop_findvaliddroplocation( self.origin + anglestoforward( self.angles ) * 500 );
            ...
            var_14 = scripts\cp_mp\killstreaks\airdrop::dropbrc130airdropcrate( var_13 + ( 0, 0, level.c130airdrop_heightoverride - 100 ), var_13, self.angles, var_1, var_2 );
            ...
            var_15.usetimeoverride = 5;
            level.c130successfulairdrops[level.c130successfulairdrops.size] = var_14;
        }
    }
}

c130airdrop_findvaliddroplocation( var_0, var_1 )
{
    var_2 = undefined;
    var_3 = var_0 - ( 0, 0, 20000 );
    var_4 = [ self, self.chassis ];
    ...
    {
        var_7 = scripts\mp\gametypes\br_c130.gsc::ispointinbounds( var_2 ) && !c130airdrop_isnearotherdrop( var_2 );
...
c130airdrop_oncrateuse( var_0 )
{
    ...
    if ( !scripts\mp\gametypes\br_public.gsc::isdmztutorial() && getdvarint( "scr_dmz_airdrop_drop_tablet", 0 ) == 1 )
    {
