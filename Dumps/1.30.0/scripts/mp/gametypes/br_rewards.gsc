...
spawndropbagatposition( var_0, var_1 )
{
    ...
    var_3 endon( "death" );
    trackdropbagotherent( var_3 );
    enabledropbagobjective( var_3 );
    choosedropbagmodel( var_3 );
    var_4 = [];
    ...
    if ( !scripts\mp\gametypes\br_public.gsc::istutorial() )
        scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "dropbag_incoming", self.team, 1 );

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        scripts\mp\gametypes\br_analytics.gsc::branalytics_dropbagdeployed( self, var_0, var_1, var_3 );
        thread handlecratestuckinair( var_3 );
    }
}

handlecratestuckinair( var_0 )
{
    var_0 endon( "death" );
    wait 1.0;
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( abs( var_2[2] ) < 0.01 )
        {
            ...
            if ( var_5["fraction"] == 1 )
                var_0 scripts\cp_mp\killstreaks\airdrop::cratephysicson( var_0.origin, ( 0, 0, -10 ) );
            else
                break;
        }
...
spawndropbagsovertime( var_0 )
{
    foreach ( var_2 in var_0 )
    {
        ...
        if ( isdefined( level.br_circle ) && isdefined( level.br_circle.safecircleent ) )
        {
            ...
            else if ( istrue( level.usenavmeshfordropbags ) && isnavmeshloaded() )
                var_3 = getclosestpointonnavmesh( var_3 );

            if ( scripts\mp\outofbounds::ispointinoutofbounds( var_3 ) )
            {
                var_4 = scripts\mp\gametypes\br_circle.gsc::getsafecircleorigin();
                var_7 = scripts\mp\gametypes\br_c130.gsc::snappointtooutofboundstriggertrace( var_4, var_3 );
        ...
        var_8 = getdropbagspawntypeenum( 1, 0, 0, 0, 0 );
        var_2 spawndropbagatposition( var_3, var_8 );
        waitframe();
    }
}
...
spawndropbagonlanding()
{
    ...
    if ( isdefined( var_0 ) )
    {
        var_3 = getdropbagspawntypeenum( 0, 0, 0, 1, 0 );
        spawndropbagatposition( var_0.origin, var_3 );
        level thread managedropbags();
    }
}
...
trackdropbagotherent( var_0 )
{
    level thread trackdropbagotherent_internal( var_0, self );
}

trackdropbagotherent_internal( var_0, var_1 )
{
    level endon( "game_ended" );
    var_0 endon( "death" );
    var_2 = var_1;
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "dropbag" ) )
        return;
...
getdropbagspawntypeenum( var_0, var_1, var_2, var_3, var_4 )
{
    if ( istrue( var_0 ) )
        return 0;
