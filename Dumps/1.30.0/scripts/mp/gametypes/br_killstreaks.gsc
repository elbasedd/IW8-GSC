...
{
    if ( isdefined( level.dangernotifycooldown ) && isdefined( level.dangernotifycooldowns ) )
    {
        if ( isdefined( level.dangernotifycooldowns[var_1] ) && isdefined( level.dangernotifycooldowns[var_1][var_0.guid] ) && gettime() < level.dangernotifycooldowns[var_1][var_0.guid] )
            var_2 = 0;
        else
            level.dangernotifycooldowns[var_1][var_0.guid] = gettime() + level.dangernotifycooldown * 1000;
    }

    if ( istrue( var_2 ) && scripts\mp\utility\killstreak::getkillstreakenemyusedialogue( var_1 ) )
    {
        var_4 = scripts\mp\gametypes\br_public.gsc::brgetoperatorteam( self );
