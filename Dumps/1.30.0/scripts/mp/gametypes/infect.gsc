...
main()
{
    ...
    if ( scripts\mp\utility\game::matchmakinggame() || issubstr( level.infectedprimaryweapon, "none" ) && issubstr( level.infectedsecondaryweapon, "iw8_fists" ) )
    ...
    if ( level.isgroundwarinfected )
    {
        ...
        level.infectparachuteheightoffset = var_3;
        level.alwaysdoskyspawnontacinsert = getdvarint( "scr_infect_alwaysTacInsertSkySpawn", 0 );
        level.skydiveontacinsertplacement = getdvarint( "scr_infect_skyDiveOnTacInsertPlacement", 1 );
        level.allowskydivecutparachute = getdvarint( "scr_infect_allowSkyDiveCutParachute", 0 );
...
onstartgametype()
{
    ...
    if ( istrue( level.isgroundwarinfected ) )
    {
        scripts\mp\gametypes\arm.gsc::emergency_cleanupents();
...
updategametypedvars()
{
    ...
    level.infectedprimaryweapon = getdvar( "scr_infect_weaponInfectPrimary", "none" );
    ...
    level.infectsetradaronnumsurvivors = getdvarint( "scr_infect_setRadarOnNumSurvivors", 8 );
    level.survivorstreakoverride = [];
    var_0 = getdvar( "scr_infect_survivorStreakOverride", "" );

    if ( var_0 != "" )
        level.survivorstreakoverride = strtok( var_0, "," );
...
onplayerconnect( var_0 )
{
    ...
    if ( level.isgroundwarinfected )
        var_0 thread skydivehintnotify();
}
...
onspawnfinished()
{
    ...
    if ( scripts\mp\utility\game::matchmakinggame() || level.infectedprimaryweapon == "iw8_fists_mp_zmb" && level.infectedsecondaryweapon == "iw8_fists_mp_zmb" )
    {
        ...
        if ( !var_1 )
        {
            ...
            foreach ( var_5 in level.players )
            {
                ...
                if ( var_5.team == "axis" && var_5 != var_0 && var_5 != self )
                    var_5 thread scripts\mp\utility\points::giveunifiedpoints( "assist", undefined, level.infectbonusscore );
            }
        }
    }
...
setspecialloadouts()
{
    ...
    var_0 = 0;
    var_1 = scripts\mp\gametypes\gun.gsc::getggweapontablelootvariants( level.survivorprimaryweapon );
    var_0 = scripts\mp\class::table_parseweaponvariantidvalue( level.survivorprimaryweapon, var_1 );
    var_2 = 0;
    var_3 = scripts\mp\gametypes\gun.gsc::getggweapontablelootvariants( level.survivorsecondaryweapon );
    var_2 = scripts\mp\class::table_parseweaponvariantidvalue( level.survivorsecondaryweapon, var_3 );
    ...
    {
        var_6 = scripts\mp\gametypes\gun.gsc::getggweapontablelootvariants( level.initialprimaryweapon );
        var_4 = scripts\mp\class::table_parseweaponvariantidvalue( level.initialprimaryweapon, var_6 );
    }
    ...
    {
        var_7 = scripts\mp\gametypes\gun.gsc::getggweapontablelootvariants( level.initialsecondaryweapon );
        var_5 = scripts\mp\class::table_parseweaponvariantidvalue( level.initialsecondaryweapon, var_7 );
    }
    ...
    {
        var_9 = 0;
        var_10 = scripts\mp\gametypes\gun.gsc::getggweapontablelootvariants( level.infectedprimaryweapon );
        var_9 = scripts\mp\class::table_parseweaponvariantidvalue( level.infectedprimaryweapon, var_10 );
    }
...
getinfectedairdropposition()
{
    ...
    level.infectedairdroppositions[level.infectedairdroppositions.size] = level.infectedairdroppositions[0];
...
setupinfectedairdroppositions()
{
    switch ( level.mapname )
    {
        ...
        case "mp_aniyah":
            ...
            break;
        default:
            level.infectedairdroppositions = getcoremapdropzones();
            break;
    }
...
gamemodespawnprotectedcallback( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
