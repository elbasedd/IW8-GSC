...
initarrays()
{
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        ...
        overrideitemcount( "brloot_equip_gasmask_durable", getdvarint( "scr_br_gasMask_health_durable", 216 ) );
    }
    ...
    level.br_pickups.br_pickupcirclelimit = "MP_BR_INGAME/CIRCLE_PEEK_LIMIT";
    level.br_pickups.br_pickupcontractonlyitem = "MP_BR_INGAME/CONTACT_ONLY_ITEM";
...
getitemdropinfo( var_0, var_1, var_2, var_3 )
{
    ...
    var_4.groundentity = var_3;
    return var_4;
}

getitemdroporiginandangles( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 1;
    var_8 = 1;
    var_9 = getdvarint( "br_loot_trace_debug", 0 );
    var_10 = 14;
    var_11 = 50.0;
    var_12 = 40.0;
    var_13 = -5.0;
    ...
    var_29 = int( var_0 / var_10 );
    var_30 = var_0 - var_29 * var_10;
    var_31 = var_2[1] + ( var_30 * var_16 + var_29 * var_15 ) + randomfloatrange( var_17, var_18 );
    var_32 = var_11 + var_29 * var_12 + randomfloatrange( var_13, var_14 );

    if ( isdefined( var_4 ) )
        var_31 = var_2[1] + var_4;

    if ( isdefined( var_5 ) )
        var_32 = var_5;

    var_33 = ( 0.0, var_31, 0.0 );
    var_34 = anglestoforward( var_33 );
    var_35 = var_1 + var_34 * var_32;

    if ( var_8 )
    {
        var_36 = vehicle_getarrayinradius( var_35, 500, 500 );

        if ( isdefined( var_3 ) )
            var_36[var_36.size] = var_3;

        var_37 = var_1 + ( 0.0, 0.0, var_20 );
        var_38 = var_35 + ( 0.0, 0.0, var_20 );
        var_39 = scripts\engine\trace::create_contents( 0, 1, 1, 1, 1, 1, 1, 0, 1 );
        var_40 = scripts\engine\trace::ray_trace( var_37, var_38, var_36, var_39 );

        if ( var_40["fraction"] < 1.0 )
        {
            var_35 = var_40["position"];
            var_35 = var_35 + var_34 * var_24;
        }
        else
            var_35 = var_38;

        var_37 = var_35;
        var_38 = var_35 + ( 0.0, 0.0, var_21 );
        var_40 = scripts\engine\trace::ray_trace( var_37, var_38, var_36, var_39 );

        if ( var_40["fraction"] < 1.0 )
            var_35 = var_40["position"] + ( 0.0, 0.0, var_22 );
        else
            var_35 = var_38;

        var_37 = var_35;
        var_41 = -1 * getdvarfloat( "bg_maxLootDropHeight", 2000.0 );
        var_38 = var_35 + ( 0.0, 0.0, var_41 );
        var_40 = scripts\engine\trace::ray_trace( var_37, var_38, var_36, var_39 );

        if ( var_40["fraction"] < 1.0 )
        {
            var_35 = var_40["position"] + ( 0.0, 0.0, var_28 );
            var_27 = var_40["entity"];
        }
        else
        {
            var_35 = ( 0, 0, 0 );
        ...
        var_35 = var_35 + ( 0, 0, var_28 );

    if ( var_7 && !var_25 )
        var_26 = calcscriptablepayloadgravityarc( var_1 + ( 0, 0, var_19 ), var_35 );

    return getitemdropinfo( var_35, var_33, var_26, var_27 );
}
...
loot_getitemcount( var_0 )
{
    return var_0.count >> 0 & 2047;
}

loot_getitemcountlefthand( var_0 )
{
    return var_0.count >> 11 & 2047;
}

loot_getitemcountalt( var_0 )
{
    return var_0.count >> 22 & 31;
}

loot_setitemcount( var_0, var_1, var_2, var_3 )
{
    var_4 = 0;
...
lootusedignore( var_0 )
{
    ...
    if ( istrue( scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "lootUsedIgnore", var_0 ) ) )
        return 1;
...
lootused( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( var_3 scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "playerSkipLootPickup", var_0 ) ) || istrue( level.infilcinematicactive ) )
        return;

    if ( var_0 getscriptableisloot() && !lootusedignore( var_0 ) )
    {
        var_5 = spawnstruct();
        var_5.scriptablename = var_0.type;
        var_5.origin = var_0.origin;
        var_5.count = loot_getitemcount( var_0 );
        var_5.countlefthand = loot_getitemcountlefthand( var_0 );
        var_5.countalt = loot_getitemcountalt( var_0 );
        ...
        if ( var_6 == 1 )
        {
            ...
            if ( isdefined( var_0 ) && var_7 )
                loot_setitemcount( var_0, var_5.count, var_5.countlefthand, var_5.countalt );
...
loothide( var_0, var_1 )
{
    ...
    if ( isquesttablet( var_0.type ) )
    {
        ...
        scripts\mp\gametypes\br_quest_util.gsc::onquesttablethide( var_0 );
    }
...
br_forcegivecustompickupitem( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( istrue( var_5 ) )
    {
        var_0 dropbrcustompickupitem( var_1, var_3, var_4, var_5 );
        return 1;
    }
...
{
    var_1 = scripts\mp\utility\game::getsubgametype() == "kingslayer";
    self.br_inventory_slots = [];

    if ( !scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "armor" ) )
        scripts\mp\gametypes\br_armor.gsc::breakarmor();
    ...
    if ( scripts\mp\gametypes\br_public.gsc::hasselfrevivetoken() )
...
{
    var_4 = scripts\mp\equipment::getequipmentslotammo( var_0 );

    if ( isdefined( var_3 ) )
        var_4 = var_3;

    var_5 = scripts\engine\utility::array_find( level.br_pickups.br_equipname, self.equipment[var_0] );
    ...
    if ( isdefined( var_5 ) )
    {
        ...
        if ( istrue( var_1 ) )
            var_6 = scripts\mp\gametypes\br_armory_kiosk.gsc::getkioskyawoffsetoverride();
        ...
        var_8 = getitemdroporiginandangles( var_7, self.origin, self.angles, self, var_6 );
        var_9 = 0;
        var_10 = spawnpickup( var_5, var_8, var_4, 1 );

        if ( isdefined( var_10 ) )
            var_10 dropmissionequipment( self, var_5 );
    }
}

dropmissionequipment( var_0, var_1 )
{
    var_2 = self;
...
{
    if ( !respawntokendisabled() && !scripts\mp\gametypes\br_public.gsc::hasrespawntoken() )
    {
        addrespawntoken();
        return 1;
    }
...
addrespawntoken( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_public.gsc::sethasrespawntokenextrainfo( 1 );
...
removerespawntoken()
{
    ...
    var_0 scripts\mp\gametypes\br_public.gsc::sethasrespawntokenextrainfo( 0 );
}
...
addselfrevivetoken( var_0 )
{
    ...
    var_1 scripts\mp\gametypes\br_public.gsc::sethasselfrevivetokenextrainfo( 1 );
...
removeselfrevivetoken()
{
    ...
    var_0 scripts\mp\gametypes\br_public.gsc::sethasselfrevivetokenextrainfo( 0 );
...
fillmaxarmorplate()
{
    ...
    var_1.equipname = level.br_pickups.br_equipname[var_1.scriptablename];
    var_1.origin = self.origin;
    var_1.maxcount = scripts\mp\equipment::getequipmentmaxammo( var_1.equipname );
...
{
    if ( scripts\mp\gametypes\br_public.gsc::hasaccesscard() )
    {
        var_1 = undefined;
        var_2 = getitemdroporiginandangles( 0, self.origin, self.angles, self, var_1 );
        spawnpickup( self.accesscard, var_2, 1, 1 );
    }
...
takequestitem( var_0 )
{
    ...
    if ( var_1 == "brloot_x1_stash_cypher" )
        var_0 scripts\mp\gametypes\br_x1_stash_quest.gsc::x1cypherused( self );
}
...
addspecialistbonuspickup( var_0 )
{
    var_1 = self;
    self playsoundtoplayer( "br_legendary_loot_pickup", self );
    var_1.hasbrspecialistbonus = 1;
    var_1 scripts\mp\perks\perks::addspecialistbonus();
...
{
    var_0 = self;
    var_0.hasbrspecialistbonus = 0;
    var_0 scripts\mp\perks\perks::removespecialistbonus();
}

forcegivekillstreak( var_0, var_1, var_2, var_3 )
{
    self notify( "cancel_all_killstreak_deployments" );

    if ( istrue( var_3 ) )
    {
        dropbrkillstreak( var_2, var_3, var_0 );
        return;
    }
...
takekillstreakpickup( var_0, var_1 )
{
    ...
    if ( isforcedirectusekillstreak( var_2 ) )
        forcedirectusekillstreak( var_2 );
    else
...
isforcedirectusekillstreak( var_0 )
{
    var_1 = 0;
...
forcedirectusekillstreak( var_0 )
{
    var_1 = scripts\mp\killstreaks\killstreaks::getkillstreaksetupinfo( var_0 );

    if ( isdefined( var_1 ) && isdefined( var_1.directusefunc ) )
        self [[ var_1.directusefunc ]]();
}
...
takesuperpickup( var_0, var_1 )
{
    ...
    if ( isdefined( self.equipment["super"] ) && ( scripts\mp\equipment::getequipmentslotammo( "super" ) > 0 || empjammedplayerhassuper() ) )
...
empjammedplayerhassuper()
{
    if ( istrue( self.isempjammed ) )
    {
...
forcegivesuper( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !isdefined( var_4 ) )
    {
        ...
        scripts\mp\utility\script::demoforcesre( "superref: '" + var_6 + "' size: " + level.br_pickups.br_superreference.size );
    }
    ...
    if ( istrue( var_3 ) )
    {
        dropbrequipment( var_2, var_3, var_8 );
        return;
    }
...
takegasmask( var_0, var_1 )
{
    if ( scripts\cp_mp\gasmask::hasgasmask( self ) )
    {
        ...
        if ( istrue( var_1 ) )
            var_2 = scripts\mp\gametypes\br_armory_kiosk.gsc::getkioskyawoffsetoverride();

        var_3 = getitemdroporiginandangles( 0, self.origin, self.angles, self, var_2 );
        spawnpickup( self.gasmasktype, var_3, int( self.gasmaskhealth ), 1 );
    }
...
equipgasmaskbr()
{
    ...
    if ( canplaygasmaskgesturebr() )
        thread playgasmaskweaponanim( "iw8_ges_plyr_gasmask_on", var_0 );
...
playgasmaskweaponanim( var_0, var_1 )
{
    self endon( "death_or_disconnect" );
    var_2 = makeweapon( var_0 );
    self giveandfireoffhand( var_2 );

    while ( canplaygasmaskgesturebr() && var_1 > 0 )
    {
        if ( var_1 > 1 )
        {
            var_3 = 1;
...
removegasmaskbr()
{
    ...
    if ( canplaygasmaskgesturebr() )
        thread playgasmaskweaponanim( "iw8_ges_plyr_gasmask_off", var_0 );
...
breakgasmaskbr()
{
    ...
    thread scripts\mp\gametypes\br_public.gsc::playerplaygestureweaponanim( "iw8_ges_plyr_gasmask_break", var_0 );
    self.gasmaskswapinprogress = 1;
...
cantakepickup( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "canTakePickupLoot", var_0 );
    ...
    if ( isweaponpickupitem( var_0 ) )
    {
        ...
        if ( scripts\mp\equipment\binoculars::binoculars_isads() )
            return 21;
    ...
    if ( scripts\mp\gametypes\br_public.gsc::isequipment( var_0.scriptablename ) )
    {
        ...
        {
            if ( self != var_0.instance.owner )
                return 20;
            else
                self.droppedcounterref = undefined;
        }

        var_2 = level.br_pickups.br_equipname[var_0.scriptablename];
        var_3 = level.equipment.table[var_2].defaultslot;
        var_4 = istrue( var_0.isautouse );
        var_5 = 1;
    ...
    if ( iskillstreak( var_0.scriptablename ) )
    {
        ...
        if ( isforcedirectusekillstreak( var_6 ) )
        {
            if ( var_6 == "circle_peek" )
            {
                ...
                var_7 = level.teamswithcirclepeek[self.team] + level.br_circle.circleindex + 1;

                if ( var_7 >= level.circlepeeks.size )
                    return 19;
            }
    ...
    if ( isplatepouch( var_0.scriptablename ) )
    {
        ...
        if ( scripts\mp\gametypes\br_public.gsc::hasplatepouch() )
            return 15;
        else
            return 1;
    }
    ...
    if ( isquestitem( var_0.scriptablename ) )
    {
        if ( isdefined( var_0.instance.team ) && self.team == var_0.instance.team )
            return 1;
        else
            return 4;
    }

    if ( isspecialistbonus( var_0.scriptablename ) )
    {
        if ( istrue( self.isjuggernaut ) )
            return 16;

        if ( scripts\mp\gametypes\br_public.gsc::hasspecialistbonus() )
            return 18;
    ...
    if ( isobjectivetype( var_0.scriptablename ) )
        return 1;
...
{
    if ( scripts\mp\weapons::isfistweapon( var_0 ) || scripts\mp\utility\weapon::isgunlessweapon( var_0 ) || scripts\mp\utility\weapon::ismeleeoverrideweapon( var_0 ) )
        return 0;

    return 1;
}

iscriticalitem( var_0 )
{
    if ( !isdefined( var_0 ) )
        return 0;
...
spawnpickup( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    if ( istrue( level.isx1ops ) && var_0 == "brloot_x1_map_fragment" )
        scripts\mp\gametypes\br_smokinggun_quest.gsc::spawnmap( var_1, undefined );
    else
    {
        var_9 = undefined;
        ...
        else if ( scripts\mp\gametypes\br_weapons.gsc::isvalidcustomweapon( var_4 ) )
        {
        ...
        if ( var_9 == "brloot_weapon_me_riotshield_epic" || scripts\mp\gametypes\br_weapons.gsc::isvalidcustomweapon( var_4 ) && scripts\mp\riotshield::isriotshield( var_4 ) )
        ...
        if ( var_8 )
        {
            var_11 = spawncustomweaponscriptable( var_9, var_1.origin, var_1.angles, var_1.payload, var_4 );

            if ( isdefined( var_11 ) )
                var_11.customweaponname = getcompleteweaponname( var_4 );
        }
        else
            var_11 = spawnscriptable( var_9, var_1.origin, var_1.angles, var_1.payload );

        if ( !isdefined( var_11 ) )
            return;

        if ( isdefined( var_1.groundentity ) )
        {
            var_12 = rotatevectorinverted( var_1.origin - var_1.groundentity.origin, var_1.groundentity.angles );
            var_13 = combineangles( invertangles( var_1.groundentity.angles ), var_1.angles );
            var_11 scriptablesetparententity( var_1.groundentity, var_12, var_13 );
            var_11.groundentity = var_1.groundentity;
        }

        registerscriptableinstance( var_11 );

        if ( isdefined( var_2 ) )
            loot_setitemcount( var_11, var_2, var_6, var_7 );
        else
            loot_setitemcount( var_11, 0 );
        ...
        if ( iscriticalitem( var_0 ) )
            var_11.criticalitem = 1;
        ...
        var_14 = level.br_pickups.createcallbacks[var_9];
...
showuseresultsfeedback( var_0 )
{
    switch ( var_0 )
    {
        ...
        case 18:
            ...
            return;
        case 19:
            scripts\mp\hud_message::showerrormessage( level.br_pickups.br_pickupcirclelimit );
            return;
        case 20:
            scripts\mp\hud_message::showerrormessage( level.br_pickups.br_pickupcontractonlyitem );
            return;
        case 2:
            break;
    }
...
onusecompleted( var_0, var_1, var_2, var_3 )
{
    ...
    if ( istrue( scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "onUseCompleted", var_0 ) ) )
    {
    ...
    else if ( isplunder( var_0.scriptablename ) )
    {
        ...
        scripts\mp\gametypes\br_quest_util.gsc::takequesttablet( var_0.instance );
    else if ( isplatepouch( var_0.scriptablename ) )
    {
        ...
        takeaccesscardpickup( var_0 );
    else if ( isdogtag( var_0.scriptablename ) )
        takedogtag( var_0 );
    else if ( isquestitem( var_0.scriptablename ) )
        takequestitem( var_0 );
    else if ( isspecialistbonus( var_0.scriptablename ) )
        addspecialistbonuspickup();
    else if ( isobjectivetype( var_0.scriptablename ) )
    {
        if ( var_0.scriptablename == "brloot_escape_radio" )
            var_0 thread scripts\mp\gametypes\br_alt_mode_escape.gsc::escaperadiopickup( self );
        else if ( var_0.scriptablename == "brloot_zmb_access_item" )
        {
            if ( isdefined( level.zombielootpickupfunc ) )
                var_0 thread [[ level.zombielootpickupfunc ]]( self );
        }
    }
    else
    {
    ...
    if ( isdefined( var_0.instance ) && isdefined( var_0.instance.uniquelootitemid ) )
        processuniquelootitem( var_0.instance.uniquelootitemid, self );
...
playerplaypickupanim( var_0 )
{
    ...
    if ( isweaponpickupitem( var_0 ) || !scripts\mp\gametypes\br_public.gsc::playercanplaynotcriticalgesture() )
        return;
    ...
    scripts\mp\gametypes\br_public.gsc::playerplaygestureweaponanim( "iw8_ges_plyr_loot_pickup", 1.17 );
}

droponplayerdeath( var_0 )
{
    if ( istrue( scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "dropOnPlayerDeath" ) ) )
        return;

    if ( istrue( level.usegulag ) && ( scripts\mp\gametypes\br_public.gsc::isplayeringulag() || scripts\mp\gametypes\br_public.gsc::wasplayeringulag() ) )
        return;

    scripts\mp\gametypes\br_gametypes.gsc::runbrgametypefunc( "addDropOnPlayerDeath", var_0 );

    if ( scripts\mp\utility\killstreak::isjuggernaut() )
        scripts\mp\gametypes\br_jugg_common.gsc::droponplayerdeath();
    ...
    dropbrhealthpack();
    scripts\mp\gametypes\br_plunder.gsc::playerdropplunderondeath( 14, var_0 );
    dropbrgasmask();
...
dropbrammoboxes()
{
    ...
    foreach ( var_3 in level.br_ammo_types )
    {
        ...
        {
            var_4 = var_3;
            var_5 = getitemdroporiginandangles( var_0, self.origin, self.angles, self );
            spawnpickup( var_4, var_5, self.br_ammo[var_3], 1 );
            var_0++;
        }
    }
}
...
dropbrprimaryweapons()
{
    ...
    foreach ( var_3 in self.equippedweapons )
    {
        ...
        {
            var_4 = dropbrweapon( var_3, var_0 );
...
dropbrweapon( var_0, var_1 )
{
    ...
    var_3 = getitemdroporiginandangles( var_2, self.origin, self.angles, self );
    var_4 = undefined;
    var_5 = 1;
    var_6 = 0;
    var_7 = 0;
    ...
    if ( isdefined( var_0 ) )
    {
        if ( isweapon( var_0 ) )
        {
            ...
            {
                var_8 = var_4 getaltweapon();

                if ( !scripts\mp\gametypes\br_weapons.gsc::br_alt_weapon_shares_ammo( var_4, var_8 ) )
                    var_7 = self getweaponammoclip( var_8 );
            }
        }
        else if ( isstring( var_0 ) )
        {
            var_4 = getfullweaponobjfromscriptablename( var_0 );

            if ( isdefined( var_4 ) )
                var_5 = var_4.clipsize;
            else if ( isdefined( level.br_ammo_clipsize[var_0] ) )
                var_5 = level.br_ammo_clipsize[var_0];
        }
    }
    ...
    var_9 = scripts\mp\gametypes\br_weapons.gsc::weaponspawn( var_4, self, var_3, 0, 1 );

    if ( isdefined( var_9 ) )
        loot_setitemcount( var_9, var_5, var_6, var_7 );
...
shoulddropbrprimary( var_0, var_1 )
{
    ...
    if ( var_1 scripts\mp\gametypes\br_extract_quest.gsc::extract_ismissionweapon( var_0 ) )
        return 0;

    return 1;
}

dropbrequipment( var_0, var_1, var_2 )
{
    var_3 = 7;
    var_4 = istrue( var_1 ) && isdefined( var_2 );

    if ( var_4 )
    {
        var_5 = scripts\engine\utility::array_find( level.br_pickups.br_equipname, var_2 );
        ...
        if ( isdefined( var_5 ) )
        {
            ...
            var_7 = getitemdroporiginandangles( var_3, self.origin, self.angles, self, var_6 );
    ...
    if ( isdefined( self.equipment["primary"] ) )
    {
        ...
        if ( var_8 > 0 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                var_7 = getitemdroporiginandangles( var_3, self.origin, self.angles, self );
    ...
    if ( isdefined( self.equipment["secondary"] ) )
    {
        ...
        if ( var_8 > 0 )
        {
            ...
            if ( isdefined( var_9 ) )
            {
                ...
                var_10 dropmissionequipment( self, var_9 );
            }
...
dropbrsuper( var_0, var_1, var_2 )
{
    ...
    if ( var_4 )
    {
        ...
        if ( isdefined( var_5 ) )
        {
            ...
            [var_8, var_9, var_10] = getitemdroporiginandangles( var_3, self.origin, self.angles, self, var_6 );
    ...
    {
        var_11 = int( max( scripts\mp\equipment::getequipmentslotammo( "super" ), scripts\mp\gametypes\br.gsc::getsuperweapondisabledammobr() ) );
        ...
        if ( var_11 > 0 )
        {
            ...
            if ( isdefined( var_2 ) && var_2 == "super_fulton" )
            {
            ...
            dropequipmentinslot( "super", var_0, var_12, var_11 );
        }
    }
}
...
dropbrmissiontablet()
{
    ...
    {
        var_0 = getitemdroporiginandangles( 13, self.origin, self.angles, self );
        var_1 = spawnpickup( self.extractquest_missionitem, var_0, 1, 1 );

        if ( isdefined( var_1 ) )
            var_1 scripts\mp\gametypes\br_blueprint_extract_spawn.gsc::blueprintextract_setunlockablelootid( self.extractquest_unlockablelootid );
    }
}
...
dropbrhealthpack()
{
    ...
    else if ( istrue( level.forcearmordropondeath ) )
    {
        var_1 = level.br_pickups.br_equipnametoscriptable["equip_armorplate"];
        var_0 = level.forcearmordropondeath;
    }

    if ( istrue( level.minarmordropondeath ) && var_0 < level.minarmordropondeath )
    {
        var_0 = level.minarmordropondeath;
    ...
    if ( var_0 > 0 && isdefined( var_1 ) )
    {
        if ( var_0 > level.br_pickups.maxcounts[var_1] )
        {
            ...
            var_2 = getitemdroporiginandangles( 9, self.origin, self.angles, self );
            spawnpickup( var_1, var_2, level.br_pickups.maxcounts[var_1], 1 );
        }

        var_2 = getitemdroporiginandangles( 9, self.origin, self.angles, self );
        spawnpickup( var_1, var_2, var_0, 1 );
    }
}
...
dropbrgasmask()
{
    if ( scripts\cp_mp\gasmask::hasgasmask( self ) )
    {
        ...
        var_2 = spawnpickup( self.gasmasktype, var_1, int( self.gasmaskhealth ), 1 );
        var_2.gasmaskmaxhealth = self.gasmaskmaxhealth;
        self setclientomnvar( "ui_gas_mask", 1 );
        self.gasmaskhealth = undefined;
...
{
    var_3 = istrue( var_1 ) && isdefined( var_2 );
    ...
    if ( var_3 )
    {
        ...
        if ( istrue( var_0 ) )
            var_4 = scripts\mp\gametypes\br_armory_kiosk.gsc::getkioskyawoffsetoverride();

        var_5 = getitemdroporiginandangles( 0, self.origin, self.angles, self, var_4 );
        spawnpickup( level.br_pickups.br_killstreaktoscriptable[var_2], var_5 );
        return;
    }
    ...
    if ( hasanykillstreak() )
    {
        ...
        var_5 = getitemdroporiginandangles( 0, self.origin, self.angles, self, var_4 );
        spawnpickup( level.br_pickups.br_killstreaktoscriptable[self.streakdata.streaks[1].streakname], var_5 );
        scripts\mp\killstreaks\killstreaks::removekillstreak( 1 );
    }
}
...
dropbrattackerperkammo( var_0 )
{
    ...
    {
        var_2 = scripts\mp\gametypes\br_weapons.gsc::br_ammo_type_for_weapon( var_0.currentweapon );
        var_3 = getitemdroporiginandangles( var_1, self.origin, self.angles, self );
        spawnpickup( var_2, var_3, var_0.currentweapon.startammo, 1 );
        var_1 = var_1 + 13;
    }
    ...
    if ( var_0 scripts\mp\utility\perk::_hasperk( "specialty_br_plunderscavenger" ) )
        scripts\mp\gametypes\br_plunder.gsc::dropplunderbyrarity( 50, var_1 );
}
...
dropbrplatepouch()
{
    if ( scripts\mp\gametypes\br_public.gsc::hasplatepouch() )
    {
        var_0 = getitemdroporiginandangles( 0, self.origin, self.angles, self );
        spawnpickup( "brloot_plate_pouch", var_0 );
        removeplatepouch();
    }
}
...
dropaccesscard()
{
    ...
    {
        var_0 = getitemdroporiginandangles( 0, self.origin, self.angles, self );
        spawnpickup( self.accesscard, var_0 );
        removeaccesscard();
    }
}
...
dropbrselfrevivetoken()
{
    ...
    {
        var_0 = getitemdroporiginandangles( 0, self.origin, self.angles, self );
        spawnpickup( "brloot_self_revive", var_0 );
        removeselfrevivetoken();
    }
}

dropbrcustompickupitem( var_0, var_1, var_2, var_3 )
{
    ...
    if ( var_4 )
    {
        ...
        if ( istrue( var_2 ) )
            var_5 = scripts\mp\gametypes\br_armory_kiosk.gsc::getkioskyawoffsetoverride();

        var_6 = getitemdroporiginandangles( 0, self.origin, self.angles, self, var_5 );
        spawnpickup( var_0, var_6, var_1 );
    }
}
...
dropspecialistbonus()
{
    ...
    {
        var_0 = getitemdroporiginandangles( 0, self.origin, self.angles, self );
        spawnpickup( "brloot_specialist_bonus", var_0 );
        removespecialistbonuspickup();
    }
}
...
dropescaperadio()
{
    if ( isdefined( level.escape_mode ) && isdefined( level.escape_mode.radio ) && isdefined( level.escape_mode.radio.owner ) && level.escape_mode.radio.owner == self )
        thread scripts\mp\gametypes\br_alt_mode_escape.gsc::dropescaperadio();
}
...
dropitemfrominventory( var_0 )
{
    if ( isdefined( self.br_inventory_slots[var_0] ) )
    {
        ...
        var_2 = getitemdropinfo( self.origin + level.br_pickups.br_dropoffsets[0], self.angles );
...
getquickdropitemcount( var_0, var_1 )
{
    ...
    switch ( var_0 )
    {
        ...
        case 4:
        case 3:
            var_7 = getquickdropammotype( var_0 );
            var_3 = getquickdropammocount( var_7, var_1 );
            var_2 = var_3 > 0;
            break;
        case 0:
        ...
        case 1:
            ...
            break;
        case 8:
            var_3 = scripts\engine\utility::ter_op( istrue( self.hasselfrevivetoken ), 1, 0 );
            var_2 = var_3 > 0;
            break;
        case 9:
            var_8 = self.lastdroppableweaponobj;

            if ( !isdefined( var_8 ) || isnullweapon( var_8 ) || !self hasweapon( var_8 ) || var_8 == makeweapon( "iw8_fists_mp" ) || self isskydiving() )
                var_2 = 0;
            else
            {
                ...
                if ( var_8.hasalternate )
                {
                    ...
                    if ( !scripts\mp\gametypes\br_weapons.gsc::br_alt_weapon_shares_ammo( var_8, var_9 ) )
...
{
    scripts\mp\gametypes\br_plunder.gsc::playerplunderdrop( var_1 );
}
...
quickdropremoveweaponfrominventory( var_0, var_1 )
{
    ...
    foreach ( var_7 in var_5 )
    {
        ...
        if ( var_7 != var_3 && var_7 != var_2 && !scripts\mp\utility\weapon::ismeleeoverrideweapon( var_7 ) )
        {
            var_4 = var_7;
            break;
        }
    ...
    if ( scripts\mp\utility\weapon::isminigunweapon( var_2 ) )
...
quickdropaddtocache( var_0, var_1, var_2, var_3, var_4 )
{
    if ( !isdefined( self.quickdropcache ) )
        self.quickdropcache = [];

    var_5 = spawnstruct();
    var_5.itemslotindex = var_0;
    var_5.slot = var_1;
    var_5.ent = var_2;
    var_5.droporigin = var_3;
    var_5.dropangles = var_4;
    var_5.playerorigin = self.origin;
    var_5.playeryaw = self.angles[1];
    self.quickdropcache[self.quickdropcache.size] = var_5;
...
quickdropaddtoexisting( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = quickdropfinditemincache( var_0 );

    if ( isdefined( var_5 ) )
    {
        var_6 = var_5.ent;
        var_7 = var_5.droporigin;
        var_8 = var_5.dropangles;
        var_9 = loot_getitemcount( var_6 );
        var_10 = loot_getitemcountlefthand( var_6 );
        var_11 = loot_getitemcountalt( var_6 );
        ...
        if ( isdefined( var_6.groundentity ) )
            var_12 = var_6.groundentity;

        var_13 = var_9 + var_1;
        var_14 = var_10 + var_2;
        var_15 = var_11 + var_3;
        var_16 = quickdropgetscriptableforcount( var_0, var_13 );
        var_17 = calcscriptablepayloadgravityarc( var_7 + ( 0, 0, 12 ), var_7 );
        var_18 = getitemdropinfo( var_7, var_8, var_17, var_12 );
        ...
        if ( isdefined( var_4 ) )
            level.onweapondropcreated scripts\cp_mp\utility\callback_group::callback_trigger( var_19, self, var_4 );

        quickdropplaysound( var_0, var_7, var_16 );
        var_5.ent = var_19;
        thread quickdropcleanupcache();
        deregisterscriptableinstance( var_6 );
...
quickdropnewitem( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = quickdropgetscriptableforcount( var_0, var_1 );

    if ( !isdefined( var_5 ) )
        return;

    var_6 = quickdropcachefindslot();
    var_7 = getitemdroporiginandangles( var_6, self.origin, self.angles, self );
    var_8 = scripts\mp\gametypes\br_extract_quest.gsc::extract_ismissionweapon( var_4 );

    if ( !var_8 )
    {
        var_9 = spawnpickup( var_5, var_7, var_1, 1, var_4, 0, var_2, var_3 );
        quickdropaddtocache( var_0, var_6, var_9, var_7.origin, var_7.angles );
        scripts\mp\gametypes\br_analytics.gsc::branalytics_lootdrop( self, var_5, undefined, var_1 );

        if ( isdefined( var_4 ) )
            level.onweapondropcreated scripts\cp_mp\utility\callback_group::callback_trigger( var_9, self, var_4 );
    }

    quickdropplaysound( var_0, var_7.origin, var_5 );
}
...
quickdropitem( var_0 )
{
    ...
    [var_2, var_3, var_4, var_5, var_6] = getquickdropitemcount( var_0 );

    if ( !var_2 )
        return;

    quickdropremovefrominventory( var_0, var_3 );
    var_7 = quickdropaddtoexisting( var_0, var_3, var_4, var_5, var_6 );

    if ( var_7 )
        return;

    quickdropnewitem( var_0, var_3, var_4, var_5, var_6 );
}
...
quickdropall( var_0 )
{
    ...
    handleweaponreloadammodrop( var_0 );
    var_1 = 1;
    [var_3, var_4, var_5, var_6, var_7] = getquickdropitemcount( var_0, 1 );

    if ( !var_3 )
        return;

    quickdropremovefrominventory( var_0, var_4 );
    var_8 = quickdropaddtoexisting( var_0, var_4, var_5, var_6, var_7 );

    if ( !var_8 )
        quickdropnewitem( var_0, var_4, var_5, var_6, var_7 );
}
...
{
    if ( scripts\mp\gametypes\br_gametypes.gsc::isfeaturedisabled( "loot" ) )
        return;
    ...
    for ( var_5 = level.br_pickups.droppedgasmasks.size - 1; var_5 >= 0; var_5-- )
    {
        ...
        if ( distance2dsquared( var_6.origin, var_0 ) > var_2 )
        {
            ...
            else if ( var_6 scripts\cp_mp\gasmask::didgasmaskpipschange( var_7, var_8 ) )
            {
                var_9 = calcscriptablepayloadgravityarc( var_6.origin + ( 0, 0, 12 ), var_6.angles );
                var_10 = getitemdropinfo( var_6.origin, var_6.angles, var_9 );
                var_11 = var_6.type;
...
registeruniquelootcallback( var_0, var_1 )
{
    while ( !isdefined( level.br_pickups ) )
        waitframe();

    level.br_pickups.uniquelootcallbacks["uniqueLootItem_" + var_0] = var_1;
}

processuniquelootitem( var_0, var_1 )
{
    if ( isdefined( [[ level.br_pickups.uniquelootcallbacks[var_0] ]]( var_1 ) ) )
        return;
    else
    {
...
watchremoveminigunrestrictions()
{
    ...
    for (;;)
    {
        var_0 = scripts\engine\utility::waittill_any_return_no_endon_death_2( "switched_from_minigun", "dropped_minigun" );
...
watchminigunweapon()
{
    ...
    for (;;)
    {
        if ( !scripts\mp\utility\weapon::isminigunweapon( self getcurrentweapon() ) )
        {
            if ( istrue( var_0 ) )
            {
                var_0 = 0;
