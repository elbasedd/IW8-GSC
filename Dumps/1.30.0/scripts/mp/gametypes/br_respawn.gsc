...
playersetinlaststand()
{
    ...
    scripts\mp\gametypes\br_public.gsc::setplayerdownedextrainfo( 1 );
}
...
playertrytakedefibrillator( var_0 )
{
    if ( isalive( self ) && isdefined( var_0 ) && isdefined( var_0.basename ) && var_0.basename == "iw8_defibrillator_mp" && self hasweapon( "iw8_defibrillator_mp" ) )
    {
        ...
        if ( var_1.size > 0 && !scripts\mp\utility\weapon::ismeleeoverrideweapon( var_1[0] ) )
            self switchtoweapon( var_1[0] );
        else if ( var_1.size > 1 && !scripts\mp\utility\weapon::ismeleeoverrideweapon( var_1[1] ) )
