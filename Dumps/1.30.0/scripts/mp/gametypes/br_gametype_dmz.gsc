...
init()
{
    ...
    level.quest_secretdistmin = getdvarint( "scr_bmo_questScavDistMin", 5000 );
    level.quest_secretdistmax = getdvarint( "scr_bmo_questScavDistMax", 8000 );
...
playerwelcomesplashes( var_0 )
{
    ...
    if ( soundexists( "dx_bra_uktl_bm_tut_earn_cash" ) )
        level scripts\mp\gametypes\br_public.gsc::brleaderdialogplayer( "bm_tut_earn_cash", self );
...
handleendgamesplash()
{
    foreach ( var_1 in level.players )
    {
        if ( !isteamextracted( var_1.team ) )
            var_1 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "post_game_state", 2 );
    }
}
...
hackclientomnvarclamp( var_0, var_1 )
{
    ...
    scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( var_0, var_2 );
}

hackomnvarclamp( var_0, var_1 )
{
    var_2 = int( min( var_1, 131072 ) );
    scripts\cp_mp\utility\omnvar_utility::setcachedgameomnvar( var_0, var_2 );
}
...
plunderrankupdate()
{
    ...
    for (;;)
    {
        ...
        var_12 = level.called50percentprogress && level.called75percentprogress && level.called90percentprogress;
        var_13 = getwincost();
        ...
        if ( istrue( level.usemilestonephases ) )
            ...
            var_14 = var_0 > level.secondsbeforeplacementupdates;

        var_15 = level.showplacementsplashesandmusic && var_14;
        var_16 = scripts\mp\gamescore::getteamscoreplacements();
        var_17 = level.teamplunderscoremechanic;
        var_18 = undefined;
        var_19 = undefined;
        var_20 = undefined;
        var_21 = [];
        ...
        {
            var_30 = getteamplunder( var_29 );
            var_31 = getbankedplunder( var_29 );
            var_32 = updateteamplunderscore( var_30, var_29, level.brgametype.firstteam );
            var_33 = getpreviousplacement( var_29 );
            ...
            foreach ( var_40 in var_38 )
            {
                ...
                var_40 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_team_placement", var_34 );
                var_40 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_player_position", var_34 );
                var_40 hackclientomnvarclamp( "ui_br_team_cash_banked", int( var_37 * 0.01 ) );
                var_40 hackclientomnvarclamp( "ui_br_team_cash_pockets", int( var_35 * 0.01 ) );
            ...
            if ( var_36 >= var_13 )
            {
                autobankteamplunder( var_29 );

                if ( var_17 && level.doendofmatchotsequence > 0 && !level.disablewinonscore )
                {
                    level thread triggerovertimetimer( var_29, level.teamdata[var_29]["plunderBanked"] * 1000 >= var_13 );
                    continue;
                }

                if ( var_17 && level.doendofmatchotsequence > 0 && level.disablewinonscore )
                {
                    level.initialwinningteam = var_29;
                    continue;
                }
                ...
                {
                    level.exfilactive = 1;
                    level thread startbmoexfilprocess( var_29 );
                    continue;
                }

                if ( !level.teamplunderexfil && var_17 && !level.disablewinonscore )
                    level thread givewincondition( var_29 );
            }
        }
        ...
        level.brgametype.firstteam = var_24;
        ...
        if ( var_25 != "none" )
            hackomnvarclamp( "ui_br_cash_second", int( var_27 ) );

        hackomnvarclamp( "ui_br_cash_leader", int( var_26 ) );

        if ( !var_8 && var_26 * 100 >= var_13 * level.hideleaderhashuntilpercent * 0.01 )
        {
        ...
        {
            if ( !var_2 && var_26 * 100 >= var_13 * level.milestonephasepercent_vips * 0.01 )
            {
                var_2 = 1;
            ...
            if ( !var_3 && ( level.scorerequiresbanking || var_26 * 100 >= var_13 * level.milestonephasepercent_lzs * 0.01 ) )
            {
                var_3 = 1;
            ...
            if ( !var_4 && var_26 * 100 >= var_13 * level.milestonephasepercent_drops * 0.01 )
            {
                var_4 = 1;
            ...
            if ( !var_5 && ( istrue( level.bmoovertime ) || var_26 * 100 >= var_13 * level.milestonephasepercent_helis * 0.01 ) )
            {
                var_5 = 1;
            ...
            if ( !var_6 && var_26 * 100 >= var_13 * level.hideplacementuntilpercent * 0.01 )
                var_6 = 1;
        ...
        foreach ( var_29 in var_21 )
        {
            ...
            {
                if ( istrue( level.topteamsever[var_29] ) )
                {
                    if ( !scripts\mp\gametypes\br_public.gsc::isdmztutorial() )
        ...
        var_1 = var_21;
        level.topteam = var_24;
        level.previousplacements = var_16;

        if ( !var_12 )
        {
            if ( !level.called90percentprogress && isdefined( var_18 ) )
            {
                level.called90percentprogress = 1;

                if ( var_11 < var_10 )
                    level printallcashsources( "90 Percent", var_11 );

                if ( !scripts\mp\gametypes\br_public.gsc::isdmztutorial() )
                {
                    if ( !level.disablepercentageannouncements )
                    {
                        showsplashtoallexceptteam( var_18, "bm_first_to_90_them" );
                        showsplashtoteam( var_18, "bm_first_to_90_us" );
                        level thread scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "gamestate_90_perc_first", var_18, 1, undefined, "bm" );

                        foreach ( var_50 in level.teamnamelist )
                        {
                            if ( var_50 != var_18 )
                                level thread scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "gamestate_90_perc_enemy", var_50, 1, undefined, "bm" );
                        }
                    }
                }
            }
            else if ( !level.called75percentprogress && isdefined( var_19 ) )
            {
                level.called75percentprogress = 1;

                if ( var_11 < var_10 )
                    level printallcashsources( "75 Percent", var_11 );

                if ( !scripts\mp\gametypes\br_public.gsc::isdmztutorial() )
                {
                    if ( !level.disablepercentageannouncements )
                    {
                        showsplashtoallexceptteam( var_19, "bm_first_to_75_them" );
                        showsplashtoteam( var_19, "bm_first_to_75_us" );
                        level thread scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "gamestate_75_perc_first", var_19, 1, undefined, "bm" );

                        foreach ( var_50 in level.teamnamelist )
                        {
                            if ( var_50 != var_19 )
                                level thread scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "gamestate_75_perc_enemy", var_50, 1, undefined, "bm" );
                        }
                    }
                }
            }
            else if ( !level.called50percentprogress && isdefined( var_20 ) )
            {
                level.called50percentprogress = 1;

                if ( var_11 < var_10 )
                    level printallcashsources( "50 Percent", var_11 );

                if ( !scripts\mp\gametypes\br_public.gsc::isdmztutorial() )
                {
                    if ( !level.disablepercentageannouncements )
                    {
                        showsplashtoallexceptteam( var_20, "bm_first_to_50_them" );
                        showsplashtoteam( var_20, "bm_first_to_50_us" );
                        level thread scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "gamestate_50_perc_first", var_20, 1, undefined, "bm" );

                        foreach ( var_50 in level.teamnamelist )
                        {
                            if ( var_50 != var_20 )
                                level thread scripts\mp\gametypes\br_public.gsc::brleaderdialogteam( "gamestate_50_perc_enemy", var_50, 1, undefined, "bm" );
                        }
                    }
                }
            }
...
autobankteamplunder( var_0 )
{
    ...
    foreach ( var_4 in var_1 )
    {
        if ( isdefined( var_4.plundercount ) && var_4.plundercount > 0 )
            var_4 scripts\mp\gametypes\br_plunder.gsc::playerplunderbank( var_4.plundercount, undefined, var_2 );
    }
...
playerdropplunderondeath( var_0, var_1 )
{
    ...
    if ( var_3 > 0 )
        scripts\mp\gametypes\br_plunder.gsc::playerplunderdrop( var_3 );
    ...
    if ( isdefined( var_1 ) && self == var_1 || !level.killcam )
        scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_plunder_dropped", var_3 );
    else
        self.postkillcamplunderlost = var_3;

    scripts\mp\gametypes\br_analytics.gsc::trackcashevent( self, "combat", var_3 * -1 );
...
onpostkillcamcallback()
{
    ...
    {
        scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_plunder_dropped", int( self.postkillcamplunderlost ) );
...
helisetteamextractionhud( var_0, var_1 )
{
    ...
    {
        var_5 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_plunder_extract_state", var_0 );
        var_5 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_plunder_extract_end_time", var_2 );
    }
}
...
handleplunderendgamesplash( var_0 )
{
    ...
    foreach ( var_4 in level.players )
    {
        ...
        {
            var_4 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "post_game_state", var_2 );
            var_4 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_end_game_splash_type", 11 );
            continue;
        }

        var_4 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "post_game_state", var_2 );
        var_4 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "ui_br_end_game_splash_type", 12 );
    }
}
...
triggerovertimetimer( var_0, var_1, var_2 )
{
    ...
    scripts\mp\gametypes\br_publicevents.gsc::cancelupcomingpublicevents();
...
handlebmoendgamesplash()
{
    ...
    foreach ( var_2 in level.players )
        var_2 scripts\cp_mp\utility\omnvar_utility::setcachedclientomnvar( "post_game_state", var_0 );
}
...
printallcashsources( var_0, var_1 )
{
    var_2 = scripts\mp\gamescore::getteamscoreplacements();
    logstring( "printAllCashSources() + " + var_0 + " @ " + var_1 );
    logstring( "level.dmzWinCost                  = " + level.dmzwincost );
    logstring( "level.useMilestonePhases          = " + level.usemilestonephases );
    logstring( "level.milestonePhasePercent_VIPs  = " + level.milestonephasepercent_vips );
    logstring( "level.milestonePhasePercent_LZs   = " + level.milestonephasepercent_lzs );
    logstring( "level.milestonePhasePercent_Drops = " + level.milestonephasepercent_drops );
    logstring( "level.milestonePhasePercent_Helis = " + level.milestonephasepercent_helis );
    ...
    foreach ( var_4 in level.teamnamelist )
    {
        ...
        var_5 = getteamplunder( var_4 ) * 100;
        logstring( "TEAM          = " + var_4 );
        logstring( "PLACEMENT     = " + var_2[var_4] );
        logstring( "PLUNDER TOTAL = " + var_5 );
        logstring( "SNAPSHOT SOURCES:" );

        foreach ( var_7 in level.cashtypes )
        {
            var_8 = level.cashmetrics[var_4].sources[var_7];
            logstring( var_7 + " = " + var_8 );
        }
    }
}
