...
flaglockedtimer()
{
    ...
    if ( level.flagactivationdelay )
    {
        ...
        level.defenderflagbase.objectiveicon thread scripts\mp\gametypes\obj_zonecapture.gsc::lockedradialunfill( level.flagactivationdelay, level.defenderflag.curorigin + level.defenderflag.offset3d );
...
createteamdefenderflag( var_0 )
{
    ...
    var_5 scripts\mp\gameobjects::registercarryobjectpickupcheck( ::flagpickupchecks );
    ...
    if ( isdefined( level.showenemycarrier ) )
    {
        ...
        var_5 scripts\mp\gameobjects::setobjectivestatusallicons( level.iconescort, level.iconkill, level.mlgiconfullflag, var_6 );
    }
    else
    {
        var_5.objidpingfriendly = 1;
...
createteamdefenderflagbase( var_0, var_1 )
{
    ...
    if ( level.flagactivationdelay )
    {
        ...
        var_3.objectiveicon scripts\mp\gameobjects::setobjectivestatusallicons( level.icontarget, level.icontarget, level.mlgiconfullflag );
    }
    else
        var_3.objectiveicon scripts\mp\gameobjects::setobjectivestatusallicons( level.iconcaptureflag, level.iconcaptureflag, level.mlgiconfullflag );
