...
setupcommoncallbacks()
{
    ...
    level.gungameweapons = getdvarint( "scr_game_gunGameWeapons", 0 );

    if ( level.gungameweapons > 0 )
    {
        setspecialggloadout();
        setomnvar( "ui_gamemode_override", 1 );
        level thread waitthensetupgungameweapons();
    }
    ...
    if ( level.dosoccerevent || istrue( var_0 ) )
    {
        ...
        level.dosoccerevent = undefined;

    if ( getdvarint( "scr_game_specialEventObjs", 0 ) == 1 )
    {
        level.gos_fx["gos_fireworks"] = loadfx( "vfx/iw8_mp/gamemode/vfx_gos_firework.vfx" );
        level.gamesofsummercallbacks = 1;
    }

    var_3 = scripts\mp\utility\game::matchmakinggame() && scripts\mp\utility\game::isspecialeventobjhalloween();

    if ( var_3 )
    {
        level.halloweendvar = 1;
        level.hween_fx["vanish_hw_fr"] = loadfx( "vfx/iw8_mp/gamemode/vfx_halloween_kc_capture_friendly.vfx" );
        level.hween_fx["vanish_hw_en"] = loadfx( "vfx/iw8_mp/gamemode/vfx_halloween_kc_capture_enemy.vfx" );
        level.hween_fx["ghostcat_hw"] = loadfx( "vfx/iw8_br/gameplay/hween/vfx_halloween_ghost_cat.vfx" );
        level.hween_fx["bats_hw"] = loadfx( "vfx/iw8_br/gameplay/hween/vfx_hween_bats.vfx" );
        level.hween_fx["bats_fly_hw"] = loadfx( "vfx/iw8_br/gameplay/hween/vfx_hween_bats_fly.vfx" );
        level.hween_fx["blood_ceil_hw"] = loadfx( "vfx/iw8_br/gameplay/hween/vfx_halloween_blood_ceiling_01.vfx" );
        level.hween_fx["blood_floor_hw"] = loadfx( "vfx/iw8_br/gameplay/hween/vfx_halloween_blood_floor_01.vfx" );

        if ( getdvarint( "scr_player_event_models", 1 ) > 0 )
        {
            var_4 = strtok( getdvar( "scr_player_hwhead_killcount", "3 10" ), " " );
            level.hwheadkillcount = int( var_4[0] );
            level.hwheadkillcountfire = int( var_4[1] );
            level.onplayerkilledhw = ::onplayerkilledhw;
        }
    }
...
onspawnplayercommon()
{
    ...
    if ( istrue( level.gungameweapons ) )
        thread waitloadoutdoneggw();
    ...
    if ( istrue( level.halloweendvar ) )
    {
        ...
        if ( scripts\mp\flags::gameflag( "prematch_done" ) )
            thread waitthensetneutralheadvfx();

        if ( getdvarint( "scr_player_event_models", 1 ) == 2 )
            thread spawnwithpumpkinhead();
    }
}
...
onplayerkilledcommon( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( level.onggwplayerkilled ) )
        [[ level.onggwplayerkilled ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 );

    if ( isdefined( level.onplayerkilledhw ) )
        [[ level.onplayerkilledhw ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 );
}
...
onplayerkilledhw( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    {
        if ( !isdefined( var_1.hw_killcount ) )
            var_1.hw_killcount = 1;
        else
        {
            var_1.hw_killcount++;

            if ( var_1.hw_killcount == level.hwheadkillcount )
            {
            ...
            else if ( var_1.hw_killcount == level.hwheadkillcountfire )
                var_1 setscriptablepartstate( "headVFX", "flames", 0 );
        }
    }
}

waitthensetneutralheadvfx()
{
    waitframe();
    self setscriptablepartstate( "headVFX", "neutral", 0 );
}

spawnwithpumpkinhead()
{
    self endon( "death_or_disconnect" );
    self waittill( "spawned_player" );
...
waitthensetupgungameweapons()
{
    ...
    level.ladderindex = level.gungameweapons;
    scripts\mp\gametypes\gun.gsc::setgunladder();
    scripts\mp\gametypes\gun.gsc::setgunsfinal();

    if ( isallowallkillstocycleguns() )
        level.onggwplayerkilled = ::onggwplayerkilledany;
    else
        level.onggwplayerkilled = ::onggwplayerkilled;

    scripts\mp\flags::gameflagset( "gungame_set" );
    level.gun_loadouts["axis"]["loadoutPrimary"] = getnextgun( 0 );
}

onggwplayerkilled( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( var_3 == "MOD_FALLING" || isdefined( var_1 ) && isplayer( var_1 ) )
    {
        ...
        var_11 = scripts\mp\utility\weapon::isknifeonly( var_4.basename ) || scripts\mp\utility\weapon::isakimbomeleeweapon( var_4.basename ) || scripts\mp\utility\weapon::isaxeweapon( var_4.basename ) || scripts\mp\utility\weapon::ismeleeoverrideweapon( var_4 );
        ...
        if ( var_1 != self && var_3 == "MOD_PISTOL_BULLET" || var_3 == "MOD_RIFLE_BULLET" || var_3 == "MOD_HEAD_SHOT" || var_3 == "MOD_PROJECTILE" || var_3 == "MOD_PROJECTILE_SPLASH" || var_3 == "MOD_IMPACT" || var_3 == "MOD_GRENADE" || var_3 == "MOD_GRENADE_SPLASH" || var_3 == "MOD_EXPLOSIVE" || var_3 == "MOD_FIRE" || var_3 == "MOD_MELEE" && var_1 isonlastkill() && ( var_11 || var_10 || var_12 ) || var_3 == "MOD_MELEE" && !var_11 || var_12 )
        {
            var_14 = getweaponbasename( var_1.primaryweapon );

            if ( !var_1 canprogressingunrank( var_4, var_14, var_12, var_10, var_11 ) )
                return;
...
canprogressingunrank( var_0, var_1, var_2, var_3, var_4 )
{
...
onggwplayerkilledany( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    if ( isdefined( var_1 ) && isplayer( var_1 ) )
    {
        if ( isdefined( self.pers["classCache"] ) && self.pers["classCache"].size > 0 )
...
ischangeonkillgungameweapons()
{
    return level.gungameweapons == 1;
}

ischangeondeathsgungameweapons()
{
    return level.gungameweapons == 2;
}

ischangeonbothgungameweapons()
{
    return level.gungameweapons == 3;
}

isallowallkillstocycleguns()
{
    return level.gungameweapons == 7 || level.gungameweapons == 8 || level.gungameweapons == 9 || level.gungameweapons == 10;
}
...
setupsoccerball()
{
    ...
    level.multiballspawnpositions = var_7;
    var_12 = undefined;
    ...
    level thread createball( var_1, 1 );
}

createball( var_0, var_1 )
{
    if ( isdefined( var_1 ) )
        wait( var_1 );
    ...
    var_5.resetposition = var_0;
    var_5.issoccerball = 1;
    var_5.onreset = ::onsoccerballreset;
    var_5.ongoalscore = ::ongoalscore;
    var_5.soccerphysicscallbacks = ::start_ball_physics_callbacks;
    var_6 = ( 0, 30, 0 );
    ...
    var_5 thread outofboundswatcher();
    var_5 thread outofworldwatcher();

    if ( getdvarint( "scr_game_soccergoal", 1 ) == 1 )
        var_5 thread soccergoaltriggertouchingwatcher();

    if ( isdefined( var_5.soccerphysicscallbacks ) )
        var_5 [[ var_5.soccerphysicscallbacks ]]();

    level.soccerballs[level.soccerballs.size] = var_5;
}

start_ball_physics_callbacks()
{
...
onsoccerballreset( var_0 )
{
    ...
    if ( !istrue( var_0 ) )
    {
        ...
        playfx( level.soccer_fx["vanish"], self.visuals.origin );
    }
    else
    {
        wait 0.1;
    ...
    if ( isdefined( self.soccerphysicscallbacks ) )
        self [[ self.soccerphysicscallbacks ]]();
}
...
ongoalscore( var_0 )
{
    ...
    var_0.goalsscored++;
    level updatescoreboardscriptables( var_0 );
    var_0 thread goalplayfireworks();
        ...
        foreach ( var_5 in level.players )
        {
            if ( var_5.team == var_1 )
            {
                if ( var_5.team == "allies" )
                    var_5 thread playgoaldialogdelayed( "dx_mpa_rutl_summer_game_goal" + scripts\engine\utility::random( level.goaldialog ), "summer_game_goal", 2, "soccer_goal_them" );
                else
                    var_5 thread playgoaldialogdelayed( "dx_mpa_uktl_summer_game_goal" + scripts\engine\utility::random( level.goaldialog ), "summer_game_goal", 2, "soccer_goal_them" );
            ...
            if ( var_5.team == "allies" )
            {
                var_5 thread playgoaldialogdelayed( "dx_mpa_uktl_summer_game_goal" + scripts\engine\utility::random( level.goaldialog ), "summer_game_goal", 2, "soccer_goal_us" );
                continue;
            }

            var_5 thread playgoaldialogdelayed( "dx_mpa_rutl_summer_game_goal" + scripts\engine\utility::random( level.goaldialog ), "summer_game_goal", 2, "soccer_goal_us" );
        }
    }
    else
    {
    ...
    self.visuals thread playgoalsfx();
    ...
    if ( var_0.goalsscored >= 10 && isdefined( game["multiBall"] ) && !game["multiBall"] || getdvarint( "scr_game_forcemultiball", 0 ) == 1 && isdefined( game["multiBall"] ) && !game["multiBall"] )
    {
        game["multiBall"] = 1;
        ...
        if ( level.multiballspawnpositions.size > 0 )
        {
            var_15 = getdvarint( "scr_game_soccermultiball", 3 );

            for ( var_16 = 0; var_16 < var_15; var_16++ )
                createball( level.multiballspawnpositions[var_16] );
        }
    }
}
...
goalplayfireworks( var_0, var_1 )
{
    for ( var_2 = 0; var_2 < min( self.goalsscored, 10 ); var_2++ )
    {
        playfx( level.gos_fx["gos_fireworks"], self.trigger.origin + ( randomintrange( -100, 100 ), randomintrange( -100, 100 ), randomintrange( -25, 60 ) ), anglestoforward( self.trigger.angles + ( randomintrange( int( max( clamp( 0 - var_2 * 5, -19, 0 ), -20 ) ), int( min( 20, 1 + var_2 * 5 ) ) ), randomintrange( int( max( clamp( 0 - var_2 * 5, -19, 0 ), -20 ) ), int( min( 20, 1 + var_2 * 5 ) ) ), 0 ) ), anglestoup( self.trigger.angles + ( randomintrange( int( max( clamp( 0 - var_2 * 5, -19, 0 ), -20 ) ), int( min( 20, 1 + var_2 * 5 ) ) ), randomintrange( int( max( clamp( 0 - var_2 * 5, -19, 0 ), -20 ) ), int( min( 20, 1 + var_2 * 5 ) ) ), 0 ) ) );

        if ( istrue( var_0 ) )
            level thread waitthenplayfireworkexplode( self.trigger.origin );
...
updatescoreboardscriptables( var_0 )
{
    foreach ( var_2 in level.allscoreboardstructs )
    {
        if ( var_2.scoreteam == var_0.team )
        {
            if ( var_0.goalsscored >= 10 )
            {
                var_2.scriptable setscriptablepartstate( "score", "10" );
                continue;
            }

            var_2.scriptable setscriptablepartstate( "score", "0" + scripts\engine\utility::string( var_0.goalsscored ) );
        }
    }
}
...
soccergoalwatcher()
{
    ...
    if ( var_0.size > 0 && var_1.size > 0 )
    {
        ...
        level.alliesgoal.trigger = var_0[0];
        level.alliesgoal.entsinside = [];
        level.axisgoal = spawnstruct();
        level.axisgoal.team = "axis";
        level.axisgoal.trigger = var_1[0];
        level.axisgoal.entsinside = [];
        level.axisgoal.goalsscored = 0;

        if ( !isdefined( game["roundsPlayed"] ) || isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] == 0 )
        {
            game["alliesGoals"] = 0;
            level.alliesgoal.goalsscored = 0;
            game["axisGoals"] = 0;
            level.axisgoal.goalsscored = 0;
        }
        else if ( game["switchedsides"] )
        {
            level.axisgoal.goalsscored = game["alliesGoals"];
            level.alliesgoal.goalsscored = game["axisGoals"];
        }
        else
        {
            level.alliesgoal.goalsscored = game["alliesGoals"];
            level.axisgoal.goalsscored = game["axisGoals"];
        }

        level.soccergoaltriggers = [ level.axisgoal, level.alliesgoal ];
        level thread waitthensetgoalstructs();
    }
    else
        level notify( "stop_soccer_goal" );
}

waitthensetgoalstructs()
{
    wait 1;
    level.alliesscorestructs = scripts\engine\utility::getstructarray( "home", "targetname" );
    level.axisscorestructs = scripts\engine\utility::getstructarray( "away", "targetname" );
    level.allscoreboardstructs = scripts\engine\utility::array_combine( level.alliesscorestructs, level.axisscorestructs );

    foreach ( var_1 in level.alliesscorestructs )
    {
        ...
        var_1.scoreteam = "allies";
    }

    foreach ( var_1 in level.axisscorestructs )
    {
        var_1.scriptable = spawn( "script_model", var_1.origin );
        var_1.scriptable.angles = var_1.angles;
        var_1.scriptable setmodel( "vfx_stadium_scoreboard_scriptable" );
        var_1.scoreteam = "axis";
    }

    level updatescoreboardscriptables( level.alliesgoal );
    level updatescoreboardscriptables( level.axisgoal );
}

soccergoaltriggertouchingwatcher( var_0 )
{
    level endon( "game_ended" );
    level endon( "stop_soccer_goal" );

    while ( !isdefined( level.soccergoaltriggers ) )
        waitframe();
    ...
    for (;;)
    {
        ...
        for ( var_1 = 0; var_1 < level.soccergoaltriggers.size; var_1++ )
        {
            if ( !istouchingsoccergoaltrigger( level.soccergoaltriggers[var_1], self.visuals ) )
                continue;

            if ( !shouldaddtosoccergoaltrigger( level.soccergoaltriggers[var_1], self.visuals ) )
                continue;

            var_2 = self.visuals getentitynumber();
            level.soccergoaltriggers[var_1].entsinside[var_2] = self.visuals;
            self.visuals.soccergoaltriggerstruct = level.soccergoaltriggers[var_1];

            if ( isdefined( self.ongoalscore ) )
                [[ self.ongoalscore ]]( level.soccergoaltriggers[var_1] );
...
shouldaddtosoccergoaltrigger( var_0, var_1 )
{
...
istouchingsoccergoaltrigger( var_0, var_1 )
{
    if ( !var_1 istouching( var_0.trigger ) )
    {
        ...
        if ( isdefined( var_1.soccergoaltriggerstruct ) && var_1.soccergoaltriggerstruct == var_0 )
            var_1.soccergoaltriggerstruct = undefined;
...
waitthenplayfireworkexplode( var_0 )
{
...
{
    level.gos_fx["gos_fireworks"] = loadfx( "vfx/iw8_mp/gamemode/vfx_gos_firework.vfx" );
    level.soccer_fx["vanish"] = loadfx( "vfx/iw8_mp/gamemode/vfx_soccer_ball_burst.vfx" );
    level.soccer_fx["score_00"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_00.vfx" );
    level.soccer_fx["score_01"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_01.vfx" );
    level.soccer_fx["score_02"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_02.vfx" );
    level.soccer_fx["score_03"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_03.vfx" );
    level.soccer_fx["score_04"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_04.vfx" );
    level.soccer_fx["score_05"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_05.vfx" );
    level.soccer_fx["score_06"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_06.vfx" );
    level.soccer_fx["score_07"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_07.vfx" );
    level.soccer_fx["score_08"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_08.vfx" );
    level.soccer_fx["score_09"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_09.vfx" );
    level.soccer_fx["score_10"] = loadfx( "vfx/iw8_mp/level/stadium/vfx_stad_score_10.vfx" );
}
...
playgoaldialogdelayed( var_0, var_1, var_2, var_3 )
{
