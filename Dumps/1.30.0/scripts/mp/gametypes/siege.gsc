...
main()
{
    ...
    if ( level.isgroundwarsiege )
    {
        ...
        level.maxhqtanks = 0;
        level.numnonrallyvehicles = getdvarint( "scr_siege_numNonRallyVehicles", 25 );
...
onstartgametype()
{
    ...
    if ( level.isgroundwarsiege )
    {
        ...
        scripts\mp\gametypes\arm.gsc::setuphqs();
        scripts\mp\gametypes\arm.gsc::calculatehqmidpoint();
        level.numsiegeflags = getdvarint( "scr_siege_flagcount", 3 );
...
getvehiclespawns( var_0, var_1 )
{
    ...
    level.atvoriginsarray = var_4;
    level.atvanglesarray = var_5;
...
onplayerconnect( var_0 )
{
    ...
    if ( level.isgroundwarsiege && isdefined( game["roundsPlayed"] ) && game["roundsPlayed"] != 0 && !scripts\mp\flags::gameflag( "prematch_done" ) )
...
domflags()
{
    ...
    foreach ( var_24 in level.objectives )
    {
        ...
        var_24.stompeenemyprogressupdate = ::onstompeenemyprogressupdate;
...
watchflagenduse( var_0 )
{
    ...
    if ( var_1 == level.numsiegeflags )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_2 == level.numsiegeflags )
...
onuse( var_0 )
{
    ...
    if ( var_2 == "neutral" )
    {
        ...
        {
            if ( var_4 == 2 && level.numsiegeflags == 3 )
            {
    ...
    thread checkshouldplaymusic( var_1 );
}
...
checkendgame()
{
    ...
    if ( var_0 == level.numsiegeflags )
        setwinner( "allies", "siege_allflags_win", "siege_allflags_loss" );
    else if ( var_1 == level.numsiegeflags )
        setwinner( "axis", "siege_allflags_win", "siege_allflags_loss" );
}
...
runobjectives( var_0 )
{
        ...
        if ( level.numsiegeflags == 3 )
        {
            if ( level.mapname == "mp_downtown_gw" )
            {
                if ( var_2.trigger.objkey == "_a" || var_2.trigger.objkey == "_e" )
                    ...
                    remapobjkeysandscriptlabels( var_2.trigger );
            }
    ...
    foreach ( var_2 in level.allfobs )
    {
        ...
        var_2.trigger.gameobject.stompeenemyprogressupdate = ::onstompeenemyprogressupdate;
    ...
    if ( level.precappoints )
        scripts\mp\gametypes\obj_dom.gsc::precap( level.numsiegeflags == 5 );

    scripts\mp\gametypes\dom.gsc::flagsetup();
    level thread objective_manageobjectivesintrovisibility();
    level thread scripts\mp\gametypes\arm.gsc::allowobjectiveuseaftermatchstart();
}
...
remapobjkeysandscriptlabels( var_0 )
{
    if ( level.mapname == "mp_downtown_gw" )
    {
        if ( var_0.objkey == "_b" && !isdefined( var_0.oldkey ) )
        {
            var_0.oldkey = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_c" && !isdefined( var_0.oldkey ) )
        {
            var_0.oldkey = "_c";
            var_0.objkey = "_b";
            var_0.script_label = var_0.objkey;
        }
        else if ( var_0.objkey == "_d" && !isdefined( var_0.oldkey ) )
        {
            var_0.oldkey = "_d";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
    ...
    {
        if ( var_0.objkey == "_a" && !isdefined( var_0.oldkey ) )
        {
            var_0.oldkey = "_a";
            var_0.objkey = "_a";
            var_0.script_label = var_0.objkey;
        ...
        else if ( var_0.objkey == "_e" && !isdefined( var_0.oldkey ) )
        {
            var_0.oldkey = "_e";
            var_0.objkey = "_c";
            var_0.script_label = var_0.objkey;
    ...
    else if ( var_0.objkey == "_b" && !isdefined( var_0.oldkey ) )
    {
        var_0.oldkey = "_b";
        var_0.objkey = "_a";
        var_0.script_label = var_0.objkey;
