...
bombzone_onbombplanted( var_0, var_1 )
{
    ...
    if ( !level.multibomb )
    {
        ...
        var_3 = getmaptraceoffsetoverride();
    ...
    if ( scripts\mp\utility\game::getgametype() != "cmd" )
        var_8 thread bombradialfill( var_2, "waypoint_bomb_defend", "waypoint_defuse" );
...
getbombmodel( var_0 )
{
    if ( istrue( level.halloweendvar ) && istrue( var_0 ) )
    ...
    if ( !level.bombdefused )
    {
        ...
        if ( istrue( self.firstpickup ) )
        {
            ...
            if ( istrue( level.halloweendvar ) )
            {
                ...
                playfx( level.hween_fx["vanish_hw_fr"], self.trigger.origin + ( 0, 0, -9970 ) );
            }
        }
        else
            var_3 = "bomb_pickup";
