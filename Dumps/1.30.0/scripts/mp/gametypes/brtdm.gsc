...
main()
{
    ...
    scripts\mp\gametypes\br_gametypes.gsc::disablefeature( "weapons" );
    updategametypedvars();
...
updategametypedvars()
{
    ...
    level.autorespawnwaittime = getdvarint( "scr_dmz_autoRespawnWaitTime", 3 );
    ...
    foreach ( var_2 in var_0 )
    {
        if ( getdvarint( "scr_brtdm_vehicle_disable_" + var_2, 0 ) == 1 )
            level.brtdm_config.disabledvehicles[var_2] = 1;
    }
...
{
    level.brtdm_config.locale_defaults[var_0] = var_1;
}
...
applylocaledefaults()
{
    ...
    switch ( level.brtdm_config.locale )
    {
        ...
        case "escape2":
            setlocaledefaultvalue( "scr_brtdm_circle_center", ( 0, 0, 0 ) );
            setlocaledefaultvalue( "scr_brtdm_circle_radius", 7000 );
            setlocaledefaultvalue( "scr_brtdm_spawn_angles_allies", 90 );
            setlocaledefaultvalue( "scr_brtdm_spawn_angles_axis", 270 );
            setlocaledefaultvalue( "scr_brtdm_spawn_angle_max", 25.0 );
            setlocaledefaultvalue( "scr_brtdm_spawn_height_allies", 2250 );
            setlocaledefaultvalue( "scr_brtdm_spawn_height_axis", 2500 );
            setlocaledefaultvalue( "scr_brtdm_spectate_origin", ( 3492, 706, 2292 ) );
            setlocaledefaultvalue( "scr_brtdm_spectate_angles", ( 0, 180, 0 ) );
            break;
        case "mechanics":
...
initspawns()
{
    ...
    level.brtdm_config.spawnoffsettacinsertmin = getdvarfloat( "scr_brtdm_ti_spawn_dist_min", 1000 );
    level.brtdm_config.spawnoffsettacinsertmax = getdvarfloat( "scr_brtdm_ti_spawn_dist_max", 3000 );
...
getspawnpoint()
{
    ...
    if ( isdefined( self.setspawnpoint ) )
    {
        ...
        var_7 = vectortoangles( level.brtdm_config.spawnvector[self.team] );
        var_8 = randomfloatrange( level.brtdm_config.spawnanglemin, level.brtdm_config.spawnanglemax );
        var_9 = anglestoforward( ( 0, var_7[1] + scripts\engine\utility::ter_op( scripts\engine\utility::cointoss(), var_8, var_8 * -1 ), 0 ) );
        var_10 = randomfloatrange( level.brtdm_config.spawnoffsettacinsertmin, level.brtdm_config.spawnoffsettacinsertmax );
        var_11 = self.setspawnpoint.playerspawnpos + var_9 * var_10;

        if ( distance2dsquared( var_11, level.brtdm_config.circlecenter ) > level.brtdm_config.circleradius * level.brtdm_config.circleradius )
        {
            var_12 = vectornormalize( var_11 - level.brtdm_config.circlecenter );
            var_11 = level.brtdm_config.circlecenter + var_12 * level.brtdm_config.circleradius * 0.99;
        }
...
pregeneratespawnpoints()
{
    ...
    foreach ( var_4 in level.teamnamelist )
    {
        ...
        {
            var_6 = spawnstruct();
            var_7 = vectortoangles( level.brtdm_config.spawnvector[var_4] );
            var_8 = randomfloatrange( level.brtdm_config.spawnanglemin, level.brtdm_config.spawnanglemax );
            var_9 = anglestoforward( ( 0, var_7[1] + scripts\engine\utility::ter_op( scripts\engine\utility::cointoss(), var_8, var_8 * -1 ), 0 ) );
            var_10 = randomfloatrange( level.brtdm_config.spawndistancemin, level.brtdm_config.spawndistancemax );
            var_11 = level.brtdm_config.circlecenter + var_9 * level.brtdm_config.circleradius * var_10;

            if ( istrue( level.brtdm_config.faceenemyspawn ) )
            {
                var_12 = level.brtdm_config.spawnorigin[scripts\mp\utility\game::getotherteam( var_4 )[0]] - var_11;
            ...
            var_11 = ( var_11[0], var_11[1], var_14 + level.brtdm_config.spawnheight[var_4] );
            var_6.origin = var_11;
...
generatespawnpoint()
{
    ...
    self.redeployspawn.origin = var_1.origin;
    self.redeployspawn.angles = var_1.angles;
    self.redeployspawn.time = gettime();
...
onplayerconnect( var_0 )
{
    ...
    if ( !isbot( var_0 ) )
    {
        var_4 = scripts\mp\gametypes\br_circle.gsc::_safecircledurationforplayer( var_0, var_1 );
        ...
        var_0 scripts\mp\gametypes\br_circle.gsc::_hidesafecircleui();
        var_4 = scripts\mp\gametypes\br_circle.gsc::_dangercircledurationforplayer( var_0, var_1 );
    ...
    if ( !scripts\mp\flags::gameflag( "prematch_done" ) )
        var_0 thread manageprematchfade();
}

manageprematchfade( var_0, var_1 )
{
    ...
    var_2 = 0.0;
    var_3 = 0.5;
    thread managerespawnfade( var_2, var_3 );
...
initvehicles()
{
    ...
    if ( !isdefined( level.brtdm_config.disabledvehicles["little_bird_mg"] ) )
    ...
    if ( !isdefined( level.brtdm_config.disabledvehicles["cargo_truck"] ) )
    ...
    if ( !isdefined( level.brtdm_config.disabledvehicles["cargo_truck_mg"] ) )
        registervehicletype( "cargo_truck_mg", scripts\cp_mp\vehicles\cargo_truck_mg::cargo_truck_mg_getspawnstructscallback, ::vehiclespawn_cargotruckmg );

    if ( !isdefined( level.brtdm_config.disabledvehicles["jeep"] ) )
    ...
    foreach ( var_1 in level.vehicleinfo )
    {
        ...
        {
            case "little_bird":
                var_1.vehiclespawns = getvehiclespawns( "little_bird", "lbravo_physics_mp" );
                break;
            case "little_bird_mg":
                var_1.vehiclespawns = getvehiclespawns( "little_bird_mg", "lbravo_physics_mp" );
                break;
            case "atv":
                var_1.vehiclespawns = getvehiclespawns( "atv", "atango_physics_mp" );
                break;
            case "cargo_truck":
                var_1.vehiclespawns = getvehiclespawns( "cargo_truck", "mkilo_physics_mp" );
                break;
            case "cargo_truck_mg":
                var_1.vehiclespawns = getvehiclespawns( "cargo_truck_mg", "mkilo_physics_mg" );
                break;
            case "jeep":
                var_1.vehiclespawns = getvehiclespawns( "jeep", "decho_physics_mp" );
                break;
            case "tac_rover":
                var_1.vehiclespawns = getvehiclespawns( "tac_rover", "tromeo_physics_mp" );
                break;
        }
    ...
    var_10 = level.numnonrallyvehicles;
...
getvehiclespawns( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.brtdm_config.locale_defaults[var_5] ) )
            var_7 = level.brtdm_config.locale_defaults[var_5];
        ...
        if ( isdefined( level.brtdm_config.locale_defaults[var_6] ) )
            var_10 = level.brtdm_config.locale_defaults[var_6];
...
filtervehiclespawnstructs( var_0 )
{
    var_1 = [];
    ...
    {
        if ( distance2dsquared( var_3.origin, level.brtdm_config.circlecenter ) < level.brtdm_config.circleradius * level.brtdm_config.circleradius )
...
initprematchc130()
{
    ...
    var_2 = 5000;
    var_3 = 10;
    var_4 = vectortoangles( level.brtdm_config.spawnvector["allies"] * -1 );
    var_5 = anglestoforward( ( 0, var_4[1] + var_3, 0 ) );
    var_6 = level.brtdm_config.circlecenter + level.brtdm_config.spawnvector["allies"] * ( level.brtdm_config.circleradius + var_0 ) + ( 0, 0, 1 );
    var_7 = level.brtdm_config.circlecenter + var_5 * ( level.brtdm_config.circleradius * 2 + var_1 );
    var_8 = scripts\engine\trace::create_default_contents( 1 );
    var_6 = scripts\engine\utility::drop_to_ground( var_6, level.brtdm_config.spawnheight["allies"], -1 * level.brtdm_config.spawnheight["allies"], undefined, var_8 );
    var_6 = var_6 + ( 0, 0, 1 ) * ( level.brtdm_config.spawnheight["allies"] + var_2 );
    var_7 = scripts\engine\utility::drop_to_ground( var_7, level.brtdm_config.spawnheight["allies"], -1 * level.brtdm_config.spawnheight["allies"], undefined, var_8 );
    var_7 = var_7 + ( 0, 0, 1 ) * ( level.brtdm_config.spawnheight["allies"] + var_2 );
    var_9 = spawnstruct();
    var_9.startpt = var_6;
    var_9.endpt = var_7;
    ...
    var_13 = scripts\mp\gametypes\br_c130airdrop.gsc::c130airdrop_spawn( var_9, var_10, var_11, var_12 );
    var_13 scripts\mp\gametypes\br_c130airdrop.gsc::c130airdrop_startdelivery( 0 );
    var_4 = vectortoangles( level.brtdm_config.spawnvector["axis"] * -1 );
    var_5 = anglestoforward( ( 0, var_4[1] + var_3, 0 ) );
    var_6 = level.brtdm_config.circlecenter + level.brtdm_config.spawnvector["axis"] * ( level.brtdm_config.circleradius + var_0 ) + ( 0, 0, 1 );
    var_7 = level.brtdm_config.circlecenter + var_5 * ( level.brtdm_config.circleradius * 2 + var_1 );
    var_6 = scripts\engine\utility::drop_to_ground( var_6, level.brtdm_config.spawnheight["axis"], -1 * level.brtdm_config.spawnheight["axis"], undefined, var_8 );
    var_6 = var_6 + ( 0, 0, 1 ) * ( level.brtdm_config.spawnheight["axis"] + var_2 );
    var_7 = scripts\engine\utility::drop_to_ground( var_7, level.brtdm_config.spawnheight["axis"], -1 * level.brtdm_config.spawnheight["axis"], undefined, var_8 );
    var_7 = var_7 + ( 0, 0, 1 ) * ( level.brtdm_config.spawnheight["axis"] + var_2 );
    var_9 = spawnstruct();
    var_9.startpt = var_6;
    var_9.endpt = var_7;
    var_9.angle = vectortoangles( var_5 );
