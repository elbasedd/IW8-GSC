...
callback_vehicledamage_internal( var_0 )
{
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        if ( isdefined( var_4 ) && var_4 == "radar_drone_recon" )
        {
            ...
            var_0.attacker scripts\cp_mp\pet_watch::trackcarpunches( self );
    }

    if ( isdefined( level.modifyvehicledamage ) )
        var_0.damage = self [[ level.modifyvehicledamage ]]( var_0 );
    ...
    if ( var_0.meansofdeath == "MOD_MELEE" )
    {
        ...
        else
        {
            ...
            if ( isdefined( level.modeallowmeleevehicledamage ) )
                var_7 = self [[ level.modeallowmeleevehicledamage ]]( var_0 );
    ...
    {
        if ( isdefined( level.modeignorevehicleexplosivedamage ) && self [[ level.modeignorevehicleexplosivedamage ]]( var_0 ) )
            var_0.damage = 0;
        else if ( scripts\mp\damage::issmallsplashdamage( var_0.objweapon ) )
            var_0.damage = 0;
    ...
    else if ( var_1 )
    {
        ...
        else if ( scripts\mp\damage::isaalpha12explosivedamage( var_0.objweapon, var_0.meansofdeath ) )
            var_0.damage = 0;
        else if ( isdefined( var_4 ) )
    ...
    var_9 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_shouldskipburndown( var_0 );

    if ( !var_9 )
    {
        var_10 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_getstate();
    ...
    if ( scripts\mp\utility\game::getgametype() == "br" )
        ...
        scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_updatestate( var_0, var_9, 1 );
    ...
    var_16 = istrue( var_0.isrearcriticaldamage ) || istrue( var_0.issidecriticaldamage );
    ...
    {
        if ( isdefined( var_0.attacker ) && isplayer( var_0.attacker ) )
            var_0.attacker scripts\cp_mp\pet_watch::checkcarpuncherprogress( self );
