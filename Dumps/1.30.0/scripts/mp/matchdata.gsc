...
init()
{
    ...
    level.canlogbrweaponstats = scripts\mp\utility\game::getgametype() == "br" && getdvarint( "scr_log_br_weapon_stats", 0 ) == 1;
...
logplayermatchend( var_0 )
{
    ...
    {
        var_36["press_rclick"] = istrue( self.gwinputtypesused["rightmouseup"] );
        var_36["press_lclick"] = istrue( self.gwinputtypesused["leftmouseup"] );
        var_36["press_activate"] = istrue( self.gwinputtypesused["activate"] );
        var_36["press_gostand"] = istrue( self.gwinputtypesused["gostand"] );
    }
...
logplayerdata( var_0 )
{
    ...
    foreach ( var_23, var_6 in self.pers["matchdataWeaponStats"] )
    {
        ...
        self dlog_recordplayerevent( "dlog_event_player_weapon_stats_br", [ "weapon", var_6.weapon, "variant_id", var_6.variantid, "from_loadout", var_19, "died", var_20, "time_used_s", var_22, "longest_hit_distance", var_21, "deaths", var_9, "headshots", var_10, "hits", var_11, "kills", var_12, "shots", var_13, "damage", var_14, "attachment_0", var_6.attachments[0], "attachment_1", var_6.attachments[1], "attachment_2", var_6.attachments[2], "attachment_3", var_6.attachments[3], "attachment_4", var_6.attachments[4], "sticker_0", var_6.stickers[0], "sticker_1", var_6.stickers[1], "sticker_2", var_6.stickers[2], "sticker_3", var_6.stickers[3], "reticle", var_6.reticle, "cosmetic_attachment", var_6.cosmetic, "camo", var_6.camo, "match_time_created_s", var_6.pickuptime ] );
    }
}
...
setgamemodemodifierinplayerdata( var_0 )
{
...
endofgamesummarylogger()
{
    ...
    foreach ( var_2 in level.players )
    {
        ...
        setgamemodemodifierinplayerdata( var_2 );
    }
}
...
logweaponstat( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( !istrue( level.canlogbrweaponstats ) )
        return;
    ...
    {
        if ( !checkifmatchdataweaponstatsexists( var_4, var_5 ) )
        {
            var_6 = 1;
            var_7 = var_5 + "_" + var_6;
            ...
            for (;;)
            {
                if ( !isdefined( self.pers["matchdataWeaponStats"][var_7] ) || checkifmatchdataweaponstatsexists( var_4, var_7 ) )
                    break;
    ...
    if ( !isdefined( self.pers["matchdataWeaponStats"][var_5] ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && isdefined( var_4 ) )
        {
            ...
            self.pers["matchdataWeaponStats"][var_5].cosmetic = var_9;
            ...
            self.pers["matchdataWeaponStats"][var_5].stickers = var_18;
        }
    }
...
checkifmatchdataweaponstatsexists( var_0, var_1 )
{
    ...
    if ( var_3 != self.pers["matchdataWeaponStats"][var_1].cosmetic )
        return 0;
    ...
    if ( var_7.size != self.pers["matchdataWeaponStats"][var_1].stickers.size )
        return 0;

    for ( var_6 = 0; var_6 < var_7.size; var_6++ )
    {
        if ( var_7[var_6] != self.pers["matchdataWeaponStats"][var_1].stickers[var_6] )
            return 0;
    }
