...
init()
{
    ...
    level.map10v10type = getdvarint( "scr_map_use10v10_objectives", 0 );
    level.teambased = 0;
...
registerdvars()
{
    ...
    registerturretoverheatdvars();
}

registerfalldamagedvars()
{
    if ( ( scripts\mp\utility\game::getgametype() == "arm" || scripts\mp\utility\game::isgroundwarcoremode() || scripts\mp\utility\game::isverdansksubmap() ) && getdvarint( "scr_game_forceDefaultFallHeight", 0 ) != 1 )
    {
