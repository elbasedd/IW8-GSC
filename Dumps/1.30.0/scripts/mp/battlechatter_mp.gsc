...
dosound( var_0, var_1 )
{
    ...
    {
        if ( isdefined( self.operatorcustomization.executionquipoverride ) && self.operatorcustomization.executionquipoverride != "" )
            var_2 = self.operatorcustomization.executionquipoverride;
        else
        {
    ...
    if ( isdefined( level.bcinfo["additional_local_vo"][var_0] ) && isdefined( self.squadindex ) )
    {
        ...
        if ( soundexists( var_10 ) )
        {
            ...
            if ( !scripts\mp\utility\game::lpcfeaturegated() )
                playbattlechattersoundexpensive( 1, 1, var_11, undefined, var_10, var_12 );
            else if ( self issplitscreenplayer() )
                playbattlechattersoundsplitscreen( 1, 1, var_11, undefined, var_10, var_12 );
            else
                playbattlechattersound( 1, 1, var_11, undefined, var_10, var_12 );
        }
    }
...
playbattlechattersound( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
playbattlechattersoundexpensive( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    if ( !isdefined( var_5 ) )
        var_5 = [];
...
playbattlechattersoundsplitscreen( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = self getothersplitscreenplayer();
...
trysaylocalsound( var_0, var_1, var_2, var_3 )
{
    ...
    if ( gettime() > var_0.bctimequeued + level.bcinfo["max_wait_time"] + var_3 * 1000 )
    {
        var_0.bcinfoqueued = "none";
        var_0.bctimequeued = 0;
    }

    if ( comparesoundpriorities( var_1, var_0.bcinfoqueued ) )
    {
        var_0.bcinfoqueued = var_1;
        var_0.bctimequeued = gettime();
    }
    else
        return;
