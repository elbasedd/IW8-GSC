...
player_update_unresolved_collision( var_0, var_1 )
{
    ...
    if ( self.unresolved_collision_count >= var_2 )
    {
        if ( isdefined( var_0 ) )
        {
            ...
            {
                var_3 = isdefined( self.lastascenderusetime ) && gettime() - self.lastascenderusetime <= 250;

                if ( var_3 || var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() && !scripts\cp_mp\vehicles\vehicle::vehicle_docollisiondamagetoplayer( var_0, self ) )
                    var_0 unresolved_collision_nearest_node( self, 0, var_0 );
                else
                {
                    var_4 = player_should_be_killed_by_mover( var_0 );
                    var_0 unresolved_collision_nearest_node( self, var_4, var_0 );
                }
            }
        }
        else
        {
            var_4 = player_should_be_killed_by_mover( var_0 );
            unresolved_collision_nearest_node( self, var_4 );
        }
...
player_ignore_mover( var_0 )
{
    ...
    if ( isdefined( var_0.carriabletype ) )
        var_1 = 1;
...
unresolved_collision_nearest_node( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        if ( scripts\cp_mp\utility\game_utility::islargemap() )
        {
            ...
            else if ( isdefined( level.modeunresolvedcollision ) && [[ level.modeunresolvedcollision ]]( var_0, var_2 ) )
                return;
        }
        else
        {
...
handle_moving_platforms( var_0 )
{
    ...
    if ( isdefined( var_0.linkparent ) )
    {
        ...
        {
            if ( isdefined( var_0.linkoffset ) )
                self linkto( var_0.linkparent, "", var_0.linkoffset, var_0.angleoffset );
            else
