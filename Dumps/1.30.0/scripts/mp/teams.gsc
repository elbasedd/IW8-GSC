...
createoperatorcustomization()
{
    ...
    var_10.executionquipoverride = getoperatorexecutionquipoverride( var_8 );
    var_10.suit = var_3;
    var_10.rebuild = 0;

    if ( scripts\mp\utility\game::getgametype() == "br" )
    {
        var_11 = getoperatorbrinfilsmokesuffix( var_9 );

        if ( var_11 != "" )
            var_10.brinfilsmokesuffix = var_11;
    }

    var_12 = spawnstruct();
    var_12.apc = getvehicleplayercamo( "apc" );
    var_12.apcturret = getvehicleplayerturretcamo( "apc" );
    var_12.atv = getvehicleplayercamo( "atv" );
    var_12.cargo_truck = getvehicleplayercamo( "cargo_truck" );
    var_12.jeep = getvehicleplayercamo( "jeep" );
    var_12.little_bird = getvehicleplayercamo( "little_bird" );
    var_12.tac_rover = getvehicleplayercamo( "tac_rover" );
    var_12.tank_east = getvehicleplayercamo( "tank_east" );
    var_12.tank_eastturret = getvehicleplayerturretcamo( "tank_east" );
    var_12.tank_west = getvehicleplayercamo( "tank_west" );
    var_12.tank_westturret = getvehicleplayerturretcamo( "tank_west" );
    var_12.apc_horn = getvehicleplayerhorn( "apc", 4 );
    var_12.atv_horn = getvehicleplayerhorn( "atv", 6 );
    var_12.cargo_truck_horn = getvehicleplayerhorn( "cargo_truck", 8 );
    var_12.jeep_horn = getvehicleplayerhorn( "jeep", 10 );
    var_12.little_bird_horn = getvehicleplayerhorn( "little_bird", 12 );
    var_12.tac_rover_horn = getvehicleplayerhorn( "tac_rover", 14 );
    var_12.atv_trail = getvehicleplayertrail( "atv" );
    var_12.tac_rover_trail = getvehicleplayertrail( "tac_rover" );
    var_12.little_bird_trail = getvehicleplayertrail( "little_bird" );
    ...
    self.vehiclecustomization = var_12;
}
...
getoperatorcustomization()
{
    ...
    if ( isdefined( level.modegetforceoperatorcustomization ) )
        [var_0, var_1] = [[ level.modegetforceoperatorcustomization ]]( self, var_0, var_1 );
...
getoperatorexecutionquipoverride( var_0 )
{
    self.loadoutexecutionquipoverride = tablelookup( "mp_cp/executiontable.csv", 1, self.loadoutexecution, 19 );
    return self.loadoutexecutionquipoverride;
}
...
getoperatorbrinfilsmokesuffix( var_0 )
{
    var_1 = tablelookup( "operatorskins.csv", 0, var_0, 23 );
    return var_1;
}

getoperatorvalidforbots( var_0 )
{
...
getvehicleplayerhorn( var_0, var_1 )
{
    var_2 = 0;
...
initoperatorcustomization()
{
    ...
    for (;;)
    {
        ...
        var_5 = getoperatorvalidforbots( var_1 );
