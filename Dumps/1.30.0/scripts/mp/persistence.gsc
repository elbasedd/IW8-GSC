...
updateweaponbufferedstats( var_0 )
{
    ...
    if ( !scripts\mp\utility\weapon::ispickedupweapon( var_1 ) || istrue( level.canprocesspickedupweapon ) )
...
{
    if ( self.trackingweaponshots > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "shots", self.trackingweaponshots, var_1, var_2 );

    if ( self.trackingweaponkills > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "kills", self.trackingweaponkills, var_1, var_2 );

    if ( self.trackingweaponhits > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "hits", self.trackingweaponhits, var_1, var_2 );

    if ( self.trackingweaponheadshots > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "headshots", self.trackingweaponheadshots, var_1, var_2 );

    if ( self.trackingweapondeaths > 0 )
        scripts\common\utility::trycall( level.matchdata_logweaponstat, var_0, "deaths", self.trackingweapondeaths, var_1, var_2 );
}
