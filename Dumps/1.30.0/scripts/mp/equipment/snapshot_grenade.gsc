...
snapshot_grenade_watch_flight( var_0 )
{
    ...
    if ( istrue( var_1.touchedmovingplatform ) )
        var_1 thread entity_movingplatform_update();
    ...
    if ( var_8 > 0 )
    {
        ...
        if ( isdefined( var_1.lastmovingplatform ) )
        {
            var_5 = scripts\cp_mp\utility\train_utility::is_moving_platform_train( var_1.lastmovingplatform );

            if ( var_5 )
                var_4 linkto( var_1.lastmovingplatform );
        }
        ...
        var_1 childthread scripts\mp\utility\equipment::watch_flight_collision();
        var_1 scripts\engine\utility::waittill_any_timeout_1( var_11, "collision_with_platform" );
    }
    else
    {
        var_4.angles = var_9;
...
snapshot_grenade_detect()
{
    ...
    var_6 = agentsinsphere( var_1, 540 );
    ...
    foreach ( var_8 in var_5 )
    {
        ...
        snapshot_grenade_applysnapshot( var_8, var_0, var_3 );
    }
...
agentsinsphere( var_0, var_1 )
{
    var_2 = agentsnear( var_0, var_1 );
    var_3 = [];
    var_4 = var_1 * var_1;
