...
at_mine_use( var_0 )
{
    ...
    if ( isdefined( var_3 ) )
    {
        if ( isent( var_3 ) && is_train_ent( var_3 ) )
...
at_mine_plant( var_0 )
{
    ...
    if ( istrue( var_0.touchedmovingplatform ) )
        var_0 thread at_mine_movingplatform_update();
...
at_mine_movingplatform_update()
{
    ...
    for (;;)
    {
        var_1 = self.origin;
        wait( var_0 );
        self.attachedvelocity = 1 / var_0 * ( self.origin - var_1 );
    }
}

is_at_mine_moving( var_0 )
{
    return isdefined( var_0 ) && isdefined( var_0.attachedvelocity ) && length2dsquared( var_0.attachedvelocity ) > 0.01;
}
...
at_mine_watch_flight()
{
    ...
    if ( var_0 > 0 )
    {
        ...
        if ( is_at_mine_moving( self ) )
            var_2 = var_2 + self.attachedvelocity * var_0;
        ...
        if ( var_0 > 0 )
        {
            ...
            scripts\engine\utility::waittill_any_timeout_1( var_0, "collision_with_platform" );
