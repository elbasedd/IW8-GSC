...
supportbox_watch_flight( var_0 )
{
    self endon( "death" );
    self endon( "missile_stuck" );
    var_0 endon( "disconnect" );
    var_1 = scripts\engine\utility::waittill_any_timeout_1( 2, "touching_platform" );
...
{
    var_0 endon( "death" );
    var_0.timeoutvfxname = "vfx/iw8_mp/equipment/vfx_offhand_wm_supportbox_timeout.vfx";
    box_used_common_setup( var_0, "equip_supportBox", "super_ammo_drop", "hud_icon_equipment_support_box" );
...
{
    var_0 endon( "death" );
    var_0.timeoutvfxname = "vfx/iw8_mp/equipment/vfx_offhand_wm_armorbox_timeout.vfx";
    box_used_common_setup( var_0, "equip_armorBox", "super_armor_drop", "ui_mp_br_loot_icon_health_armor_box" );
...
supportbox_destroy( var_0 )
{
    ...
    thread supportbox_delete( var_3 );
    var_4 = undefined;
    var_5 = undefined;
...
supportbox_delete( var_0, var_1 )
{
    ...
    if ( isdefined( self.equipmentref ) && self.equipmentref == "equip_armorBox" )
        self.owner scripts\cp_mp\challenges::onfieldupgradeend( "super_armor_drop", self.usedcount );
    else
...
{
    self.headiconbox = scripts\cp_mp\entityheadicons::setheadicon_singleimage( [], var_0, 20, 1, 1000, 100, undefined, 1 );
...
supportbox_givexpforuse( var_0 )
{
    if ( isdefined( self.owner ) && !scripts\cp_mp\utility\player_utility::playersareenemies( self.owner, var_0 ) )
    {
        if ( self.owner != var_0 )
        {
            ...
            self.owner scripts\cp_mp\challenges::reportt9userevent( "t9_ch_global_resupply_teammates_for_operator_mission", 1 );
        }
