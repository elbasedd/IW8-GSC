...
ammobox_onplayerholduse( var_0 )
{
    ...
    if ( isdefined( level.onweapongiven ) )
        var_0 [[ level.onweapongiven ]]( var_2 );
...
{
    if ( istrue( var_1.isusingammobox ) )
        return;

    var_1.isusingammobox = 1;
    ammobox_tryuseinternal( var_0, var_1 );

    if ( isdefined( var_1 ) )
        var_1.isusingammobox = undefined;
}
