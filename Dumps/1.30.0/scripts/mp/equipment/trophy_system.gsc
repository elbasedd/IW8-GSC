...
trophy_used( var_0 )
{
    ...
    var_0 thread trophy_watch_flight( self );
...
trophy_deploy()
{
    ...
    thread trophy_watchprotection( 45, 105625, ::trophy_shouldprotectionloopcontinue, ::trophy_protectionsuccessful );
...
trophy_protectionsuccessful( var_0 )
{
    ...
    trophy_destroytrophytarget( var_0 );
