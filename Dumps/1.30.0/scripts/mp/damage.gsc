...
callback_playerdamage_internal( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    if ( istrue( var_2.onlytakedamagefrombrgas ) && isdefined( var_6 ) )
    {
        if ( !is_br_gas_damage( var_6.basename ) )
            return;
    }
    ...
    if ( isspreadweapon( var_6 ) && scripts\mp\utility\damage::validshotcheck( var_5, var_1 ) )
    {
    ...
    if ( isscriptedagentdamage( var_1 ) )
        var_3 = scriptedagentmodifieddamage( var_1, var_3, var_5 );
...
postplayerdamaged( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14, var_15, var_16 )
{
    ...
    else if ( isdefined( var_4 ) && var_4 & level.idflags_penetration && !( var_4 & level.idflags_penetration_player_only ) )
    {
...
meleestagger( var_0 )
{
    ...
    if ( isdefined( level.gamemodeoverridemeleeviewkickscale ) )
        self setviewkickscale( scripts\engine\utility::ter_op( var_0 scripts\mp\utility\perk::_hasperk( "specialty_hardmelee" ), level.gamemodeoverridemeleeviewkickscale * 2, level.gamemodeoverridemeleeviewkickscale ) );
    else
...
weaponignoresbrarmor( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( is_br_gas_damage( var_7 ) )
        return 1;

    if ( isdefined( level.brgametype ) && istrue( level.brgametype.zombieignorearmor ) && isdefined( var_7 ) && var_7 == "iw8_fists_mp_zmb" )
        return 1;
...
cac_modified_damage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11 )
{
    ...
    if ( scripts\engine\utility::isbulletdamage( var_3 ) )
    {
        ...
        if ( scripts\mp\utility\weapon::isminigunweapon( var_17 ) && scripts\mp\utility\game::getgametype() == "br" )
            var_2 = var_2 * scripts\mp\gametypes\br_jugg_common.gsc::getminigundamagescale();
        ...
        var_23 = istrue( var_1.lastcrossbowhadstoppingpower ) && scripts\mp\utility\weapon::getweaponrootname( var_4 ) == "iw8_sn_crossbow";
        ...
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
            var_2 = modify_juggernaut_damage( var_4, var_2, var_25, 0, var_1 );
    ...
    else if ( var_3 == "MOD_FIRE" )
    {
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
        {
            if ( isdefined( var_4.basename ) && var_4.basename == "thermite_ap_mp" || var_4.basename == "thermite_bolt_mp" )
                var_2 = modify_juggernaut_damage( var_4, var_2, 0, 1, var_1 );
        }
    ...
    var_36 = var_7 == "shield" && var_3 != "MOD_GRENADE_SPLASH";
    ...
    if ( var_15 && !istrue( var_35 ) && !istrue( var_0.inlaststand ) && !var_36 )
    {
        ...
        if ( isplayer( var_1 ) )
        {
            ...
            if ( shouldrecorddamagestats( self ) )
                ...
                var_1 [[ level.onattackerdamagenottracked ]]( var_38 );
        }
    }
    ...
    if ( istrue( var_0.inlaststand ) && getdvarfloat( "scr_player_lastStandHealthScalar", 0 ) > 0 )
    {
        ...
        if ( isdefined( level.modeshouldlaststanddamagescale ) )
        {
            var_43 = scripts\cp_mp\utility\damage_utility::packdamagedata( var_1, var_0, var_2, var_4, var_3, var_8 );
            var_42 = self [[ level.modeshouldlaststanddamagescale ]]( var_43 );
        }
...
modify_juggernaut_damage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_4 ) && var_4 scripts\mp\utility\killstreak::isjuggernaut() && scripts\mp\utility\game::getgametype() == "br" )
        var_6 = scripts\mp\gametypes\br_jugg_common.gsc::getjuggdamagescale();
    ...
    switch ( var_5 )
    {
        ...
        case "mg":
        case "rifle":
            if ( scripts\mp\utility\weapon::isminigunweapon( var_0.basename ) && scripts\mp\utility\game::getgametype() == "br" )
                var_1 = min( 50, var_1 );
            else
                var_1 = min( 20, var_1 );
...
isaalpha12explosivedamage( var_0, var_1 )
{
...
applystoppingpower( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( var_6 == 2 )
    {
        if ( stoppingpowercanonehitkill( var_0, var_1, var_2, var_3 ) )
            return var_5;
        else
            return 0.9 * var_5;
    }
...
stoppingpowercanonehitkill( var_0, var_1, var_2, var_3 )
{
...
killstreakdamagefilter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( level.gamemodespawnprotectedcallback ) )
        var_5 = [[ level.gamemodespawnprotectedcallback ]]( var_0, var_1, var_2, var_3, var_4 );
...
modifyscriptedballistics( var_0, var_1, var_2, var_3, var_4 )
{
    if ( isdefined( var_1 ) )
    {
        if ( isaalpha12explosivedamage( var_0, var_4 ) )
        {
            if ( var_2.health > 0 && var_3 >= var_2.health )
                var_3 = var_2.health - 1;
        }
        else if ( isdefined( var_0.splashweaponignore ) )
        {
            if ( !isdefined( var_1.splashignorevictimids ) )
                var_1.splashignorevictimids = [];

            var_5 = "" + var_2 getentitynumber();
            var_6 = gettime();
            var_1.splashignorevictimids[var_5] = spawnstruct();
            var_1.splashignorevictimids[var_5].time = var_6;
            var_1.splashignorevictimids[var_5].ignoreweaponname = var_0.splashweaponignore.basename;
        }
        else if ( isdefined( var_1.splashignorevictimids ) )
        {
            var_6 = gettime();

            foreach ( var_9, var_8 in var_1.splashignorevictimids )
            {
                if ( var_6 != var_8.time )
                    var_1.splashignorevictimids = scripts\engine\utility::array_remove_key( var_1.splashignorevictimids, var_9 );
            }

            var_9 = "" + var_2 getentitynumber();

            if ( scripts\engine\utility::array_contains_key( var_1.splashignorevictimids, var_9 ) && var_1.splashignorevictimids[var_9].ignoreweaponname == var_0.basename )
            {
                var_3 = 0;
                var_1.splashignorevictimids = scripts\engine\utility::array_remove_key( var_1.splashignorevictimids, var_9 );
            }

            if ( var_1.splashignorevictimids.size == 0 )
                var_1.splashignorevictimids = undefined;
        }
    }
...
modifyfalldamage( var_0, var_1, var_2 )
{
    var_3 = var_1;
    ...
    {
        if ( var_0 scripts\mp\utility\killstreak::isjuggernaut() )
            var_3 = var_0 scripts\mp\juggernaut::jugg_modifyfalldamage();
    }

    return var_3;
}

modifyvehicletoplayerdamage( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_3;
    ...
    if ( isdefined( var_0 ) && var_0 scripts\cp_mp\vehicles\vehicle::isvehicle() )
    {
        if ( var_2 scripts\mp\utility\killstreak::isjuggernaut() )
            var_5 = var_2 scripts\mp\juggernaut::jugg_modifyvehicletoplayerdamage( var_3, var_4 );
    }

    return var_5;
}

modifyvehicleoccupantdamage( var_0, var_1 )
{
    var_2 = var_1;
    var_3 = var_0 scripts\cp_mp\utility\player_utility::getvehicle();

    if ( isdefined( var_3 ) )
        var_2 = scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_modifyoccupantdamage( var_3, var_0, var_1 );

    return var_2;
}

modifycrushdamage( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = var_3;
    ...
    if ( isdefined( var_4 ) && var_4 == "MOD_CRUSH" )
    {
        if ( isdefined( var_0 ) && isdefined( var_1 ) && var_0 == var_1 && var_1 scripts\mp\utility\killstreak::isjuggernaut() && var_2 scripts\mp\utility\killstreak::isjuggernaut() )
            var_5 = var_2 scripts\mp\juggernaut::jugg_modifyherodroptoplayerdamage( var_3 );
    }
...
{
    var_3 = modifyakimboburstrenettidamagehack( var_3, var_6 );
    var_3 = mlgmodifyheadshotdamage( var_1, var_3, var_5, var_6, var_9 );
    var_3 = modifyfalldamage( var_2, var_3, var_5 );
    var_3 = modifyvehicletoplayerdamage( var_0, var_1, var_2, var_3, var_5 );
    var_3 = modifyvehicleoccupantdamage( var_2, var_3 );
    var_3 = modifycrushdamage( var_0, var_1, var_2, var_3, var_5 );
    var_3 = modifyscriptedballistics( var_6, var_1, var_2, var_3, var_5 );
...
filterdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    if ( scripts\cp_mp\vehicles\vehicle::vehicle_playershouldignorecollisiondamage( var_0, var_2, var_4, var_5 ) )
...
handledamagefeedback( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    if ( isdefined( var_12 ) && var_12 != var_2 && var_3 + var_8 + var_9 > 0 && ( !isdefined( var_6 ) || var_6 != "shield" ) )
    {
        ...
        var_18 = !isspreadweapon( var_5 ) && scripts\mp\utility\damage::isheadshot( var_6, var_4, var_1 );
        var_19 = 1;
...
lethalequipmentdamagemod( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    ...
    var_1 scripts\common\utility::trycall( level.matchdata_logweaponstat, scripts\mp\utility\weapon::getweaponrootname( var_6 ), "damage", min( var_2.health, var_3 ), -1, var_6 );
    return var_3;
}
...
playerkilled_fixupattacker( var_0 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( isdefined( var_2 ) )
        {
            ...
            if ( istrue( var_0.victim.squadwiped ) && isdefined( var_0.victim.attackerdata[var_2.guid].inflictor ) )
...
playerkilled_sharedlogic_early( var_0 )
{
    ...
    if ( scripts\mp\utility\weapon::iskillstreakvehicleinflictor( var_3 ) && isdefined( var_4 ) && var_4.basename == "none" )
    {
    ...
    var_2 scripts\mp\equipment\throwing_knife_mp::throwingknife_clear_fx();
    ...
    if ( var_1 != var_2 )
    {
        if ( isdefined( var_1.petwatch ) )
        {
            ...
            else if ( var_2 playerkilled_washitbyvehicle( var_6, var_3 ) )
                var_1 scripts\cp_mp\pet_watch::addvehicularmanslaughtercharge();
        }
        else if ( isdefined( var_2.petwatchgo ) )
            var_2 scripts\cp_mp\pet_watch_go.gsc::onplayerkilled( var_1 );
    }
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "getGameType" ) )
    {
        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "getGameType" ) ]]() == "br" )
        {
            ...
            if ( istrue( level.br_prematchstarted ) && !scripts\mp\gametypes\br_public.gsc::isplayeringulag() )
                scripts\mp\gametypes\br_analytics.gsc::branalytics_inventory_snapshot( self, "player_death" );
        }
    }
    ...
    if ( isdefined( var_0.idflags ) && var_0.idflags & level.idflags_penetration && !( var_0.idflags & level.idflags_penetration_player_only ) )
    {
    ...
    if ( isdefined( var_0.inflictor ) && ( istrue( var_0.inflictor.iswztrain ) || istrue( var_0.inflictor.iswzsubwaytrain ) ) )
        var_17 = "MOD_CRUSH";
    ...
    if ( level.gametype == "br" )
    {
        ...
        if ( var_18.size > 0 )
        {
            var_21 = scripts\engine\utility::ter_op( scripts\cp_mp\vehicles\vehicle::vehicle_checkplayerkilledbycollision( var_0 ), "MOD_EXPLOSIVE", var_17 );

            if ( isdefined( level.brgametype ) && isdefined( level.brgametype.name ) && level.brgametype.name == "zxp" )
                var_21 = scripts\mp\gametypes\br_gametype_zxp.gsc::meansofdeathoverride( var_0 );
...
handleinlaststanddeath( var_0 )
{
    ...
    {
        thread scripts\cp_mp\challenges::onplayerkilled( self.laststandattacker, self.laststandattacker, 0, var_0.damageflags, self.laststandmeansofdeath, self.laststandweaponobj, var_0.hitloc, self.laststandattackermodifiers1, self.laststandattackermodifiers2 );
...
handlenormaldeath( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !istrue( level.disablestattracking ) )
    {
        ...
        var_5 thread scripts\cp_mp\challenges::onplayerkilled( var_2, var_1, var_7.damage, var_7.damageflags, var_4, var_3, var_7.hitloc, var_9, var_10 );
        ...
        if ( isdefined( var_2 ) && istrue( var_2.isequipment ) )
        {
            switch ( var_2.equipmentref )
            {
                ...
                case "equip_throwing_knife":
                    ...
                    var_1 scripts\cp_mp\pet_watch::addthrowingknifecharge();
                    break;
                case "equip_c4":
    ...
    if ( !istrue( var_8 ) && !isfriendlyfire( var_5, var_1 ) )
    {
        if ( !istrue( level.ignorescoring ) )
        {
            var_11 playerincrementscoreboardkills();
    ...
    if ( !istrue( var_11.pers["ignoreWeaponMatchBonus"] ) && ( scripts\mp\utility\weapon::iscacprimaryweapon( var_3 ) || scripts\mp\utility\weapon::iscacsecondaryweapon( var_3 ) ) )
    {
        ...
        if ( var_11.pers["weaponMatchBonusKills"] > scripts\mp\weaponrank::getgametypekillspermatchmaximum() )
        {
        ...
        else
        {
            ...
            if ( !var_13 )
            {
                ...
                var_15.orderindex = var_11.pers["killsPerWeapon"].size;
    ...
    if ( isdefined( self.attackers ) )
    {
        foreach ( var_24 in self.attackers )
        {
            ...
            if ( isdefined( self.laststandattacker ) && self.laststandattacker == var_24 )
                continue;
        ...
        if ( isdefined( var_1.team ) && isdefined( level.uavmodels ) && isdefined( level.uavmodels[var_1.team] ) && level.uavmodels[var_1.team].size > 0 )
        {
            ...
            foreach ( var_33 in level.uavmodels[var_1.team] )
            {
                if ( isdefined( var_33 ) && isdefined( var_33.owner ) && var_33.owner != var_1 && !scripts\engine\utility::array_contains( var_31, var_33.uavtype ) )
                {
                    ...
                    if ( !isdefined( var_33.assistsgiven ) )
                        var_33.assistsgiven = 0;

                    var_36 = scripts\engine\utility::ter_op( var_33.uavtype == "directional_uav", 15, 10 );

                    if ( var_33.assistsgiven < var_36 )
                        ...
                        var_33.owner thread scripts\mp\utility\points::givexpwithtext( var_34, var_35 );
                    ...
                    scripts\cp_mp\challenges::processuavassist( var_33.owner, var_33.uavtype );
                ...
                if ( var_39.helperdronetype == "scrambler_drone_guard" )
                {
                    if ( var_1 != var_39.owner )
                    {
                        ...
                        if ( var_39.assistsgiven < 10 )
                            ...
                            var_39.owner thread scripts\mp\utility\points::givexpwithtext( var_34 );
                    ...
                    if ( isdefined( var_1.team ) && isdefined( var_39.owner.team ) && var_1.team == var_39.owner.team )
                    {
                        foreach ( var_24 in scripts\mp\utility\teams::getteamdata( var_1.team, "players" ) )
                            var_24 scripts\cp_mp\challenges::reportt9userevent( "t9_ch_global_kill_scrambled_enemies_s1", 1 );
                    }
                }
            }
        }

        scripts\mp\equipment\binoculars::binoculars_giveassistpoints( var_1, self );
        ...
        if ( isdefined( var_1.team ) && isdefined( level.activewpzones ) && level.activewpzones.size > 0 )
        {
            ...
            if ( var_1.team == var_45 && var_1 != var_44 )
            {
                if ( istrue( var_5.wpdisorient ) || istrue( var_5.wpburning ) )
                {
                    ...
                    if ( !isdefined( var_43.assistsgiven ) )
                        var_43.assistsgiven = 0;

                    if ( var_43.assistsgiven < 15 )
                        var_44 thread scripts\mp\utility\points::giveunifiedpoints( var_34, undefined, undefined, undefined, undefined, undefined, var_43.streakinfo );
                    else
                        var_44 thread scripts\mp\utility\points::givexpwithtext( var_34 );
...
resetplayervariables()
{
    ...
    self.currentshotgunkillcountthislife = 0;
...
addattacker( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    var_0.attackerdata[var_1.guid].modifiers1 = var_1 scripts\mp\events::getassistdamagemodifiers1( 0, var_0, var_3, var_9, var_2 );
    var_0.attackerdata[var_1.guid].modifiers2 = var_1 scripts\mp\events::getassistdamagemodifiers2( 0, var_0, var_3, var_9, var_2 );
...
addattackerkillstreak( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    ...
    var_0.attackerdata[var_2.guid].modifiers1 = 0;
    var_0.attackerdata[var_2.guid].modifiers2 = 0;
...
finishplayerdamagewrapper( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12 )
{
    ...
    if ( isdefined( var_1 ) && isplayer( var_1 ) )
    {
        if ( shouldrecorddamagestats( self ) )
        {
            ...
            if ( scripts\mp\codcasterclientmatchdata::shouldlogcodcasterclientmatchdata() )
            {
                if ( isplayer( var_1 ) )
                {
                    var_1 scripts\common\utility::trycall( level.matchdata_logweaponstat, scripts\mp\utility\weapon::getweaponrootname( var_5 ), "damage", min( self.health, var_2 ), -1, var_5 );
    ...
    {
        if ( scripts\mp\utility\killstreak::getkillstreaknamefromweapon( var_5 ) == "precision_airstrike" && istrue( level.isx1ops ) )
            return;
    }
...
callback_playerlaststand( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    if ( !istrue( var_9 ) )
    {
        ...
        if ( isdefined( level.modelaststandallowed ) && !self [[ level.modelaststandallowed ]]( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 ) )
            return 0;
    }
    ...
    if ( isdefined( var_1 ) && var_1.classname != "worldspawn" )
    {
        ...
        if ( isplayer( var_1 ) && var_1 != self )
        {
            ...
            var_1 thread scripts\mp\events::assignkilledplayermodifiers( var_10, self, var_4, var_3, var_0, var_11 );
            self.laststandattackermodifiers1 = var_1.modifiers["mask"];
            self.laststandattackermodifiers2 = var_1.modifiers["mask2"];
        }
    ...
    scripts\common\utility::allow_ascender_use( 0 );

    if ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" )
        scripts\mp\gametypes\br_plunder.gsc::plunder_allowallrepositoryuseforplayer( self, 0, 1 );
...
damageshellshockandrumble( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( !isai( self ) && scripts\common\utility::getdamagetype( var_2 ) != "bullet" )
    {
        ...
        if ( isdefined( var_0 ) && istrue( var_0.iswztrain ) )
        {
            self playsound( "train_veh_impact_body" );

            if ( isdefined( level.wztrain_info.train_array ) )
            {
                var_6 = level.wztrain_info.train_array[0].linked_model;
...
gamemodemodifyplayerdamage( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10 )
{
    if ( isdefined( var_2 ) && isplayer( var_2 ) && isalive( var_2 ) )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "infect" && var_4 == "MOD_MELEE" && isdefined( var_5 ) )
        {
...
monitordamageoneshot( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9, var_10, var_11, var_12, var_13, var_14 )
{
    ...
    if ( !istrue( self.skipignoredamage ) && scripts\mp\utility\damage::non_player_should_ignore_damage( var_1, var_9, var_10, var_4 ) )
        return 1;
...
{
    if ( scripts\mp\weapons::ismtx8bitdeath( var_3 ) )
        enqueuecorpsetablefunc( "8bitDeath", scripts\mp\weapons::mtx8bitdeath );
    else if ( scripts\mp\weapons::ismtxtesladeath( var_3 ) )
        enqueuecorpsetablefunc( "teslaDeath", scripts\mp\weapons::mtxtesladeath );
}
...
logfriendlyfire( var_0, var_1, var_2, var_3 )
{
    ...
    var_1 scripts\common\utility::trycall( level.matchdata_logweaponstat, scripts\mp\utility\weapon::getweaponrootname( var_1.currentweapon ), "friendly_fire_damage", int( min( var_2, var_0.health ) ), -1, var_1.currentweapon );
...
scriptedagentmodifieddamage( var_0, var_1, var_2 )
{
