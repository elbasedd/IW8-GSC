...
vehicleindangertracking( var_0 )
{
    ...
    {
        var_2 = gettime();
        var_3 = istrue( var_0.burningdown );
        var_4 = scripts\cp_mp\utility\weapon_utility::islockedonto( var_0 );
        var_5 = scripts\cp_mp\vehicles\vehicle_occupancy::vehicle_occupancy_canspawninto( var_0 );
...
spawnselectionthink( var_0 )
{
    ...
    if ( istrue( level.showteamtanks ) )
        thread scripts\mp\gametypes\arm.gsc::vehicle_showteamtanks();

    if ( istrue( level.showteamlittlebirds ) )
        thread scripts\mp\gametypes\arm.gsc::vehicle_showvalidlittlebirds();
