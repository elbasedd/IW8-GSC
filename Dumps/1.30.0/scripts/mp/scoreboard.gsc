...
setplayerscoreboardinfo()
{
    ...
    if ( var_0 < 200 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_12 = scripts\mp\gametypes\br.gsc::calculateclientmatchdataextrainfopayload( self );
            ...
            if ( scripts\mp\utility\game::getsubgametype() == "dmz" || scripts\mp\utility\game::getsubgametype() == "risk" )
            {
                ...
                var_17 = scripts\mp\gametypes\br_gametype_dmz.gsc::packclientmatchdata();
            ...
            else if ( scripts\mp\utility\game::getsubgametype() == "kingslayer" )
            {
                ...
                var_16 = var_15[self.team];
                setclientmatchdata( "players", self.clientmatchdataid, "placement", var_16 );
                var_17 = scripts\mp\gametypes\br_gametype_kingslayer.gsc::packclientmatchdata();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
                var_18 = 0;
            ...
            else if ( scripts\mp\utility\game::getsubgametype() == "rebirth" )
            {
                ...
                var_17 = scripts\mp\gametypes\br_gametype_rebirth.gsc::brrebirth_packclientmatchdata();
                setclientmatchdata( "players", self.clientmatchdataid, "extrascore4", var_17 );
            }
