...
addspecialistbonus()
{
    ...
    {
        var_2 = scripts\engine\utility::ter_op( scripts\mp\utility\game::getgametype() == "br", istrue( var_1.specialistbr ), istrue( var_1.specialist ) );
