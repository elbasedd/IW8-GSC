...
setviewkickoverride()
{
    ...
    self.overrideviewkickscaleromeo700 = 0.08;
...
unsetviewkickoverride()
{
    ...
    self.overrideviewkickscaleromeo700 = undefined;
...
setovercharge()
{
    thread scripts\cp_mp\utility\omnvar_utility::setclientomnvarsafe( "ui_overcharge", 1 );
}

unsetovercharge()
{
    thread scripts\cp_mp\utility\omnvar_utility::setclientomnvarsafe( "ui_overcharge", 0 );
}
...
setthrowingknifemelee()
{
    ...
    if ( self.throwingknifemelee == "iw8_throwingknife_fire_melee_mp" )
        thread watchthrowingkifefireswipe();
    else if ( self.throwingknifemelee == "iw8_throwingknife_electric_melee_mp" )
        thread watchthrowingkifeelectricswipe();
}
...
unsetthrowingknifemelee()
{
    ...
    if ( isdefined( self.throwingknifemelee ) && self.throwingknifemelee == "iw8_throwingknife_fire_melee_mp" )
        killthrowingknifefire();
    else if ( isdefined( self.throwingknifemelee ) && self.throwingknifemelee == "iw8_throwingknife_electric_melee_mp" )
        killthrowingknifeelectric();
}
...
watchthrowingkifeelectricswipe()
{
    self endon( "death_or_disconnect" );
    self endon( "specialty_equip_throwingKnife_end" );
...
rechargeequipment_updateslot( var_0, var_1 )
{
    ...
    if ( isdefined( level.gamemodeoverriderestockrechargeperupdate ) )
        var_7 = level.gamemodeoverriderestockrechargeperupdate;
    else
...
updateteambettermissionrewardsui( var_0 )
{
    ...
    var_1 = scripts\mp\gametypes\br_quest_util.gsc::getquestperkbonus( var_0 );
    ...
    if ( var_3 != 0 )
        scripts\mp\gametypes\br_quest_util.gsc::addquestrewardtier( var_0, var_3 );
