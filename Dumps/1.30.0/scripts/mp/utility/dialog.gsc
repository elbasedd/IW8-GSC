...
leaderdialogonplayer_internal( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.gametype == "br" )
        var_5 = scripts\mp\gametypes\br_public.gsc::brgetoperatorteam( self );
    ...
    if ( isdefined( var_5 ) && scripts\mp\utility\teams::isgameplayteam( var_5 ) )
    {
        ...
        if ( level.gametype == "br" && isbronlykillstreakdialog( var_0 ) )
            var_7 = "dx_bra_";
...
isbronlykillstreakdialog( var_0 )
{
    var_1 = 0;

    if ( issubstr( var_0, "radar_drone_recon" ) || issubstr( var_0, "circle_peek" ) )
        var_1 = 1;
...
playkillstreakusedialog( var_0 )
{
    ...
    if ( level.gametype == "br" )
        var_3 = scripts\mp\gametypes\br_public.gsc::brgetoperatorteam( self );
