...
giveunifiedpoints( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7 )
{
    ...
    var_16 = isnokillstreakprogressweapon( var_1 );
    var_17 = scripts\mp\utility\perk::_hasperk( "specialty_killstreak_to_scorestreak" );
    var_18 = !istrue( level.killstreakconfirmed );
    ...
    if ( isdefined( level.onpointsgained ) )
        [[ level.onpointsgained ]]( self, var_9, var_0, var_7 );
