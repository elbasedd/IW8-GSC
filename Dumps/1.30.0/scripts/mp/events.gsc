...
init()
{
    ...
    if ( scripts\mp\utility\game::getgametype() != "br" )
        initheadshotlongshotmaskoffsetsmap();
}
...
onplayerconnect()
{
    for (;;)
    {
        ...
        var_0.objectiveachievementkillcount = 0;
...
attackerisinflictor( var_0, var_1, var_2, var_3 )
{
    var_4 = 1;
    ...
    if ( isdefined( var_1 ) )
    {
        ...
        else if ( attackerisinflictorforradiusexplosiveweapon( var_2, var_1, var_3 ) )
        {
...
attackerisinflictorforradiusexplosiveweapon( var_0, var_1, var_2 )
{
    var_3 = 0;
...
assignkilledplayermodifiers( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    self.modifiers = [];
    ...
    {
        var_10 = attackerisinflictor( self, var_4, var_2, var_3 );
        ...
        {
            if ( var_7 != "other" && var_7 != "weapon_projectile" && var_3 != "MOD_MELEE" && var_6 == var_1.attackerdata[self.guid].firsttimedamaged )
            {
        ...
        if ( var_3 == "MOD_HEAD_SHOT" || isxmike109explosiveheadshot( var_2, var_5 ) || isaalpha12explosiveheadshot( var_2, var_5 ) )
        {
        ...
        if ( level.teambased && var_6 - var_1.lastkilltime < 1500 )
        {
        ...
        if ( var_10 )
        {
            ...
            switch ( var_24 )
            {
                ...
                case "longshot":
                    ...
                    self setclientomnvar( "ui_longshot_special", islongshotspecial( var_11, var_1, var_2 ) );
                    break;
                case "very_longshot":
                    self.modifiers["longshot"] = 1;
                    self.modifiers["mask"] = self.modifiers["mask"] | 262144;
            ...
            if ( scripts\mp\class::isweaponsilenced( var_2 ) )
            {
            ...
            if ( isdefined( var_5.damageflags ) && var_5.damageflags & level.idflags_penetration && !( var_5.damageflags & level.idflags_penetration_player_only ) )
            {
                self.modifiers["coverkill"] = 1;
                self.modifiers["mask2"] = self.modifiers["mask2"] | 262144;
            }

            if ( scripts\mp\equipment\gas_grenade::gas_isvictiminattackersgas( self, var_1 ) )
            {
                self.modifiers["gasimpairedkill"] = 1;
                self.modifiers["mask2"] = self.modifiers["mask2"] | 16777216;
            }

            if ( scripts\mp\gametypes\br_public.gsc::isplayermostwanted( var_1 ) )
            {
                self.modifiers["victimmostwanted"] = 1;
        ...
        if ( isdefined( self.tookweaponfrom[var_8] ) && self.tookweaponfrom[var_8].team != self.team )
        {
        ...
        if ( scripts\mp\utility\player::isinlaststand( var_1 ) || istrue( var_5.brvictiminlaststand ) )
        {
            ...
            if ( var_4.equipmentref == "equip_c4" || var_4.equipmentref == "equip_claymore" )
            {
                ...
                if ( isdefined( var_42 ) && isdefined( var_42.helperdronetype ) && var_42.helperdronetype == "radar_drone_recon" )
                {
                    ...
                    if ( level.challengesallowed && isdefined( var_42.owner ) )
                        self.recondroneteammate = var_42.owner;
                }
    ...
    if ( scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) || scripts\mp\utility\weapon::iskillstreakvehicleinflictor( var_4 ) )
    ...
    if ( scripts\mp\utility\game::getgametype() != "br" )
    {
        if ( self.modifiers["mask"] & 1048576 && self.modifiers["mask"] & 262144 )
            checkheadshotlongshotweaponsachievement( var_2 );
    }

    if ( var_7 == "other" )
        checklethalequipmentachievement( var_2 );
}

getassistdamagemodifiers1( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
    return var_5;
}

getassistdamagemodifiers2( var_0, var_1, var_2, var_3, var_4 )
{
    var_5 = 0;
...
killedplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( isdefined( var_2.parentweapon ) )
        var_2 = var_2.parentweapon;
    ...
    thread checkfinalkillachievements( var_1 );
    var_7 = var_1.guid;
    var_8 = self.guid;
    ...
    thread updatekillsformasterychallenges( var_3, var_4, var_1 );
    ...
    if ( !scripts\mp\utility\weapon::iskillstreakweapon( var_2.basename ) && !scripts\mp\utility\perk::_hasperk( "specialty_explosivebullets" ) )
    {
        ...
        var_12 = attackerisinflictor( self, var_4, var_2, var_3 );
        ...
        if ( scripts\mp\utility\game::getgametypenumlives() >= 1 )
        {
            ...
            var_27 = scripts\mp\utility\game::trygetlastpotentiallivingplayer();
        ...
        if ( isdefined( var_2 ) && isdefined( var_2.streakinfo ) )
        {
            ...
            if ( isdefined( var_2.streakinfo.streakname ) )
            {
                ...
                if ( isdefined( var_2.streakinfo.kills ) )
                {
                    ...
                    if ( !istrue( var_2.streakinfo.multikillchallengeawarded ) && var_2.streakinfo.kills > 1 )
                    {
                        scripts\cp_mp\challenges::reportt9userevent( "t9_ch_global_scorestreak_kill_two_or_more_s1", 1 );
                        var_2.streakinfo.multikillchallengeawarded = 1;
                    }
                }
...
islongshotspecial( var_0, var_1, var_2 )
{
...
isdetected( var_0, var_1 )
{
    var_2 = isdefined( var_1.lastsnapshotgrenadetime ) && var_1.lastsnapshotgrenadetime + scripts\mp\equipment\snapshot_grenade::getmarkerduration() > gettime();
    var_3 = isdefined( var_0.radarstrength ) && var_0.radarstrength > 3 && !var_1 scripts\mp\utility\perk::_hasperk( "specialty_br_ghost" );
    var_4 = istrue( var_1.islivepinged );
...
updaterecentkills( var_0, var_1, var_2, var_3 )
{
    ...
    if ( !isdefined( self.recentkillsperweaponname ) )
        self.recentkillsperweaponname = [];
    ...
    if ( !isdefined( self.recentkillsperweaponname[var_2.basename] ) )
        self.recentkillsperweaponname[var_2.basename] = 1;
    else
        self.recentkillsperweaponname[var_2.basename]++;
    ...
    self.recentkillsperweaponname = undefined;
    self.multikillchallengeawarded = 0;
}

updatekillsformasterychallenges( var_0, var_1, var_2 )
{
    if ( scripts\mp\utility\game::getgametype() != "br" )
        return;
    ...
    var_3.victim = var_2;
    var_3.maderecentkill = 1;
    scripts\mp\gametypes\br_challenges.gsc::challengeevaluator( "br_mastery_travelogue", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::challengeevaluator( "br_mastery_c4VehicleMultKill", var_3 );
    scripts\mp\gametypes\br_challenges.gsc::challengeevaluator( "br_mastery_ghostRideWhip", var_3 );
}
...
revivedplayer( var_0, var_1 )
{
    ...
    var_0 scripts\cp_mp\challenges::reportt9userevent( "t9_ch_global_revived_teammate_for_operator_mission", 1 );
...
isaalpha12explosiveheadshot( var_0, var_1 )
{
...
checklethalequipmentachievement( var_0 )
{
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.lethal_equipmentmaskoffsets[var_1] ) )
        return;

    if ( self.pers["lethalEquipmentKillMask"] & level.lethal_equipmentmaskoffsets[var_1] )
        return;
    else
        self.pers["lethalEquipmentKillMask"] = self.pers["lethalEquipmentKillMask"] | level.lethal_equipmentmaskoffsets[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.lethal_equipmentmaskoffsets )
    {
...
initheadshotlongshotmaskoffsetsmap()
{
    level.headshotlongshotmaskoffsets = [];
    var_0 = [ "weapon_pistol", "weapon_smg", "weapon_assault", "weapon_dmr", "weapon_sniper", "weapon_shotgun", "weapon_lmg", "weapon_tactical" ];
    var_1 = 0;

    foreach ( var_3 in var_0 )
    {
        level.headshotlongshotmaskoffsets[var_3] = 1 << var_1;
        var_1++;
    }
}

checkheadshotlongshotweaponsachievement( var_0 )
{
    if ( !level.challengesallowed )
        return;
    ...
    if ( !isdefined( var_1 ) || !isdefined( level.headshotlongshotmaskoffsets[var_1] ) )
        return;

    if ( self.pers["headshotLongshotMask"] & level.headshotlongshotmaskoffsets[var_1] )
        return;
    else
        self.pers["headshotLongshotMask"] = self.pers["headshotLongshotMask"] | level.headshotlongshotmaskoffsets[var_1];

    var_2 = 0;

    foreach ( var_5, var_4 in level.headshotlongshotmaskoffsets )
    {
...
incrementobjectiveachievementkill()
{
    ...
    if ( self.objectiveachievementkillcount >= var_0 )
    {
...
checkfinalkillachievements( var_0 )
{
    ...
    if ( isplayer( var_0 ) && isdefined( self.recondroneteammate ) )
    {
    ...
    if ( level.gameended )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_2 = spawnstruct();
            var_2.player = self;
            scripts\mp\gametypes\br_challenges.gsc::challengeevaluator( "br_mastery_roundKillExecute", var_2 );
        }
    }
