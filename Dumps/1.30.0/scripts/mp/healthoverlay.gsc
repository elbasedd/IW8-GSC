...
healhregenthink( var_0 )
{
    ...
    if ( var_2 < 0.55 && !scripts\mp\utility\player::isusingremote() && !istrue( self.ignoredeathsdoor ) )
        onenterdeathsdoor();
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.regenhealthaddfunc ) )
            var_7 = [[ level.regenhealthaddfunc ]]( var_7 );
    ...
    if ( var_6 )
    {
        ...
        scripts\cp_mp\challenges::reportt9userevent( "t9_ch_global_stim_shot_health_recovery_for_operator_mission", var_10 );
...
waitforhealthregendelay()
{
    ...
    while ( self.currentregendelay - self.regendelayreduction > 0 )
    {
        ...
        if ( isdefined( level.regendelayspeedfunc ) )
            var_5 = [[ level.regendelayspeedfunc ]]( var_5 );
