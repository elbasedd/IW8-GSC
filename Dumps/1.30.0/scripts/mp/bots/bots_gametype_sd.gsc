...
atk_bomber_update()
{
    ...
    else
    {
        ...
        {
            self botsetpathingstyle( "scripted" );
            var_11 = scripts\mp\bots\bots_gametype_common.gsc::get_bombzone_node_to_plant_on( var_10, 1 );
        ...
        if ( var_12 == "goal" )
        {
            ...
            var_17 = scripts\mp\bots\bots_gametype_common.gsc::bombzone_press_use( level.planttime + 2, "bomb_planted", var_16 );
            self botclearscriptgoal();
...
bomb_defuser_update()
{
    ...
    if ( var_4 == "goal" )
    {
        ...
        var_13 = scripts\mp\bots\bots_gametype_common.gsc::bombzone_press_use( level.defusetime + 2, "bomb_defused", var_11, var_12 > 40 );
...
{
    var_1 = scripts\mp\bots\bots_gametype_common.gsc::get_ai_hearing_bomb_plant_sound( var_0 );
