...
manual_turret_handlemovingplatform( var_0 )
{
    if ( isdefined( var_0.moving_platform ) )
    {
        ...
        var_1.linkoffset = var_0.moving_platform_offset;
        var_1.angleoffset = var_0.moving_platform_angles_offset;
        var_1.endonstring = "carried";
        var_1.deathoverridecallback = ::manualturret_moving_platform_death;
