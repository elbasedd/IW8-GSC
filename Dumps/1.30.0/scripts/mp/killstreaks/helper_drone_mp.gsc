...
helper_drone_init()
{
    ...
    scripts\cp_mp\utility\script_utility::registersharedfunc( "helperDrone", "onReconDroneSuperStarted", ::helperdrone_onrecondronesuperstarted );
}
...
helperdrone_onrecondronesuperstarted()
{
    if ( scripts\mp\utility\game::getgametype() == "br" && !scripts\mp\flags::gameflag( "prematch_fade_done" ) )
        thread recondrone_watchsuperendfromprematchfadedone();
}

recondrone_watchsuperendfromprematchfadedone()
{
