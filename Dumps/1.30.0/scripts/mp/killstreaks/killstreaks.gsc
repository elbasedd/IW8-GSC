...
updatekillstreakuislots()
{
    ...
    for ( var_1 = 0; var_1 <= getlastslot(); var_1++ )
...
updatekillstreakuislot( var_0 )
{
    ...
    if ( isdefined( level.modevalidatekillstreakslot ) && ![[ level.modevalidatekillstreakslot ]]( var_0 ) )
        return;
...
makekillstreakavailable( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( isdefined( var_5.specialistperk ) )
        var_6 = var_5.specialistperk;
    ...
    var_5.available = 1;
    _setclientkillstreakavailability( var_0, var_5.available );
    ...
    var_5.streakmatchlifeid = self.matchdatalifeindex;
    var_5.owner = self;
    var_5.ownerxuid = self getxuid();

    if ( isdefined( var_2 ) )
        var_5.streaklifeid = var_2;

    if ( isdefined( var_3 ) )
        var_5.streakmatchlifeid = var_3;

    if ( isdefined( var_4 ) )
    {
        var_5.owner = var_4;
        var_5.ownerxuid = var_4 getxuid();
    }

    scripts\cp_mp\challenges::onkillstreakavailable( var_5.streakname, var_1 );
    scripts\mp\analyticslog::logevent_killstreakavailable( self, var_5.streakmatchlifeid, var_6, var_5.isgimme, var_5.madeavailabletime, self.origin );

    if ( isdefined( self.petwatch ) && var_0 == getlastslot() )
    {
        var_8 = 0;
        var_9 = 0;
...
selectfirstavailablekillstreak()
{
    ...
    {
        for ( var_1 = getlastslot(); var_1 >= 0; var_1-- )
        {
...
{
    var_1 = var_0;
    var_2 = scripts\engine\utility::ter_op( var_0 >= getlastslot(), 0, var_0 + 1 );
    var_3 = var_0;
    var_4 = var_2;
...
{
    var_1 = var_0;
    var_2 = scripts\engine\utility::ter_op( var_0 <= 0, getlastslot(), var_0 - 1 );
    var_3 = var_0;
    var_4 = var_2;
...
selectmostexpensivekillstreak()
{
    ...
    for ( var_2 = getlastslot(); var_2 >= 0; var_2-- )
    {
...
selectnextavailablekillstreak()
{
    ...
    for ( var_2 = 0; var_2 <= getlastslot(); var_2++ )
    {
        var_3 = self.streakdata.streaks[var_2];
...
checkstreakreward( var_0, var_1 )
{
    for ( var_2 = 1; var_2 <= 4; var_2++ )
    {
        ...
        if ( isdefined( var_3.lifeid ) && var_3.lifeid == self.lifeid && ( !istrue( level.wrapkillstreaks ) || istrue( level.wrapkillstreaks ) && self.streaktype == "specialist" ) || istrue( level.wrapkillstreaks ) && istrue( level.casualscorestreaks ) && self.streaktype != "specialist" && var_3.available == -1 )
            continue;
...
givestreakpoints( var_0, var_1, var_2 )
{
    ...
    if ( var_6 && !istrue( level.disablepersonalnuke ) && ( istrue( level.allowkillstreaks ) || isdefined( level.personalnukecostoverride ) ) )
    {
        ...
        else
        {
            ...
            if ( isdefined( self.petwatch ) )
                scripts\cp_mp\pet_watch::updatenukeprogress( self.nukepoints / var_8 );
        }
    }
...
checkcasualstreaksreset()
{
    ...
    if ( isdefined( self.streaktype ) && self.streaktype == "specialist" || isdefined( self.loadoutstreaktype ) && self.loadoutstreaktype == "specialist" || !istrue( level.wrapkillstreaks ) )
    {
