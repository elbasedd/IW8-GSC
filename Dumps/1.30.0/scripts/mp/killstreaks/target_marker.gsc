...
gettargetmarker( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        else
        {
            ...
            if ( isdefined( var_3 ) && var_3.string == "equip_deploy_succeeded" )
            {
                ...
                else if ( scripts\cp_mp\utility\train_utility::isplayerinsideanysubwaycar() )
                {
    ...
    if ( isdefined( var_3.location ) && isdefined( var_3.angles ) )
    {
        ...
        if ( isdefined( var_8["entity"] ) )
        {
            ...
            var_3.moving_platform_offset = ( var_11, var_12, var_13 );
            var_3.moving_platform_angles_offset = combineangles( invertangles( var_9.angles ), var_3.angles );
        }
