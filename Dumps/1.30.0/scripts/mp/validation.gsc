...
validateloadout( var_0 )
{
    ...
    if ( !scripts\mp\weapons::isweaponavailable( var_0.loadoutprimary ) )
    {
        var_2 = 1;
        var_3 = 1;
    }
    ...
    else
    {
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutprimaryattachments.size; var_5++ )
        {
            ...
            if ( var_6 != "none" && ( attachmentisrestricted( var_6, var_0.loadoutprimary ) || !isvalidattachmentunlock( var_0.loadoutprimary, var_6 ) ) )
            {
    ...
    else
    {
        ...
        for ( var_5 = 0; var_5 < var_0.loadoutsecondaryattachments.size; var_5++ )
        {
            ...
            if ( var_6 != "none" && ( attachmentisrestricted( var_6, var_0.loadoutsecondary ) || !isvalidattachmentunlock( var_0.loadoutsecondary, var_6 ) ) )
            {
