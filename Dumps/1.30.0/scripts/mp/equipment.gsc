...
inititems()
{
    ...
    var_0.callbacks["equip_binoculars"]["onGive"] = scripts\mp\equipment\binoculars::binoculars_ongive;
    var_0.callbacks["equip_binoculars"]["onTake"] = scripts\mp\equipment\binoculars::binoculars_ontake;
...
giveandstoreequipment( var_0, var_1, var_2 )
{
    foreach ( var_4 in var_0 )
    {
        ...
        var_4.secondarystartref = var_4 getcurrentequipment( var_1 );
        var_4.secondarystartammo = getequipmentslotammo( var_1 );
        var_4 takeequipment( var_1 );
        var_4 giveequipment( var_2, var_1 );
    }
}

takeandrestoreequipment( var_0, var_1, var_2, var_3 )
{
    foreach ( var_5 in var_0 )
    {
        ...
        var_7 = var_5.secondarystartref;
        var_8 = var_5.secondarystartammo;

        if ( isdefined( var_7 ) )
        {
            var_5 giveequipment( var_7, var_1 );
            var_5.secondarystartref = undefined;

            if ( isdefined( var_8 ) )
            {
                var_5 setequipmentammo( var_7, var_8 );
                var_5.secondarystartammo = undefined;
            }
        }
    }
}
...
initlethalmaxoffsetmap()
{
    ...
    foreach ( var_2 in level.equipment.table )
    {
        ...
        level.lethal_equipmentmaskoffsets[var_2.ref] = 1 << var_0;
        var_0++;
    }
}
