...
registersupers()
{
    ...
    registersuper( "super_vehicle_drop", undefined, undefined, ::supervehicledropbeginuse, undefined );
...
clearsuper( var_0 )
{
    ...
    thread scripts\cp_mp\utility\omnvar_utility::setclientomnvarsafe( "ui_super_state", 0 );
...
updatesuperuistate()
{
    ...
    if ( !isdefined( var_1 ) || var_2 != var_1 )
        thread scripts\cp_mp\utility\omnvar_utility::setclientomnvarsafe( "ui_super_state", var_2 );
