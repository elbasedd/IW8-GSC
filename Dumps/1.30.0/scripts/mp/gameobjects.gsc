...
carryobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( !isflagcarrymode() && var_0 scripts\mp\utility\weapon::grenadeinpullback() )
        {
...
setdropped( var_0, var_1 )
{
    ...
    if ( isdefined( var_15 ) )
    {
        ...
        if ( isdefined( var_17 ) && istrue( var_17.issuper ) )
        {
            ...
            thread waittillsuperdeathtotracedrop( var_17 );
        }
...
waittillsuperdeathtotracedrop( var_0 )
{
...
useobjectusethink()
{
    ...
    for (;;)
    {
        ...
        if ( isdefined( level.modeusecondition ) )
        {
            if ( ![[ level.modeusecondition ]]( var_0 ) )
                continue;
        }
...
getearliestclaimplayer()
{
    ...
    if ( isdefined( self.futuretouchlist ) && istrue( self.checkfuturelist ) )
    {
        if ( self.futuretouchlist[var_0].size > 0 )
        {
            var_2 = undefined;
            var_3 = getarraykeys( self.futuretouchlist[var_0] );

            for ( var_4 = 0; var_4 < var_3.size; var_4++ )
            {
                var_5 = self.futuretouchlist[var_0][var_3[var_4]];
...
proxtriggerthink()
{
    ...
    for (;;)
    {
        ...
        if ( istrue( self.iscarryobject ) && ( var_1 scripts\mp\utility\player::isusingremote() || isdefined( var_1.spawningafterremotedeath ) ) )
            continue;
            ...
            if ( hasdomflags() && isdefined( var_0.id ) && ( var_0.id == "domFlag" || var_0.id == "hardpoint" || var_0.id == "bomb_site" || var_0.id == "rugby_jugg" ) )
            {
                ...
                else if ( var_1 && isdefined( self.ui_dom_securing ) && ( isdefined( var_0.stalemate ) && !var_0.stalemate && !istrue( var_0.majoritycapprogress ) ) && var_0.ownerteam != self.team )
                {
                    ...
                    if ( scripts\mp\utility\game::getgametype() == "hq" )
                    {
                        ...
                        self setclientomnvar( "ui_objective_state", var_0 scripts\mp\gametypes\obj_dom.gsc::getdomneutralizeomnvarvalue() );
                    else
                        self setclientomnvar( "ui_objective_state", 1 );
                }
                else
...
updateuisecuring( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( var_1 )
    {
        ...
        if ( scripts\mp\utility\game::getgametype() == "br" && var_3.id == "laststand_reviver" )
        {
            ...
            scripts\mp\gametypes\br.gsc::updatesquadmemberlaststandreviveprogress( var_6, self, var_0 );
        }
    }
    else
    {
    ...
    else if ( !var_1 )
    {
        if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
        {
            if ( !var_0 scripts\mp\utility\perk::_hasperk( "specialty_revive_use_weapon" ) )
            {
                ...
                {
                    var_0 thread forceunsetdemeanor( 1 );
        ...
        if ( !isdefined( var_2 ) && !var_1 )
        {
            if ( isdefined( self.trigger ) && self.trigger isrevivetrigger() || isdefined( self.id ) && self.id == "rugby_jugg" )
            {
                if ( istrue( var_0.weaponsdisabledwhilereviving ) )
                {
                    ...
                    if ( !level.allowreviveweapons )
                    {
                        var_0 thread forceunsetdemeanor( 0 );
...
usetest( var_0, var_1, var_2, var_3 )
{
    ...
    if ( isdefined( self.trigger ) && isdefined( self.trigger.useobjdistancelimit ) && distance2dsquared( self.trigger.origin, var_0.origin ) >= self.trigger.useobjdistancelimit )
        return 0;
        ...
        if ( var_1 != -1 )
        {
            if ( level.codcasterenabled )
            {
                if ( isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::update_objective_mlgicon( var_1, var_12 );
                }
                else
            ...
            if ( !var_7 )
            {
                ...
                if ( level.codcasterenabled && isdefined( self.compassicons["codcaster"] ) )
                {
                    ...
                    scripts\mp\objidpoolmanager::update_objective_setmlgbackground( var_1, var_20 );
                }
