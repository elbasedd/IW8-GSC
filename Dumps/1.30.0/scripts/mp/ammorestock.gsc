...
ammorestock_playeruse( var_0, var_1 )
{
    ...
    foreach ( var_9 in var_2 )
    {
        if ( scripts\mp\utility\game::getgametype() == "br" )
        {
            var_0 scripts\mp\gametypes\br_weapons.gsc::br_give_weapon_clip( var_9, 2 );
            continue;
        }
...
br_ammorestock_playeruse( var_0 )
{
    ...
    foreach ( var_8 in var_3 )
    {
        ...
        else if ( scripts\mp\utility\weapon::isminigunweapon( var_8 ) )
        {
        ...
        if ( var_12 )
        {
            ...
            var_0 scripts\mp\gametypes\br_weapons.gsc::br_give_weapon_clip( var_8, 2 );
            var_1 = 1;
        }
    }
