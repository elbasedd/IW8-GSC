...
init()
{
    ...
    thread scripts\cp_mp\pet_watch_go.gsc::init();
}
    ...
    if ( isdefined( var_2 ) )
    {
        switch ( var_2 )
        {
            ...
            case "pet_black":
                ...
                break;
            case "pet_go":
                scripts\cp_mp\pet_watch_go.gsc::initpet( 0 );
                break;
            case "heartbeat":
                break;
            case "thermometer":
            ...
            case "holo":
                ...
                break;
            case "holo2":
                scripts\cp_mp\gestures::startholowatchvfxorange();
                break;
            default:
                break;
        }
