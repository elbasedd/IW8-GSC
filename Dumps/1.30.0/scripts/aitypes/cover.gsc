...
covershouldexpose( var_0 )
{
    ...
    if ( scripts\engine\utility::actor_is3d() && scripts\engine\utility::isnode3d( self.node ) )
    {
        ...
        var_9 = get3dcoveranglelimits( self.node, self.currentpose );
    ...
    {
        var_10 = getcoveranglelimits( self.node, self.currentpose );
...
coverexpose( var_0 )
{
    ...
    {
        var_9 = getcoveranglelimits( var_8, self.currentpose );
        var_17 = undefined;
    ...
    if ( !self.doingambush && isdefined( self.enemy ) )
    {
        ...
        if ( !var_21 )
            var_20.canseecantshoottime = undefined;
        else if ( isdefined( var_20.canseecantshoottime ) )
        {
            if ( var_5 - var_20.canseecantshoottime > 2000 )
                return anim.failure;
        }
        else
            var_20.canseecantshoottime = var_5;
    }
...
shouldthrowgrenade( var_0 )
{
    ...
    if ( isnullweapon( self.grenadeweapon ) )
        return anim.failure;
