...
placeweaponon( var_0, var_1, var_2 )
{
    ...
    if ( !isundefinedweapon( self.a.weaponpos[var_1] ) )
...
attachweapon( var_0, var_1 )
{
    ...
    if ( !isundefinedweapon( self.a.weaponposdropping[var_1] ) )
    {
...
updateattachedweaponmodels()
{
    ...
    foreach ( var_4 in var_0 )
    {
        ...
        if ( !isundefinedweapon( var_6 ) && !isnullweapon( var_6 ) )
        {
...
dropweaponwrapper( var_0, var_1 )
{
    ...
    if ( issubstr( tolower( var_3 ), "_ai" ) )
    {
        ...
        var_2 = makeweapon( var_3, var_0.attachments );
    }
...
forceuseweapon( var_0, var_1 )
{
    ...
    var_3 = !isnullweapon( self.weapon );
