...
getascenderascendspeed()
{
    return 360.0;
}

getascenderdescendspeed()
{
    return 460.0;
}

getascenderdescendspeedcp()
{
    return 540.0;
}

getascenderaccelpercent()
{
    return 0.4;
}

getascenderdecelpercent()
{
    return 0.15;
}

getascendernearradiussq()
{
    return 12100;
}

getascendernearheight()
{
    return 72;
}
...
canplayeruseascender( var_0, var_1 )
{
    if ( var_1 isswitchingweapon() )
    {
        var_1 thread denyascendmessagegeneric();
        return 0;
    }
    ...
    {
        var_2 = istrue( var_1.iszombie ) && isdefined( var_1.jumpfraction );
    ...
    if ( isdefined( var_4.sololink ) && istrue( var_4.sololink.inuse ) )
    {
        var_1 thread denyascendmessage();
        return 0;
    }
...
ascenderuse( var_0, var_1 )
{
    ...
    if ( !canplayeruseascender( var_0, var_1 ) )
        return;
    ...
    var_1.ascendermodelview = var_6;
    var_1.ascendermodelworld = var_7;
    ...
    if ( !var_2.dir )
    {
        if ( scripts\common\utility::iscp() )
            var_9 = getdvarfloat( "scr_descender_speed_cp", getascenderdescendspeedcp() );
        else
            var_9 = getdvarfloat( "scr_descender_speed", getascenderdescendspeed() );
    }
    else
        var_9 = getdvarfloat( "scr_ascender_speed", getascenderascendspeed() );

    var_10 = var_8 / var_9;
    var_11 = getascenderaccelpercent() * var_10;
    var_12 = getascenderdecelpercent() * var_10;
...
cleanupascenduse( var_0 )
{
    ...
    if ( isdefined( var_0 ) )
    {
        ...
        if ( isdefined( var_0.ascendermodelview ) )
        {
            var_0.ascendermodelview unlink();
            var_0.ascendermodelview delete();
        }

        if ( isdefined( var_0.ascendermodelworld ) )
        {
...
ispointnearascenderline( var_0 )
{
    foreach ( var_2 in level.ascendstructs )
    {
        if ( distance2dsquared( var_2.origin, var_0 ) < getascendernearradiussq() )
        {
            if ( abs( var_0[2] - var_2.origin[2] ) < getascendernearheight() )
                return 1;
        }
    }
