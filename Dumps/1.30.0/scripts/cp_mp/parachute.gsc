...
startfreefall( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    if ( level.gametype == "br" && ( !istrue( var_4 ) || ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" ) ) && getdvarint( "scr_infil_parachute_vfx", 1 ) )
        thread infilparachutevfx( getdvarint( "scr_bmo_parachuteTouchdownVFX", 1 ) == 1 && ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" ) );
...
infilparachutevfx( var_0 )
{
    ...
    if ( isdefined( self.operatorcustomization ) && isdefined( self.operatorcustomization.brinfilsmokesuffix ) )
        var_2 = var_2 + self.operatorcustomization.brinfilsmokesuffix;
...
freefallstartdefault()
{
    ...
    thread playertoggleallowfire();
}

playertoggleallowfire()
{
    self endon( "death_or_disconnect" );
    self allowfire( 0 );
    wait 0.5;
...
ffsm_introsetup( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( level.gametype == "br" && ( !istrue( self.ffsm_isgulagrespawn ) || getdvar( "scr_br_gametype", "" ) == "dmz" ) || getdvar( "scr_br_gametype", "" ) == "risk" )
        thread infilparachutevfx( getdvarint( "scr_bmo_parachuteTouchdownVFX", 1 ) == 1 && ( getdvar( "scr_br_gametype", "" ) == "dmz" || getdvar( "scr_br_gametype", "" ) == "risk" ) );
...
ffsm_skydive_stateenter()
{
    ...
    if ( !self.ffsm_isgulagrespawn )
    {
        ...
        if ( isdefined( self.operatorcustomization ) && isdefined( self.operatorcustomization.brinfilsmokesuffix ) )
            var_0 = var_0 + self.operatorcustomization.brinfilsmokesuffix;
    }
}
...
ffsm_parachuteopen_stateenter()
{
    ...
    if ( isdefined( self.jump_music ) && self.jump_music == 1 && getdvar( "scr_br_gametype", "" ) != "truckwar" )
    {
