...
_calloutmarkerping_predicted_timeout( var_0, var_1, var_2 )
{
    var_3 = self;
    ...
    if ( _calloutmarkerping_poolidisentity( var_0 ) )
    {
        ...
        if ( isdefined( var_6 ) )
        {
            ...
            if ( var_7 && _calloutmarkerping_isenemy( var_6, var_3 ) )
            {
                if ( isdefined( level.lootleaders ) && getdvar( "scr_br_gametype", "" ) == "kingslayer" && scripts\engine\utility::array_contains( level.lootleaders, var_6 ) )
                ...
                if ( !istrue( var_2 ) )
                    var_6.islivepinged = 1;
            }

            var_3 thread calloutmarkerping_watchentitydeathorenemydisconnect( var_0, var_6 );
    ...
    else if ( var_0 == 0 )
    {
        if ( getdvarint( "scr_calloutmarkerping_navigation_proximity_cancel", 0 ) )
            var_3 thread calloutmarkerping_navigationcancelproximity();
    }
    else if ( var_0 == 8 )
    {
        var_8 = var_3 calloutmarkerping_getent( var_0 );
        var_3 thread calloutmarkerping_watchentitydeathorenemydisconnect( var_0, var_8 );
        var_3 thread calloutmarkerping_removevehiclecalloutonspecialconditions( var_0, var_8 );
    }
    else if ( var_0 == 7 )
    {
        ...
        {
            var_3 thread calloutmarkerping_watchwhenobjectivestartsprogress( var_0, var_9 );
            var_3 thread calloutmarkerping_watchwhenobjectivedeleted( var_0, var_9 );
        }
    }
    else if ( var_0 == 12 )
        var_3 thread calloutmarkerping_watchplayerdeathordisconnect( 12, var_1 );

    if ( !isdefined( var_5 ) )
        var_4 = var_3 calloutmarkerping_gettimeoutforpoolid( var_0 );

    _calloutmarkerping_predicted_log( "Timeout value before wait: " + var_4 + " | poolID: " + var_0 );
    wait( var_4 );

    if ( isdefined( var_5 ) && isdefined( var_3 ) )
    {
        if ( isdefined( var_5.islivepinged ) )
            var_5.islivepinged = undefined;

        var_3 thread calloutmarkerping_enemytodangerdecaycreate( var_0, var_5 );
    }
    else
    {
...
calloutmarkerpingvo_getcalloutaliasstringvehicle( var_0, var_1 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "ping", "ping_cp_getCPVehicleCallout" ) )
    {
        ...
        if ( isdefined( var_4 ) && istrue( var_4.bshouldreturnvalue ) )
...
calloutmarkerping_watchwhenobjectivestartsprogress( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            _calloutmarkerping_predicted_log( "gscObjectiveStartedProgress: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
calloutmarkerping_watchwhenobjectivedeleted( var_0, var_1 )
{
    self endon( "disconnect" );
    self endon( "predictiveCalloutClear_" + var_0 );
    ...
    for (;;)
    {
        ...
        if ( isdefined( var_2 ) && var_2 == var_1 )
        {
            _calloutmarkerping_predicted_log( "gscObjectiveDeleted: " + var_0 + " | gscObjID: " + var_1 );
            break;
        }
    }
...
calloutmarkerping_watchentitydeathorenemydisconnect( var_0, var_1 )
{
    ...
    if ( !isdefined( var_1 ) )
    {
        ...
        var_1 scripts\engine\utility::waittill_any_3( "death", "pickup", "explode" );

    if ( isdefined( var_1.islivepinged ) )
        var_1.islivepinged = undefined;
...
calloutmarkerping_watchscriptabledeath( var_0, var_1 )
{
    ...
    else if ( var_1.type == "equip_fulton_mp" )
    {
        ...
        level scripts\engine\utility::waittill_any_5( "pickedupweapon_kill_callout_" + var_1.type + var_1.origin, "lootcache_opened_kill_callout" + var_1.origin, "dropbag_kill_callout_" + var_1.origin, "tablethide_kill_callout_" + var_1.origin, "carriable_kill_callout_" + var_1.origin );
...
calloutmarkerping_gettimeoutforpoolid( var_0 )
{
    ...
    if ( _calloutmarkerping_istrain( var_0 ) )
        var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
    else if ( _calloutmarkerping_poolidisloot( var_0 ) )
    {
        if ( _calloutmarkerping_isontrain( var_0 ) )
            var_2 = getdvarfloat( "scr_calloutmarkerping_death_timeout_navigation", 120.0 );
        else if ( calloutmarkerping_islootquesttablet( var_0 ) )
...
{
    var_1 = self;
    var_2 = var_1 calloutmarkerpingvo_getfulloperatorvoaliasfromsimplealias2d( var_0 );
    var_3 = var_1 calloutmarkerpingvo_getfulloperatorvoaliasfromsimplealias3d( var_0 );
...
calloutmarkerpingvo_playpredictivepingacknowledged( var_0, var_1 )
{
    ...
    if ( isplayer( var_1 ) )
        var_2 calloutmarkerpingvo_play( var_4, var_0, var_1 );
    else if ( isdefined( var_2 ) )
        var_2 calloutmarkerpingvo_play( var_4, var_0 );
}
...
_calloutmarkerping_isontrain( var_0 )
{
    var_1 = self;
    var_2 = var_1 calloutmarkerping_getent( var_0 );

    if ( isdefined( var_2 ) && issubstr( var_2.classname, "scriptable" ) && !isdefined( var_2.entity ) && var_2 getscriptableisreserved() )
    {
        if ( var_2 _meth_87B7() )
        {
            var_3 = var_2 _meth_87B5();
            return scripts\cp_mp\utility\train_utility::is_moving_platform_train( var_3 );
        }
    }
...
_calloutmarkerping_istrain( var_0 )
{
    var_1 = self;
    var_2 = var_1 calloutmarkerping_getent( var_0 );
...
{
    var_2 = self;
    var_2 thread _calloutmarkerping_predicted_timeout( var_0, 0, 1 );
...
_calloutmarkerping_handleluinotify_added( var_0 )
{
    ...
    if ( istrue( level.infilcinematicactive ) && !istrue( var_1 istacmapactive() ) )
    {
        calloutmarkerping_removecallout( var_0 );
        return;
    }
...
{
    var_1 = self;
    var_1 thread _calloutmarkerping_predicted_timeout( var_0, 0, 1 );
