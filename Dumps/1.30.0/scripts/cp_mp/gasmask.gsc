...
init( var_0, var_1 )
{
    ...
    if ( var_2 )
        var_3 = getdvarint( "scr_br_gasMask_health", 108 );
    else
        var_3 = 180;
    ...
    self.gasmaskmaxhealth = var_3;
    self.gasmasktype = var_1;
    var_4 = 2;

    if ( isdefined( var_1 ) && var_1 == "brloot_equip_gasmask_durable" )
        var_4 = 3;

    if ( isdefined( var_0 ) )
    {
        self.gasmaskhealth = var_0;
        self.gasmaskmaxhealth = var_0;
    }

    if ( var_2 )
        level.gasmaskhealthperpip = self.gasmaskhealth / 6;

    level.gasmaskmaxhealth = var_3;
...
processdamage( var_0 )
{
    ...
    var_2 = self.gasmaskhealth / self.gasmaskmaxhealth;
    self.gasmaskhealth = self.gasmaskhealth - var_0;
    self.gasmaskhealth = max( 0, self.gasmaskhealth );

    if ( var_1 )
        var_3 = ( self.gasmaskhealth + 1 ) / self.gasmaskmaxhealth;
    else
        var_3 = self.gasmaskhealth / self.gasmaskmaxhealth;
...
didgasmaskpipschange( var_0, var_1 )
{
    ...
    if ( !isdefined( self.gasmaskmaxhealth ) )
        self.gasmaskmaxhealth = getdvarint( "scr_br_gasMask_health", 108 );

    var_3 = var_0 / self.gasmaskmaxhealth;
    var_4 = var_1 / self.gasmaskmaxhealth;
    var_5 = floor( var_3 * 6 + 0.5 );
