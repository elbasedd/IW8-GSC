...
movingplatform_playerlink( var_0 )
{
    ...
    if ( isdefined( var_1 ) && scripts\cp_mp\utility\train_utility::is_moving_platform_train( var_1 ) )
    {
        var_0 playerlinkto( var_1 );
        var_0 playerlinkedoffsetenable();
        var_0.movingplatforment = var_1;
    }
}

movingplatform_playerunlink( var_0 )
{
    if ( isdefined( var_0.movingplatforment ) )
    {
        var_0.movingplatforment = undefined;
        var_0 unlink();
    }
}
