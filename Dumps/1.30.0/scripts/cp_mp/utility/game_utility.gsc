...
stopkeyearning( var_0 )
{
    ...
    if ( isdefined( self.timeplayed ) && self.timeplayed["total"] >= 1 && self.pers["participation"] >= 1 )
        var_10 = self.timeplayed["total"];

    if ( istrue( level.ismp ) )
        self reportchallengeuserevent( "end_match", var_1, var_3, var_6, var_7, var_8, var_9, var_10 );
    else
    {
        ...
        self reportchallengeuserevent( "end_match", var_1, var_3, var_6, 0, 0, var_9, var_10 );
    }
...
getchallengegamemode( var_0 )
{
    ...
    {
        if ( getdvarint( "tu_tango_escape2_uses_allmode_challenge", 1 ) && getmapname() == "mp_escape2" )
            return 95;
