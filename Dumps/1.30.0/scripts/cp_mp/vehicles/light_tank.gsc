...
light_tank_initcollision()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_collision::vehicle_collision_getleveldataforvehicle( "light_tank", 1 );
    var_0.attackfactormod = 2.5;
    var_0.defensefactormod = 0.625;
    var_0.damagefactorlow = 350;
    var_0.damagefactormedium = 525;
    var_0.damagefactorhigh = 875;
    var_0.damagepercentlow = 1.25;
    var_0.damagepercentmedium = 5;
    var_0.damagepercenthigh = 10;
...
light_tank_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_activateinteractiontype( "light_tank", "single", [ "driver", "gunner" ] );
}
...
light_tank_create( var_0, var_1 )
{
    ...
    if ( light_tank_usealtmodel( var_0 ) )
...
light_tank_createdriverturret( var_0, var_1 )
{
    ...
    if ( light_tank_usealtmodel( var_1 ) )
...
light_tank_explode( var_0, var_1, var_2 )
{
    ...
    if ( !istrue( level.suppressvehicleexplosion ) )
    {
        ...
        if ( light_tank_usealtmodel( self.spawndata ) )
