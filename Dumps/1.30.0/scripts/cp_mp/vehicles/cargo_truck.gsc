...
cargo_truck_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_activateinteractiontype( "cargo_truck", "single", [ "driver" ] );
}
...
cargo_truck_initcollision()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_collision::vehicle_collision_getleveldataforvehicle( "cargo_truck", 1 );
    var_0.attackfactormod = 2;
    var_0.defensefactormod = 0.75;
    var_0.damagefactorlow = 350;
    var_0.damagefactormedium = 525;
    var_0.damagefactorhigh = 875;
    var_0.damagepercentlow = 5;
    var_0.damagepercentmedium = 20;
    var_0.damagepercenthigh = 40;
