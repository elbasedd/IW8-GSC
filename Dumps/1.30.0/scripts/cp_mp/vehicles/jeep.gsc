...
jeep_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_activateinteractiontype( "jeep", "single", [ "driver", "front_right", "back_left", "back_right" ] );
}
...
jeep_initcollision()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_collision::vehicle_collision_getleveldataforvehicle( "jeep", 1 );
    var_0.attackfactormod = 1.33333;
    var_0.defensefactormod = 0.91666;
    var_0.damagefactorlow = 350;
    var_0.damagefactormedium = 525;
    var_0.damagefactorhigh = 875;
    var_0.damagepercentlow = 10;
    var_0.damagepercentmedium = 40;
    var_0.damagepercenthigh = 80;
