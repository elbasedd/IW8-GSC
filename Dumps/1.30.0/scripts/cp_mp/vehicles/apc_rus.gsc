...
apc_rus_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_activateinteractiontype( "apc_russian", "single", [ "driver", "front_right", "back_right", "back", "back_left", "front_left" ] );
}

apc_rus_initcollision()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_collision::vehicle_collision_getleveldataforvehicle( "apc_russian", 1 );
    var_0.attackfactormod = 2.33333;
    var_0.defensefactormod = 0.66666;
    var_0.damagefactorlow = 350;
    var_0.damagefactormedium = 525;
    var_0.damagefactorhigh = 875;
    var_0.damagepercentlow = 2.5;
    var_0.damagepercentmedium = 10;
    var_0.damagepercenthigh = 20;
...
apc_rus_initdamage()
{
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_registerdefaultstates( "apc_russian", var_0 );
    ...
    scripts\cp_mp\vehicles\vehicle_damage::vehicle_damage_setvehiclehitdamagedata( "apc_russian", var_2 );
