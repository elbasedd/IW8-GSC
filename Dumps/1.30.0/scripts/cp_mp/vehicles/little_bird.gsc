...
little_bird_initinteract()
{
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_activateinteractiontype( "little_bird", "single", [ "pilot", "fl_platform", "fr_platform", "bl_platform", "br_platform" ] );
}
...
little_bird_initcollision()
{
    var_0 = scripts\cp_mp\vehicles\vehicle_collision::vehicle_collision_getleveldataforvehicle( "little_bird", 1 );
    var_0.attackfactormod = 1.5;
    var_0.defensefactormod = 0.875;
    var_0.damagefactorlow = 350;
    var_0.damagefactormedium = 525;
    var_0.damagefactorhigh = 875;
    var_0.damagepercentlow = 8.75;
    var_0.damagepercentmedium = 35;
    var_0.damagepercenthigh = 70;
