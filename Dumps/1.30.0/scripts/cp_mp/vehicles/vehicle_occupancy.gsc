...
vehicle_occupancy_enter( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    if ( istrue( vehicle_occupancy_seatisavailable( var_0, var_1, var_2 ) ) )
    {
        ...
        if ( var_10 )
        {
                ...
                if ( istrue( var_11 ) )
                {
                    ...
                    switch ( var_0.targetname )
                    {
                        case "apc_russian":
                            ...
                            var_12 = 1;
                            var_15 = var_2.vehiclecustomization.apc_horn;
                            break;
                        case "atv":
                            var_13 = var_2.vehiclecustomization.atv;
                            var_15 = var_2.vehiclecustomization.atv_horn;
                            var_16 = var_2.vehiclecustomization.atv_trail;
                            break;
                        case "cargo_truck_mg":
                        case "cargo_truck":
                            var_13 = var_2.vehiclecustomization.cargo_truck;
                            var_15 = var_2.vehiclecustomization.cargo_truck_horn;
                            break;
                        case "jeep":
                            var_13 = var_2.vehiclecustomization.jeep;
                            var_15 = var_2.vehiclecustomization.jeep_horn;
                            break;
                        case "little_bird_mg":
                        case "little_bird":
                            var_13 = var_2.vehiclecustomization.little_bird;
                            var_15 = var_2.vehiclecustomization.little_bird_horn;
                            var_16 = var_2.vehiclecustomization.little_bird_trail;
                            break;
                        case "tac_rover":
                            var_13 = var_2.vehiclecustomization.tac_rover;
                            var_15 = var_2.vehiclecustomization.tac_rover_horn;
                            var_16 = var_2.vehiclecustomization.tac_rover_trail;
                            break;
                        case "light_tank":
            ...
            scripts\cp_mp\vehicles\customization\battle_tracks::battle_tracks_vehicleoccupancyenter( var_0, var_2, var_1, var_9 );
            scripts\cp_mp\vehicles\vehicle_dlog::vehicle_dlog_enterevent( var_0, var_2, var_1, var_20 );
        }
...
vehicle_occupancy_init()
{
    ...
    var_0.vehicledata = [];
    var_0.transitionhideenabled = getdvarint( "scr_transitionHideEnabled", 1 ) > 0;

    if ( var_0.transitionhideenabled )
    {
        var_0.transitionhideeventid = 0;
        var_0.transitionhideeventids = [];
    }
...
vehicle_occupancy_exitend( var_0, var_1, var_2, var_3, var_4 )
{
    if ( var_4.success )
    {
        ...
        if ( !var_0 scripts\common\vehicle_code::vehicle_is_stopped() && vehicle_occupancy_isdriverseat( var_0, var_1 ) )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
            {
                var_5 = spawnstruct();
                var_5.exitdriver = 1;
                var_3 thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "br", "challengeEvaluator" ) ]]( "br_mastery_ghostRideWhip", var_5 );
            }
        }
    }
    ...
    scripts\cp_mp\vehicles\vehicle_interact::vehicle_interact_updateusability( var_0 );
    var_6 = gettime();
    var_7 = vehicle_occupancy_getexitendcallbackforseat( var_0, var_1 );
...
vehicle_occupancy_onentervehicle( var_0, var_1, var_2, var_3 )
{
    ...
    scripts\cp_mp\vehicles\customization\battle_tracks::battle_tracks_onentervehicle( var_0, var_2 );
...
vehicle_occupancy_onexitvehicle( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdisconnect ) )
    {
        ...
        if ( !istrue( var_3.playerdeath ) )
        {
            ...
            thread scripts\cp_mp\vehicles\vehicle::vehicle_preventplayercollisiondamagefortimeafterexit( var_0, var_2 );
        }
        else
            var_3.exittype = "DEATH";
    ...
    scripts\cp_mp\vehicles\customization\battle_tracks::battle_tracks_onexitvehicle( var_0, var_2, var_1 );
}
...
vehicle_occupancy_hideoccupantwithstack()
{
    if ( !isdefined( level.hideoccupantwithstack ) )
        level.hideoccupantwithstack = getdvarint( "scr_hideOccupantWithStack", 1 );

    return level.hideoccupantwithstack;
}
...
vehicle_occupancy_hideoccupant( var_0, var_1, var_2, var_3 )
{
    if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
    {
        ...
        if ( vehicle_occupancy_hideoccupantwithstack() )
            var_2 scripts\cp_mp\utility\player_utility::_playerhide();
        else
            var_2 playerhide();
    }
}

vehicle_occupancy_hideoccupantduringtransition( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();

    if ( !var_2.transitionhideenabled )
        return;

    var_3 = var_2.transitionhideeventid;
    var_2.transitionhideeventid++;
    var_0 scripts\cp_mp\utility\player_utility::_playerhide();
    var_2.transitionhideeventids[var_3] = var_0;

    if ( !isdefined( var_1.transitionhideeventids ) )
        var_1.transitionhideeventids = [];

    var_1.transitionhideeventids[var_3] = var_0;
    return var_3;
}

vehicle_occupancy_showoccupantaftertransitionbyeventid( var_0, var_1, var_2 )
{
    var_3 = vehicle_occupancy_getleveldata();

    if ( !var_3.transitionhideenabled )
        return;
    ...
    if ( !isdefined( var_3.transitionhideeventids[var_0] ) )
        return;

    var_4 = var_3.transitionhideeventids[var_0];

    if ( isdefined( var_1 ) && isdefined( var_1.transitionhideeventids ) )
        var_1.transitionhideeventids[var_0] = undefined;

    if ( isdefined( var_4 ) )
        var_4 scripts\cp_mp\utility\player_utility::_playershow();
}

vehicle_occupancy_showoccupantaftertransition( var_0, var_1 )
{
    var_2 = vehicle_occupancy_getleveldata();
    ...
    if ( !isdefined( var_0.transitionhideeventids ) )
        return;

    foreach ( var_5, var_4 in var_0.transitionhideeventids )
    {
        if ( isdefined( var_2.transitionhideeventids[var_5] ) )
        {
            var_2.transitionhideeventids[var_5] = undefined;
    ...
    var_0.transitionhideeventids = undefined;
}

vehicle_occupancy_cleanuptransitionhideeventids()
{
    ...
    foreach ( var_3, var_2 in var_0.transitionhideeventids )
    {
        if ( !isdefined( var_2 ) )
            var_0.transitionhideeventids[var_3] = undefined;
    }
}
...
vehicle_occupancy_showoccupant( var_0, var_1, var_2, var_3 )
{
    if ( !istrue( var_3.playerdeath ) )
    {
        if ( vehicle_shouldhideoccupantforseat( var_0, var_1 ) )
        {
            ...
            if ( vehicle_occupancy_hideoccupantwithstack() )
                var_2 scripts\cp_mp\utility\player_utility::_playershow();
            else
                var_2 playershow();
        }
    }
...
vehicle_occupancy_animateplayer( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    ...
    {
        _overridevehicleseatanimconditionals( var_4, var_5 );
        thread _overridevehicleseatanimconditionalsclear( 1 );
    }
    ...
    if ( !isdefined( var_6.turretobjweapon ) )
    {
        if ( !isdefined( var_2 ) )
...
vehicle_occupancy_killoccupants( var_0, var_1 )
{
    ...
    foreach ( var_5 in var_3 )
    {
        ...
        if ( isdefined( var_6 ) && var_6 scripts\cp_mp\utility\player_utility::_isalive() )
        {
            ...
            {
                if ( isdefined( var_6.juggcontext.juggconfig.vehiclecankillhealth ) && var_6.health > var_6.juggcontext.juggconfig.vehiclecankillhealth )
                    var_8 = 1;
            }
