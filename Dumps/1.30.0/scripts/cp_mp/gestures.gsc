...
startholowatchvfx()
{
    ...
    thread playerholowatchskydive();
}

startholowatchvfxorange()
{
    if ( level.mapname == "mp_hackney_yard" || level.mapname == "mp_spear_pm" || level.mapname == "mp_runner_pm" || level.mapname == "mp_cave" )
    {
...
playerholowatchskydive()
{
    ...
    for (;;)
    {
        scripts\engine\utility::waittill_any_3( "skydive_deployparachute", "skydive_end", "skydive_beginfreefall" );
        thread tryreenablescriptablevfx();
    }
}

startbluntwatchvfx()
{
    if ( istrue( self.blunttime ) )
        return;
    ...
    self.blunttime = 1;
    thread bluntwatchspindowntimer();
}

bluntwatchspindowntimer()
{
    self endon( "disconnect" );
    self endon( "game_ended" );
    wait 4.2;
    self.blunttime = undefined;
...
tryreenablescriptablevfx()
{
    ...
    if ( var_0 )
    {
        ...
        if ( var_2 && ( !isdefined( self.smartwatchinteract ) || !istrue( self.smartwatchinteract ) ) )
        {
            if ( var_2 )
            {
                startholowatchvfx();
    ...
    else if ( var_1 )
    {
        ...
        if ( var_3 && ( !isdefined( self.smartwatchinteract ) || !istrue( self.smartwatchinteract ) ) )
        {
            if ( var_3 )
                startholowatchvfxorange();
        }
            ...
            if ( var_2 == "iw8_ges_plyr_gesture024" )
            {
                ...
                if ( isdefined( self.accessorylogic ) )
                {
                    ...
                    else if ( self.accessorylogic == "holo2" )
                    {
                        ...
                        scripts\cp_mp\pet_watch_go.gsc::watchinteract();
                }
            }
