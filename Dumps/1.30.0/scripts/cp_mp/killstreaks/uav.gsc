...
useuav( var_0, var_1 )
{
    ...
    scripts\cp_mp\challenges::reportt9userevent( "t9_ch_global_call_in_uav_for_operator_mission", 1 );
...
updateteamuavstatus( var_0, var_1 )
{
    ...
    foreach ( var_10 in var_8 )
    {
        ...
        if ( istrue( var_10.insidecuavbunker ) )
            continue;

        if ( istrue( var_10.skipuavupdate ) )
            continue;
...
updateplayersuavstatus()
{
    foreach ( var_1 in level.players )
    {
        if ( istrue( var_1.insidecuavbunker ) )
            continue;
