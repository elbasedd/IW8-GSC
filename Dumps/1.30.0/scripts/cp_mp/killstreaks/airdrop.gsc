...
initcratedata()
{
    ...
    level.cratedata.unresolvedcollisiontolerancesqr = pow( getdvarfloat( "scr_crateUnresolvedCollisionToleranceSqr", 2 ), 2 );
    ...
    switch ( var_2 )
    {
        ...
        case "br":
            ...
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "airdrop", "brGetGameModeSpecificCrateData" ) )
            {
                ...
                var_3.usetimeowner = 0.5;
                var_3.usetimeother = 3;
                var_3.usefov = 180;
...
createcrate( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8, var_9 )
{
    ...
    if ( isdefined( var_11.owner ) )
        var_11.owner.isffprotectedaction = 1;
...
watchcrateuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        {
            if ( istrue( var_4.isjuggernaut ) && !var_4 juggcanusecrate( self.cratetype ) )
            {
...
airdrop_watchforcrateuseend( var_0 )
{
    ...
    else
    {
        ...
        {
            var_1 = scripts\cp_mp\utility\weapon_utility::restoreweaponstates( self.lastdroppableweaponobj );
...
monitoraveragevelocityandupdate()
{
    ...
    for (;;)
    {
        var_5 = getaveragelinearvelocity();
        var_6 = getaverageangularvelocity();
...
checklinktotrain( var_0 )
{
    if ( isdefined( var_0.script_noteworthy ) && isstartstr( var_0.script_noteworthy, "train_" ) && !isdefined( self getlinkedparent() ) )
    {
        ...
        thread checklinktotraininternal( var_0 );
    }
}
...
checklinktotraininternal( var_0 )
{
    ...
    {
        var_7 = self.origin + anglestoup( self.angles ) * var_1.halfheight;
        var_8 = var_7 + ( 0, 0, -200 );
        var_9 = scripts\engine\trace::ray_trace( var_7, var_8, var_3, var_2 );

        if ( var_9.size > 0 && isdefined( var_9["entity"] ) && var_9["entity"] == self.trainent )
        {
            ...
            else if ( distancesquared( var_10, self.traintracerelpos ) > 25 )
            {
                self.traintracefails++;
                self.traintracesuccesses = 0;
            }
            else if ( vectordot( var_10, self.traintracerelpos ) < 0.997 )
            {
                self.traintracefails++;
                self.traintracesuccesses = 0;
            }
...
crateunresolvedcollisioncallback( var_0, var_1 )
{
    ...
    {
        if ( lengthsquared( var_1 ) <= level.cratedata.unresolvedcollisiontolerancesqr )
            return;
    }
...
dropbrc130airdropcrate( var_0, var_1, var_2, var_3, var_4, var_5 )
{
    var_6 = 250;
    var_7 = level.c130airdrop_heightoverride;
    var_8 = 1000;
    var_9 = 10500;
    var_10 = 7500;
    var_11 = 3000;
    var_12 = var_1 + ( 0, 0, var_8 );
    var_13 = "battle_royale_c130_loot";
    ...
    var_14 = createcrate( undefined, undefined, var_13, var_0, ( 0, 0, 0 ), var_1, undefined, 0 );

    if ( isdefined( var_14 ) )
    {
        var_14.skipminimapicon = 1;

        if ( !var_5 && var_12[2] < var_0[2] )
        {
            var_15 = undefined;
            var_16 = distance( var_0, var_12 );

            if ( var_16 >= var_9 )
                var_15 = "brc130_drop_high";
            else if ( var_16 >= var_10 )
                var_15 = "brc130_drop_med";
            else if ( var_16 >= var_11 )
                var_15 = "brc130_drop_low";

            if ( isdefined( var_15 ) )
            {
                var_17 = 1000;
                var_18 = spawn( "script_model", var_12 + ( 0, 0, var_17 ) );
                var_18.angles = var_2;
                var_18 setmodel( "tag_origin" );
                var_14.animname = "care_package";
                var_14.dropanim = level.scr_anim[var_14.animname][var_15];
                var_14.animlength = getanimlength( var_14.dropanim );
                var_14 scripts\common\anim::setanimtree();
                var_19 = spawn( "script_model", var_14.origin );
                var_19.angles = var_14.angles;
                var_19.animname = "care_package_chute";
                var_19.dropanim = level.scr_anim[var_19.animname][var_15];
                var_19.animlength = getanimlength( var_19.dropanim );
                var_19 setmodel( "veh8_mil_lnd_carepackage_parachute_br" );
                var_19 scripts\common\anim::setanimtree();
                var_18 thread scripts\common\anim::anim_single_solo( var_14, var_15 );
                var_18 thread scripts\common\anim::anim_single_solo( var_19, var_15 );
                var_14 thread watchbrc130aidropcrateanimend();
                var_19 thread watchbrc130airdropchuteanimend( var_18 );
            }
            else
                var_14 cratephysicson();
        }
        else
            var_14 cratephysicson();

        var_20 = "cashdrop_common";
        var_21 = getdvarint( "scr_dmz_airdrop_ingame_obj", 1 );

        if ( var_21 )
            var_20 = "cashdrop_common_world";

        if ( isdefined( var_4 ) )
            var_20 = var_4;

        var_14 setscriptablepartstate( "objective_map", var_20, 0 );
        var_14 setscriptablepartstate( "crate_audio", "parachuting", 0 );
        var_14.smokesignal = spawn( "script_model", var_1 );
        var_14.smokesignal setmodel( "ks_airdrop_crate_br" );
        var_14.smokesignal setscriptablepartstate( "smoke_signal", "on", 0 );
    }
...
dropbrlootchoppercrateforpublicevent( var_0, var_1 )
{
    var_2 = dropcrate( undefined, undefined, "battle_royale_chopper_loot", var_0, ( 0, randomfloat( 360 ), 0 ), var_1 );
    ...
    if ( isdefined( var_2 ) )
    {
        ...
        var_2.smokesignal = spawn( "script_model", var_1 );
        var_2.smokesignal setmodel( "ks_airdrop_crate_br" );
        var_2.smokesignal setscriptablepartstate( "smoke_signal", "pe_chopper_on", 0 );
    }
...
spawnjuggernautcrateatposition( var_0, var_1 )
{
    ...
    if ( istrue( self.isdeepunderground ) )
        var_2 = 10000;

    var_3 = dropjuggernautcrate( self.team, var_0 + ( 0, 0, var_2 ), var_0 + ( 0, 0, 512 ) );
    var_3 endon( "death" );
    enablejuggernautcrateobjective( var_3 );
    choosejuggernautcratemodel( var_3 );
    var_4 = [];
