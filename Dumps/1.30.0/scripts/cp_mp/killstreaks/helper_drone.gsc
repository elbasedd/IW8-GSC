...
init()
{
    ...
    level.helperdronesettings["radar_drone_recon"].markdetectcoldblooded = 1;
    level.helperdronesettings["radar_drone_recon"].markdetectonlyfov = 1;
    level.helperdronesettings["radar_drone_recon"].markrangesqrd = 3062500;
    level.helperdronesettings["radar_drone_recon"].markrangesqrdbr = 6250000;
    ...
    level.helperdronesettings["assault_drone"].primarymodefunc = ::setassaultmodesettings;
    ...
    level.helperdronesettings["assault_drone"].markdetectcoldblooded = 0;
    level.helperdronesettings["assault_drone"].markdetectonlyfov = 0;
    level.helperdronesettings["assault_drone"].markrangesqrd = 73984;
    level.helperdronesettings["assault_drone"].markrangesqrdbr = 73984;
    level.helperdronesettings["assault_drone"].detonateoninput = 1;
    level.helperdronesettings["assault_drone"].detonateonexit = undefined;
    level.helperdronesettings["assault_drone"].detonateontouchvehicle = 1;
    level.helperdronesettings["assault_drone"].overrideexittime = undefined;
    var_0 = "br";
    ...
    level.assaultdroneenemynotifydist = getdvarfloat( "scr_assault_drone_enemy_notify_dist", 3000.0 );
    level.assaultdronedebugfreeze = getdvarint( "scr_assault_drone_freeze_debug", 0 );
    level.dronedebugfreezeswitch = getdvarint( "scr_drone_freeze_switch_debug", 1 );
}
...
tryusehelperdronefromstruct( var_0 )
{
    ...
    var_5 = self.incrementedfauxvehiclecount;
    self.incrementedfauxvehiclecount = undefined;
    ...
    {
        if ( istrue( level.dronedebugfreezeswitch ) )
        ...
        var_10 = 0.6;
        var_11 = 2;
        var_12 = scripts\engine\utility::waittill_any_timeout_2( var_10, "death", "weapon_switch_started" );
        ...
        var_12 = scripts\engine\utility::waittill_any_timeout_1( var_11 - var_10, "death" );
    ...
    else if ( var_6 == "scrambler_drone_guard" )
    {
        ...
        {
            var_15 = [[ level.traceselectedmaplocation ]]( self.origin );
...
tryusehelperdroneearlyout( var_0, var_1 )
{
    ...
    if ( ( var_0.streakname == "radar_drone_recon" || var_0.streakname == "assault_drone" ) && ( !self isonground() && !self isonladder() || scripts\cp_mp\utility\train_utility::isplayerinsideanysubwaycar() ) )
    {
        if ( var_1 )
        {
            if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "hud", "showErrorMessage" ) )
    ...
    self.incrementedfauxvehiclecount = 1;
    return 0;
}
...
helperdrone_notifyenemyplayersinrange( var_0 )
{
    ...
    if ( var_0 == "assault_drone" )
        var_1 = level.assaultdroneenemynotifydist;
...
helperdrone_endscramblereffect()
{
    ...
    if ( isdefined( self.enemiesaffectedbyscrambler ) && self.enemiesaffectedbyscrambler.size > 0 )
    {
        foreach ( var_1 in self.enemiesaffectedbyscrambler )
        {
            if ( isdefined( var_1 ) )
            {
                var_2 = var_1;
...
helperdrone_watchscramblereffectdist( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "explode" );
    ...
    self.enemiesaffectedbyscrambler = [];
    var_1 = 0;
...
helperdrone_setscramblerjammed( var_0, var_1, var_2 )
{
    ...
    if ( istrue( var_0 ) )
    {
        ...
        if ( !scripts\engine\utility::array_contains( var_1.enemiesaffectedbyscrambler, var_3 ) )
            var_1.enemiesaffectedbyscrambler[var_1.enemiesaffectedbyscrambler.size] = var_3;
...
helperdrone_managescramblereffect( var_0, var_1 )
{
    ...
    if ( isdefined( self ) )
    {
        ...
        if ( isdefined( var_0 ) && isdefined( var_0.enemiesaffectedbyscrambler ) )
            var_0.enemiesaffectedbyscrambler = scripts\engine\utility::array_remove( var_0.enemiesaffectedbyscrambler, self );
    }
    else if ( isdefined( var_0 ) && isdefined( var_0.enemiesaffectedbyscrambler ) )
        var_0.enemiesaffectedbyscrambler = scripts\engine\utility::array_removeundefined( var_0.enemiesaffectedbyscrambler );
}
        ...
        foreach ( var_5 in level.supportdrones )
        {
            ...
            if ( level.teambased )
            {
                if ( !isdefined( var_1 ) && var_5.team == self.team )
                    ...
                    var_3 = var_5.enemiesaffectedbyscrambler;
            }
...
setreconmodesettings( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        self.owner setrcdcontrolsstate( 1, self );
...
setassaultmodesettings( var_0 )
{
    ...
    if ( !istrue( var_1 ) )
    {
        ...
        scripts\cp_mp\utility\weapon_utility::setlockedonremovedcallback( self, ::helperdrone_lockedonremovedcallback );
        thread helperdrone_watchouterreticletargets( var_0 );
        thread helperdrone_watchouterreticlestateassault( var_0 );
        thread helperdrone_markplayersassault( var_0 );
    }
    ...
    if ( istrue( level.assaultdronedebugfreeze ) )
        thread helperdrone_debugfreezeaftertime( 2 );
...
setguardmode( var_0 )
{
    ...
    thread helperdrone_watchscramblereffectdist();
    return 1;
}
...
helperdrone_watchearlyexit( var_0 )
{
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "killstreak", "allowRideKillstreakPlayerExit" ) )
        self thread [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "killstreak", "allowRideKillstreakPlayerExit" ) ]]( "death", var_0.overrideexittime );

    self waittill( "killstreakExit" );
    thread helperdroneexplode( 0, istrue( var_0.detonateonexit ) );
}

helperdrone_watchdetonateinput( var_0 )
{
    ...
    helperdrone_watchdetonateinternal();
...
helperdrone_monitorcollision( var_0 )
{
    ...
    for (;;)
    {
        ...
        if ( var_1 scripts\cp_mp\vehicles\vehicle::isvehicle() )
            ...
            var_2 = var_1.vehicle;
        else if ( istrue( var_1.kill_helper_drone_on_contact ) )
            var_2 = var_1;
...
helperdrone_debugfreezeaftertime( var_0 )
{
    self.owner endon( "disconnect" );
    self endon( "death" );
    wait( var_0 );
    self.owner thread scripts\cp_mp\utility\player_utility::_freezecontrolsdebug();
}
...
helperdrone_markplayersassault( var_0 )
{
    var_1 = self.owner;
    var_1 endon( "disconnect" );
    self endon( "death" );
    ...
    for (;;)
    {
        ...
        foreach ( var_6 in var_3 )
        {
            ...
            var_2++;
            settargetmarkerstate( self.targetmarkergroup, var_6, 1 );
            var_7 = canseetarget( var_6 );
            var_8 = isinmarkingrange( var_6 );

            if ( !var_8 || !var_7 )
            {
                settargetmarkerstate( self.targetmarkergroup, var_6, 0 );
                continue;
            }

            var_4 = 1;
            settargetmarkerstate( self.targetmarkergroup, var_6, 2 );
        }

        self.targetisinrange = var_4;
        var_2 = 0;
        waitframe();
    }
}
...
helperdrone_watchouterreticlestateassault( var_0 )
{
    self endon( "death" );
    self endon( "leaving" );
    self endon( "switch_modes" );
    ...
    for (;;)
    {
        if ( istrue( self.targetisinrange ) && var_1 == 0 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 1 );
            var_1 = 1;
        }
        else if ( !istrue( self.targetisinrange ) && var_1 == 1 )
        {
            self.owner setclientomnvar( "ui_rcd_outer_ring", 0 );
            var_1 = 0;
        }
    ...
    for (;;)
    {
                ...
                if ( isdefined( var_6.datakey ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "gameFlag" ) )
                    {
                        if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "gameFlag" ) ]]( "prematch_done" ) )
                        {
                            ...
                            {
                                if ( [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "player", "isPlayerOnIntelChallenge" ) ]]( self.owner, var_6.datakey ) )
        ...
        foreach ( var_10 in var_8 )
        {
            if ( isplayer( var_10 ) )
            {
                ...
                if ( !istrue( var_0.markdetectcoldblooded ) )
                {
                    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "perk", "hasPerk" ) )
                    {
            ...
            if ( istrue( var_0.markdetectonlyfov ) && !self.owner helperdrone_istargetinreticle( var_10, 70, 300 ) )
                continue;
...
canseetarget( var_0 )
{
    ...
    if ( isdefined( var_0.recondronetracecontents ) )
        var_2 = var_0.recondronetracecontents;
    else
        var_2 = scripts\engine\trace::create_contents( 0, 1, 0, 1, 1, 1, 0, 1 );

    var_3 = var_0.origin;

    if ( isdefined( var_0.recondronetraceoffset ) )
        var_3 = var_3 + var_0.recondronetraceoffset;
...
startmarkingpassivetarget( var_0 )
{
    ...
    while ( isdefined( var_0 ) )
    {
        ...
        if ( istrue( var_2.markdetectonlyfov ) && !self.owner helperdrone_istargetinreticle( var_0, 70, 300 ) )
            break;
...
startmarkingtarget( var_0, var_1, var_2, var_3 )
{
    ...
    self.owner setrcdcontrolsstate( 2, self );
    ...
    if ( isdefined( var_0.recondronemarkedcb ) )
        [[ var_0.recondronemarkedcb ]]( var_4, var_0 );
    ...
    self.owner stoplocalsound( "recon_drone_marking_owner" );
    self.owner setrcdcontrolsstate( 4, self );
...
isinmarkingrange( var_0 )
{
    ...
    var_3 = scripts\engine\utility::ter_op( var_2, var_1.markrangesqrdbr, var_1.markrangesqrd );

    if ( isdefined( var_0.markdistanceoverride ) )
        var_3 = var_0.markdistanceoverride;
...
setrcdcontrolsstate( var_0, var_1 )
{
    var_2 = 0;
...
helperdroneexplode( var_0, var_1 )
{
    ...
    if ( istrue( var_1 ) )
    {
        ...
        helperdronedetonateeffects();
    }
    else
        helperdroneexplodeeffects();
...
helperdrone_returnplayer( var_0 )
{
    ...
    scripts\cp_mp\utility\killstreak_utility::movingplatform_playerunlink( var_0 );
...
helperdrone_istargetinreticle( var_0, var_1, var_2 )
{
    ...
    if ( isdefined( var_0.recondronetraceoffset ) )
        var_4 = var_4 + var_0.recondronetraceoffset;

    var_5 = [ var_4 ];

    if ( isplayer( var_0 ) )
    {
        var_6 = var_0 scripts\mp\utility\player::getstancetop();
