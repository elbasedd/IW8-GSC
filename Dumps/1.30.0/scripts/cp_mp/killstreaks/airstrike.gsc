...
weapongivenairstrike( var_0 )
{
    ...
    var_2 = airstrike_canbeused( self.origin );
...
weaponfiredairstrike( var_0, var_1, var_2 )
{
    if ( !isdefined( var_0.targetoverride ) )
    {
        ...
        var_4 = airstrike_canbeused( var_3 );
...
selectairstrikelocation( var_0 )
{
    ...
    if ( isdefined( var_2 ) )
    {
        var_8 = airstrike_canbeused( var_2 );
...
finishmapselectairstrikeusage( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_8 = airstrike_addactivestrike( self.origin, self );
    thread airstrike_watchkills( var_7 * 2, var_8 );
    thread watchairstrikeowner( var_8 );
    thread airstrike_watchgameend( var_4, var_8 );
    ...
    airstrike_removeactivestrike( self, var_8 );
...
finishstandardairstrikeusage( var_0, var_1, var_2 )
{
    ...
    var_6 = airstrike_addactivestrike( var_0, self );
    thread airstrike_watchkills( var_5 * 2, var_6 );
    thread watchairstrikeowner( var_6 );
    thread airstrike_watchgameend( var_2, var_6 );
    ...
    airstrike_removeactivestrike( self, var_6 );
...
watchairstrikeowner( var_0 )
{
    ...
    airstrike_removeactivestrike( self, var_0 );
}

callstrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6 )
{
    var_7 = 0;
    var_8 = scripts\cp_mp\utility\killstreak_utility::getkillstreakairstrikeheightent();
    var_9 = 24000;
    var_10 = 6500;
    var_11 = 2500;
    var_7 = 1500;
...
doplanestrike( var_0, var_1, var_2, var_3, var_4, var_5, var_6, var_7, var_8 )
{
    ...
    var_13 = vectortoangles( var_2 - var_1 );
    ...
    var_15.flightdir = anglestoforward( var_13 );
    var_15.flightheight = var_3;
    var_15.owner = var_7;
    var_16 = istrue( level.isx1ops ) && ( isdefined( level.x1ops ) && level.x1ops == 6 );
    ...
    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "br", "challengeEvaluator" ) )
    {
        var_17 = spawnstruct();
        var_17.plane = var_15;
        var_17.targetsite = var_0;
        var_7 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "br", "challengeEvaluator" ) ]]( "br_mastery_pointBlank_airstrike", var_17 );
    }

    var_18 = "icon_minimap_airstrike";

    if ( var_5.streakname == "fuel_airstrike" )
        var_18 = "icon_minimap_fuelairstrike";

    if ( scripts\cp_mp\utility\script_utility::issharedfuncdefined( "game", "createObjective" ) )
        var_15.minimapid = var_15 [[ scripts\cp_mp\utility\script_utility::getsharedfunc( "game", "createObjective" ) ]]( var_18, var_15.team, undefined, 1, 1 );
    ...
    level thread airstrike_playplaneattackfx( var_15, var_19, var_5 );
    level thread airstrike_playflyfx( var_15, var_1, anglestoforward( var_13 ), var_20, var_21, var_10, var_5 );
    ...
    if ( var_5.streakname == "precision_airstrike" || var_5.streakname == "multi_airstrike" )
        level thread callstrike_precisionbulleteffect( var_15, var_19, var_10, var_0, var_7 );
...
airstrike_watchkills( var_0, var_1 )
{
    ...
    scripts\engine\utility::waittill_any_timeout_no_endon_death_1( var_0, var_2 );
...
callstrike_precisionbulleteffect( var_0, var_1, var_2, var_3, var_4 )
{
    ...
    var_9 = var_6;
    var_10 = istrue( level.isx1ops ) && ( isdefined( level.x1ops ) && level.x1ops == 6 );
...
airstrike_watchgameend( var_0, var_1 )
{
...
airstrike_addactivestrike( var_0, var_1 )
{
    ...
    var_2.origin = var_0;
    var_2.owner = var_1;
    var_2.id = var_1.name + "_" + level.airstrikecount;
    level.activeairstrikes[var_2.id] = var_2;
    return var_2.id;
}

airstrike_removeactivestrike( var_0, var_1 )
{
    level.activeairstrikes = scripts\engine\utility::array_remove_index( level.activeairstrikes, var_1, 1 );

    if ( isdefined( var_0 ) )
        var_0 notify( "airstrike_finished_" + var_1 );
}

airstrike_canbeused( var_0 )
{
    var_1 = "success";
    var_2 = 625000000;
    ...
    if ( isdefined( var_0 ) )
    {
        if ( level.activeairstrikes.size > 0 )
        {
            ...
            if ( level.activeairstrikes.size >= var_3 )
                var_1 = "KILLSTREAKS/AIR_SPACE_TOO_CROWDED";
            else
            {
                foreach ( var_6 in level.activeairstrikes )
                {
...
callprecisionairstrikeonlocation( var_0 )
{
    var_1 = self;
    var_2 = spawnstruct();
    ...
    var_6 = undefined;
    level thread callstrike( var_1, var_0, var_3, var_4, var_2, var_5, var_6 );
}
