...
manualturret_setplaced( var_0, var_1 )
{
    ...
    if ( isdefined( var_1.moving_platform ) )
    {
        ...
        var_0.moving_platform_offset = var_1.moving_platform_offset;
        var_0.moving_platform_angles_offset = var_1.moving_platform_angles_offset;
    }
...
manualturret_setcarried( var_0 )
{
    ...
    if ( istrue( self.inuse ) )
    {
        ...
        var_0 manualturret_toggleallowuseactions( 1 );
    }
    ...
    var_0 scripts\cp_mp\utility\weapon_utility::saveweaponstates();
    ...
    var_0 manualturret_toggleallowplacementactions( 0 );
    var_5 = var_0 manualturret_watchplacement( self, self.streakinfo, 1, 2 );

    if ( !isdefined( var_5 ) )
    {
        var_0 manualturret_toggleallowplacementactions( 1 );
        return 0;
    }
...
manualturret_switchbacklastweapon( var_0, var_1, var_2 )
{
    ...
    var_3 = scripts\cp_mp\utility\weapon_utility::restoreweaponstates( self.lastdroppableweaponobj );
...
manualturret_watchuse( var_0, var_1 )
{
    ...
    for (;;)
    {
        ...
        self.inuse = 1;
        var_3 manualturret_toggleallowuseactions( 0 );
            ...
            if ( var_5 >= 0.25 )
            {
                ...
                if ( isdefined( var_3 ) )
                {
                    ...
                    if ( var_3 scripts\cp_mp\utility\player_utility::_isalive() )
                        var_3 manualturret_toggleallowuseactions( 1 );
                }
        ...
        var_3 scripts\cp_mp\utility\weapon_utility::saveweaponstates();
        ...
        if ( !istrue( var_7 ) )
        {
            ...
            if ( isdefined( var_3 ) )
            {
                ...
                {
                    var_3 manualturret_toggleallowuseactions( 1 );
                    var_8 = var_3 scripts\cp_mp\utility\weapon_utility::restoreweaponstates( var_3.lastdroppableweaponobj );
...
manualturret_toggleallowuseactions( var_0 )
{
    if ( scripts\cp_mp\utility\player_utility::_isalive() )
    {
        scripts\common\utility::allow_offhand_weapons( var_0 );
